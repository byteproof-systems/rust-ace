...
#[export_name = "_ZN8ACE_FIFO4openEPKciji"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_FIFO4openEPKciji(
    __this: *mut ACE_FIFO,
    r: *const libc::c_char,
    flags: libc::c_int,
    perms: libc::c_uint,
    ...
    unsafe { ACE_FIFO::open(__this, r, flags, perms, sa) }
}
#[export_name = "_ZN8ACE_FIFO5closeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_FIFO5closeEv(
    __this: *mut ACE_FIFO,
) -> libc::c_int {
    unsafe { ACE_FIFO::close(__this) }
}
#[export_name = "_ZNK8ACE_FIFO4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK8ACE_FIFO4dumpEv(__this: *const ACE_FIFO) {
    unsafe { ACE_FIFO::dump(__this) }
}
#[export_name = "_ZN8ACE_FIFOC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_FIFOC1Ev(__this: *mut ACE_FIFO) {
    ACE_FIFO::new_at(__this)
}
#[export_name = "_ZN8ACE_FIFOC1EPKciji"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_FIFOC1EPKciji(
    __this: *mut ACE_FIFO,
    ...
    ACE_FIFO::new_at_uf9ce2b0e67be5b26(__this, __a0, __a1, __a2, __a3)
}
...
impl ACE_FIFO {
    ...
    pub unsafe fn open(
        ...
        unsafe {
            ...
            {
                ACE_OS::strsncpy(
                    (((*__this).rendezvous_).as_mut_ptr() as *mut libc::c_char),
                    ((r) as *const libc::c_char),
                    ((4096) as libc::c_ulong),
                );
                if (((((((((((((((((flags) as libc::c_int)) & ((64) as libc::c_int))
                    as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                    && (((((ACE_OS::mkfifo_u463594cc85e8e50a(
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/FIFO.cpp\0".as_ptr()
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        b"ACE_FIFO\0".as_ptr() as *const libc::c_char,
                                    );
                                }
                            }
