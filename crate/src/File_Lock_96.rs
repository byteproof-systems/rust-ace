...
#[export_name = "_ZN13ACE_File_LockC1Eib"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_File_LockC1Eib(
    __this: *mut ACE_File_Lock,
    __a0: libc::c_int,
    __a1: bool,
) {
    ACE_File_Lock::new_at(__this, __a0, __a1)
}
#[export_name = "_ZN13ACE_File_LockC1EPKcijb"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_File_LockC1EPKcijb(
    __this: *mut ACE_File_Lock,
    ...
    ACE_File_Lock::new_at_u861aea7ba294a55d(__this, __a0, __a1, __a2, __a3)
}
#[export_name = "_ZN13ACE_File_Lock4openEPKcij"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_File_Lock4openEPKcij(
    __this: *mut ACE_File_Lock,
    name: *const libc::c_char,
    flags: libc::c_int,
    perms: libc::c_uint,
) -> libc::c_int {
    unsafe { ACE_File_Lock::open(__this, name, flags, perms) }
}
impl Drop for ACE_File_Lock {
    fn drop(&mut self) {
        unsafe {
            ...
            {
                <ACE_File_Lock>::remove(
                    (__this) as *mut ACE_File_Lock,
                    (((*__this).unlink_in_destructor_) as bool),
                );
            }
            ()
        }
...
#[export_name = "__acedtor_ubba3170a7b7f92a1"]
pub unsafe extern "C-unwind" fn __acedtor_ubba3170a7b7f92a1(__this: *mut ACE_File_Lock) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
    }
}
#[export_name = "_ZNK13ACE_File_Lock4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_File_Lock4dumpEv(
    __this: *const ACE_File_Lock,
) {
    unsafe { ACE_File_Lock::dump(__this) }
}
...
impl ACE_File_Lock {
    ...
    pub unsafe fn new_at(
        ...
        unsafe {
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).unlink_in_destructor_),
                ((unlink_in_destructor) as bool),
            );
            {
                if (((((ACE_OS::flock_init(
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/File_Lock.cpp\0".as_ptr()
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        b"ACE_File_Lock::ACE_File_Lock\0".as_ptr()
                                            as *const libc::c_char,
                                    );
                                }
                            }
                ...
                <ACE_File_Lock>::set_handle((__this) as *mut ACE_File_Lock, h);
            }
            ()
        }
    }
