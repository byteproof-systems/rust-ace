...
#[export_name = "_ZN18ACE_Method_RequestC1Em"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_Method_RequestC1Em(
    __this: *mut ACE_Method_Request,
    __a0: libc::c_ulong,
) {
    ACE_Method_Request::new_at(__this, __a0)
}
#[export_name = "_ZNK18ACE_Method_Request8priorityEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK18ACE_Method_Request8priorityEv(
    __this: *const ACE_Method_Request,
) -> libc::c_ulong {
    unsafe { ACE_Method_Request::priority(__this) }
}
#[export_name = "_ZN18ACE_Method_Request8priorityEm"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_Method_Request8priorityEm(
    __this: *mut ACE_Method_Request,
    prio: libc::c_ulong,
) {
    unsafe { ACE_Method_Request::priority_u3eb5dc74c76c0f6a(__this, prio) }
}
