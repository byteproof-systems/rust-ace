...
#[export_name = "_ZN14ACE_RecyclableC1E20ACE_Recyclable_State"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_RecyclableC1E20ACE_Recyclable_State(
    __this: *mut ACE_Recyclable,
    __a0: libc::c_uint,
) {
    ACE_Recyclable::new_at(__this, __a0)
}
