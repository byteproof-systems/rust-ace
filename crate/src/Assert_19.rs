...
#[doc = "/"]
#[export_name = "_Z12__ace_assertPKciS0_"]
pub unsafe extern "C-unwind" fn __ace_assert(
    ...
    unsafe {
        {
            let mut error: libc::c_int = <ACE_Log_Msg>::last_error_adapter();
            let mut log: *mut ACE_Log_Msg = <ACE_Log_Msg>::instance();
            <ACE_Log_Msg>::set(
                (log) as *mut ACE_Log_Msg,
                file,
                line,
                (-((1) as libc::c_int)),
                error,
                <ACE_Log_Msg>::restart_uc5a430d422835657((log) as *const ACE_Log_Msg),
                <ACE_Log_Msg>::msg_ostream_ueaab56de14069bdb(
                    (log) as *const ACE_Log_Msg,
                ),
            ...
            {
                extern "C-unwind" {
                    #[link_name = "_ZN11ACE_Log_Msg3logE16ACE_Log_PriorityPKcz"]
                    fn __ext(
                ...
                __ext(
                    (log) as *mut ACE_Log_Msg,
                    LM_ERROR,
                    ((b"ACE_ASSERT: file %N, line %l assertion failed for '%s'.%a\n\0"
