...
impl Drop for ACE_Message_Queue_Base {
    fn drop(&mut self) {
        unsafe {
...
#[export_name = "_ZN22ACE_Message_Queue_Base5stateEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN22ACE_Message_Queue_Base5stateEv(
    __this: *mut ACE_Message_Queue_Base,
) -> libc::c_int {
    unsafe { ACE_Message_Queue_Base::state(__this) }
}
