...
#[export_name = "_ZNK9ACE_LSOCK11send_handleEi"]
pub unsafe extern "C-unwind" fn __xtu__ZNK9ACE_LSOCK11send_handleEi(
    __this: *const ACE_LSOCK,
    handle: libc::c_int,
) -> libc::c_long {
    unsafe { ACE_LSOCK::send_handle(__this, handle) }
}
#[export_name = "_ZNK9ACE_LSOCK11recv_handleERiPcPl"]
pub unsafe extern "C-unwind" fn __xtu__ZNK9ACE_LSOCK11recv_handleERiPcPl(
    __this: *const ACE_LSOCK,
    handle: *mut libc::c_int,
    pbuf: *mut libc::c_char,
    len: *mut libc::c_long,
) -> libc::c_long {
    unsafe { ACE_LSOCK::recv_handle(__this, handle, pbuf, len) }
}
#[export_name = "_ZNK9ACE_LSOCK4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK9ACE_LSOCK4dumpEv(__this: *const ACE_LSOCK) {
    unsafe { ACE_LSOCK::dump(__this) }
}
