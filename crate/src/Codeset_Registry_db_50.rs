...
#[allow(non_upper_case_globals)]
#[no_mangle]
pub static ACE_Codeset_Registry_num_registry_entries_: libc::c_ulong = ((9)
    as libc::c_ulong);
#[allow(non_upper_case_globals)]
#[no_mangle]
pub static mut ACE_Codeset_Registry_registry_db_: [registry_entry; 9usize] = [
    registry_entry {
        desc_: b"ISO/IEC 10646-1:1993; UCS-2, Level 1\0".as_ptr() as *const libc::c_char,
        loc_name_: b"UCS-2\0".as_ptr() as *const libc::c_char,
        codeset_id_: ((0x00010100) as libc::c_uint),
        num_sets_: ((1) as libc::c_ushort),
        char_sets_: [
            ((0x1000) as libc::c_ushort),
            unsafe {
                ::core::mem::MaybeUninit::<libc::c_ushort>::zeroed().assume_init()
            },
            unsafe {
                ::core::mem::MaybeUninit::<libc::c_ushort>::zeroed().assume_init()
            },
            ...
            unsafe { ::core::mem::MaybeUninit::<libc::c_ushort>::zeroed().assume_init() },
        ],
        max_bytes_: ((2) as libc::c_ushort),
    },
    registry_entry {
        desc_: b"ISO 8859-1:1987; Latin Alphabet No. 1\0".as_ptr()
            as *const libc::c_char,
        loc_name_: b"ISO8859_1\0".as_ptr() as *const libc::c_char,
        codeset_id_: ((0x00010001) as libc::c_uint),
        num_sets_: ((1) as libc::c_ushort),
        char_sets_: [
            ((0x0011) as libc::c_ushort),
            unsafe {
                ::core::mem::MaybeUninit::<libc::c_ushort>::zeroed().assume_init()
            },
            unsafe {
        ...
        max_bytes_: ((1) as libc::c_ushort),
    },
    registry_entry {
        desc_: b"IBM-1047 (CCSID 01047); Latin-1 Open System\0".as_ptr()
            as *const libc::c_char,
        loc_name_: b"EBCDIC\0".as_ptr() as *const libc::c_char,
        codeset_id_: ((0x10020417) as libc::c_uint),
        num_sets_: ((1) as libc::c_ushort),
        char_sets_: [
            ((0x0011) as libc::c_ushort),
            unsafe {
    ...
    registry_entry {
        desc_: b"ISO/IEC 10646-1:1993; UCS-4, Level 1\0".as_ptr() as *const libc::c_char,
        loc_name_: b"UCS-4\0".as_ptr() as *const libc::c_char,
        codeset_id_: ((0x00010104) as libc::c_uint),
        num_sets_: ((1) as libc::c_ushort),
        char_sets_: [
            ((0x1000) as libc::c_ushort),
            unsafe {
        ...
        max_bytes_: ((4) as libc::c_ushort),
    },
    registry_entry {
        desc_: b"ISO/IEC 10646-1:1993; UTF-16, UCS Transformation Format 16-bit form\0"
            .as_ptr() as *const libc::c_char,
        loc_name_: b"UTF-16\0".as_ptr() as *const libc::c_char,
        codeset_id_: ((0x00010109) as libc::c_uint),
        num_sets_: ((1) as libc::c_ushort),
        char_sets_: [
            ((0x1000) as libc::c_ushort),
            unsafe {
    ...
    registry_entry {
        desc_: b"X/Open UTF-8; UCS Transformation Format 8 (UTF-8)\0".as_ptr()
            as *const libc::c_char,
        loc_name_: b"UTF-8\0".as_ptr() as *const libc::c_char,
        codeset_id_: ((0x05010001) as libc::c_uint),
        num_sets_: ((1) as libc::c_ushort),
        char_sets_: [
            ((0x1000) as libc::c_ushort),
            unsafe {
        ...
        max_bytes_: ((6) as libc::c_ushort),
    },
    registry_entry {
        desc_: b"ISO/IEC 8859-5:1988; Latin-Cyrillic Alphabet\0".as_ptr()
            as *const libc::c_char,
        loc_name_: b"ISO-8859-5\0".as_ptr() as *const libc::c_char,
        codeset_id_: ((0x00010005) as libc::c_uint),
        num_sets_: ((1) as libc::c_ushort),
        char_sets_: [
            ((0x0015) as libc::c_ushort),
            unsafe {
                ::core::mem::MaybeUninit::<libc::c_ushort>::zeroed().assume_init()
            },
            unsafe {
    ...
    registry_entry {
        desc_: b"IBM-1251 (CCSID 01251); MS Windows Cyrillic\0".as_ptr()
            as *const libc::c_char,
        loc_name_: b"CP1251\0".as_ptr() as *const libc::c_char,
        codeset_id_: ((0x100204e3) as libc::c_uint),
        num_sets_: ((1) as libc::c_ushort),
        char_sets_: [
            ((0x0015) as libc::c_ushort),
            unsafe {
    ...
    registry_entry {
        desc_: b"IBM-855 (CCSID 04951); Cyrillic Personal Computer\0".as_ptr()
            as *const libc::c_char,
        loc_name_: b"CP855\0".as_ptr() as *const libc::c_char,
        codeset_id_: ((0x10021357) as libc::c_uint),
        num_sets_: ((1) as libc::c_ushort),
        char_sets_: [
            ((0x0015) as libc::c_ushort),
            unsafe {
...
impl ACE_Codeset_Registry {
  ...
  /// This wraps the rpc_rgy_get_max_bytes function.*/
    ...
    pub unsafe fn locale_to_registry_i(
        mut locale: *const ACE_String_Base_char_,
        mut codeset_id: *mut libc::c_uint,
        mut _anon_2: *mut libc::c_ushort,
        mut _anon_3: *mut *mut libc::c_ushort,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN20ACE_Codeset_Registry20locale_to_registry_iERK15ACE_String_BaseIcERjPtPS5_"]
            fn __ext(
                locale: *const ACE_String_Base_char_,
                codeset_id: *mut libc::c_uint,
                _anon_2: *mut libc::c_ushort,
                _anon_3: *mut *mut libc::c_ushort,
            ) -> libc::c_int;
        }
        __ext(locale, codeset_id, _anon_2, _anon_3)
    }
    pub unsafe fn registry_to_locale_i(
        ...
        extern "C-unwind" {
            #[link_name = "_ZN20ACE_Codeset_Registry20registry_to_locale_iEjR15ACE_String_BaseIcEPtPS3_"]
            fn __ext(
        ...
        __ext(codeset_id, locale, _anon_2, _anon_3)
    }
    pub unsafe fn is_compatible_i(
        ...
        extern "C-unwind" {
            #[link_name = "_ZN20ACE_Codeset_Registry15is_compatible_iEjj"]
            fn __ext(codeset_id: libc::c_uint, other: libc::c_uint) -> libc::c_int;
        }
        __ext(codeset_id, other)
    }
    pub unsafe fn get_max_bytes_i(mut codeset_id: libc::c_uint) -> libc::c_short {
        extern "C-unwind" {
            #[link_name = "_ZN20ACE_Codeset_Registry15get_max_bytes_iEj"]
            fn __ext(codeset_id: libc::c_uint) -> libc::c_short;
        }
        __ext(codeset_id)
    }
}
