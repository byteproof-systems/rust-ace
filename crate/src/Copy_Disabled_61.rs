...
#[export_name = "_ZN17ACE_Copy_DisabledC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Copy_DisabledC1Ev(
    __this: *mut ACE_Copy_Disabled,
) {
    ACE_Copy_Disabled::new_at(__this)
}
