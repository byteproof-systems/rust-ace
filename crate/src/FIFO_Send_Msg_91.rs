...
#[doc = "* @class ACE_FIFO_Send_Msg\n *\n * @brief Sender side for the Record oriented C++ wrapper for UNIX\n * FIFOs."]
#[repr(C)]
#[derive(Clone)]
pub struct ACE_FIFO_Send_Msg {
    pub __base_0: ::core::mem::ManuallyDrop<ACE_FIFO_Send>,
}
impl Drop for ACE_FIFO_Send_Msg {
    fn drop(&mut self) {
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.__base_0);
        }
...
#[export_name = "_ZN17ACE_FIFO_Send_MsgC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_FIFO_Send_MsgC1Ev(
    __this: *mut ACE_FIFO_Send_Msg,
) {
    ACE_FIFO_Send_Msg::new_at(__this)
}
#[export_name = "_ZN17ACE_FIFO_Send_MsgC1EPKciji"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_FIFO_Send_MsgC1EPKciji(
    __this: *mut ACE_FIFO_Send_Msg,
    ...
    ACE_FIFO_Send_Msg::new_at_u34233f249c9f8c19(__this, __a0, __a1, __a2, __a3)
}
#[export_name = "_ZN17ACE_FIFO_Send_Msg4openEPKciji"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_FIFO_Send_Msg4openEPKciji(
    __this: *mut ACE_FIFO_Send_Msg,
    ...
    unsafe { ACE_FIFO_Send_Msg::open(__this, fifo_name, flags, perms, sa) }
}
#[export_name = "_ZN17ACE_FIFO_Send_Msg4sendERK11ACE_Str_Buf"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_FIFO_Send_Msg4sendERK11ACE_Str_Buf(
    __this: *mut ACE_FIFO_Send_Msg,
    send_msg: *const ACE_Str_Buf,
) -> libc::c_long {
    unsafe { ACE_FIFO_Send_Msg::send(__this, send_msg) }
}
#[export_name = "_ZNK17ACE_FIFO_Send_Msg4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK17ACE_FIFO_Send_Msg4dumpEv(
    __this: *const ACE_FIFO_Send_Msg,
) {
    unsafe { ACE_FIFO_Send_Msg::dump(__this) }
}
...
impl ACE_FIFO_Send {
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        extern "C-unwind" {
            #[link_name = "_ZN13ACE_FIFO_SendC1Ev"]
            fn __ext(__this: *mut ACE_FIFO_Send);
        }
        __ext(__this as *mut ACE_FIFO_Send)
    }
    pub unsafe fn new() -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at(::core::ptr::addr_of_mut!(__obj));
    ...
    pub unsafe fn new_at_u831c4a193dba6a1b(
        __this: *mut Self,
        mut __a0: *const libc::c_char,
        mut __a1: libc::c_int,
        mut __a2: libc::c_uint,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN13ACE_FIFO_SendC1EPKciji"]
            fn __ext(
                __this: *mut ACE_FIFO_Send,
                __a0: *const libc::c_char,
                __a1: libc::c_int,
                __a2: libc::c_uint,
                __a3: libc::c_int,
        ...
        __ext(__this as *mut ACE_FIFO_Send, __a0, __a1, __a2, __a3)
    }
    pub unsafe fn new_u831c4a193dba6a1b(
        mut __a0: *const libc::c_char,
        mut __a1: libc::c_int,
        mut __a2: libc::c_uint,
        mut __a3: libc::c_int,
    ...
    pub unsafe fn open(
        ...
        extern "C-unwind" {
            #[link_name = "_ZN13ACE_FIFO_Send4openEPKciji"]
            fn __ext(
                __this: *mut ACE_FIFO_Send,
                rendezvous: *const libc::c_char,
                flags: libc::c_int,
        ...
        __ext(__this as *mut ACE_FIFO_Send, rendezvous, flags, perms, sa)
    }
    ...
    pub unsafe fn dump(__this: *const Self) {
        extern "C-unwind" {
            #[link_name = "_ZNK13ACE_FIFO_Send4dumpEv"]
            fn __ext(__this: *const ACE_FIFO_Send);
        }
        __ext(__this as *const ACE_FIFO_Send)
    }
}
...
impl ACE_FIFO_Send_Msg {
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ...
            <ACE_FIFO_Send>::new_at(
                ::core::ptr::addr_of_mut!((* __this).__base_0).cast::<ACE_FIFO_Send>(),
            );
            {}
            ()
        }
    ...
    pub unsafe fn new_at_u34233f249c9f8c19(
        __this: *mut Self,
        ...
        unsafe {
            ...
            {
                if (((((<ACE_FIFO_Send_Msg>::open(
                    (__this) as *mut ACE_FIFO_Send_Msg,
                    fifo_name,
                    flags,
                    perms,
                    sa,
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/FIFO_Send_Msg.cpp\0"
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        b"ACE_FIFO_Send_Msg\0".as_ptr() as *const libc::c_char,
                                    );
                                }
                            }
    ...
    pub unsafe fn new_u34233f249c9f8c19(
        mut __a0: *const libc::c_char,
        mut __a1: libc::c_int,
        mut __a2: libc::c_uint,
        mut __a3: libc::c_int,
    ...
    pub unsafe fn open(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return <ACE_FIFO_Send>::open(
                    (::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                        ACE_FIFO_Send > ().cast_mut())
                    )) as *mut ACE_FIFO_Send,
                    fifo_name,
                    (((flags) as libc::c_int)) | ((1) as libc::c_int),
                    perms,
                    sa,
                );
            }
    ...
    pub unsafe fn send(
        __this: *mut Self,
        mut send_msg: *const ACE_Str_Buf,
    ) -> libc::c_long {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                (iov)[(0) as usize].iov_base = (((::core::ptr::addr_of!(
                    (* send_msg).__base_0.len
                ) as *const libc::c_int as *mut libc::c_char)) as *mut libc::c_void);
                (iov)[(0) as usize].iov_len = ((::core::mem::size_of::<libc::c_int>()
                    as libc::c_ulong) as libc::c_ulong);
                (iov)[(1) as usize].iov_base = ((((*send_msg).__base_0.buf
                    as *mut libc::c_char)) as *mut libc::c_void);
                (iov)[(1) as usize].iov_len = ((((*send_msg).__base_0.len
                    as libc::c_ulong)) as libc::c_ulong);
                let mut sent: libc::c_long = ACE_OS::writev_u9b20468f161f7ab3(
                    <ACE_IPC_SAP>::get_handle(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((*
                            ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                            ACE_FIFO_Send > ().cast_mut()).__base_0) .cast:: < ACE_FIFO >
                ...
                if (((((sent as libc::c_long)) > (((0) as libc::c_long))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    {
                        sent = (((sent) as libc::c_long))
                            .wrapping_sub(((iov)[(0) as usize].iov_len) as libc::c_long);
                        sent
                    };
                }
                return sent;
    ...
    ///Send @a buf of exactly @a len bytes (block until done).
    pub unsafe fn send_u303daad85c09a892(
        __this: *mut Self,
        mut buf: *const libc::c_void,
        mut len: libc::c_ulong,
    ) -> libc::c_long {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut send_msg: ACE_Str_Buf = ::core::mem::MaybeUninit::<
                    ACE_Str_Buf,
                >::zeroed()
                    .assume_init();
                <ACE_Str_Buf>::new_at(
                    (::core::ptr::addr_of_mut!(send_msg)) as *mut ACE_Str_Buf,
                    (((buf as *mut libc::c_char)) as *mut libc::c_void),
                    (len as libc::c_int),
                    0,
                );
                return <ACE_FIFO_Send_Msg>::send(
                    (__this) as *mut ACE_FIFO_Send_Msg,
                    ::core::ptr::addr_of!(send_msg),
                );
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
