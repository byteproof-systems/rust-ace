...
#[export_name = "_ZN14ACE_Handle_SetC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Handle_SetC1Ev(
    __this: *mut ACE_Handle_Set,
) {
    ACE_Handle_Set::new_at(__this)
}
#[export_name = "_ZN14ACE_Handle_SetC1ERK6fd_set"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Handle_SetC1ERK6fd_set(
    __this: *mut ACE_Handle_Set,
    __a0: *const fd_set,
) {
    ACE_Handle_Set::new_at_u79ec3d4a32249acb(__this, __a0)
}
#[export_name = "_ZN14ACE_Handle_Set4syncEi"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Handle_Set4syncEi(
    __this: *mut ACE_Handle_Set,
    max: libc::c_int,
) {
    unsafe { ACE_Handle_Set::sync(__this, max) }
}
#[export_name = "_ZNK14ACE_Handle_Set4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK14ACE_Handle_Set4dumpEv(
    __this: *const ACE_Handle_Set,
) {
    unsafe { ACE_Handle_Set::dump(__this) }
}
#[export_name = "_ZN14ACE_Handle_Set10count_bitsEm"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Handle_Set10count_bitsEm(
    n: libc::c_ulong,
) -> libc::c_int {
    unsafe { ACE_Handle_Set::count_bits(n) }
}
#[export_name = "_ZN14ACE_Handle_Set6bitposEm"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Handle_Set6bitposEm(
    bit: libc::c_ulong,
) -> libc::c_int {
    unsafe { ACE_Handle_Set::bitpos(bit) }
}
#[export_name = "_ZN14ACE_Handle_Set7set_maxEi"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Handle_Set7set_maxEi(
    __this: *mut ACE_Handle_Set,
    current_max: libc::c_int,
) {
    unsafe { ACE_Handle_Set::set_max(__this, current_max) }
}
#[export_name = "_ZN23ACE_Handle_Set_IteratorC1ERK14ACE_Handle_Set"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Handle_Set_IteratorC1ERK14ACE_Handle_Set(
    __this: *mut ACE_Handle_Set_Iterator,
    __a0: *const ACE_Handle_Set,
) {
    ACE_Handle_Set_Iterator::new_at(__this, __a0)
}
#[export_name = "_ZN23ACE_Handle_Set_Iterator11reset_stateEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Handle_Set_Iterator11reset_stateEv(
    __this: *mut ACE_Handle_Set_Iterator,
) {
    unsafe { ACE_Handle_Set_Iterator::reset_state(__this) }
}
#[export_name = "_ZN23ACE_Handle_Set_IteratorclEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Handle_Set_IteratorclEv(
    __this: *mut ACE_Handle_Set_Iterator,
) -> libc::c_int {
    unsafe { ACE_Handle_Set_Iterator::operator_call(__this) }
}
#[export_name = "_ZNK23ACE_Handle_Set_Iterator4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK23ACE_Handle_Set_Iterator4dumpEv(
    __this: *const ACE_Handle_Set_Iterator,
) {
    unsafe { ACE_Handle_Set_Iterator::dump(__this) }
}
extern "C-unwind" {
