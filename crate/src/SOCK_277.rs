...
#[export_name = "_ZN8ACE_SOCK5closeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_SOCK5closeEv(
    __this: *mut ACE_SOCK,
) -> libc::c_int {
    unsafe { ACE_SOCK::close(__this) }
}
#[export_name = "_ZNK8ACE_SOCK14get_local_addrER8ACE_Addr"]
pub unsafe extern "C-unwind" fn __xtu__ZNK8ACE_SOCK14get_local_addrER8ACE_Addr(
    __this: *const ACE_SOCK,
    sa: *mut ACE_Addr,
) -> libc::c_int {
    unsafe { ACE_SOCK::get_local_addr(__this, sa) }
}
#[export_name = "_ZNK8ACE_SOCK15get_remote_addrER8ACE_Addr"]
pub unsafe extern "C-unwind" fn __xtu__ZNK8ACE_SOCK15get_remote_addrER8ACE_Addr(
    __this: *const ACE_SOCK,
    sa: *mut ACE_Addr,
) -> libc::c_int {
    unsafe { ACE_SOCK::get_remote_addr(__this, sa) }
}
#[export_name = "_ZNK8ACE_SOCK4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK8ACE_SOCK4dumpEv(__this: *const ACE_SOCK) {
    unsafe { ACE_SOCK::dump(__this) }
}
#[export_name = "_ZN8ACE_SOCK4openEiiii"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_SOCK4openEiiii(
    __this: *mut ACE_SOCK,
    r#type: libc::c_int,
    ...
    unsafe { ACE_SOCK::open(__this, r#type, protocol_family, protocol, reuse_addr) }
}
#[export_name = "_ZN8ACE_SOCK4openEiiiP17ACE_Protocol_Infommi"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_SOCK4openEiiiP17ACE_Protocol_Infommi(
    __this: *mut ACE_SOCK,
    r#type: libc::c_int,
    protocol_family: libc::c_int,
    protocol: libc::c_int,
...
#[export_name = "_ZN8ACE_SOCKC1Eiiii"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_SOCKC1Eiiii(
    __this: *mut ACE_SOCK,
    __a0: libc::c_int,
    __a1: libc::c_int,
    __a2: libc::c_int,
    ...
    ACE_SOCK::new_at(__this, __a0, __a1, __a2, __a3)
}
#[export_name = "_ZN8ACE_SOCKC1EiiiP17ACE_Protocol_Infommi"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_SOCKC1EiiiP17ACE_Protocol_Infommi(
    __this: *mut ACE_SOCK,
    __a0: libc::c_int,
    __a1: libc::c_int,
    __a2: libc::c_int,
    ...
    ACE_SOCK::new_at_u29b3d6504f3a1a8a(__this, __a0, __a1, __a2, __a3, __a4, __a5, __a6)
}
#[export_name = "_ZN8ACE_SOCKC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_SOCKC1Ev(__this: *mut ACE_SOCK) {
    ACE_SOCK::new_at_u5fc888c9b9ff78ab(__this)
}
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut len: libc::c_int = <ACE_Addr>::get_size(
                    (::core::ptr::addr_of!((* sa))) as *const ACE_Addr,
                );
                let mut addr: *mut sockaddr = ({
                    let __obj: *mut ACE_Addr = (::core::ptr::addr_of!((* sa)))
                        as *mut ACE_Addr;
                ...
                <ACE_Addr>::set_type(
                    (::core::ptr::addr_of_mut!((* sa))) as *mut ACE_Addr,
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                <ACE_IPC_SAP>::set_handle(
                    ...
                    ACE_OS::socket_u707bc17eb37e5e24(protocol_family, r#type, protocol),
                );
                if (((((<ACE_IPC_SAP>::get_handle(
                    (::core::ptr::addr_of!(
                        (* ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                    ...
                    as libc::c_int as libc::c_int) != 0)
                {
                    ...
                    if (((((((((((((protocol_family as libc::c_int))
                        != (((1) as libc::c_int))) as libc::c_int as libc::c_int) != 0)
                        && ((reuse_addr) != 0)) as libc::c_int) as libc::c_int) != 0)
                        && (((((<ACE_SOCK>::set_option(
                            (__this) as *const ACE_SOCK,
                            1,
                            2,
                        ...
                        as libc::c_int) != 0)
                    {
                        <ACE_SOCK>::close((__this) as *mut ACE_SOCK);
                        return (-((1) as libc::c_int));
                    }
                }
                return 0;
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                <ACE_IPC_SAP>::set_handle(
                    ...
                    ACE_OS::socket_u03f77517e3b1f817(
                        protocol_family,
                        r#type,
                        protocol,
                        protocolinfo,
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/SOCK.cpp\0".as_ptr()
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        b"ACE_SOCK::ACE_SOCK\0".as_ptr() as *const libc::c_char,
                                    );
                                }
                            }
