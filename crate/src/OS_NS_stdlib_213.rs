...
pub mod ACE_OS {
    ...
    #[export_name = "_ZN6ACE_OS6callocEmm"]
    pub unsafe extern "C-unwind" fn calloc_uda0c707404e15bad(
        mut elements: libc::c_ulong,
        mut sizeof_elements: libc::c_ulong,
    ) -> *mut libc::c_void {
        unsafe {
            {
                return super::calloc(elements, sizeof_elements);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    #[export_name = "_ZN6ACE_OS4exitEi"]
    pub unsafe extern "C-unwind" fn exit_ud318a3a23e137d2b(mut status: libc::c_int) {
        unsafe {
            {
                super::exit(status);
            }
    ...
    #[export_name = "_ZN6ACE_OS4freeEPv"]
    pub unsafe extern "C-unwind" fn free_ucbe6910a56eae126(mut ptr: *mut libc::c_void) {
        unsafe {
            {
                super::free((((ptr as *mut libc::c_void)) as *mut libc::c_void));
            }
            ()
        }
    }
    pub use crate::full_ops_0::ACE_OS::getenv_u25dce132a786d601;
    #[export_name = "_ZN6ACE_OS13getenvstringsEv"]
    pub unsafe extern "C-unwind" fn getenvstrings() -> *mut libc::c_char {
        unsafe {
            {
                'dowhile_0: loop {
                    'cont_0: loop {
    ...
    #[export_name = "_ZN6ACE_OS14itoa_emulationEiPci"]
    pub unsafe extern "C-unwind" fn itoa_emulation(
        ...
        unsafe {
            {
                let mut e: *mut libc::c_char = string;
                let mut b: *mut libc::c_char = string;
                if (((((value as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    (*(string).wrapping_offset((0) as isize)) = 48 as libc::c_char;
                    (*(string).wrapping_offset((1) as isize)) = ((0) as libc::c_char);
                    return string;
                }
                if (((((((((value as libc::c_int)) < (((0) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                    && (((((radix as libc::c_int)) == (((10) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    (*(string).wrapping_offset((0) as isize)) = 45 as libc::c_char;
                    {
                        let __lv = &mut (b);
                ...
                'while_0: loop {
                    ...
                    'cont_0: loop {
                        {
                            {
                                let mut r#mod: libc::c_int = (((value) as libc::c_int))
                                    % ((radix) as libc::c_int);
                                ...
                                (*({
                                    ...
                                    *__lv = (*__lv).wrapping_offset(1);
                                    __r
                                })) = ((if ((((((r#mod as libc::c_int))
                                    < (((10) as libc::c_int))) as libc::c_int) as libc::c_int)
                                    != 0)
                                {
                                    (((48 as libc::c_char) as libc::c_int))
                                        .wrapping_add((r#mod) as libc::c_int)
                                } else {
                                    ((((((97 as libc::c_char) as libc::c_int))
                                        .wrapping_add((r#mod) as libc::c_int)) as libc::c_int))
                                        .wrapping_sub((10) as libc::c_int)
                                }) as libc::c_char);
                            }
                        }
                        #[allow(unreachable_code)] break 'cont_0;
                ...
                'while_1: loop {
                    if !(((((((e) as *const u8)) > (((b) as *const u8))) as libc::c_int
                        as libc::c_int) != 0))
                    {
                        break 'while_1;
                    }
    ...
    #[export_name = "_ZN6ACE_OS14itow_emulationEiPwi"]
    pub unsafe extern "C-unwind" fn itow_emulation(
        mut value: libc::c_int,
        mut string: *mut libc::wchar_t,
        mut radix: libc::c_int,
    ) -> *mut libc::wchar_t {
        unsafe {
            {
                let mut e: *mut libc::wchar_t = string;
                let mut b: *mut libc::wchar_t = string;
                if (((((value as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    (*(string).wrapping_offset((0) as isize)) = ((48 as libc::c_char)
                        as libc::wchar_t);
                    (*(string).wrapping_offset((1) as isize)) = ((0) as libc::wchar_t);
                    return string;
                }
                if (((((((((value as libc::c_int)) < (((0) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
    ...
    #[export_name = "_ZN6ACE_OS6mallocEm"]
    pub unsafe extern "C-unwind" fn malloc_u80646b42522769ca(
    ...
    #[export_name = "_ZN6ACE_OS7reallocEPvm"]
    pub unsafe extern "C-unwind" fn realloc_u7a2f3395e781bb73(
        mut ptr: *mut libc::c_void,
        mut nbytes: libc::c_ulong,
    ) -> *mut libc::c_void {
        unsafe {
            {
                return super::realloc(
                    (((ptr as *mut libc::c_void)) as *mut libc::c_void),
                    nbytes,
                );
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
    ...
    #[no_mangle]
    pub static mut exit_hook_: Option<unsafe extern "C-unwind" fn()> = None;
    pub use crate::full_ops_0::ACE_OS::set_exit_hook;
    pub use crate::full_ops_0::ACE_OS::srand_u295a01f6abd1c409;
    #[export_name = "_ZN6ACE_OS9strenvdupEPKc"]
    pub unsafe extern "C-unwind" fn strenvdup_uc4fed4dc8e89ae4d(
        ...
        unsafe {
            {
                ...
                if ((((!(({
                    let __v = ((strchr_ue2d436a738f8836a(
                ...
                {
                    let mut buf: [libc::c_char; 4096usize] = unsafe {
                        ::core::mem::zeroed()
                    };
                    let mut var_len: libc::c_ulong = strcspn_u810d935abf74b6b8(
                        ((::core::ptr::addr_of!(
                            (* (start).wrapping_offset((1) as isize))
                        ) as *const libc::c_char) as *const libc::c_char),
                        ((b"$~!#%^&*()-+=\\|/?,.;:'\"`[]{} \t\n\r\0".as_ptr()
                            as *const libc::c_char) as *const libc::c_char),
                    );
                    strncpy_u11a5be0fa5efbef0(
                    ...
                    (buf)[({
                        let __lv = &mut (var_len);
                        let __r = *__lv;
                        *__lv = (*__lv).wrapping_add(1);
                        __r
                    }) as usize] = ((0 as libc::c_char) as libc::c_char);
                    let mut temp: *mut libc::c_char = getenv_u25dce132a786d601(
                        ((buf).as_ptr() as *const libc::c_char),
                    );
                    let mut buf_len: libc::c_ulong = (((strlen_u07dd12a225364fa6(
                        ((str) as *const libc::c_char),
                    )) as libc::c_ulong))
                            ...
                            buf_len = (((buf_len) as libc::c_ulong))
                                .wrapping_add(
                                    ((((strlen_u07dd12a225364fa6(
                                        ...
                                        .wrapping_sub((var_len) as libc::c_ulong)) as libc::c_ulong,
                                );
                            buf_len
                        };
                    }
                    let mut buf_p: *mut libc::c_char = (malloc_u80646b42522769ca(
                        (((((buf_len) as libc::c_ulong))
                            .wrapping_mul((1) as libc::c_ulong)) as libc::c_ulong),
                    ) as *mut libc::c_char);
                    if (((((buf_p).is_null()) as libc::c_int) as libc::c_int) != 0) {
                        ((*(super::__errno_location()))) = 12;
                        return ((0) as *mut libc::c_char);
                    }
                    let mut p: *mut libc::c_char = buf_p;
                    let mut len: libc::c_ulong = (((((start).offset_from(str))
                        as libc::c_long as libc::c_ulong)) as libc::c_ulong);
                    strncpy_u11a5be0fa5efbef0(
                    ...
                    if ((((!(temp).is_null()) as libc::c_int) as libc::c_int) != 0) {
                        ...
                        {
                            p = (p).wrapping_offset((var_len) as isize);
                            p
                        };
                        (*(p)) = ((0 as libc::c_char) as libc::c_char);
                    }
                    strcpy_u08e8184bcebbac89(
                        ((p) as *mut libc::c_char),
                        ((::core::ptr::addr_of!(
                            (* (start).wrapping_offset((var_len) as isize))
                        ) as *const libc::c_char) as *const libc::c_char),
                    );
                    return buf_p;
                } else {
                    return ((strdup_u8b6a84c4b070659c(((str) as *const libc::c_char)))
                        as *mut libc::c_char);
                }
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
    ...
    #[export_name = "_ZN6ACE_OS21getprogname_emulationEv"]
    pub unsafe extern "C-unwind" fn getprogname_emulation() -> *const libc::c_char {
        unsafe {
            {
                return super::__progname;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    pub use crate::full_ops_0::ACE_OS::setprogname;
    #[export_name = "_ZN6ACE_OS21setprogname_emulationEPKc"]
    pub unsafe extern "C-unwind" fn setprogname_emulation(
        mut progname: *const libc::c_char,
    ) {
        unsafe {
            {
                let mut p: *const libc::c_char = strrchr_u93b8199dbba81372(
                    progname,
                    ((47 as libc::c_char) as libc::c_int),
                );
                if ((((!(p).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    super::__progname = (p).wrapping_offset((1) as isize);
                } else {
                    super::__progname = progname;
                }
            }
            ()
        }
...
pub(crate) static mut __progname: *const libc::c_char = b"\0".as_ptr()
    as *const libc::c_char;
extern "C-unwind" {
