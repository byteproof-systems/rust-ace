...
#[no_mangle]
pub static mut ACE_Base64_decoder_: [libc::c_uchar; 256usize] = unsafe {
    ::core::mem::MaybeUninit::<[libc::c_uchar; 256usize]>::zeroed().assume_init()
};
#[allow(non_upper_case_globals)]
#[no_mangle]
pub static mut ACE_Base64_member_: [libc::c_uchar; 256usize] = unsafe {
    ::core::mem::MaybeUninit::<[libc::c_uchar; 256usize]>::zeroed().assume_init()
};
#[allow(non_upper_case_globals)]
#[no_mangle]
pub static mut ACE_Base64_init_: bool = false;
#[doc = "* @class ACE_Base64\n *\n * @brief Encode/Decode a stream of bytes according to Base64 encoding.\n *\n * This class provides methods to encode or decode a stream of bytes\n * to/from Base64 encoding. It doesn't convert the input stream to a\n * canonical form before encoding."]
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ACE_Base64 {}
#[export_name = "_ZN10ACE_Base646encodeEPKhmPmb"]
pub unsafe extern "C-unwind" fn __xtu__ZN10ACE_Base646encodeEPKhmPmb(
    input: *const libc::c_uchar,
    input_len: libc::c_ulong,
    output_len: *mut libc::c_ulong,
    is_chunked: bool,
) -> *mut libc::c_uchar {
    unsafe { ACE_Base64::encode(input, input_len, output_len, is_chunked) }
}
#[export_name = "_ZN10ACE_Base646decodeEPKhPm"]
pub unsafe extern "C-unwind" fn __xtu__ZN10ACE_Base646decodeEPKhPm(
    input: *const libc::c_uchar,
    output_len: *mut libc::c_ulong,
) -> *mut libc::c_uchar {
    unsafe { ACE_Base64::decode(input, output_len) }
}
#[export_name = "_ZN10ACE_Base646lengthEPKh"]
pub unsafe extern "C-unwind" fn __xtu__ZN10ACE_Base646lengthEPKh(
    input: *const libc::c_uchar,
) -> libc::c_ulong {
    unsafe { ACE_Base64::length(input) }
}
pub unsafe extern "C-unwind" fn __xtu__ZN10ACE_Base64C1Ev(__this: *mut ACE_Base64) {
    ACE_Base64::new_at(__this)
}
#[export_name = "_ZN10ACE_Base644initEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN10ACE_Base644initEv() {
    unsafe { ACE_Base64::init() }
}
...
pub mod __anon_ns_9439 {
    pub(crate) static alphabet: [libc::c_uchar; 65usize] = unsafe {
        ::core::mem::transmute::<
            _,
            [libc::c_uchar; 65usize],
        >(*b"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\0")
    };
    pub(crate) static pad: libc::c_uchar = ((61 as libc::c_char) as libc::c_uchar);
    pub(crate) static max_columns: libc::c_int = ((72) as libc::c_int);
}
extern "C-unwind" {
...
impl ACE_Base64 {
        ...
        unsafe {
            {
                    ...
                    'cont_0: loop {
                        {
                            {
                                result = {
                                    let __count: usize = (length) as usize;
                                    let __nbytes = __count
                                        .checked_mul(::core::mem::size_of::<libc::c_uchar>())
                                    ...
                                    if __data.is_null() {
                                        ::std::alloc::handle_alloc_error(
                                            ::core::alloc::Layout::array::<libc::c_uchar>(__count)
                                                .unwrap(),
                                        );
                                    }
                                ...
                                if (((((result).is_null()) as libc::c_int) as libc::c_int)
                                    != 0)
                                {
                                    ((*(__errno_location()))) = 12;
                                    return ((0) as *mut libc::c_uchar);
                ...
                let mut pos: libc::c_ulong = ((0) as libc::c_ulong);
                let mut cols: libc::c_int = 0;
                {
                    let mut i: libc::c_ulong = ((0) as libc::c_ulong);
                    'for_1: loop {
                        if !((((((i as libc::c_ulong))
                            < (((input_len) as libc::c_ulong))) as libc::c_int
                            as libc::c_int) != 0))
                        {
                            break;
                        }
                        'cont_1: loop {
                            {
                                {
                                    {
                                        bits = (((bits) as libc::c_int))
                                            .wrapping_add(
                                                ((*(input).wrapping_offset((i) as isize))) as libc::c_int,
                                            );
                                        bits
                                    };
                                    {
                                        let __lv = &mut (char_count);
                                        *__lv = (*__lv).wrapping_add(1);
                                        *__lv
                                    };
                                    if (((((char_count as libc::c_int))
                                        ...
                                        != 0)
                                    {
                                        (*(result)
                                            ...
                                            )) = (((__anon_ns_9439::alphabet)[((((bits) as libc::c_int))
                                            .wrapping_shr((18) as u32)) as usize]) as libc::c_uchar);
                                        (*(result)
                                            .wrapping_offset(
                                                ({
                                                    let __lv = &mut (pos);
                                            ...
                                            )) = (((__anon_ns_9439::alphabet)[((((((((bits)
                                            as libc::c_int))
                                            .wrapping_shr((12) as u32))) as libc::c_int))
                                        ...
                                        (*(result)
                                            ...
                                            as libc::c_int))
                                            .wrapping_shr((6) as u32))) as libc::c_int))
                                            & ((0x3f) as libc::c_int)) as usize]) as libc::c_uchar);
                                        (*(result)
                                            .wrapping_offset(
                                                ({
                                            ...
                                            & ((0x3f) as libc::c_int)) as usize]) as libc::c_uchar);
                                        {
                                            cols = (((cols) as libc::c_int))
                                                .wrapping_add((4) as libc::c_int);
                                            cols
                                        };
                                        if (((((cols as libc::c_int))
                                            == (((__anon_ns_9439::max_columns) as libc::c_int)))
                                            as libc::c_int as libc::c_int) != 0)
                                        {
                                            if ((is_chunked as libc::c_int) != 0) {
                                                (*(result)
                                                    .wrapping_offset(
                                                        ({
                                                            let __lv = &mut (pos);
                                                    ...
                                                    )) = ((10 as libc::c_char) as libc::c_uchar);
                                            }
                                            cols = 0;
                                        }
                                        bits = 0;
                                        ...
                                        {
                                            bits = (((bits) as libc::c_int)).wrapping_shl((8) as u32);
                                            bits
                                        };
                                    }
                                }
                ...
                if (((((char_count as libc::c_int)) != (((0) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    {
                        bits = (((bits) as libc::c_int))
                            .wrapping_shl(
                                (((((16) as libc::c_int))
                                    .wrapping_sub(
                                        (((((8) as libc::c_int))
                                            .wrapping_mul((char_count) as libc::c_int))) as libc::c_int,
                                    ))) as u32,
                            );
                        bits
                    };
                    ...
                    if (((((char_count as libc::c_int)) == (((1) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        (*(result)
                            .wrapping_offset(
                            ...
                            )) = ((__anon_ns_9439::pad) as libc::c_uchar);
                        (*(result)
                            .wrapping_offset(
                                ({
                                    let __lv = &mut (pos);
                ...
                if (((((((((cols as libc::c_int)) > (((0) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                    && ((is_chunked as libc::c_int) != 0)) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    (*(result)
                        .wrapping_offset(
                ...
                (*(result).wrapping_offset((pos) as isize)) = ((0) as libc::c_uchar);
                (*(output_len)) = pos;
                return result;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        ...
        unsafe {
            {
                ...
                let mut result_len: libc::c_ulong = <ACE_Base64>::length(input);
                let mut result: *mut libc::c_uchar = ((0) as *mut libc::c_uchar);
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            {
                                result = {
                                    let __count: usize = (result_len) as usize;
                                    let __nbytes = __count
                                        .checked_mul(::core::mem::size_of::<libc::c_uchar>())
                                        .expect("array new[] size overflow");
                                    let __data = ::libc::malloc(
                ...
                let mut ptr: *mut libc::c_uchar = (input as *mut libc::c_uchar);
                'while_1: loop {
                    if !(((((((((((*(ptr)) as libc::c_int)) != (((0) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
                        && (((((((((((((((ACE_Base64_member_)[((*((ptr)))) as usize]
                            as libc::c_int)) == (((1) as libc::c_int))) as libc::c_int
                            as libc::c_int) != 0)
                            || ((((((*(ptr)) as libc::c_int as libc::c_uchar))
                                == (((__anon_ns_9439::pad) as libc::c_int
                                    as libc::c_uchar))) as libc::c_int as libc::c_int) != 0))
                            as libc::c_int) as libc::c_int) != 0)
                            || ((ACE_OS::ace_isspace((((*(ptr))) as libc::c_char)))
                ...
                let mut input_len: libc::c_ulong = ((((ptr).offset_from(input))
                ...
                let mut i: libc::c_ulong = ((0) as libc::c_ulong);
                {
                    'for_2: loop {
                        ...
                        'cont_2: loop {
                            {
                                {
                                    if ((((((*(input).wrapping_offset((i) as isize))
                                    ...
                                    if (((!((((ACE_Base64_member_)[((*(input)
                                        .wrapping_offset((i) as isize))) as usize]) != 0))
                                        as libc::c_int) as libc::c_int) != 0)
                                    {
                                        break 'cont_2;
                                    }
                                    {
                                        bits = (((bits) as libc::c_int))
                                            .wrapping_add(
                                                ((ACE_Base64_decoder_)[((*(input)
                                                    .wrapping_offset((i) as isize))) as usize]) as libc::c_int,
                                            );
                                        bits
                                    };
                                    {
                                        ...
                                        != 0)
                                    {
                                        (*(result)
                                            ...
                                            )) = ((((bits) as libc::c_int)).wrapping_shr((16) as u32)
                                            as libc::c_uchar);
                                        (*(result)
                                            .wrapping_offset(
                                                ({
                                        ...
                                        (*(result)
                                            ...
                                            )) = (((((bits) as libc::c_int)) & ((0xff) as libc::c_int))
                                            as libc::c_uchar);
                                        bits = 0;
                                        char_count = 0;
                                    } else {
                                        {
                                            bits = (((bits) as libc::c_int)).wrapping_shl((6) as u32);
                                            bits
                                        };
                                    }
                                }
                ...
                if (((((i as libc::c_ulong)) == (((input_len) as libc::c_ulong)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    if ((char_count) != 0) {
                        'dowhile_3: loop {
                                ...
                                {
                                    {
                                        ...
                                        <ACE_Log_Category_TSS>::conditional_set(
                                            ...
                                            ((b"/build/ace_full/src/ACE/ace/Codecs.cpp\0".as_ptr()
                                        ...
                                        <ACE_Log_Category_TSS>::log(
                                            (ace___) as *mut ACE_Log_Category_TSS,
                                            LM_ERROR,
                                            ((b"Decoding incomplete: atleast %d bits truncated\n\0"
                                                .as_ptr() as *const libc::c_char) as *const libc::c_char),
                                            (((((((4) as libc::c_int))
                                                .wrapping_sub((char_count) as libc::c_int)))
                                                as libc::c_int))
                                                .wrapping_mul((6) as libc::c_int),
                                        );
                                    }
                                }
                    ...
                    'switch_0: {
                        ...
                        if __m == 3 {
                            let __cv_1: libc::c_int = (2 as libc::c_int);
                            if __c == __cv_1 {
                                __m = 1;
                            }
                        }
                        if __m == 3 {
                            let __cv_2: libc::c_int = (3 as libc::c_int);
                            if __c == __cv_2 {
                                __m = 2;
                            }
                        }
                                    ...
                                    {
                                        {
                                            ...
                                            <ACE_Log_Category_TSS>::log(
                                                (ace___) as *mut ACE_Log_Category_TSS,
                                                LM_ERROR,
                                                ((b"Decoding incomplete: atleast 2 bits missing\n\0"
                                                    .as_ptr() as *const libc::c_char) as *const libc::c_char),
                                            );
                                        }
                                    }
                        ...
                        if __m <= 1 {
                            (*(result)
                                ...
                                )) = ((((bits) as libc::c_int)).wrapping_shr((10) as u32)
                                as libc::c_uchar);
                            break 'switch_0;
                        }
                        if __m <= 2 {
                ...
                if ((errors) != 0) {
                    {
                        let __data = result as *mut libc::c_uchar;
                        if !__data.is_null() {
    ...
    #[doc = "* Return the length of the encoded input data\n   *\n   * @param input Encoded Base64 data in byte stream.\n   * @return Length of the encoded Base64 data.\n   *"]
    pub unsafe fn length(mut input: *const libc::c_uchar) -> libc::c_ulong {
        unsafe {
            {
                if (((!(((ACE_Base64_init_ as libc::c_int) != 0)) as libc::c_int)
                    as libc::c_int) != 0)
                ...
                let mut len: libc::c_ulong = ((((ptr).offset_from(input))
                    as libc::c_long) as libc::c_ulong);
                len = ((((((((((((((len) as libc::c_ulong))
                    .wrapping_add((3) as libc::c_ulong))) as libc::c_ulong))
                    / ((4) as libc::c_ulong))) as libc::c_ulong))
                    .wrapping_mul((3) as libc::c_ulong)) as libc::c_ulong))
                    .wrapping_add((1) as libc::c_ulong);
                return len;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
    ...
    pub unsafe fn new_at_u0c5a7bc552632cf8(
        __this: *mut Self,
        mut __a0: *const ACE_Base64,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN10ACE_Base64C1ERKS_"]
            fn __ext(__this: *mut ACE_Base64, __a0: *const ACE_Base64);
        }
        __ext(__this as *mut ACE_Base64, __a0)
    }
    pub unsafe fn new_u0c5a7bc552632cf8(mut __a0: *const ACE_Base64) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_u0c5a7bc552632cf8(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    pub unsafe fn operator_assign(
        __this: *mut Self,
        mut _anon_0: *const ACE_Base64,
    ) -> *mut ACE_Base64 {
        extern "C-unwind" {
            #[link_name = "_ZN10ACE_Base64aSERKS_"]
            fn __ext(
                __this: *mut ACE_Base64,
                _anon_0: *const ACE_Base64,
            ) -> *mut ACE_Base64;
        }
        __ext(__this as *mut ACE_Base64, _anon_0)
    }
        ...
        unsafe {
            {
                ...
                {
                    {
                        let mut i: libc::c_uchar = ((0) as libc::c_uchar);
                        'for_0: loop {
                            if !((((((i as libc::c_ulong))
                                < (((::core::mem::size_of::<[libc::c_uchar; 65usize]>()
                                    as libc::c_ulong) as libc::c_ulong))) as libc::c_int
                                as libc::c_int) != 0))
                            {
                                break;
                            }
                            'cont_0: loop {
                                {
                                    {
                                        (ACE_Base64_decoder_)[((__anon_ns_9439::alphabet)[(i)
                                            as usize]) as usize] = i;
                                        (ACE_Base64_member_)[((__anon_ns_9439::alphabet)[(i)
                                            as usize]) as usize] = ((1) as libc::c_uchar);
                                    }
                                }
                                #[allow(unreachable_code)] break 'cont_0;
                            }
