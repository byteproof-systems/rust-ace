...
#[no_mangle]
pub static mut ACE_Trace_nesting_indent_: libc::c_int = (((3 as libc::c_int))
    as libc::c_int);
#[allow(non_upper_case_globals)]
#[no_mangle]
pub static mut ACE_Trace_enable_tracing_: bool = (((1 as libc::c_int)) != 0);
...
#[export_name = "_ZN9ACE_TraceC1EPKciS1_"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_TraceC1EPKciS1_(
    __this: *mut ACE_Trace,
    __a0: *const libc::c_char,
    __a1: libc::c_int,
    __a2: *const libc::c_char,
) {
    ACE_Trace::new_at(__this, __a0, __a1, __a2)
}
impl Drop for ACE_Trace {
    fn drop(&mut self) {
        unsafe {
            ...
            {
                if ((((((ACE_Trace_enable_tracing_ as libc::c_int) != 0)
                    && (((!(((<ACE_OS_Object_Manager>::starting_up()) != 0))
                        as libc::c_int) as libc::c_int) != 0)) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    let mut lm: *mut ACE_Log_Msg = <ACE_Log_Msg>::instance();
                    if ((((((<ACE_Log_Msg>::tracing_enabled((lm) as *const ACE_Log_Msg)
                        as libc::c_int) != 0)
                        && (((((<ACE_Log_Msg>::trace_active((lm) as *const ACE_Log_Msg)
                            as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                            as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
                    {
                        <ACE_Log_Msg>::trace_active_u3597e8daa2350886(
                            (lm) as *mut ACE_Log_Msg,
                            ((1) != 0),
                        );
                        'dowhile_0: loop {
                            'cont_0: loop {
                                {
                                    {
                                        ...
                                        <ACE_Log_Category_TSS>::conditional_set(
                                            ...
                                            ((b"/build/ace_full/src/ACE/ace/Trace.cpp\0".as_ptr()
                                        ...
                                        <ACE_Log_Category_TSS>::log(
                                            ...
                                            (((ACE_Trace_nesting_indent_) as libc::c_int))
                                                .wrapping_mul(
                                                    (<ACE_Log_Msg>::dec((lm) as *mut ACE_Log_Msg))
                                                        as libc::c_int,
                                                ),
...
#[export_name = "__acedtor_u5438f1796abb9d58"]
pub unsafe extern "C-unwind" fn __acedtor_u5438f1796abb9d58(__this: *mut ACE_Trace) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
    }
}
#[export_name = "_ZN9ACE_Trace10is_tracingEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Trace10is_tracingEv() -> bool {
    unsafe { ACE_Trace::is_tracing() }
}
#[export_name = "_ZN9ACE_Trace13start_tracingEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Trace13start_tracingEv() {
    unsafe { ACE_Trace::start_tracing() }
}
#[export_name = "_ZN9ACE_Trace12stop_tracingEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Trace12stop_tracingEv() {
    unsafe { ACE_Trace::stop_tracing() }
}
#[export_name = "_ZN9ACE_Trace18set_nesting_indentEi"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Trace18set_nesting_indentEi(
    indent: libc::c_int,
) {
    unsafe { ACE_Trace::set_nesting_indent(indent) }
}
#[export_name = "_ZN9ACE_Trace18get_nesting_indentEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Trace18get_nesting_indentEv() -> libc::c_int {
    unsafe { ACE_Trace::get_nesting_indent() }
}
#[export_name = "_ZNK9ACE_Trace4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK9ACE_Trace4dumpEv(__this: *const ACE_Trace) {
    unsafe { ACE_Trace::dump(__this) }
}
extern "C-unwind" {
...
impl ACE_Trace {
  ...
  /// N, the LINE, and the ACE_FILE as the function is entered.*/
                                ...
                                {
                                    {
                                        ...
                                        <ACE_Log_Category_TSS>::log(
                                            (ace___) as *mut ACE_Log_Category_TSS,
                                            LM_TRACE,
                                            ((b"%*s(%t) calling %s in file `%s' on line %d\n\0".as_ptr()
                                                as *const libc::c_char) as *const libc::c_char),
                                            (((ACE_Trace_nesting_indent_) as libc::c_int))
                                                .wrapping_mul(
                                                    (<ACE_Log_Msg>::inc((lm) as *mut ACE_Log_Msg))
                                                        as libc::c_int,
                                                ),
                                            b"\0".as_ptr() as *const libc::c_char,
                                            (*__this).name_,
    ...
    pub unsafe fn is_tracing() -> bool {
        unsafe {
            {
                return crate::__cxx_std::__Truthy::__truthy(ACE_Trace_enable_tracing_);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    ...
    pub unsafe fn start_tracing() {
        unsafe {
            {
                ACE_Trace_enable_tracing_ = true;
            }
            ()
        }
    }
    ...
    pub unsafe fn stop_tracing() {
        unsafe {
            {
                ACE_Trace_enable_tracing_ = false;
            }
            ()
        }
    }
    ...
    pub unsafe fn set_nesting_indent(mut indent: libc::c_int) {
        unsafe {
            {
                ACE_Trace_nesting_indent_ = indent;
            }
            ()
        }
    }
    ...
    pub unsafe fn get_nesting_indent() -> libc::c_int {
        unsafe {
            {
                return ACE_Trace_nesting_indent_;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
