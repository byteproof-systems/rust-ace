...
pub type ACE_SOCK_Dgram_PEER_ADDR = ACE_INET_Addr;
#[doc = "* @class ACE_SOCK_Dgram\n *\n * @brief Defines the member functions for the ACE_SOCK datagram\n * abstraction."]
#[repr(C)]
#[derive(Clone)]
pub struct ACE_SOCK_Dgram {
    pub __base_0: ::core::mem::ManuallyDrop<ACE_SOCK>,
}
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_SOCK_DgramC1Ev(
    __this: *mut ACE_SOCK_Dgram,
) {
    ACE_SOCK_Dgram::new_at(__this)
}
impl Drop for ACE_SOCK_Dgram {
    fn drop(&mut self) {
        {
            unsafe {
                let __this: *mut Self = self as *mut Self;
...
pub unsafe extern "C-unwind" fn __acedtor_udc03fe5d0cca7533(
    __this: *mut ACE_SOCK_Dgram,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
    ...
    fn drop(&mut self) {
        {
            unsafe {
                ...
                {
                    {
                        let __data = (*__this).send_net_if_ as *mut libc::c_char;
                        if !__data.is_null() {
                            ::libc::free(__data as *mut libc::c_void);
                        }
                    };
                    <ACE_SOCK_Dgram_Mcast>::clear_subs_list(
                        (__this) as *mut ACE_SOCK_Dgram_Mcast,
                    );
                }
                ()
            }
        ...
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.send_addr_);
            ::core::mem::ManuallyDrop::drop(&mut self.__base_0);
        }
    }
}
#[export_name = "__acedtor_u87f9c97db08becc4"]
pub unsafe extern "C-unwind" fn __acedtor_u87f9c97db08becc4(
    __this: *mut ACE_SOCK_Dgram_Mcast,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[export_name = "_ZN20ACE_SOCK_Dgram_Mcast4openERK13ACE_INET_AddrPKci"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_SOCK_Dgram_Mcast4openERK13ACE_INET_AddrPKci(
    __this: *mut ACE_SOCK_Dgram_Mcast,
    mcast_addr: *const ACE_INET_Addr,
    net_if: *const libc::c_char,
    reuse_addr: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_SOCK_Dgram_Mcast::open(__this, mcast_addr, net_if, reuse_addr) }
}
#[export_name = "_ZN20ACE_SOCK_Dgram_Mcast4joinERK13ACE_INET_AddriPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_SOCK_Dgram_Mcast4joinERK13ACE_INET_AddriPKc(
    __this: *mut ACE_SOCK_Dgram_Mcast,
    mcast_addr: *const ACE_INET_Addr,
    reuse_addr: libc::c_int,
    net_if: *const libc::c_char,
) -> libc::c_int {
    unsafe { ACE_SOCK_Dgram_Mcast::join(__this, mcast_addr, reuse_addr, net_if) }
}
#[export_name = "_ZN20ACE_SOCK_Dgram_Mcast5leaveERK13ACE_INET_AddrPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_SOCK_Dgram_Mcast5leaveERK13ACE_INET_AddrPKc(
    __this: *mut ACE_SOCK_Dgram_Mcast,
    mcast_addr: *const ACE_INET_Addr,
    net_if: *const libc::c_char,
) -> libc::c_int {
    unsafe { ACE_SOCK_Dgram_Mcast::leave(__this, mcast_addr, net_if) }
}
#[export_name = "_ZNK20ACE_SOCK_Dgram_Mcast4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK20ACE_SOCK_Dgram_Mcast4dumpEv(
    __this: *const ACE_SOCK_Dgram_Mcast,
) {
    unsafe { ACE_SOCK_Dgram_Mcast::dump(__this) }
}
#[export_name = "_ZN20ACE_SOCK_Dgram_Mcast13subscribe_ifsERK13ACE_INET_AddrPKci"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_SOCK_Dgram_Mcast13subscribe_ifsERK13ACE_INET_AddrPKci(
    __this: *mut ACE_SOCK_Dgram_Mcast,
    mcast_addr: *const ACE_INET_Addr,
    net_if: *const libc::c_char,
    reuse_addr: libc::c_int,
    ...
    unsafe {
        ACE_SOCK_Dgram_Mcast::subscribe_ifs(__this, mcast_addr, net_if, reuse_addr)
    }
}
#[export_name = "_ZN20ACE_SOCK_Dgram_Mcast11subscribe_iERK13ACE_INET_AddriPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_SOCK_Dgram_Mcast11subscribe_iERK13ACE_INET_AddriPKc(
    __this: *mut ACE_SOCK_Dgram_Mcast,
    mcast_addr: *const ACE_INET_Addr,
    reuse_addr: libc::c_int,
    net_if: *const libc::c_char,
) -> libc::c_int {
    unsafe { ACE_SOCK_Dgram_Mcast::subscribe_i(__this, mcast_addr, reuse_addr, net_if) }
}
#[export_name = "_ZN20ACE_SOCK_Dgram_Mcast15unsubscribe_ifsERK13ACE_INET_AddrPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_SOCK_Dgram_Mcast15unsubscribe_ifsERK13ACE_INET_AddrPKc(
    __this: *mut ACE_SOCK_Dgram_Mcast,
    mcast_addr: *const ACE_INET_Addr,
    net_if: *const libc::c_char,
) -> libc::c_int {
    unsafe { ACE_SOCK_Dgram_Mcast::unsubscribe_ifs(__this, mcast_addr, net_if) }
}
#[export_name = "_ZN20ACE_SOCK_Dgram_Mcast13unsubscribe_iERK13ACE_INET_AddrPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_SOCK_Dgram_Mcast13unsubscribe_iERK13ACE_INET_AddrPKc(
    __this: *mut ACE_SOCK_Dgram_Mcast,
    mcast_addr: *const ACE_INET_Addr,
    net_if: *const libc::c_char,
) -> libc::c_int {
    unsafe { ACE_SOCK_Dgram_Mcast::unsubscribe_i(__this, mcast_addr, net_if) }
}
#[export_name = "_ZN20ACE_SOCK_Dgram_Mcast6open_iERK13ACE_INET_AddrPKci"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_SOCK_Dgram_Mcast6open_iERK13ACE_INET_AddrPKci(
    __this: *mut ACE_SOCK_Dgram_Mcast,
    mcast_addr: *const ACE_INET_Addr,
    net_if: *const libc::c_char,
    reuse_addr: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_SOCK_Dgram_Mcast::open_i(__this, mcast_addr, net_if, reuse_addr) }
}
#[export_name = "_ZN20ACE_SOCK_Dgram_Mcast15clear_subs_listEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_SOCK_Dgram_Mcast15clear_subs_listEv(
    __this: *mut ACE_SOCK_Dgram_Mcast,
) -> libc::c_int {
    unsafe { ACE_SOCK_Dgram_Mcast::clear_subs_list(__this) }
}
extern "C-unwind" {
...
impl ACE_SOCK_Dgram {
  ...
  /// dgram that will accept datagrams at the <local> address.*/
    pub unsafe fn new_at_ua68fcd6094aa1f6f(
        __this: *mut Self,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN14ACE_SOCK_DgramC1ERK8ACE_Addriiii"]
            fn __ext(
                __this: *mut ACE_SOCK_Dgram,
                __a0: *const ACE_Addr,
                __a1: libc::c_int,
        ...
        __ext(__this as *mut ACE_SOCK_Dgram, __a0, __a1, __a2, __a3, __a4)
    }
    pub unsafe fn new_ua68fcd6094aa1f6f(
        mut __a0: *const ACE_Addr,
        mut __a1: libc::c_int,
        mut __a2: libc::c_int,
        mut __a3: libc::c_int,
    ...
    #[doc = "* This is a QoS-enabed method for initiating a socket dgram that\n   * will accept datagrams at the <local> address.  The @a qos_params\n   * are passed to <ACE_OS::join_leaf>."]
    pub unsafe fn new_at_u3a8bb2f705837dee(
        __this: *mut Self,
        mut __a0: *const ACE_Addr,
        mut __a1: libc::c_int,
        mut __a2: libc::c_int,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN14ACE_SOCK_DgramC1ERK8ACE_AddriiP17ACE_Protocol_Infommii"]
            fn __ext(
                __this: *mut ACE_SOCK_Dgram,
                __a0: *const ACE_Addr,
                __a1: libc::c_int,
    ...
    pub unsafe fn new_u3a8bb2f705837dee(
        mut __a0: *const ACE_Addr,
        mut __a1: libc::c_int,
        mut __a2: libc::c_int,
        mut __a3: *mut ACE_Protocol_Info,
  ...
  /// dgram that will accept datagrams at the <local> address.*/
    pub unsafe fn open(
        __this: *mut Self,
        mut local: *const ACE_Addr,
        mut protocol_family: libc::c_int,
        mut protocol: libc::c_int,
        mut reuse_addr: libc::c_int,
        mut ipv6_only: libc::c_int,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN14ACE_SOCK_Dgram4openERK8ACE_Addriiii"]
            fn __ext(
                __this: *mut ACE_SOCK_Dgram,
                local: *const ACE_Addr,
                protocol_family: libc::c_int,
                protocol: libc::c_int,
                reuse_addr: libc::c_int,
                ipv6_only: libc::c_int,
            ) -> libc::c_int;
        }
        __ext(
            __this as *mut ACE_SOCK_Dgram,
    ...
    #[doc = "* This is a QoS-enabed method for initiating a socket dgram that\n   * will accept datagrams at the <local> address.  The @a qos_params\n   * are passed to <ACE_OS::join_leaf>."]
    pub unsafe fn open_u4e1b8673750a23f6(
        __this: *mut Self,
        mut local: *const ACE_Addr,
        mut protocol_family: libc::c_int,
        mut protocol: libc::c_int,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN14ACE_SOCK_Dgram4openERK8ACE_AddriiP17ACE_Protocol_Infommii"]
            fn __ext(
                __this: *mut ACE_SOCK_Dgram,
                local: *const ACE_Addr,
                protocol_family: libc::c_int,
    ...
    pub unsafe fn send(
        ...
        mut n: libc::c_ulong,
        mut addr: *const ACE_Addr,
        mut flags: libc::c_int,
    ) -> libc::c_long {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut saddr: *mut sockaddr = ({
                    let __obj: *mut ACE_Addr = (::core::ptr::addr_of!((* addr)))
                        as *mut ACE_Addr;
                ...
                let mut len: libc::c_int = <ACE_Addr>::get_size(
                    (::core::ptr::addr_of!((* addr))) as *const ACE_Addr,
                );
                return ACE_OS::sendto_uf1a8458778d74112(
                    <ACE_IPC_SAP>::get_handle(
                        (::core::ptr::addr_of!(
                    ...
                    n,
                    flags,
                    ((saddr as *mut sockaddr)) as *const sockaddr,
                    len,
                );
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
  ...
  /// <recvfrom(3)>).*/
    pub unsafe fn recv(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                let mut addr_len: libc::c_int = <ACE_Addr>::get_size(
                    (::core::ptr::addr_of!((* addr))) as *const ACE_Addr,
                );
                let mut status: libc::c_long = ((ACE_OS::recvfrom_u289b3b4f999bdcf7(
                    <ACE_IPC_SAP>::get_handle(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((* __this)
                            .__base_0) .cast:: < ACE_SOCK > ().cast_mut()).__base_0)
                    ...
                    n,
                    flags,
                    (((saddr as *mut sockaddr)) as *mut sockaddr),
                    ::core::ptr::addr_of_mut!(addr_len) as *mut libc::c_int,
                )) as libc::c_long);
                <ACE_Addr>::set_size(
                    (::core::ptr::addr_of_mut!((* addr))) as *mut ACE_Addr,
                    addr_len,
                );
                <ACE_Addr>::set_type(
                    (::core::ptr::addr_of_mut!((* addr))) as *mut ACE_Addr,
                    (((*saddr).sa_family) as libc::c_int),
                );
    ...
    pub unsafe fn recv_ua4fd28e8cd0eecc1(
        __this: *const Self,
        ...
        extern "C-unwind" {
            #[link_name = "_ZNK14ACE_SOCK_Dgram4recvEP5iovecR8ACE_AddriPK14ACE_Time_Value"]
            fn __ext(
                __this: *const ACE_SOCK_Dgram,
                io_vec: *mut iovec,
                addr: *mut ACE_Addr,
                flags: libc::c_int,
        ...
        __ext(__this as *const ACE_SOCK_Dgram, io_vec, addr, flags, timeout)
    }
    /**Send an <iovec> of size @a n to the datagram socket (uses
  /// <sendmsg(3)>).*/
    pub unsafe fn send_u70f4838a8668f181(
        __this: *const Self,
        mut iov: *const iovec,
        mut n: libc::c_int,
        mut addr: *const ACE_Addr,
        ...
        extern "C-unwind" {
            #[link_name = "_ZNK14ACE_SOCK_Dgram4sendEPK5ioveciRK8ACE_Addri"]
            fn __ext(
                __this: *const ACE_SOCK_Dgram,
                iov: *const iovec,
                n: libc::c_int,
        ...
        __ext(__this as *const ACE_SOCK_Dgram, iov, n, addr, flags)
    }
  ...
  /// value 1 for IPV6 addresses.*/
    pub unsafe fn recv_uebc810d51a40ee6b(
        __this: *const Self,
        mut iov: *mut iovec,
        mut n: libc::c_int,
        mut addr: *mut ACE_Addr,
        mut flags: libc::c_int,
        mut to_addr: *mut ACE_INET_Addr,
    ) -> libc::c_long {
        extern "C-unwind" {
            #[link_name = "_ZNK14ACE_SOCK_Dgram4recvEP5ioveciR8ACE_AddriP13ACE_INET_Addr"]
            fn __ext(
                __this: *const ACE_SOCK_Dgram,
                iov: *mut iovec,
                n: libc::c_int,
    ...
    pub unsafe fn recv_u1c32a162ffbd3597(
        ...
        extern "C-unwind" {
            #[link_name = "_ZNK14ACE_SOCK_Dgram4recvEPvmR8ACE_AddriPK14ACE_Time_Value"]
            fn __ext(
                __this: *const ACE_SOCK_Dgram,
                buf: *mut libc::c_void,
                n: libc::c_ulong,
        ...
        __ext(__this as *const ACE_SOCK_Dgram, buf, n, addr, flags, timeout)
    }
    #[doc = "* Wait up to @a timeout amount of time to send a datagram to\n   * @a buf.  The ACE_Time_Value indicates how long to blocking\n   * trying to receive.  If @a timeout == 0, the caller will block\n   * until action is possible, else will wait until the relative time\n   * specified in *@a timeout elapses).  If <send> times out a -1 is\n   * returned with @c errno == ETIME.  If it succeeds the number of\n   * bytes sent is returned."]
    pub unsafe fn send_u809e84ba2610118d(
        __this: *const Self,
        mut buf: *const libc::c_void,
        mut n: libc::c_ulong,
        mut addr: *const ACE_Addr,
        ...
        extern "C-unwind" {
            #[link_name = "_ZNK14ACE_SOCK_Dgram4sendEPKvmRK8ACE_AddriPK14ACE_Time_Value"]
            fn __ext(
                __this: *const ACE_SOCK_Dgram,
                buf: *const libc::c_void,
                n: libc::c_ulong,
  ...
  /// I/O (uses <WSASendTo>).  Returns 0 on success.*/
    pub unsafe fn send_u8770f2370cb83d65(
        __this: *const Self,
        mut buffers: *const iovec,
        mut buffer_count: libc::c_int,
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                return ACE_OS::sendto_ub6e6c93c067ba01d(
                    <ACE_IPC_SAP>::get_handle(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((* __this)
                            .__base_0) .cast:: < ACE_SOCK > ().cast_mut()).__base_0)
                    ...
                    ((buffers) as *const iovec),
                    buffer_count,
                    ::core::ptr::addr_of_mut!((* number_of_bytes_sent)),
                    flags,
                    (((saddr as *const sockaddr)) as *const sockaddr),
                    len,
                    overlapped,
                    func,
                );
  ...
  /// overlapped I/O (uses <WSARecvFrom>).  Returns 0 on success.*/
    pub unsafe fn recv_ua4c3d54e82100938(
        __this: *const Self,
        mut buffers: *mut iovec,
        mut buffer_count: libc::c_int,
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                let mut status: libc::c_long = ACE_OS::recvfrom_ued0283f1caeddad0(
                    <ACE_IPC_SAP>::get_handle(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((* __this)
                            .__base_0) .cast:: < ACE_SOCK > ().cast_mut()).__base_0)
                    ...
                    ((buffers) as *mut iovec),
                    buffer_count,
                    ::core::ptr::addr_of_mut!((* number_of_bytes_recvd)),
    ...
    pub unsafe fn send_u934127dcc406780e(
        __this: *const Self,
        mut buf: *const libc::c_void,
        mut n: libc::c_ulong,
        mut addr: *const ACE_Addr,
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut buffer: [iovec; 1usize] = unsafe {
                    ::core::mem::MaybeUninit::<[iovec; 1usize]>::zeroed().assume_init()
                };
                (buffer)[(0) as usize].iov_len = (((n as libc::c_ulong))
                    as libc::c_ulong);
                (buffer)[(0) as usize].iov_base = ((((buf as *mut libc::c_void)
                    as *mut libc::c_char)) as *mut libc::c_void);
                let mut number_of_bytes_sent: libc::c_ulong = ((0) as libc::c_ulong);
                return <ACE_SOCK_Dgram>::send_u8770f2370cb83d65(
                    (__this) as *const ACE_SOCK_Dgram,
                    ((buffer).as_ptr() as *const iovec),
                    1,
                    ::core::ptr::addr_of_mut!(number_of_bytes_sent),
                    flags,
    ...
    /**Receive an @a n byte @a buf from the datagram socket (uses
  /// <WSARecvFrom>).*/
    pub unsafe fn recv_ufb8960bb5bd1ea3c(
        __this: *const Self,
        mut buf: *mut libc::c_void,
        mut n: libc::c_ulong,
        mut addr: *mut ACE_Addr,
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                (buffer)[(0) as usize].iov_len = (((n as libc::c_ulong))
                    as libc::c_ulong);
                (buffer)[(0) as usize].iov_base = (((buf as *mut libc::c_char))
                    as *mut libc::c_void);
                let mut number_of_bytes_recvd: libc::c_ulong = ((0) as libc::c_ulong);
                return <ACE_SOCK_Dgram>::recv_ua4c3d54e82100938(
                    (__this) as *const ACE_SOCK_Dgram,
                    ((buffer).as_mut_ptr() as *mut iovec),
                    1,
                    ::core::ptr::addr_of_mut!(number_of_bytes_recvd),
                    ::core::ptr::addr_of_mut!(flags),
    ...
    pub unsafe fn dump(__this: *const Self) {
        extern "C-unwind" {
            #[link_name = "_ZNK14ACE_SOCK_Dgram4dumpEv"]
            fn __ext(__this: *const ACE_SOCK_Dgram);
        }
        __ext(__this as *const ACE_SOCK_Dgram)
    }
    ///Set NIC to use as multicast interface.
    pub unsafe fn set_nic(
        __this: *mut Self,
        mut net_if: *const libc::c_char,
        mut addr_family: libc::c_int,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN14ACE_SOCK_Dgram7set_nicEPKci"]
            fn __ext(
                __this: *mut ACE_SOCK_Dgram,
                net_if: *const libc::c_char,
        ...
        __ext(__this as *mut ACE_SOCK_Dgram, net_if, addr_family)
    }
    ...
    pub unsafe fn shared_open(
        ...
        extern "C-unwind" {
            #[link_name = "_ZN14ACE_SOCK_Dgram11shared_openERK8ACE_Addrii"]
            fn __ext(
                __this: *mut ACE_SOCK_Dgram,
                local: *const ACE_Addr,
                protocol_family: libc::c_int,
        ...
        __ext(__this as *mut ACE_SOCK_Dgram, local, protocol_family, ipv6_only)
    }
  ...
  /// If mreq param is NULL, just verify the passed addr/interface specs.*/
    pub unsafe fn make_multicast_ifaddr(
        __this: *mut Self,
        mut mreq: *mut ip_mreq,
        mut mcast_addr: *const ACE_INET_Addr,
        mut net_if: *const libc::c_char,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN14ACE_SOCK_Dgram21make_multicast_ifaddrEP7ip_mreqRK13ACE_INET_AddrPKc"]
            fn __ext(
                __this: *mut ACE_SOCK_Dgram,
                mreq: *mut ip_mreq,
                mcast_addr: *const ACE_INET_Addr,
        ...
        __ext(__this as *mut ACE_SOCK_Dgram, mreq, mcast_addr, net_if)
    }
    ...
    pub unsafe fn get_remote_addr(
        ...
        extern "C-unwind" {
            #[link_name = "_ZNK14ACE_SOCK_Dgram15get_remote_addrER8ACE_Addr"]
            fn __ext(
                __this: *const ACE_SOCK_Dgram,
                _anon_0: *mut ACE_Addr,
            ) -> libc::c_int;
        }
        __ext(__this as *const ACE_SOCK_Dgram, _anon_0)
    }
}
impl ACE_SOCK_Dgram_Mcast {
    #[doc = "Create an unitialized instance and define per-instance optional\n  /// functionality.\n  /**\n   * You must invoke open() or join(), to create/bind a socket and define\n   * operational parameters, before performing any I/O with this instance."]
    pub unsafe fn new_at(__this: *mut Self, mut opts: libc::c_uint) {
        unsafe {
            ::core::ptr::write(
                __this,
                ::core::mem::MaybeUninit::<Self>::zeroed().assume_init(),
            );
            <ACE_SOCK_Dgram>::new_at(
                ::core::ptr::addr_of_mut!((* __this).__base_0).cast::<ACE_SOCK_Dgram>(),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).opts_),
                ((opts) as libc::c_int),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).send_net_if_),
                ((0) as *mut libc::c_char),
            );
            <ACE_INET_Addr>::new_at(
                ::core::ptr::addr_of_mut!((* __this).send_addr_).cast::<ACE_INET_Addr>(),
            );
            {}
            ()
        }
            ...
            let __this: *mut Self = __this as *mut Self;
            {
                if (((((<ACE_IPC_SAP>::get_handle(
                    (::core::ptr::addr_of!(
                        ...
                        ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                        ACE_SOCK_Dgram > ().cast_mut()).__base_0) .cast:: < ACE_SOCK > ()
                ...
                if (((((<ACE_SOCK>::open(
                    (::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((* __this)
                        .__base_0) .cast:: < ACE_SOCK_Dgram > ().cast_mut()).__base_0)
                    ...
                    <ACE_Addr>::get_type(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* (::core::ptr::addr_of!((*
                            mcast_addr)))).__base_0) .cast:: < ACE_Addr > ().cast_mut())
                        )) as *const ACE_Addr,
                    ),
                    0,
                    reuse_addr,
                ...
                return <ACE_SOCK_Dgram_Mcast>::open_i(
                    (__this) as *mut ACE_SOCK_Dgram_Mcast,
                    ::core::ptr::addr_of!((* mcast_addr)),
                    net_if,
                    reuse_addr,
                );
            }
    ...
    pub unsafe fn join(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut subscribe_addr: ACE_INET_Addr = ::core::mem::MaybeUninit::<
                    ACE_INET_Addr,
                >::zeroed()
                    .assume_init();
                <ACE_INET_Addr>::new_at_ufdc256446431ae0e(
                    (::core::ptr::addr_of_mut!(subscribe_addr)) as *mut ACE_INET_Addr,
                    ::core::ptr::addr_of!((* mcast_addr)),
                );
                let mut def_port_number: libc::c_ushort = <ACE_INET_Addr>::get_port_number(
                    (::core::ptr::addr_of!(
                        (* ::core::ptr::addr_of!((* __this).send_addr_) .cast:: <
                        ACE_INET_Addr > ().cast_mut())
                    )) as *const ACE_INET_Addr,
                );
                if (((((((((<ACE_INET_Addr>::get_port_number(
                    (::core::ptr::addr_of!(subscribe_addr)) as *const ACE_INET_Addr,
                ) as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                    && (((((def_port_number as libc::c_int)) != (((0) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    <ACE_INET_Addr>::set_port_number(
                        (::core::ptr::addr_of_mut!(subscribe_addr))
                            as *mut ACE_INET_Addr,
                        def_port_number,
                        1,
                    );
                }
                let mut sub_port_number: libc::c_ushort = <ACE_INET_Addr>::get_port_number(
                    (::core::ptr::addr_of!((* mcast_addr))) as *const ACE_INET_Addr,
                );
                if (((((((((((((sub_port_number as libc::c_int))
                    != (((0) as libc::c_int))) as libc::c_int as libc::c_int) != 0)
                    && (((((def_port_number as libc::c_int)) != (((0) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                    as libc::c_int) != 0)
                    && (((((sub_port_number as libc::c_int as libc::c_ushort))
                        != (((def_port_number) as libc::c_int as libc::c_ushort)))
                        as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    'dowhile_0: loop {
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/SOCK_Dgram_Mcast.cpp\0"
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        (ace___) as *mut ACE_Log_Category_TSS,
                                        LM_ERROR,
                                        ((b"Subscribed port# (%u) different than bound port# (%u).\n\0"
                                            .as_ptr() as *const libc::c_char) as *const libc::c_char),
                                        (sub_port_number as libc::c_uint),
                                        (def_port_number as libc::c_uint),
                                    );
                                }
                            }
                ...
                let mut tmp_addr: ACE_INET_Addr = ::core::mem::MaybeUninit::<
                    ACE_INET_Addr,
                >::zeroed()
                    .assume_init();
                <ACE_INET_Addr>::new_at_ufdc256446431ae0e(
                    (::core::ptr::addr_of_mut!(tmp_addr)) as *mut ACE_INET_Addr,
                    ::core::ptr::addr_of!(
                        (* ::core::ptr::addr_of!((* __this).send_addr_) .cast:: <
                        ACE_INET_Addr > ().cast_mut())
                    ),
                ...
                if ((((((((((((((((((((*__this).opts_)) as libc::c_int))
                    & (((OPT_BINDADDR_YES)) as libc::c_int)) as libc::c_int))
                    != (((0) as libc::c_int))) as libc::c_int) as libc::c_int) != 0)
                    && (((!(((<ACE_INET_Addr>::is_any(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* __this).send_addr_) .cast:: <
                            ACE_INET_Addr > ().cast_mut())
                        )) as *const ACE_INET_Addr,
                ...
                {
                    let mut sub_addr_string: [libc::c_char; 256usize] = unsafe {
                        ::core::mem::zeroed()
                    };
                    let mut bound_addr_string: [libc::c_char; 256usize] = unsafe {
                        ::core::mem::zeroed()
                    };
                    <ACE_SDM_helpers>::addr_to_string(
                        ::core::ptr::addr_of!((* mcast_addr)),
                        ((sub_addr_string).as_mut_ptr() as *mut libc::c_char),
                        ((::core::mem::size_of::<[libc::c_char; 256usize]>()
                            as libc::c_ulong) as libc::c_ulong),
                        1,
                    );
                    <ACE_SDM_helpers>::addr_to_string(
                        ...
                        ((bound_addr_string).as_mut_ptr() as *mut libc::c_char),
                        ((::core::mem::size_of::<[libc::c_char; 256usize]>()
                            as libc::c_ulong) as libc::c_ulong),
                        1,
                    );
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        (ace___) as *mut ACE_Log_Category_TSS,
                                        LM_ERROR,
                                        ((b"Subscribed address (%s) different than bound address (%s).\n\0"
                                            .as_ptr() as *const libc::c_char) as *const libc::c_char),
                                        ((sub_addr_string).as_mut_ptr() as *mut libc::c_char),
                                        ((bound_addr_string).as_mut_ptr() as *mut libc::c_char),
                                    );
                ...
                let mut result: libc::c_int = <ACE_SOCK_Dgram_Mcast>::subscribe_i(
                    (__this) as *mut ACE_SOCK_Dgram_Mcast,
                    ::core::ptr::addr_of!(subscribe_addr),
                    reuse_addr,
                    net_if,
                );
    ...
    pub unsafe fn leave(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut result: libc::c_int = <ACE_SOCK_Dgram_Mcast>::unsubscribe_i(
                    (__this) as *mut ACE_SOCK_Dgram_Mcast,
                    ::core::ptr::addr_of!((* mcast_addr)),
                    net_if,
                );
  ...
  /// defined by the first open() or subscribe().*/
    pub unsafe fn send(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return <ACE_SOCK_Dgram>::send(
                    (::core::ptr::addr_of!(
                        (* ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                        ACE_SOCK_Dgram > ().cast_mut())
                    )) as *const ACE_SOCK_Dgram,
                    buf,
                    n,
                    ::core::ptr::addr_of!(
                        (* ::core::ptr::addr_of!(((* ::core::ptr::addr_of!((* __this)
                        .send_addr_) .cast:: < ACE_INET_Addr > ().cast_mut())).__base_0)
                        .cast:: < ACE_Addr > ().cast_mut())
                    ) as *const ACE_Addr,
                    flags,
                );
            }
  ...
  /// defined by the first open() or subscribe().*/
    pub unsafe fn send_u5bcf66cf70789bdf(
        __this: *const Self,
        mut iov: *const iovec,
        mut n: libc::c_int,
        mut flags: libc::c_int,
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return <ACE_SOCK_Dgram>::send_u70f4838a8668f181(
                    (::core::ptr::addr_of!(
                        (* ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                        ACE_SOCK_Dgram > ().cast_mut())
                    )) as *const ACE_SOCK_Dgram,
    ...
    pub unsafe fn set_option(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                let mut level: libc::c_int = (((0 as libc::c_int)) as libc::c_int);
                if (((((<ACE_Addr>::get_type(
                    (::core::ptr::addr_of!(
                        (* ::core::ptr::addr_of!((* (::core::ptr::addr_of!((*
                        ::core::ptr::addr_of!((* __this).send_addr_) .cast:: <
                ...
                ) as libc::c_int)) == (((10) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    level = (((41 as libc::c_int)) as libc::c_int);
                }
                return <ACE_SOCK>::set_option(
                    (::core::ptr::addr_of!(
                        (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((* __this)
                        .__base_0) .cast:: < ACE_SOCK_Dgram > ().cast_mut()).__base_0)
                        .cast:: < ACE_SOCK > ().cast_mut())
                    ...
                    level,
                    option,
                    ((::core::ptr::addr_of_mut!(optval) as *mut libc::c_char)
                        as *mut libc::c_void),
  ...
  /// framework so these cannot be specified on construction.*/
    pub unsafe fn opts(__this: *mut Self, mut opts: libc::c_int) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                (*__this).opts_ = opts;
    ...
    pub unsafe fn opts_u24f6dbc368bf3834(__this: *const Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((*__this).opts_) as libc::c_int);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
  ...
  /// (No QoS support.)*/
    pub unsafe fn subscribe_ifs(
        ...
        unsafe {
            ...
            {
                if ((((((((((((((((*__this).opts_)) as libc::c_int))
                    & (((OPT_NULLIFACE_ALL)) as libc::c_int)) as libc::c_int))
                    != (((0) as libc::c_int))) as libc::c_int) as libc::c_int) != 0)
                    && (((((net_if).is_null()) as libc::c_int) as libc::c_int) != 0))
                    as libc::c_int) as libc::c_int) != 0)
                {
                    let mut family: libc::c_int = <ACE_Addr>::get_type(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* (::core::ptr::addr_of!((*
                            mcast_addr)))).__base_0) .cast:: < ACE_Addr > ().cast_mut())
                        )) as *const ACE_Addr,
                    );
                    let mut nr_subscribed: libc::c_ulong = ((0) as libc::c_ulong);
                    let mut ifap: *mut ifaddrs = ((0) as *mut ifaddrs);
                    let mut p_if: *mut ifaddrs = ((0) as *mut ifaddrs);
                    if (((((getifaddrs(
                        ::core::ptr::addr_of_mut!(ifap) as *mut *mut ifaddrs,
                    ) as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                        as libc::c_int) != 0)
                    {
                        return (-((1) as libc::c_int));
                    }
                    {
                        p_if = ifap;
                        'for_0: loop {
                            if !(((((!(p_if).is_null()) as libc::c_int) as libc::c_int)
                                != 0))
                            {
                                break;
                            }
                            'cont_0: loop {
                                {
                                    {
                                        if ((((((((((*p_if).ifa_addr).is_null()) as libc::c_int)
                                            as libc::c_int) != 0)
                                            || ((((((*(*p_if).ifa_addr).sa_family as libc::c_int))
                                                != (((family) as libc::c_int))) as libc::c_int
                                                as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
                                        {
                                            break 'cont_0;
                                        }
                                        let mut wanted: libc::c_uint = ((((((1 as libc::c_int))
                                            as libc::c_int)) | (((4096 as libc::c_int)) as libc::c_int))
                                            as libc::c_uint);
                                        if ((((((((((*p_if).ifa_flags) as libc::c_uint))
                                            & ((wanted) as libc::c_uint)) as libc::c_uint))
                                            != (((wanted) as libc::c_uint))) as libc::c_int
                                            as libc::c_int) != 0)
                                        {
                                            break 'cont_0;
                                        }
                                        if ((((((*(*p_if).ifa_addr).sa_family as libc::c_int))
                                            == (((2) as libc::c_int))) as libc::c_int as libc::c_int)
                                            != 0)
                                        {
                                            let mut addr: *mut sockaddr_in = ((((*p_if).ifa_addr
                                                as *mut sockaddr_in)) as *mut sockaddr_in);
                                            if ((((((*addr).sin_addr.s_addr as libc::c_uint))
                                        ...
                                        if (((((<ACE_SOCK_Dgram_Mcast>::join(
                                            (__this) as *mut ACE_SOCK_Dgram_Mcast,
                                            ::core::ptr::addr_of!((* mcast_addr)),
                                            reuse_addr,
                                            (((*p_if).ifa_name) as *const libc::c_char),
                                        ) as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                                            as libc::c_int) != 0)
                                        {
                                            {
                                                let __lv = &mut (nr_subscribed);
                                                *__lv = (*__lv).wrapping_add(1);
                                                *__lv
                                            };
                                        }
                    ...
                    freeifaddrs(ifap);
                    if (((((nr_subscribed as libc::c_ulong)) == (((0) as libc::c_ulong)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        ((*(__errno_location()))) = 19;
                        return (-((1) as libc::c_int));
                ...
                {
                    if (((((<ACE_SOCK_Dgram>::make_multicast_ifaddr(
                        (::core::ptr::addr_of_mut!(
                            (* ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                            ACE_SOCK_Dgram > ().cast_mut())
                        )) as *mut ACE_SOCK_Dgram,
                        ((0) as *mut ip_mreq),
                        ::core::ptr::addr_of!((* mcast_addr)),
                        net_if,
                    ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
  ...
  /// (Layered method for subscribe() processing).*/
    pub unsafe fn subscribe_i(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut mreq: ip_mreq = unsafe {
                    ::core::mem::MaybeUninit::<ip_mreq>::zeroed().assume_init()
                };
                if (((((<ACE_SOCK_Dgram_Mcast>::open(
                    (__this) as *mut ACE_SOCK_Dgram_Mcast,
                    ::core::ptr::addr_of!((* mcast_addr)),
                    net_if,
                    reuse_addr,
                ...
                if (((((net_if).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    let mut result: libc::c_int = <ACE_SOCK_Dgram_Mcast>::subscribe_ifs(
                        (__this) as *mut ACE_SOCK_Dgram_Mcast,
                        ::core::ptr::addr_of!((* mcast_addr)),
                        net_if,
                        reuse_addr,
                ...
                if (((((<ACE_SOCK_Dgram>::make_multicast_ifaddr(
                    ...
                    ::core::ptr::addr_of_mut!(mreq) as *mut ip_mreq,
                    ::core::ptr::addr_of!((* mcast_addr)),
                    net_if,
                ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    ...
                    if (((((<ACE_SOCK>::set_option(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((* __this)
                            .__base_0) .cast:: < ACE_SOCK_Dgram > ().cast_mut())
                            .__base_0) .cast:: < ACE_SOCK > ().cast_mut())
                        )) as *const ACE_SOCK,
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((((((((((((((*__this).opts_)) as libc::c_int))
                    ...
                    as libc::c_int) as libc::c_int) != 0)
                {
                    let mut if_addrs: *mut ACE_INET_Addr = ((0) as *mut ACE_INET_Addr);
                    let mut if_cnt: libc::c_ulong = unsafe { ::core::mem::zeroed() };
                    if (((((ACE::get_ip_interfaces(
                        ::core::ptr::addr_of_mut!(if_cnt),
                        ::core::ptr::addr_of_mut!(if_addrs),
                    ) as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                        as libc::c_int) != 0)
                    {
                        return (-((1) as libc::c_int));
                    }
                    let mut nr_unsubscribed: libc::c_ulong = ((0) as libc::c_ulong);
                    if (((((if_cnt as libc::c_ulong)) < (((2) as libc::c_ulong)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        if (((((<ACE_SOCK_Dgram_Mcast>::leave(
                            (__this) as *mut ACE_SOCK_Dgram_Mcast,
                            ::core::ptr::addr_of!((* mcast_addr)),
                            ((b"0.0.0.0\0".as_ptr() as *const libc::c_char)
                                as *const libc::c_char),
                        ) as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                            as libc::c_int) != 0)
                        {
                            {
                                let __lv = &mut (nr_unsubscribed);
                                *__lv = (*__lv).wrapping_add(1);
                                *__lv
                            };
                        }
                                ...
                                {
                                    {
                                        ...
                                        if ((<ACE_INET_Addr>::is_loopback(
                                            (::core::ptr::addr_of!(
                                                (* (if_addrs).wrapping_offset((if_cnt) as isize))
                                            )) as *const ACE_INET_Addr,
                                        ) as libc::c_int) != 0)
                                        {
                                            break 'cont_0;
                                        }
                                        let mut addr_buf: [libc::c_char; 46usize] = unsafe {
                                            ::core::mem::zeroed()
                                        };
                                        if (((((<ACE_SOCK_Dgram_Mcast>::leave(
                                            (__this) as *mut ACE_SOCK_Dgram_Mcast,
                                            ::core::ptr::addr_of!((* mcast_addr)),
                                            ((<ACE_INET_Addr>::get_host_addr(
                                                (::core::ptr::addr_of!(
                                                    (* (if_addrs).wrapping_offset((if_cnt) as isize))
                                                )) as *const ACE_INET_Addr,
                                                ((addr_buf).as_mut_ptr() as *mut libc::c_char),
                                                46,
                                            )) as *const libc::c_char),
                                        ) as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                                            as libc::c_int) != 0)
                    ...
                    {
                        let __data = if_addrs as *mut ACE_INET_Addr;
                        if !__data.is_null() {
                            let __off = ::core::alloc::Layout::new::<usize>()
                                .extend(
                                    ::core::alloc::Layout::array::<ACE_INET_Addr>(1).unwrap(),
                                )
                                .unwrap()
                                .1;
                    ...
                    if (((((nr_unsubscribed as libc::c_ulong))
  ...
  ///  (Layered method for <unsubscribe> processing).*/
    pub unsafe fn unsubscribe_i(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut result: libc::c_int = <ACE_SOCK_Dgram_Mcast>::unsubscribe_ifs(
                    (__this) as *mut ACE_SOCK_Dgram_Mcast,
                    ::core::ptr::addr_of!((* mcast_addr)),
                    net_if,
                );
  ...
  /// reuse it.*/
            ...
            let __this: *mut Self = __this as *mut Self;
            {
                if ((reuse_addr) != 0) {
                    ...
                    if (((((<ACE_SOCK>::set_option(
                        ...
                        1,
                        15,
                        ((::core::ptr::addr_of_mut!(one) as *mut libc::c_int)
                            as *mut libc::c_void),
                ...
                let mut bind_addy: ACE_INET_Addr = ::core::mem::MaybeUninit::<
                    ACE_INET_Addr,
                >::zeroed()
                    .assume_init();
                <ACE_INET_Addr>::new_at_ufdc256446431ae0e(
                    (::core::ptr::addr_of_mut!(bind_addy)) as *mut ACE_INET_Addr,
                    ::core::ptr::addr_of!((* mcast_addr)),
                );
                if ((((((((((((*__this).opts_)) as libc::c_int))
                    & (((OPT_BINDADDR_YES)) as libc::c_int)) as libc::c_int))
                ...
                if (((((<ACE_SOCK_Dgram>::shared_open(
                    (::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                        ACE_SOCK_Dgram > ().cast_mut())
                    )) as *mut ACE_SOCK_Dgram,
                    ::core::ptr::addr_of!(
                        (* ::core::ptr::addr_of!((bind_addy).__base_0) .cast:: < ACE_Addr
                        > ().cast_mut())
                    ) as *const ACE_Addr,
                    <ACE_Addr>::get_type(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((*
                            (::core::ptr::addr_of!(bind_addy))).__base_0) .cast:: <
                            ACE_Addr > ().cast_mut())
                        )) as *const ACE_Addr,
                    ),
                    0,
                ...
                let mut bound_addy: ACE_INET_Addr = ::core::mem::MaybeUninit::<
                    ACE_INET_Addr,
                >::zeroed()
                    .assume_init();
                <ACE_INET_Addr>::new_at(
                    (::core::ptr::addr_of_mut!(bound_addy)) as *mut ACE_INET_Addr,
                );
                if (((((<ACE_SOCK>::get_local_addr(
                    (::core::ptr::addr_of!(
                        (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((* __this)
                        .__base_0) .cast:: < ACE_SOCK_Dgram > ().cast_mut()).__base_0)
                        .cast:: < ACE_SOCK > ().cast_mut())
                    ...
                    ::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((bound_addy).__base_0) .cast:: <
                        ACE_Addr > ().cast_mut())
                    ) as *mut ACE_Addr,
                ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    if (((((<ACE_INET_Addr>::set(
                        (::core::ptr::addr_of_mut!(bound_addy)) as *mut ACE_INET_Addr,
                        ::core::ptr::addr_of!(bind_addy),
                    ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        return (-((1) as libc::c_int));
                ...
                <ACE_INET_Addr>::set_port_number(
                    ...
                    <ACE_INET_Addr>::get_port_number(
                        (::core::ptr::addr_of!(bound_addy)) as *const ACE_INET_Addr,
                    ),
                    1,
                );
                if (!(net_if).is_null()) {
                    if ((<ACE_SOCK_Dgram>::set_nic(
                        (::core::ptr::addr_of_mut!(
                            (* ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                            ACE_SOCK_Dgram > ().cast_mut())
                        )) as *mut ACE_SOCK_Dgram,
                    ...
                    (*__this).send_net_if_ = {
                        let __count: usize = ((((ACE_OS::strlen_u07dd12a225364fa6(
                            ((net_if) as *const libc::c_char),
                        )) as libc::c_ulong))
                    ...
                    ACE_OS::strcpy_u08e8184bcebbac89(
                        (((*__this).send_net_if_) as *mut libc::c_char),
                        ((net_if) as *const libc::c_char),
                    );
                }
                return 0;
    ...
    pub unsafe fn clear_subs_list(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
...
impl ACE_SDM_helpers {
    pub unsafe fn addr_to_string(
        mut ip_addr: *const ACE_INET_Addr,
        mut ret_string: *mut libc::c_char,
        mut len: libc::c_ulong,
        mut clip_portnum: libc::c_int,
    ) {
        unsafe {
            {
                if ((((({
                    let __obj: *mut ACE_INET_Addr = (::core::ptr::addr_of!((* ip_addr)))
                        as *mut ACE_INET_Addr;
                    let __vt: *const __Vtbl_ued8c6ee26a6e6919 = *(__obj
                        as *const *const __Vtbl_ued8c6ee26a6e6919);
                    ((*__vt)
                        .vfn_u6a425f759686dd38)(
                        __obj,
                        ((ret_string) as *mut libc::c_char),
                        len,
                        1,
                    )
                } as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    ...
                    let mut pc: *mut libc::c_char = ((ACE_OS::strrchr_ud9ed4b42142d6283(
                        ((ret_string) as *mut libc::c_char),
                        ((58 as libc::c_char) as libc::c_int),
                    )) as *mut libc::c_char);
                    if ((((((clip_portnum) != 0) && (!(pc).is_null())) as libc::c_int)
                        as libc::c_int) != 0)
                    {
                        (*(pc)) = ((0 as libc::c_char) as libc::c_char);
                    }
                }
            }
            ()
    ...
    pub unsafe fn is_equal(
        mut m1: *const ip_mreq,
        mut m2: *const ip_mreq,
    ) -> libc::c_int {
        unsafe {
            {
                return ((((((((((*m1).imr_multiaddr.s_addr as libc::c_uint))
                    == ((((*m2).imr_multiaddr.s_addr) as libc::c_uint))) as libc::c_int
                    as libc::c_int) != 0)
                    && ((((((*m1).imr_interface.s_addr as libc::c_uint))
                        == ((((*m2).imr_interface.s_addr) as libc::c_uint)))
                        as libc::c_int as libc::c_int) != 0)) as libc::c_int))
                    as libc::c_int);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
