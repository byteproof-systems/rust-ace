...
#[export_name = "_ZN23ACE_SV_Semaphore_SimpleC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_SV_Semaphore_SimpleC1Ev(
    __this: *mut ACE_SV_Semaphore_Simple,
) {
    ACE_SV_Semaphore_Simple::new_at(__this)
}
#[export_name = "_ZN23ACE_SV_Semaphore_SimpleC1Eisitj"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_SV_Semaphore_SimpleC1Eisitj(
    __this: *mut ACE_SV_Semaphore_Simple,
    __a0: libc::c_int,
    __a1: libc::c_short,
    __a2: libc::c_int,
    ...
    ACE_SV_Semaphore_Simple::new_at_u80f8290cc20c436a(
        __this,
        __a0,
        __a1,
        __a2,
...
#[export_name = "_ZN23ACE_SV_Semaphore_SimpleC1EPKcsitj"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_SV_Semaphore_SimpleC1EPKcsitj(
    __this: *mut ACE_SV_Semaphore_Simple,
    ...
    ACE_SV_Semaphore_Simple::new_at_u60b1749b1f5fd975(
        __this,
        __a0,
        __a1,
        __a2,
...
#[export_name = "_ZN23ACE_SV_Semaphore_SimpleC1EPKwsitj"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_SV_Semaphore_SimpleC1EPKwsitj(
    __this: *mut ACE_SV_Semaphore_Simple,
    ...
    ACE_SV_Semaphore_Simple::new_at_uafd4f59c8c25bcb1(
        __this,
        __a0,
        __a1,
        __a2,
...
#[export_name = "__acedtor_ueadc0f2380782fba"]
pub unsafe extern "C-unwind" fn __acedtor_ueadc0f2380782fba(
    __this: *mut ACE_SV_Semaphore_Simple,
) {
    unsafe {
...
#[export_name = "_ZN23ACE_SV_Semaphore_Simple4openEPKcsitj"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_SV_Semaphore_Simple4openEPKcsitj(
    __this: *mut ACE_SV_Semaphore_Simple,
    ...
    unsafe {
        ACE_SV_Semaphore_Simple::open(__this, name, flags, initial_value, n, perms)
    }
}
#[export_name = "_ZN23ACE_SV_Semaphore_Simple4openEisitj"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_SV_Semaphore_Simple4openEisitj(
    __this: *mut ACE_SV_Semaphore_Simple,
    k: libc::c_int,
    flags: libc::c_short,
    initial_value: libc::c_int,
    ...
    unsafe {
        ACE_SV_Semaphore_Simple::open_uf566d1fa800d775b(
            __this,
            k,
            flags,
            initial_value,
...
#[export_name = "_ZNK23ACE_SV_Semaphore_Simple6removeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK23ACE_SV_Semaphore_Simple6removeEv(
    __this: *const ACE_SV_Semaphore_Simple,
) -> libc::c_int {
    unsafe { ACE_SV_Semaphore_Simple::remove(__this) }
}
#[export_name = "_ZNK23ACE_SV_Semaphore_Simple2opEsts"]
pub unsafe extern "C-unwind" fn __xtu__ZNK23ACE_SV_Semaphore_Simple2opEsts(
    __this: *const ACE_SV_Semaphore_Simple,
    val: libc::c_short,
    n: libc::c_ushort,
    flags: libc::c_short,
) -> libc::c_int {
    unsafe { ACE_SV_Semaphore_Simple::op(__this, val, n, flags) }
}
#[export_name = "_ZNK23ACE_SV_Semaphore_Simple7controlEiit"]
pub unsafe extern "C-unwind" fn __xtu__ZNK23ACE_SV_Semaphore_Simple7controlEiit(
    __this: *const ACE_SV_Semaphore_Simple,
    cmd: libc::c_int,
    value: libc::c_int,
    ...
    unsafe {
        ACE_SV_Semaphore_Simple::control_u8e0dfb2f98f572a5(__this, cmd, value, semnum)
    }
}
#[export_name = "_ZNK23ACE_SV_Semaphore_Simple4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK23ACE_SV_Semaphore_Simple4dumpEv(
    __this: *const ACE_SV_Semaphore_Simple,
) {
    unsafe { ACE_SV_Semaphore_Simple::dump(__this) }
}
#[export_name = "_ZN23ACE_SV_Semaphore_Simple4initEii"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_SV_Semaphore_Simple4initEii(
    __this: *mut ACE_SV_Semaphore_Simple,
    k: libc::c_int,
    i: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_SV_Semaphore_Simple::init(__this, k, i) }
}
#[export_name = "_ZN23ACE_SV_Semaphore_Simple10name_2_keyEPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_SV_Semaphore_Simple10name_2_keyEPKc(
    __this: *mut ACE_SV_Semaphore_Simple,
    name: *const libc::c_char,
) -> libc::c_int {
    unsafe { ACE_SV_Semaphore_Simple::name_2_key(__this, name) }
}
extern "C-unwind" {
...
impl ACE_SV_Semaphore_Simple {
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ...
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).sem_number_), 0);
            {
    ...
    pub unsafe fn new_at_u80f8290cc20c436a(
        ...
        unsafe {
            ...
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).key_), k);
            {
                if (((((<ACE_SV_Semaphore_Simple>::open_uf566d1fa800d775b(
                    (__this) as *mut ACE_SV_Semaphore_Simple,
                    k,
                    flags,
                    initial_value,
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/SV_Semaphore_Simple.cpp\0"
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        b"ACE_SV_Semaphore::ACE_SV_Semaphore\0".as_ptr()
                                            as *const libc::c_char,
                                    );
                                }
                            }
    ...
    pub unsafe fn new_at_u60b1749b1f5fd975(
        ...
        unsafe {
            ...
            {
                if (((((<ACE_SV_Semaphore_Simple>::open(
                    (__this) as *mut ACE_SV_Semaphore_Simple,
                    name,
                    flags,
                    initial_value,
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        b"ACE_SV_Semaphore_Simple::ACE_SV_Semaphore_Simple\0"
    ...
    pub unsafe fn open(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                return <ACE_SV_Semaphore_Simple>::open_uf566d1fa800d775b(
                    (__this) as *mut ACE_SV_Semaphore_Simple,
                    key,
                    flags,
                    initial_value,
  ...
  /// OK, else -1.*/
    pub unsafe fn open_uf566d1fa800d775b(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut ivalue: semun = unsafe {
                    ::core::mem::MaybeUninit::<semun>::zeroed().assume_init()
                };
                if (((((((((k as libc::c_int))
                ...
                (*__this).key_ = k;
                (*__this).sem_number_ = ((n) as libc::c_int);
                (*__this).internal_id_ = ACE_OS::semget_u459a57c0bbce4950(
                    (*__this).key_,
                    ((n) as libc::c_int),
                    (((((perms) as libc::c_uint)) | ((flags) as libc::c_uint))
                        as libc::c_int),
                );
                if ((((((*__this).internal_id_ as libc::c_int))
                    == ((((-((1) as libc::c_int))) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    return (-((1) as libc::c_int));
                }
                if (((((((((((flags)) as libc::c_int)) & (((512)) as libc::c_int))
                ...
                {
                    {
                        ...
                        'for_0: loop {
                            ...
                            'cont_0: loop {
                                {
                                    if (((((ACE_OS::semctl_ued1baeab063da9d3(
                                        (*__this).internal_id_,
                                        i,
                                        16,
                                        ivalue,
  ...
  /// operations...*/
    ...
    pub unsafe fn remove(__this: *const Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut result: libc::c_int = ((<ACE_SV_Semaphore_Simple>::control_u8e0dfb2f98f572a5(
  ...
  /// specific amount (positive or negative; amount can`t be zero).*/
    pub unsafe fn op(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut op_op: sembuf = unsafe {
                    ::core::mem::MaybeUninit::<sembuf>::zeroed().assume_init()
                };
                op_op.sem_num = ((n) as libc::c_ushort);
                op_op.sem_flg = flags;
                if ((((((*__this).internal_id_ as libc::c_int))
                    == ((((-((1) as libc::c_int))) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                        ...
                        as libc::c_int) != 0)
                    {
                        ...
                        return ACE_OS::semop_u80b06a9c8b5a703c(
                            ...
                            ((::core::ptr::addr_of_mut!(op_op) as *mut sembuf)
                                as *mut sembuf),
                            ((1) as libc::c_ulong),
                        );
                    }
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                    ...
                    as libc::c_int) != 0)
                {
                    ...
                    let mut semctl_arg: semun = unsafe {
                        ::core::mem::MaybeUninit::<semun>::zeroed().assume_init()
                    };
                    semctl_arg.val = value;
                    return ACE_OS::semctl_ued1baeab063da9d3(
                        (((*__this).internal_id_) as libc::c_int),
                        ((semnum) as libc::c_int),
                        cmd,
                        semctl_arg,
                    );
                }
    ...
    pub unsafe fn name_2_key(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                return (ACE::crc32_u0e5e0cf2e3dddc4e(name) as libc::c_int);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
