...
#[export_name = "_ZN12ACE_RW_MutexC1EiPKcPv"]
pub unsafe extern "C-unwind" fn __xtu__ZN12ACE_RW_MutexC1EiPKcPv(
    __this: *mut ACE_RW_Mutex,
    __a0: libc::c_int,
    __a1: *const libc::c_char,
    __a2: *mut libc::c_void,
) {
    ACE_RW_Mutex::new_at(__this, __a0, __a1, __a2)
}
impl Drop for ACE_RW_Mutex {
    fn drop(&mut self) {
        unsafe {
            let __this: *mut Self = self as *mut Self;
            {
                <ACE_RW_Mutex>::remove((__this) as *mut ACE_RW_Mutex);
            }
            ()
        }
    }
}
#[export_name = "__acedtor_u869c09e87589f1b0"]
pub unsafe extern "C-unwind" fn __acedtor_u869c09e87589f1b0(__this: *mut ACE_RW_Mutex) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
    }
}
#[export_name = "_ZNK12ACE_RW_Mutex4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK12ACE_RW_Mutex4dumpEv(
    __this: *const ACE_RW_Mutex,
) {
    unsafe { ACE_RW_Mutex::dump(__this) }
}
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/RW_Mutex.cpp\0".as_ptr()
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        b"ACE_RW_Mutex::ACE_RW_Mutex\0".as_ptr()
                                            as *const libc::c_char,
                                    );
                                }
                            }
