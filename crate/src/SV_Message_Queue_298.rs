...
pub mod ACE_OS {
    ...
    pub use crate::full_ops_0::ACE_OS::msgctl_uc8b3f54e718f79a1;
    pub use crate::full_ops_0::ACE_OS::msgget_ud9d18652b06d3332;
    pub use crate::full_ops_0::ACE_OS::msgrcv_uea316d0c325a47e0;
    pub use crate::full_ops_0::ACE_OS::msgsnd_u231f33838bdfda50;
...
#[doc = "* @class ACE_SV_Message_Queue\n *\n * @brief Defines the header file for the C++ wrapper for System V IPC\n * message queues."]
#[repr(C)]
#[derive(Clone)]
pub struct ACE_SV_Message_Queue {
    pub internal_id_: libc::c_int,
}
#[export_name = "_ZN20ACE_SV_Message_QueueC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_SV_Message_QueueC1Ev(
    __this: *mut ACE_SV_Message_Queue,
) {
    ACE_SV_Message_Queue::new_at(__this)
}
#[export_name = "_ZN20ACE_SV_Message_QueueC1Eiii"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_SV_Message_QueueC1Eiii(
    __this: *mut ACE_SV_Message_Queue,
    __a0: libc::c_int,
    __a1: libc::c_int,
    __a2: libc::c_int,
) {
    ACE_SV_Message_Queue::new_at_u2e54c2c96fbc18f0(__this, __a0, __a1, __a2)
}
impl Drop for ACE_SV_Message_Queue {
    fn drop(&mut self) {
        unsafe {
...
#[export_name = "__acedtor_uf17b60bcdd5e676a"]
pub unsafe extern "C-unwind" fn __acedtor_uf17b60bcdd5e676a(
    __this: *mut ACE_SV_Message_Queue,
) {
    unsafe {
...
#[export_name = "_ZNK20ACE_SV_Message_Queue4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK20ACE_SV_Message_Queue4dumpEv(
    __this: *const ACE_SV_Message_Queue,
) {
    unsafe { ACE_SV_Message_Queue::dump(__this) }
}
extern "C-unwind" {
    pub fn msgctl(
        __msqid: libc::c_int,
...
extern "C-unwind" {
    pub fn msgget(__key: libc::c_int, __msgflg: libc::c_int) -> libc::c_int;
}
extern "C-unwind" {
    pub fn msgrcv(
        __msqid: libc::c_int,
        __msgp: *mut libc::c_void,
        __msgsz: libc::c_ulong,
        __msgtyp: libc::c_long,
        __msgflg: libc::c_int,
    ) -> libc::c_long;
}
extern "C-unwind" {
...
impl ACE_SV_Message_Queue {
    ...
    pub unsafe fn new_at_u2e54c2c96fbc18f0(
        __this: *mut Self,
        ...
        unsafe {
            ...
            {
                if (((((<ACE_SV_Message_Queue>::open(
                    (__this) as *mut ACE_SV_Message_Queue,
                    external_id,
                    create,
                    perms,
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/SV_Message_Queue.cpp\0"
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        b"ACE_SV_Message_Queue::ACE_SV_Message_Queue\0".as_ptr()
                                            as *const libc::c_char,
                                    );
                                }
                            }
    ...
    pub unsafe fn new_u2e54c2c96fbc18f0(
        mut __a0: libc::c_int,
        mut __a1: libc::c_int,
        mut __a2: libc::c_int,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_u2e54c2c96fbc18f0(
    ...
    pub unsafe fn open(
        ...
        unsafe {
            ...
            {
                return {
                    let __v = ACE_OS::msgget_ud9d18652b06d3332(
                        external_id,
                        (((create) as libc::c_int)) | ((perms) as libc::c_int),
                    );
                    (*__this).internal_id_ = __v;
                    __v
                };
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
  ...
  /// from the system.*/
    pub unsafe fn close(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                (*__this).internal_id_ = (-((1) as libc::c_int));
                return 1;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    ...
    pub unsafe fn remove(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut result: libc::c_int = ((<ACE_SV_Message_Queue>::control(
                    (__this) as *mut ACE_SV_Message_Queue,
                    0,
    ...
    pub unsafe fn recv(
        __this: *mut Self,
        mut mb: *mut ACE_SV_Message,
        mut length: libc::c_int,
        mut r#type: libc::c_long,
        mut mflags: libc::c_int,
    ) -> libc::c_long {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return ACE_OS::msgrcv_uea316d0c325a47e0(
                    (*__this).internal_id_,
                    (::core::ptr::addr_of_mut!((* mb)) as *mut ACE_SV_Message
                        as *mut libc::c_void),
    ...
    pub unsafe fn send(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return ACE_OS::msgsnd_u231f33838bdfda50(
                    (*__this).internal_id_,
                    (((::core::ptr::addr_of!((* mb)) as *const ACE_SV_Message
    ...
    pub unsafe fn control(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return ACE_OS::msgctl_uc8b3f54e718f79a1(
                    (*__this).internal_id_,
                    option,
                    (arg as *mut msqid_ds),
                );
    ...
    pub unsafe fn set_id(__this: *mut Self, mut id: libc::c_int) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                (*__this).internal_id_ = id;
            }
            ()
        }
    }
