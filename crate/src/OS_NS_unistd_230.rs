...
pub mod ACE_OS {
    ...
    #[export_name = "_ZN6ACE_OS14argv_to_stringEiPPcRS0_bb"]
    pub unsafe extern "C-unwind" fn argv_to_string_u240466127d20addd(
        mut argc: libc::c_int,
        mut argv: *mut *mut libc::c_char,
        mut buf: *mut *mut libc::c_char,
        mut substitute_env_args: bool,
        mut quote_args: bool,
    ) -> libc::c_int {
        unsafe {
            {
                if (((((((((((((argc as libc::c_int)) <= (((0) as libc::c_int)))
                    ...
                    || (((((argv).is_null()) as libc::c_int) as libc::c_int) != 0))
                    as libc::c_int) as libc::c_int) != 0)
                    || ((((((*(argv).wrapping_offset((0) as isize))).is_null())
                        as libc::c_int) as libc::c_int) != 0)) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    return 0;
                }
                let mut buf_len: libc::c_ulong = ((0) as libc::c_ulong);
                let mut argv_p: *mut *mut libc::c_char = argv;
                {
                    let mut i: libc::c_int = 0;
                    'for_0: loop {
                        if !((((((i as libc::c_int)) < (((argc) as libc::c_int)))
                            as libc::c_int as libc::c_int) != 0))
                        {
                            break;
                        }
                        'cont_0: loop {
                            {
                                {
                                    if ((((((substitute_env_args as libc::c_int) != 0)
                                        && ((((!(strchr_u824406bee5e3796b(
                                            (((*(argv).wrapping_offset((i) as isize)))
                                                as *mut libc::c_char),
                                            ((36 as libc::c_char) as libc::c_int),
                                        ))
                                            .is_null()) as libc::c_int) as libc::c_int) != 0))
                                        as libc::c_int) as libc::c_int) != 0)
                                    {
                                        if ((((((argv_p) as *const u8)) == (((argv) as *const u8)))
                                            as libc::c_int as libc::c_int) != 0)
                                        {
                                            argv_p = (malloc_u80646b42522769ca(
                                                (((((argc) as libc::c_ulong))
                                                    .wrapping_mul((8) as libc::c_ulong)) as libc::c_ulong),
                                            ) as *mut *mut libc::c_char);
                                            if (((((argv_p).is_null()) as libc::c_int) as libc::c_int)
                                                != 0)
                                            {
                                                ((*(super::__errno_location()))) = 12;
                                                return 0;
                                            }
                                            memcpy_u6033eb81edaf9212(
                                                ((argv_p) as *mut libc::c_void),
                                                ((argv) as *const libc::c_void),
                                                (((((argc) as libc::c_ulong))
                                                    .wrapping_mul((8) as libc::c_ulong)) as libc::c_ulong),
                                            );
                                        }
                                        (*(argv_p).wrapping_offset((i) as isize)) = strenvdup_uc4fed4dc8e89ae4d(
                                            (((*(argv).wrapping_offset((i) as isize)))
                                                as *const libc::c_char),
                                        );
                                        if ((((((*(argv_p).wrapping_offset((i) as isize)))
                                            .is_null()) as libc::c_int) as libc::c_int) != 0)
                                        {
                                            free_ucbe6910a56eae126(((argv_p) as *mut libc::c_void));
                                            ((*(super::__errno_location()))) = 12;
                                            return 0;
                                        }
                                    }
                                    if ((((((quote_args as libc::c_int) != 0)
                                        && (((((((((((((((((!(strchr_u824406bee5e3796b(
                                            (((*(argv_p).wrapping_offset((i) as isize)))
                                                as *mut libc::c_char),
                                            ((32 as libc::c_char) as libc::c_int),
                                        ))
                                            .is_null()) as libc::c_int) as libc::c_int) != 0)
                                            || ((((!(strchr_u824406bee5e3796b(
                                                (((*(argv_p).wrapping_offset((i) as isize)))
                                                    as *mut libc::c_char),
                                                ((9 as libc::c_char) as libc::c_int),
                                            ))
                                                .is_null()) as libc::c_int) as libc::c_int) != 0))
                                            as libc::c_int) as libc::c_int) != 0)
                                            || ((((!(strchr_u824406bee5e3796b(
                                                (((*(argv_p).wrapping_offset((i) as isize)))
                                                    as *mut libc::c_char),
                                                ((10 as libc::c_char) as libc::c_int),
                                            ))
                                                .is_null()) as libc::c_int) as libc::c_int) != 0))
                                            as libc::c_int) as libc::c_int) != 0)
                                            || ((((((*((*(argv_p).wrapping_offset((i) as isize))))
                                            ...
                                            != 0)) as libc::c_int) as libc::c_int) != 0)
                                    {
                                        ...
                                        let mut temp: *mut libc::c_char = (*(argv_p)
                                            .wrapping_offset((i) as isize));
                                        if ((((!(strchr_u824406bee5e3796b(
                                            ((temp) as *mut libc::c_char),
                                            ((34 as libc::c_char) as libc::c_int),
                                        ))
                                            .is_null()) as libc::c_int) as libc::c_int) != 0)
                                        {
                                            {
                                                ...
                                                'for_1: loop {
                                                    if !(((((((*(temp).wrapping_offset((j) as isize))
                                                        as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                                                        as libc::c_int) != 0))
                                                    {
                                                        break;
                                        ...
                                        (*(argv_p).wrapping_offset((i) as isize)) = (malloc_u80646b42522769ca(
                                            ((((((((((((strlen_u07dd12a225364fa6(
                                                ((temp) as *const libc::c_char),
                                            )) as libc::c_ulong))
                                                .wrapping_add((quotes) as libc::c_ulong)) as libc::c_ulong))
                                                .wrapping_add((3) as libc::c_ulong))) as libc::c_ulong))
                                        ...
                                        let mut end: *mut libc::c_char = (*(argv_p)
                                            .wrapping_offset((i) as isize));
                                        (*({
                                            let __lv = &mut (end);
                                            let __r = *__lv;
                                            *__lv = (*__lv).wrapping_offset(1);
                                            __r
                                        })) = ((34 as libc::c_char) as libc::c_char);
                                        if (((((quotes as libc::c_int)) > (((0) as libc::c_int)))
                                            as libc::c_int as libc::c_int) != 0)
                                        {
                                            {
                                                let mut p: *mut libc::c_char = temp;
                                                'for_2: loop {
                                                    ...
                                                    'cont_2: loop {
                                                        {
                                                                ...
                                                                as libc::c_int as libc::c_int) != 0)
                                                            {
                                                                (*({
                                                                    ...
                                                                    *__lv = (*__lv).wrapping_offset(1);
                                                                    __r
                                                                })) = ((92 as libc::c_char) as libc::c_char);
                                                            }
                                                        }
                                        ...
                                        (*(end)
                                            .wrapping_offset(((-((1) as libc::c_int))) as isize)) = ((34
                                            as libc::c_char) as libc::c_char);
                                        (*(end)) = ((0 as libc::c_char) as libc::c_char);
                                        if ((((((temp) as *const u8))
                                            != ((((*(argv).wrapping_offset((i) as isize)))
                                                as *const u8))) as libc::c_int as libc::c_int) != 0)
                                        {
                                            free_ucbe6910a56eae126(((temp) as *mut libc::c_void));
                                        }
                                    }
                                    {
                    ...
                    'cont_3: loop {
                        {
                            {
                                (*buf) = {
                                    let __count: usize = ((((buf_len) as libc::c_ulong))
                ...
                (*((*buf)).wrapping_offset((0) as isize)) = ((0 as libc::c_char)
                    as libc::c_char);
                            ...
                            {
                                {
                                    ...
                                    if (((((((*(argv_p).wrapping_offset((i) as isize)))
                                        ...
                                        != ((((*(argv).wrapping_offset((i) as isize)))
                                            as *const u8))) as libc::c_int as libc::c_int) != 0)
                                    {
                                        free_ucbe6910a56eae126(
                                            (((*(argv_p).wrapping_offset((i) as isize)))
                                                as *mut libc::c_void),
                                        );
                                    }
                                    (*(end)
                                        .wrapping_offset(((-((1) as libc::c_int))) as isize)) = ((32
                                        as libc::c_char) as libc::c_char);
                                }
                            }
    ...
    #[export_name = "_ZN6ACE_OS14argv_to_stringEPPcRS0_bb"]
    pub unsafe extern "C-unwind" fn argv_to_string(
        mut argv: *mut *mut libc::c_char,
        mut buf: *mut *mut libc::c_char,
        mut substitute_env_args: bool,
        mut quote_args: bool,
        ...
        unsafe {
            {
                ...
                let mut argc: libc::c_int = unsafe { ::core::mem::zeroed() };
                {
                    argc = 0;
                    'for_0: loop {
                        if !(((((!((*(argv).wrapping_offset((argc) as isize))).is_null())
                            as libc::c_int) as libc::c_int) != 0))
                        {
                            break;
                        }
                ...
                return argv_to_string_u240466127d20addd(
                    argc,
                    argv,
    ...
    #[export_name = "_ZN6ACE_OS5execlEPKcS1_z"]
    pub unsafe extern "C-unwind" fn execl_ub81cd3482485e0c0(
        mut _anon_0: *const libc::c_char,
        mut _anon_1: *const libc::c_char,
        mut __args: ...
    ) -> libc::c_int {
        unsafe {
            {
    ...
    #[export_name = "_ZN6ACE_OS6execleEPKcS1_z"]
    pub unsafe extern "C-unwind" fn execle_u057fbff73b71fbb9(
        mut _anon_0: *const libc::c_char,
        mut _anon_1: *const libc::c_char,
        mut __args: ...
    ) -> libc::c_int {
    ...
    #[export_name = "_ZN6ACE_OS6execlpEPKcS1_z"]
    pub unsafe extern "C-unwind" fn execlp_u53e722b3191e043a(
        mut _anon_0: *const libc::c_char,
        mut _anon_1: *const libc::c_char,
        mut __args: ...
    ) -> libc::c_int {
    ...
    #[export_name = "_ZN6ACE_OS4forkEPKc"]
    pub unsafe extern "C-unwind" fn fork_uc56682233d614dbc(
        mut program_name: *const libc::c_char,
    ) -> libc::c_int {
        unsafe {
            {
                let mut pid: libc::c_int = ((super::fork()) as libc::c_int);
                {
                    let _ = (program_name);
                };
    ...
    #[export_name = "_ZN6ACE_OS9fork_execEPPc"]
    pub unsafe extern "C-unwind" fn fork_exec(
        mut argv: *mut *mut libc::c_char,
    ) -> libc::c_int {
        unsafe {
            {
                let mut result: libc::c_int = ((fork_ud832228bf11480c3())
                    as libc::c_int);
                'switch_0: {
                    ...
                    if __m <= 1 {
                        if (((((execv_u2d5c5effd88bba3e(
                            ...
                            as libc::c_int as libc::c_int) != 0)
                        {
                            exit_ud318a3a23e137d2b(((*(super::__errno_location()))));
                        }
    ...
    #[export_name = "_ZN6ACE_OS14num_processorsEv"]
    pub unsafe extern "C-unwind" fn num_processors() -> libc::c_long {
        unsafe {
            {
                return super::sysconf((((83 as libc::c_int)) as libc::c_int));
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    ///Get the number of CPUs currently online.
    #[export_name = "_ZN6ACE_OS21num_processors_onlineEv"]
    pub unsafe extern "C-unwind" fn num_processors_online() -> libc::c_long {
        unsafe {
            {
                return super::sysconf((((84 as libc::c_int)) as libc::c_int));
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    pub use crate::full_ops_0::ACE_OS::pipe_u635316640e09601f;
    #[export_name = "_ZN6ACE_OS5preadEiPvml"]
    pub unsafe extern "C-unwind" fn pread_u1b611c818e4074d0(
    ...
    #[export_name = "_ZN6ACE_OS6pwriteEiPKvml"]
    pub unsafe extern "C-unwind" fn pwrite_u004420a1c470f7a8(
        mut handle: libc::c_int,
        ...
        unsafe {
            {
                ...
                let mut n: libc::c_long = ((0) as libc::c_long);
                {
    ...
    #[export_name = "_ZN6ACE_OS14string_to_argvEPcRiRPS0_b"]
    pub unsafe extern "C-unwind" fn string_to_argv(
        ...
        unsafe {
            {
                (*argc) = 0;
                if (((((buf).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    return (-((1) as libc::c_int));
                }
                let mut cp: *mut libc::c_char = buf;
                'while_0: loop {
                    if !(((((((((((*(cp)) as libc::c_int as libc::c_char))
                        != (((0 as libc::c_char) as libc::c_int as libc::c_char)))
                        as libc::c_int as libc::c_int) != 0)
                        && ((((((*(cp)) as libc::c_int as libc::c_char))
                        ...
                        {
                            {
                                ...
                                'while_2: loop {
                                    if !(((((((((((*(cp)) as libc::c_int as libc::c_char))
                                        != (((0 as libc::c_char) as libc::c_int as libc::c_char)))
                                        as libc::c_int as libc::c_int) != 0)
                                        && (((!(((ace_isspace((*(cp)))) != 0)) as libc::c_int)
                                            as libc::c_int) != 0)) as libc::c_int) as libc::c_int)
                                        != 0))
                                    {
                                        break 'while_2;
                                                    ...
                                                    let mut quote: libc::c_char = (*(cp));
                                                    {
                                                        ...
                                                        'for_3: loop {
                                                            if !(((((((((((*(cp)) as libc::c_int as libc::c_char))
                                                                ...
                                                                as libc::c_int as libc::c_int) != 0)
                                                                && (((((((((((*(cp)) as libc::c_int as libc::c_char))
                                                                    != (((quote) as libc::c_int as libc::c_char)))
                                                                    as libc::c_int as libc::c_int) != 0)
                                                                    || ((((((*(cp)
                ...
                let mut arg: [libc::c_char; 4096usize] = unsafe {
                    ::core::mem::zeroed()
                };
                let mut argp: *mut libc::c_char = ((arg).as_mut_ptr()
                    as *mut libc::c_char);
                if (((((((cp).offset_from(buf)) as libc::c_long as libc::c_long))
                    >= ((((((1024) as libc::c_int)).wrapping_mul((4) as libc::c_int))
                        ...
                        'cont_4: loop {
                            {
                                {
                                    argp = {
                                        let __count: usize = ((((((cp).offset_from(buf))
                                            as libc::c_long) as libc::c_long))
                                            .wrapping_add((1) as libc::c_long)) as usize;
                                        let __nbytes = __count
                                            .checked_mul(::core::mem::size_of::<libc::c_char>())
                                            .expect("array new[] size overflow");
                                        let __data = ::libc::malloc(
                                    ...
                                    if (((((argp).is_null()) as libc::c_int) as libc::c_int)
                                        != 0)
                                    {
                                        ((*(super::__errno_location()))) = 12;
                                        return (-((1) as libc::c_int));
                    ...
                    'cont_5: loop {
                        {
                            {
                                (*argv) = {
                                    let __count: usize = (((((*argc)) as libc::c_int))
                                ...
                                if ((((((*argv)).is_null()) as libc::c_int) as libc::c_int)
                                    != 0)
                                {
                                    ((*(super::__errno_location()))) = 12;
                                    return (-((1) as libc::c_int));
                            ...
                            {
                                {
                                    ...
                                    cp = argp;
                                    'while_8: loop {
                                        if !(((((((((((*(ptr)) as libc::c_int as libc::c_char))
                                            != (((0 as libc::c_char) as libc::c_int as libc::c_char)))
                                            as libc::c_int as libc::c_int) != 0)
                                            && (((!(((ace_isspace((*(ptr)))) != 0)) as libc::c_int)
                                                as libc::c_int) != 0)) as libc::c_int) as libc::c_int)
                                            != 0))
                                        {
                                            break 'while_8;
                                        ...
                                        'cont_8: loop {
                                            {
                                                if ((((((((((*(ptr)) as libc::c_int as libc::c_char))
                                                    == (((39 as libc::c_char) as libc::c_int as libc::c_char)))
                                                    as libc::c_int as libc::c_int) != 0)
                                                    || ((((((*(ptr)) as libc::c_int as libc::c_char))
                                                        == (((34 as libc::c_char) as libc::c_int as libc::c_char)))
                                                        as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                                                    as libc::c_int) != 0)
                                                {
                                                    let mut quote: libc::c_char = (*({
                                                        let __lv = &mut (ptr);
                                                        let __r = *__lv;
                                                        *__lv = (*__lv).wrapping_offset(1);
                                                        __r
                                                    ...
                                                    'while_9: loop {
                                                        ...
                                                        'cont_9: loop {
                                                            ...
                                                            #[allow(unreachable_code)] break 'cont_9;
                                                        }
                                                    }
                                                    if ((((((*(ptr)) as libc::c_int as libc::c_char))
                                                        == (((quote) as libc::c_int as libc::c_char)))
                                    ...
                                    (*(cp)) = ((0 as libc::c_char) as libc::c_char);
                                    if ((substitute_env_args as libc::c_int) != 0) {
                                        (*((*argv)).wrapping_offset((i) as isize)) = strenvdup_uc4fed4dc8e89ae4d(
                                            ((argp) as *const libc::c_char),
                                        );
                                        if ((((((*((*argv)).wrapping_offset((i) as isize)))
                                            .is_null()) as libc::c_int) as libc::c_int) != 0)
                                        {
                                            if ((((argp) != (((arg).as_ptr() as *mut libc::c_char)))
                                                as libc::c_int as libc::c_int) != 0)
                                            {
                                                {
                                                    let __data = argp as *mut libc::c_char;
                                                    if !__data.is_null() {
                                        ...
                                        (*((*argv)).wrapping_offset((i) as isize)) = ((strdup_u8b6a84c4b070659c(
                                            ((argp) as *const libc::c_char),
                                        )) as *mut libc::c_char);
                                        if ((((((*((*argv)).wrapping_offset((i) as isize)))
                                            .is_null()) as libc::c_int) as libc::c_int) != 0)
                ...
                if ((((argp) != (((arg).as_ptr() as *mut libc::c_char))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    {
                        let __data = argp as *mut libc::c_char;
                ...
                (*((*argv)).wrapping_offset(((*argc)) as isize)) = ((0)
                    as *mut libc::c_char);
                return 0;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
...
pub mod ACE_Utils {
    ...
    pub type truncator_454 = Truncator_unsigned_long__long_;
