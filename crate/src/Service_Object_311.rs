...
#[export_name = "_ZN16ACE_Service_TypeC1EPKcP21ACE_Service_Type_ImplRK7ACE_DLLb"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_Service_TypeC1EPKcP21ACE_Service_Type_ImplRK7ACE_DLLb(
    ...
    ACE_Service_Type::new_at(__this, __a0, __a1, __a2, __a3)
}
#[export_name = "_ZN16ACE_Service_TypeC1EPKcP21ACE_Service_Type_ImplPvb"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_Service_TypeC1EPKcP21ACE_Service_Type_ImplPvb(
    __this: *mut ACE_Service_Type,
    __a0: *const libc::c_char,
    __a1: *mut ACE_Service_Type_Impl,
    ...
    ACE_Service_Type::new_at_u97afa6dfb10eaca5(__this, __a0, __a1, __a2, __a3)
}
    ...
    fn drop(&mut self) {
        {
            unsafe {
                let __this: *mut Self = self as *mut Self;
                {
                    <ACE_Service_Type>::fini((__this) as *mut ACE_Service_Type);
                    {
        ...
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.dll_);
        }
    }
}
#[export_name = "__acedtor_u603c59bafb6b7f73"]
pub unsafe extern "C-unwind" fn __acedtor_u603c59bafb6b7f73(
    __this: *mut ACE_Service_Type,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[export_name = "_ZN16ACE_Service_Type4nameEPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_Service_Type4nameEPKc(
    __this: *mut ACE_Service_Type,
    n: *const libc::c_char,
) {
    unsafe { ACE_Service_Type::name_u360824dab8abc741(__this, n) }
}
#[export_name = "_ZNK16ACE_Service_Type7suspendEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK16ACE_Service_Type7suspendEv(
    __this: *const ACE_Service_Type,
) -> libc::c_int {
    unsafe { ACE_Service_Type::suspend(__this) }
}
#[export_name = "_ZNK16ACE_Service_Type6resumeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK16ACE_Service_Type6resumeEv(
    __this: *const ACE_Service_Type,
) -> libc::c_int {
    unsafe { ACE_Service_Type::resume(__this) }
}
#[export_name = "_ZN16ACE_Service_Type4finiEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_Service_Type4finiEv(
    __this: *mut ACE_Service_Type,
) -> libc::c_int {
    unsafe { ACE_Service_Type::fini(__this) }
}
#[export_name = "_ZNK16ACE_Service_Type4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK16ACE_Service_Type4dumpEv(
    __this: *const ACE_Service_Type,
) {
    unsafe { ACE_Service_Type::dump(__this) }
}
...
#[export_name = "_ZN18ACE_Service_ObjectC1EP11ACE_Reactor"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_Service_ObjectC1EP11ACE_Reactor(
    __this: *mut ACE_Service_Object,
    __a0: *mut ACE_Reactor,
) {
    ACE_Service_Object::new_at(__this, __a0)
}
impl Drop for ACE_Service_Object {
    fn drop(&mut self) {
        {
            unsafe {
                let __this: *mut Self = self as *mut Self;
        ...
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.__base_1);
            ::core::mem::ManuallyDrop::drop(&mut self.__base_0);
        }
    }
}
#[export_name = "_ZN18ACE_Service_Object7suspendEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_Service_Object7suspendEv(
    __this: *mut ACE_Service_Object,
) -> libc::c_int {
    unsafe { ACE_Service_Object::suspend(__this) }
}
#[export_name = "_ZN18ACE_Service_Object6resumeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_Service_Object6resumeEv(
    __this: *mut ACE_Service_Object,
) -> libc::c_int {
    unsafe { ACE_Service_Object::resume(__this) }
}
extern "C-unwind" {
...
impl ACE_Service_Type {
    pub unsafe fn new_at(
        ...
        mut t: *mut ACE_Service_Type_Impl,
        mut dll: *const ACE_DLL,
        mut active: bool,
    ) {
        unsafe {
            ::core::ptr::write(
            ...
            ::core::ptr::write(
                ...
                (t) as *const ACE_Service_Type_Impl,
            );
            <ACE_DLL>::new_at_uee3c603b69ee15fa(
                (::core::ptr::addr_of_mut!((* __this).dll_).cast::<ACE_DLL>())
                    as *mut ACE_DLL,
                ::core::ptr::addr_of!((* dll)),
            );
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).active_), active);
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).fini_already_called_),
                false,
            );
            {
                <ACE_Service_Type>::name_u360824dab8abc741(
                    (__this) as *mut ACE_Service_Type,
                    n,
                );
            }
            ()
    ...
    pub unsafe fn name_u360824dab8abc741(__this: *mut Self, mut n: *const libc::c_char) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                {
                ...
                (*__this).name_ = ((ACE::strnew(((n) as *const libc::c_char)))
                    as *const libc::c_char);
            }
            ()
        }
    ...
    pub unsafe fn suspend(__this: *const Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                (*((__this as *mut ACE_Service_Type))).active_ = false;
                return {
                    let __obj: *mut ACE_Service_Type_Impl = ((*__this).type_)
                        as *mut ACE_Service_Type_Impl;
                    let __vt: *const __Vtbl_u3dbd2b1dd7cbef42 = *(__obj
                        as *const *const __Vtbl_u3dbd2b1dd7cbef42);
                    ((*__vt).vfn_u1fa7b5910ad68e36)(__obj)
                };
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    ...
    pub unsafe fn resume(__this: *const Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                (*((__this as *mut ACE_Service_Type))).active_ = true;
                return {
                    let __obj: *mut ACE_Service_Type_Impl = ((*__this).type_)
                        as *mut ACE_Service_Type_Impl;
                    let __vt: *const __Vtbl_u3dbd2b1dd7cbef42 = *(__obj
                        as *const *const __Vtbl_u3dbd2b1dd7cbef42);
                    ((*__vt).vfn_ufb021615b2c33acd)(__obj)
                };
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    ...
    pub unsafe fn fini(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/Service_Object.cpp\0"
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        (ace___) as *mut ACE_Log_Category_TSS,
                                        LM_DEBUG,
                                        ((b"ACE (%P|%t) ST::fini - destroying name=%s, dll=%s\n\0"
                                            .as_ptr() as *const libc::c_char) as *const libc::c_char),
                                        (*__this).name_,
                                        (*::core::ptr::addr_of!((* __this).dll_)
                                            .cast::<ACE_DLL>()
                                            .cast_mut())
                                            .dll_name_,
                                    );
                ...
                if (((*__this).fini_already_called_ as libc::c_int) != 0) {
                    return 0;
                }
                (*__this).fini_already_called_ = true;
                if ((((((*__this).type_).is_null()) as libc::c_int) as libc::c_int) != 0)
                {
                    return 1;
                }
                let mut ret: libc::c_int = (({
                    ...
                    let __vt: *const __Vtbl_u3dbd2b1dd7cbef42 = *(__obj
                        as *const *const __Vtbl_u3dbd2b1dd7cbef42);
                    ((*__vt).vfn_u08d39263417e9b0e)(__obj)
                }) as libc::c_int);
                (*__this).type_ = ((0) as *const ACE_Service_Type_Impl);
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ACE_OS::fprintf_u7a83295f0e5d324f(
                    stderr,
                    ((b"// [ST] dump, this=%p, name=%s, type=%p, so=%p, active=%d\n\0"
                        .as_ptr() as *const libc::c_char) as *const libc::c_char),
                    (__this as *const libc::c_void),
                    (*__this).name_,
                    ((*__this).type_ as *const libc::c_void),
                    if (((((!((*__this).type_).is_null()) as libc::c_int))
                        as libc::c_int) != 0)
                    {
                        <ACE_Service_Type_Impl>::object(
                            ((*__this).type_) as *const ACE_Service_Type_Impl,
                        )
                    } else {
                        ((0) as *mut libc::c_void)
                    },
                    (((*__this).active_) as libc::c_int),
                );
            }
            ()
        }
...
impl ACE_Service_Object {
    ///Constructor.
    pub unsafe fn new_at(__this: *mut Self, mut r: *mut ACE_Reactor) {
        unsafe {
            ::core::ptr::write(
                __this,
                ::core::mem::MaybeUninit::<Self>::zeroed().assume_init(),
            ...
            <ACE_Shared_Object>::new_at(
                ::core::ptr::addr_of_mut!((* __this).__base_1)
                    .cast::<ACE_Shared_Object>(),
            );
            *(__this as *mut *const ()) = &__VTBL_u1f27e317a855b000
                as *const __Vtbl_u1f27e317a855b000 as *const ();
            *(::core::ptr::addr_of!(
                (* ::core::ptr::addr_of!((* __this).__base_1) .cast:: < ACE_Shared_Object
                > ().cast_mut())
            )
                .cast_mut() as *mut *const ()) = &__VTBL_s1_mdu1f27e317a855b000
                as *const __Vtbl_u9a97f8219f30fcec as *const ();
            {}
            ()
        }
    }
