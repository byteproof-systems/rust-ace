...
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Sub_Barrier {
    pub barrier_finished_: ::core::mem::ManuallyDrop<ACE_Condition_ACE_Thread_Mutex_>,
    pub running_threads_: libc::c_int,
}
#[export_name = "_ZN15ACE_Sub_BarrierC1EjR16ACE_Thread_MutexPKcPv"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Sub_BarrierC1EjR16ACE_Thread_MutexPKcPv(
    __this: *mut ACE_Sub_Barrier,
    __a0: libc::c_uint,
    __a1: *mut ACE_Thread_Mutex,
    __a2: *const libc::c_char,
    __a3: *mut libc::c_void,
) {
    ACE_Sub_Barrier::new_at(__this, __a0, __a1, __a2, __a3)
}
impl Drop for ACE_Sub_Barrier {
    fn drop(&mut self) {
        {
            unsafe {
                let __this: *mut Self = self as *mut Self;
        ...
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.barrier_finished_);
        }
    }
}
pub unsafe extern "C-unwind" fn __acedtor_u8d5867aeda1604cb(
    __this: *mut ACE_Sub_Barrier,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
impl Drop for ACE_Barrier {
    fn drop(&mut self) {
        ...
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.sub_barrier_2_);
            ::core::mem::ManuallyDrop::drop(&mut self.sub_barrier_1_);
            ::core::mem::ManuallyDrop::drop(&mut self.lock_);
        }
    }
}
pub unsafe extern "C-unwind" fn __acedtor_u04405cd1add0c0b2(__this: *mut ACE_Barrier) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
    }
}
#[export_name = "_ZN11ACE_Barrier4waitEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_Barrier4waitEv(
    __this: *mut ACE_Barrier,
) -> libc::c_int {
    unsafe { ACE_Barrier::wait(__this) }
}
#[export_name = "_ZN11ACE_Barrier8shutdownEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_Barrier8shutdownEv(
    __this: *mut ACE_Barrier,
) -> libc::c_int {
    unsafe { ACE_Barrier::shutdown(__this) }
}
#[export_name = "_ZNK11ACE_Barrier4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK11ACE_Barrier4dumpEv(
    __this: *const ACE_Barrier,
) {
    unsafe { ACE_Barrier::dump(__this) }
}
#[doc = "* @class ACE_Thread_Barrier\n *\n * @brief Implements \"barrier synchronization\" using ACE_Thread_Mutexes!\n *\n * This class is just a simple wrapper for ACE_Barrier that\n * selects the USYNC_THREAD variant for the locks."]
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Thread_Barrier {
    pub __base_0: ::core::mem::ManuallyDrop<ACE_Barrier>,
}
#[export_name = "_ZN18ACE_Thread_BarrierC1EjPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_Thread_BarrierC1EjPKc(
    __this: *mut ACE_Thread_Barrier,
    __a0: libc::c_uint,
    __a1: *const libc::c_char,
) {
    ACE_Thread_Barrier::new_at(__this, __a0, __a1)
}
impl Drop for ACE_Thread_Barrier {
    fn drop(&mut self) {
        {
            unsafe {
                let __this: *mut Self = self as *mut Self;
...
pub unsafe extern "C-unwind" fn __acedtor_u004e526ee9c17e5f(
    __this: *mut ACE_Thread_Barrier,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[export_name = "_ZNK18ACE_Thread_Barrier4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK18ACE_Thread_Barrier4dumpEv(
    __this: *const ACE_Thread_Barrier,
) {
    unsafe { ACE_Thread_Barrier::dump(__this) }
}
#[repr(C)]
#[derive(Clone)]
    ...
    pub unsafe fn new_at(
        ...
        unsafe {
            ...
            <ACE_Condition_ACE_Thread_Mutex_>::new_at(
                (::core::ptr::addr_of_mut!((* __this).barrier_finished_)
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).running_threads_),
                ((count) as libc::c_int),
            );
            {}
            ()
...
impl ACE_Barrier {
    ...
    pub unsafe fn new_at(
        ...
        unsafe {
            ...
            <ACE_Thread_Mutex>::new_at(
                ...
                name,
                (arg as *mut pthread_mutexattr_t),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).current_generation_),
                0,
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).count_),
                ((count) as libc::c_int),
            );
            <ACE_Sub_Barrier>::new_at(
                (::core::ptr::addr_of_mut!((* __this).sub_barrier_1_)
                    .cast::<ACE_Sub_Barrier>()) as *mut ACE_Sub_Barrier,
                count,
                ::core::ptr::addr_of_mut!(
            ...
            <ACE_Sub_Barrier>::new_at(
                (::core::ptr::addr_of_mut!((* __this).sub_barrier_2_)
                    .cast::<ACE_Sub_Barrier>()) as *mut ACE_Sub_Barrier,
                count,
                ::core::ptr::addr_of_mut!(
                    (* ::core::ptr::addr_of!((* __this).lock_) .cast:: < ACE_Thread_Mutex
            ...
            {
                (*((((*__this).sub_barrier_).as_ptr() as *mut *mut ACE_Sub_Barrier)
                    .wrapping_offset((0) as isize))) = ::core::ptr::addr_of_mut!(
                    (* ::core::ptr::addr_of!((* __this).sub_barrier_1_) .cast:: <
                    ACE_Sub_Barrier > ().cast_mut())
                ) as *mut ACE_Sub_Barrier;
                (*((((*__this).sub_barrier_).as_ptr() as *mut *mut ACE_Sub_Barrier)
                    .wrapping_offset((1) as isize))) = ::core::ptr::addr_of_mut!(
                    (* ::core::ptr::addr_of!((* __this).sub_barrier_2_) .cast:: <
                    ACE_Sub_Barrier > ().cast_mut())
                ) as *mut ACE_Sub_Barrier;
            }
            ()
  ...
  /// down (@sa shutdown ()).*/
    pub unsafe fn wait(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                let mut sbp: *mut ACE_Sub_Barrier = (*((((*__this).sub_barrier_).as_ptr()
                    as *mut *mut ACE_Sub_Barrier)
                    .wrapping_offset(((*__this).current_generation_) as isize)));
                if (((((sbp).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    ((*(__errno_location()))) = 108;
                    return (-((1) as libc::c_int));
                }
                let mut retval: libc::c_int = 0;
                if ((((((*sbp).running_threads_ as libc::c_int))
                    == (((1) as libc::c_int))) as libc::c_int as libc::c_int) != 0)
                {
                    (*sbp).running_threads_ = (*__this).count_;
                    (*__this).current_generation_ = (((1) as libc::c_int))
                        .wrapping_sub(((*__this).current_generation_) as libc::c_int);
                    <ACE_Condition_ACE_Thread_Mutex_>::broadcast(
                        (::core::ptr::addr_of_mut!(
                            (* ::core::ptr::addr_of!((* sbp).barrier_finished_) .cast:: <
                            ACE_Condition_ACE_Thread_Mutex_ > ().cast_mut())
                        )) as *mut ACE_Condition_ACE_Thread_Mutex_,
                    );
                } else {
                    {
                        let __lv = &mut ((*sbp).running_threads_);
                        *__lv = (*__lv).wrapping_sub(1);
                        *__lv
                    };
                    'while_0: loop {
                        if !(((((((*sbp).running_threads_ as libc::c_int))
                            != ((((*__this).count_) as libc::c_int))) as libc::c_int
                            as libc::c_int) != 0))
                        {
                            break 'while_0;
                        }
                        'cont_0: loop {
                            {
                                <ACE_Condition_ACE_Thread_Mutex_>::wait_u7b23a5781005aed8(
                                    (::core::ptr::addr_of_mut!(
                                        (* ::core::ptr::addr_of!((* sbp).barrier_finished_) .cast::
                                        < ACE_Condition_ACE_Thread_Mutex_ > ().cast_mut())
                                    )) as *mut ACE_Condition_ACE_Thread_Mutex_,
  ...
  /// @since ACE beta 5.4.9.*/
    pub unsafe fn shutdown(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut ace_mon: ACE_Guard_ACE_Thread_Mutex_ = ::core::mem::MaybeUninit::<
                ...
                (*((((*__this).sub_barrier_).as_ptr() as *mut *mut ACE_Sub_Barrier)
                    .wrapping_offset((0) as isize))) = ((0) as *mut ACE_Sub_Barrier);
                (*((((*__this).sub_barrier_).as_ptr() as *mut *mut ACE_Sub_Barrier)
                    .wrapping_offset((1) as isize))) = ((0) as *mut ACE_Sub_Barrier);
                (*sbp).running_threads_ = (*__this).count_;
                <ACE_Condition_ACE_Thread_Mutex_>::broadcast(
                    (::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* sbp).barrier_finished_) .cast:: <
    ...
    pub unsafe fn operator_assign(__this: *mut Self, mut _anon_0: *const ACE_Barrier) {
        extern "C-unwind" {
            #[link_name = "_ZN11ACE_BarrieraSERKS_"]
            fn __ext(__this: *mut ACE_Barrier, _anon_0: *const ACE_Barrier);
        }
        __ext(__this as *mut ACE_Barrier, _anon_0)
    }
    pub unsafe fn new_at_u8d94a1976a2744e0(
        __this: *mut Self,
        mut __a0: *const ACE_Barrier,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN11ACE_BarrierC1ERKS_"]
            fn __ext(__this: *mut ACE_Barrier, __a0: *const ACE_Barrier);
        }
        __ext(__this as *mut ACE_Barrier, __a0)
    }
    pub unsafe fn new_u8d94a1976a2744e0(mut __a0: *const ACE_Barrier) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_u8d94a1976a2744e0(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
}
impl ACE_Thread_Barrier {
    ...
    pub unsafe fn new_at(
        ...
        unsafe {
            ...
            <ACE_Barrier>::new_at(
                (::core::ptr::addr_of_mut!((* __this).__base_0).cast::<ACE_Barrier>())
                    as *mut ACE_Barrier,
                count,
                name,
    ...
    pub unsafe fn new(mut __a0: libc::c_uint, mut __a1: *const libc::c_char) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at(::core::ptr::addr_of_mut!(__obj), __a0, __a1);
        __obj
    }
