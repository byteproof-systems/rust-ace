...
#[export_name = "_ZN11ACE_ObchunkC1Em"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_ObchunkC1Em(
    __this: *mut ACE_Obchunk,
    __a0: libc::c_ulong,
) {
    ACE_Obchunk::new_at(__this, __a0)
}
#[export_name = "_ZNK11ACE_Obchunk4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK11ACE_Obchunk4dumpEv(
    __this: *const ACE_Obchunk,
) {
    unsafe { ACE_Obchunk::dump(__this) }
}
extern "C-unwind" {
