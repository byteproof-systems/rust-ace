...
pub mod ACE_OS {
    ...
    #[export_name = "_ZN6ACE_OS17wcsicmp_emulationEPKwS1_"]
    pub unsafe extern "C-unwind" fn wcsicmp_emulation(
        mut s: *const libc::wchar_t,
        mut t: *const libc::wchar_t,
    ) -> libc::c_int {
        unsafe {
            {
                let mut scan1: *const libc::wchar_t = s;
                let mut scan2: *const libc::wchar_t = t;
                'while_0: loop {
                    if !(((((((((((*(scan1)) as libc::wchar_t))
                        != (((0) as libc::wchar_t))) as libc::c_int as libc::c_int) != 0)
                        && (((((ace_towlower((((*(scan1))) as libc::c_uint))
                            as libc::c_uint))
                            == (((ace_towlower((((*(scan2))) as libc::c_uint)))
                        ...
                        as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
                {
                        ...
                        as libc::c_int) != 0)
                    {
                        ...
                        if ((((((*(scan2)) as libc::wchar_t))
                            == (((0 as libc::c_char) as libc::wchar_t))) as libc::c_int
                            as libc::c_int) != 0)
                        {
                            return 1;
                        } else {
                            return (((((ace_tolower((((*(scan1))) as libc::c_int)))
                                as libc::c_uint))
                                .wrapping_sub(
                                    (ace_towlower((((*(scan2))) as libc::c_uint)))
                                        as libc::c_uint,
  ...
  /// arrays*/
    #[export_name = "_ZN6ACE_OS18wcsnicmp_emulationEPKwS1_m"]
    pub unsafe extern "C-unwind" fn wcsnicmp_emulation(
        mut s: *const libc::wchar_t,
        mut t: *const libc::wchar_t,
        ...
        unsafe {
            {
                let mut scan1: *const libc::wchar_t = s;
                let mut scan2: *const libc::wchar_t = t;
                let mut count: libc::c_ulong = ((0) as libc::c_ulong);
                'while_0: loop {
                    if !(((((((((((((({
                        let __lv = &mut (count);
                        let __r = *__lv;
                        *__lv = (*__lv).wrapping_add(1);
                        __r
                    } as libc::c_ulong)) < (((len) as libc::c_ulong))) as libc::c_int
                        as libc::c_int) != 0)
                        && ((((((*(scan1)) as libc::wchar_t))
                            != (((0) as libc::wchar_t))) as libc::c_int as libc::c_int)
                ...
                if (((((count as libc::c_ulong)) > (((len) as libc::c_ulong)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    return 0;
                }
                        ...
                        as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
                {
                        ...
                        as libc::c_int) != 0)
                    {
                            ...
                            as libc::c_int) != 0)
                        {
                            ...
                            return (((((ace_towlower((((*(scan1))) as libc::c_uint)))
                                as libc::c_uint))
                                .wrapping_sub(
                                    (ace_towlower((((*(scan2))) as libc::c_uint)))
                                        as libc::c_uint,
