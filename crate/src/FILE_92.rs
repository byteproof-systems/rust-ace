...
#[export_name = "_ZN8ACE_FILE5closeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_FILE5closeEv(
    __this: *mut ACE_FILE,
) -> libc::c_int {
    unsafe { ACE_FILE::close(__this) }
}
#[export_name = "_ZN8ACE_FILE6removeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_FILE6removeEv(
    __this: *mut ACE_FILE,
) -> libc::c_int {
    unsafe { ACE_FILE::remove(__this) }
}
#[export_name = "_ZN8ACE_FILE6unlinkEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_FILE6unlinkEv(
    __this: *mut ACE_FILE,
) -> libc::c_int {
    unsafe { ACE_FILE::unlink(__this) }
}
#[export_name = "_ZN8ACE_FILE8get_infoEP13ACE_FILE_Info"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_FILE8get_infoEP13ACE_FILE_Info(
    __this: *mut ACE_FILE,
    finfo: *mut ACE_FILE_Info,
) -> libc::c_int {
    unsafe { ACE_FILE::get_info(__this, finfo) }
}
#[export_name = "_ZN8ACE_FILE8get_infoER13ACE_FILE_Info"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_FILE8get_infoER13ACE_FILE_Info(
    __this: *mut ACE_FILE,
    finfo: *mut ACE_FILE_Info,
) -> libc::c_int {
    unsafe { ACE_FILE::get_info_u51a63f950b675b19(__this, finfo) }
}
#[export_name = "_ZN8ACE_FILE8truncateEl"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_FILE8truncateEl(
    __this: *mut ACE_FILE,
    length: libc::c_long,
) -> libc::c_int {
    unsafe { ACE_FILE::truncate(__this, length) }
}
#[export_name = "_ZN8ACE_FILE4seekEli"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_FILE4seekEli(
    __this: *mut ACE_FILE,
    offset: libc::c_long,
    startpos: libc::c_int,
) -> libc::c_long {
    unsafe { ACE_FILE::seek(__this, offset, startpos) }
}
#[export_name = "_ZN8ACE_FILE4tellEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_FILE4tellEv(
    __this: *mut ACE_FILE,
) -> libc::c_long {
    unsafe { ACE_FILE::tell(__this) }
}
#[export_name = "_ZNK8ACE_FILE14get_local_addrER8ACE_Addr"]
pub unsafe extern "C-unwind" fn __xtu__ZNK8ACE_FILE14get_local_addrER8ACE_Addr(
    __this: *const ACE_FILE,
    addr: *mut ACE_Addr,
) -> libc::c_int {
    unsafe { ACE_FILE::get_local_addr(__this, addr) }
}
#[export_name = "_ZNK8ACE_FILE15get_remote_addrER8ACE_Addr"]
pub unsafe extern "C-unwind" fn __xtu__ZNK8ACE_FILE15get_remote_addrER8ACE_Addr(
    __this: *const ACE_FILE,
    addr: *mut ACE_Addr,
) -> libc::c_int {
    unsafe { ACE_FILE::get_remote_addr(__this, addr) }
}
#[export_name = "_ZNK8ACE_FILE4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK8ACE_FILE4dumpEv(__this: *const ACE_FILE) {
    unsafe { ACE_FILE::dump(__this) }
}
#[export_name = "_ZN8ACE_FILEC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_FILEC1Ev(__this: *mut ACE_FILE) {
    ACE_FILE::new_at(__this)
}
extern "C-unwind" {
  ...
  /// the file system.*/
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                if (((((<ACE_IO_SAP>::get_handle(
                    ...
                    as libc::c_int as libc::c_int) != 0)
                {
                    result = ACE_OS::close_u07c1eb6343f8c667(
    ...
    pub unsafe fn remove(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                <ACE_FILE>::close((__this) as *mut ACE_FILE);
                return ACE_OS::unlink_ucc448fde77c19cbd(
                    ((<ACE_FILE_Addr>::get_path_name(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* __this).addr_) .cast:: <
  ...
  /// ACE_FILE handle.*/
    ...
    pub unsafe fn get_info(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut filestatus: stat = unsafe {
                    ::core::mem::MaybeUninit::<stat>::zeroed().assume_init()
                };
                let mut result: libc::c_int = ((ACE_OS::fstat_u4a66c24ea8739c1b(
                    <ACE_IO_SAP>::get_handle(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                            ACE_IO_SAP > ().cast_mut())
                    ...
                    ::core::ptr::addr_of_mut!(filestatus) as *mut stat,
                )) as libc::c_int);
                if (((((result as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    (*finfo).mode_ = ((filestatus.st_mode) as libc::c_uint);
                    (*finfo).nlink_ = ((filestatus.st_nlink) as libc::c_ulong);
                    (*finfo).size_ = ((filestatus.st_size) as libc::c_long);
                }
    ...
    pub unsafe fn get_info_u51a63f950b675b19(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return <ACE_FILE>::get_info(
                    (__this) as *mut ACE_FILE,
                    ::core::ptr::addr_of_mut!((* finfo)) as *mut ACE_FILE_Info,
                );
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    ...
    pub unsafe fn truncate(__this: *mut Self, mut length: libc::c_long) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return ACE_OS::ftruncate_uc81bc2f492b8838e(
                    <ACE_IO_SAP>::get_handle(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                            ACE_IO_SAP > ().cast_mut())
    ...
    pub unsafe fn seek(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return ACE_OS::lseek_u7c6593c8f5712dbe(
                    <ACE_IO_SAP>::get_handle(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                            ACE_IO_SAP > ().cast_mut())
  ...
  /// Returns 0 if successful, else -1.*/
    pub unsafe fn get_local_addr(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut file_addr: *mut ACE_FILE_Addr = (::core::ptr::addr_of_mut!(
                    (* addr)
                ) as *mut ACE_Addr as *mut ACE_FILE_Addr);
                if (((((file_addr).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    return (-((1) as libc::c_int));
                } else {
                    <ACE_FILE_Addr>::operator_assign(
                        (file_addr) as *mut ACE_FILE_Addr,
                        ::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* __this).addr_) .cast:: <
                            ACE_FILE_Addr > ().cast_mut())
                        ),
    ...
    pub unsafe fn get_remote_addr(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return <ACE_FILE>::get_local_addr(
                    (__this) as *const ACE_FILE,
  ...
  /// ACE_FILE_Connector.*/
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ...
            <ACE_IO_SAP>::new_at(
                ::core::ptr::addr_of_mut!((* __this).__base_0).cast::<ACE_IO_SAP>(),
            );
            <ACE_FILE_Addr>::new_at(
                ::core::ptr::addr_of_mut!((* __this).addr_).cast::<ACE_FILE_Addr>(),
            );
            {}
            ()
        }
