...
#[doc = "* @class ACE_Bcast_Node\n *\n * @brief Linked list of broadcast interfaces."]
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Bcast_Node {
    pub bcast_addr_: ::core::mem::ManuallyDrop<ACE_INET_Addr>,
    pub next_: *mut ACE_Bcast_Node,
}
#[export_name = "_ZN14ACE_Bcast_NodeC1ER13ACE_INET_AddrPS_"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Bcast_NodeC1ER13ACE_INET_AddrPS_(
    __this: *mut ACE_Bcast_Node,
    __a0: *mut ACE_INET_Addr,
    __a1: *mut ACE_Bcast_Node,
) {
    ACE_Bcast_Node::new_at(__this, __a0, __a1)
}
impl Drop for ACE_Bcast_Node {
    fn drop(&mut self) {
        {
            unsafe {
                let __this: *mut Self = self as *mut Self;
        ...
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.bcast_addr_);
        }
    }
}
pub unsafe extern "C-unwind" fn __acedtor_u87e38399f1003401(
    __this: *mut ACE_Bcast_Node,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[doc = "* @class ACE_SOCK_Dgram_Bcast\n *\n * @brief Defines the member functions for the ACE_SOCK datagram\n * abstraction."]
#[repr(C)]
#[derive(Clone)]
pub struct ACE_SOCK_Dgram_Bcast {
    pub __base_0: ::core::mem::ManuallyDrop<ACE_SOCK_Dgram>,
    pub if_list_: *mut ACE_Bcast_Node,
}
#[export_name = "_ZN20ACE_SOCK_Dgram_BcastC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_SOCK_Dgram_BcastC1Ev(
    __this: *mut ACE_SOCK_Dgram_Bcast,
) {
    ACE_SOCK_Dgram_Bcast::new_at(__this)
}
#[export_name = "_ZN20ACE_SOCK_Dgram_BcastC1ERK8ACE_AddriiiPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_SOCK_Dgram_BcastC1ERK8ACE_AddriiiPKc(
    __this: *mut ACE_SOCK_Dgram_Bcast,
    __a0: *const ACE_Addr,
    __a1: libc::c_int,
    __a2: libc::c_int,
    __a3: libc::c_int,
    __a4: *const libc::c_char,
) {
    ACE_SOCK_Dgram_Bcast::new_at_u001b924438692ba6(__this, __a0, __a1, __a2, __a3, __a4)
}
impl Drop for ACE_SOCK_Dgram_Bcast {
    fn drop(&mut self) {
        {
            unsafe {
                let __this: *mut Self = self as *mut Self;
...
pub unsafe extern "C-unwind" fn __acedtor_u3e91dfcbbddd93a1(
    __this: *mut ACE_SOCK_Dgram_Bcast,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[export_name = "_ZN20ACE_SOCK_Dgram_Bcast4openERK8ACE_AddriiiPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_SOCK_Dgram_Bcast4openERK8ACE_AddriiiPKc(
    __this: *mut ACE_SOCK_Dgram_Bcast,
...
#[export_name = "_ZN20ACE_SOCK_Dgram_Bcast5closeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_SOCK_Dgram_Bcast5closeEv(
    __this: *mut ACE_SOCK_Dgram_Bcast,
) -> libc::c_int {
    unsafe { ACE_SOCK_Dgram_Bcast::close(__this) }
}
#[export_name = "_ZNK20ACE_SOCK_Dgram_Bcast4sendEPKvmti"]
pub unsafe extern "C-unwind" fn __xtu__ZNK20ACE_SOCK_Dgram_Bcast4sendEPKvmti(
    __this: *const ACE_SOCK_Dgram_Bcast,
    buf: *const libc::c_void,
    n: libc::c_ulong,
    port_number: libc::c_ushort,
    flags: libc::c_int,
) -> libc::c_long {
    unsafe { ACE_SOCK_Dgram_Bcast::send(__this, buf, n, port_number, flags) }
}
#[export_name = "_ZNK20ACE_SOCK_Dgram_Bcast4sendEPK5ioveciti"]
pub unsafe extern "C-unwind" fn __xtu__ZNK20ACE_SOCK_Dgram_Bcast4sendEPK5ioveciti(
    __this: *const ACE_SOCK_Dgram_Bcast,
    iov: *const iovec,
    n: libc::c_int,
    port_number: libc::c_ushort,
    ...
    unsafe {
        ACE_SOCK_Dgram_Bcast::send_u3862ca230e24030d(__this, iov, n, port_number, flags)
    }
}
#[export_name = "_ZNK20ACE_SOCK_Dgram_Bcast4sendEPK5ioveciRK8ACE_Addri"]
pub unsafe extern "C-unwind" fn __xtu__ZNK20ACE_SOCK_Dgram_Bcast4sendEPK5ioveciRK8ACE_Addri(
    __this: *const ACE_SOCK_Dgram_Bcast,
    iov: *const iovec,
    n: libc::c_int,
    addr: *const ACE_Addr,
    ...
    unsafe { ACE_SOCK_Dgram_Bcast::send_u8f1c7a3c11750e39(__this, iov, n, addr, flags) }
}
#[export_name = "_ZNK20ACE_SOCK_Dgram_Bcast4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK20ACE_SOCK_Dgram_Bcast4dumpEv(
    __this: *const ACE_SOCK_Dgram_Bcast,
) {
    unsafe { ACE_SOCK_Dgram_Bcast::dump(__this) }
}
#[export_name = "_ZN20ACE_SOCK_Dgram_Bcast12mk_broadcastEPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_SOCK_Dgram_Bcast12mk_broadcastEPKc(
    __this: *mut ACE_SOCK_Dgram_Bcast,
    host_name: *const libc::c_char,
) -> libc::c_int {
    unsafe { ACE_SOCK_Dgram_Bcast::mk_broadcast(__this, host_name) }
}
...
impl ACE_Bcast_Node {
    ...
    pub unsafe fn new_at(
        __this: *mut Self,
        mut addr: *mut ACE_INET_Addr,
        mut next: *mut ACE_Bcast_Node,
    ) {
        unsafe {
            ::core::ptr::write(
                __this,
            ...
            <ACE_INET_Addr>::new_at_ufdc256446431ae0e(
                (::core::ptr::addr_of_mut!((* __this).bcast_addr_)
                    .cast::<ACE_INET_Addr>()) as *mut ACE_INET_Addr,
                ::core::ptr::addr_of!((* addr)),
            );
    ...
    pub unsafe fn new(
        mut __a0: *mut ACE_INET_Addr,
        mut __a1: *mut ACE_Bcast_Node,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
...
impl ACE_SOCK_Dgram_Bcast {
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).if_list_),
                ((0) as *mut ACE_Bcast_Node),
            );
            {}
            ()
        }
    ...
    pub unsafe fn new_at_u001b924438692ba6(
        __this: *mut Self,
        mut local: *const ACE_Addr,
        mut protocol_family: libc::c_int,
        mut protocol: libc::c_int,
        ...
        unsafe {
            ...
            <ACE_SOCK_Dgram>::new_at_ua68fcd6094aa1f6f(
                (::core::ptr::addr_of_mut!((* __this).__base_0).cast::<ACE_SOCK_Dgram>())
                    as *mut ACE_SOCK_Dgram,
                ::core::ptr::addr_of!((* local)),
                protocol_family,
                protocol,
                reuse_addr,
                0,
            ...
            {
                if (((((<ACE_SOCK_Dgram_Bcast>::mk_broadcast(
                    (__this) as *mut ACE_SOCK_Dgram_Bcast,
                    host_name,
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/SOCK_Dgram_Bcast.cpp\0"
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        b"ACE_SOCK_Dgram_Bcast\0".as_ptr() as *const libc::c_char,
                                    );
                                }
                            }
    ...
    pub unsafe fn new_u001b924438692ba6(
        mut __a0: *const ACE_Addr,
        mut __a1: libc::c_int,
        mut __a2: libc::c_int,
        mut __a3: libc::c_int,
        mut __a4: *const libc::c_char,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_u001b924438692ba6(
            ::core::ptr::addr_of_mut!(__obj),
            __a0,
            __a1,
            __a2,
    ...
    pub unsafe fn open(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                return <ACE_SOCK_Dgram_Bcast>::mk_broadcast(
                    (__this) as *mut ACE_SOCK_Dgram_Bcast,
                    host_name,
                );
            }
    ...
    pub unsafe fn close(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut temp: *mut ACE_Bcast_Node = (*__this).if_list_;
                (*__this).if_list_ = ((0) as *mut ACE_Bcast_Node);
                'while_0: loop {
                    ...
                    'cont_0: loop {
                        {
                            {
                                let mut hold: *mut ACE_Bcast_Node = (*temp).next_;
                                {
                                    let __d = temp;
                                    if !__d.is_null() {
                                        let _ = Box::from_raw(__d as *mut ACE_Bcast_Node);
                                    }
                                };
                                temp = hold;
                            }
  ...
  /// number of bytes sent.*/
    pub unsafe fn send(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut iterations: libc::c_long = ((0) as libc::c_long);
                let mut total_bytes: libc::c_long = ((0) as libc::c_long);
                if ((((((*__this).if_list_).is_null()) as libc::c_int) as libc::c_int)
                    != 0)
                {
                            ...
                            {
                                {
                                    <ACE_INET_Addr>::set_port_number(
                                        (::core::ptr::addr_of_mut!(
                                            (* ::core::ptr::addr_of!((* temp).bcast_addr_) .cast:: <
                                            ACE_INET_Addr > ().cast_mut())
                                        )) as *mut ACE_INET_Addr,
                                        port_number,
                                        1,
                                    );
                                    let mut bytes_sent: libc::c_long = <ACE_SOCK_Dgram>::send(
                                        (::core::ptr::addr_of!(
                                            (* ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                                            ACE_SOCK_Dgram > ().cast_mut())
                                        ...
                                        n,
                                        ::core::ptr::addr_of!(
                                            (* ::core::ptr::addr_of!(((* ::core::ptr::addr_of!((* temp)
                                            .bcast_addr_) .cast:: < ACE_INET_Addr > ().cast_mut()))
                                            .__base_0) .cast:: < ACE_Addr > ().cast_mut())
                                        ) as *const ACE_Addr,
                                        flags,
                                    );
                                    if (((((bytes_sent as libc::c_long))
                                        ...
                                        as libc::c_int as libc::c_int) != 0)
                                    {
                                        ...
                                        {
                                            total_bytes = (((total_bytes) as libc::c_long))
                                                .wrapping_add((bytes_sent) as libc::c_long);
                                            total_bytes
                                        };
                                    }
                                    {
                                        let __lv = &mut (iterations);
                                        let __r = *__lv;
                                        *__lv = (*__lv).wrapping_add(1);
                                        __r
                                    };
                ...
                return if (((((iterations as libc::c_long)) == (((0) as libc::c_long)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    ((0) as libc::c_long)
                } else {
                    (((total_bytes) as libc::c_long)) / ((iterations) as libc::c_long)
                };
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
  ...
  /// average number of bytes sent.*/
    pub unsafe fn send_u3862ca230e24030d(
        __this: *const Self,
        mut iov: *const iovec,
        mut n: libc::c_int,
        mut port_number: libc::c_ushort,
                            ...
                            {
                                {
                                    ...
                                    if (((((<ACE_SOCK_Dgram>::send_u70f4838a8668f181(
                                        (::core::ptr::addr_of!(
                                            (* ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                                            ACE_SOCK_Dgram > ().cast_mut())
                                        )) as *const ACE_SOCK_Dgram,
  ...
  /// preassigned to the broadcast address of the subnet...).*/
    pub unsafe fn send_u89616d4067f32c8f(
        __this: *const Self,
        mut buf: *const libc::c_void,
        mut n: libc::c_ulong,
        mut addr: *const ACE_Addr,
    ...
    #[doc = "* Broadcast an @a iovec of size @a n to @a addr as a datagram (note\n   * that addr must be preassigned to the broadcast address of the\n   * subnet...)"]
    pub unsafe fn send_u8f1c7a3c11750e39(
        __this: *const Self,
        mut iov: *const iovec,
        mut n: libc::c_int,
        mut addr: *const ACE_Addr,
    ...
    pub unsafe fn mk_broadcast(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                if (((((ACE_OS::setsockopt_u491187844361ffa3(
                    <ACE_IPC_SAP>::get_handle(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((*
                            ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        b"ACE_SOCK_Dgram_Bcast::mk_broadcast: setsockopt failed\0"
                ...
                let mut s: libc::c_int = <ACE_IPC_SAP>::get_handle(
                    (::core::ptr::addr_of!(
                        (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((*
                        ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                        ACE_SOCK_Dgram > ().cast_mut()).__base_0) .cast:: < ACE_SOCK > ()
                ...
                let mut ifc: ifconf = unsafe {
                    ::core::mem::MaybeUninit::<ifconf>::zeroed().assume_init()
                };
                ifc.ifc_len = ((::core::mem::size_of::<[libc::c_char; 8192usize]>()
                    as libc::c_ulong) as libc::c_int);
                ifc.ifc_ifcu.ifcu_buf = ((buf).as_mut_ptr() as *mut libc::c_char);
                if (((((ACE_OS::ioctl_u5ac77b5f0779af02(
                    s,
                    ((35090) as libc::c_ulong),
                    (((::core::ptr::addr_of_mut!(ifc) as *mut ifconf
                        as *mut libc::c_char)) as *mut libc::c_void),
                ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        b"ACE_SOCK_Dgram_Bcast::mk_broadcast: ioctl (get interface configuration)\0"
                                            .as_ptr() as *const libc::c_char,
                                    );
                                    return (-((1) as libc::c_int));
                                }
                ...
                let mut ifr: *mut ifreq = ifc.ifc_ifcu.ifcu_req;
                let mut host_addr: sockaddr_in = unsafe {
                    ::core::mem::MaybeUninit::<sockaddr_in>::zeroed().assume_init()
                };
                if (!(host_name).is_null()) {
                    let mut hp: *mut hostent = ((ACE_OS::gethostbyname_ubf26fe0a4f84901c(
                        ((host_name) as *const libc::c_char),
                    )) as *mut hostent);
                    if (((((hp).is_null()) as libc::c_int) as libc::c_int) != 0) {
                        return (-((1) as libc::c_int));
                    } else {
                        ACE_OS::memcpy_u6033eb81edaf9212(
                            (((::core::ptr::addr_of_mut!(host_addr.sin_addr.s_addr)
                                as *mut libc::c_uint as *mut libc::c_char))
                                as *mut libc::c_void),
                            ((((*((*hp).h_addr_list).wrapping_offset((0) as isize))
                ...
                {
                    let mut n: libc::c_int = (((((ifc.ifc_len) as libc::c_ulong))
                        / ((40) as libc::c_ulong)) as libc::c_int);
                    'for_2: loop {
                        ...
                        'cont_2: loop {
                            {
                                {
                                    if (!(host_name).is_null()) {
                                        let mut if_addr: sockaddr_in = unsafe {
                                            ::core::mem::MaybeUninit::<sockaddr_in>::zeroed()
                                                .assume_init()
                                        };
                                        ACE_OS::memcpy_u6033eb81edaf9212(
                                            ((::core::ptr::addr_of_mut!(if_addr) as *mut sockaddr_in)
                                                as *mut libc::c_void),
                                            ((::core::ptr::addr_of_mut!((* ifr).ifr_ifru.ifru_addr)
                                                as *mut sockaddr) as *const libc::c_void),
                                            ((::core::mem::size_of::<sockaddr_in>() as libc::c_ulong)
                                                as libc::c_ulong),
                                        );
                                        if (((((host_addr.sin_addr.s_addr as libc::c_uint))
                                            != (((if_addr.sin_addr.s_addr) as libc::c_uint)))
                                            as libc::c_int as libc::c_int) != 0)
                                        {
                                            break 'cont_2;
                                        }
                                    ...
                                    if ((((((*ifr).ifr_ifru.ifru_addr.sa_family as libc::c_int))
                                        ...
                                        != 0)
                                    {
                                        if ((((((((((*ifr).ifr_ifru.ifru_addr.sa_family
                                            as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                                            as libc::c_int) != 0)
                                                    ...
                                                    {
                                                        {
                                                            ...
                                                            <ACE_Log_Category_TSS>::log(
                                                                (ace___) as *mut ACE_Log_Category_TSS,
                                                                LM_DEBUG,
                                                                ((b"warning %p: sa_family: %d\n\0".as_ptr()
                                                                    as *const libc::c_char) as *const libc::c_char),
                                                                b"ACE_SOCK_Dgram_Bcast::mk_broadcast: Not AF_INET\0"
                                                                    .as_ptr() as *const libc::c_char,
                                    ...
                                    let mut flags: ifreq = (*(ifr));
                                    let mut if_req: ifreq = (*(ifr));
                                    if (((((ACE_OS::ioctl_u5ac77b5f0779af02(
                                        s,
                                        ((35091) as libc::c_ulong),
                                        (((::core::ptr::addr_of_mut!(flags) as *mut ifreq
                                            as *mut libc::c_char)) as *mut libc::c_void),
                                    ) as libc::c_int))
                                                ...
                                                {
                                                    {
                                                        ...
                                                        <ACE_Log_Category_TSS>::log(
                                                            ...
                                                            ((b"%p [%s]\n\0".as_ptr() as *const libc::c_char)
                                                                as *const libc::c_char),
                                                            b"ACE_SOCK_Dgram_Bcast::mk_broadcast: ioctl (get interface flags)\0"
                                                                .as_ptr() as *const libc::c_char,
                                                            ((flags.ifr_ifrn.ifrn_name).as_mut_ptr()
                                                                as *mut libc::c_char),
                                                        );
                                                    }
                                                }
                                                ...
                                                {
                                                    {
                                                        ...
                                                        <ACE_Log_Category_TSS>::log(
                                                            ...
                                                            ((b"%p [%s]\n\0".as_ptr() as *const libc::c_char)
                                                                as *const libc::c_char),
                                                            b"ACE_SOCK_Dgram_Bcast::mk_broadcast: Network interface is not up\0"
                                                                .as_ptr() as *const libc::c_char,
                                                            ((flags.ifr_ifrn.ifrn_name).as_mut_ptr()
                                                                as *mut libc::c_char),
                                                        );
                                    ...
                                    if (((((((((((flags.ifr_ifru.ifru_flags)) as libc::c_int))
                                        & ((((8 as libc::c_int))) as libc::c_int)) as libc::c_int))
                                        ...
                                        != 0)
                                    {
                                        if (((((ACE_OS::ioctl_u5ac77b5f0779af02(
                                            s,
                                            ((35097) as libc::c_ulong),
                                            (((::core::ptr::addr_of_mut!(if_req) as *mut ifreq
                                                as *mut libc::c_char)) as *mut libc::c_void),
                                        ) as libc::c_int))
                                            == ((((-((1) as libc::c_int))) as libc::c_int)))
                                            as libc::c_int as libc::c_int) != 0)
                                        {
                                                    ...
                                                    {
                                                        {
                                                            ...
                                                            <ACE_Log_Category_TSS>::log(
                                                                ...
                                                                ((b"%p [%s]\n\0".as_ptr() as *const libc::c_char)
                                                                    as *const libc::c_char),
                                                                b"ACE_SOCK_Dgram_Bcast::mk_broadcast: ioctl (get broadaddr)\0"
                                                                    .as_ptr() as *const libc::c_char,
                                                                ((flags.ifr_ifrn.ifrn_name).as_mut_ptr()
                                                                    as *mut libc::c_char),
                                                            );
                                            ...
                                            let mut addr: ACE_INET_Addr = ::core::mem::MaybeUninit::<
                                                ACE_INET_Addr,
                                            >::zeroed()
                                                .assume_init();
                                            <ACE_INET_Addr>::new_at_u7d57fae8a46ef0f3(
                                                (::core::ptr::addr_of_mut!(addr)) as *mut ACE_INET_Addr,
                                                ((::core::ptr::addr_of_mut!(if_req.ifr_ifru.ifru_broadaddr)
                                                ...
                                                'cont_7: loop {
                                                    {
                                                        {
                                                            (*__this).if_list_ = {
                                                                let __new: *mut ACE_Bcast_Node = Box::into_raw(
                                                                    Box::new(
                                                                        ::core::mem::MaybeUninit::<ACE_Bcast_Node>::zeroed()
                                                                            .assume_init(),
                                                                    ),
                                                                );
                                                                <ACE_Bcast_Node>::new_at(
                                                                    (__new) as *mut ACE_Bcast_Node,
                                                                    ::core::ptr::addr_of_mut!(addr),
                                                                    (*__this).if_list_,
                                                                );
                                                                __new
                                                            };
                                                            if ((((((*__this).if_list_).is_null()) as libc::c_int)
                                                                as libc::c_int) != 0)
                                                            {
                                                                ((*(__errno_location()))) = 12;
                                                                return (-((1) as libc::c_int));
                                            ...
                                            as libc::c_int) != 0)
                                        {
                                            'dowhile_8: loop {
                                                'cont_8: loop {
                                                    {
                                                        {
                                                            ...
                                                            <ACE_Log_Category_TSS>::log(
                                                                ...
                                                                ((b"%p [%s]\n\0".as_ptr() as *const libc::c_char)
                                                                    as *const libc::c_char),
                                                                b"ACE_SOCK_Dgram_Bcast::mk_broadcast: Broadcast is not enabled for this interface.\0"
                                                                    .as_ptr() as *const libc::c_char,
                                                                ((flags.ifr_ifrn.ifrn_name).as_mut_ptr()
                                                                    as *mut libc::c_char),
                                                            );
                                                    ...
                                                    #[allow(unreachable_code)] break 'cont_8;
                                                }
                                                if !(((0) != 0)) {
                                                    break 'dowhile_8;
                                                }
    ...
    pub unsafe fn get_remote_addr(
        ...
        extern "C-unwind" {
            #[link_name = "_ZNK20ACE_SOCK_Dgram_Bcast15get_remote_addrER8ACE_Addr"]
            fn __ext(
                __this: *const ACE_SOCK_Dgram_Bcast,
                _anon_0: *mut ACE_Addr,
            ) -> libc::c_int;
        }
        __ext(__this as *const ACE_SOCK_Dgram_Bcast, _anon_0)
    }
}
