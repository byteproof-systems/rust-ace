...
pub mod ACE_OS {
  ...
  /// quite right'' in its semantics.*/
    #[export_name = "_ZN6ACE_OS4openEPKciji"]
    pub unsafe extern "C-unwind" fn open_u20e73ad42bc94ee0(
        ...
        unsafe {
            {
                ...
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            return ((super::open(filename, mode, perms)) as libc::c_int);
                        }
    ...
    #[export_name = "_ZN6ACE_OS4openEPKwiji"]
    pub unsafe extern "C-unwind" fn open_u3ea2b23d28764574(
        mut filename: *const libc::wchar_t,
        mut mode: libc::c_int,
        mut perms: libc::c_uint,
        mut sa: libc::c_int,
    ) -> libc::c_int {
