...
#[allow(non_upper_case_globals)]
#[no_mangle]
pub static ACE_SV_Semaphore_Complex_BIGCOUNT_: libc::c_int = ((10000) as libc::c_int);
#[allow(non_upper_case_globals)]
#[no_mangle]
pub static mut ACE_SV_Semaphore_Complex_op_lock_: [sembuf; 2usize] = [
    sembuf {
        ...
        sem_flg: ((0) as libc::c_short),
    },
    sembuf {
        sem_num: ((0) as libc::c_ushort),
        sem_op: ((1) as libc::c_short),
        sem_flg: ((4096) as libc::c_short),
    },
];
#[allow(non_upper_case_globals)]
#[no_mangle]
...
#[export_name = "_ZN24ACE_SV_Semaphore_ComplexC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN24ACE_SV_Semaphore_ComplexC1Ev(
    __this: *mut ACE_SV_Semaphore_Complex,
) {
    ACE_SV_Semaphore_Complex::new_at(__this)
}
#[export_name = "_ZN24ACE_SV_Semaphore_ComplexC1Eisitj"]
pub unsafe extern "C-unwind" fn __xtu__ZN24ACE_SV_Semaphore_ComplexC1Eisitj(
    __this: *mut ACE_SV_Semaphore_Complex,
    __a0: libc::c_int,
    __a1: libc::c_short,
    __a2: libc::c_int,
    ...
    ACE_SV_Semaphore_Complex::new_at_u3bc50e9b4e06cc1a(
        __this,
        __a0,
        __a1,
        __a2,
...
#[export_name = "_ZN24ACE_SV_Semaphore_ComplexC1EPKcsitj"]
pub unsafe extern "C-unwind" fn __xtu__ZN24ACE_SV_Semaphore_ComplexC1EPKcsitj(
    __this: *mut ACE_SV_Semaphore_Complex,
    ...
    ACE_SV_Semaphore_Complex::new_at_ubf78377b304cccc5(
        __this,
        __a0,
        __a1,
        __a2,
            ...
            unsafe {
                let __this: *mut Self = self as *mut Self;
                {
                    if ((((((*::core::ptr::addr_of!((* __this).__base_0)
                        .cast::<ACE_SV_Semaphore_Simple>()
                        .cast_mut())
                        .internal_id_ as libc::c_int)) >= (((0) as libc::c_int)))
...
#[export_name = "__acedtor_u2b660f4dfa26342c"]
pub unsafe extern "C-unwind" fn __acedtor_u2b660f4dfa26342c(
    __this: *mut ACE_SV_Semaphore_Complex,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[export_name = "_ZN24ACE_SV_Semaphore_Complex4openEPKcsitj"]
pub unsafe extern "C-unwind" fn __xtu__ZN24ACE_SV_Semaphore_Complex4openEPKcsitj(
    __this: *mut ACE_SV_Semaphore_Complex,
    name: *const libc::c_char,
    flags: libc::c_short,
    ...
    unsafe {
        ACE_SV_Semaphore_Complex::open(__this, name, flags, initial_value, nsems, perms)
    }
}
#[export_name = "_ZN24ACE_SV_Semaphore_Complex4openEisitj"]
pub unsafe extern "C-unwind" fn __xtu__ZN24ACE_SV_Semaphore_Complex4openEisitj(
    __this: *mut ACE_SV_Semaphore_Complex,
    k: libc::c_int,
    create: libc::c_short,
    initial_value: libc::c_int,
    ...
    unsafe {
        ACE_SV_Semaphore_Complex::open_uddaba6ae1311aceb(
            __this,
            k,
            create,
            initial_value,
...
#[export_name = "_ZN24ACE_SV_Semaphore_Complex5closeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN24ACE_SV_Semaphore_Complex5closeEv(
    __this: *mut ACE_SV_Semaphore_Complex,
) -> libc::c_int {
    unsafe { ACE_SV_Semaphore_Complex::close(__this) }
}
#[export_name = "_ZNK24ACE_SV_Semaphore_Complex4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK24ACE_SV_Semaphore_Complex4dumpEv(
    __this: *const ACE_SV_Semaphore_Complex,
) {
    unsafe { ACE_SV_Semaphore_Complex::dump(__this) }
}
...
impl ACE_SV_Semaphore_Complex {
    ...
    pub unsafe fn new_at_u3bc50e9b4e06cc1a(
        ...
        unsafe {
            ...
            {
                if (((((<ACE_SV_Semaphore_Complex>::open_uddaba6ae1311aceb(
                    (__this) as *mut ACE_SV_Semaphore_Complex,
                    k,
                    flags,
                    initial_value,
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/SV_Semaphore_Complex.cpp\0"
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        b"ACE_SV_Semaphore_Complex\0".as_ptr()
                                            as *const libc::c_char,
                                    );
                                }
                            }
    ...
    pub unsafe fn new_at_ubf78377b304cccc5(
        ...
        unsafe {
            ...
            {
                let mut key: libc::c_int = ((1234) as libc::c_int);
                if ((((!(name).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    key = <ACE_SV_Semaphore_Simple>::name_2_key(
                        (::core::ptr::addr_of_mut!(
                            (* ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                            ACE_SV_Semaphore_Simple > ().cast_mut())
                        )) as *mut ACE_SV_Semaphore_Simple,
  ...
  /// OK, else -1.*/
    pub unsafe fn open(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return <ACE_SV_Semaphore_Complex>::open_uddaba6ae1311aceb(
                    (__this) as *mut ACE_SV_Semaphore_Complex,
                    <ACE_SV_Semaphore_Simple>::name_2_key(
                        (::core::ptr::addr_of_mut!(
                            (* ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                            ACE_SV_Semaphore_Simple > ().cast_mut())
                        )) as *mut ACE_SV_Semaphore_Simple,
  ...
  /// OK, else -1.*/
    pub unsafe fn open_uddaba6ae1311aceb(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((((k as libc::c_int)) == (((((0 as libc::c_int))) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                ...
                (*::core::ptr::addr_of!((* __this).__base_0)
                    .cast::<ACE_SV_Semaphore_Simple>()
                    .cast_mut())
                    .sem_number_ = (((nsems) as libc::c_int))
                    .wrapping_add((2) as libc::c_int);
                if (((((create as libc::c_int as libc::c_short))
                    == ((((512 as libc::c_int)) as libc::c_int as libc::c_short)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    ...
                    'dowhile_0: loop {
                            ...
                            {
                                {
                                    (*::core::ptr::addr_of!((* __this).__base_0)
                                        .cast::<ACE_SV_Semaphore_Simple>()
                                        .cast_mut())
                                        .internal_id_ = ACE_OS::semget_u459a57c0bbce4950(
                                        (*::core::ptr::addr_of!((* __this).__base_0)
                                            .cast::<ACE_SV_Semaphore_Simple>()
                                            .cast_mut())
                                            .key_,
                                        ((((2 as libc::c_ushort)) as libc::c_int))
                                            .wrapping_add((nsems) as libc::c_int),
                                        (((((perms) as libc::c_uint))
                                            | (((512 as libc::c_int)) as libc::c_uint)) as libc::c_int),
                                    );
                                    if ((((((*::core::ptr::addr_of!((* __this).__base_0)
                                        .cast::<ACE_SV_Semaphore_Simple>()
                                        .cast_mut())
                                        .internal_id_ as libc::c_int))
                                        == ((((-((1) as libc::c_int))) as libc::c_int)))
                                        as libc::c_int as libc::c_int) != 0)
                                    {
                                        return (-((1) as libc::c_int));
                                    }
                                    result = ACE_OS::semop_u80b06a9c8b5a703c(
                                        (*::core::ptr::addr_of!((* __this).__base_0)
                                            .cast::<ACE_SV_Semaphore_Simple>()
                                            .cast_mut())
                                            .internal_id_,
                                        ((::core::ptr::addr_of_mut!(
                                            (ACE_SV_Semaphore_Complex_op_lock_) [(0) as usize]
                                        ) as *mut sembuf) as *mut sembuf),
                                        ((2) as libc::c_ulong),
                                    );
                                }
                            }
                        ...
                        if !((((((((((result as libc::c_int))
                            ...
                            && ((((((((((((*(__errno_location()))) as libc::c_int))
                                == (((22) as libc::c_int))) as libc::c_int as libc::c_int)
                                != 0)
                                || (((((((*(__errno_location()))) as libc::c_int))
                                    == (((43) as libc::c_int))) as libc::c_int as libc::c_int)
                    ...
                    let mut semval: libc::c_int = <ACE_SV_Semaphore_Simple>::control_u8e0dfb2f98f572a5(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                            ACE_SV_Semaphore_Simple > ().cast_mut())
                        ...
                        as libc::c_int) != 0)
                    {
                        ...
                        if (((((semval as libc::c_int)) == (((0) as libc::c_int)))
                            as libc::c_int as libc::c_int) != 0)
                        {
                            if (((((<ACE_SV_Semaphore_Simple>::control_u8e0dfb2f98f572a5(
                                (::core::ptr::addr_of!(
                                    (* ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                                    ACE_SV_Semaphore_Simple > ().cast_mut())
                                )) as *const ACE_SV_Semaphore_Simple,
                                16,
                                ((ACE_SV_Semaphore_Complex_BIGCOUNT_) as libc::c_int),
                                ((1) as libc::c_ushort),
                            ) as libc::c_int))
                                == ((((-((1) as libc::c_int))) as libc::c_int)))
                                as libc::c_int as libc::c_int) != 0)
                            {
                                ...
                                {
                                    let mut i: libc::c_ushort = ((0) as libc::c_ushort);
                                    'for_1: loop {
                                        if !((((((i as libc::c_int as libc::c_ushort))
                                            < (((nsems) as libc::c_int as libc::c_ushort)))
                                            as libc::c_int as libc::c_int) != 0))
                                        {
                                            break;
                                        }
                                        'cont_1: loop {
                                            {
                                                if (((((<ACE_SV_Semaphore_Complex>::control_u341a73996b9554d5(
                    ...
                    return ACE_OS::semop_u80b06a9c8b5a703c(
                        (*::core::ptr::addr_of!((* __this).__base_0)
                            .cast::<ACE_SV_Semaphore_Simple>()
                            .cast_mut())
                            .internal_id_,
                        ((::core::ptr::addr_of_mut!(
                            (ACE_SV_Semaphore_Complex_op_endcreate_) [(0) as usize]
                        ) as *mut sembuf) as *mut sembuf),
                        ((2) as libc::c_ulong),
                    );
                } else {
                    (*::core::ptr::addr_of!((* __this).__base_0)
                        ...
                        (*::core::ptr::addr_of!((* __this).__base_0)
                            ...
                            .cast_mut())
                            .key_,
                        (((2) as libc::c_int)).wrapping_add((nsems) as libc::c_int),
                        0,
                    );
                    if ((((((*::core::ptr::addr_of!((* __this).__base_0)
                        .cast::<ACE_SV_Semaphore_Simple>()
                    ...
                    if (((((ACE_OS::semop_u80b06a9c8b5a703c(
                        (*::core::ptr::addr_of!((* __this).__base_0)
                            .cast::<ACE_SV_Semaphore_Simple>()
                            .cast_mut())
                            .internal_id_,
                        ((::core::ptr::addr_of_mut!(
                            (ACE_SV_Semaphore_Complex_op_open_) [(0) as usize]
                        ) as *mut sembuf) as *mut sembuf),
                        ((1) as libc::c_ulong),
    ...
    pub unsafe fn close(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut semval: libc::c_int = unsafe { ::core::mem::zeroed() };
                if ((((((((((*::core::ptr::addr_of!((* __this).__base_0)
                    .cast::<ACE_SV_Semaphore_Simple>()
                    .cast_mut())
                    .key_ as libc::c_int))
                ...
                if (((((ACE_OS::semop_u80b06a9c8b5a703c(
                    (*::core::ptr::addr_of!((* __this).__base_0)
                        ...
                        .internal_id_,
                    ((::core::ptr::addr_of_mut!(
                        (ACE_SV_Semaphore_Complex_op_close_) [(0) as usize]
                    ) as *mut sembuf) as *mut sembuf),
                    ((3) as libc::c_ulong),
                ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                ...
                if (((((({
                    let __v = <ACE_SV_Semaphore_Simple>::control_u8e0dfb2f98f572a5(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                            ACE_SV_Semaphore_Simple > ().cast_mut())
                        )) as *const ACE_SV_Semaphore_Simple,
                    ...
                    as libc::c_int as libc::c_int) != 0)
                {
                        ...
                        as libc::c_int as libc::c_int) != 0)
                    {
                        ...
                        let mut result: libc::c_int = ACE_OS::semop_u80b06a9c8b5a703c(
                            (*::core::ptr::addr_of!((* __this).__base_0)
                                .cast::<ACE_SV_Semaphore_Simple>()
                                .cast_mut())
                                .internal_id_,
                            ((::core::ptr::addr_of_mut!(
                                (ACE_SV_Semaphore_Complex_op_unlock_) [(0) as usize]
                            ) as *mut sembuf) as *mut sembuf),
                            ((1) as libc::c_ulong),
                        );
                        <ACE_SV_Semaphore_Simple>::init(
