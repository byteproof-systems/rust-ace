...
pub type ACE_Ping_Socket_inherited = ACE_ICMP_Socket;
#[allow(non_upper_case_globals)]
#[no_mangle]
pub static mut ACE_Ping_Socket_time_default_: ACE_Time_Value = unsafe {
    ::core::mem::MaybeUninit::<ACE_Time_Value>::zeroed().assume_init()
};
#[doc = "* @class ACE_Ping_Socket\n *\n * @brief This class is useful to perform ICMP echo checks (pinging)\n * on the party of your interest.  It may be used as well to check\n * LAN-adapters against 3rd parties."]
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Ping_Socket {
    pub __base_0: ::core::mem::ManuallyDrop<ACE_ICMP_Socket>,
    pub icmp_send_buff_: [libc::c_char; 2048usize],
    pub icmp_recv_buff_: [libc::c_char; 2048usize],
    pub sequence_number_: libc::c_ushort,
    pub connected_socket_: bool,
}
#[export_name = "_ZN15ACE_Ping_SocketC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Ping_SocketC1Ev(
    __this: *mut ACE_Ping_Socket,
) {
    ACE_Ping_Socket::new_at(__this)
}
#[export_name = "_ZN15ACE_Ping_SocketC1ERK8ACE_Addrii"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Ping_SocketC1ERK8ACE_Addrii(
    __this: *mut ACE_Ping_Socket,
    __a0: *const ACE_Addr,
    __a1: libc::c_int,
    __a2: libc::c_int,
) {
    ACE_Ping_Socket::new_at_u89f645354b929bed(__this, __a0, __a1, __a2)
}
impl Drop for ACE_Ping_Socket {
    fn drop(&mut self) {
        {
            unsafe {
                let __this: *mut Self = self as *mut Self;
...
#[export_name = "__acedtor_ue9d854f920848051"]
pub unsafe extern "C-unwind" fn __acedtor_ue9d854f920848051(
    __this: *mut ACE_Ping_Socket,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[export_name = "_ZN15ACE_Ping_Socket4openERK8ACE_Addrii"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Ping_Socket4openERK8ACE_Addrii(
    __this: *mut ACE_Ping_Socket,
    local: *const ACE_Addr,
    protocol: libc::c_int,
    reuse_addr: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_Ping_Socket::open(__this, local, protocol, reuse_addr) }
}
#[export_name = "_ZN15ACE_Ping_Socket15send_echo_checkER13ACE_INET_Addrb"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Ping_Socket15send_echo_checkER13ACE_INET_Addrb(
    __this: *mut ACE_Ping_Socket,
    remote_addr: *mut ACE_INET_Addr,
    to_connect: bool,
) -> libc::c_int {
    unsafe { ACE_Ping_Socket::send_echo_check(__this, remote_addr, to_connect) }
}
#[export_name = "_ZN15ACE_Ping_Socket22process_incoming_dgramEPcl"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Ping_Socket22process_incoming_dgramEPcl(
    __this: *mut ACE_Ping_Socket,
    ptr: *mut libc::c_char,
    len: libc::c_long,
) -> libc::c_int {
    unsafe { ACE_Ping_Socket::process_incoming_dgram(__this, ptr, len) }
}
#[export_name = "_ZN15ACE_Ping_Socket15make_echo_checkER13ACE_INET_AddrbPK14ACE_Time_Value"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Ping_Socket15make_echo_checkER13ACE_INET_AddrbPK14ACE_Time_Value(
    __this: *mut ACE_Ping_Socket,
    remote_addr: *mut ACE_INET_Addr,
    to_connect: bool,
    timeout: *const ACE_Time_Value,
) -> libc::c_int {
    unsafe { ACE_Ping_Socket::make_echo_check(__this, remote_addr, to_connect, timeout) }
}
#[export_name = "_ZNK15ACE_Ping_Socket4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK15ACE_Ping_Socket4dumpEv(
    __this: *const ACE_Ping_Socket,
) {
    unsafe { ACE_Ping_Socket::dump(__this) }
}
#[export_name = "_ZN15ACE_Ping_Socket18receive_echo_replyEPK14ACE_Time_Value"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Ping_Socket18receive_echo_replyEPK14ACE_Time_Value(
    __this: *mut ACE_Ping_Socket,
    timeout: *const ACE_Time_Value,
) -> libc::c_int {
    unsafe { ACE_Ping_Socket::receive_echo_reply(__this, timeout) }
}
...
pub type n_short = libc::c_ushort;
pub type n_long = libc::c_uint;
pub type n_time = libc::c_uint;
#[repr(C, align(4))]
#[derive(Copy, Clone)]
pub struct timestamp {
    pub len: libc::c_uchar,
    pub ptr: libc::c_uchar,
    pub bitfield_storage_0: [u8; 1],
...
pub struct iphdr {
    pub bitfield_storage_0: [u8; 1],
    pub tos: libc::c_uchar,
    pub tot_len: libc::c_ushort,
    pub id: libc::c_ushort,
    pub frag_off: libc::c_ushort,
    pub ttl: libc::c_uchar,
    pub protocol: libc::c_uchar,
    pub check: libc::c_ushort,
    pub saddr: libc::c_uint,
    pub daddr: libc::c_uint,
}
#[repr(C, align(4))]
#[derive(Copy, Clone)]
pub struct ip {
...
pub struct ip_timestamp {
    pub ipt_code: libc::c_uchar,
    pub ipt_len: libc::c_uchar,
    pub ipt_ptr: libc::c_uchar,
    pub bitfield_storage_0: [u8; 1],
    pub data: [libc::c_uint; 9usize],
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct _unnamed_struct_at__usr_include_netinet_ip_icmp_h_33_5_ {
    pub id: libc::c_ushort,
    pub sequence: libc::c_ushort,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct _unnamed_struct_at__usr_include_netinet_ip_icmp_h_39_5_ {
    pub __glibc_reserved: libc::c_ushort,
    pub mtu: libc::c_ushort,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub union _unnamed_union_at__usr_include_netinet_ip_icmp_h_31_3_ {
    pub echo: _unnamed_struct_at__usr_include_netinet_ip_icmp_h_33_5_,
    pub gateway: libc::c_uint,
    pub frag: _unnamed_struct_at__usr_include_netinet_ip_icmp_h_39_5_,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct icmphdr {
    ...
    pub un: _unnamed_union_at__usr_include_netinet_ip_icmp_h_31_3_,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct icmp_ra_addr {
    pub ira_addr: libc::c_uint,
    pub ira_preference: libc::c_uint,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ih_idseq {
    pub icd_id: libc::c_ushort,
    pub icd_seq: libc::c_ushort,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ih_pmtu {
    pub ipm_void: libc::c_ushort,
    pub ipm_nextmtu: libc::c_ushort,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ih_rtradv {
    pub irt_num_addrs: libc::c_uchar,
    pub irt_wpa: libc::c_uchar,
    pub irt_lifetime: libc::c_ushort,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub union _unnamed_union_at__usr_include_netinet_ip_icmp_h_160_3_ {
    pub ih_pptr: libc::c_uchar,
    pub ih_gwaddr: in_addr,
    pub ih_idseq: ih_idseq,
    pub ih_void: libc::c_uint,
    pub ih_pmtu: ih_pmtu,
    pub ih_rtradv: ih_rtradv,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct _unnamed_struct_at__usr_include_netinet_ip_icmp_h_197_5_ {
    pub its_otime: libc::c_uint,
    pub its_rtime: libc::c_uint,
    pub its_ttime: libc::c_uint,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct _unnamed_struct_at__usr_include_netinet_ip_icmp_h_203_5_ {
    pub idi_ip: ip,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub union _unnamed_union_at__usr_include_netinet_ip_icmp_h_195_3_ {
    pub id_ts: _unnamed_struct_at__usr_include_netinet_ip_icmp_h_197_5_,
    pub id_ip: _unnamed_struct_at__usr_include_netinet_ip_icmp_h_203_5_,
    pub id_radv: icmp_ra_addr,
    pub id_mask: libc::c_uint,
    pub id_data: [libc::c_uchar; 1usize],
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct icmp {
    pub icmp_type: libc::c_uchar,
    pub icmp_code: libc::c_uchar,
    pub icmp_cksum: libc::c_ushort,
    pub icmp_hun: _unnamed_union_at__usr_include_netinet_ip_icmp_h_160_3_,
    pub icmp_dun: _unnamed_union_at__usr_include_netinet_ip_icmp_h_195_3_,
}
pub(crate) static ICMP_MIN: libc::c_int = ((8) as libc::c_int);
pub(crate) static ICMP_DATA_LENGTH: libc::c_int = ((56) as libc::c_int);
extern "C-unwind" {
...
impl ACE_ICMP_Socket {
  ...
  /// @c sendto(3) ).*/
    pub unsafe fn send(
        ...
        extern "C-unwind" {
            #[link_name = "_ZNK15ACE_ICMP_Socket4sendEPKvmRK8ACE_Addri"]
            fn __ext(
                __this: *const ACE_ICMP_Socket,
                buf: *const libc::c_void,
                n: libc::c_ulong,
                addr: *const ACE_Addr,
                flags: libc::c_int,
        ...
        __ext(__this as *const ACE_ICMP_Socket, buf, n, addr, flags)
    }
  ...
  /// (uses @c recvfrom(3) ).*/
    pub unsafe fn recv(
        ...
        extern "C-unwind" {
            #[link_name = "_ZNK15ACE_ICMP_Socket4recvEPvmR8ACE_Addri"]
            fn __ext(
                __this: *const ACE_ICMP_Socket,
                buf: *mut libc::c_void,
                n: libc::c_ulong,
    ...
    ///TODO: comment
    pub unsafe fn recv_u1f245b00dbfe2fd8(
        __this: *const Self,
        mut buf: *mut libc::c_void,
        mut n: libc::c_ulong,
        mut flags: libc::c_int,
        ...
        extern "C-unwind" {
            #[link_name = "_ZNK15ACE_ICMP_Socket4recvEPvmiPK14ACE_Time_Value"]
            fn __ext(
                __this: *const ACE_ICMP_Socket,
                buf: *mut libc::c_void,
                n: libc::c_ulong,
        ...
        __ext(__this as *const ACE_ICMP_Socket, buf, n, flags, timeout)
    }
    ///Wrapper around the BSD-style @c socket system call (no QoS).
    pub unsafe fn open(
        __this: *mut Self,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_ICMP_Socket4openERK8ACE_Addrii"]
            fn __ext(
                __this: *mut ACE_ICMP_Socket,
                local: *const ACE_Addr,
                protocol: libc::c_int,
                reuse_addr: libc::c_int,
            ) -> libc::c_int;
        }
        __ext(__this as *mut ACE_ICMP_Socket, local, protocol, reuse_addr)
    }
    ///Dump the state of object.
    pub unsafe fn dump(__this: *const Self) {
        extern "C-unwind" {
            #[link_name = "_ZNK15ACE_ICMP_Socket4dumpEv"]
            fn __ext(__this: *const ACE_ICMP_Socket);
        }
        __ext(__this as *const ACE_ICMP_Socket)
    }
    ///Default constructor.
    pub unsafe fn new_at(__this: *mut Self) {
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_ICMP_SocketC1Ev"]
            fn __ext(__this: *mut ACE_ICMP_Socket);
        }
        __ext(__this as *mut ACE_ICMP_Socket)
    }
    pub unsafe fn new() -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at(::core::ptr::addr_of_mut!(__obj));
    ...
    pub unsafe fn new_at_ue3eec726f593fde4(
        __this: *mut Self,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_ICMP_SocketC1ERK8ACE_Addrii"]
            fn __ext(
                __this: *mut ACE_ICMP_Socket,
                __a0: *const ACE_Addr,
                __a1: libc::c_int,
        ...
        __ext(__this as *mut ACE_ICMP_Socket, __a0, __a1, __a2)
    }
    pub unsafe fn new_ue3eec726f593fde4(
        mut __a0: *const ACE_Addr,
        mut __a1: libc::c_int,
        mut __a2: libc::c_int,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_ue3eec726f593fde4(
            ::core::ptr::addr_of_mut!(__obj),
            __a0,
            __a1,
            __a2,
    ...
    pub unsafe fn shared_open(
        ...
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_ICMP_Socket11shared_openERK8ACE_Addr"]
            fn __ext(
                __this: *mut ACE_ICMP_Socket,
                local: *const ACE_Addr,
            ) -> libc::c_int;
        }
        __ext(__this as *mut ACE_ICMP_Socket, local)
    }
    ///Calculates check-sum.
    pub unsafe fn calculate_checksum(
        __this: *mut Self,
        mut paddress: *mut libc::c_ushort,
        mut len: libc::c_int,
    ) -> libc::c_ushort {
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_ICMP_Socket18calculate_checksumEPti"]
            fn __ext(
                __this: *mut ACE_ICMP_Socket,
                paddress: *mut libc::c_ushort,
                len: libc::c_int,
            ) -> libc::c_ushort;
        }
        __ext(__this as *mut ACE_ICMP_Socket, paddress, len)
    }
}
impl ACE_INET_Addr {
    ///Default constructor.
...
impl ACE_Ping_Socket {
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ...
            <ACE_ICMP_Socket>::new_at(
                ::core::ptr::addr_of_mut!((* __this).__base_0).cast::<ACE_ICMP_Socket>(),
            );
            {}
            ()
        }
    ...
    pub unsafe fn new_at_u89f645354b929bed(
        __this: *mut Self,
        mut local: *const ACE_Addr,
        mut protocol: libc::c_int,
        mut reuse_addr: libc::c_int,
        ...
        unsafe {
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).sequence_number_),
                ((0) as libc::c_ushort),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).connected_socket_),
                false,
            );
            {
                ACE_OS::memset_u2b5dfc47d301370a(
                    (((*__this).icmp_send_buff_).as_mut_ptr() as *mut libc::c_void),
                    0,
                    ((::core::mem::size_of::<[libc::c_char; 2048usize]>()
                        as libc::c_ulong) as libc::c_ulong),
                );
                ACE_OS::memset_u2b5dfc47d301370a(
                    (((*__this).icmp_recv_buff_).as_mut_ptr() as *mut libc::c_void),
                    0,
                    ((::core::mem::size_of::<[libc::c_char; 2048usize]>()
                        as libc::c_ulong) as libc::c_ulong),
                );
                if (((((<ACE_Ping_Socket>::open(
                    (__this) as *mut ACE_Ping_Socket,
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/Ping_Socket.cpp\0".as_ptr()
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        (ace___) as *mut ACE_Log_Category_TSS,
                                        LM_DEBUG,
                                        ((b"ACE_Ping_Socket::ACE_Ping_Socket: %p\n\0".as_ptr()
                                            as *const libc::c_char) as *const libc::c_char),
                ...
                let mut size: libc::c_int = (((64) as libc::c_int))
                    .wrapping_mul((1024) as libc::c_int);
                <ACE_SOCK>::set_option(
                    (::core::ptr::addr_of!(
                        (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((* __this)
                        .__base_0) .cast:: < ACE_ICMP_Socket > ().cast_mut()).__base_0)
                        .cast:: < ACE_SOCK > ().cast_mut())
                    )) as *const ACE_SOCK,
                    1,
                    8,
                    (::core::ptr::addr_of_mut!(size) as *mut libc::c_int
                        as *mut libc::c_void),
    ...
    pub unsafe fn new_u89f645354b929bed(
        mut __a0: *const ACE_Addr,
        mut __a1: libc::c_int,
        mut __a2: libc::c_int,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_u89f645354b929bed(
            ::core::ptr::addr_of_mut!(__obj),
            __a0,
            __a1,
            __a2,
    ...
    pub unsafe fn open(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return <ACE_ICMP_Socket>::open(
                    (::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                        ACE_ICMP_Socket > ().cast_mut())
                    )) as *mut ACE_ICMP_Socket,
                    ::core::ptr::addr_of!((* local)),
                    protocol,
                    reuse_addr,
                );
    ...
    pub unsafe fn send_echo_check(
        __this: *mut Self,
        mut remote_addr: *mut ACE_INET_Addr,
        mut to_connect: bool,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((((<ACE_IPC_SAP>::get_handle(
                    (::core::ptr::addr_of!(
                        ...
                        ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                        ACE_ICMP_Socket > ().cast_mut()).__base_0) .cast:: < ACE_SOCK >
                ...
                let mut addr_connect: *mut sockaddr_in = ((0) as *mut sockaddr_in);
                addr_connect = ({
                    let __obj: *mut ACE_Addr = (::core::ptr::addr_of!((* remote_addr)))
                        as *mut ACE_Addr;
                ...
                ACE_OS::memset_u2b5dfc47d301370a(
                    (::core::ptr::addr_of_mut!((* addr_connect).sin_port)
                        as *mut libc::c_ushort as *mut libc::c_void),
                    0,
                    ((::core::mem::size_of::<libc::c_ushort>() as libc::c_ulong)
                        as libc::c_ulong),
                );
                if ((((((to_connect as libc::c_int) != 0)
                    && (((!((((*__this).connected_socket_ as libc::c_int) != 0))
                        as libc::c_int) as libc::c_int) != 0)) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    if (((((ACE_OS::connect_u21719e7a4d49e872(
                        <ACE_IPC_SAP>::get_handle(
                            (::core::ptr::addr_of!(
                                (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((*
                                ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                                ACE_ICMP_Socket > ().cast_mut()).__base_0) .cast:: <
                                ACE_SOCK > ().cast_mut()).__base_0) .cast:: < ACE_IPC_SAP >
                                ().cast_mut())
                            )) as *const ACE_IPC_SAP,
                        ),
                        (((addr_connect as *mut sockaddr)) as *mut sockaddr),
                        <ACE_Addr>::get_size(
                            (::core::ptr::addr_of!(
                                (* ::core::ptr::addr_of!((* (::core::ptr::addr_of!((*
                                remote_addr)))).__base_0) .cast:: < ACE_Addr > ()
                                .cast_mut())
                            )) as *const ACE_Addr,
                        ),
                    ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                ...
                let mut datalen: libc::c_int = ((ICMP_DATA_LENGTH) as libc::c_int);
                let mut _icmp: *mut icmp = ((0) as *mut icmp);
                _icmp = (((*__this).icmp_send_buff_).as_mut_ptr() as *mut icmp);
                (*_icmp).icmp_type = ((8) as libc::c_uchar);
                (*_icmp).icmp_code = ((0) as libc::c_uchar);
                (*_icmp).icmp_hun.ih_idseq.icd_id = (((((ACE_OS::getpid_ucc9c2c9e176d9ca8())
                    as libc::c_int)) & ((0xffff) as libc::c_int)) as libc::c_ushort);
                (*_icmp).icmp_hun.ih_idseq.icd_seq = (({
                    let __lv = &mut ((*__this).sequence_number_);
                    let __r = *__lv;
                    *__lv = (*__lv).wrapping_add(1);
                    __r
                }) as libc::c_ushort);
                gettimeofday(
                    (((::core::ptr::addr_of_mut!((* _icmp).icmp_dun.id_data)
                        as *mut [libc::c_uchar; 1usize] as *mut timeval))
                        as *mut timeval),
                    ((0) as *mut libc::c_void),
                );
                let mut length_icmp: libc::c_int = (((ICMP_MIN) as libc::c_int))
                    .wrapping_add((datalen) as libc::c_int);
                (*_icmp).icmp_cksum = ((0) as libc::c_ushort);
                (*_icmp).icmp_cksum = ((<ACE_ICMP_Socket>::calculate_checksum(
                    (::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                        ACE_ICMP_Socket > ().cast_mut())
                    )) as *mut ACE_ICMP_Socket,
                    (((_icmp as *mut libc::c_ushort)) as *mut libc::c_ushort),
                    length_icmp,
                )) as libc::c_ushort);
                let mut rval_send: libc::c_long = (((-((1) as libc::c_int)))
                    as libc::c_long);
                if (((((({
                    let __v = <ACE_ICMP_Socket>::send(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                            ACE_ICMP_Socket > ().cast_mut())
                        )) as *const ACE_ICMP_Socket,
                        (((*__this).icmp_send_buff_).as_ptr() as *const libc::c_void),
                        ((length_icmp) as libc::c_ulong),
                        ::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!(((* remote_addr)).__base_0) .cast::
                            < ACE_Addr > ().cast_mut())
                        ) as *const ACE_Addr,
                        0,
                    );
                    rval_send = __v;
                    __v
                }) as libc::c_long)) != (((length_icmp) as libc::c_long))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    return (-((1) as libc::c_int));
                }
  ...
  /// sending @c ICMP_ECHO.*/
    pub unsafe fn process_incoming_dgram(
        __this: *mut Self,
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut hlen1: libc::c_uchar = unsafe { ::core::mem::zeroed() };
                let mut icmplen: libc::c_long = unsafe { ::core::mem::zeroed() };
                let mut ip: *mut ip = unsafe { ::core::mem::zeroed() };
                let mut icmp: *mut icmp = unsafe { ::core::mem::zeroed() };
                ip = (ptr as *mut ip);
                hlen1 = ((*(ptr)) as libc::c_uchar);
                {
                    hlen1 = (((hlen1) as libc::c_int as libc::c_uchar))
                        .wrapping_shl((4) as u32);
                    hlen1
                };
                {
                    hlen1 = (((hlen1) as libc::c_int as libc::c_uchar))
                        .wrapping_shr((4) as u32);
                    hlen1
                };
                {
                    hlen1 = (((hlen1) as libc::c_int as libc::c_uchar))
                        .wrapping_shl((2) as u32);
                    hlen1
                };
                icmp = (((ptr).wrapping_offset((hlen1) as isize)) as *mut icmp);
                if (((((({
                    let __v = (((len) as libc::c_long))
                        .wrapping_sub((hlen1) as libc::c_long);
                    icmplen = __v;
                    __v
                }) as libc::c_long)) < (((ICMP_MIN) as libc::c_long))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    'dowhile_0: loop {
                        'cont_0: loop {
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        (ace___) as *mut ACE_Log_Category_TSS,
                                        LM_DEBUG,
                                        ((b"(%P|%t) ACE_Ping_Socket::process_incoming_dgram - ICMP length is %b < 8.\n\0"
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        (ace___) as *mut ACE_Log_Category_TSS,
                                        LM_ERROR,
                                        ((b"(%P|%t) ACE_Ping_Socket::process_incoming_dgram - The ICMP header either not received or is corrupted.\0"
                                            .as_ptr() as *const libc::c_char) as *const libc::c_char),
                                    );
                                    return (-((1) as libc::c_int));
                                }
                ...
                if ((((((*icmp).icmp_type as libc::c_int)) == (((0) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    'dowhile_2: loop {
                        'cont_2: loop {
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        (ace___) as *mut ACE_Log_Category_TSS,
                                        LM_DEBUG,
                                        ((b"(%P|%t) ACE_Ping_Socket::process_incoming_dgram - ICMP_ECHOREPLY received.\n\0"
                                            .as_ptr() as *const libc::c_char) as *const libc::c_char),
                                    );
                                }
                            }
                    ...
                    if ((((((*icmp).icmp_hun.ih_idseq.icd_id as libc::c_int))
                        != (((((((ACE_OS::getpid_ucc9c2c9e176d9ca8()) as libc::c_int))
                            & ((0xffff) as libc::c_int))) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        'dowhile_3: loop {
                            'cont_3: loop {
                                {
                                    {
                                        ...
                                        <ACE_Log_Category_TSS>::log(
                                            (ace___) as *mut ACE_Log_Category_TSS,
                                            LM_ERROR,
                                            ((b"(%P|%t) ACE_Ping_Socket::process_incoming_dgram - The ICMP header received is a reply to request of another process (%d; expected %d).\n\0"
                                                .as_ptr() as *const libc::c_char) as *const libc::c_char),
                                            (((*icmp).icmp_hun.ih_idseq.icd_id) as libc::c_int),
                                            ACE_OS::getpid_ucc9c2c9e176d9ca8(),
                                        );
                                        return (-((1) as libc::c_int));
                                    }
                                }
                    ...
                    if (((((icmplen as libc::c_long)) < (((16) as libc::c_long)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        'dowhile_4: loop {
                            'cont_4: loop {
                                {
                                    {
                                        ...
                                        <ACE_Log_Category_TSS>::log(
                                            (ace___) as *mut ACE_Log_Category_TSS,
                                            LM_ERROR,
                                            ((b"(%P|%t) ACE_Ping_Socket::process_incoming_dgram - ICMP length is %b < 16.\0"
                                                .as_ptr() as *const libc::c_char) as *const libc::c_char),
                                            icmplen,
                                        );
                                        return (-((1) as libc::c_int));
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        (ace___) as *mut ACE_Log_Category_TSS,
                                        LM_DEBUG,
                                        ((b"(%P|%t) ACE::Ping_Socket::process_incoming_dgram - received ICMP datagram with length of %b bytes (not counting IP-header): seq=%u, ttl=%d.\n\0"
                                            .as_ptr() as *const libc::c_char) as *const libc::c_char),
                                        icmplen,
                                        (((*icmp).icmp_hun.ih_idseq.icd_seq) as libc::c_int),
                        ...
                        {
                            {
                                ...
                                <ACE_Log_Category_TSS>::log(
                                    (ace___) as *mut ACE_Log_Category_TSS,
                                    LM_DEBUG,
                                    ((b"(%P|%t) ACE::Ping_Socket::process_incoming_dgram - received datagram that is not ICMP_ECHOREPLY.\n\0"
                                        .as_ptr() as *const libc::c_char) as *const libc::c_char),
                                );
                            }
                        }
    ...
    pub unsafe fn make_echo_check(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut rval_send: libc::c_int = (-((1) as libc::c_int));
                if (((((({
                    let __v = <ACE_Ping_Socket>::send_echo_check(
                        (__this) as *mut ACE_Ping_Socket,
                        ::core::ptr::addr_of_mut!((* remote_addr)),
                        to_connect,
                    );
                    rval_send = __v;
                    __v
                        ...
                        {
                            {
                                ...
                                <ACE_Log_Category_TSS>::log(
                                    (ace___) as *mut ACE_Log_Category_TSS,
                                    LM_DEBUG,
                                    ((b"(%P|%t) ACE_Ping_Socket::make_echo_check - sent %d.\n\0"
                                        .as_ptr() as *const libc::c_char) as *const libc::c_char),
                                    rval_send,
                                );
                            }
                ...
                return <ACE_Ping_Socket>::receive_echo_reply(
                    (__this) as *mut ACE_Ping_Socket,
                    timeout,
                );
            }
    ...
    pub unsafe fn icmp_recv_buff(__this: *mut Self) -> *mut libc::c_char {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((*__this).icmp_recv_buff_).as_mut_ptr() as *mut libc::c_char);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    ...
    pub unsafe fn receive_echo_reply(
        __this: *mut Self,
        mut timeout: *const ACE_Time_Value,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut before: ACE_Time_Value = ACE_OS::gettimeofday_u3220bcbbceb90f45();
                let mut after: ACE_Time_Value = ::core::mem::MaybeUninit::<
                    ACE_Time_Value,
                >::zeroed()
                    .assume_init();
                <ACE_Time_Value>::new_at(
                    (::core::ptr::addr_of_mut!(after)) as *mut ACE_Time_Value,
                );
                let mut time_left: ACE_Time_Value = ::core::mem::MaybeUninit::<
                    ACE_Time_Value,
                >::zeroed()
                    .assume_init();
                <ACE_Time_Value>::new_at(
                    (::core::ptr::addr_of_mut!(time_left)) as *mut ACE_Time_Value,
                );
                let mut wait_time: *mut ACE_Time_Value = (timeout
                    as *mut ACE_Time_Value);
                let mut half_millisec: ACE_Time_Value = ::core::mem::MaybeUninit::<
                    ACE_Time_Value,
                >::zeroed()
                    .assume_init();
                <ACE_Time_Value>::new_at_ub59bcc88eaedf2a6(
                    (::core::ptr::addr_of_mut!(half_millisec)) as *mut ACE_Time_Value,
                    ((0) as libc::c_long),
                    ((500) as libc::c_long),
                );
                ACE_OS::memset_u2b5dfc47d301370a(
                ...
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            {
                                let mut rval_recv: libc::c_long = <ACE_ICMP_Socket>::recv_u1f245b00dbfe2fd8(
                                    (::core::ptr::addr_of!(
                                        (* ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                                        ACE_ICMP_Socket > ().cast_mut())
                                    )) as *const ACE_ICMP_Socket,
                                    (((*__this).icmp_recv_buff_).as_mut_ptr()
                                        as *mut libc::c_void),
                                    ((::core::mem::size_of::<[libc::c_char; 2048usize]>()
                                        as libc::c_ulong) as libc::c_ulong),
                                    0,
                                    (wait_time) as *const ACE_Time_Value,
                                );
                                if (((((rval_recv as libc::c_long))
                                    ...
                                    != 0)
                                {
                                    if (((((((*(__errno_location()))) as libc::c_int))
                                        ...
                                        != 0)
                                    {
                                        let mut __addrof_tmp_0 = ACE_OS::gettimeofday_u3220bcbbceb90f45();
                                        <ACE_Time_Value>::operator_assign_uac328283e2b88277(
                                            (::core::ptr::addr_of_mut!(after)) as *mut ACE_Time_Value,
                                            &mut __addrof_tmp_0 as *mut ACE_Time_Value,
                                        );
                                        let __addrof_tmp_1 = operator_sub_u7824066738f89e79(
                                            timeout,
                                            ::core::ptr::addr_of!(after),
                                        );
                                        let mut __addrof_tmp_2 = operator_add_u6912887df3d67ceb(
                                            &__addrof_tmp_1 as *const ACE_Time_Value,
                                            ::core::ptr::addr_of!(before),
                                        );
                                        <ACE_Time_Value>::operator_assign_uac328283e2b88277(
                                            (::core::ptr::addr_of_mut!(time_left))
                                                as *mut ACE_Time_Value,
                                            &mut __addrof_tmp_2 as *mut ACE_Time_Value,
                                        );
                                        if ((operator_gt_u897a3dc677ab5d80(
                                            ::core::ptr::addr_of!(time_left),
                                            ::core::ptr::addr_of!(half_millisec),
                                        ) as libc::c_int) != 0)
                                        {
                                            wait_time = ::core::ptr::addr_of_mut!(time_left)
                                                as *mut ACE_Time_Value;
                                            break 'cont_0;
                                        } else {
                                            break 'dowhile_0;
                                    ...
                                    if (((!(((<ACE_Ping_Socket>::process_incoming_dgram(
                                        (__this) as *mut ACE_Ping_Socket,
                                        (((*__this).icmp_recv_buff_).as_mut_ptr()
                                            as *mut libc::c_char),
                                        rval_recv,
                                    )) != 0)) as libc::c_int) as libc::c_int) != 0)
                                    {
                                        ...
                                        let mut __addrof_tmp_3 = ACE_OS::gettimeofday_u3220bcbbceb90f45();
                                        <ACE_Time_Value>::operator_assign_uac328283e2b88277(
                                            (::core::ptr::addr_of_mut!(after)) as *mut ACE_Time_Value,
                                            &mut __addrof_tmp_3 as *mut ACE_Time_Value,
                                        );
                                        if ((operator_ge_uf7353febab1e0383(
                                            &((operator_sub_u7824066738f89e79(
                                                ::core::ptr::addr_of!(after),
                                                ::core::ptr::addr_of!(before),
                                        ...
                                        let __addrof_tmp_4 = operator_sub_u7824066738f89e79(
                                            timeout,
                                            ::core::ptr::addr_of!(after),
                                        );
                                        let mut __addrof_tmp_5 = operator_add_u6912887df3d67ceb(
                                            &__addrof_tmp_4 as *const ACE_Time_Value,
                                            ::core::ptr::addr_of!(before),
                                        );
                                        <ACE_Time_Value>::operator_assign_uac328283e2b88277(
                                            (wait_time) as *mut ACE_Time_Value,
                                            &mut __addrof_tmp_5 as *mut ACE_Time_Value,
                                        );
                                    }
                                }
                            }
    ...
    pub unsafe fn get_remote_addr(
        ...
        extern "C-unwind" {
            #[link_name = "_ZNK15ACE_Ping_Socket15get_remote_addrER13ACE_INET_Addr"]
            fn __ext(
                __this: *const ACE_Ping_Socket,
                addr: *mut ACE_INET_Addr,
            ) -> libc::c_int;
        }
        __ext(__this as *const ACE_Ping_Socket, addr)
    }
}
...
impl timestamp {
    #[inline]
    pub unsafe fn get_flags(&self) -> libc::c_uint {
        let mut __v: u64 = 0;
        let mut __k: u32 = 0;
        while __k < (4 as u32) {
            let __bit = (0 as u32) + __k;
            __v
                |= (((self.bitfield_storage_0[(__bit / 8) as usize] >> (__bit % 8)) & 1)
                    as u64) << __k;
            __k += 1;
        }
        (__v & 0xfu64) as libc::c_uint
    }
    #[inline]
    pub unsafe fn set_flags(&mut self, value: libc::c_uint) {
        let __val = (value as u64) & 0xfu64;
        let mut __k: u32 = 0;
        while __k < (4 as u32) {
            let __bit = (0 as u32) + __k;
            let __idx = (__bit / 8) as usize;
            let __off = (__bit % 8) as u8;
            let __b = (((__val >> __k) & 1) as u8) << __off;
            self.bitfield_storage_0[__idx] = (self.bitfield_storage_0[__idx]
                & !(1u8 << __off)) | __b;
            __k += 1;
        }
    }
    #[inline]
    pub unsafe fn get_overflow(&self) -> libc::c_uint {
        let mut __v: u64 = 0;
        let mut __k: u32 = 0;
        while __k < (4 as u32) {
            let __bit = (4 as u32) + __k;
            __v
                |= (((self.bitfield_storage_0[(__bit / 8) as usize] >> (__bit % 8)) & 1)
                    as u64) << __k;
            __k += 1;
    ...
    #[inline]
    pub unsafe fn set_overflow(&mut self, value: libc::c_uint) {
        let __val = (value as u64) & 0xfu64;
        let mut __k: u32 = 0;
        while __k < (4 as u32) {
            let __bit = (4 as u32) + __k;
...
impl iphdr {
    #[inline]
    pub unsafe fn get_ihl(&self) -> libc::c_uint {
        let mut __v: u64 = 0;
        let mut __k: u32 = 0;
        while __k < (4 as u32) {
            let __bit = (0 as u32) + __k;
    ...
    #[inline]
    pub unsafe fn set_ihl(&mut self, value: libc::c_uint) {
        let __val = (value as u64) & 0xfu64;
        let mut __k: u32 = 0;
        while __k < (4 as u32) {
            let __bit = (0 as u32) + __k;
    ...
    #[inline]
    pub unsafe fn get_version(&self) -> libc::c_uint {
        let mut __v: u64 = 0;
        let mut __k: u32 = 0;
        while __k < (4 as u32) {
            let __bit = (4 as u32) + __k;
    ...
    #[inline]
    pub unsafe fn set_version(&mut self, value: libc::c_uint) {
        let __val = (value as u64) & 0xfu64;
        let mut __k: u32 = 0;
        while __k < (4 as u32) {
            let __bit = (4 as u32) + __k;
...
impl ip {
    #[inline]
    pub unsafe fn get_ip_hl(&self) -> libc::c_uint {
        let mut __v: u64 = 0;
        let mut __k: u32 = 0;
        while __k < (4 as u32) {
            let __bit = (0 as u32) + __k;
    ...
    #[inline]
    pub unsafe fn set_ip_hl(&mut self, value: libc::c_uint) {
        let __val = (value as u64) & 0xfu64;
        let mut __k: u32 = 0;
        while __k < (4 as u32) {
            let __bit = (0 as u32) + __k;
    ...
    #[inline]
    pub unsafe fn get_ip_v(&self) -> libc::c_uint {
        let mut __v: u64 = 0;
        let mut __k: u32 = 0;
        while __k < (4 as u32) {
            let __bit = (4 as u32) + __k;
    ...
    #[inline]
    pub unsafe fn set_ip_v(&mut self, value: libc::c_uint) {
        let __val = (value as u64) & 0xfu64;
        let mut __k: u32 = 0;
        while __k < (4 as u32) {
            let __bit = (4 as u32) + __k;
...
impl ip_timestamp {
    #[inline]
    pub unsafe fn get_ipt_flg(&self) -> libc::c_uint {
        let mut __v: u64 = 0;
        let mut __k: u32 = 0;
        while __k < (4 as u32) {
            let __bit = (0 as u32) + __k;
    ...
    #[inline]
    pub unsafe fn set_ipt_flg(&mut self, value: libc::c_uint) {
        let __val = (value as u64) & 0xfu64;
        let mut __k: u32 = 0;
        while __k < (4 as u32) {
            let __bit = (0 as u32) + __k;
    ...
    #[inline]
    pub unsafe fn get_ipt_oflw(&self) -> libc::c_uint {
        let mut __v: u64 = 0;
        let mut __k: u32 = 0;
        while __k < (4 as u32) {
            let __bit = (4 as u32) + __k;
    ...
    #[inline]
    pub unsafe fn set_ipt_oflw(&mut self, value: libc::c_uint) {
        let __val = (value as u64) & 0xfu64;
        let mut __k: u32 = 0;
        while __k < (4 as u32) {
            let __bit = (4 as u32) + __k;
...
unsafe extern "C-unwind" fn __rt_static_init() {
    ::core::ptr::write(
        ::core::ptr::addr_of_mut!(ACE_Ping_Socket_time_default_),
        <ACE_Time_Value>::new_ub59bcc88eaedf2a6(
            ((0) as libc::c_long),
            ((500000) as libc::c_long),
        ),
    );
}
#[used]
