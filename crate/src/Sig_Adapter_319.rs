...
impl Clone for ACE_Sig_Action {
    #[inline]
    fn clone(&self) -> Self {
        unsafe { Self::new_u50f762489472a0aa(self as *const Self) }
    }
}
#[export_name = "_ZN14ACE_Sig_ActionC1ERKS_"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Sig_ActionC1ERKS_(
    __this: *mut ACE_Sig_Action,
    __a0: *const ACE_Sig_Action,
) {
    ACE_Sig_Action::new_at_u50f762489472a0aa(__this, __a0)
}
...
#[export_name = "_ZN15ACE_Sig_AdapterC1ER14ACE_Sig_Actioni"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Sig_AdapterC1ER14ACE_Sig_Actioni(
    __this: *mut ACE_Sig_Adapter,
    __a0: *mut ACE_Sig_Action,
    __a1: libc::c_int,
) {
    ACE_Sig_Adapter::new_at(__this, __a0, __a1)
}
#[export_name = "_ZN15ACE_Sig_AdapterC1EP17ACE_Event_Handleri"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Sig_AdapterC1EP17ACE_Event_Handleri(
    __this: *mut ACE_Sig_Adapter,
    __a0: *mut ACE_Event_Handler,
    __a1: libc::c_int,
) {
    ACE_Sig_Adapter::new_at_udfaa58f296a97135(__this, __a0, __a1)
}
#[export_name = "_ZN15ACE_Sig_AdapterC1EPFviP9siginfo_tP10ucontext_tEi"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Sig_AdapterC1EPFviP9siginfo_tP10ucontext_tEi(
    __this: *mut ACE_Sig_Adapter,
    __a0: Option<
        unsafe extern "C-unwind" fn(libc::c_int, *mut siginfo_t, *mut ucontext_t),
    >,
    ...
    ACE_Sig_Adapter::new_at_u4b0e1e4f3a2d0d22(__this, __a0, __a1)
}
impl Drop for ACE_Sig_Adapter {
    fn drop(&mut self) {
        {
            unsafe {
                let __this: *mut Self = self as *mut Self;
        ...
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.sa_);
            ::core::mem::ManuallyDrop::drop(&mut self.__base_0);
        }
    }
}
#[export_name = "_ZN15ACE_Sig_Adapter6sigkeyEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Sig_Adapter6sigkeyEv(
    __this: *mut ACE_Sig_Adapter,
) -> libc::c_int {
    unsafe { ACE_Sig_Adapter::sigkey(__this) }
}
#[export_name = "_ZN15ACE_Sig_Adapter13handle_signalEiP9siginfo_tP10ucontext_t"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Sig_Adapter13handle_signalEiP9siginfo_tP10ucontext_t(
    __this: *mut ACE_Sig_Adapter,
    signum: libc::c_int,
    siginfo: *mut siginfo_t,
    ucontext: *mut ucontext_t,
) -> libc::c_int {
    unsafe { ACE_Sig_Adapter::handle_signal(__this, signum, siginfo, ucontext) }
}
extern "C-unwind" {
...
impl ACE_Sig_Action {
  ...
  /// register for signal handling via the @c sigaction function.*/
    ...
    pub unsafe fn new_at_u50f762489472a0aa(
        __this: *mut Self,
        ...
        unsafe {
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).sa_),
                ::core::ptr::read(::core::ptr::addr_of!((* _anon_0).sa_)),
            );
            {}
            ()
        }
    }
    pub unsafe fn new_u50f762489472a0aa(mut __a0: *const ACE_Sig_Action) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_u50f762489472a0aa(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    pub unsafe fn operator_assign(
        __this: *mut Self,
...
impl ACE_Sig_Adapter {
    pub unsafe fn new_at(
        ...
        unsafe {
            ...
            *(__this as *mut *const ()) = &__VTBL_udb0ac16d398da040
                as *const __Vtbl_udb0ac16d398da040 as *const ();
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).sigkey_), sigkey);
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).type_),
                (((1 as libc::c_int)) as libc::c_uint),
            );
            <ACE_Sig_Action>::new_at_u50f762489472a0aa(
                (::core::ptr::addr_of_mut!((* __this).sa_).cast::<ACE_Sig_Action>())
            ...
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).sig_func_), None);
            {}
            ()
        }
    }
    ...
    pub unsafe fn new_at_u4b0e1e4f3a2d0d22(
        ...
        unsafe {
            ...
            *(__this as *mut *const ()) = &__VTBL_udb0ac16d398da040
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).sig_func_),
                sig_func,
            );
            <ACE_Sig_Action>::new_at(
                ::core::ptr::addr_of_mut!((* __this).sa_).cast::<ACE_Sig_Action>(),
  ...
  /// ACE_Reactor's internal table.*/
    ...
    pub unsafe fn handle_signal(
        ...
        unsafe {
            ...
            {
                'switch_0: {
                    let __c: libc::c_uint = (*__this).type_;
                    #[allow(unused_assignments)]
                    let mut __m: u32 = 3;
                    {
                        let __cv_0: libc::c_uint = (1 as libc::c_uint);
                        if __c == __cv_0 {
                            __m = 0;
                        }
                    }
                    if __m == 3 {
                        let __cv_1: libc::c_uint = (0 as libc::c_uint);
                        if __c == __cv_1 {
                            __m = 1;
                        }
                    }
                    if __m == 3 {
                        let __cv_2: libc::c_uint = (2 as libc::c_uint);
                        if __c == __cv_2 {
                            __m = 2;
                        }
                    }
                    if __m <= 0 {
                        let mut old_disp: ACE_Sig_Action = ::core::mem::MaybeUninit::<
                            ACE_Sig_Action,
                        >::zeroed()
                            .assume_init();
                        <ACE_Sig_Action>::new_at(
                            (::core::ptr::addr_of_mut!(old_disp)) as *mut ACE_Sig_Action,
                        );
                        <ACE_Sig_Action>::register_action(
                            (::core::ptr::addr_of_mut!(
                                (* ::core::ptr::addr_of!((* __this).sa_) .cast:: <
                                ACE_Sig_Action > ().cast_mut())
                            )) as *mut ACE_Sig_Action,
                            signum,
                            ::core::ptr::addr_of_mut!(old_disp) as *mut ACE_Sig_Action,
                        );
                        let mut sig_handler: Option<
                        ...
                        > = unsafe {
                            ::core::mem::transmute::<
                                ...
                                >,
                            >(unsafe {
                                ::core::mem::transmute::<_, *mut libc::c_void>(sig_handler)
                            })
                        };
                        (((sig_func))
                            .expect("null function pointer"))(signum, siginfo, ucontext);
                        <ACE_Sig_Action>::register_action(
                            (::core::ptr::addr_of_mut!(old_disp)) as *mut ACE_Sig_Action,
                            signum,
                    ...
                    if __m <= 1 {
                        {
                            let __obj: *mut ACE_Event_Handler = ((*__this).eh_)
