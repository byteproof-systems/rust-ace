...
#[export_name = "_ZN17ACE_Shared_Object4initEiPPc"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Shared_Object4initEiPPc(
    __this: *mut ACE_Shared_Object,
    _anon_0: libc::c_int,
    _anon_1: *mut *mut libc::c_char,
) -> libc::c_int {
    unsafe { ACE_Shared_Object::init(__this, _anon_0, _anon_1) }
}
#[export_name = "_ZN17ACE_Shared_Object4finiEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Shared_Object4finiEv(
    __this: *mut ACE_Shared_Object,
) -> libc::c_int {
    unsafe { ACE_Shared_Object::fini(__this) }
}
#[export_name = "_ZNK17ACE_Shared_Object4infoEPPcm"]
pub unsafe extern "C-unwind" fn __xtu__ZNK17ACE_Shared_Object4infoEPPcm(
    __this: *const ACE_Shared_Object,
    _anon_0: *mut *mut libc::c_char,
    _anon_1: libc::c_ulong,
) -> libc::c_int {
    unsafe { ACE_Shared_Object::info(__this, _anon_0, _anon_1) }
}
extern "C-unwind" {
