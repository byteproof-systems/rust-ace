...
pub mod ACE_Utils {
    ...
    pub use crate::FILE_IO_95::ACE_Utils::Truncator_unsigned_long__int_;
    pub use crate::full_ops_0::ACE_Utils::truncator;
    pub use crate::full_ops_0::ACE_Utils::truncate_cast___long__ub591475ebc843689;
    pub type truncator_618 = Truncator_unsigned_long__int_;
    pub use crate::FILE_IO_95::ACE_Utils::truncate_cast___unsigned_long_;
}
extern "C" {
    #[allow(non_upper_case_globals)]
...
#[export_name = "_ZN19ACE_Process_OptionsC1Ebmmmm"]
pub unsafe extern "C-unwind" fn __xtu__ZN19ACE_Process_OptionsC1Ebmmmm(
    ...
    ACE_Process_Options::new_at(__this, __a0, __a1, __a2, __a3, __a4)
}
    ...
    fn drop(&mut self) {
        unsafe {
            let __this: *mut Self = self as *mut Self;
            {
                ...
                {
                    let __data = (*__this).environment_buf_ as *mut libc::c_char;
                    if !__data.is_null() {
                        ::libc::free(__data as *mut libc::c_void);
                    }
                };
                {
                    let __data = (*__this).environment_argv_ as *mut *mut libc::c_char;
                    if !__data.is_null() {
                        ::libc::free(__data as *mut libc::c_void);
                    }
                };
                {
                    let __data = (*__this).command_line_buf_ as *mut libc::c_char;
                    if !__data.is_null() {
                        ::libc::free(__data as *mut libc::c_void);
                    }
                };
                ACE::strdelete((((*__this).command_line_copy_) as *mut libc::c_char));
                {
                    let __data = (*__this).command_line_argv_ as *mut *mut libc::c_char;
                    if !__data.is_null() {
                        ::libc::free(__data as *mut libc::c_void);
                    }
                };
...
#[export_name = "__acedtor_u9f898fe84bb87f35"]
pub unsafe extern "C-unwind" fn __acedtor_u9f898fe84bb87f35(
    __this: *mut ACE_Process_Options,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[export_name = "_ZN19ACE_Process_Options11set_handlesEiii"]
pub unsafe extern "C-unwind" fn __xtu__ZN19ACE_Process_Options11set_handlesEiii(
    __this: *mut ACE_Process_Options,
    std_in: libc::c_int,
    std_out: libc::c_int,
    std_err: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_Process_Options::set_handles(__this, std_in, std_out, std_err) }
}
#[export_name = "_ZN19ACE_Process_Options15release_handlesEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN19ACE_Process_Options15release_handlesEv(
    __this: *mut ACE_Process_Options,
) {
    unsafe { ACE_Process_Options::release_handles(__this) }
}
#[export_name = "_ZN19ACE_Process_Options6setenvEPPc"]
pub unsafe extern "C-unwind" fn __xtu__ZN19ACE_Process_Options6setenvEPPc(
    __this: *mut ACE_Process_Options,
    envp: *mut *mut libc::c_char,
) -> libc::c_int {
    unsafe { ACE_Process_Options::setenv_u272ea02094c11226(__this, envp) }
}
#[export_name = "_ZN19ACE_Process_Options12command_lineEPKPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN19ACE_Process_Options12command_lineEPKPKc(
    __this: *mut ACE_Process_Options,
    argv: *const *const libc::c_char,
) -> libc::c_int {
    unsafe { ACE_Process_Options::command_line_u0cd738baa4082b1b(__this, argv) }
}
#[export_name = "_ZN19ACE_Process_Options17command_line_argvEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN19ACE_Process_Options17command_line_argvEv(
    __this: *mut ACE_Process_Options,
) -> *const *mut libc::c_char {
    unsafe { ACE_Process_Options::command_line_argv(__this) }
}
#[export_name = "_ZN19ACE_Process_Options7env_bufEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN19ACE_Process_Options7env_bufEv(
    __this: *mut ACE_Process_Options,
) -> *mut libc::c_char {
    unsafe { ACE_Process_Options::env_buf(__this) }
}
#[export_name = "_ZN19ACE_Process_Options11pass_handleEi"]
pub unsafe extern "C-unwind" fn __xtu__ZN19ACE_Process_Options11pass_handleEi(
    __this: *mut ACE_Process_Options,
    h: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_Process_Options::pass_handle(__this, h) }
}
#[export_name = "_ZNK19ACE_Process_Options11dup_handlesER14ACE_Handle_Set"]
pub unsafe extern "C-unwind" fn __xtu__ZNK19ACE_Process_Options11dup_handlesER14ACE_Handle_Set(
    __this: *const ACE_Process_Options,
    set: *mut ACE_Handle_Set,
) -> libc::c_int {
    unsafe { ACE_Process_Options::dup_handles(__this, set) }
}
#[export_name = "_ZNK19ACE_Process_Options14passed_handlesER14ACE_Handle_Set"]
pub unsafe extern "C-unwind" fn __xtu__ZNK19ACE_Process_Options14passed_handlesER14ACE_Handle_Set(
    __this: *const ACE_Process_Options,
    set: *mut ACE_Handle_Set,
) -> libc::c_int {
    unsafe { ACE_Process_Options::passed_handles(__this, set) }
}
#[export_name = "_ZN19ACE_Process_Options8env_argvEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN19ACE_Process_Options8env_argvEv(
    __this: *mut ACE_Process_Options,
) -> *const *mut libc::c_char {
    unsafe { ACE_Process_Options::env_argv(__this) }
}
#[export_name = "_ZN19ACE_Process_Options8setenv_iEPcm"]
pub unsafe extern "C-unwind" fn __xtu__ZN19ACE_Process_Options8setenv_iEPcm(
    __this: *mut ACE_Process_Options,
    assignment: *mut libc::c_char,
    len: libc::c_ulong,
) -> libc::c_int {
    unsafe { ACE_Process_Options::setenv_i(__this, assignment, len) }
}
...
#[export_name = "_ZN11ACE_ProcessC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_ProcessC1Ev(__this: *mut ACE_Process) {
    ACE_Process::new_at(__this)
}
impl Drop for ACE_Process {
    fn drop(&mut self) {
        unsafe {
            let __this: *mut Self = self as *mut Self;
            {
                <ACE_Process>::close_dup_handles((__this) as *mut ACE_Process);
            }
            ()
        }
    }
}
#[export_name = "_ZN11ACE_Process7prepareER19ACE_Process_Options"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_Process7prepareER19ACE_Process_Options(
    __this: *mut ACE_Process,
    _anon_0: *mut ACE_Process_Options,
) -> libc::c_int {
    unsafe { ACE_Process::prepare(__this, _anon_0) }
}
#[export_name = "_ZN11ACE_Process5spawnER19ACE_Process_Options"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_Process5spawnER19ACE_Process_Options(
    __this: *mut ACE_Process,
    options: *mut ACE_Process_Options,
) -> libc::c_int {
    unsafe { ACE_Process::spawn(__this, options) }
}
#[export_name = "_ZN11ACE_Process6parentEi"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_Process6parentEi(
    __this: *mut ACE_Process,
    _anon_0: libc::c_int,
) {
    unsafe { ACE_Process::parent(__this, _anon_0) }
}
#[export_name = "_ZN11ACE_Process5childEi"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_Process5childEi(
    __this: *mut ACE_Process,
    _anon_0: libc::c_int,
) {
    unsafe { ACE_Process::child(__this, _anon_0) }
}
#[export_name = "_ZN11ACE_Process8unmanageEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_Process8unmanageEv(
    __this: *mut ACE_Process,
) {
    unsafe { ACE_Process::unmanage(__this) }
}
#[export_name = "_ZN11ACE_Process4waitERK14ACE_Time_ValuePi"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_Process4waitERK14ACE_Time_ValuePi(
    __this: *mut ACE_Process,
    tv: *const ACE_Time_Value,
    status: *mut libc::c_int,
) -> libc::c_int {
    unsafe { ACE_Process::wait_u9c844e55a2eff714(__this, tv, status) }
}
#[export_name = "_ZNK11ACE_Process7runningEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK11ACE_Process7runningEv(
    __this: *const ACE_Process,
) -> libc::c_int {
    unsafe { ACE_Process::running(__this) }
}
#[export_name = "_ZN11ACE_Process17close_dup_handlesEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_Process17close_dup_handlesEv(
    __this: *mut ACE_Process,
) {
    unsafe { ACE_Process::close_dup_handles(__this) }
}
#[export_name = "_ZN11ACE_Process20close_passed_handlesEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_Process20close_passed_handlesEv(
    __this: *mut ACE_Process,
) {
    unsafe { ACE_Process::close_passed_handles(__this) }
}
...
#[export_name = "_ZN19ACE_Managed_Process8unmanageEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN19ACE_Managed_Process8unmanageEv(
    __this: *mut ACE_Managed_Process,
) {
    unsafe { ACE_Managed_Process::unmanage(__this) }
}
impl Drop for ACE_Managed_Process {
    fn drop(&mut self) {
        {
            unsafe {
                let __this: *mut Self = self as *mut Self;
...
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Unbounded_Queue_ACE_ARGV_Queue_Entry_T_char__ {
    pub head_: *mut ACE_Node_ACE_ARGV_Queue_Entry_T_char__,
    pub cur_size_: libc::c_ulong,
    pub allocator_: *mut ACE_Allocator,
}
pub unsafe extern "C-unwind" fn __xtu__ZN19ACE_Unbounded_QueueI22ACE_ARGV_Queue_Entry_TIcEEC1EP13ACE_Allocator(
    __this: *mut ACE_Unbounded_Queue_ACE_ARGV_Queue_Entry_T_char__,
    __a0: *mut ACE_Allocator,
) {
    ACE_Unbounded_Queue_ACE_ARGV_Queue_Entry_T_char__::new_at_sb5a8781fceccb7e1(
        __this,
        __a0,
    )
}
...
#[repr(C)]
pub struct ACE_ARGV_T_char_ {
    pub _opaque: [u8; 1],
}
pub type ACE_ARGV = ACE_ARGV_T_char_;
pub mod __cxxabiv1 {}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ACE_Tokenizer_T_char_ {
    pub buffer_: *mut libc::c_char,
    pub index_: libc::c_int,
    pub preserves_: [ACE_Tokenizer_T_char__Preserve_Entry; 16usize],
    pub preserves_index_: libc::c_int,
    pub delimiters_: [ACE_Tokenizer_T_char__Delimiter_Entry; 16usize],
    pub delimiter_index_: libc::c_int,
}
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Tokenizer_TIcEC1EPc(
    __this: *mut ACE_Tokenizer_T_char_,
    __a0: *mut libc::c_char,
) {
    ACE_Tokenizer_T_char_::new_at_s73bd3a4d73cd429b(__this, __a0)
}
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Tokenizer_TIcE17delimiter_replaceEcc(
    __this: *mut ACE_Tokenizer_T_char_,
    d: libc::c_char,
    replacement: libc::c_char,
) -> libc::c_int {
    unsafe { ACE_Tokenizer_T_char_::delimiter_replace(__this, d, replacement) }
}
#[export_name = "_ZN15ACE_Tokenizer_TIcE20preserve_designatorsEcci"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Tokenizer_TIcE20preserve_designatorsEcci(
    __this: *mut ACE_Tokenizer_T_char_,
    start: libc::c_char,
    stop: libc::c_char,
    strip: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_Tokenizer_T_char_::preserve_designators(__this, start, stop, strip) }
}
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Tokenizer_TIcE12is_delimiterEcRiRc(
    __this: *mut ACE_Tokenizer_T_char_,
    d: libc::c_char,
    replace: *mut libc::c_int,
    r: *mut libc::c_char,
) -> libc::c_int {
    unsafe { ACE_Tokenizer_T_char_::is_delimiter(__this, d, replace, r) }
}
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Tokenizer_TIcE22is_preserve_designatorEcRcRi(
    __this: *mut ACE_Tokenizer_T_char_,
    start: libc::c_char,
    stop: *mut libc::c_char,
    strip: *mut libc::c_int,
) -> libc::c_int {
    unsafe { ACE_Tokenizer_T_char_::is_preserve_designator(__this, start, stop, strip) }
}
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Tokenizer_TIcE4nextEv(
    __this: *mut ACE_Tokenizer_T_char_,
) -> *mut libc::c_char {
    unsafe { ACE_Tokenizer_T_char_::next(__this) }
}
pub type ACE_Tokenizer = ACE_Tokenizer_T_char_;
pub(crate) unsafe extern "C-unwind" fn sigchld_nop(
...
impl ACE_Process_Options {
    ...
    pub unsafe fn new_at(
        ...
        mut command_line_buf_len: libc::c_ulong,
        mut env_buf_len: libc::c_ulong,
        mut max_env_args: libc::c_ulong,
        mut max_cmdline_args: libc::c_ulong,
    ) {
        unsafe {
            ::core::ptr::write(
                __this,
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).inherit_environment_),
                inherit_environment,
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).creation_flags_),
                ((0) as libc::c_ulong),
            );
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).avoid_zombies_), 0);
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).stdin_),
                (((-((1) as libc::c_int))) as libc::c_int),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).stdout_),
                (((-((1) as libc::c_int))) as libc::c_int),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).stderr_),
                (((-((1) as libc::c_int))) as libc::c_int),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).ruid_),
                ((-((1) as libc::c_int)) as libc::c_uint),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).euid_),
                ((-((1) as libc::c_int)) as libc::c_uint),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).rgid_),
                ((-((1) as libc::c_int)) as libc::c_uint),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).egid_),
                ((-((1) as libc::c_int)) as libc::c_uint),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).handle_inheritance_),
                true,
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).set_handles_called_),
                0,
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).environment_buf_index_),
                ((0) as libc::c_ulong),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).environment_argv_index_),
                ((0) as libc::c_ulong),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).environment_buf_),
                ((0) as *mut libc::c_char),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).environment_buf_len_),
                env_buf_len,
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).max_environment_args_),
                max_env_args,
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).max_environ_argv_index_),
                (((max_env_args) as libc::c_ulong)).wrapping_sub((1) as libc::c_ulong),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).command_line_argv_calculated_),
                false,
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).command_line_buf_),
                ((0) as *mut libc::c_char),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).command_line_copy_),
                ((0) as *mut libc::c_char),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).command_line_buf_len_),
                command_line_buf_len,
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).max_command_line_args_),
                max_cmdline_args,
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).command_line_argv_),
                ((0) as *mut *mut libc::c_char),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).process_group_),
                (((-((1) as libc::c_int)) as libc::c_int)),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).use_unicode_environment_),
                false,
            );
            <ACE_Handle_Set>::new_at(
                ::core::ptr::addr_of_mut!((* __this).handles_passed_),
            );
            <ACE_Handle_Set>::new_at(::core::ptr::addr_of_mut!((* __this).dup_handles_));
            {
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            {
                                (*__this).command_line_buf_ = {
                                    let __count: usize = (command_line_buf_len) as usize;
                                ...
                                if ((((((*__this).command_line_buf_).is_null())
                ...
                (*((*__this).command_line_buf_).wrapping_offset((0) as isize)) = ((0
                    as libc::c_char) as libc::c_char);
                (*((((*__this).process_name_).as_ptr() as *mut libc::c_char)
                    .wrapping_offset((0) as isize))) = ((0 as libc::c_char)
                    as libc::c_char);
                (*((((*__this).working_directory_).as_ptr() as *mut libc::c_char)
                    .wrapping_offset((0) as isize))) = ((0 as libc::c_char)
                    as libc::c_char);
                'dowhile_1: loop {
                    'cont_1: loop {
                        {
                            {
                                (*__this).environment_buf_ = {
                                    let __count: usize = (env_buf_len) as usize;
                                    let __nbytes = __count
                                        .checked_mul(::core::mem::size_of::<libc::c_char>())
                                        .expect("array new[] size overflow");
                                    let __data = ::libc::malloc(
                                ...
                                if ((((((*__this).environment_buf_).is_null())
                                    as libc::c_int) as libc::c_int) != 0)
                                {
                                    ((*(__errno_location()))) = 12;
                                    return;
                ...
                'dowhile_2: loop {
                    'cont_2: loop {
                        {
                            {
                                (*__this).environment_argv_ = {
                                    let __count: usize = (max_env_args) as usize;
                                    let __nbytes = __count
                                        .checked_mul(::core::mem::size_of::<*mut libc::c_char>())
                                        .expect("array new[] size overflow");
                                    let __data = ::libc::malloc(
                                        if __nbytes == 0 { 1 } else { __nbytes },
                                    ...
                                    if __data.is_null() {
                                        ::std::alloc::handle_alloc_error(
                                            ::core::alloc::Layout::array::<*mut libc::c_char>(__count)
                                                .unwrap(),
                                        );
                                    }
                                    ::core::ptr::write_bytes(__data, 0u8, __count);
                                ...
                                if ((((((*__this).environment_argv_).is_null())
                                    as libc::c_int) as libc::c_int) != 0)
                                {
                                    ((*(__errno_location()))) = 12;
                                    return;
                ...
                (*((*__this).environment_buf_).wrapping_offset((0) as isize)) = ((0
                    as libc::c_char) as libc::c_char);
                (*((*__this).environment_argv_).wrapping_offset((0) as isize)) = ((0)
                    as *mut libc::c_char);
                'dowhile_3: loop {
                    'cont_3: loop {
                        {
                            {
                                (*__this).command_line_argv_ = {
                                    let __count: usize = (max_cmdline_args) as usize;
                                    let __nbytes = __count
                                        .checked_mul(::core::mem::size_of::<*mut libc::c_char>())
                                        .expect("array new[] size overflow");
                                    let __data = ::libc::malloc(
                                ...
                                if ((((((*__this).command_line_argv_).is_null())
                                    as libc::c_int) as libc::c_int) != 0)
                                {
                                    ((*(__errno_location()))) = 12;
                                    return;
    ...
    pub unsafe fn set_handles(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                (*__this).set_handles_called_ = 1;
                (*__this).stdin_ = ACE_OS::dup_u8dba25e4b6f24d00(std_in);
                (*__this).stdout_ = ACE_OS::dup_u8dba25e4b6f24d00(std_out);
                (*__this).stderr_ = ACE_OS::dup_u8dba25e4b6f24d00(std_err);
                return 0;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    ...
    pub unsafe fn release_handles(__this: *mut Self) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((*__this).set_handles_called_) != 0) {
                    ACE_OS::close_u07c1eb6343f8c667((*__this).stdin_);
                    ACE_OS::close_u07c1eb6343f8c667((*__this).stdout_);
                    ACE_OS::close_u07c1eb6343f8c667((*__this).stderr_);
                    (*__this).set_handles_called_ = 0;
                }
            }
            ()
        }
  ...
  /// any spaces between VARIABLE and the equal sign.*/
    #[export_name = "_ZN19ACE_Process_Options6setenvEPKcz"]
    pub unsafe extern "C-unwind" fn setenv(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut stack_buf: [libc::c_char; 1024usize] = unsafe {
                    ::core::mem::zeroed()
                };
                let mut argp: ::core::ffi::VaList<'_> = unsafe {
                    ::core::mem::MaybeUninit::<::core::ffi::VaList<'_>>::zeroed()
                ...
                argp = __args.clone();
                let mut status: libc::c_int = ACE_OS::vsnprintf_u82a2749143e3ac84(
                ...
                if (((((<ACE_Process_Options>::setenv_i(
                    (__this) as *mut ACE_Process_Options,
                    ((stack_buf).as_mut_ptr() as *mut libc::c_char),
                    ACE_OS::strlen_u07dd12a225364fa6(
                        ((stack_buf).as_ptr() as *const libc::c_char),
                    ),
    ...
    pub unsafe extern "C-unwind" fn setenv_ua72e95eb0d05341a(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut buflen: libc::c_ulong = ((((((((ACE_OS::strlen_u07dd12a225364fa6(
                    ((variable_name) as *const libc::c_char),
                )) as libc::c_ulong))
                    .wrapping_add(
                        (ACE_OS::strlen_u07dd12a225364fa6(
                            ((format) as *const libc::c_char),
                    ...
                    .wrapping_add((2) as libc::c_ulong)) as libc::c_ulong);
                let mut newformat: *mut libc::c_char = ((0) as *mut libc::c_char);
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            {
                                newformat = {
                                    let __count: usize = (buflen) as usize;
                                    let __nbytes = __count
                                        .checked_mul(::core::mem::size_of::<libc::c_char>())
                                        .expect("array new[] size overflow");
                                    let __data = ::libc::malloc(
                                ...
                                if (((((newformat).is_null()) as libc::c_int)
                                    as libc::c_int) != 0)
                                {
                                    ((*(__errno_location()))) = 12;
                                    return (-((1) as libc::c_int));
                ...
                let mut safe_newformat: ACE_Auto_Basic_Array_Ptr_char_ = ::core::mem::MaybeUninit::<
                    ACE_Auto_Basic_Array_Ptr_char_,
                >::zeroed()
                    .assume_init();
                <ACE_Auto_Basic_Array_Ptr_char_>::new_at_s532c2c2e97370d04(
                    (::core::ptr::addr_of_mut!(safe_newformat))
                        as *mut ACE_Auto_Basic_Array_Ptr_char_,
                    ((newformat) as *mut libc::c_char),
                );
                ACE_OS::snprintf_u9a28649a3b771eeb(
                    <ACE_Auto_Basic_Array_Ptr_char_>::get(
                        (::core::ptr::addr_of!(safe_newformat))
                ...
                let mut tmp_buflen: libc::c_ulong = ((buflen) as libc::c_ulong);
                if ((((((1024 as libc::c_int) as libc::c_uint))
                    > (((buflen) as libc::c_uint))) as libc::c_int as libc::c_int) != 0)
                {
                    tmp_buflen = (((1024 as libc::c_int)) as libc::c_ulong);
                }
                let mut retval: libc::c_int = 0;
                let mut stack_buf: *mut libc::c_char = ((0) as *mut libc::c_char);
                'dowhile_1: loop {
                    'cont_1: loop {
                        {
                            {
                                stack_buf = {
                                    let __count: usize = (tmp_buflen) as usize;
                                    let __nbytes = __count
                                        .checked_mul(::core::mem::size_of::<libc::c_char>())
                                        .expect("array new[] size overflow");
                                    let __data = ::libc::malloc(
                                ...
                                if (((((stack_buf).is_null()) as libc::c_int)
                                    as libc::c_int) != 0)
                                {
                                    ((*(__errno_location()))) = 12;
                                    return (-((1) as libc::c_int));
                ...
                let mut safe_stack_buf: ACE_Auto_Basic_Array_Ptr_char_ = ::core::mem::MaybeUninit::<
                    ACE_Auto_Basic_Array_Ptr_char_,
                >::zeroed()
                    .assume_init();
                <ACE_Auto_Basic_Array_Ptr_char_>::new_at_s532c2c2e97370d04(
                    (::core::ptr::addr_of_mut!(safe_stack_buf))
                        as *mut ACE_Auto_Basic_Array_Ptr_char_,
                    ((stack_buf) as *mut libc::c_char),
                );
                'dowhile_2: loop {
                    'cont_2: loop {
                        {
                            {
                                ...
                                argp = __args.clone();
                                retval = ACE_OS::vsnprintf_u82a2749143e3ac84(
                                    <ACE_Auto_Basic_Array_Ptr_char_>::get(
                                        (::core::ptr::addr_of!(safe_stack_buf))
                                            as *const ACE_Auto_Basic_Array_Ptr_char_,
                                    ),
                                    tmp_buflen,
                                    ((<ACE_Auto_Basic_Array_Ptr_char_>::get(
                                ...
                                if (((((retval as libc::c_int))
                                    > (((ACE_Utils::truncate_cast___unsigned_long_(
                                        ((tmp_buflen) as libc::c_ulong),
                                    )) as libc::c_int))) as libc::c_int as libc::c_int) != 0)
                                {
                                    {
                                        tmp_buflen = (((tmp_buflen) as libc::c_ulong))
                                    ...
                                    <ACE_Auto_Basic_Array_Ptr_char_>::reset(
                                        (::core::ptr::addr_of_mut!(safe_stack_buf))
                                            as *mut ACE_Auto_Basic_Array_Ptr_char_,
                                        ((stack_buf) as *mut libc::c_char),
                                    );
                    ...
                    as libc::c_int) != 0)
                {
                    if (((((((*(__errno_location()))) as libc::c_int))
                        == (((95) as libc::c_int))) as libc::c_int as libc::c_int) != 0)
                    {
                        let mut argp: ::core::ffi::VaList<'_> = unsafe {
                            ::core::mem::MaybeUninit::<::core::ffi::VaList<'_>>::zeroed()
                                .assume_init()
                        ...
                        argp = __args.clone();
                        retval = ACE_OS::vsprintf_u244a12457fe38a73(
                            <ACE_Auto_Basic_Array_Ptr_char_>::get(
                                (::core::ptr::addr_of!(safe_stack_buf))
                                    as *const ACE_Auto_Basic_Array_Ptr_char_,
                            ),
    ...
    pub unsafe fn setenv_u272ea02094c11226(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                'while_0: loop {
                    if !((!((*(envp).wrapping_offset((i) as isize))).is_null())) {
                        break 'while_0;
                    }
                    'cont_0: loop {
                        {
                            {
                                if (((((<ACE_Process_Options>::setenv_i(
                                    (__this) as *mut ACE_Process_Options,
                                    (*(envp).wrapping_offset((i) as isize)),
                                    ACE_OS::strlen_u07dd12a225364fa6(
                                        (((*(envp).wrapping_offset((i) as isize)))
                                            as *const libc::c_char),
                                    ),
  ...
  /// be <= MAXPATHLEN.*/
    ...
    pub unsafe extern "C-unwind" fn command_line(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                argp = __args.clone();
                if ((((((*__this).command_line_buf_len_ as libc::c_ulong))
                    < (((1) as libc::c_ulong))) as libc::c_int as libc::c_int) != 0)
                {
                    ();
                    return (-((1) as libc::c_int));
                }
                ACE_OS::vsnprintf_u82a2749143e3ac84(
                    (((*__this).command_line_buf_) as *mut libc::c_char),
                    (*__this).command_line_buf_len_,
                    ((format) as *const libc::c_char),
                    argp,
                );
                ();
                (*__this).command_line_argv_calculated_ = false;
                return 0;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    ...
    #[export_name = "_ZN19ACE_Process_Options12command_lineEPKwz"]
    pub unsafe extern "C-unwind" fn command_line_u2cac8ba314fa5ee6(
        __this: *mut Self,
        mut format: *const libc::wchar_t,
        mut __args: ...
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut anti_clb: *mut libc::wchar_t = ((0) as *mut libc::wchar_t);
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            {
                                anti_clb = {
                                    let __count: usize = ((*__this).command_line_buf_len_)
                                        as usize;
                                    let __nbytes = __count
                                ...
                                if (((((anti_clb).is_null()) as libc::c_int) as libc::c_int)
                                    != 0)
                                {
                                    ((*(__errno_location()))) = 12;
                                    return (-((1) as libc::c_int));
                ...
                argp = __args.clone();
                ACE_OS::vsnprintf_u5faa4708bec76a1c(
                    ((anti_clb) as *mut libc::wchar_t),
                    (*__this).command_line_buf_len_,
                    ((format) as *const libc::wchar_t),
                    argp,
                );
                ();
                ACE_OS::strcpy_u08e8184bcebbac89(
                    ...
                    ((<ACE_Wide_To_Ascii>::char_rep(
                        (((&mut ({
                            let mut __recv: ACE_Wide_To_Ascii = (<ACE_Wide_To_Ascii>::new(
                                ((anti_clb) as *const libc::wchar_t),
                            ));
                            __recv
                        })) as *mut ACE_Wide_To_Ascii)) as *mut ACE_Wide_To_Ascii,
                    )) as *const libc::c_char),
                ...
                {
                    let __data = anti_clb as *mut libc::wchar_t;
                    if !__data.is_null() {
                        ::libc::free(__data as *mut libc::c_void);
                    }
                };
    ...
    pub unsafe fn command_line_u0cd738baa4082b1b(
        ...
        unsafe {
            ...
            {
                let mut i: libc::c_int = 0;
                if (!((*(argv).wrapping_offset((i) as isize))).is_null()) {
                    ACE_OS::strcat_u59e0931d4af5fb3f(
                        (((*__this).command_line_buf_) as *mut libc::c_char),
                        (((*(argv).wrapping_offset((i) as isize)))
                            as *const libc::c_char),
                    );
                    'while_0: loop {
                        if !((!((*(argv)
                        ...
                        'cont_0: loop {
                            {
                                {
                                    let mut cur_len: libc::c_ulong = ((((((((ACE_OS::strlen_u07dd12a225364fa6(
                                        (((*__this).command_line_buf_) as *const libc::c_char),
                                    )) as libc::c_ulong))
                                        .wrapping_add(
                                            (ACE_OS::strlen_u07dd12a225364fa6(
                                                (((*(argv).wrapping_offset((i) as isize)))
                                        ...
                                        .wrapping_add((2) as libc::c_ulong)) as libc::c_ulong);
                                    if (((((cur_len as libc::c_ulong))
                                        > ((((*__this).command_line_buf_len_) as libc::c_ulong)))
                                        as libc::c_int as libc::c_int) != 0)
                                    {
                                        'dowhile_1: loop {
                                            'cont_1: loop {
                                                {
                                                    {
                                                        ...
                                                        <ACE_Log_Category_TSS>::conditional_set(
                                                            ...
                                                            ((b"/build/ace_full/src/ACE/ace/Process.cpp\0".as_ptr()
                                                        ...
                                                        <ACE_Log_Category_TSS>::log(
                                                            (ace___) as *mut ACE_Log_Category_TSS,
                                                            LM_ERROR,
                                                            ((b"ACE_Process:command_line: command line is longer than %d\n\0"
  ...
  /// into which the total length of the command line buffer is returned.*/
    ...
    pub unsafe fn command_line_argv(__this: *mut Self) -> *const *mut libc::c_char {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((!((((*__this).command_line_argv_calculated_ as libc::c_int) != 0))
                    as libc::c_int) as libc::c_int) != 0)
                {
                    (*__this).command_line_argv_calculated_ = true;
                    ACE::strdelete(
                        (((*__this).command_line_copy_) as *mut libc::c_char),
                    );
                    (*__this).command_line_copy_ = ((ACE::strnew(
                        (((*__this).command_line_buf_) as *const libc::c_char),
                    )) as *mut libc::c_char);
                    let mut parser: ACE_Tokenizer_T_char_ = ::core::mem::MaybeUninit::<
                        ACE_Tokenizer_T_char_,
                    >::zeroed()
                        .assume_init();
                    <ACE_Tokenizer_T_char_>::new_at_s73bd3a4d73cd429b(
                        (::core::ptr::addr_of_mut!(parser))
                            as *mut ACE_Tokenizer_T_char_,
                        (((*__this).command_line_copy_) as *mut libc::c_char),
                    );
                    <ACE_Tokenizer_T_char_>::delimiter_replace(
                        (::core::ptr::addr_of_mut!(parser))
                            as *mut ACE_Tokenizer_T_char_,
                        32 as libc::c_char,
                        0 as libc::c_char,
                    );
                    <ACE_Tokenizer_T_char_>::preserve_designators(
                        (::core::ptr::addr_of_mut!(parser))
                            as *mut ACE_Tokenizer_T_char_,
                        34 as libc::c_char,
                        34 as libc::c_char,
                    ...
                    'dowhile_0: loop {
                        'cont_0: loop {
                            {
                                (*((*__this).command_line_argv_)
                                    .wrapping_offset((x) as isize)) = ((<ACE_Tokenizer_T_char_>::next(
                                    (::core::ptr::addr_of_mut!(parser))
                                        as *mut ACE_Tokenizer_T_char_,
                                )) as *mut libc::c_char);
                            }
                        ...
                        if !(((((((((!((*((*__this).command_line_argv_)
                            ...
                            && ((((({
                                ...
                                *__lv
                                ...
                                < (((((((*__this).max_command_line_args_) as libc::c_ulong))
                    ...
                    (*((*__this).command_line_argv_).wrapping_offset((x) as isize)) = ((0)
                        as *mut libc::c_char);
                }
                return (((*__this).command_line_argv_) as *const *mut libc::c_char);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    ...
    pub unsafe fn env_buf(__this: *mut Self) -> *mut libc::c_char {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((((*((*__this).environment_buf_).wrapping_offset((0) as isize))
                    ...
                    as libc::c_int as libc::c_int) != 0)
                {
                    ...
                    return (*__this).environment_buf_;
                }
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
  ...
  /// from surviving in the created process.*/
    ...
    pub unsafe fn pass_handle(__this: *mut Self, mut h: libc::c_int) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                <ACE_Handle_Set>::set_bit(
                    (::core::ptr::addr_of_mut!((* __this).handles_passed_))
                        as *mut ACE_Handle_Set,
                    h,
                );
                return 0;
            }
    ...
    pub unsafe fn dup_handles(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((((<ACE_Handle_Set>::num_set(
                    (::core::ptr::addr_of!((* __this).dup_handles_))
                        as *const ACE_Handle_Set,
                ) as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    return 0;
                ...
                <ACE_Handle_Set>::reset(
                    (::core::ptr::addr_of_mut!((* set))) as *mut ACE_Handle_Set,
                );
                <ACE_Handle_Set>::operator_assign(
                    (::core::ptr::addr_of_mut!((* set))) as *mut ACE_Handle_Set,
                    ::core::ptr::addr_of!((* __this).dup_handles_),
                );
                return 1;
    ...
    pub unsafe fn passed_handles(
        ...
        unsafe {
            ...
            {
                if (((((<ACE_Handle_Set>::num_set(
                    (::core::ptr::addr_of!((* __this).handles_passed_))
                        as *const ACE_Handle_Set,
                ) as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
  ...
  /// for Win32 when ACE_USES_WCHAR is not defined.*/
    ...
    pub unsafe fn env_argv(__this: *mut Self) -> *const *mut libc::c_char {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((*__this).environment_argv_) as *const *mut libc::c_char);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    ...
    pub unsafe fn setenv_i(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                if ((((((((((*__this).environment_argv_index_ as libc::c_ulong))
                    == ((((*__this).max_environ_argv_index_) as libc::c_ulong)))
                    as libc::c_int as libc::c_int) != 0)
                    || (((((((((len) as libc::c_ulong))
                        .wrapping_add(
                            ((*__this).environment_buf_index_) as libc::c_ulong,
                        )) as libc::c_ulong))
                        >= ((((*__this).environment_buf_len_) as libc::c_ulong)))
                        as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    return (-((1) as libc::c_int));
                ...
                ACE_OS::memcpy_u6033eb81edaf9212(
                    ((((*__this).environment_buf_)
                        .wrapping_offset(((*__this).environment_buf_index_) as isize))
                        as *mut libc::c_void),
                    ((assignment) as *const libc::c_void),
                ...
                (*((*__this).environment_argv_)
                    .wrapping_offset(
                        ({
                            let __lv = &mut ((*__this).environment_argv_index_);
                            let __r = *__lv;
                            *__lv = (*__lv).wrapping_add(1);
                            __r
                        }) as isize,
                    ...
                    .wrapping_offset(((*__this).environment_buf_index_) as isize);
                (*((*__this).environment_argv_)
                    .wrapping_offset(((*__this).environment_argv_index_) as isize)) = ((0)
                    as *mut libc::c_char);
                {
                    let __lv = ::core::ptr::addr_of_mut!(
                        (* __this).environment_buf_index_
                    );
                    unsafe {
                ...
                (*((*__this).environment_buf_)
                    .wrapping_offset(((*__this).environment_buf_index_) as isize)) = ((0
                    as libc::c_char) as libc::c_char);
                return 0;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
...
impl ACE_Process {
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ...
            *(__this as *mut *const ()) = &__VTBL_u75264ee698c7f168
                as *const __Vtbl_u75264ee698c7f168 as *const ();
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).child_id_),
                (((-((1) as libc::c_int)) as libc::c_int)),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).exit_code_),
                ((0) as libc::c_int),
            );
            <ACE_Handle_Set>::new_at(
                ::core::ptr::addr_of_mut!((* __this).handles_passed_),
    ...
    pub unsafe fn prepare(
        __this: *mut Self,
        mut _anon_0: *mut ACE_Process_Options,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
    ...
    pub unsafe fn spawn(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                let mut set_p: *mut ACE_Handle_Set = ((0) as *mut ACE_Handle_Set);
                if ((<ACE_Process_Options>::dup_handles(
                    (::core::ptr::addr_of!((* options))) as *const ACE_Process_Options,
                    ::core::ptr::addr_of_mut!((* __this).dup_handles_),
                )) != 0)
                {
                    set_p = ::core::ptr::addr_of_mut!((* __this).dup_handles_)
                        as *mut ACE_Handle_Set;
                } else {
                    if ((<ACE_Process_Options>::passed_handles(
                        (::core::ptr::addr_of!((* options)))
                            as *const ACE_Process_Options,
                        ::core::ptr::addr_of_mut!((* __this).handles_passed_),
                    )) != 0)
                    {
                        set_p = ::core::ptr::addr_of_mut!((* __this).handles_passed_)
                            as *mut ACE_Handle_Set;
                    }
                }
                if (((((!(set_p).is_null())
                    && (((!((((((((((((<ACE_Process_Options>::creation_flags(
                        (::core::ptr::addr_of!((* options)))
                            as *const ACE_Process_Options,
                    ...
                    as libc::c_int) as libc::c_int) != 0)
                {
                    let mut max_len: libc::c_ulong = ((0) as libc::c_ulong);
                    let mut cmd_line_buf: *mut libc::c_char = <ACE_Process_Options>::command_line_buf(
                        (::core::ptr::addr_of_mut!((* options)))
                            as *mut ACE_Process_Options,
                        ::core::ptr::addr_of_mut!(max_len) as *mut libc::c_ulong,
                    );
                    let mut curr_len: libc::c_ulong = ACE_OS::strlen_u07dd12a225364fa6(
                        ((cmd_line_buf) as *const libc::c_char),
                    );
                    let mut h_iter: ACE_Handle_Set_Iterator = ::core::mem::MaybeUninit::<
                        ACE_Handle_Set_Iterator,
                    >::zeroed()
                        .assume_init();
                    <ACE_Handle_Set_Iterator>::new_at(
                        (::core::ptr::addr_of_mut!(h_iter))
                            as *mut ACE_Handle_Set_Iterator,
                        set_p,
                    );
                    {
                        let mut h: libc::c_int = <ACE_Handle_Set_Iterator>::operator_call(
                            (::core::ptr::addr_of_mut!(h_iter))
                                as *mut ACE_Handle_Set_Iterator,
                        );
                        'for_0: loop {
                            if !((((((((((h as libc::c_int))
                                != ((((-((1) as libc::c_int))) as libc::c_int)))
                                as libc::c_int as libc::c_int) != 0)
                                && ((((((((curr_len) as libc::c_ulong))
                                    .wrapping_add((20) as libc::c_ulong) as libc::c_ulong))
                                    < (((max_len) as libc::c_ulong))) as libc::c_int
                                    as libc::c_int) != 0)) as libc::c_int) as libc::c_int)
                                != 0))
                            {
                                break;
                            ...
                            'cont_0: loop {
                                {
                                    {
                                        {
                                            curr_len = (((curr_len) as libc::c_ulong))
                                                .wrapping_add(
                                                    (ACE_OS::sprintf_u124e1cc3d4c1a9fc(
                                                        ((::core::ptr::addr_of_mut!(
                                                            (* (cmd_line_buf).wrapping_offset((curr_len) as isize))
                                                        ) as *mut libc::c_char) as *mut libc::c_char),
                                                        ((b" +H %d\0".as_ptr() as *const libc::c_char)
                                                            as *const libc::c_char),
                                                        h,
                                                    )) as libc::c_ulong,
                                                );
                            ...
                            {
                                let __v = <ACE_Handle_Set_Iterator>::operator_call(
                                    (::core::ptr::addr_of_mut!(h_iter))
                                        as *mut ACE_Handle_Set_Iterator,
                                );
                                h = __v;
                ...
                (*__this).child_id_ = ACE::fork_u4fb8921c2c83ccf9(
                    <ACE_Process_Options>::process_name_u4c7c375f150565ca(
                        (::core::ptr::addr_of_mut!((* options)))
                            as *mut ACE_Process_Options,
                    ),
                    <ACE_Process_Options>::avoid_zombies_uce94ebb5b3607812(
                        (::core::ptr::addr_of_mut!((* options)))
                            as *mut ACE_Process_Options,
                    ),
                );
                if ((((((*__this).child_id_ as libc::c_int)) == (((0) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    if (((((((((<ACE_Process_Options>::getgroup(
                        (::core::ptr::addr_of!((* options)))
                            as *const ACE_Process_Options,
                    ) as libc::c_int))
                        != ((((((-((1) as libc::c_int)) as libc::c_int)))
                            as libc::c_int))) as libc::c_int as libc::c_int) != 0)
                        && (((((ACE_OS::setpgid_u242b3044f4f12393(
                            ((0) as libc::c_int),
                            <ACE_Process_Options>::getgroup(
                                (::core::ptr::addr_of!((* options)))
                                    as *const ACE_Process_Options,
                            ),
                        ) as libc::c_int)) < (((0) as libc::c_int))) as libc::c_int
                            as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
                    {}
                    if (((((((((<ACE_Process_Options>::getrgid(
                        (::core::ptr::addr_of!((* options)))
                            as *const ACE_Process_Options,
                    ) as libc::c_uint))
                        != (((((-((1) as libc::c_int)) as libc::c_uint))
                            as libc::c_uint))) as libc::c_int as libc::c_int) != 0)
                        || (((((<ACE_Process_Options>::getegid(
                            (::core::ptr::addr_of!((* options)))
                                as *const ACE_Process_Options,
                        ) as libc::c_uint))
                            != (((((-((1) as libc::c_int)) as libc::c_uint))
                        ...
                        as libc::c_int) as libc::c_int) != 0)
                    {
                        if (((((ACE_OS::setregid_u50366ede2d592b3e(
                            <ACE_Process_Options>::getrgid(
                                (::core::ptr::addr_of!((* options)))
                                    as *const ACE_Process_Options,
                            ),
                            <ACE_Process_Options>::getegid(
                    ...
                    if (((((((((<ACE_Process_Options>::getruid(
                        (::core::ptr::addr_of!((* options)))
                            as *const ACE_Process_Options,
                    ) as libc::c_uint))
                        != (((((-((1) as libc::c_int)) as libc::c_uint))
                            as libc::c_uint))) as libc::c_int as libc::c_int) != 0)
                        || (((((<ACE_Process_Options>::geteuid(
                            (::core::ptr::addr_of!((* options)))
                                as *const ACE_Process_Options,
                        ) as libc::c_uint))
                            != (((((-((1) as libc::c_int)) as libc::c_uint))
                        ...
                        as libc::c_int) as libc::c_int) != 0)
                    {
                        if (((((ACE_OS::setreuid_u70d13597a915cfc4(
                            <ACE_Process_Options>::getruid(
                                (::core::ptr::addr_of!((* options)))
                                    as *const ACE_Process_Options,
                            ),
                            <ACE_Process_Options>::geteuid(
                    ...
                    }
                    {
                        ...
                        let __vt: *const __Vtbl_u75264ee698c7f168 = *(__obj
                            as *const *const __Vtbl_u75264ee698c7f168);
                        ((*__vt)
                            .vfn_udbf99b92792d94dd)(
                            __obj,
                            ACE_OS::getppid_ueab0d2dc69dce544(),
                        )
                    };
                } else {
                    if ((((((*__this).child_id_ as libc::c_int))
                        != ((((-((1) as libc::c_int))) as libc::c_int))) as libc::c_int
                        as libc::c_int) != 0)
                    {
                        {
                            ...
                            let __vt: *const __Vtbl_u75264ee698c7f168 = *(__obj
                                as *const *const __Vtbl_u75264ee698c7f168);
                            ((*__vt).vfn_uecaa3acc181bab5b)(__obj, (*__this).child_id_)
                        };
                    }
                }
                if (((((((((((<ACE_Process_Options>::creation_flags(
                    (::core::ptr::addr_of!((* options))) as *const ACE_Process_Options,
                ))) as libc::c_ulong)) & ((((1 as libc::c_int))) as libc::c_ulong))
                    as libc::c_ulong)) != (((0) as libc::c_ulong))) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    return (*__this).child_id_;
                }
                'switch_0: {
                    let __c: libc::c_int = (*__this).child_id_;
                    ...
                    if __m <= 1 {
                        if (((((((((<ACE_Process_Options>::get_stdin(
                            (::core::ptr::addr_of!((* options)))
                                as *const ACE_Process_Options,
                        ) as libc::c_int))
                            != ((((-((1) as libc::c_int))) as libc::c_int)))
                            as libc::c_int as libc::c_int) != 0)
                            && (((((ACE_OS::dup2_uc67e543d2abcb368(
                                <ACE_Process_Options>::get_stdin(
                                    (::core::ptr::addr_of!((* options)))
                                        as *const ACE_Process_Options,
                                ),
                                ((0) as libc::c_int),
                            ...
                            as libc::c_int) != 0)
                        {
                            ACE_OS::exit_ud318a3a23e137d2b(((*(__errno_location()))));
                        } else {
                            if (((((((((<ACE_Process_Options>::get_stdout(
                                (::core::ptr::addr_of!((* options)))
                                    as *const ACE_Process_Options,
                            ) as libc::c_int))
                                != ((((-((1) as libc::c_int))) as libc::c_int)))
                                as libc::c_int as libc::c_int) != 0)
                                && (((((ACE_OS::dup2_uc67e543d2abcb368(
                                    <ACE_Process_Options>::get_stdout(
                                        (::core::ptr::addr_of!((* options)))
                                            as *const ACE_Process_Options,
                                    ),
                                    ((1) as libc::c_int),
                                ...
                                as libc::c_int) != 0)
                            {
                                ...
                                if (((((((((<ACE_Process_Options>::get_stderr(
                                    (::core::ptr::addr_of!((* options)))
                                        as *const ACE_Process_Options,
                                ) as libc::c_int))
                                    != ((((-((1) as libc::c_int))) as libc::c_int)))
                                    as libc::c_int as libc::c_int) != 0)
                                    && (((((ACE_OS::dup2_uc67e543d2abcb368(
                                        <ACE_Process_Options>::get_stderr(
                                            (::core::ptr::addr_of!((* options)))
                                                as *const ACE_Process_Options,
                                        ),
                                        ((2) as libc::c_int),
                        ...
                        ACE_OS::close_u07c1eb6343f8c667(
                            <ACE_Process_Options>::get_stdin(
                                (::core::ptr::addr_of!((* options)))
                                    as *const ACE_Process_Options,
                            ),
                        ...
                        if (((!(((<ACE_Process_Options>::handle_inheritance(
                            (::core::ptr::addr_of_mut!((* options)))
                                as *mut ACE_Process_Options,
                        )) != 0)) as libc::c_int) as libc::c_int) != 0)
                        {
                            {
                                let mut i: libc::c_int = (((ACE::max_handles())
                                    as libc::c_int))
                                        ...
                                        {
                                            {
                                                ...
                                                ACE_OS::fcntl_ue9a749ea668b010b(
                                                    ((i) as libc::c_int),
                                                    2,
                                                    ((1) as libc::c_long),
                                                );
                        ...
                        if ((((!(<ACE_Process_Options>::working_directory_uf98831c8bacc074c(
                            (::core::ptr::addr_of_mut!((* options)))
                                as *mut ACE_Process_Options,
                        ))
                            .is_null()) as libc::c_int) as libc::c_int) != 0)
                        {
                            ACE_OS::chdir_u77b018072c3d9162(
                                ((<ACE_Process_Options>::working_directory_uf98831c8bacc074c(
                                    (::core::ptr::addr_of_mut!((* options)))
                                        as *mut ACE_Process_Options,
                                )) as *const libc::c_char),
                            );
                        ...
                        let mut result: libc::c_int = 0;
                        let mut procname: *const libc::c_char = ((<ACE_Process_Options>::process_name_u4c7c375f150565ca(
                            (::core::ptr::addr_of_mut!((* options)))
                                as *mut ACE_Process_Options,
                        )) as *const libc::c_char);
                        let mut procargv: *const *mut libc::c_char = ((<ACE_Process_Options>::command_line_argv(
                            (::core::ptr::addr_of_mut!((* options)))
                                as *mut ACE_Process_Options,
                        )) as *const *mut libc::c_char);
                        let mut procenv: *const *mut libc::c_char = ((<ACE_Process_Options>::env_argv(
                            (::core::ptr::addr_of_mut!((* options)))
                                as *mut ACE_Process_Options,
                        )) as *const *mut libc::c_char);
                        if ((<ACE_Process_Options>::inherit_environment(
                            (::core::ptr::addr_of!((* options)))
                                as *const ACE_Process_Options,
                        ) as libc::c_int) != 0)
                        {
                            {
                                ...
                                'for_2: loop {
                                    if !(((((!((*(procenv).wrapping_offset((i) as isize)))
                                        .is_null()) as libc::c_int) as libc::c_int) != 0))
                                    {
                                        break;
                                    }
                                    'cont_2: loop {
                                        {
                                            if (((((ACE_OS::putenv_u2bcc4efea7b4aaa8(
                                                (((*(procenv).wrapping_offset((i) as isize)))
                                                    as *const libc::c_char),
                                            ) as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                                                as libc::c_int) != 0)
                                            {
                            ...
                            result = ACE_OS::execvp_u52a756775140b0d4(
                                procname,
                                procargv,
                            );
                        } else {
                            result = ACE_OS::execve_uc4d493e58c8f0655(
                                procname,
                                procargv,
                                procenv,
                            );
                        ...
                        if (((((result as libc::c_int))
                            ...
                            as libc::c_int as libc::c_int) != 0)
                        {
                            ACE_OS::_exit_u5699558a229ba490(((*(__errno_location()))));
                        }
  ...
  /// if the fork succeeds.  The default simply returns.*/
    pub unsafe fn parent(__this: *mut Self, mut _anon_0: libc::c_int) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {}
            ()
    ...
    pub unsafe fn child(__this: *mut Self, mut _anon_0: libc::c_int) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {}
            ()
    ...
    pub unsafe fn wait_u9c844e55a2eff714(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                {
                    let mut retv: libc::c_int = ACE_OS::waitpid_ua99c1cff38bad46d(
                        (*__this).child_id_,
                        ::core::ptr::addr_of_mut!((* __this).exit_code_)
                            as *mut libc::c_int,
                        1,
                ...
                {
                    return <ACE_Process>::wait((__this) as *mut ACE_Process, status, 0);
                }
                            ...
                            {
                                {
                                    ...
                                    if ((((!(status).is_null()) as libc::c_int) as libc::c_int)
                                        != 0)
                                    {
                                        (*(status)) = (*__this).exit_code_;
                                    }
  ...
  /// systems that support signals, such as UNIX/POSIX.*/
    ...
    pub unsafe fn running(__this: *const Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((((((-((1) as libc::c_int)) as libc::c_int)) as libc::c_int))
                    == (((<ACE_Process>::getpid((__this) as *const ACE_Process))
                        as libc::c_int))) as libc::c_int as libc::c_int) != 0)
                {
                    return 0;
...
impl ACE_Tokenizer_T_char_ {
    ...
    pub unsafe fn new_at_s73bd3a4d73cd429b(
        ...
        unsafe {
            ...
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).index_), 0);
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).preserves_index_),
                0,
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).delimiter_index_),
                0,
            );
            {}
            ()
    ...
    pub unsafe fn new_s73bd3a4d73cd429b(mut __a0: *mut libc::c_char) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s73bd3a4d73cd429b(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    #[doc = "* \\a d is a delimiter and, when found, will be replaced by\n   * \\a replacement.\n   * \\return 0 on success, -1 if there is no memory left.\n   *\n   * <B>Example:</B>\n   * \\verbatim\n     char buf[30];\n     ACE_OS::strcpy(buf, \"William/Joseph/Hagins\");\n\n     ACE_Tokenizer tok (buf);\n     tok.delimiter_replace ('/', 0);\n     for (char *p = tok.next (); p; p = tok.next ())\n       cout << p << endl;\n    \\endverbatim\n   *\n   * This will print out:\n   * \\verbatim\n       William\n       Joseph\n       Hagins \\endverbatim"]
    pub unsafe fn delimiter_replace(
        __this: *mut Self,
        mut d: libc::c_char,
        mut replacement: libc::c_char,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                {
                    ...
                    'for_0: loop {
                        if !((((((i as libc::c_int))
                            < ((((*__this).delimiter_index_) as libc::c_int)))
                            as libc::c_int as libc::c_int) != 0))
                        {
                            break;
                        }
                        'cont_0: loop {
                            {
                                if ((((((*((((*__this).delimiters_).as_ptr()
                                    as *mut ACE_Tokenizer_T_char__Delimiter_Entry)
                                    .wrapping_offset((i) as isize)))
                                    .delimiter_ as libc::c_int as libc::c_char))
                                    == (((d) as libc::c_int as libc::c_char))) as libc::c_int
                                    as libc::c_int) != 0)
                                {
                                    (*((((*__this).delimiters_).as_ptr()
                                        as *mut ACE_Tokenizer_T_char__Delimiter_Entry)
                                        .wrapping_offset((i) as isize)))
                ...
                if ((((((*__this).delimiter_index_ as libc::c_int))
                ...
                (*((((*__this).delimiters_).as_ptr()
                    as *mut ACE_Tokenizer_T_char__Delimiter_Entry)
                    .wrapping_offset(((*__this).delimiter_index_) as isize)))
                    .delimiter_ = d;
                (*((((*__this).delimiters_).as_ptr()
                    as *mut ACE_Tokenizer_T_char__Delimiter_Entry)
                    .wrapping_offset(((*__this).delimiter_index_) as isize)))
                ...
                (*((((*__this).delimiters_).as_ptr()
                    ...
                    .replace_ = 1;
                {
                    let __lv = &mut ((*__this).delimiter_index_);
                    *__lv = (*__lv).wrapping_add(1);
                    *__lv
                };
                return 0;
    ...
    pub unsafe fn preserve_designators(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((((*__this).preserves_index_ as libc::c_int))
                    == ((((16 as libc::c_int)) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    return (-((1) as libc::c_int));
                }
                (*((((*__this).preserves_).as_ptr()
                    as *mut ACE_Tokenizer_T_char__Preserve_Entry)
                    .wrapping_offset(((*__this).preserves_index_) as isize)))
                    .start_ = start;
                (*((((*__this).preserves_).as_ptr()
                    as *mut ACE_Tokenizer_T_char__Preserve_Entry)
                    .wrapping_offset(((*__this).preserves_index_) as isize)))
                ...
                (*((((*__this).preserves_).as_ptr()
                    ...
                    .strip_ = strip;
                {
                    let __lv = &mut ((*__this).preserves_index_);
                    *__lv = (*__lv).wrapping_add(1);
                    *__lv
                };
                return 0;
  ...
  /// replaced with @a r, @a replace is set to 1, otherwise 0.*/
    pub unsafe fn is_delimiter(
        __this: *mut Self,
        mut d: libc::c_char,
        mut replace: *mut libc::c_int,
    ...
    #[doc = "* If @a start is a start preserve designator, returns 1 and sets\n   * @a stop to the stop designator.  Returns 0 if @a start is not a\n   * preserve designator."]
    pub unsafe fn is_preserve_designator(
        __this: *mut Self,
        mut start: libc::c_char,
        mut stop: *mut libc::c_char,
        mut strip: *mut libc::c_int,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                {
                    ...
                    'for_0: loop {
                        if !((((((x as libc::c_int))
                            < ((((*__this).preserves_index_) as libc::c_int)))
                            as libc::c_int as libc::c_int) != 0))
                        {
                            break;
                        }
                        'cont_0: loop {
                            {
                                if ((((((*((((*__this).preserves_).as_ptr()
                                    as *mut ACE_Tokenizer_T_char__Preserve_Entry)
                                    .wrapping_offset((x) as isize)))
                                    .start_ as libc::c_int as libc::c_char))
                                    == (((start) as libc::c_int as libc::c_char)))
                                    as libc::c_int as libc::c_int) != 0)
                                {
                                    (*stop) = (*((((*__this).preserves_).as_ptr()
                                        as *mut ACE_Tokenizer_T_char__Preserve_Entry)
                                        .wrapping_offset((x) as isize)))
                                        .stop_;
                                    (*strip) = (*((((*__this).preserves_).as_ptr()
                                        as *mut ACE_Tokenizer_T_char__Preserve_Entry)
                                        .wrapping_offset((x) as isize)))
                                        .strip_;
                                    return 1;
    ...
    pub unsafe fn next(__this: *mut Self) -> *mut libc::c_char {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            #[allow(unused_assignments)]
            let mut replacement_14239: libc::c_char = unsafe { ::core::mem::zeroed() };
            #[allow(unused_assignments)]
            let mut replace_14240: libc::c_int = unsafe { ::core::mem::zeroed() };
            #[allow(unused_assignments)]
            let mut next_token_14241: *mut libc::c_char = unsafe {
                ::core::mem::zeroed()
            };
            #[allow(unused_assignments)]
            let mut stop_14247: libc::c_char = unsafe { ::core::mem::zeroed() };
            #[allow(unused_assignments)]
            let mut strip_14248: libc::c_int = unsafe { ::core::mem::zeroed() };
            'fn_label_EXIT_LABEL: {
                {
                    if ((((((*__this).index_ as libc::c_int))
                        == ((((-((1) as libc::c_int))) as libc::c_int))) as libc::c_int
                        as libc::c_int) != 0)
                    {
                        (*__this).index_ = 0;
                    ...
                    if (((!((!((*__this).buffer_).is_null())) as libc::c_int)
                        as libc::c_int) != 0)
                    {
                        return ((0) as *mut libc::c_char);
                    }
                    replacement_14239 = ((0) as libc::c_char);
                    next_token_14241 = ((0) as *mut libc::c_char);
                    {
                        'for_0: loop {
                            'cont_0: loop {
                                {
                                    {
                                        ...
                                        if ((<ACE_Tokenizer_T_char_>::is_delimiter(
                                            (__this) as *mut ACE_Tokenizer_T_char_,
                                            (*((*__this).buffer_)
                                                .wrapping_offset(((*__this).index_) as isize)),
                                            ::core::ptr::addr_of_mut!(replace_14240),
                                            ::core::ptr::addr_of_mut!(replacement_14239),
                                        )) != 0)
                                        {
                                            {
                    ...
                    next_token_14241 = ((*__this).buffer_)
                        .wrapping_offset(((*__this).index_) as isize);
                    if ((<ACE_Tokenizer_T_char_>::is_preserve_designator(
                        (__this) as *mut ACE_Tokenizer_T_char_,
                        (*((*__this).buffer_)
                            .wrapping_offset(((*__this).index_) as isize)),
                        ::core::ptr::addr_of_mut!(stop_14247),
                        ::core::ptr::addr_of_mut!(strip_14248),
                    )) != 0)
                    {
                        'while_1: loop {
                            if !((({
                                ...
                                {
                                    {
                                        if ((((((*((*__this).buffer_)
                                            ...
                                            as libc::c_int as libc::c_int) != 0)
                                        {
                                            (*__this).index_ = (-((1) as libc::c_int));
                                            { break 'fn_label_EXIT_LABEL }
                                        }
                                        if ((((((*((*__this).buffer_)
                                            .wrapping_offset(((*__this).index_) as isize))
                                            as libc::c_int as libc::c_char))
                                            == (((stop_14247) as libc::c_int as libc::c_char)))
                                            as libc::c_int as libc::c_int) != 0)
                                        {
                                            break 'while_1;
                                        }
                        ...
                        if ((strip_14248) != 0) {
                            {
                                next_token_14241 = (next_token_14241)
                                    .wrapping_offset((1) as isize);
                                next_token_14241
                            };
                            (*((*__this).buffer_)
                                .wrapping_offset(((*__this).index_) as isize)) = 0
                                as libc::c_char;
                            {
                                let __lv = &mut ((*__this).index_);
                                *__lv = (*__lv).wrapping_add(1);
                                ...
                                {
                                    {
                                        ...
                                        {
                                            if (((((replace_14240 as libc::c_int))
                                                != (((0) as libc::c_int))) as libc::c_int as libc::c_int)
                                                != 0)
                                            {
                                                (*((*__this).buffer_)
                                                    .wrapping_offset(((*__this).index_) as isize)) = replacement_14239;
                                            }
                                            {
                                                let __lv = &mut ((*__this).index_);
                                                *__lv = (*__lv).wrapping_add(1);
                                        ...
                                        )) != 0)
                                        {
                                            ...
                                            'while_3: loop {
                                                if !(((((((((((0 as libc::c_char as libc::c_int
                                                    as libc::c_char))
                                                    != ((((*((*__this).buffer_)
                                                        .wrapping_offset(((*__this).index_) as isize)))
            ...
            {
                return next_token_14241;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
}
impl ACE_Unbounded_Queue_ACE_ARGV_Queue_Entry_T_char__ {
    #[doc = "Construction.  Use user specified allocation strategy\n  /// if specified.\n  /**\n   * Initialize an empty queue using the strategy provided."]
    pub unsafe fn new_at_sb5a8781fceccb7e1(
        __this: *mut Self,
        mut alloc: *mut ACE_Allocator,
    ) {
        unsafe {
            ...
            ::core::ptr::write(
                ...
                ((0) as *mut ACE_Node_ACE_ARGV_Queue_Entry_T_char__),
            );
            ::core::ptr::write(
                        ...
                        {
                            {
                                (*__this).head_ = ({
                                    ...
                                    let __vt: *const __Vtbl_uf2113694993e252c = *(__obj
                                        as *const *const __Vtbl_uf2113694993e252c);
                                    ((*__vt)
                                        .vfn_u685215409e23bf32)(__obj, ((24) as libc::c_ulong))
                                } as *mut ACE_Node_ACE_ARGV_Queue_Entry_T_char__);
                                    ...
                                    as libc::c_int) != 0)
                                {
                                    ...
                                    {
                                        let _ = {
                                            let __place: *mut ACE_Node_ACE_ARGV_Queue_Entry_T_char__ = ((*__this)
                                                .head_) as *mut ACE_Node_ACE_ARGV_Queue_Entry_T_char__;
                                            <ACE_Node_ACE_ARGV_Queue_Entry_T_char__>::new_at_scd38e8ba8919eed7(
                                                (__place) as *mut ACE_Node_ACE_ARGV_Queue_Entry_T_char__,
                                                ((0) as *mut ACE_Node_ACE_ARGV_Queue_Entry_T_char__),
                                                0,
                                            );
                                            __place
    ...
    pub unsafe fn new_sb5a8781fceccb7e1(mut __a0: *mut ACE_Allocator) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_sb5a8781fceccb7e1(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
}
