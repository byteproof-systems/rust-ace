...
pub mod ACE {
    ...
    #[export_name = "_ZN3ACE5crc32EPKc"]
    pub unsafe extern "C-unwind" fn crc32_u0e5e0cf2e3dddc4e(
        mut string: *const libc::c_char,
    ) -> libc::c_uint {
        unsafe {
            {
                let mut crc: libc::c_uint = ((0xffffffffu32) as libc::c_uint);
                {
                    ...
                    'for_0: loop {
                        ...
                        'cont_0: loop {
                            {
                                {
                                    (crc) = (((((super::__anon_ns_9666::crc_table)[((((((((crc)
                                        as libc::c_uint)) ^ (((*(p))) as libc::c_uint)))
                                        as libc::c_uint)) & ((255) as libc::c_uint)) as usize])
                                        as libc::c_uint))
                                        ^ ((((((crc) as libc::c_uint)).wrapping_shr((8) as u32)))
                                            as libc::c_uint));
                                }
                            }
    ...
    #[export_name = "_ZN3ACE5crc32EPKvmj"]
    pub unsafe extern "C-unwind" fn crc32_ub39069a03a8eec8e(
        ...
        unsafe {
            {
                crc = (!(crc));
                {
                    let mut p: *const libc::c_char = (buffer as *const libc::c_char);
                    let mut e: *const libc::c_char = ((buffer as *const libc::c_char))
                        .wrapping_offset((len) as isize);
                    'for_0: loop {
                        if !(((((((p) as *const u8)) != (((e) as *const u8)))
                            as libc::c_int as libc::c_int) != 0))
                        {
                            break;
                        }
  ...
  /// @ len iovec buffers.*/
    #[export_name = "_ZN3ACE5crc32EPK5iovecij"]
        ...
        unsafe {
            {
                crc = (!(crc));
                {
                    ...
                    'for_0: loop {
                        if !((((((i as libc::c_int)) < (((len) as libc::c_int)))
                            as libc::c_int as libc::c_int) != 0))
                        {
                            break;
                        }
                        'cont_0: loop {
                            {
                                {
                                    {
                                        let mut p: *const libc::c_char = ((*(iov)
                                            .wrapping_offset((i) as isize))
                                            .iov_base as *const libc::c_char);
                                        let mut e: *const libc::c_char = (((*(iov)
                                            .wrapping_offset((i) as isize))
                                            .iov_base as *const libc::c_char))
                                            .wrapping_offset(
                                                ((*(iov).wrapping_offset((i) as isize)).iov_len) as isize,
                                            );
                                        'for_1: loop {
                                            if !(((((((p) as *const u8)) != (((e) as *const u8)))
                                                as libc::c_int as libc::c_int) != 0))
...
pub mod __anon_ns_9666 {
    ///**************************************************************
    pub(crate) static crc_table: [libc::c_uint; 256usize] = [
        ((0x00000000i64) as libc::c_uint),
        ((0x77073096i64) as libc::c_uint),
        ((0xee0e612ci64) as libc::c_uint),
        ((0x990951bai64) as libc::c_uint),
        ((0x076dc419i64) as libc::c_uint),
        ((0x706af48fi64) as libc::c_uint),
        ((0xe963a535i64) as libc::c_uint),
        ((0x9e6495a3i64) as libc::c_uint),
        ((0x0edb8832i64) as libc::c_uint),
        ((0x79dcb8a4i64) as libc::c_uint),
        ((0xe0d5e91ei64) as libc::c_uint),
        ((0x97d2d988i64) as libc::c_uint),
        ((0x09b64c2bi64) as libc::c_uint),
        ((0x7eb17cbdi64) as libc::c_uint),
        ((0xe7b82d07i64) as libc::c_uint),
        ((0x90bf1d91i64) as libc::c_uint),
        ((0x1db71064i64) as libc::c_uint),
        ((0x6ab020f2i64) as libc::c_uint),
        ((0xf3b97148i64) as libc::c_uint),
        ((0x84be41dei64) as libc::c_uint),
        ((0x1adad47di64) as libc::c_uint),
        ((0x6ddde4ebi64) as libc::c_uint),
        ((0xf4d4b551i64) as libc::c_uint),
        ((0x83d385c7i64) as libc::c_uint),
        ((0x136c9856i64) as libc::c_uint),
        ((0x646ba8c0i64) as libc::c_uint),
        ((0xfd62f97ai64) as libc::c_uint),
        ((0x8a65c9eci64) as libc::c_uint),
        ((0x14015c4fi64) as libc::c_uint),
        ((0x63066cd9i64) as libc::c_uint),
        ((0xfa0f3d63i64) as libc::c_uint),
        ((0x8d080df5i64) as libc::c_uint),
        ((0x3b6e20c8i64) as libc::c_uint),
        ((0x4c69105ei64) as libc::c_uint),
        ((0xd56041e4i64) as libc::c_uint),
        ((0xa2677172i64) as libc::c_uint),
        ((0x3c03e4d1i64) as libc::c_uint),
        ((0x4b04d447i64) as libc::c_uint),
        ((0xd20d85fdi64) as libc::c_uint),
        ((0xa50ab56bi64) as libc::c_uint),
        ((0x35b5a8fai64) as libc::c_uint),
        ((0x42b2986ci64) as libc::c_uint),
        ((0xdbbbc9d6i64) as libc::c_uint),
        ((0xacbcf940i64) as libc::c_uint),
        ((0x32d86ce3i64) as libc::c_uint),
        ((0x45df5c75i64) as libc::c_uint),
        ((0xdcd60dcfi64) as libc::c_uint),
        ((0xabd13d59i64) as libc::c_uint),
        ((0x26d930aci64) as libc::c_uint),
        ((0x51de003ai64) as libc::c_uint),
        ((0xc8d75180i64) as libc::c_uint),
        ((0xbfd06116i64) as libc::c_uint),
        ((0x21b4f4b5i64) as libc::c_uint),
        ((0x56b3c423i64) as libc::c_uint),
        ((0xcfba9599i64) as libc::c_uint),
        ((0xb8bda50fi64) as libc::c_uint),
        ((0x2802b89ei64) as libc::c_uint),
        ((0x5f058808i64) as libc::c_uint),
        ((0xc60cd9b2i64) as libc::c_uint),
        ((0xb10be924i64) as libc::c_uint),
        ((0x2f6f7c87i64) as libc::c_uint),
        ((0x58684c11i64) as libc::c_uint),
        ((0xc1611dabi64) as libc::c_uint),
        ((0xb6662d3di64) as libc::c_uint),
        ((0x76dc4190i64) as libc::c_uint),
        ((0x01db7106i64) as libc::c_uint),
        ((0x98d220bci64) as libc::c_uint),
        ((0xefd5102ai64) as libc::c_uint),
        ((0x71b18589i64) as libc::c_uint),
        ((0x06b6b51fi64) as libc::c_uint),
        ((0x9fbfe4a5i64) as libc::c_uint),
        ((0xe8b8d433i64) as libc::c_uint),
        ((0x7807c9a2i64) as libc::c_uint),
        ((0x0f00f934i64) as libc::c_uint),
        ((0x9609a88ei64) as libc::c_uint),
        ((0xe10e9818i64) as libc::c_uint),
        ((0x7f6a0dbbi64) as libc::c_uint),
        ((0x086d3d2di64) as libc::c_uint),
        ((0x91646c97i64) as libc::c_uint),
        ((0xe6635c01i64) as libc::c_uint),
        ((0x6b6b51f4i64) as libc::c_uint),
        ((0x1c6c6162i64) as libc::c_uint),
        ((0x856530d8i64) as libc::c_uint),
        ((0xf262004ei64) as libc::c_uint),
        ((0x6c0695edi64) as libc::c_uint),
        ((0x1b01a57bi64) as libc::c_uint),
        ((0x8208f4c1i64) as libc::c_uint),
        ((0xf50fc457i64) as libc::c_uint),
        ((0x65b0d9c6i64) as libc::c_uint),
        ((0x12b7e950i64) as libc::c_uint),
        ((0x8bbeb8eai64) as libc::c_uint),
        ((0xfcb9887ci64) as libc::c_uint),
        ((0x62dd1ddfi64) as libc::c_uint),
        ((0x15da2d49i64) as libc::c_uint),
        ((0x8cd37cf3i64) as libc::c_uint),
        ((0xfbd44c65i64) as libc::c_uint),
        ((0x4db26158i64) as libc::c_uint),
        ((0x3ab551cei64) as libc::c_uint),
        ((0xa3bc0074i64) as libc::c_uint),
        ((0xd4bb30e2i64) as libc::c_uint),
        ((0x4adfa541i64) as libc::c_uint),
        ((0x3dd895d7i64) as libc::c_uint),
        ((0xa4d1c46di64) as libc::c_uint),
        ((0xd3d6f4fbi64) as libc::c_uint),
        ((0x4369e96ai64) as libc::c_uint),
        ((0x346ed9fci64) as libc::c_uint),
        ((0xad678846i64) as libc::c_uint),
        ((0xda60b8d0i64) as libc::c_uint),
        ((0x44042d73i64) as libc::c_uint),
        ((0x33031de5i64) as libc::c_uint),
        ((0xaa0a4c5fi64) as libc::c_uint),
        ((0xdd0d7cc9i64) as libc::c_uint),
        ((0x5005713ci64) as libc::c_uint),
        ((0x270241aai64) as libc::c_uint),
        ((0xbe0b1010i64) as libc::c_uint),
        ((0xc90c2086i64) as libc::c_uint),
        ((0x5768b525i64) as libc::c_uint),
        ((0x206f85b3i64) as libc::c_uint),
        ((0xb966d409i64) as libc::c_uint),
        ((0xce61e49fi64) as libc::c_uint),
        ((0x5edef90ei64) as libc::c_uint),
        ((0x29d9c998i64) as libc::c_uint),
        ((0xb0d09822i64) as libc::c_uint),
        ((0xc7d7a8b4i64) as libc::c_uint),
        ((0x59b33d17i64) as libc::c_uint),
        ((0x2eb40d81i64) as libc::c_uint),
        ((0xb7bd5c3bi64) as libc::c_uint),
        ((0xc0ba6cadi64) as libc::c_uint),
        ((0xedb88320i64) as libc::c_uint),
        ((0x9abfb3b6i64) as libc::c_uint),
        ((0x03b6e20ci64) as libc::c_uint),
        ((0x74b1d29ai64) as libc::c_uint),
        ((0xead54739i64) as libc::c_uint),
        ((0x9dd277afi64) as libc::c_uint),
        ((0x04db2615i64) as libc::c_uint),
        ((0x73dc1683i64) as libc::c_uint),
        ((0xe3630b12i64) as libc::c_uint),
        ((0x94643b84i64) as libc::c_uint),
        ((0x0d6d6a3ei64) as libc::c_uint),
        ((0x7a6a5aa8i64) as libc::c_uint),
        ((0xe40ecf0bi64) as libc::c_uint),
        ((0x9309ff9di64) as libc::c_uint),
        ((0x0a00ae27i64) as libc::c_uint),
        ((0x7d079eb1i64) as libc::c_uint),
        ((0xf00f9344i64) as libc::c_uint),
        ((0x8708a3d2i64) as libc::c_uint),
        ((0x1e01f268i64) as libc::c_uint),
        ((0x6906c2fei64) as libc::c_uint),
        ((0xf762575di64) as libc::c_uint),
        ((0x806567cbi64) as libc::c_uint),
        ((0x196c3671i64) as libc::c_uint),
        ((0x6e6b06e7i64) as libc::c_uint),
        ((0xfed41b76i64) as libc::c_uint),
        ((0x89d32be0i64) as libc::c_uint),
        ((0x10da7a5ai64) as libc::c_uint),
        ((0x67dd4acci64) as libc::c_uint),
        ((0xf9b9df6fi64) as libc::c_uint),
        ((0x8ebeeff9i64) as libc::c_uint),
        ((0x17b7be43i64) as libc::c_uint),
        ((0x60b08ed5i64) as libc::c_uint),
        ((0xd6d6a3e8i64) as libc::c_uint),
        ((0xa1d1937ei64) as libc::c_uint),
        ((0x38d8c2c4i64) as libc::c_uint),
        ((0x4fdff252i64) as libc::c_uint),
        ((0xd1bb67f1i64) as libc::c_uint),
        ((0xa6bc5767i64) as libc::c_uint),
        ((0x3fb506ddi64) as libc::c_uint),
        ((0x48b2364bi64) as libc::c_uint),
        ((0xd80d2bdai64) as libc::c_uint),
        ((0xaf0a1b4ci64) as libc::c_uint),
        ((0x36034af6i64) as libc::c_uint),
        ((0x41047a60i64) as libc::c_uint),
        ((0xdf60efc3i64) as libc::c_uint),
        ((0xa867df55i64) as libc::c_uint),
        ((0x316e8eefi64) as libc::c_uint),
        ((0x4669be79i64) as libc::c_uint),
        ((0xcb61b38ci64) as libc::c_uint),
        ((0xbc66831ai64) as libc::c_uint),
        ((0x256fd2a0i64) as libc::c_uint),
        ((0x5268e236i64) as libc::c_uint),
        ((0xcc0c7795i64) as libc::c_uint),
        ((0xbb0b4703i64) as libc::c_uint),
        ((0x220216b9i64) as libc::c_uint),
        ((0x5505262fi64) as libc::c_uint),
        ((0xc5ba3bbei64) as libc::c_uint),
        ((0xb2bd0b28i64) as libc::c_uint),
        ((0x2bb45a92i64) as libc::c_uint),
        ((0x5cb36a04i64) as libc::c_uint),
        ((0xc2d7ffa7i64) as libc::c_uint),
        ((0xb5d0cf31i64) as libc::c_uint),
        ((0x2cd99e8bi64) as libc::c_uint),
        ((0x5bdeae1di64) as libc::c_uint),
        ((0x9b64c2b0i64) as libc::c_uint),
        ((0xec63f226i64) as libc::c_uint),
        ((0x756aa39ci64) as libc::c_uint),
        ((0x026d930ai64) as libc::c_uint),
        ((0x9c0906a9i64) as libc::c_uint),
        ((0xeb0e363fi64) as libc::c_uint),
        ((0x72076785i64) as libc::c_uint),
        ((0x05005713i64) as libc::c_uint),
        ((0x95bf4a82i64) as libc::c_uint),
        ((0xe2b87a14i64) as libc::c_uint),
        ((0x7bb12baei64) as libc::c_uint),
        ((0x0cb61b38i64) as libc::c_uint),
        ((0x92d28e9bi64) as libc::c_uint),
        ((0xe5d5be0di64) as libc::c_uint),
        ((0x7cdcefb7i64) as libc::c_uint),
        ((0x0bdbdf21i64) as libc::c_uint),
        ((0x86d3d2d4i64) as libc::c_uint),
        ((0xf1d4e242i64) as libc::c_uint),
        ((0x68ddb3f8i64) as libc::c_uint),
        ((0x1fda836ei64) as libc::c_uint),
        ((0x81be16cdi64) as libc::c_uint),
        ((0xf6b9265bi64) as libc::c_uint),
        ((0x6fb077e1i64) as libc::c_uint),
        ((0x18b74777i64) as libc::c_uint),
        ((0x88085ae6i64) as libc::c_uint),
        ((0xff0f6a70i64) as libc::c_uint),
        ((0x66063bcai64) as libc::c_uint),
        ((0x11010b5ci64) as libc::c_uint),
        ((0x8f659effi64) as libc::c_uint),
        ((0xf862ae69i64) as libc::c_uint),
        ((0x616bffd3i64) as libc::c_uint),
        ((0x166ccf45i64) as libc::c_uint),
        ((0xa00ae278i64) as libc::c_uint),
        ((0xd70dd2eei64) as libc::c_uint),
        ((0x4e048354i64) as libc::c_uint),
        ((0x3903b3c2i64) as libc::c_uint),
        ((0xa7672661i64) as libc::c_uint),
        ((0xd06016f7i64) as libc::c_uint),
        ((0x4969474di64) as libc::c_uint),
        ((0x3e6e77dbi64) as libc::c_uint),
        ((0xaed16a4ai64) as libc::c_uint),
        ((0xd9d65adci64) as libc::c_uint),
        ((0x40df0b66i64) as libc::c_uint),
        ((0x37d83bf0i64) as libc::c_uint),
        ((0xa9bcae53i64) as libc::c_uint),
        ((0xdebb9ec5i64) as libc::c_uint),
        ((0x47b2cf7fi64) as libc::c_uint),
        ((0x30b5ffe9i64) as libc::c_uint),
        ((0xbdbdf21ci64) as libc::c_uint),
        ((0xcabac28ai64) as libc::c_uint),
        ((0x53b39330i64) as libc::c_uint),
        ((0x24b4a3a6i64) as libc::c_uint),
        ((0xbad03605i64) as libc::c_uint),
        ((0xcdd70693i64) as libc::c_uint),
        ((0x54de5729i64) as libc::c_uint),
        ((0x23d967bfi64) as libc::c_uint),
        ((0xb3667a2ei64) as libc::c_uint),
        ((0xc4614ab8i64) as libc::c_uint),
        ((0x5d681b02i64) as libc::c_uint),
        ((0x2a6f2b94i64) as libc::c_uint),
        ((0xb40bbe37i64) as libc::c_uint),
        ((0xc30c8ea1i64) as libc::c_uint),
        ((0x5a05df1bi64) as libc::c_uint),
        ((0x2d02ef8di64) as libc::c_uint),
    ];
}
extern "C-unwind" {
