...
#[export_name = "_ZN13ACE_FIFO_RecvC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_FIFO_RecvC1Ev(
    __this: *mut ACE_FIFO_Recv,
) {
    ACE_FIFO_Recv::new_at(__this)
}
#[export_name = "_ZN13ACE_FIFO_RecvC1EPKcijii"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_FIFO_RecvC1EPKcijii(
    __this: *mut ACE_FIFO_Recv,
    ...
    ACE_FIFO_Recv::new_at_ud0a469d0ac6af71d(__this, __a0, __a1, __a2, __a3, __a4)
}
#[export_name = "_ZN13ACE_FIFO_Recv4openEPKcijii"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_FIFO_Recv4openEPKcijii(
    __this: *mut ACE_FIFO_Recv,
    ...
    unsafe { ACE_FIFO_Recv::open(__this, fifo_name, flags, perms, persistent, sa) }
}
#[export_name = "_ZN13ACE_FIFO_Recv5closeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_FIFO_Recv5closeEv(
    __this: *mut ACE_FIFO_Recv,
) -> libc::c_int {
    unsafe { ACE_FIFO_Recv::close(__this) }
}
#[export_name = "_ZNK13ACE_FIFO_Recv4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_FIFO_Recv4dumpEv(
    __this: *const ACE_FIFO_Recv,
) {
    unsafe { ACE_FIFO_Recv::dump(__this) }
}
#[repr(C)]
...
impl ACE_FIFO_Recv {
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ...
            <ACE_FIFO>::new_at(
                ::core::ptr::addr_of_mut!((* __this).__base_0).cast::<ACE_FIFO>(),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).aux_handle_),
    ...
    pub unsafe fn new_at_ud0a469d0ac6af71d(
        ...
        unsafe {
            ...
            {
                if (((((<ACE_FIFO_Recv>::open(
                    (__this) as *mut ACE_FIFO_Recv,
                    fifo_name,
                    flags,
                    perms,
                    persistent,
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/FIFO_Recv.cpp\0".as_ptr()
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        b"ACE_FIFO_Recv\0".as_ptr() as *const libc::c_char,
                                    );
                                }
                            }
    ...
    pub unsafe fn open(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((((<ACE_FIFO>::open(
                    (::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).__base_0) .cast:: < ACE_FIFO
                        > ().cast_mut())
                    )) as *mut ACE_FIFO,
                    fifo_name,
                    (((2048) as libc::c_int)) | ((flags) as libc::c_int),
                    perms,
                    sa,
                ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                        ...
                        as libc::c_int as libc::c_int) != 0)
                    {
                        ...
                        if ((((((persistent) != 0)
                            && (((((({
                                let __v = ACE_OS::open_u20e73ad42bc94ee0(
                                    ((fifo_name) as *const libc::c_char),
                                    1,
                                    ((0) as libc::c_uint),
                                    sa,
                                );
                                (*__this).aux_handle_ = __v;
                                __v
                            }) as libc::c_int))
                                == ((((-((1) as libc::c_int))) as libc::c_int)))
                            ...
                            as libc::c_int) != 0)
                        {
                            ...
                            return if (((((<ACE_IPC_SAP>::get_handle(
                                (::core::ptr::addr_of!(
                                    (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((* __this)
                                    .__base_0) .cast:: < ACE_FIFO > ().cast_mut()).__base_0)
                                    .cast:: < ACE_IPC_SAP > ().cast_mut())
    ...
    pub unsafe fn close(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                if ((((((*__this).aux_handle_ as libc::c_int))
                    != ((((-((1) as libc::c_int))) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    return ACE_OS::close_u07c1eb6343f8c667((*__this).aux_handle_);
                } else {
                    return result;
                }
            }
