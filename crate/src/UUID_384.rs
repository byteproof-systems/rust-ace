...
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Auto_Basic_Ptr_ACE_String_Base_char__ {
    pub p_: *mut ACE_String_Base_char_,
}
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_Auto_Basic_PtrI15ACE_String_BaseIcEEC1EPS1_(
    __this: *mut ACE_Auto_Basic_Ptr_ACE_String_Base_char__,
    __a0: *mut ACE_String_Base_char_,
) {
    ACE_Auto_Basic_Ptr_ACE_String_Base_char__::new_at_s6410a1362e87c9e5(__this, __a0)
}
impl Drop for ACE_Auto_Basic_Ptr_ACE_String_Base_char__ {
    fn drop(&mut self) {
        unsafe {
            let __this: *mut Self = self as *mut Self;
            {
                {
                    let __d = <ACE_Auto_Basic_Ptr_ACE_String_Base_char__>::get(
                        (__this) as *const ACE_Auto_Basic_Ptr_ACE_String_Base_char__,
                    );
                    if !__d.is_null() {
                        let _ = Box::from_raw(__d as *mut ACE_String_Base_char_);
                    }
                };
            }
            ()
...
pub unsafe extern "C-unwind" fn __acedtor_u2cb8bfaa3e3421dd(
    __this: *mut ACE_Auto_Basic_Ptr_ACE_String_Base_char__,
) {
    unsafe {
...
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Auto_Ptr_ACE_String_Base_char__ {
    pub __base_0: ::core::mem::ManuallyDrop<ACE_Auto_Basic_Ptr_ACE_String_Base_char__>,
}
impl Drop for ACE_Auto_Ptr_ACE_String_Base_char__ {
    fn drop(&mut self) {
        unsafe {
...
pub unsafe extern "C-unwind" fn __xtu__ZN12ACE_Auto_PtrI15ACE_String_BaseIcEEC1EPS1_(
    __this: *mut ACE_Auto_Ptr_ACE_String_Base_char__,
    __a0: *mut ACE_String_Base_char_,
) {
    ACE_Auto_Ptr_ACE_String_Base_char__::new_at_s90ea86af6ba2ad18(__this, __a0)
}
extern "C-unwind" {
...
pub mod ACE_OS {
    ...
    pub use crate::full_ops_0::ACE_OS::gethostbyaddr_u4b05aea586a05c98;
    pub use crate::full_ops_0::ACE_OS::gethostbyaddr_r_ua3b27f2af8867e4e;
    pub use crate::full_ops_0::ACE_OS::gethostbyname_ubf26fe0a4f84901c;
    pub use crate::full_ops_0::ACE_OS::gethostbyname_r_ua6fe6c2e547821aa;
    pub use crate::full_ops_0::ACE_OS::getipnodebyaddr;
    pub use crate::full_ops_0::ACE_OS::getipnodebyname;
    pub use crate::full_ops_0::ACE_OS::macaddr_node_t;
    extern "C-unwind" {
        #[link_name = "_ZN6ACE_OS13getmacaddressEPNS_14macaddr_node_tE"]
        pub fn getmacaddress(node: *mut macaddr_node_t) -> libc::c_int;
    }
    pub use crate::full_ops_0::ACE_OS::getprotobyname_u839dfc24d41334f8;
    pub use crate::full_ops_0::ACE_OS::getprotobyname_r_ue0512e582cc6e2b0;
    pub use crate::full_ops_0::ACE_OS::getprotobynumber_u6b7b2275b04178d9;
    pub use crate::full_ops_0::ACE_OS::getprotobynumber_r_ueb06517d3f729a73;
    pub use crate::full_ops_0::ACE_OS::getservbyname_u43e8e765506ffe2f;
    pub use crate::full_ops_0::ACE_OS::getservbyname_r_u7054edf2cbe5b4bd;
    pub use crate::full_ops_0::ACE_OS::getaddrinfo_u337ffbb26d9a3335;
    pub use crate::full_ops_0::ACE_OS::freeaddrinfo_u6f46ec03d1f136e7;
    pub use crate::full_ops_0::ACE_OS::gai_strerror_u12d9db9043b4382e;
    pub use crate::full_ops_0::ACE_OS::getnameinfo_uba86e201ee9aef5f;
}
...
pub unsafe extern "C-unwind" fn __xtu__ZNK15ACE_String_BaseIcE4findEcm(
    __this: *const ACE_String_Base_char_,
    c: libc::c_char,
    pos: libc::c_ulong,
) -> libc::c_ulong {
    unsafe { ACE_String_Base_char_::find_s9bd4e6ac12180766(__this, c, pos) }
}
...
pub mod ACE_Utils {
    ...
    pub use crate::full_ops_0::ACE_Utils::_unnamed_enum_at__build_ace_full_src_ACE_ace_UUID_h_40_5_;
    pub use crate::full_ops_0::ACE_Utils::UUID_Node_Node_ID;
    pub use crate::full_ops_0::ACE_Utils::UUID_Node;
    pub use crate::full_ops_0::ACE_Utils::_unnamed_enum_at__build_ace_full_src_ACE_ace_UUID_h_86_5_;
    pub use crate::full_ops_0::ACE_Utils::UUID_Ace_;
    pub use crate::full_ops_0::ACE_Utils::data;
    #[allow(non_upper_case_globals)]
    #[no_mangle]
    pub static mut UUID_NIL_UUID: UUID = unsafe {
        ::core::mem::MaybeUninit::<UUID>::zeroed().assume_init()
    };
    ...
    pub struct UUID {
        pub uuid_: data,
        pub thr_id_: ::core::mem::ManuallyDrop<super::ACE_String_Base_char_>,
        pub pid_: ::core::mem::ManuallyDrop<super::ACE_String_Base_char_>,
        pub as_string_: ::core::mem::ManuallyDrop<
            super::ACE_Auto_Ptr_ACE_String_Base_char__,
        >,
    }
    impl Clone for UUID {
        #[inline]
        fn clone(&self) -> Self {
            unsafe { Self::new_u94be0531d46f551f(self as *const Self) }
        }
    }
    pub use crate::full_ops_0::ACE_Utils::__xtu__ZN9ACE_Utils4UUIDC1Ev;
    #[export_name = "_ZN9ACE_Utils4UUIDC1ERK15ACE_String_BaseIcE"]
    pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Utils4UUIDC1ERK15ACE_String_BaseIcE(
        __this: *mut UUID,
        __a0: *const super::ACE_String_Base_char_,
    ) {
        UUID::new_at_ubebbc86aefd0a6de(__this, __a0)
    }
    pub use crate::full_ops_0::ACE_Utils::__xtu__ZN9ACE_Utils4UUIDC1ERKS0_;
    impl Drop for UUID {
        fn drop(&mut self) {
            {
                unsafe {
            ...
            unsafe {
                ::core::mem::ManuallyDrop::drop(&mut self.as_string_);
                ::core::mem::ManuallyDrop::drop(&mut self.pid_);
                ::core::mem::ManuallyDrop::drop(&mut self.thr_id_);
            }
        }
    }
    pub use crate::full_ops_0::ACE_Utils::__acedtor_ub5457934bda3feed;
    #[export_name = "_ZNK9ACE_Utils4UUID9to_stringEv"]
    pub unsafe extern "C-unwind" fn __xtu__ZNK9ACE_Utils4UUID9to_stringEv(
        __this: *const UUID,
    ) -> *const super::ACE_String_Base_char_ {
        unsafe { UUID::to_string(__this) }
    }
    #[export_name = "_ZN9ACE_Utils4UUIDaSERKS0_"]
    pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Utils4UUIDaSERKS0_(
        __this: *mut UUID,
        rhs: *const UUID,
    ) -> *const UUID {
        unsafe { UUID::operator_assign(__this, rhs) }
    }
    #[export_name = "_ZN9ACE_Utils4UUID13from_string_iERK15ACE_String_BaseIcE"]
    pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Utils4UUID13from_string_iERK15ACE_String_BaseIcE(
        __this: *mut UUID,
        uuid_string: *const super::ACE_String_Base_char_,
    ) {
        unsafe { UUID::from_string_i(__this, uuid_string) }
    }
    pub use crate::full_ops_0::ACE_Utils::_unnamed_enum_at__build_ace_full_src_ACE_ace_UUID_h_203_5_;
    pub use crate::full_ops_0::ACE_Utils::UUID_Generator_UUID_Time;
    pub use crate::full_ops_0::ACE_Utils::UUID_State;
    #[doc = "* @class ACE_UUID_Generator\n   *\n   * Singleton class that generates UUIDs.\n   *"]
    #[repr(C)]
    #[derive(Clone)]
    pub struct UUID_Generator {
        pub time_last_: libc::c_ulong,
        pub uuid_state_: UUID_State,
        pub lock_: *mut super::ACE_Thread_Mutex,
        pub destroy_lock_: bool,
        pub is_init_: bool,
    }
    #[export_name = "_ZN9ACE_Utils14UUID_GeneratorC1Ev"]
    pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Utils14UUID_GeneratorC1Ev(
        __this: *mut UUID_Generator,
    ) {
        UUID_Generator::new_at(__this)
    }
    impl Drop for UUID_Generator {
        fn drop(&mut self) {
            unsafe {
                let __this: *mut Self = self as *mut Self;
                {
                    if (((*__this).destroy_lock_ as libc::c_int) != 0) {
                        {
                            let __d = (*__this).lock_;
                            if !__d.is_null() {
                                let _ = Box::from_raw(__d as *mut super::ACE_Thread_Mutex);
                            }
                        };
                    }
                }
    ...
    #[export_name = "__acedtor_u948eab55e0c2f72b"]
    pub unsafe extern "C-unwind" fn __acedtor_u948eab55e0c2f72b(
        __this: *mut UUID_Generator,
    ) {
        unsafe {
            ::core::ptr::drop_in_place(__this);
    ...
    #[export_name = "_ZN9ACE_Utils14UUID_Generator4initEv"]
    pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Utils14UUID_Generator4initEv(
        __this: *mut UUID_Generator,
    ) {
        unsafe { UUID_Generator::init(__this) }
    }
    #[export_name = "_ZN9ACE_Utils14UUID_Generator13generate_UUIDERNS_4UUIDEth"]
    pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Utils14UUID_Generator13generate_UUIDERNS_4UUIDEth(
        __this: *mut UUID_Generator,
        uuid: *mut UUID,
        version: libc::c_ushort,
        variant: libc::c_uchar,
    ) {
        unsafe { UUID_Generator::generate_UUID(__this, uuid, version, variant) }
    }
    #[export_name = "_ZN9ACE_Utils14UUID_Generator13generate_UUIDEth"]
    pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Utils14UUID_Generator13generate_UUIDEth(
        __this: *mut UUID_Generator,
        version: libc::c_ushort,
        variant: libc::c_uchar,
    ) -> *mut UUID {
        unsafe {
            UUID_Generator::generate_UUID_u191e86a9bd9955b2(__this, version, variant)
        }
    }
    #[export_name = "_ZN9ACE_Utils14UUID_Generator4lockEv"]
    pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Utils14UUID_Generator4lockEv(
        __this: *mut UUID_Generator,
    ) -> *mut super::ACE_Thread_Mutex {
        unsafe { UUID_Generator::lock(__this) }
    }
    #[export_name = "_ZN9ACE_Utils14UUID_Generator4lockEP16ACE_Thread_Mutexb"]
    pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Utils14UUID_Generator4lockEP16ACE_Thread_Mutexb(
        __this: *mut UUID_Generator,
        lock: *mut super::ACE_Thread_Mutex,
        release_lock: bool,
    ) {
        unsafe { UUID_Generator::lock_u6f96543e05a3708f(__this, lock, release_lock) }
    }
    #[export_name = "_ZN9ACE_Utils14UUID_Generator13get_timestampERm"]
    pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Utils14UUID_Generator13get_timestampERm(
        __this: *mut UUID_Generator,
        timestamp: *mut libc::c_ulong,
    ) {
        unsafe { UUID_Generator::get_timestamp(__this, timestamp) }
    }
    #[export_name = "_ZN9ACE_Utils14UUID_Generator31get_timestamp_and_clocksequenceERmRt"]
    pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Utils14UUID_Generator31get_timestamp_and_clocksequenceERmRt(
        __this: *mut UUID_Generator,
        timestamp: *mut libc::c_ulong,
        clock_sequence: *mut libc::c_ushort,
    ) {
        unsafe {
            UUID_Generator::get_timestamp_and_clocksequence(
                __this,
                timestamp,
                clock_sequence,
            )
    ...
    #[export_name = "_ZN9ACE_Utils14UUID_Generator14get_systemtimeERm"]
    pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Utils14UUID_Generator14get_systemtimeERm(
        __this: *mut UUID_Generator,
        timestamp: *mut libc::c_ulong,
    ) {
        unsafe { UUID_Generator::get_systemtime(__this, timestamp) }
    }
    pub type UUID_GENERATOR = super::ACE_Singleton_ACE_Utils__UUID_Generator__ACE_MT_SYNCH__MUTEX_;
    impl UUID {
        ///Constructor
        pub unsafe fn new_at(__this: *mut Self) {
            unsafe {
                ...
                <super::ACE_String_Base_char_>::new_at_s89536104322d6768(
                    ::core::ptr::addr_of_mut!((* __this).thr_id_)
                        .cast::<super::ACE_String_Base_char_>(),
                    ((0) as *mut super::ACE_Allocator),
                );
                <super::ACE_String_Base_char_>::new_at_s89536104322d6768(
                    ::core::ptr::addr_of_mut!((* __this).pid_)
                        .cast::<super::ACE_String_Base_char_>(),
                    ((0) as *mut super::ACE_Allocator),
                );
                <super::ACE_Auto_Ptr_ACE_String_Base_char__>::new_at_s90ea86af6ba2ad18(
                    ::core::ptr::addr_of_mut!((* __this).as_string_)
                        .cast::<super::ACE_Auto_Ptr_ACE_String_Base_char__>(),
                    ((0) as *mut super::ACE_String_Base_char_),
                );
                {
                    <UUID>::init((__this) as *mut UUID);
                }
                ()
            }
        }
        ...
        pub unsafe fn new_at_ubebbc86aefd0a6de(
            __this: *mut Self,
            mut uuid_string: *const super::ACE_String_Base_char_,
        ) {
            unsafe {
                ::core::ptr::write(
                    __this,
                ...
                );
                {
                    ...
                    <UUID>::from_string_i(
                        (__this) as *mut UUID,
                        ::core::ptr::addr_of!((* uuid_string)),
                    );
                }
                ()
            }
        }
        pub unsafe fn new_ubebbc86aefd0a6de(
            mut __a0: *const super::ACE_String_Base_char_,
        ) -> Self {
            let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed()
                .assume_init();
            Self::new_at_ubebbc86aefd0a6de(::core::ptr::addr_of_mut!(__obj), __a0);
            __obj
        }
        pub unsafe fn new_at_u94be0531d46f551f(
            __this: *mut Self,
            mut right: *const UUID,
        ) {
            unsafe {
                ::core::ptr::write(
                    __this,
                ...
                <super::ACE_String_Base_char_>::new_at_sabcff583f5288c57(
                    (::core::ptr::addr_of_mut!((* __this).thr_id_)
                        .cast::<super::ACE_String_Base_char_>())
                        as *mut super::ACE_String_Base_char_,
                    ::core::ptr::addr_of!(
                        (* ::core::ptr::addr_of!((* right).thr_id_) .cast:: <
                        super::ACE_String_Base_char_ > ().cast_mut())
                    ),
                );
                <super::ACE_String_Base_char_>::new_at_sabcff583f5288c57(
                    (::core::ptr::addr_of_mut!((* __this).pid_)
                        ...
                        as *mut super::ACE_String_Base_char_,
                    ::core::ptr::addr_of!(
                        (* ::core::ptr::addr_of!((* right).pid_) .cast:: <
                        super::ACE_String_Base_char_ > ().cast_mut())
                    ),
                );
                <super::ACE_Auto_Ptr_ACE_String_Base_char__>::new_at_s90ea86af6ba2ad18(
                ...
                {
                    super::ACE_OS::memcpy_u6033eb81edaf9212(
                        ((::core::ptr::addr_of_mut!((* __this).uuid_) as *mut data)
                            as *mut libc::c_void),
                        ((::core::ptr::addr_of!((* right).uuid_) as *const data)
        ...
        pub unsafe fn new_u94be0531d46f551f(mut __a0: *const UUID) -> Self {
            let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed()
                .assume_init();
            Self::new_at_u94be0531d46f551f(::core::ptr::addr_of_mut!(__obj), __a0);
            __obj
        }
        pub unsafe fn time_low(__this: *const Self) -> libc::c_uint {
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    return (((*__this).uuid_.time_low_) as libc::c_uint);
                }
                #[allow(unreachable_code)] { ::core::unreachable!() }
            }
        }
        pub unsafe fn time_low_u91d0b6c37e681b93(
            __this: *mut Self,
            mut timelow: libc::c_uint,
        ) {
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    (*__this).uuid_.time_low_ = timelow;
                }
                ()
            }
        }
        pub unsafe fn time_mid(__this: *const Self) -> libc::c_ushort {
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    return (((*__this).uuid_.time_mid_) as libc::c_ushort);
                }
                #[allow(unreachable_code)] { ::core::unreachable!() }
            }
        }
        pub unsafe fn time_mid_ue72906ca1f0a8ae5(
            __this: *mut Self,
            mut time_mid: libc::c_ushort,
        ) {
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    (*__this).uuid_.time_mid_ = time_mid;
                }
                ()
            }
        }
        pub unsafe fn time_hi_and_version(__this: *const Self) -> libc::c_ushort {
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    return (((*__this).uuid_.time_hi_and_version_) as libc::c_ushort);
                }
                #[allow(unreachable_code)] { ::core::unreachable!() }
            }
        }
        pub unsafe fn time_hi_and_version_u074dcc3bc96f7075(
            __this: *mut Self,
            mut time_hi_and_version: libc::c_ushort,
        ) {
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    (*__this).uuid_.time_hi_and_version_ = time_hi_and_version;
                }
                ()
            }
        }
        pub unsafe fn clock_seq_hi_and_reserved(__this: *const Self) -> libc::c_uchar {
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    return (((*__this).uuid_.clock_seq_hi_and_reserved_)
                        as libc::c_uchar);
                }
                #[allow(unreachable_code)] { ::core::unreachable!() }
            }
        }
        pub unsafe fn clock_seq_hi_and_reserved_uc95f6bff4ae469d0(
            __this: *mut Self,
            mut clock_seq_hi_and_reserved: libc::c_uchar,
        ) {
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    (*__this).uuid_.clock_seq_hi_and_reserved_ = clock_seq_hi_and_reserved;
                }
                ()
            }
        }
        pub unsafe fn clock_seq_low(__this: *const Self) -> libc::c_uchar {
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    return (((*__this).uuid_.clock_seq_low_) as libc::c_uchar);
                }
                #[allow(unreachable_code)] { ::core::unreachable!() }
            }
        }
        pub unsafe fn clock_seq_low_uefb323910e3bea9c(
            __this: *mut Self,
            mut clock_seq_low: libc::c_uchar,
        ) {
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    (*__this).uuid_.clock_seq_low_ = clock_seq_low;
                }
                ()
            }
        }
        pub unsafe fn node(__this: *mut Self) -> *mut UUID_Node {
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    return ::core::ptr::addr_of_mut!((* __this).uuid_.node_);
                }
                #[allow(unreachable_code)] { ::core::unreachable!() }
            }
        }
        pub unsafe fn node_ufa3fbd13aed38ef2(__this: *const Self) -> *const UUID_Node {
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    return ::core::ptr::addr_of!((* __this).uuid_.node_);
                }
                #[allow(unreachable_code)] { ::core::unreachable!() }
            }
        }
        pub unsafe fn node_u08cd53404ba9c5e1(
            __this: *mut Self,
            mut node: *const UUID_Node,
        ) {
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    super::ACE_OS::memcpy_u6033eb81edaf9212(
                        ((::core::ptr::addr_of_mut!((* __this).uuid_.node_)
                            as *mut UUID_Node) as *mut libc::c_void),
                        (((*<UUID_Node>::node_ID_u0145985074a8cb4a(
                            (::core::ptr::addr_of!((* node))) as *const UUID_Node,
                        )))
        ...
        pub unsafe fn thr_id(__this: *mut Self) -> *mut super::ACE_String_Base_char_ {
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    return ::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).thr_id_) .cast:: <
                        super::ACE_String_Base_char_ > ().cast_mut())
                    ) as *mut super::ACE_String_Base_char_;
                }
                #[allow(unreachable_code)] { ::core::unreachable!() }
        ...
        pub unsafe fn thr_id_u31b402370a2f177b(
            __this: *mut Self,
            mut thr_id: *mut libc::c_char,
        ) {
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    <super::ACE_String_Base_char_>::operator_assign_s55feb9c94acd63a8(
                        (::core::ptr::addr_of_mut!(
                            (* ::core::ptr::addr_of!((* __this).thr_id_) .cast:: <
                            super::ACE_String_Base_char_ > ().cast_mut())
                        )) as *mut super::ACE_String_Base_char_,
                        ((thr_id) as *const libc::c_char),
                    );
                }
                ()
            }
        }
        pub unsafe fn pid(__this: *mut Self) -> *mut super::ACE_String_Base_char_ {
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    return ::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).pid_) .cast:: <
                        super::ACE_String_Base_char_ > ().cast_mut())
                    ) as *mut super::ACE_String_Base_char_;
                }
                #[allow(unreachable_code)] { ::core::unreachable!() }
        ...
        pub unsafe fn pid_ubea6a2e318d38194(
            __this: *mut Self,
            mut pid: *mut libc::c_char,
        ) {
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
        ...
        pub unsafe fn to_string(
            ...
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    if ((((!(<super::ACE_Auto_Basic_Ptr_ACE_String_Base_char__>::get(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* (::core::ptr::addr_of!((*
                            ::core::ptr::addr_of!((* __this).as_string_) .cast:: <
                            super::ACE_Auto_Ptr_ACE_String_Base_char__ > ()
                            .cast_mut())))).__base_0) .cast:: <
                            super::ACE_Auto_Basic_Ptr_ACE_String_Base_char__ > ()
                            .cast_mut())
                        )) as *const super::ACE_Auto_Basic_Ptr_ACE_String_Base_char__,
                    ))
                        .is_null()) as libc::c_int) as libc::c_int) != 0)
                    {
                        return (<super::ACE_Auto_Basic_Ptr_ACE_String_Base_char__>::get(
                            (::core::ptr::addr_of!(
                                (* ::core::ptr::addr_of!((* (::core::ptr::addr_of!((*
                                ::core::ptr::addr_of!((* __this).as_string_) .cast:: <
                                super::ACE_Auto_Ptr_ACE_String_Base_char__ > ()
                        ...
                        )) as *const super::ACE_String_Base_char_;
                    }
                    let mut auto_clean: super::ACE_Auto_Array_Ptr_char_ = ::core::mem::MaybeUninit::<
                        super::ACE_Auto_Array_Ptr_char_,
                    >::zeroed()
                        .assume_init();
                    <super::ACE_Auto_Array_Ptr_char_>::new_at_scfd4d5332d0ebcaf(
                        (::core::ptr::addr_of_mut!(auto_clean))
                            as *mut super::ACE_Auto_Array_Ptr_char_,
                        ((0) as *mut libc::c_char),
                    );
                    let mut UUID_STRING_LENGTH: libc::c_ulong = ((((((((36)
                        as libc::c_ulong))
                        .wrapping_add(
                            (<super::ACE_String_Base_char_>::length(
                                (::core::ptr::addr_of!(
                                    (* ::core::ptr::addr_of!((* __this).thr_id_) .cast:: <
                                    super::ACE_String_Base_char_ > ().cast_mut())
                                )) as *const super::ACE_String_Base_char_,
                    ...
                    if (((((36 as libc::c_ulong))
                        == (((UUID_STRING_LENGTH) as libc::c_ulong))) as libc::c_int
                        as libc::c_int) != 0)
                    {
                        'dowhile_0: loop {
                            'cont_0: loop {
                                {
                                    {
                                        buf = {
                                            let __count: usize = ((((UUID_STRING_LENGTH)
                                                as libc::c_ulong))
                                                .wrapping_add((1) as libc::c_ulong)) as usize;
                                            let __nbytes = __count
                                                .checked_mul(::core::mem::size_of::<libc::c_char>())
                                            ...
                                            if __data.is_null() {
                                                ::std::alloc::handle_alloc_error(
                                                    ::core::alloc::Layout::array::<libc::c_char>(__count)
                                                        .unwrap(),
                                                );
                                            }
                                        ...
                                        if (((((buf).is_null()) as libc::c_int) as libc::c_int)
                                            != 0)
                                        {
                                            ((*(super::__errno_location()))) = 12;
                                            return ((0) as *const super::ACE_String_Base_char_);
                                        }
                                    }
                                }
                        ...
                        <super::ACE_Auto_Basic_Array_Ptr_char_>::reset(
                            (::core::ptr::addr_of_mut!(
                                (* ::core::ptr::addr_of!((*
                                (::core::ptr::addr_of_mut!(auto_clean))).__base_0) .cast:: <
                                super::ACE_Auto_Basic_Array_Ptr_char_ > ().cast_mut())
                            )) as *mut super::ACE_Auto_Basic_Array_Ptr_char_,
                            buf,
                        );
                        super::ACE_OS::snprintf_u9a28649a3b771eeb(
                            buf,
                            (((UUID_STRING_LENGTH) as libc::c_ulong))
                                .wrapping_add((1) as libc::c_ulong),
                            ((b"%8.8x-%4.4x-%4.4x-%2.2x%2.2x-%2.2x%2.2x%2.2x%2.2x%2.2x%2.2x\0"
                                .as_ptr() as *const libc::c_char) as *const libc::c_char),
                            (*__this).uuid_.time_low_,
                            (((*__this).uuid_.time_mid_) as libc::c_int),
                            (((*__this).uuid_.time_hi_and_version_) as libc::c_int),
                            (((*__this).uuid_.clock_seq_hi_and_reserved_)
                                as libc::c_int),
                            (((*__this).uuid_.clock_seq_low_) as libc::c_int),
                            ((((*<UUID_Node>::node_ID_u0145985074a8cb4a(
                                (::core::ptr::addr_of!((* __this).uuid_.node_))
                                    as *const UUID_Node,
                            )))[(0) as usize]) as libc::c_int),
                            ((((*<UUID_Node>::node_ID_u0145985074a8cb4a(
                                (::core::ptr::addr_of!((* __this).uuid_.node_))
                                    as *const UUID_Node,
                            ...
                            ((((*<UUID_Node>::node_ID_u0145985074a8cb4a(
                                (::core::ptr::addr_of!((* __this).uuid_.node_))
                                    as *const UUID_Node,
                            )))[(2) as usize]) as libc::c_int),
                            ((((*<UUID_Node>::node_ID_u0145985074a8cb4a(
                                (::core::ptr::addr_of!((* __this).uuid_.node_))
                                    as *const UUID_Node,
                            )))[(3) as usize]) as libc::c_int),
                            ((((*<UUID_Node>::node_ID_u0145985074a8cb4a(
                                (::core::ptr::addr_of!((* __this).uuid_.node_))
                                    as *const UUID_Node,
                            )))[(4) as usize]) as libc::c_int),
                            ((((*<UUID_Node>::node_ID_u0145985074a8cb4a(
                                (::core::ptr::addr_of!((* __this).uuid_.node_))
                                    as *const UUID_Node,
                            )))[(5) as usize]) as libc::c_int),
                        );
                    } else {
                        {
                            UUID_STRING_LENGTH = (((UUID_STRING_LENGTH)
                                as libc::c_ulong))
                        ...
                        super::ACE_OS::snprintf_u9a28649a3b771eeb(
                            ...
                            (((UUID_STRING_LENGTH) as libc::c_ulong))
                                .wrapping_add((1) as libc::c_ulong),
                            ((b"%8.8x-%4.4x-%4.4x-%2.2x%2.2x-%2.2x%2.2x%2.2x%2.2x%2.2x%2.2x-%s-%s\0"
                                .as_ptr() as *const libc::c_char) as *const libc::c_char),
                            (*__this).uuid_.time_low_,
                            (((*__this).uuid_.time_mid_) as libc::c_int),
                            (((*__this).uuid_.time_hi_and_version_) as libc::c_int),
                            ...
                            <super::ACE_String_Base_char_>::c_str(
                                (::core::ptr::addr_of!(
                                    (* ::core::ptr::addr_of!((* __this).thr_id_) .cast:: <
                                    super::ACE_String_Base_char_ > ().cast_mut())
                                )) as *const super::ACE_String_Base_char_,
                    ...
                    let mut as_string: *mut super::ACE_String_Base_char_ = ((0)
                        as *mut super::ACE_String_Base_char_);
                    'dowhile_2: loop {
                        'cont_2: loop {
                            {
                                {
                                    as_string = {
                                        let __new: *mut super::ACE_String_Base_char_ = Box::into_raw(
                                            Box::new(
                                                ::core::mem::MaybeUninit::<
                                                    super::ACE_String_Base_char_,
                                                >::zeroed()
                                                    .assume_init(),
                                            ),
                                        );
                                        <super::ACE_String_Base_char_>::new_at_s6f773fdae271bd2d(
                                            (__new) as *mut super::ACE_String_Base_char_,
                                    ...
                                    if (((((as_string).is_null()) as libc::c_int)
                                        as libc::c_int) != 0)
                                    {
                                        ((*(super::__errno_location()))) = 12;
                                        return ((0) as *const super::ACE_String_Base_char_);
                    ...
                    <super::ACE_Auto_Basic_Ptr_ACE_String_Base_char__>::reset(
                        (::core::ptr::addr_of_mut!(
                            ...
                            super::ACE_Auto_Basic_Ptr_ACE_String_Base_char__ > ()
                            .cast_mut())
                        )) as *mut super::ACE_Auto_Basic_Ptr_ACE_String_Base_char__,
                        ((as_string) as *mut super::ACE_String_Base_char_),
                    );
                    return (<super::ACE_Auto_Basic_Ptr_ACE_String_Base_char__>::get(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* (::core::ptr::addr_of!((*
        ...
        pub unsafe fn from_string(
            __this: *mut Self,
            mut uuidString: *const super::ACE_String_Base_char_,
        ) {
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
        ...
        ///Equality Operations
        pub unsafe fn operator_eq(__this: *const Self, mut right: *const UUID) -> bool {
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    return (((((0 as libc::c_int))
                        == (((super::ACE_OS::memcmp_u2459c16080f3a32c(
                            ((::core::ptr::addr_of!((* __this).uuid_) as *const data)
                                as *const libc::c_void),
                            ((::core::ptr::addr_of!((* right).uuid_) as *const data)
                                as *const libc::c_void),
                            (((16 as libc::c_int)) as libc::c_ulong),
        ...
        pub unsafe fn operator_ne(__this: *const Self, mut right: *const UUID) -> bool {
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    return (((((0 as libc::c_int))
        ...
        pub unsafe fn hash(__this: *const Self) -> libc::c_ulong {
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    return ((super::ACE::hash_pjw_u1df7e2c40de66984(
                        (::core::ptr::addr_of!((* __this).uuid_) as *const data
            ...
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    if ((((((__this) as *const u8))
                        != (((((::core::ptr::addr_of!((* rhs)) as *const UUID)
                            as *mut UUID)) as *const u8))) as libc::c_int as libc::c_int)
                        != 0)
                    {
                        if ((((!(<super::ACE_Auto_Basic_Ptr_ACE_String_Base_char__>::get(
                            (::core::ptr::addr_of!(
                            ...
                            .is_null()) as libc::c_int) as libc::c_int) != 0)
                        {
                            if (((((((((<super::ACE_Auto_Basic_Ptr_ACE_String_Base_char__>::get(
                                (::core::ptr::addr_of!(
                                    (* ::core::ptr::addr_of!((* (::core::ptr::addr_of!((*
                                    ::core::ptr::addr_of!((* rhs).as_string_) .cast:: <
                                    super::ACE_Auto_Ptr_ACE_String_Base_char__ > ()
                                    .cast_mut())))).__base_0) .cast:: <
                                    super::ACE_Auto_Basic_Ptr_ACE_String_Base_char__ > ()
                                    .cast_mut())
                        ...
                        super::ACE_OS::memcpy_u6033eb81edaf9212(
                            ((::core::ptr::addr_of_mut!((* __this).uuid_) as *mut data)
                                as *mut libc::c_void),
                            ((::core::ptr::addr_of!((* rhs).uuid_) as *const data)
                                as *const libc::c_void),
                            (((16 as libc::c_int)) as libc::c_ulong),
                        );
                        <super::ACE_String_Base_char_>::operator_assign_sbd22052c3b720a46(
                            (::core::ptr::addr_of_mut!(
                                (* ::core::ptr::addr_of!((* __this).thr_id_) .cast:: <
                                super::ACE_String_Base_char_ > ().cast_mut())
                            )) as *mut super::ACE_String_Base_char_,
                            ::core::ptr::addr_of!(
                                (* ::core::ptr::addr_of!((* rhs).thr_id_) .cast:: <
                                super::ACE_String_Base_char_ > ().cast_mut())
                            ),
                        );
                        <super::ACE_String_Base_char_>::operator_assign_sbd22052c3b720a46(
                            ...
                            ::core::ptr::addr_of!(
                                (* ::core::ptr::addr_of!((* rhs).pid_) .cast:: <
                                super::ACE_String_Base_char_ > ().cast_mut())
                            ),
                        );
                    }
        ...
        pub unsafe fn init(__this: *mut Self) {
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    super::ACE_OS::memset_u2b5dfc47d301370a(
                        ((::core::ptr::addr_of_mut!((* __this).uuid_) as *mut data)
                            as *mut libc::c_void),
                        0,
                        (((16 as libc::c_int)) as libc::c_ulong),
        ...
        pub unsafe fn from_string_i(
            ...
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    if (((((<super::ACE_String_Base_char_>::length(
                        (::core::ptr::addr_of!((* uuid_string)))
                            as *const super::ACE_String_Base_char_,
                    ) as libc::c_ulong))
                        < (((<super::ACE_String_Base_char_>::length(
                            (<UUID>::to_string(
                                (::core::ptr::addr_of!(UUID_NIL_UUID)) as *const UUID,
                            )) as *const super::ACE_String_Base_char_,
                        )) as libc::c_ulong))) as libc::c_int as libc::c_int) != 0)
                    {
                        'dowhile_0: loop {
                            'cont_0: loop {
                                {
                                    {
                                        let mut __ace_error: libc::c_int = ((<super::ACE_Log_Msg>::last_error_adapter())
                                            as libc::c_int);
                                        let mut ace___: *mut super::ACE_Log_Category_TSS = <super::ACE_Log_Category>::per_thr_obj(
                                            (::core::ptr::addr_of_mut!(
                                                (* < super::ACE_Log_Category > ::ace_lib())
                                            )) as *mut super::ACE_Log_Category,
                                        );
                                        ...
                                        <super::ACE_Log_Category_TSS>::conditional_set(
                                            (ace___) as *mut super::ACE_Log_Category_TSS,
                                            ((b"/build/ace_full/src/ACE/ace/UUID.cpp\0".as_ptr()
                                                as *const libc::c_char) as *const libc::c_char),
                                            152,
                                            (-((1) as libc::c_int)),
                                            ((__ace_error) as libc::c_int),
                                        );
                                        <super::ACE_Log_Category_TSS>::log(
                                            (ace___) as *mut super::ACE_Log_Category_TSS,
                                            super::LM_ERROR,
                                            ((b"%N ACE_UUID::from_string_i - IllegalArgument (incorrect string length)\n\0"
                                                .as_ptr() as *const libc::c_char) as *const libc::c_char),
                                        );
                                    }
                                }
                    ...
                    if ((<super::ACE_String_Base_char_>::operator_eq_s221488fb36ec8992(
                        (::core::ptr::addr_of!((* uuid_string)))
                            as *const super::ACE_String_Base_char_,
                        <UUID>::to_string(
                            (::core::ptr::addr_of!(UUID_NIL_UUID)) as *const UUID,
                    ...
                    {
                        <UUID>::operator_assign(
                            (__this) as *mut UUID,
                            ::core::ptr::addr_of!(UUID_NIL_UUID),
                        );
                        return;
                    }
                    let mut time_low: libc::c_uint = unsafe { ::core::mem::zeroed() };
                    let mut time_mid: libc::c_uint = unsafe { ::core::mem::zeroed() };
                    let mut time_hi_and_version: libc::c_uint = unsafe {
                        ::core::mem::zeroed()
                    };
                    let mut clock_seq_hi_and_reserved: libc::c_uint = unsafe {
                        ::core::mem::zeroed()
                    };
                    let mut clock_seq_low: libc::c_uint = unsafe {
                        ::core::mem::zeroed()
                    };
                    let mut node: [libc::c_uint; 6usize] = unsafe {
                        ::core::mem::zeroed()
                    };
                    let mut thr_pid_buf: [libc::c_char; 8192usize] = unsafe {
                        ::core::mem::zeroed()
                    };
                    if (((((<super::ACE_String_Base_char_>::length(
                        (::core::ptr::addr_of!((* uuid_string)))
                    ...
                    {
                        let mut nScanned: libc::c_int = ((super::sscanf(
                            ((<super::ACE_String_Base_char_>::c_str(
                                (::core::ptr::addr_of!((* uuid_string)))
                                    as *const super::ACE_String_Base_char_,
                            )) as *const libc::c_char),
                            ((b"%8x-%4x-%4x-%2x%2x-%2x%2x%2x%2x%2x%2x\0".as_ptr()
                                as *const libc::c_char) as *const libc::c_char),
                            ::core::ptr::addr_of_mut!(time_low) as *mut libc::c_uint,
                            ::core::ptr::addr_of_mut!(time_mid) as *mut libc::c_uint,
                            ::core::ptr::addr_of_mut!(time_hi_and_version)
                                as *mut libc::c_uint,
                            ::core::ptr::addr_of_mut!(clock_seq_hi_and_reserved)
                                as *mut libc::c_uint,
                            ::core::ptr::addr_of_mut!(clock_seq_low)
                                as *mut libc::c_uint,
                            ::core::ptr::addr_of_mut!((node) [(0) as usize])
                                as *mut libc::c_uint,
                            ::core::ptr::addr_of_mut!((node) [(1) as usize])
                                as *mut libc::c_uint,
                            ::core::ptr::addr_of_mut!((node) [(2) as usize])
                                as *mut libc::c_uint,
                            ::core::ptr::addr_of_mut!((node) [(3) as usize])
                                as *mut libc::c_uint,
                            ::core::ptr::addr_of_mut!((node) [(4) as usize])
                                as *mut libc::c_uint,
                            ::core::ptr::addr_of_mut!((node) [(5) as usize])
                                as *mut libc::c_uint,
                        )) as libc::c_int);
                        if (((((nScanned as libc::c_int)) != (((11) as libc::c_int)))
                                    ...
                                    {
                                        {
                                            ...
                                            <super::ACE_Log_Category_TSS>::log(
                                                (ace___) as *mut super::ACE_Log_Category_TSS,
                                                super::LM_DEBUG,
                                                ((b"UUID::from_string_i - IllegalArgument (invalid string representation)\n\0"
                                                    .as_ptr() as *const libc::c_char) as *const libc::c_char),
                                            );
                                        }
                                    }
                        ...
                        let mut nScanned: libc::c_int = ((super::sscanf(
                            ...
                            ((b"%8x-%4x-%4x-%2x%2x-%2x%2x%2x%2x%2x%2x-%s\0".as_ptr()
                                as *const libc::c_char) as *const libc::c_char),
                            ::core::ptr::addr_of_mut!(time_low) as *mut libc::c_uint,
                            ::core::ptr::addr_of_mut!(time_mid) as *mut libc::c_uint,
                            ::core::ptr::addr_of_mut!(time_hi_and_version)
                            ...
                            ::core::ptr::addr_of_mut!((node) [(5) as usize])
                                as *mut libc::c_uint,
                            ((thr_pid_buf).as_mut_ptr() as *mut libc::c_char),
                        )) as libc::c_int);
                        if (((((nScanned as libc::c_int)) != (((12) as libc::c_int)))
                            as libc::c_int as libc::c_int) != 0)
                        {
                            'dowhile_2: loop {
                                'cont_2: loop {
                                    {
                                        {
                                            ...
                                            <super::ACE_Log_Category_TSS>::log(
                                                (ace___) as *mut super::ACE_Log_Category_TSS,
                                                super::LM_DEBUG,
                                                ((b"ACE_UUID::from_string_i - IllegalArgument (invalid string representation)\n\0"
                                                    .as_ptr() as *const libc::c_char) as *const libc::c_char),
                                            );
                                        }
                                    }
                    ...
                    (*__this).uuid_.time_low_ = (time_low as libc::c_uint);
                    (*__this).uuid_.time_mid_ = (time_mid as libc::c_ushort);
                    (*__this).uuid_.time_hi_and_version_ = (time_hi_and_version
                        as libc::c_ushort);
                    (*__this).uuid_.clock_seq_hi_and_reserved_ = (clock_seq_hi_and_reserved
                        as libc::c_uchar);
                    (*__this).uuid_.clock_seq_low_ = (clock_seq_low as libc::c_uchar);
                    {
                            ...
                            'cont_3: loop {
                                {
                                    ((*<UUID_Node>::node_ID(
                                        (::core::ptr::addr_of_mut!((* __this).uuid_.node_))
                                            as *mut UUID_Node,
                                    )))[(i) as usize] = ((node)[(i) as usize] as libc::c_uchar);
                                }
                    ...
                    if ((((((((((((((*__this).uuid_.clock_seq_hi_and_reserved_)
                        as libc::c_int)) & ((0xc0) as libc::c_int)) as libc::c_int))
                        != (((0x80) as libc::c_int))) as libc::c_int as libc::c_int)
                        != 0)
                        && ((((((((((*__this).uuid_.clock_seq_hi_and_reserved_)
                            as libc::c_int)) & ((0xc0) as libc::c_int)) as libc::c_int))
                            != (((0xc0) as libc::c_int))) as libc::c_int as libc::c_int)
                                ...
                                {
                                    {
                                        ...
                                        <super::ACE_Log_Category_TSS>::log(
                                            (ace___) as *mut super::ACE_Log_Category_TSS,
                                            super::LM_DEBUG,
                                            ((b"ACE_UUID::from_string_i - IllegalArgument (unsupported variant)\n\0"
                                                .as_ptr() as *const libc::c_char) as *const libc::c_char),
                                        );
                                    }
                                }
                    ...
                    let mut V1: libc::c_ushort = (*__this).uuid_.time_hi_and_version_;
                    if (((((((((((((((((V1) as libc::c_int)) & ((0xf000) as libc::c_int))
                        as libc::c_int)) != (((0x1000) as libc::c_int))) as libc::c_int
                        as libc::c_int) != 0)
                        && (((((((((V1) as libc::c_int)) & ((0xf000) as libc::c_int))
                                ...
                                {
                                    {
                                        ...
                                        <super::ACE_Log_Category_TSS>::log(
                                            (ace___) as *mut super::ACE_Log_Category_TSS,
                                            super::LM_DEBUG,
                                            ((b"ACE_UUID::from_string_i - IllegalArgument (unsupported version)\n\0"
                                                .as_ptr() as *const libc::c_char) as *const libc::c_char),
                                        );
                                    }
                                }
                        ...
                        != 0)
                    {
                                    ...
                                    {
                                        {
                                            ...
                                            <super::ACE_Log_Category_TSS>::log(
                                                (ace___) as *mut super::ACE_Log_Category_TSS,
                                                super::LM_DEBUG,
                                                ((b"ACE_UUID::from_string_i - IllegalArgument (Missing Thread and Process Id)\n\0"
                                                    .as_ptr() as *const libc::c_char) as *const libc::c_char),
                                            );
                                        }
                                    }
                        ...
                        let mut thr_pid_str: super::ACE_String_Base_char_ = ::core::mem::MaybeUninit::<
                            super::ACE_String_Base_char_,
                        >::zeroed()
                            .assume_init();
                        <super::ACE_String_Base_char_>::new_at_se5a50063ebed1e80(
                            (::core::ptr::addr_of_mut!(thr_pid_str))
                                as *mut super::ACE_String_Base_char_,
                            ((thr_pid_buf).as_ptr() as *const libc::c_char),
                            ((0) as *mut super::ACE_Allocator),
                            true,
                        );
                        let mut pos: libc::c_long = (<super::ACE_String_Base_char_>::find_s9bd4e6ac12180766(
                            (::core::ptr::addr_of!(thr_pid_str))
                                as *const super::ACE_String_Base_char_,
                            45 as libc::c_char,
                            ((0) as libc::c_ulong),
                        ) as libc::c_long);
                        if (((((pos as libc::c_long))
                                    ...
                                    {
                                        {
                                            ...
                                            <super::ACE_Log_Category_TSS>::log(
                                                (ace___) as *mut super::ACE_Log_Category_TSS,
                                                super::LM_DEBUG,
                                                ((b"ACE_UUID::from_string_i - IllegalArgument (Thread and Process Id format incorrect)\n\0"
                                                    .as_ptr() as *const libc::c_char) as *const libc::c_char),
                                            );
                                        }
                                    }
                                    #[allow(unreachable_code)] break 'cont_7;
                                }
                                if !(((0) != 0)) {
                                    break 'dowhile_7;
                                }
                        ...
                        let __addrof_tmp_0 = <super::ACE_String_Base_char_>::substr(
                            (::core::ptr::addr_of!(thr_pid_str))
                                as *const super::ACE_String_Base_char_,
                            ((0) as libc::c_ulong),
                            ((pos) as libc::c_ulong),
                        ...
                        <super::ACE_String_Base_char_>::operator_assign_sbd22052c3b720a46(
                            ...
                            &__addrof_tmp_0 as *const super::ACE_String_Base_char_,
                        );
                        let __addrof_tmp_1 = <super::ACE_String_Base_char_>::substr(
                            (::core::ptr::addr_of!(thr_pid_str))
                                as *const super::ACE_String_Base_char_,
                            (((((pos) as libc::c_long))
                                .wrapping_add((1) as libc::c_long)) as libc::c_ulong),
                            ((((((<super::ACE_String_Base_char_>::length(
                                (::core::ptr::addr_of!(thr_pid_str))
                                    as *const super::ACE_String_Base_char_,
                            )) as libc::c_ulong))
                                .wrapping_sub((pos) as libc::c_ulong)) as libc::c_ulong))
                        ...
                        <super::ACE_String_Base_char_>::operator_assign_sbd22052c3b720a46(
                            ...
                            &__addrof_tmp_1 as *const super::ACE_String_Base_char_,
                        );
                    }
                }
                ()
    ...
    impl UUID_Generator {
        ...
        pub unsafe fn new_at(__this: *mut Self) {
            unsafe {
                ...
                ::core::ptr::write(
                    ::core::ptr::addr_of_mut!((* __this).time_last_),
                    ((0) as libc::c_ulong),
                );
                ::core::ptr::write(
                    ::core::ptr::addr_of_mut!((* __this).destroy_lock_),
                    true,
                );
                ::core::ptr::write(
                    ::core::ptr::addr_of_mut!((* __this).is_init_),
                    false,
                );
                {
                    'dowhile_0: loop {
                        'cont_0: loop {
                            {
                                {
                                    (*__this).lock_ = {
                                        let __new: *mut super::ACE_Thread_Mutex = Box::into_raw(
                                            Box::new(
                                                ::core::mem::MaybeUninit::<
                                                    super::ACE_Thread_Mutex,
                                                >::zeroed()
                                                    .assume_init(),
                                            ),
                                        );
                                        <super::ACE_Thread_Mutex>::new_at(
                                            (__new) as *mut super::ACE_Thread_Mutex,
                                            ((0) as *const libc::c_char),
                                            ((0) as *mut super::pthread_mutexattr_t),
                                        );
                                        __new
                                    };
                                    if ((((((*__this).lock_).is_null()) as libc::c_int)
                                        as libc::c_int) != 0)
                                    {
                                        ((*(super::__errno_location()))) = 12;
                                        return;
                    ...
                    <UUID_Generator>::init((__this) as *mut UUID_Generator);
                }
                ()
            }
        }
    ...
    /// @deprecated This method may go away in some future release.*/
        pub unsafe fn init(__this: *mut Self) {
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    if (((*__this).is_init_ as libc::c_int) != 0) {
                        return;
                    }
                    let mut macaddress: super::ACE_OS::macaddr_node_t = unsafe {
                        ::core::mem::MaybeUninit::<
                            super::ACE_OS::macaddr_node_t,
                        >::zeroed()
                            .assume_init()
                    };
                    let mut result: libc::c_int = ((super::ACE_OS::getmacaddress(
                        ((::core::ptr::addr_of_mut!(macaddress)
                            as *mut super::ACE_OS::macaddr_node_t)
                            as *mut super::ACE_OS::macaddr_node_t),
                    )) as libc::c_int);
                    let mut node_id: [libc::c_uchar; 6usize] = unsafe {
                        ::core::mem::zeroed()
                    };
                    if ((((((-((1) as libc::c_int)) as libc::c_int))
                        != (((result) as libc::c_int))) as libc::c_int as libc::c_int)
                        != 0)
                    {
                        super::ACE_OS::memcpy_u6033eb81edaf9212(
                            ((node_id).as_mut_ptr() as *mut libc::c_void),
                            ((macaddress.node).as_ptr() as *const libc::c_void),
                            (((6 as libc::c_int)) as libc::c_ulong),
                        );
                    } else {
                        (node_id)[(0) as usize] = (super::ACE_OS::rand_uf8dfc603800d7fea()
                            as libc::c_uchar);
                        (node_id)[(1) as usize] = (super::ACE_OS::rand_uf8dfc603800d7fea()
                            as libc::c_uchar);
                        (node_id)[(2) as usize] = (super::ACE_OS::rand_uf8dfc603800d7fea()
                            as libc::c_uchar);
                        (node_id)[(3) as usize] = (super::ACE_OS::rand_uf8dfc603800d7fea()
                            as libc::c_uchar);
                        (node_id)[(4) as usize] = (super::ACE_OS::rand_uf8dfc603800d7fea()
                            as libc::c_uchar);
                        (node_id)[(5) as usize] = (super::ACE_OS::rand_uf8dfc603800d7fea()
                            as libc::c_uchar);
                    }
                    <UUID_Generator>::get_timestamp(
                        (__this) as *mut UUID_Generator,
                        ::core::ptr::addr_of_mut!((* __this).time_last_),
                    );
                    {
                        let mut ace_mon: super::ACE_Guard_ACE_Thread_Mutex_ = ::core::mem::MaybeUninit::<
                            super::ACE_Guard_ACE_Thread_Mutex_,
                        >::zeroed()
                            .assume_init();
                        <super::ACE_Guard_ACE_Thread_Mutex_>::new_at_s194b481c4e491c25(
                            (::core::ptr::addr_of_mut!(ace_mon))
                                as *mut super::ACE_Guard_ACE_Thread_Mutex_,
                            (*__this).lock_,
                        );
                        if (((((<super::ACE_Guard_ACE_Thread_Mutex_>::locked(
                            (::core::ptr::addr_of!(ace_mon))
                                as *const super::ACE_Guard_ACE_Thread_Mutex_,
                        ) as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                            as libc::c_int) != 0)
                        {} else {
                            return;
                        };
                        (*__this).uuid_state_.timestamp = (*__this).time_last_;
                        super::ACE_OS::memcpy_u6033eb81edaf9212(
                            (((*<UUID_Node>::node_ID(
                                (::core::ptr::addr_of_mut!((* __this).uuid_state_.node))
                                    as *mut UUID_Node,
                            )))
                                .as_mut_ptr() as *mut libc::c_void),
                            ((node_id).as_ptr() as *const libc::c_void),
                            (((6 as libc::c_int)) as libc::c_ulong),
                        );
                    }
                    (*__this).is_init_ = true;
                }
                ()
            }
        }
    ...
    /// thread and process ids use variant=0xc0*/
        pub unsafe fn generate_UUID(
            __this: *mut Self,
            mut uuid: *mut UUID,
            mut version: libc::c_ushort,
            mut variant: libc::c_uchar,
        ) {
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    let mut timestamp: libc::c_ulong = ((0) as libc::c_ulong);
                    let mut clock_sequence: libc::c_ushort = ((0) as libc::c_ushort);
                    <UUID_Generator>::get_timestamp_and_clocksequence(
                        (__this) as *mut UUID_Generator,
                        ::core::ptr::addr_of_mut!(timestamp),
                        ::core::ptr::addr_of_mut!(clock_sequence),
                    );
                    <UUID>::time_low_u91d0b6c37e681b93(
                        (::core::ptr::addr_of_mut!((* uuid))) as *mut UUID,
                        (((((timestamp) as libc::c_ulong))
                            & ((0xffffffffu32) as libc::c_ulong)) as libc::c_uint),
                    );
                    <UUID>::time_mid_ue72906ca1f0a8ae5(
                        (::core::ptr::addr_of_mut!((* uuid))) as *mut UUID,
                        (((((((((timestamp) as libc::c_ulong))
                            .wrapping_shr((32) as u32))) as libc::c_ulong))
                            & ((0xffff) as libc::c_ulong)) as libc::c_ushort),
                    );
                    let mut tHAV: libc::c_ushort = (((((((((timestamp) as libc::c_ulong))
                        .wrapping_shr((48) as u32))) as libc::c_ulong))
                        & ((0xffff) as libc::c_ulong)) as libc::c_ushort);
                    tHAV = (((((tHAV) as libc::c_int))
                        | ((((((version) as libc::c_int)).wrapping_shl((12) as u32)))
                            as libc::c_int)) as libc::c_ushort);
                    <UUID>::time_hi_and_version_u074dcc3bc96f7075(
                        (::core::ptr::addr_of_mut!((* uuid))) as *mut UUID,
                        tHAV,
                    );
                    let mut cseqHAV: libc::c_uchar = unsafe { ::core::mem::zeroed() };
                    <UUID>::clock_seq_low_uefb323910e3bea9c(
                        (::core::ptr::addr_of_mut!((* uuid))) as *mut UUID,
                        (((((clock_sequence) as libc::c_int)) & ((0xff) as libc::c_int))
                            as libc::c_uchar),
                    );
                    cseqHAV = ((((((((clock_sequence) as libc::c_int))
                        & ((0x3f00) as libc::c_int))) as libc::c_int))
                        .wrapping_shr((8) as u32) as libc::c_uchar);
                    (*__this).uuid_state_.timestamp = timestamp;
                    cseqHAV = (((((cseqHAV) as libc::c_int))
                        | ((variant) as libc::c_int)) as libc::c_uchar);
                    <UUID>::clock_seq_hi_and_reserved_uc95f6bff4ae469d0(
                        (::core::ptr::addr_of_mut!((* uuid))) as *mut UUID,
                        cseqHAV,
                    );
                    <UUID>::node_u08cd53404ba9c5e1(
                        (::core::ptr::addr_of_mut!((* uuid))) as *mut UUID,
                        ::core::ptr::addr_of!((* __this).uuid_state_.node),
                    );
                    if (((((variant as libc::c_int)) == (((0xc0) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        let mut thread_id: super::ACE_Thread_ID = ::core::mem::MaybeUninit::<
                            super::ACE_Thread_ID,
                        >::zeroed()
                            .assume_init();
                        <super::ACE_Thread_ID>::new_at_u84c6a26382b7660d(
                            (::core::ptr::addr_of_mut!(thread_id))
                                as *mut super::ACE_Thread_ID,
                        );
                        let mut buf: [libc::c_char; 8192usize] = unsafe {
                            ::core::mem::zeroed()
                        };
                        <super::ACE_Thread_ID>::to_string(
                            (::core::ptr::addr_of!(thread_id))
                                as *const super::ACE_Thread_ID,
                            ((buf).as_mut_ptr() as *mut libc::c_char),
                            ((8192) as libc::c_ulong),
                        );
                        <UUID>::thr_id_u31b402370a2f177b(
                            (::core::ptr::addr_of_mut!((* uuid))) as *mut UUID,
                            ((buf).as_mut_ptr() as *mut libc::c_char),
                        );
                        super::ACE_OS::snprintf_u9a28649a3b771eeb(
                            ...
                            ((b"%d\0".as_ptr() as *const libc::c_char)
                                as *const libc::c_char),
                            (super::ACE_OS::getpid_ucc9c2c9e176d9ca8() as libc::c_int),
                        );
                        <UUID>::pid_ubea6a2e318d38194(
                            (::core::ptr::addr_of_mut!((* uuid))) as *mut UUID,
                            ((buf).as_mut_ptr() as *mut libc::c_char),
                        );
                    }
    ...
    /// generating UUID's with thread and process ids use variant=0xc0*/
        pub unsafe fn generate_UUID_u191e86a9bd9955b2(
            __this: *mut Self,
            mut version: libc::c_ushort,
            mut variant: libc::c_uchar,
        ) -> *mut UUID {
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    let mut uuid: *mut UUID = ((0) as *mut UUID);
                    'dowhile_0: loop {
                        'cont_0: loop {
                            {
                                {
                                    uuid = {
                                        let __new: *mut UUID = Box::into_raw(
                                            Box::new(
                                                ::core::mem::MaybeUninit::<UUID>::zeroed().assume_init(),
                                            ),
                                        );
                                        <UUID>::new_at((__new) as *mut UUID);
                                        __new
                                    };
                                    if (((((uuid).is_null()) as libc::c_int) as libc::c_int)
                                        != 0)
                                    {
                                        ((*(super::__errno_location()))) = 12;
                                        return ((0) as *mut UUID);
                                    }
                                }
                            }
                            #[allow(unreachable_code)] break 'cont_0;
    ...
    /// the UUID_state at the same time. Get the locking strategy.*/
        pub unsafe fn lock(__this: *mut Self) -> *mut super::ACE_Thread_Mutex {
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    return (*__this).lock_;
        ...
        pub unsafe fn lock_u6f96543e05a3708f(
            __this: *mut Self,
            mut lock: *mut super::ACE_Thread_Mutex,
            mut release_lock: bool,
        ) {
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    ...
                    (*__this).lock_ = lock;
                    (*__this).destroy_lock_ = release_lock;
                }
                ()
            }
        }
    ...
    /// obtained from getSystem time has a resolution less than 100ns.*/
        pub unsafe fn get_timestamp(
            __this: *mut Self,
            mut timestamp: *mut libc::c_ulong,
        ) {
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    let mut mon: super::ACE_Guard_ACE_Thread_Mutex_ = ::core::mem::MaybeUninit::<
                        super::ACE_Guard_ACE_Thread_Mutex_,
                    >::zeroed()
                        .assume_init();
                    <super::ACE_Guard_ACE_Thread_Mutex_>::new_at_s194b481c4e491c25(
                        (::core::ptr::addr_of_mut!(mon))
                            as *mut super::ACE_Guard_ACE_Thread_Mutex_,
                        (*__this).lock_,
                    );
                    if (((((<super::ACE_Guard_ACE_Thread_Mutex_>::locked(
                        (::core::ptr::addr_of!(mon))
                            as *const super::ACE_Guard_ACE_Thread_Mutex_,
                    ) as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                        as libc::c_int) != 0)
                    {} else {
                    ...
                    <UUID_Generator>::get_systemtime(
                        (__this) as *mut UUID_Generator,
                        ::core::ptr::addr_of_mut!((* timestamp)),
                    );
                    if ((((((*timestamp) as libc::c_ulong))
                        <= ((((*__this).time_last_) as libc::c_ulong))) as libc::c_int
                        as libc::c_int) != 0)
                    {
                        (*__this).uuid_state_.clock_sequence = ((((((((((*__this)
                            .uuid_state_
                            .clock_sequence) as libc::c_int))
                            .wrapping_add((1) as libc::c_int))) as libc::c_int))
                            & (((16383 as libc::c_int)) as libc::c_int))
                            as libc::c_ushort);
                    } else {
                        if ((((((*timestamp) as libc::c_ulong))
                            > ((((*__this).time_last_) as libc::c_ulong))) as libc::c_int
                            as libc::c_int) != 0)
                        {
                            (*__this).uuid_state_.clock_sequence = ((0)
                                as libc::c_ushort);
                        }
                    }
                    (*__this).time_last_ = (*timestamp);
                }
                ()
            }
        }
    ...
    /// resolution less than 100ns.*/
        pub unsafe fn get_timestamp_and_clocksequence(
            __this: *mut Self,
            mut timestamp: *mut libc::c_ulong,
            mut clock_sequence: *mut libc::c_ushort,
        ) {
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    ...
                    (*__this).time_last_ = (*timestamp);
                    (*clock_sequence) = (*__this).uuid_state_.clock_sequence;
                }
                ()
            }
        }
    ...
    /// the Christian calendar).*/
        pub unsafe fn get_systemtime(
            ...
            unsafe {
                let __this: *mut Self = __this as *mut Self;
                {
                    let mut timeOffset: libc::c_ulong = ((122192928000000000u64)
                        as libc::c_ulong);
                    let mut now: super::ACE_Time_Value = super::ACE_OS::gettimeofday_u3220bcbbceb90f45();
                    let mut time: libc::c_ulong = unsafe { ::core::mem::zeroed() };
                    <super::ACE_Time_Value>::to_usec(
                        (::core::ptr::addr_of!(now)) as *const super::ACE_Time_Value,
                        ::core::ptr::addr_of_mut!(time),
                    );
                    time = (((time) as libc::c_ulong))
                        .wrapping_mul((10) as libc::c_ulong);
                    (*timestamp) = (((((time) as libc::c_ulong))
                        .wrapping_add((timeOffset) as libc::c_ulong)) as libc::c_ulong);
                }
                ()
            }
        }
...
#[allow(non_upper_case_globals)]
#[no_mangle]
pub static mut ACE_Singleton_ACE_Utils__UUID_Generator__ACE_MT_SYNCH__MUTEX__singleton_: *mut ACE_Singleton_ACE_Utils__UUID_Generator__ACE_MT_SYNCH__MUTEX_ = ((0)
    as *mut ACE_Singleton_ACE_Utils__UUID_Generator__ACE_MT_SYNCH__MUTEX_);
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Singleton_ACE_Utils__UUID_Generator__ACE_MT_SYNCH__MUTEX_ {
    pub __base_0: ::core::mem::ManuallyDrop<ACE_Cleanup>,
    pub instance_: ::core::mem::ManuallyDrop<ACE_Utils::UUID_Generator>,
}
impl Drop for ACE_Singleton_ACE_Utils__UUID_Generator__ACE_MT_SYNCH__MUTEX_ {
    fn drop(&mut self) {
        unsafe {
...
#[export_name = "_ZN13ACE_SingletonIN9ACE_Utils14UUID_GeneratorE16ACE_Thread_MutexE10instance_iEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_SingletonIN9ACE_Utils14UUID_GeneratorE16ACE_Thread_MutexE10instance_iEv() -> *mut *mut ACE_Singleton_ACE_Utils__UUID_Generator__ACE_MT_SYNCH__MUTEX_ {
    unsafe {
        ACE_Singleton_ACE_Utils__UUID_Generator__ACE_MT_SYNCH__MUTEX_::instance_i()
    }
}
#[export_name = "_ZN13ACE_SingletonIN9ACE_Utils14UUID_GeneratorE16ACE_Thread_MutexE7cleanupEPv"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_SingletonIN9ACE_Utils14UUID_GeneratorE16ACE_Thread_MutexE7cleanupEPv(
    __this: *mut ACE_Singleton_ACE_Utils__UUID_Generator__ACE_MT_SYNCH__MUTEX_,
    param: *mut libc::c_void,
) {
    unsafe {
        ACE_Singleton_ACE_Utils__UUID_Generator__ACE_MT_SYNCH__MUTEX_::cleanup(
            __this,
            param,
        )
    }
}
#[export_name = "_ZN13ACE_SingletonIN9ACE_Utils14UUID_GeneratorE16ACE_Thread_MutexE5closeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_SingletonIN9ACE_Utils14UUID_GeneratorE16ACE_Thread_MutexE5closeEv() {
    unsafe { ACE_Singleton_ACE_Utils__UUID_Generator__ACE_MT_SYNCH__MUTEX_::close() }
}
#[export_name = "_ZN13ACE_SingletonIN9ACE_Utils14UUID_GeneratorE16ACE_Thread_MutexE4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_SingletonIN9ACE_Utils14UUID_GeneratorE16ACE_Thread_MutexE4dumpEv() {
    unsafe { ACE_Singleton_ACE_Utils__UUID_Generator__ACE_MT_SYNCH__MUTEX_::dump() }
}
#[export_name = "_ZN13ACE_SingletonIN9ACE_Utils14UUID_GeneratorE16ACE_Thread_MutexEC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_SingletonIN9ACE_Utils14UUID_GeneratorE16ACE_Thread_MutexEC1Ev(
    __this: *mut ACE_Singleton_ACE_Utils__UUID_Generator__ACE_MT_SYNCH__MUTEX_,
) {
    ACE_Singleton_ACE_Utils__UUID_Generator__ACE_MT_SYNCH__MUTEX_::new_at_s0512303279ab8916(
        __this,
    )
}
#[export_name = "_ZN13ACE_SingletonIN9ACE_Utils14UUID_GeneratorE16ACE_Thread_MutexE8instanceEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_SingletonIN9ACE_Utils14UUID_GeneratorE16ACE_Thread_MutexE8instanceEv() -> *mut ACE_Utils::UUID_Generator {
    unsafe { ACE_Singleton_ACE_Utils__UUID_Generator__ACE_MT_SYNCH__MUTEX_::instance() }
}
#[repr(C)]
...
extern "C-unwind" {
    pub fn getnetbyaddr(__net: libc::c_uint, __type: libc::c_int) -> *mut netent;
}
extern "C-unwind" {
...
extern "C-unwind" {
    pub fn rresvport_af(__alport: *mut libc::c_int, __af: libc::c_ushort) -> libc::c_int;
}
extern "C-unwind" {
    pub fn getaddrinfo(
        __name: *const libc::c_char,
...
extern "C-unwind" {
    pub fn getnameinfo(
        ...
        __hostlen: libc::c_uint,
        __serv: *mut libc::c_char,
        __servlen: libc::c_uint,
        __flags: libc::c_int,
    ) -> libc::c_int;
}
extern "C-unwind" {
...
extern "C-unwind" {
    pub fn gai_error(__req: *mut gaicb) -> libc::c_int;
}
extern "C-unwind" {
    pub fn gai_cancel(__gaicbp: *mut gaicb) -> libc::c_int;
}
extern "C-unwind" {
    ...
    pub unsafe fn find_s9bd4e6ac12180766(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                let mut pointer: *mut libc::c_char = ACE_OS::strnchr_uc374d3979b1df78e(
                    substr,
                    ((c) as libc::c_int),
                    ((((((*__this).len_) as libc::c_ulong))
                        .wrapping_sub((pos) as libc::c_ulong)) as libc::c_ulong),
...
impl ACE_Auto_Ptr_ACE_String_Base_char__ {
    pub unsafe fn new_at_s90ea86af6ba2ad18(
        __this: *mut Self,
        mut p: *mut ACE_String_Base_char_,
    ) {
        unsafe {
            ::core::ptr::write(
                __this,
            ...
            <ACE_Auto_Basic_Ptr_ACE_String_Base_char__>::new_at_s6410a1362e87c9e5(
                (::core::ptr::addr_of_mut!((* __this).__base_0)
                    .cast::<ACE_Auto_Basic_Ptr_ACE_String_Base_char__>())
                    as *mut ACE_Auto_Basic_Ptr_ACE_String_Base_char__,
                p,
            );
            {}
            ()
    ...
    pub unsafe fn new_s90ea86af6ba2ad18(mut __a0: *mut ACE_String_Base_char_) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s90ea86af6ba2ad18(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    pub unsafe fn operator_arrow(__this: *const Self) -> *mut ACE_String_Base_char_ {
        extern "C-unwind" {
            #[link_name = "_ZNK12ACE_Auto_PtrI15ACE_String_BaseIcEEptEv"]
            fn __ext(
                __this: *const ACE_Auto_Ptr_ACE_String_Base_char__,
            ) -> *mut ACE_String_Base_char_;
        }
        __ext(__this as *const ACE_Auto_Ptr_ACE_String_Base_char__)
    }
}
impl ACE_Singleton_ACE_Utils__UUID_Generator__ACE_MT_SYNCH__MUTEX_ {
    pub unsafe fn instance_i() -> *mut *mut ACE_Singleton_ACE_Utils__UUID_Generator__ACE_MT_SYNCH__MUTEX_ {
        unsafe {
            {
                return ::core::ptr::addr_of_mut!(
                    ACE_Singleton_ACE_Utils__UUID_Generator__ACE_MT_SYNCH__MUTEX__singleton_
                );
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    ...
    pub unsafe fn cleanup(__this: *mut Self, mut param: *mut libc::c_void) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                <ACE_Object_Manager>::remove_at_exit(((__this) as *mut libc::c_void));
                {
                    let __p = __this;
                    if !__p.is_null() {
                        let __vt: *const __Vtbl_u7e0a41a385e4df65 = *(__p
                            as *const *const __Vtbl_u7e0a41a385e4df65);
                        ((*__vt).__vdtor)(__p as *mut ACE_Cleanup);
                    }
                };
                (*<ACE_Singleton_ACE_Utils__UUID_Generator__ACE_MT_SYNCH__MUTEX_>::instance_i()) = ((0)
                    as *mut ACE_Singleton_ACE_Utils__UUID_Generator__ACE_MT_SYNCH__MUTEX_);
                if (!(param).is_null()) {
                    let mut lock: *mut *mut ACE_Thread_Mutex = (param
                        as *mut *mut ACE_Thread_Mutex);
                    (*(lock)) = ((0) as *mut ACE_Thread_Mutex);
                }
            }
            ()
        }
    ...
    pub unsafe fn close() {
        unsafe {
            {
                let mut singleton: *mut *mut ACE_Singleton_ACE_Utils__UUID_Generator__ACE_MT_SYNCH__MUTEX_ = &mut ((*<ACE_Singleton_ACE_Utils__UUID_Generator__ACE_MT_SYNCH__MUTEX_>::instance_i()));
                if (!((*singleton)).is_null()) {
                    {
                        let __obj: *mut ACE_Cleanup = ((*singleton)) as *mut ACE_Cleanup;
                        let __vt: *const __Vtbl_u7e0a41a385e4df65 = *(__obj
                            as *const *const __Vtbl_u7e0a41a385e4df65);
                        ((*__vt)
                            .vfn_ucaae14a381d74b6a)(__obj, ((0) as *mut libc::c_void))
                    };
                    (*<ACE_Singleton_ACE_Utils__UUID_Generator__ACE_MT_SYNCH__MUTEX_>::instance_i()) = ((0)
                        as *mut ACE_Singleton_ACE_Utils__UUID_Generator__ACE_MT_SYNCH__MUTEX_);
                }
    ...
    pub unsafe fn new_at_s0512303279ab8916(__this: *mut Self) {
        unsafe {
            ::core::ptr::write(
                __this,
                ::core::mem::MaybeUninit::<Self>::zeroed().assume_init(),
            ...
            <ACE_Cleanup>::new_at(
                ::core::ptr::addr_of_mut!((* __this).__base_0).cast::<ACE_Cleanup>(),
            );
            *(__this as *mut *const ()) = &__VTBL_u0512303279ab8916
                as *const __Vtbl_u0512303279ab8916 as *const ();
            <ACE_Utils::UUID_Generator>::new_at(
                ::core::ptr::addr_of_mut!((* __this).instance_)
                    .cast::<ACE_Utils::UUID_Generator>(),
            );
            {}
            ()
        }
    }
    pub unsafe fn new_s0512303279ab8916() -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s0512303279ab8916(::core::ptr::addr_of_mut!(__obj));
        __obj
    }
    pub unsafe fn instance() -> *mut ACE_Utils::UUID_Generator {
        unsafe {
            {
                let mut singleton: *mut *mut ACE_Singleton_ACE_Utils__UUID_Generator__ACE_MT_SYNCH__MUTEX_ = &mut ((*<ACE_Singleton_ACE_Utils__UUID_Generator__ACE_MT_SYNCH__MUTEX_>::instance_i()));
                if ((((((*singleton)).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    if ((((((<ACE_Object_Manager>::starting_up()) != 0)
                        || ((<ACE_Object_Manager>::shutting_down()) != 0))
                        as libc::c_int) as libc::c_int) != 0)
                    {
                        'dowhile_0: loop {
                            'cont_0: loop {
                                {
                                    {
                                        (*singleton) = {
                                            let __new: *mut ACE_Singleton_ACE_Utils__UUID_Generator__ACE_MT_SYNCH__MUTEX_ = Box::into_raw(
                                                Box::new(
                                                    ::core::mem::MaybeUninit::<
                                                        ACE_Singleton_ACE_Utils__UUID_Generator__ACE_MT_SYNCH__MUTEX_,
                                                    >::zeroed()
                                                        .assume_init(),
                                                ),
                                            );
                                        ...
                                        if ((((((*singleton)).is_null()) as libc::c_int)
                                            as libc::c_int) != 0)
                                        {
                                            ((*(__errno_location()))) = 12;
                                            return ((0) as *mut ACE_Utils::UUID_Generator);
                                        }
                                    }
                                }
                                #[allow(unreachable_code)] break 'cont_0;
                        ...
                        static mut lock: *mut ACE_Thread_Mutex = ((0)
                            as *mut ACE_Thread_Mutex);
                        if (((((<ACE_Object_Manager>::get_singleton_lock_ucad184b1c11997ce(
                        ...
                        if ((((((*singleton)).is_null()) as libc::c_int) as libc::c_int)
                            != 0)
                        {
                            'dowhile_1: loop {
                                'cont_1: loop {
                            ...
                            <ACE_Object_Manager>::at_exit(
                                (((*singleton)) as *mut ACE_Cleanup),
                                ((::core::ptr::addr_of_mut!(lock)
                                    as *mut *mut ACE_Thread_Mutex) as *mut libc::c_void),
                                unsafe {
                                    (*((&__TYPEINFO_N9ACE_Utils14UUID_GeneratorE
                ...
                return ::core::ptr::addr_of_mut!(
                    (* ::core::ptr::addr_of!((* (* singleton)).instance_) .cast:: <
                    ACE_Utils::UUID_Generator > ().cast_mut())
                ) as *mut ACE_Utils::UUID_Generator;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
}
impl ACE_Auto_Basic_Ptr_ACE_String_Base_char__ {
    pub unsafe fn new_at_s6410a1362e87c9e5(
        __this: *mut Self,
        mut p: *mut ACE_String_Base_char_,
    ) {
        unsafe {
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).p_),
                ((p) as *mut ACE_String_Base_char_),
            );
            {}
            ()
        }
    }
    pub unsafe fn new_s6410a1362e87c9e5(mut __a0: *mut ACE_String_Base_char_) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s6410a1362e87c9e5(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    pub unsafe fn new_at_s5624f258ed7c6228(
        __this: *mut Self,
        mut __a0: *mut ACE_Auto_Basic_Ptr_ACE_String_Base_char__,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN18ACE_Auto_Basic_PtrI15ACE_String_BaseIcEEC1ERS2_"]
            fn __ext(
                __this: *mut ACE_Auto_Basic_Ptr_ACE_String_Base_char__,
                __a0: *mut ACE_Auto_Basic_Ptr_ACE_String_Base_char__,
            );
        }
        __ext(__this as *mut ACE_Auto_Basic_Ptr_ACE_String_Base_char__, __a0)
    }
    pub unsafe fn new_s5624f258ed7c6228(
        mut __a0: *mut ACE_Auto_Basic_Ptr_ACE_String_Base_char__,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s5624f258ed7c6228(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    pub unsafe fn operator_assign(
        __this: *mut Self,
        mut rhs: *mut ACE_Auto_Basic_Ptr_ACE_String_Base_char__,
    ) -> *mut ACE_Auto_Basic_Ptr_ACE_String_Base_char__ {
        extern "C-unwind" {
            #[link_name = "_ZN18ACE_Auto_Basic_PtrI15ACE_String_BaseIcEEaSERS2_"]
            fn __ext(
                __this: *mut ACE_Auto_Basic_Ptr_ACE_String_Base_char__,
                rhs: *mut ACE_Auto_Basic_Ptr_ACE_String_Base_char__,
            ) -> *mut ACE_Auto_Basic_Ptr_ACE_String_Base_char__;
        }
        __ext(__this as *mut ACE_Auto_Basic_Ptr_ACE_String_Base_char__, rhs)
    }
    pub unsafe fn operator_mul(__this: *const Self) -> *mut ACE_String_Base_char_ {
        extern "C-unwind" {
            #[link_name = "_ZNK18ACE_Auto_Basic_PtrI15ACE_String_BaseIcEEdeEv"]
            fn __ext(
                __this: *const ACE_Auto_Basic_Ptr_ACE_String_Base_char__,
            ) -> *mut ACE_String_Base_char_;
        }
        __ext(__this as *const ACE_Auto_Basic_Ptr_ACE_String_Base_char__)
    }
    pub unsafe fn release(__this: *mut Self) -> *mut ACE_String_Base_char_ {
        extern "C-unwind" {
            #[link_name = "_ZN18ACE_Auto_Basic_PtrI15ACE_String_BaseIcEE7releaseEv"]
            fn __ext(
                __this: *mut ACE_Auto_Basic_Ptr_ACE_String_Base_char__,
            ) -> *mut ACE_String_Base_char_;
        }
        __ext(__this as *mut ACE_Auto_Basic_Ptr_ACE_String_Base_char__)
    }
    ///Dump the state of an object.
    pub unsafe fn dump(__this: *const Self) {
        extern "C-unwind" {
            #[link_name = "_ZNK18ACE_Auto_Basic_PtrI15ACE_String_BaseIcEE4dumpEv"]
            fn __ext(__this: *const ACE_Auto_Basic_Ptr_ACE_String_Base_char__);
        }
        __ext(__this as *const ACE_Auto_Basic_Ptr_ACE_String_Base_char__)
    }
    pub unsafe fn get(__this: *const Self) -> *mut ACE_String_Base_char_ {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((*__this).p_) as *mut ACE_String_Base_char_);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    pub unsafe fn reset(__this: *mut Self, mut p: *mut ACE_String_Base_char_) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((((<ACE_Auto_Basic_Ptr_ACE_String_Base_char__>::get(
                    (__this) as *const ACE_Auto_Basic_Ptr_ACE_String_Base_char__,
                )) as *const u8)) != (((p) as *const u8))) as libc::c_int as libc::c_int)
                    != 0)
                {
                    {
                        let __d = <ACE_Auto_Basic_Ptr_ACE_String_Base_char__>::get(
...
unsafe extern "C-unwind" fn __rt_static_init() {
    ::core::ptr::write(
        ::core::ptr::addr_of_mut!(ACE_Utils::UUID_NIL_UUID),
        <ACE_Utils::UUID>::new(),
    );
}
#[used]
...
pub static __TYPEINFO_N9ACE_Utils14UUID_GeneratorE: crate::__cxx_std::TypeInfo = crate::__cxx_std::TypeInfo {
    __name: b"N9ACE_Utils14UUID_GeneratorE\0".as_ptr() as *const libc::c_char,
};
pub unsafe fn __vdtor_u0512303279ab8916(__this: *mut ACE_Cleanup) {
    let _ = Box::from_raw(
        __this as *mut ACE_Singleton_ACE_Utils__UUID_Generator__ACE_MT_SYNCH__MUTEX_,
    );
}
pub unsafe fn __vthunk_ouc9dd5c96622e1b7c_iucaae14a381d74b6a(
...
pub static __VTBL_u0512303279ab8916: __Vtbl_u0512303279ab8916 = __Vtbl_u0512303279ab8916 {
    __type_info: &__TYPEINFO_13ACE_Singleton,
    __vdtor: __vdtor_u0512303279ab8916,
    vfn_ucaae14a381d74b6a: __vthunk_ouc9dd5c96622e1b7c_iucaae14a381d74b6a,
};
