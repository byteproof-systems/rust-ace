...
#[export_name = "_ZNK28ACE_SOCK_SEQPACK_Association15get_local_addrsEP13ACE_INET_AddrRm"]
pub unsafe extern "C-unwind" fn __xtu__ZNK28ACE_SOCK_SEQPACK_Association15get_local_addrsEP13ACE_INET_AddrRm(
    __this: *const ACE_SOCK_SEQPACK_Association,
    addrs: *mut ACE_INET_Addr,
    size: *mut libc::c_ulong,
) -> libc::c_int {
    unsafe { ACE_SOCK_SEQPACK_Association::get_local_addrs(__this, addrs, size) }
}
#[export_name = "_ZNK28ACE_SOCK_SEQPACK_Association16get_remote_addrsEP13ACE_INET_AddrRm"]
pub unsafe extern "C-unwind" fn __xtu__ZNK28ACE_SOCK_SEQPACK_Association16get_remote_addrsEP13ACE_INET_AddrRm(
    __this: *const ACE_SOCK_SEQPACK_Association,
    addrs: *mut ACE_INET_Addr,
    size: *mut libc::c_ulong,
) -> libc::c_int {
    unsafe { ACE_SOCK_SEQPACK_Association::get_remote_addrs(__this, addrs, size) }
}
#[export_name = "_ZN28ACE_SOCK_SEQPACK_Association5closeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN28ACE_SOCK_SEQPACK_Association5closeEv(
    __this: *mut ACE_SOCK_SEQPACK_Association,
) -> libc::c_int {
    unsafe { ACE_SOCK_SEQPACK_Association::close(__this) }
}
#[export_name = "_ZN28ACE_SOCK_SEQPACK_Association5abortEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN28ACE_SOCK_SEQPACK_Association5abortEv(
    __this: *mut ACE_SOCK_SEQPACK_Association,
) -> libc::c_int {
    unsafe { ACE_SOCK_SEQPACK_Association::abort(__this) }
}
#[export_name = "_ZNK28ACE_SOCK_SEQPACK_Association4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK28ACE_SOCK_SEQPACK_Association4dumpEv(
    __this: *const ACE_SOCK_SEQPACK_Association,
) {
    unsafe { ACE_SOCK_SEQPACK_Association::dump(__this) }
}
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Auto_Basic_Array_Ptr_sockaddr_in_ {
    pub p_: *mut sockaddr_in,
}
#[export_name = "_ZN24ACE_Auto_Basic_Array_PtrI11sockaddr_inEC1EPS0_"]
pub unsafe extern "C-unwind" fn __xtu__ZN24ACE_Auto_Basic_Array_PtrI11sockaddr_inEC1EPS0_(
    __this: *mut ACE_Auto_Basic_Array_Ptr_sockaddr_in_,
    __a0: *mut sockaddr_in,
) {
    ACE_Auto_Basic_Array_Ptr_sockaddr_in_::new_at_s5509e64012e39f5f(__this, __a0)
}
impl Drop for ACE_Auto_Basic_Array_Ptr_sockaddr_in_ {
    fn drop(&mut self) {
        unsafe {
            let __this: *mut Self = self as *mut Self;
            {
                {
                    let __data = <ACE_Auto_Basic_Array_Ptr_sockaddr_in_>::get(
                        (__this) as *const ACE_Auto_Basic_Array_Ptr_sockaddr_in_,
                    ) as *mut sockaddr_in;
                    if !__data.is_null() {
...
#[export_name = "__acedtor_ubbf1dbebf5ef6dbd"]
pub unsafe extern "C-unwind" fn __acedtor_ubbf1dbebf5ef6dbd(
    __this: *mut ACE_Auto_Basic_Array_Ptr_sockaddr_in_,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Auto_Array_Ptr_sockaddr_in_ {
    pub __base_0: ::core::mem::ManuallyDrop<ACE_Auto_Basic_Array_Ptr_sockaddr_in_>,
}
impl Drop for ACE_Auto_Array_Ptr_sockaddr_in_ {
    fn drop(&mut self) {
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.__base_0);
        }
...
#[export_name = "_ZN18ACE_Auto_Array_PtrI11sockaddr_inEC1EPS0_"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_Auto_Array_PtrI11sockaddr_inEC1EPS0_(
    __this: *mut ACE_Auto_Array_Ptr_sockaddr_in_,
    __a0: *mut sockaddr_in,
) {
    ACE_Auto_Array_Ptr_sockaddr_in_::new_at_s50962462f357265e(__this, __a0)
}
extern "C-unwind" {
...
impl ACE_SOCK_SEQPACK_Association {
    ...
    pub unsafe fn get_local_addrs(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut addr_structs: ACE_Auto_Array_Ptr_sockaddr_in_ = ::core::mem::MaybeUninit::<
                    ACE_Auto_Array_Ptr_sockaddr_in_,
                >::zeroed()
                    .assume_init();
                <ACE_Auto_Array_Ptr_sockaddr_in_>::new_at_s50962462f357265e(
                    (::core::ptr::addr_of_mut!(addr_structs))
                        as *mut ACE_Auto_Array_Ptr_sockaddr_in_,
                    ((0) as *mut sockaddr_in),
                );
                {
                    let mut addr_structs_bootstrap: *mut sockaddr_in = ((0)
                        as *mut sockaddr_in);
                    'dowhile_0: loop {
                        'cont_0: loop {
                            {
                                {
                                    addr_structs_bootstrap = {
                                    ...
                                    if (((((addr_structs_bootstrap).is_null()) as libc::c_int)
                                        as libc::c_int) != 0)
                                    {
                                        ((*(__errno_location()))) = 12;
                                        return (-((1) as libc::c_int));
                    ...
                    <ACE_Auto_Basic_Array_Ptr_sockaddr_in_>::reset(
                        (::core::ptr::addr_of_mut!(
                            (* ::core::ptr::addr_of!((*
                            (::core::ptr::addr_of_mut!(addr_structs))).__base_0) .cast::
                            < ACE_Auto_Basic_Array_Ptr_sockaddr_in_ > ().cast_mut())
                        )) as *mut ACE_Auto_Basic_Array_Ptr_sockaddr_in_,
                        addr_structs_bootstrap,
                    );
                }
                let mut physical_size: libc::c_ulong = ((((((*size)) as libc::c_ulong))
                    .wrapping_mul((16) as libc::c_ulong)) as libc::c_ulong);
                ACE_OS::memset_u2b5dfc47d301370a(
                    ((<ACE_Auto_Basic_Array_Ptr_sockaddr_in_>::get(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((*
                            (::core::ptr::addr_of!(addr_structs))).__base_0) .cast:: <
                            ACE_Auto_Basic_Array_Ptr_sockaddr_in_ > ().cast_mut())
                        )) as *const ACE_Auto_Basic_Array_Ptr_sockaddr_in_,
                    )) as *mut libc::c_void),
                    0,
                    physical_size,
                );
                let mut name_size: libc::c_int = (physical_size as libc::c_int);
                if (((((ACE_OS::getsockname_ua0d322ba11951c19(
                    <ACE_IPC_SAP>::get_handle(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((*
                            ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                    ...
                    ::core::ptr::addr_of_mut!(name_size) as *mut libc::c_int,
                ...
                {
                    name_size = (((name_size) as libc::c_int)) / ((16) as libc::c_int);
                    name_size
                };
                (*size) = (name_size as libc::c_ulong);
                let mut addrlen: libc::c_int = (((16 as libc::c_int)) as libc::c_int);
                {
                    let mut i: libc::c_int = 0;
                    'for_1: loop {
                        if !((((((i as libc::c_int)) < (((name_size) as libc::c_int)))
                            as libc::c_int as libc::c_int) != 0))
                        {
                            break;
                        }
                            ...
                            {
                                {
                                    <ACE_INET_Addr>::set_addr(
                                        (::core::ptr::addr_of_mut!(
                                            (* (addrs).wrapping_offset((i) as isize))
                                        )) as *mut ACE_INET_Addr,
                                        ((((<ACE_Auto_Basic_Array_Ptr_sockaddr_in_>::operator_index(
                                            (::core::ptr::addr_of!(
                                                (* ::core::ptr::addr_of!((*
                                                (::core::ptr::addr_of!(addr_structs))).__base_0) .cast:: <
                                                ACE_Auto_Basic_Array_Ptr_sockaddr_in_ > ().cast_mut())
                                            ...
                                            i,
                                        ))) as *mut sockaddr_in) as *const libc::c_void),
                                        ((addrlen) as libc::c_int),
                                    );
                                    <ACE_Addr>::set_type(
                                        (::core::ptr::addr_of_mut!(
                                            (* ::core::ptr::addr_of!((* (::core::ptr::addr_of_mut!((*
                                            (addrs).wrapping_offset((i) as isize))))).__base_0) .cast::
                                            < ACE_Addr > ().cast_mut())
                                        )) as *mut ACE_Addr,
                                        (((*<ACE_Auto_Basic_Array_Ptr_sockaddr_in_>::operator_index(
                                            (::core::ptr::addr_of!(
  ...
  /// operation to reduce the domain-crossing penalty.*/
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return <ACE_SOCK>::close(
                    (::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((* __this)
                        .__base_0) .cast:: < ACE_SOCK_IO > ().cast_mut()).__base_0)
                        .cast:: < ACE_SOCK > ().cast_mut())
                    )) as *mut ACE_SOCK,
                );
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
    ...
    pub unsafe fn abort(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut slinger: linger = linger { l_onoff: 0, l_linger: 0 };
                slinger.l_onoff = 1;
                if ((((((-((1) as libc::c_int)) as libc::c_int))
                    == (((ACE_OS::setsockopt_u491187844361ffa3(
                        <ACE_IPC_SAP>::get_handle(
                            (::core::ptr::addr_of!(
                                (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((*
                                ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                        ...
                        1,
                        13,
                        (::core::ptr::addr_of_mut!(slinger) as *mut linger
                            as *const libc::c_char),
                        ((8) as libc::c_int),
                ...
                return <ACE_SOCK_SEQPACK_Association>::close(
                    (__this) as *mut ACE_SOCK_SEQPACK_Association,
                );
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
...
impl ACE_Auto_Array_Ptr_sockaddr_in_ {
    pub unsafe fn operator_arrow(__this: *const Self) -> *mut sockaddr_in {
        extern "C-unwind" {
            #[link_name = "_ZNK18ACE_Auto_Array_PtrI11sockaddr_inEptEv"]
            fn __ext(__this: *const ACE_Auto_Array_Ptr_sockaddr_in_) -> *mut sockaddr_in;
        }
        __ext(__this as *const ACE_Auto_Array_Ptr_sockaddr_in_)
    }
    pub unsafe fn new_at_s50962462f357265e(__this: *mut Self, mut p: *mut sockaddr_in) {
        unsafe {
            ::core::ptr::write(
                __this,
                ::core::mem::MaybeUninit::<Self>::zeroed().assume_init(),
            );
            <ACE_Auto_Basic_Array_Ptr_sockaddr_in_>::new_at_s5509e64012e39f5f(
                (::core::ptr::addr_of_mut!((* __this).__base_0)
                    .cast::<ACE_Auto_Basic_Array_Ptr_sockaddr_in_>())
                    as *mut ACE_Auto_Basic_Array_Ptr_sockaddr_in_,
                p,
            );
            {}
    ...
    pub unsafe fn new_s50962462f357265e(mut __a0: *mut sockaddr_in) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s50962462f357265e(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
}
impl ACE_Auto_Basic_Array_Ptr_sockaddr_in_ {
    pub unsafe fn new_at_sfa327829e1dc9b4e(
        __this: *mut Self,
        mut __a0: *mut ACE_Auto_Basic_Array_Ptr_sockaddr_in_,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN24ACE_Auto_Basic_Array_PtrI11sockaddr_inEC1ERS1_"]
            fn __ext(
                __this: *mut ACE_Auto_Basic_Array_Ptr_sockaddr_in_,
                __a0: *mut ACE_Auto_Basic_Array_Ptr_sockaddr_in_,
            );
        }
        __ext(__this as *mut ACE_Auto_Basic_Array_Ptr_sockaddr_in_, __a0)
    }
    pub unsafe fn new_sfa327829e1dc9b4e(
        mut __a0: *mut ACE_Auto_Basic_Array_Ptr_sockaddr_in_,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_sfa327829e1dc9b4e(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    pub unsafe fn operator_assign(
        __this: *mut Self,
        mut rhs: *mut ACE_Auto_Basic_Array_Ptr_sockaddr_in_,
    ) -> *mut ACE_Auto_Basic_Array_Ptr_sockaddr_in_ {
        extern "C-unwind" {
            #[link_name = "_ZN24ACE_Auto_Basic_Array_PtrI11sockaddr_inEaSERS1_"]
            fn __ext(
                __this: *mut ACE_Auto_Basic_Array_Ptr_sockaddr_in_,
                rhs: *mut ACE_Auto_Basic_Array_Ptr_sockaddr_in_,
            ) -> *mut ACE_Auto_Basic_Array_Ptr_sockaddr_in_;
        }
        __ext(__this as *mut ACE_Auto_Basic_Array_Ptr_sockaddr_in_, rhs)
    }
    pub unsafe fn operator_mul(__this: *const Self) -> *mut sockaddr_in {
        extern "C-unwind" {
            #[link_name = "_ZNK24ACE_Auto_Basic_Array_PtrI11sockaddr_inEdeEv"]
            fn __ext(
                __this: *const ACE_Auto_Basic_Array_Ptr_sockaddr_in_,
            ) -> *mut sockaddr_in;
        }
        __ext(__this as *const ACE_Auto_Basic_Array_Ptr_sockaddr_in_)
    }
    pub unsafe fn release(__this: *mut Self) -> *mut sockaddr_in {
        extern "C-unwind" {
            #[link_name = "_ZN24ACE_Auto_Basic_Array_PtrI11sockaddr_inE7releaseEv"]
            fn __ext(
                __this: *mut ACE_Auto_Basic_Array_Ptr_sockaddr_in_,
            ) -> *mut sockaddr_in;
        }
        __ext(__this as *mut ACE_Auto_Basic_Array_Ptr_sockaddr_in_)
    }
    ///Dump the state of an object.
    pub unsafe fn dump(__this: *const Self) {
        extern "C-unwind" {
            #[link_name = "_ZNK24ACE_Auto_Basic_Array_PtrI11sockaddr_inE4dumpEv"]
            fn __ext(__this: *const ACE_Auto_Basic_Array_Ptr_sockaddr_in_);
        }
        __ext(__this as *const ACE_Auto_Basic_Array_Ptr_sockaddr_in_)
    }
    pub unsafe fn new_at_s5509e64012e39f5f(__this: *mut Self, mut p: *mut sockaddr_in) {
        unsafe {
            ::core::ptr::write(
                __this,
                ::core::mem::MaybeUninit::<Self>::zeroed().assume_init(),
    ...
    pub unsafe fn new_s5509e64012e39f5f(mut __a0: *mut sockaddr_in) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s5509e64012e39f5f(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    pub unsafe fn get(__this: *const Self) -> *mut sockaddr_in {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((*__this).p_) as *mut sockaddr_in);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    pub unsafe fn reset(__this: *mut Self, mut p: *mut sockaddr_in) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((((<ACE_Auto_Basic_Array_Ptr_sockaddr_in_>::get(
                    (__this) as *const ACE_Auto_Basic_Array_Ptr_sockaddr_in_,
    ...
    pub unsafe fn operator_index(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut array: *mut sockaddr_in = <ACE_Auto_Basic_Array_Ptr_sockaddr_in_>::get(
                    (__this) as *const ACE_Auto_Basic_Array_Ptr_sockaddr_in_,
                );
                return ::core::ptr::addr_of_mut!(
                    (* (array).wrapping_offset((i) as isize))
                );
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
