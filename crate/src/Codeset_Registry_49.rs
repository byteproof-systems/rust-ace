...
extern "C" {
    #[allow(non_upper_case_globals)]
    pub static mut ACE_Codeset_Registry_num_registry_entries_: libc::c_ulong;
}
extern "C" {
    #[allow(non_upper_case_globals)]
    pub static mut ACE_Codeset_Registry_registry_db_: [registry_entry; 9usize];
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ACE_Codeset_Registry {}
#[export_name = "_ZN20ACE_Codeset_Registry20locale_to_registry_iERK15ACE_String_BaseIcERjPtPS5_"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Codeset_Registry20locale_to_registry_iERK15ACE_String_BaseIcERjPtPS5_(
    locale: *const ACE_String_Base_char_,
    codeset_id: *mut libc::c_uint,
    num_sets: *mut libc::c_ushort,
    char_sets: *mut *mut libc::c_ushort,
) -> libc::c_int {
    unsafe {
        ACE_Codeset_Registry::locale_to_registry_i(
            locale,
            codeset_id,
            num_sets,
            char_sets,
...
#[export_name = "_ZN20ACE_Codeset_Registry20registry_to_locale_iEjR15ACE_String_BaseIcEPtPS3_"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Codeset_Registry20registry_to_locale_iEjR15ACE_String_BaseIcEPtPS3_(
    codeset_id: libc::c_uint,
    locale: *mut ACE_String_Base_char_,
    num_sets: *mut libc::c_ushort,
    char_sets: *mut *mut libc::c_ushort,
) -> libc::c_int {
    unsafe {
        ACE_Codeset_Registry::registry_to_locale_i(
            codeset_id,
            locale,
            num_sets,
            char_sets,
...
#[export_name = "_ZN20ACE_Codeset_Registry15is_compatible_iEjj"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Codeset_Registry15is_compatible_iEjj(
    codeset_id: libc::c_uint,
    other: libc::c_uint,
) -> libc::c_int {
    unsafe { ACE_Codeset_Registry::is_compatible_i(codeset_id, other) }
}
#[export_name = "_ZN20ACE_Codeset_Registry15get_max_bytes_iEj"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Codeset_Registry15get_max_bytes_iEj(
    codeset_id: libc::c_uint,
) -> libc::c_short {
    unsafe { ACE_Codeset_Registry::get_max_bytes_i(codeset_id) }
}
extern "C-unwind" {
...
impl ACE_Codeset_Registry {
  ...
  /// collection. This wraps the dce_cs_loc_to_rgy function, or emulates it.*/
    pub unsafe fn locale_to_registry(
        mut locale: *const ACE_String_Base_char_,
        mut codeset_id: *mut libc::c_uint,
        mut num_sets: *mut libc::c_ushort,
        mut char_sets: *mut *mut libc::c_ushort,
    ) -> libc::c_int {
        unsafe {
            {
                return <ACE_Codeset_Registry>::locale_to_registry_i(
                    ::core::ptr::addr_of!((* locale)),
                    ::core::ptr::addr_of_mut!((* codeset_id)),
                    num_sets,
                    char_sets,
                );
            }
  ...
  /// collection.  This wraps the dce_cs_rgy_to_loc function, or emulates it.*/
    pub unsafe fn registry_to_locale(
        mut codeset_id: libc::c_uint,
        mut locale: *mut ACE_String_Base_char_,
        mut num_sets: *mut libc::c_ushort,
        mut char_sets: *mut *mut libc::c_ushort,
    ) -> libc::c_int {
        unsafe {
            {
                return <ACE_Codeset_Registry>::registry_to_locale_i(
                    codeset_id,
                    ::core::ptr::addr_of_mut!((* locale)),
                    num_sets,
                    char_sets,
                );
            }
  ...
  /// This wraps the rpc_rgy_get_max_bytes function.*/
    pub unsafe fn get_max_bytes(mut codeset_id: libc::c_uint) -> libc::c_short {
        unsafe {
            {
    ...
    pub unsafe fn locale_to_registry_i(
        mut locale: *const ACE_String_Base_char_,
        mut codeset_id: *mut libc::c_uint,
        mut num_sets: *mut libc::c_ushort,
        mut char_sets: *mut *mut libc::c_ushort,
        ...
        unsafe {
            {
                let mut element: *const registry_entry = ((0) as *const registry_entry);
                {
                    let mut i: libc::c_ulong = ((0) as libc::c_ulong);
                    'for_0: loop {
                        if !((((((((((element).is_null()) as libc::c_int) as libc::c_int)
                            != 0)
                            && (((((i as libc::c_ulong))
                                < (((ACE_Codeset_Registry_num_registry_entries_)
                        ...
                        'cont_0: loop {
                            {
                                if (((((ACE_OS::strcmp_u2f671283fc8b6d4a(
                                    (((ACE_Codeset_Registry_registry_db_)[(i) as usize]
                                        .loc_name_) as *const libc::c_char),
                                    ...
                                    as libc::c_int) != 0)
                                {
                                    element = ::core::ptr::addr_of!(
                                        (ACE_Codeset_Registry_registry_db_) [(i) as usize]
                                    ) as *const registry_entry;
                                }
                            }
                            #[allow(unreachable_code)] break 'cont_0;
                        }
                ...
                if (((((element).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    return 0;
                }
                (*codeset_id) = (((*element).codeset_id_) as libc::c_uint);
                if ((((!(num_sets).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    (*(num_sets)) = (((*element).num_sets_) as libc::c_ushort);
                }
                if ((((!(char_sets).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    'dowhile_1: loop {
                        'cont_1: loop {
                            {
                                {
                                    (*(char_sets)) = {
                                        let __count: usize = ((*element).num_sets_) as usize;
                                    ...
                                    if ((((((*(char_sets))).is_null()) as libc::c_int)
                                        as libc::c_int) != 0)
                                    {
                                        ((*(__errno_location()))) = 12;
                                        return 0;
                    ...
                    ACE_OS::memcpy_u6033eb81edaf9212(
                        (((*(char_sets))) as *mut libc::c_void),
                        (((*element).char_sets_).as_ptr() as *const libc::c_void),
                        ((((((*element).num_sets_) as libc::c_ulong))
    ...
    pub unsafe fn registry_to_locale_i(
        mut codeset_id: libc::c_uint,
        mut locale: *mut ACE_String_Base_char_,
        mut num_sets: *mut libc::c_ushort,
        mut char_sets: *mut *mut libc::c_ushort,
        ...
        unsafe {
            {
                let mut element: *const registry_entry = ((0) as *const registry_entry);
                {
                    ...
                    'for_0: loop {
                        ...
                        'cont_0: loop {
                            {
                                if (((((codeset_id as libc::c_uint))
                                    == ((((ACE_Codeset_Registry_registry_db_)[(i) as usize]
                                        .codeset_id_) as libc::c_uint))) as libc::c_int
                                    as libc::c_int) != 0)
                                {
                                    element = ::core::ptr::addr_of!(
                                        (ACE_Codeset_Registry_registry_db_) [(i) as usize]
                ...
                <ACE_String_Base_char_>::set_se0d2578f0f93d128(
                    ...
                    (((*element).loc_name_) as *const libc::c_char),
                    true,
                );
                if ((((!(num_sets).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    (*(num_sets)) = (((*element).num_sets_) as libc::c_ushort);
    ...
    pub unsafe fn is_compatible_i(
        mut codeset_id: libc::c_uint,
        mut other: libc::c_uint,
    ) -> libc::c_int {
        unsafe {
            {
                let mut lhs: *const registry_entry = ((0) as *const registry_entry);
                let mut rhs: *const registry_entry = ((0) as *const registry_entry);
                {
                    let mut i: libc::c_ulong = ((0) as libc::c_ulong);
                    'for_0: loop {
                        if !(((((((((((((((lhs).is_null()) as libc::c_int)
                            as libc::c_int) != 0)
                            || (((((rhs).is_null()) as libc::c_int) as libc::c_int)
                            ...
                            {
                                {
                                    if (((((codeset_id as libc::c_uint))
                                        ...
                                        as libc::c_int) != 0)
                                    {
                                        lhs = ::core::ptr::addr_of!(
                                            (ACE_Codeset_Registry_registry_db_) [(i) as usize]
                                        ) as *const registry_entry;
                                    }
                                    if (((((other as libc::c_uint))
                                        == ((((ACE_Codeset_Registry_registry_db_)[(i) as usize]
                                            .codeset_id_) as libc::c_uint))) as libc::c_int
                                        as libc::c_int) != 0)
                                    {
                                        rhs = ::core::ptr::addr_of!(
                                            (ACE_Codeset_Registry_registry_db_) [(i) as usize]
                                        ) as *const registry_entry;
                                    }
                                }
                ...
                if (((((((((lhs).is_null()) as libc::c_int) as libc::c_int) != 0)
                    || (((((rhs).is_null()) as libc::c_int) as libc::c_int) != 0))
                    as libc::c_int) as libc::c_int) != 0)
                {
                    return 0;
                }
                {
                    let mut l: libc::c_ushort = ((0) as libc::c_ushort);
                    'for_1: loop {
                        if !((((((l as libc::c_int as libc::c_ushort))
                            < ((((*lhs).num_sets_) as libc::c_int as libc::c_ushort)))
                            as libc::c_int as libc::c_int) != 0))
                        {
                            break;
                        }
                        'cont_1: loop {
                            {
                                {
                                    let mut r: libc::c_ushort = ((0) as libc::c_ushort);
                                    'for_2: loop {
                                        if !((((((r as libc::c_int as libc::c_ushort))
                                            < ((((*rhs).num_sets_) as libc::c_int as libc::c_ushort)))
                                            as libc::c_int as libc::c_int) != 0))
                                        {
                                            break;
                                        }
                                        'cont_2: loop {
                                            {
                                                if ((((((*((((*rhs).char_sets_).as_ptr()
                                                    as *mut libc::c_ushort)
                                                    .wrapping_offset((r) as isize))) as libc::c_int
                                                    as libc::c_ushort))
                                                    == ((((*((((*lhs).char_sets_).as_ptr()
                                                        as *mut libc::c_ushort)
                                                        .wrapping_offset((l) as isize)))) as libc::c_int
                                                        as libc::c_ushort))) as libc::c_int as libc::c_int) != 0)
                                                {
                                                    return 1;
                                                }
                                            }
    ...
    pub unsafe fn get_max_bytes_i(mut codeset_id: libc::c_uint) -> libc::c_short {
        unsafe {
            {
                {
                    let mut i: libc::c_ulong = ((0) as libc::c_ulong);
                        ...
                        'cont_0: loop {
                            {
                                if (((((codeset_id as libc::c_uint))
                                    ...
                                    as libc::c_int) != 0)
                                {
                                    return (((ACE_Codeset_Registry_registry_db_)[(i) as usize]
                                        .max_bytes_) as libc::c_short);
                                }
                            }
                            #[allow(unreachable_code)] break 'cont_0;
                        }
