...
#[export_name = "_ZN14ACE_Log_RecordC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Log_RecordC1Ev(
    __this: *mut ACE_Log_Record,
) {
    ACE_Log_Record::new_at(__this)
}
#[export_name = "_ZN14ACE_Log_RecordC1E16ACE_Log_Priorityll"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Log_RecordC1E16ACE_Log_Priorityll(
    __this: *mut ACE_Log_Record,
    __a0: libc::c_uint,
    __a1: libc::c_long,
    __a2: libc::c_long,
) {
    ACE_Log_Record::new_at_u7a41f48999333dc0(__this, __a0, __a1, __a2)
}
#[export_name = "_ZN14ACE_Log_RecordC1E16ACE_Log_PriorityRK14ACE_Time_Valuel"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Log_RecordC1E16ACE_Log_PriorityRK14ACE_Time_Valuel(
    __this: *mut ACE_Log_Record,
    __a0: libc::c_uint,
    __a1: *const ACE_Time_Value,
    __a2: libc::c_long,
) {
    ACE_Log_Record::new_at_u5a37408ef8ac50e7(__this, __a0, __a1, __a2)
}
...
#[export_name = "_ZN14ACE_Log_Record5printEPKcmP8_IO_FILE"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Log_Record5printEPKcmP8_IO_FILE(
    __this: *mut ACE_Log_Record,
    host_name: *const libc::c_char,
    verbose_flag: libc::c_ulong,
    fp: *mut _IO_FILE,
) -> libc::c_int {
    unsafe { ACE_Log_Record::print(__this, host_name, verbose_flag, fp) }
}
#[export_name = "_ZN14ACE_Log_Record5printEPKcmRSo"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Log_Record5printEPKcmRSo(
    __this: *mut ACE_Log_Record,
    host_name: *const libc::c_char,
    verbose_flag: libc::c_ulong,
    s: *mut crate::__cxx_std::Ostream,
) -> libc::c_int {
    unsafe {
        ACE_Log_Record::print_ufd36a7167f11a180(__this, host_name, verbose_flag, s)
    }
}
#[export_name = "_ZN14ACE_Log_Record10format_msgEPKcmPcm"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Log_Record10format_msgEPKcmPcm(
    __this: *mut ACE_Log_Record,
    host_name: *const libc::c_char,
    verbose_flag: libc::c_ulong,
...
#[export_name = "_ZN14ACE_Log_Record13priority_nameE16ACE_Log_Priority"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Log_Record13priority_nameE16ACE_Log_Priority(
    p: libc::c_uint,
) -> *const libc::c_char {
    unsafe { ACE_Log_Record::priority_name(p) }
}
#[export_name = "_ZN14ACE_Log_Record13priority_nameE16ACE_Log_PriorityPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Log_Record13priority_nameE16ACE_Log_PriorityPKc(
    p: libc::c_uint,
    name: *const libc::c_char,
) {
    unsafe { ACE_Log_Record::priority_name_uca8ae485b15eb414(p, name) }
}
#[export_name = "_ZNK14ACE_Log_Record8priorityEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK14ACE_Log_Record8priorityEv(
    __this: *const ACE_Log_Record,
) -> libc::c_ulong {
    unsafe { ACE_Log_Record::priority(__this) }
}
#[export_name = "_ZN14ACE_Log_Record8priorityEm"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Log_Record8priorityEm(
    __this: *mut ACE_Log_Record,
    p: libc::c_ulong,
) {
    unsafe { ACE_Log_Record::priority_ua8f07a45b6f49c7e(__this, p) }
}
#[export_name = "_ZN14ACE_Log_Record8msg_dataEPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Log_Record8msg_dataEPKc(
    __this: *mut ACE_Log_Record,
    data: *const libc::c_char,
) -> libc::c_int {
    unsafe { ACE_Log_Record::msg_data_u6c82741b0f816e66(__this, data) }
}
#[export_name = "_ZNK14ACE_Log_Record4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK14ACE_Log_Record4dumpEv(
    __this: *const ACE_Log_Record,
) {
    unsafe { ACE_Log_Record::dump(__this) }
}
#[export_name = "_ZN14ACE_Log_Record8round_upEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Log_Record8round_upEv(
    __this: *mut ACE_Log_Record,
) {
    unsafe { ACE_Log_Record::round_up(__this) }
}
...
#[export_name = "_ZrsR12ACE_InputCDRR14ACE_Log_Record"]
pub unsafe extern "C-unwind" fn operator_shr_u21390954517cc944(
    mut cdr: *mut ACE_InputCDR,
    mut log_record: *mut ACE_Log_Record,
) -> libc::c_int {
    unsafe {
        {
            let mut r#type: libc::c_int = unsafe { ::core::mem::zeroed() };
            let mut pid: libc::c_int = unsafe { ::core::mem::zeroed() };
            let mut sec: libc::c_long = unsafe { ::core::mem::zeroed() };
            let mut usec: libc::c_int = unsafe { ::core::mem::zeroed() };
            let mut buffer_len: libc::c_uint = unsafe { ::core::mem::zeroed() };
            if (((((((((((((((((((operator_shr_u9b4c92d8d799b9de(
                ::core::ptr::addr_of_mut!((* cdr)),
                ::core::ptr::addr_of_mut!(r#type),
            )) as libc::c_int) != 0)
                && (((operator_shr_u9b4c92d8d799b9de(
                    ::core::ptr::addr_of_mut!((* cdr)),
                    ::core::ptr::addr_of_mut!(pid),
                )) as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
                && (((operator_shr_u9b5682d8d7a1f333(
                    ::core::ptr::addr_of_mut!((* cdr)),
                    ::core::ptr::addr_of_mut!(sec),
                )) as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
                && (((operator_shr_u9b4c92d8d799b9de(
                    ::core::ptr::addr_of_mut!((* cdr)),
                    ::core::ptr::addr_of_mut!(usec),
                )) as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
                && (((operator_shr_u9bb912d8d7f5b23e(
                    ::core::ptr::addr_of_mut!((* cdr)),
                    ::core::ptr::addr_of_mut!(buffer_len),
                )) as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
            {
                let mut log_msg: *mut libc::c_char = unsafe { ::core::mem::zeroed() };
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            {
                                log_msg = {
                                    let __count: usize = ((((buffer_len) as libc::c_uint))
                                ...
                                if (((((log_msg).is_null()) as libc::c_int) as libc::c_int)
                                    != 0)
                                {
                                    ((*(__errno_location()))) = 12;
                ...
                let mut log_msg_p: ACE_Auto_Basic_Array_Ptr_char_ = ::core::mem::MaybeUninit::<
                    ACE_Auto_Basic_Array_Ptr_char_,
                >::zeroed()
                    .assume_init();
                <ACE_Auto_Basic_Array_Ptr_char_>::new_at_s532c2c2e97370d04(
                    (::core::ptr::addr_of_mut!(log_msg_p))
                        as *mut ACE_Auto_Basic_Array_Ptr_char_,
                    ((log_msg) as *mut libc::c_char),
                );
                <ACE_Log_Record>::type_u77bb4f12aefc84b7(
                    (::core::ptr::addr_of_mut!((* log_record))) as *mut ACE_Log_Record,
                    ((r#type) as libc::c_uint),
                );
                <ACE_Log_Record>::pid_ud5567264d4dd1d7d(
                    (::core::ptr::addr_of_mut!((* log_record))) as *mut ACE_Log_Record,
                    ((pid) as libc::c_long),
                );
                <ACE_Log_Record>::time_stamp_uad72df21fab83cfe(
                    (::core::ptr::addr_of_mut!((* log_record))) as *mut ACE_Log_Record,
                    &(<ACE_Time_Value>::new_ub59bcc88eaedf2a6(
                        ((ACE_Utils::truncate_cast___long_(((sec) as libc::c_long)))
                            as libc::c_long),
                        ((usec) as libc::c_long),
                ...
                (*(log_msg).wrapping_offset((buffer_len) as isize)) = ((0
                    as libc::c_char) as libc::c_char);
                if ((((((-((1) as libc::c_int)) as libc::c_int))
                    == (((<ACE_Log_Record>::msg_data_u6c82741b0f816e66(
                        (::core::ptr::addr_of_mut!((* log_record)))
                            as *mut ACE_Log_Record,
                        ((log_msg) as *const libc::c_char),
                    )) as libc::c_int))) as libc::c_int as libc::c_int) != 0)
                {
                    return (-((1) as libc::c_int));
                }
            }
            return ((<ACE_InputCDR>::good_bit(
                (::core::ptr::addr_of!((* cdr))) as *const ACE_InputCDR,
            )) as libc::c_int);
        }
        #[allow(unreachable_code)] { ::core::unreachable!() }
    }
}
#[export_name = "_ZlsR13ACE_OutputCDRRK14ACE_Log_Record"]
pub unsafe extern "C-unwind" fn operator_shl_ub3e53c4872f84b62(
    mut cdr: *mut ACE_OutputCDR,
    mut log_record: *const ACE_Log_Record,
) -> libc::c_int {
    unsafe {
        {
            let mut u_msglen: libc::c_uint = ((ACE_Utils::truncate_cast___unsigned_long__ue27a31e3ddf7f306(
                ((<ACE_Log_Record>::msg_data_len(
                    (::core::ptr::addr_of!((* log_record))) as *const ACE_Log_Record,
                )) as libc::c_ulong),
            )) as libc::c_uint);
            operator_shl_u716cb651458f4c0d(
                ::core::ptr::addr_of_mut!((* cdr)),
                (<ACE_Log_Record>::r#type(
                    (::core::ptr::addr_of!((* log_record))) as *const ACE_Log_Record,
                ) as libc::c_int),
            );
            operator_shl_u716cb651458f4c0d(
            ...
            operator_shl_u71627e5145869860(
                ::core::ptr::addr_of_mut!((* cdr)),
                (<ACE_Time_Value>::sec(
                    (((&(<ACE_Log_Record>::time_stamp(
                        (::core::ptr::addr_of!((* log_record))) as *const ACE_Log_Record,
                    ))) as *const ACE_Time_Value)) as *const ACE_Time_Value,
                ) as libc::c_long),
            );
            operator_shl_u716cb651458f4c0d(
                ::core::ptr::addr_of_mut!((* cdr)),
            ...
            operator_shl_u70ffb65145327a2d(::core::ptr::addr_of_mut!((* cdr)), u_msglen);
            <ACE_OutputCDR>::write_char_array(
                (::core::ptr::addr_of_mut!((* cdr))) as *mut ACE_OutputCDR,
                ((<ACE_Log_Record>::msg_data(
                    (::core::ptr::addr_of!((* log_record))) as *const ACE_Log_Record,
                )) as *const libc::c_char),
                u_msglen,
            );
            return ((<ACE_OutputCDR>::good_bit(
                (::core::ptr::addr_of!((* cdr))) as *const ACE_OutputCDR,
            )) as libc::c_int);
        }
        #[allow(unreachable_code)] { ::core::unreachable!() }
    }
...
pub mod ACE_Utils {
    ...
    pub type truncator_727 = Truncator_unsigned_long__unsigned_int_;
    pub use crate::CDR_Size_38::ACE_Utils::truncate_cast___unsigned_long__ue27a31e3ddf7f306;
    pub type truncator_728 = Truncator_long__long_;
...
pub mod __anon_ns_15241 {
    pub(crate) static mut ace_priority_names: [*const libc::c_char; 32usize] = [
        b"LM_SHUTDOWN\0".as_ptr() as *const libc::c_char,
        b"LM_TRACE\0".as_ptr() as *const libc::c_char,
        b"LM_DEBUG\0".as_ptr() as *const libc::c_char,
        b"LM_INFO\0".as_ptr() as *const libc::c_char,
        b"LM_NOTICE\0".as_ptr() as *const libc::c_char,
        b"LM_WARNING\0".as_ptr() as *const libc::c_char,
        b"LM_STARTUP\0".as_ptr() as *const libc::c_char,
        b"LM_ERROR\0".as_ptr() as *const libc::c_char,
        b"LM_CRITICAL\0".as_ptr() as *const libc::c_char,
        b"LM_ALERT\0".as_ptr() as *const libc::c_char,
        b"LM_EMERGENCY\0".as_ptr() as *const libc::c_char,
        b"LM_UNK(04000)\0".as_ptr() as *const libc::c_char,
        b"LM_UNK(010000)\0".as_ptr() as *const libc::c_char,
        b"LM_UNK(020000)\0".as_ptr() as *const libc::c_char,
        b"LM_UNK(040000)\0".as_ptr() as *const libc::c_char,
        b"LM_UNK(0100000)\0".as_ptr() as *const libc::c_char,
        b"LM_UNK(0200000)\0".as_ptr() as *const libc::c_char,
        b"LM_UNK(0400000)\0".as_ptr() as *const libc::c_char,
        b"LM_UNK(01000000)\0".as_ptr() as *const libc::c_char,
        b"LM_UNK(02000000)\0".as_ptr() as *const libc::c_char,
        b"LM_UNK(04000000)\0".as_ptr() as *const libc::c_char,
        b"LM_UNK(010000000)\0".as_ptr() as *const libc::c_char,
        b"LM_UNK(020000000)\0".as_ptr() as *const libc::c_char,
        b"LM_UNK(040000000)\0".as_ptr() as *const libc::c_char,
        b"LM_UNK(0100000000)\0".as_ptr() as *const libc::c_char,
        b"LM_UNK(0200000000)\0".as_ptr() as *const libc::c_char,
        b"LM_UNK(0400000000)\0".as_ptr() as *const libc::c_char,
        b"LM_UNK(01000000000)\0".as_ptr() as *const libc::c_char,
        b"LM_UNK(02000000000)\0".as_ptr() as *const libc::c_char,
        b"LM_UNK(04000000000)\0".as_ptr() as *const libc::c_char,
        b"LM_UNK(010000000000)\0".as_ptr() as *const libc::c_char,
        b"LM_UNK(020000000000)\0".as_ptr() as *const libc::c_char,
    ];
}
#[export_name = "_Z20log_priority_enabledP20ACE_Log_Category_TSS16ACE_Log_Priority"]
pub unsafe extern "C-unwind" fn log_priority_enabled(
    ...
    unsafe {
        {
            if (((((!(category).is_null())
                && (((!(((<ACE_Log_Category_TSS>::log_priority_enabled(
                    (category) as *mut ACE_Log_Category_TSS,
                    priority,
                )) != 0)) as libc::c_int) as libc::c_int) != 0)) as libc::c_int)
                as libc::c_int) != 0)
            {
            ...
            return crate::__cxx_std::__Truthy::__truthy(
                ((<ACE_Log_Msg>::log_priority_enabled(
                    (<ACE_Log_Msg>::instance()) as *mut ACE_Log_Msg,
                    priority,
                )) != 0),
            );
        }
...
impl ACE_Log_Record {
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).length_),
                ((0) as libc::c_int),
            );
            ::core::ptr::write(
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).secs_),
                ((0) as libc::c_long),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).usecs_),
                ((0) as libc::c_uint),
            );
            ::core::ptr::write(
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).msg_data_),
                ((0) as *mut libc::c_char),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).msg_data_size_),
                ((0) as libc::c_ulong),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).category_),
                ((0) as *mut ACE_Log_Category_TSS),
            );
            {
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            {
                                (*__this).msg_data_ = {
                                    let __count: usize = ((4097 as libc::c_int)) as usize;
                                    let __nbytes = __count
                                        .checked_mul(::core::mem::size_of::<libc::c_char>())
                                        .expect("array new[] size overflow");
                                    let __data = ::libc::malloc(
                                ...
                                if ((((((*__this).msg_data_).is_null()) as libc::c_int)
                                    as libc::c_int) != 0)
                                {
                                    ((*(__errno_location()))) = 12;
                                }
                ...
                if ((((!((*__this).msg_data_).is_null()) as libc::c_int) as libc::c_int)
                    != 0)
                {
                    (*__this).msg_data_size_ = (((4097 as libc::c_int))
                        as libc::c_ulong);
                    (*((*__this).msg_data_).wrapping_offset((0) as isize)) = ((0
                        as libc::c_char) as libc::c_char);
                }
            }
            ()
    ...
    pub unsafe fn new_at_u7a41f48999333dc0(
        ...
        unsafe {
            ...
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).secs_), ts_sec);
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).usecs_),
                ((0) as libc::c_uint),
            );
  ...
  /// FILE if the corresponding type is enabled.*/
    pub unsafe fn print(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((log_priority_enabled(
                    <ACE_Log_Record>::category((__this) as *const ACE_Log_Record),
                    ((*__this).type_ as libc::c_uint),
                ) as libc::c_int) != 0)
                {
                    let mut verbose_msg: *mut libc::c_char = ((0) as *mut libc::c_char);
                    'dowhile_0: loop {
                        'cont_0: loop {
                            {
                                {
                                    verbose_msg = {
                                        let __count: usize = ((4225 as libc::c_int)) as usize;
                                        let __nbytes = __count
                                            .checked_mul(::core::mem::size_of::<libc::c_char>())
                                            .expect("array new[] size overflow");
                                        let __data = ::libc::malloc(
                                    ...
                                    if (((((verbose_msg).is_null()) as libc::c_int)
                                        as libc::c_int) != 0)
                                    {
                                        ((*(__errno_location()))) = 12;
                                        return (-((1) as libc::c_int));
                    ...
                    let mut result: libc::c_int = <ACE_Log_Record>::format_msg(
                        (__this) as *mut ACE_Log_Record,
                        ((host_name) as *const libc::c_char),
                        verbose_flag,
                        verbose_msg,
                        (((4225 as libc::c_int)) as libc::c_ulong),
                    );
                    if (((((result as libc::c_int)) == (((0) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        if ((((!(fp).is_null()) as libc::c_int) as libc::c_int) != 0) {
                            let mut verbose_msg_len: libc::c_int = (((ACE_OS::strlen_u07dd12a225364fa6(
                                ((verbose_msg) as *const libc::c_char),
                            ) as libc::c_int)) as libc::c_int);
                            let mut fwrite_result: libc::c_int = ((ACE_OS::fprintf_u7a83295f0e5d324f(
                                fp,
                                ((b"%s\0".as_ptr() as *const libc::c_char)
                                    as *const libc::c_char),
                                verbose_msg,
                            )) as libc::c_int);
                            if (((((fwrite_result as libc::c_int))
                                != (((verbose_msg_len) as libc::c_int))) as libc::c_int
                                as libc::c_int) != 0)
                            {
                                result = (-((1) as libc::c_int));
                            } else {
                                ACE_OS::fflush_ub53d4035e1b86ad5(fp);
                            }
                        }
                    }
                    {
                        let __data = verbose_msg as *mut libc::c_char;
                        if !__data.is_null() {
                            ::libc::free(__data as *mut libc::c_void);
                        }
                    };
  ...
  /// @a stream if the corresponding type is enabled.*/
    pub unsafe fn print_ufd36a7167f11a180(
        ...
        mut host_name: *const libc::c_char,
        mut verbose_flag: libc::c_ulong,
        mut s: *mut crate::__cxx_std::Ostream,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                ) as libc::c_int) != 0)
                {
                    ...
                    if (((((result as libc::c_int)) == (((0) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        ((*s)).put_cstr((verbose_msg) as *const libc::c_char);
                        ((*s)).flush();
                    }
                    {
                        let __data = verbose_msg as *mut libc::c_char;
    ...
    pub unsafe fn format_msg(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut timestamp: [libc::c_char; 27usize] = unsafe {
                    ::core::mem::zeroed()
                };
                if (((((((((((((((verbose_flag)) as libc::c_ulong))
                    & ((((16 as libc::c_int))) as libc::c_ulong)) as libc::c_ulong))
                    != (((0) as libc::c_ulong))) as libc::c_int) as libc::c_int) != 0)
                    || (((((((((((verbose_flag)) as libc::c_ulong))
                        & ((((32 as libc::c_int))) as libc::c_ulong)) as libc::c_ulong))
                        != (((0) as libc::c_ulong))) as libc::c_int) as libc::c_int)
                        != 0)) as libc::c_int) as libc::c_int) != 0)
                {
                    let mut reftime: ACE_Time_Value = ::core::mem::MaybeUninit::<
                        ACE_Time_Value,
                    >::zeroed()
                        .assume_init();
                    <ACE_Time_Value>::new_at_ub59bcc88eaedf2a6(
                        (::core::ptr::addr_of_mut!(reftime)) as *mut ACE_Time_Value,
                        (*__this).secs_,
                        (((*__this).usecs_) as libc::c_long),
                    );
                    if (((((ACE::timestamp(
                        ::core::ptr::addr_of!(reftime),
                        ((timestamp).as_mut_ptr() as *mut libc::c_char),
                        (((((::core::mem::size_of::<[libc::c_char; 27usize]>()
                            as libc::c_ulong) as libc::c_ulong))
                    ...
                    (timestamp)[(23) as usize] = ((0 as libc::c_char) as libc::c_char);
                }
                if (((((((((((verbose_flag)) as libc::c_ulong))
                    & ((((16 as libc::c_int))) as libc::c_ulong)) as libc::c_ulong))
                    != (((0) as libc::c_ulong))) as libc::c_int) as libc::c_int) != 0)
                {
                    let mut lhost_name: *const libc::c_char = (((if ((((((host_name)
                        .is_null()) as libc::c_int)) as libc::c_int) != 0)
                    {
                        b"<local_host>\0".as_ptr() as *const libc::c_char
                    } else {
                        host_name
                    })) as *const libc::c_char);
                    ACE_OS::snprintf_u9a28649a3b771eeb(
                        ((verbose_msg) as *mut libc::c_char),
                        verbose_msg_size,
                        ((b"%s@%s@%u@%s@%s\0".as_ptr() as *const libc::c_char)
                            as *const libc::c_char),
                        ((timestamp).as_mut_ptr() as *mut libc::c_char),
                        lhost_name,
                        (*__this).pid_,
                        ...
                        != 0)
                    {
                        ACE_OS::snprintf_u9a28649a3b771eeb(
                            ((verbose_msg) as *mut libc::c_char),
                            verbose_msg_size,
                            ((b"%s@%s@%s\0".as_ptr() as *const libc::c_char)
                                as *const libc::c_char),
                            ((timestamp).as_mut_ptr() as *mut libc::c_char),
                            <ACE_Log_Record>::priority_name(
                                ((*__this).type_ as libc::c_uint),
    ...
    pub unsafe fn priority_name(mut p: libc::c_uint) -> *const libc::c_char {
        unsafe {
            {
                return (__anon_ns_15241::ace_priority_names)[(ACE::log2_ua1e99811554d7513(
                    ((p) as libc::c_ulong),
                )) as usize];
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
    ...
    pub unsafe fn priority_name_uca8ae485b15eb414(
        ...
        unsafe {
            {
                (__anon_ns_15241::ace_priority_names)[(ACE::log2_ua1e99811554d7513(
                    ((p) as libc::c_ulong),
                )) as usize] = name;
            }
            ()
    ...
    pub unsafe fn priority(__this: *const Self) -> libc::c_ulong {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return ACE::log2_ua1e99811554d7513(((*__this).type_ as libc::c_ulong));
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
  ...
  /// power of 2, as defined by the enums in ACE_Log_Priority).*/
    pub unsafe fn priority_ua8f07a45b6f49c7e(__this: *mut Self, mut p: libc::c_ulong) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                (*__this).type_ = (p as libc::c_uint);
            }
            ()
        }
    }
  ...
  /// fit. If such a reallocation faisl, this method returns -1, else 0.*/
    pub unsafe fn msg_data_u6c82741b0f816e66(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut newlen: libc::c_ulong = (((((ACE_OS::strlen_u07dd12a225364fa6(
                    ((data) as *const libc::c_char),
                )) as libc::c_ulong))
                    .wrapping_add((1) as libc::c_ulong)) as libc::c_ulong);
                if (((((newlen as libc::c_ulong))
                    > ((((*__this).msg_data_size_) as libc::c_ulong))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    (*__this).msg_data_size_ = ((0) as libc::c_ulong);
                    {
                        let __data = (*__this).msg_data_ as *mut libc::c_char;
                        if !__data.is_null() {
                            ::libc::free(__data as *mut libc::c_void);
                        ...
                        'cont_0: loop {
                            {
                                {
                                    (*__this).msg_data_ = {
                                        let __count: usize = (newlen) as usize;
                                        let __nbytes = __count
                                            .checked_mul(::core::mem::size_of::<libc::c_char>())
                                            .expect("array new[] size overflow");
                                        let __data = ::libc::malloc(
                    ...
                    (*__this).msg_data_size_ = ((newlen) as libc::c_ulong);
                }
                ACE_OS::strcpy_u08e8184bcebbac89(
                    (((*__this).msg_data_) as *mut libc::c_char),
                    ((data) as *const libc::c_char),
                );
                <ACE_Log_Record>::round_up((__this) as *mut ACE_Log_Record);
                return 0;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    ...
    pub unsafe fn round_up(__this: *mut Self) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                (*__this).length_ = (((len as libc::c_uint)) as libc::c_int);
            }
            ()
        }
    }
