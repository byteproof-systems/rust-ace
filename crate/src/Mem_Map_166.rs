...
#[export_name = "_ZN11ACE_Mem_MapC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_Mem_MapC1Ev(__this: *mut ACE_Mem_Map) {
    ACE_Mem_Map::new_at(__this)
}
#[export_name = "_ZN11ACE_Mem_MapC1EimiiPvli"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_Mem_MapC1EimiiPvli(
...
#[export_name = "_ZN11ACE_Mem_MapC1EPKcmijiiPvli"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_Mem_MapC1EPKcmijiiPvli(
    __this: *mut ACE_Mem_Map,
...
#[export_name = "_ZN11ACE_Mem_Map3mapEPKcmijiiPvli"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_Mem_Map3mapEPKcmijiiPvli(
    __this: *mut ACE_Mem_Map,
    ...
    unsafe {
        ACE_Mem_Map::map_uf8d94af3fe7dec57(
            __this,
            file_name,
            len,
            flags,
...
impl Drop for ACE_Mem_Map {
    fn drop(&mut self) {
        unsafe {
            ...
            {
                <ACE_Mem_Map>::close((__this) as *mut ACE_Mem_Map);
            }
            ()
        }
    }
}
#[export_name = "__acedtor_ue12ccc626227af79"]
pub unsafe extern "C-unwind" fn __acedtor_ue12ccc626227af79(__this: *mut ACE_Mem_Map) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
    }
}
#[export_name = "_ZN11ACE_Mem_Map4openEPKciji"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_Mem_Map4openEPKciji(
    __this: *mut ACE_Mem_Map,
    file_name: *const libc::c_char,
    flags: libc::c_int,
    perms: libc::c_uint,
    ...
    unsafe { ACE_Mem_Map::open(__this, file_name, flags, perms, sa) }
}
#[export_name = "_ZN11ACE_Mem_Map5closeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_Mem_Map5closeEv(
    __this: *mut ACE_Mem_Map,
) -> libc::c_int {
    unsafe { ACE_Mem_Map::close(__this) }
}
#[export_name = "_ZN11ACE_Mem_Map6removeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_Mem_Map6removeEv(
    __this: *mut ACE_Mem_Map,
) -> libc::c_int {
    unsafe { ACE_Mem_Map::remove(__this) }
}
#[export_name = "_ZNK11ACE_Mem_Map4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK11ACE_Mem_Map4dumpEv(
    __this: *const ACE_Mem_Map,
) {
    unsafe { ACE_Mem_Map::dump(__this) }
}
#[export_name = "_ZN11ACE_Mem_Map6map_itEimiiPvli"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_Mem_Map6map_itEimiiPvli(
    __this: *mut ACE_Mem_Map,
    handle: libc::c_int,
    length_request: libc::c_ulong,
    prot: libc::c_int,
    share: libc::c_int,
    addr: *mut libc::c_void,
    offset: libc::c_long,
...
impl ACE_Mem_Map {
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).file_mapping_),
                (((-((1) as libc::c_int))) as libc::c_int),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).close_handle_),
                false,
            );
            {
                ACE_OS::memset_u2b5dfc47d301370a(
                    (((*__this).filename_).as_mut_ptr() as *mut libc::c_void),
                    0,
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/Mem_Map.cpp\0".as_ptr()
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        b"ACE_Mem_Map::ACE_Mem_Map\0".as_ptr()
                                            as *const libc::c_char,
                                    );
                                }
                            }
  ...
  /// will lookup the length of the file if it is not given.*/
    ...
    pub unsafe fn map_uf8d94af3fe7dec57(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                (*__this).length_ = ((0) as libc::c_ulong);
                if (((((<ACE_Mem_Map>::open(
                    (__this) as *mut ACE_Mem_Map,
                    file_name,
                    flags,
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                (*__this).handle_ = ACE_OS::open_u20e73ad42bc94ee0(
                    ((file_name) as *const libc::c_char),
                    flags,
                    perms,
                    sa,
                );
    ...
    pub unsafe fn close(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                return <ACE_Mem_Map>::close_handle((__this) as *mut ACE_Mem_Map);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
  ...
  /// starting at @a addr up to @a len bytes.*/
    ...
    pub unsafe fn remove(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ACE_OS::ftruncate_uc81bc2f492b8838e(
                    (*__this).handle_,
                    ((0) as libc::c_long),
                );
                <ACE_Mem_Map>::close((__this) as *mut ACE_Mem_Map);
                if ((((((*((((*__this).filename_).as_ptr() as *mut libc::c_char)
  ...
  /// the file into memory.*/
    pub unsafe fn map_it(
        __this: *mut Self,
        mut handle: libc::c_int,
        mut length_request: libc::c_ulong,
        mut prot: libc::c_int,
        mut share: libc::c_int,
        mut addr: *mut libc::c_void,
        mut offset: libc::c_long,
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                    ...
                    as libc::c_int) != 0)
                {
                    ...
                    if (((((((((current_file_type.st_mode) as libc::c_uint))
                        & ((61440) as libc::c_uint)) as libc::c_uint))
                        == (((8192) as libc::c_uint))) as libc::c_int as libc::c_int)
                        != 0)
                    {
                        (*__this).length_ = length_request;
                    } else {
                        if (((((((((current_file_type.st_mode) as libc::c_uint))
                            & ((61440) as libc::c_uint)) as libc::c_uint))
                            == (((32768) as libc::c_uint))) as libc::c_int
                            as libc::c_int) != 0)
                        {
                            let mut current_file_length: libc::c_long = ((ACE_OS::filesize_uc42c876f8a2ca43a(
                                (*__this).handle_,
                            )) as libc::c_long);
                            let mut extend_backing_store: bool = false;
                            let mut requested_file_length: libc::c_long = ((0)
                                as libc::c_long);
                            if (((((length_request as libc::c_ulong))
                                == (((((-((1) as libc::c_int)) as libc::c_ulong))
                                    as libc::c_ulong))) as libc::c_int as libc::c_int) != 0)
                            {
                                (*__this).length_ = ((ACE_Utils::truncate_cast___long__ub591475ebc843689(
                                    (((((current_file_length) as libc::c_long))
                                        .wrapping_sub((offset) as libc::c_long)) as libc::c_long),
                                )) as libc::c_ulong);
                            } else {
                                if (((((((((length_request as libc::c_ulong))
                                    as libc::c_ulong))
                                    .wrapping_add(((offset as libc::c_ulong)) as libc::c_ulong)
                                    as libc::c_ulong))
                                    > ((((<ACE_Numeric_Limits_long_>::max() as libc::c_ulong))
                                        as libc::c_ulong))) as libc::c_int as libc::c_int) != 0)
                                {
                                    return (-((1) as libc::c_int));
                                }
                                requested_file_length = ((((length_request as libc::c_long))
                                    as libc::c_long))
                                    .wrapping_add((offset) as libc::c_long);
                                if (((((requested_file_length as libc::c_long))
                                    > (((current_file_length) as libc::c_long))) as libc::c_int
                                    as libc::c_int) != 0)
                                {
                            ...
                            if ((extend_backing_store as libc::c_int) != 0) {
                                let mut null_byte_position: libc::c_long = ((0)
                                    as libc::c_long);
                                if (((((requested_file_length as libc::c_long))
                                    > (((0) as libc::c_long))) as libc::c_int as libc::c_int)
                                    != 0)
                                {
                                    null_byte_position = (((requested_file_length)
                                        as libc::c_long))
                ...
                (*__this).base_addr_ = ACE_OS::mmap_uf18c0366a1aaeae8(
                    (*__this).base_addr_,
                    (*__this).length_,
                    prot,
                    share,
                ...
                return if (((((((*__this).base_addr_) as *const u8))
                    == ((((((-((1) as libc::c_int)) as *mut libc::c_void)))
                        as *const u8))) as libc::c_int as libc::c_int) != 0)
                {
                    (-((1) as libc::c_int))
