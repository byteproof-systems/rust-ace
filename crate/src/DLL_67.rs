...
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_String_BaseIcE10fast_clearEv(
    __this: *mut ACE_String_Base_char_,
) {
    unsafe { ACE_String_Base_char_::fast_clear(__this) }
}
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_String_BaseIcE5clearEb(
    __this: *mut ACE_String_Base_char_,
    release: bool,
) {
    unsafe { ACE_String_Base_char_::clear(__this, release) }
}
...
extern "C" {
    #[allow(non_upper_case_globals)]
    pub static mut ACE_DLL_Handle_open_called_: libc::c_int;
}
...
impl Drop for ACE_DLL_Handle {
    fn drop(&mut self) {
        unsafe {
            extern "C-unwind" {
                #[link_name = "__acedtor_u4ff1f377bddceba8"]
                fn __ext(__this: *mut ACE_DLL_Handle);
            }
            __ext(self as *mut Self);
        }
    }
...
pub struct ACE_DLL {
    ...
    pub error_: bool,
    pub errmsg_: ::core::mem::ManuallyDrop<ACE_String_Base_char_>,
}
impl Clone for ACE_DLL {
    #[inline]
    fn clone(&self) -> Self {
        unsafe { Self::new_uee3c603b69ee15fa(self as *const Self) }
    }
}
#[export_name = "_ZN7ACE_DLLC1Eb"]
pub unsafe extern "C-unwind" fn __xtu__ZN7ACE_DLLC1Eb(__this: *mut ACE_DLL, __a0: bool) {
    ACE_DLL::new_at(__this, __a0)
}
#[export_name = "_ZN7ACE_DLLaSERKS_"]
pub unsafe extern "C-unwind" fn __xtu__ZN7ACE_DLLaSERKS_(
    __this: *mut ACE_DLL,
    rhs: *const ACE_DLL,
) -> *mut ACE_DLL {
    unsafe { ACE_DLL::operator_assign(__this, rhs) }
}
#[export_name = "_ZN7ACE_DLLC1EPKcib"]
pub unsafe extern "C-unwind" fn __xtu__ZN7ACE_DLLC1EPKcib(
    __this: *mut ACE_DLL,
    __a0: *const libc::c_char,
    __a1: libc::c_int,
    __a2: bool,
) {
    ACE_DLL::new_at_u08b225859092d161(__this, __a0, __a1, __a2)
}
#[export_name = "_ZN7ACE_DLLC1ERKS_"]
pub unsafe extern "C-unwind" fn __xtu__ZN7ACE_DLLC1ERKS_(
    __this: *mut ACE_DLL,
    __a0: *const ACE_DLL,
) {
    ACE_DLL::new_at_uee3c603b69ee15fa(__this, __a0)
}
#[export_name = "_ZN7ACE_DLL4openEPKcib"]
pub unsafe extern "C-unwind" fn __xtu__ZN7ACE_DLL4openEPKcib(
    __this: *mut ACE_DLL,
    dll_filename: *const libc::c_char,
    open_mode: libc::c_int,
    close_handle_on_destruction: bool,
) -> libc::c_int {
    unsafe {
        ACE_DLL::open(__this, dll_filename, open_mode, close_handle_on_destruction)
    }
}
#[export_name = "_ZN7ACE_DLL5closeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN7ACE_DLL5closeEv(
    __this: *mut ACE_DLL,
) -> libc::c_int {
    unsafe { ACE_DLL::close(__this) }
}
    ...
    fn drop(&mut self) {
        {
            unsafe {
                let __this: *mut Self = self as *mut Self;
                {
                    <ACE_DLL>::close((__this) as *mut ACE_DLL);
                    {
        ...
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.errmsg_);
        }
    }
}
#[export_name = "__acedtor_u72326742edf4fc95"]
pub unsafe extern "C-unwind" fn __acedtor_u72326742edf4fc95(__this: *mut ACE_DLL) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
    }
}
#[export_name = "_ZN7ACE_DLL6symbolEPKci"]
pub unsafe extern "C-unwind" fn __xtu__ZN7ACE_DLL6symbolEPKci(
    __this: *mut ACE_DLL,
    sym_name: *const libc::c_char,
    ignore_errors: libc::c_int,
) -> *mut libc::c_void {
    unsafe { ACE_DLL::symbol(__this, sym_name, ignore_errors) }
}
#[export_name = "_ZNK7ACE_DLL5errorEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK7ACE_DLL5errorEv(
    __this: *const ACE_DLL,
) -> *mut libc::c_char {
    unsafe { ACE_DLL::error(__this) }
}
#[export_name = "_ZNK7ACE_DLL10get_handleEb"]
pub unsafe extern "C-unwind" fn __xtu__ZNK7ACE_DLL10get_handleEb(
    __this: *const ACE_DLL,
    become_owner: bool,
) -> *mut libc::c_void {
    unsafe { ACE_DLL::get_handle(__this, become_owner) }
}
#[export_name = "_ZN7ACE_DLL10set_handleEPvb"]
pub unsafe extern "C-unwind" fn __xtu__ZN7ACE_DLL10set_handleEPvb(
    __this: *mut ACE_DLL,
    handle: *mut libc::c_void,
    close_handle_on_destruction: bool,
) -> libc::c_int {
    unsafe { ACE_DLL::set_handle(__this, handle, close_handle_on_destruction) }
}
#[export_name = "_ZN7ACE_DLL6open_iEPKcibPv"]
pub unsafe extern "C-unwind" fn __xtu__ZN7ACE_DLL6open_iEPKcibPv(
    __this: *mut ACE_DLL,
    dll_filename: *const libc::c_char,
    open_mode: libc::c_int,
    close_handle_on_destruction: bool,
...
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Array_BaseI15ACE_String_BaseIcEEC1EmRKS1_P13ACE_Allocator(
    __this: *mut ACE_Array_Base_ACE_String_Base_char__,
    __a0: libc::c_ulong,
    __a1: *const ACE_String_Base_char_,
    __a2: *mut ACE_Allocator,
) {
    ACE_Array_Base_ACE_String_Base_char__::new_at_s7abb16bbe0a1329b(
        __this,
        __a0,
        __a1,
        __a2,
...
#[export_name = "_ZN15ACE_Fixed_StackI15ACE_String_BaseIcELm10EEC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Fixed_StackI15ACE_String_BaseIcELm10EEC1Ev(
    __this: *mut ACE_Fixed_Stack_ACE_String_Base_char___10_,
) {
    ACE_Fixed_Stack_ACE_String_Base_char___10_::new_at_sd1537ad37a8f1e59(__this)
}
impl Drop for ACE_Fixed_Stack_ACE_String_Base_char___10_ {
    fn drop(&mut self) {
        unsafe {
            let __this: *mut Self = self as *mut Self;
            {}
...
#[export_name = "__acedtor_ud1537ad37a8f1e59"]
pub unsafe extern "C-unwind" fn __acedtor_ud1537ad37a8f1e59(
    __this: *mut ACE_Fixed_Stack_ACE_String_Base_char___10_,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
extern "C" {
    #[allow(non_upper_case_globals)]
    pub static mut ACE_DLL_Manager_instance_: *mut ACE_DLL_Manager;
}
...
impl Drop for ACE_DLL_Manager {
    fn drop(&mut self) {
        unsafe {
            extern "C-unwind" {
                #[link_name = "__acedtor_u72c8b7358df3282d"]
                fn __ext(__this: *mut ACE_DLL_Manager);
            }
            __ext(self as *mut Self);
        }
    }
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((release as libc::c_int) != 0) {
                    ...
                    <ACE_String_Base_char_>::fast_clear(
...
impl ACE_DLL_Handle {
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        extern "C-unwind" {
            #[link_name = "_ZN14ACE_DLL_HandleC1Ev"]
            fn __ext(__this: *mut ACE_DLL_Handle);
        }
        __ext(__this as *mut ACE_DLL_Handle)
    }
    pub unsafe fn new() -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at(::core::ptr::addr_of_mut!(__obj));
    ...
    pub unsafe fn dll_name(__this: *const Self) -> *const libc::c_char {
        extern "C-unwind" {
            #[link_name = "_ZNK14ACE_DLL_Handle8dll_nameEv"]
            fn __ext(__this: *const ACE_DLL_Handle) -> *const libc::c_char;
        }
        __ext(__this as *const ACE_DLL_Handle)
    }
    ...
    pub unsafe fn open(
        ...
        extern "C-unwind" {
            #[link_name = "_ZN14ACE_DLL_Handle4openEPKciPvP15ACE_Fixed_StackI15ACE_String_BaseIcELm10EE"]
            fn __ext(
        ...
        __ext(__this as *mut ACE_DLL_Handle, dll_name, open_mode, handle, errors)
    }
  ...
  /// the library when the refcount == 0;*/
    pub unsafe fn close(__this: *mut Self, mut unload: libc::c_int) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN14ACE_DLL_Handle5closeEi"]
            fn __ext(__this: *mut ACE_DLL_Handle, unload: libc::c_int) -> libc::c_int;
        }
        __ext(__this as *mut ACE_DLL_Handle, unload)
    }
    ///Return the current refcount.
    pub unsafe fn refcount(__this: *const Self) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZNK14ACE_DLL_Handle8refcountEv"]
            fn __ext(__this: *const ACE_DLL_Handle) -> libc::c_int;
        }
        __ext(__this as *const ACE_DLL_Handle)
    }
  ...
  /// available, since missing functions in that case aren't really errors.*/
    pub unsafe fn symbol(
        ...
        extern "C-unwind" {
            #[link_name = "_ZN14ACE_DLL_Handle6symbolEPKcb"]
            fn __ext(
                __this: *mut ACE_DLL_Handle,
        ...
        __ext(__this as *mut ACE_DLL_Handle, symbol_name, ignore_errors)
    }
    ...
    pub unsafe fn symbol_u46d085d1aabecf62(
        ...
        extern "C-unwind" {
            #[link_name = "_ZN14ACE_DLL_Handle6symbolEPKcbR15ACE_String_BaseIcE"]
            fn __ext(
                __this: *mut ACE_DLL_Handle,
                symbol_name: *const libc::c_char,
                ignore_errors: bool,
        ...
        __ext(__this as *mut ACE_DLL_Handle, symbol_name, ignore_errors, error)
    }
    ...
    pub unsafe fn get_handle(
        ...
        extern "C-unwind" {
            #[link_name = "_ZN14ACE_DLL_Handle10get_handleEb"]
            fn __ext(
                __this: *mut ACE_DLL_Handle,
                become_owner: bool,
            ) -> *mut libc::c_void;
        }
        __ext(__this as *mut ACE_DLL_Handle, become_owner)
    }
  ...
  /// to the caller.*/
    pub unsafe fn error(
        ...
        extern "C-unwind" {
            #[link_name = "_ZN14ACE_DLL_Handle5errorER15ACE_String_BaseIcE"]
            fn __ext(
                __this: *mut ACE_DLL_Handle,
                err: *mut ACE_String_Base_char_,
            ) -> *mut ACE_String_Base_char_;
        }
        __ext(__this as *mut ACE_DLL_Handle, err)
    }
  ...
  /// Returns the array of names to try in @a try_names.*/
    pub unsafe fn get_dll_names(
        ...
        extern "C-unwind" {
            #[link_name = "_ZN14ACE_DLL_Handle13get_dll_namesEPKcR9ACE_ArrayI15ACE_String_BaseIcEE"]
            fn __ext(
                __this: *mut ACE_DLL_Handle,
                dll_name: *const libc::c_char,
        ...
        __ext(__this as *mut ACE_DLL_Handle, dll_name, try_names)
    }
    ...
    pub unsafe fn open_i(
        ...
        extern "C-unwind" {
            #[link_name = "_ZN14ACE_DLL_Handle6open_iEPKciP15ACE_Fixed_StackI15ACE_String_BaseIcELm10EE"]
            fn __ext(
                __this: *mut ACE_DLL_Handle,
                dll_name: *const libc::c_char,
                open_mode: libc::c_int,
        ...
        __ext(__this as *mut ACE_DLL_Handle, dll_name, open_mode, errors)
    }
...
impl ACE_DLL {
    ...
    pub unsafe fn new_at(__this: *mut Self, mut close_handle_on_destruction: bool) {
        unsafe {
            ::core::ptr::write(
                __this,
                ::core::mem::MaybeUninit::<Self>::zeroed().assume_init(),
            );
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).open_mode_), 0);
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).dll_name_),
                ((0) as *mut libc::c_char),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).close_handle_on_destruction_),
                close_handle_on_destruction,
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).dll_handle_),
                ((0) as *mut ACE_DLL_Handle),
            );
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).error_), ((0) != 0));
            <ACE_String_Base_char_>::new_at_s89536104322d6768(
                ::core::ptr::addr_of_mut!((* __this).errmsg_)
    ...
    pub unsafe fn operator_assign(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut tmp: ACE_DLL = ::core::mem::MaybeUninit::<ACE_DLL>::zeroed()
                    .assume_init();
                <ACE_DLL>::new_at_uee3c603b69ee15fa(
                    (::core::ptr::addr_of_mut!(tmp)) as *mut ACE_DLL,
                    ::core::ptr::addr_of!((* rhs)),
                );
                ::core::ptr::swap(
                    ::core::ptr::addr_of_mut!((* __this).open_mode_),
                    ::core::ptr::addr_of_mut!(tmp.open_mode_),
                );
                ::core::ptr::swap(
                    ::core::ptr::addr_of_mut!((* __this).dll_name_),
                    ::core::ptr::addr_of_mut!(tmp.dll_name_),
                );
                ::core::ptr::swap(
                    ::core::ptr::addr_of_mut!((* __this).close_handle_on_destruction_),
                    ::core::ptr::addr_of_mut!(tmp.close_handle_on_destruction_),
                );
                ::core::ptr::swap(
                    ::core::ptr::addr_of_mut!((* __this).dll_handle_),
                    ::core::ptr::addr_of_mut!(tmp.dll_handle_),
                );
                ::core::ptr::swap(
                    ::core::ptr::addr_of_mut!((* __this).error_),
                    ::core::ptr::addr_of_mut!(tmp.error_),
                );
                return __this;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/DLL.cpp\0".as_ptr()
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        (ace___) as *mut ACE_Log_Category_TSS,
                                        LM_ERROR,
                                        ((b"ACE_DLL::open: error calling open: %s\n\0".as_ptr()
                                            as *const libc::c_char) as *const libc::c_char),
                                        <ACE_DLL>::error((__this) as *const ACE_DLL),
                                    );
                                }
                            }
                            #[allow(unreachable_code)] break 'cont_0;
    ...
    ///Copy constructor.
    pub unsafe fn new_at_uee3c603b69ee15fa(__this: *mut Self, mut rhs: *const ACE_DLL) {
        unsafe {
            ::core::ptr::write(
                __this,
                ::core::mem::MaybeUninit::<Self>::zeroed().assume_init(),
            ...
            {
                if (((((((((!((*rhs).dll_name_).is_null())
                    && (((((<ACE_DLL>::open(
                        (__this) as *mut ACE_DLL,
                        (((*rhs).dll_name_) as *const libc::c_char),
                        (((*rhs).open_mode_) as libc::c_int),
                        (((*rhs).close_handle_on_destruction_) as bool),
                    ) as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                        as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
    ...
    pub unsafe fn open(
        __this: *mut Self,
        mut dll_filename: *const libc::c_char,
        mut open_mode: libc::c_int,
        mut close_handle_on_destruction: bool,
    ) -> libc::c_int {
        unsafe {
    ...
    pub unsafe fn close(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                if (((((((((((((!((*__this).dll_handle_).is_null())
                    && (((*__this).close_handle_on_destruction_ as libc::c_int) != 0))
                    as libc::c_int) as libc::c_int) != 0)
                    && (!((*__this).dll_name_).is_null())) as libc::c_int)
                    as libc::c_int) != 0)
                    && (((((({
                        let __v = <ACE_DLL_Manager>::close_dll(
                ...
                (*__this).dll_handle_ = ((0) as *mut ACE_DLL_Handle);
                {
                    let __data = (*__this).dll_name_ as *mut libc::c_char;
                    if !__data.is_null() {
                        ::libc::free(__data as *mut libc::c_void);
                ...
                (*__this).dll_name_ = ((0) as *mut libc::c_char);
                (*__this).close_handle_on_destruction_ = false;
                return retval;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    ...
    pub unsafe fn symbol(
        ...
        unsafe {
            ...
            {
                (*__this).error_ = ((0) != 0);
                <ACE_String_Base_char_>::clear(
                    (::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).errmsg_) .cast:: <
                ...
                if (!((*__this).dll_handle_).is_null()) {
                    sym = <ACE_DLL_Handle>::symbol_u46d085d1aabecf62(
                        ((*__this).dll_handle_) as *mut ACE_DLL_Handle,
                        sym_name,
                        ((ignore_errors) != 0),
                        ::core::ptr::addr_of_mut!(
                            (* ::core::ptr::addr_of!((* __this).errmsg_) .cast:: <
  ...
  /// returned by the OS.*/
    pub unsafe fn error(__this: *const Self) -> *mut libc::c_char {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((*__this).error_ as libc::c_int) != 0) {
    ...
    pub unsafe fn get_handle(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                if (!((*__this).dll_handle_).is_null()) {
                    handle = <ACE_DLL_Handle>::get_handle(
                        ((*__this).dll_handle_) as *mut ACE_DLL_Handle,
                        become_owner,
                    );
                }
  ...
  /// operation on / the object will be invoked before it is destroyed.*/
    pub unsafe fn set_handle(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut temp: [libc::c_char; 100usize] = unsafe {
                    ::core::mem::zeroed()
                };
                ACE_OS::unique_name_u335a6b57ecb175f1(
                    ((__this) as *const libc::c_void),
                    ((temp).as_mut_ptr() as *mut libc::c_char),
                    ((100) as libc::c_ulong),
                );
                return <ACE_DLL>::open_i(
                    (__this) as *mut ACE_DLL,
                    ((temp).as_ptr() as *const libc::c_char),
                    1,
                    close_handle_on_destruction,
                    handle,
                );
    ...
    pub unsafe fn open_i(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                if (((!((!(dll_filename).is_null())) as libc::c_int) as libc::c_int)
                    != 0)
                {
                                ...
                                {
                                    {
                                        ...
                                        <ACE_Log_Category_TSS>::log(
                                            (ace___) as *mut ACE_Log_Category_TSS,
                                            LM_ERROR,
                                            ((b"ACE_DLL::open_i: dll_name is %s\n\0".as_ptr()
                                                as *const libc::c_char) as *const libc::c_char),
                                            if ((((((*__this).dll_name_).is_null()) as libc::c_int)
                                                as libc::c_int) != 0)
                                            {
                ...
                if (!((*__this).dll_handle_).is_null()) {
                    if (((((ACE_OS::strcmp_u2f671283fc8b6d4a(
                        (((*__this).dll_name_) as *const libc::c_char),
                        ((dll_filename) as *const libc::c_char),
                    ) as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                        as libc::c_int) != 0)
                    {
                        return 0;
                ...
                (*__this).open_mode_ = open_mode;
                (*__this).close_handle_on_destruction_ = close_handle_on_destruction;
                let mut errors: ACE_Fixed_Stack_ACE_String_Base_char___10_ = ::core::mem::MaybeUninit::<
                    ACE_Fixed_Stack_ACE_String_Base_char___10_,
                >::zeroed()
                    .assume_init();
                <ACE_Fixed_Stack_ACE_String_Base_char___10_>::new_at_sd1537ad37a8f1e59(
                    (::core::ptr::addr_of_mut!(errors))
                        as *mut ACE_Fixed_Stack_ACE_String_Base_char___10_,
                );
                (*__this).dll_handle_ = <ACE_DLL_Manager>::open_dll(
                    (<ACE_DLL_Manager>::instance(
                        (((1024 as libc::c_int)) as libc::c_int),
                    )) as *mut ACE_DLL_Manager,
                    (((*__this).dll_name_) as *const libc::c_char),
                ...
                if (((!((!((*__this).dll_handle_).is_null())) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    ...
                    'while_1: loop {
                        if !((((!(((<ACE_Fixed_Stack_ACE_String_Base_char___10_>::is_empty(
                            (::core::ptr::addr_of!(errors))
                                as *const ACE_Fixed_Stack_ACE_String_Base_char___10_,
                        ...
                        'cont_1: loop {
                            {
                                {
                                    <ACE_Fixed_Stack_ACE_String_Base_char___10_>::pop(
                                        (::core::ptr::addr_of_mut!(errors))
                                            as *mut ACE_Fixed_Stack_ACE_String_Base_char___10_,
                                        ::core::ptr::addr_of_mut!(errtmp),
                                    );
                ...
                return if (((*__this).error_ as libc::c_int) != 0) {
                    (-((1) as libc::c_int))
                } else {
                    0
                };
...
impl ACE_Fixed_Stack_ACE_String_Base_char___10_ {
    ...
    pub unsafe fn push(
        ...
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_Fixed_StackI15ACE_String_BaseIcELm10EE4pushERKS1_"]
            fn __ext(
                __this: *mut ACE_Fixed_Stack_ACE_String_Base_char___10_,
                new_item: *const ACE_String_Base_char_,
            ) -> libc::c_int;
        }
        __ext(__this as *mut ACE_Fixed_Stack_ACE_String_Base_char___10_, new_item)
    }
    ...
    pub unsafe fn is_full(__this: *const Self) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZNK15ACE_Fixed_StackI15ACE_String_BaseIcELm10EE7is_fullEv"]
            fn __ext(
                __this: *const ACE_Fixed_Stack_ACE_String_Base_char___10_,
            ) -> libc::c_int;
        }
    ...
    pub unsafe fn new_at_sd1537ad37a8f1e59(__this: *mut Self) {
        unsafe {
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).top_),
                ((0) as libc::c_ulong),
            );
            {}
            ()
                    ...
                    as libc::c_int) != 0)
                {
                    <ACE_String_Base_char_>::operator_assign_sbd22052c3b720a46(
                        ...
                        ::core::ptr::addr_of!(
                            ...
                            ((* __this).top_); * __lv = (* __lv).wrapping_sub(1); * __lv
                            }) as isize)))
                        ),
                    );
                    return 0;
...
impl ACE_DLL_Manager {
    ...
    pub unsafe fn instance(mut size: libc::c_int) -> *mut ACE_DLL_Manager {
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_DLL_Manager8instanceEi"]
            fn __ext(size: libc::c_int) -> *mut ACE_DLL_Manager;
        }
        __ext(size)
    }
  ...
  /// its refcount is incremented.*/
    pub unsafe fn open_dll(
        __this: *mut Self,
        mut dll_name: *const libc::c_char,
        mut openmode: libc::c_int,
        mut handle: *mut libc::c_void,
        mut errors: *mut ACE_Fixed_Stack_ACE_String_Base_char___10_,
    ) -> *mut ACE_DLL_Handle {
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_DLL_Manager8open_dllEPKciPvP15ACE_Fixed_StackI15ACE_String_BaseIcELm10EE"]
            fn __ext(
        ...
        __ext(__this as *mut ACE_DLL_Manager, dll_name, openmode, handle, errors)
    }
    ...
    pub unsafe fn close_dll(
        ...
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_DLL_Manager9close_dllEPKc"]
            fn __ext(
                __this: *mut ACE_DLL_Manager,
                dll_name: *const libc::c_char,
            ) -> libc::c_int;
        }
        __ext(__this as *mut ACE_DLL_Manager, dll_name)
    }
    ///Returns the current per-process UNLOAD_POLICY.
    pub unsafe fn unload_policy(__this: *const Self) -> libc::c_ulong {
        extern "C-unwind" {
            #[link_name = "_ZNK15ACE_DLL_Manager13unload_policyEv"]
            fn __ext(__this: *const ACE_DLL_Manager) -> libc::c_ulong;
        }
        __ext(__this as *const ACE_DLL_Manager)
    }
  ...
  /// refcounts.*/
    pub unsafe fn unload_policy_ua6554d2cb47bac1e(
        ...
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_DLL_Manager13unload_policyEm"]
            fn __ext(__this: *mut ACE_DLL_Manager, unload_policy: libc::c_ulong);
        }
        __ext(__this as *mut ACE_DLL_Manager, unload_policy)
    }
    ///Default constructor.
    pub unsafe fn new_at(__this: *mut Self, mut __a0: libc::c_int) {
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_DLL_ManagerC1Ei"]
            fn __ext(__this: *mut ACE_DLL_Manager, __a0: libc::c_int);
        }
    ...
    pub unsafe fn open(__this: *mut Self, mut size: libc::c_int) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_DLL_Manager4openEi"]
            fn __ext(__this: *mut ACE_DLL_Manager, size: libc::c_int) -> libc::c_int;
        }
        __ext(__this as *mut ACE_DLL_Manager, size)
    }
    ///Close all open dlls and deallocate memory.
    pub unsafe fn close(__this: *mut Self) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_DLL_Manager5closeEv"]
            fn __ext(__this: *mut ACE_DLL_Manager) -> libc::c_int;
        }
        __ext(__this as *mut ACE_DLL_Manager)
    }
    ...
    pub unsafe fn find_dll(
        ...
        extern "C-unwind" {
            #[link_name = "_ZNK15ACE_DLL_Manager8find_dllEPKc"]
            fn __ext(
                __this: *const ACE_DLL_Manager,
                dll_name: *const libc::c_char,
            ) -> *mut ACE_DLL_Handle;
        }
        __ext(__this as *const ACE_DLL_Manager, dll_name)
    }
    ...
    pub unsafe fn unload_dll(
        ...
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_DLL_Manager10unload_dllEP14ACE_DLL_Handlei"]
            fn __ext(
                __this: *mut ACE_DLL_Manager,
        ...
        __ext(__this as *mut ACE_DLL_Manager, dll_handle, force_unload)
    }
    ///Close the singleton instance.
    pub unsafe fn close_singleton() {
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_DLL_Manager15close_singletonEv"]
            fn __ext();
        }
        __ext()
    }
...
impl ACE_Array_Base_ACE_String_Base_char__ {
    ...
    pub unsafe fn new_at_s7abb16bbe0a1329b(
        __this: *mut Self,
        mut size: libc::c_ulong,
        mut default_value: *const ACE_String_Base_char_,
        mut alloc: *mut ACE_Allocator,
    ) {
        unsafe {
            ::core::ptr::write(
            ...
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).max_size_), size);
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).cur_size_), size);
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).allocator_), alloc);
            {
                if ((((((*__this).allocator_).is_null()) as libc::c_int) as libc::c_int)
                    != 0)
