...
#[export_name = "_ZN14ACE_SOCK_DgramC1ERK8ACE_Addriiii"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_SOCK_DgramC1ERK8ACE_Addriiii(
    __this: *mut ACE_SOCK_Dgram,
    __a0: *const ACE_Addr,
    __a1: libc::c_int,
    __a2: libc::c_int,
    ...
    ACE_SOCK_Dgram::new_at_ua68fcd6094aa1f6f(__this, __a0, __a1, __a2, __a3, __a4)
}
#[export_name = "_ZN14ACE_SOCK_DgramC1ERK8ACE_AddriiP17ACE_Protocol_Infommii"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_SOCK_DgramC1ERK8ACE_AddriiP17ACE_Protocol_Infommii(
    __this: *mut ACE_SOCK_Dgram,
    __a0: *const ACE_Addr,
    __a1: libc::c_int,
    __a2: libc::c_int,
    ...
    ACE_SOCK_Dgram::new_at_u3a8bb2f705837dee(
        __this,
        __a0,
        __a1,
        __a2,
...
#[export_name = "_ZN14ACE_SOCK_Dgram4openERK8ACE_Addriiii"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_SOCK_Dgram4openERK8ACE_Addriiii(
    __this: *mut ACE_SOCK_Dgram,
...
#[export_name = "_ZN14ACE_SOCK_Dgram4openERK8ACE_AddriiP17ACE_Protocol_Infommii"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_SOCK_Dgram4openERK8ACE_AddriiP17ACE_Protocol_Infommii(
    __this: *mut ACE_SOCK_Dgram,
    local: *const ACE_Addr,
    protocol_family: libc::c_int,
    protocol: libc::c_int,
    ...
    unsafe {
        ACE_SOCK_Dgram::open_u4e1b8673750a23f6(
            __this,
            local,
            protocol_family,
            protocol,
...
#[export_name = "_ZNK14ACE_SOCK_Dgram4recvEP5iovecR8ACE_AddriPK14ACE_Time_Value"]
pub unsafe extern "C-unwind" fn __xtu__ZNK14ACE_SOCK_Dgram4recvEP5iovecR8ACE_AddriPK14ACE_Time_Value(
    ...
    unsafe {
        ACE_SOCK_Dgram::recv_ua4fd28e8cd0eecc1(__this, io_vec, addr, flags, timeout)
    }
}
#[export_name = "_ZNK14ACE_SOCK_Dgram4sendEPK5ioveciRK8ACE_Addri"]
pub unsafe extern "C-unwind" fn __xtu__ZNK14ACE_SOCK_Dgram4sendEPK5ioveciRK8ACE_Addri(
    __this: *const ACE_SOCK_Dgram,
    iov: *const iovec,
    n: libc::c_int,
    addr: *const ACE_Addr,
    ...
    unsafe { ACE_SOCK_Dgram::send_u70f4838a8668f181(__this, iov, n, addr, flags) }
}
#[repr(C)]
#[derive(Copy, Clone)]
pub union recv__control_buffer {
    pub control_msg_header: cmsghdr,
    pub padding: [libc::c_uchar; 32usize],
}
#[export_name = "_ZNK14ACE_SOCK_Dgram4recvEP5ioveciR8ACE_AddriP13ACE_INET_Addr"]
pub unsafe extern "C-unwind" fn __xtu__ZNK14ACE_SOCK_Dgram4recvEP5ioveciR8ACE_AddriP13ACE_INET_Addr(
    __this: *const ACE_SOCK_Dgram,
    iov: *mut iovec,
    n: libc::c_int,
    addr: *mut ACE_Addr,
    ...
    unsafe {
        ACE_SOCK_Dgram::recv_uebc810d51a40ee6b(__this, iov, n, addr, flags, to_addr)
    }
}
#[export_name = "_ZNK14ACE_SOCK_Dgram4recvEPvmR8ACE_AddriPK14ACE_Time_Value"]
pub unsafe extern "C-unwind" fn __xtu__ZNK14ACE_SOCK_Dgram4recvEPvmR8ACE_AddriPK14ACE_Time_Value(
    __this: *const ACE_SOCK_Dgram,
    buf: *mut libc::c_void,
    n: libc::c_ulong,
    addr: *mut ACE_Addr,
    ...
    unsafe {
        ACE_SOCK_Dgram::recv_u1c32a162ffbd3597(__this, buf, n, addr, flags, timeout)
    }
}
#[export_name = "_ZNK14ACE_SOCK_Dgram4sendEPKvmRK8ACE_AddriPK14ACE_Time_Value"]
pub unsafe extern "C-unwind" fn __xtu__ZNK14ACE_SOCK_Dgram4sendEPKvmRK8ACE_AddriPK14ACE_Time_Value(
    __this: *const ACE_SOCK_Dgram,
    buf: *const libc::c_void,
    n: libc::c_ulong,
    addr: *const ACE_Addr,
    ...
    unsafe {
        ACE_SOCK_Dgram::send_u809e84ba2610118d(__this, buf, n, addr, flags, timeout)
    }
}
#[export_name = "_ZNK14ACE_SOCK_Dgram4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK14ACE_SOCK_Dgram4dumpEv(
    __this: *const ACE_SOCK_Dgram,
) {
    unsafe { ACE_SOCK_Dgram::dump(__this) }
}
#[export_name = "_ZN14ACE_SOCK_Dgram7set_nicEPKci"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_SOCK_Dgram7set_nicEPKci(
    __this: *mut ACE_SOCK_Dgram,
    net_if: *const libc::c_char,
    addr_family: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_SOCK_Dgram::set_nic(__this, net_if, addr_family) }
}
#[export_name = "_ZN14ACE_SOCK_Dgram11shared_openERK8ACE_Addrii"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_SOCK_Dgram11shared_openERK8ACE_Addrii(
    __this: *mut ACE_SOCK_Dgram,
    local: *const ACE_Addr,
    protocol_family: libc::c_int,
    ipv6_only: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_SOCK_Dgram::shared_open(__this, local, protocol_family, ipv6_only) }
}
#[export_name = "_ZN14ACE_SOCK_Dgram21make_multicast_ifaddrEP7ip_mreqRK13ACE_INET_AddrPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_SOCK_Dgram21make_multicast_ifaddrEP7ip_mreqRK13ACE_INET_AddrPKc(
    __this: *mut ACE_SOCK_Dgram,
    ret_mreq: *mut ip_mreq,
    mcast_addr: *const ACE_INET_Addr,
    net_if: *const libc::c_char,
) -> libc::c_int {
    unsafe {
        ACE_SOCK_Dgram::make_multicast_ifaddr(__this, ret_mreq, mcast_addr, net_if)
    }
}
  ...
  /// dgram that will accept datagrams at the <local> address.*/
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/SOCK_Dgram.cpp\0".as_ptr()
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        b"ACE_SOCK_Dgram\0".as_ptr() as *const libc::c_char,
                                    );
                                }
                            }
    ...
    pub unsafe fn new_at_u3a8bb2f705837dee(
        ...
        unsafe {
            ...
            {
                if (((((<ACE_SOCK_Dgram>::open_u4e1b8673750a23f6(
                    (__this) as *mut ACE_SOCK_Dgram,
                    ::core::ptr::addr_of!((* local)),
                    protocol_family,
                    protocol,
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((<ACE_Addr>::operator_ne(
                    (::core::ptr::addr_of!((* local))) as *const ACE_Addr,
                    ...
                    as libc::c_int as libc::c_int) != 0)
                {
                    ...
                    return <ACE_SOCK_Dgram>::shared_open(
                        (__this) as *mut ACE_SOCK_Dgram,
                        ::core::ptr::addr_of!((* local)),
                        protocol_family,
                        ipv6_only,
    ...
    pub unsafe fn recv_ua4fd28e8cd0eecc1(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                let mut inlen: libc::c_int = unsafe { ::core::mem::zeroed() };
                if (((((ACE_OS::ioctl_u5ac77b5f0779af02(
                    ...
                    ((21531) as libc::c_ulong),
                    ((::core::ptr::addr_of_mut!(inlen) as *mut libc::c_int)
                        as *mut libc::c_void),
                ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    ...
                    if (((((inlen as libc::c_int)) > (((0) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        'dowhile_0: loop {
                            'cont_0: loop {
                                {
                                    {
                                        (*io_vec).iov_base = (({
                                            let __count: usize = (inlen) as usize;
                                        ...
                                        if ((((((*io_vec).iov_base).is_null()) as libc::c_int)
                                            as libc::c_int) != 0)
                                        {
                                            ((*(__errno_location()))) = 12;
                                            return (((-((1) as libc::c_int))) as libc::c_long);
                        ...
                        let mut rcv_len: libc::c_long = ACE_OS::recvfrom_u289b3b4f999bdcf7(
                            <ACE_IPC_SAP>::get_handle(
                                (::core::ptr::addr_of!(
                                    (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((* __this)
                                    .__base_0) .cast:: < ACE_SOCK > ().cast_mut()).__base_0)
                            ...
                            ((*io_vec).iov_base as *mut libc::c_char),
                            ((inlen) as libc::c_ulong),
                            flags,
                            (((saddr as *mut sockaddr)) as *mut sockaddr),
                            ::core::ptr::addr_of_mut!(addr_len) as *mut libc::c_int,
                        );
                        if (((((rcv_len as libc::c_long)) < (((0) as libc::c_long)))
                            as libc::c_int as libc::c_int) != 0)
                        {
                            {
                                let __data = ((*io_vec).iov_base as *mut libc::c_char)
                                    as *mut libc::c_char;
                                if !__data.is_null() {
                                    ::libc::free(__data as *mut libc::c_void);
                                }
                            };
                            (*io_vec).iov_base = ((0) as *mut libc::c_void);
                        } else {
                            (*io_vec).iov_len = ((ACE_Utils::truncate_cast___long__ub591475ebc843689(
                                ((rcv_len) as libc::c_long),
                            )) as libc::c_ulong);
                            <ACE_Addr>::set_size(
                                (::core::ptr::addr_of_mut!((* addr))) as *mut ACE_Addr,
                                addr_len,
  ...
  /// <sendmsg(3)>).*/
    pub unsafe fn send_u70f4838a8668f181(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut send_msg: msghdr = unsafe {
                    ::core::mem::MaybeUninit::<msghdr>::zeroed().assume_init()
                };
                send_msg.msg_iov = (((iov as *mut iovec)) as *mut iovec);
                send_msg.msg_iovlen = ((n) as libc::c_ulong);
                send_msg.msg_name = ((({
                    let __obj: *mut ACE_Addr = (::core::ptr::addr_of!((* addr)))
                        as *mut ACE_Addr;
                    let __vt: *const __Vtbl_u8861458fe5cac90c = *(__obj
                ...
                send_msg.msg_namelen = ((<ACE_Addr>::get_size(
                    (::core::ptr::addr_of!((* addr))) as *const ACE_Addr,
                )) as libc::c_uint);
                send_msg.msg_control = ((0) as *mut libc::c_void);
                send_msg.msg_controllen = ((0) as libc::c_ulong);
                send_msg.msg_flags = 0;
                return ACE_OS::sendmsg_ue8fec1119c766cbe(
                    <ACE_IPC_SAP>::get_handle(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((* __this)
                            .__base_0) .cast:: < ACE_SOCK > ().cast_mut()).__base_0)
                    ...
                    (::core::ptr::addr_of_mut!(send_msg) as *mut msghdr)
                        as *const msghdr,
                    flags,
                );
            }
  ...
  /// value 1 for IPV6 addresses.*/
    pub unsafe fn recv_uebc810d51a40ee6b(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut recv_msg: msghdr = unsafe {
                    ::core::mem::MaybeUninit::<msghdr>::zeroed().assume_init()
                };
                let mut cbuf: recv__control_buffer = unsafe {
                    ::core::mem::MaybeUninit::<recv__control_buffer>::zeroed()
                        .assume_init()
                };
                recv_msg.msg_iov = (((iov as *mut iovec)) as *mut iovec);
                recv_msg.msg_iovlen = ((n) as libc::c_ulong);
                recv_msg.msg_name = ((({
                    let __obj: *mut ACE_Addr = (::core::ptr::addr_of!((* addr)))
                        as *mut ACE_Addr;
                    let __vt: *const __Vtbl_u8861458fe5cac90c = *(__obj
                ...
                recv_msg.msg_namelen = ((<ACE_Addr>::get_size(
                    (::core::ptr::addr_of!((* addr))) as *const ACE_Addr,
                )) as libc::c_uint);
                recv_msg.msg_control = ((if (!(to_addr).is_null()) {
                    ::core::ptr::addr_of_mut!(cbuf) as *mut recv__control_buffer
                } else {
                    ((0) as *mut recv__control_buffer)
                }) as *mut libc::c_void);
                recv_msg.msg_controllen = ((if (!(to_addr).is_null()) {
                    ::core::mem::size_of::<recv__control_buffer>() as libc::c_ulong
                } else {
                    ((0) as libc::c_ulong)
                }) as libc::c_ulong);
                let mut status: libc::c_long = ACE_OS::recvmsg_u2eff40656fa046cd(
                    <ACE_IPC_SAP>::get_handle(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((* __this)
                            .__base_0) .cast:: < ACE_SOCK > ().cast_mut()).__base_0)
                    ...
                    ((::core::ptr::addr_of_mut!(recv_msg) as *mut msghdr)
                        as *mut msghdr),
                    flags,
                );
                <ACE_Addr>::set_size(
                    (::core::ptr::addr_of_mut!((* addr))) as *mut ACE_Addr,
                    ((recv_msg.msg_namelen) as libc::c_int),
                );
                <ACE_Addr>::set_type(
                    (::core::ptr::addr_of_mut!((* addr))) as *mut ACE_Addr,
                    (((*(({
                ...
                if (!(to_addr).is_null()) {
                    <ACE_SOCK>::get_local_addr(
                        ...
                        ::core::ptr::addr_of_mut!(
                            (* ::core::ptr::addr_of!(((* (to_addr))).__base_0) .cast:: <
                            ACE_Addr > ().cast_mut())
                        ) as *mut ACE_Addr,
                    );
                    if (((((<ACE_Addr>::get_type(
                    ...
                    {
                        {
                            let mut ptr: *mut cmsghdr = (((if (((((((*(::core::ptr::addr_of_mut!(
                                recv_msg
                            ) as *mut msghdr))
                                .msg_controllen as libc::c_ulong) as libc::c_ulong))
                                >= (((16) as libc::c_ulong))) as libc::c_int as libc::c_int)
                                != 0)
                            {
                                ((*(::core::ptr::addr_of_mut!(recv_msg) as *mut msghdr))
                            ...
                            'for_0: loop {
                                ...
                                'cont_0: loop {
                                    {
                                        {
                                            if ((((((((((*ptr).cmsg_level as libc::c_int))
                                                == ((((0 as libc::c_int)) as libc::c_int))) as libc::c_int
                                                as libc::c_int) != 0)
                                                && ((((((*ptr).cmsg_type as libc::c_int))
                                                    == (((8) as libc::c_int))) as libc::c_int as libc::c_int)
                                                    != 0)) as libc::c_int) as libc::c_int) != 0)
                                            {
                                                <ACE_INET_Addr>::set_address(
                                                    (to_addr) as *mut ACE_INET_Addr,
                                                    (&mut (((*((((((*(ptr)).__cmsg_data))).as_mut_ptr()
                                                        as *mut in_pktinfo)))
                                                        .ipi_addr)) as *mut in_addr as *const libc::c_char),
                                                    ((4) as libc::c_int),
                                                    0,
                                                    0,
                                                );
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                if (((((<ACE_SOCK>::set_option(
                    ...
                    32,
                    ((::core::ptr::addr_of_mut!((send_mreq.imr_interface))
                        as *mut in_addr) as *mut libc::c_void),
                    ((::core::mem::size_of::<in_addr>() as libc::c_ulong) as libc::c_int),
                ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    return (-((1) as libc::c_int));
            ...
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                ) as libc::c_int) != 0)
                {
                    ...
                    if (((((ACE_OS::bind_uef4d981726093bc5(
                        ...
                        ((({
                            let __obj: *mut ACE_Addr = (::core::ptr::addr_of!((* local)))
                                as *mut ACE_Addr;
                            let __vt: *const __Vtbl_u8861458fe5cac90c = *(__obj
                                as *const *const __Vtbl_u8861458fe5cac90c);
                            ((*__vt).vfn_ueade8b323a2ffe30)(__obj)
                ...
                return if ((error as libc::c_int) != 0) {
                    (-((1) as libc::c_int))
                } else {
                    0
                };
  ...
  /// If mreq param is NULL, just verify the passed addr/interface specs.*/
    pub unsafe fn make_multicast_ifaddr(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut lmreq: ip_mreq = unsafe {
                    ::core::mem::MaybeUninit::<ip_mreq>::zeroed().assume_init()
                };
                if ((((!(net_if).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    let mut if_address: ifreq = unsafe {
                        ::core::mem::MaybeUninit::<ifreq>::zeroed().assume_init()
                    };
                    ACE_OS::strncpy_u11a5be0fa5efbef0(
                        ((if_address.ifr_ifrn.ifrn_name).as_mut_ptr()
                            as *mut libc::c_char),
                        ((net_if) as *const libc::c_char),
                        (((((::core::mem::size_of::<[libc::c_char; 16usize]>()
                            as libc::c_ulong) as libc::c_ulong))
                            .wrapping_sub((1) as libc::c_ulong)) as libc::c_ulong),
                    );
                    (*(((if_address.ifr_ifrn.ifrn_name).as_ptr() as *mut libc::c_char)
                        .wrapping_offset(
                            (((((::core::mem::size_of::<[libc::c_char; 16usize]>()
                                as libc::c_ulong)) as libc::c_ulong))
                    ...
                    if (((((ACE_OS::ioctl_u5ac77b5f0779af02(
                        ...
                        ((35093) as libc::c_ulong),
                        ((::core::ptr::addr_of_mut!(if_address) as *mut ifreq)
                            as *mut libc::c_void),
                    ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        let mut interface_addr: ACE_INET_Addr = ::core::mem::MaybeUninit::<
                            ACE_INET_Addr,
                        >::zeroed()
                            .assume_init();
                        <ACE_INET_Addr>::new_at(
                            (::core::ptr::addr_of_mut!(interface_addr))
                        ...
                        lmreq.imr_interface.s_addr = ((__bswap_32(
                            ((<ACE_INET_Addr>::get_ip_address(
                                (::core::ptr::addr_of!(interface_addr))
                                    as *const ACE_INET_Addr,
                            )) as libc::c_uint),
                        )) as libc::c_uint);
                    } else {
                        let mut socket_address: *mut sockaddr_in = (::core::ptr::addr_of_mut!(
                            if_address.ifr_ifru.ifru_addr
                        ) as *mut sockaddr as *mut sockaddr_in);
                        lmreq.imr_interface.s_addr = (*socket_address).sin_addr.s_addr;
                    }
                } else {
                    lmreq.imr_interface.s_addr = ((0 as libc::c_uint));
                }
                lmreq.imr_multiaddr.s_addr = ((__bswap_32(
                    ((<ACE_INET_Addr>::get_ip_address(
                ...
                if (!(ret_mreq).is_null()) {
                    {
                        let __v = lmreq;
                        let __asg_p = ::core::ptr::addr_of_mut!((* (ret_mreq)));
                        *__asg_p = __v;
                        __asg_p
                    };
                }
