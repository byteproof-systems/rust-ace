...
#[export_name = "_ZN16ACE_SOCK_CODgramC1ERK8ACE_AddrS2_iii"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_SOCK_CODgramC1ERK8ACE_AddrS2_iii(
    __this: *mut ACE_SOCK_CODgram,
    __a0: *const ACE_Addr,
    __a1: *const ACE_Addr,
    __a2: libc::c_int,
    ...
    ACE_SOCK_CODgram::new_at_u444e8701be22633c(__this, __a0, __a1, __a2, __a3, __a4)
}
...
#[export_name = "_ZN16ACE_SOCK_CODgram4openERK8ACE_AddrS2_iii"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_SOCK_CODgram4openERK8ACE_AddrS2_iii(
    __this: *mut ACE_SOCK_CODgram,
...
#[export_name = "_ZNK16ACE_SOCK_CODgram4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK16ACE_SOCK_CODgram4dumpEv(
    __this: *const ACE_SOCK_CODgram,
) {
    unsafe { ACE_SOCK_CODgram::dump(__this) }
}
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/SOCK_CODgram.cpp\0".as_ptr()
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        b"ACE_SOCK_CODgram\0".as_ptr() as *const libc::c_char,
                                    );
                                }
                            }
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((<ACE_Addr>::operator_ne(
                    (::core::ptr::addr_of!((* remote))) as *const ACE_Addr,
                            ...
                            != 0)
                        {
                                ...
                                != 0)
                            {
                                ...
                                if (((((((((ACE_OS::bind_uef4d981726093bc5(
                                    ...
                                    == ((((-((1) as libc::c_int))) as libc::c_int)))
                                    as libc::c_int as libc::c_int) != 0)
                                    || (((((ACE_OS::connect_u21719e7a4d49e872(
                                        <ACE_IPC_SAP>::get_handle(
                                            (::core::ptr::addr_of!(
                                                (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((*
                                                ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
