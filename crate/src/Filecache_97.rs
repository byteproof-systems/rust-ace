...
pub mod ACE_Utils {
    ...
    pub use crate::FILE_IO_95::ACE_Utils::Truncator_long__long_;
    pub use crate::full_ops_0::ACE_Utils::truncator;
    pub use crate::full_ops_0::ACE_Utils::truncate_cast___long__ub591475ebc843689;
    pub type truncator_465 = Truncator_long__long_;
    pub use crate::FILE_IO_95::ACE_Utils::truncate_cast___long_;
}
extern "C-unwind" {
...
pub unsafe extern "C-unwind" fn __xtu__ZNK15ACE_String_BaseIcE4hashEv(
    __this: *const ACE_String_Base_char_,
) -> libc::c_ulong {
    unsafe { ACE_String_Base_char_::hash(__this) }
}
pub unsafe extern "C-unwind" fn __xtu__ZNK15ACE_String_BaseIcEeqERKS0_(
    __this: *const ACE_String_Base_char_,
    s: *const ACE_String_Base_char_,
) -> bool {
    unsafe { ACE_String_Base_char_::operator_eq_s221488fb36ec8992(__this, s) }
}
pub unsafe extern "C-unwind" fn __xtu__ZNK15ACE_String_BaseIcE7compareERKS0_(
    __this: *const ACE_String_Base_char_,
    s: *const ACE_String_Base_char_,
) -> libc::c_int {
    unsafe { ACE_String_Base_char_::compare(__this, s) }
}
#[repr(C)]
...
pub mod __cxxabiv1 {}
#[doc = "* @brief Function object for determining whether two ACE_CStrings are\n * equal."]
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ACE_Equal_To_ACE_CString_ {}
///* @brief Function object for hashing a ACE_CString
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ACE_Hash_ACE_CString_ {}
#[doc = "* @brief Function object for determining whether the first const string\n * is less than the second const string."]
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ACE_Less_Than_ACE_CString_ {}
extern "C" {
    #[allow(non_upper_case_globals)]
...
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___ {
    pub ext_id_: *const libc::c_char,
    pub int_id_: *mut ACE_Filecache_Object,
    pub next_: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
    pub prev_: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
}
#[export_name = "_ZN18ACE_Hash_Map_EntryIPKcP20ACE_Filecache_ObjectEC1ERKS1_RKS3_PS4_S9_"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_Hash_Map_EntryIPKcP20ACE_Filecache_ObjectEC1ERKS1_RKS3_PS4_S9_(
    __this: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
    __a0: *const *const libc::c_char,
    __a1: *const *mut ACE_Filecache_Object,
    __a2: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
    __a3: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
) {
    ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___::new_at_s7bea9536d140c4aa(
        __this,
        __a0,
        __a1,
        __a2,
...
#[export_name = "_ZN18ACE_Hash_Map_EntryIPKcP20ACE_Filecache_ObjectEC1EPS4_S5_"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_Hash_Map_EntryIPKcP20ACE_Filecache_ObjectEC1EPS4_S5_(
    __this: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
    __a0: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
    __a1: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
) {
    ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___::new_at_s4a4d67fe7c61c090(
        __this,
        __a0,
        __a1,
    )
}
impl Drop for ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___ {
    fn drop(&mut self) {
        unsafe {
            let __this: *mut Self = self as *mut Self;
            {
                ACE_OS::free_ucbe6910a56eae126(((*__this).ext_id_ as *mut libc::c_void));
            }
            ()
        }
    }
}
#[export_name = "__acedtor_u21003267ea41ebec"]
pub unsafe extern "C-unwind" fn __acedtor_u21003267ea41ebec(
    __this: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_ {
    pub table_allocator_: *mut ACE_Allocator,
    pub entry_allocator_: *mut ACE_Allocator,
    pub lock_: ::core::mem::ManuallyDrop<ACE_Null_Mutex>,
    pub hash_key_: ACE_Hash_const_char___,
    pub compare_keys_: ACE_Equal_To_const_char___,
    pub table_: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
    pub total_size_: libc::c_ulong,
    pub cur_size_: libc::c_ulong,
}
#[export_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE4hashERKS1_"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE4hashERKS1_(
    __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
    ext_id: *const *const libc::c_char,
) -> libc::c_ulong {
    unsafe {
        ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_::hash(
            __this,
            ext_id,
        )
    }
}
#[export_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE5equalERKS1_SB_"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE5equalERKS1_SB_(
    __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
    id1: *const *const libc::c_char,
    id2: *const *const libc::c_char,
) -> libc::c_int {
    unsafe {
        ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_::equal(
            __this,
            id1,
            id2,
        )
...
#[export_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE12unbind_all_iEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE12unbind_all_iEv(
    __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
) -> libc::c_int {
    unsafe {
        ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_::unbind_all_i(
            __this,
        )
    }
}
#[export_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE7close_iEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE7close_iEv(
    __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
) -> libc::c_int {
    unsafe {
        ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_::close_i(
            __this,
        )
    }
}
#[export_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE14create_bucketsEm"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE14create_bucketsEm(
    __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
    size: libc::c_ulong,
) -> libc::c_int {
    unsafe {
        ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_::create_buckets(
            __this,
            size,
        )
    }
}
#[export_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE4openEmP13ACE_AllocatorSB_"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE4openEmP13ACE_AllocatorSB_(
    __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
    size: libc::c_ulong,
    table_alloc: *mut ACE_Allocator,
    entry_alloc: *mut ACE_Allocator,
) -> libc::c_int {
    unsafe {
        ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_::open(
            __this,
            size,
            table_alloc,
            entry_alloc,
...
#[export_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexEC1EmP13ACE_AllocatorSB_"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexEC1EmP13ACE_AllocatorSB_(
    __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
    __a0: libc::c_ulong,
    __a1: *mut ACE_Allocator,
    __a2: *mut ACE_Allocator,
) {
    ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_::new_at_sb5003cedcc930893(
        __this,
        __a0,
        __a1,
        __a2,
...
#[export_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE11shared_findERKS1_RP18ACE_Hash_Map_EntryIS1_S3_ERm"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE11shared_findERKS1_RP18ACE_Hash_Map_EntryIS1_S3_ERm(
    __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
    ext_id: *const *const libc::c_char,
    entry: *mut *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
    loc: *mut libc::c_ulong,
) -> libc::c_int {
    unsafe {
        ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_::shared_find(
            __this,
            ext_id,
            entry,
            loc,
...
#[export_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE6bind_iERKS1_RKS3_RP18ACE_Hash_Map_EntryIS1_S3_E"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE6bind_iERKS1_RKS3_RP18ACE_Hash_Map_EntryIS1_S3_E(
    __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
    ext_id: *const *const libc::c_char,
    int_id: *const *mut ACE_Filecache_Object,
    entry: *mut *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
) -> libc::c_int {
    unsafe {
        ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_::bind_i_se9fa14f5ef9a6aba(
            __this,
            ext_id,
            int_id,
            entry,
...
#[export_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE8unbind_iEP18ACE_Hash_Map_EntryIS1_S3_E"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE8unbind_iEP18ACE_Hash_Map_EntryIS1_S3_E(
    __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
    entry: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
) -> libc::c_int {
    unsafe {
        ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_::unbind_i_sa054122be33619e6(
            __this,
            entry,
        )
    }
}
#[export_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE8unbind_iERKS1_RS3_"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE8unbind_iERKS1_RS3_(
    __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
    ext_id: *const *const libc::c_char,
    int_id: *mut *mut ACE_Filecache_Object,
) -> libc::c_int {
    unsafe {
        ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_::unbind_i_s3a899625543d75e7(
            __this,
            ext_id,
            int_id,
        )
...
impl Drop
for ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_ {
    fn drop(&mut self) {
        {
            unsafe {
                let __this: *mut Self = self as *mut Self;
                {
                    <ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_>::close(
                        (__this)
                            as *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                    );
                }
                ()
            }
...
#[export_name = "__acedtor_ue4d5e264b52eeb60"]
pub unsafe extern "C-unwind" fn __acedtor_ue4d5e264b52eeb60(
    __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Guard_ACE_RW_Thread_Mutex_ {
    pub lock_: *mut ACE_RW_Thread_Mutex,
    pub owner_: libc::c_int,
}
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_GuardI19ACE_RW_Thread_MutexEC1ERS0_(
    __this: *mut ACE_Guard_ACE_RW_Thread_Mutex_,
    __a0: *mut ACE_RW_Thread_Mutex,
) {
    ACE_Guard_ACE_RW_Thread_Mutex_::new_at_s50861607d96ddf5f(__this, __a0)
}
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_GuardI19ACE_RW_Thread_MutexEC1EPS0_(
    __this: *mut ACE_Guard_ACE_RW_Thread_Mutex_,
    __a0: *mut ACE_RW_Thread_Mutex,
) {
    ACE_Guard_ACE_RW_Thread_Mutex_::new_at_sb5b35a9e6045c43b(__this, __a0)
}
impl Drop for ACE_Guard_ACE_RW_Thread_Mutex_ {
    fn drop(&mut self) {
        unsafe {
            let __this: *mut Self = self as *mut Self;
            {
                <ACE_Guard_ACE_RW_Thread_Mutex_>::release(
                    (__this) as *mut ACE_Guard_ACE_RW_Thread_Mutex_,
                );
            }
            ()
        }
...
pub unsafe extern "C-unwind" fn __acedtor_uaf97bde8fe8f0eac(
    __this: *mut ACE_Guard_ACE_RW_Thread_Mutex_,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Write_Guard_ACE_RW_Thread_Mutex_ {
    pub __base_0: ::core::mem::ManuallyDrop<ACE_Guard_ACE_RW_Thread_Mutex_>,
}
impl Drop for ACE_Write_Guard_ACE_RW_Thread_Mutex_ {
    fn drop(&mut self) {
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.__base_0);
        }
...
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Write_GuardI19ACE_RW_Thread_MutexEC1ERS0_(
    __this: *mut ACE_Write_Guard_ACE_RW_Thread_Mutex_,
    __a0: *mut ACE_RW_Thread_Mutex,
) {
    ACE_Write_Guard_ACE_RW_Thread_Mutex_::new_at_se40246b82153f867(__this, __a0)
}
...
#[doc = "* @class ACE_Filecache_Object\n *\n * @brief\n * Abstraction over a real file.  This is what the Virtual\n * Filesystem contains.  This class is not intended for general\n * consumption.  Please consult a physician before attempting to\n * use this class."]
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Filecache_Object {
    pub tempname_: *mut libc::c_char,
    pub filename_: [libc::c_char; 4097usize],
    pub mmap_: ::core::mem::ManuallyDrop<ACE_Mem_Map>,
    pub handle_: libc::c_int,
    pub stat_: stat,
    pub size_: libc::c_long,
    pub action_: libc::c_int,
    pub error_: libc::c_int,
    pub stale_: libc::c_int,
    pub sa_: libc::c_int,
    pub junklock_: ::core::mem::ManuallyDrop<ACE_RW_Thread_Mutex>,
    pub lock_: *mut ACE_RW_Thread_Mutex,
}
#[export_name = "_ZN20ACE_Filecache_ObjectC1EPKcR19ACE_RW_Thread_Mutexii"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Filecache_ObjectC1EPKcR19ACE_RW_Thread_Mutexii(
    __this: *mut ACE_Filecache_Object,
    __a0: *const libc::c_char,
    __a1: *mut ACE_RW_Thread_Mutex,
    __a2: libc::c_int,
    __a3: libc::c_int,
) {
    ACE_Filecache_Object::new_at(__this, __a0, __a1, __a2, __a3)
}
#[export_name = "_ZN20ACE_Filecache_ObjectC1EPKclR19ACE_RW_Thread_Mutexi"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Filecache_ObjectC1EPKclR19ACE_RW_Thread_Mutexi(
    __this: *mut ACE_Filecache_Object,
    __a0: *const libc::c_char,
    __a1: libc::c_long,
    __a2: *mut ACE_RW_Thread_Mutex,
    __a3: libc::c_int,
) {
    ACE_Filecache_Object::new_at_ucae32729405e96dd(__this, __a0, __a1, __a2, __a3)
}
impl Drop for ACE_Filecache_Object {
    fn drop(&mut self) {
        {
            unsafe {
                let __this: *mut Self = self as *mut Self;
                {
                    if ((((((*__this).error_ as libc::c_int))
                        == (((ACE_SUCCESS) as libc::c_int))) as libc::c_int
                        as libc::c_int) != 0)
                    {
                        <ACE_Mem_Map>::unmap(
                            (::core::ptr::addr_of_mut!(
                                (* ::core::ptr::addr_of!((* __this).mmap_) .cast:: <
                                ACE_Mem_Map > ().cast_mut())
                            )) as *mut ACE_Mem_Map,
                            (((-((1) as libc::c_int))) as libc::c_long),
                        );
                        ACE_OS::close_u07c1eb6343f8c667((*__this).handle_);
                        (*__this).handle_ = (((-((1) as libc::c_int))) as libc::c_int);
                    }
                    <ACE_RW_Mutex>::release(
                        (::core::ptr::addr_of_mut!(
                            (* ::core::ptr::addr_of!((* (::core::ptr::addr_of_mut!((* (*
                            __this).lock_)))).__base_0) .cast:: < ACE_RW_Mutex > ()
                            .cast_mut())
                        )) as *mut ACE_RW_Mutex,
                    );
                }
        ...
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.junklock_);
            ::core::mem::ManuallyDrop::drop(&mut self.mmap_);
        }
    }
}
#[export_name = "__acedtor_uf3125ac7212581d5"]
pub unsafe extern "C-unwind" fn __acedtor_uf3125ac7212581d5(
    __this: *mut ACE_Filecache_Object,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[export_name = "_ZN20ACE_Filecache_Object7acquireEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Filecache_Object7acquireEv(
    __this: *mut ACE_Filecache_Object,
) -> libc::c_int {
    unsafe { ACE_Filecache_Object::acquire(__this) }
}
#[export_name = "_ZN20ACE_Filecache_Object7releaseEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Filecache_Object7releaseEv(
    __this: *mut ACE_Filecache_Object,
) -> libc::c_int {
    unsafe { ACE_Filecache_Object::release(__this) }
}
#[export_name = "_ZNK20ACE_Filecache_Object5errorEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK20ACE_Filecache_Object5errorEv(
    __this: *const ACE_Filecache_Object,
) -> libc::c_int {
    unsafe { ACE_Filecache_Object::error(__this) }
}
#[export_name = "_ZNK20ACE_Filecache_Object8filenameEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK20ACE_Filecache_Object8filenameEv(
    __this: *const ACE_Filecache_Object,
) -> *const libc::c_char {
    unsafe { ACE_Filecache_Object::filename(__this) }
}
#[export_name = "_ZNK20ACE_Filecache_Object6handleEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK20ACE_Filecache_Object6handleEv(
    __this: *const ACE_Filecache_Object,
) -> libc::c_int {
    unsafe { ACE_Filecache_Object::handle(__this) }
}
#[export_name = "_ZNK20ACE_Filecache_Object7addressEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK20ACE_Filecache_Object7addressEv(
    __this: *const ACE_Filecache_Object,
) -> *mut libc::c_void {
    unsafe { ACE_Filecache_Object::address(__this) }
}
#[export_name = "_ZNK20ACE_Filecache_Object4sizeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK20ACE_Filecache_Object4sizeEv(
    __this: *const ACE_Filecache_Object,
) -> libc::c_long {
    unsafe { ACE_Filecache_Object::size(__this) }
}
#[export_name = "_ZNK20ACE_Filecache_Object6updateEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK20ACE_Filecache_Object6updateEv(
    __this: *const ACE_Filecache_Object,
) -> libc::c_int {
    unsafe { ACE_Filecache_Object::update(__this) }
}
#[export_name = "_ZN20ACE_Filecache_ObjectC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Filecache_ObjectC1Ev(
    __this: *mut ACE_Filecache_Object,
) {
    ACE_Filecache_Object::new_at_udda7ae0d79428bb1(__this)
}
#[export_name = "_ZN20ACE_Filecache_Object4initEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Filecache_Object4initEv(
    __this: *mut ACE_Filecache_Object,
) {
    unsafe { ACE_Filecache_Object::init(__this) }
}
#[export_name = "_ZN20ACE_Filecache_Object7error_iEiPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Filecache_Object7error_iEiPKc(
    __this: *mut ACE_Filecache_Object,
    error_value: libc::c_int,
    s: *const libc::c_char,
) -> libc::c_int {
    unsafe { ACE_Filecache_Object::error_i(__this, error_value, s) }
}
#[doc = "* @class ACE_Filecache_Handle\n *\n * @brief\n * Abstraction over a real file.  This is meant to be the entry\n * point into the Cached Virtual Filesystem.\n *\n * This is a cached filesystem implementation based loosely on the\n * implementation of JAWS_File.  The interfaces will be nearly the\n * same.  The under-the-hood implementation should hopefully be a\n * much faster thing.\n * These will be given their own implementations later. For now, we\n * borrow the implementation provided by JAWS.\n * On creation, the cache is checked, and reference count is\n * incremented.  On destruction, reference count is decremented.  If\n * the reference count is 0, the file is removed from the cache.\n * E.g. 1,\n * {\n * ACE_Filecache_Handle foo(\"foo.html\");\n * this->peer ().send (foo.address (), foo.size ());\n * }\n * E.g. 2,\n * {\n * ACE_Filecache_Handle foo(\"foo.html\");\n * io->transmitfile (foo.handle (), this->peer ().handle ());\n * }\n * E.g. 3,\n * {\n * ACE_Filecache_Handle foo(\"foo.html\", content_length);\n * this->peer ().recv (foo.address (), content_length);\n * }\n * TODO:"]
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Filecache_Handle {
    pub file_: *mut ACE_Filecache_Object,
    pub handle_: libc::c_int,
}
#[export_name = "_ZN20ACE_Filecache_HandleC1EPKc18ACE_Filecache_Flag"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Filecache_HandleC1EPKc18ACE_Filecache_Flag(
    __this: *mut ACE_Filecache_Handle,
    __a0: *const libc::c_char,
    __a1: libc::c_uint,
) {
    ACE_Filecache_Handle::new_at(__this, __a0, __a1)
}
#[export_name = "_ZN20ACE_Filecache_HandleC1EPKci18ACE_Filecache_Flag"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Filecache_HandleC1EPKci18ACE_Filecache_Flag(
    __this: *mut ACE_Filecache_Handle,
    __a0: *const libc::c_char,
    __a1: libc::c_int,
    __a2: libc::c_uint,
) {
    ACE_Filecache_Handle::new_at_ucf8c64dcbf70a35c(__this, __a0, __a1, __a2)
}
impl Drop for ACE_Filecache_Handle {
    fn drop(&mut self) {
        unsafe {
            let __this: *mut Self = self as *mut Self;
            {
                if ((((((*__this).handle_ as libc::c_int))
                    != ((((-((1) as libc::c_int))) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    ACE_OS::close_u07c1eb6343f8c667((*__this).handle_);
                }
                <ACE_Filecache>::finish(
                    (<ACE_Filecache>::instance()) as *mut ACE_Filecache,
                    ::core::ptr::addr_of_mut!((* __this).file_),
                );
            }
            ()
        }
...
#[export_name = "__acedtor_u292fb20d30045b50"]
pub unsafe extern "C-unwind" fn __acedtor_u292fb20d30045b50(
    __this: *mut ACE_Filecache_Handle,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[export_name = "_ZNK20ACE_Filecache_Handle7addressEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK20ACE_Filecache_Handle7addressEv(
    __this: *const ACE_Filecache_Handle,
) -> *mut libc::c_void {
    unsafe { ACE_Filecache_Handle::address(__this) }
}
#[export_name = "_ZNK20ACE_Filecache_Handle6handleEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK20ACE_Filecache_Handle6handleEv(
    __this: *const ACE_Filecache_Handle,
) -> libc::c_int {
    unsafe { ACE_Filecache_Handle::handle(__this) }
}
#[export_name = "_ZNK20ACE_Filecache_Handle5errorEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK20ACE_Filecache_Handle5errorEv(
    __this: *const ACE_Filecache_Handle,
) -> libc::c_int {
    unsafe { ACE_Filecache_Handle::error(__this) }
}
#[export_name = "_ZNK20ACE_Filecache_Handle4sizeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK20ACE_Filecache_Handle4sizeEv(
    __this: *const ACE_Filecache_Handle,
) -> libc::c_long {
    unsafe { ACE_Filecache_Handle::size(__this) }
}
#[export_name = "_ZN20ACE_Filecache_HandleC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Filecache_HandleC1Ev(
    __this: *mut ACE_Filecache_Handle,
) {
    ACE_Filecache_Handle::new_at_u3f2a36b351f59986(__this)
}
#[export_name = "_ZN20ACE_Filecache_Handle4initEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Filecache_Handle4initEv(
    __this: *mut ACE_Filecache_Handle,
) {
    unsafe { ACE_Filecache_Handle::init(__this) }
}
pub type ACE_Filecache_Hash = ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_;
pub type ACE_Filecache_Hash_Entry = ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___;
#[allow(non_upper_case_globals)]
#[no_mangle]
pub static mut ACE_Filecache_cvf_: *mut ACE_Filecache = ((0) as *mut ACE_Filecache);
#[doc = "* @class ACE_Filecache\n *\n * @brief\n * A hash table holding the information about entry point into\n * the Cached Virtual Filesystem. On insertion, the reference\n * count is incremented. On destruction, reference count is\n * decremented."]
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Filecache {
    pub size_: libc::c_long,
    pub hash_: ::core::mem::ManuallyDrop<
        ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
    >,
    pub hash_lock_: [ACE_RW_Thread_Mutex; 512usize],
    pub file_lock_: [ACE_RW_Thread_Mutex; 512usize],
}
#[export_name = "_ZN13ACE_Filecache8instanceEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_Filecache8instanceEv() -> *mut ACE_Filecache {
    unsafe { ACE_Filecache::instance() }
}
impl Drop for ACE_Filecache {
    fn drop(&mut self) {
        {
            unsafe {
                let __this: *mut Self = self as *mut Self;
        ...
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.hash_);
        }
    }
}
#[export_name = "__acedtor_ub9c1c08cac5e710d"]
pub unsafe extern "C-unwind" fn __acedtor_ub9c1c08cac5e710d(__this: *mut ACE_Filecache) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
    }
}
#[export_name = "_ZN13ACE_Filecache4findEPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_Filecache4findEPKc(
    __this: *mut ACE_Filecache,
    filename: *const libc::c_char,
) -> libc::c_int {
    unsafe { ACE_Filecache::find(__this, filename) }
}
#[export_name = "_ZN13ACE_Filecache5fetchEPKci"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_Filecache5fetchEPKci(
    __this: *mut ACE_Filecache,
    filename: *const libc::c_char,
    mapit: libc::c_int,
) -> *mut ACE_Filecache_Object {
    unsafe { ACE_Filecache::fetch(__this, filename, mapit) }
}
#[export_name = "_ZN13ACE_Filecache6removeEPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_Filecache6removeEPKc(
    __this: *mut ACE_Filecache,
    filename: *const libc::c_char,
) -> *mut ACE_Filecache_Object {
    unsafe { ACE_Filecache::remove(__this, filename) }
}
#[export_name = "_ZN13ACE_Filecache6createEPKci"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_Filecache6createEPKci(
    __this: *mut ACE_Filecache,
    filename: *const libc::c_char,
    size: libc::c_int,
) -> *mut ACE_Filecache_Object {
    unsafe { ACE_Filecache::create(__this, filename, size) }
}
#[export_name = "_ZN13ACE_Filecache6finishERP20ACE_Filecache_Object"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_Filecache6finishERP20ACE_Filecache_Object(
    __this: *mut ACE_Filecache,
    file: *mut *mut ACE_Filecache_Object,
) -> *mut ACE_Filecache_Object {
    unsafe { ACE_Filecache::finish(__this, file) }
}
#[export_name = "_ZN13ACE_Filecache8insert_iEPKcR19ACE_RW_Thread_Mutexi"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_Filecache8insert_iEPKcR19ACE_RW_Thread_Mutexi(
    __this: *mut ACE_Filecache,
    filename: *const libc::c_char,
    filelock: *mut ACE_RW_Thread_Mutex,
    mapit: libc::c_int,
) -> *mut ACE_Filecache_Object {
    unsafe { ACE_Filecache::insert_i(__this, filename, filelock, mapit) }
}
#[export_name = "_ZN13ACE_Filecache8remove_iEPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_Filecache8remove_iEPKc(
    __this: *mut ACE_Filecache,
    filename: *const libc::c_char,
) -> *mut ACE_Filecache_Object {
    unsafe { ACE_Filecache::remove_i(__this, filename) }
}
#[export_name = "_ZN13ACE_Filecache8update_iEPKcR19ACE_RW_Thread_Mutexi"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_Filecache8update_iEPKcR19ACE_RW_Thread_Mutexi(
    __this: *mut ACE_Filecache,
    filename: *const libc::c_char,
    filelock: *mut ACE_RW_Thread_Mutex,
    mapit: libc::c_int,
) -> *mut ACE_Filecache_Object {
    unsafe { ACE_Filecache::update_i(__this, filename, filelock, mapit) }
}
#[export_name = "_ZN13ACE_FilecacheC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_FilecacheC1Ev(
    __this: *mut ACE_Filecache,
) {
    ACE_Filecache::new_at(__this)
}
#[repr(C)]
...
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Cleanup_Adapter_ACE_RW_Thread_Mutex_ {
    pub __base_0: ::core::mem::ManuallyDrop<ACE_Cleanup>,
    pub object_: ::core::mem::ManuallyDrop<ACE_RW_Thread_Mutex>,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ACE_Managed_Object_ACE_RW_Thread_Mutex_ {}
#[repr(C)]
...
impl ACE_String_Base_char_ {
    #[doc = "*  Returns a hash value for this string.\n   *\n   *  @return Hash value of string"]
    pub unsafe fn hash(__this: *const Self) -> libc::c_ulong {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return ACE::hash_pjw_u1df7e2c40de66984(
                    (((((*__this).rep_ as *mut libc::c_char) as *mut libc::c_char))
                        as *const libc::c_char),
    ...
    #[doc = "*  Equality comparison operator (must match entire string).\n   *\n   * @param s Input ACE_String_Base string to compare against stored string.\n   * @return @c true if equal, @c false otherwise."]
    pub unsafe fn operator_eq_s221488fb36ec8992(
        __this: *const Self,
        mut s: *const ACE_String_Base_char_,
    ) -> bool {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return ((((((((((*__this).len_ as libc::c_ulong))
                    ...
                    != 0)
                    && (((((ACE_OS::memcmp_u2459c16080f3a32c(
                        (((*__this).rep_) as *const libc::c_void),
                        (((*s).rep_) as *const libc::c_void),
                        ((((((*__this).len_) as libc::c_ulong))
                            .wrapping_mul((1) as libc::c_ulong)) as libc::c_ulong),
    ...
    pub unsafe fn compare(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((((((*__this).rep_) as *const u8)) == ((((*s).rep_) as *const u8)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    return 0;
                }
                let mut smaller_length: libc::c_ulong = (((*ace_min___const_unsigned_long____const_unsigned_long___(
                    ::core::ptr::addr_of!((* __this).len_),
                    ::core::ptr::addr_of!((* s).len_),
                ))) as libc::c_ulong);
                let mut result: libc::c_int = ACE_OS::memcmp_u2459c16080f3a32c(
                    (((*__this).rep_) as *const libc::c_void),
                    (((*s).rep_) as *const libc::c_void),
                    (((((smaller_length) as libc::c_ulong))
                        .wrapping_mul((1) as libc::c_ulong)) as libc::c_ulong),
                );
                if (((((((((result as libc::c_int)) == (((0) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                    && ((((((*__this).len_ as libc::c_ulong))
                        != ((((*s).len_) as libc::c_ulong))) as libc::c_int
                        as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
                {
                    result = if ((((((*__this).len_ as libc::c_ulong))
                        > ((((*s).len_) as libc::c_ulong))) as libc::c_int
                        as libc::c_int) != 0)
                    {
                        1
    ...
    pub unsafe fn operator_lt(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((((<ACE_String_Base_char_>::compare(
                    (__this) as *const ACE_String_Base_char_,
                    ::core::ptr::addr_of!((* s)),
                ) as libc::c_int)) < (((0) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0);
            }
...
impl ACE_Equal_To_ACE_CString_ {
    pub unsafe fn operator_call(
        __this: *const Self,
        mut lhs: *const ACE_String_Base_char_,
        mut rhs: *const ACE_String_Base_char_,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return ((<ACE_String_Base_char_>::operator_eq_s221488fb36ec8992(
                    (::core::ptr::addr_of!((* lhs))) as *const ACE_String_Base_char_,
...
impl ACE_Hash_ACE_CString_ {
    ///Calls ACE::hash_pjw
    pub unsafe fn operator_call(
        __this: *const Self,
        mut t: *const ACE_String_Base_char_,
    ) -> libc::c_ulong {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return ((<ACE_String_Base_char_>::hash(
                    (::core::ptr::addr_of!((* t))) as *const ACE_String_Base_char_,
                )) as libc::c_ulong);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
...
impl ACE_Less_Than_ACE_CString_ {
    ...
    pub unsafe fn operator_call(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((<ACE_String_Base_char_>::operator_lt(
                    (::core::ptr::addr_of!((* lhs))) as *const ACE_String_Base_char_,
                    ::core::ptr::addr_of!((* rhs)),
                ))) as libc::c_int);
            }
...
impl ACE_Filecache_Object {
    ///Creates a file for reading.
    pub unsafe fn new_at(
        __this: *mut Self,
        mut filename: *const libc::c_char,
        mut lock: *mut ACE_RW_Thread_Mutex,
        mut sa: libc::c_int,
        mut mapit: libc::c_int,
    ) {
        unsafe {
            ::core::ptr::write(
                __this,
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).tempname_),
                ((0) as *mut libc::c_char),
            );
            <ACE_Mem_Map>::new_at(
                (::core::ptr::addr_of_mut!((* __this).mmap_).cast::<ACE_Mem_Map>())
                    as *mut ACE_Mem_Map,
            );
            ::core::ptr::write(
            ...
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).action_), 0);
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).error_), 0);
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).stale_), 0);
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).sa_), sa);
            <ACE_RW_Thread_Mutex>::new_at(
                (::core::ptr::addr_of_mut!((* __this).junklock_)
                    .cast::<ACE_RW_Thread_Mutex>()) as *mut ACE_RW_Thread_Mutex,
                ((0) as *const libc::c_char),
                ((0) as *mut libc::c_void),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).lock_),
                ::core::ptr::addr_of_mut!((* lock)),
            );
            {
                <ACE_Filecache_Object>::init((__this) as *mut ACE_Filecache_Object);
                ACE_OS::strcpy_u08e8184bcebbac89(
                    (((*__this).filename_).as_mut_ptr() as *mut libc::c_char),
                    ((filename) as *const libc::c_char),
                );
                (*__this).action_ = ((ACE_READING) as libc::c_int);
                if (((((ACE_OS::access_ud59681e785d3d49a(
                    (((*__this).filename_).as_ptr() as *const libc::c_char),
                    4,
                ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    <ACE_Filecache_Object>::error_i(
                        (__this) as *mut ACE_Filecache_Object,
                        ((ACE_ACCESS_FAILED) as libc::c_int),
                        ((b"ACE_Filecache_Object\0".as_ptr() as *const libc::c_char)
                            as *const libc::c_char),
                    );
                    return;
                }
                if (((((ACE_OS::stat_u2ae4cb015063d662(
                    (((*__this).filename_).as_ptr() as *const libc::c_char),
                    ::core::ptr::addr_of_mut!((* __this).stat_) as *mut stat,
                ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    <ACE_Filecache_Object>::error_i(
                        (__this) as *mut ACE_Filecache_Object,
                        ((ACE_STAT_FAILED) as libc::c_int),
                        ((b"ACE_Filecache_Object\0".as_ptr() as *const libc::c_char)
                            as *const libc::c_char),
                    );
                    return;
                }
                (*__this).size_ = ((ACE_Utils::truncate_cast___long_(
                    (((*__this).stat_.st_size) as libc::c_long),
                )) as libc::c_long);
                (*__this).tempname_ = (((*__this).filename_).as_mut_ptr()
                    as *mut libc::c_char);
                (*__this).handle_ = ACE_OS::open_u20e73ad42bc94ee0(
                    (((*__this).tempname_) as *const libc::c_char),
                    0,
                    ((((((((256) as libc::c_int))
                        | ((((((256) as libc::c_int)).wrapping_shr((3) as u32)))
                            as libc::c_int)) as libc::c_int))
                        | ((((((((((256) as libc::c_int)).wrapping_shr((3) as u32)))
                            as libc::c_int))
                            .wrapping_shr((3) as u32))) as libc::c_int))
                        as libc::c_uint),
                    (*__this).sa_,
                );
                if ((((((*__this).handle_ as libc::c_int))
                    ...
                    as libc::c_int) != 0)
                {
                    <ACE_Filecache_Object>::error_i(
                        (__this) as *mut ACE_Filecache_Object,
                        ((ACE_OPEN_FAILED) as libc::c_int),
                        ((b"ACE_Filecache_Object::ctor: open\0".as_ptr()
                ...
                if ((mapit) != 0) {
                        ...
                        as libc::c_int) != 0)
                    {
                        <ACE_Filecache_Object>::error_i(
                            (__this) as *mut ACE_Filecache_Object,
                            ((ACE_MEMMAP_FAILED) as libc::c_int),
                            ((b"ACE_Filecache_Object::ctor: map\0".as_ptr()
                                as *const libc::c_char) as *const libc::c_char),
                        );
                        ACE_OS::close_u07c1eb6343f8c667((*__this).handle_);
                        (*__this).handle_ = (((-((1) as libc::c_int))) as libc::c_int);
    ...
    pub unsafe fn new(
        mut __a0: *const libc::c_char,
        mut __a1: *mut ACE_RW_Thread_Mutex,
        mut __a2: libc::c_int,
        mut __a3: libc::c_int,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
    ...
    pub unsafe fn new_at_ucae32729405e96dd(
        __this: *mut Self,
        mut filename: *const libc::c_char,
        ...
        unsafe {
            ...
            );
            {
                ...
                (*__this).action_ = ((ACE_WRITING) as libc::c_int);
                if (((((((((ACE_OS::access_ud59681e785d3d49a(
                    (((*__this).filename_).as_ptr() as *const libc::c_char),
                    (((4) as libc::c_int)) | ((2) as libc::c_int),
                ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                    && (((((ACE_OS::access_ud59681e785d3d49a(
                        (((*__this).filename_).as_ptr() as *const libc::c_char),
                        0,
                    ) as libc::c_int)) != ((((-((1) as libc::c_int))) as libc::c_int)))
                ...
                (*__this).handle_ = ACE_OS::open_u20e73ad42bc94ee0(
                    (((*__this).tempname_) as *const libc::c_char),
                    (((((((2) as libc::c_int)) | ((64) as libc::c_int)) as libc::c_int))
                        | ((512) as libc::c_int)),
                    (((((((((((((((((256) as libc::c_int))
                        | ((((((256) as libc::c_int)).wrapping_shr((3) as u32)))
                            as libc::c_int)) as libc::c_int))
                        | ((((((((((256) as libc::c_int)).wrapping_shr((3) as u32)))
                            as libc::c_int))
                            .wrapping_shr((3) as u32))) as libc::c_int)) as libc::c_int))
                        | ((128) as libc::c_int)) as libc::c_int))
                        | ((((((128) as libc::c_int)).wrapping_shr((3) as u32)))
                            as libc::c_int)) as libc::c_int))
                        | ((((((((((128) as libc::c_int)).wrapping_shr((3) as u32)))
                            as libc::c_int))
                            .wrapping_shr((3) as u32))) as libc::c_int))
                    ...
                    as libc::c_int) != 0)
                {
                    <ACE_Filecache_Object>::error_i(
                        (__this) as *mut ACE_Filecache_Object,
                        ((ACE_OPEN_FAILED) as libc::c_int),
                        ((b"ACE_Filecache_Object::acquire: open\0".as_ptr()
                            as *const libc::c_char) as *const libc::c_char),
                    );
                    return;
                }
                if (((((ACE_OS::pwrite_u004420a1c470f7a8(
                    (*__this).handle_,
                    ((b"\0".as_ptr() as *const libc::c_char) as *const libc::c_void),
                    ((1) as libc::c_ulong),
                    ((((*__this).size_) as libc::c_long))
                    ...
                    as libc::c_int) != 0)
                {
                    <ACE_Filecache_Object>::error_i(
                        (__this) as *mut ACE_Filecache_Object,
                        ((ACE_WRITE_FAILED) as libc::c_int),
                        ((b"ACE_Filecache_Object::acquire: write\0".as_ptr()
                            as *const libc::c_char) as *const libc::c_char),
                    );
                    ACE_OS::close_u07c1eb6343f8c667((*__this).handle_);
                    return;
                    ...
                    as libc::c_int) != 0)
                {
                    <ACE_Filecache_Object>::error_i(
                        (__this) as *mut ACE_Filecache_Object,
                        ((ACE_MEMMAP_FAILED) as libc::c_int),
                        ((b"ACE_Filecache_Object::acquire: map\0".as_ptr()
                            as *const libc::c_char) as *const libc::c_char),
                    );
                    ACE_OS::close_u07c1eb6343f8c667((*__this).handle_);
                }
    ...
    pub unsafe fn new_ucae32729405e96dd(
        mut __a0: *const libc::c_char,
        mut __a1: libc::c_long,
        mut __a2: *mut ACE_RW_Thread_Mutex,
        mut __a3: libc::c_int,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_ucae32729405e96dd(
            ::core::ptr::addr_of_mut!(__obj),
            __a0,
            __a1,
            __a2,
    ...
    pub unsafe fn acquire(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return <ACE_RW_Mutex>::tryacquire_read(
                    (::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* (::core::ptr::addr_of_mut!((* (*
                        __this).lock_)))).__base_0) .cast:: < ACE_RW_Mutex > ()
                        .cast_mut())
    ...
    pub unsafe fn release(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((((*__this).action_ as libc::c_int))
                    == (((ACE_WRITING) as libc::c_int))) as libc::c_int as libc::c_int)
                    != 0)
                {
                    <ACE_Mem_Map>::unmap(
                        (::core::ptr::addr_of_mut!(
    ...
    pub unsafe fn error(__this: *const Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((*__this).error_) as libc::c_int);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    pub unsafe fn error_u9e85f8952c47b52a(
        __this: *mut Self,
        mut error_value: libc::c_int,
        mut s: *const libc::c_char,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN20ACE_Filecache_Object5errorEiPKc"]
            fn __ext(
                __this: *mut ACE_Filecache_Object,
                error_value: libc::c_int,
                s: *const libc::c_char,
        ...
        __ext(__this as *mut ACE_Filecache_Object, error_value, s)
    }
    ///filename_ accessor
    pub unsafe fn filename(__this: *const Self) -> *const libc::c_char {
        unsafe {
    ...
    pub unsafe fn address(__this: *const Self) -> *mut libc::c_void {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return <ACE_Mem_Map>::addr(
                    (::core::ptr::addr_of!(
                        (* ::core::ptr::addr_of!((* __this).mmap_) .cast:: < ACE_Mem_Map
                        > ().cast_mut())
                    )) as *const ACE_Mem_Map,
                );
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    ...
    ///size_ accessor.
    pub unsafe fn size(__this: *const Self) -> libc::c_long {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((*__this).size_) as libc::c_long);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    ///True if file on disk is newer than cached file.
    pub unsafe fn update(__this: *const Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut result: libc::c_int = unsafe { ::core::mem::zeroed() };
                let mut statbuf: stat = unsafe {
                    ::core::mem::MaybeUninit::<stat>::zeroed().assume_init()
                };
                if (((((ACE_OS::stat_u2ae4cb015063d662(
                    (((*__this).filename_).as_ptr() as *const libc::c_char),
                    ::core::ptr::addr_of_mut!(statbuf) as *mut stat,
                ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    result = 1;
                } else {
                    result = (((((ACE_OS::difftime_u7379ee088bf95ffd(
                        (((*__this).stat_.st_mtim.tv_sec) as libc::c_long),
                        ((statbuf.st_mtim.tv_sec) as libc::c_long),
                    ) as libc::c_double)) < (((0) as libc::c_double))) as libc::c_int)
                        as libc::c_int);
                }
                return result;
            }
    ...
    pub unsafe fn new_at_udda7ae0d79428bb1(__this: *mut Self) {
        unsafe {
            ::core::ptr::write(
                __this,
                ::core::mem::MaybeUninit::<Self>::zeroed().assume_init(),
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).lock_),
                ::core::ptr::addr_of_mut!(
                    (* ::core::ptr::addr_of!((* __this).junklock_) .cast:: <
                    ACE_RW_Thread_Mutex > ().cast_mut())
                ),
            );
            {
                <ACE_Filecache_Object>::init((__this) as *mut ACE_Filecache_Object);
    ...
    pub unsafe fn new_udda7ae0d79428bb1() -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_udda7ae0d79428bb1(::core::ptr::addr_of_mut!(__obj));
        __obj
    }
    ///Common initialization code,
    pub unsafe fn init(__this: *mut Self) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                (*((((*__this).filename_).as_ptr() as *mut libc::c_char)
                    .wrapping_offset((0) as isize))) = ((0 as libc::c_char)
                    as libc::c_char);
                (*__this).handle_ = (((-((1) as libc::c_int))) as libc::c_int);
                (*__this).error_ = ((ACE_SUCCESS) as libc::c_int);
                (*__this).tempname_ = ((0) as *mut libc::c_char);
                (*__this).size_ = ((0) as libc::c_long);
                ACE_OS::memset_u2b5dfc47d301370a(
                    ((::core::ptr::addr_of_mut!(((* __this).stat_)) as *mut stat)
                        as *mut libc::c_void),
                    0,
                    ((::core::mem::size_of::<stat>() as libc::c_ulong) as libc::c_ulong),
                );
            }
            ()
        }
                        ...
                        {
                            {
                                ...
                                <ACE_Log_Category_TSS>::conditional_set(
                                    ...
                                    ((b"/build/ace_full/src/ACE/ace/Filecache.cpp\0".as_ptr()
                                        as *const libc::c_char) as *const libc::c_char),
                                    701,
                                    (-((1) as libc::c_int)),
  ...
  /// opened for reading.*/
    pub unsafe fn new_at(
        ...
        unsafe {
            ...
            {
                <ACE_Filecache_Handle>::init((__this) as *mut ACE_Filecache_Handle);
                (*__this).file_ = <ACE_Filecache>::fetch(
                    (<ACE_Filecache>::instance()) as *mut ACE_Filecache,
                    filename,
                    ((mapit) as libc::c_int),
                );
    ...
    pub unsafe fn new(mut __a0: *const libc::c_char, mut __a1: libc::c_uint) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at(::core::ptr::addr_of_mut!(__obj), __a0, __a1);
        __obj
    }
    #[doc = "* Create new entry, and acquire it.  Presence of SIZE assumes the\n   * file is being opened for writing.  If SIZE is zero, assumes the\n   * file is to be removed from the cache."]
    pub unsafe fn new_at_ucf8c64dcbf70a35c(
        __this: *mut Self,
        mut filename: *const libc::c_char,
        mut size: libc::c_int,
        ...
        unsafe {
            ...
            {
                <ACE_Filecache_Handle>::init((__this) as *mut ACE_Filecache_Handle);
                if (((((size as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    <ACE_Filecache>::remove(
                        (<ACE_Filecache>::instance()) as *mut ACE_Filecache,
                        filename,
                    );
                } else {
                    (*__this).file_ = <ACE_Filecache>::create(
                        (<ACE_Filecache>::instance()) as *mut ACE_Filecache,
                        filename,
                        size,
                    );
    ...
    pub unsafe fn new_ucf8c64dcbf70a35c(
        mut __a0: *const libc::c_char,
        mut __a1: libc::c_int,
        mut __a2: libc::c_uint,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_ucf8c64dcbf70a35c(
            ::core::ptr::addr_of_mut!(__obj),
            __a0,
            __a1,
            __a2,
    ...
    pub unsafe fn address(__this: *const Self) -> *mut libc::c_void {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return if ((((((*__this).file_).is_null()) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    ((0) as *mut libc::c_void)
                } else {
                    <ACE_Filecache_Object>::address(
                        ((*__this).file_) as *const ACE_Filecache_Object,
                    )
                };
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((((((((*__this).handle_ as libc::c_int))
                    == ((((-((1) as libc::c_int))) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                    && ((((!((*__this).file_).is_null()) as libc::c_int) as libc::c_int)
                        != 0)) as libc::c_int) as libc::c_int) != 0)
                {
                    let mut mutable_this: *mut ACE_Filecache_Handle = (__this
                        as *mut ACE_Filecache_Handle);
                    (*mutable_this).handle_ = ACE_OS::dup_u8dba25e4b6f24d00(
                        <ACE_Filecache_Object>::handle(
                            ((*__this).file_) as *const ACE_Filecache_Object,
                        ),
                    );
                }
    ...
    pub unsafe fn error(__this: *const Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((((*__this).file_).is_null()) as libc::c_int) as libc::c_int) != 0)
                {
                    return (-((1) as libc::c_int));
                } else {
                    return <ACE_Filecache_Object>::error(
                        ((*__this).file_) as *const ACE_Filecache_Object,
                    );
                }
            }
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((((*__this).file_).is_null()) as libc::c_int) as libc::c_int) != 0)
                {
                    ...
                    return <ACE_Filecache_Object>::size(
                        ((*__this).file_) as *const ACE_Filecache_Object,
                    );
                }
            }
    ...
    pub unsafe fn new_at_u3f2a36b351f59986(__this: *mut Self) {
        unsafe {
            ::core::ptr::write(
                __this,
                ::core::mem::MaybeUninit::<Self>::zeroed().assume_init(),
    ...
    pub unsafe fn new_u3f2a36b351f59986() -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_u3f2a36b351f59986(::core::ptr::addr_of_mut!(__obj));
        __obj
    }
    ...
    pub unsafe fn init(__this: *mut Self) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                (*__this).file_ = ((0) as *mut ACE_Filecache_Object);
                (*__this).handle_ = (((-((1) as libc::c_int))) as libc::c_int);
            }
            ()
        }
...
impl ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_ {
    ...
    pub unsafe fn new_sbef0f67ae2a0224c(
        mut __a0: *mut ACE_Allocator,
        mut __a1: *mut ACE_Allocator,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_sbef0f67ae2a0224c(::core::ptr::addr_of_mut!(__obj), __a0, __a1);
        __obj
    }
    ///Removes all the entries in the ACE_Hash_Map_Manager_Ex.
    pub unsafe fn unbind_all(__this: *mut Self) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE10unbind_allEv"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
            ) -> libc::c_int;
        }
    ...
    #[doc = "* Same as a normal bind, except the map entry is also passed back\n   * to the caller.  The entry in this case will either be the newly\n   * created entry, or the existing one."]
    pub unsafe fn bind_se9fa14f5ef9a6aba(
        __this: *mut Self,
        mut ext_id: *const *const libc::c_char,
        mut int_id: *const *mut ACE_Filecache_Object,
        mut entry: *mut *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE4bindERKS1_RKS3_RP18ACE_Hash_Map_EntryIS1_S3_E"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                ext_id: *const *const libc::c_char,
                int_id: *const *mut ACE_Filecache_Object,
    ...
    #[doc = "* Associate @a ext_id with @a int_id if and only if @a ext_id is not\n   * in the map.  If @a ext_id is already in the map then the @a int_id\n   * parameter is assigned the existing value in the map.  Returns 0\n   * if a new entry is bound successfully, returns 1 if an attempt is\n   * made to bind an existing entry, and returns -1 if failures occur."]
    pub unsafe fn trybind_s3a899625543d75e7(
        __this: *mut Self,
        mut ext_id: *const *const libc::c_char,
        mut int_id: *mut *mut ACE_Filecache_Object,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE7trybindERKS1_RS3_"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                ext_id: *const *const libc::c_char,
                int_id: *mut *mut ACE_Filecache_Object,
    ...
    #[doc = "* Same as a normal trybind, except the map entry is also passed\n   * back to the caller.  The entry in this case will either be the\n   * newly created entry, or the existing one."]
    pub unsafe fn trybind_s2db9e3fad5e11fef(
        __this: *mut Self,
        mut ext_id: *const *const libc::c_char,
        mut int_id: *mut *mut ACE_Filecache_Object,
        mut entry: *mut *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE7trybindERKS1_RS3_RP18ACE_Hash_Map_EntryIS1_S3_E"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                ext_id: *const *const libc::c_char,
                int_id: *mut *mut ACE_Filecache_Object,
    ...
    #[doc = "* Reassociate @a ext_id with @a int_id.  If @a ext_id is not in the\n   * map then behaves just like <bind>.  Returns 0 if a new entry is\n   * bound successfully, returns 1 if an existing entry was rebound,\n   * and returns -1 if failures occur."]
    pub unsafe fn rebind_sb9853f1396977f1e(
        __this: *mut Self,
        mut ext_id: *const *const libc::c_char,
        mut int_id: *const *mut ACE_Filecache_Object,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE6rebindERKS1_RKS3_"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                ext_id: *const *const libc::c_char,
                int_id: *const *mut ACE_Filecache_Object,
    ...
    #[doc = "* Same as a normal rebind, except the map entry is also passed back\n   * to the caller.  The entry in this case will either be the newly\n   * created entry, or the existing one."]
    pub unsafe fn rebind_se9fa14f5ef9a6aba(
        __this: *mut Self,
        mut ext_id: *const *const libc::c_char,
        mut int_id: *const *mut ACE_Filecache_Object,
        mut entry: *mut *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE6rebindERKS1_RKS3_RP18ACE_Hash_Map_EntryIS1_S3_E"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                ext_id: *const *const libc::c_char,
                int_id: *const *mut ACE_Filecache_Object,
    ...
    #[doc = "* Associate @a ext_id with @a int_id.  If @a ext_id is not in the map\n   * then behaves just like <bind>.  Otherwise, store the old value of\n   * @a int_id into the \"out\" parameter and rebind the new parameters.\n   * Returns 0 if a new entry is bound successfully, returns 1 if an\n   * existing entry was rebound, and returns -1 if failures occur."]
    pub unsafe fn rebind_s8db051a81e94e587(
        __this: *mut Self,
        mut ext_id: *const *const libc::c_char,
        mut int_id: *const *mut ACE_Filecache_Object,
        mut old_int_id: *mut *mut ACE_Filecache_Object,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE6rebindERKS1_RKS3_RS3_"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                ext_id: *const *const libc::c_char,
                int_id: *const *mut ACE_Filecache_Object,
                old_int_id: *mut *mut ACE_Filecache_Object,
            ) -> libc::c_int;
        }
        __ext(
            __this
    ...
    #[doc = "* Same as a normal rebind, except the map entry is also passed back\n   * to the caller.  The entry in this case will either be the newly\n   * created entry, or the existing one."]
    pub unsafe fn rebind_sb029923cba5a120f(
        __this: *mut Self,
        mut ext_id: *const *const libc::c_char,
        mut int_id: *const *mut ACE_Filecache_Object,
        mut old_int_id: *mut *mut ACE_Filecache_Object,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE6rebindERKS1_RKS3_RS3_RP18ACE_Hash_Map_EntryIS1_S3_E"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                ext_id: *const *const libc::c_char,
                int_id: *const *mut ACE_Filecache_Object,
    ...
    pub unsafe fn rebind_sd32eb54c168197e0(
        __this: *mut Self,
        mut ext_id: *const *const libc::c_char,
        mut int_id: *const *mut ACE_Filecache_Object,
        mut old_ext_id: *mut *const libc::c_char,
        mut old_int_id: *mut *mut ACE_Filecache_Object,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE6rebindERKS1_RKS3_RS1_RS3_"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                ext_id: *const *const libc::c_char,
                int_id: *const *mut ACE_Filecache_Object,
                old_ext_id: *mut *const libc::c_char,
                old_int_id: *mut *mut ACE_Filecache_Object,
            ) -> libc::c_int;
        }
        __ext(
    ...
    #[doc = "* Same as a normal rebind, except the map entry is also passed back\n   * to the caller.  The entry in this case will either be the newly\n   * created entry, or the existing one."]
    pub unsafe fn rebind_s7ec423f494783270(
        __this: *mut Self,
        mut ext_id: *const *const libc::c_char,
        mut int_id: *const *mut ACE_Filecache_Object,
        mut old_ext_id: *mut *const libc::c_char,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE6rebindERKS1_RKS3_RS1_RS3_RP18ACE_Hash_Map_EntryIS1_S3_E"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                ext_id: *const *const libc::c_char,
                int_id: *const *mut ACE_Filecache_Object,
  ...
  /// return 0, returns -1 if not found.*/
    pub unsafe fn find_s800655d3fc74ef49(
        __this: *const Self,
        mut ext_id: *const *const libc::c_char,
        mut entry: *mut *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZNK23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE4findERKS1_RP18ACE_Hash_Map_EntryIS1_S3_E"]
            fn __ext(
                __this: *const ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                ext_id: *const *const libc::c_char,
                entry: *mut *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
            ) -> libc::c_int;
        }
        __ext(
            __this
                as *const ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
            ext_id,
            entry,
        )
    }
    #[doc = "Locate @a ext_id and pass out an iterator that points to its\n  /// corresponding value.\n  /**\n   * @param pos @a pos will be set to @c end() if not found."]
    pub unsafe fn find_sa8943f9bca0fff1c(
        __this: *const Self,
        mut ext_id: *const *const libc::c_char,
        mut pos: *mut libc::c_void,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZNK23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE4findERKS1_R24ACE_Hash_Map_Iterator_ExIS1_S3_S5_S7_S8_E"]
            fn __ext(
                __this: *const ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                ext_id: *const *const libc::c_char,
                pos: *mut libc::c_void,
    ...
    #[doc = "* Unbind (remove) the @a ext_id from the map.  Don't return the\n   * @a int_id to the caller (this is useful for collections where the\n   * @a int_ids are *not* dynamically allocated...)"]
    pub unsafe fn unbind_s5eefce432bd60c3e(
        __this: *mut Self,
        mut ext_id: *const *const libc::c_char,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE6unbindERKS1_"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                ext_id: *const *const libc::c_char,
            ) -> libc::c_int;
    ...
    #[doc = "Remove entry from map.\n  /**\n   * This unbind operation is fast relative to those that accept an\n   * external ID parameter since no map lookup is performed.\n   *\n   * @return 0 if the unbind was successful, and -1 if failures\n   *         occur."]
    pub unsafe fn unbind_sa054122be33619e6(
        __this: *mut Self,
        mut entry: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE6unbindEP18ACE_Hash_Map_EntryIS1_S3_E"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                entry: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
            ) -> libc::c_int;
    ...
    #[doc = "Remove entry from map pointed to by @c iterator @a pos.\n  /**\n   * This unbind operation is fast relative to those that accept an\n   * external ID parameter since no map lookup is performed.\n   *\n   * @return 0 if the unbind was successful, and -1 if failures\n   *         occur."]
    pub unsafe fn unbind_s8db971fdeff90bfd(
        __this: *mut Self,
        pos: libc::c_void,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE6unbindE24ACE_Hash_Map_Iterator_ExIS1_S3_S5_S7_S8_E"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                pos: *mut libc::c_void,
            ) -> libc::c_int;
        }
        let mut __md_pos = ::core::mem::ManuallyDrop::new(pos);
        __ext(
            __this
                as *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
            &mut *__md_pos as *mut libc::c_void,
        )
    }
  ...
  /// hash table.*/
    pub unsafe fn current_size(__this: *const Self) -> libc::c_ulong {
        extern "C-unwind" {
            #[link_name = "_ZNK23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE12current_sizeEv"]
            fn __ext(
                __this: *const ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
            ) -> libc::c_ulong;
        }
  ...
  /// linked lists of ACE_Hash_Map_Entry objects in the hash table.*/
    pub unsafe fn total_size(__this: *const Self) -> libc::c_ulong {
        extern "C-unwind" {
            #[link_name = "_ZNK23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE10total_sizeEv"]
            fn __ext(
                __this: *const ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
            ) -> libc::c_ulong;
        }
    ...
    #[doc = "* Returns a reference to the underlying <ACE_LOCK>.  This makes it\n   * possible to acquire the lock explicitly, which can be useful in\n   * some cases if you instantiate the ACE_Atomic_Op with an\n   * ACE_Recursive_Mutex or ACE_Process_Mutex, or if you need to\n   * guard the state of an iterator.\n   * @note The right name would be <lock>, but HP/C++ will choke on that!"]
    pub unsafe fn mutex(__this: *mut Self) -> *mut ACE_Null_Mutex {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE5mutexEv"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
            ) -> *mut ACE_Null_Mutex;
        }
    ...
    pub unsafe fn dump(__this: *const Self) {
        extern "C-unwind" {
            #[link_name = "_ZNK23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE4dumpEv"]
            fn __ext(
                __this: *const ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
            );
        }
    ...
    pub unsafe fn trybind_i_s3a899625543d75e7(
        __this: *mut Self,
        mut ext_id: *const *const libc::c_char,
        mut int_id: *mut *mut ACE_Filecache_Object,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE9trybind_iERKS1_RS3_"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                ext_id: *const *const libc::c_char,
                int_id: *mut *mut ACE_Filecache_Object,
    ...
    ///Performs trybind.  Must be called with locks held.
    pub unsafe fn trybind_i_s2db9e3fad5e11fef(
        __this: *mut Self,
        mut ext_id: *const *const libc::c_char,
        mut int_id: *mut *mut ACE_Filecache_Object,
        mut entry: *mut *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE9trybind_iERKS1_RS3_RP18ACE_Hash_Map_EntryIS1_S3_E"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                ext_id: *const *const libc::c_char,
                int_id: *mut *mut ACE_Filecache_Object,
    ...
    pub unsafe fn rebind_i_sb9853f1396977f1e(
        __this: *mut Self,
        mut ext_id: *const *const libc::c_char,
        mut int_id: *const *mut ACE_Filecache_Object,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE8rebind_iERKS1_RKS3_"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                ext_id: *const *const libc::c_char,
                int_id: *const *mut ACE_Filecache_Object,
    ...
    ///Performs rebind.  Must be called with locks held.
    pub unsafe fn rebind_i_se9fa14f5ef9a6aba(
        __this: *mut Self,
        mut ext_id: *const *const libc::c_char,
        mut int_id: *const *mut ACE_Filecache_Object,
        mut entry: *mut *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE8rebind_iERKS1_RKS3_RP18ACE_Hash_Map_EntryIS1_S3_E"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                ext_id: *const *const libc::c_char,
                int_id: *const *mut ACE_Filecache_Object,
    ...
    ///Performs rebind.  Must be called with locks held.
    pub unsafe fn rebind_i_s8db051a81e94e587(
        __this: *mut Self,
        mut ext_id: *const *const libc::c_char,
        mut int_id: *const *mut ACE_Filecache_Object,
        mut old_int_id: *mut *mut ACE_Filecache_Object,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE8rebind_iERKS1_RKS3_RS3_"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                ext_id: *const *const libc::c_char,
                int_id: *const *mut ACE_Filecache_Object,
    ...
    ///Performs rebind.  Must be called with locks held.
    pub unsafe fn rebind_i_sb029923cba5a120f(
        __this: *mut Self,
        mut ext_id: *const *const libc::c_char,
        mut int_id: *const *mut ACE_Filecache_Object,
        mut old_int_id: *mut *mut ACE_Filecache_Object,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE8rebind_iERKS1_RKS3_RS3_RP18ACE_Hash_Map_EntryIS1_S3_E"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                ext_id: *const *const libc::c_char,
                int_id: *const *mut ACE_Filecache_Object,
    ...
    ///Performs rebind.  Must be called with locks held.
    pub unsafe fn rebind_i_sd32eb54c168197e0(
        __this: *mut Self,
        mut ext_id: *const *const libc::c_char,
        mut int_id: *const *mut ACE_Filecache_Object,
        mut old_ext_id: *mut *const libc::c_char,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE8rebind_iERKS1_RKS3_RS1_RS3_"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                ext_id: *const *const libc::c_char,
                int_id: *const *mut ACE_Filecache_Object,
    ...
    ///Performs rebind.  Must be called with locks held.
    pub unsafe fn rebind_i_s7ec423f494783270(
        __this: *mut Self,
        mut ext_id: *const *const libc::c_char,
        mut int_id: *const *mut ACE_Filecache_Object,
        mut old_ext_id: *mut *const libc::c_char,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE8rebind_iERKS1_RKS3_RS1_RS3_RP18ACE_Hash_Map_EntryIS1_S3_E"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                ext_id: *const *const libc::c_char,
                int_id: *const *mut ACE_Filecache_Object,
  ...
  /// locks held.*/
    pub unsafe fn find_i_sef7306e647264eda(
        __this: *mut Self,
        mut ext_id: *const *const libc::c_char,
        mut entry: *mut *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE6find_iERKS1_RP18ACE_Hash_Map_EntryIS1_S3_E"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                ext_id: *const *const libc::c_char,
                entry: *mut *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
    ...
    pub unsafe fn unbind_i_s5eefce432bd60c3e(
        __this: *mut Self,
        mut ext_id: *const *const libc::c_char,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE8unbind_iERKS1_"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                ext_id: *const *const libc::c_char,
            ) -> libc::c_int;
    ...
    pub unsafe fn table(__this: *mut Self) -> *mut libc::c_void {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE5tableEv"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
            ) -> *mut libc::c_void;
        }
    ...
    pub unsafe fn operator_assign(
        __this: *mut Self,
        mut _anon_0: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexEaSERKS9_"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                _anon_0: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
            );
        }
        __ext(
            __this
    ...
    pub unsafe fn new_at_s018df0bbdfc10429(
        __this: *mut Self,
        mut __a0: *const ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExIPKcP20ACE_Filecache_Object8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexEC1ERKS9_"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                __a0: *const ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
            );
        }
        __ext(
            __this
    ...
    pub unsafe fn new_s018df0bbdfc10429(
        mut __a0: *const ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s018df0bbdfc10429(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    pub unsafe fn hash(
        __this: *mut Self,
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return ((ACE::hash_pjw((((*ext_id)) as *const libc::c_char)))
                    as libc::c_ulong);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    ...
    pub unsafe fn equal(
        __this: *mut Self,
        mut id1: *const *const libc::c_char,
        mut id2: *const *const libc::c_char,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((((ACE_OS::strcmp_u2f671283fc8b6d4a(
                    (((*id1)) as *const libc::c_char),
                    (((*id2)) as *const libc::c_char),
                ) as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int)
                    as libc::c_int);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
  ...
  /// locks held.*/
    pub unsafe fn unbind_all_i(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                {
                    ...
                    'for_0: loop {
                        if !((((((i as libc::c_ulong))
                            < ((((*__this).total_size_) as libc::c_ulong)))
                            as libc::c_int as libc::c_int) != 0))
                        {
                            break;
                        }
                        'cont_0: loop {
                            {
                                {
                                    {
                                        let mut temp_ptr: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___ = (*((*__this)
                                            .table_)
                                            .wrapping_offset((i) as isize))
                                            .next_;
                                        'for_1: loop {
                                            if !(((((((temp_ptr) as *const u8))
                                                != (((::core::ptr::addr_of_mut!(
                                                    (* ((* __this).table_).wrapping_offset((i) as isize))
                                                )
                                                    as *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___)
                                                    as *const u8))) as libc::c_int as libc::c_int) != 0))
                                            {
                                                break;
                                            }
                                            'cont_1: loop {
                                                {
                                                    {
                                                        let mut hold_ptr: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___ = temp_ptr;
                                                            ...
                                                            'cont_2: loop {
                                                                {
                                                                    {
                                                                        if (!(hold_ptr).is_null()) {
                                                                            ::core::ptr::drop_in_place((hold_ptr));
                                                                            {
                                                                                let __obj: *mut ACE_Allocator = ((*__this).entry_allocator_)
                                    ...
                                    (*((*__this).table_).wrapping_offset((i) as isize)).next_ = ::core::ptr::addr_of_mut!(
                                        (* ((* __this).table_).wrapping_offset((i) as isize))
                                    )
                                        as *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___;
                                    (*((*__this).table_).wrapping_offset((i) as isize)).prev_ = ::core::ptr::addr_of_mut!(
                                        (* ((* __this).table_).wrapping_offset((i) as isize))
                                    )
                                        as *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___;
                                }
                ...
                (*__this).cur_size_ = ((0) as libc::c_ulong);
                return 0;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
  ...
  /// locks held.*/
    pub unsafe fn close_i(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((!((*__this).table_).is_null()) as libc::c_int) as libc::c_int)
                    != 0)
                {
                    <ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_>::unbind_all_i(
                        (__this)
                    ...
                    );
                    {
                        ...
                        'for_0: loop {
                            ...
                            'cont_0: loop {
                                {
                                    {
                                        let mut entry: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___ = ::core::ptr::addr_of_mut!(
                                            (* ((* __this).table_).wrapping_offset((i) as isize))
                                        )
                                            as *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___;
                                        'dowhile_1: loop {
                    ...
                    (*__this).total_size_ = ((0) as libc::c_ulong);
                    {
                        let __obj: *mut ACE_Allocator = ((*__this).table_allocator_)
                            as *mut ACE_Allocator;
                        let __vt: *const __Vtbl_uf2113694993e252c = *(__obj
                            as *const *const __Vtbl_uf2113694993e252c);
                        ((*__vt)
                            .vfn_ucc7a27ee055bb87e)(
                            __obj,
                            (((*__this).table_) as *mut libc::c_void),
                        )
                    };
                    (*__this).table_ = ((0)
                        as *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___);
    ...
    pub unsafe fn create_buckets(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut bytes: libc::c_ulong = (((((size) as libc::c_ulong))
                        ...
                        {
                            {
                                ptr = {
                                    ...
                                    let __vt: *const __Vtbl_uf2113694993e252c = *(__obj
                                        as *const *const __Vtbl_uf2113694993e252c);
                                    ((*__vt)
                                        .vfn_u685215409e23bf32)(__obj, ((bytes) as libc::c_ulong))
                                };
                                if (((((ptr).is_null()) as libc::c_int) as libc::c_int)
                                    != 0)
                                {
                                    ((*(__errno_location()))) = 12;
                                    return (-((1) as libc::c_int));
                ...
                (*__this).table_ = (ptr
                    as *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___);
                (*__this).total_size_ = size;
                {
                    let mut i: libc::c_ulong = ((0) as libc::c_ulong);
                    'for_1: loop {
                        if !((((((i as libc::c_ulong)) < (((size) as libc::c_ulong)))
                            as libc::c_int as libc::c_int) != 0))
                        {
                            break;
                        }
                        'cont_1: loop {
                            {
                                {
                                    let __place: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___ = (::core::ptr::addr_of_mut!(
                                        (* ((* __this).table_).wrapping_offset((i) as isize))
                                    )
                                        as *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___)
                                        as *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___;
    ...
    #[doc = "* Initialize an ACE_Hash_Map_Manager_Ex with @a size elements.\n   * @param table_alloc is a pointer to a memory allocator used for\n   *        table_, so it should supply size*sizeof (ACE_Hash_Map_Entry<EXT_ID, INT_ID>).\n   *        If @a table_alloc is 0 it defaults to ACE_Allocator::instance().\n   * @param entry_alloc is a pointer to an additional allocator for\n   *        entries, so it should be able to allocate 'size' / chunks\n   *        of sizeof(ACE_Hash_Map_Entry<EXT_ID, INT_ID>) bytes each.\n   *        If @a entry_alloc is 0 then it defaults to the same allocator as\n   *        @a table_alloc.\n   * @return -1 on failure, 0 on success"]
    pub unsafe fn open(
        __this: *mut Self,
        mut size: libc::c_ulong,
        mut table_alloc: *mut ACE_Allocator,
        mut entry_alloc: *mut ACE_Allocator,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                if (((((table_alloc).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    table_alloc = <ACE_Allocator>::instance();
                }
                (*__this).table_allocator_ = table_alloc;
                if (((((entry_alloc).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    entry_alloc = table_alloc;
                }
                (*__this).entry_allocator_ = entry_alloc;
                if (((((size as libc::c_ulong)) == (((0) as libc::c_ulong)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    return (-((1) as libc::c_int));
                }
                return <ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_>::create_buckets(
                    (__this)
                        as *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                    size,
                );
    ...
    #[doc = "* Initialize an ACE_Hash_Map_Manager_Ex with @a size elements.\n   *\n   * @param table_alloc is a pointer to a memory allocator used for\n   *        table_, so it should supply size*sizeof (ACE_Hash_Map_Entry<EXT_ID, INT_ID>).\n   *        If @a table_alloc is 0 it defaults to ACE_Allocator::instance().\n   * @param entry_alloc is a pointer to an additional allocator for\n   *        entries, so it should be able to allocate 'size' / chunks\n   *        of sizeof(ACE_Hash_Map_Entry<EXT_ID, INT_ID>) bytes each.\n   *        If @a entry_alloc is 0 it defaults to the same allocator as\n   *        @a table_alloc."]
    pub unsafe fn new_at_sb5003cedcc930893(
        __this: *mut Self,
        mut size: libc::c_ulong,
        mut table_alloc: *mut ACE_Allocator,
        mut entry_alloc: *mut ACE_Allocator,
        ...
        unsafe {
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).table_allocator_),
                table_alloc,
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).entry_allocator_),
                entry_alloc,
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).table_),
                ((0) as *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).total_size_),
                ((0) as libc::c_ulong),
            );
            ::core::ptr::write(
            ...
            <ACE_Null_Mutex>::new_at(
                ::core::ptr::addr_of_mut!((* __this).lock_).cast::<ACE_Null_Mutex>(),
                ((0) as *const libc::c_char),
            );
            <ACE_Hash_const_char___>::new_at(
                ::core::ptr::addr_of_mut!((* __this).hash_key_),
            );
            <ACE_Equal_To_const_char___>::new_at(
                ::core::ptr::addr_of_mut!((* __this).compare_keys_),
            );
            {
                if (((((<ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_>::open(
                    (__this)
                        as *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                    size,
                    table_alloc,
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        (ace___) as *mut ACE_Log_Category_TSS,
                                        ((b"/build/ace_full/src/ACE/ace/Hash_Map_Manager_T.inl\0"
    ...
    pub unsafe fn new_sb5003cedcc930893(
        mut __a0: libc::c_ulong,
        mut __a1: *mut ACE_Allocator,
        mut __a2: *mut ACE_Allocator,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_sb5003cedcc930893(
            ::core::ptr::addr_of_mut!(__obj),
            __a0,
            __a1,
            __a2,
    ...
    pub unsafe fn shared_find(
        ...
        mut ext_id: *const *const libc::c_char,
        mut entry: *mut *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
        mut loc: *mut libc::c_ulong,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((((*__this).total_size_ as libc::c_ulong))
                    == (((0) as libc::c_ulong))) as libc::c_int as libc::c_int) != 0)
                {
                    ((*(__errno_location()))) = 2;
                    return (-((1) as libc::c_int));
                }
                (*loc) = (((((<ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_>::hash(
                    (__this)
                        as *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                    ::core::ptr::addr_of!((* ext_id)),
                )) as libc::c_ulong)) % (((*__this).total_size_) as libc::c_ulong))
                    as libc::c_ulong);
                let mut temp: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___ = (*((*__this)
                    .table_)
                    .wrapping_offset(((*loc)) as isize))
                    .next_;
                'while_0: loop {
                    if !(((((((((((temp) as *const u8))
                        != (((::core::ptr::addr_of_mut!(
                            (* ((* __this).table_).wrapping_offset(((* loc)) as isize))
                        )
                            as *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___)
                            as *const u8))) as libc::c_int as libc::c_int) != 0)
                        && (((((<ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_>::equal(
  ...
  /// called with locks held.*/
    pub unsafe fn find_i_s3a899625543d75e7(
        __this: *mut Self,
        mut ext_id: *const *const libc::c_char,
        mut int_id: *mut *mut ACE_Filecache_Object,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut entry: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___ = ((0)
                    as *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___);
                let mut dummy: libc::c_ulong = unsafe { ::core::mem::zeroed() };
                if (((((<ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_>::shared_find(
                    (__this)
                        as *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                    ::core::ptr::addr_of!((* ext_id)),
  ...
  /// Return 0 if found, returns -1 if not found.*/
    pub unsafe fn find_s38726ef71bd24f26(
        __this: *const Self,
        mut ext_id: *const *const libc::c_char,
        mut int_id: *mut *mut ACE_Filecache_Object,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut nc_this: *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_ = (__this
                    as *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_);
                ...
                return <ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_>::find_i_s3a899625543d75e7(
                    (nc_this)
                        as *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                    ::core::ptr::addr_of!((* ext_id)),
                    ::core::ptr::addr_of_mut!((* int_id)),
                );
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    ...
    pub unsafe fn bind_i_se9fa14f5ef9a6aba(
        __this: *mut Self,
        mut ext_id: *const *const libc::c_char,
        mut int_id: *const *mut ACE_Filecache_Object,
        mut entry: *mut *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut loc: libc::c_ulong = ((0) as libc::c_ulong);
                if (((((<ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_>::shared_find(
                    (__this)
                        as *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                    ::core::ptr::addr_of!((* ext_id)),
                    ::core::ptr::addr_of_mut!((* entry)),
                    ::core::ptr::addr_of_mut!(loc),
                ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    let mut ptr: *mut libc::c_void = ((0) as *mut libc::c_void);
                            ...
                            {
                                {
                                    ptr = {
                                        ...
                                        let __vt: *const __Vtbl_uf2113694993e252c = *(__obj
                                            as *const *const __Vtbl_uf2113694993e252c);
                                        ((*__vt)
                                            .vfn_u685215409e23bf32)(__obj, ((32) as libc::c_ulong))
                                    };
                                    if (((((ptr).is_null()) as libc::c_int) as libc::c_int)
                                        != 0)
                                    {
                    ...
                    (*entry) = {
                        let __place: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___ = (ptr)
                            as *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___;
                        <ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___>::new_at_s7bea9536d140c4aa(
                            (__place)
                                as *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
                            ::core::ptr::addr_of!((* ext_id)),
                            ::core::ptr::addr_of!((* int_id)),
                            (((*((*__this).table_).wrapping_offset((loc) as isize))
                                .next_)
                                as *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___),
                            ((::core::ptr::addr_of_mut!(
                    ...
                    (*((*__this).table_).wrapping_offset((loc) as isize)).next_ = (*entry);
                    (*(*(*entry)).next_).prev_ = (*entry);
                    {
                        let __lv = &mut ((*__this).cur_size_);
                        *__lv = (*__lv).wrapping_add(1);
                        *__lv
                    };
                    return 0;
    ...
    ///Performs bind.  Must be called with locks held.
    pub unsafe fn bind_i_sb9853f1396977f1e(
        __this: *mut Self,
        mut ext_id: *const *const libc::c_char,
        mut int_id: *const *mut ACE_Filecache_Object,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut temp: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___ = unsafe {
                    ::core::mem::zeroed()
                };
                return <ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_>::bind_i_se9fa14f5ef9a6aba(
                    (__this)
                        as *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                    ::core::ptr::addr_of!((* ext_id)),
                    ::core::ptr::addr_of!((* int_id)),
    ...
    pub unsafe fn bind_sb9853f1396977f1e(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                return <ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_>::bind_i_sb9853f1396977f1e(
                    (__this)
                        as *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                    ::core::ptr::addr_of!((* ext_id)),
                    ::core::ptr::addr_of!((* int_id)),
    ...
    ///Performs unbind.  Must be called with locks held.
    pub unsafe fn unbind_i_sa054122be33619e6(
        __this: *mut Self,
        mut entry: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
    ) -> libc::c_int {
        unsafe {
    ...
    ///Performs unbind.  Must be called with locks held.
    pub unsafe fn unbind_i_s3a899625543d75e7(
        __this: *mut Self,
        mut ext_id: *const *const libc::c_char,
        mut int_id: *mut *mut ACE_Filecache_Object,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut temp: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___ = ((0)
                    as *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___);
                let mut loc: libc::c_ulong = ((0) as libc::c_ulong);
                if (((((<ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_>::shared_find(
                    (__this)
                ...
                (*int_id) = (*temp).int_id_;
                return <ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_>::unbind_i_sa054122be33619e6(
                    (__this)
                        as *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                    temp,
                );
  ...
  /// unbind was successful, and returns -1 if failures occur.*/
    pub unsafe fn unbind_s3a899625543d75e7(
        __this: *mut Self,
        mut ext_id: *const *const libc::c_char,
        mut int_id: *mut *mut ACE_Filecache_Object,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                return <ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_>::unbind_i_s3a899625543d75e7(
                    (__this)
                        as *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                    ::core::ptr::addr_of!((* ext_id)),
                    ::core::ptr::addr_of_mut!((* int_id)),
    ...
    /**Performs a find using @a ext_id as the key.  Must be called with
  /// locks held.*/
    pub unsafe fn find_i_s5eefce432bd60c3e(
        __this: *mut Self,
        mut ext_id: *const *const libc::c_char,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut entry: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___ = unsafe {
                    ::core::mem::zeroed()
                };
                let mut dummy: libc::c_ulong = unsafe { ::core::mem::zeroed() };
                return <ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_>::shared_find(
                    (__this)
                        as *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                    ::core::ptr::addr_of!((* ext_id)),
                    ::core::ptr::addr_of_mut!(entry),
    ...
    pub unsafe fn find_s2f3a8bddccb8d405(
        __this: *const Self,
        mut ext_id: *const *const libc::c_char,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                return <ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_>::find_i_s5eefce432bd60c3e(
                    (nc_this)
                        as *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                    ::core::ptr::addr_of!((* ext_id)),
                );
    ...
    pub unsafe fn close(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                return <ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_>::close_i(
                    (__this)
                        as *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                );
            }
...
impl ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___ {
    ///Key accessor.
    pub unsafe fn key_sddf64e146004ce3c(__this: *mut Self) -> *mut *const libc::c_char {
        extern "C-unwind" {
            #[link_name = "_ZN18ACE_Hash_Map_EntryIPKcP20ACE_Filecache_ObjectE3keyEv"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
            ) -> *mut *const libc::c_char;
        }
        __ext(__this as *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___)
    }
    ///Read-only key accessor.
    pub unsafe fn key_s448f5907a7a63a36(
        __this: *const Self,
    ) -> *const *const libc::c_char {
        extern "C-unwind" {
            #[link_name = "_ZNK18ACE_Hash_Map_EntryIPKcP20ACE_Filecache_ObjectE3keyEv"]
            fn __ext(
                __this: *const ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
            ) -> *const *const libc::c_char;
        }
        __ext(__this as *const ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___)
    }
    ///Item accessor.
    pub unsafe fn item_s217be3247488a5a6(
        __this: *mut Self,
    ) -> *mut *mut ACE_Filecache_Object {
        extern "C-unwind" {
            #[link_name = "_ZN18ACE_Hash_Map_EntryIPKcP20ACE_Filecache_ObjectE4itemEv"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
            ) -> *mut *mut ACE_Filecache_Object;
        }
    ...
    pub unsafe fn item_sb3f3c0ab964b785c(
        __this: *const Self,
    ) -> *const *mut ACE_Filecache_Object {
        extern "C-unwind" {
            #[link_name = "_ZNK18ACE_Hash_Map_EntryIPKcP20ACE_Filecache_ObjectE4itemEv"]
            fn __ext(
                __this: *const ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
            ) -> *const *mut ACE_Filecache_Object;
        }
    ...
    pub unsafe fn dump(__this: *const Self) {
        extern "C-unwind" {
            #[link_name = "_ZNK18ACE_Hash_Map_EntryIPKcP20ACE_Filecache_ObjectE4dumpEv"]
            fn __ext(
                __this: *const ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
            );
        }
    ...
    pub unsafe fn new_at_s7bea9536d140c4aa(
        __this: *mut Self,
        mut ext_id: *const *const libc::c_char,
        mut int_id: *const *mut ACE_Filecache_Object,
        mut next: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
        mut prev: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
    ) {
        unsafe {
            ::core::ptr::write(
                __this,
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).ext_id_),
                ((if (!((*ext_id)).is_null()) {
                    ACE_OS::strdup_u8b6a84c4b070659c(
                        (((*ext_id)) as *const libc::c_char),
                    )
                } else {
                    ACE_OS::strdup_u8b6a84c4b070659c(
                        ((b"\0".as_ptr() as *const libc::c_char) as *const libc::c_char),
                    )
                }) as *const libc::c_char),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).int_id_),
                (((*int_id)) as *mut ACE_Filecache_Object),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).next_),
                ((next) as *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).prev_),
                ((prev) as *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___),
            );
            {}
            ()
        }
    }
    pub unsafe fn new_s7bea9536d140c4aa(
        mut __a0: *const *const libc::c_char,
        mut __a1: *const *mut ACE_Filecache_Object,
        mut __a2: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
        mut __a3: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s7bea9536d140c4aa(
            ::core::ptr::addr_of_mut!(__obj),
            __a0,
            __a1,
            __a2,
    ...
    pub unsafe fn new_at_s4a4d67fe7c61c090(
        __this: *mut Self,
        mut next: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
        mut prev: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
    ) {
    ...
    pub unsafe fn new_s4a4d67fe7c61c090(
        mut __a0: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
        mut __a1: *mut ACE_Hash_Map_Entry_const_char____ACE_Filecache_Object___,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s4a4d67fe7c61c090(::core::ptr::addr_of_mut!(__obj), __a0, __a1);
        __obj
    }
}
impl ACE_Filecache {
    ///Singleton pattern.
    pub unsafe fn instance() -> *mut ACE_Filecache {
        unsafe {
            {
                if (((((ACE_Filecache_cvf_).is_null()) as libc::c_int) as libc::c_int)
                    != 0)
                {
                    let mut lock: *mut ACE_RW_Thread_Mutex = <ACE_Managed_Object_ACE_RW_Thread_Mutex_>::get_preallocated_object(
                        ACE_FILECACHE_LOCK,
                    );
                    let mut ace_mon: ACE_Guard_ACE_RW_Thread_Mutex_ = ::core::mem::MaybeUninit::<
                        ACE_Guard_ACE_RW_Thread_Mutex_,
                    >::zeroed()
                        .assume_init();
                    <ACE_Guard_ACE_RW_Thread_Mutex_>::new_at_s50861607d96ddf5f(
                        (::core::ptr::addr_of_mut!(ace_mon))
                            as *mut ACE_Guard_ACE_RW_Thread_Mutex_,
                        ::core::ptr::addr_of_mut!((* lock)),
                    );
                    if (((((<ACE_Guard_ACE_RW_Thread_Mutex_>::locked(
                        (::core::ptr::addr_of!(ace_mon))
                            as *const ACE_Guard_ACE_RW_Thread_Mutex_,
                    ) as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                        as libc::c_int) != 0)
                    {} else {
                        return ((0) as *mut ACE_Filecache);
                    };
                    if (((((ACE_Filecache_cvf_).is_null()) as libc::c_int)
                        as libc::c_int) != 0)
                    {
                        'dowhile_0: loop {
                            'cont_0: loop {
                                {
                                    {
                                        ACE_Filecache_cvf_ = {
                                            let __new: *mut ACE_Filecache = Box::into_raw(
                                                Box::new(
                                                    ::core::mem::MaybeUninit::<ACE_Filecache>::zeroed()
                                                        .assume_init(),
                                                ),
                                            );
                                            <ACE_Filecache>::new_at((__new) as *mut ACE_Filecache);
                                            __new
                                        };
                                        if (((((ACE_Filecache_cvf_).is_null()) as libc::c_int)
                                            as libc::c_int) != 0)
  ...
  /// or -1 if not.*/
    pub unsafe fn find(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return <ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_>::find_s2f3a8bddccb8d405(
                    (::core::ptr::addr_of!(
                        (* ::core::ptr::addr_of!((* __this).hash_) .cast:: <
                        ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_
                        > ().cast_mut())
                    ))
                        as *const ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                    ::core::ptr::addr_of!(filename),
                );
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
  ...
  /// or create if not.*/
    pub unsafe fn fetch(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut handle: *mut ACE_Filecache_Object = ((0)
                    as *mut ACE_Filecache_Object);
                let mut loc: libc::c_long = (((((ACE::hash_pjw(
                    ((filename) as *const libc::c_char),
                )) as libc::c_ulong)) % (((*__this).size_) as libc::c_ulong))
                    as libc::c_long);
                let mut hashlock: *mut ACE_RW_Thread_Mutex = ::core::ptr::addr_of_mut!(
                    (* ((((* __this).hash_lock_).as_ptr() as * mut ACE_RW_Thread_Mutex)
                    .wrapping_offset((loc) as isize)))
                );
                let mut filelock: *mut ACE_RW_Thread_Mutex = ::core::ptr::addr_of_mut!(
                    (* ((((* __this).file_lock_).as_ptr() as * mut ACE_RW_Thread_Mutex)
                    .wrapping_offset((loc) as isize)))
                );
                <ACE_RW_Mutex>::acquire_read(
                    (::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* (::core::ptr::addr_of_mut!((*
                        filelock)))).__base_0) .cast:: < ACE_RW_Mutex > ().cast_mut())
                    )) as *mut ACE_RW_Mutex,
                );
                if (((((<ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_>::find_s38726ef71bd24f26(
                    (::core::ptr::addr_of!(
                        (* ::core::ptr::addr_of!((* __this).hash_) .cast:: <
                        ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_
                        > ().cast_mut())
                    ...
                    as libc::c_int as libc::c_int) != 0)
                {
                    let mut ace_mon: ACE_Write_Guard_ACE_RW_Thread_Mutex_ = ::core::mem::MaybeUninit::<
                        ACE_Write_Guard_ACE_RW_Thread_Mutex_,
                    >::zeroed()
                        .assume_init();
                    <ACE_Write_Guard_ACE_RW_Thread_Mutex_>::new_at_se40246b82153f867(
                        (::core::ptr::addr_of_mut!(ace_mon))
                            as *mut ACE_Write_Guard_ACE_RW_Thread_Mutex_,
                        ::core::ptr::addr_of_mut!((* hashlock)),
                    );
                    if (((((<ACE_Guard_ACE_RW_Thread_Mutex_>::locked(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* (::core::ptr::addr_of!(ace_mon)))
                            .__base_0) .cast:: < ACE_Guard_ACE_RW_Thread_Mutex_ > ()
                            .cast_mut())
                        )) as *const ACE_Guard_ACE_RW_Thread_Mutex_,
                    ) as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                        as libc::c_int) != 0)
                    {
                        return ((0) as *mut ACE_Filecache_Object);
                    }
                    handle = <ACE_Filecache>::insert_i(
                        (__this) as *mut ACE_Filecache,
                        filename,
                        ::core::ptr::addr_of_mut!((* filelock)),
                        mapit,
                    );
                    if (((((handle).is_null()) as libc::c_int) as libc::c_int) != 0) {
                        <ACE_RW_Mutex>::release(
                            (::core::ptr::addr_of_mut!(
                                (* ::core::ptr::addr_of!((* (::core::ptr::addr_of_mut!((*
                                filelock)))).__base_0) .cast:: < ACE_RW_Mutex > ()
                                .cast_mut())
                            )) as *mut ACE_RW_Mutex,
                        );
                    }
                } else {
                    if ((<ACE_Filecache_Object>::update(
                        (handle) as *const ACE_Filecache_Object,
                    )) != 0)
                    {
                        {
                            let mut ace_mon: ACE_Write_Guard_ACE_RW_Thread_Mutex_ = ::core::mem::MaybeUninit::<
                            ...
                            if (((((<ACE_Guard_ACE_RW_Thread_Mutex_>::locked(
                                (::core::ptr::addr_of!(
                                    (* ::core::ptr::addr_of!((*
                                    (::core::ptr::addr_of!(ace_mon))).__base_0) .cast:: <
                                    ACE_Guard_ACE_RW_Thread_Mutex_ > ().cast_mut())
                                )) as *const ACE_Guard_ACE_RW_Thread_Mutex_,
                            ) as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                                as libc::c_int) != 0)
                            {
                            ...
                            handle = <ACE_Filecache>::update_i(
                                (__this) as *mut ACE_Filecache,
                                filename,
                                ::core::ptr::addr_of_mut!((* filelock)),
                                mapit,
                            );
                            if (((((handle).is_null()) as libc::c_int) as libc::c_int)
                                != 0)
                            {
                                <ACE_RW_Mutex>::release(
                                    (::core::ptr::addr_of_mut!(
    ...
    pub unsafe fn create(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                    ...
                    'cont_0: loop {
                        {
                            {
                                handle = {
                                    let __new: *mut ACE_Filecache_Object = Box::into_raw(
                                        Box::new(
                                            ::core::mem::MaybeUninit::<ACE_Filecache_Object>::zeroed()
                                                .assume_init(),
                                        ),
                                    );
                                    <ACE_Filecache_Object>::new_at_ucae32729405e96dd(
                                        (__new) as *mut ACE_Filecache_Object,
                                        filename,
                                        ((size) as libc::c_long),
                                        ::core::ptr::addr_of_mut!((* filelock)),
                                        0,
                ...
                <ACE_Filecache_Object>::acquire((handle) as *mut ACE_Filecache_Object);
                return handle;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
  ...
  /// was deleted.*/
    pub unsafe fn finish(
        __this: *mut Self,
        mut file: *mut *mut ACE_Filecache_Object,
    ) -> *mut ACE_Filecache_Object {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((((*file)).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    return (*file);
                }
                let mut loc: libc::c_long = (((((ACE::hash_pjw(
                    (((*(*file)).filename_).as_ptr() as *const libc::c_char),
                )) as libc::c_ulong)) % (((*__this).size_) as libc::c_ulong))
                    as libc::c_long);
                let mut hashlock: *mut ACE_RW_Thread_Mutex = ::core::ptr::addr_of_mut!(
                    (* ((((* __this).hash_lock_).as_ptr() as * mut ACE_RW_Thread_Mutex)
                ...
                if ((((!((*file)).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    'switch_0: {
                        let __c: libc::c_int = (*(*file)).action_;
                        #[allow(unused_assignments)]
                        let mut __m: u32 = 1;
                        {
                            let __cv_0: libc::c_int = (2 as libc::c_int);
                            if __c == __cv_0 {
                                __m = 0;
                            }
                        }
                        if __m <= 0 {
                            ...
                            <ACE_Filecache_Object>::release(
                                ((*file)) as *mut ACE_Filecache_Object,
                            );
                            ...
                            if (((*(*file)).stale_) != 0) {
                                if (((((<ACE_RW_Mutex>::tryacquire_write(
                                    (::core::ptr::addr_of_mut!(
                                        (* ::core::ptr::addr_of!((* (::core::ptr::addr_of_mut!((* (*
                                        (* file)).lock_)))).__base_0) .cast:: < ACE_RW_Mutex > ()
                                        .cast_mut())
                                    )) as *mut ACE_RW_Mutex,
                                ) as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                                    as libc::c_int) != 0)
                                {
                                    {
                                        let __d = (*file);
                                        if !__d.is_null() {
                                            let _ = Box::from_raw(__d as *mut ACE_Filecache_Object);
                                        }
                                    };
                                    (*file) = ((0) as *mut ACE_Filecache_Object);
                                }
                            }
                            break 'switch_0;
                        }
    ...
    pub unsafe fn insert_i(
        __this: *mut Self,
        mut filename: *const libc::c_char,
        mut filelock: *mut ACE_RW_Thread_Mutex,
        mut mapit: libc::c_int,
    ) -> *mut ACE_Filecache_Object {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                    ...
                    as libc::c_int as libc::c_int) != 0)
                {
                    ...
                    if (((((<ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_>::bind_sb9853f1396977f1e(
                        (::core::ptr::addr_of_mut!(
                            (* ::core::ptr::addr_of!((* __this).hash_) .cast:: <
                            ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_
                            > ().cast_mut())
                        ...
                        as libc::c_int as libc::c_int) != 0)
                    {
                        ...
                        handle = ((0) as *mut ACE_Filecache_Object);
                    }
                } else {
                    handle = ((0) as *mut ACE_Filecache_Object);
                }
    ...
    pub unsafe fn remove_i(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut handle: *mut ACE_Filecache_Object = ((0)
                    as *mut ACE_Filecache_Object);
                if (((((<ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_>::unbind_s3a899625543d75e7(
                    (::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).hash_) .cast:: <
                        ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_
                        > ().cast_mut())
                    ...
                    as libc::c_int) != 0)
                {
                    ...
                    if (((((<ACE_RW_Mutex>::tryacquire_write(
                        (::core::ptr::addr_of_mut!(
                            (* ::core::ptr::addr_of!((* (::core::ptr::addr_of_mut!((* (*
                            handle).lock_)))).__base_0) .cast:: < ACE_RW_Mutex > ()
                            .cast_mut())
                        )) as *mut ACE_RW_Mutex,
                    ) as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                        as libc::c_int) != 0)
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ...
            <ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_>::new_at_sb5003cedcc930893(
                (::core::ptr::addr_of_mut!((* __this).hash_)
                    .cast::<
                        ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
                    >())
                    as *mut ACE_Hash_Map_Manager_Ex_const_char____ACE_Filecache_Object____ACE_Hash_const_char_____ACE_Equal_To_const_char_____ACE_Null_Mutex_,
...
impl ACE_Cleanup_Adapter_ACE_RW_Thread_Mutex_ {
    ///Default constructor.
    pub unsafe fn new_at_s13e657580333e713(__this: *mut Self) {
        extern "C-unwind" {
            #[link_name = "_ZN19ACE_Cleanup_AdapterI19ACE_RW_Thread_MutexEC1Ev"]
            fn __ext(__this: *mut ACE_Cleanup_Adapter_ACE_RW_Thread_Mutex_);
        }
        __ext(__this as *mut ACE_Cleanup_Adapter_ACE_RW_Thread_Mutex_)
    }
    pub unsafe fn new_s13e657580333e713() -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s13e657580333e713(::core::ptr::addr_of_mut!(__obj));
        __obj
    }
    pub unsafe fn new_at_sc5d8ec6db9eea733(
        __this: *mut Self,
        mut __a0: *const ACE_Cleanup_Adapter_ACE_RW_Thread_Mutex_,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN19ACE_Cleanup_AdapterI19ACE_RW_Thread_MutexEC1ERKS1_"]
            fn __ext(
                __this: *mut ACE_Cleanup_Adapter_ACE_RW_Thread_Mutex_,
                __a0: *const ACE_Cleanup_Adapter_ACE_RW_Thread_Mutex_,
            );
        }
        __ext(__this as *mut ACE_Cleanup_Adapter_ACE_RW_Thread_Mutex_, __a0)
    }
    pub unsafe fn new_sc5d8ec6db9eea733(
        mut __a0: *const ACE_Cleanup_Adapter_ACE_RW_Thread_Mutex_,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_sc5d8ec6db9eea733(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    pub unsafe fn operator_assign(
        __this: *mut Self,
        mut _anon_0: *mut ACE_Cleanup_Adapter_ACE_RW_Thread_Mutex_,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN19ACE_Cleanup_AdapterI19ACE_RW_Thread_MutexEaSERKS1_"]
            fn __ext(
                __this: *mut ACE_Cleanup_Adapter_ACE_RW_Thread_Mutex_,
                _anon_0: *mut ACE_Cleanup_Adapter_ACE_RW_Thread_Mutex_,
            );
        }
        __ext(__this as *mut ACE_Cleanup_Adapter_ACE_RW_Thread_Mutex_, _anon_0)
    }
    ///Accessor for contained object.
    pub unsafe fn object(__this: *mut Self) -> *mut ACE_RW_Thread_Mutex {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
...
impl ACE_Managed_Object_ACE_RW_Thread_Mutex_ {
    pub unsafe fn get_preallocated_array(
        mut identifier: libc::c_uint,
    ) -> *mut ACE_RW_Thread_Mutex {
        unsafe {
            {
                return (((<ACE_Cleanup_Adapter_ACE_RW_Thread_Mutex_>::object(
                    ((((ACE_Object_Manager_preallocated_array)[(identifier) as usize]
                        as *mut ACE_Cleanup_Adapter_ACE_RW_Thread_Mutex_)))
                        as *mut ACE_Cleanup_Adapter_ACE_RW_Thread_Mutex_,
                )) as *mut ACE_RW_Thread_Mutex) as *mut ACE_RW_Thread_Mutex);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    pub unsafe fn new_at_sd1c790b17dffe3da(__this: *mut Self) {
        extern "C-unwind" {
            #[link_name = "_ZN18ACE_Managed_ObjectI19ACE_RW_Thread_MutexEC1Ev"]
            fn __ext(__this: *mut ACE_Managed_Object_ACE_RW_Thread_Mutex_);
        }
        __ext(__this as *mut ACE_Managed_Object_ACE_RW_Thread_Mutex_)
    }
    pub unsafe fn new_sd1c790b17dffe3da() -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_sd1c790b17dffe3da(::core::ptr::addr_of_mut!(__obj));
        __obj
    }
    pub unsafe fn new_at_s1eba8bc08630ced1(
        __this: *mut Self,
        mut __a0: *const ACE_Managed_Object_ACE_RW_Thread_Mutex_,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN18ACE_Managed_ObjectI19ACE_RW_Thread_MutexEC1ERKS1_"]
            fn __ext(
                __this: *mut ACE_Managed_Object_ACE_RW_Thread_Mutex_,
                __a0: *const ACE_Managed_Object_ACE_RW_Thread_Mutex_,
            );
        }
        __ext(__this as *mut ACE_Managed_Object_ACE_RW_Thread_Mutex_, __a0)
    }
    pub unsafe fn new_s1eba8bc08630ced1(
        mut __a0: *const ACE_Managed_Object_ACE_RW_Thread_Mutex_,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s1eba8bc08630ced1(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    pub unsafe fn operator_assign(
        __this: *mut Self,
        mut _anon_0: *mut ACE_Managed_Object_ACE_RW_Thread_Mutex_,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN18ACE_Managed_ObjectI19ACE_RW_Thread_MutexEaSERKS1_"]
            fn __ext(
                __this: *mut ACE_Managed_Object_ACE_RW_Thread_Mutex_,
                _anon_0: *mut ACE_Managed_Object_ACE_RW_Thread_Mutex_,
            );
        }
        __ext(__this as *mut ACE_Managed_Object_ACE_RW_Thread_Mutex_, _anon_0)
    }
        ...
        unsafe {
            {
                return (<ACE_Cleanup_Adapter_ACE_RW_Thread_Mutex_>::object(
                    ((((ACE_Object_Manager_preallocated_object)[(identifier) as usize]
                        as *mut ACE_Cleanup_Adapter_ACE_RW_Thread_Mutex_)))
                        as *mut ACE_Cleanup_Adapter_ACE_RW_Thread_Mutex_,
                )) as *mut ACE_RW_Thread_Mutex;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
}
impl ACE_Guard_ACE_RW_Thread_Mutex_ {
    ///Explicitly acquire the lock.
    pub unsafe fn acquire(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return {
                    let __v = <ACE_RW_Mutex>::acquire(
                        (::core::ptr::addr_of_mut!(
                            (* ::core::ptr::addr_of!((* (* __this).lock_).__base_0)
                            .cast:: < ACE_RW_Mutex > ().cast_mut())
                        )) as *mut ACE_RW_Mutex,
                    );
                    (*__this).owner_ = __v;
                    __v
    ...
    pub unsafe fn new_at_s50861607d96ddf5f(
        __this: *mut Self,
        mut l: *mut ACE_RW_Thread_Mutex,
    ) {
        unsafe {
            ::core::ptr::write(
                __this,
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).lock_),
                ::core::ptr::addr_of_mut!((* l)) as *mut ACE_RW_Thread_Mutex,
            );
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).owner_), 0);
            {
                <ACE_Guard_ACE_RW_Thread_Mutex_>::acquire(
                    (__this) as *mut ACE_Guard_ACE_RW_Thread_Mutex_,
                );
            }
            ()
    ...
    pub unsafe fn new_s50861607d96ddf5f(mut __a0: *mut ACE_RW_Thread_Mutex) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s50861607d96ddf5f(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
  ...
  /// (errno will contain the reason for this).*/
    ...
    pub unsafe fn new_at_sb5b35a9e6045c43b(
        __this: *mut Self,
        mut lock: *mut ACE_RW_Thread_Mutex,
    ) {
        unsafe {
            ...
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).lock_), lock);
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).owner_), 0);
            {}
            ()
        }
    }
    pub unsafe fn new_sb5b35a9e6045c43b(mut __a0: *mut ACE_RW_Thread_Mutex) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_sb5b35a9e6045c43b(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
...
impl ACE_Write_Guard_ACE_RW_Thread_Mutex_ {
    ...
    pub unsafe fn acquire_write(__this: *mut Self) -> libc::c_int {
        unsafe {
            ...
            {
                return {
                    let __v = <ACE_RW_Mutex>::acquire_write(
                        (::core::ptr::addr_of_mut!(
                            (* ::core::ptr::addr_of!((* (* ::core::ptr::addr_of!((*
                            __this).__base_0) .cast:: < ACE_Guard_ACE_RW_Thread_Mutex_ >
                            ().cast_mut()).lock_).__base_0) .cast:: < ACE_RW_Mutex > ()
                            .cast_mut())
                        )) as *mut ACE_RW_Mutex,
                    );
                    (*::core::ptr::addr_of!((* __this).__base_0)
                        .cast::<ACE_Guard_ACE_RW_Thread_Mutex_>()
                        .cast_mut())
                        .owner_ = __v;
                    __v
                };
    ...
    pub unsafe fn new_at_se40246b82153f867(
        __this: *mut Self,
        mut m: *mut ACE_RW_Thread_Mutex,
    ) {
        unsafe {
            ::core::ptr::write(
                __this,
            ...
            <ACE_Guard_ACE_RW_Thread_Mutex_>::new_at_sb5b35a9e6045c43b(
                (::core::ptr::addr_of_mut!((* __this).__base_0)
                    .cast::<ACE_Guard_ACE_RW_Thread_Mutex_>())
                    as *mut ACE_Guard_ACE_RW_Thread_Mutex_,
                ::core::ptr::addr_of_mut!((* m)) as *mut ACE_RW_Thread_Mutex,
            );
            {
                <ACE_Write_Guard_ACE_RW_Thread_Mutex_>::acquire_write(
                    (__this) as *mut ACE_Write_Guard_ACE_RW_Thread_Mutex_,
                );
            }
            ()
        }
    }
    pub unsafe fn new_se40246b82153f867(mut __a0: *mut ACE_RW_Thread_Mutex) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_se40246b82153f867(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
}
...
pub unsafe fn __vdtor_u13e657580333e713(__this: *mut ACE_Cleanup) {
    let _ = Box::from_raw(__this as *mut ACE_Cleanup_Adapter_ACE_RW_Thread_Mutex_);
}
pub static __VTBL_u13e657580333e713: __Vtbl_u13e657580333e713 = __Vtbl_u13e657580333e713 {
    __type_info: &__TYPEINFO_19ACE_Cleanup_Adapter,
    __vdtor: __vdtor_u13e657580333e713,
    vfn_ucaae14a381d74b6a: __vthunk_oucaae14a381d74b6a_iucaae14a381d74b6a,
};
