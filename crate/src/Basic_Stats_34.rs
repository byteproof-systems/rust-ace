...
#[export_name = "_ZN15ACE_Basic_Stats10accumulateERKS_"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Basic_Stats10accumulateERKS_(
    __this: *mut ACE_Basic_Stats,
    rhs: *const ACE_Basic_Stats,
) {
    unsafe { ACE_Basic_Stats::accumulate(__this, rhs) }
}
#[export_name = "_ZNK15ACE_Basic_Stats12dump_resultsEPKcj"]
pub unsafe extern "C-unwind" fn __xtu__ZNK15ACE_Basic_Stats12dump_resultsEPKcj(
    __this: *const ACE_Basic_Stats,
    msg: *const libc::c_char,
    sf: libc::c_uint,
) {
    unsafe { ACE_Basic_Stats::dump_results(__this, msg, sf) }
}
extern "C-unwind" {
...
impl ACE_Basic_Stats {
    ...
    pub unsafe fn accumulate(__this: *mut Self, mut rhs: *const ACE_Basic_Stats) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((((*rhs).samples_count_ as libc::c_uint))
                ...
                if ((((((*__this).samples_count_ as libc::c_uint))
                    == (((0) as libc::c_uint))) as libc::c_int as libc::c_int) != 0)
                {
                    (*__this).min_ = (((*rhs).min_) as libc::c_ulong);
                    (*__this).min_at_ = (((*rhs).min_at_) as libc::c_uint);
                    (*__this).max_ = (((*rhs).max_) as libc::c_ulong);
                    (*__this).max_at_ = (((*rhs).max_at_) as libc::c_uint);
                } else {
                    if ((((((*__this).min_ as libc::c_ulong))
                        > ((((*rhs).min_) as libc::c_ulong))) as libc::c_int
                        as libc::c_int) != 0)
                    {
                        (*__this).min_ = (((*rhs).min_) as libc::c_ulong);
                        (*__this).min_at_ = (((*rhs).min_at_) as libc::c_uint);
                    ...
                    if ((((((*__this).max_ as libc::c_ulong))
                        < ((((*rhs).max_) as libc::c_ulong))) as libc::c_int
                        as libc::c_int) != 0)
                    {
                        (*__this).max_ = (((*rhs).max_) as libc::c_ulong);
                        (*__this).max_at_ = (((*rhs).max_at_) as libc::c_uint);
                ...
                {
                    let __lv = ::core::ptr::addr_of_mut!((* __this).samples_count_);
                    unsafe {
                        *__lv = ((((*__lv)) as libc::c_uint))
                            .wrapping_add(((*rhs).samples_count_) as libc::c_uint);
                        *__lv
                    }
                };
                {
                    ...
                    unsafe {
                        *__lv = ((((*__lv)) as libc::c_ulong))
                            .wrapping_add(((*rhs).sum_) as libc::c_ulong);
                        *__lv
                    }
                };
            }
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((((<ACE_Basic_Stats>::samples_count(
                    (__this) as *const ACE_Basic_Stats,
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/Basic_Stats.cpp\0".as_ptr()
                ...
                let mut avg: libc::c_ulong = ((((*__this).sum_) as libc::c_ulong))
                    / (((*__this).samples_count_) as libc::c_ulong);
                let mut l_min: libc::c_ulong = ((((*__this).min_) as libc::c_ulong))
                    / ((sf) as libc::c_ulong);
                let mut l_max: libc::c_ulong = ((((*__this).max_) as libc::c_ulong))
                    / ((sf) as libc::c_ulong);
                let mut l_avg: libc::c_ulong = (((avg) as libc::c_ulong))
                    / ((sf) as libc::c_ulong);
                'dowhile_1: loop {
                    'cont_1: loop {
                        {
                            {
                                ...
                                <ACE_Log_Category_TSS>::log(
                                    (ace___) as *mut ACE_Log_Category_TSS,
                                    LM_DEBUG,
                                    ((b"%s latency   : %Q[%d]/%Q/%Q[%d] (min/avg/max)\n\0"
