...
#[doc = "* @class ACE_Log_Msg_UNIX_Syslog\n *\n * @brief Implements an ACE_Log_Msg_Backend that logs messages to a UNIX\n * system's syslog facility."]
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Log_Msg_UNIX_Syslog {
    pub __base_0: ::core::mem::ManuallyDrop<ACE_Log_Msg_Backend>,
}
#[export_name = "_ZN23ACE_Log_Msg_UNIX_SyslogC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Log_Msg_UNIX_SyslogC1Ev(
    __this: *mut ACE_Log_Msg_UNIX_Syslog,
) {
    ACE_Log_Msg_UNIX_Syslog::new_at(__this)
}
impl Drop for ACE_Log_Msg_UNIX_Syslog {
    fn drop(&mut self) {
        {
            unsafe {
                let __this: *mut Self = self as *mut Self;
...
#[export_name = "_ZN23ACE_Log_Msg_UNIX_Syslog4openEPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Log_Msg_UNIX_Syslog4openEPKc(
    __this: *mut ACE_Log_Msg_UNIX_Syslog,
    logger_key: *const libc::c_char,
) -> libc::c_int {
    unsafe { ACE_Log_Msg_UNIX_Syslog::open(__this, logger_key) }
}
#[export_name = "_ZN23ACE_Log_Msg_UNIX_Syslog5resetEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Log_Msg_UNIX_Syslog5resetEv(
    __this: *mut ACE_Log_Msg_UNIX_Syslog,
) -> libc::c_int {
    unsafe { ACE_Log_Msg_UNIX_Syslog::reset(__this) }
}
#[export_name = "_ZN23ACE_Log_Msg_UNIX_Syslog5closeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Log_Msg_UNIX_Syslog5closeEv(
    __this: *mut ACE_Log_Msg_UNIX_Syslog,
) -> libc::c_int {
    unsafe { ACE_Log_Msg_UNIX_Syslog::close(__this) }
}
#[export_name = "_ZN23ACE_Log_Msg_UNIX_Syslog3logER14ACE_Log_Record"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Log_Msg_UNIX_Syslog3logER14ACE_Log_Record(
    __this: *mut ACE_Log_Msg_UNIX_Syslog,
    log_record: *mut ACE_Log_Record,
) -> libc::c_long {
    unsafe { ACE_Log_Msg_UNIX_Syslog::log(__this, log_record) }
}
#[export_name = "_ZN23ACE_Log_Msg_UNIX_Syslog20convert_log_priorityEj"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Log_Msg_UNIX_Syslog20convert_log_priorityEj(
    __this: *mut ACE_Log_Msg_UNIX_Syslog,
    lm_priority: libc::c_uint,
) -> libc::c_int {
    unsafe { ACE_Log_Msg_UNIX_Syslog::convert_log_priority(__this, lm_priority) }
}
#[export_name = "_ZN23ACE_Log_Msg_UNIX_Syslog16convert_log_maskEi"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Log_Msg_UNIX_Syslog16convert_log_maskEi(
    __this: *mut ACE_Log_Msg_UNIX_Syslog,
    lm_mask: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_Log_Msg_UNIX_Syslog::convert_log_mask(__this, lm_mask) }
}
#[repr(C)]
...
impl ACE_Log_Msg_UNIX_Syslog {
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ...
            *(__this as *mut *const ()) = &__VTBL_u15e32c1cd39ce8d0
                as *const __Vtbl_u15e32c1cd39ce8d0 as *const ();
            {}
            ()
        }
    }
    ...
    pub unsafe fn open(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((((logger_key).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    logger_key = <ACE_Log_Msg>::program_name();
                }
                openlog(
                    (((logger_key as *mut libc::c_char)) as *const libc::c_char),
                    (((2) as libc::c_int)) | ((1) as libc::c_int),
                    ((((1) as libc::c_int)).wrapping_shl((3) as u32)),
                );
                {
                    let _ = setlogmask(
                        ((((((((1) as libc::c_int))
    ...
    pub unsafe fn log(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut syslog_priority: libc::c_int = <ACE_Log_Msg_UNIX_Syslog>::convert_log_priority(
                    (__this) as *mut ACE_Log_Msg_UNIX_Syslog,
                    <ACE_Log_Record>::r#type(
                        (::core::ptr::addr_of!((* log_record))) as *const ACE_Log_Record,
                    ),
                );
                let mut flags: libc::c_ulong = <ACE_Log_Msg>::flags(
                    (<ACE_Log_Msg>::instance()) as *mut ACE_Log_Msg,
                );
                let mut message: [libc::c_char; 4225usize] = unsafe {
                    ::core::mem::zeroed()
                };
                ...
                let mut strtokp: *mut libc::c_char = ((0) as *mut libc::c_char);
                {
                    let mut line: *mut libc::c_char = ((ACE_OS::strtok_r_u995a2e1f2d66cef7(
                        ((message).as_mut_ptr() as *mut libc::c_char),
                        ((b"\n\0".as_ptr() as *const libc::c_char)
                            as *const libc::c_char),
                        ((::core::ptr::addr_of_mut!(strtokp) as *mut *mut libc::c_char)
                            as *mut *mut libc::c_char),
                    )) as *mut libc::c_char);
                    'for_0: loop {
                        if !(((((!(line).is_null()) as libc::c_int) as libc::c_int)
                            != 0))
                        {
                            break;
                        }
                            ...
                            {
                                {
                                    if (((((((((((((((flags)) as libc::c_ulong))
                                        ...
                                        as libc::c_int) != 0)
                                    {
                                        let mut date_and_time: [libc::c_char; 27usize] = unsafe {
                                            ::core::mem::zeroed()
                                        };
                                        if (((((ACE::timestamp_uedcad69f71820d6a(
                                            ((date_and_time).as_mut_ptr() as *mut libc::c_char),
                                            ...
                                            .is_null()) as libc::c_int) as libc::c_int) != 0)
                                        {
                                            ACE_OS::strcpy_u08e8184bcebbac89(
                                                ((date_and_time).as_mut_ptr() as *mut libc::c_char),
                                                ((b"<time error>\0".as_ptr() as *const libc::c_char)
                                                    as *const libc::c_char),
                                            );
                                        }
                                        let mut prio_name: *const libc::c_char = <ACE_Log_Record>::priority_name(
                                            (<ACE_Log_Record>::r#type(
                        ...
                        {
                            let __v = ((ACE_OS::strtok_r_u995a2e1f2d66cef7(
                                ((0) as *mut libc::c_char),
                                ((b"\n\0".as_ptr() as *const libc::c_char)
                                    as *const libc::c_char),
                                ((::core::ptr::addr_of_mut!(strtokp)
    ...
    pub unsafe fn convert_log_priority(
        __this: *mut Self,
        mut lm_priority: libc::c_uint,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut syslog_priority: libc::c_int = unsafe { ::core::mem::zeroed() };
                'switch_0: {
                    let __c: libc::c_uint = lm_priority;
                    #[allow(unused_assignments)]
                    let mut __m: u32 = 11;
                    {
                        let __cv_0: libc::c_uint = (2 as libc::c_uint);
                        if __c == __cv_0 {
                            __m = 0;
                        }
                    }
                    if __m == 11 {
                        let __cv_1: libc::c_uint = (4 as libc::c_uint);
                        if __c == __cv_1 {
                            __m = 1;
                        }
                    }
                    if __m == 11 {
                        let __cv_2: libc::c_uint = (64 as libc::c_uint);
                        if __c == __cv_2 {
                            __m = 2;
                        }
                    }
                    if __m == 11 {
                        let __cv_3: libc::c_uint = (1 as libc::c_uint);
                        if __c == __cv_3 {
                            __m = 3;
                        }
                    }
                    if __m == 11 {
                        let __cv_4: libc::c_uint = (8 as libc::c_uint);
                        if __c == __cv_4 {
                            __m = 4;
                        }
                    }
                    if __m == 11 {
                        let __cv_5: libc::c_uint = (16 as libc::c_uint);
                        if __c == __cv_5 {
                            __m = 5;
                        }
                    }
                    if __m == 11 {
                        let __cv_6: libc::c_uint = (32 as libc::c_uint);
                        if __c == __cv_6 {
                            __m = 6;
                        }
                    }
                    if __m == 11 {
                        let __cv_7: libc::c_uint = (256 as libc::c_uint);
                        if __c == __cv_7 {
                            __m = 7;
                        }
                    }
                    if __m == 11 {
                        let __cv_8: libc::c_uint = (512 as libc::c_uint);
                        if __c == __cv_8 {
                            __m = 8;
                        }
                    }
                    if __m == 11 {
                        let __cv_9: libc::c_uint = (1024 as libc::c_uint);
                        if __c == __cv_9 {
                            __m = 9;
                        }
                    }
                    if __m == 11 {
                        let __cv_10: libc::c_uint = (128 as libc::c_uint);
                        if __c == __cv_10 {
                            __m = 10;
                        }
                    }
    ...
    pub unsafe fn convert_log_mask(
        __this: *mut Self,
        mut lm_mask: libc::c_int,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut syslog_mask: libc::c_int = 0;
                if (((((((((((((((lm_mask)) as libc::c_int))
                    & (((LM_TRACE)) as libc::c_int)) as libc::c_int))
                    != (((0) as libc::c_int))) as libc::c_int) as libc::c_int) != 0)
                    || (((((((((((lm_mask)) as libc::c_int))
                        & (((LM_DEBUG)) as libc::c_int)) as libc::c_int))
                        != (((0) as libc::c_int))) as libc::c_int) as libc::c_int) != 0))
                    as libc::c_int) as libc::c_int) != 0)
                {
                    ({
                        syslog_mask = (((syslog_mask) as libc::c_int))
                            | (((((((1) as libc::c_int)).wrapping_shl(((7)) as u32))))
                                as libc::c_int);
                        syslog_mask
                    });
                }
                if (((((((((((((((((((lm_mask)) as libc::c_int))
                    & (((LM_STARTUP)) as libc::c_int)) as libc::c_int))
                    != (((0) as libc::c_int))) as libc::c_int) as libc::c_int) != 0)
                    || (((((((((((lm_mask)) as libc::c_int))
                        & (((LM_SHUTDOWN)) as libc::c_int)) as libc::c_int))
                        != (((0) as libc::c_int))) as libc::c_int) as libc::c_int) != 0))
                    as libc::c_int) as libc::c_int) != 0)
                    || (((((((((((lm_mask)) as libc::c_int))
                        & (((LM_INFO)) as libc::c_int)) as libc::c_int))
                        != (((0) as libc::c_int))) as libc::c_int) as libc::c_int) != 0))
                    as libc::c_int) as libc::c_int) != 0)
                {
                    ({
                        syslog_mask = (((syslog_mask) as libc::c_int))
                            | (((((((1) as libc::c_int)).wrapping_shl(((6)) as u32))))
                                as libc::c_int);
                        syslog_mask
                    });
                }
                if (((((((((((lm_mask)) as libc::c_int))
                    & (((LM_NOTICE)) as libc::c_int)) as libc::c_int))
                    != (((0) as libc::c_int))) as libc::c_int) as libc::c_int) != 0)
                {
                    ({
                        syslog_mask = (((syslog_mask) as libc::c_int))
                            | (((((((1) as libc::c_int)).wrapping_shl(((5)) as u32))))
                                as libc::c_int);
                        syslog_mask
                    });
                }
                if (((((((((((lm_mask)) as libc::c_int)) & (((LM_ERROR)) as libc::c_int))
                    as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    ({
                ...
                if (((((((((((lm_mask)) as libc::c_int))
                    & (((LM_WARNING)) as libc::c_int)) as libc::c_int))
                    != (((0) as libc::c_int))) as libc::c_int) as libc::c_int) != 0)
                {
                    ({
                        syslog_mask = (((syslog_mask) as libc::c_int))
                            | (((((((1) as libc::c_int)).wrapping_shl(((4)) as u32))))
                                as libc::c_int);
                        syslog_mask
                    });
                }
                if (((((((((((lm_mask)) as libc::c_int))
                    & (((LM_CRITICAL)) as libc::c_int)) as libc::c_int))
                    != (((0) as libc::c_int))) as libc::c_int) as libc::c_int) != 0)
                {
                    ({
                        syslog_mask = (((syslog_mask) as libc::c_int))
                            | (((((((1) as libc::c_int)).wrapping_shl(((2)) as u32))))
                                as libc::c_int);
                        syslog_mask
                    });
                }
                if (((((((((((lm_mask)) as libc::c_int)) & (((LM_ALERT)) as libc::c_int))
                    as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    ({
                        syslog_mask = (((syslog_mask) as libc::c_int))
                            | (((((((1) as libc::c_int)).wrapping_shl(((1)) as u32))))
                                as libc::c_int);
                        syslog_mask
                    });
                }
                if (((((((((((lm_mask)) as libc::c_int))
                    & (((LM_EMERGENCY)) as libc::c_int)) as libc::c_int))
                    != (((0) as libc::c_int))) as libc::c_int) as libc::c_int) != 0)
                {
                    ({
                        syslog_mask = (((syslog_mask) as libc::c_int))
                            | (((((((1) as libc::c_int)).wrapping_shl(((0)) as u32))))
                                as libc::c_int);
                        syslog_mask
                    });
                }
...
pub unsafe fn __vdtor_u15e32c1cd39ce8d0(__this: *mut ACE_Log_Msg_Backend) {
    let _ = Box::from_raw(__this as *mut ACE_Log_Msg_UNIX_Syslog);
}
pub unsafe fn __vthunk_ou24b4f537639f4bb0_iue9cbb6d7ae11c030(
    __this: *mut ACE_Log_Msg_Backend,
    p0: *const libc::c_char,
) -> libc::c_int {
    <ACE_Log_Msg_UNIX_Syslog>::open((__this as *mut ACE_Log_Msg_UNIX_Syslog), p0)
}
pub unsafe fn __vthunk_ou7e70a174f117a7a6_iu26314720d1e50526(
    __this: *mut ACE_Log_Msg_Backend,
) -> libc::c_int {
    <ACE_Log_Msg_UNIX_Syslog>::reset((__this as *mut ACE_Log_Msg_UNIX_Syslog))
}
pub unsafe fn __vthunk_ou17642ea164c8721b_iubf24d44d4595cf9b(
    __this: *mut ACE_Log_Msg_Backend,
) -> libc::c_int {
    <ACE_Log_Msg_UNIX_Syslog>::close((__this as *mut ACE_Log_Msg_UNIX_Syslog))
}
pub unsafe fn __vthunk_ouaadb8c07b2664069_iued873b4a9e3519e9(
    __this: *mut ACE_Log_Msg_Backend,
    p0: *mut ACE_Log_Record,
) -> libc::c_long {
    <ACE_Log_Msg_UNIX_Syslog>::log((__this as *mut ACE_Log_Msg_UNIX_Syslog), p0)
}
#[repr(C)]
pub struct __Vtbl_u15e32c1cd39ce8d0 {
    pub __type_info: &'static crate::__cxx_std::TypeInfo,
    pub __vdtor: unsafe fn(*mut ACE_Log_Msg_Backend),
    pub vfn_ue9cbb6d7ae11c030: unsafe fn(
        *mut ACE_Log_Msg_Backend,
...
pub static __VTBL_u15e32c1cd39ce8d0: __Vtbl_u15e32c1cd39ce8d0 = __Vtbl_u15e32c1cd39ce8d0 {
    __type_info: &__TYPEINFO_23ACE_Log_Msg_UNIX_Syslog,
    __vdtor: __vdtor_u15e32c1cd39ce8d0,
    vfn_ue9cbb6d7ae11c030: __vthunk_ou24b4f537639f4bb0_iue9cbb6d7ae11c030,
    vfn_u26314720d1e50526: __vthunk_ou7e70a174f117a7a6_iu26314720d1e50526,
    vfn_ubf24d44d4595cf9b: __vthunk_ou17642ea164c8721b_iubf24d44d4595cf9b,
    vfn_ued873b4a9e3519e9: __vthunk_ouaadb8c07b2664069_iued873b4a9e3519e9,
};
