...
pub mod ACE {
    pub mod Monitor_Control {
        ...
        #[export_name = "_ZN3ACE15Monitor_Control14Control_Action7add_refEv"]
        pub unsafe extern "C-unwind" fn __xtu__ZN3ACE15Monitor_Control14Control_Action7add_refEv(
            __this: *mut Control_Action,
        ) {
            unsafe { Control_Action::add_ref(__this) }
        }
        #[export_name = "_ZN3ACE15Monitor_Control14Control_Action10remove_refEv"]
        pub unsafe extern "C-unwind" fn __xtu__ZN3ACE15Monitor_Control14Control_Action10remove_refEv(
            __this: *mut Control_Action,
        ) {
            unsafe { Control_Action::remove_ref(__this) }
        }
        #[export_name = "_ZN3ACE15Monitor_Control14Control_ActionC1Ev"]
        pub unsafe extern "C-unwind" fn __xtu__ZN3ACE15Monitor_Control14Control_ActionC1Ev(
            __this: *mut Control_Action,
        ) {
            Control_Action::new_at(__this)
        }
        impl Drop for Control_Action {
            fn drop(&mut self) {
                {
                    unsafe {
                        let __this: *mut Self = self as *mut Self;
        ...
        impl Control_Action {
            ...
            pub unsafe fn new_at(__this: *mut Self) {
                unsafe {
                    ...
                    <super::super::ACE_Refcountable_T_ACE_Thread_Mutex_>::new_at_s3a4e37fa73761f62(
                    ...
                    *(__this as *mut *const ()) = &super::super::__VTBL_u51d6074b53476d22
                        as *const super::super::__Vtbl_u51d6074b53476d22 as *const ();
                    {}
                    ()
                }
            }
...
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_Refcountable_TI16ACE_Thread_MutexEC1El(
    __this: *mut ACE_Refcountable_T_ACE_Thread_Mutex_,
    __a0: libc::c_long,
) {
    ACE_Refcountable_T_ACE_Thread_Mutex_::new_at_s3a4e37fa73761f62(__this, __a0)
}
impl Drop for ACE_Refcountable_T_ACE_Thread_Mutex_ {
    fn drop(&mut self) {
        unsafe {
            let __this: *mut Self = self as *mut Self;
            {}
...
impl ACE_Refcountable_T_ACE_Thread_Mutex_ {
    ...
    pub unsafe fn new_at_s3a4e37fa73761f62(
        __this: *mut Self,
        mut refcount: libc::c_long,
    ) {
        unsafe {
            ::core::ptr::write(
                __this,
            ...
            *(__this as *mut *const ()) = &__VTBL_u59e7b99390b4a68c
                as *const __Vtbl_u59e7b99390b4a68c as *const ();
