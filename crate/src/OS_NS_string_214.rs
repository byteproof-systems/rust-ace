...
pub mod ACE_OS {
    ...
    #[export_name = "_ZN6ACE_OS16strdup_emulationEPKw"]
    pub unsafe extern "C-unwind" fn strdup_emulation(
        mut s: *const libc::wchar_t,
    ) -> *mut libc::wchar_t {
        unsafe {
            {
                let mut buffer: *mut libc::wchar_t = (malloc_u80646b42522769ca(
                    (((((((((strlen_u07b44aa22513a9ba(s)) as libc::c_ulong))
                        .wrapping_add((1) as libc::c_ulong))) as libc::c_ulong))
                        .wrapping_mul((4) as libc::c_ulong)) as libc::c_ulong),
                ) as *mut libc::wchar_t);
                if (((((buffer).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    return ((0) as *mut libc::wchar_t);
                }
                return strcpy_u7344f334f51e13d1(buffer, s);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
  ...
  /// copied region (char version).*/
    #[export_name = "_ZN6ACE_OS7strecpyEPcPKc"]
    pub unsafe extern "C-unwind" fn strecpy(
        mut s: *mut libc::c_char,
        mut t: *const libc::c_char,
    ) -> *mut libc::c_char {
        unsafe {
            {
                let mut dscan: *mut libc::c_char = s;
                let mut sscan: *const libc::c_char = t;
                'while_0: loop {
                    if !((((((({
                        let __v = (((*({
                            let __lv = &mut (sscan);
  ...
  /// copied region (wchar_t version).*/
    #[export_name = "_ZN6ACE_OS7strecpyEPwPKw"]
    pub unsafe extern "C-unwind" fn strecpy_u35fead064ff3d60e(
        mut s: *mut libc::wchar_t,
        mut t: *const libc::wchar_t,
    ) -> *mut libc::wchar_t {
        unsafe {
            {
                let mut dscan: *mut libc::wchar_t = s;
                let mut sscan: *const libc::wchar_t = t;
                'while_0: loop {
                    if !((((((({
                        let __v = (((*({
                            let __lv = &mut (sscan);
  ...
  /// whose pointer is returned and errno is set to EINVAL.*/
    #[export_name = "_ZN6ACE_OS8strerrorEi"]
    pub unsafe extern "C-unwind" fn strerror_uba489202eb01d03e(
        mut errnum: libc::c_int,
    ) -> *mut libc::c_char {
        unsafe {
            {
                static mut ret_errortext: [libc::c_char; 128usize] = unsafe {
                    ::core::mem::MaybeUninit::<[libc::c_char; 128usize]>::zeroed()
                        .assume_init()
                };
                if ((super::ACE::is_sock_error(errnum) as libc::c_int) != 0) {
                    let mut errortext: *const libc::c_char = super::ACE::sock_error(
                        errnum,
                    );
                    strsncpy(
                        (::core::ptr::addr_of_mut!(ret_errortext) as *mut libc::c_char),
                        ((errortext) as *const libc::c_char),
                        ((::core::mem::size_of::<[libc::c_char; 128usize]>()
                            as libc::c_ulong) as libc::c_ulong),
                    );
                    return (::core::ptr::addr_of_mut!(ret_errortext)
                        as *mut libc::c_char);
                }
                let mut g: super::ACE_Errno_Guard = ::core::mem::MaybeUninit::<
                    super::ACE_Errno_Guard,
                >::zeroed()
                    .assume_init();
                <super::ACE_Errno_Guard>::new_at_u581aee1139351ac3(
                    (::core::ptr::addr_of_mut!(g)) as *mut super::ACE_Errno_Guard,
                    super::__errno_location(),
                );
                ((*(super::__errno_location()))) = 0;
                let mut errmsg: *mut libc::c_char = ((0) as *mut libc::c_char);
                errmsg = super::strerror(errnum);
                if (((((((((((((((*(super::__errno_location()))) as libc::c_int))
                    == (((22) as libc::c_int))) as libc::c_int as libc::c_int) != 0)
                    || (((((errmsg).is_null()) as libc::c_int) as libc::c_int) != 0))
                    as libc::c_int) as libc::c_int) != 0)
                    || ((((((*(errmsg).wrapping_offset((0) as isize)) as libc::c_int))
                    ...
                    as libc::c_int) as libc::c_int) != 0)
                {
                    snprintf_u9a28649a3b771eeb(
                        (::core::ptr::addr_of_mut!(ret_errortext) as *mut libc::c_char),
                        ((128) as libc::c_ulong),
                        ((b"Unknown error %d\0".as_ptr() as *const libc::c_char)
                            as *const libc::c_char),
                        errnum,
                    );
                    errmsg = (::core::ptr::addr_of_mut!(ret_errortext)
                        as *mut libc::c_char);
                    <super::ACE_Errno_Guard>::operator_assign(
                        (::core::ptr::addr_of_mut!(g)) as *mut super::ACE_Errno_Guard,
                        22,
                    );
                }
  ...
  /// whose pointer is returned.*/
    #[export_name = "_ZN6ACE_OS9strsignalEi"]
    pub unsafe extern "C-unwind" fn strsignal_u43542216f9e86286(
        mut signum: libc::c_int,
    ) -> *mut libc::c_char {
        unsafe {
            {
                static mut signal_text: [libc::c_char; 128usize] = unsafe {
                    ::core::mem::MaybeUninit::<[libc::c_char; 128usize]>::zeroed()
                        .assume_init()
                };
                let mut ret_val: *mut libc::c_char = ((0) as *mut libc::c_char);
                ret_val = super::strsignal(signum);
                if ((((((ret_val) as *const u8))
                    <= ((((0 as *mut libc::c_char)) as *const u8))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    snprintf_u9a28649a3b771eeb(
                        (::core::ptr::addr_of_mut!(signal_text) as *mut libc::c_char),
                        ((128) as libc::c_ulong),
                        ((b"Unknown signal: %d\0".as_ptr() as *const libc::c_char)
                            as *const libc::c_char),
                        signum,
                    );
                    ret_val = (::core::ptr::addr_of_mut!(signal_text)
                        as *mut libc::c_char);
                }
                return ret_val;
            }
    ...
    #[export_name = "_ZN6ACE_OS10strerror_rEiPcm"]
    pub unsafe extern "C-unwind" fn strerror_r_u01ae71f59759ac2a(
        mut errnum: libc::c_int,
        mut buf: *mut libc::c_char,
        mut buflen: libc::c_ulong,
    ) -> *mut libc::c_char {
        unsafe {
            {
                return super::strerror_r(errnum, buf, buflen);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
  ...
  /// version).*/
    #[export_name = "_ZN6ACE_OS7strnchrEPKcim"]
    pub unsafe extern "C-unwind" fn strnchr(
                        ...
                        'cont_0: loop {
                            {
                                if ((((((*(s).wrapping_offset((i) as isize))
                                    as libc::c_int)) == (((c) as libc::c_int))) as libc::c_int
                                    as libc::c_int) != 0)
                                {
                                    return (s).wrapping_offset((i) as isize);
                                }
                            }
                            #[allow(unreachable_code)] break 'cont_0;
                        }
  ...
  /// version).*/
    #[export_name = "_ZN6ACE_OS7strnchrEPKwwm"]
    pub unsafe extern "C-unwind" fn strnchr_u49bc8e7dd2ed2fed(
        mut s: *const libc::wchar_t,
        mut c: libc::wchar_t,
        mut len: libc::c_ulong,
    ) -> *const libc::wchar_t {
        unsafe {
            {
                        ...
                        'cont_0: loop {
                            {
                                {
                                    if ((((((*(s).wrapping_offset((i) as isize))
                                        as libc::wchar_t)) == (((c) as libc::wchar_t)))
                                        as libc::c_int as libc::c_int) != 0)
                                    {
                                        return (s).wrapping_offset((i) as isize);
                                    }
                ...
                return ((0) as *const libc::wchar_t);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
  ...
  /// version).*/
    #[export_name = "_ZN6ACE_OS7strnstrEPKcS1_m"]
    pub unsafe extern "C-unwind" fn strnstr(
        mut s1: *const libc::c_char,
        mut s2: *const libc::c_char,
        mut len2: libc::c_ulong,
    ) -> *const libc::c_char {
        unsafe {
            {
                let mut len1: libc::c_ulong = ((strlen_u07dd12a225364fa6(s1))
                    as libc::c_ulong);
                if (((((len2 as libc::c_ulong)) > (((len1) as libc::c_ulong)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    return ((0) as *const libc::c_char);
                }
                let mut len: libc::c_ulong = (((((len1) as libc::c_ulong))
                    .wrapping_sub((len2) as libc::c_ulong)) as libc::c_ulong);
                {
                    let mut i: libc::c_ulong = ((0) as libc::c_ulong);
                    'for_0: loop {
                        if !((((((i as libc::c_ulong)) <= (((len) as libc::c_ulong)))
                        ...
                        'cont_0: loop {
                            {
                                {
                                    if (((((memcmp_u2459c16080f3a32c(
                                        (((s1).wrapping_offset((i) as isize))
                                        ...
                                        as libc::c_int) != 0)
                                    {
                                        return (s1).wrapping_offset((i) as isize);
                                    }
                                }
                            }
                            #[allow(unreachable_code)] break 'cont_0;
  ...
  /// version).*/
    #[export_name = "_ZN6ACE_OS7strnstrEPKwS1_m"]
    pub unsafe extern "C-unwind" fn strnstr_uc392ec1665afec52(
        mut s1: *const libc::wchar_t,
        mut s2: *const libc::wchar_t,
        mut len2: libc::c_ulong,
    ) -> *const libc::wchar_t {
        unsafe {
            {
                let mut len1: libc::c_ulong = ((strlen_u07b44aa22513a9ba(s1))
                    as libc::c_ulong);
                if (((((len2 as libc::c_ulong)) > (((len1) as libc::c_ulong)))
                    as libc::c_int as libc::c_int) != 0)
                {
    ...
    pub unsafe extern "C-unwind" fn strsncpy(
        ...
        unsafe {
            {
                let mut rdst: *mut libc::c_char = dst;
                let mut rsrc: *const libc::c_char = src;
                let mut rmaxlen: libc::c_ulong = maxlen;
                if (((((rmaxlen as libc::c_ulong)) > (((0) as libc::c_ulong)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    if ((((((rdst) as *const u8))
                        != (((((rsrc) as *mut libc::c_char)) as *const u8)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        (*(rdst)) = 0 as libc::c_char;
                        if ((((!(rsrc).is_null()) as libc::c_int) as libc::c_int) != 0) {
                            strncat_u4ca56e9e01c42c12(
                                rdst,
                                rsrc,
                                {
                                    let __lv = &mut (rmaxlen);
    ...
    #[doc = "This is a \"safe\" c string copy function (wchar_t version).\n  /**\n   * Unlike strncpy() this function will always add a terminating '\\0'\n   * char if maxlen > 0.  So the user doesn't has to provide an extra\n   * '\\0' if the user wants a '\\0' terminated dst.  The function\n   * doesn't check for a 0 @a dst, because this will give problems\n   * anyway.  When @a src is 0 an empty string is made.  We do not\n   * \"touch\" * @a dst if maxlen is 0.  Returns @a dst.  Care should be\n   * taken when replacing strncpy() calls, because in some cases a\n   * strncpy() user is using the \"not '\\0' terminating\" feature from\n   * strncpy().  This happens most when the call to strncpy() was\n   * optimized by using a maxlen which is 1 smaller than the size\n   * because there's always written a '\\0' inside this last position.\n   * Very seldom it's possible that the '\\0' padding feature from\n   * strncpy() is needed."]
    #[export_name = "_ZN6ACE_OS8strsncpyEPwPKwm"]
    pub unsafe extern "C-unwind" fn strsncpy_u8a4aa104d1b86cfb(
        mut dst: *mut libc::wchar_t,
        mut src: *const libc::wchar_t,
        mut maxlen: libc::c_ulong,
    ) -> *mut libc::wchar_t {
        unsafe {
            {
                let mut rdst: *mut libc::wchar_t = dst;
                let mut rsrc: *const libc::wchar_t = src;
                let mut rmaxlen: libc::c_ulong = maxlen;
                if (((((rmaxlen as libc::c_ulong)) > (((0) as libc::c_ulong)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    if ((((((rdst) as *const u8))
                        != (((((rsrc) as *mut libc::wchar_t)) as *const u8)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        (*(rdst)) = 0 as libc::wchar_t;
                        if ((((!(rsrc).is_null()) as libc::c_int) as libc::c_int) != 0) {
                            strncat_u63ded26dcfa8694a(
                                rdst,
                                rsrc,
                                {
                                    let __lv = &mut (rmaxlen);
