...
#[export_name = "_ZN33ACE_Connection_Recycling_StrategyC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN33ACE_Connection_Recycling_StrategyC1Ev(
    __this: *mut ACE_Connection_Recycling_Strategy,
) {
    ACE_Connection_Recycling_Strategy::new_at(__this)
}
