...
#[export_name = "_ZNK11ACE_IPC_SAP6enableEi"]
pub unsafe extern "C-unwind" fn __xtu__ZNK11ACE_IPC_SAP6enableEi(
    __this: *const ACE_IPC_SAP,
    value: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_IPC_SAP::enable(__this, value) }
}
#[export_name = "_ZNK11ACE_IPC_SAP7disableEi"]
pub unsafe extern "C-unwind" fn __xtu__ZNK11ACE_IPC_SAP7disableEi(
    __this: *const ACE_IPC_SAP,
    value: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_IPC_SAP::disable(__this, value) }
}
#[export_name = "_ZNK11ACE_IPC_SAP4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK11ACE_IPC_SAP4dumpEv(
    __this: *const ACE_IPC_SAP,
) {
    unsafe { ACE_IPC_SAP::dump(__this) }
}
#[export_name = "_ZN11ACE_IPC_SAPC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_IPC_SAPC1Ev(__this: *mut ACE_IPC_SAP) {
    ACE_IPC_SAP::new_at(__this)
}
extern "C-unwind" {
