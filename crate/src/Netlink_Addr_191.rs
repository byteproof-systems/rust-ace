...
impl Clone for ACE_Netlink_Addr {
    #[inline]
    fn clone(&self) -> Self {
        unsafe { Self::new_u524ab9fa4cf84a28(self as *const Self) }
    }
}
...
#[export_name = "_ZN16ACE_Netlink_AddrC1ERKS_"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_Netlink_AddrC1ERKS_(
    __this: *mut ACE_Netlink_Addr,
    __a0: *const ACE_Netlink_Addr,
) {
    ACE_Netlink_Addr::new_at_u524ab9fa4cf84a28(__this, __a0)
}
#[export_name = "_ZN16ACE_Netlink_AddrC1EPK11sockaddr_nli"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_Netlink_AddrC1EPK11sockaddr_nli(
    __this: *mut ACE_Netlink_Addr,
    __a0: *const sockaddr_nl,
    __a1: libc::c_int,
) {
    ACE_Netlink_Addr::new_at_u2c36fe56e3ff601f(__this, __a0, __a1)
}
...
#[export_name = "_ZN16ACE_Netlink_Addr3setERKS_"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_Netlink_Addr3setERKS_(
    __this: *mut ACE_Netlink_Addr,
    sa: *const ACE_Netlink_Addr,
) -> libc::c_int {
    unsafe { ACE_Netlink_Addr::set(__this, sa) }
}
#[export_name = "_ZN16ACE_Netlink_Addr3setEPK11sockaddr_nli"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_Netlink_Addr3setEPK11sockaddr_nli(
    __this: *mut ACE_Netlink_Addr,
    un: *const sockaddr_nl,
    len: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_Netlink_Addr::set_u923be2e9f5210c16(__this, un, len) }
}
#[export_name = "_ZNK16ACE_Netlink_Addr7get_pidEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK16ACE_Netlink_Addr7get_pidEv(
    __this: *const ACE_Netlink_Addr,
) -> libc::c_int {
    unsafe { ACE_Netlink_Addr::get_pid(__this) }
}
#[export_name = "_ZNK16ACE_Netlink_Addr7get_gidEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK16ACE_Netlink_Addr7get_gidEv(
    __this: *const ACE_Netlink_Addr,
) -> libc::c_int {
    unsafe { ACE_Netlink_Addr::get_gid(__this) }
}
extern "C-unwind" {
...
impl ACE_Netlink_Addr {
    ...
    pub unsafe fn new_at_u524ab9fa4cf84a28(
        ...
        unsafe {
            ...
            *(__this as *mut *const ()) = &__VTBL_uffaef866901fe51c
                as *const __Vtbl_uffaef866901fe51c as *const ();
            {
                <ACE_Netlink_Addr>::set(
                    (__this) as *mut ACE_Netlink_Addr,
                    ::core::ptr::addr_of!((* sa)),
                );
            }
            ()
    ...
    pub unsafe fn new_at_u2c36fe56e3ff601f(
        ...
        unsafe {
            ...
            *(__this as *mut *const ()) = &__VTBL_uffaef866901fe51c
                as *const __Vtbl_uffaef866901fe51c as *const ();
            {
                <ACE_Netlink_Addr>::set_u923be2e9f5210c16(
                    (__this) as *mut ACE_Netlink_Addr,
                    un,
                    len,
                );
    ...
    pub unsafe fn get_pid(__this: *const Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((*__this).nl_.nl_pid) as libc::c_int);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    ...
    pub unsafe fn get_gid(__this: *const Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((*__this).nl_.nl_groups) as libc::c_int);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
