...
#[allow(non_upper_case_globals)]
#[no_mangle]
pub static mut ACE_Thread_Exit_is_constructed_: bool = false;
...
#[export_name = "_ZN15ACE_Thread_ExitC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Thread_ExitC1Ev(
    __this: *mut ACE_Thread_Exit,
) {
    ACE_Thread_Exit::new_at(__this)
}
#[export_name = "_ZN15ACE_Thread_Exit7thr_mgrEP18ACE_Thread_Manager"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Thread_Exit7thr_mgrEP18ACE_Thread_Manager(
    __this: *mut ACE_Thread_Exit,
    tm: *mut ACE_Thread_Manager,
) {
    unsafe { ACE_Thread_Exit::thr_mgr(__this, tm) }
}
impl Drop for ACE_Thread_Exit {
    fn drop(&mut self) {
        ...
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.thread_control_);
        }
    }
}
#[export_name = "__acedtor_u074d11dd58b5bebc"]
pub unsafe extern "C-unwind" fn __acedtor_u074d11dd58b5bebc(
    __this: *mut ACE_Thread_Exit,
) {
    unsafe {
...
#[export_name = "_ZN15ACE_Thread_Exit8instanceEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Thread_Exit8instanceEv() -> *mut ACE_Thread_Exit {
    unsafe { ACE_Thread_Exit::instance() }
}
#[export_name = "_ZN15ACE_Thread_Exit7cleanupEPv"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Thread_Exit7cleanupEPv(
    instance: *mut libc::c_void,
) {
    unsafe { ACE_Thread_Exit::cleanup(instance) }
}
...
#[export_name = "_ZN21ACE_Thread_Exit_MaybeC1Ei"]
pub unsafe extern "C-unwind" fn __xtu__ZN21ACE_Thread_Exit_MaybeC1Ei(
    __this: *mut ACE_Thread_Exit_Maybe,
    __a0: libc::c_int,
) {
    ACE_Thread_Exit_Maybe::new_at(__this, __a0)
}
impl Drop for ACE_Thread_Exit_Maybe {
    fn drop(&mut self) {
        unsafe {
            ...
            {
                {
                    let __d = (*__this).instance_;
                    if !__d.is_null() {
                        let _ = Box::from_raw(__d as *mut ACE_Thread_Exit);
                    }
                };
            }
            ()
...
#[export_name = "__acedtor_u483535fe513547f7"]
pub unsafe extern "C-unwind" fn __acedtor_u483535fe513547f7(
    __this: *mut ACE_Thread_Exit_Maybe,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[export_name = "_ZNK21ACE_Thread_Exit_MaybeptEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK21ACE_Thread_Exit_MaybeptEv(
    __this: *const ACE_Thread_Exit_Maybe,
) -> *mut ACE_Thread_Exit {
    unsafe { ACE_Thread_Exit_Maybe::operator_arrow(__this) }
}
#[export_name = "_ZNK21ACE_Thread_Exit_Maybe8instanceEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK21ACE_Thread_Exit_Maybe8instanceEv(
    __this: *const ACE_Thread_Exit_Maybe,
) -> *mut ACE_Thread_Exit {
    unsafe { ACE_Thread_Exit_Maybe::instance(__this) }
}
#[repr(C)]
#[derive(Clone)]
...
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Cleanup_Adapter_ACE_Thread_Mutex_ {
    pub __base_0: ::core::mem::ManuallyDrop<ACE_Cleanup>,
    pub object_: ::core::mem::ManuallyDrop<ACE_Thread_Mutex>,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ACE_Managed_Object_ACE_Thread_Mutex_ {}
...
#[export_name = "_ZN7ACE_TSSI15ACE_Thread_ExitE7cleanupEPv"]
pub unsafe extern "C-unwind" fn __xtu__ZN7ACE_TSSI15ACE_Thread_ExitE7cleanupEPv(
    ptr: *mut libc::c_void,
) {
    unsafe { ACE_TSS_ACE_Thread_Exit_::cleanup(ptr) }
}
#[export_name = "_ZN7ACE_TSSI15ACE_Thread_ExitE7ts_initEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN7ACE_TSSI15ACE_Thread_ExitE7ts_initEv(
    __this: *mut ACE_TSS_ACE_Thread_Exit_,
) -> libc::c_int {
    unsafe { ACE_TSS_ACE_Thread_Exit_::ts_init(__this) }
}
#[export_name = "_ZN7ACE_TSSI15ACE_Thread_ExitEC1EPS0_"]
pub unsafe extern "C-unwind" fn __xtu__ZN7ACE_TSSI15ACE_Thread_ExitEC1EPS0_(
    __this: *mut ACE_TSS_ACE_Thread_Exit_,
    __a0: *mut ACE_Thread_Exit,
) {
    ACE_TSS_ACE_Thread_Exit_::new_at_s2e13302b8b028b5e(__this, __a0)
}
#[export_name = "_ZNK7ACE_TSSI15ACE_Thread_ExitE13make_TSS_TYPEEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK7ACE_TSSI15ACE_Thread_ExitE13make_TSS_TYPEEv(
    __this: *const ACE_TSS_ACE_Thread_Exit_,
) -> *mut ACE_Thread_Exit {
    unsafe { ACE_TSS_ACE_Thread_Exit_::make_TSS_TYPE(__this) }
}
#[export_name = "_ZNK7ACE_TSSI15ACE_Thread_ExitE6ts_getEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK7ACE_TSSI15ACE_Thread_ExitE6ts_getEv(
    __this: *const ACE_TSS_ACE_Thread_Exit_,
) -> *mut ACE_Thread_Exit {
    unsafe { ACE_TSS_ACE_Thread_Exit_::ts_get(__this) }
}
#[export_name = "_ZNK7ACE_TSSI15ACE_Thread_ExitEcvPS0_Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZNK7ACE_TSSI15ACE_Thread_ExitEcvPS0_Ev(
    __this: *const ACE_TSS_ACE_Thread_Exit_,
) -> *mut ACE_Thread_Exit {
    unsafe { ACE_TSS_ACE_Thread_Exit_::operator_ACE_Thread_Exit__(__this) }
}
impl Drop for ACE_TSS_ACE_Thread_Exit_ {
    fn drop(&mut self) {
        {
            unsafe {
                let __this: *mut Self = self as *mut Self;
                {
                    if ((unsafe {
                        ::core::ptr::read_volatile(
                            ::core::ptr::addr_of!((* __this).once_),
                        )
                    } as libc::c_int) != 0)
                    {
                        let mut ts_obj: *mut ACE_Thread_Exit = <ACE_TSS_ACE_Thread_Exit_>::ts_value_s0c185e6b87458dce(
                            (__this) as *const ACE_TSS_ACE_Thread_Exit_,
                        );
                        <ACE_TSS_ACE_Thread_Exit_>::ts_value_sda86fd50308b226d(
                            (__this) as *const ACE_TSS_ACE_Thread_Exit_,
                            ((0) as *mut ACE_Thread_Exit),
                        );
                        <ACE_TSS_ACE_Thread_Exit_>::cleanup(
                            ((ts_obj) as *mut libc::c_void),
                        );
                        ACE_OS::thr_key_detach((*__this).key_);
                        ACE_OS::thr_keyfree((*__this).key_);
                    }
                }
                ()
            }
        ...
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.keylock_);
        }
    }
}
extern "C" {
...
impl ACE_Thread_Exit {
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ...
            <ACE_Thread_Control>::new_at(
                ::core::ptr::addr_of_mut!((* __this).thread_control_)
                    .cast::<ACE_Thread_Control>(),
                ((0) as *mut ACE_Thread_Manager),
                0,
            );
            {}
            ()
    ...
    pub unsafe fn thr_mgr(__this: *mut Self, mut tm: *mut ACE_Thread_Manager) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((!(tm).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    <ACE_Thread_Control>::insert(
                        (::core::ptr::addr_of_mut!(
                            (* ::core::ptr::addr_of!((* __this).thread_control_) .cast::
                            < ACE_Thread_Control > ().cast_mut())
                        )) as *mut ACE_Thread_Control,
                        tm,
                        ((0) != 0),
                    );
                }
    ...
    pub unsafe fn instance() -> *mut ACE_Thread_Exit {
        unsafe {
            {
                static mut instance_: *mut ACE_TSS_ACE_Thread_Exit_ = unsafe {
                    ::core::mem::MaybeUninit::<*mut ACE_TSS_ACE_Thread_Exit_>::zeroed()
                        .assume_init()
                };
                if (((!(((ACE_Thread_Exit_is_constructed_ as libc::c_int) != 0))
                    as libc::c_int) as libc::c_int) != 0)
                {
                    let mut lock: *mut ACE_Thread_Mutex = <ACE_Managed_Object_ACE_Thread_Mutex_>::get_preallocated_object(
                    ...
                    if (((((<ACE_Guard_ACE_Thread_Mutex_>::locked(
                        ...
                        as libc::c_int) != 0)
                    {} else {
                        return ((0) as *mut ACE_Thread_Exit);
                    };
                    if (((!(((ACE_Thread_Exit_is_constructed_ as libc::c_int) != 0))
                        as libc::c_int) as libc::c_int) != 0)
                    {
                                ...
                                {
                                    {
                                        unsafe {
                                            ::core::ptr::write_volatile(
                                                ::core::ptr::addr_of_mut!(instance_),
                                                (({
                                                    let __new: *mut ACE_TSS_ACE_Thread_Exit_ = Box::into_raw(
                                                        Box::new(
                                                            ::core::mem::MaybeUninit::<
                                                                ACE_TSS_ACE_Thread_Exit_,
                                                            >::zeroed()
                                                                .assume_init(),
                                                        ),
                                                    );
                                                    <ACE_TSS_ACE_Thread_Exit_>::new_at_s2e13302b8b028b5e(
                                                        (__new) as *mut ACE_TSS_ACE_Thread_Exit_,
                                                        ((0) as *mut ACE_Thread_Exit),
                                                    );
                                                    __new
                                                }) as *mut ACE_TSS_ACE_Thread_Exit_),
                                            );
                                        }
                                        if (((((unsafe {
                                            ::core::ptr::read_volatile(::core::ptr::addr_of!(instance_))
                                        })
                        ...
                        ACE_Thread_Exit_is_constructed_ = true;
                        <ACE_Thread_Manager>::set_thr_exit(
                            ((unsafe {
                                ::core::ptr::read_volatile(::core::ptr::addr_of!(instance_))
                            }) as *mut ACE_TSS_ACE_Thread_Exit_),
                        );
                ...
                return (<ACE_TSS_ACE_Thread_Exit_>::operator_ACE_Thread_Exit__(
                    (unsafe {
                        ::core::ptr::read_volatile(::core::ptr::addr_of!(instance_))
                    }) as *const ACE_TSS_ACE_Thread_Exit_,
                ));
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
  ...
  /// singleton.*/
    pub unsafe fn cleanup(mut instance: *mut libc::c_void) {
        unsafe {
            {
                {
                    let __p = (instance as *mut ACE_TSS_ACE_Thread_Exit_);
                    if !__p.is_null() {
                        let __vt: *const __Vtbl_u58e65c3375bedb5c = *(__p
                            as *const *const __Vtbl_u58e65c3375bedb5c);
                        ((*__vt).__vdtor)(__p as *mut ACE_TSS_ACE_Thread_Exit_);
                    }
                };
                ACE_Thread_Manager_thr_exit_ = ((0) as *mut ACE_TSS_ACE_Thread_Exit_);
                ACE_Thread_Exit_is_constructed_ = false;
            }
            ()
        }
    }
...
impl ACE_Thread_Exit_Maybe {
    ...
    pub unsafe fn new_at(__this: *mut Self, mut flag: libc::c_int) {
        unsafe {
            ::core::ptr::write(
                __this,
                ::core::mem::MaybeUninit::<Self>::zeroed().assume_init(),
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).instance_),
                ((0) as *mut ACE_Thread_Exit),
            );
            {
                if ((flag) != 0) {
                        ...
                        'cont_0: loop {
                            {
                                {
                                    (*__this).instance_ = {
                                        let __new: *mut ACE_Thread_Exit = Box::into_raw(
                                            Box::new(
                                                ::core::mem::MaybeUninit::<ACE_Thread_Exit>::zeroed()
                                                    .assume_init(),
                                            ),
                                        );
                                        <ACE_Thread_Exit>::new_at((__new) as *mut ACE_Thread_Exit);
                                        __new
                                    };
                                    if ((((((*__this).instance_).is_null()) as libc::c_int)
                                        as libc::c_int) != 0)
                                    {
                                        ((*(__errno_location()))) = 12;
                                        return;
    ...
    pub unsafe fn operator_arrow(__this: *const Self) -> *mut ACE_Thread_Exit {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((*__this).instance_) as *mut ACE_Thread_Exit);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
...
impl ACE_TSS_ACE_Thread_Exit_ {
    ...
    pub unsafe fn dump(__this: *const Self) {
        extern "C-unwind" {
            #[link_name = "_ZNK7ACE_TSSI15ACE_Thread_ExitE4dumpEv"]
            fn __ext(__this: *const ACE_TSS_ACE_Thread_Exit_);
        }
        __ext(__this as *const ACE_TSS_ACE_Thread_Exit_)
    }
    ///"Destructor" that deletes internal TYPE * when thread exits.
    pub unsafe fn cleanup(mut ptr: *mut libc::c_void) {
        unsafe {
            {
                {
                    let __d = (ptr as *mut ACE_Thread_Exit);
                    if !__d.is_null() {
                        let _ = Box::from_raw(__d as *mut ACE_Thread_Exit);
                    }
                };
  ...
  /// called with the lock held...*/
    pub unsafe fn ts_init(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut ace_mon: ACE_Guard_ACE_Thread_Mutex_ = ::core::mem::MaybeUninit::<
                ...
                <ACE_Guard_ACE_Thread_Mutex_>::new_at_s194b481c4e491c25(
                    (::core::ptr::addr_of_mut!(ace_mon))
                        as *mut ACE_Guard_ACE_Thread_Mutex_,
                    ::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).keylock_) .cast:: <
                        ACE_Thread_Mutex > ().cast_mut())
                    ),
                );
                if (((((<ACE_Guard_ACE_Thread_Mutex_>::locked(
                ...
                if (((!(((unsafe {
                    ::core::ptr::read_volatile(::core::ptr::addr_of!((* __this).once_))
                } as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
                {
                    if (((((<ACE_Thread>::keycreate(
                        ::core::ptr::addr_of_mut!((* __this).key_) as *mut libc::c_uint,
                        Some({
                            unsafe extern "C-unwind" fn __shim(a0: *mut libc::c_void) {
                                unsafe { ACE_TSS_ACE_Thread_Exit_::cleanup(a0) }
                            }
                            __shim as unsafe extern "C-unwind" fn(*mut libc::c_void)
                        }),
                    ) as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                        as libc::c_int) != 0)
                    {
                        ...
                        unsafe {
                            ::core::ptr::write_volatile(
                                ::core::ptr::addr_of_mut!((* __this).once_),
                                ((true) as bool),
                            );
                        }
                        return 0;
    ...
    pub unsafe fn ts_value_sda86fd50308b226d(
        __this: *const Self,
        mut new_ts_obj: *mut ACE_Thread_Exit,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((((<ACE_Thread>::setspecific(
                    (((*__this).key_) as libc::c_uint),
                    (new_ts_obj as *mut libc::c_void),
                ) as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    'dowhile_0: loop {
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/TSS_T.inl\0".as_ptr()
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        b"Error: ACE_Thread::setspecific() failed!\0".as_ptr()
                                            as *const libc::c_char,
                                    );
                                }
                            }
    ...
    pub unsafe fn new_at_s2e13302b8b028b5e(
        ...
        unsafe {
            ...
            <ACE_Copy_Disabled>::new_at(::core::ptr::addr_of_mut!((* __this).__base_0));
            *(__this as *mut *const ()) = &__VTBL_u58e65c3375bedb5c
                as *const __Vtbl_u58e65c3375bedb5c as *const ();
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).once_),
                ((false) as bool),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).key_),
                ACE_OS::NULL_key,
            );
            <ACE_Thread_Mutex>::new_at(
                ::core::ptr::addr_of_mut!((* __this).keylock_)
                    .cast::<ACE_Thread_Mutex>(),
                ((0) as *const libc::c_char),
                ((0) as *mut pthread_mutexattr_t),
            );
            {
                if ((((!(ts_obj).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    if (((((<ACE_TSS_ACE_Thread_Exit_>::ts_init(
                        (__this) as *mut ACE_TSS_ACE_Thread_Exit_,
                    ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        let mut error: ACE_Errno_Guard = ::core::mem::MaybeUninit::<
                            ACE_Errno_Guard,
                        >::zeroed()
                            .assume_init();
                        <ACE_Errno_Guard>::new_at_u581aee1139351ac3(
                            (::core::ptr::addr_of_mut!(error)) as *mut ACE_Errno_Guard,
                            __errno_location(),
                        );
                        ACE_OS::fprintf_u7a83295f0e5d324f(
                            stderr,
                            ((b"ACE_Thread::keycreate() failed!\0".as_ptr()
                                as *const libc::c_char) as *const libc::c_char),
                        );
                        return;
                    }
    ...
    pub unsafe fn new_s2e13302b8b028b5e(mut __a0: *mut ACE_Thread_Exit) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s2e13302b8b028b5e(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    pub unsafe fn ts_value_s0c185e6b87458dce(
        __this: *const Self,
    ) -> *mut ACE_Thread_Exit {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                if (((((<ACE_Thread>::getspecific(
                    (((*__this).key_) as libc::c_uint),
                    ::core::ptr::addr_of_mut!(temp) as *mut *mut libc::c_void,
                ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    return ((0) as *mut ACE_Thread_Exit);
                }
                return (temp as *mut ACE_Thread_Exit);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    ///Hook for construction parameters.
    pub unsafe fn make_TSS_TYPE(__this: *const Self) -> *mut ACE_Thread_Exit {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut temp: *mut ACE_Thread_Exit = ((0) as *mut ACE_Thread_Exit);
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            {
  ...
  /// thread-specific storage.*/
    pub unsafe fn ts_get(__this: *const Self) -> *mut ACE_Thread_Exit {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((!(((unsafe {
                ...
                let mut ts_obj: *mut ACE_Thread_Exit = ((0) as *mut ACE_Thread_Exit);
                ts_obj = <ACE_TSS_ACE_Thread_Exit_>::ts_value_s0c185e6b87458dce(
                    (__this) as *const ACE_TSS_ACE_Thread_Exit_,
                );
                if (((((ts_obj).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    ts_obj = {
                        let __obj: *mut ACE_TSS_ACE_Thread_Exit_ = (__this)
                            as *mut ACE_TSS_ACE_Thread_Exit_;
                        let __vt: *const __Vtbl_u58e65c3375bedb5c = *(__obj
                            as *const *const __Vtbl_u58e65c3375bedb5c);
                        ((*__vt).vfn_u3af80ff543ce307a)(__obj)
                    };
                    if (((((ts_obj).is_null()) as libc::c_int) as libc::c_int) != 0) {
                        return ((0) as *mut ACE_Thread_Exit);
                    }
                    if (((((<ACE_TSS_ACE_Thread_Exit_>::ts_value_sda86fd50308b226d(
                        (__this) as *const ACE_TSS_ACE_Thread_Exit_,
                        ts_obj,
                    ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
    ...
    #[doc = "* Obtain a pointer to the calling thread's TYPE object.\n   * If this ACE_TSS object hasn't been initialized, this method\n   * will initialize it as a side-affect. If the calling thread has not\n   * set a value, a default-constructed instance of TYPE is allocated and it\n   * becomes the thread's instance.\n   *\n   * @return  The calling thread's copy of the data. The returned pointer\n   *          may be 0 under odd error conditions; check errno for further\n   *          information."]
    pub unsafe fn operator_ACE_Thread_Exit__(
        __this: *const Self,
    ) -> *mut ACE_Thread_Exit {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return <ACE_TSS_ACE_Thread_Exit_>::ts_get(
                    (__this) as *const ACE_TSS_ACE_Thread_Exit_,
                );
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
...
impl ACE_Cleanup_Adapter_ACE_Thread_Mutex_ {
    ///Default constructor.
    pub unsafe fn new_at_sdc41ded67eb0f795(__this: *mut Self) {
        extern "C-unwind" {
            #[link_name = "_ZN19ACE_Cleanup_AdapterI16ACE_Thread_MutexEC1Ev"]
            fn __ext(__this: *mut ACE_Cleanup_Adapter_ACE_Thread_Mutex_);
        }
        __ext(__this as *mut ACE_Cleanup_Adapter_ACE_Thread_Mutex_)
    }
    pub unsafe fn new_sdc41ded67eb0f795() -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_sdc41ded67eb0f795(::core::ptr::addr_of_mut!(__obj));
        __obj
    }
    pub unsafe fn new_at_s314441133da85abb(
        __this: *mut Self,
        mut __a0: *const ACE_Cleanup_Adapter_ACE_Thread_Mutex_,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN19ACE_Cleanup_AdapterI16ACE_Thread_MutexEC1ERKS1_"]
            fn __ext(
                __this: *mut ACE_Cleanup_Adapter_ACE_Thread_Mutex_,
                __a0: *const ACE_Cleanup_Adapter_ACE_Thread_Mutex_,
            );
        }
        __ext(__this as *mut ACE_Cleanup_Adapter_ACE_Thread_Mutex_, __a0)
    }
    pub unsafe fn new_s314441133da85abb(
        mut __a0: *const ACE_Cleanup_Adapter_ACE_Thread_Mutex_,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s314441133da85abb(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    pub unsafe fn operator_assign(
        __this: *mut Self,
        mut _anon_0: *mut ACE_Cleanup_Adapter_ACE_Thread_Mutex_,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN19ACE_Cleanup_AdapterI16ACE_Thread_MutexEaSERKS1_"]
            fn __ext(
                __this: *mut ACE_Cleanup_Adapter_ACE_Thread_Mutex_,
                _anon_0: *mut ACE_Cleanup_Adapter_ACE_Thread_Mutex_,
            );
        }
        __ext(__this as *mut ACE_Cleanup_Adapter_ACE_Thread_Mutex_, _anon_0)
    }
    ///Accessor for contained object.
    pub unsafe fn object(__this: *mut Self) -> *mut ACE_Thread_Mutex {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return ::core::ptr::addr_of_mut!(
                    (* ::core::ptr::addr_of!((* __this).object_) .cast:: <
                    ACE_Thread_Mutex > ().cast_mut())
                );
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
...
impl ACE_Managed_Object_ACE_Thread_Mutex_ {
    pub unsafe fn get_preallocated_array(
        mut identifier: libc::c_uint,
    ) -> *mut ACE_Thread_Mutex {
        unsafe {
            {
                return (((<ACE_Cleanup_Adapter_ACE_Thread_Mutex_>::object(
                    ((((ACE_Object_Manager_preallocated_array)[(identifier) as usize]
                        as *mut ACE_Cleanup_Adapter_ACE_Thread_Mutex_)))
                        as *mut ACE_Cleanup_Adapter_ACE_Thread_Mutex_,
                )) as *mut ACE_Thread_Mutex) as *mut ACE_Thread_Mutex);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    pub unsafe fn new_at_s9c174016ac872aee(__this: *mut Self) {
        extern "C-unwind" {
            #[link_name = "_ZN18ACE_Managed_ObjectI16ACE_Thread_MutexEC1Ev"]
            fn __ext(__this: *mut ACE_Managed_Object_ACE_Thread_Mutex_);
        }
        __ext(__this as *mut ACE_Managed_Object_ACE_Thread_Mutex_)
    }
    pub unsafe fn new_s9c174016ac872aee() -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s9c174016ac872aee(::core::ptr::addr_of_mut!(__obj));
        __obj
    }
    pub unsafe fn new_at_sa62730595f0c06af(
        __this: *mut Self,
        mut __a0: *const ACE_Managed_Object_ACE_Thread_Mutex_,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN18ACE_Managed_ObjectI16ACE_Thread_MutexEC1ERKS1_"]
            fn __ext(
                __this: *mut ACE_Managed_Object_ACE_Thread_Mutex_,
                __a0: *const ACE_Managed_Object_ACE_Thread_Mutex_,
            );
        }
        __ext(__this as *mut ACE_Managed_Object_ACE_Thread_Mutex_, __a0)
    }
    pub unsafe fn new_sa62730595f0c06af(
        mut __a0: *const ACE_Managed_Object_ACE_Thread_Mutex_,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_sa62730595f0c06af(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    pub unsafe fn operator_assign(
        __this: *mut Self,
        mut _anon_0: *mut ACE_Managed_Object_ACE_Thread_Mutex_,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN18ACE_Managed_ObjectI16ACE_Thread_MutexEaSERKS1_"]
            fn __ext(
                __this: *mut ACE_Managed_Object_ACE_Thread_Mutex_,
                _anon_0: *mut ACE_Managed_Object_ACE_Thread_Mutex_,
            );
        }
        __ext(__this as *mut ACE_Managed_Object_ACE_Thread_Mutex_, _anon_0)
    }
    pub unsafe fn get_preallocated_object(
        mut identifier: libc::c_uint,
    ) -> *mut ACE_Thread_Mutex {
        unsafe {
            {
                return (<ACE_Cleanup_Adapter_ACE_Thread_Mutex_>::object(
                    ((((ACE_Object_Manager_preallocated_object)[(identifier) as usize]
                        as *mut ACE_Cleanup_Adapter_ACE_Thread_Mutex_)))
                        as *mut ACE_Cleanup_Adapter_ACE_Thread_Mutex_,
                )) as *mut ACE_Thread_Mutex;
            }
...
pub unsafe fn __vdtor_udc41ded67eb0f795(__this: *mut ACE_Cleanup) {
    let _ = Box::from_raw(__this as *mut ACE_Cleanup_Adapter_ACE_Thread_Mutex_);
}
pub static __VTBL_udc41ded67eb0f795: __Vtbl_udc41ded67eb0f795 = __Vtbl_udc41ded67eb0f795 {
    __type_info: &__TYPEINFO_19ACE_Cleanup_Adapter,
    __vdtor: __vdtor_udc41ded67eb0f795,
    vfn_ucaae14a381d74b6a: __vthunk_oucaae14a381d74b6a_iucaae14a381d74b6a,
};
...
pub unsafe fn __vdtor_u58e65c3375bedb5c(__this: *mut ACE_TSS_ACE_Thread_Exit_) {
    let _ = Box::from_raw(__this as *mut ACE_TSS_ACE_Thread_Exit_);
}
pub unsafe fn __vthunk_ou3af80ff543ce307a_iu3af80ff543ce307a(
    __this: *mut ACE_TSS_ACE_Thread_Exit_,
) -> *mut ACE_Thread_Exit {
    <ACE_TSS_ACE_Thread_Exit_>::make_TSS_TYPE((__this as *mut ACE_TSS_ACE_Thread_Exit_))
}
#[repr(C)]
pub struct __Vtbl_u58e65c3375bedb5c {
    pub __type_info: &'static crate::__cxx_std::TypeInfo,
    pub __vdtor: unsafe fn(*mut ACE_TSS_ACE_Thread_Exit_),
    pub vfn_u3af80ff543ce307a: unsafe fn(
        *mut ACE_TSS_ACE_Thread_Exit_,
    ) -> *mut ACE_Thread_Exit,
}
pub static __VTBL_u58e65c3375bedb5c: __Vtbl_u58e65c3375bedb5c = __Vtbl_u58e65c3375bedb5c {
    __type_info: &__TYPEINFO_7ACE_TSS,
    __vdtor: __vdtor_u58e65c3375bedb5c,
    vfn_u3af80ff543ce307a: __vthunk_ou3af80ff543ce307a_iu3af80ff543ce307a,
};
