...
pub mod ACE {
    ...
    #[export_name = "_ZN3ACE13major_versionEv"]
    pub unsafe extern "C-unwind" fn major_version() -> libc::c_uint {
        unsafe {
            {
    ...
    #[export_name = "_ZN3ACE13minor_versionEv"]
    pub unsafe extern "C-unwind" fn minor_version() -> libc::c_uint {
        unsafe {
            {
  ...
  /// Returns 0 for "stable" (non-micro) releases.*/
    #[export_name = "_ZN3ACE13micro_versionEv"]
    pub unsafe extern "C-unwind" fn micro_version() -> libc::c_uint {
        unsafe {
            {
                return ((24) as libc::c_uint);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    /**e.g., the "4" in ACE 6.3.4
  /// Returns 0 for "stable" (non-micro) releases.*/
    #[export_name = "_ZN3ACE12beta_versionEv"]
    pub unsafe extern "C-unwind" fn beta_version() -> libc::c_uint {
        unsafe {
            {
                return ((24) as libc::c_uint);
            }
    ...
    #[export_name = "_ZN3ACE13compiler_nameEv"]
    pub unsafe extern "C-unwind" fn compiler_name() -> *const libc::c_char {
        unsafe {
            {
                return b"g++\0".as_ptr() as *const libc::c_char;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    ///E.g., the "4" in SunPro C++ 4.32.0
    #[export_name = "_ZN3ACE22compiler_major_versionEv"]
    pub unsafe extern "C-unwind" fn compiler_major_version() -> libc::c_uint {
        unsafe {
            {
    ...
    #[export_name = "_ZN3ACE22compiler_minor_versionEv"]
    pub unsafe extern "C-unwind" fn compiler_minor_version() -> libc::c_uint {
        unsafe {
            {
    ...
    #[export_name = "_ZN3ACE21compiler_beta_versionEv"]
    pub unsafe extern "C-unwind" fn compiler_beta_version() -> libc::c_uint {
        unsafe {
            {
  ...
  /// descriptors).*/
    #[export_name = "_ZN3ACE14out_of_handlesEi"]
    pub unsafe extern "C-unwind" fn out_of_handles(
        mut error: libc::c_int,
    ) -> libc::c_int {
        unsafe {
            {
                if (((((((((((((((((((((error as libc::c_int))
                    == (((24) as libc::c_int))) as libc::c_int as libc::c_int) != 0)
                    || (((((error as libc::c_int)) == (((2) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                    as libc::c_int) != 0)
                    || (((((error as libc::c_int)) == (((22) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                    as libc::c_int) != 0)
                    || (((((error as libc::c_int)) == (((95) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                    as libc::c_int) != 0)
                    || (((((error as libc::c_int)) == (((23) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    return 1;
  ...
  /// assumed.*/
    #[export_name = "_ZN3ACE10wild_matchEPKcS1_bb"]
    pub unsafe extern "C-unwind" fn wild_match(
        mut str: *const libc::c_char,
        mut pat: *const libc::c_char,
        mut case_sensitive: bool,
        mut character_classes: bool,
    ) -> bool {
        unsafe {
            {
                if ((((((str) as *const u8)) == (((pat) as *const u8))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    return crate::__cxx_std::__Truthy::__truthy(true);
                }
                if (((((((((pat).is_null()) as libc::c_int) as libc::c_int) != 0)
                    || (((((str).is_null()) as libc::c_int) as libc::c_int) != 0))
                ...
                'while_0: loop {
                    if !(((((((*(s)) as libc::c_int as libc::c_char))
                    ...
                    'cont_0: loop {
                        {
                            {
                                if (((((((!(((escape as libc::c_int) != 0)) as libc::c_int)
                                    as libc::c_int) != 0)
                                    && ((((((*(p)) as libc::c_int as libc::c_char))
                                    ...
                                    as libc::c_int) != 0)
                                {
                                    ...
                                    if (((((((!(((escape as libc::c_int) != 0)) as libc::c_int)
                                        as libc::c_int) != 0)
                                        && ((((((*(p)) as libc::c_int as libc::c_char))
                                            == (((42 as libc::c_char) as libc::c_int as libc::c_char)))
                                            as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                                        as libc::c_int) != 0)
                                    {
                                        star = true;
                                        ...
                                        if ((((((*(pat)) as libc::c_int as libc::c_char))
                                            == (((0 as libc::c_char) as libc::c_int as libc::c_char)))
                                            as libc::c_int as libc::c_int) != 0)
                                        {
                                            return crate::__cxx_std::__Truthy::__truthy(true);
                                        ...
                                        if (((((((!(((escape as libc::c_int) != 0)) as libc::c_int)
                                            as libc::c_int) != 0)
                                            && ((((((*(p)) as libc::c_int as libc::c_char))
                                                == (((63 as libc::c_char) as libc::c_int as libc::c_char)))
                                                as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                                            as libc::c_int) != 0)
                                        {
                                            {
                                            ...
                                            if (((((((((((!(((escape as libc::c_int) != 0))
                                                as libc::c_int) as libc::c_int) != 0)
                                                && ((character_classes as libc::c_int) != 0))
                                                as libc::c_int) as libc::c_int) != 0)
                                                && ((((((*(p)) as libc::c_int as libc::c_char))
                                                    == (((91 as libc::c_char) as libc::c_int as libc::c_char)))
                                                    as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                                                as libc::c_int) != 0)
                                            {
                                                if ((super::__anon_ns_14319::equal_class(
                                                    (((*(s))) as libc::c_char),
                                                ...
                                                ) as libc::c_int) != 0)
                                                {
                                                    ...
                                                    if (((!(((star as libc::c_int) != 0)) as libc::c_int)
                                                        as libc::c_int) != 0)
                                                    {
                                                        return crate::__cxx_std::__Truthy::__truthy(false);
                                                    }
                                                ...
                                                if (((!(((super::__anon_ns_14319::equal_char(
                                                    (((*(s))) as libc::c_char),
                                                    (((*(p))) as libc::c_char),
                                                    case_sensitive,
                ...
                return ((((((*(p)) as libc::c_int as libc::c_char))
                    == (((0 as libc::c_char) as libc::c_int as libc::c_char)))
                    as libc::c_int as libc::c_int) != 0);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
    ...
    #[export_name = "_ZN3ACE4recvEiPvmiPK14ACE_Time_Value"]
    pub unsafe extern "C-unwind" fn recv_ubc58a1994981cdc8(
        mut handle: libc::c_int,
        mut buf: *mut libc::c_void,
        mut len: libc::c_ulong,
        mut flags: libc::c_int,
        mut timeout: *const super::ACE_Time_Value,
    ) -> libc::c_long {
        unsafe {
            {
                if (((((timeout).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    return super::ACE_OS::recv_u32019f19ae792060(
                        handle,
                        ...
                        as libc::c_int as libc::c_int) != 0)
                    {
                        ...
                        let mut bytes_transferred: libc::c_long = super::ACE_OS::recv_u32019f19ae792060(
                            handle,
                            (buf as *mut libc::c_char),
                            len,
                            flags,
                        );
                        restore_non_blocking_mode(handle, val);
    ...
    #[export_name = "_ZN3ACE4recvEiPvmPK14ACE_Time_Value"]
    pub unsafe extern "C-unwind" fn recv_ufcaf818c3c730c74(
        mut handle: libc::c_int,
        mut buf: *mut libc::c_void,
        mut n: libc::c_ulong,
        mut timeout: *const super::ACE_Time_Value,
        ...
        unsafe {
            {
                if (((((timeout).is_null()) as libc::c_int) as libc::c_int) != 0) {
                        ...
                        as libc::c_int as libc::c_int) != 0)
                    {
                        ...
                        let mut bytes_transferred: libc::c_long = recv_i(handle, buf, n);
                        restore_non_blocking_mode(handle, val);
                        return bytes_transferred;
                    }
                }
    ...
    #[export_name = "_ZN3ACE7recvmsgEiP6msghdriPK14ACE_Time_Value"]
    pub unsafe extern "C-unwind" fn recvmsg_ud0b6852c2d7ce63c(
        mut handle: libc::c_int,
        mut msg: *mut super::msghdr,
        mut flags: libc::c_int,
        mut timeout: *const super::ACE_Time_Value,
    ) -> libc::c_long {
        unsafe {
            {
                if (((((timeout).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    return super::ACE_OS::recvmsg_u2eff40656fa046cd(handle, msg, flags);
                } else {
                    let mut val: libc::c_int = 0;
                    if (((((enter_recv_timedwait(
                        handle,
                        ...
                        as libc::c_int as libc::c_int) != 0)
                    {
                        ...
                        let mut bytes_transferred: libc::c_long = super::ACE_OS::recvmsg_u2eff40656fa046cd(
                            handle,
                            msg,
                            flags,
                        );
    ...
    #[export_name = "_ZN3ACE8recvfromEiPciiP8sockaddrPiPK14ACE_Time_Value"]
    pub unsafe extern "C-unwind" fn recvfrom_u88b4ad8d8c4c2595(
        mut handle: libc::c_int,
        mut buf: *mut libc::c_char,
        mut len: libc::c_int,
        mut flags: libc::c_int,
        mut addr: *mut super::sockaddr,
        mut addrlen: *mut libc::c_int,
        mut timeout: *const super::ACE_Time_Value,
    ) -> libc::c_long {
        unsafe {
            {
                if (((((timeout).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    return super::ACE_OS::recvfrom_u289b3b4f999bdcf7(
                        handle,
                        buf,
                        ((len) as libc::c_ulong),
                        flags,
                        ...
                        as libc::c_int as libc::c_int) != 0)
                    {
                        ...
                        let mut bytes_transferred: libc::c_long = super::ACE_OS::recvfrom_u289b3b4f999bdcf7(
                            handle,
                            buf,
                            ((len) as libc::c_ulong),
                            flags,
    ...
    #[export_name = "_ZN3ACE4recvEimz"]
    pub unsafe extern "C-unwind" fn recv_ue6095f44fab5805d(
        mut handle: libc::c_int,
        mut n: libc::c_ulong,
        mut __args: ...
    ) -> libc::c_long {
        unsafe {
            let mut __alloca_arena: ::std::vec::Vec<::std::boxed::Box<[u128]>> = ::std::vec::Vec::new();
            {
                ...
                let mut total_tuples: libc::c_int = (((((((n) as libc::c_ulong))
                    / ((2) as libc::c_ulong)) as libc::c_int)) as libc::c_int);
                let mut iovp: *mut super::iovec = ((0) as *mut super::iovec);
                iovp = ({
                    let __n: usize = ((((total_tuples) as libc::c_ulong))
                        .wrapping_mul((16) as libc::c_ulong)) as usize;
                    let __words: usize = (__n.saturating_add(15) / 16).max(1);
                    __alloca_arena.push(::std::vec![0u128; __words].into_boxed_slice());
                    __alloca_arena.last_mut().unwrap().as_mut_ptr() as *mut libc::c_void
                } as *mut super::iovec);
                argp = __args.clone();
                {
                    let mut i: libc::c_int = 0;
                    'for_0: loop {
                        if !((((((i as libc::c_int)) < (((total_tuples) as libc::c_int)))
                            as libc::c_int as libc::c_int) != 0))
                        {
                            break;
                        }
                        'cont_0: loop {
                            {
                                {
                                    (*(iovp).wrapping_offset((i) as isize)).iov_base = ((unsafe {
                                        (argp).next_arg::<*mut libc::c_char>()
                                    }) as *mut libc::c_void);
                                    (*(iovp).wrapping_offset((i) as isize)).iov_len = ((unsafe {
                                        (argp).next_arg::<libc::c_int>()
                                    }) as libc::c_ulong);
                                }
                            }
                            #[allow(unreachable_code)] break 'cont_0;
                ...
                let mut result: libc::c_long = ((super::ACE_OS::recvv_u5bf3764b3b283ae9(
                    handle,
                    iovp,
                    ((total_tuples) as libc::c_int),
                )) as libc::c_long);
                ();
    ...
    #[export_name = "_ZN3ACE5recvvEiP5ioveciPK14ACE_Time_Value"]
    pub unsafe extern "C-unwind" fn recvv(
        mut handle: libc::c_int,
        mut iov: *mut super::iovec,
        ...
        unsafe {
            {
                if (((((timeout).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    return super::ACE_OS::recvv_u5bf3764b3b283ae9(handle, iov, iovcnt);
                } else {
                    let mut val: libc::c_int = 0;
                    if (((((enter_recv_timedwait(
                        handle,
                        ...
                        as libc::c_int as libc::c_int) != 0)
                    {
                        ...
                        let mut bytes_transferred: libc::c_long = super::ACE_OS::recvv_u5bf3764b3b283ae9(
                            handle,
                            iov,
                            iovcnt,
                        );
    ...
    #[export_name = "_ZN3ACE6recv_nEiP17ACE_Message_BlockPK14ACE_Time_ValuePm"]
    pub unsafe extern "C-unwind" fn recv_n(
        mut handle: libc::c_int,
        mut message_block: *mut super::ACE_Message_Block,
        mut timeout: *const super::ACE_Time_Value,
        mut bt: *mut libc::c_ulong,
    ) -> libc::c_long {
        unsafe {
            {
                let mut temp: libc::c_ulong = unsafe { ::core::mem::zeroed() };
                let mut bytes_transferred: *mut libc::c_ulong = if (((((bt).is_null())
                    as libc::c_int) as libc::c_int) != 0)
                {
                ...
                (*bytes_transferred) = ((0) as libc::c_ulong);
                let mut iov: [super::iovec; 1024usize] = unsafe {
                    ::core::mem::MaybeUninit::<[super::iovec; 1024usize]>::zeroed()
                        .assume_init()
                };
                let mut iovcnt: libc::c_int = 0;
                'while_0: loop {
                    if !(((((!(message_block).is_null()) as libc::c_int) as libc::c_int)
                        != 0))
                    {
                        break 'while_0;
                    }
                    'cont_0: loop {
                        {
                            {
                                let mut current_message_block: *const super::ACE_Message_Block = (message_block)
                                    as *const super::ACE_Message_Block;
                                'while_1: loop {
                                    if !(((((!(current_message_block).is_null()) as libc::c_int)
                                        as libc::c_int) != 0))
                                    {
                                        break 'while_1;
                                    }
                                    'cont_1: loop {
                                        {
                                            {
                                                let mut current_message_block_length: libc::c_ulong = <super::ACE_Message_Block>::length(
                                                    (current_message_block) as *const super::ACE_Message_Block,
                                                );
                                                let mut this_rd_ptr: *mut libc::c_char = <super::ACE_Message_Block>::rd_ptr(
                                                    (current_message_block) as *const super::ACE_Message_Block,
                                                );
                                                'while_2: loop {
                                                    if !((((((current_message_block_length as libc::c_ulong))
                                                    ...
                                                    'cont_2: loop {
                                                        {
                                                            {
                                                                let mut this_chunk_length: libc::c_ulong = ((super::ACE_Utils::truncate_cast___unsigned_long__u1d9a2ec2b81302c9(
                                                                    ((current_message_block_length) as libc::c_ulong),
                                                                )) as libc::c_ulong);
                                                                (iov)[(iovcnt) as usize].iov_base = ((this_rd_ptr)
                                                                    as *mut libc::c_void);
                                                                (iov)[(iovcnt) as usize].iov_len = ((this_chunk_length)
                                                                    as libc::c_ulong);
                                                                {
                                                                    current_message_block_length = (((current_message_block_length)
                                                                        as libc::c_ulong))
                                                                        .wrapping_sub((this_chunk_length) as libc::c_ulong);
                                                                    current_message_block_length
                                                                };
                                                                {
                                                                    this_rd_ptr = (this_rd_ptr)
                                                                        .wrapping_offset((this_chunk_length) as isize);
                                                                    this_rd_ptr
                                                                };
                                                                {
                                                                    let __lv = &mut (iovcnt);
                                                                ...
                                                                if (((((iovcnt as libc::c_int))
                                                                    == (((1024) as libc::c_int))) as libc::c_int as libc::c_int)
                                                                    != 0)
                                                                {
                                                                    let mut current_transfer: libc::c_ulong = ((0)
                                                                        as libc::c_ulong);
                                                                    let mut result: libc::c_long = ((recvv_n(
                                                                        handle,
                                                                        ((iov).as_mut_ptr() as *mut super::iovec),
                                                                        iovcnt,
                                                                        timeout,
                                                                        ::core::ptr::addr_of_mut!(current_transfer)
                                                                            as *mut libc::c_ulong,
                                                                    )) as libc::c_long);
                                                                    {
                                                                        (*bytes_transferred) = ((((*bytes_transferred))
                                                                            as libc::c_ulong))
                                                                            .wrapping_add((current_transfer) as libc::c_ulong);
                                                                        (*bytes_transferred)
                                                                    };
                                                                    if (((((((((result as libc::c_long))
                                                                        == ((((-((1) as libc::c_int))) as libc::c_long)))
                                                                        as libc::c_int as libc::c_int) != 0)
                                                                        || (((((result as libc::c_long)) == (((0) as libc::c_long)))
                                                                            as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                                                                        as libc::c_int) != 0)
                                                                    {
                                                                        return ((result) as libc::c_long);
                                                ...
                                                current_message_block = (<super::ACE_Message_Block>::cont(
                                                    (current_message_block) as *const super::ACE_Message_Block,
                                                )) as *const super::ACE_Message_Block;
                                            }
                                        }
                                ...
                                message_block = <super::ACE_Message_Block>::next(
                                    (message_block) as *const super::ACE_Message_Block,
                                );
                            }
                        }
                        #[allow(unreachable_code)] break 'cont_0;
                ...
                if (((((iovcnt as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    let mut current_transfer: libc::c_ulong = ((0) as libc::c_ulong);
                    let mut result: libc::c_long = ((recvv_n(
                        handle,
                        ((iov).as_mut_ptr() as *mut super::iovec),
                        iovcnt,
                        timeout,
                        ::core::ptr::addr_of_mut!(current_transfer) as *mut libc::c_ulong,
                    )) as libc::c_long);
                    {
                        (*bytes_transferred) = ((((*bytes_transferred))
                            as libc::c_ulong))
                ...
                return ((super::ACE_Utils::truncate_cast___unsigned_long__u503964095c07d269(
                    (((*bytes_transferred)) as libc::c_ulong),
                )) as libc::c_long);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    #[export_name = "_ZN3ACE4sendEiPKvmiPK14ACE_Time_Value"]
    pub unsafe extern "C-unwind" fn send_ue0793508d1a7ed9b(
        mut handle: libc::c_int,
        ...
        unsafe {
            {
                if (((((timeout).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    return super::ACE_OS::send_u46b905aa4005e9e7(
                        handle,
                        ...
                        as libc::c_int as libc::c_int) != 0)
                    {
                        ...
                        let mut bytes_transferred: libc::c_long = ((super::ACE_OS::send_u46b905aa4005e9e7(
                            handle,
                            (buf as *const libc::c_char),
                            n,
                            flags,
                        ...
                        restore_non_blocking_mode(handle, val);
                        return ((bytes_transferred) as libc::c_long);
                    }
                }
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
    ...
    #[export_name = "_ZN3ACE4sendEiPKvmPK14ACE_Time_Value"]
    pub unsafe extern "C-unwind" fn send_u8622bdbd94726127(
        mut handle: libc::c_int,
        mut buf: *const libc::c_void,
        mut n: libc::c_ulong,
        mut timeout: *const super::ACE_Time_Value,
        ...
        unsafe {
            {
                if (((((timeout).is_null()) as libc::c_int) as libc::c_int) != 0) {
                        ...
                        as libc::c_int as libc::c_int) != 0)
                    {
                        ...
                        let mut bytes_transferred: libc::c_long = ((send_i(
                            handle,
                            buf,
                            n,
                        )) as libc::c_long);
    ...
    #[export_name = "_ZN3ACE7sendmsgEiPK6msghdriPK14ACE_Time_Value"]
    pub unsafe extern "C-unwind" fn sendmsg_u4bdd8a5369fa21d3(
        mut handle: libc::c_int,
        mut msg: *const super::msghdr,
        mut flags: libc::c_int,
        mut timeout: *const super::ACE_Time_Value,
    ) -> libc::c_long {
        unsafe {
            {
                if (((((timeout).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    return super::ACE_OS::sendmsg_ue8fec1119c766cbe(handle, msg, flags);
                } else {
                    let mut val: libc::c_int = 0;
                    if (((((enter_send_timedwait(
                        handle,
                        ...
                        as libc::c_int as libc::c_int) != 0)
                    {
                        ...
                        let mut bytes_transferred: libc::c_long = ((super::ACE_OS::sendmsg_ue8fec1119c766cbe(
                            handle,
                            msg,
                            flags,
                        )) as libc::c_long);
    ...
    #[export_name = "_ZN3ACE6sendtoEiPKciiPK8sockaddriPK14ACE_Time_Value"]
    pub unsafe extern "C-unwind" fn sendto_u39d71d775d080700(
        mut handle: libc::c_int,
        mut buf: *const libc::c_char,
        mut len: libc::c_int,
        mut flags: libc::c_int,
        mut addr: *const super::sockaddr,
        ...
        unsafe {
            {
                if (((((timeout).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    return super::ACE_OS::sendto_uf1a8458778d74112(
                        handle,
                        buf,
                        ((len) as libc::c_ulong),
                        flags,
                        ...
                        as libc::c_int as libc::c_int) != 0)
                    {
                        ...
                        let mut bytes_transferred: libc::c_long = ((super::ACE_OS::sendto_uf1a8458778d74112(
                            handle,
                            buf,
                            ((len) as libc::c_ulong),
                            flags,
    ...
    #[export_name = "_ZN3ACE4sendEimz"]
    pub unsafe extern "C-unwind" fn send_uc53816df24ab747f(
        mut handle: libc::c_int,
        mut n: libc::c_ulong,
        mut __args: ...
    ) -> libc::c_long {
        unsafe {
            let mut __alloca_arena: ::std::vec::Vec<::std::boxed::Box<[u128]>> = ::std::vec::Vec::new();
            {
                ...
                let mut total_tuples: libc::c_int = (((((n) as libc::c_ulong))
                    / ((2) as libc::c_ulong)) as libc::c_int);
                let mut iovp: *mut super::iovec = unsafe { ::core::mem::zeroed() };
                iovp = ({
                    let __n: usize = ((((total_tuples) as libc::c_ulong))
                        .wrapping_mul((16) as libc::c_ulong)) as usize;
                    let __words: usize = (__n.saturating_add(15) / 16).max(1);
                ...
                let mut result: libc::c_long = super::ACE_OS::sendv_u2741ac8ad81ed9fe(
                    handle,
                    (iovp) as *const super::iovec,
                    total_tuples,
                );
                ();
                return result;
    ...
    #[export_name = "_ZN3ACE5sendvEiPK5ioveciPK14ACE_Time_Value"]
    pub unsafe extern "C-unwind" fn sendv(
        mut handle: libc::c_int,
        mut iov: *const super::iovec,
        mut iovcnt: libc::c_int,
        mut timeout: *const super::ACE_Time_Value,
    ) -> libc::c_long {
        unsafe {
            {
                if (((((timeout).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    return super::ACE_OS::sendv_u2741ac8ad81ed9fe(handle, iov, iovcnt);
                } else {
                    let mut val: libc::c_int = 0;
                    if (((((enter_send_timedwait(
                        handle,
                        ...
                        as libc::c_int as libc::c_int) != 0)
                    {
                        ...
                        let mut bytes_transferred: libc::c_long = super::ACE_OS::sendv_u2741ac8ad81ed9fe(
                            handle,
                            iov,
                            iovcnt,
                        );
  ...
  /// operation to reduce the domain-crossing penalty.*/
    #[export_name = "_ZN3ACE6send_nEiPK17ACE_Message_BlockPK14ACE_Time_ValuePm"]
    pub unsafe extern "C-unwind" fn send_n(
        mut handle: libc::c_int,
        mut message_block: *const super::ACE_Message_Block,
        mut timeout: *const super::ACE_Time_Value,
        mut bt: *mut libc::c_ulong,
    ) -> libc::c_long {
        unsafe {
                        ...
                        {
                            {
                                ...
                                'while_1: loop {
                                    ...
                                    'cont_1: loop {
                                        {
                                            {
                                                let mut this_block_ptr: *mut libc::c_char = <super::ACE_Message_Block>::rd_ptr(
                                                    (current_message_block) as *const super::ACE_Message_Block,
                                                );
                                                let mut current_message_block_length: libc::c_ulong = <super::ACE_Message_Block>::length(
                                                    (current_message_block) as *const super::ACE_Message_Block,
                                                        ...
                                                        {
                                                            {
                                                                ...
                                                                (iov)[(iovcnt) as usize].iov_base = ((this_block_ptr)
                                                                    as *mut libc::c_void);
                                                                (iov)[(iovcnt) as usize].iov_len = ((this_chunk_length)
                                                                    as libc::c_ulong);
                                                                {
                                                                    ...
                                                                    != 0)
                                                                {
                                                                    let mut current_transfer: libc::c_ulong = ((0)
                                                                        as libc::c_ulong);
                                                                    let mut result: libc::c_long = ((sendv_n(
                                                                        handle,
                                                                        ((iov).as_ptr() as *const super::iovec),
                                                                        iovcnt,
                                                                        timeout,
                                                                        ::core::ptr::addr_of_mut!(current_transfer)
                                                                            as *mut libc::c_ulong,
  ...
  /// gather-write operation to reduce the domain-crossing penalty.*/
    #[export_name = "_ZN3ACE7write_nEiPK17ACE_Message_BlockPm"]
    pub unsafe extern "C-unwind" fn write_n(
        mut handle: libc::c_int,
        mut message_block: *const super::ACE_Message_Block,
        mut bt: *mut libc::c_ulong,
    ) -> libc::c_long {
                                                        ...
                                                        {
                                                            {
                                                                    ...
                                                                    != 0)
                                                                {
                                                                    let mut current_transfer: libc::c_ulong = ((0)
                                                                        as libc::c_ulong);
                                                                    let mut result: libc::c_long = ((writev_n(
                                                                        handle,
                                                                        ((iov).as_ptr() as *const super::iovec),
                                                                        iovcnt,
                                                                        ::core::ptr::addr_of_mut!(current_transfer)
    ...
    #[export_name = "_ZN3ACE7readv_nEiP5ioveciPm"]
    pub unsafe extern "C-unwind" fn readv_n(
        mut handle: libc::c_int,
        mut iov: *mut super::iovec,
        mut iovcnt: libc::c_int,
        mut bt: *mut libc::c_ulong,
        ...
        unsafe {
            {
                ...
                (*bytes_transferred) = ((0) as libc::c_ulong);
                {
                    ...
                    'for_0: loop {
                        if !((((((s as libc::c_int)) < (((iovcnt) as libc::c_int)))
                            as libc::c_int as libc::c_int) != 0))
                        {
                            break;
                        }
                        'cont_0: loop {
                            {
                                {
                                    let mut n: libc::c_long = super::ACE_OS::readv_u0f79db0b81259088(
                                        handle,
                                        ((iov).wrapping_offset((s) as isize))
                                            as *const super::iovec,
                                        (((iovcnt) as libc::c_int)).wrapping_sub((s) as libc::c_int),
                                    );
                                    if (((((((((n as libc::c_long))
                                        == ((((-((1) as libc::c_int))) as libc::c_long)))
                                        as libc::c_int as libc::c_int) != 0)
                                        || (((((n as libc::c_long)) == (((0) as libc::c_long)))
                                            as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                                        as libc::c_int) != 0)
                                    {
                                        return n;
                                    }
                                    {
                                        ...
                                        'for_1: loop {
                                            if !((((((((((s as libc::c_int))
                                                < (((iovcnt) as libc::c_int))) as libc::c_int
                                                as libc::c_int) != 0)
                                                && (((((n as libc::c_long))
                                                    >= (((((*(iov).wrapping_offset((s) as isize)).iov_len
                                                        as libc::c_long)) as libc::c_long))) as libc::c_int
                                                    as libc::c_int) != 0)) as libc::c_int) as libc::c_int)
                                                != 0))
                                            {
                                                break;
                                    ...
                                    if (((((n as libc::c_long)) != (((0) as libc::c_long)))
                                        as libc::c_int as libc::c_int) != 0)
                                    {
                                        let mut base: *mut libc::c_char = ((*(iov)
                                            .wrapping_offset((s) as isize))
                                            .iov_base as *mut libc::c_char);
                                        (*(iov).wrapping_offset((s) as isize)).iov_base = (((base)
                                            .wrapping_offset((n) as isize)) as *mut libc::c_void);
                                        (*(iov).wrapping_offset((s) as isize)).iov_len = ((((((*(iov)
                                            .wrapping_offset((s) as isize))
                                            .iov_len) as libc::c_ulong))
                                            .wrapping_sub(((n as libc::c_ulong)) as libc::c_ulong))
                                            as libc::c_ulong);
                                    }
                                }
                            }
    ...
    #[export_name = "_ZN3ACE8writev_nEiPK5ioveciPm"]
    pub unsafe extern "C-unwind" fn writev_n(
        mut handle: libc::c_int,
        mut i: *const super::iovec,
        mut iovcnt: libc::c_int,
        mut bt: *mut libc::c_ulong,
    ) -> libc::c_long {
        unsafe {
            {
                ...
                (*bytes_transferred) = ((0) as libc::c_ulong);
                let mut iov: *mut super::iovec = (i as *mut super::iovec);
                {
                    let mut s: libc::c_int = 0;
                    'for_0: loop {
                        if !((((((s as libc::c_int)) < (((iovcnt) as libc::c_int)))
                        ...
                        'cont_0: loop {
                            {
                                {
                                    let mut n: libc::c_long = super::ACE_OS::writev_u9b20468f161f7ab3(
                                        handle,
                                        ((iov).wrapping_offset((s) as isize))
                                            as *const super::iovec,
                                        (((iovcnt) as libc::c_int)).wrapping_sub((s) as libc::c_int),
    ...
    #[doc = "* Wait up to @a timeout amount of time to passively establish a\n   * connection.  This method doesn't perform the @c accept, it just\n   * does the timed wait."]
    #[export_name = "_ZN3ACE19handle_timed_acceptEiP14ACE_Time_Valueb"]
    pub unsafe extern "C-unwind" fn handle_timed_accept(
        mut listener: libc::c_int,
        mut timeout: *mut super::ACE_Time_Value,
        mut restart: bool,
    ) -> libc::c_int {
        unsafe {
            {
                if (((((listener as libc::c_int))
                    == ((((-((1) as libc::c_int))) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    return (-((1) as libc::c_int));
                }
                let mut fds: super::pollfd = unsafe {
                    ::core::mem::MaybeUninit::<super::pollfd>::zeroed().assume_init()
                };
                fds.fd = ((listener) as libc::c_int);
                fds.events = ((1) as libc::c_short);
                fds.revents = ((0) as libc::c_short);
                {
                    'for_0: loop {
                        'cont_0: loop {
                            {
                                {
                                    let mut n: libc::c_int = super::ACE_OS::poll_uafd6e356b68ec65c(
                                        ::core::ptr::addr_of_mut!(fds) as *mut super::pollfd,
                                        ((1) as libc::c_ulong),
                                        (timeout) as *const super::ACE_Time_Value,
                                    );
                                    'switch_0: {
                                        let __c: libc::c_int = n;
                                        #[allow(unused_assignments)]
                                        let mut __m: u32 = 3;
                                        {
                                            let __cv_0: libc::c_int = (-1 as libc::c_int);
                                            if __c == __cv_0 {
                                                __m = 0;
                                            }
                                        }
                                        if __m == 3 {
                                            let __cv_1: libc::c_int = (0 as libc::c_int);
                                            if __c == __cv_1 {
                                                __m = 1;
                                            }
                                        }
                                        ...
                                        if __m <= 0 {
                                            if (((((((((((*(super::__errno_location())))
                                                as libc::c_int)) == (((4) as libc::c_int))) as libc::c_int
                                                as libc::c_int) != 0) && ((restart as libc::c_int) != 0))
                                                as libc::c_int) as libc::c_int) != 0)
                                            {
                                                break 'cont_0;
                                            } else {
                                        ...
                                        if __m <= 1 {
                                            if ((((((((!(timeout).is_null()) as libc::c_int)
                                                as libc::c_int) != 0)
                                                && ((super::operator_eq_u62c91a36bca5f714(
                                                    timeout,
                                                    ::core::ptr::addr_of!(super::ACE_Time_Value_zero),
                                                ) as libc::c_int) != 0)) as libc::c_int) as libc::c_int)
                                                != 0)
                                            {
                                                ((*(super::__errno_location()))) = 11;
                                            } else {
                                                ((*(super::__errno_location()))) = 110;
                                            }
                                            return (-((1) as libc::c_int));
                                        }
                                        if __m <= 2 {
    ...
    #[doc = "* Wait up to @a timeout amount of time to complete an actively\n   * established non-blocking connection.  If @a is_tli is non-0 then\n   * we are being called by a TLI wrapper (which behaves slightly\n   * differently from a socket wrapper)."]
    #[export_name = "_ZN3ACE21handle_timed_completeEiPK14ACE_Time_Valuei"]
    pub unsafe extern "C-unwind" fn handle_timed_complete(
        mut h: libc::c_int,
        mut timeout: *const super::ACE_Time_Value,
        mut is_tli: libc::c_int,
    ) -> libc::c_int {
        unsafe {
            {
                let mut fds: super::pollfd = unsafe {
                ...
                fds.fd = ((h) as libc::c_int);
                fds.events = (((((1) as libc::c_int)) | ((4) as libc::c_int))
                    as libc::c_short);
                fds.revents = ((0) as libc::c_short);
                let mut need_to_check: bool = false;
                let mut known_failure: bool = false;
                let mut n: libc::c_int = super::ACE_OS::poll_uafd6e356b68ec65c(
                    ::core::ptr::addr_of_mut!(fds) as *mut super::pollfd,
                    ((1) as libc::c_ulong),
                    timeout,
                );
                if (((((n as libc::c_int)) <= (((0) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    if (((((((((n as libc::c_int)) == (((0) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
                        && ((((!(timeout).is_null()) as libc::c_int) as libc::c_int)
                            != 0)) as libc::c_int) as libc::c_int) != 0)
                    {
                        ((*(super::__errno_location()))) = 62;
                    }
                    return (((-((1) as libc::c_int))) as libc::c_int);
                }
                if ((is_tli) != 0) {
                    need_to_check = ((((((((((fds.revents) as libc::c_int))
                        & ((1) as libc::c_int))) != 0)
                        && (((!(((((((fds.revents) as libc::c_int))
                            & ((4) as libc::c_int))) != 0)) as libc::c_int)
                            as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0);
                } else {
                    need_to_check = ((((((((((fds.revents) as libc::c_int))
                        & ((1) as libc::c_int))) != 0)
                        || ((((((fds.revents) as libc::c_int)) & ((8) as libc::c_int)))
                            != 0)) as libc::c_int) as libc::c_int) != 0);
                    known_failure = ((((((fds.revents) as libc::c_int))
                        & ((8) as libc::c_int))) != 0);
                }
                if ((need_to_check as libc::c_int) != 0) {
                    let mut sock_err: libc::c_int = 0;
                    let mut sock_err_len: libc::c_int = ((::core::mem::size_of::<
                        libc::c_int,
                    >() as libc::c_ulong) as libc::c_int);
                    let mut sockopt_ret: libc::c_int = super::ACE_OS::getsockopt_ue319435db01d3776(
                        h,
                        1,
                        4,
                        (::core::ptr::addr_of_mut!(sock_err) as *mut libc::c_int
                            as *mut libc::c_char),
                        ::core::ptr::addr_of_mut!(sock_err_len) as *mut libc::c_int,
                    );
                    if (((((sockopt_ret as libc::c_int)) < (((0) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        h = (((-((1) as libc::c_int))) as libc::c_int);
                    }
                    if (((((((((sock_err as libc::c_int)) != (((0) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
                        || ((known_failure as libc::c_int) != 0)) as libc::c_int)
                        as libc::c_int) != 0)
                    {
                        h = (((-((1) as libc::c_int))) as libc::c_int);
                        ((*(super::__errno_location()))) = sock_err;
                    }
                }
                return h;
            }
    ...
    #[doc = "* Reset the limit on the number of open handles.  If @a new_limit\n   * == -1 set the limit to the maximum allowable.  Otherwise, set\n   * the limit value to @a new_limit.  If @a increase_limit_only is\n   * non-0 then only allow increases to the limit."]
    #[export_name = "_ZN3ACE16set_handle_limitEii"]
    pub unsafe extern "C-unwind" fn set_handle_limit(
        mut new_limit: libc::c_int,
        mut increase_limit_only: libc::c_int,
    ) -> libc::c_int {
        unsafe {
            {
                let mut cur_limit: libc::c_int = max_handles();
                let mut max_limit: libc::c_int = cur_limit;
                if (((((cur_limit as libc::c_int))
                    == ((((-((1) as libc::c_int))) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    return (-((1) as libc::c_int));
                }
                let mut rl: super::rlimit = unsafe {
                    ::core::mem::MaybeUninit::<super::rlimit>::zeroed().assume_init()
                };
                super::ACE_OS::memset_u2b5dfc47d301370a(
                    (::core::ptr::addr_of_mut!(rl) as *mut super::rlimit
                        as *mut libc::c_void),
                    0,
                    ((::core::mem::size_of::<super::rlimit>() as libc::c_ulong)
                        as libc::c_ulong),
                );
                let mut r: libc::c_int = super::ACE_OS::getrlimit_u4b95a386b5c97de9(
                    ((super::RLIMIT_NOFILE) as libc::c_int),
                    ::core::ptr::addr_of_mut!(rl) as *mut super::rlimit,
                );
                if (((((r as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    max_limit = ((rl.rlim_max) as libc::c_int);
                }
                if (((((new_limit as libc::c_int))
                    == ((((-((1) as libc::c_int))) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    new_limit = max_limit;
                }
                if (((((new_limit as libc::c_int)) < (((0) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    ((*(super::__errno_location()))) = 22;
                    return (-((1) as libc::c_int));
                } else {
                    if (((((new_limit as libc::c_int)) > (((cur_limit) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        rl.rlim_cur = ((new_limit) as libc::c_ulong);
                        return super::ACE_OS::setrlimit_uba2c05ddd65b35bc(
                            ((super::RLIMIT_NOFILE) as libc::c_int),
                            (::core::ptr::addr_of_mut!(rl) as *mut super::rlimit)
                                as *const super::rlimit,
                        );
                    } else {
                        if (((((increase_limit_only as libc::c_int))
    ...
    #[doc = "* Returns the maximum number of open handles currently permitted in\n   * this process.  This maximum may be extended using\n   * @c ACE::set_handle_limit."]
    #[export_name = "_ZN3ACE11max_handlesEv"]
    pub unsafe extern "C-unwind" fn max_handles() -> libc::c_int {
        unsafe {
            {
                let mut rl: super::rlimit = unsafe {
                    ::core::mem::MaybeUninit::<super::rlimit>::zeroed().assume_init()
                ...
                if (((((((((r as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                    && (((((rl.rlim_cur as libc::c_ulong))
                        != ((((((-((1) as libc::c_int)) as libc::c_ulong)))
                            as libc::c_ulong))) as libc::c_int as libc::c_int) != 0))
                    as libc::c_int) as libc::c_int) != 0)
                {
                    return ((rl.rlim_cur) as libc::c_int);
                }
                return (super::ACE_OS::sysconf_ufbfaa6ac06fab24e(
    ...
    #[doc = "* Return a dynamically allocated duplicate of @a str, substituting\n   * the environment variable if @c str[0] @c == @c '$'.  Note that\n   * the pointer is allocated with @c ACE_OS::malloc and must be freed\n   * by @c ACE_OS::free."]
    #[export_name = "_ZN3ACE9strenvdupEPKc"]
    pub unsafe extern "C-unwind" fn strenvdup(
        mut str: *const libc::c_char,
    ) -> *mut libc::c_char {
        unsafe {
            {
                return super::ACE_OS::strenvdup_uc4fed4dc8e89ae4d(str);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
  ...
  /// past the '\0'.*/
    #[export_name = "_ZN3ACE6strendEPKc"]
    pub unsafe extern "C-unwind" fn strend(
  ...
  /// returns NULL rather than segfaulting.*/
    #[export_name = "_ZN3ACE6strnewEPKc"]
    pub unsafe extern "C-unwind" fn strnew(
        mut s: *const libc::c_char,
    ) -> *mut libc::c_char {
        unsafe {
            {
                    ...
                    'cont_0: loop {
                        {
                            {
                                t = {
                                    let __count: usize = ((((super::ACE_OS::strlen_u07dd12a225364fa6(
                                        s,
                                    )) as libc::c_ulong))
                ...
                return super::ACE_OS::strcpy_u08e8184bcebbac89(t, s);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
  ...
  /// @c ACE_OS::malloc to allocate the new string.*/
    #[export_name = "_ZN3ACE7strndupEPKcm"]
    pub unsafe extern "C-unwind" fn strndup_u823226a82bf0fd9a(
        mut str: *const libc::c_char,
        mut n: libc::c_ulong,
    ) -> *mut libc::c_char {
        unsafe {
            {
                let mut t: *const libc::c_char = str;
                let mut len: libc::c_ulong = unsafe { ::core::mem::zeroed() };
                {
                    len = ((0) as libc::c_ulong);
                    'for_0: loop {
                        if !((((((((((len as libc::c_ulong)) < (((n) as libc::c_ulong)))
                            as libc::c_int as libc::c_int) != 0)
                            && ((((((*({
                                let __lv = &mut (t);
                                let __r = *__lv;
                ...
                let mut s: *mut libc::c_char = unsafe { ::core::mem::zeroed() };
                'dowhile_1: loop {
                    'cont_1: loop {
                        {
                            {
                                s = (super::ACE_OS::malloc_u80646b42522769ca(
                                    (((len) as libc::c_ulong))
                ...
                return super::ACE_OS::strsncpy(
                    s,
                    str,
                    (((len) as libc::c_ulong)).wrapping_add((1) as libc::c_ulong),
                );
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    ...
    /**Create a fresh new copy of @a str, up to @a n chars long.  Uses
  /// @c ACE_OS::malloc to allocate the new string.*/
    #[export_name = "_ZN3ACE7strnnewEPKcm"]
    pub unsafe extern "C-unwind" fn strnnew(
        mut str: *const libc::c_char,
        mut n: libc::c_ulong,
    ) -> *mut libc::c_char {
        unsafe {
                        ...
                        if !((((((((((len as libc::c_ulong)) < (((n) as libc::c_ulong)))
                            ...
                            && ((((((*({
                                ...
                                *__lv = (*__lv).wrapping_offset(1);
                                ...
                                != (((0 as libc::wchar_t) as libc::wchar_t))) as libc::c_int
                                as libc::c_int) != 0)) as libc::c_int) as libc::c_int)
                            != 0))
                        {
                            break;
                    ...
                    'cont_1: loop {
                        {
                            {
                                s = {
                                    let __count: usize = ((((len) as libc::c_ulong))
                                        .wrapping_add((1) as libc::c_ulong)) as usize;
                                    let __nbytes = __count
                                        .checked_mul(::core::mem::size_of::<libc::c_char>())
                                        .expect("array new[] size overflow");
    ...
    #[export_name = "_ZN3ACE6strendEPKw"]
    pub unsafe extern "C-unwind" fn strend_u1645597eee4d5ce1(
        ...
        unsafe {
            {
                'while_0: loop {
                    if !(((((((*({
                        ...
                        *__lv = (*__lv).wrapping_offset(1);
                        __r
                    })) as libc::wchar_t)) != (((0 as libc::wchar_t) as libc::wchar_t)))
                        as libc::c_int as libc::c_int) != 0))
                    {
                        break 'while_0;
                    }
    ...
    #[export_name = "_ZN3ACE6strnewEPKw"]
    pub unsafe extern "C-unwind" fn strnew_ufad401caff9461f0(
        mut s: *const libc::wchar_t,
    ) -> *mut libc::wchar_t {
        unsafe {
            {
                if (((((s).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    return ((0) as *mut libc::wchar_t);
                }
                let mut n: libc::c_ulong = (((((super::ACE_OS::strlen_u07b44aa22513a9ba(
                    s,
                )) as libc::c_ulong))
                    ...
                    'cont_0: loop {
                        {
                            {
                                t = {
                                    let __count: usize = (n) as usize;
                                    let __nbytes = __count
                                        .checked_mul(::core::mem::size_of::<libc::wchar_t>())
                                        .expect("array new[] size overflow");
                                    let __data = ::libc::malloc(
                                        if __nbytes == 0 { 1 } else { __nbytes },
                                    ) as *mut libc::wchar_t;
                                    if __data.is_null() {
                                        ::std::alloc::handle_alloc_error(
                                            ::core::alloc::Layout::array::<libc::wchar_t>(__count)
                                                .unwrap(),
                                        );
                                    }
                                    ::core::ptr::write_bytes(__data, 0u8, __count);
                ...
                return super::ACE_OS::strcpy_u7344f334f51e13d1(t, s);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    pub use crate::full_ops_0::ACE::strdelete_u98ec8357f60b4ba4;
    #[export_name = "_ZN3ACE7strndupEPKwm"]
    pub unsafe extern "C-unwind" fn strndup_ud668670afb78138e(
        mut str: *const libc::wchar_t,
        mut n: libc::c_ulong,
    ) -> *mut libc::wchar_t {
        unsafe {
            {
                let mut t: *const libc::wchar_t = str;
                let mut len: libc::c_ulong = unsafe { ::core::mem::zeroed() };
                {
                    len = ((0) as libc::c_ulong);
                    'for_0: loop {
                        if !((((((((((len as libc::c_ulong)) < (((n) as libc::c_ulong)))
                            ...
                            && ((((((*({
                                ...
                                *__lv = (*__lv).wrapping_offset(1);
                                ...
                                != (((0 as libc::c_char) as libc::wchar_t))) as libc::c_int
                                as libc::c_int) != 0)) as libc::c_int) as libc::c_int)
                            != 0))
                        {
                            break;
                ...
                let mut size: libc::c_ulong = (((((((((len) as libc::c_ulong))
                    .wrapping_add((1) as libc::c_ulong))) as libc::c_ulong))
                    .wrapping_mul((4) as libc::c_ulong)) as libc::c_ulong);
                let mut s: *mut libc::wchar_t = ((0) as *mut libc::wchar_t);
                'dowhile_1: loop {
                    'cont_1: loop {
                        {
                            {
                ...
                return super::ACE_OS::strsncpy_u8a4aa104d1b86cfb(
                    s,
                    str,
                    (((len) as libc::c_ulong)).wrapping_add((1) as libc::c_ulong),
                );
    ...
    #[export_name = "_ZN3ACE7strnnewEPKwm"]
    pub unsafe extern "C-unwind" fn strnnew_u08b3cba2a6796603(
        mut str: *const libc::wchar_t,
        mut n: libc::c_ulong,
    ) -> *mut libc::wchar_t {
        unsafe {
            {
                ...
                let mut s: *mut libc::wchar_t = unsafe { ::core::mem::zeroed() };
                'dowhile_1: loop {
                    'cont_1: loop {
                        {
                            {
    ...
    #[doc = "* Returns the \"basename\" of a @a pathname separated by @a delim.\n   * For instance, the basename of \"/tmp/foo.cpp\" is \"foo.cpp\" when\n   * @a delim is @a '/'."]
    #[export_name = "_ZN3ACE8basenameEPKcc"]
    pub unsafe extern "C-unwind" fn basename_u206a02824429514d(
        mut pathname: *const libc::c_char,
        mut delim: libc::c_char,
    ) -> *const libc::c_char {
        unsafe {
            {
                let mut temp: *const libc::c_char = ((super::ACE_OS::strrchr_u93b8199dbba81372(
                ...
                if (((((temp).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    ...
                    return (temp).wrapping_offset((1) as isize);
                }
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    #[doc = "* Returns the \"dirname\" of a @a pathname.  For instance, the\n   * dirname of \"/tmp/foo.cpp\" is \"/tmp\" when @a delim is @a '/'.  If\n   * @a pathname has no @a delim \".\\0\" is returned.  This method does\n   * not modify @a pathname and is not reentrant."]
    #[export_name = "_ZN3ACE7dirnameEPKcc"]
    pub unsafe extern "C-unwind" fn dirname(
        mut pathname: *const libc::c_char,
        mut delim: libc::c_char,
    ) -> *const libc::c_char {
        unsafe {
            {
                static mut return_dirname: [libc::c_char; 4097usize] = unsafe {
                    ::core::mem::MaybeUninit::<[libc::c_char; 4097usize]>::zeroed()
                        .assume_init()
                };
                let mut temp: *const libc::c_char = ((super::ACE_OS::strrchr_u93b8199dbba81372(
                    ((pathname) as *const libc::c_char),
                ...
                if (((((temp).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    (return_dirname)[(0) as usize] = ((46 as libc::c_char)
                        as libc::c_char);
                    (return_dirname)[(1) as usize] = ((0 as libc::c_char)
                        as libc::c_char);
                    return (::core::ptr::addr_of!(return_dirname)
                        as *const libc::c_char);
                } else {
                    let mut len: libc::c_ulong = (((((((temp).offset_from(pathname))
                    ...
                    if (((((len as libc::c_ulong))
                        > (((((((::core::mem::size_of::<[libc::c_char; 4097usize]>()
                            ...
                            / ((1) as libc::c_ulong))) as libc::c_ulong))) as libc::c_int
                        as libc::c_int) != 0)
                    {
                        len = (((((::core::mem::size_of::<[libc::c_char; 4097usize]>()
                            as libc::c_ulong) as libc::c_ulong))
                            / ((1) as libc::c_ulong)) as libc::c_ulong);
                    }
                    super::ACE_OS::strsncpy(
                        (::core::ptr::addr_of_mut!(return_dirname) as *mut libc::c_char),
                        ((pathname) as *const libc::c_char),
                        len,
                    );
                    return (::core::ptr::addr_of!(return_dirname)
    ...
    #[doc = "* Translate the given timestamp to ISO-8601 format.\n   *\n   * @param time_value      ACE_Time_Value to format. This is assumed to be\n   *                        an absolute time value.\n   * @param date_and_time   Array to hold the timestamp.\n   * @param time_len        Size of @a date_and_time in ACE_TCHARs.\n   *                        Must be greater than or equal to 27.\n   * @param return_pointer_to_first_digit  If true, returned pointer value\n   *                        is to the first time digit, else to the space\n   *                        prior to the first time digit. See Return Values.\n   *\n   * @retval 0 if unsuccessful, with errno set. If @a time_len is less than\n   *           27 errno will be EINVAL.\n   * @retval If successful, pointer to beginning of the \"time\" portion of\n   *         @a date_and_time.  If @a return_pointer_to_first_digit is false\n   *         the pointer is actually to the space before the time, else\n   *         the pointer is to the first time digit."]
    #[export_name = "_ZN3ACE9timestampERK14ACE_Time_ValuePcmb"]
    pub unsafe extern "C-unwind" fn timestamp(
        mut time_value: *const super::ACE_Time_Value,
        mut date_and_time: *mut libc::c_char,
        mut date_and_timelen: libc::c_ulong,
        mut return_pointer_to_first_digit: bool,
    ) -> *mut libc::c_char {
        unsafe {
            {
                if (((((date_and_timelen as libc::c_ulong)) < (((27) as libc::c_ulong)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    ((*(super::__errno_location()))) = 22;
                    return ((0) as *mut libc::c_char);
                }
                let mut cur_time: super::ACE_Time_Value = if (((super::operator_eq_u62c91a36bca5f714(
                    ::core::ptr::addr_of!((* time_value)),
                    ::core::ptr::addr_of!(super::ACE_Time_Value_zero),
                )) as libc::c_int) != 0)
                {
                    (super::ACE_OS::gettimeofday_u3220bcbbceb90f45())
                } else {
                    <super::ACE_Time_Value>::new_u3614bf99aa612c0c(
                        ::core::ptr::addr_of!((* time_value)),
                    )
                };
                let mut secs: libc::c_long = <super::ACE_Time_Value>::sec(
                    (::core::ptr::addr_of!(cur_time)) as *const super::ACE_Time_Value,
                );
                let mut tms: super::tm = unsafe {
                    ::core::mem::MaybeUninit::<super::tm>::zeroed().assume_init()
                };
                super::ACE_OS::localtime_r_u00ea56666aff6d11(
                    ((::core::ptr::addr_of_mut!(secs) as *mut libc::c_long)
                        as *const libc::c_long),
                    ::core::ptr::addr_of_mut!(tms) as *mut super::tm,
                );
                super::ACE_OS::snprintf_u9a28649a3b771eeb(
                    ((date_and_time) as *mut libc::c_char),
                    date_and_timelen,
                    ((b"%4.4d-%2.2d-%2.2d %2.2d:%2.2d:%2.2d.%06ld\0".as_ptr()
                        as *const libc::c_char) as *const libc::c_char),
                    (((tms.tm_year) as libc::c_int)).wrapping_add((1900) as libc::c_int),
                    (((tms.tm_mon) as libc::c_int)).wrapping_add((1) as libc::c_int),
                    tms.tm_mday,
                    tms.tm_hour,
                    tms.tm_min,
                    tms.tm_sec,
                    (<super::ACE_Time_Value>::usec(
                        (::core::ptr::addr_of!(cur_time)) as *const super::ACE_Time_Value,
                    ) as libc::c_long),
                );
                (*(date_and_time)
                    .wrapping_offset(
                        ((((date_and_timelen) as libc::c_ulong))
                            .wrapping_sub((1) as libc::c_ulong)) as isize,
                    )) = ((0 as libc::c_char) as libc::c_char);
                return ::core::ptr::addr_of_mut!(
                    (* (date_and_time).wrapping_offset(((((10) as libc::c_int))
                    .wrapping_add((((((return_pointer_to_first_digit as libc::c_int)) !=
                    (((0) as libc::c_int))) as libc::c_int)) as libc::c_int)) as isize))
                ) as *mut libc::c_char;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    #[doc = "* Translate the current time to ISO-8601 timestamp format.\n   *\n   * @param date_and_time   Array to hold the timestamp.\n   * @param time_len        Size of @a date_and_time in ACE_TCHARs.\n   *                        Must be greater than or equal to 27.\n   * @param return_pointer_to_first_digit  If true, returned pointer value\n   *                        is to the first time digit, else to the space\n   *                        prior to the first time digit. See Return Values.\n   *\n   * @retval 0 if unsuccessful, with errno set. If @a time_len is less than\n   *           27 errno will be EINVAL.\n   * @retval If successful, pointer to beginning of the \"time\" portion of\n   *         @a date_and_time.  If @a return_pointer_to_first_digit is false\n   *         the pointer is actually to the space before the time, else\n   *         the pointer is to the first time digit."]
    #[export_name = "_ZN3ACE9timestampEPcmb"]
    pub unsafe extern "C-unwind" fn timestamp_uedcad69f71820d6a(
        mut date_and_time: *mut libc::c_char,
        mut date_and_timelen: libc::c_ulong,
        mut return_pointer_to_first_digit: bool,
    ) -> *mut libc::c_char {
    ...
    #[doc = "* if @a avoid_zombies == 0 call @c ACE_OS::fork directly, else\n   * create an orphan process that's inherited by the init process;\n   * init cleans up when the orphan process terminates so we don't\n   * create zombies.  Returns -1 on failure and either the child PID\n   * on success if @a avoid_zombies == 0 or 1 on success if @a\n   * avoid_zombies != 0 (this latter behavior is a known bug that\n   * needs to be fixed)."]
    #[export_name = "_ZN3ACE4forkEPKci"]
    pub unsafe extern "C-unwind" fn fork_u4fb8921c2c83ccf9(
        mut program_name: *const libc::c_char,
        mut avoid_zombies: libc::c_int,
    ) -> libc::c_int {
        unsafe {
            {
                if (((((avoid_zombies as libc::c_int)) == (((0) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    return super::ACE_OS::fork_uc56682233d614dbc(program_name);
                } else {
                    let mut pid: libc::c_int = super::ACE_OS::fork_ud832228bf11480c3();
                    if (((((pid as libc::c_int)) == (((0) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        'switch_0: {
                            let __c: libc::c_int = super::ACE_OS::fork_uc56682233d614dbc(
                                program_name,
                            );
                            #[allow(unused_assignments)]
                            let mut __m: u32 = 2;
                            ...
                            if __m == 2 {
                                let __cv_1: libc::c_int = (-1 as libc::c_int);
                                if __c == __cv_1 {
                                    __m = 1;
                                }
                            }
                            ...
                            if __m <= 1 {
                                super::ACE_OS::_exit_u5699558a229ba490(
                                    ((*(super::__errno_location()))),
                                );
                            }
                            if __m <= 2 {
                                super::ACE_OS::_exit_u5699558a229ba490(0);
                            }
                            #[allow(unreachable_code)] break 'switch_0;
                        }
                    }
                    let mut status: libc::c_int = unsafe { ::core::mem::zeroed() };
                    if (((((((((pid as libc::c_int)) < (((0) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
                        || (((((super::ACE_OS::waitpid_ua99c1cff38bad46d(
                            pid,
                            ::core::ptr::addr_of_mut!(status) as *mut libc::c_int,
                            0,
                            ((0) as libc::c_int),
                        ) as libc::c_int)) < (((0) as libc::c_int))) as libc::c_int
                            as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
                    ...
                    if ((((((((((((status))) as libc::c_int)) & ((127) as libc::c_int))
                        as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int)
                        as libc::c_int) != 0)
                    {
                        if (((((((((((((((status))) as libc::c_int))
                            & ((65280) as libc::c_int))) as libc::c_int))
                            .wrapping_shr((8) as u32)) as libc::c_int))
                            == (((0) as libc::c_int))) as libc::c_int as libc::c_int)
                            != 0)
                        {
                            return ((1) as libc::c_int);
                        } else {
                            ((*(super::__errno_location()))) = ((((((((((status)))
                                as libc::c_int)) & ((65280) as libc::c_int)))
                                as libc::c_int))
                                .wrapping_shr((8) as u32));
                        }
                    } else {
                        ((*(super::__errno_location()))) = 4;
                    }
                    return (((-((1) as libc::c_int))) as libc::c_int);
                }
            }
    ...
    #[doc = "* Become a daemon process using the algorithm in Richard Stevens\n   * \"Advanced Programming in the UNIX Environment.\"  If\n   * @a close_all_handles is non-zero then all open file handles are\n   * closed."]
    #[export_name = "_ZN3ACE9daemonizeEPKcbS1_"]
    pub unsafe extern "C-unwind" fn daemonize(
        mut pathname: *const libc::c_char,
        mut close_all_handles: bool,
        mut program_name: *const libc::c_char,
    ) -> libc::c_int {
        unsafe {
            {
                    ...
                    as libc::c_int) != 0)
                {
                    ...
                    if (((((pid as libc::c_int)) != (((0) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        super::ACE_OS::exit_ud318a3a23e137d2b(0);
                    }
                }
                super::ACE_OS::setsid_ua5c41d8548bb754b();
                super::ACE_OS::signal_u868eb443292c1ed5(
                    1,
                    (unsafe {
                        ::core::mem::transmute::<
                            usize,
                ...
                pid = super::ACE_OS::fork_uc56682233d614dbc(
                    ((program_name) as *const libc::c_char),
                );
                if (((((pid as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    super::ACE_OS::exit_ud318a3a23e137d2b(0);
                }
                if ((((!(pathname).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    super::ACE_OS::chdir_u77b018072c3d9162(
                        ((pathname) as *const libc::c_char),
                    );
                }
                super::ACE_OS::umask_uc870dde6e298b316(((0) as libc::c_uint));
                if ((close_all_handles as libc::c_int) != 0) {
                    {
                        let mut i: libc::c_int = (((max_handles()) as libc::c_int))
                        ...
                        'for_0: loop {
                            ...
                            'cont_0: loop {
                                {
                                    super::ACE_OS::close_u07c1eb6343f8c667(
                                        ((i) as libc::c_int),
                                    );
                                }
                                #[allow(unreachable_code)] break 'cont_0;
                    ...
                    let mut fd: libc::c_int = ((super::ACE_OS::open_u20e73ad42bc94ee0(
                    ...
                    if (((((fd as libc::c_int))
                        ...
                        as libc::c_int) != 0)
                    {
                        super::ACE_OS::dup2_uc67e543d2abcb368(
                            ((fd) as libc::c_int),
                            ((0) as libc::c_int),
                        );
                        super::ACE_OS::dup2_uc67e543d2abcb368(
                        ...
                        if (((((fd as libc::c_int)) > (((2) as libc::c_int)))
                            as libc::c_int as libc::c_int) != 0)
                        {
                            super::ACE_OS::close_u07c1eb6343f8c667(
                                ((fd) as libc::c_int),
    ...
    #[export_name = "_ZN3ACE17round_to_pagesizeEm"]
    pub unsafe extern "C-unwind" fn round_to_pagesize(
        mut len: libc::c_ulong,
    ) -> libc::c_ulong {
        unsafe {
            {
                if (((((pagesize_ as libc::c_ulong)) == (((0) as libc::c_ulong)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    pagesize_ = ((super::ACE_OS::getpagesize_u45b438574b8edc31())
                        as libc::c_ulong);
                }
                return (((((((len) as libc::c_ulong))
                    .wrapping_add(
                        (((((pagesize_) as libc::c_ulong))
    ...
    #[export_name = "_ZN3ACE31round_to_allocation_granularityEm"]
    pub unsafe extern "C-unwind" fn round_to_allocation_granularity(
        mut len: libc::c_ulong,
    ) -> libc::c_ulong {
        unsafe {
            {
                if (((((allocation_granularity_ as libc::c_ulong))
                    == (((0) as libc::c_ulong))) as libc::c_int as libc::c_int) != 0)
                {
                    allocation_granularity_ = ((super::ACE_OS::allocation_granularity())
                        as libc::c_ulong);
                }
                return (((((((len) as libc::c_ulong))
                    .wrapping_add(
                        (((((allocation_granularity_) as libc::c_ulong))
                            .wrapping_sub((1) as libc::c_ulong))) as libc::c_ulong,
                    ))) as libc::c_ulong))
                    & (((!(((((allocation_granularity_) as libc::c_ulong))
                        .wrapping_sub((1) as libc::c_ulong))))) as libc::c_ulong);
  ...
  /// debugging.*/
    #[export_name = "_ZN3ACE14format_hexdumpEPKcmPcm"]
    pub unsafe extern "C-unwind" fn format_hexdump(
        mut buffer: *const libc::c_char,
        mut size: libc::c_ulong,
        mut obuf: *mut libc::c_char,
        mut obuf_sz: libc::c_ulong,
    ) -> libc::c_ulong {
        unsafe {
            {
                let mut c: libc::c_uchar = unsafe { ::core::mem::zeroed() };
                let mut textver: [libc::c_char; 17usize] = unsafe {
                    ::core::mem::zeroed()
                };
                let mut maxlen: libc::c_ulong = (((((((obuf_sz) as libc::c_ulong))
                    / ((68) as libc::c_ulong))) as libc::c_ulong))
                    .wrapping_mul((16) as libc::c_ulong);
                let mut obuf_start: *const libc::c_char = ((obuf)
                    as *const libc::c_char);
                if (((((size as libc::c_ulong)) > (((maxlen) as libc::c_ulong)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    size = maxlen;
                }
                let mut i: libc::c_ulong = unsafe { ::core::mem::zeroed() };
                let mut lines: libc::c_ulong = (((((size) as libc::c_ulong))
                    / ((16) as libc::c_ulong)) as libc::c_ulong);
                {
                    i = ((0) as libc::c_ulong);
                    'for_0: loop {
                        if !((((((i as libc::c_ulong)) < (((lines) as libc::c_ulong)))
                            as libc::c_int as libc::c_int) != 0))
                        {
                            break;
                        }
                        'cont_0: loop {
                            {
                                {
                                    let mut j: libc::c_ulong = unsafe { ::core::mem::zeroed() };
                                    {
                                        j = ((0) as libc::c_ulong);
                                        'for_1: loop {
                                            if !((((((j as libc::c_ulong)) < (((16) as libc::c_ulong)))
                                                as libc::c_int as libc::c_int) != 0))
                                            {
                                                break;
                                            }
                                                ...
                                                {
                                                    {
                                                        c = ((*(buffer)
                                                            .wrapping_offset(
                                                                ((((((((i) as libc::c_ulong)).wrapping_shl((4) as u32)))
                                                                    as libc::c_ulong))
                                                                    .wrapping_add((j) as libc::c_ulong)) as isize,
                                                            )) as libc::c_uchar);
                                                        super::ACE_OS::snprintf_u9a28649a3b771eeb(
                                                            ((obuf) as *mut libc::c_char),
                                                            (((((obuf_sz) as libc::c_ulong))
                                                                .wrapping_sub(
                                                                    ((((obuf).offset_from(obuf_start)) as libc::c_long))
                                                                        as libc::c_ulong,
                                                                )) as libc::c_ulong),
                                                            ((b"%02x \0".as_ptr() as *const libc::c_char)
                                                                as *const libc::c_char),
                                                            ((c) as libc::c_int),
                                                        );
                                                        {
                                                            obuf = (obuf).wrapping_offset((3) as isize);
                                                            obuf
                                                        };
                                                        if (((((j as libc::c_ulong)) == (((7) as libc::c_ulong)))
                                                            as libc::c_int as libc::c_int) != 0)
                                                        {
                                                            (*({
                                                                let __lv = &mut (obuf);
                                                                ...
                                                                *__lv = (*__lv).wrapping_offset(1);
                                                                __r
                                                            })) = ((32 as libc::c_char) as libc::c_char);
                                                        }
                                                        (textver)[(j) as usize] = ((if ((super::ACE_OS::ace_isprint(
                                                            ((c) as libc::c_char),
                                                        )) != 0)
                                                        {
                                                            c
                                                        } else {
                                                            (46 as libc::c_char as libc::c_uchar)
                                                        }) as libc::c_char);
                                                    }
                                                }
                                                #[allow(unreachable_code)] break 'cont_1;
                                    ...
                                    (textver)[(j) as usize] = ((0) as libc::c_char);
                                    super::ACE_OS::snprintf_u9a28649a3b771eeb(
                                        ((obuf) as *mut libc::c_char),
                                        (((((obuf_sz) as libc::c_ulong))
                                            .wrapping_sub(
                                        ...
                                        ((b"  %s\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        ((textver).as_mut_ptr() as *mut libc::c_char),
                                    );
                                    'while_2: loop {
                                        if !(((((((*(obuf)) as libc::c_int as libc::c_char))
                                            != (((0 as libc::c_char) as libc::c_int as libc::c_char)))
                                            as libc::c_int as libc::c_int) != 0))
                                        {
                                            break 'while_2;
                ...
                if (((((size) as libc::c_ulong)) % ((16) as libc::c_ulong)) != 0) {
                    {
                        i = ((0) as libc::c_ulong);
                        'for_3: loop {
                            if !((((((i as libc::c_ulong))
                                < ((((((size) as libc::c_ulong)) % ((16) as libc::c_ulong))
                                    as libc::c_ulong))) as libc::c_int as libc::c_int) != 0))
                            {
                                break;
                            }
                                ...
                                {
                                    {
                                        ...
                                        if (((((i as libc::c_ulong)) == (((7) as libc::c_ulong)))
                                            as libc::c_int as libc::c_int) != 0)
                                        {
                                            (*({
                                                let __lv = &mut (obuf);
                                        ...
                                        (textver)[(i) as usize] = ((if ((super::ACE_OS::ace_isprint(
                                            ((c) as libc::c_char),
                                        )) != 0)
                                        {
                                            c
                    ...
                    {
                        i = (((size) as libc::c_ulong)) % ((16) as libc::c_ulong);
                        'for_4: loop {
                            if !((((((i as libc::c_ulong)) < (((16) as libc::c_ulong)))
                                as libc::c_int as libc::c_int) != 0))
                            {
                                break;
                            }
                                ...
                                {
                                    {
                                        ...
                                        (textver)[(i) as usize] = ((32 as libc::c_char)
                                            as libc::c_char);
                                    }
                                }
                    ...
                    (textver)[(i) as usize] = ((0) as libc::c_char);
                    super::ACE_OS::snprintf_u9a28649a3b771eeb(
                        ((obuf) as *mut libc::c_char),
                        (((((obuf_sz) as libc::c_ulong))
                            .wrapping_sub(
    ...
    #[export_name = "_ZN3ACE8hash_pjwEPKc"]
    pub unsafe extern "C-unwind" fn hash_pjw(
        mut str: *const libc::c_char,
    ) -> libc::c_ulong {
        unsafe {
            {
                return hash_pjw_u1df7e2c40de66984(
                    str,
                    super::ACE_OS::strlen_u07dd12a225364fa6(str),
                );
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    ...
    ///Computes the hash value of {str} using the "Hash PJW" routine.
    #[export_name = "_ZN3ACE8hash_pjwEPKcm"]
    pub unsafe extern "C-unwind" fn hash_pjw_u1df7e2c40de66984(
        mut str: *const libc::c_char,
        mut len: libc::c_ulong,
    ) -> libc::c_ulong {
        unsafe {
            {
                let mut hash: libc::c_ulong = ((0) as libc::c_ulong);
                {
                    let mut i: libc::c_ulong = ((0) as libc::c_ulong);
                    'for_0: loop {
                        if !((((((i as libc::c_ulong)) < (((len) as libc::c_ulong)))
                            as libc::c_int as libc::c_int) != 0))
                        {
                            break;
                        }
                        'cont_0: loop {
                            {
                                {
                                    let mut temp: libc::c_char = (*(str)
                                        .wrapping_offset((i) as isize));
                                    hash = (((((((hash) as libc::c_ulong))
                                        .wrapping_shl((4) as u32))) as libc::c_ulong))
                                        .wrapping_add(
                                            (((((temp) as libc::c_int))
                                                .wrapping_mul((13) as libc::c_int))) as libc::c_ulong,
                                        );
                                    let mut g: libc::c_ulong = (((hash) as libc::c_ulong))
                                        & ((0xf0000000u32) as libc::c_ulong);
                                    if ((g) != 0) {
                                        {
                                            hash = (((hash) as libc::c_ulong))
                                                ^ ((((((g) as libc::c_ulong)).wrapping_shr((24) as u32)))
                                                    as libc::c_ulong);
                                            hash
                                        };
                                        {
                                            hash = (((hash) as libc::c_ulong)) ^ ((g) as libc::c_ulong);
                                            hash
                                        };
                                    }
                                }
    ...
    ///Computes the hash value of {str} using the "Hash PJW" routine.
    #[export_name = "_ZN3ACE8hash_pjwEPKw"]
    pub unsafe extern "C-unwind" fn hash_pjw_ue0653afd76c2ae8d(
        mut str: *const libc::wchar_t,
    ) -> libc::c_ulong {
        unsafe {
            {
                return hash_pjw_uc7d0e36c0401b650(
                    str,
                    super::ACE_OS::strlen_u07b44aa22513a9ba(str),
                );
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    ...
    ///Computes the hash value of {str} using the "Hash PJW" routine.
    #[export_name = "_ZN3ACE8hash_pjwEPKwm"]
    pub unsafe extern "C-unwind" fn hash_pjw_uc7d0e36c0401b650(
        mut str: *const libc::wchar_t,
        mut len: libc::c_ulong,
    ) -> libc::c_ulong {
        unsafe {
    ...
    #[export_name = "_ZN3ACE3gcdEmm"]
    pub unsafe extern "C-unwind" fn gcd(
        mut x: libc::c_ulong,
        mut y: libc::c_ulong,
    ) -> libc::c_ulong {
        unsafe {
            {
                'while_0: loop {
                    if !((((((y as libc::c_ulong)) != (((0) as libc::c_ulong)))
                        as libc::c_int as libc::c_int) != 0))
                    {
                        break 'while_0;
                    }
                    'cont_0: loop {
                        {
                            {
                                let mut r: libc::c_ulong = (((x) as libc::c_ulong))
                                    % ((y) as libc::c_ulong);
                                x = y;
                                y = r;
                            }
    ...
    #[export_name = "_ZN3ACE18minimum_frame_sizeEmm"]
    pub unsafe extern "C-unwind" fn minimum_frame_size(
        mut period1: libc::c_ulong,
        mut period2: libc::c_ulong,
    ) -> libc::c_ulong {
        unsafe {
            {
                if (((((0 as libc::c_ulong)) == (((period1) as libc::c_ulong)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    return period2;
                }
                if (((((0 as libc::c_ulong)) == (((period2) as libc::c_ulong)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    return period1;
                }
                let mut greatest_common_divisor: libc::c_ulong = gcd(period1, period2);
                if (((((greatest_common_divisor as libc::c_ulong))
                    == (((1) as libc::c_ulong))) as libc::c_int as libc::c_int) != 0)
                {
                    return (((period1) as libc::c_ulong))
                        .wrapping_mul((period2) as libc::c_ulong);
                } else {
                    if (((((greatest_common_divisor as libc::c_ulong))
                        == (((period1) as libc::c_ulong))) as libc::c_int as libc::c_int)
                        != 0)
                    {
                        return period2;
                    } else {
                        if (((((greatest_common_divisor as libc::c_ulong))
                            == (((period2) as libc::c_ulong))) as libc::c_int
                            as libc::c_int) != 0)
                        {
                            return period1;
                        } else {
                            return (((((((period1) as libc::c_ulong))
                                .wrapping_mul((period2) as libc::c_ulong)))
                                as libc::c_ulong))
                                / ((greatest_common_divisor) as libc::c_ulong);
                        }
                    }
                }
            }
    ...
    #[doc = "* Function that can burn up noticeable CPU time:  brute-force\n   * determination of whether number @a n is prime.  Returns 0 if\n   * it is prime, or the smallest factor if it is not prime.\n   * @a min_factor and @a max_factor can be used to partition the work\n   * among threads. For just one thread, typical values are 2 and\n   * n/2."]
    #[export_name = "_ZN3ACE8is_primeEmmm"]
    pub unsafe extern "C-unwind" fn is_prime(
        mut n: libc::c_ulong,
        mut min_factor: libc::c_ulong,
        mut max_factor: libc::c_ulong,
    ) -> libc::c_ulong {
        unsafe {
            {
                if (((((n as libc::c_ulong)) > (((3) as libc::c_ulong))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    {
                        let mut factor: libc::c_ulong = ((min_factor) as libc::c_ulong);
                        'for_0: loop {
                            if !((((((factor as libc::c_ulong))
                                <= (((max_factor) as libc::c_ulong))) as libc::c_int
                                as libc::c_int) != 0))
                            {
                                break;
                            }
                            'cont_0: loop {
                                {
                                    if (((((((((((n) as libc::c_ulong))
                                        / ((factor) as libc::c_ulong)) as libc::c_ulong))
                                        .wrapping_mul((factor) as libc::c_ulong) as libc::c_ulong))
                                        == (((n) as libc::c_ulong))) as libc::c_int as libc::c_int)
                                        != 0)
                                    {
                                        return factor;
                                    }
  ...
  /// @internal*/
    #[export_name = "_ZN3ACE10sock_errorEi"]
    pub unsafe extern "C-unwind" fn sock_error(
        mut error: libc::c_int,
    ) -> *const libc::c_char {
        unsafe {
            {
  ...
  /// @internal*/
    #[export_name = "_ZN3ACE13is_sock_errorEi"]
    pub unsafe extern "C-unwind" fn is_sock_error(mut error: libc::c_int) -> bool {
        unsafe {
            {
                {
                    let _ = (error);
    ...
    #[doc = "* Checks if process with {pid} is still alive.  Returns 1 if it is\n   * still alive, 0 if it isn't alive, and -1 if something weird\n   * happened."]
    #[export_name = "_ZN3ACE14process_activeEi"]
    pub unsafe extern "C-unwind" fn process_active(mut pid: libc::c_int) -> libc::c_int {
        unsafe {
            {
                if (((((super::ACE_OS::kill_udafa4deef137b5a3(pid, 0) as libc::c_int))
                    == (((0) as libc::c_int))) as libc::c_int as libc::c_int) != 0)
                {
                    return 1;
                } else {
                    if (((((((*(super::__errno_location()))) as libc::c_int))
                        == (((3) as libc::c_int))) as libc::c_int as libc::c_int) != 0)
                    {
                        return 0;
                    } else {
                        return (-((1) as libc::c_int));
    ...
    #[export_name = "_ZN3ACE10nibble2hexEj"]
    pub unsafe extern "C-unwind" fn nibble2hex(mut n: libc::c_uint) -> libc::c_char {
        unsafe {
            {
                return (((*(b"0123456789abcdef\0".as_ptr() as *const libc::c_char)
                    .wrapping_offset(
                        ((((n) as libc::c_uint)) & ((0x0f) as libc::c_uint)) as isize,
                    ))) as libc::c_char);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    ...
    #[export_name = "_ZN3ACE5debugEv"]
    pub unsafe extern "C-unwind" fn debug() -> bool {
        unsafe {
            {
                static mut debug: *const libc::c_char = unsafe {
                    ::core::mem::MaybeUninit::<*const libc::c_char>::zeroed()
                        .assume_init()
                };
                {
                    static __init_debug_13853: ::std::sync::Once = ::std::sync::Once::new();
                    __init_debug_13853
                        .call_once(|| unsafe {
                            ::core::ptr::write(
                                ::core::ptr::addr_of_mut!(debug),
                                ((super::ACE_OS::getenv_u25dce132a786d601(
                                    ((b"ACE_DEBUG\0".as_ptr() as *const libc::c_char)
                                        as *const libc::c_char),
                                )) as *const libc::c_char),
                            );
                        });
                ...
                return crate::__cxx_std::__Truthy::__truthy(
                    ((if ((((((debug_ as libc::c_int)) != (((0) as libc::c_int)))
                        as libc::c_int) as libc::c_int) != 0)
                    {
                        ((debug_) as libc::c_int)
                    } else {
                        (((if ((((!(debug).is_null()) as libc::c_int) as libc::c_int)
                            != 0)
                        {
                            (((((((*(debug)) as libc::c_int as libc::c_char))
                                != (((48 as libc::c_char) as libc::c_int as libc::c_char)))
                                as libc::c_int) as libc::c_int) != 0)
                        } else {
                            false
                        })) as libc::c_int)
    ...
    #[export_name = "_ZN3ACE5debugEb"]
    pub unsafe extern "C-unwind" fn debug_u300ab704d1c44c4a(mut onoff: bool) {
        unsafe {
            {
                debug_ = ((onoff) as libc::c_char);
            }
            ()
        }
    }
    ///Wrapper facade for @c select that uses @c ACE_Handle_Sets.
    #[export_name = "_ZN3ACE6selectEiP14ACE_Handle_SetS1_S1_PK14ACE_Time_Value"]
    pub unsafe extern "C-unwind" fn select_u68dbe54b28affe83(
        mut width: libc::c_int,
        mut readfds: *mut super::ACE_Handle_Set,
        mut writefds: *mut super::ACE_Handle_Set,
        mut exceptfds: *mut super::ACE_Handle_Set,
        mut timeout: *const super::ACE_Time_Value,
    ) -> libc::c_int {
        unsafe {
            {
                let mut result: libc::c_int = super::ACE_OS::select_u1d2fd7bfb0b79951(
                    width,
                    if (!(readfds).is_null()) {
                        <super::ACE_Handle_Set>::fdset(
                            (readfds) as *mut super::ACE_Handle_Set,
                        )
                    } else {
                        ((0) as *mut super::fd_set)
                    },
                    if (!(writefds).is_null()) {
                        <super::ACE_Handle_Set>::fdset(
                            (writefds) as *mut super::ACE_Handle_Set,
                        )
                    } else {
                        ((0) as *mut super::fd_set)
                    },
                    if (!(exceptfds).is_null()) {
                        <super::ACE_Handle_Set>::fdset(
                            (exceptfds) as *mut super::ACE_Handle_Set,
                        )
                    } else {
                        ((0) as *mut super::fd_set)
                    },
  ...
  /// @c ACE_Handle_Sets.*/
    #[export_name = "_ZN3ACE6selectEiR14ACE_Handle_SetPK14ACE_Time_Value"]
    pub unsafe extern "C-unwind" fn select_u00462dd3223da577(
        mut width: libc::c_int,
        mut readfds: *mut super::ACE_Handle_Set,
        mut timeout: *const super::ACE_Time_Value,
    ) -> libc::c_int {
        unsafe {
            {
                let mut result: libc::c_int = super::ACE_OS::select_u1d2fd7bfb0b79951(
                    width,
                    <super::ACE_Handle_Set>::fdset(
                        (::core::ptr::addr_of_mut!((* readfds)))
                            as *mut super::ACE_Handle_Set,
                    ),
                    ((0) as *mut super::fd_set),
                    ((0) as *mut super::fd_set),
                    timeout,
  ...
  /// @retval 1 the handle is ready*/
    #[export_name = "_ZN3ACE12handle_readyEiPK14ACE_Time_Valuebbb"]
    pub unsafe extern "C-unwind" fn handle_ready(
        mut handle: libc::c_int,
        mut timeout: *const super::ACE_Time_Value,
        mut read_ready: bool,
        mut write_ready: bool,
        mut exception_ready: bool,
    ) -> libc::c_int {
        unsafe {
            {
                {
                    let _ = (exception_ready);
                };
                let mut fds: super::pollfd = unsafe {
                    ::core::mem::MaybeUninit::<super::pollfd>::zeroed().assume_init()
                };
                fds.fd = ((handle) as libc::c_int);
                fds.events = ((if ((read_ready as libc::c_int) != 0) { 1 } else { 0 })
                    as libc::c_short);
                if ((write_ready as libc::c_int) != 0) {
                    {
                        let __lv = ::core::ptr::addr_of_mut!(fds.events);
                        unsafe {
                            *__lv = ((((*__lv)) as libc::c_int as libc::c_short))
                ...
                fds.revents = ((0) as libc::c_short);
                let mut result: libc::c_int = ((super::ACE_OS::poll_uafd6e356b68ec65c(
                    ::core::ptr::addr_of_mut!(fds) as *mut super::pollfd,
                    ((1) as libc::c_ulong),
                    timeout,
                )) as libc::c_int);
                'switch_0: {
                    let __c: libc::c_int = result;
                    #[allow(unused_assignments)]
                    let mut __m: u32 = 3;
                    {
                        let __cv_0: libc::c_int = (0 as libc::c_int);
  ...
  /// not.*/
    #[export_name = "_ZN3ACE20enter_recv_timedwaitEiPK14ACE_Time_ValueRi"]
    pub unsafe extern "C-unwind" fn enter_recv_timedwait(
        mut handle: libc::c_int,
        mut timeout: *const super::ACE_Time_Value,
        ...
        unsafe {
            {
                let mut result: libc::c_int = ((handle_read_ready(handle, timeout))
                    as libc::c_int);
  ...
  /// @a val keeps track of whether we're in non-blocking mode or
  /// not.*/
    #[export_name = "_ZN3ACE20enter_send_timedwaitEiPK14ACE_Time_ValueRi"]
    pub unsafe extern "C-unwind" fn enter_send_timedwait(
        mut handle: libc::c_int,
        mut timeout: *const super::ACE_Time_Value,
        mut val: *mut libc::c_int,
    ) -> libc::c_int {
        unsafe {
            {
                let mut result: libc::c_int = ((handle_write_ready(handle, timeout))
                    as libc::c_int);
                if (((((result as libc::c_int))
                    == ((((-((1) as libc::c_int))) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
  ...
  /// @a val keeps track of whether were in non-blocking mode or not.*/
    #[export_name = "_ZN3ACE32record_and_set_non_blocking_modeEiRi"]
    pub unsafe extern "C-unwind" fn record_and_set_non_blocking_mode(
        mut handle: libc::c_int,
        mut val: *mut libc::c_int,
    ) {
        unsafe {
            {
                (*val) = get_flags(handle);
                if ((((((((((((*val))) as libc::c_int)) & (((2048)) as libc::c_int))
                    as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    set_flags(handle, 2048);
                }
            }
            ()
        }
  ...
  /// non-blocking status of @a handle.*/
    #[export_name = "_ZN3ACE25restore_non_blocking_modeEii"]
    pub unsafe extern "C-unwind" fn restore_non_blocking_mode(
        mut handle: libc::c_int,
        mut val: libc::c_int,
    ) {
        unsafe {
            {
                if (((((((((((val)) as libc::c_int)) & (((2048)) as libc::c_int))
                    ...
                    as libc::c_int) != 0)
                {
                    let mut error: super::ACE_Errno_Guard = ::core::mem::MaybeUninit::<
                        super::ACE_Errno_Guard,
                    >::zeroed()
                        .assume_init();
                    <super::ACE_Errno_Guard>::new_at_u581aee1139351ac3(
                        (::core::ptr::addr_of_mut!(error))
                            as *mut super::ACE_Errno_Guard,
                        super::__errno_location(),
                    );
                    clr_flags(handle, 2048);
                }
            }
            ()
        }
    ...
    #[export_name = "_ZN3ACE8recv_n_iEiPvmiPm"]
    pub unsafe extern "C-unwind" fn recv_n_i_ube713064e95e6c1e(
        mut handle: libc::c_int,
        mut buf: *mut libc::c_void,
        mut len: libc::c_ulong,
        mut flags: libc::c_int,
        ...
        unsafe {
            {
                ...
                let mut n: libc::c_long = unsafe { ::core::mem::zeroed() };
                {
                    (*bytes_transferred) = ((0) as libc::c_ulong);
                    'for_0: loop {
                        if !(((((((*bytes_transferred) as libc::c_ulong))
                            < (((len) as libc::c_ulong))) as libc::c_int as libc::c_int)
                            != 0))
                        {
                            break;
                        }
                        'cont_0: loop {
                            {
                                {
                                    n = super::ACE_OS::recv_u32019f19ae792060(
                                        handle,
                                        ((((buf as *mut libc::c_char))
                                            .wrapping_offset(((*bytes_transferred)) as isize))
                                            as *mut libc::c_char),
                                        (((len) as libc::c_ulong))
                                            .wrapping_sub(((*bytes_transferred)) as libc::c_ulong),
                                        flags,
                                    );
                                    if (((((n as libc::c_long)) == (((0) as libc::c_long)))
                                        as libc::c_int as libc::c_int) != 0)
                                    ...
                                    {
                                        if (((((((*(super::__errno_location()))) as libc::c_int))
                                            == (((11) as libc::c_int))) as libc::c_int as libc::c_int)
                                            != 0)
                                        {
                                            let mut result: libc::c_int = ((handle_read_ready(
                                                handle,
                                                ((0) as *const super::ACE_Time_Value),
                                            )) as libc::c_int);
                                            if (((((result as libc::c_int))
    ...
    #[export_name = "_ZN3ACE8recv_n_iEiPvmiPK14ACE_Time_ValuePm"]
    pub unsafe extern "C-unwind" fn recv_n_i_u611e7f8bb985d036(
        mut handle: libc::c_int,
        mut buf: *mut libc::c_void,
        mut len: libc::c_ulong,
        mut flags: libc::c_int,
        ...
        unsafe {
            {
                ...
                let mut n: libc::c_long = unsafe { ::core::mem::zeroed() };
                let mut result: libc::c_long = ((0) as libc::c_long);
                let mut error: libc::c_int = 0;
                let mut val: libc::c_int = 0;
                record_and_set_non_blocking_mode(handle, ::core::ptr::addr_of_mut!(val));
                {
                    (*bytes_transferred) = ((0) as libc::c_ulong);
                    'for_0: loop {
                        if !(((((((*bytes_transferred) as libc::c_ulong))
                            ...
                            {
                                {
                                        ...
                                        as libc::c_int) != 0)
                                    {
                                        if (((((((((n as libc::c_long))
                                            == ((((-((1) as libc::c_int))) as libc::c_long)))
                                            as libc::c_int as libc::c_int) != 0)
                                            && (((((((*(super::__errno_location()))) as libc::c_int))
                                                == (((11) as libc::c_int))) as libc::c_int as libc::c_int)
                                                != 0)) as libc::c_int) as libc::c_int) != 0)
                                        {
                                            let mut rtn: libc::c_int = ((handle_read_ready(
                                                handle,
                                                timeout,
                                            )) as libc::c_int);
                                            if (((((rtn as libc::c_int))
                                                != ((((-((1) as libc::c_int))) as libc::c_int)))
                                                as libc::c_int as libc::c_int) != 0)
                                            {
                                                n = ((0) as libc::c_long);
    ...
    #[export_name = "_ZN3ACE8recv_n_iEiPvmPm"]
    pub unsafe extern "C-unwind" fn recv_n_i_u657193012b74eb3a(
        mut handle: libc::c_int,
        mut buf: *mut libc::c_void,
        mut len: libc::c_ulong,
        mut bt: *mut libc::c_ulong,
    ...
    #[export_name = "_ZN3ACE8recv_n_iEiPvmPK14ACE_Time_ValuePm"]
    pub unsafe extern "C-unwind" fn recv_n_i(
        mut handle: libc::c_int,
        mut buf: *mut libc::c_void,
        mut len: libc::c_ulong,
        mut timeout: *const super::ACE_Time_Value,
    ...
    #[export_name = "_ZN3ACE9recvv_n_iEiP5ioveciPm"]
    pub unsafe extern "C-unwind" fn recvv_n_i_ue6b6b92f3b58e3e4(
        mut handle: libc::c_int,
        mut iov: *mut super::iovec,
        mut iovcnt: libc::c_int,
        mut bt: *mut libc::c_ulong,
                ...
                (*bytes_transferred) = ((0) as libc::c_ulong);
                {
                    ...
                    'for_0: loop {
                        ...
                        'cont_0: loop {
                            {
                                {
                                    let mut n: libc::c_long = super::ACE_OS::recvv_u5bf3764b3b283ae9(
                                        handle,
                                        (((iov).wrapping_offset((s) as isize))
                                            as *mut super::iovec),
                                        (((iovcnt) as libc::c_int)).wrapping_sub((s) as libc::c_int),
    ...
    #[export_name = "_ZN3ACE9recvv_n_iEiP5ioveciPK14ACE_Time_ValuePm"]
    pub unsafe extern "C-unwind" fn recvv_n_i(
        mut handle: libc::c_int,
        mut iov: *mut super::iovec,
        mut iovcnt: libc::c_int,
        mut timeout: *const super::ACE_Time_Value,
    ...
    #[export_name = "_ZN3ACE8send_n_iEiPKvmiPm"]
    pub unsafe extern "C-unwind" fn send_n_i_u29b9c88dde4b736b(
        mut handle: libc::c_int,
        mut buf: *const libc::c_void,
        mut len: libc::c_ulong,
        mut flags: libc::c_int,
                ...
                let mut n: libc::c_long = unsafe { ::core::mem::zeroed() };
                {
                    ...
                    'for_0: loop {
                        ...
                        'cont_0: loop {
                            {
                                {
                                    n = super::ACE_OS::send_u46b905aa4005e9e7(
                                        handle,
                                        ((((buf as *mut libc::c_char))
                                            .wrapping_offset(((*bytes_transferred)) as isize))
                                            as *const libc::c_char),
                                    ...
                                    {
                                        if (((((((((((*(super::__errno_location())))
                                            as libc::c_int)) == (((11) as libc::c_int))) as libc::c_int
                                            as libc::c_int) != 0)
                                            || (((((((*(super::__errno_location()))) as libc::c_int))
                                                == (((105) as libc::c_int))) as libc::c_int as libc::c_int)
                                                != 0)) as libc::c_int) as libc::c_int) != 0)
                                        {
                                            let mut result: libc::c_int = ((handle_write_ready(
                                                handle,
                                                ((0) as *const super::ACE_Time_Value),
                                            )) as libc::c_int);
                                            if (((((result as libc::c_int))
    ...
    #[export_name = "_ZN3ACE8send_n_iEiPKvmiPK14ACE_Time_ValuePm"]
    pub unsafe extern "C-unwind" fn send_n_i_uca7d9e5057923519(
        mut handle: libc::c_int,
        mut buf: *const libc::c_void,
        mut len: libc::c_ulong,
        mut flags: libc::c_int,
                            ...
                            {
                                {
                                        ...
                                        as libc::c_int) != 0)
                                    {
                                        if (((((((((n as libc::c_long))
                                            ...
                                            as libc::c_int) as libc::c_int) != 0)
                                        {
                                            let mut rtn: libc::c_int = ((handle_write_ready(
                                                handle,
                                                timeout,
                                            )) as libc::c_int);
                                            if (((((rtn as libc::c_int))
    ...
    #[export_name = "_ZN3ACE8send_n_iEiPKvmPm"]
    pub unsafe extern "C-unwind" fn send_n_i_u9fd33f238b140983(
        mut handle: libc::c_int,
        mut buf: *const libc::c_void,
        mut len: libc::c_ulong,
        mut bt: *mut libc::c_ulong,
    ...
    #[export_name = "_ZN3ACE8send_n_iEiPKvmPK14ACE_Time_ValuePm"]
    pub unsafe extern "C-unwind" fn send_n_i(
        mut handle: libc::c_int,
        mut buf: *const libc::c_void,
        mut len: libc::c_ulong,
        mut timeout: *const super::ACE_Time_Value,
    ...
    #[export_name = "_ZN3ACE9sendv_n_iEiPK5ioveciPm"]
    pub unsafe extern "C-unwind" fn sendv_n_i_ua83fa69ef4917cf5(
        mut handle: libc::c_int,
        mut i: *const super::iovec,
        mut iovcnt: libc::c_int,
        mut bt: *mut libc::c_ulong,
                ...
                let mut iov: *mut super::iovec = (i as *mut super::iovec);
                {
                    ...
                    'for_0: loop {
                        ...
                        'cont_0: loop {
                            {
                                {
                                    let mut n: libc::c_long = super::ACE_OS::sendv_u2741ac8ad81ed9fe(
                                        handle,
                                        ((iov).wrapping_offset((s) as isize))
                                            as *const super::iovec,
                                        (((iovcnt) as libc::c_int)).wrapping_sub((s) as libc::c_int),
    ...
    #[export_name = "_ZN3ACE9sendv_n_iEiPK5ioveciPK14ACE_Time_ValuePm"]
    pub unsafe extern "C-unwind" fn sendv_n_i(
        mut handle: libc::c_int,
        mut i: *const super::iovec,
        mut iovcnt: libc::c_int,
        mut timeout: *const super::ACE_Time_Value,
    ...
    #[no_mangle]
    pub static mut allocation_granularity_: libc::c_ulong = ((0) as libc::c_ulong);
    #[no_mangle]
    pub static mut pagesize_: libc::c_ulong = ((0) as libc::c_ulong);
    #[no_mangle]
    pub static mut debug_: libc::c_char = unsafe {
        ::core::mem::MaybeUninit::<libc::c_char>::zeroed().assume_init()
    };
}
extern "C-unwind" {
...
pub mod ACE_OS {
    ...
    pub use crate::full_ops_0::ACE_OS::select_u1d2fd7bfb0b79951;
    pub use crate::full_ops_0::ACE_OS::select_ufb84c962ccce6ead;
    pub use crate::full_ops_0::ACE_OS::strcasecmp_u16aef50f9fc896fe;
    pub use crate::full_ops_0::ACE_OS::strcasecmp_u96e543e20a0023aa;
    pub use crate::full_ops_0::ACE_OS::strncasecmp_u0fce6df40cea66eb;
    pub use crate::full_ops_0::ACE_OS::strncasecmp_u1f447f04c52e86b7;
    pub use crate::full_ops_0::ACE_OS::getrlimit_u4b95a386b5c97de9;
    pub use crate::full_ops_0::ACE_OS::getrusage_uad34c2a8c422cec1;
    pub use crate::full_ops_0::ACE_OS::setrlimit_uba2c05ddd65b35bc;
    ...
    pub use crate::full_ops_0::ACE_OS::t_accept;
    pub use crate::full_ops_0::ACE_OS::t_alloc;
    pub use crate::full_ops_0::ACE_OS::t_bind;
    pub use crate::full_ops_0::ACE_OS::t_close;
    pub use crate::full_ops_0::ACE_OS::t_connect;
    pub use crate::full_ops_0::ACE_OS::t_error;
    pub use crate::full_ops_0::ACE_OS::t_free;
    pub use crate::full_ops_0::ACE_OS::t_getinfo;
    pub use crate::full_ops_0::ACE_OS::t_getname;
    pub use crate::full_ops_0::ACE_OS::t_getstate;
    pub use crate::full_ops_0::ACE_OS::t_listen;
    pub use crate::full_ops_0::ACE_OS::t_look;
    pub use crate::full_ops_0::ACE_OS::t_open;
    pub use crate::full_ops_0::ACE_OS::t_optmgmt;
    pub use crate::full_ops_0::ACE_OS::t_rcv;
    pub use crate::full_ops_0::ACE_OS::t_rcvdis;
    pub use crate::full_ops_0::ACE_OS::t_rcvrel;
    pub use crate::full_ops_0::ACE_OS::t_rcvudata;
    pub use crate::full_ops_0::ACE_OS::t_rcvuderr;
    pub use crate::full_ops_0::ACE_OS::t_snd;
    pub use crate::full_ops_0::ACE_OS::t_snddis;
    pub use crate::full_ops_0::ACE_OS::t_sndrel;
    pub use crate::full_ops_0::ACE_OS::t_sync;
    pub use crate::full_ops_0::ACE_OS::t_unbind;
    pub use crate::full_ops_0::ACE_OS::poll_uafd6e356b68ec65c;
    pub use crate::full_ops_0::ACE_OS::poll_ua5b526bc4173db28;
}
pub mod ACE_Utils {
    #[allow(non_upper_case_globals)]
    ...
    #[repr(C)]
    #[derive(Copy, Clone)]
    pub struct Truncator_unsigned_long__unsigned_long_ {}
    pub use crate::full_ops_0::ACE_Utils::truncator;
    pub use crate::full_ops_0::ACE_Utils::truncate_cast___long__ub591475ebc843689;
    pub type truncator_621 = Truncator_unsigned_long__long_;
    pub use crate::full_ops_0::ACE_Utils::truncate_cast___unsigned_long__u503964095c07d269;
    pub type truncator_622 = Truncator_unsigned_long__unsigned_long_;
    #[doc = "* @class truncate_cast\n   *\n   * @brief Helper function to truncate an integral value to the\n   *        maximum  value of the given type.\n   *\n   *        Very useful since ACE methods return @c int very often and\n   *        the value's source is often a different-size integral\n   *        type, such as @c size_t.  This function hides the\n   *        truncation logic and resolves compiler diagnostics.\n   *\n   * @internal Internal use only."]
    #[export_name = "_ZN9ACE_Utils13truncate_castImmEET_T0_"]
    pub unsafe extern "C-unwind" fn truncate_cast___unsigned_long__u1d9a2ec2b81302c9(
        mut val: libc::c_ulong,
    ) -> libc::c_ulong {
        unsafe {
            {
                return <Truncator_unsigned_long__unsigned_long_>::operator_call(
                    (((&mut ({
                        let mut __recv: Truncator_unsigned_long__unsigned_long_ = <Truncator_unsigned_long__unsigned_long_>::new_sdd843d58bb1108ae();
                        __recv
                    })) as *mut Truncator_unsigned_long__unsigned_long_))
                        as *mut Truncator_unsigned_long__unsigned_long_,
                    val,
                );
            }
    ...
    impl Truncator_unsigned_long__unsigned_long_ {
        ...
        pub unsafe fn new_at_sdd843d58bb1108ae(__this: *mut Self) {
            unsafe {
                ::core::ptr::write(
                    __this,
        ...
        pub unsafe fn new_sdd843d58bb1108ae() -> Self {
            let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed()
                .assume_init();
            Self::new_at_sdd843d58bb1108ae(::core::ptr::addr_of_mut!(__obj));
            __obj
        }
    }
}
...
pub mod __anon_ns_14319 {
    pub(crate) unsafe extern "C-unwind" fn equal_char(
        mut a: libc::c_char,
        mut b: libc::c_char,
        mut case_sensitive: bool,
    ) -> bool {
        unsafe {
            {
                if ((case_sensitive as libc::c_int) != 0) {
                    return (((((a as libc::c_int as libc::c_char))
                        == (((b) as libc::c_int as libc::c_char))) as libc::c_int
                        as libc::c_int) != 0);
                }
                return (((((super::ACE_OS::ace_tolower(((a) as libc::c_int))
                    as libc::c_int))
                    == (((super::ACE_OS::ace_tolower(((b) as libc::c_int)))
                        as libc::c_int))) as libc::c_int as libc::c_int) != 0);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    pub(crate) unsafe extern "C-unwind" fn equal_class(
        mut s: libc::c_char,
        ...
        unsafe {
            {
                ...
                if ((((((*((*p))) as libc::c_int as libc::c_char))
                    == (((33 as libc::c_char) as libc::c_int as libc::c_char)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    negate = true;
                    {
                    ...
                    'for_0: loop {
                        if !((((((((*((*p)))) != 0)
                            && (((((((first as libc::c_int) != 0)
                                || ((((((*((*p))) as libc::c_int as libc::c_char))
                                    != (((93 as libc::c_char) as libc::c_int as libc::c_char)))
                                    as libc::c_int as libc::c_int) != 0)) as libc::c_int))
                                as libc::c_int) != 0)) as libc::c_int) as libc::c_int)
                            != 0))
                        {
                            ...
                            {
                                {
                                    if (((((((((((!(((first as libc::c_int) != 0))
                                        as libc::c_int) as libc::c_int) != 0)
                                        && ((((((*((*p))) as libc::c_int as libc::c_char))
                                            == (((45 as libc::c_char) as libc::c_int as libc::c_char)))
                                            as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                                        as libc::c_int) != 0)
                                        && ((((((*((*p)).wrapping_offset((1) as isize))
                                            as libc::c_int as libc::c_char))
                                            != (((93 as libc::c_char) as libc::c_int as libc::c_char)))
                                            as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                                        as libc::c_int) != 0)
                                    {
                                        if (((((((!((((*((*p)).wrapping_offset((1) as isize)))
                                            != 0)) as libc::c_int) as libc::c_int) != 0)
                                            || ((((((*((*p)).wrapping_offset((1) as isize))
                                                as libc::c_int as libc::c_char))
                                                <= ((((*((*p))
                                                    .wrapping_offset(((-((1) as libc::c_int))) as isize)))
                                                    as libc::c_int as libc::c_char))) as libc::c_int
                                                as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
                                        {
                                            break 'cont_0;
                                        }
                                        {
                                            let mut range: libc::c_char = (((((*((*p))
                                                .wrapping_offset(((-((1) as libc::c_int))) as isize)))
                                                as libc::c_int))
                                                .wrapping_add((1) as libc::c_int) as libc::c_char);
                                            'for_1: loop {
                                                if !((((((range as libc::c_int as libc::c_char))
                                                    <= ((((*((*p)).wrapping_offset((1) as isize)))
                                                        as libc::c_int as libc::c_char))) as libc::c_int
                                                    as libc::c_int) != 0))
                                                {
                                                ...
                                                'cont_1: loop {
                                                    {
                                                        {
                                                            if ((equal_char(s, range, case_sensitive) as libc::c_int)
                                                                != 0)
                                                            {
                                                                'while_2: loop {
                                                                    if !(((((((*({
                                                                ...
                                                                return (((!(((negate as libc::c_int) != 0)) as libc::c_int)
                                                                    as libc::c_int) != 0);
                                                            }
                                                        }
                                                    }
                ...
                return crate::__cxx_std::__Truthy::__truthy(negate);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
...
extern "C-unwind" {
    pub fn __builtin_alloca(_anon_0: libc::c_ulong) -> *mut libc::c_void;
}
