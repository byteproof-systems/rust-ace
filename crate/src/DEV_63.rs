...
#[export_name = "_ZN7ACE_DEV5closeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN7ACE_DEV5closeEv(
    __this: *mut ACE_DEV,
) -> libc::c_int {
    unsafe { ACE_DEV::close(__this) }
}
#[export_name = "_ZNK7ACE_DEV4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK7ACE_DEV4dumpEv(__this: *const ACE_DEV) {
    unsafe { ACE_DEV::dump(__this) }
}
#[export_name = "_ZN7ACE_DEVC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN7ACE_DEVC1Ev(__this: *mut ACE_DEV) {
    ACE_DEV::new_at(__this)
}
extern "C-unwind" {
