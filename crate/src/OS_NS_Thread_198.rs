...
pub mod ACE_OS {
  ...
  /// structures for thread ids.*/
    #[no_mangle]
    pub static mut NULL_thread: libc::c_ulong = unsafe {
        ::core::mem::MaybeUninit::<libc::c_ulong>::zeroed().assume_init()
    };
    /**This is necessary to deal with POSIX pthreads and their use of
  /// structures for thread handles.*/
    #[no_mangle]
    pub static mut NULL_hthread: libc::c_ulong = unsafe {
        ::core::mem::MaybeUninit::<libc::c_ulong>::zeroed().assume_init()
    };
    /**This is necessary to deal with POSIX pthreads and their use of
  /// structures for TSS keys.*/
    #[no_mangle]
    pub static mut NULL_key: libc::c_uint = unsafe {
        ::core::mem::MaybeUninit::<libc::c_uint>::zeroed().assume_init()
    };
    #[doc = "* Call TSS destructors for the current thread.  If the current\n   * thread is the main thread, then the argument must be 1.\n   * For private use of ACE_Object_Manager and ACE_Thread_Adapter only."]
    #[export_name = "_ZN6ACE_OS11cleanup_tssEj"]
    pub unsafe extern "C-unwind" fn cleanup_tss(mut main_thread: libc::c_uint) {
        unsafe {
            {
                if ((main_thread) != 0) {
                    <super::ACE_Base_Thread_Adapter>::close_log_msg();
                }
            }
            ()
        }
    ...
    #[export_name = "_ZN6ACE_OS9cond_initEP14pthread_cond_tsPKcPv"]
    pub unsafe extern "C-unwind" fn cond_init_ue107a1ce456396d5(
        mut cv: *mut super::pthread_cond_t,
        mut r#type: libc::c_short,
        mut name: *const libc::c_char,
        mut arg: *mut libc::c_void,
    ) -> libc::c_int {
        unsafe {
            {
                let mut attributes: super::pthread_condattr_t = unsafe {
                    ::core::mem::MaybeUninit::<super::pthread_condattr_t>::zeroed()
                        .assume_init()
                };
                if (((((((((condattr_init(
                    ::core::ptr::addr_of_mut!(attributes),
                    ((r#type) as libc::c_int),
                ...
                {
                    {
                        let _ = condattr_destroy(::core::ptr::addr_of_mut!(attributes));
                    };
                    return 0;
                }
    ...
    #[export_name = "_ZN6ACE_OS13event_destroyEP11ACE_event_t"]
    pub unsafe extern "C-unwind" fn event_destroy(
        mut event: *mut super::ACE_event_t,
    ) -> libc::c_int {
        unsafe {
            {
                if (((!((!((*event).eventdata_).is_null())) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    ((*(super::__errno_location()))) = 22;
                    return (-((1) as libc::c_int));
                }
                if ((((((*(*event).eventdata_).type_ as libc::c_int))
                    == ((((1 as libc::c_int)) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    if (!((*event).name_).is_null()) {
                        let mut r1: libc::c_int = unsafe { ::core::mem::zeroed() };
                        let mut r2: libc::c_int = unsafe { ::core::mem::zeroed() };
                        'while_0: loop {
                            if !((((((((((({
                                let __v = mutex_destroy(
                                    ::core::ptr::addr_of_mut!((* (* event).eventdata_).lock_)
                                        as *mut super::pthread_mutex_t,
                                );
                                r1 = __v;
                                __v
                            }) as libc::c_int))
                        ...
                        'while_1: loop {
                            if !((((((((((({
                                let __v = cond_destroy(
                                    ::core::ptr::addr_of_mut!(
                                        (* (* event).eventdata_).condition_
                                    ) as *mut super::pthread_cond_t,
                                );
                                r2 = __v;
                                __v
                            }) as libc::c_int))
                        ...
                        munmap_u78403a470c5b78d3(
                            (((*event).eventdata_) as *mut libc::c_void),
                            ((120) as libc::c_ulong),
                        );
                        shm_unlink_u95e94a846074d1ac(
                            (((*event).name_) as *const libc::c_char),
                        );
                        free_ucbe6910a56eae126((((*event).name_) as *mut libc::c_void));
                        return if (((((((((r1 as libc::c_int)) != (((0) as libc::c_int)))
                            as libc::c_int as libc::c_int) != 0)
                            || (((((r2 as libc::c_int)) != (((0) as libc::c_int)))
                    ...
                    {
                        let __d = (*event).eventdata_;
                        if !__d.is_null() {
                            let _ = Box::from_raw(__d as *mut super::ACE_eventdata_t);
                        }
                    };
                    return if (((((((((r1 as libc::c_int)) != (((0) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
    ...
    #[export_name = "_ZN6ACE_OS10event_initEP11ACE_event_tiP18pthread_condattr_tiiPKcPvi"]
    pub unsafe extern "C-unwind" fn event_init(
        mut event: *mut super::ACE_event_t,
        mut r#type: libc::c_int,
        mut attributes: *mut super::pthread_condattr_t,
        mut manual_reset: libc::c_int,
        mut initial_state: libc::c_int,
        mut name: *const libc::c_char,
        mut arg: *mut libc::c_void,
        mut sa: libc::c_int,
    ) -> libc::c_int {
        unsafe {
            {
                ...
                (*event).name_ = ((0) as *mut libc::c_char);
                (*event).eventdata_ = ((0) as *mut super::ACE_eventdata_t);
                if (((((r#type as libc::c_int))
                    == ((((1 as libc::c_int)) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    let mut name_p: *const libc::c_char = name;
                    let mut owner: bool = false;
                    let mut fd: libc::c_int = shm_open_u8832aeab90456f8d(
                        ((name_p) as *const libc::c_char),
                        ...
                        as libc::c_int) != 0)
                    {
                        if (((((((*(super::__errno_location()))) as libc::c_int))
                            == (((17) as libc::c_int))) as libc::c_int as libc::c_int)
                            != 0)
                        {
                            fd = shm_open_u8832aeab90456f8d(
                                ((name_p) as *const libc::c_char),
                                (((2) as libc::c_int)) | ((64) as libc::c_int),
                                ((420) as libc::c_uint),
                                0,
                        ...
                        if (((((ftruncate_uc81bc2f492b8838e(fd, ((120) as libc::c_long))
                            as libc::c_int))
                            == ((((-((1) as libc::c_int))) as libc::c_int)))
                            as libc::c_int as libc::c_int) != 0)
                        {
                            close_u07c1eb6343f8c667(fd);
                            return (-((1) as libc::c_int));
                        }
                        owner = true;
                    }
                    let mut mapped: *mut libc::c_void = ((mmap_uf18c0366a1aaeae8(
                    ...
                    let mut evtdata: *mut super::ACE_eventdata_t = (mapped
                        as *mut super::ACE_eventdata_t);
                    close_u07c1eb6343f8c667(fd);
                    if ((((((evtdata) as *const u8))
                        == ((((((((-((1) as libc::c_int)) as *mut libc::c_void)))
                            as *mut super::ACE_eventdata_t)) as *const u8)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        if ((owner as libc::c_int) != 0) {
                            shm_unlink_u95e94a846074d1ac(
                                ((name_p) as *const libc::c_char),
                            );
                        }
                    ...
                    if ((owner as libc::c_int) != 0) {
                        (*event).name_ = strdup_u8b6a84c4b070659c(name_p);
                        if ((((((((((*event).name_).is_null()) as libc::c_int)
                            as libc::c_int) != 0)
                            || (((((super::__anon_ns_11255::eventdata_init(
                                (*event).eventdata_,
                                (((1 as libc::c_int)) as libc::c_int),
                                manual_reset,
                                initial_state,
                        ...
                        'cont_0: loop {
                            {
                                {
                                    (*event).eventdata_ = {
                                        let mut __new: super::ACE_eventdata_t = unsafe {
                                            ::core::mem::MaybeUninit::<super::ACE_eventdata_t>::zeroed()
                                                .assume_init()
                                        };
                    ...
                    return super::__anon_ns_11255::eventdata_init(
                        (*event).eventdata_,
    ...
    #[export_name = "_ZN6ACE_OS11event_pulseEP11ACE_event_t"]
    pub unsafe extern "C-unwind" fn event_pulse(
        mut event: *mut super::ACE_event_t,
    ) -> libc::c_int {
        unsafe {
            {
                let mut error: libc::c_int = 0;
                let mut result: libc::c_int = <super::ACE_event_t>::lock(
                    (event) as *mut super::ACE_event_t,
                );
                ...
                if ((((((*(*event).eventdata_).waiting_threads_ as libc::c_ulong))
                    > (((0) as libc::c_ulong))) as libc::c_int as libc::c_int) != 0)
                {
                    if ((((((*(*event).eventdata_).manual_reset_ as libc::c_int))
                        == (((1) as libc::c_int))) as libc::c_int as libc::c_int) != 0)
                    {
                            ...
                            as libc::c_int) != 0)
                        {
                            ...
                            error = ((*(super::__errno_location())));
                        } else {
                            (*(*event).eventdata_).signal_count_ = (*(*event).eventdata_)
                                .waiting_threads_;
                        }
                    } else {
                        if (((((<super::ACE_event_t>::wake_one(
                            (event) as *mut super::ACE_event_t,
                        ) as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                            as libc::c_int) != 0)
                        {
                ...
                if (((((<super::ACE_event_t>::unlock((event) as *mut super::ACE_event_t)
                    as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    return (-((1) as libc::c_int));
    ...
    #[export_name = "_ZN6ACE_OS11event_resetEP11ACE_event_t"]
    pub unsafe extern "C-unwind" fn event_reset(
        mut event: *mut super::ACE_event_t,
    ) -> libc::c_int {
        unsafe {
            {
                if (((((<super::ACE_event_t>::lock((event) as *mut super::ACE_event_t)
                    as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    return (-((1) as libc::c_int));
                ...
                return <super::ACE_event_t>::unlock((event) as *mut super::ACE_event_t);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    #[export_name = "_ZN6ACE_OS12event_signalEP11ACE_event_t"]
    pub unsafe extern "C-unwind" fn event_signal(
        mut event: *mut super::ACE_event_t,
    ) -> libc::c_int {
        unsafe {
            {
                ...
                {
                    if (((((cond_broadcast(
                        ::core::ptr::addr_of_mut!((* (* event).eventdata_).condition_)
                            as *mut super::pthread_cond_t,
                    ) as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                        as libc::c_int) != 0)
                    {
    ...
    #[export_name = "_ZN6ACE_OS15event_timedwaitEP11ACE_event_tP14ACE_Time_Valuei"]
    pub unsafe extern "C-unwind" fn event_timedwait(
        mut event: *mut super::ACE_event_t,
        mut timeout: *mut super::ACE_Time_Value,
        mut use_absolute_time: libc::c_int,
    ) -> libc::c_int {
        unsafe {
            {
                let mut error: libc::c_int = 0;
                ...
                if ((((((*(*event).eventdata_).is_signaled_ as libc::c_int))
                    == (((1) as libc::c_int))) as libc::c_int as libc::c_int) != 0)
                {
                    if ((((((*(*event).eventdata_).manual_reset_ as libc::c_int))
                    ...
                    {
                        let __lv = &mut ((*(*event).eventdata_).waiting_threads_);
                        *__lv = (*__lv).wrapping_add(1);
                        *__lv
                    };
                    let mut absolute_timeout: *mut super::ACE_Time_Value = timeout;
                    let mut converted_time: super::ACE_Time_Value = ::core::mem::MaybeUninit::<
                        super::ACE_Time_Value,
                    >::zeroed()
                        .assume_init();
                    <super::ACE_Time_Value>::new_at(
                        (::core::ptr::addr_of_mut!(converted_time))
                            as *mut super::ACE_Time_Value,
                    );
                    if (((((!(timeout).is_null())
                        && (((((use_absolute_time as libc::c_int))
                            == (((0) as libc::c_int))) as libc::c_int as libc::c_int)
                            != 0)) as libc::c_int) as libc::c_int) != 0)
                    {
                        let mut __addrof_tmp_0 = {
                            let __obj: *mut super::ACE_Time_Value = (timeout)
                                as *mut super::ACE_Time_Value;
                            let __vt: *const super::__Vtbl_u99ffb170af8c7e64 = *(__obj
                                as *const *const super::__Vtbl_u99ffb170af8c7e64);
                            ((*__vt).vfn_uc093c9f86ab975ab)(__obj)
                        };
                        <super::ACE_Time_Value>::operator_assign_uac328283e2b88277(
                            (::core::ptr::addr_of_mut!(converted_time))
                                as *mut super::ACE_Time_Value,
                            &mut __addrof_tmp_0 as *mut super::ACE_Time_Value,
                        );
                        absolute_timeout = ::core::ptr::addr_of_mut!(converted_time)
                            as *mut super::ACE_Time_Value;
                    }
                    'while_0: loop {
                        if !(((((((((((*(*event).eventdata_).is_signaled_
                            as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                            as libc::c_int) != 0)
                            ...
                            {
                                {
                                    ...
                                    if ((((((*(*event).eventdata_).signal_count_
                                        as libc::c_ulong)) > (((0) as libc::c_ulong)))
                                        as libc::c_int as libc::c_int) != 0)
                                    {
                                        {
                                            let __lv = &mut ((*(*event).eventdata_).signal_count_);
                    ...
                    if (((*(*event).eventdata_).auto_event_signaled_ as libc::c_int)
                        != 0)
                    {
                        (*(*event).eventdata_).auto_event_signaled_ = false;
                    }
    ...
    ///**************************************************************************
    #[export_name = "_ZN6ACE_OS13lwp_getparamsER16ACE_Sched_Params"]
    pub unsafe extern "C-unwind" fn lwp_getparams(
        mut sched_params: *mut super::ACE_Sched_Params,
    ) -> libc::c_int {
        unsafe {
            {
                {
    ...
    #[export_name = "_ZN6ACE_OS13lwp_setparamsERK16ACE_Sched_Params"]
    pub unsafe extern "C-unwind" fn lwp_setparams(
        mut sched_params: *const super::ACE_Sched_Params,
    ) -> libc::c_int {
        unsafe {
            {
                {
    ...
    #[export_name = "_ZN6ACE_OS13mutex_destroyEP15pthread_mutex_t"]
    pub unsafe extern "C-unwind" fn mutex_destroy(
        mut m: *mut super::pthread_mutex_t,
    ) -> libc::c_int {
        unsafe {
            {
                ...
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            return (((if (((((({
                                let __v = (super::pthread_mutex_destroy(
                                    ((m) as *mut super::pthread_mutex_t),
                                ));
                                result = __v;
                                __v
                            }) as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
    ...
    ///**************************************************************************
    #[export_name = "_ZN6ACE_OS10mutex_initEP15pthread_mutex_tiPKcP19pthread_mutexattr_tii"]
    pub unsafe extern "C-unwind" fn mutex_init(
        mut m: *mut super::pthread_mutex_t,
        mut lock_scope: libc::c_int,
        mut name: *const libc::c_char,
        mut attributes: *mut super::pthread_mutexattr_t,
        mut sa: libc::c_int,
        mut lock_type: libc::c_int,
    ) -> libc::c_int {
        unsafe {
            {
                {
                ...
                let mut l_attributes: super::pthread_mutexattr_t = unsafe {
                    ::core::mem::MaybeUninit::<super::pthread_mutexattr_t>::zeroed()
                        .assume_init()
                };
                if (((((attributes).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    attributes = ((::core::ptr::addr_of_mut!(l_attributes)
                        as *mut super::pthread_mutexattr_t)
                        as *mut super::pthread_mutexattr_t);
                }
                let mut result: libc::c_int = 0;
                let mut attr_init: libc::c_int = 0;
                if ((((((attributes) as *const u8))
                    == (((::core::ptr::addr_of_mut!(l_attributes)
                        as *mut super::pthread_mutexattr_t) as *const u8)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    if ((((((if (((((({
                        let __v = (super::pthread_mutexattr_init(
                            ((attributes) as *mut super::pthread_mutexattr_t),
                        ));
                        result = __v;
                        __v
                    }) as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                ...
                if (((((((((result as libc::c_int)) == (((0) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                    && (((((lock_scope as libc::c_int)) != (((0) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    {
                        let _ = (if (((((({
                            let __v = (super::pthread_mutexattr_setpshared(
                                ((attributes) as *mut super::pthread_mutexattr_t),
                                lock_scope,
                            ));
                            result = __v;
                ...
                if (((((((((result as libc::c_int)) == (((0) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                    && (((((lock_type as libc::c_int)) != (((0) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    {
                        let _ = (if (((((({
                            let __v = (super::pthread_mutexattr_settype(
                                ((attributes) as *mut super::pthread_mutexattr_t),
                                lock_type,
                            ));
                            result = __v;
                ...
                {
                    if ((((((if (((((({
                        let __v = (super::pthread_mutex_init(
                            ((m) as *mut super::pthread_mutex_t),
                            (attributes) as *const super::pthread_mutexattr_t,
                        ));
                        result = __v;
                        __v
                    }) as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                ...
                if ((((((((((attributes) as *const u8))
                    == (((::core::ptr::addr_of_mut!(l_attributes)
                        as *mut super::pthread_mutexattr_t) as *const u8)))
                    as libc::c_int as libc::c_int) != 0) && ((attr_init) != 0))
                    as libc::c_int) as libc::c_int) != 0)
                {
                    super::pthread_mutexattr_destroy(
                        ::core::ptr::addr_of_mut!(l_attributes)
                            as *mut super::pthread_mutexattr_t,
                    );
                }
    ...
    #[export_name = "_ZN6ACE_OS10mutex_initEP15pthread_mutex_tiPKwP19pthread_mutexattr_tii"]
    pub unsafe extern "C-unwind" fn mutex_init_u6e18c531e078042b(
        mut m: *mut super::pthread_mutex_t,
        mut lock_scope: libc::c_int,
        ...
        unsafe {
            {
                return mutex_init(
                    m,
                    lock_scope,
                    ((<super::ACE_Wide_To_Ascii>::char_rep(
                        (((&mut ({
                            let mut __recv: super::ACE_Wide_To_Ascii = (<super::ACE_Wide_To_Ascii>::new(
                                name,
                            ));
                            __recv
                        })) as *mut super::ACE_Wide_To_Ascii))
                            as *mut super::ACE_Wide_To_Ascii,
  ...
  /// returned since the calling thread does get the ownership.*/
    #[export_name = "_ZN6ACE_OS10mutex_lockEP15pthread_mutex_t"]
    pub unsafe extern "C-unwind" fn mutex_lock(
        mut m: *mut super::pthread_mutex_t,
    ) -> libc::c_int {
        unsafe {
            {
                ...
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            return (((if (((((({
                                let __v = (super::pthread_mutex_lock(
                                    ((m) as *mut super::pthread_mutex_t),
                                ));
                                result = __v;
                                __v
  ...
  /// mutexes, @a abandoned is set to 1 and 0 is returned.*/
    #[export_name = "_ZN6ACE_OS10mutex_lockEP15pthread_mutex_tRi"]
    pub unsafe extern "C-unwind" fn mutex_lock_u0c1e8676d442c3cc(
        mut m: *mut super::pthread_mutex_t,
        mut abandoned: *mut libc::c_int,
    ) -> libc::c_int {
        unsafe {
            {
                {
    ...
    pub unsafe extern "C-unwind" fn mutex_lock_uc739b38639033558(
        ...
        unsafe {
            {
                let mut result: libc::c_int = unsafe { ::core::mem::zeroed() };
                let mut ts: super::timespec = <super::ACE_Time_Value>::operator_timespec(
                    (::core::ptr::addr_of!((* timeout))) as *const super::ACE_Time_Value,
                );
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            result = (((if (((((({
                                let __v = (super::pthread_mutex_timedlock(
                                    ((m) as *mut super::pthread_mutex_t),
                                    (::core::ptr::addr_of_mut!(ts) as *mut super::timespec)
                                        as *const super::timespec,
                                ));
                                result = __v;
                                __v
                            }) as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
    ...
    #[export_name = "_ZN6ACE_OS18mutex_lock_cleanupEPv"]
    pub unsafe extern "C-unwind" fn mutex_lock_cleanup(mut mutex: *mut libc::c_void) {
        unsafe {
            {
                let mut p_lock: *mut super::pthread_mutex_t = (mutex
                    as *mut super::pthread_mutex_t);
                mutex_unlock(p_lock);
            }
            ()
    ...
    /**Win32 note: Abandoned mutexes are not treated differently. 0 is
  /// returned since the calling thread does get the ownership.*/
    #[export_name = "_ZN6ACE_OS13mutex_trylockEP15pthread_mutex_t"]
    pub unsafe extern "C-unwind" fn mutex_trylock(
        mut m: *mut super::pthread_mutex_t,
    ) -> libc::c_int {
        unsafe {
            {
                ...
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            return (((if (((((({
                                let __v = (super::pthread_mutex_trylock(
                                    ((m) as *mut super::pthread_mutex_t),
                                ));
                                result = __v;
                                __v
    ...
    /**This method is only implemented for Win32.  For abandoned
  /// mutexes, @a abandoned is set to 1 and 0 is returned.*/
    #[export_name = "_ZN6ACE_OS13mutex_trylockEP15pthread_mutex_tRi"]
    pub unsafe extern "C-unwind" fn mutex_trylock_u4cc89e8105f89a99(
        mut m: *mut super::pthread_mutex_t,
        mut abandoned: *mut libc::c_int,
    ) -> libc::c_int {
        unsafe {
    ...
    #[export_name = "_ZN6ACE_OS12mutex_unlockEP15pthread_mutex_t"]
    pub unsafe extern "C-unwind" fn mutex_unlock(
        mut m: *mut super::pthread_mutex_t,
    ) -> libc::c_int {
        unsafe {
            {
                ...
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            return (((if (((((({
                                let __v = (super::pthread_mutex_unlock(
                                    ((m) as *mut super::pthread_mutex_t),
                                ));
                                result = __v;
                                __v
  ...
  /// set the parameters on the calling thread.*/
    #[export_name = "_ZN6ACE_OS12sched_paramsERK16ACE_Sched_Paramsl"]
    pub unsafe extern "C-unwind" fn sched_params(
        mut sched_params: *const super::ACE_Sched_Params,
        mut id: libc::c_long,
    ) -> libc::c_int {
        unsafe {
            {
                if ((super::operator_ne_u91cbe2252f9b8e90(
                    (<super::ACE_Sched_Params>::quantum(
                        (::core::ptr::addr_of!((* sched_params)))
                            as *const super::ACE_Sched_Params,
                    )) as *const super::ACE_Time_Value,
                ...
                let mut param: super::sched_param = unsafe {
                    ::core::mem::MaybeUninit::<super::sched_param>::zeroed()
                        .assume_init()
                };
                param.sched_priority = ((<super::ACE_Sched_Params>::priority(
                    (::core::ptr::addr_of!((* sched_params)))
                        as *const super::ACE_Sched_Params,
                )) as libc::c_int);
                if (((((<super::ACE_Sched_Params>::scope(
                    (::core::ptr::addr_of!((* sched_params)))
                        as *const super::ACE_Sched_Params,
                ) as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    let mut result: libc::c_int = if (((((super::sched_setscheduler(
                        ((if (((((id as libc::c_long))
                        ...
                        ((<super::ACE_Sched_Params>::policy(
                            (::core::ptr::addr_of!((* sched_params)))
                                as *const super::ACE_Sched_Params,
                        )) as libc::c_int),
                        (::core::ptr::addr_of_mut!(param) as *mut super::sched_param)
                            as *const super::sched_param,
                    ...
                    if (((((<super::ACE_Sched_Params>::scope(
                        ...
                        as libc::c_int) != 0)
                    {
                        let mut thr_id: libc::c_ulong = thr_self();
                        let mut result: libc::c_int = unsafe { ::core::mem::zeroed() };
                        'dowhile_0: loop {
                            'cont_0: loop {
                                {
                                    return (((if (((((({
                                        let __v = (super::pthread_setschedparam(
                                            ((thr_id) as libc::c_ulong),
                                            ((<super::ACE_Sched_Params>::policy(
                                                (::core::ptr::addr_of!((* sched_params)))
                                                    as *const super::ACE_Sched_Params,
                                            )) as libc::c_int),
                                            (::core::ptr::addr_of_mut!(param)
                                                as *mut super::sched_param) as *const super::sched_param,
                                        ));
                                        result = __v;
                                        __v
    ...
    #[export_name = "_ZN6ACE_OS16scheduling_classEPKcRl"]
    pub unsafe extern "C-unwind" fn scheduling_class(
        mut class_name: *const libc::c_char,
        mut id: *mut libc::c_long,
    ) -> libc::c_int {
        unsafe {
            {
                {
    ...
    #[export_name = "_ZN6ACE_OS21set_scheduling_paramsERK16ACE_Sched_Paramsl"]
    pub unsafe extern "C-unwind" fn set_scheduling_params(
        mut sched_params: *const super::ACE_Sched_Params,
        mut id: libc::c_long,
    ) -> libc::c_int {
        unsafe {
    ...
    #[export_name = "_ZN6ACE_OS10thr_createEPFPvS0_ES0_lPmS3_lS0_mP23ACE_Base_Thread_AdapterPPKc"]
    pub unsafe extern "C-unwind" fn thr_create(
        mut func: Option<
            unsafe extern "C-unwind" fn(*mut libc::c_void) -> *mut libc::c_void,
        >,
        mut args: *mut libc::c_void,
        mut flags: libc::c_long,
        mut thr_id: *mut libc::c_ulong,
        mut thr_handle: *mut libc::c_ulong,
        mut priority: libc::c_long,
        mut stack: *mut libc::c_void,
        mut stacksize: libc::c_ulong,
        mut thread_adapter: *mut super::ACE_Base_Thread_Adapter,
        mut thr_name: *mut *const libc::c_char,
    ) -> libc::c_int {
        unsafe {
            {
                if (((((((((((((((flags)) as libc::c_long)) & (((64)) as libc::c_long))
                    as libc::c_long)) == (((0) as libc::c_long))) as libc::c_int)
                    as libc::c_int) != 0)
                    && (((((((((((flags)) as libc::c_long))
                        & (((65536)) as libc::c_long)) as libc::c_long))
                        == (((0) as libc::c_long))) as libc::c_int) as libc::c_int)
                        != 0)) as libc::c_int) as libc::c_int) != 0)
                {
                    ({
                        flags = (((flags) as libc::c_long))
                            | (((65536)) as libc::c_long);
                        flags
                    });
                }
                let mut thread_args: *mut super::ACE_Base_Thread_Adapter = ((0)
                    as *mut super::ACE_Base_Thread_Adapter);
                if (((((thread_adapter).is_null()) as libc::c_int) as libc::c_int) != 0)
                {
                    'dowhile_0: loop {
                        'cont_0: loop {
                            {
                                {
                                    thread_args = (({
                                        let __new: *mut super::ACE_OS_Thread_Adapter = Box::into_raw(
                                            Box::new(
                                                ::core::mem::MaybeUninit::<
                                                    super::ACE_OS_Thread_Adapter,
                                                >::zeroed()
                                                    .assume_init(),
                                            ),
                                        );
                                        <super::ACE_OS_Thread_Adapter>::new_at(
                                            (__new) as *mut super::ACE_OS_Thread_Adapter,
                                            func,
                                            args,
                                            unsafe {
                                                ::core::mem::transmute::<
                                    ...
                                    if (((((thread_args).is_null()) as libc::c_int)
                                        as libc::c_int) != 0)
                                    {
                                        ((*(super::__errno_location()))) = 12;
                                        return (-((1) as libc::c_int));
                ...
                let mut auto_thread_args: crate::__cxx_std::UniquePtr<
                    super::ACE_Base_Thread_Adapter,
                > = crate::__cxx_std::UniquePtr::null();
                if (((((thread_adapter).is_null()) as libc::c_int) as libc::c_int) != 0)
                {
                    super::ACE_auto_ptr_reset___std__unique_ptr_ACE_Base_Thread_Adapter_____ACE_Base_Thread_Adapter___(
                        ::core::ptr::addr_of_mut!(auto_thread_args),
                        thread_args,
                    );
                }
                let mut tmp_thr: libc::c_ulong = unsafe { ::core::mem::zeroed() };
                if (((((thr_id).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    thr_id = ::core::ptr::addr_of_mut!(tmp_thr) as *mut libc::c_ulong;
                }
                let mut tmp_handle: libc::c_ulong = unsafe { ::core::mem::zeroed() };
                if (((((thr_handle).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    thr_handle = ::core::ptr::addr_of_mut!(tmp_handle)
                        as *mut libc::c_ulong;
                }
                let mut result: libc::c_int = unsafe { ::core::mem::zeroed() };
                let mut attr: super::pthread_attr_t = unsafe {
                    ::core::mem::MaybeUninit::<super::pthread_attr_t>::zeroed()
                        .assume_init()
                };
                if ((((((if (((((({
                    let __v = (super::pthread_attr_init(
                        ::core::ptr::addr_of_mut!(attr) as *mut super::pthread_attr_t,
                    ));
                    result = __v;
                    __v
                }) as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                ...
                if (((((stacksize as libc::c_ulong)) != (((0) as libc::c_ulong)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    let mut size: libc::c_ulong = stacksize;
                    if (((((size as libc::c_ulong))
                        < ((((super::__sysconf(75) as libc::c_ulong)) as libc::c_ulong)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        size = ((super::__sysconf(75)) as libc::c_ulong);
                    }
                    let mut result: libc::c_int = unsafe { ::core::mem::zeroed() };
                    if ((((!(stack).is_null()) as libc::c_int) as libc::c_int) != 0) {
                        result = (if (((((({
                            let __v = (super::pthread_attr_setstack(
                                ::core::ptr::addr_of_mut!(attr)
                                    as *mut super::pthread_attr_t,
                                stack,
                                size,
                            ));
                            result = __v;
                        ...
                        result = (if (((((({
                            let __v = (super::pthread_attr_setstacksize(
                                ::core::ptr::addr_of_mut!(attr)
                                    as *mut super::pthread_attr_t,
                                size,
                            ));
                    ...
                    if (((((result as libc::c_int))
                        ...
                        as libc::c_int) != 0)
                    {
                        super::pthread_attr_destroy(
                            ::core::ptr::addr_of_mut!(attr) as *mut super::pthread_attr_t,
                        );
                        return (-((1) as libc::c_int));
                    }
                }
                if (((((flags as libc::c_long)) != (((0) as libc::c_long)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    if (((((((((((((((flags)) as libc::c_long))
                        & (((64)) as libc::c_long)) as libc::c_long))
                        ...
                        || (((((((((((flags)) as libc::c_long))
                            ...
                            != 0)) as libc::c_int) as libc::c_int) != 0)
                    {
                        let mut dstate: libc::c_int = (((0 as libc::c_int))
                            as libc::c_int);
                        if (((((((((((flags)) as libc::c_long))
                            & (((64)) as libc::c_long)) as libc::c_long))
                            != (((0) as libc::c_long))) as libc::c_int) as libc::c_int)
                            != 0)
                        {
                            dstate = (((1 as libc::c_int)) as libc::c_int);
                        }
                        if ((((((if (((((({
                            let __v = (super::pthread_attr_setdetachstate(
                                ::core::ptr::addr_of_mut!(attr)
                                    as *mut super::pthread_attr_t,
                                dstate,
                            ));
                    ...
                    if (((((priority as libc::c_long))
                        != ((((((((-((2147483647) as libc::c_long))) as libc::c_long))
                            .wrapping_sub((1) as libc::c_long))) as libc::c_long)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        ({
                            flags = (((flags) as libc::c_long))
                                | (((8388608)) as libc::c_long);
                            flags
                        });
                        if (((((((((((((((((((flags)) as libc::c_long))
                            & (((131072)) as libc::c_long)) as libc::c_long))
                            == (((0) as libc::c_long))) as libc::c_int) as libc::c_int)
                            != 0)
                            && (((((((((((flags)) as libc::c_long))
                                & (((262144)) as libc::c_long)) as libc::c_long))
                                == (((0) as libc::c_long))) as libc::c_int) as libc::c_int)
                                != 0)) as libc::c_int) as libc::c_int) != 0)
                            && (((((((((((flags)) as libc::c_long))
                                & (((524288)) as libc::c_long)) as libc::c_long))
                                == (((0) as libc::c_long))) as libc::c_int) as libc::c_int)
                                != 0)) as libc::c_int) as libc::c_int) != 0)
                        {
                            ({
                                flags = (((flags) as libc::c_long))
                                    | (((524288)) as libc::c_long);
                                flags
                            });
                        }
                    }
                    if (((((((((((((((((((flags)) as libc::c_long))
                        ...
                        || (((((((((((flags)) as libc::c_long))
                            ...
                            != 0)) as libc::c_int) as libc::c_int) != 0)
                    {
                        let mut spolicy: libc::c_int = unsafe { ::core::mem::zeroed() };
                        ({
                            flags = (((flags) as libc::c_long))
                                | (((8388608)) as libc::c_long);
                            flags
                            ...
                            != 0)
                        {
                                ...
                                != 0)
                            {
                                ...
                                if (((((((((((flags)) as libc::c_long))
                                    & (((16777216)) as libc::c_long)) as libc::c_long))
                                    != (((0) as libc::c_long))) as libc::c_int) as libc::c_int)
                                    != 0)
                                {
                                    ((*(super::__errno_location()))) = 38;
                                    return (-((1) as libc::c_int));
                                } else {
                                    spolicy = 2;
                                }
                        ...
                        {
                            let _ = (if (((((({
                                let __v = (super::pthread_attr_setschedpolicy(
                                    ::core::ptr::addr_of_mut!(attr)
                                        as *mut super::pthread_attr_t,
                                    spolicy,
                                ));
                    ...
                    if ((((((((((((((((((((((((flags)) as libc::c_long))
                        ...
                        || (((((((((((flags)) as libc::c_long))
                            ...
                            != (((0) as libc::c_long))) as libc::c_int) as libc::c_int)
                            != 0)) as libc::c_int)) as libc::c_int) != 0)
                        && (((((priority as libc::c_long))
                            == ((((((((-((2147483647) as libc::c_long)))
                                as libc::c_long))
                                .wrapping_sub((1) as libc::c_long))) as libc::c_long)))
                            as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                        as libc::c_int) != 0)
                    {
                        if (((((((((((flags)) as libc::c_long))
                            ...
                            != 0)
                        {
                            priority = ((((((((((super::sched_get_priority_min(1))
                                as libc::c_long)) as libc::c_long))
                                .wrapping_add(
                                    (((super::sched_get_priority_max(1)) as libc::c_long))
                                        as libc::c_long,
                                ))) as libc::c_long)) / ((2) as libc::c_long));
                        } else {
                            if (((((((((((flags)) as libc::c_long))
                                & (((262144)) as libc::c_long)) as libc::c_long))
                                != (((0) as libc::c_long))) as libc::c_int) as libc::c_int)
                                != 0)
                            {
                                priority = ((((((((((super::sched_get_priority_min(2))
                                    as libc::c_long)) as libc::c_long))
                                    .wrapping_add(
                                        (((super::sched_get_priority_max(2)) as libc::c_long))
                                            as libc::c_long,
                                    ))) as libc::c_long)) / ((2) as libc::c_long));
                            } else {
                                priority = ((((((((((super::sched_get_priority_min(0))
                                    as libc::c_long)) as libc::c_long))
                                    .wrapping_add(
                                        (((super::sched_get_priority_max(0)) as libc::c_long))
                                            as libc::c_long,
                                    ))) as libc::c_long)) / ((2) as libc::c_long));
                            }
                        }
                    ...
                    if (((((priority as libc::c_long))
                        ...
                        as libc::c_int as libc::c_int) != 0)
                    {
                        let mut sparam: super::sched_param = unsafe {
                            ::core::mem::MaybeUninit::<super::sched_param>::zeroed()
                                .assume_init()
                        };
                        memset_u2b5dfc47d301370a(
                            (::core::ptr::addr_of_mut!(sparam) as *mut super::sched_param
                                as *mut libc::c_void),
                            0,
                            ((::core::mem::size_of::<super::sched_param>()
                        ...
                        if (((((((((((flags)) as libc::c_long))
                            ...
                            != 0)
                        {
                            sparam.sched_priority = (((*super::ace_min___const_long____const_long___(
                                &((((super::sched_get_priority_max(1)) as libc::c_long)))
                                    as *const libc::c_long,
                                &(((*super::ace_max___const_long____const_long___(
                                    &((((super::sched_get_priority_min(1)) as libc::c_long)))
                                        as *const libc::c_long,
                                    ::core::ptr::addr_of!(priority),
                                )))) as *const libc::c_long,
                            ))) as libc::c_int);
                        } else {
                            if (((((((((((flags)) as libc::c_long))
                                ...
                                != 0)
                            {
                                sparam.sched_priority = (((*super::ace_min___const_long____const_long___(
                                    &((((super::sched_get_priority_max(2)) as libc::c_long)))
                                        as *const libc::c_long,
                                    &(((*super::ace_max___const_long____const_long___(
                                        &((((super::sched_get_priority_min(2)) as libc::c_long)))
                                            as *const libc::c_long,
                                        ::core::ptr::addr_of!(priority),
                                    )))) as *const libc::c_long,
                                ))) as libc::c_int);
                                ...
                                sparam.sched_priority = (((*super::ace_min___const_long____const_long___(
                                    &((((super::sched_get_priority_max(0)) as libc::c_long)))
                                        as *const libc::c_long,
                                    &(((*super::ace_max___const_long____const_long___(
                                        &((((super::sched_get_priority_min(0)) as libc::c_long)))
                                            as *const libc::c_long,
                                        ::core::ptr::addr_of!(priority),
                                    )))) as *const libc::c_long,
                                ))) as libc::c_int);
                        ...
                        {
                            {
                                {
                                    let _ = (if (((((({
                                        let __v = (super::pthread_attr_setschedparam(
                                            ((::core::ptr::addr_of_mut!(attr)
                                                as *mut super::pthread_attr_t)
                                                as *mut super::pthread_attr_t),
                                            (::core::ptr::addr_of_mut!(sparam)
                                                as *mut super::sched_param) as *const super::sched_param,
                                        ));
                                        result = __v;
                                        __v
                    ...
                    if (((((((((((((((flags)) as libc::c_long))
                        & (((4194304)) as libc::c_long)) as libc::c_long))
                        != (((0) as libc::c_long))) as libc::c_int) as libc::c_int) != 0)
                        || (((((((((((flags)) as libc::c_long))
                            & (((8388608)) as libc::c_long)) as libc::c_long))
                            != (((0) as libc::c_long))) as libc::c_int) as libc::c_int)
                            != 0)) as libc::c_int) as libc::c_int) != 0)
                    {
                        let mut sched: libc::c_int = (((1 as libc::c_int))
                            as libc::c_int);
                        if (((((((((((flags)) as libc::c_long))
                            & (((4194304)) as libc::c_long)) as libc::c_long))
                            != (((0) as libc::c_long))) as libc::c_int) as libc::c_int)
                            != 0)
                        {
                            sched = (((0 as libc::c_int)) as libc::c_int);
                        }
                        if ((((((if (((((({
                            let __v = (super::pthread_attr_setinheritsched(
                                ::core::ptr::addr_of_mut!(attr)
                                    as *mut super::pthread_attr_t,
                                sched,
                            ));
                    ...
                    if (((((((((((((((flags)) as libc::c_long))
                        & (((1048576)) as libc::c_long)) as libc::c_long))
                        != (((0) as libc::c_long))) as libc::c_int) as libc::c_int) != 0)
                        || (((((((((((flags)) as libc::c_long))
                            & (((2097152)) as libc::c_long)) as libc::c_long))
                            != (((0) as libc::c_long))) as libc::c_int) as libc::c_int)
                            != 0)) as libc::c_int) as libc::c_int) != 0)
                    {
                        ...
                        if (((((((((((flags)) as libc::c_long))
                            ...
                            != 0)
                        {
                            scope = (((0 as libc::c_int)) as libc::c_int);
                        }
                        if ((((((if (((((({
                            let __v = (super::pthread_attr_setscope(
                                ::core::ptr::addr_of_mut!(attr)
                                    as *mut super::pthread_attr_t,
                                scope,
                            ));
                    ...
                    if (((((((((((flags)) as libc::c_long)) & (((2)) as libc::c_long))
                        as libc::c_long)) != (((0) as libc::c_long))) as libc::c_int)
                        as libc::c_int) != 0)
                    {
                        let mut lwps: libc::c_int = thr_getconcurrency();
                        if (((((lwps as libc::c_int))
                            == ((((-((1) as libc::c_int))) as libc::c_int)))
                            as libc::c_int as libc::c_int) != 0)
                        {
                            if (((((((*(super::__errno_location()))) as libc::c_int))
                                == (((95) as libc::c_int))) as libc::c_int as libc::c_int)
                                != 0)
                            {
                                ((*(super::__errno_location()))) = 0;
                            } else {
                                return (-((1) as libc::c_int));
                            }
                        } else {
                            if (((((thr_setconcurrency(
                                (((lwps) as libc::c_int)).wrapping_add((1) as libc::c_int),
                            ) as libc::c_int))
                                == ((((-((1) as libc::c_int))) as libc::c_int)))
                                as libc::c_int as libc::c_int) != 0)
                            {
                ...
                'dowhile_1: loop {
                    'cont_1: loop {
                        {
                            result = (((if (((((({
                                let __v = (super::pthread_create(
                                    ((thr_id) as *mut libc::c_ulong),
                                    (::core::ptr::addr_of_mut!(attr)
                                        as *mut super::pthread_attr_t)
                                        as *const super::pthread_attr_t,
                                    <super::ACE_Base_Thread_Adapter>::entry_point(
                                        (thread_args) as *mut super::ACE_Base_Thread_Adapter,
                                    ),
                                    ((thread_args) as *mut libc::c_void),
                                ));
                                result = __v;
                                __v
                            }) as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                ...
                if (((((result as libc::c_int))
                    ...
                    as libc::c_int) != 0)
                {
                    (*(thr_handle)) = (((*(thr_id))) as libc::c_ulong);
                }
    ...
    #[export_name = "_ZN6ACE_OS8thr_exitEPv"]
    pub unsafe extern "C-unwind" fn thr_exit(mut status: *mut libc::c_void) {
        unsafe {
            {
                super::pthread_exit(((status) as *mut libc::c_void));
            }
            ()
        }
    }
    ...
    #[doc = "* Set the thread affinity\n   *\n   * @param thr_id For NPTL-threads, when ACE_HAS_PTHREAD_SETAFFINITY_NP\n   * defined, this is the thread-id. For linux-threads, when\n   * ACE_HAS_SCHED_SETAFFINITY defined, it expects a process-id. Since for\n   * linux-threads a thread is seen as a process, it does the job.\n   * @param cpu_set_size The size of the cpu_mask, in bytes.\n   * @param cpu_mask Is a bitmask of CPUs to bind to, e.g value 1 binds the\n   * thread to the \"CPU 0\", etc"]
    #[export_name = "_ZN6ACE_OS16thr_set_affinityEmmPK9cpu_set_t"]
    pub unsafe extern "C-unwind" fn thr_set_affinity(
        mut thr_id: libc::c_ulong,
        mut cpu_set_size: libc::c_ulong,
        mut cpu_mask: *const super::cpu_set_t,
    ) -> libc::c_int {
        unsafe {
            {
                if (((((super::sched_setaffinity(
                    ((thr_id) as libc::c_int),
                    cpu_set_size,
                    cpu_mask,
                ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
    ...
    #[export_name = "_ZN6ACE_OS14thr_key_detachEj"]
    pub unsafe extern "C-unwind" fn thr_key_detach(
        mut key: libc::c_uint,
    ) -> libc::c_int {
        unsafe {
            {
    ...
    #[export_name = "_ZN6ACE_OS12thr_key_usedEj"]
    pub unsafe extern "C-unwind" fn thr_key_used(mut key: libc::c_uint) -> libc::c_int {
        unsafe {
            {
                {
                    let _ = (key);
    ...
    #[export_name = "_ZN6ACE_OS20thr_keycreate_nativeEPjPFvPvE"]
    pub unsafe extern "C-unwind" fn thr_keycreate_native(
        mut key: *mut libc::c_uint,
        mut dest: Option<unsafe extern "C-unwind" fn(*mut libc::c_void)>,
    ) -> libc::c_int {
        unsafe {
            {
                let mut result: libc::c_int = unsafe { ::core::mem::zeroed() };
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            return (((if (((((({
                                let __v = (super::pthread_key_create(
                                    ((key) as *mut libc::c_uint),
                                    dest,
                                ));
                                result = __v;
                                __v
    ...
    #[export_name = "_ZN6ACE_OS13thr_keycreateEPjPFvPvE"]
    pub unsafe extern "C-unwind" fn thr_keycreate(
        mut key: *mut libc::c_uint,
        mut dest: Option<unsafe extern "C-unwind" fn(*mut libc::c_void)>,
    ) -> libc::c_int {
        unsafe {
            {
                return thr_keycreate_native(((key) as *mut libc::c_uint), dest);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    ///@internal Applications should call thr_keyfree instead
    #[export_name = "_ZN6ACE_OS18thr_keyfree_nativeEj"]
    pub unsafe extern "C-unwind" fn thr_keyfree_native(
        mut key: libc::c_uint,
    ) -> libc::c_int {
        unsafe {
            {
                return super::pthread_key_delete(((key) as libc::c_uint));
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    #[export_name = "_ZN6ACE_OS11thr_keyfreeEj"]
    pub unsafe extern "C-unwind" fn thr_keyfree(mut key: libc::c_uint) -> libc::c_int {
        unsafe {
            {
                return thr_keyfree_native(((key) as libc::c_uint));
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    ...
    #[export_name = "_ZN6ACE_OS11thr_setprioEi"]
    pub unsafe extern "C-unwind" fn thr_setprio(mut prio: libc::c_int) -> libc::c_int {
        unsafe {
            {
                let mut my_thread_id: libc::c_ulong = unsafe { ::core::mem::zeroed() };
                thr_self_u35bfcd9d5906cbcf(::core::ptr::addr_of_mut!(my_thread_id));
                let mut status: libc::c_int = ((thr_setprio_ucfa01c0139522e03(
                    my_thread_id,
                    ((prio) as libc::c_int),
                    (-((1) as libc::c_int)),
                )) as libc::c_int);
    ...
    #[export_name = "_ZN6ACE_OS22thr_setspecific_nativeEjPv"]
    pub unsafe extern "C-unwind" fn thr_setspecific_native(
        mut key: libc::c_uint,
        ...
        unsafe {
            {
                ...
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            return (((if (((((({
                                let __v = (super::pthread_setspecific(
                                    ((key) as libc::c_uint),
    ...
    #[export_name = "_ZN6ACE_OS15thr_setspecificEjPv"]
    pub unsafe extern "C-unwind" fn thr_setspecific(
        mut key: libc::c_uint,
        mut data: *mut libc::c_void,
    ) -> libc::c_int {
        unsafe {
            {
                return thr_setspecific_native(((key) as libc::c_uint), data);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    ...
    #[doc = "* This method uses process id and object pointer to come up with a\n   * machine wide unique name.  The process ID will provide uniqueness\n   * between processes on the same machine. The \"this\" pointer of the\n   * @a object will provide uniqueness between other \"live\" objects in\n   * the same process. The uniqueness of this name is therefore only\n   * valid for the life of @a object."]
    #[export_name = "_ZN6ACE_OS11unique_nameEPKvPcm"]
    pub unsafe extern "C-unwind" fn unique_name_u335a6b57ecb175f1(
        mut object: *const libc::c_void,
        mut name: *mut libc::c_char,
        mut length: libc::c_ulong,
    ) {
        unsafe {
            {
                snprintf_u9a28649a3b771eeb(
                    name,
                    length,
                    ((b"%p%d\0".as_ptr() as *const libc::c_char) as *const libc::c_char),
                    object,
                    (getpid_ucc9c2c9e176d9ca8() as libc::c_int),
                );
            }
            ()
        }
...
#[export_name = "_ZNK13ACE_Thread_ID9to_stringEPcm"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_Thread_ID9to_stringEPcm(
    __this: *const ACE_Thread_ID,
    thr_string: *mut libc::c_char,
    thr_string_len: libc::c_ulong,
) {
    unsafe { ACE_Thread_ID::to_string(__this, thr_string, thr_string_len) }
}
extern "C" {
    #[allow(non_upper_case_globals)]
...
#[no_mangle]
pub unsafe extern "C-unwind" fn ACE_MUTEX_LOCK_CLEANUP_ADAPTER_NAME(
    mut args: *mut libc::c_void,
) {
    unsafe {
        {
...
#[export_name = "_ZN11ACE_event_t4lockEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_event_t4lockEv(
    __this: *mut ACE_event_t,
) -> libc::c_int {
    unsafe { ACE_event_t::lock(__this) }
}
#[export_name = "_ZN11ACE_event_t6unlockEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_event_t6unlockEv(
    __this: *mut ACE_event_t,
) -> libc::c_int {
    unsafe { ACE_event_t::unlock(__this) }
}
#[export_name = "_ZN11ACE_event_t8wake_oneEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_event_t8wake_oneEv(
    __this: *mut ACE_event_t,
) -> libc::c_int {
    unsafe { ACE_event_t::wake_one(__this) }
}
...
#[doc = "* @class ACE_OS_Thread_Adapter\n *\n * @brief Converts a C++ function into a function that can be\n * called from a thread creation routine\n * (e.g., pthread_create() or _beginthreadex()) that expects an\n * extern \"C\" entry point.  This class also makes it possible to\n * transparently provide hooks to register a thread with an\n * ACE_Thread_Manager.\n *\n * This class is used in ACE_OS::thr_create().  In general, the\n * thread that creates an object of this class is different from\n * the thread that calls invoke() on this object.  Therefore,\n * the invoke() method is responsible for deleting itself."]
#[repr(C)]
#[derive(Clone)]
pub struct ACE_OS_Thread_Adapter {
    pub __base_0: ::core::mem::ManuallyDrop<ACE_Base_Thread_Adapter>,
}
#[export_name = "_Z7ace_minIlERKT_S2_S2_"]
pub unsafe extern "C-unwind" fn ace_min___const_long____const_long___(
    mut t1: *const libc::c_long,
    mut t2: *const libc::c_long,
) -> *const libc::c_long {
    unsafe {
        {
            return if ((((((*t2) as libc::c_long)) > ((((*t1)) as libc::c_long)))
                as libc::c_int as libc::c_int) != 0)
            {
                ::core::ptr::addr_of!((* t1))
            } else {
...
#[export_name = "_Z18ACE_auto_ptr_resetISt10unique_ptrI23ACE_Base_Thread_AdapterSt14default_deleteIS1_EES1_EvRT_PT0_"]
pub unsafe extern "C-unwind" fn ACE_auto_ptr_reset___std__unique_ptr_ACE_Base_Thread_Adapter_____ACE_Base_Thread_Adapter___(
    mut ap: *mut crate::__cxx_std::UniquePtr<ACE_Base_Thread_Adapter>,
    mut p: *mut ACE_Base_Thread_Adapter,
) {
    unsafe {
        {
            (*ap).reset(p);
...
pub mod __anon_ns_11255 {
    pub(crate) unsafe extern "C-unwind" fn eventdata_init(
        mut evtdata: *mut super::ACE_eventdata_t,
        mut r#type: libc::c_int,
        mut manual_reset: libc::c_int,
        mut initial_state: libc::c_int,
        mut attributes: *mut super::pthread_condattr_t,
        mut name: *const libc::c_char,
        mut arg: *mut libc::c_void,
        mut init_condition: libc::c_int,
        mut init_mutex: libc::c_int,
    ) -> libc::c_int {
        unsafe {
            {
                (*evtdata).type_ = r#type;
                (*evtdata).manual_reset_ = manual_reset;
                (*evtdata).is_signaled_ = initial_state;
                (*evtdata).auto_event_signaled_ = false;
                (*evtdata).waiting_threads_ = ((0) as libc::c_ulong);
                (*evtdata).signal_count_ = ((0) as libc::c_ulong);
                if ((init_condition) != 0) {
                    let mut result: libc::c_int = ((if (!(attributes).is_null()) {
                        super::ACE_OS::cond_init(
                            ::core::ptr::addr_of_mut!((* evtdata).condition_)
                                as *mut super::pthread_cond_t,
                            attributes,
                            name,
                            arg,
                        ...
                        super::ACE_OS::cond_init_ue107a1ce456396d5(
                            ::core::ptr::addr_of_mut!((* evtdata).condition_)
                                as *mut super::pthread_cond_t,
                            (r#type as libc::c_short),
                            name,
                            arg,
                        )
                    }) as libc::c_int);
                ...
                return if ((init_mutex) != 0) {
                    super::ACE_OS::mutex_init(
                        ::core::ptr::addr_of_mut!((* evtdata).lock_)
                            as *mut super::pthread_mutex_t,
                        r#type,
                        name,
                        (arg as *mut super::pthread_mutexattr_t),
                        0,
                        0,
                    )
                } else {
...
impl ACE_OS_Thread_Adapter {
    ...
    pub unsafe fn new_at(
        ...
        mut __a2: Option<
            unsafe extern "C-unwind" fn(*mut libc::c_void) -> *mut libc::c_void,
        >,
        mut __a3: libc::c_long,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN21ACE_OS_Thread_AdapterC1EPFPvS0_ES0_S2_l"]
            fn __ext(
                __this: *mut ACE_OS_Thread_Adapter,
                __a0: Option<
                    unsafe extern "C-unwind" fn(*mut libc::c_void) -> *mut libc::c_void,
                >,
                __a1: *mut libc::c_void,
        ...
        __ext(__this as *mut ACE_OS_Thread_Adapter, __a0, __a1, __a2, __a3)
    }
    pub unsafe fn new(
        mut __a0: Option<
            unsafe extern "C-unwind" fn(*mut libc::c_void) -> *mut libc::c_void,
    ...
    #[doc = "* Execute the @a user_func_ with the @a arg.  This function deletes\n   * @c this, thereby rendering the object useless after the call\n   * returns."]
    pub unsafe fn invoke(__this: *mut Self) -> *mut libc::c_void {
        extern "C-unwind" {
            #[link_name = "_ZN21ACE_OS_Thread_Adapter6invokeEv"]
            fn __ext(__this: *mut ACE_OS_Thread_Adapter) -> *mut libc::c_void;
        }
        __ext(__this as *mut ACE_OS_Thread_Adapter)
    }
}
...
pub unsafe fn __vdtor_ue9d5de87bbd2b606(__this: *mut ACE_Base_Thread_Adapter) {
    let _ = Box::from_raw(__this as *mut ACE_OS_Thread_Adapter);
}
pub unsafe fn __vthunk_oua1443d53ce4ed317_iu11d7950624b3f9a1(
    __this: *mut ACE_Base_Thread_Adapter,
) -> *mut libc::c_void {
    <ACE_OS_Thread_Adapter>::invoke((__this as *mut ACE_OS_Thread_Adapter))
}
#[repr(C)]
pub struct __Vtbl_ue9d5de87bbd2b606 {
    pub __type_info: &'static crate::__cxx_std::TypeInfo,
    pub __vdtor: unsafe fn(*mut ACE_Base_Thread_Adapter),
    pub vfn_u11d7950624b3f9a1: unsafe fn(
        *mut ACE_Base_Thread_Adapter,
...
pub static __VTBL_ue9d5de87bbd2b606: __Vtbl_ue9d5de87bbd2b606 = __Vtbl_ue9d5de87bbd2b606 {
    __type_info: &__TYPEINFO_21ACE_OS_Thread_Adapter,
    __vdtor: __vdtor_ue9d5de87bbd2b606,
    vfn_u11d7950624b3f9a1: __vthunk_oua1443d53ce4ed317_iu11d7950624b3f9a1,
};
