...
pub mod ACE_Utils {
    ...
    pub type truncator_276 = Truncator_unsigned_long__int_;
...
#[allow(non_upper_case_globals)]
#[no_mangle]
pub static mut ACE_High_Res_Timer_global_scale_factor_: libc::c_uint = ((1000u32)
    as libc::c_uint);
#[allow(non_upper_case_globals)]
#[no_mangle]
pub static mut ACE_High_Res_Timer_global_scale_factor_status_: libc::c_int = 0;
...
#[export_name = "_ZN18ACE_High_Res_Timer19global_scale_factorEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_High_Res_Timer19global_scale_factorEv() -> libc::c_uint {
    unsafe { ACE_High_Res_Timer::global_scale_factor_ubcde1b6c85276b84() }
}
#[export_name = "_ZN18ACE_High_Res_Timer27get_env_global_scale_factorEPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_High_Res_Timer27get_env_global_scale_factorEPKc(
    env: *const libc::c_char,
) -> libc::c_int {
    unsafe { ACE_High_Res_Timer::get_env_global_scale_factor(env) }
}
#[export_name = "_ZN18ACE_High_Res_Timer9calibrateEjj"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_High_Res_Timer9calibrateEjj(
    usec: libc::c_uint,
    iterations: libc::c_uint,
) -> libc::c_uint {
    unsafe { ACE_High_Res_Timer::calibrate(usec, iterations) }
}
#[export_name = "_ZN18ACE_High_Res_TimerC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_High_Res_TimerC1Ev(
    __this: *mut ACE_High_Res_Timer,
) {
    ACE_High_Res_Timer::new_at(__this)
}
...
#[export_name = "_ZN18ACE_High_Res_Timer5resetEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_High_Res_Timer5resetEv(
    __this: *mut ACE_High_Res_Timer,
) {
    unsafe { ACE_High_Res_Timer::reset(__this) }
}
#[export_name = "_ZNK18ACE_High_Res_Timer12elapsed_timeER14ACE_Time_Value"]
pub unsafe extern "C-unwind" fn __xtu__ZNK18ACE_High_Res_Timer12elapsed_timeER14ACE_Time_Value(
    __this: *const ACE_High_Res_Timer,
    tv: *mut ACE_Time_Value,
) {
    unsafe { ACE_High_Res_Timer::elapsed_time(__this, tv) }
}
#[export_name = "_ZNK18ACE_High_Res_Timer12elapsed_timeERm"]
pub unsafe extern "C-unwind" fn __xtu__ZNK18ACE_High_Res_Timer12elapsed_timeERm(
    __this: *const ACE_High_Res_Timer,
    nanoseconds: *mut libc::c_ulong,
) {
    unsafe { ACE_High_Res_Timer::elapsed_time_u0ae118857bf6b975(__this, nanoseconds) }
}
#[export_name = "_ZNK18ACE_High_Res_Timer12elapsed_timeER8timespec"]
pub unsafe extern "C-unwind" fn __xtu__ZNK18ACE_High_Res_Timer12elapsed_timeER8timespec(
    __this: *const ACE_High_Res_Timer,
    elapsed_time: *mut timespec,
) {
    unsafe { ACE_High_Res_Timer::elapsed_time_uefa7a55ba73008f6(__this, elapsed_time) }
}
#[export_name = "_ZNK18ACE_High_Res_Timer17elapsed_time_incrER14ACE_Time_Value"]
pub unsafe extern "C-unwind" fn __xtu__ZNK18ACE_High_Res_Timer17elapsed_time_incrER14ACE_Time_Value(
    __this: *const ACE_High_Res_Timer,
    tv: *mut ACE_Time_Value,
) {
    unsafe { ACE_High_Res_Timer::elapsed_time_incr(__this, tv) }
}
#[export_name = "_ZNK18ACE_High_Res_Timer17elapsed_time_incrERm"]
pub unsafe extern "C-unwind" fn __xtu__ZNK18ACE_High_Res_Timer17elapsed_time_incrERm(
    __this: *const ACE_High_Res_Timer,
    nanoseconds: *mut libc::c_ulong,
) {
    unsafe {
        ACE_High_Res_Timer::elapsed_time_incr_u71012f5f981a9568(__this, nanoseconds)
    }
}
#[export_name = "_ZNK18ACE_High_Res_Timer11print_totalEPKcii"]
pub unsafe extern "C-unwind" fn __xtu__ZNK18ACE_High_Res_Timer11print_totalEPKcii(
    __this: *const ACE_High_Res_Timer,
    str: *const libc::c_char,
    count: libc::c_int,
    handle: libc::c_int,
) {
    unsafe { ACE_High_Res_Timer::print_total(__this, str, count, handle) }
}
#[export_name = "_ZNK18ACE_High_Res_Timer9print_aveEPKcii"]
pub unsafe extern "C-unwind" fn __xtu__ZNK18ACE_High_Res_Timer9print_aveEPKcii(
    __this: *const ACE_High_Res_Timer,
    str: *const libc::c_char,
    count: libc::c_int,
    handle: libc::c_int,
) {
    unsafe { ACE_High_Res_Timer::print_ave(__this, str, count, handle) }
}
#[export_name = "_ZNK18ACE_High_Res_Timer4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK18ACE_High_Res_Timer4dumpEv(
    __this: *const ACE_High_Res_Timer,
) {
    unsafe { ACE_High_Res_Timer::dump(__this) }
}
#[export_name = "_ZN18ACE_High_Res_Timer11get_cpuinfoEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_High_Res_Timer11get_cpuinfoEv() -> libc::c_uint {
    unsafe { ACE_High_Res_Timer::get_cpuinfo() }
}
#[repr(C)]
#[derive(Clone)]
...
impl ACE_High_Res_Timer {
    ...
    pub unsafe fn global_scale_factor_ubcde1b6c85276b84() -> libc::c_uint {
        unsafe {
            {
                return ((ACE_High_Res_Timer_global_scale_factor_) as libc::c_uint);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    ...
    pub unsafe fn get_env_global_scale_factor(
        ...
        unsafe {
            {
                if ((((!(env).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    let mut env_value: *const libc::c_char = ((ACE_OS::getenv_u25dce132a786d601(
                        ((env) as *const libc::c_char),
                    )) as *const libc::c_char);
                    if ((((!(env_value).is_null()) as libc::c_int) as libc::c_int) != 0)
                    {
                        let mut value: libc::c_int = ((ACE_OS::atoi_ud83f836c714024f7(
                            env_value,
                        )) as libc::c_int);
    ...
    pub unsafe fn calibrate(
        ...
        unsafe {
            {
                let mut sleep_time: ACE_Time_Value = ::core::mem::MaybeUninit::<
                    ACE_Time_Value,
                >::zeroed()
                    .assume_init();
                <ACE_Time_Value>::new_at_ub59bcc88eaedf2a6(
                    (::core::ptr::addr_of_mut!(sleep_time)) as *mut ACE_Time_Value,
                    ((0) as libc::c_long),
                    ((usec) as libc::c_long),
                );
                let mut delta_hrtime: ACE_Stats = ::core::mem::MaybeUninit::<
                    ACE_Stats,
                >::zeroed()
                    .assume_init();
                <ACE_Stats>::new_at(
                    (::core::ptr::addr_of_mut!(delta_hrtime)) as *mut ACE_Stats,
                );
                let mut actual_sleeps: ACE_Stats = ::core::mem::MaybeUninit::<
                    ACE_Stats,
                >::zeroed()
                    .assume_init();
                <ACE_Stats>::new_at(
                    (::core::ptr::addr_of_mut!(actual_sleeps)) as *mut ACE_Stats,
                );
                {
                    let mut i: libc::c_uint = ((0) as libc::c_uint);
                    'for_0: loop {
                        if !((((((i as libc::c_uint)) < (((iterations) as libc::c_uint)))
                            as libc::c_int as libc::c_int) != 0))
                        {
                            break;
                        }
                        'cont_0: loop {
                            {
                                {
                                    let mut actual_start: ACE_Time_Value = ACE_OS::gettimeofday_u3220bcbbceb90f45();
                                    let mut start: libc::c_ulong = ((ACE_OS::gethrtime(
                                        ((ACE_OS::ACE_HRTIMER_GETTIME) as libc::c_uint),
                                    )) as libc::c_ulong);
                                    ACE_OS::sleep_u1b7b7e36e28cf584(
                                        ::core::ptr::addr_of!(sleep_time),
                                    );
                                    let mut stop: libc::c_ulong = ((ACE_OS::gethrtime(
                                        ((ACE_OS::ACE_HRTIMER_GETTIME) as libc::c_uint),
                                    )) as libc::c_ulong);
                                    let __addrof_tmp_0 = ACE_OS::gettimeofday_u3220bcbbceb90f45();
                                    let mut actual_delta: ACE_Time_Value = operator_sub_u7824066738f89e79(
                                        &__addrof_tmp_0 as *const ACE_Time_Value,
                                        ::core::ptr::addr_of!(actual_start),
                                    );
                                    <ACE_Stats>::sample(
                                        (::core::ptr::addr_of_mut!(delta_hrtime)) as *mut ACE_Stats,
                                        ((ACE_Utils::truncate_cast___unsigned_long_(
                                            (((((stop) as libc::c_ulong))
                                                .wrapping_sub((start) as libc::c_ulong)) as libc::c_ulong),
                                        )) as libc::c_int),
                                    );
                                    <ACE_Stats>::sample(
                                        (::core::ptr::addr_of_mut!(actual_sleeps))
                                            as *mut ACE_Stats,
                                        (((((<ACE_Time_Value>::msec(
                                            (::core::ptr::addr_of!(actual_delta))
                                                as *const ACE_Time_Value,
                                        )) as libc::c_ulong))
                                            .wrapping_mul((100u32) as libc::c_ulong)) as libc::c_int),
                                    );
                                }
                            }
                            #[allow(unreachable_code)] break 'cont_0;
                ...
                let mut ticks: ACE_Stats_Value = ::core::mem::MaybeUninit::<
                    ACE_Stats_Value,
                >::zeroed()
                    .assume_init();
                <ACE_Stats_Value>::new_at(
                    (::core::ptr::addr_of_mut!(ticks)) as *mut ACE_Stats_Value,
                    ((0) as libc::c_uint),
                );
                <ACE_Stats>::mean(
                    (::core::ptr::addr_of_mut!(delta_hrtime)) as *mut ACE_Stats,
                    ::core::ptr::addr_of_mut!(ticks),
                    ((1) as libc::c_uint),
                );
                let mut actual_sleep: ACE_Stats_Value = ::core::mem::MaybeUninit::<
                    ACE_Stats_Value,
                >::zeroed()
                    .assume_init();
                <ACE_Stats_Value>::new_at(
                    (::core::ptr::addr_of_mut!(actual_sleep)) as *mut ACE_Stats_Value,
                    ((0) as libc::c_uint),
                );
                <ACE_Stats>::mean(
                    (::core::ptr::addr_of_mut!(actual_sleeps)) as *mut ACE_Stats,
                    ::core::ptr::addr_of_mut!(actual_sleep),
                    ((1) as libc::c_uint),
                );
                let mut scale_factor: libc::c_uint = ((((((((((((<ACE_Stats_Value>::whole_uafb62f09e36f57e1(
                    (::core::ptr::addr_of!(ticks)) as *const ACE_Stats_Value,
                )) as libc::c_uint))
                    / ((<ACE_Stats_Value>::whole_uafb62f09e36f57e1(
                        (::core::ptr::addr_of!(actual_sleep)) as *const ACE_Stats_Value,
                    )) as libc::c_uint)) as libc::c_uint))
                    .wrapping_add((5) as libc::c_uint))) as libc::c_uint))
                    / ((10u32) as libc::c_uint)) as libc::c_uint);
                <ACE_High_Res_Timer>::global_scale_factor(
                    ((scale_factor) as libc::c_uint),
                );
                return ((scale_factor) as libc::c_uint);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ...
            {
                <ACE_High_Res_Timer>::reset((__this) as *mut ACE_High_Res_Timer);
                {
                    let _ = <ACE_High_Res_Timer>::global_scale_factor_ubcde1b6c85276b84();
                };
            }
            ()
        }
    ...
    pub unsafe fn reset(__this: *mut Self) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                (*__this).start_ = ((0) as libc::c_ulong);
                (*__this).end_ = ((0) as libc::c_ulong);
                (*__this).total_ = ((0) as libc::c_ulong);
                (*__this).start_incr_ = ((0) as libc::c_ulong);
            }
            ()
        }
    }
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                (*nanoseconds) = (((<ACE_High_Res_Timer>::elapsed_hrtime(
                    ...
                    .wrapping_mul(
                        (((((1024000u32) as libc::c_uint))
                            / ((<ACE_High_Res_Timer>::global_scale_factor_ubcde1b6c85276b84())
                                as libc::c_uint))) as libc::c_ulong,
                    );
                (*nanoseconds) = ((((*nanoseconds)) as libc::c_ulong))
                    .wrapping_shr((10) as u32);
            }
            ()
        }
    }
    ...
    pub unsafe fn elapsed_time_uefa7a55ba73008f6(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                let mut nseconds: libc::c_ulong = (((((((((((elapsed) as libc::c_ulong))
                    % ((<ACE_High_Res_Timer>::global_scale_factor_ubcde1b6c85276b84())
                        as libc::c_ulong)) as libc::c_ulong))
                    .wrapping_mul((1000u32) as libc::c_ulong)) as libc::c_ulong))
                    / ((<ACE_High_Res_Timer>::global_scale_factor_ubcde1b6c85276b84())
                        as libc::c_ulong)) as libc::c_ulong);
                let mut useconds: libc::c_uint = (((((elapsed) as libc::c_ulong))
                    / ((<ACE_High_Res_Timer>::global_scale_factor_ubcde1b6c85276b84())
                        as libc::c_ulong)) as libc::c_uint);
                (*elapsed_time).tv_sec = (((((((useconds) as libc::c_long))
                    / ((ACE_ONE_SECOND_IN_USECS) as libc::c_long)) as libc::c_long))
                    as libc::c_long);
                (*elapsed_time).tv_nsec = ((((((((((((((useconds) as libc::c_long))
                    % ((ACE_ONE_SECOND_IN_USECS) as libc::c_long))) as libc::c_long))
                    .wrapping_mul((1000u32) as libc::c_long)) as libc::c_ulong))
                    .wrapping_add((nseconds) as libc::c_ulong)) as libc::c_long))
                    as libc::c_long);
            }
            ()
        }
  ...
  /// to start_incr and stop_incr.*/
    pub unsafe fn elapsed_time_incr_u71012f5f981a9568(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                (*nanoseconds) = ((((*__this).total_) as libc::c_ulong))
                    .wrapping_mul(
                        (((((1024000u32) as libc::c_uint))
                            / ((<ACE_High_Res_Timer>::global_scale_factor_ubcde1b6c85276b84())
                                as libc::c_uint))) as libc::c_ulong,
  ...
  /// @note only use @c print_total if incremental timings had been used!*/
    pub unsafe fn print_total(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut total_nanoseconds: libc::c_ulong = unsafe {
                    ::core::mem::zeroed()
                };
                <ACE_High_Res_Timer>::elapsed_time_u0ae118857bf6b975(
                    (__this) as *const ACE_High_Res_Timer,
                    ::core::ptr::addr_of_mut!(total_nanoseconds),
                );
                let mut total_secs: libc::c_ulong = (((((total_nanoseconds)
                    as libc::c_ulong))
                    / (((1000000000 as libc::c_uint)) as libc::c_ulong))
                    as libc::c_ulong);
                let mut extra_nsecs: libc::c_uint = (((((total_nanoseconds)
                    as libc::c_ulong))
                    % (((1000000000 as libc::c_uint)) as libc::c_ulong))
                    as libc::c_uint);
                let mut buf: [libc::c_char; 100usize] = unsafe { ::core::mem::zeroed() };
                if (((((count as libc::c_int)) > (((1) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    let mut avg_nsecs: libc::c_ulong = ((((*__this).total_)
                        as libc::c_ulong))
                        / (((count as libc::c_uint)) as libc::c_ulong);
                    ACE_OS::snprintf_u9a28649a3b771eeb(
                        ((buf).as_mut_ptr() as *mut libc::c_char),
                        ((100) as libc::c_ulong),
                        ((b" count = %d, total (secs %lu, usecs %u), avg usecs = %lu\n\0"
                            .as_ptr() as *const libc::c_char) as *const libc::c_char),
                        count,
                        total_secs,
                        (((((((extra_nsecs) as libc::c_uint))
                            .wrapping_add((500u32) as libc::c_uint))) as libc::c_uint))
                            / ((1000u32) as libc::c_uint),
                        (((((((((avg_nsecs) as libc::c_ulong))
                            .wrapping_add((500u32) as libc::c_ulong))) as libc::c_ulong))
                            / ((1000u32) as libc::c_ulong)) as libc::c_ulong),
                    );
                } else {
                    ACE_OS::snprintf_u9a28649a3b771eeb(
                        ((buf).as_mut_ptr() as *mut libc::c_char),
                        ((100) as libc::c_ulong),
                        ((b" total %3lu.%06u secs\n\0".as_ptr() as *const libc::c_char)
                            as *const libc::c_char),
                        total_secs,
                        (((((((extra_nsecs) as libc::c_uint))
                            .wrapping_add((500u32) as libc::c_uint))) as libc::c_uint))
                ...
                ACE_OS::write_uba4fd70f52b99861(
                    handle,
                    ((str) as *const libc::c_void),
                    ACE_OS::strlen_u07dd12a225364fa6(((str) as *const libc::c_char)),
                );
                ACE_OS::write_uba4fd70f52b99861(
                    handle,
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                if (((((count as libc::c_int)) > (((1) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    let mut avg_nsecs: libc::c_ulong = (((total_nanoseconds)
                        as libc::c_ulong))
                        / (((count as libc::c_uint)) as libc::c_ulong);
                    ACE_OS::snprintf_u9a28649a3b771eeb(
                        ((buf).as_mut_ptr() as *mut libc::c_char),
                    ...
                    ACE_OS::snprintf_u9a28649a3b771eeb(
                        ((buf).as_mut_ptr() as *mut libc::c_char),
                        ((100) as libc::c_ulong),
                        ((b" total %3lu.%06lu secs\n\0".as_ptr() as *const libc::c_char)
                            as *const libc::c_char),
                        total_secs,
                        (((((((extra_nsecs) as libc::c_ulong))
                            .wrapping_add((500u64) as libc::c_ulong))) as libc::c_ulong))
                            / ((1000u64) as libc::c_ulong),
                    );
                }
                ACE_OS::write_uba4fd70f52b99861(
                    handle,
    ...
    pub unsafe fn get_cpuinfo() -> libc::c_uint {
        unsafe {
            {
                let mut scale_factor: libc::c_uint = ((1u32) as libc::c_uint);
                let mut supported: bool = false;
                let mut cpuinfo: *mut _IO_FILE = ACE_OS::fopen_ua6d43bbd3a566b87(
                    ((b"/proc/cpuinfo\0".as_ptr() as *const libc::c_char)
                        as *const libc::c_char),
                    ((b"r\0".as_ptr() as *const libc::c_char) as *const libc::c_char),
                );
                if ((((!(cpuinfo).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    let mut buf: [libc::c_char; 128usize] = unsafe {
                        ::core::mem::zeroed()
                    };
                    'while_0: loop {
                        if !((!(ACE_OS::fgets_uafd841fb54fd292c(
                            ((buf).as_mut_ptr() as *mut libc::c_char),
                            ((::core::mem::size_of::<[libc::c_char; 128usize]>()
                        ...
                        'cont_0: loop {
                            {
                                {
                                    let mut mhertz: libc::c_double = ((1) as libc::c_double);
                                    let mut bmips: libc::c_double = ((1) as libc::c_double);
                                    let mut arg: [libc::c_char; 128usize] = unsafe {
                                        ::core::mem::zeroed()
                                    };
                                    if (((((sscanf(
                                        ((buf).as_ptr() as *const libc::c_char),
                                        ...
                                        as libc::c_int) != 0)
                                    {
                                        ...
                                        if (((((((!(((supported as libc::c_int) != 0))
                                            as libc::c_int) as libc::c_int) != 0)
                                            && (((((sscanf(
                                                ((buf).as_ptr() as *const libc::c_char),
                                                ((b"model name : Pentium %s\n\0".as_ptr()
                                                ...
                                                as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
                                        {
                                            if (((((((((((((((((ACE_OS::strcmp_u2f671283fc8b6d4a(
                                                ((arg).as_ptr() as *const libc::c_char),
                                                ((b"II\0".as_ptr() as *const libc::c_char)
                                                    as *const libc::c_char),
                                            ) as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                                                as libc::c_int) != 0)
                                                || (((((ACE_OS::strcmp_u2f671283fc8b6d4a(
                                                    ((arg).as_ptr() as *const libc::c_char),
                                                    ((b"III\0".as_ptr() as *const libc::c_char)
                                                        as *const libc::c_char),
                                                ) as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                                                    as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
                                                || (((((ACE_OS::strcmp_u2f671283fc8b6d4a(
                                                    ((arg).as_ptr() as *const libc::c_char),
                                                    ((b"IV\0".as_ptr() as *const libc::c_char)
                                                        as *const libc::c_char),
                                                ) as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                                                    as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
                                                || (((((ACE_OS::strcmp_u2f671283fc8b6d4a(
                                                    ((arg).as_ptr() as *const libc::c_char),
                                                    ((b"Pro\0".as_ptr() as *const libc::c_char)
                                                        as *const libc::c_char),
                                                ) as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                                                    as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
                                            {
                                            ...
                                            if (((((sscanf(
                                                ...
                                                ((b"cpu MHz : %lf\n\0".as_ptr() as *const libc::c_char)
                                                    as *const libc::c_char),
                                                ::core::ptr::addr_of_mut!(mhertz) as *mut libc::c_double,
                                            ) as libc::c_int)) == (((1) as libc::c_int))) as libc::c_int
                                                as libc::c_int) != 0)
                                            {
                                                if (((((mhertz as libc::c_double))
                                                    > (((0.0f64) as libc::c_double))) as libc::c_int
                                                    as libc::c_int) != 0)
                                                {
                                                    scale_factor = (((((mhertz) as libc::c_double))
                                                        + ((0.5f64) as libc::c_double)) as libc::c_uint);
                                                    break 'while_0;
                                                }
                                            } else {
                                                if (((((((((sscanf(
                                                    ...
                                                    ((b"bogomips : %lf\n\0".as_ptr() as *const libc::c_char)
                                                        as *const libc::c_char),
                                                    ::core::ptr::addr_of_mut!(bmips) as *mut libc::c_double,
                                                ) as libc::c_int)) == (((1) as libc::c_int))) as libc::c_int
                                                    as libc::c_int) != 0)
                                                    || (((((sscanf(
                                                        ((buf).as_ptr() as *const libc::c_char),
                                                ...
                                                {
                                                    if ((supported as libc::c_int) != 0) {
                                                        scale_factor = (((((bmips) as libc::c_double))
                                                            + ((0.5f64) as libc::c_double)) as libc::c_uint);
                                                    }
                                                    break 'while_0;
                                                }
                    ...
                    ACE_OS::fclose_u07d30b70956bcb1f(cpuinfo);
                }
                return scale_factor;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
...
impl ACE_Stats {
  ...
  /// to running out of memory, or to rolling over of the sample count.*/
    pub unsafe fn sample(__this: *mut Self, mut value: libc::c_int) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN9ACE_Stats6sampleEi"]
            fn __ext(__this: *mut ACE_Stats, value: libc::c_int) -> libc::c_int;
        }
        __ext(__this as *mut ACE_Stats, value)
    }
    ...
    pub unsafe fn mean(
        __this: *mut Self,
        mut mean: *mut ACE_Stats_Value,
        mut scale_factor: libc::c_uint,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN9ACE_Stats4meanER15ACE_Stats_Valuej"]
            fn __ext(
                __this: *mut ACE_Stats,
                mean: *mut ACE_Stats_Value,
                scale_factor: libc::c_uint,
            );
        }
        __ext(__this as *mut ACE_Stats, mean, scale_factor)
    }
  ...
  /// description of {mean} method for argument descriptions.*/
    pub unsafe fn std_dev(
        ...
        extern "C-unwind" {
            #[link_name = "_ZN9ACE_Stats7std_devER15ACE_Stats_Valuej"]
            fn __ext(
                __this: *mut ACE_Stats,
        ...
        __ext(__this as *mut ACE_Stats, std_dev, scale_factor)
    }
    ...
    pub unsafe fn print_summary(
        ...
        mut scale_factor: libc::c_uint,
        mut _anon_2: *mut _IO_FILE,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZNK9ACE_Stats13print_summaryEjjP8_IO_FILE"]
            fn __ext(
                __this: *const ACE_Stats,
                precision: libc::c_uint,
                scale_factor: libc::c_uint,
                _anon_2: *mut _IO_FILE,
            ) -> libc::c_int;
        }
        __ext(__this as *const ACE_Stats, precision, scale_factor, _anon_2)
    }
    ///Initialize internal state.
    pub unsafe fn reset(__this: *mut Self) {
        extern "C-unwind" {
            #[link_name = "_ZN9ACE_Stats5resetEv"]
            fn __ext(__this: *mut ACE_Stats);
        }
        __ext(__this as *mut ACE_Stats)
    }
    ...
    pub unsafe fn quotient(
        ...
        extern "C-unwind" {
            #[link_name = "_ZN9ACE_Stats8quotientEmjR15ACE_Stats_Value"]
            fn __ext(
        ...
        __ext(dividend, divisor, quotient)
    }
    ...
    pub unsafe fn quotient_ub0fc8e782b5a532e(
        ...
        extern "C-unwind" {
            #[link_name = "_ZN9ACE_Stats8quotientERK15ACE_Stats_ValuejRS0_"]
            fn __ext(
    ...
    pub unsafe fn square_root(
        ...
        extern "C-unwind" {
            #[link_name = "_ZN9ACE_Stats11square_rootEmR15ACE_Stats_Value"]
            fn __ext(n: libc::c_ulong, square_root: *mut ACE_Stats_Value);
        }
        __ext(n, square_root)
    }
...
impl ACE_Unbounded_Queue_int_ {
    ...
    pub unsafe fn enqueue_tail(
        ...
        extern "C-unwind" {
            #[link_name = "_ZN19ACE_Unbounded_QueueIiE12enqueue_tailERKi"]
            fn __ext(
                __this: *mut ACE_Unbounded_Queue_int_,
    ...
    pub unsafe fn reset(__this: *mut Self) {
        extern "C-unwind" {
            #[link_name = "_ZN19ACE_Unbounded_QueueIiE5resetEv"]
            fn __ext(__this: *mut ACE_Unbounded_Queue_int_);
        }
        __ext(__this as *mut ACE_Unbounded_Queue_int_)
    }
