...
#[export_name = "_ZN17ACE_Adaptive_Lock6removeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Adaptive_Lock6removeEv(
    __this: *mut ACE_Adaptive_Lock,
) -> libc::c_int {
    unsafe { ACE_Adaptive_Lock::remove(__this) }
}
#[export_name = "_ZN17ACE_Adaptive_Lock7acquireEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Adaptive_Lock7acquireEv(
    __this: *mut ACE_Adaptive_Lock,
) -> libc::c_int {
    unsafe { ACE_Adaptive_Lock::acquire(__this) }
}
#[export_name = "_ZN17ACE_Adaptive_Lock10tryacquireEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Adaptive_Lock10tryacquireEv(
    __this: *mut ACE_Adaptive_Lock,
) -> libc::c_int {
    unsafe { ACE_Adaptive_Lock::tryacquire(__this) }
}
#[export_name = "_ZN17ACE_Adaptive_Lock7releaseEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Adaptive_Lock7releaseEv(
    __this: *mut ACE_Adaptive_Lock,
) -> libc::c_int {
    unsafe { ACE_Adaptive_Lock::release(__this) }
}
#[export_name = "_ZN17ACE_Adaptive_Lock12acquire_readEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Adaptive_Lock12acquire_readEv(
    __this: *mut ACE_Adaptive_Lock,
) -> libc::c_int {
    unsafe { ACE_Adaptive_Lock::acquire_read(__this) }
}
#[export_name = "_ZN17ACE_Adaptive_Lock13acquire_writeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Adaptive_Lock13acquire_writeEv(
    __this: *mut ACE_Adaptive_Lock,
) -> libc::c_int {
    unsafe { ACE_Adaptive_Lock::acquire_write(__this) }
}
#[export_name = "_ZN17ACE_Adaptive_Lock15tryacquire_readEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Adaptive_Lock15tryacquire_readEv(
    __this: *mut ACE_Adaptive_Lock,
) -> libc::c_int {
    unsafe { ACE_Adaptive_Lock::tryacquire_read(__this) }
}
#[export_name = "_ZN17ACE_Adaptive_Lock16tryacquire_writeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Adaptive_Lock16tryacquire_writeEv(
    __this: *mut ACE_Adaptive_Lock,
) -> libc::c_int {
    unsafe { ACE_Adaptive_Lock::tryacquire_write(__this) }
}
#[export_name = "_ZN17ACE_Adaptive_Lock24tryacquire_write_upgradeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Adaptive_Lock24tryacquire_write_upgradeEv(
    __this: *mut ACE_Adaptive_Lock,
) -> libc::c_int {
    unsafe { ACE_Adaptive_Lock::tryacquire_write_upgrade(__this) }
}
#[export_name = "_ZNK17ACE_Adaptive_Lock4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK17ACE_Adaptive_Lock4dumpEv(
    __this: *const ACE_Adaptive_Lock,
) {
    unsafe { ACE_Adaptive_Lock::dump(__this) }
}
#[export_name = "_ZN17ACE_Adaptive_LockC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Adaptive_LockC1Ev(
    __this: *mut ACE_Adaptive_Lock,
) {
    ACE_Adaptive_Lock::new_at(__this)
}
