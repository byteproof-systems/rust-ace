...
#[export_name = "_ZN13ACE_ConditionI16ACE_Thread_MutexEC1ERS0_PKcPv"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_ConditionI16ACE_Thread_MutexEC1ERS0_PKcPv(
    __this: *mut ACE_Condition_ACE_Thread_Mutex_,
    __a0: *mut ACE_Thread_Mutex,
    __a1: *const libc::c_char,
    __a2: *mut libc::c_void,
) {
    ACE_Condition_ACE_Thread_Mutex_::new_at(__this, __a0, __a1, __a2)
}
#[export_name = "_ZN13ACE_ConditionI16ACE_Thread_MutexEC1ERS0_RK24ACE_Condition_AttributesPKcPv"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_ConditionI16ACE_Thread_MutexEC1ERS0_RK24ACE_Condition_AttributesPKcPv(
    __this: *mut ACE_Condition_ACE_Thread_Mutex_,
    __a0: *mut ACE_Thread_Mutex,
...
impl Drop for ACE_Condition_ACE_Thread_Mutex_ {
    fn drop(&mut self) {
        unsafe {
            let __this: *mut Self = self as *mut Self;
            {
                <ACE_Condition_ACE_Thread_Mutex_>::remove(
                    (__this) as *mut ACE_Condition_ACE_Thread_Mutex_,
                );
            }
            ()
        }
...
#[export_name = "__acedtor_u9bf8d1c18f5a7ed4"]
pub unsafe extern "C-unwind" fn __acedtor_u9bf8d1c18f5a7ed4(
    __this: *mut ACE_Condition_ACE_Thread_Mutex_,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[export_name = "_ZN13ACE_ConditionI16ACE_Thread_MutexE4waitEPK14ACE_Time_Value"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_ConditionI16ACE_Thread_MutexE4waitEPK14ACE_Time_Value(
    __this: *mut ACE_Condition_ACE_Thread_Mutex_,
    abstime: *const ACE_Time_Value,
) -> libc::c_int {
    unsafe { ACE_Condition_ACE_Thread_Mutex_::wait(__this, abstime) }
}
#[export_name = "_ZN13ACE_ConditionI16ACE_Thread_MutexE4waitEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_ConditionI16ACE_Thread_MutexE4waitEv(
    __this: *mut ACE_Condition_ACE_Thread_Mutex_,
) -> libc::c_int {
    unsafe { ACE_Condition_ACE_Thread_Mutex_::wait_u7b23a5781005aed8(__this) }
}
#[export_name = "_ZN13ACE_ConditionI16ACE_Thread_MutexE4waitERS0_PK14ACE_Time_Value"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_ConditionI16ACE_Thread_MutexE4waitERS0_PK14ACE_Time_Value(
    __this: *mut ACE_Condition_ACE_Thread_Mutex_,
    mutex: *mut ACE_Thread_Mutex,
    abstime: *const ACE_Time_Value,
) -> libc::c_int {
    unsafe {
        ACE_Condition_ACE_Thread_Mutex_::wait_u7c552daa61366173(__this, mutex, abstime)
    }
}
#[export_name = "_ZN13ACE_ConditionI16ACE_Thread_MutexE6signalEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_ConditionI16ACE_Thread_MutexE6signalEv(
    __this: *mut ACE_Condition_ACE_Thread_Mutex_,
) -> libc::c_int {
    unsafe { ACE_Condition_ACE_Thread_Mutex_::signal(__this) }
}
#[export_name = "_ZN13ACE_ConditionI16ACE_Thread_MutexE9broadcastEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_ConditionI16ACE_Thread_MutexE9broadcastEv(
    __this: *mut ACE_Condition_ACE_Thread_Mutex_,
) -> libc::c_int {
    unsafe { ACE_Condition_ACE_Thread_Mutex_::broadcast(__this) }
}
#[export_name = "_ZNK13ACE_ConditionI16ACE_Thread_MutexE4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_ConditionI16ACE_Thread_MutexE4dumpEv(
    __this: *const ACE_Condition_ACE_Thread_Mutex_,
) {
    unsafe { ACE_Condition_ACE_Thread_Mutex_::dump(__this) }
}
extern "C-unwind" {
...
impl ACE_Condition_ACE_Thread_Mutex_ {
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/Condition_Thread_Mutex.cpp\0"
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        b"ACE_Condition<ACE_Thread_Mutex>::ACE_Condition<ACE_Thread_Mutex>\0"
    ...
    pub unsafe fn wait(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return <ACE_Condition_ACE_Thread_Mutex_>::wait_u7c552daa61366173(
                    (__this) as *mut ACE_Condition_ACE_Thread_Mutex_,
                    ::core::ptr::addr_of_mut!((* (* __this).mutex_)),
                    abstime,
                );
    ...
    pub unsafe fn wait_u7b23a5781005aed8(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return ACE_OS::cond_wait(
                    ::core::ptr::addr_of_mut!((* __this).cond_) as *mut pthread_cond_t,
                    (((<ACE_Thread_Mutex>::lock_uc8df6ef02603782a(
                        (::core::ptr::addr_of_mut!((* (* __this).mutex_)))
    ...
    pub unsafe fn wait_u7c552daa61366173(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return ACE_OS::cond_timedwait(
                    ::core::ptr::addr_of_mut!((* __this).cond_) as *mut pthread_cond_t,
                    (((<ACE_Thread_Mutex>::lock_uc8df6ef02603782a(
                        (::core::ptr::addr_of_mut!((* mutex))) as *mut ACE_Thread_Mutex,
                    )) as *mut pthread_mutex_t) as *mut pthread_mutex_t),
