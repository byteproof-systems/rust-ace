...
#[no_mangle]
pub unsafe extern "C-unwind" fn ace_thread_adapter(
    mut args: *mut libc::c_void,
) -> *mut libc::c_void {
    unsafe {
        {
            let mut thread_args: *mut ACE_Base_Thread_Adapter = (((args
                as *mut ACE_Base_Thread_Adapter)) as *mut ACE_Base_Thread_Adapter);
            let mut status: *mut libc::c_void = {
                let __obj: *mut ACE_Base_Thread_Adapter = (thread_args)
                    as *mut ACE_Base_Thread_Adapter;
                let __vt: *const __Vtbl_uf9c6177bf0b37713 = *(__obj
                    as *const *const __Vtbl_uf9c6177bf0b37713);
                ((*__vt).vfn_u11d7950624b3f9a1)(__obj)
            };
            return status;
        }
...
impl Drop for ACE_Base_Thread_Adapter {
    fn drop(&mut self) {
        unsafe {
...
#[export_name = "_ZN23ACE_Base_Thread_Adapter13close_log_msgEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Base_Thread_Adapter13close_log_msgEv() {
    unsafe { ACE_Base_Thread_Adapter::close_log_msg() }
}
#[export_name = "_ZN23ACE_Base_Thread_Adapter12sync_log_msgEPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Base_Thread_Adapter12sync_log_msgEPKc(
    prg: *const libc::c_char,
) {
    unsafe { ACE_Base_Thread_Adapter::sync_log_msg(prg) }
}
#[export_name = "_ZN23ACE_Base_Thread_Adapter16thr_desc_log_msgEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Base_Thread_Adapter16thr_desc_log_msgEv() -> *mut ACE_OS_Thread_Descriptor {
    unsafe { ACE_Base_Thread_Adapter::thr_desc_log_msg() }
}
#[export_name = "_ZN23ACE_Base_Thread_AdapterC1EPFPvS0_ES0_S2_P24ACE_OS_Thread_Descriptorl"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Base_Thread_AdapterC1EPFPvS0_ES0_S2_P24ACE_OS_Thread_Descriptorl(
    __this: *mut ACE_Base_Thread_Adapter,
    __a0: Option<unsafe extern "C-unwind" fn(*mut libc::c_void) -> *mut libc::c_void>,
    __a1: *mut libc::c_void,
    __a2: Option<unsafe extern "C-unwind" fn(*mut libc::c_void) -> *mut libc::c_void>,
    __a3: *mut ACE_OS_Thread_Descriptor,
    __a4: libc::c_long,
) {
    ACE_Base_Thread_Adapter::new_at(__this, __a0, __a1, __a2, __a3, __a4)
}
#[export_name = "_ZN23ACE_Base_Thread_Adapter15inherit_log_msgEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Base_Thread_Adapter15inherit_log_msgEv(
    __this: *mut ACE_Base_Thread_Adapter,
) {
    unsafe { ACE_Base_Thread_Adapter::inherit_log_msg(__this) }
}
...
impl ACE_Base_Thread_Adapter {
  ...
  /// routine.*/
    ...
    pub unsafe fn close_log_msg() {
        unsafe {
            {
                if (((((ACE_Base_Thread_Adapter_close_log_msg_hook_).is_some())
                    as libc::c_int) as libc::c_int) != 0)
                {
                    (((ACE_Base_Thread_Adapter_close_log_msg_hook_))
    ...
    pub unsafe fn sync_log_msg(mut prg: *const libc::c_char) {
        unsafe {
            {
                if (((((ACE_Base_Thread_Adapter_sync_log_msg_hook_).is_some())
                    as libc::c_int) as libc::c_int) != 0)
                {
                    (((ACE_Base_Thread_Adapter_sync_log_msg_hook_))
                        .expect("null function pointer"))(prg);
                }
            }
            ()
        }
    ...
    pub unsafe fn thr_desc_log_msg() -> *mut ACE_OS_Thread_Descriptor {
        unsafe {
            {
                if (((((ACE_Base_Thread_Adapter_thr_desc_log_msg_hook_).is_some())
                    as libc::c_int) as libc::c_int) != 0)
                {
                    return (((ACE_Base_Thread_Adapter_thr_desc_log_msg_hook_))
                        .expect("null function pointer"))();
                }
                return ((0) as *mut ACE_OS_Thread_Descriptor);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    ...
    pub unsafe fn new_at(
        __this: *mut Self,
        mut user_func: Option<
            unsafe extern "C-unwind" fn(*mut libc::c_void) -> *mut libc::c_void,
        >,
        mut arg: *mut libc::c_void,
        mut entry_point: Option<
            unsafe extern "C-unwind" fn(*mut libc::c_void) -> *mut libc::c_void,
        >,
        mut td: *mut ACE_OS_Thread_Descriptor,
        mut cancel_flags: libc::c_long,
    ) {
        unsafe {
            ::core::ptr::write(
                __this,
            ...
            *(__this as *mut *const ()) = &__VTBL_uf9c6177bf0b37713
                as *const __Vtbl_uf9c6177bf0b37713 as *const ();
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).user_func_),
                user_func,
            );
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).arg_), arg);
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).entry_point_),
                entry_point,
            );
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).thr_desc_), td);
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).ctx_),
            ...
            <ACE_OS_Log_Msg_Attributes>::new_at(
                ::core::ptr::addr_of_mut!((* __this).log_msg_attributes_),
            );
            {
                if (((((ACE_Base_Thread_Adapter_init_log_msg_hook_).is_some())
                    as libc::c_int) as libc::c_int) != 0)
                {
                    (((ACE_Base_Thread_Adapter_init_log_msg_hook_))
                        .expect(
  ...
  /// ACE_Log_Msg.*/
    pub unsafe fn inherit_log_msg(__this: *mut Self) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((((ACE_Base_Thread_Adapter_inherit_log_msg_hook_).is_some())
                    as libc::c_int) as libc::c_int) != 0)
                {
                    (((ACE_Base_Thread_Adapter_inherit_log_msg_hook_))
                        .expect(
                            "null function pointer",
                        ))(
                        (*__this).thr_desc_,
                ...
                <ACE_Service_Config>::current(
                    (((*__this).ctx_) as *mut ACE_Service_Gestalt),
                );
            }
            ()
        }
