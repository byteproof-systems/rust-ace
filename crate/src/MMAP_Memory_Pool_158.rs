...
#[export_name = "_ZN28ACE_MMAP_Memory_Pool_OptionsC1EPKvibmjbijbb"]
pub unsafe extern "C-unwind" fn __xtu__ZN28ACE_MMAP_Memory_Pool_OptionsC1EPKvibmjbijbb(
    __this: *mut ACE_MMAP_Memory_Pool_Options,
    ...
    ACE_MMAP_Memory_Pool_Options::new_at(
        __this,
        __a0,
        __a1,
        __a2,
...
#[export_name = "_ZN20ACE_MMAP_Memory_PoolC1EPKcPK28ACE_MMAP_Memory_Pool_Options"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_MMAP_Memory_PoolC1EPKcPK28ACE_MMAP_Memory_Pool_Options(
    __this: *mut ACE_MMAP_Memory_Pool,
    __a0: *const libc::c_char,
    __a1: *const ACE_MMAP_Memory_Pool_Options,
) {
    ACE_MMAP_Memory_Pool::new_at(__this, __a0, __a1)
}
impl Drop for ACE_MMAP_Memory_Pool {
    fn drop(&mut self) {
        {
            unsafe {
                let __this: *mut Self = self as *mut Self;
...
#[export_name = "_ZN20ACE_MMAP_Memory_Pool12init_acquireEmRmRi"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_MMAP_Memory_Pool12init_acquireEmRmRi(
    __this: *mut ACE_MMAP_Memory_Pool,
    nbytes: libc::c_ulong,
    ...
    unsafe {
        ACE_MMAP_Memory_Pool::init_acquire(__this, nbytes, rounded_bytes, first_time)
    }
}
#[export_name = "_ZN20ACE_MMAP_Memory_Pool7acquireEmRm"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_MMAP_Memory_Pool7acquireEmRm(
    __this: *mut ACE_MMAP_Memory_Pool,
    nbytes: libc::c_ulong,
    rounded_bytes: *mut libc::c_ulong,
) -> *mut libc::c_void {
    unsafe { ACE_MMAP_Memory_Pool::acquire(__this, nbytes, rounded_bytes) }
}
#[export_name = "_ZN20ACE_MMAP_Memory_Pool7releaseEi"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_MMAP_Memory_Pool7releaseEi(
    __this: *mut ACE_MMAP_Memory_Pool,
    destroy: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_MMAP_Memory_Pool::release(__this, destroy) }
}
#[export_name = "_ZN20ACE_MMAP_Memory_Pool4syncEmi"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_MMAP_Memory_Pool4syncEmi(
    __this: *mut ACE_MMAP_Memory_Pool,
    len: libc::c_ulong,
    flags: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_MMAP_Memory_Pool::sync(__this, len, flags) }
}
#[export_name = "_ZN20ACE_MMAP_Memory_Pool4syncEi"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_MMAP_Memory_Pool4syncEi(
    __this: *mut ACE_MMAP_Memory_Pool,
    flags: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_MMAP_Memory_Pool::sync_ua77e6bd2e6007bc6(__this, flags) }
}
#[export_name = "_ZN20ACE_MMAP_Memory_Pool4syncEPvmi"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_MMAP_Memory_Pool4syncEPvmi(
    __this: *mut ACE_MMAP_Memory_Pool,
    addr: *mut libc::c_void,
    len: libc::c_ulong,
    flags: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_MMAP_Memory_Pool::sync_u8f2f28f4f83a3cf6(__this, addr, len, flags) }
}
#[export_name = "_ZN20ACE_MMAP_Memory_Pool7protectEmi"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_MMAP_Memory_Pool7protectEmi(
    __this: *mut ACE_MMAP_Memory_Pool,
    len: libc::c_ulong,
    prot: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_MMAP_Memory_Pool::protect(__this, len, prot) }
}
#[export_name = "_ZN20ACE_MMAP_Memory_Pool7protectEi"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_MMAP_Memory_Pool7protectEi(
    __this: *mut ACE_MMAP_Memory_Pool,
    prot: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_MMAP_Memory_Pool::protect_u540e04f76dbb68be(__this, prot) }
}
#[export_name = "_ZN20ACE_MMAP_Memory_Pool7protectEPvmi"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_MMAP_Memory_Pool7protectEPvmi(
    __this: *mut ACE_MMAP_Memory_Pool,
    addr: *mut libc::c_void,
    len: libc::c_ulong,
    prot: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_MMAP_Memory_Pool::protect_u1b7d5a46d0b852fe(__this, addr, len, prot) }
}
#[export_name = "_ZN20ACE_MMAP_Memory_Pool5remapEPv"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_MMAP_Memory_Pool5remapEPv(
    __this: *mut ACE_MMAP_Memory_Pool,
    addr: *mut libc::c_void,
) -> libc::c_int {
    unsafe { ACE_MMAP_Memory_Pool::remap(__this, addr) }
}
#[export_name = "_ZNK20ACE_MMAP_Memory_Pool9base_addrEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK20ACE_MMAP_Memory_Pool9base_addrEv(
    __this: *const ACE_MMAP_Memory_Pool,
) -> *mut libc::c_void {
    unsafe { ACE_MMAP_Memory_Pool::base_addr(__this) }
}
#[export_name = "_ZNK20ACE_MMAP_Memory_Pool4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK20ACE_MMAP_Memory_Pool4dumpEv(
    __this: *const ACE_MMAP_Memory_Pool,
) {
    unsafe { ACE_MMAP_Memory_Pool::dump(__this) }
}
#[export_name = "_ZN20ACE_MMAP_Memory_Pool8round_upEm"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_MMAP_Memory_Pool8round_upEm(
    __this: *mut ACE_MMAP_Memory_Pool,
    nbytes: libc::c_ulong,
) -> libc::c_ulong {
    unsafe { ACE_MMAP_Memory_Pool::round_up(__this, nbytes) }
}
#[export_name = "_ZN20ACE_MMAP_Memory_Pool25commit_backing_store_nameEmRm"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_MMAP_Memory_Pool25commit_backing_store_nameEmRm(
    __this: *mut ACE_MMAP_Memory_Pool,
    rounded_bytes: libc::c_ulong,
    map_size: *mut libc::c_ulong,
) -> libc::c_int {
    unsafe {
        ACE_MMAP_Memory_Pool::commit_backing_store_name(__this, rounded_bytes, map_size)
    }
}
#[export_name = "_ZN20ACE_MMAP_Memory_Pool8map_fileEm"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_MMAP_Memory_Pool8map_fileEm(
    __this: *mut ACE_MMAP_Memory_Pool,
    map_size: libc::c_ulong,
) -> libc::c_int {
    unsafe { ACE_MMAP_Memory_Pool::map_file(__this, map_size) }
}
#[export_name = "_ZN20ACE_MMAP_Memory_Pool13handle_signalEiP9siginfo_tP10ucontext_t"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_MMAP_Memory_Pool13handle_signalEiP9siginfo_tP10ucontext_t(
    __this: *mut ACE_MMAP_Memory_Pool,
    signum: libc::c_int,
    siginfo: *mut siginfo_t,
    _anon_2: *mut ucontext_t,
) -> libc::c_int {
    unsafe { ACE_MMAP_Memory_Pool::handle_signal(__this, signum, siginfo, _anon_2) }
}
...
#[export_name = "_ZN25ACE_Lite_MMAP_Memory_PoolC1EPKcPK28ACE_MMAP_Memory_Pool_Options"]
pub unsafe extern "C-unwind" fn __xtu__ZN25ACE_Lite_MMAP_Memory_PoolC1EPKcPK28ACE_MMAP_Memory_Pool_Options(
    __this: *mut ACE_Lite_MMAP_Memory_Pool,
    __a0: *const libc::c_char,
    __a1: *const ACE_MMAP_Memory_Pool_Options,
) {
    ACE_Lite_MMAP_Memory_Pool::new_at(__this, __a0, __a1)
}
impl Drop for ACE_Lite_MMAP_Memory_Pool {
    fn drop(&mut self) {
        {
            unsafe {
                let __this: *mut Self = self as *mut Self;
...
#[export_name = "_ZN25ACE_Lite_MMAP_Memory_Pool4syncEmi"]
pub unsafe extern "C-unwind" fn __xtu__ZN25ACE_Lite_MMAP_Memory_Pool4syncEmi(
    __this: *mut ACE_Lite_MMAP_Memory_Pool,
    _anon_0: libc::c_ulong,
    _anon_1: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_Lite_MMAP_Memory_Pool::sync(__this, _anon_0, _anon_1) }
}
#[export_name = "_ZN25ACE_Lite_MMAP_Memory_Pool4syncEi"]
pub unsafe extern "C-unwind" fn __xtu__ZN25ACE_Lite_MMAP_Memory_Pool4syncEi(
    __this: *mut ACE_Lite_MMAP_Memory_Pool,
    _anon_0: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_Lite_MMAP_Memory_Pool::sync_u5c8be02cdb2a7232(__this, _anon_0) }
}
#[export_name = "_ZN25ACE_Lite_MMAP_Memory_Pool4syncEPvmi"]
pub unsafe extern "C-unwind" fn __xtu__ZN25ACE_Lite_MMAP_Memory_Pool4syncEPvmi(
    __this: *mut ACE_Lite_MMAP_Memory_Pool,
    _anon_0: *mut libc::c_void,
    _anon_1: libc::c_ulong,
    _anon_2: libc::c_int,
...
impl ACE_MMAP_Memory_Pool {
    ...
    pub unsafe fn new_at(
        ...
        unsafe {
            ...
            *(__this as *mut *const ()) = &__VTBL_uba5fe4b11c1b37b5
                as *const __Vtbl_uba5fe4b11c1b37b5 as *const ();
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).base_addr_),
                ((0) as *mut libc::c_void),
            );
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).use_fixed_addr_), 0);
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).flags_), 1);
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).write_each_page_),
                false,
            );
            ::core::ptr::write(
            ...
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).sa_), 0);
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).file_mode_),
                ((420) as libc::c_uint),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).install_signal_handler_),
                true,
            );
            ...
            {
                (*__this).guess_on_fault_ = false;
                if (!(options).is_null()) {
                    if ((((((*options).flags_ as libc::c_uint))
                        != (((0) as libc::c_uint))) as libc::c_int as libc::c_int) != 0)
                    {
                        (*__this).flags_ = (((*options).flags_) as libc::c_int);
                    }
                    (*__this).use_fixed_addr_ = (((*options).use_fixed_addr_)
                        as libc::c_int);
                    if ((((((*__this).use_fixed_addr_ as libc::c_int))
                        == ((((1 as libc::c_int)) as libc::c_int))) as libc::c_int
                        as libc::c_int) != 0)
                    {
                        (*__this).base_addr_ = ((*options).base_addr_
                            as *mut libc::c_void);
                        ({
                            let __lv = ::core::ptr::addr_of_mut!((* __this).flags_);
                            unsafe {
                                *__lv = ((((*__lv)) as libc::c_int))
                                    | (((16)) as libc::c_int);
                                *__lv
                            }
                        });
                    }
                    (*__this).write_each_page_ = (((*options).write_each_page_) as bool);
                    (*__this).minimum_bytes_ = (((*options).minimum_bytes_)
                        as libc::c_ulong);
                    if ((((((*options).sa_ as libc::c_int)) != (((0) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        (*__this).sa_ = (((*options).sa_) as libc::c_int);
                    }
                    (*__this).file_mode_ = (((*options).file_mode_) as libc::c_uint);
                    (*__this).install_signal_handler_ = (((*options)
                        .install_signal_handler_) as bool);
                }
                if (((((backing_store_name).is_null()) as libc::c_int) as libc::c_int)
                    != 0)
                {
                    if (((((ACE::get_temp_dir(
                        (((*__this).backing_store_name_).as_mut_ptr()
                            as *mut libc::c_char),
                        ...
                        as libc::c_int as libc::c_int) != 0)
                    {
                                ...
                                {
                                    {
                                        ...
                                        <ACE_Log_Category_TSS>::conditional_set(
                                            ...
                                            ((b"/build/ace_full/src/ACE/ace/MMAP_Memory_Pool.cpp\0"
                        ...
                        (*((((*__this).backing_store_name_).as_ptr()
                            as *mut libc::c_char)
                    ...
                    if (((((!(options).is_null())
                        && (((*options).unique_ as libc::c_int) != 0)) as libc::c_int)
                        as libc::c_int) != 0)
                    {
                        ACE_OS::mktemp_ufd8deab57221e9e3(
                            (((*__this).backing_store_name_).as_mut_ptr()
                                as *mut libc::c_char),
                        );
                    }
                ...
                if (((*__this).install_signal_handler_ as libc::c_int) != 0) {
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                if (((((nbytes as libc::c_ulong))
                    < (((((*__this).minimum_bytes_ as libc::c_ulong)) as libc::c_ulong)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    nbytes = ((*__this).minimum_bytes_ as libc::c_ulong);
                }
                if (((((<ACE_Mem_Map>::open(
                    (::core::ptr::addr_of_mut!(
                    ...
                    (((*__this).backing_store_name_).as_ptr() as *const libc::c_char),
                    ...
                    as libc::c_int as libc::c_int) != 0)
                {
                    ...
                    let mut result: *mut libc::c_void = {
                        let __obj: *mut ACE_MMAP_Memory_Pool = (__this)
                            as *mut ACE_MMAP_Memory_Pool;
                        let __vt: *const __Vtbl_uba5fe4b11c1b37b5 = *(__obj
                            as *const *const __Vtbl_uba5fe4b11c1b37b5);
                        ((*__vt)
                            .vfn_u9e3b67a324526ce5)(
                            __obj,
                            nbytes,
                    ...
                    {
                        ((*(__errno_location()))) = 0;
                        if (((((<ACE_Mem_Map>::map_uf8d94af3fe7dec57(
                            (::core::ptr::addr_of_mut!(
                                    ...
                                    {
                                        {
                                            ...
                                            <ACE_Log_Category_TSS>::log(
                                                ...
                                                ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                                    as *const libc::c_char),
                                                b"MMAP_Memory_Pool::init_acquire, EEXIST\0".as_ptr()
                                                    as *const libc::c_char,
                                            );
                                            return ((0) as *mut libc::c_void);
                                        }
                        ...
                        <ACE_Based_Pointer_Repository>::bind(
                                ...
                                {
                                    {
                                        ...
                                        <ACE_Log_Category_TSS>::log(
                                            ...
                                            ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                                as *const libc::c_char),
                                            b"MMAP_Memory_Pool::init_acquire\0".as_ptr()
                                                as *const libc::c_char,
                                        );
                                        return ((0) as *mut libc::c_void);
                                    }
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                (*rounded_bytes) = {
                    ...
                    let __vt: *const __Vtbl_uba5fe4b11c1b37b5 = *(__obj
                        as *const *const __Vtbl_uba5fe4b11c1b37b5);
                    ((*__vt).vfn_u4d0589be66e92dfe)(__obj, nbytes)
                };
                let mut map_size: libc::c_ulong = unsafe { ::core::mem::zeroed() };
                if ((((({
                    let __obj: *mut ACE_MMAP_Memory_Pool = (__this)
                        as *mut ACE_MMAP_Memory_Pool;
                    let __vt: *const __Vtbl_uba5fe4b11c1b37b5 = *(__obj
                    ...
                    as libc::c_int as libc::c_int) != 0)
                {
                    ...
                    if ((((({
                        ...
                        let __vt: *const __Vtbl_uba5fe4b11c1b37b5 = *(__obj
                            as *const *const __Vtbl_uba5fe4b11c1b37b5);
                        ((*__vt).vfn_u40093adb9e70cb2d)(__obj, map_size)
                    } as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        return ((0) as *mut libc::c_void);
                ...
                return ((((<ACE_Mem_Map>::addr(
                    ...
                    .wrapping_offset(
                        (((((<ACE_Mem_Map>::size(
                            ...
                            .wrapping_sub(((*rounded_bytes)) as libc::c_ulong))) as isize,
                    )) as *mut libc::c_void);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    ...
    pub unsafe fn release(__this: *mut Self, mut destroy: libc::c_int) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                <ACE_Based_Pointer_Repository>::unbind(
                    (<ACE_Singleton_ACE_Based_Pointer_Repository__ACE_MT_SYNCH__RW_MUTEX_>::instance())
                        as *mut ACE_Based_Pointer_Repository,
                    <ACE_Mem_Map>::addr(
                        (::core::ptr::addr_of!(
  ...
  /// allows.*/
    pub unsafe fn sync_ua77e6bd2e6007bc6(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut len: libc::c_ulong = ((ACE_Utils::truncate_cast___long__ub591475ebc843689(
                    ((ACE_OS::lseek_u7c6593c8f5712dbe(
                        <ACE_Mem_Map>::handle(
                            (::core::ptr::addr_of!(
                                (* ::core::ptr::addr_of!((* __this).mmap_) .cast:: <
                                ACE_Mem_Map > ().cast_mut())
  ...
  /// starting at @a addr up to @a len bytes.*/
    ...
    pub unsafe fn remap(__this: *mut Self, mut addr: *mut libc::c_void) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut current_map_size: libc::c_ulong = ((ACE_Utils::truncate_cast___long__ub591475ebc843689(
                    ((ACE_OS::filesize_uc42c876f8a2ca43a(
                        <ACE_Mem_Map>::handle(
                            (::core::ptr::addr_of!(
                                (* ::core::ptr::addr_of!((* __this).mmap_) .cast:: <
                                ACE_Mem_Map > ().cast_mut())
                ...
                if (((!((((((((((((addr) as *const u8))
                    < (((((((<ACE_Mem_Map>::addr(
                        ...
                        .wrapping_offset((current_map_size) as isize))
                ...
                return {
                    ...
                    let __vt: *const __Vtbl_uba5fe4b11c1b37b5 = *(__obj
                        as *const *const __Vtbl_uba5fe4b11c1b37b5);
                    ((*__vt)
                        .vfn_u40093adb9e70cb2d)(
                        __obj,
                        ((current_map_size) as libc::c_ulong),
                    )
                };
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
  ...
  /// memory.*/
    pub unsafe fn commit_backing_store_name(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut seek_len: libc::c_ulong = unsafe { ::core::mem::zeroed() };
                if (((*__this).write_each_page_ as libc::c_int) != 0) {
                    seek_len = {
                        let __obj: *mut ACE_MMAP_Memory_Pool = (__this)
                            as *mut ACE_MMAP_Memory_Pool;
                        let __vt: *const __Vtbl_uba5fe4b11c1b37b5 = *(__obj
                            as *const *const __Vtbl_uba5fe4b11c1b37b5);
                        ((*__vt).vfn_u4d0589be66e92dfe)(__obj, ((1) as libc::c_ulong))
                    };
                } else {
                    seek_len = rounded_bytes;
                }
                {
                    let mut cur_block: libc::c_ulong = ((0) as libc::c_ulong);
                    'for_0: loop {
                        if !((((((cur_block as libc::c_ulong))
                            < (((rounded_bytes) as libc::c_ulong))) as libc::c_int
                            as libc::c_int) != 0))
                        {
                            break;
                        }
                        'cont_0: loop {
                            {
                                {
                                    (*map_size) = ((ACE_Utils::truncate_cast___long__ub591475ebc843689(
                                        ((ACE_OS::lseek_u7c6593c8f5712dbe(
                                            <ACE_Mem_Map>::handle(
                                                (::core::ptr::addr_of!(
                                                    (* ::core::ptr::addr_of!((* __this).mmap_) .cast:: <
                                            ...
                                            ((((seek_len) as libc::c_ulong))
                                                .wrapping_sub((1) as libc::c_ulong) as libc::c_long),
                                            2,
                                        )) as libc::c_long),
                                    )) as libc::c_ulong);
                                    if ((((((((((*map_size) as libc::c_ulong))
                                        == (((((-((1) as libc::c_int)) as libc::c_ulong))
                        ...
                        {
                            cur_block = (((cur_block) as libc::c_ulong))
                                .wrapping_add((seek_len) as libc::c_ulong);
                            cur_block
                        };
                    }
                }
                {
                    let __lv = &mut ((*map_size));
                    *__lv = (*__lv).wrapping_add(1);
                    *__lv
                };
                return 0;
    ...
    pub unsafe fn map_file(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut obase_addr: *mut libc::c_void = (*__this).base_addr_;
                <ACE_Mem_Map>::unmap(
                    (::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).mmap_) .cast:: < ACE_Mem_Map
                        > ().cast_mut())
                ...
                if ((((((*__this).use_fixed_addr_ as libc::c_int))
                    ...
                    as libc::c_int) != 0)
                {
                    (*__this).base_addr_ = ((0) as *mut libc::c_void);
                }
                if (((((((((<ACE_Mem_Map>::map_ud24c6c3b9d9e1386(
                    (::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).mmap_) .cast:: < ACE_Mem_Map
                        > ().cast_mut())
                    )) as *mut ACE_Mem_Map,
                    ...
                    || (((((((((!((*__this).base_addr_).is_null()) as libc::c_int)
                        ...
                        )) as *const u8)) != ((((*__this).base_addr_) as *const u8)))
                            as libc::c_int as libc::c_int) != 0)) as libc::c_int))
                        as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
                {
                    return (-((1) as libc::c_int));
                } else {
                    (*__this).base_addr_ = <ACE_Mem_Map>::addr(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* __this).mmap_) .cast:: <
                            ACE_Mem_Map > ().cast_mut())
                        )) as *const ACE_Mem_Map,
                    );
                    if (((((!(obase_addr).is_null())
                        && (((((((*__this).base_addr_) as *const u8))
                            != (((obase_addr) as *const u8))) as libc::c_int
                            as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
                    {
                        <ACE_Based_Pointer_Repository>::unbind(
                            (<ACE_Singleton_ACE_Based_Pointer_Repository__ACE_MT_SYNCH__RW_MUTEX_>::instance())
    ...
    pub unsafe fn handle_signal(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((((signum as libc::c_int)) != (((11) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    return (-((1) as libc::c_int));
                }
                if ((((!(siginfo).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    if ((((({
                        ...
                        let __vt: *const __Vtbl_uba5fe4b11c1b37b5 = *(__obj
                            as *const *const __Vtbl_uba5fe4b11c1b37b5);
                        ((*__vt)
                            .vfn_uaaac20440c36bfb9)(
                            __obj,
                            ((*siginfo)._sifields._sigfault.si_addr as *mut libc::c_void),
                        )
                    } as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                ...
                if (((*__this).guess_on_fault_ as libc::c_int) != 0) {
                    let mut current_map_size: libc::c_ulong = ((ACE_Utils::truncate_cast___long__ub591475ebc843689(
                        ((ACE_OS::filesize_uc42c876f8a2ca43a(
                            <ACE_Mem_Map>::handle(
                                (::core::ptr::addr_of!(
                    ...
                    if ((((((current_map_size as libc::c_ulong) as libc::c_ulong))
                        == (((<ACE_Mem_Map>::size(
                            (::core::ptr::addr_of!(
                                (* ::core::ptr::addr_of!((* __this).mmap_) .cast:: <
                                ACE_Mem_Map > ().cast_mut())
...
impl ACE_Lite_MMAP_Memory_Pool {
    ...
    pub unsafe fn new_at(
        ...
        unsafe {
            ...
            *(__this as *mut *const ()) = &__VTBL_uea71ce087f45c45a
                as *const __Vtbl_uea71ce087f45c45a as *const ();
            {}
            ()
        }
    }
