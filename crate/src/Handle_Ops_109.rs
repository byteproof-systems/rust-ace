...
pub mod ACE {
    #[doc = "* Wait up to @a timeout amount of time to actively open a device.\n   * This method doesn't perform the @c connect, it just does the\n   * timed wait."]
    #[export_name = "_ZN3ACE17handle_timed_openEP14ACE_Time_ValuePKciii"]
    pub unsafe extern "C-unwind" fn handle_timed_open(
        ...
        unsafe {
            {
                if ((((!(timeout).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    {
                        flags = (((flags) as libc::c_int)) | ((2048) as libc::c_int);
                        flags
                    };
                    ...
                    return ((handle) as libc::c_int);
                } else {
                    return super::ACE_OS::open_u20e73ad42bc94ee0(
                        ((name) as *const libc::c_char),
                        flags,
                        (perms as libc::c_uint),
                        sa,
