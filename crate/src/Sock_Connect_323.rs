...
pub mod ACE {
    ...
    #[export_name = "_ZN3ACE9bind_portEiji"]
    pub unsafe extern "C-unwind" fn bind_port(
        ...
        unsafe {
            {
                let mut addr: super::ACE_INET_Addr = ::core::mem::MaybeUninit::<
                    super::ACE_INET_Addr,
                >::zeroed()
                    .assume_init();
                <super::ACE_INET_Addr>::new_at(
                    (::core::ptr::addr_of_mut!(addr)) as *mut super::ACE_INET_Addr,
                );
                {
                    let _ = (address_family);
                };
                <super::ACE_INET_Addr>::operator_assign(
                    (::core::ptr::addr_of_mut!(addr)) as *mut super::ACE_INET_Addr,
                    &(<super::ACE_INET_Addr>::new_uccf807117aa945b3(
                        (0 as libc::c_ushort),
                        ip_addr,
                    )) as *const super::ACE_INET_Addr,
                );
                return super::ACE_OS::bind_uef4d981726093bc5(
                    handle,
                    (((<super::ACE_INET_Addr>::get_addr(
                        (::core::ptr::addr_of!(addr)) as *const super::ACE_INET_Addr,
                    ) as *mut super::sockaddr)) as *mut super::sockaddr),
                    <super::ACE_Addr>::get_size(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* (::core::ptr::addr_of!(addr)))
                            .__base_0) .cast:: < super::ACE_Addr > ().cast_mut())
                        )) as *const super::ACE_Addr,
                    ),
                );
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        ...
        unsafe {
            {
                            ...
                            {
                                {
                                    ...
                                    <super::ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/Sock_Connect.cpp\0".as_ptr()
                                    ...
                                    <super::ACE_Log_Category_TSS>::log(
                                        ...
                                        b"ACE_OS::socket\0".as_ptr() as *const libc::c_char,
                                    );
                                    return (-((1) as libc::c_int));
                                }
                            }
                ...
                let mut ifc: super::ifconf = unsafe {
                    ::core::mem::MaybeUninit::<super::ifconf>::zeroed().assume_init()
                };
                ...
                if (((((super::ACE_OS::ioctl_u5ac77b5f0779af02(
                    s,
                    ((35090) as libc::c_ulong),
                    (((::core::ptr::addr_of_mut!(ifc) as *mut super::ifconf
                            ...
                            {
                                {
                                    ...
                                    <super::ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        b"ACE::get_bcast_addr:ioctl (get interface configuration)\0"
                ...
                let mut ifr: *mut super::ifreq = ifc.ifc_ifcu.ifcu_req;
                let mut ip_addr: super::sockaddr_in = unsafe {
                    ::core::mem::MaybeUninit::<super::sockaddr_in>::zeroed()
                        .assume_init()
                };
                if (!(host_name).is_null()) {
                    let mut hp: *mut super::hostent = ((super::ACE_OS::gethostbyname_ubf26fe0a4f84901c(
                        ((host_name) as *const libc::c_char),
                    )) as *mut super::hostent);
                    if (((((hp).is_null()) as libc::c_int) as libc::c_int) != 0) {
                        return (-((1) as libc::c_int));
                    } else {
                        super::ACE_OS::memcpy_u6033eb81edaf9212(
                            (((::core::ptr::addr_of_mut!(ip_addr.sin_addr.s_addr)
                    ...
                    super::ACE_OS::memset_u2b5dfc47d301370a(
                        (::core::ptr::addr_of_mut!(ip_addr) as *mut super::sockaddr_in
                            as *mut libc::c_void),
                        0,
                        ((::core::mem::size_of::<super::sockaddr_in>() as libc::c_ulong)
                            as libc::c_ulong),
                    );
                    super::ACE_OS::memcpy_u6033eb81edaf9212(
                        (::core::ptr::addr_of_mut!(ip_addr.sin_addr)
                            as *mut super::in_addr as *mut libc::c_void),
                        (((::core::ptr::addr_of_mut!(host_addr) as *mut libc::c_uint
                            as *mut libc::c_void)) as *const libc::c_void),
                        ((::core::mem::size_of::<super::in_addr>() as libc::c_ulong)
                            as libc::c_ulong),
                    );
                }
                {
                    ...
                    'for_2: loop {
                        ...
                        'cont_2: loop {
                            {
                                {
                                    let mut if_addr: super::sockaddr_in = unsafe {
                                        ::core::mem::MaybeUninit::<super::sockaddr_in>::zeroed()
                                            .assume_init()
                                    };
                                    super::ACE_OS::memcpy_u6033eb81edaf9212(
                                        ((::core::ptr::addr_of_mut!(if_addr)
                                            as *mut super::sockaddr_in) as *mut libc::c_void),
                                        ((::core::ptr::addr_of_mut!((* ifr).ifr_ifru.ifru_addr)
                                            as *mut super::sockaddr) as *const libc::c_void),
                                        ((::core::mem::size_of::<super::sockaddr_in>()
                                            as libc::c_ulong) as libc::c_ulong),
                                    );
                                    if (((((ip_addr.sin_addr.s_addr as libc::c_uint))
                                                ...
                                                {
                                                    {
                                                        ...
                                                        <super::ACE_Log_Category_TSS>::log(
                                                            ...
                                                            ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                                                as *const libc::c_char),
                                                            b"ACE::get_bcast_addr:Not AF_INET\0".as_ptr()
                                                                as *const libc::c_char,
                                                        );
                                                    }
                                                }
                                    ...
                                    let mut flags: super::ifreq = (*(ifr));
                                    let mut if_req: super::ifreq = (*(ifr));
                                    if (((((super::ACE_OS::ioctl_u5ac77b5f0779af02(
                                        s,
                                        ((35091) as libc::c_ulong),
                                        (((::core::ptr::addr_of_mut!(flags) as *mut super::ifreq
                                            as *mut libc::c_char)) as *mut libc::c_void),
                                    ) as libc::c_int))
                                                ...
                                                {
                                                    {
                                                        ...
                                                        <super::ACE_Log_Category_TSS>::log(
                                                            ...
                                                            ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                                                as *const libc::c_char),
                                                            b"ACE::get_bcast_addr: ioctl (get interface flags)\0"
                                                                .as_ptr() as *const libc::c_char,
                                                        );
                                                    }
                                                }
                                                ...
                                                {
                                                    {
                                                        ...
                                                        <super::ACE_Log_Category_TSS>::log(
                                                            ...
                                                            ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                                                as *const libc::c_char),
                                                            b"ACE::get_bcast_addr:Network interface is not up\0"
                                                                .as_ptr() as *const libc::c_char,
                                                        );
                                                    }
                                                }
                                        ...
                                        != 0)
                                    {
                                        if (((((super::ACE_OS::ioctl_u5ac77b5f0779af02(
                                            ...
                                            (((::core::ptr::addr_of_mut!(if_req) as *mut super::ifreq
                                                as *mut libc::c_char)) as *mut libc::c_void),
                                        ) as libc::c_int))
                                            == ((((-((1) as libc::c_int))) as libc::c_int)))
                                            as libc::c_int as libc::c_int) != 0)
                                        {
                                                    ...
                                                    {
                                                        {
                                                            ...
                                                            <super::ACE_Log_Category_TSS>::log(
                                                                ...
                                                                ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                                                    as *const libc::c_char),
                                                                b"ACE::get_bcast_addr:ioctl (get broadaddr)\0".as_ptr()
                                                                    as *const libc::c_char,
                                                            );
                                                        }
                                                    }
                                            ...
                                            super::ACE_OS::memcpy_u6033eb81edaf9212(
                                                ((::core::ptr::addr_of_mut!(ip_addr)
                                                    as *mut super::sockaddr_in) as *mut libc::c_void),
                                                ((::core::ptr::addr_of_mut!(if_req.ifr_ifru.ifru_broadaddr)
                                                    as *mut super::sockaddr) as *const libc::c_void),
                                                ((::core::mem::size_of::<super::sockaddr>()
                                                    as libc::c_ulong) as libc::c_ulong),
                                            );
                                            super::ACE_OS::memcpy_u6033eb81edaf9212(
                                                (::core::ptr::addr_of_mut!(host_addr) as *mut libc::c_uint
                                            ...
                                            if (((((handle as libc::c_int))
                                                ...
                                                as libc::c_int as libc::c_int) != 0)
                                            {
                                                super::ACE_OS::close_u07c1eb6343f8c667(s);
                                            }
                                                ...
                                                {
                                                    {
                                                        ...
                                                        <super::ACE_Log_Category_TSS>::log(
                                                            ...
                                                            ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                                                as *const libc::c_char),
                                                            b"ACE::get_bcast_addr:Broadcast is not enabled for this interface.\0"
                                                                .as_ptr() as *const libc::c_char,
                                                        );
                                                    }
                                                }
    ...
    #[export_name = "_ZN3ACE8get_fqdnERK13ACE_INET_AddrPcm"]
    pub unsafe extern "C-unwind" fn get_fqdn(
        mut addr: *const super::ACE_INET_Addr,
        ...
        unsafe {
            {
                ...
                if (((((super::ACE_OS::getnameinfo_uba86e201ee9aef5f(
                    ({
                        let __obj: *mut super::ACE_Addr = (::core::ptr::addr_of!(
                            (* addr)
                        )) as *mut super::ACE_Addr;
                        let __vt: *const super::__Vtbl_u8861458fe5cac90c = *(__obj
                            as *const *const super::__Vtbl_u8861458fe5cac90c);
                        ((*__vt).vfn_ueade8b323a2ffe30)(__obj)
                    } as *const super::sockaddr),
                            ...
                            {
                                {
                                    ...
                                    <super::ACE_Log_Category_TSS>::log(
                                        (ace___) as *mut super::ACE_Log_Category_TSS,
                                        super::LM_DEBUG,
                                        ((b"(%P|%t) - ACE::get_fqdn, canonical host name is %C\n\0"
    ...
    #[doc = "* Return count and array of all configured IP interfaces on this\n   * host, rc = 0 on success (count == number of interfaces else -1).\n   * Caller is responsible for calling delete [] on @a addr_array."]
    #[export_name = "_ZN3ACE17get_ip_interfacesERmRP13ACE_INET_Addr"]
    pub unsafe extern "C-unwind" fn get_ip_interfaces(
        mut count: *mut libc::c_ulong,
        mut addrs: *mut *mut super::ACE_INET_Addr,
    ) -> libc::c_int {
        unsafe {
            {
                (*count) = ((0) as libc::c_ulong);
                (*addrs) = ((0) as *mut super::ACE_INET_Addr);
                return super::get_ip_interfaces_getifaddrs(
                    ::core::ptr::addr_of_mut!((* count)),
                    ::core::ptr::addr_of_mut!((* addrs)),
                );
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    #[doc = "* Helper routine for get_ip_interfaces, differs by UNIX platform so\n   * put into own subroutine.  perform some ioctls to retrieve ifconf\n   * list of ifreq structs."]
    #[export_name = "_ZN3ACE16count_interfacesEiRm"]
    pub unsafe extern "C-unwind" fn count_interfaces(
        mut handle: libc::c_int,
        mut how_many: *mut libc::c_ulong,
    ) -> libc::c_int {
        unsafe {
            {
                let mut MAX_INTERFACES: libc::c_int = ((50) as libc::c_int);
                let mut num_ifs: libc::c_int = MAX_INTERFACES;
                let mut ifcfg: super::ifconf = unsafe {
                    ::core::mem::MaybeUninit::<super::ifconf>::zeroed().assume_init()
                };
                let mut ifreq_size: libc::c_ulong = (((((num_ifs) as libc::c_ulong))
                    .wrapping_mul((40) as libc::c_ulong)) as libc::c_ulong);
                let mut p_ifs: *mut super::ifreq = unsafe { ::core::mem::zeroed() };
                p_ifs = (super::ACE_OS::malloc_u80646b42522769ca(ifreq_size)
                    as *mut super::ifreq);
                if (((!((!(p_ifs).is_null())) as libc::c_int) as libc::c_int) != 0) {
                    ((*(super::__errno_location()))) = 12;
                    return (-((1) as libc::c_int));
                }
                super::ACE_OS::memset_u2b5dfc47d301370a(
                    ((p_ifs) as *mut libc::c_void),
                    0,
                    ifreq_size,
                );
                super::ACE_OS::memset_u2b5dfc47d301370a(
                    ((::core::ptr::addr_of_mut!(ifcfg) as *mut super::ifconf)
                        as *mut libc::c_void),
                    0,
                    ((16) as libc::c_ulong),
                );
                ifcfg.ifc_ifcu.ifcu_req = p_ifs;
                ifcfg.ifc_len = ((ifreq_size) as libc::c_int);
                if (((((super::ACE_OS::ioctl_u5ac77b5f0779af02(
                    handle,
                    ((35090) as libc::c_ulong),
                    (((::core::ptr::addr_of_mut!(ifcfg) as *mut super::ifconf
                    ...
                    as libc::c_int as libc::c_int) != 0)
                {
                    super::ACE_OS::free_ucbe6910a56eae126(
                        ((ifcfg.ifc_ifcu.ifcu_req) as *mut libc::c_void),
                    );
                    'dowhile_0: loop {
                        'cont_0: loop {
                            {
                                {
                                    ...
                                    <super::ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        b"ACE::count_interfaces:ioctl - SIOCGIFCONF failed\0"
                                            .as_ptr() as *const libc::c_char,
                                    );
                                    return (-((1) as libc::c_int));
                                }
                ...
                let mut if_count: libc::c_int = 0;
                let mut i: libc::c_int = 0;
                {
                    i = 0;
                    'for_1: loop {
                        if !((((((i as libc::c_int)) < (((num_ifs) as libc::c_int)))
                            as libc::c_int as libc::c_int) != 0))
                        {
                            break;
                        }
                        'cont_1: loop {
                            {
                                {
                                    {
                                        let __lv = ::core::ptr::addr_of_mut!(ifcfg.ifc_len);
                                        unsafe {
                                            *__lv = ((((*__lv)) as libc::c_int))
                                                .wrapping_sub((40) as libc::c_int);
                                            *__lv
                                        }
                                    };
                                    if (((((ifcfg.ifc_len as libc::c_int))
                                        < (((0) as libc::c_int))) as libc::c_int as libc::c_int)
                                        != 0)
                                    {
                                        break 'for_1;
                ...
                (*how_many) = ((if_count) as libc::c_ulong);
                return 0;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
  ...
  /// made.  Caller must close the handle.*/
    #[export_name = "_ZN3ACE10get_handleEv"]
    pub unsafe extern "C-unwind" fn get_handle() -> libc::c_int {
        unsafe {
            {
                let mut handle: libc::c_int = (((-((1) as libc::c_int))) as libc::c_int);
                handle = super::ACE_OS::socket_u707bc17eb37e5e24(
                    2,
                    ((super::SOCK_DGRAM) as libc::c_int),
                    0,
                );
                return handle;
            }
...
pub(crate) unsafe extern "C-unwind" fn get_ip_interfaces_getifaddrs(
    mut count: *mut libc::c_ulong,
    mut addrs: *mut *mut ACE_INET_Addr,
) -> libc::c_int {
    unsafe {
        {
            let mut ifap: *mut ifaddrs = ((0) as *mut ifaddrs);
            let mut p_if: *mut ifaddrs = ((0) as *mut ifaddrs);
            if (((((getifaddrs(::core::ptr::addr_of_mut!(ifap) as *mut *mut ifaddrs)
                as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                as libc::c_int) != 0)
            {
                return (-((1) as libc::c_int));
            }
            let mut num_ifs: libc::c_ulong = ((0) as libc::c_ulong);
            {
                p_if = ifap;
                'for_0: loop {
                    if !(((((!(p_if).is_null()) as libc::c_int) as libc::c_int) != 0)) {
                        break;
                    }
                    'cont_0: loop {
                        {
                            {
                                let __lv = &mut (num_ifs);
                                *__lv = (*__lv).wrapping_add(1);
                                *__lv
                            };
                        }
                ...
                'cont_1: loop {
                    {
                        {
                            (*addrs) = {
                                let __count: usize = (num_ifs) as usize;
                                ...
                                *(__base as *mut usize) = __count;
                                let __data = __base.add(__off) as *mut ACE_INET_Addr;
                                let mut __i: usize = 0;
                                while __i < __count {
                                    ::core::ptr::write(__data.add(__i), <ACE_INET_Addr>::new());
                                    __i += 1;
                                }
                                __data
                            };
                            if ((((((*addrs)).is_null()) as libc::c_int) as libc::c_int)
                                != 0)
                            {
                                ((*(__errno_location()))) = 12;
                                return (-((1) as libc::c_int));
                        ...
                        {
                            {
                                ...
                                if ((((((((((*p_if).ifa_flags) as libc::c_uint))
                                    & (((1 as libc::c_int)) as libc::c_uint)) as libc::c_uint))
                                    ...
                                    != 0)
                                {
                                        ...
                                        as libc::c_int as libc::c_int) != 0)
                                    {
                                        <ACE_INET_Addr>::set_u25969953d4ee6f07(
                                            (::core::ptr::addr_of_mut!(
                                                (* ((* addrs)).wrapping_offset(((* count)) as isize))
                                            )) as *mut ACE_INET_Addr,
                                            (0 as libc::c_ushort),
                                            (((*addr).sin_addr.s_addr) as libc::c_uint),
                                            0,
                                            0,
                                        );
                                        {
