...
#[repr(C)]
pub struct ACE_Map_Entry_void____unsigned_long_ {
    pub ext_id_: *mut libc::c_void,
    pub int_id_: libc::c_ulong,
    pub next_: libc::c_uint,
    pub prev_: libc::c_uint,
}
impl Clone for ACE_Map_Entry_void____unsigned_long_ {
    #[inline]
    fn clone(&self) -> Self {
        unsafe { Self::new_sbbce3234b73ce77d(self as *const Self) }
    }
}
#[export_name = "_ZN13ACE_Map_EntryIPvmEC1ERKS1_"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_Map_EntryIPvmEC1ERKS1_(
    __this: *mut ACE_Map_Entry_void____unsigned_long_,
    __a0: *const ACE_Map_Entry_void____unsigned_long_,
) {
    ACE_Map_Entry_void____unsigned_long_::new_at_sbbce3234b73ce77d(__this, __a0)
}
#[export_name = "_ZN13ACE_Map_EntryIPvmEC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_Map_EntryIPvmEC1Ev(
    __this: *mut ACE_Map_Entry_void____unsigned_long_,
) {
    ACE_Map_Entry_void____unsigned_long_::new_at_s869970fd24d3d440(__this)
}
impl Drop for ACE_Map_Entry_void____unsigned_long_ {
    fn drop(&mut self) {
        unsafe {
...
#[export_name = "__acedtor_u869970fd24d3d440"]
pub unsafe extern "C-unwind" fn __acedtor_u869970fd24d3d440(
    __this: *mut ACE_Map_Entry_void____unsigned_long_,
) {
    unsafe {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ACE_Map_Iterator_Base_void____unsigned_long__ACE_Null_Mutex_ {
    pub map_man_: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
    pub next_: libc::c_uint,
}
#[export_name = "_ZN21ACE_Map_Iterator_BaseIPvm14ACE_Null_MutexEC1ER15ACE_Map_ManagerIS0_mS1_E"]
pub unsafe extern "C-unwind" fn __xtu__ZN21ACE_Map_Iterator_BaseIPvm14ACE_Null_MutexEC1ER15ACE_Map_ManagerIS0_mS1_E(
    __this: *mut ACE_Map_Iterator_Base_void____unsigned_long__ACE_Null_Mutex_,
    __a0: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
) {
    ACE_Map_Iterator_Base_void____unsigned_long__ACE_Null_Mutex_::new_at_s2024e43ea93684d3(
        __this,
        __a0,
    )
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ACE_Map_Iterator_void____unsigned_long__ACE_Null_Mutex_ {
    pub __base_0: ACE_Map_Iterator_Base_void____unsigned_long__ACE_Null_Mutex_,
}
#[export_name = "_ZN16ACE_Map_IteratorIPvm14ACE_Null_MutexEC1ER15ACE_Map_ManagerIS0_mS1_Ei"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_Map_IteratorIPvm14ACE_Null_MutexEC1ER15ACE_Map_ManagerIS0_mS1_Ei(
    __this: *mut ACE_Map_Iterator_void____unsigned_long__ACE_Null_Mutex_,
    __a0: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
    __a1: libc::c_int,
) {
    ACE_Map_Iterator_void____unsigned_long__ACE_Null_Mutex_::new_at_s2284d6b38b764f5e(
        __this,
        __a0,
        __a1,
    )
...
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_ {
    pub allocator_: *mut ACE_Allocator,
    pub lock_: ::core::mem::ManuallyDrop<ACE_Null_Mutex>,
    pub search_structure_: *mut ACE_Map_Entry_void____unsigned_long_,
    pub total_size_: libc::c_uint,
    pub cur_size_: libc::c_uint,
    pub free_list_: ::core::mem::ManuallyDrop<ACE_Map_Entry_void____unsigned_long_>,
    pub occupied_list_: ::core::mem::ManuallyDrop<ACE_Map_Entry_void____unsigned_long_>,
}
#[export_name = "_ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE21find_and_return_indexERKS0_Rj"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE21find_and_return_indexERKS0_Rj(
    __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
    ext_id: *const *mut libc::c_void,
    slot: *mut libc::c_uint,
) -> libc::c_int {
    unsafe {
        ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_::find_and_return_index(
            __this,
            ext_id,
            slot,
        )
...
#[export_name = "_ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE21free_search_structureEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE21free_search_structureEv(
    __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
) {
    unsafe {
        ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_::free_search_structure(
            __this,
        )
    }
}
#[export_name = "_ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE8resize_iEj"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE8resize_iEj(
    __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
    new_size: libc::c_uint,
) -> libc::c_int {
    unsafe {
        ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_::resize_i(
            __this,
            new_size,
        )
    }
}
#[export_name = "_ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE8new_sizeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE8new_sizeEv(
    __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
) -> libc::c_uint {
    unsafe { ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_::new_size(__this) }
}
#[export_name = "_ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE9next_freeERj"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE9next_freeERj(
    __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
    free_slot: *mut libc::c_uint,
) -> libc::c_int {
    unsafe {
        ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_::next_free(
            __this,
            free_slot,
        )
    }
}
#[export_name = "_ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE11shared_moveEjR13ACE_Map_EntryIS0_mEjS5_j"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE11shared_moveEjR13ACE_Map_EntryIS0_mEjS5_j(
    __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
    slot: libc::c_uint,
    current_list: *mut ACE_Map_Entry_void____unsigned_long_,
    current_list_id: libc::c_uint,
    new_list: *mut ACE_Map_Entry_void____unsigned_long_,
    new_list_id: libc::c_uint,
) {
    unsafe {
        ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_::shared_move(
            __this,
            slot,
            current_list,
            current_list_id,
...
#[export_name = "_ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE11shared_bindERKS0_RKm"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE11shared_bindERKS0_RKm(
    __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
    ext_id: *const *mut libc::c_void,
    int_id: *const libc::c_ulong,
) -> libc::c_int {
    unsafe {
        ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_::shared_bind(
            __this,
            ext_id,
            int_id,
        )
...
#[export_name = "_ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE8rebind_iERKS0_RKm"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE8rebind_iERKS0_RKm(
    __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
    ext_id: *const *mut libc::c_void,
    int_id: *const libc::c_ulong,
) -> libc::c_int {
    unsafe {
        ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_::rebind_i_s493f800a5d933d6a(
            __this,
            ext_id,
            int_id,
        )
...
#[export_name = "_ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE11unbind_slotEj"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE11unbind_slotEj(
    __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
    slot: libc::c_uint,
) {
    unsafe {
        ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_::unbind_slot(__this, slot)
    }
}
#[export_name = "_ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE23unbind_and_return_indexERKS0_Rj"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE23unbind_and_return_indexERKS0_Rj(
    __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
    ext_id: *const *mut libc::c_void,
    slot: *mut libc::c_uint,
) -> libc::c_int {
    unsafe {
        ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_::unbind_and_return_index(
            __this,
            ext_id,
            slot,
        )
...
#[export_name = "_ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE7close_iEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE7close_iEv(
    __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
) -> libc::c_int {
    unsafe { ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_::close_i(__this) }
}
#[export_name = "_ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE4openEmP13ACE_Allocator"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE4openEmP13ACE_Allocator(
    __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
    size: libc::c_ulong,
    alloc: *mut ACE_Allocator,
) -> libc::c_int {
    unsafe {
        ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_::open(__this, size, alloc)
    }
}
impl Drop for ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_ {
    fn drop(&mut self) {
        {
            unsafe {
                let __this: *mut Self = self as *mut Self;
                {
                    <ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_>::close(
                        (__this)
                            as *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                    );
                }
                ()
            }
        ...
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.occupied_list_);
            ::core::mem::ManuallyDrop::drop(&mut self.free_list_);
            ::core::mem::ManuallyDrop::drop(&mut self.lock_);
        }
    }
}
#[export_name = "__acedtor_u43552a08b145f3da"]
pub unsafe extern "C-unwind" fn __acedtor_u43552a08b145f3da(
    __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[export_name = "_ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexEC1EP13ACE_Allocator"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexEC1EP13ACE_Allocator(
    __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
    __a0: *mut ACE_Allocator,
) {
    ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_::new_at_sfe68a6419bd96344(
        __this,
        __a0,
    )
}
...
#[export_name = "_ZN9ACE_GuardI19ACE_RW_Thread_MutexEC1ERS0_"]
...
#[allow(non_upper_case_globals)]
#[no_mangle]
pub static mut ACE_Singleton_ACE_Based_Pointer_Repository__ACE_MT_SYNCH__RW_MUTEX__singleton_: *mut ACE_Singleton_ACE_Based_Pointer_Repository__ACE_MT_SYNCH__RW_MUTEX_ = ((0)
...
#[export_name = "_ZN13ACE_SingletonI28ACE_Based_Pointer_Repository19ACE_RW_Thread_MutexE10instance_iEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_SingletonI28ACE_Based_Pointer_Repository19ACE_RW_Thread_MutexE10instance_iEv() -> *mut *mut ACE_Singleton_ACE_Based_Pointer_Repository__ACE_MT_SYNCH__RW_MUTEX_ {
    unsafe {
        ACE_Singleton_ACE_Based_Pointer_Repository__ACE_MT_SYNCH__RW_MUTEX_::instance_i()
    }
}
#[export_name = "_ZN13ACE_SingletonI28ACE_Based_Pointer_Repository19ACE_RW_Thread_MutexE7cleanupEPv"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_SingletonI28ACE_Based_Pointer_Repository19ACE_RW_Thread_MutexE7cleanupEPv(
    __this: *mut ACE_Singleton_ACE_Based_Pointer_Repository__ACE_MT_SYNCH__RW_MUTEX_,
    param: *mut libc::c_void,
) {
    unsafe {
        ACE_Singleton_ACE_Based_Pointer_Repository__ACE_MT_SYNCH__RW_MUTEX_::cleanup(
            __this,
            param,
        )
    }
}
#[export_name = "_ZN13ACE_SingletonI28ACE_Based_Pointer_Repository19ACE_RW_Thread_MutexE5closeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_SingletonI28ACE_Based_Pointer_Repository19ACE_RW_Thread_MutexE5closeEv() {
    unsafe {
        ACE_Singleton_ACE_Based_Pointer_Repository__ACE_MT_SYNCH__RW_MUTEX_::close()
    }
}
#[export_name = "_ZN13ACE_SingletonI28ACE_Based_Pointer_Repository19ACE_RW_Thread_MutexE4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_SingletonI28ACE_Based_Pointer_Repository19ACE_RW_Thread_MutexE4dumpEv() {
    unsafe {
        ACE_Singleton_ACE_Based_Pointer_Repository__ACE_MT_SYNCH__RW_MUTEX_::dump()
    }
}
#[export_name = "_ZN13ACE_SingletonI28ACE_Based_Pointer_Repository19ACE_RW_Thread_MutexEC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_SingletonI28ACE_Based_Pointer_Repository19ACE_RW_Thread_MutexEC1Ev(
    __this: *mut ACE_Singleton_ACE_Based_Pointer_Repository__ACE_MT_SYNCH__RW_MUTEX_,
) {
    ACE_Singleton_ACE_Based_Pointer_Repository__ACE_MT_SYNCH__RW_MUTEX_::new_at_s222e6f3b64630094(
        __this,
    )
}
#[export_name = "_ZN13ACE_SingletonI28ACE_Based_Pointer_Repository19ACE_RW_Thread_MutexE8instanceEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_SingletonI28ACE_Based_Pointer_Repository19ACE_RW_Thread_MutexE8instanceEv() -> *mut ACE_Based_Pointer_Repository {
    unsafe {
...
pub mod __cxxabiv1 {}
pub type ACE_Based_Pointer_Repository_Rep_MAP_MANAGER = ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_;
pub type ACE_Based_Pointer_Repository_Rep_MAP_ITERATOR = ACE_Map_Iterator_void____unsigned_long__ACE_Null_Mutex_;
pub type ACE_Based_Pointer_Repository_Rep_MAP_ENTRY = ACE_Map_Entry_void____unsigned_long_;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ACE_Based_Pointer_Repository_Rep_Ace_ {}
#[doc = "* @class ACE_Based_Pointer_Repository_Rep\n *\n * @brief Implementation for the ACE_Based_Pointer_Repository.\n *\n * Every memory pool in ACE binds it's mapping base address and\n * the mapped size to this repository every time it maps/remaps a\n * new chunk of memory successfully."]
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Based_Pointer_Repository_Rep {
    pub addr_map_: ::core::mem::ManuallyDrop<
        ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
    >,
    pub lock_: ::core::mem::ManuallyDrop<ACE_Thread_Mutex>,
}
impl Drop for ACE_Based_Pointer_Repository_Rep {
    fn drop(&mut self) {
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.lock_);
            ::core::mem::ManuallyDrop::drop(&mut self.addr_map_);
        }
    }
}
...
#[export_name = "_ZN28ACE_Based_Pointer_RepositoryC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN28ACE_Based_Pointer_RepositoryC1Ev(
    __this: *mut ACE_Based_Pointer_Repository,
) {
    ACE_Based_Pointer_Repository::new_at(__this)
}
            ...
            {
                {
                    ...
                    if !__d.is_null() {
                        let _ = Box::from_raw(
                            __d as *mut ACE_Based_Pointer_Repository_Rep,
                        );
                    }
                };
            }
...
#[export_name = "__acedtor_u696fdcdee9efade5"]
pub unsafe extern "C-unwind" fn __acedtor_u696fdcdee9efade5(
    __this: *mut ACE_Based_Pointer_Repository,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[export_name = "_ZN28ACE_Based_Pointer_Repository4findEPvRS0_"]
pub unsafe extern "C-unwind" fn __xtu__ZN28ACE_Based_Pointer_Repository4findEPvRS0_(
    __this: *mut ACE_Based_Pointer_Repository,
    addr: *mut libc::c_void,
    base_addr: *mut *mut libc::c_void,
) -> libc::c_int {
    unsafe { ACE_Based_Pointer_Repository::find(__this, addr, base_addr) }
}
#[export_name = "_ZN28ACE_Based_Pointer_Repository4bindEPvm"]
pub unsafe extern "C-unwind" fn __xtu__ZN28ACE_Based_Pointer_Repository4bindEPvm(
    __this: *mut ACE_Based_Pointer_Repository,
    addr: *mut libc::c_void,
    size: libc::c_ulong,
) -> libc::c_int {
    unsafe { ACE_Based_Pointer_Repository::bind(__this, addr, size) }
}
#[export_name = "_ZN28ACE_Based_Pointer_Repository6unbindEPv"]
pub unsafe extern "C-unwind" fn __xtu__ZN28ACE_Based_Pointer_Repository6unbindEPv(
    __this: *mut ACE_Based_Pointer_Repository,
    addr: *mut libc::c_void,
) -> libc::c_int {
    unsafe { ACE_Based_Pointer_Repository::unbind(__this, addr) }
}
...
impl ACE_Based_Pointer_Repository {
                    ...
                    'cont_0: loop {
                        {
                            {
                                (*__this).rep_ = {
                                    let mut __new: ACE_Based_Pointer_Repository_Rep = unsafe {
                                        {
                                            let mut __obj: ACE_Based_Pointer_Repository_Rep = ::core::mem::MaybeUninit::<
                                                ACE_Based_Pointer_Repository_Rep,
                                            >::zeroed()
                                                .assume_init();
                                            let __this: *mut ACE_Based_Pointer_Repository_Rep = &mut __obj
                                                as *mut ACE_Based_Pointer_Repository_Rep;
                                            ::core::ptr::write(
                                                ::core::ptr::addr_of_mut!((* __this).addr_map_)
                                                    .cast::<
                                                        ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                                                    >(),
                                                <ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_>::new_sfe68a6419bd96344(
                                ...
                                if ((((((*__this).rep_).is_null()) as libc::c_int)
                                    as libc::c_int) != 0)
                                {
                                    ((*(__errno_location()))) = 12;
                                    return;
    ...
    pub unsafe fn find(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut mon: ACE_Guard_ACE_Thread_Mutex_ = ::core::mem::MaybeUninit::<
                    ACE_Guard_ACE_Thread_Mutex_,
                >::zeroed()
                    .assume_init();
                <ACE_Guard_ACE_Thread_Mutex_>::new_at_s194b481c4e491c25(
                    (::core::ptr::addr_of_mut!(mon)) as *mut ACE_Guard_ACE_Thread_Mutex_,
                    ::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* (* __this).rep_).lock_) .cast:: <
                        ACE_Thread_Mutex > ().cast_mut())
                    ),
                );
                if (((((<ACE_Guard_ACE_Thread_Mutex_>::locked(
                    (::core::ptr::addr_of!(mon)) as *const ACE_Guard_ACE_Thread_Mutex_,
                ) as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {} else {
                    return (-((1) as libc::c_int));
                };
                let mut ce: *mut ACE_Map_Entry_void____unsigned_long_ = ((0)
                    as *mut ACE_Map_Entry_void____unsigned_long_);
                {
                    let mut iter: ACE_Map_Iterator_void____unsigned_long__ACE_Null_Mutex_ = ::core::mem::MaybeUninit::<
                        ACE_Map_Iterator_void____unsigned_long__ACE_Null_Mutex_,
                    >::zeroed()
                        .assume_init();
                    <ACE_Map_Iterator_void____unsigned_long__ACE_Null_Mutex_>::new_at_s2284d6b38b764f5e(
                        (::core::ptr::addr_of_mut!(iter))
                            as *mut ACE_Map_Iterator_void____unsigned_long__ACE_Null_Mutex_,
                        ::core::ptr::addr_of_mut!(
                            (* ::core::ptr::addr_of!((* (* __this).rep_).addr_map_)
                            .cast:: <
                            ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_ > ()
                            .cast_mut())
                        ),
                    ...
                    'for_0: loop {
                        if !((((((<ACE_Map_Iterator_Base_void____unsigned_long__ACE_Null_Mutex_>::next(
                            (::core::ptr::addr_of!(
                                (* (::core::ptr::addr_of!(iter))).__base_0
                            ))
                                as *const ACE_Map_Iterator_Base_void____unsigned_long__ACE_Null_Mutex_,
                            ::core::ptr::addr_of_mut!(ce),
                        ) as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                            as libc::c_int) != 0))
                        {
                            break;
                        ...
                        'cont_0: loop {
                            {
                                if ((((((((((addr) as *const u8))
                                    >= ((((*ce).ext_id_) as *const u8))) as libc::c_int
                                    as libc::c_int) != 0)
                                    && ((((((addr) as *const u8))
                                        < (((((((((*ce).ext_id_ as *mut libc::c_char))
                                            .wrapping_offset(((*ce).int_id_) as isize)))
                                            as *mut libc::c_void)) as *const u8))) as libc::c_int
                                        as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
                                {
                        ...
                        <ACE_Map_Iterator_void____unsigned_long__ACE_Null_Mutex_>::advance(
                            (::core::ptr::addr_of_mut!(iter))
                                as *mut ACE_Map_Iterator_void____unsigned_long__ACE_Null_Mutex_,
                        );
                    }
                }
                (*base_addr) = ((0) as *mut libc::c_void);
                return 0;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    ...
    pub unsafe fn bind(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                return <ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_>::rebind_s493f800a5d933d6a(
                    (::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* (* __this).rep_).addr_map_) .cast:: <
                        ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_ > ()
                        .cast_mut())
                    )) as *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                    ::core::ptr::addr_of!(addr),
                    ::core::ptr::addr_of!(size),
                );
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
                            ...
                            {
                                {
                                    if ((((((((((addr) as *const u8))
                                        ...
                                        && ((((((addr) as *const u8))
                                            ...
                                            as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
                                    {
                                        return <ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_>::unbind_s0b1d3aa04cffcca6(
                                            (::core::ptr::addr_of_mut!(
                                                (* ::core::ptr::addr_of!((* (* __this).rep_).addr_map_)
                                                .cast:: <
                                                ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_ > ()
...
impl ACE_Singleton_ACE_Based_Pointer_Repository__ACE_MT_SYNCH__RW_MUTEX_ {
        ...
        unsafe {
            {
                return ::core::ptr::addr_of_mut!(
                    ACE_Singleton_ACE_Based_Pointer_Repository__ACE_MT_SYNCH__RW_MUTEX__singleton_
                );
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    ...
    pub unsafe fn cleanup(__this: *mut Self, mut param: *mut libc::c_void) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                (*<ACE_Singleton_ACE_Based_Pointer_Repository__ACE_MT_SYNCH__RW_MUTEX_>::instance_i()) = ((0)
                    as *mut ACE_Singleton_ACE_Based_Pointer_Repository__ACE_MT_SYNCH__RW_MUTEX_);
                if (!(param).is_null()) {
                    let mut lock: *mut *mut ACE_RW_Thread_Mutex = (param
                        as *mut *mut ACE_RW_Thread_Mutex);
                    (*(lock)) = ((0) as *mut ACE_RW_Thread_Mutex);
                }
            }
            ()
        }
    ...
    pub unsafe fn close() {
        unsafe {
            {
                let mut singleton: *mut *mut ACE_Singleton_ACE_Based_Pointer_Repository__ACE_MT_SYNCH__RW_MUTEX_ = &mut ((*<ACE_Singleton_ACE_Based_Pointer_Repository__ACE_MT_SYNCH__RW_MUTEX_>::instance_i()));
    ...
    pub unsafe fn new_at_s222e6f3b64630094(__this: *mut Self) {
        unsafe {
            ...
            *(__this as *mut *const ()) = &__VTBL_u222e6f3b64630094
                as *const __Vtbl_u222e6f3b64630094 as *const ();
            <ACE_Based_Pointer_Repository>::new_at(
                ::core::ptr::addr_of_mut!((* __this).instance_)
                    .cast::<ACE_Based_Pointer_Repository>(),
            );
            {}
            ()
        }
        ...
        unsafe {
            {
                ...
                if ((((((*singleton)).is_null()) as libc::c_int) as libc::c_int) != 0) {
                        ...
                        as libc::c_int) as libc::c_int) != 0)
                    {
                            ...
                            'cont_0: loop {
                                {
                                    {
                                        (*singleton) = {
                                            let __new: *mut ACE_Singleton_ACE_Based_Pointer_Repository__ACE_MT_SYNCH__RW_MUTEX_ = Box::into_raw(
                                                Box::new(
                                                    ::core::mem::MaybeUninit::<
                                                        ACE_Singleton_ACE_Based_Pointer_Repository__ACE_MT_SYNCH__RW_MUTEX_,
                                                    >::zeroed()
                                                        .assume_init(),
                                                ),
                                            );
                                        ...
                                        {
                                            ((*(__errno_location()))) = 12;
                                            return ((0) as *mut ACE_Based_Pointer_Repository);
                                        }
                                    }
                                }
                                #[allow(unreachable_code)] break 'cont_0;
                        ...
                        static mut lock: *mut ACE_RW_Thread_Mutex = ((0)
                            as *mut ACE_RW_Thread_Mutex);
                        if (((((<ACE_Object_Manager>::get_singleton_lock_uce60b00472ad1b0a(
                            ...
                            != 0)
                        {
                            ...
                            <ACE_Object_Manager>::at_exit(
                                ...
                                ((::core::ptr::addr_of_mut!(lock)
                                    as *mut *mut ACE_RW_Thread_Mutex) as *mut libc::c_void),
                                unsafe {
                                    (*((&__TYPEINFO_28ACE_Based_Pointer_Repository
                ...
                return ::core::ptr::addr_of_mut!(
                    ...
                    ACE_Based_Pointer_Repository > ().cast_mut())
...
impl ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_ {
    ///Initialize a ACE_Map_Manager with @a size entries.
    pub unsafe fn new_at_s28d0ff182a290c49(
        __this: *mut Self,
        mut __a0: libc::c_ulong,
        mut __a1: *mut ACE_Allocator,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexEC1EmP13ACE_Allocator"]
            fn __ext(
                __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                __a0: libc::c_ulong,
        ...
        __ext(
            __this as *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
            __a0,
            __a1,
        )
    }
    pub unsafe fn new_s28d0ff182a290c49(
        mut __a0: libc::c_ulong,
        mut __a1: *mut ACE_Allocator,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s28d0ff182a290c49(::core::ptr::addr_of_mut!(__obj), __a0, __a1);
        __obj
    }
    #[doc = "* Associate @a ext_id with @a int_id.  If @a ext_id is already in the\n   * map then the ACE_Map_Entry is not changed.\n   * @retval 0 If a new entry is bound successfully.\n   * @retval 1 If an attempt is made to bind an existing entry.\n   * @retval -1 If failures occur."]
    pub unsafe fn bind(
        __this: *mut Self,
        mut ext_id: *const *mut libc::c_void,
        mut int_id: *const libc::c_ulong,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE4bindERKS0_RKm"]
            fn __ext(
                __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                ext_id: *const *mut libc::c_void,
                int_id: *const libc::c_ulong,
    ...
    pub unsafe fn rebind_s15e381172d8f48f8(
        __this: *mut Self,
        mut ext_id: *const *mut libc::c_void,
        mut int_id: *const libc::c_ulong,
        mut old_ext_id: *mut *mut libc::c_void,
        mut old_int_id: *mut libc::c_ulong,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE6rebindERKS0_RKmRS0_Rm"]
            fn __ext(
                __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                ext_id: *const *mut libc::c_void,
                int_id: *const libc::c_ulong,
                old_ext_id: *mut *mut libc::c_void,
                old_int_id: *mut libc::c_ulong,
            ) -> libc::c_int;
        }
        __ext(
            __this as *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
    ...
    pub unsafe fn rebind_sc6fe7af62725d257(
        __this: *mut Self,
        mut ext_id: *const *mut libc::c_void,
        mut int_id: *const libc::c_ulong,
        mut old_int_id: *mut libc::c_ulong,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE6rebindERKS0_RKmRm"]
            fn __ext(
                __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                ext_id: *const *mut libc::c_void,
                int_id: *const libc::c_ulong,
    ...
    pub unsafe fn trybind(
        __this: *mut Self,
        mut ext_id: *const *mut libc::c_void,
        mut int_id: *mut libc::c_ulong,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE7trybindERKS0_Rm"]
            fn __ext(
                __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                ext_id: *const *mut libc::c_void,
                int_id: *mut libc::c_ulong,
            ) -> libc::c_int;
        }
        __ext(
            __this as *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
    ...
    #[doc = "* Locate @a ext_id and pass out parameter via @a int_id.\n   * @retval 0 If found.\n   * @retval -1 If not found."]
    pub unsafe fn find_sc0d9910855914540(
        __this: *const Self,
        mut ext_id: *const *mut libc::c_void,
        mut int_id: *mut libc::c_ulong,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZNK15ACE_Map_ManagerIPvm14ACE_Null_MutexE4findERKS0_Rm"]
            fn __ext(
                __this: *const ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                ext_id: *const *mut libc::c_void,
                int_id: *mut libc::c_ulong,
            ) -> libc::c_int;
        }
        __ext(
            __this as *const ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
            ext_id,
            int_id,
        )
    }
    ///Returns 0 if the @a ext_id is in the mapping, otherwise -1.
    pub unsafe fn find_s9a830c525d51fd1f(
        __this: *const Self,
        mut ext_id: *const *mut libc::c_void,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZNK15ACE_Map_ManagerIPvm14ACE_Null_MutexE4findERKS0_"]
            fn __ext(
                __this: *const ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                ext_id: *const *mut libc::c_void,
            ) -> libc::c_int;
    ...
    #[doc = "* Break any association of @a ext_id.  Returns the value of @a int_id\n   * in case the caller needs to deallocate memory.  Returns 0 if\n   * successful, else -1."]
    pub unsafe fn unbind_s154bd1d6a5f0253b(
        __this: *mut Self,
        mut ext_id: *const *mut libc::c_void,
        mut int_id: *mut libc::c_ulong,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE6unbindERKS0_Rm"]
            fn __ext(
                __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                ext_id: *const *mut libc::c_void,
                int_id: *mut libc::c_ulong,
    ...
    ///* Unbind all entires.
    pub unsafe fn unbind_all(__this: *mut Self) {
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE10unbind_allEv"]
            fn __ext(
                __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
            );
        }
        __ext(__this as *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_)
    }
    ///Return the current size of the map.
    pub unsafe fn current_size(__this: *const Self) -> libc::c_ulong {
        extern "C-unwind" {
            #[link_name = "_ZNK15ACE_Map_ManagerIPvm14ACE_Null_MutexE12current_sizeEv"]
            fn __ext(
                __this: *const ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
            ) -> libc::c_ulong;
        }
        __ext(__this as *const ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_)
    }
    ///Return the total size of the map.
    pub unsafe fn total_size(__this: *const Self) -> libc::c_ulong {
        extern "C-unwind" {
            #[link_name = "_ZNK15ACE_Map_ManagerIPvm14ACE_Null_MutexE10total_sizeEv"]
            fn __ext(
                __this: *const ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
            ) -> libc::c_ulong;
        }
    ...
    pub unsafe fn mutex(__this: *mut Self) -> *mut ACE_Null_Mutex {
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE5mutexEv"]
            fn __ext(
                __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
            ) -> *mut ACE_Null_Mutex;
        }
    ...
    pub unsafe fn dump(__this: *const Self) {
        extern "C-unwind" {
            #[link_name = "_ZNK15ACE_Map_ManagerIPvm14ACE_Null_MutexE4dumpEv"]
            fn __ext(
                __this: *const ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
            );
        }
  ...
  /// with locks held.*/
    pub unsafe fn bind_i(
        __this: *mut Self,
        mut ext_id: *const *mut libc::c_void,
        mut int_id: *const libc::c_ulong,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE6bind_iERKS0_RKm"]
            fn __ext(
                __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                ext_id: *const *mut libc::c_void,
                int_id: *const libc::c_ulong,
  ...
  /// values.  Must be called with locks held.*/
    pub unsafe fn rebind_i_s15e381172d8f48f8(
        __this: *mut Self,
        mut ext_id: *const *mut libc::c_void,
        mut int_id: *const libc::c_ulong,
        mut old_ext_id: *mut *mut libc::c_void,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE8rebind_iERKS0_RKmRS0_Rm"]
            fn __ext(
                __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                ext_id: *const *mut libc::c_void,
                int_id: *const libc::c_ulong,
    ...
    /**Performs a rebinding of <ext_it> to @a int_id.  Also, recovers old
  /// values.  Must be called with locks held.*/
    pub unsafe fn rebind_i_sc6fe7af62725d257(
        __this: *mut Self,
        mut ext_id: *const *mut libc::c_void,
        mut int_id: *const libc::c_ulong,
        mut old_int_id: *mut libc::c_ulong,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE8rebind_iERKS0_RKmRm"]
            fn __ext(
                __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                ext_id: *const *mut libc::c_void,
                int_id: *const libc::c_ulong,
  ...
  /// key.  Must be called with locks held.*/
    pub unsafe fn trybind_i(
        __this: *mut Self,
        mut ext_id: *const *mut libc::c_void,
        mut int_id: *mut libc::c_ulong,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE9trybind_iERKS0_Rm"]
            fn __ext(
                __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                ext_id: *const *mut libc::c_void,
                int_id: *mut libc::c_ulong,
  ...
  /// called with locks held.*/
    pub unsafe fn find_i(
        ...
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE6find_iERKS0_Rm"]
            fn __ext(
                __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                ext_id: *const *mut libc::c_void,
                int_id: *mut libc::c_ulong,
  ...
  /// be called with locks held.*/
    pub unsafe fn unbind_i_s154bd1d6a5f0253b(
        __this: *mut Self,
        mut ext_id: *const *mut libc::c_void,
        mut int_id: *mut libc::c_ulong,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexE8unbind_iERKS0_Rm"]
            fn __ext(
                __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                ext_id: *const *mut libc::c_void,
                int_id: *mut libc::c_ulong,
    ...
    pub unsafe fn operator_assign(
        __this: *mut Self,
        mut _anon_0: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexEaSERKS2_"]
            fn __ext(
                __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                _anon_0: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
            );
        }
        __ext(
            __this as *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
    ...
    pub unsafe fn new_at_s39904e74784c333b(
        __this: *mut Self,
        mut __a0: *const ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_Map_ManagerIPvm14ACE_Null_MutexEC1ERKS2_"]
            fn __ext(
                __this: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                __a0: *const ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
            );
        }
        __ext(
            __this as *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
    ...
    pub unsafe fn new_s39904e74784c333b(
        mut __a0: *const ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s39904e74784c333b(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    ///Id of the occupied list sentinel.
    pub unsafe fn occupied_list_id(__this: *const Self) -> libc::c_uint {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
  ...
  /// separate method to facilitate template specialization.*/
    pub unsafe fn equal(
        __this: *mut Self,
        mut id1: *const *mut libc::c_void,
        mut id2: *const *mut libc::c_void,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((((((*id1)) as *const u8)) == ((((*id2)) as *const u8)))
  ...
  /// locks held.*/
    pub unsafe fn find_and_return_index(
        __this: *mut Self,
        mut ext_id: *const *mut libc::c_void,
        mut slot: *mut libc::c_uint,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                {
                    let mut i: libc::c_uint = <ACE_Map_Entry_void____unsigned_long_>::next_sefcfc7bde2e9b4e4(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* __this).occupied_list_) .cast:: <
                            ACE_Map_Entry_void____unsigned_long_ > ().cast_mut())
                        )) as *const ACE_Map_Entry_void____unsigned_long_,
                    );
                    'for_0: loop {
                        if !((((((i as libc::c_uint))
                            != (((<ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_>::occupied_list_id(
                                (__this)
                                    as *const ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                        ...
                        'cont_0: loop {
                            {
                                {
                                    if ((<ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_>::equal(
                                        (__this)
                                            as *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                                        ::core::ptr::addr_of!(
                                            (* ((* __this).search_structure_).wrapping_offset((i) as
                                            isize)).ext_id_
                                        ),
                        ...
                        {
                            let __v = <ACE_Map_Entry_void____unsigned_long_>::next_sefcfc7bde2e9b4e4(
                                (::core::ptr::addr_of!(
                                    (* ((* __this).search_structure_).wrapping_offset((i) as
                                    isize))
                                )) as *const ACE_Map_Entry_void____unsigned_long_,
    ...
    pub unsafe fn free_list_id(__this: *const Self) -> libc::c_uint {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
  ...
  /// <search_structure_>.*/
    pub unsafe fn free_search_structure(__this: *mut Self) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((!((*__this).search_structure_).is_null()) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    {
                        ...
                        'for_0: loop {
                            if !((((((i as libc::c_uint))
                                < ((((*__this).total_size_) as libc::c_uint)))
                                as libc::c_int as libc::c_int) != 0))
                            {
                                break;
                            }
                            'cont_0: loop {
                                {
                                    {
                                        let mut ss: *mut ACE_Map_Entry_void____unsigned_long_ = ((::core::ptr::addr_of_mut!(
                                            (* ((* __this).search_structure_).wrapping_offset((i) as
                                            isize))
                                        ) as *mut ACE_Map_Entry_void____unsigned_long_)
                                            as *mut ACE_Map_Entry_void____unsigned_long_);
                    ...
                    }
                    {
                        ...
                        ((*__vt)
                            ...
                            __obj,
                            (((*__this).search_structure_) as *mut libc::c_void),
                        )
                    };
                    (*__this).search_structure_ = ((0)
                        as *mut ACE_Map_Entry_void____unsigned_long_);
                }
            }
            ()
    ...
    pub unsafe fn resize_i(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut i: libc::c_uint = unsafe { ::core::mem::zeroed() };
                let mut temp: *mut ACE_Map_Entry_void____unsigned_long_ = ((0)
                    as *mut ACE_Map_Entry_void____unsigned_long_);
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                ...
                {
                    i = <ACE_Map_Entry_void____unsigned_long_>::next_sefcfc7bde2e9b4e4(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* __this).occupied_list_) .cast:: <
                            ACE_Map_Entry_void____unsigned_long_ > ().cast_mut())
                        )) as *const ACE_Map_Entry_void____unsigned_long_,
                    ...
                    'for_1: loop {
                        ...
                        'cont_1: loop {
                            {
                                {
                                    let __place: *mut ACE_Map_Entry_void____unsigned_long_ = (::core::ptr::addr_of_mut!(
                                        ((* (temp).wrapping_offset((i) as isize)))
                                    ) as *mut ACE_Map_Entry_void____unsigned_long_)
                                        as *mut ACE_Map_Entry_void____unsigned_long_;
                                    <ACE_Map_Entry_void____unsigned_long_>::new_at_sbbce3234b73ce77d(
                                        (__place) as *mut ACE_Map_Entry_void____unsigned_long_,
                                        ::core::ptr::addr_of!(
                                            (* ((* __this).search_structure_).wrapping_offset((i) as
                                            isize))
                                        ),
                ...
                }
                {
                    i = <ACE_Map_Entry_void____unsigned_long_>::next_sefcfc7bde2e9b4e4(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* __this).free_list_) .cast:: <
                            ACE_Map_Entry_void____unsigned_long_ > ().cast_mut())
                        )) as *const ACE_Map_Entry_void____unsigned_long_,
                    );
                    'for_2: loop {
                        if !((((((i as libc::c_uint))
                            != (((<ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_>::free_list_id(
                                (__this)
                                    as *const ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                            )) as libc::c_uint))) as libc::c_int as libc::c_int) != 0))
                        {
                ...
                {
                    i = (*__this).total_size_;
                    'for_3: loop {
                        if !((((((i as libc::c_uint)) < (((new_size) as libc::c_uint)))
                            as libc::c_int as libc::c_int) != 0))
                        {
                            break;
                        }
                                ...
                                {
                                    {
                                        let __place: *mut ACE_Map_Entry_void____unsigned_long_ = (::core::ptr::addr_of_mut!(
                                            ...
                                            as *mut ACE_Map_Entry_void____unsigned_long_;
                                        <ACE_Map_Entry_void____unsigned_long_>::new_at_s869970fd24d3d440(
                                            (__place) as *mut ACE_Map_Entry_void____unsigned_long_,
                                        );
                                        __place
                                    };
                                    <ACE_Map_Entry_void____unsigned_long_>::next_se0a84a2731604b90(
                                        (::core::ptr::addr_of_mut!(
                                            (* (temp).wrapping_offset((i) as isize))
                                        )) as *mut ACE_Map_Entry_void____unsigned_long_,
                                        (((i) as libc::c_uint)).wrapping_add((1) as libc::c_uint),
                                    );
                                    <ACE_Map_Entry_void____unsigned_long_>::prev_se0a84a2731604b90(
                                        (::core::ptr::addr_of_mut!(
                                            (* (temp).wrapping_offset((i) as isize))
                                        )) as *mut ACE_Map_Entry_void____unsigned_long_,
                                        (((i) as libc::c_uint)).wrapping_sub((1) as libc::c_uint),
                                    );
                                }
                            }
                ...
                <ACE_Map_Entry_void____unsigned_long_>::prev_se0a84a2731604b90(
                    ...
                    (((new_size) as libc::c_uint)).wrapping_sub((1) as libc::c_uint),
                );
                <ACE_Map_Entry_void____unsigned_long_>::next_se0a84a2731604b90(
                    (::core::ptr::addr_of_mut!(
                        (* (temp).wrapping_offset(((((new_size) as libc::c_uint))
                ...
                <ACE_Map_Entry_void____unsigned_long_>::prev_se0a84a2731604b90(
                    (::core::ptr::addr_of_mut!(
                        (* (temp).wrapping_offset(((* __this).total_size_) as isize))
                    )) as *mut ACE_Map_Entry_void____unsigned_long_,
                    <ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_>::free_list_id(
                        (__this)
                            as *const ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                ...
                (*__this).total_size_ = new_size;
                (*__this).search_structure_ = ((temp)
                    as *mut ACE_Map_Entry_void____unsigned_long_);
                return 0;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
  ...
  /// function is called when we run out of room and need to resize.*/
    pub unsafe fn new_size(__this: *mut Self) -> libc::c_uint {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut current_size: libc::c_uint = (*__this).total_size_;
                if (((((current_size as libc::c_uint))
                    < ((((65536 as libc::c_int)) as libc::c_uint))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    {
                        current_size = (((current_size) as libc::c_uint))
    ...
    pub unsafe fn next_free(
        __this: *mut Self,
        mut free_slot: *mut libc::c_uint,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                (*free_slot) = <ACE_Map_Entry_void____unsigned_long_>::next_sefcfc7bde2e9b4e4(
                    (::core::ptr::addr_of!(
                        (* ::core::ptr::addr_of!((* __this).free_list_) .cast:: <
                        ACE_Map_Entry_void____unsigned_long_ > ().cast_mut())
                    )) as *const ACE_Map_Entry_void____unsigned_long_,
                );
                if ((((((*free_slot) as libc::c_uint))
                    != (((<ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_>::free_list_id(
                        (__this)
                            as *const ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                    )) as libc::c_uint))) as libc::c_int as libc::c_int) != 0)
                ...
                let mut result: libc::c_int = <ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_>::resize_i(
                    (__this)
                        as *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                    <ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_>::new_size(
                        (__this)
                            as *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                    ),
                );
    ...
    ///Move helper.
    pub unsafe fn shared_move(
        __this: *mut Self,
        mut slot: libc::c_uint,
        mut current_list: *mut ACE_Map_Entry_void____unsigned_long_,
        mut current_list_id: libc::c_uint,
        mut new_list: *mut ACE_Map_Entry_void____unsigned_long_,
        mut new_list_id: libc::c_uint,
    ) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut entry: *mut ACE_Map_Entry_void____unsigned_long_ = ::core::ptr::addr_of_mut!(
                    (* ((* __this).search_structure_).wrapping_offset((slot) as isize))
                );
                let mut current_list_prev: libc::c_uint = <ACE_Map_Entry_void____unsigned_long_>::prev_sefcfc7bde2e9b4e4(
                    (::core::ptr::addr_of!((* entry)))
                        as *const ACE_Map_Entry_void____unsigned_long_,
                );
                if (((((current_list_prev as libc::c_uint))
                    == (((current_list_id) as libc::c_uint))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    <ACE_Map_Entry_void____unsigned_long_>::next_se0a84a2731604b90(
                        (::core::ptr::addr_of_mut!((* current_list)))
                            as *mut ACE_Map_Entry_void____unsigned_long_,
                        <ACE_Map_Entry_void____unsigned_long_>::next_sefcfc7bde2e9b4e4(
                            (::core::ptr::addr_of!((* entry)))
                                as *const ACE_Map_Entry_void____unsigned_long_,
                        ),
                    );
                    ...
                    <ACE_Map_Entry_void____unsigned_long_>::next_se0a84a2731604b90(
                        (::core::ptr::addr_of_mut!(
                            (* ((* __this).search_structure_)
                            .wrapping_offset((current_list_prev) as isize))
                        )) as *mut ACE_Map_Entry_void____unsigned_long_,
                        <ACE_Map_Entry_void____unsigned_long_>::next_sefcfc7bde2e9b4e4(
                            (::core::ptr::addr_of!((* entry)))
                                as *const ACE_Map_Entry_void____unsigned_long_,
                ...
                let mut current_list_next: libc::c_uint = <ACE_Map_Entry_void____unsigned_long_>::next_sefcfc7bde2e9b4e4(
                    (::core::ptr::addr_of!((* entry)))
                        as *const ACE_Map_Entry_void____unsigned_long_,
                );
                if (((((current_list_next as libc::c_uint))
                    == (((current_list_id) as libc::c_uint))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    <ACE_Map_Entry_void____unsigned_long_>::prev_se0a84a2731604b90(
                        (::core::ptr::addr_of_mut!((* current_list)))
                            as *mut ACE_Map_Entry_void____unsigned_long_,
                        <ACE_Map_Entry_void____unsigned_long_>::prev_sefcfc7bde2e9b4e4(
                            (::core::ptr::addr_of!((* entry)))
                                as *const ACE_Map_Entry_void____unsigned_long_,
                        ),
                    );
                    ...
                    <ACE_Map_Entry_void____unsigned_long_>::prev_se0a84a2731604b90(
                        (::core::ptr::addr_of_mut!(
                            (* ((* __this).search_structure_)
                            .wrapping_offset((current_list_next) as isize))
                        )) as *mut ACE_Map_Entry_void____unsigned_long_,
                        <ACE_Map_Entry_void____unsigned_long_>::prev_sefcfc7bde2e9b4e4(
                            (::core::ptr::addr_of!((* entry)))
                                as *const ACE_Map_Entry_void____unsigned_long_,
                ...
                let mut new_list_next: libc::c_uint = <ACE_Map_Entry_void____unsigned_long_>::next_sefcfc7bde2e9b4e4(
                    (::core::ptr::addr_of!((* new_list)))
                        as *const ACE_Map_Entry_void____unsigned_long_,
                );
                <ACE_Map_Entry_void____unsigned_long_>::next_se0a84a2731604b90(
                ...
                <ACE_Map_Entry_void____unsigned_long_>::next_se0a84a2731604b90(
                    (::core::ptr::addr_of_mut!((* new_list)))
                        as *mut ACE_Map_Entry_void____unsigned_long_,
                    slot,
                );
                if (((((new_list_next as libc::c_uint))
                    == (((new_list_id) as libc::c_uint))) as libc::c_int as libc::c_int)
                    != 0)
                {
                    <ACE_Map_Entry_void____unsigned_long_>::prev_se0a84a2731604b90(
                        (::core::ptr::addr_of_mut!((* new_list)))
                    ...
                    <ACE_Map_Entry_void____unsigned_long_>::prev_se0a84a2731604b90(
                        (::core::ptr::addr_of_mut!(
                            (* ((* __this).search_structure_)
                            .wrapping_offset((new_list_next) as isize))
                        )) as *mut ACE_Map_Entry_void____unsigned_long_,
                        slot,
                    );
                }
    ...
    pub unsafe fn move_from_free_list_to_occupied_list(
        __this: *mut Self,
        mut slot: libc::c_uint,
    ) {
        unsafe {
  ...
  /// held.*/
    pub unsafe fn shared_bind(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut slot: libc::c_uint = ((0) as libc::c_uint);
                let mut result: libc::c_int = <ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_>::next_free(
                    (__this)
                        as *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                ...
                {
                    (*((*__this).search_structure_).wrapping_offset((slot) as isize))
                        .int_id_ = (((*int_id)) as libc::c_ulong);
                    (*((*__this).search_structure_).wrapping_offset((slot) as isize))
                        .ext_id_ = (((*ext_id)) as *mut libc::c_void);
                    <ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_>::move_from_free_list_to_occupied_list(
                        (__this)
                            as *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                        slot,
                    );
  ...
  /// with locks held.*/
    pub unsafe fn rebind_i_s493f800a5d933d6a(
        __this: *mut Self,
        mut ext_id: *const *mut libc::c_void,
        mut int_id: *const libc::c_ulong,
    ) -> libc::c_int {
        unsafe {
            ...
            {
                let mut slot: libc::c_uint = ((0) as libc::c_uint);
                let mut result: libc::c_int = <ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_>::find_and_return_index(
                    (__this)
                        as *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                    ::core::ptr::addr_of!((* ext_id)),
                    ::core::ptr::addr_of_mut!(slot),
                ...
                {
                    let mut ss: *mut ACE_Map_Entry_void____unsigned_long_ = ::core::ptr::addr_of_mut!(
                        (* ((* __this).search_structure_).wrapping_offset((slot) as
                        isize))
                    );
                    (*ss).ext_id_ = (((*ext_id)) as *mut libc::c_void);
                    (*ss).int_id_ = (((*int_id)) as libc::c_ulong);
                    {
                        let __obj: *mut ACE_Allocator = ((*__this).allocator_)
                            as *mut ACE_Allocator;
                        let __vt: *const __Vtbl_uf2113694993e252c = *(__obj
                            as *const *const __Vtbl_uf2113694993e252c);
                        ((*__vt)
                            .vfn_u7db10b00cce8fa5e)(
                            __obj,
                            ((::core::ptr::addr_of_mut!((* ss))
                                as *mut ACE_Map_Entry_void____unsigned_long_)
                                as *mut libc::c_void),
                            ((::core::mem::size_of::<
                                ACE_Map_Entry_void____unsigned_long_,
                            >() as libc::c_ulong) as libc::c_ulong),
                            4,
                        )
                    };
                    ...
                    return <ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_>::shared_bind(
                        (__this)
                            as *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                        ::core::ptr::addr_of!((* ext_id)),
  ...
  /// ignored.*/
    pub unsafe fn rebind_s493f800a5d933d6a(
        __this: *mut Self,
        mut ext_id: *const *mut libc::c_void,
        mut int_id: *const libc::c_ulong,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                return <ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_>::rebind_i_s493f800a5d933d6a(
                    (__this)
                        as *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                    ::core::ptr::addr_of!((* ext_id)),
                    ::core::ptr::addr_of!((* int_id)),
    ...
    pub unsafe fn move_from_occupied_list_to_free_list(
        __this: *mut Self,
        mut slot: libc::c_uint,
    ) {
        unsafe {
    ...
    ///Unbind @a slot.
    pub unsafe fn unbind_slot(__this: *mut Self, mut slot: libc::c_uint) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                <ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_>::move_from_occupied_list_to_free_list(
                    (__this)
                        as *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                    slot,
                );
  ...
  /// with locks held.*/
    pub unsafe fn unbind_and_return_index(
        __this: *mut Self,
        mut ext_id: *const *mut libc::c_void,
        mut slot: *mut libc::c_uint,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                if (((((result as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    <ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_>::unbind_slot(
                        (__this)
                            as *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                        (*slot),
                    );
    ...
    /**Performs an unbind using @a ext_id as the key.  Must be called
  /// with locks held.*/
    pub unsafe fn unbind_i_s0b1d3aa04cffcca6(
        __this: *mut Self,
        mut ext_id: *const *mut libc::c_void,
    ) -> libc::c_int {
        unsafe {
            ...
            {
                let mut slot: libc::c_uint = ((0) as libc::c_uint);
                return <ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_>::unbind_and_return_index(
                    (__this)
                        as *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                    ::core::ptr::addr_of!((* ext_id)),
                    ::core::ptr::addr_of_mut!(slot),
    ...
    pub unsafe fn unbind_s0b1d3aa04cffcca6(
        __this: *mut Self,
        mut ext_id: *const *mut libc::c_void,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                return <ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_>::unbind_i_s0b1d3aa04cffcca6(
                    (__this)
                        as *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                    ::core::ptr::addr_of!((* ext_id)),
                );
    ...
    pub unsafe fn close_i(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                (*__this).total_size_ = ((0) as libc::c_uint);
                (*__this).cur_size_ = ((0) as libc::c_uint);
                <ACE_Map_Entry_void____unsigned_long_>::next_se0a84a2731604b90(
                    (::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).free_list_) .cast:: <
                        ACE_Map_Entry_void____unsigned_long_ > ().cast_mut())
  ...
  /// resources.*/
    pub unsafe fn close(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                return <ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_>::close_i(
                    (__this)
                        as *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                );
            }
    ...
    pub unsafe fn open(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                <ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_>::close_i(
                    (__this)
                        as *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                );
                if (((((alloc).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    alloc = <ACE_Allocator>::instance();
                }
                (*__this).allocator_ = alloc;
                    ...
                    as libc::c_int) as libc::c_int) != 0)
                {
                    ...
                    __ace_assert(
                        ((b"/build/ace_full/src/ACE/ace/Map_Manager.cpp\0".as_ptr()
                            as *const libc::c_char) as *const libc::c_char),
                        43,
                        ((b"size != 0\0".as_ptr() as *const libc::c_char)
                            as *const libc::c_char),
                    )
                });
                (if ((((((size as libc::c_ulong))
                    <= (((4294967295u32) as libc::c_ulong))) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    ()
                } else {
                    __ace_assert(
                        ((b"/build/ace_full/src/ACE/ace/Map_Manager.cpp\0".as_ptr()
                            as *const libc::c_char) as *const libc::c_char),
                        52,
                        ((b"size <= 0xFFFFFFFF\0".as_ptr() as *const libc::c_char)
                            as *const libc::c_char),
                    )
                });
                return <ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_>::resize_i(
                    (__this)
                        as *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                    (size as libc::c_uint),
                );
    ...
    pub unsafe fn new_at_sfe68a6419bd96344(
        __this: *mut Self,
        mut alloc: *mut ACE_Allocator,
    ) {
        unsafe {
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).search_structure_),
                ((0) as *mut ACE_Map_Entry_void____unsigned_long_),
            );
            ::core::ptr::write(
            ...
            <ACE_Map_Entry_void____unsigned_long_>::new_at_s869970fd24d3d440(
                ::core::ptr::addr_of_mut!((* __this).free_list_)
                    .cast::<ACE_Map_Entry_void____unsigned_long_>(),
            );
            <ACE_Map_Entry_void____unsigned_long_>::new_at_s869970fd24d3d440(
                ::core::ptr::addr_of_mut!((* __this).occupied_list_)
                    .cast::<ACE_Map_Entry_void____unsigned_long_>(),
            );
            {
                if (((((<ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_>::open(
                    (__this)
                        as *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/Map_Manager.inl\0".as_ptr()
                                            as *const libc::c_char) as *const libc::c_char),
                                        67,
                                        (-((1) as libc::c_int)),
    ...
    pub unsafe fn new_sfe68a6419bd96344(mut __a0: *mut ACE_Allocator) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_sfe68a6419bd96344(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
}
impl ACE_Map_Entry_void____unsigned_long_ {
    ///Dump the state of an object.
    pub unsafe fn dump(__this: *const Self) {
        extern "C-unwind" {
            #[link_name = "_ZNK13ACE_Map_EntryIPvmE4dumpEv"]
            fn __ext(__this: *const ACE_Map_Entry_void____unsigned_long_);
        }
        __ext(__this as *const ACE_Map_Entry_void____unsigned_long_)
    }
    ///Get next entry.
    pub unsafe fn next_sefcfc7bde2e9b4e4(__this: *const Self) -> libc::c_uint {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((*__this).next_) as libc::c_uint);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    pub unsafe fn new_at_sbbce3234b73ce77d(
        __this: *mut Self,
        mut _anon_0: *const ACE_Map_Entry_void____unsigned_long_,
    ) {
        unsafe {
            ::core::ptr::write(
                __this,
            ...
            ::core::ptr::write(
                ...
                ::core::ptr::read(::core::ptr::addr_of!((* _anon_0).ext_id_)),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).int_id_),
                ::core::ptr::read(::core::ptr::addr_of!((* _anon_0).int_id_)),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).next_),
                ::core::ptr::read(::core::ptr::addr_of!((* _anon_0).next_)),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).prev_),
                ::core::ptr::read(::core::ptr::addr_of!((* _anon_0).prev_)),
            );
            {}
            ()
        }
    }
    pub unsafe fn new_sbbce3234b73ce77d(
        mut __a0: *const ACE_Map_Entry_void____unsigned_long_,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_sbbce3234b73ce77d(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    ///Initialize member variables.
    pub unsafe fn new_at_s869970fd24d3d440(__this: *mut Self) {
        unsafe {
            ::core::ptr::write(
                __this,
                ::core::mem::MaybeUninit::<Self>::zeroed().assume_init(),
    ...
    pub unsafe fn new_s869970fd24d3d440() -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s869970fd24d3d440(::core::ptr::addr_of_mut!(__obj));
        __obj
    }
    ///Set next entry.
    pub unsafe fn next_se0a84a2731604b90(__this: *mut Self, mut n: libc::c_uint) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                (*__this).next_ = n;
    ...
    ///Set prev entry.
    pub unsafe fn prev_se0a84a2731604b90(__this: *mut Self, mut p: libc::c_uint) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                (*__this).prev_ = p;
    ...
    ///Get prev entry.
    pub unsafe fn prev_sefcfc7bde2e9b4e4(__this: *const Self) -> libc::c_uint {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((*__this).prev_) as libc::c_uint);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
}
impl ACE_Map_Iterator_void____unsigned_long__ACE_Null_Mutex_ {
    ///Dump the state of an object.
    pub unsafe fn dump(__this: *const Self) {
        extern "C-unwind" {
            #[link_name = "_ZNK16ACE_Map_IteratorIPvm14ACE_Null_MutexE4dumpEv"]
            fn __ext(
                __this: *const ACE_Map_Iterator_void____unsigned_long__ACE_Null_Mutex_,
            );
        }
        __ext(__this as *const ACE_Map_Iterator_void____unsigned_long__ACE_Null_Mutex_)
    }
    ///Prefix advance.
    pub unsafe fn operator_inc_s95c6a9fec7d43b77(
        __this: *mut Self,
    ) -> *mut ACE_Map_Iterator_void____unsigned_long__ACE_Null_Mutex_ {
        extern "C-unwind" {
            #[link_name = "_ZN16ACE_Map_IteratorIPvm14ACE_Null_MutexEppEv"]
            fn __ext(
                __this: *mut ACE_Map_Iterator_void____unsigned_long__ACE_Null_Mutex_,
            ) -> *mut ACE_Map_Iterator_void____unsigned_long__ACE_Null_Mutex_;
        }
        __ext(__this as *mut ACE_Map_Iterator_void____unsigned_long__ACE_Null_Mutex_)
    }
    ///Prefix reverse.
    pub unsafe fn operator_dec_s95c6a9fec7d43b77(
        __this: *mut Self,
    ) -> *mut ACE_Map_Iterator_void____unsigned_long__ACE_Null_Mutex_ {
        extern "C-unwind" {
            #[link_name = "_ZN16ACE_Map_IteratorIPvm14ACE_Null_MutexEmmEv"]
            fn __ext(
                __this: *mut ACE_Map_Iterator_void____unsigned_long__ACE_Null_Mutex_,
            ) -> *mut ACE_Map_Iterator_void____unsigned_long__ACE_Null_Mutex_;
        }
    ...
    pub unsafe fn new_at_s2284d6b38b764f5e(
        __this: *mut Self,
        mut mm: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
        mut pass_end: libc::c_int,
    ) {
        unsafe {
            ::core::ptr::write(
                __this,
            ...
            <ACE_Map_Iterator_Base_void____unsigned_long__ACE_Null_Mutex_>::new_at_s2024e43ea93684d3(
                (::core::ptr::addr_of_mut!((* __this).__base_0))
                    as *mut ACE_Map_Iterator_Base_void____unsigned_long__ACE_Null_Mutex_,
                ::core::ptr::addr_of_mut!((* mm)),
            );
            {
                if (((!(((pass_end) != 0)) as libc::c_int) as libc::c_int) != 0) {
                    (*__this).__base_0.next_ = <ACE_Map_Entry_void____unsigned_long_>::next_sefcfc7bde2e9b4e4(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* (* __this).__base_0.map_man_)
                            .occupied_list_) .cast:: <
                            ACE_Map_Entry_void____unsigned_long_ > ().cast_mut())
                        )) as *const ACE_Map_Entry_void____unsigned_long_,
                    );
    ...
    pub unsafe fn new_s2284d6b38b764f5e(
        mut __a0: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
        mut __a1: libc::c_int,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s2284d6b38b764f5e(::core::ptr::addr_of_mut!(__obj), __a0, __a1);
        __obj
    }
  ...
  /// items in the set have been seen, else 1.*/
    pub unsafe fn advance(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return <ACE_Map_Iterator_Base_void____unsigned_long__ACE_Null_Mutex_>::forward_i(
                    (::core::ptr::addr_of_mut!((* __this).__base_0))
                        as *mut ACE_Map_Iterator_Base_void____unsigned_long__ACE_Null_Mutex_,
                );
            }
...
impl ACE_Map_Iterator_Base_void____unsigned_long__ACE_Null_Mutex_ {
    /**Constructor.  If head != 0, the iterator constructed is positioned
  /// at the head of the map, it is positioned at the end otherwise.*/
    pub unsafe fn new_at_s2024e43ea93684d3(
        __this: *mut Self,
        mut mm: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
    ) {
        unsafe {
    ...
    pub unsafe fn new_s2024e43ea93684d3(
        mut __a0: *mut ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s2024e43ea93684d3(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
  ...
  /// Returns 0 when all items have been seen, else 1.*/
    pub unsafe fn next(
        __this: *const Self,
        mut mm: *mut *mut ACE_Map_Entry_void____unsigned_long_,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((((*__this).next_ as libc::c_uint))
                    != (((<ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_>::occupied_list_id(
                        ((*__this).map_man_)
                            as *const ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                    )) as libc::c_uint))) as libc::c_int as libc::c_int) != 0)
                {
                    (*mm) = ::core::ptr::addr_of_mut!(
                        (* ((* (* __this).map_man_).search_structure_)
                        .wrapping_offset(((* __this).next_) as isize))
                    ) as *mut ACE_Map_Entry_void____unsigned_long_;
                    return 1;
                } else {
                    return 0;
  ...
  /// no more item in the set after the current items, else 1.*/
    pub unsafe fn forward_i(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                (*__this).next_ = <ACE_Map_Entry_void____unsigned_long_>::next_sefcfc7bde2e9b4e4(
                    (::core::ptr::addr_of!(
                        (* ((* (* __this).map_man_).search_structure_)
                        .wrapping_offset(((* __this).next_) as isize))
                    )) as *const ACE_Map_Entry_void____unsigned_long_,
                ...
                return ((((((*__this).next_ as libc::c_uint))
                    != (((<ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_>::occupied_list_id(
                        ((*__this).map_man_)
                            as *const ACE_Map_Manager_void____unsigned_long__ACE_Null_Mutex_,
                    )) as libc::c_uint))) as libc::c_int) as libc::c_int);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
...
impl ACE_Guard_ACE_RW_Thread_Mutex_ {
  ...
  /// lock.  If @a block is non-0 then acquire() the ACE_LOCK, else
  /// tryacquire() it.*/
    pub unsafe fn new_at_s5bc571e9fe0e17e6(
        __this: *mut Self,
        mut __a0: *mut ACE_RW_Thread_Mutex,
        mut __a1: bool,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN9ACE_GuardI19ACE_RW_Thread_MutexEC1ERS0_b"]
            fn __ext(
                __this: *mut ACE_Guard_ACE_RW_Thread_Mutex_,
                __a0: *mut ACE_RW_Thread_Mutex,
                __a1: bool,
        ...
        __ext(__this as *mut ACE_Guard_ACE_RW_Thread_Mutex_, __a0, __a1)
    }
    pub unsafe fn new_s5bc571e9fe0e17e6(
        mut __a0: *mut ACE_RW_Thread_Mutex,
        mut __a1: bool,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s5bc571e9fe0e17e6(::core::ptr::addr_of_mut!(__obj), __a0, __a1);
        __obj
    }
    /**Initialize the guard without implicitly acquiring the lock. The
  /// @a become_owner parameter indicates whether the guard should release
  ...
  /// ignored and is used here to disambiguate with the preceding
  /// constructor.*/
    pub unsafe fn new_at_s88212c8332a02683(
        __this: *mut Self,
        mut __a0: *mut ACE_RW_Thread_Mutex,
        mut __a1: bool,
        mut __a2: libc::c_int,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN9ACE_GuardI19ACE_RW_Thread_MutexEC1ERS0_bi"]
            fn __ext(
                __this: *mut ACE_Guard_ACE_RW_Thread_Mutex_,
                __a0: *mut ACE_RW_Thread_Mutex,
                __a1: bool,
        ...
        __ext(__this as *mut ACE_Guard_ACE_RW_Thread_Mutex_, __a0, __a1, __a2)
    }
    pub unsafe fn new_s88212c8332a02683(
        mut __a0: *mut ACE_RW_Thread_Mutex,
        mut __a1: bool,
        mut __a2: libc::c_int,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s88212c8332a02683(
            ::core::ptr::addr_of_mut!(__obj),
            __a0,
            __a1,
            __a2,
    ...
    pub unsafe fn tryacquire(__this: *mut Self) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN9ACE_GuardI19ACE_RW_Thread_MutexE10tryacquireEv"]
            fn __ext(__this: *mut ACE_Guard_ACE_RW_Thread_Mutex_) -> libc::c_int;
        }
        __ext(__this as *mut ACE_Guard_ACE_RW_Thread_Mutex_)
    }
    /**Relinquish ownership of the lock so that it is not released
  /// implicitly in the destructor.*/
    pub unsafe fn disown(__this: *mut Self) {
        extern "C-unwind" {
            #[link_name = "_ZN9ACE_GuardI19ACE_RW_Thread_MutexE6disownEv"]
            fn __ext(__this: *mut ACE_Guard_ACE_RW_Thread_Mutex_);
        }
        __ext(__this as *mut ACE_Guard_ACE_RW_Thread_Mutex_)
    }
    ///Explicitly remove the lock.
    pub unsafe fn remove(__this: *mut Self) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN9ACE_GuardI19ACE_RW_Thread_MutexE6removeEv"]
            fn __ext(__this: *mut ACE_Guard_ACE_RW_Thread_Mutex_) -> libc::c_int;
        }
        __ext(__this as *mut ACE_Guard_ACE_RW_Thread_Mutex_)
    }
    ...
    pub unsafe fn dump(__this: *const Self) {
        extern "C-unwind" {
            #[link_name = "_ZNK9ACE_GuardI19ACE_RW_Thread_MutexE4dumpEv"]
            fn __ext(__this: *const ACE_Guard_ACE_RW_Thread_Mutex_);
        }
        __ext(__this as *const ACE_Guard_ACE_RW_Thread_Mutex_)
    }
    ///Helper, meant for subclass only.
    pub unsafe fn new_at_sb5b35a9e6045c43b(
        ...
        unsafe {
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).lock_),
                ((lock) as *mut ACE_RW_Thread_Mutex),
            );
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).owner_), 0);
            {}
            ()
    ...
    pub unsafe fn operator_assign(
        __this: *mut Self,
        mut _anon_0: *mut ACE_Guard_ACE_RW_Thread_Mutex_,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN9ACE_GuardI19ACE_RW_Thread_MutexEaSERKS1_"]
            fn __ext(
                __this: *mut ACE_Guard_ACE_RW_Thread_Mutex_,
                _anon_0: *mut ACE_Guard_ACE_RW_Thread_Mutex_,
            );
        }
        __ext(__this as *mut ACE_Guard_ACE_RW_Thread_Mutex_, _anon_0)
    }
    pub unsafe fn new_at_sd89ddd31fb292c03(
        __this: *mut Self,
        mut __a0: *const ACE_Guard_ACE_RW_Thread_Mutex_,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN9ACE_GuardI19ACE_RW_Thread_MutexEC1ERKS1_"]
            fn __ext(
                __this: *mut ACE_Guard_ACE_RW_Thread_Mutex_,
                __a0: *const ACE_Guard_ACE_RW_Thread_Mutex_,
            );
        }
        __ext(__this as *mut ACE_Guard_ACE_RW_Thread_Mutex_, __a0)
    }
    pub unsafe fn new_sd89ddd31fb292c03(
        mut __a0: *const ACE_Guard_ACE_RW_Thread_Mutex_,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_sd89ddd31fb292c03(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    ///Explicitly acquire the lock.
    pub unsafe fn acquire(__this: *mut Self) -> libc::c_int {
...
pub static __TYPEINFO_28ACE_Based_Pointer_Repository: crate::__cxx_std::TypeInfo = crate::__cxx_std::TypeInfo {
    __name: b"28ACE_Based_Pointer_Repository\0".as_ptr() as *const libc::c_char,
};
...
pub unsafe fn __vthunk_ou576316b46de1f8f8_iucaae14a381d74b6a(
...
pub static __VTBL_u222e6f3b64630094: __Vtbl_u222e6f3b64630094 = __Vtbl_u222e6f3b64630094 {
    ...
    vfn_ucaae14a381d74b6a: __vthunk_ou576316b46de1f8f8_iucaae14a381d74b6a,
};
