...
#[export_name = "_ZNK10ACE_IO_SAP6enableEi"]
pub unsafe extern "C-unwind" fn __xtu__ZNK10ACE_IO_SAP6enableEi(
    __this: *const ACE_IO_SAP,
    value: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_IO_SAP::enable(__this, value) }
}
#[export_name = "_ZNK10ACE_IO_SAP7disableEi"]
pub unsafe extern "C-unwind" fn __xtu__ZNK10ACE_IO_SAP7disableEi(
    __this: *const ACE_IO_SAP,
    value: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_IO_SAP::disable(__this, value) }
}
#[export_name = "_ZNK10ACE_IO_SAP4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK10ACE_IO_SAP4dumpEv(
    __this: *const ACE_IO_SAP,
) {
    unsafe { ACE_IO_SAP::dump(__this) }
}
#[export_name = "_ZN10ACE_IO_SAPC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN10ACE_IO_SAPC1Ev(__this: *mut ACE_IO_SAP) {
    ACE_IO_SAP::new_at(__this)
}
extern "C-unwind" {
