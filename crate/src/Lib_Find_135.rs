...
pub mod ACE {
    #[doc = "* Finds the file @a filename either using an absolute path or using\n   * a relative path in conjunction with ACE_LD_SEARCH_PATH (e.g.,\n   * $LD_LIBRARY_PATH on UNIX or the directories scanned by Win32 API\n   * SearchPath on Win32).  This function will add appropriate suffix\n   * (e.g., .dll on Win32 or .so on UNIX) according to the OS\n   * platform.  In addition, this function will apply the appropriate\n   * prefix (e.g., \"lib\" on UNIX and \"\" on Win32) if the @a filename\n   * doesn't match directly."]
    #[export_name = "_ZN3ACE6ldfindEPKcPcm"]
    pub unsafe extern "C-unwind" fn ldfind(
        mut filename: *const libc::c_char,
        mut pathname: *mut libc::c_char,
        mut maxpathnamelen: libc::c_ulong,
    ) -> libc::c_int {
        unsafe {
            {
                let mut tempcopy: [libc::c_char; 4097usize] = unsafe {
                    ::core::mem::zeroed()
                };
                let mut searchpathname: [libc::c_char; 4097usize] = unsafe {
                    ::core::mem::zeroed()
                };
                let mut searchfilename: [libc::c_char; 4097usize] = unsafe {
                    ::core::mem::zeroed()
                };
                if ((((((((super::ACE_OS::strlen_u07dd12a225364fa6(
                    ((filename) as *const libc::c_char),
                )) as libc::c_ulong))
                    .wrapping_add((1) as libc::c_ulong) as libc::c_ulong))
                    > (((((((::core::mem::size_of::<[libc::c_char; 4097usize]>()
                        as libc::c_ulong) as libc::c_ulong)) / ((1) as libc::c_ulong)))
                        as libc::c_ulong))) as libc::c_int as libc::c_int) != 0)
                {
                    ((*(super::__errno_location()))) = 12;
                    return (-((1) as libc::c_int));
                } else {
                    super::ACE_OS::strcpy_u08e8184bcebbac89(
                        ((tempcopy).as_mut_ptr() as *mut libc::c_char),
                        ((filename) as *const libc::c_char),
                    );
                }
                let mut separator_ptr: *mut libc::c_char = unsafe {
                    ::core::mem::zeroed()
                };
                separator_ptr = ((super::ACE_OS::strrchr_ud9ed4b42142d6283(
                    ((tempcopy).as_mut_ptr() as *mut libc::c_char),
                    ((47 as libc::c_char) as libc::c_int),
                )) as *mut libc::c_char);
                if (((((separator_ptr).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    (searchpathname)[(0) as usize] = ((0 as libc::c_char)
                        as libc::c_char);
                    super::ACE_OS::strcpy_u08e8184bcebbac89(
                        ((searchfilename).as_mut_ptr() as *mut libc::c_char),
                        ((tempcopy).as_ptr() as *const libc::c_char),
                    );
                } else {
                    super::ACE_OS::strcpy_u08e8184bcebbac89(
                        ((searchfilename).as_mut_ptr() as *mut libc::c_char),
                        (((separator_ptr).wrapping_offset((1) as isize))
                            as *const libc::c_char),
                    );
                    (*(separator_ptr).wrapping_offset((1) as isize)) = ((0
                        as libc::c_char) as libc::c_char);
                    super::ACE_OS::strcpy_u08e8184bcebbac89(
                        ((searchpathname).as_mut_ptr() as *mut libc::c_char),
                        ((tempcopy).as_ptr() as *const libc::c_char),
                    );
                }
                let mut has_suffix: bool = false;
                let mut s: *mut libc::c_char = ((super::ACE_OS::strrchr_ud9ed4b42142d6283(
                    ((searchfilename).as_mut_ptr() as *mut libc::c_char),
                    ((46 as libc::c_char) as libc::c_int),
                )) as *mut libc::c_char);
                let mut dll_suffix: *const libc::c_char = b".so\0".as_ptr()
                    as *const libc::c_char;
                if ((((!(s).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    has_suffix = true;
                    if (((((super::ACE_OS::strcmp_u2f671283fc8b6d4a(
                        ((s) as *const libc::c_char),
                        ((dll_suffix) as *const libc::c_char),
                                ...
                                {
                                    {
                                        ...
                                        <super::ACE_Log_Category_TSS>::conditional_set(
                                            ...
                                            ((b"/build/ace_full/src/ACE/ace/Lib_Find.cpp\0".as_ptr()
                                        ...
                                        <super::ACE_Log_Category_TSS>::log(
                                            (ace___) as *mut super::ACE_Log_Category_TSS,
                                            super::LM_WARNING,
                                            ((b"Warning: improper suffix for a shared library on this platform: %s\n\0"
                ...
                if (((((((((((super::ACE_OS::strlen_u07dd12a225364fa6(
                    ((searchfilename).as_ptr() as *const libc::c_char),
                )) as libc::c_ulong))
                    .wrapping_add(
                        (super::ACE_OS::strlen_u07dd12a225364fa6(
                            ((b"lib\0".as_ptr() as *const libc::c_char)
                                as *const libc::c_char),
                        )) as libc::c_ulong,
                    )) as libc::c_ulong))
                    .wrapping_add(
                        ((if ((has_suffix as libc::c_int) != 0) {
                            ((0) as libc::c_ulong)
                        } else {
                            super::ACE_OS::strlen_u07dd12a225364fa6(
                                ((dll_suffix) as *const libc::c_char),
                ...
                if (((((super::ACE_OS::strlen_u07dd12a225364fa6(
                    ((searchpathname).as_ptr() as *const libc::c_char),
                    ...
                    as libc::c_int) != 0)
                {
                    if ((((((((super::ACE_OS::strlen_u07dd12a225364fa6(
                        ...
                        ) as libc::c_ulong)) >= (((maxpathnamelen) as libc::c_ulong)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        ...
                        if (((((super::ACE_OS::access_ud59681e785d3d49a(
                        ...
                        super::ACE_OS::snprintf_u9a28649a3b771eeb(
                            ((pathname) as *mut libc::c_char),
                            maxpathnamelen,
                            ((b"%s%s%s%s\0".as_ptr() as *const libc::c_char)
                                as *const libc::c_char),
                            ((searchpathname).as_mut_ptr() as *mut libc::c_char),
                            b"lib\0".as_ptr() as *const libc::c_char,
                            ((searchfilename).as_mut_ptr() as *mut libc::c_char),
                    ...
                    let mut ld_path: *mut libc::c_char = ((0) as *mut libc::c_char);
                    ld_path = ((super::ACE_OS::getenv_u25dce132a786d601(
                        ((b"LD_LIBRARY_PATH\0".as_ptr() as *const libc::c_char)
                            as *const libc::c_char),
                    )) as *mut libc::c_char);
                    if ((((((((!(ld_path).is_null()) as libc::c_int) as libc::c_int)
                        != 0)
                        && ((((!(({
                            let __v = ((super::ACE_OS::strdup_u8b6a84c4b070659c(
                                ((ld_path) as *const libc::c_char),
                            )) as *mut libc::c_char);
                            ld_path = __v;
                            __v
                        }))
                        ...
                        as libc::c_int) as libc::c_int) != 0)
                    {
                        let mut nextholder: *mut libc::c_char = ((0)
                            as *mut libc::c_char);
                        let mut path_entry: *const libc::c_char = ((strsplit_r(
                            ((ld_path) as *mut libc::c_char),
                            ((b":\0".as_ptr() as *const libc::c_char)
                                as *const libc::c_char),
                            ::core::ptr::addr_of_mut!(nextholder),
                        )) as *const libc::c_char);
                        let mut result: libc::c_int = 0;
                        {
                            'for_1: loop {
                                'cont_1: loop {
                                    {
                                        {
                                            if (((((path_entry).is_null()) as libc::c_int)
                                                as libc::c_int) != 0)
                                            {
                                                ((*(super::__errno_location()))) = 2;
                                                result = (-((1) as libc::c_int));
                                                break 'for_1;
                                            } else {
                                                if (((((((((((super::ACE_OS::strlen_u07dd12a225364fa6(
                                                    ((path_entry) as *const libc::c_char),
                                                )) as libc::c_ulong))
                                                    .wrapping_add((1) as libc::c_ulong)) as libc::c_ulong))
                                                    .wrapping_add(
                                                        (super::ACE_OS::strlen_u07dd12a225364fa6(
                                                    ...
                                                    >= (((maxpathnamelen) as libc::c_ulong))) as libc::c_int
                                                    as libc::c_int) != 0)
                                                {
                                                    ((*(super::__errno_location()))) = 12;
                                                    result = (-((1) as libc::c_int));
                                                    ...
                                                    if ((((((*(path_entry).wrapping_offset((0) as isize))
                                                        as libc::c_int as libc::c_char))
                                                        == (((0 as libc::c_char) as libc::c_int as libc::c_char)))
                                                        as libc::c_int as libc::c_int) != 0)
                                                    {
                                                        path_entry = b".\0".as_ptr() as *const libc::c_char;
                                                    }
                                                }
                                            }
                                            super::ACE_OS::snprintf_u9a28649a3b771eeb(
                                                ((pathname) as *mut libc::c_char),
                                                maxpathnamelen,
                                                ((b"%s%c%s%s\0".as_ptr() as *const libc::c_char)
                                                    as *const libc::c_char),
                                                path_entry,
                                                ((47 as libc::c_char) as libc::c_int),
                                                ((searchfilename).as_mut_ptr() as *mut libc::c_char),
                                            ...
                                            super::ACE_OS::snprintf_u9a28649a3b771eeb(
                                                ((pathname) as *mut libc::c_char),
                                                maxpathnamelen,
                                                ((b"%s%c%s%s%s\0".as_ptr() as *const libc::c_char)
                                                    as *const libc::c_char),
                                                path_entry,
                                                ((47 as libc::c_char) as libc::c_int),
                                                b"lib\0".as_ptr() as *const libc::c_char,
    ...
    #[doc = "* Uses @c ldfind to locate and open the appropriate @a filename and\n   * returns a pointer to the file, else it returns a NULL\n   * pointer. @a type specifies how the file should be open."]
    #[export_name = "_ZN3ACE6ldopenEPKcS1_"]
    pub unsafe extern "C-unwind" fn ldopen(
        mut filename: *const libc::c_char,
        mut r#type: *const libc::c_char,
    ) -> *mut super::_IO_FILE {
        unsafe {
            {
                let mut buf: [libc::c_char; 4097usize] = unsafe {
                    ::core::mem::zeroed()
                };
                if (((((ldfind(
                    filename,
                    ...
                    as libc::c_int as libc::c_int) != 0)
                {
                    return ((0) as *mut super::_IO_FILE);
                } else {
                    return super::ACE_OS::fopen_ua6d43bbd3a566b87(
                        ((buf).as_ptr() as *const libc::c_char),
                        ((r#type) as *const libc::c_char),
                    );
                }
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
    ...
    #[doc = "* Transforms @a entry_point into a form that can be located in a\n   * dynamic library using <dlsym>. For example, with Win32/Borland\n   * extern \"C\" functions which use the default calling convention\n   * have a '_' prepended. Always returns a buffer that has been\n   * dynamically allocated using <operator new>."]
    #[export_name = "_ZN3ACE6ldnameEPKc"]
    pub unsafe extern "C-unwind" fn ldname(
        mut entry_point: *const libc::c_char,
    ) -> *mut libc::c_char {
        unsafe {
            {
                let mut size: libc::c_ulong = (((super::ACE_OS::strlen_u07dd12a225364fa6(
                    ((entry_point) as *const libc::c_char),
                )) as libc::c_ulong))
                    .wrapping_add((1) as libc::c_ulong);
                let mut new_name: *mut libc::c_char = unsafe { ::core::mem::zeroed() };
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            {
                                ...
                                if (((((new_name).is_null()) as libc::c_int) as libc::c_int)
                                    != 0)
                                {
                                    ((*(super::__errno_location()))) = 12;
    ...
    #[doc = "* Returns the temporary directory including the trailing slash in\n   * @a buffer.  Returns -1 for an error or if the buffer_len is not\n   * long enough."]
    #[export_name = "_ZN3ACE12get_temp_dirEPcm"]
    pub unsafe extern "C-unwind" fn get_temp_dir(
        mut buffer: *mut libc::c_char,
        mut buffer_len: libc::c_ulong,
    ) -> libc::c_int {
        unsafe {
            {
                let mut result: libc::c_int = unsafe { ::core::mem::zeroed() };
                let mut tmpdir: *const libc::c_char = ((super::ACE_OS::getenv_u25dce132a786d601(
                    ((b"TMPDIR\0".as_ptr() as *const libc::c_char)
                        as *const libc::c_char),
                )) as *const libc::c_char);
                if (((((tmpdir).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    tmpdir = b"/tmp\0".as_ptr() as *const libc::c_char;
                }
                let mut len: libc::c_ulong = super::ACE_OS::strlen_u07dd12a225364fa6(
                    tmpdir,
                );
                if (((((((((len) as libc::c_ulong)).wrapping_add((2) as libc::c_ulong))
                    as libc::c_ulong)) > (((buffer_len) as libc::c_ulong)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    result = (-((1) as libc::c_int));
                } else {
                    ...
                    (*(buffer).wrapping_offset((len) as isize)) = ((47 as libc::c_char)
                        as libc::c_char);
                    (*(buffer)
                        .wrapping_offset(
                            ((((len) as libc::c_ulong))
  ...
  /// closed.  This is useful for have temp files.*/
    #[export_name = "_ZN3ACE14open_temp_fileEPKcii"]
    pub unsafe extern "C-unwind" fn open_temp_file(
        ...
        unsafe {
            {
                let mut handle: libc::c_int = super::ACE_OS::open_u20e73ad42bc94ee0(
                ...
                if (((((super::ACE_OS::unlink_ucc448fde77c19cbd(
                    ((name) as *const libc::c_char),
                ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    super::ACE_OS::close_u07c1eb6343f8c667(handle);
                    return (((-((1) as libc::c_int))) as libc::c_int);
                } else {
                    return handle;
                }
  ...
  /// the number of replacements made.*/
    #[export_name = "_ZN3ACE7strreplEPccc"]
    pub unsafe extern "C-unwind" fn strrepl(
        mut s: *mut libc::c_char,
        mut search: libc::c_char,
        mut replace: libc::c_char,
    ) -> libc::c_ulong {
        unsafe {
            {
                let mut replaced: libc::c_ulong = ((0) as libc::c_ulong);
                {
                    let mut i: libc::c_ulong = ((0) as libc::c_ulong);
                    'for_0: loop {
                        if !(((((((*(s).wrapping_offset((i) as isize)) as libc::c_int
                            as libc::c_char))
                            != (((0 as libc::c_char) as libc::c_int as libc::c_char)))
                            as libc::c_int as libc::c_int) != 0))
                        {
                        ...
                        'cont_0: loop {
                            {
                                if ((((((*(s).wrapping_offset((i) as isize)) as libc::c_int
                                    as libc::c_char))
                                    == (((search) as libc::c_int as libc::c_char)))
                                    as libc::c_int as libc::c_int) != 0)
                                {
                                    (*(s).wrapping_offset((i) as isize)) = replace;
                                    {
                                        let __lv = &mut (replaced);
    ...
    #[doc = "* Splits string @a s into pieces separated by the string @a token.\n   * @a next_start is an opaque cookie handed back by the call to store\n   * its state for the next invocation, thus making it re-entrant.\n   * This operates very similar to Perl's @c split function except that\n   * it returns pieces one at a time instead of into an array."]
    #[export_name = "_ZN3ACE10strsplit_rEPcPKcRS0_"]
    pub unsafe extern "C-unwind" fn strsplit_r(
        mut str: *mut libc::c_char,
        mut token: *const libc::c_char,
        mut next_start: *mut *mut libc::c_char,
    ) -> *mut libc::c_char {
        unsafe {
            {
                let mut result: *mut libc::c_char = ((0) as *mut libc::c_char);
                if ((((!(str).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    (*next_start) = str;
                }
                if ((((!((*next_start)).is_null()) as libc::c_int) as libc::c_int) != 0)
                {
                    let mut tok_loc: *mut libc::c_char = super::ACE_OS::strstr_u25e13fe23ca4c804(
                        (*next_start),
                        token,
                    );
                    if ((((!(tok_loc).is_null()) as libc::c_int) as libc::c_int) != 0) {
                        result = (*next_start);
                        (*(tok_loc)) = 0 as libc::c_char;
                        (*next_start) = (tok_loc)
                            .wrapping_offset(
                                (super::ACE_OS::strlen_u07dd12a225364fa6(token)) as isize,
                            );
                    } else {
                        result = (*next_start);
                        (*next_start) = (0 as *mut libc::c_char);
                    }
                }
                return result;
            }
    ...
    #[export_name = "_ZN3ACE7strreplEPwww"]
    pub unsafe extern "C-unwind" fn strrepl_u65535d728da90bba(
        mut s: *mut libc::wchar_t,
        mut search: libc::wchar_t,
        mut replace: libc::wchar_t,
    ) -> libc::c_ulong {
        unsafe {
            {
                let mut replaced: libc::c_ulong = ((0) as libc::c_ulong);
                {
                    let mut i: libc::c_ulong = ((0) as libc::c_ulong);
                    'for_0: loop {
                        if !(((((((*(s).wrapping_offset((i) as isize)) as libc::wchar_t))
                        ...
                        'cont_0: loop {
                            {
                                if ((((((*(s).wrapping_offset((i) as isize))
                                    as libc::wchar_t)) == (((search) as libc::wchar_t)))
                                    as libc::c_int as libc::c_int) != 0)
                                {
                                    (*(s).wrapping_offset((i) as isize)) = replace;
                                    {
    ...
    #[export_name = "_ZN3ACE10strsplit_rEPwPKwRS0_"]
    pub unsafe extern "C-unwind" fn strsplit_r_uff181bcf52540678(
        mut str: *mut libc::wchar_t,
        mut token: *const libc::wchar_t,
        mut next_start: *mut *mut libc::wchar_t,
    ) -> *mut libc::wchar_t {
        unsafe {
            {
                let mut result: *mut libc::wchar_t = ((0) as *mut libc::wchar_t);
                if ((((!(str).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    (*next_start) = str;
                }
                if ((((!((*next_start)).is_null()) as libc::c_int) as libc::c_int) != 0)
                {
                    let mut tok_loc: *mut libc::wchar_t = super::ACE_OS::strstr_ud415c256dd1973d4(
                        (*next_start),
                        token,
                    );
                    if ((((!(tok_loc).is_null()) as libc::c_int) as libc::c_int) != 0) {
                        result = (*next_start);
                        (*(tok_loc)) = ((0 as libc::c_char) as libc::wchar_t);
                        (*next_start) = (tok_loc)
                            .wrapping_offset(
                                (super::ACE_OS::strlen_u07b44aa22513a9ba(token)) as isize,
                            );
                    } else {
                        result = (*next_start);
                        (*next_start) = (0 as *mut libc::wchar_t);
                    }
                }
                return result;
            }
