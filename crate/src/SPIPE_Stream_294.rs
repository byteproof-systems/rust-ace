...
#[export_name = "_ZN16ACE_SPIPE_StreamC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_SPIPE_StreamC1Ev(
    __this: *mut ACE_SPIPE_Stream,
) {
    ACE_SPIPE_Stream::new_at(__this)
}
#[export_name = "_ZNK16ACE_SPIPE_Stream4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK16ACE_SPIPE_Stream4dumpEv(
    __this: *const ACE_SPIPE_Stream,
) {
    unsafe { ACE_SPIPE_Stream::dump(__this) }
}
extern "C-unwind" {
...
impl ACE_SPIPE_Stream {
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ...
            <ACE_SPIPE_Addr>::new_at(
                ::core::ptr::addr_of_mut!((* __this).remote_addr_)
                    .cast::<ACE_SPIPE_Addr>(),
            );
            {}
            ()
    ...
    #[export_name = "_ZNK16ACE_SPIPE_Stream4sendEmz"]
    pub unsafe extern "C-unwind" fn send_u87a10e8ab56b4607(
        __this: *const Self,
        mut n: libc::c_ulong,
        mut __args: ...
    ) -> libc::c_long {
    ...
    #[export_name = "_ZNK16ACE_SPIPE_Stream4recvEmz"]
    pub unsafe extern "C-unwind" fn recv_uffa4354b34f6fc15(
        __this: *const Self,
        mut n: libc::c_ulong,
        mut __args: ...
    ) -> libc::c_long {
