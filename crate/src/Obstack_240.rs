...
#[export_name = "_ZN13ACE_Obstack_TIcE9new_chunkEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_Obstack_TIcE9new_chunkEv(
    __this: *mut ACE_Obstack_T_char_,
) -> *mut ACE_Obchunk {
    unsafe { ACE_Obstack_T_char_::new_chunk(__this) }
}
#[export_name = "_ZN13ACE_Obstack_TIcE7requestEm"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_Obstack_TIcE7requestEm(
    __this: *mut ACE_Obstack_T_char_,
    len: libc::c_ulong,
) -> libc::c_int {
    unsafe { ACE_Obstack_T_char_::request(__this, len) }
}
#[export_name = "_ZN13ACE_Obstack_TIcE6freezeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_Obstack_TIcE6freezeEv(
    __this: *mut ACE_Obstack_T_char_,
) -> *mut libc::c_char {
    unsafe { ACE_Obstack_T_char_::freeze(__this) }
}
#[export_name = "_ZN13ACE_Obstack_TIcE4copyEPKcm"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_Obstack_TIcE4copyEPKcm(
    __this: *mut ACE_Obstack_T_char_,
    s: *const libc::c_char,
    len: libc::c_ulong,
) -> *mut libc::c_char {
    unsafe { ACE_Obstack_T_char_::copy(__this, s, len) }
}
#[export_name = "_ZNK13ACE_Obstack_TIcE4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_Obstack_TIcE4dumpEv(
    __this: *const ACE_Obstack_T_char_,
) {
    unsafe { ACE_Obstack_T_char_::dump(__this) }
}
#[export_name = "_ZN13ACE_Obstack_TIcE4growEc"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_Obstack_TIcE4growEc(
    __this: *mut ACE_Obstack_T_char_,
    c: libc::c_char,
) -> *mut libc::c_char {
    unsafe { ACE_Obstack_T_char_::grow(__this, c) }
}
#[export_name = "_ZN13ACE_Obstack_TIcE9grow_fastEc"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_Obstack_TIcE9grow_fastEc(
    __this: *mut ACE_Obstack_T_char_,
    c: libc::c_char,
) {
    unsafe { ACE_Obstack_T_char_::grow_fast(__this, c) }
}
#[export_name = "_ZN13ACE_Obstack_TIcE7releaseEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_Obstack_TIcE7releaseEv(
    __this: *mut ACE_Obstack_T_char_,
) {
    unsafe { ACE_Obstack_T_char_::release(__this) }
}
#[export_name = "_ZN13ACE_Obstack_TIcE8unwind_iEPv"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_Obstack_TIcE8unwind_iEPv(
    __this: *mut ACE_Obstack_T_char_,
    obj: *mut libc::c_void,
) {
    unsafe { ACE_Obstack_T_char_::unwind_i(__this, obj) }
}
#[export_name = "_ZN13ACE_Obstack_TIcE6unwindEPv"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_Obstack_TIcE6unwindEPv(
    __this: *mut ACE_Obstack_T_char_,
    obj: *mut libc::c_void,
) {
    unsafe { ACE_Obstack_T_char_::unwind(__this, obj) }
}
impl Drop for ACE_Obstack_T_char_ {
    fn drop(&mut self) {
        unsafe {
            let __this: *mut Self = self as *mut Self;
            {
                let mut temp: *mut ACE_Obchunk = (((*__this).head_) as *mut ACE_Obchunk);
                'while_0: loop {
                    ...
                    'cont_0: loop {
                        {
                            {
                                let mut next: *mut ACE_Obchunk = (*temp).next_;
                                (*temp).next_ = ((0) as *mut ACE_Obchunk);
                                {
...
#[export_name = "__acedtor_u0fe96d850f7bbe63"]
pub unsafe extern "C-unwind" fn __acedtor_u0fe96d850f7bbe63(
    __this: *mut ACE_Obstack_T_char_,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[export_name = "_ZN13ACE_Obstack_TIcEC1EmP13ACE_Allocator"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_Obstack_TIcEC1EmP13ACE_Allocator(
    __this: *mut ACE_Obstack_T_char_,
    __a0: libc::c_ulong,
    __a1: *mut ACE_Allocator,
) {
    ACE_Obstack_T_char_::new_at_se16342d999bb447e(__this, __a0, __a1)
}
...
impl ACE_Obstack_T_char_ {
    pub unsafe fn new_chunk(__this: *mut Self) -> *mut ACE_Obchunk {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut temp: *mut ACE_Obchunk = ((0) as *mut ACE_Obchunk);
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            {
                                temp = ({
                                    ...
                                    ((*__vt)
                                        ...
                                        __obj,
                                        (((((40) as libc::c_ulong))
                                            .wrapping_add(((*__this).size_) as libc::c_ulong))
                                            as libc::c_ulong),
                                    )
                                } as *mut ACE_Obchunk);
                                ...
                                {
                                    ((*(__errno_location()))) = 12;
                                    return ((0) as *mut ACE_Obchunk);
                                } else {
                                    {
                                        let _ = {
                                            let __place: *mut ACE_Obchunk = (temp) as *mut ACE_Obchunk;
                                            <ACE_Obchunk>::new_at(
                                                (__place) as *mut ACE_Obchunk,
                                                (*__this).size_,
                                            );
                                            __place
                                        };
                ...
                return ((temp) as *mut ACE_Obchunk);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    pub unsafe fn request(__this: *mut Self, mut len: libc::c_ulong) -> libc::c_int {
        unsafe {
            ...
            {
                {
                    len = (((len) as libc::c_ulong)).wrapping_mul((1) as libc::c_ulong);
                    len
                };
                let mut resulting_len: libc::c_ulong = (((((((*(*__this).curr_).cur_)
                    .offset_from((*(*__this).curr_).block_)) as libc::c_long))
                    as libc::c_ulong))
                    .wrapping_add((len) as libc::c_ulong);
                if ((((((*__this).size_ as libc::c_ulong))
                    < (((resulting_len) as libc::c_ulong))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    (*__this).size_ = ((((*__this).size_) as libc::c_ulong))
                        .wrapping_shl((1) as u32);
                }
                if ((((((((*(*__this).curr_).cur_).wrapping_offset((len) as isize))
                    as *const u8)) >= ((((*(*__this).curr_).end_) as *const u8)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    let mut temp: *mut ACE_Obchunk = (((*__this).curr_)
                        as *mut ACE_Obchunk);
                    if ((((((*(*__this).curr_).next_).is_null()) as libc::c_int)
                        as libc::c_int) != 0)
                    {
                        let mut tmp: *mut ACE_Obchunk = ((<ACE_Obstack_T_char_>::new_chunk(
                            (__this) as *mut ACE_Obstack_T_char_,
                        )) as *mut ACE_Obchunk);
                        if (((!((!(tmp).is_null())) as libc::c_int) as libc::c_int) != 0)
                        {
                            return (-((1) as libc::c_int));
                        }
                        (*(*__this).curr_).next_ = tmp;
                        (*__this).curr_ = (((*(*__this).curr_).next_)
                            as *mut ACE_Obchunk);
                    } else {
                        (*__this).curr_ = (((*(*__this).curr_).next_)
                            as *mut ACE_Obchunk);
                        (*(*__this).curr_).block_ = {
                            let __v = (((*(*__this).curr_).contents_).as_mut_ptr()
                                as *mut libc::c_char);
                            (*(*__this).curr_).cur_ = __v;
                            __v
                        };
                    }
                    if (((((((*temp).cur_) as *const u8))
                        != ((((*temp).block_) as *const u8))) as libc::c_int
                        as libc::c_int) != 0)
                    {
                        let mut datasize: libc::c_ulong = (((((*temp).cur_)
                            .offset_from((*temp).block_)) as libc::c_long)
                            as libc::c_ulong);
                        ACE_OS::memcpy_u6033eb81edaf9212(
                            (((*(*__this).curr_).block_) as *mut libc::c_void),
                            (((*temp).block_) as *const libc::c_void),
                            datasize,
                        );
                        (*(*__this).curr_).cur_ = ((*(*__this).curr_).block_)
                            .wrapping_offset((datasize) as isize);
    ...
    pub unsafe fn freeze(__this: *mut Self) -> *mut libc::c_char {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut retv: *mut libc::c_char = ((*(*__this).curr_).block_
                    as *mut libc::c_char);
                (*((((*(*__this).curr_).cur_ as *mut libc::c_char)))) = ((0)
                    as libc::c_char);
                {
                    let __lv = ::core::ptr::addr_of_mut!((* (* __this).curr_).cur_);
                    unsafe {
                        *__lv = ((*__lv)).wrapping_offset((1) as isize);
                        *__lv
                    }
                };
                (*(*__this).curr_).block_ = (*(*__this).curr_).cur_;
                return retv;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    ...
    pub unsafe fn copy(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((((<ACE_Obstack_T_char_>::request(
                    (__this) as *mut ACE_Obstack_T_char_,
                    len,
                ) as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                ...
                let mut tsize: libc::c_ulong = (((((len) as libc::c_ulong))
                    .wrapping_mul((1) as libc::c_ulong)) as libc::c_ulong);
                ACE_OS::memcpy_u6033eb81edaf9212(
                    (((*(*__this).curr_).cur_) as *mut libc::c_void),
                ...
                );
                {
                    let __lv = ::core::ptr::addr_of_mut!((* (* __this).curr_).cur_);
                    unsafe {
                        *__lv = ((*__lv)).wrapping_offset((tsize) as isize);
                        *__lv
                    }
                };
                return <ACE_Obstack_T_char_>::freeze(
                    (__this) as *mut ACE_Obstack_T_char_,
                );
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((((<ACE_Obstack_T_char_>::request(
                    ...
                    as libc::c_int) != 0)
                {
                    let mut retv: *mut libc::c_char = ((*(*__this).curr_).cur_
                        as *mut libc::c_char);
                    {
                        let __lv = ::core::ptr::addr_of_mut!((* (* __this).curr_).cur_);
                        unsafe {
    ...
    pub unsafe fn grow_fast(__this: *mut Self, mut c: libc::c_char) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                (*((((*(*__this).curr_).cur_ as *mut libc::c_char)))) = c;
                {
                    let __lv = ::core::ptr::addr_of_mut!((* (* __this).curr_).cur_);
                    unsafe {
                        *__lv = ((*__lv)).wrapping_offset((1) as isize);
    ...
    pub unsafe fn unwind_i(__this: *mut Self, mut obj: *mut libc::c_void) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut curr: *mut ACE_Obchunk = (((*__this).head_) as *mut ACE_Obchunk);
                'while_0: loop {
                    if !(((((((((!(curr).is_null()) as libc::c_int) as libc::c_int) != 0)
                        && ((((((((((((*curr).contents_).as_ptr() as *mut libc::c_void))
                            > (obj)) as libc::c_int as libc::c_int) != 0)
                            || (((((((*curr).end_) as *const u8))
                                < (((((obj) as *mut libc::c_char)) as *const u8)))
                ...
                if (!(curr).is_null()) {
                    (*__this).curr_ = ((curr) as *mut ACE_Obchunk);
                    (*(*__this).curr_).block_ = {
                        let __v = (obj as *mut libc::c_char);
                        (*(*__this).curr_).cur_ = __v;
                        __v
                    };
                } else {
                    if ((((!(obj).is_null()) as libc::c_int) as libc::c_int) != 0) {
                        'dowhile_1: loop {
                            'cont_1: loop {
                                {
                                    {
                                        ...
                                        <ACE_Log_Category_TSS>::conditional_set(
                                            ...
                                            ((b"/build/ace_full/src/ACE/ace/Obstack_T.cpp\0".as_ptr()
                                        ...
                                        <ACE_Log_Category_TSS>::log(
                                            (ace___) as *mut ACE_Log_Category_TSS,
                                            LM_ERROR,
                                            ((b"Deletion of non-existent object.\n%a\0".as_ptr()
                                                as *const libc::c_char) as *const libc::c_char),
                                        );
                                    }
                                }
    ...
    pub unsafe fn unwind(__this: *mut Self, mut obj: *mut libc::c_void) {
        unsafe {
            ...
            {
                if ((((((((obj)
                    >= ((((*(*__this).curr_).contents_).as_ptr() as *mut libc::c_void)))
                    as libc::c_int as libc::c_int) != 0)
                    && ((((((obj) as *const u8))
                        < ((((((*(*__this).curr_).end_) as *mut libc::c_void))
    ...
    pub unsafe fn new_at_se16342d999bb447e(
        ...
        unsafe {
            ...
            ::core::ptr::write(
                ...
                ((0) as *mut ACE_Obchunk),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).curr_),
                ((0) as *mut ACE_Obchunk),
            );
            {
                ...
                (*__this).head_ = <ACE_Obstack_T_char_>::new_chunk(
                    (__this) as *mut ACE_Obstack_T_char_,
                );
                (*__this).curr_ = (*__this).head_;
            }
