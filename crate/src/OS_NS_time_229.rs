...
pub mod ACE_OS {
    ...
    #[export_name = "_ZN6ACE_OS11localtime_rEPKlP2tm"]
    pub unsafe extern "C-unwind" fn localtime_r_u00ea56666aff6d11(
        mut t: *const libc::c_long,
        mut res: *mut super::tm,
    ) -> *mut super::tm {
        unsafe {
            {
                return super::ace_localtime_r_helper(t, res);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    #[export_name = "_ZN6ACE_OS6mktimeEP2tm"]
    pub unsafe extern "C-unwind" fn mktime_ua30f0b21ba95e4f3(
        mut t: *mut super::tm,
    ) -> libc::c_long {
        unsafe {
            {
                let mut ace_os_guard__: super::ACE_OS_Thread_Mutex_Guard = ::core::mem::MaybeUninit::<
                    super::ACE_OS_Thread_Mutex_Guard,
                >::zeroed()
                    .assume_init();
                <super::ACE_OS_Thread_Mutex_Guard>::new_at(
                    (::core::ptr::addr_of_mut!(ace_os_guard__))
                        as *mut super::ACE_OS_Thread_Mutex_Guard,
                    ((super::ACE_OS_Object_Manager_preallocated_object)[(super::ACE_OS_MONITOR_LOCK)
                        as usize] as *mut super::pthread_mutex_t),
                );
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            return ((super::mktime(t)) as libc::c_long);
                        }
