...
impl Clone for ACE_String_Base_char_ {
    #[inline]
    fn clone(&self) -> Self {
        unsafe { Self::new_sabcff583f5288c57(self as *const Self) }
    }
}
...
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_String_BaseIcE3setEPKcmb(
    __this: *mut ACE_String_Base_char_,
    s: *const libc::c_char,
    len: libc::c_ulong,
    release: bool,
) {
    unsafe { ACE_String_Base_char_::set_se7c59a7a094a3fb3(__this, s, len, release) }
}
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_String_BaseIcEC1ERKS0_(
    __this: *mut ACE_String_Base_char_,
    __a0: *const ACE_String_Base_char_,
) {
    ACE_String_Base_char_::new_at_sabcff583f5288c57(__this, __a0)
}
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_String_BaseIcE6appendEPKcm(
    __this: *mut ACE_String_Base_char_,
    s: *const libc::c_char,
    slen: libc::c_ulong,
) -> *mut ACE_String_Base_char_ {
    unsafe { ACE_String_Base_char_::append(__this, s, slen) }
}
#[export_name = "_ZN15ACE_String_BaseIcEpLEc"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_String_BaseIcEpLEc(
    __this: *mut ACE_String_Base_char_,
    c: libc::c_char,
) -> *mut ACE_String_Base_char_ {
    unsafe { ACE_String_Base_char_::operator_add_assign_s982d0a332c979fca(__this, c) }
}
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_String_BaseIcEC1EP13ACE_Allocator(
    __this: *mut ACE_String_Base_char_,
    __a0: *mut ACE_Allocator,
) {
    ACE_String_Base_char_::new_at_s89536104322d6768(__this, __a0)
}
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_String_BaseIcE3setEPKcb(
    __this: *mut ACE_String_Base_char_,
    s: *const libc::c_char,
    release: bool,
) {
    unsafe { ACE_String_Base_char_::set_se0d2578f0f93d128(__this, s, release) }
}
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_String_BaseIcEC1EPKcP13ACE_Allocatorb(
    __this: *mut ACE_String_Base_char_,
    __a0: *const libc::c_char,
    __a1: *mut ACE_Allocator,
    __a2: bool,
) {
    ACE_String_Base_char_::new_at_se5a50063ebed1e80(__this, __a0, __a1, __a2)
}
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_String_BaseIcEaSERKS0_(
    __this: *mut ACE_String_Base_char_,
    s: *const ACE_String_Base_char_,
) -> *mut ACE_String_Base_char_ {
    unsafe { ACE_String_Base_char_::operator_assign_sbd22052c3b720a46(__this, s) }
}
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_String_BaseIcEpLERKS0_(
    __this: *mut ACE_String_Base_char_,
    s: *const ACE_String_Base_char_,
) -> *mut ACE_String_Base_char_ {
    unsafe { ACE_String_Base_char_::operator_add_assign_sbd22052c3b720a46(__this, s) }
}
impl Drop for ACE_String_Base_char_ {
    fn drop(&mut self) {
        unsafe {
            let __this: *mut Self = self as *mut Self;
            {
...
pub unsafe extern "C-unwind" fn __acedtor_ub1e79022741755a6(
    __this: *mut ACE_String_Base_char_,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
pub unsafe extern "C-unwind" fn __xtu__ZN12ACE_Equal_ToI15ACE_String_BaseIcEEC1Ev(
    __this: *mut ACE_Equal_To_ACE_CString_,
) {
    ACE_Equal_To_ACE_CString_::new_at(__this)
}
///* @brief Function object for hashing a ACE_CString
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ACE_Hash_ACE_CString_ {}
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_HashI15ACE_String_BaseIcEEC1Ev(
    __this: *mut ACE_Hash_ACE_CString_,
) {
    ACE_Hash_ACE_CString_::new_at(__this)
}
...
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___ {
    pub ext_id_: ::core::mem::ManuallyDrop<ACE_String_Base_char_>,
    pub int_id_: *mut ACE_CapEntry,
    pub next_: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
    pub prev_: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
}
impl Drop for ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___ {
    fn drop(&mut self) {
        {
            unsafe {
                let __this: *mut Self = self as *mut Self;
        ...
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.ext_id_);
        }
    }
}
#[export_name = "__acedtor_ubf327eb86bec93c6"]
pub unsafe extern "C-unwind" fn __acedtor_ubf327eb86bec93c6(
    __this: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
    }
}
#[export_name = "_ZN18ACE_Hash_Map_EntryI15ACE_String_BaseIcEP12ACE_CapEntryEC1EPS4_S5_"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_Hash_Map_EntryI15ACE_String_BaseIcEP12ACE_CapEntryEC1EPS4_S5_(
    __this: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
    __a0: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
    __a1: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
) {
    ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___::new_at_s961c6805b9945fe6(
        __this,
        __a0,
        __a1,
    )
}
#[export_name = "_ZN18ACE_Hash_Map_EntryI15ACE_String_BaseIcEP12ACE_CapEntryEC1ERKS1_RKS3_PS4_S9_"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_Hash_Map_EntryI15ACE_String_BaseIcEP12ACE_CapEntryEC1ERKS1_RKS3_PS4_S9_(
    __this: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
    __a0: *const ACE_String_Base_char_,
    __a1: *const *mut ACE_CapEntry,
    __a2: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
    __a3: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
) {
    ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___::new_at_s74300038fe8e6ad1(
        __this,
        __a0,
        __a1,
        __a2,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ACE_Hash_Map_Iterator_Base_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_ {
    pub map_man_: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
    pub index_: libc::c_long,
    pub next_: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
}
#[export_name = "_ZN29ACE_Hash_Map_Iterator_Base_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE9forward_iEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN29ACE_Hash_Map_Iterator_Base_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE9forward_iEv(
    __this: *mut ACE_Hash_Map_Iterator_Base_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
) -> libc::c_int {
    unsafe {
        ACE_Hash_Map_Iterator_Base_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_::forward_i(
            __this,
        )
    }
}
#[export_name = "_ZN29ACE_Hash_Map_Iterator_Base_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexEC1ER23ACE_Hash_Map_Manager_ExIS1_S3_S5_S7_S8_Eb"]
pub unsafe extern "C-unwind" fn __xtu__ZN29ACE_Hash_Map_Iterator_Base_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexEC1ER23ACE_Hash_Map_Manager_ExIS1_S3_S5_S7_S8_Eb(
    __this: *mut ACE_Hash_Map_Iterator_Base_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
    __a0: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
    __a1: bool,
) {
    ACE_Hash_Map_Iterator_Base_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_::new_at_s4fb81f4b81430a58(
        __this,
        __a0,
        __a1,
    )
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ACE_Hash_Map_Iterator_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_ {
    pub __base_0: ACE_Hash_Map_Iterator_Base_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
}
#[export_name = "_ZN24ACE_Hash_Map_Iterator_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexEC1ER23ACE_Hash_Map_Manager_ExIS1_S3_S5_S7_S8_Ei"]
pub unsafe extern "C-unwind" fn __xtu__ZN24ACE_Hash_Map_Iterator_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexEC1ER23ACE_Hash_Map_Manager_ExIS1_S3_S5_S7_S8_Ei(
    __this: *mut ACE_Hash_Map_Iterator_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
    __a0: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
    __a1: libc::c_int,
) {
    ACE_Hash_Map_Iterator_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_::new_at_s46b0dbef5bca7a4a(
        __this,
        __a0,
        __a1,
    )
...
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_ {
    ...
    pub hash_key_: ACE_Hash_ACE_CString_,
    pub compare_keys_: ACE_Equal_To_ACE_CString_,
    pub table_: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
    pub total_size_: libc::c_ulong,
    pub cur_size_: libc::c_ulong,
}
#[export_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE12unbind_all_iEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE12unbind_all_iEv(
    __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
) -> libc::c_int {
    unsafe {
        ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_::unbind_all_i(
            __this,
        )
    }
}
#[export_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE7close_iEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE7close_iEv(
    __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
) -> libc::c_int {
    unsafe {
        ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_::close_i(
            __this,
        )
    }
}
#[export_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE14create_bucketsEm"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE14create_bucketsEm(
    __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
    size: libc::c_ulong,
) -> libc::c_int {
    unsafe {
        ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_::create_buckets(
            __this,
            size,
        )
    }
}
#[export_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE4openEmP13ACE_AllocatorSB_"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE4openEmP13ACE_AllocatorSB_(
    __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
    size: libc::c_ulong,
    ...
    unsafe {
        ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_::open(
            __this,
            size,
            table_alloc,
            entry_alloc,
...
#[export_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexEC1EP13ACE_AllocatorSB_"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexEC1EP13ACE_AllocatorSB_(
    __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
    __a0: *mut ACE_Allocator,
    __a1: *mut ACE_Allocator,
) {
    ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_::new_at_s070e196bc4421324(
        __this,
        __a0,
        __a1,
    )
}
#[export_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE11shared_findERKS1_RP18ACE_Hash_Map_EntryIS1_S3_ERm"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE11shared_findERKS1_RP18ACE_Hash_Map_EntryIS1_S3_ERm(
    __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
    ext_id: *const ACE_String_Base_char_,
    entry: *mut *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
    loc: *mut libc::c_ulong,
) -> libc::c_int {
    unsafe {
        ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_::shared_find(
            __this,
            ext_id,
            entry,
            loc,
...
#[export_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE6bind_iERKS1_RKS3_RP18ACE_Hash_Map_EntryIS1_S3_E"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE6bind_iERKS1_RKS3_RP18ACE_Hash_Map_EntryIS1_S3_E(
    __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
    ext_id: *const ACE_String_Base_char_,
    int_id: *const *mut ACE_CapEntry,
    entry: *mut *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
) -> libc::c_int {
    unsafe {
        ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_::bind_i_scc0ab8f6f74bf063(
            __this,
            ext_id,
            int_id,
            entry,
...
impl Drop
for ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_ {
    fn drop(&mut self) {
        {
            unsafe {
                let __this: *mut Self = self as *mut Self;
                {
                    <ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_>::close(
                        (__this)
                            as *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                    );
                }
                ()
            }
...
#[export_name = "__acedtor_u7ced180ea83fe578"]
pub unsafe extern "C-unwind" fn __acedtor_u7ced180ea83fe578(
    __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[doc = "* @class ACE_StringCapEntry\n *\n * @brief This class implement the ACE String Capability subclass.\n *\n * This is a container class for ACE Capabilities String container\n * values."]
#[repr(C)]
#[derive(Clone)]
pub struct ACE_StringCapEntry {
    pub __base_0: ::core::mem::ManuallyDrop<ACE_CapEntry>,
    pub val_: ::core::mem::ManuallyDrop<ACE_String_Base_char_>,
}
impl Drop for ACE_StringCapEntry {
    fn drop(&mut self) {
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.val_);
            ::core::mem::ManuallyDrop::drop(&mut self.__base_0);
        }
    }
}
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_StringCapEntryC1ERK15ACE_String_BaseIcE(
    __this: *mut ACE_StringCapEntry,
    __a0: *const ACE_String_Base_char_,
) {
    ACE_StringCapEntry::new_at(__this, __a0)
}
pub type ACE_Capabilities_CAPABILITIES_MAP = ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_;
#[doc = "* @class ACE_Capabilities\n *\n * @brief\n * This class implement the ACE Capabilities.\n *\n * This is a container class for ACE Capabilities\n * values. Currently exist three different capability values:\n * ACE_IntCapEntry (integer), ACE_BoolCapEntry (bool) and\n * ACE_StringCapEntry (String).  An ACE_Capabilities is a\n * unordered set of pair = (String, ACE_CapEntry *).  Where\n * the first component is the name of capability and the second\n * component is a pointer to the capability value container.  A\n * FILE is a container for ACE_Capabilities, the\n * ACE_Capabilities has a name in the file, as a termcap file."]
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Capabilities {
    pub caps_: ::core::mem::ManuallyDrop<
        ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
    >,
}
#[export_name = "_ZN16ACE_CapabilitiesC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_CapabilitiesC1Ev(
    __this: *mut ACE_Capabilities,
) {
    ACE_Capabilities::new_at(__this)
}
impl Drop for ACE_Capabilities {
    fn drop(&mut self) {
        {
            unsafe {
                let __this: *mut Self = self as *mut Self;
                {
                    <ACE_Capabilities>::resetcaps((__this) as *mut ACE_Capabilities);
                }
                ()
            }
        }
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.caps_);
        }
    }
}
#[export_name = "__acedtor_ud5c903065fe14871"]
pub unsafe extern "C-unwind" fn __acedtor_ud5c903065fe14871(
    __this: *mut ACE_Capabilities,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[export_name = "_ZN16ACE_Capabilities6getvalEPKcR15ACE_String_BaseIcE"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_Capabilities6getvalEPKcR15ACE_String_BaseIcE(
    __this: *mut ACE_Capabilities,
    keyname: *const libc::c_char,
    val: *mut ACE_String_Base_char_,
) -> libc::c_int {
    unsafe { ACE_Capabilities::getval(__this, keyname, val) }
}
#[export_name = "_ZN16ACE_Capabilities6getvalEPKcRi"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_Capabilities6getvalEPKcRi(
    __this: *mut ACE_Capabilities,
    keyname: *const libc::c_char,
    val: *mut libc::c_int,
) -> libc::c_int {
    unsafe { ACE_Capabilities::getval_ued8da4ccf3a3e555(__this, keyname, val) }
}
#[export_name = "_ZN16ACE_Capabilities6getentEPKcS1_"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_Capabilities6getentEPKcS1_(
    __this: *mut ACE_Capabilities,
    fname: *const libc::c_char,
    name: *const libc::c_char,
) -> libc::c_int {
    unsafe { ACE_Capabilities::getent(__this, fname, name) }
}
#[export_name = "_ZN16ACE_Capabilities5parseEPKcRi"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_Capabilities5parseEPKcRi(
    __this: *mut ACE_Capabilities,
    buf: *const libc::c_char,
    cap: *mut libc::c_int,
) -> *const libc::c_char {
    unsafe { ACE_Capabilities::parse(__this, buf, cap) }
}
#[export_name = "_ZN16ACE_Capabilities5parseEPKcR15ACE_String_BaseIcE"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_Capabilities5parseEPKcR15ACE_String_BaseIcE(
    __this: *mut ACE_Capabilities,
    buf: *const libc::c_char,
    cap: *mut ACE_String_Base_char_,
) -> *const libc::c_char {
    unsafe { ACE_Capabilities::parse_uc3a7d153b06c7c50(__this, buf, cap) }
}
#[export_name = "_ZN16ACE_Capabilities7fillentEPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_Capabilities7fillentEPKc(
    __this: *mut ACE_Capabilities,
    buf: *const libc::c_char,
) -> libc::c_int {
    unsafe { ACE_Capabilities::fillent(__this, buf) }
}
#[export_name = "_ZN16ACE_Capabilities7getlineEP8_IO_FILER15ACE_String_BaseIcE"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_Capabilities7getlineEP8_IO_FILER15ACE_String_BaseIcE(
    __this: *mut ACE_Capabilities,
    fp: *mut _IO_FILE,
    line: *mut ACE_String_Base_char_,
) -> libc::c_int {
    unsafe { ACE_Capabilities::getline(__this, fp, line) }
}
#[export_name = "_ZN16ACE_Capabilities8is_entryEPKcS1_"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_Capabilities8is_entryEPKcS1_(
    __this: *mut ACE_Capabilities,
    name: *const libc::c_char,
    line: *const libc::c_char,
) -> libc::c_int {
    unsafe { ACE_Capabilities::is_entry(__this, name, line) }
}
#[export_name = "_ZN16ACE_Capabilities9resetcapsEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_Capabilities9resetcapsEv(
    __this: *mut ACE_Capabilities,
) {
    unsafe { ACE_Capabilities::resetcaps(__this) }
}
pub(crate) unsafe extern "C-unwind" fn is_empty(
    ...
    unsafe {
        {
            'while_0: loop {
                if !((((((((*(line))) != 0)
                    && ((ACE_OS::ace_isspace((((*(line))) as libc::c_char))) != 0))
            ...
            return ((((((((((*(line)) as libc::c_int as libc::c_char))
                == (((0 as libc::c_char) as libc::c_int as libc::c_char))) as libc::c_int
                as libc::c_int) != 0)
                || ((((((*(line)) as libc::c_int as libc::c_char))
...
pub(crate) unsafe extern "C-unwind" fn is_line(
    mut line: *const libc::c_char,
) -> libc::c_int {
    unsafe {
        {
...
impl ACE_String_Base_char_ {
    ...
    pub unsafe fn set_se7c59a7a094a3fb3(
        __this: *mut Self,
            ...
            let __this: *mut Self = __this as *mut Self;
            {
                        ...
                        as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
                {
                    ...
                    ACE_OS::memcpy_u6033eb81edaf9212(
                        ...
                        (((((len) as libc::c_ulong)).wrapping_mul((1) as libc::c_ulong))
                            as libc::c_ulong),
                    );
                        ...
                        as libc::c_int) != 0)
                    {
                        ...
                        (*__this).rep_ = ::core::ptr::addr_of_mut!(
                            ACE_String_Base_char__NULL_String_
                        ) as *mut libc::c_char;
                        (*__this).release_ = false;
                    } else {
                        if (((!(((release as libc::c_int) != 0)) as libc::c_int)
                            as libc::c_int) != 0)
                        {
                            (*__this).buf_len_ = len;
                            (*__this).len_ = len;
                            (*__this).rep_ = (s as *mut libc::c_char);
                            (*__this).release_ = false;
                        } else {
                            ACE_OS::memcpy_u6033eb81edaf9212(
                                (((*__this).rep_) as *mut libc::c_void),
    ...
    pub unsafe fn new_at_sabcff583f5288c57(
        __this: *mut Self,
        mut s: *const ACE_String_Base_char_,
    ) {
        unsafe {
            ...
            {
                <ACE_String_Base_char_>::set_se7c59a7a094a3fb3(
                    (__this) as *mut ACE_String_Base_char_,
    ...
    pub unsafe fn new_sabcff583f5288c57(mut __a0: *const ACE_String_Base_char_) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_sabcff583f5288c57(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    ...
    pub unsafe fn operator_add_assign_s982d0a332c979fca(
        __this: *mut Self,
        mut c: libc::c_char,
    ) -> *mut ACE_String_Base_char_ {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut slen: libc::c_ulong = ((1) as libc::c_ulong);
                let mut r: *mut ACE_String_Base_char_ = &mut ((*<ACE_String_Base_char_>::append(
                    (__this) as *mut ACE_String_Base_char_,
                    ::core::ptr::addr_of!(c) as *const libc::c_char,
                    ((slen) as libc::c_ulong),
                )));
                return ::core::ptr::addr_of_mut!((* r));
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    #[doc = "*  Default constructor.\n    *\n    *  @param the_allocator ACE_Allocator associated with string\n    *  @return Default ACE_String_Base string."]
    pub unsafe fn new_at_s89536104322d6768(
        __this: *mut Self,
        ...
        unsafe {
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).rep_),
                ::core::ptr::addr_of_mut!(ACE_String_Base_char__NULL_String_)
                    as *mut libc::c_char,
            );
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).release_), false);
            {}
    ...
    pub unsafe fn new_s89536104322d6768(mut __a0: *mut ACE_Allocator) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s89536104322d6768(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    ...
    pub unsafe fn set_se0d2578f0f93d128(
        __this: *mut Self,
        mut s: *const libc::c_char,
        mut release: bool,
    ) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                if ((((!(s).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    length = ACE_OS::strlen_u07dd12a225364fa6(s);
                }
                <ACE_String_Base_char_>::set_se7c59a7a094a3fb3(
                    (__this) as *mut ACE_String_Base_char_,
                    s,
    ...
    pub unsafe fn new_at_se5a50063ebed1e80(
        __this: *mut Self,
        mut s: *const libc::c_char,
        mut the_allocator: *mut ACE_Allocator,
        mut release: bool,
        ...
        unsafe {
            ...
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).release_), false);
            {
                <ACE_String_Base_char_>::set_se0d2578f0f93d128(
                    (__this) as *mut ACE_String_Base_char_,
                    s,
                    release,
                );
    ...
    pub unsafe fn new_se5a50063ebed1e80(
        mut __a0: *const libc::c_char,
        mut __a1: *mut ACE_Allocator,
        mut __a2: bool,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_se5a50063ebed1e80(
            ::core::ptr::addr_of_mut!(__obj),
            __a0,
            __a1,
            __a2,
    ...
    pub unsafe fn operator_assign_sbd22052c3b720a46(
        __this: *mut Self,
        mut s: *const ACE_String_Base_char_,
    ) -> *mut ACE_String_Base_char_ {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((((__this) as *const u8))
                    != (((((::core::ptr::addr_of!((* s)) as *const ACE_String_Base_char_)
                        as *mut ACE_String_Base_char_)) as *const u8))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    <ACE_String_Base_char_>::set_se7c59a7a094a3fb3(
                        (__this) as *mut ACE_String_Base_char_,
    ...
    pub unsafe fn operator_add_assign_sbd22052c3b720a46(
        __this: *mut Self,
        mut s: *const ACE_String_Base_char_,
    ) -> *mut ACE_String_Base_char_ {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (<ACE_String_Base_char_>::append(
                    (__this) as *mut ACE_String_Base_char_,
                    (((*s).rep_) as *const libc::c_char),
                    (((*s).len_) as libc::c_ulong),
                )) as *mut ACE_String_Base_char_;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
...
impl ACE_StringCapEntry {
    pub unsafe fn new_at(__this: *mut Self, mut val: *const ACE_String_Base_char_) {
        unsafe {
            ::core::ptr::write(
                __this,
                ::core::mem::MaybeUninit::<Self>::zeroed().assume_init(),
            ...
            <ACE_CapEntry>::new_at(
                (::core::ptr::addr_of_mut!((* __this).__base_0).cast::<ACE_CapEntry>())
                    as *mut ACE_CapEntry,
                (((1 as libc::c_int)) as libc::c_int),
            );
            *(__this as *mut *const ()) = &__VTBL_ue84903f32cb09f56
                as *const __Vtbl_ue84903f32cb09f56 as *const ();
            <ACE_String_Base_char_>::new_at_sabcff583f5288c57(
                (::core::ptr::addr_of_mut!((* __this).val_)
                    .cast::<ACE_String_Base_char_>()) as *mut ACE_String_Base_char_,
                ::core::ptr::addr_of!((* val)),
            );
            {}
            ()
        }
    }
    pub unsafe fn new(mut __a0: *const ACE_String_Base_char_) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    pub unsafe fn getval(__this: *const Self) -> ACE_String_Base_char_ {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return <ACE_String_Base_char_>::new_sabcff583f5288c57(
                    ::core::ptr::addr_of!(
                        (* ::core::ptr::addr_of!((* __this).val_) .cast:: <
                        ACE_String_Base_char_ > ().cast_mut())
                    ),
                );
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
...
impl ACE_Capabilities {
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ...
            <ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_>::new_at_s070e196bc4421324(
                (::core::ptr::addr_of_mut!((* __this).caps_)
                    .cast::<
                        ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                    >())
                    as *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
    ...
    ///Get a string entry.
    pub unsafe fn getval(
        __this: *mut Self,
        mut keyname: *const libc::c_char,
        mut val: *mut ACE_String_Base_char_,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut cap: *mut ACE_CapEntry = ((0) as *mut ACE_CapEntry);
                if (((((<ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_>::find_sce8c1849c72cc46f(
                    (::core::ptr::addr_of!(
                        (* ::core::ptr::addr_of!((* __this).caps_) .cast:: <
                        ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_
                        > ().cast_mut())
                    ))
                        as *const ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                    &(<ACE_String_Base_char_>::new_se5a50063ebed1e80(
                        ((keyname) as *const libc::c_char),
                        ((0) as *mut ACE_Allocator),
                        true,
                    )) as *const ACE_String_Base_char_,
                    ::core::ptr::addr_of_mut!(cap),
                ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    return (-((1) as libc::c_int));
                }
                let mut scap: *mut ACE_StringCapEntry = (cap as *mut ACE_StringCapEntry);
                if (((((scap).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    return (-((1) as libc::c_int));
                }
                let __addrof_tmp_0 = <ACE_StringCapEntry>::getval(
                    (scap) as *const ACE_StringCapEntry,
                );
                <ACE_String_Base_char_>::operator_assign_sbd22052c3b720a46(
                    (::core::ptr::addr_of_mut!((* val))) as *mut ACE_String_Base_char_,
                    &__addrof_tmp_0 as *const ACE_String_Base_char_,
                );
                return 0;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
    ...
    pub unsafe fn getval_ued8da4ccf3a3e555(
        __this: *mut Self,
        mut keyname: *const libc::c_char,
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                let mut icap: *mut ACE_IntCapEntry = (cap as *mut ACE_IntCapEntry);
                if ((((!(icap).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    (*val) = <ACE_IntCapEntry>::getval((icap) as *const ACE_IntCapEntry);
                    return 0;
                }
                let mut bcap: *mut ACE_BoolCapEntry = (cap as *mut ACE_BoolCapEntry);
                if (((((bcap).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    return (-((1) as libc::c_int));
                }
                (*val) = <ACE_BoolCapEntry>::getval((bcap) as *const ACE_BoolCapEntry);
                return 0;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
  ...
  /// associated capabitily entries in map.*/
    pub unsafe fn getent(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut fp: *mut _IO_FILE = ACE_OS::fopen_ua6d43bbd3a566b87(
                    ((fname) as *const libc::c_char),
                    ((b"r\0".as_ptr() as *const libc::c_char) as *const libc::c_char),
                );
                if (((((fp).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    'dowhile_0: loop {
                        'cont_0: loop {
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/Capabilities.cpp\0".as_ptr()
                ...
                let mut done: libc::c_int = unsafe { ::core::mem::zeroed() };
                let mut line: ACE_String_Base_char_ = ::core::mem::MaybeUninit::<
                    ACE_String_Base_char_,
                >::zeroed()
                    .assume_init();
                <ACE_String_Base_char_>::new_at_s89536104322d6768(
                    (::core::ptr::addr_of_mut!(line)) as *mut ACE_String_Base_char_,
                    ((0) as *mut ACE_Allocator),
                );
                'while_1: loop {
                    if !((((((((((0 as libc::c_int))
                        == (((({
                            let __v = ((((((<ACE_Capabilities>::getline(
                                (__this) as *mut ACE_Capabilities,
                                fp,
                        ...
                        && ((is_empty(
                            ((<ACE_String_Base_char_>::c_str(
                                (::core::ptr::addr_of!(line))
                                    as *const ACE_String_Base_char_,
                            )) as *const libc::c_char),
                ...
                'while_2: loop {
                    if !((((!(((done) != 0)) as libc::c_int) as libc::c_int) != 0)) {
                        break 'while_2;
                    }
                    'cont_2: loop {
                        {
                            {
                                let mut newline: ACE_String_Base_char_ = ::core::mem::MaybeUninit::<
                                    ACE_String_Base_char_,
                                >::zeroed()
                                    .assume_init();
                                <ACE_String_Base_char_>::new_at_s89536104322d6768(
                                    (::core::ptr::addr_of_mut!(newline))
                                        as *mut ACE_String_Base_char_,
                                    ((0) as *mut ACE_Allocator),
                                );
                                let mut description: ACE_String_Base_char_ = ::core::mem::MaybeUninit::<
                                    ACE_String_Base_char_,
                                >::zeroed()
                                    .assume_init();
                                <ACE_String_Base_char_>::new_at_s89536104322d6768(
                                    (::core::ptr::addr_of_mut!(description))
                                        as *mut ACE_String_Base_char_,
                                    ((0) as *mut ACE_Allocator),
                                );
                                'while_3: loop {
                                    ...
                                    'cont_3: loop {
                                        {
                                            if ((is_line(
                                                ((<ACE_String_Base_char_>::c_str(
                                                    (::core::ptr::addr_of!(newline))
                                                        as *const ACE_String_Base_char_,
                                                )) as *const libc::c_char),
                                            )) != 0)
                                            {
                                                <ACE_String_Base_char_>::operator_add_assign_sbd22052c3b720a46(
                                                    (::core::ptr::addr_of_mut!(description))
                                                        as *mut ACE_String_Base_char_,
                                                    ::core::ptr::addr_of!(newline),
                                                );
                                ...
                                {
                                    ACE_OS::fclose_u07d30b70956bcb1f(fp);
                                    return <ACE_Capabilities>::fillent(
                                        (__this) as *mut ACE_Capabilities,
                                        ((<ACE_String_Base_char_>::c_str(
                                            (::core::ptr::addr_of!(description))
                                                as *const ACE_String_Base_char_,
                                        )) as *const libc::c_char),
                                    );
                                }
                                ...
                                'while_4: loop {
                                    if !((((((((!(((done) != 0)) as libc::c_int) as libc::c_int)
                                        != 0)
                                        && ((is_empty(
                                            ((<ACE_String_Base_char_>::c_str(
                                                (::core::ptr::addr_of!(line))
                                    ...
                                    'cont_4: loop {
                                        ...
                                        #[allow(unreachable_code)] break 'cont_4;
                                    }
                                }
                            }
                        }
    ...
    pub unsafe fn parse(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                'while_0: loop {
                    if !((((((((*(buf))) != 0)
                        && ((ACE_OS::ace_isdigit((((*(buf))) as libc::c_char))) != 0))
                        as libc::c_int) as libc::c_int) != 0))
                    {
                        break 'while_0;
                    }
                    'cont_0: loop {
                        {
                            n = ((((((n) as libc::c_int))
                                .wrapping_mul((10) as libc::c_int)) as libc::c_int))
                                .wrapping_add(
                                    ((((((*({
                                        let __lv = &mut (buf);
                                        let __r = *__lv;
                                        *__lv = (*__lv).wrapping_offset(1);
                                        ...
                                        .wrapping_sub((48 as libc::c_char) as libc::c_int)))
                                        as libc::c_int,
                                );
                        }
                        #[allow(unreachable_code)] break 'cont_0;
    ...
    pub unsafe fn parse_uc3a7d153b06c7c50(
        __this: *mut Self,
        mut buf: *const libc::c_char,
        mut cap: *mut ACE_String_Base_char_,
    ) -> *const libc::c_char {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                'while_0: loop {
                    if !(((((((((((*(buf)) as libc::c_int as libc::c_char))
                        != (((0 as libc::c_char) as libc::c_int as libc::c_char)))
                        as libc::c_int as libc::c_int) != 0)
                        && ((((((*(buf)) as libc::c_int as libc::c_char))
                            != (((44 as libc::c_char) as libc::c_int as libc::c_char)))
                            as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                        as libc::c_int) != 0))
                    {
                        break 'while_0;
                    ...
                    'cont_0: loop {
                        {
                            {
                                if ((((((*(buf)) as libc::c_int as libc::c_char))
                                    == (((92 as libc::c_char) as libc::c_int as libc::c_char)))
                                    as libc::c_int as libc::c_int) != 0)
                                {
                                    {
                                        let __lv = &mut (buf);
                                    ...
                                    if ((((((((((*(buf)) as libc::c_int as libc::c_char))
                                        == (((69 as libc::c_char) as libc::c_int as libc::c_char)))
                                        as libc::c_int as libc::c_int) != 0)
                                        || ((((((*(buf)) as libc::c_int as libc::c_char))
                                            == (((101 as libc::c_char) as libc::c_int as libc::c_char)))
                                            as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                                        as libc::c_int) != 0)
                                    {
                                        <ACE_String_Base_char_>::operator_add_assign_s982d0a332c979fca(
                                            (::core::ptr::addr_of_mut!((* cap)))
                                                as *mut ACE_String_Base_char_,
                                            ((((27 as libc::c_char))) as libc::c_char),
                                        );
                                        {
                                            let __lv = &mut (buf);
                                            *__lv = (*__lv).wrapping_offset(1);
                                        ...
                                        if ((((((*(buf)) as libc::c_int as libc::c_char))
                                            == (((114 as libc::c_char) as libc::c_int as libc::c_char)))
                                            as libc::c_int as libc::c_int) != 0)
                                        {
                                            <ACE_String_Base_char_>::operator_add_assign_s982d0a332c979fca(
                                                (::core::ptr::addr_of_mut!((* cap)))
                                                    as *mut ACE_String_Base_char_,
                                                ((13 as libc::c_char) as libc::c_char),
                                            );
                                            {
                                                let __lv = &mut (buf);
                                                *__lv = (*__lv).wrapping_offset(1);
                                            ...
                                            if ((((((*(buf)) as libc::c_int as libc::c_char))
                                                == (((110 as libc::c_char) as libc::c_int as libc::c_char)))
                                                as libc::c_int as libc::c_int) != 0)
                                            {
                                                <ACE_String_Base_char_>::operator_add_assign_s982d0a332c979fca(
                                                    (::core::ptr::addr_of_mut!((* cap)))
                                                        as *mut ACE_String_Base_char_,
                                                    ((10 as libc::c_char) as libc::c_char),
                                                );
                                                {
                                                    let __lv = &mut (buf);
                                                    *__lv = (*__lv).wrapping_offset(1);
                                                ...
                                                if ((((((*(buf)) as libc::c_int as libc::c_char))
                                                    == (((116 as libc::c_char) as libc::c_int as libc::c_char)))
                                                    as libc::c_int as libc::c_int) != 0)
                                                {
                                                    <ACE_String_Base_char_>::operator_add_assign_s982d0a332c979fca(
                                                        (::core::ptr::addr_of_mut!((* cap)))
                                                            as *mut ACE_String_Base_char_,
                                                        ((9 as libc::c_char) as libc::c_char),
                                                    );
                                                    {
                                                        let __lv = &mut (buf);
                                                        *__lv = (*__lv).wrapping_offset(1);
                                    ...
                                    if ((ACE_OS::ace_isdigit((((*(buf))) as libc::c_char)))
                                        != 0)
                                    {
                                        let mut oc: libc::c_int = 0;
                                        {
                                            ...
                                            'for_1: loop {
                                                if !((((((((((((((i as libc::c_int))
                                                    < (((3) as libc::c_int))) as libc::c_int as libc::c_int)
                                                    != 0) && (((*(buf))) != 0)) as libc::c_int) as libc::c_int)
                                                    != 0)
                                                    && ((ACE_OS::ace_isdigit((((*(buf))) as libc::c_char)))
                                                        != 0)) as libc::c_int) as libc::c_int) != 0))
                                                {
                                                    break;
                                                }
                                                'cont_1: loop {
                                                    {
                                                        oc = ((((((oc) as libc::c_int))
                                                            .wrapping_mul((8) as libc::c_int)) as libc::c_int))
                                                            .wrapping_add(
                                                                ((((((*({
                                                                    let __lv = &mut (buf);
                                                                    let __r = *__lv;
                                        ...
                                        <ACE_String_Base_char_>::operator_add_assign_s982d0a332c979fca(
                                            (::core::ptr::addr_of_mut!((* cap)))
                                                as *mut ACE_String_Base_char_,
                                            (((oc as libc::c_char)) as libc::c_char),
                                        );
                                        break 'cont_0;
                                    }
                                }
            ...
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                'while_0: loop {
                    ...
                    'cont_0: loop {
                        {
                            {
                                let mut s: ACE_String_Base_char_ = ::core::mem::MaybeUninit::<
                                    ACE_String_Base_char_,
                                >::zeroed()
                                    .assume_init();
                                <ACE_String_Base_char_>::new_at_s89536104322d6768(
                                ...
                                let mut name: ACE_String_Base_char_ = ::core::mem::MaybeUninit::<
                                    ACE_String_Base_char_,
                                >::zeroed()
                                    .assume_init();
                                <ACE_String_Base_char_>::new_at_s89536104322d6768(
                                ...
                                let mut ce: *mut ACE_CapEntry = unsafe {
                                    ::core::mem::zeroed()
                                };
                                'while_1: loop {
                                    if !((((((((*(buf))) != 0)
                                        && ((ACE_OS::ace_isspace((((*(buf))) as libc::c_char)))
                                            != 0)) as libc::c_int) as libc::c_int) != 0))
                                    {
                                        break 'while_1;
                                    }
                                ...
                                'while_3: loop {
                                    if !((((((((((((((((*(buf))) != 0)
                                        && ((((((*(buf)) as libc::c_int as libc::c_char))
                                            != (((61 as libc::c_char) as libc::c_int as libc::c_char)))
                                            as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                                        as libc::c_int) != 0)
                                        && ((((((*(buf)) as libc::c_int as libc::c_char))
                                            != (((35 as libc::c_char) as libc::c_int as libc::c_char)))
                                ...
                                'switch_0: {
                                    let __c: libc::c_char = (*(buf));
                                    #[allow(unused_assignments)]
                                    let mut __m: u32 = 3;
                                    {
                                        let __cv_0: libc::c_char = (61 as libc::c_char);
                                        if __c == __cv_0 {
                                            __m = 0;
                                        }
                                    }
                                    if __m == 3 {
                                        let __cv_1: libc::c_char = (35 as libc::c_char);
                                        if __c == __cv_1 {
                                            __m = 1;
                                        }
                                    }
                                    if __m == 3 {
                                        let __cv_2: libc::c_char = (44 as libc::c_char);
                                        if __c == __cv_2 {
                                            __m = 2;
                                        }
                                    }
                                    if __m <= 0 {
                                        buf = <ACE_Capabilities>::parse_uc3a7d153b06c7c50(
                                            (__this) as *mut ACE_Capabilities,
                                            (((buf).wrapping_offset((1) as isize))
                                                as *const libc::c_char),
                                            ::core::ptr::addr_of_mut!(s),
                                        );
                                        'dowhile_4: loop {
                                            'cont_4: loop {
                                                {
                                                    {
                                                        ce = (({
                                                            let __new: *mut ACE_StringCapEntry = Box::into_raw(
                                                                Box::new(
                                                                    ::core::mem::MaybeUninit::<ACE_StringCapEntry>::zeroed()
                                                                        .assume_init(),
                                                                ),
                                                            );
                                                            <ACE_StringCapEntry>::new_at(
                                                                (__new) as *mut ACE_StringCapEntry,
                                                                ::core::ptr::addr_of!(s),
                                                            );
                                                            __new
                                                        }) as *mut ACE_CapEntry);
                                                        if (((((ce).is_null()) as libc::c_int) as libc::c_int) != 0)
                                                        {
                                                            ((*(__errno_location()))) = 12;
                                                            return (-((1) as libc::c_int));
                                                        }
                                        ...
                                        if (((((<ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_>::bind_s436e7376947974ff(
                                            (::core::ptr::addr_of_mut!(
                                                (* ::core::ptr::addr_of!((* __this).caps_) .cast:: <
                                                ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_
                                                > ().cast_mut())
                                        ...
                                        {
                                            {
                                                let __p = ce;
                                                if !__p.is_null() {
                                                    let __vt: *const __Vtbl_ubfc78034bc996427 = *(__p
                                                        as *const *const __Vtbl_ubfc78034bc996427);
                                                    ((*__vt).__vdtor)(__p as *mut ACE_CapEntry);
                                                }
                                            };
                                            return (-((1) as libc::c_int));
                                        }
                                            ...
                                            'cont_5: loop {
                                                {
                                                    {
                                                        ce = (({
                                                            let __new: *mut ACE_IntCapEntry = Box::into_raw(
                                                                Box::new(
                                                                    ::core::mem::MaybeUninit::<ACE_IntCapEntry>::zeroed()
                                                                        .assume_init(),
                                                                ),
                                                            );
                                                            <ACE_IntCapEntry>::new_at(
                                                                (__new) as *mut ACE_IntCapEntry,
                                                                n,
                                                            );
                                                            __new
                                                        }) as *mut ACE_CapEntry);
                                                ...
                                                #[allow(unreachable_code)] break 'cont_5;
                                            }
                                            if !(((0) != 0)) {
                                                break 'dowhile_5;
                                            }
                                            ...
                                            'cont_6: loop {
                                                {
                                                    {
                                                        ce = (({
                                                            let __new: *mut ACE_BoolCapEntry = Box::into_raw(
                                                                Box::new(
                                                                    ::core::mem::MaybeUninit::<ACE_BoolCapEntry>::zeroed()
                                                                        .assume_init(),
                                                                ),
                                                            );
                                                            <ACE_BoolCapEntry>::new_at(
                                                                (__new) as *mut ACE_BoolCapEntry,
                                                                1,
                                                            );
                                                            __new
                                                        }) as *mut ACE_CapEntry);
                                                ...
                                                #[allow(unreachable_code)] break 'cont_6;
                                            }
                                            if !(((0) != 0)) {
                                                break 'dowhile_6;
                                            }
    ...
    ///Parse a cap entry
    pub unsafe fn parseent(
        __this: *mut Self,
        mut name: *const libc::c_char,
        mut line: *mut libc::c_char,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN16ACE_Capabilities8parseentEPKcPc"]
            fn __ext(
                __this: *mut ACE_Capabilities,
                name: *const libc::c_char,
        ...
        __ext(__this as *mut ACE_Capabilities, name, line)
    }
    ///Get a line from FILE input stream
    pub unsafe fn getline(
        __this: *mut Self,
        mut fp: *mut _IO_FILE,
        mut line: *mut ACE_String_Base_char_,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut ch: libc::c_int = unsafe { ::core::mem::zeroed() };
                <ACE_String_Base_char_>::set_se0d2578f0f93d128(
                    (::core::ptr::addr_of_mut!((* line))) as *mut ACE_String_Base_char_,
                ...
                'while_0: loop {
                    if !((((((((((({
                        let __v = ACE_OS::fgetc_ua8ec9df85630c044(fp);
                        ch = __v;
                        __v
                    }) as libc::c_int))
                        != (((((-((1) as libc::c_int)))) as libc::c_int))) as libc::c_int
                        as libc::c_int) != 0)
                        && (((((ch as libc::c_int))
                            != (((10 as libc::c_char) as libc::c_int))) as libc::c_int
                            as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0))
                    {
                        break 'while_0;
                    }
                    'cont_0: loop {
                        {
                            <ACE_String_Base_char_>::operator_add_assign_s982d0a332c979fca(
                                (::core::ptr::addr_of_mut!((* line)))
                                    as *mut ACE_String_Base_char_,
                                (((ch as libc::c_char)) as libc::c_char),
                            );
                        }
                        #[allow(unreachable_code)] break 'cont_0;
                    }
                ...
                if (((((((((ch as libc::c_int))
                    == (((((-((1) as libc::c_int)))) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                    && (((((<ACE_String_Base_char_>::length(
                        (::core::ptr::addr_of!((* line))) as *const ACE_String_Base_char_,
                    ) as libc::c_ulong)) == (((0) as libc::c_ulong))) as libc::c_int
                        as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
                {
                    return (-((1) as libc::c_int));
                            ...
                            {
                                {
                                    'while_1: loop {
                                        if !((((((((*(line))) != 0)
                                            && ((ACE_OS::ace_isspace((((*(line))) as libc::c_char)))
                                                != 0)) as libc::c_int) as libc::c_int) != 0))
                                        {
                                            break 'while_1;
                                        }
                                    ...
                                    if ((((((*(line)) as libc::c_int as libc::c_char))
                                        == (((0 as libc::c_char) as libc::c_int as libc::c_char)))
                                        as libc::c_int as libc::c_int) != 0)
                                    {
                                        break 'for_0;
                                    }
                                    let mut nextname: ACE_String_Base_char_ = ::core::mem::MaybeUninit::<
                                        ACE_String_Base_char_,
                                    >::zeroed()
                                        .assume_init();
                                    <ACE_String_Base_char_>::new_at_s89536104322d6768(
                                        (::core::ptr::addr_of_mut!(nextname))
                                            as *mut ACE_String_Base_char_,
                                        ((0) as *mut ACE_Allocator),
                                    );
                                    'while_2: loop {
                                        if !((((((((((((*(line))) != 0)
                                            && ((((((*(line)) as libc::c_int as libc::c_char))
                                                != (((124 as libc::c_char) as libc::c_int as libc::c_char)))
                                                as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                                            as libc::c_int) != 0)
                                            && ((((((*(line)) as libc::c_int as libc::c_char))
                                                != (((44 as libc::c_char) as libc::c_int as libc::c_char)))
    ...
    pub unsafe fn resetcaps(__this: *mut Self) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                {
                    let mut iter: ACE_Hash_Map_Iterator_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_ = ::core::mem::MaybeUninit::<
                        ACE_Hash_Map_Iterator_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                    >::zeroed()
                        .assume_init();
                    <ACE_Hash_Map_Iterator_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_>::new_at_s46b0dbef5bca7a4a(
                        (::core::ptr::addr_of_mut!(iter))
                            as *mut ACE_Hash_Map_Iterator_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                        ::core::ptr::addr_of_mut!(
                            (* ::core::ptr::addr_of!((* __this).caps_) .cast:: <
                            ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_
                            > ().cast_mut())
                    ...
                    'for_0: loop {
                        if !((((!(((<ACE_Hash_Map_Iterator_Base_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_>::done(
                            (::core::ptr::addr_of!(
                                (* (::core::ptr::addr_of!(iter))).__base_0
                            ))
                                as *const ACE_Hash_Map_Iterator_Base_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                        )) != 0)) as libc::c_int) as libc::c_int) != 0))
                        {
                            break;
                        }
                        'cont_0: loop {
                            {
                                {
                                    let mut entry: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___ = ((0)
                                        as *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___);
                                    <ACE_Hash_Map_Iterator_Base_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_>::next(
                                        (::core::ptr::addr_of!(
                                            (* (::core::ptr::addr_of!(iter))).__base_0
                                        ))
                                            as *const ACE_Hash_Map_Iterator_Base_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                        ...
                        <ACE_Hash_Map_Iterator_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_>::advance(
                            (::core::ptr::addr_of_mut!(iter))
                                as *mut ACE_Hash_Map_Iterator_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                        );
                    }
...
impl ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_ {
    ...
    pub unsafe fn new_at_s0b876c459fb8fbbb(
        __this: *mut Self,
        mut __a0: libc::c_ulong,
        mut __a1: *mut ACE_Allocator,
        mut __a2: *mut ACE_Allocator,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexEC1EmP13ACE_AllocatorSB_"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                __a0: libc::c_ulong,
                __a1: *mut ACE_Allocator,
    ...
    pub unsafe fn new_s0b876c459fb8fbbb(
        mut __a0: libc::c_ulong,
        mut __a1: *mut ACE_Allocator,
        mut __a2: *mut ACE_Allocator,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s0b876c459fb8fbbb(
            ::core::ptr::addr_of_mut!(__obj),
            __a0,
            __a1,
            __a2,
    ...
    pub unsafe fn unbind_all(__this: *mut Self) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE10unbind_allEv"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
            ) -> libc::c_int;
        }
    ...
    pub unsafe fn bind_scc0ab8f6f74bf063(
        __this: *mut Self,
        mut ext_id: *const ACE_String_Base_char_,
        mut int_id: *const *mut ACE_CapEntry,
        mut entry: *mut *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE4bindERKS1_RKS3_RP18ACE_Hash_Map_EntryIS1_S3_E"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                ext_id: *const ACE_String_Base_char_,
                int_id: *const *mut ACE_CapEntry,
    ...
    pub unsafe fn trybind_s89ec0fe4220f75f0(
        __this: *mut Self,
        mut ext_id: *const ACE_String_Base_char_,
        mut int_id: *mut *mut ACE_CapEntry,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE7trybindERKS1_RS3_"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                ext_id: *const ACE_String_Base_char_,
                int_id: *mut *mut ACE_CapEntry,
            ) -> libc::c_int;
        }
        __ext(
            __this
    ...
    pub unsafe fn trybind_sff41d34c57eddd52(
        __this: *mut Self,
        mut ext_id: *const ACE_String_Base_char_,
        mut int_id: *mut *mut ACE_CapEntry,
        mut entry: *mut *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE7trybindERKS1_RS3_RP18ACE_Hash_Map_EntryIS1_S3_E"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                ext_id: *const ACE_String_Base_char_,
                int_id: *mut *mut ACE_CapEntry,
    ...
    pub unsafe fn rebind_s436e7376947974ff(
        __this: *mut Self,
        mut ext_id: *const ACE_String_Base_char_,
        mut int_id: *const *mut ACE_CapEntry,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE6rebindERKS1_RKS3_"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                ext_id: *const ACE_String_Base_char_,
                int_id: *const *mut ACE_CapEntry,
    ...
    pub unsafe fn rebind_scc0ab8f6f74bf063(
        __this: *mut Self,
        mut ext_id: *const ACE_String_Base_char_,
        mut int_id: *const *mut ACE_CapEntry,
        mut entry: *mut *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE6rebindERKS1_RKS3_RP18ACE_Hash_Map_EntryIS1_S3_E"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                ext_id: *const ACE_String_Base_char_,
                int_id: *const *mut ACE_CapEntry,
    ...
    pub unsafe fn rebind_s6b8615192c7580c2(
        __this: *mut Self,
        mut ext_id: *const ACE_String_Base_char_,
        mut int_id: *const *mut ACE_CapEntry,
        mut old_int_id: *mut *mut ACE_CapEntry,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE6rebindERKS1_RKS3_RS3_"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                ext_id: *const ACE_String_Base_char_,
                int_id: *const *mut ACE_CapEntry,
                old_int_id: *mut *mut ACE_CapEntry,
            ) -> libc::c_int;
        }
        __ext(
            __this
    ...
    #[doc = "* Same as a normal rebind, except the map entry is also passed back\n   * to the caller.  The entry in this case will either be the newly\n   * created entry, or the existing one."]
    pub unsafe fn rebind_sb63414e08c9375e4(
        __this: *mut Self,
        mut ext_id: *const ACE_String_Base_char_,
        mut int_id: *const *mut ACE_CapEntry,
        mut old_int_id: *mut *mut ACE_CapEntry,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE6rebindERKS1_RKS3_RS3_RP18ACE_Hash_Map_EntryIS1_S3_E"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                ext_id: *const ACE_String_Base_char_,
                int_id: *const *mut ACE_CapEntry,
    ...
    pub unsafe fn rebind_sb2ab5a2c740d20a4(
        __this: *mut Self,
        mut ext_id: *const ACE_String_Base_char_,
        mut int_id: *const *mut ACE_CapEntry,
        mut old_ext_id: *mut ACE_String_Base_char_,
        mut old_int_id: *mut *mut ACE_CapEntry,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE6rebindERKS1_RKS3_RS1_RS3_"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                ext_id: *const ACE_String_Base_char_,
                int_id: *const *mut ACE_CapEntry,
                old_ext_id: *mut ACE_String_Base_char_,
                old_int_id: *mut *mut ACE_CapEntry,
            ) -> libc::c_int;
        }
        __ext(
    ...
    #[doc = "* Same as a normal rebind, except the map entry is also passed back\n   * to the caller.  The entry in this case will either be the newly\n   * created entry, or the existing one."]
    pub unsafe fn rebind_s8f9df5dcc265c21e(
        __this: *mut Self,
        mut ext_id: *const ACE_String_Base_char_,
        mut int_id: *const *mut ACE_CapEntry,
        mut old_ext_id: *mut ACE_String_Base_char_,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE6rebindERKS1_RKS3_RS1_RS3_RP18ACE_Hash_Map_EntryIS1_S3_E"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                ext_id: *const ACE_String_Base_char_,
                int_id: *const *mut ACE_CapEntry,
    ...
    pub unsafe fn find_s4ae2dda4c060ec94(
        __this: *const Self,
        mut ext_id: *const ACE_String_Base_char_,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZNK23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE4findERKS1_"]
            fn __ext(
                __this: *const ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                ext_id: *const ACE_String_Base_char_,
            ) -> libc::c_int;
        }
        __ext(
  ...
  /// return 0, returns -1 if not found.*/
    pub unsafe fn find_s687d9481673cb26e(
        __this: *const Self,
        mut ext_id: *const ACE_String_Base_char_,
        mut entry: *mut *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZNK23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE4findERKS1_RP18ACE_Hash_Map_EntryIS1_S3_E"]
            fn __ext(
                __this: *const ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                ext_id: *const ACE_String_Base_char_,
                entry: *mut *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
    ...
    pub unsafe fn find_sab29f4c611301e55(
        __this: *const Self,
        mut ext_id: *const ACE_String_Base_char_,
        mut pos: *mut ACE_Hash_Map_Iterator_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZNK23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE4findERKS1_R24ACE_Hash_Map_Iterator_ExIS1_S3_S5_S7_S8_E"]
            fn __ext(
                __this: *const ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                ext_id: *const ACE_String_Base_char_,
                pos: *mut ACE_Hash_Map_Iterator_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
            );
        }
        __ext(
            __this
    ...
    pub unsafe fn unbind_s92247b79196ba601(
        __this: *mut Self,
        mut ext_id: *const ACE_String_Base_char_,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE6unbindERKS1_"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                ext_id: *const ACE_String_Base_char_,
            ) -> libc::c_int;
  ...
  /// unbind was successful, and returns -1 if failures occur.*/
    pub unsafe fn unbind_s89ec0fe4220f75f0(
        __this: *mut Self,
        mut ext_id: *const ACE_String_Base_char_,
        mut int_id: *mut *mut ACE_CapEntry,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE6unbindERKS1_RS3_"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                ext_id: *const ACE_String_Base_char_,
                int_id: *mut *mut ACE_CapEntry,
    ...
    pub unsafe fn unbind_s3a39b7f79998f364(
        __this: *mut Self,
        mut entry: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE6unbindEP18ACE_Hash_Map_EntryIS1_S3_E"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                entry: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
            ) -> libc::c_int;
        }
        __ext(
            __this
    ...
    pub unsafe fn unbind_s67a6454384b30d53(
        __this: *mut Self,
        mut pos: ACE_Hash_Map_Iterator_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE6unbindE24ACE_Hash_Map_Iterator_ExIS1_S3_S5_S7_S8_E"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                pos: ACE_Hash_Map_Iterator_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
            ) -> libc::c_int;
        }
        __ext(
            __this
  ...
  /// hash table.*/
    pub unsafe fn current_size(__this: *const Self) -> libc::c_ulong {
        extern "C-unwind" {
            #[link_name = "_ZNK23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE12current_sizeEv"]
            fn __ext(
                __this: *const ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
            ) -> libc::c_ulong;
        }
  ...
  /// linked lists of ACE_Hash_Map_Entry objects in the hash table.*/
    pub unsafe fn total_size(__this: *const Self) -> libc::c_ulong {
        extern "C-unwind" {
            #[link_name = "_ZNK23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE10total_sizeEv"]
            fn __ext(
                __this: *const ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
            ) -> libc::c_ulong;
        }
    ...
    pub unsafe fn mutex(__this: *mut Self) -> *mut ACE_Null_Mutex {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE5mutexEv"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
            ) -> *mut ACE_Null_Mutex;
        }
    ...
    pub unsafe fn dump(__this: *const Self) {
        extern "C-unwind" {
            #[link_name = "_ZNK23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE4dumpEv"]
            fn __ext(
                __this: *const ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
            );
        }
    ...
    pub unsafe fn trybind_i_s89ec0fe4220f75f0(
        __this: *mut Self,
        mut ext_id: *const ACE_String_Base_char_,
        mut int_id: *mut *mut ACE_CapEntry,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE9trybind_iERKS1_RS3_"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                ext_id: *const ACE_String_Base_char_,
                int_id: *mut *mut ACE_CapEntry,
    ...
    ///Performs trybind.  Must be called with locks held.
    pub unsafe fn trybind_i_sff41d34c57eddd52(
        __this: *mut Self,
        mut ext_id: *const ACE_String_Base_char_,
        mut int_id: *mut *mut ACE_CapEntry,
        mut entry: *mut *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE9trybind_iERKS1_RS3_RP18ACE_Hash_Map_EntryIS1_S3_E"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                ext_id: *const ACE_String_Base_char_,
                int_id: *mut *mut ACE_CapEntry,
    ...
    pub unsafe fn rebind_i_s436e7376947974ff(
        __this: *mut Self,
        mut ext_id: *const ACE_String_Base_char_,
        mut int_id: *const *mut ACE_CapEntry,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE8rebind_iERKS1_RKS3_"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                ext_id: *const ACE_String_Base_char_,
                int_id: *const *mut ACE_CapEntry,
    ...
    ///Performs rebind.  Must be called with locks held.
    pub unsafe fn rebind_i_scc0ab8f6f74bf063(
        __this: *mut Self,
        mut ext_id: *const ACE_String_Base_char_,
        mut int_id: *const *mut ACE_CapEntry,
        mut entry: *mut *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE8rebind_iERKS1_RKS3_RP18ACE_Hash_Map_EntryIS1_S3_E"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                ext_id: *const ACE_String_Base_char_,
                int_id: *const *mut ACE_CapEntry,
    ...
    ///Performs rebind.  Must be called with locks held.
    pub unsafe fn rebind_i_s6b8615192c7580c2(
        __this: *mut Self,
        mut ext_id: *const ACE_String_Base_char_,
        mut int_id: *const *mut ACE_CapEntry,
        mut old_int_id: *mut *mut ACE_CapEntry,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE8rebind_iERKS1_RKS3_RS3_"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                ext_id: *const ACE_String_Base_char_,
                int_id: *const *mut ACE_CapEntry,
    ...
    ///Performs rebind.  Must be called with locks held.
    pub unsafe fn rebind_i_sb63414e08c9375e4(
        __this: *mut Self,
        mut ext_id: *const ACE_String_Base_char_,
        mut int_id: *const *mut ACE_CapEntry,
        mut old_int_id: *mut *mut ACE_CapEntry,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE8rebind_iERKS1_RKS3_RS3_RP18ACE_Hash_Map_EntryIS1_S3_E"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                ext_id: *const ACE_String_Base_char_,
                int_id: *const *mut ACE_CapEntry,
    ...
    ///Performs rebind.  Must be called with locks held.
    pub unsafe fn rebind_i_sb2ab5a2c740d20a4(
        __this: *mut Self,
        mut ext_id: *const ACE_String_Base_char_,
        mut int_id: *const *mut ACE_CapEntry,
        mut old_ext_id: *mut ACE_String_Base_char_,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE8rebind_iERKS1_RKS3_RS1_RS3_"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                ext_id: *const ACE_String_Base_char_,
                int_id: *const *mut ACE_CapEntry,
    ...
    ///Performs rebind.  Must be called with locks held.
    pub unsafe fn rebind_i_s8f9df5dcc265c21e(
        __this: *mut Self,
        mut ext_id: *const ACE_String_Base_char_,
        mut int_id: *const *mut ACE_CapEntry,
        mut old_ext_id: *mut ACE_String_Base_char_,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE8rebind_iERKS1_RKS3_RS1_RS3_RP18ACE_Hash_Map_EntryIS1_S3_E"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                ext_id: *const ACE_String_Base_char_,
                int_id: *const *mut ACE_CapEntry,
  ...
  /// locks held.*/
    pub unsafe fn find_i_s92247b79196ba601(
        __this: *mut Self,
        mut ext_id: *const ACE_String_Base_char_,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE6find_iERKS1_"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                ext_id: *const ACE_String_Base_char_,
            ) -> libc::c_int;
    ...
    /**Performs a find using @a ext_id as the key.  Must be called with
  /// locks held.*/
    pub unsafe fn find_i_s3a4a162c2915b645(
        __this: *mut Self,
        mut ext_id: *const ACE_String_Base_char_,
        mut entry: *mut *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE6find_iERKS1_RP18ACE_Hash_Map_EntryIS1_S3_E"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                ext_id: *const ACE_String_Base_char_,
                entry: *mut *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
    ...
    pub unsafe fn unbind_i_s89ec0fe4220f75f0(
        __this: *mut Self,
        mut ext_id: *const ACE_String_Base_char_,
        mut int_id: *mut *mut ACE_CapEntry,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE8unbind_iERKS1_RS3_"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                ext_id: *const ACE_String_Base_char_,
                int_id: *mut *mut ACE_CapEntry,
    ...
    ///Performs unbind.  Must be called with locks held.
    pub unsafe fn unbind_i_s92247b79196ba601(
        __this: *mut Self,
        mut ext_id: *const ACE_String_Base_char_,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE8unbind_iERKS1_"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                ext_id: *const ACE_String_Base_char_,
            ) -> libc::c_int;
    ...
    ///Performs unbind.  Must be called with locks held.
    pub unsafe fn unbind_i_s3a39b7f79998f364(
        __this: *mut Self,
        mut entry: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE8unbind_iEP18ACE_Hash_Map_EntryIS1_S3_E"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                entry: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
            ) -> libc::c_int;
    ...
    pub unsafe fn table(__this: *mut Self) -> *mut libc::c_void {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexE5tableEv"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
            ) -> *mut libc::c_void;
        }
    ...
    pub unsafe fn operator_assign(
        __this: *mut Self,
        mut _anon_0: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexEaSERKS9_"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                _anon_0: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
            );
        }
        __ext(
            __this
    ...
    pub unsafe fn new_at_s61996444bd97941f(
        __this: *mut Self,
        mut __a0: *const ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN23ACE_Hash_Map_Manager_ExI15ACE_String_BaseIcEP12ACE_CapEntry8ACE_HashIS1_E12ACE_Equal_ToIS1_E14ACE_Null_MutexEC1ERKS9_"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                __a0: *const ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
            );
        }
        __ext(
            __this
    ...
    pub unsafe fn new_s61996444bd97941f(
        mut __a0: *const ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s61996444bd97941f(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
                        ...
                        'cont_0: loop {
                            {
                                {
                                    {
                                        let mut temp_ptr: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___ = (*((*__this)
                                            .table_)
                                        ...
                                        'for_1: loop {
                                            ...
                                            'cont_1: loop {
                                                {
                                                    {
                                                        let mut hold_ptr: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___ = temp_ptr;
  ...
  /// locks held.*/
                    ...
                    );
                    {
                        ...
                        'for_0: loop {
                            ...
                            'cont_0: loop {
                                {
                                    {
                                        let mut entry: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___ = ::core::ptr::addr_of_mut!(
                                            (* ((* __this).table_).wrapping_offset((i) as isize))
                                        )
                                            as *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___;
                                        'dowhile_1: loop {
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut bytes: libc::c_ulong = (((((size) as libc::c_ulong))
                    .wrapping_mul((64) as libc::c_ulong)) as libc::c_ulong);
                ...
                (*__this).total_size_ = size;
                {
                    ...
                    'for_1: loop {
                        ...
                        'cont_1: loop {
                            {
                                {
                                    let __place: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___ = (::core::ptr::addr_of_mut!(
                                        (* ((* __this).table_).wrapping_offset((i) as isize))
                                    )
                                        as *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___)
                                        as *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___;
    ...
    pub unsafe fn open(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                return <ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_>::create_buckets(
                    (__this)
                        as *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                    size,
                );
    ...
    pub unsafe fn new_at_s070e196bc4421324(
        __this: *mut Self,
        mut table_alloc: *mut ACE_Allocator,
        mut entry_alloc: *mut ACE_Allocator,
    ) {
        unsafe {
            ...
            ::core::ptr::write(
                ...
                ((0) as *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___),
            );
            ::core::ptr::write(
            ...
            <ACE_Hash_ACE_CString_>::new_at(
                ::core::ptr::addr_of_mut!((* __this).hash_key_),
            );
            <ACE_Equal_To_ACE_CString_>::new_at(
                ::core::ptr::addr_of_mut!((* __this).compare_keys_),
            );
            {
                if (((((<ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_>::open(
                    (__this)
                        as *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                    ((1024) as libc::c_ulong),
                    table_alloc,
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        b"ACE_Hash_Map_Manager_Ex open\0".as_ptr()
                                            as *const libc::c_char,
                                    );
                                }
                            }
    ...
    pub unsafe fn new_s070e196bc4421324(
        mut __a0: *mut ACE_Allocator,
        mut __a1: *mut ACE_Allocator,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s070e196bc4421324(::core::ptr::addr_of_mut!(__obj), __a0, __a1);
        __obj
    }
    ...
    pub unsafe fn close(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                return <ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_>::close_i(
                    (__this)
                        as *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                );
            }
  ...
  /// separate method to facilitate template specialization.*/
    pub unsafe fn hash(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return ((<ACE_Hash_ACE_CString_>::operator_call(
                    (::core::ptr::addr_of!((* __this).hash_key_))
                        as *const ACE_Hash_ACE_CString_,
  ...
  /// separate method to facilitate template specialization.*/
    pub unsafe fn equal(
        __this: *mut Self,
        mut id1: *const ACE_String_Base_char_,
        mut id2: *const ACE_String_Base_char_,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return <ACE_Equal_To_ACE_CString_>::operator_call(
                    (::core::ptr::addr_of!((* __this).compare_keys_))
                        as *const ACE_Equal_To_ACE_CString_,
                    ::core::ptr::addr_of!((* id1)),
                    ::core::ptr::addr_of!((* id2)),
                );
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    ...
    pub unsafe fn shared_find(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                (*loc) = (((((<ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_>::hash(
                    (__this)
                        as *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                    ::core::ptr::addr_of!((* ext_id)),
                )) as libc::c_ulong)) % (((*__this).total_size_) as libc::c_ulong))
                    as libc::c_ulong);
                let mut temp: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___ = (*((*__this)
                    .table_)
                ...
                'while_0: loop {
                    if !(((((((((((temp) as *const u8))
                        != (((::core::ptr::addr_of_mut!(
                            ...
                            as *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___)
                            as *const u8))) as libc::c_int as libc::c_int) != 0)
                        && (((((<ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_>::equal(
                            (__this)
                                as *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                            ::core::ptr::addr_of!(
                                (* ::core::ptr::addr_of!((* temp).ext_id_) .cast:: <
                                ACE_String_Base_char_ > ().cast_mut())
                            ),
                            ::core::ptr::addr_of!((* ext_id)),
                        ) as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
    ...
    pub unsafe fn bind_i_scc0ab8f6f74bf063(
        __this: *mut Self,
        mut ext_id: *const ACE_String_Base_char_,
        mut int_id: *const *mut ACE_CapEntry,
        mut entry: *mut *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                if (((((<ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_>::shared_find(
                    (__this)
                        as *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                    ::core::ptr::addr_of!((* ext_id)),
                    ::core::ptr::addr_of_mut!((* entry)),
                    ...
                    as libc::c_int as libc::c_int) != 0)
                {
                            ...
                            {
                                {
                                    ptr = {
                                        ...
                                        let __vt: *const __Vtbl_uf2113694993e252c = *(__obj
                                            as *const *const __Vtbl_uf2113694993e252c);
                                        ((*__vt)
                                            .vfn_u685215409e23bf32)(__obj, ((64) as libc::c_ulong))
                                    };
                                    if (((((ptr).is_null()) as libc::c_int) as libc::c_int)
                                        != 0)
                                    {
                    ...
                    (*entry) = {
                        let __place: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___ = (ptr)
                            as *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___;
                        <ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___>::new_at_s74300038fe8e6ad1(
                            (__place)
                                as *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
                            ...
                            (*((*__this).table_).wrapping_offset((loc) as isize)).next_,
                            ::core::ptr::addr_of_mut!(
                                (* ((* __this).table_).wrapping_offset((loc) as isize))
                            )
                                as *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
    ...
    ///Performs bind.  Must be called with locks held.
    pub unsafe fn bind_i_s436e7376947974ff(
        __this: *mut Self,
        mut ext_id: *const ACE_String_Base_char_,
        mut int_id: *const *mut ACE_CapEntry,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut temp: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___ = unsafe {
                    ::core::mem::zeroed()
                };
                return <ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_>::bind_i_scc0ab8f6f74bf063(
                    (__this)
                        as *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                    ::core::ptr::addr_of!((* ext_id)),
                    ::core::ptr::addr_of!((* int_id)),
    ...
    pub unsafe fn bind_s436e7376947974ff(
        __this: *mut Self,
        mut ext_id: *const ACE_String_Base_char_,
        mut int_id: *const *mut ACE_CapEntry,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                return <ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_>::bind_i_s436e7376947974ff(
                    (__this)
                        as *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                    ::core::ptr::addr_of!((* ext_id)),
                    ::core::ptr::addr_of!((* int_id)),
  ...
  /// called with locks held.*/
    pub unsafe fn find_i_s89ec0fe4220f75f0(
        __this: *mut Self,
        mut ext_id: *const ACE_String_Base_char_,
        mut int_id: *mut *mut ACE_CapEntry,
    ) -> libc::c_int {
  ...
  /// Return 0 if found, returns -1 if not found.*/
    pub unsafe fn find_sce8c1849c72cc46f(
        __this: *const Self,
        mut ext_id: *const ACE_String_Base_char_,
        mut int_id: *mut *mut ACE_CapEntry,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut nc_this: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_ = (__this
                    as *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_);
                ...
                return <ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_>::find_i_s89ec0fe4220f75f0(
                    (nc_this)
                        as *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                    ::core::ptr::addr_of!((* ext_id)),
...
impl ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___ {
    ///Key accessor.
    pub unsafe fn key_s1db87e8295bec41d(
        __this: *mut Self,
    ) -> *mut ACE_String_Base_char_ {
        extern "C-unwind" {
            #[link_name = "_ZN18ACE_Hash_Map_EntryI15ACE_String_BaseIcEP12ACE_CapEntryE3keyEv"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
            ) -> *mut ACE_String_Base_char_;
        }
        __ext(__this as *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___)
    }
    ///Read-only key accessor.
    pub unsafe fn key_s5a1c19455b066f0f(
        __this: *const Self,
    ) -> *const ACE_String_Base_char_ {
        extern "C-unwind" {
            #[link_name = "_ZNK18ACE_Hash_Map_EntryI15ACE_String_BaseIcEP12ACE_CapEntryE3keyEv"]
            fn __ext(
                __this: *const ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
            ) -> *const ACE_String_Base_char_;
        }
        __ext(__this as *const ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___)
    }
    ///Item accessor.
    pub unsafe fn item_s9db367e67e5fda1a(__this: *mut Self) -> *mut *mut ACE_CapEntry {
        extern "C-unwind" {
            #[link_name = "_ZN18ACE_Hash_Map_EntryI15ACE_String_BaseIcEP12ACE_CapEntryE4itemEv"]
            fn __ext(
                __this: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
            ) -> *mut *mut ACE_CapEntry;
        }
        __ext(__this as *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___)
    }
    ///Read-only item accessor.
    pub unsafe fn item_s8c5b56b646005ccc(
        __this: *const Self,
    ) -> *const *mut ACE_CapEntry {
        extern "C-unwind" {
            #[link_name = "_ZNK18ACE_Hash_Map_EntryI15ACE_String_BaseIcEP12ACE_CapEntryE4itemEv"]
            fn __ext(
                __this: *const ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
            ) -> *const *mut ACE_CapEntry;
        }
    ...
    pub unsafe fn dump(__this: *const Self) {
        extern "C-unwind" {
            #[link_name = "_ZNK18ACE_Hash_Map_EntryI15ACE_String_BaseIcEP12ACE_CapEntryE4dumpEv"]
            fn __ext(
                __this: *const ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
            );
        }
    ...
    ///Constructor.
    pub unsafe fn new_at_s961c6805b9945fe6(
        __this: *mut Self,
        mut next: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
        mut prev: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
    ) {
        unsafe {
            ::core::ptr::write(
                __this,
            ...
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).next_), next);
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).prev_), prev);
            <ACE_String_Base_char_>::new_at_s89536104322d6768(
                ::core::ptr::addr_of_mut!((* __this).ext_id_)
                    .cast::<ACE_String_Base_char_>(),
                ((0) as *mut ACE_Allocator),
            );
            {}
            ()
    ...
    pub unsafe fn new_s961c6805b9945fe6(
        mut __a0: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
        mut __a1: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s961c6805b9945fe6(::core::ptr::addr_of_mut!(__obj), __a0, __a1);
        __obj
    }
    ///Constructor.
    pub unsafe fn new_at_s74300038fe8e6ad1(
        __this: *mut Self,
        mut ext_id: *const ACE_String_Base_char_,
        mut int_id: *const *mut ACE_CapEntry,
        mut next: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
    ...
    pub unsafe fn new_s74300038fe8e6ad1(
        mut __a0: *const ACE_String_Base_char_,
        mut __a1: *const *mut ACE_CapEntry,
        mut __a2: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
        mut __a3: *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s74300038fe8e6ad1(
            ::core::ptr::addr_of_mut!(__obj),
            __a0,
            __a1,
            __a2,
...
impl ACE_Hash_Map_Iterator_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_ {
    pub unsafe fn new_at_s46b0dbef5bca7a4a(
        __this: *mut Self,
        mut mm: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
        mut tail: libc::c_int,
    ) {
        unsafe {
            ::core::ptr::write(
            ...
            <ACE_Hash_Map_Iterator_Base_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_>::new_at_s4fb81f4b81430a58(
                (::core::ptr::addr_of_mut!((* __this).__base_0))
                    as *mut ACE_Hash_Map_Iterator_Base_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                ::core::ptr::addr_of_mut!((* mm)),
                ((if (((((tail as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    1
                } else {
    ...
    pub unsafe fn new_s46b0dbef5bca7a4a(
        mut __a0: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
        mut __a1: libc::c_int,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s46b0dbef5bca7a4a(::core::ptr::addr_of_mut!(__obj), __a0, __a1);
        __obj
    }
  ...
  /// items in the set have been seen, else 1.*/
    pub unsafe fn advance(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return <ACE_Hash_Map_Iterator_Base_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_>::forward_i(
                    (::core::ptr::addr_of_mut!((* __this).__base_0))
                        as *mut ACE_Hash_Map_Iterator_Base_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
                );
            }
...
impl ACE_Hash_Map_Iterator_Base_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_ {
    /**Move forward by one element in the set.  Returns 0 when there's
  /// no more item in the set after the current items, else 1.*/
    pub unsafe fn forward_i(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((((*(*__this).map_man_).table_).is_null()) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    return (-((1) as libc::c_int));
                } else {
                    if ((((((*__this).index_ as libc::c_long))
                        == ((((-((1) as libc::c_int))) as libc::c_long))) as libc::c_int
                        as libc::c_int) != 0)
                    {
                        {
                            let __lv = &mut ((*__this).index_);
                            let __r = *__lv;
                            *__lv = (*__lv).wrapping_add(1);
                            __r
                        };
                        ...
                        if ((((((*__this).index_ as libc::c_long))
                            >= (((((*(*__this).map_man_).total_size_ as libc::c_long))
                                as libc::c_long))) as libc::c_int as libc::c_int) != 0)
                        {
                            return 0;
                        }
                    }
                }
                (*__this).next_ = (*(*__this).next_).next_;
                if (((((((*__this).next_) as *const u8))
                    == (((::core::ptr::addr_of_mut!(
                        (* ((* (* __this).map_man_).table_).wrapping_offset(((* __this)
                        .index_) as isize))
                    ) as *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___)
                        as *const u8))) as libc::c_int as libc::c_int) != 0)
                {
                    'while_0: loop {
                        ...
                        'cont_0: loop {
                            {
                                {
                                    (*__this).next_ = (*((*(*__this).map_man_).table_)
                                        .wrapping_offset(((*__this).index_) as isize))
                                        .next_;
                                    if (((((((*__this).next_) as *const u8))
                                        != (((::core::ptr::addr_of_mut!(
                                            (* ((* (* __this).map_man_).table_).wrapping_offset(((*
                                            __this).index_) as isize))
                                        )
                                            as *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___)
                                            as *const u8))) as libc::c_int as libc::c_int) != 0)
                                    {
                ...
                return ((((((*__this).index_ as libc::c_long))
                    < (((((*(*__this).map_man_).total_size_ as libc::c_long))
                        as libc::c_long))) as libc::c_int) as libc::c_int);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    #[doc = "Constructor.\n  /**\n   *  If @a head != @c false, the iterator constructed is positioned\n   *  at the head of the map.  It is positioned at the end otherwise.\n   *  @par"]
    pub unsafe fn new_at_s4fb81f4b81430a58(
        __this: *mut Self,
        mut mm: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
        mut head: bool,
    ) {
        unsafe {
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).map_man_),
                ::core::ptr::addr_of_mut!((* mm))
                    as *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).index_),
                if ((head as libc::c_int) != 0) {
                    (((-((1) as libc::c_int))) as libc::c_long)
                } else {
                    ((*mm).total_size_ as libc::c_long)
                },
            );
            ::core::ptr::write(
            ...
            {
                if ((((!((*mm).table_).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    (*__this).next_ = ::core::ptr::addr_of_mut!(
                        (* ((* mm).table_).wrapping_offset((if ((head as libc::c_int) !=
                        0) { ((0) as libc::c_ulong) } else { ((((* mm).total_size_) as
                        libc::c_ulong)).wrapping_sub((1) as libc::c_ulong) }) as isize))
                    ) as *mut ACE_Hash_Map_Entry_ACE_String_Base_char___ACE_CapEntry___;
                }
            }
            ()
    ...
    pub unsafe fn new_s4fb81f4b81430a58(
        mut __a0: *mut ACE_Hash_Map_Manager_Ex_ACE_String_Base_char___ACE_CapEntry____ACE_Hash_ACE_CString___ACE_Equal_To_ACE_CString___ACE_Null_Mutex_,
        mut __a1: bool,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s4fb81f4b81430a58(::core::ptr::addr_of_mut!(__obj), __a0, __a1);
        __obj
    }
  ...
  /// Returns 0 when all items have been seen, else 1.*/
    pub unsafe fn next(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((((((((((((((!((*(*__this).map_man_).table_).is_null())
                    as libc::c_int) as libc::c_int) != 0)
                    && ((((((*__this).index_ as libc::c_long))
                        < (((((*(*__this).map_man_).total_size_ as libc::c_long))
                            as libc::c_long))) as libc::c_int as libc::c_int) != 0))
                    as libc::c_int) as libc::c_int) != 0)
                    && ((((((*__this).index_ as libc::c_long))
    ...
    pub unsafe fn done(__this: *const Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return ((((((((((((((*(*__this).map_man_).table_).is_null())
                    as libc::c_int) as libc::c_int) != 0)
                    || ((((((*__this).index_ as libc::c_long))
                        >= (((((*(*__this).map_man_).total_size_ as libc::c_long))
                            as libc::c_long))) as libc::c_int as libc::c_int) != 0))
                    as libc::c_int) as libc::c_int) != 0)
                    || ((((((*__this).index_ as libc::c_long)) < (((0) as libc::c_long)))
                        as libc::c_int as libc::c_int) != 0)) as libc::c_int))
                    as libc::c_int);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
...
pub unsafe fn __vdtor_ue84903f32cb09f56(__this: *mut ACE_CapEntry) {
    let _ = Box::from_raw(__this as *mut ACE_StringCapEntry);
}
pub static __VTBL_ue84903f32cb09f56: __Vtbl_ue84903f32cb09f56 = __Vtbl_ue84903f32cb09f56 {
    __type_info: &__TYPEINFO_18ACE_StringCapEntry,
    __vdtor: __vdtor_ue84903f32cb09f56,
};
