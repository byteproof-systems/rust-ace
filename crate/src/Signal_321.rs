...
#[export_name = "__acedtor_u6c78bee3fdbb2127"]
pub unsafe extern "C-unwind" fn __acedtor_u6c78bee3fdbb2127(__this: *mut ACE_Sig_Set) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
    }
}
#[export_name = "_ZNK11ACE_Sig_Set4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK11ACE_Sig_Set4dumpEv(
    __this: *const ACE_Sig_Set,
) {
    unsafe { ACE_Sig_Set::dump(__this) }
}
...
#[export_name = "_ZN14ACE_Sig_ActionC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Sig_ActionC1Ev(
    __this: *mut ACE_Sig_Action,
) {
    ACE_Sig_Action::new_at(__this)
}
#[export_name = "_ZN14ACE_Sig_ActionC1EPFviEP10__sigset_ti"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Sig_ActionC1EPFviEP10__sigset_ti(
    __this: *mut ACE_Sig_Action,
    __a0: Option<unsafe extern "C-unwind" fn(libc::c_int)>,
    __a1: *mut __sigset_t,
    __a2: libc::c_int,
) {
    ACE_Sig_Action::new_at_u892bf0cfe5150792(__this, __a0, __a1, __a2)
}
#[export_name = "_ZN14ACE_Sig_ActionC1EPFviERK11ACE_Sig_Seti"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Sig_ActionC1EPFviERK11ACE_Sig_Seti(
    __this: *mut ACE_Sig_Action,
    __a0: Option<unsafe extern "C-unwind" fn(libc::c_int)>,
    __a1: *const ACE_Sig_Set,
    __a2: libc::c_int,
) {
    ACE_Sig_Action::new_at_u8b56cd1c456e16e0(__this, __a0, __a1, __a2)
}
#[export_name = "_ZN14ACE_Sig_ActionC1EPFviEiP10__sigset_ti"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Sig_ActionC1EPFviEiP10__sigset_ti(
    __this: *mut ACE_Sig_Action,
    __a0: Option<unsafe extern "C-unwind" fn(libc::c_int)>,
    __a1: libc::c_int,
    __a2: *mut __sigset_t,
    ...
    ACE_Sig_Action::new_at_u86502fabbb2d72c2(__this, __a0, __a1, __a2, __a3)
}
#[export_name = "_ZN14ACE_Sig_ActionC1EPFviEiRK11ACE_Sig_Seti"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Sig_ActionC1EPFviEiRK11ACE_Sig_Seti(
    __this: *mut ACE_Sig_Action,
    __a0: Option<unsafe extern "C-unwind" fn(libc::c_int)>,
    __a1: libc::c_int,
    ...
    ACE_Sig_Action::new_at_ub54cb9768e84bbd0(__this, __a0, __a1, __a2, __a3)
}
#[export_name = "_ZN14ACE_Sig_ActionC1ERK11ACE_Sig_SetPFviES2_i"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Sig_ActionC1ERK11ACE_Sig_SetPFviES2_i(
    __this: *mut ACE_Sig_Action,
    ...
    ACE_Sig_Action::new_at_u9835d3d7c2ae36e9(__this, __a0, __a1, __a2, __a3)
}
#[export_name = "_ZN14ACE_Sig_ActionC1ERK11ACE_Sig_SetPFviEP10__sigset_ti"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Sig_ActionC1ERK11ACE_Sig_SetPFviEP10__sigset_ti(
    __this: *mut ACE_Sig_Action,
    __a0: *const ACE_Sig_Set,
    __a1: Option<unsafe extern "C-unwind" fn(libc::c_int)>,
    __a2: *mut __sigset_t,
    ...
    ACE_Sig_Action::new_at_u22c0e21ba8c3dfc5(__this, __a0, __a1, __a2, __a3)
}
...
#[export_name = "__acedtor_u2f1f30f4f5bd2233"]
pub unsafe extern "C-unwind" fn __acedtor_u2f1f30f4f5bd2233(
    __this: *mut ACE_Sig_Action,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[export_name = "_ZNK14ACE_Sig_Action4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK14ACE_Sig_Action4dumpEv(
    __this: *const ACE_Sig_Action,
) {
    unsafe { ACE_Sig_Action::dump(__this) }
}
...
impl Drop for ACE_Sig_Guard {
    fn drop(&mut self) {
        ...
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.omask_);
        }
    }
}
#[export_name = "__acedtor_ue2d33af8f6a80e7a"]
pub unsafe extern "C-unwind" fn __acedtor_ue2d33af8f6a80e7a(__this: *mut ACE_Sig_Guard) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
    }
}
#[export_name = "_ZNK13ACE_Sig_Guard4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_Sig_Guard4dumpEv(
    __this: *const ACE_Sig_Guard,
) {
    unsafe { ACE_Sig_Guard::dump(__this) }
}
extern "C" {
...
impl ACE_Sig_Action {
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ...
            {
                (*__this).sa_.sa_flags = 0;
                ACE_OS::sigemptyset_udf9bdeb276d35426(
                    ((::core::ptr::addr_of_mut!((* __this).sa_.sa_mask)
                        as *mut __sigset_t) as *mut __sigset_t),
                );
                (*__this).sa_.__sigaction_handler.sa_handler = None;
            }
            ()
        }
    }
  ...
  /// register for signal handling via the @c sigaction function.*/
    pub unsafe fn new_at_u892bf0cfe5150792(
        __this: *mut Self,
        mut sig_handler: Option<unsafe extern "C-unwind" fn(libc::c_int)>,
        mut sig_mask: *mut __sigset_t,
        mut sig_flags: libc::c_int,
    ) {
        unsafe {
            ::core::ptr::write(
                __this,
            ...
            {
                (*__this).sa_.sa_flags = sig_flags;
                if (((((sig_mask).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    ACE_OS::sigemptyset_udf9bdeb276d35426(
                        ((::core::ptr::addr_of_mut!((* __this).sa_.sa_mask)
                            as *mut __sigset_t) as *mut __sigset_t),
                    );
  ...
  /// register for signal handling via the @c sigaction function.*/
    pub unsafe fn new_at_u8b56cd1c456e16e0(
        __this: *mut Self,
        mut sig_handler: Option<unsafe extern "C-unwind" fn(libc::c_int)>,
        mut sig_mask: *const ACE_Sig_Set,
        mut sig_flags: libc::c_int,
    ) {
        unsafe {
            ::core::ptr::write(
            ...
            );
            {
                (*__this).sa_.sa_flags = sig_flags;
                {
                    let __v = <ACE_Sig_Set>::sigset(
                        (::core::ptr::addr_of!((* sig_mask))) as *const ACE_Sig_Set,
                    );
                    let __asg_p = ::core::ptr::addr_of_mut!((* __this).sa_.sa_mask);
                    *__asg_p = __v;
                    __asg_p
    ...
    pub unsafe fn new_at_u86502fabbb2d72c2(
        ...
        unsafe {
            ...
            );
            {
                ...
                ACE_OS::sigaction_uf038829092b02270(
                    signum,
            ...
            );
            {
                ...
                };
                {
                    ...
                    'for_0: loop {
                        ...
                        'cont_0: loop {
                            {
                                if ((((((<ACE_Sig_Set>::is_member(
                                    (::core::ptr::addr_of!((* signals))) as *const ACE_Sig_Set,
                                    s,
                                    ...
                                    as libc::c_int as libc::c_int) != 0)
                                {
                                    ACE_OS::sigaction_uf038829092b02270(
                                        ...
                                        (::core::ptr::addr_of_mut!((* __this).sa_)
                                            as *mut sigaction) as *const sigaction,
                                        ((0) as *mut sigaction),
                                    );
                                }
                            }
