...
#[export_name = "_ZN26ACE_Recursive_Thread_MutexC1EPKcP19pthread_mutexattr_t"]
pub unsafe extern "C-unwind" fn __xtu__ZN26ACE_Recursive_Thread_MutexC1EPKcP19pthread_mutexattr_t(
    __this: *mut ACE_Recursive_Thread_Mutex,
    __a0: *const libc::c_char,
    __a1: *mut pthread_mutexattr_t,
) {
    ACE_Recursive_Thread_Mutex::new_at(__this, __a0, __a1)
}
...
#[export_name = "__acedtor_ub41d302ca1e4f26a"]
pub unsafe extern "C-unwind" fn __acedtor_ub41d302ca1e4f26a(
    __this: *mut ACE_Recursive_Thread_Mutex,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[export_name = "_ZN26ACE_Recursive_Thread_Mutex6removeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN26ACE_Recursive_Thread_Mutex6removeEv(
    __this: *mut ACE_Recursive_Thread_Mutex,
) -> libc::c_int {
    unsafe { ACE_Recursive_Thread_Mutex::remove(__this) }
}
#[export_name = "_ZN26ACE_Recursive_Thread_Mutex13get_thread_idEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN26ACE_Recursive_Thread_Mutex13get_thread_idEv(
    __this: *mut ACE_Recursive_Thread_Mutex,
) -> libc::c_ulong {
    unsafe { ACE_Recursive_Thread_Mutex::get_thread_id(__this) }
}
#[export_name = "_ZN26ACE_Recursive_Thread_Mutex17get_nesting_levelEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN26ACE_Recursive_Thread_Mutex17get_nesting_levelEv(
    __this: *mut ACE_Recursive_Thread_Mutex,
) -> libc::c_int {
    unsafe { ACE_Recursive_Thread_Mutex::get_nesting_level(__this) }
}
#[export_name = "_ZNK26ACE_Recursive_Thread_Mutex4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK26ACE_Recursive_Thread_Mutex4dumpEv(
    __this: *const ACE_Recursive_Thread_Mutex,
) {
    unsafe { ACE_Recursive_Thread_Mutex::dump(__this) }
}
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/Recursive_Thread_Mutex.cpp\0"
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        b"recursive_mutex_init\0".as_ptr() as *const libc::c_char,
                                    );
                                }
                            }
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                    ...
                    == (((false) as libc::c_int))) as libc::c_int as libc::c_int) != 0)
                {
                    ...
                    result = ACE_OS::recursive_mutex_destroy(
                        ::core::ptr::addr_of_mut!((* __this).lock_)
                            as *mut pthread_mutex_t,
                    );
                }
