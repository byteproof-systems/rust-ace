...
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Unbounded_Queue_int_ {
    pub head_: *mut ACE_Node_int_,
    pub cur_size_: libc::c_ulong,
    pub allocator_: *mut ACE_Allocator,
}
pub unsafe extern "C-unwind" fn __xtu__ZN19ACE_Unbounded_QueueIiE12enqueue_tailERKi(
    __this: *mut ACE_Unbounded_Queue_int_,
    new_item: *const libc::c_int,
) -> libc::c_int {
    unsafe { ACE_Unbounded_Queue_int_::enqueue_tail(__this, new_item) }
}
pub unsafe extern "C-unwind" fn __xtu__ZN19ACE_Unbounded_QueueIiE12delete_nodesEv(
    __this: *mut ACE_Unbounded_Queue_int_,
) {
    unsafe { ACE_Unbounded_Queue_int_::delete_nodes(__this) }
}
#[export_name = "_ZN19ACE_Unbounded_QueueIiE5resetEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN19ACE_Unbounded_QueueIiE5resetEv(
    __this: *mut ACE_Unbounded_Queue_int_,
) {
    unsafe { ACE_Unbounded_Queue_int_::reset(__this) }
}
impl Drop for ACE_Unbounded_Queue_int_ {
    fn drop(&mut self) {
        unsafe {
            let __this: *mut Self = self as *mut Self;
            {
                <ACE_Unbounded_Queue_int_>::delete_nodes(
                    (__this) as *mut ACE_Unbounded_Queue_int_,
                );
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
...
pub unsafe extern "C-unwind" fn __acedtor_udfbf29be629bbdc1(
    __this: *mut ACE_Unbounded_Queue_int_,
) {
    unsafe {
...
pub unsafe extern "C-unwind" fn __xtu__ZN19ACE_Unbounded_QueueIiEC1EP13ACE_Allocator(
    __this: *mut ACE_Unbounded_Queue_int_,
    __a0: *mut ACE_Allocator,
) {
    ACE_Unbounded_Queue_int_::new_at_s160f93cc7a474edd(__this, __a0)
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ACE_Unbounded_Queue_Iterator_int_ {
    pub current_: *mut ACE_Node_int_,
    pub queue_: *mut ACE_Unbounded_Queue_int_,
}
#[export_name = "_ZN28ACE_Unbounded_Queue_IteratorIiEC1ER19ACE_Unbounded_QueueIiEi"]
pub unsafe extern "C-unwind" fn __xtu__ZN28ACE_Unbounded_Queue_IteratorIiEC1ER19ACE_Unbounded_QueueIiEi(
    __this: *mut ACE_Unbounded_Queue_Iterator_int_,
    __a0: *mut ACE_Unbounded_Queue_int_,
    __a1: libc::c_int,
) {
    ACE_Unbounded_Queue_Iterator_int_::new_at_s4e837c6a8f8abf3c(__this, __a0, __a1)
}
#[export_name = "_ZNK28ACE_Unbounded_Queue_IteratorIiE4doneEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK28ACE_Unbounded_Queue_IteratorIiE4doneEv(
    __this: *const ACE_Unbounded_Queue_Iterator_int_,
) -> libc::c_int {
    unsafe { ACE_Unbounded_Queue_Iterator_int_::done(__this) }
}
#[export_name = "_ZN28ACE_Unbounded_Queue_IteratorIiE4nextERPi"]
pub unsafe extern "C-unwind" fn __xtu__ZN28ACE_Unbounded_Queue_IteratorIiE4nextERPi(
    __this: *mut ACE_Unbounded_Queue_Iterator_int_,
    item: *mut *mut libc::c_int,
) -> libc::c_int {
    unsafe { ACE_Unbounded_Queue_Iterator_int_::next(__this, item) }
}
#[export_name = "_ZN28ACE_Unbounded_Queue_IteratorIiE7advanceEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN28ACE_Unbounded_Queue_IteratorIiE7advanceEv(
    __this: *mut ACE_Unbounded_Queue_Iterator_int_,
) -> libc::c_int {
    unsafe { ACE_Unbounded_Queue_Iterator_int_::advance(__this) }
}
extern "C" {
...
#[doc = "Collect basic stats about a series of samples\n/**\n * Compute the average and standard deviation (aka jitter) for an\n * arbitrary number of samples, using constant space.\n * Normally used for latency statistics."]
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ACE_Basic_Stats {
    pub samples_count_: libc::c_uint,
    pub min_: libc::c_ulong,
    pub min_at_: libc::c_uint,
    pub max_: libc::c_ulong,
    pub max_at_: libc::c_uint,
    pub sum_: libc::c_ulong,
}
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Basic_StatsC1Ev(
    __this: *mut ACE_Basic_Stats,
) {
    ACE_Basic_Stats::new_at(__this)
}
#[export_name = "_ZNK15ACE_Stats_Value16fractional_fieldEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK15ACE_Stats_Value16fractional_fieldEv(
    __this: *const ACE_Stats_Value,
) -> libc::c_uint {
    unsafe { ACE_Stats_Value::fractional_field(__this) }
}
...
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Stats {
    pub overflow_: libc::c_uint,
    pub number_of_samples_: libc::c_uint,
    pub min_: libc::c_int,
    pub max_: libc::c_int,
    pub samples_: ::core::mem::ManuallyDrop<ACE_Unbounded_Queue_int_>,
}
impl Drop for ACE_Stats {
    fn drop(&mut self) {
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.samples_);
        }
    }
}
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_StatsC1Ev(__this: *mut ACE_Stats) {
    ACE_Stats::new_at(__this)
}
#[export_name = "_ZN9ACE_Stats6sampleEi"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Stats6sampleEi(
    __this: *mut ACE_Stats,
    value: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_Stats::sample(__this, value) }
}
#[export_name = "_ZN9ACE_Stats4meanER15ACE_Stats_Valuej"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Stats4meanER15ACE_Stats_Valuej(
    __this: *mut ACE_Stats,
    m: *mut ACE_Stats_Value,
    scale_factor: libc::c_uint,
) {
    unsafe { ACE_Stats::mean(__this, m, scale_factor) }
}
#[export_name = "_ZN9ACE_Stats7std_devER15ACE_Stats_Valuej"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Stats7std_devER15ACE_Stats_Valuej(
    __this: *mut ACE_Stats,
    std_dev: *mut ACE_Stats_Value,
    scale_factor: libc::c_uint,
) -> libc::c_int {
    unsafe { ACE_Stats::std_dev(__this, std_dev, scale_factor) }
}
#[export_name = "_ZNK9ACE_Stats13print_summaryEjjP8_IO_FILE"]
pub unsafe extern "C-unwind" fn __xtu__ZNK9ACE_Stats13print_summaryEjjP8_IO_FILE(
    __this: *const ACE_Stats,
    precision: libc::c_uint,
    scale_factor: libc::c_uint,
    file: *mut _IO_FILE,
) -> libc::c_int {
    unsafe { ACE_Stats::print_summary(__this, precision, scale_factor, file) }
}
#[export_name = "_ZN9ACE_Stats5resetEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Stats5resetEv(__this: *mut ACE_Stats) {
    unsafe { ACE_Stats::reset(__this) }
}
#[export_name = "_ZN9ACE_Stats8quotientEmjR15ACE_Stats_Value"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Stats8quotientEmjR15ACE_Stats_Value(
    dividend: libc::c_ulong,
    divisor: libc::c_uint,
    quotient: *mut ACE_Stats_Value,
) {
    unsafe { ACE_Stats::quotient(dividend, divisor, quotient) }
}
#[export_name = "_ZN9ACE_Stats8quotientERK15ACE_Stats_ValuejRS0_"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Stats8quotientERK15ACE_Stats_ValuejRS0_(
    dividend: *const ACE_Stats_Value,
    divisor: libc::c_uint,
    quotient: *mut ACE_Stats_Value,
) {
    unsafe { ACE_Stats::quotient_ub0fc8e782b5a532e(dividend, divisor, quotient) }
}
#[export_name = "_ZN9ACE_Stats11square_rootEmR15ACE_Stats_Value"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Stats11square_rootEmR15ACE_Stats_Value(
    n: libc::c_ulong,
    square_root: *mut ACE_Stats_Value,
) {
    unsafe { ACE_Stats::square_root(n, square_root) }
}
extern "C-unwind" {
...
impl ACE_Basic_Stats {
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).samples_count_),
                ((0) as libc::c_uint),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).min_),
                ((0) as libc::c_ulong),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).min_at_),
                ((0) as libc::c_uint),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).max_),
                ((0) as libc::c_ulong),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).max_at_),
                ((0) as libc::c_uint),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).sum_),
                ((0) as libc::c_ulong),
            );
            {}
            ()
    ...
    pub unsafe fn samples_count(__this: *const Self) -> libc::c_uint {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((*__this).samples_count_) as libc::c_uint);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    ///Record one sample.
    pub unsafe fn sample(__this: *mut Self, mut value: libc::c_ulong) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                {
                    let __lv = &mut ((*__this).samples_count_);
                    *__lv = (*__lv).wrapping_add(1);
                    *__lv
                };
                if ((((((*__this).samples_count_ as libc::c_uint))
                    == (((1u32) as libc::c_uint))) as libc::c_int as libc::c_int) != 0)
                {
                    (*__this).min_ = value;
                    (*__this).min_at_ = (*__this).samples_count_;
                    (*__this).max_ = value;
                    (*__this).max_at_ = (*__this).samples_count_;
                } else {
                    if ((((((*__this).min_ as libc::c_ulong))
                        > (((value) as libc::c_ulong))) as libc::c_int as libc::c_int)
                        != 0)
                    {
                        (*__this).min_ = value;
                        (*__this).min_at_ = (*__this).samples_count_;
                    }
                    if ((((((*__this).max_ as libc::c_ulong))
                        < (((value) as libc::c_ulong))) as libc::c_int as libc::c_int)
                        != 0)
                    {
                        (*__this).max_ = value;
                ...
                {
                    let __lv = ::core::ptr::addr_of_mut!((* __this).sum_);
                    unsafe {
                        *__lv = ((((*__lv)) as libc::c_ulong))
                            .wrapping_add((value) as libc::c_ulong);
                        *__lv
                    }
                };
            }
    ...
    pub unsafe fn accumulate(__this: *mut Self, mut rhs: *const ACE_Basic_Stats) {
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_Basic_Stats10accumulateERKS_"]
            fn __ext(__this: *mut ACE_Basic_Stats, rhs: *const ACE_Basic_Stats);
        }
        __ext(__this as *mut ACE_Basic_Stats, rhs)
    }
    #[doc = "Dump all the samples\n  /**\n   * Prints out the results, using @a msg as a prefix for each message and\n   * scaling all the numbers by @a scale_factor. The latter is useful because\n   * high resolution timer samples are acquired in clock ticks, but often\n   * presented in microseconds."]
    pub unsafe fn dump_results(
        __this: *const Self,
        mut msg: *const libc::c_char,
        mut scale_factor: libc::c_uint,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZNK15ACE_Basic_Stats12dump_resultsEPKcj"]
            fn __ext(
                __this: *const ACE_Basic_Stats,
                msg: *const libc::c_char,
                scale_factor: libc::c_uint,
            );
        }
        __ext(__this as *const ACE_Basic_Stats, msg, scale_factor)
    }
}
impl ACE_Stats {
    ///Default constructor.
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ...
            <ACE_Unbounded_Queue_int_>::new_at_s160f93cc7a474edd(
                ::core::ptr::addr_of_mut!((* __this).samples_)
                    .cast::<ACE_Unbounded_Queue_int_>(),
                ((0) as *mut ACE_Allocator),
            );
            {
                <ACE_Stats>::reset((__this) as *mut ACE_Stats);
            }
            ()
        }
    }
  ...
  /// to running out of memory, or to rolling over of the sample count.*/
    pub unsafe fn sample(__this: *mut Self, mut value: libc::c_int) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((((<ACE_Unbounded_Queue_int_>::enqueue_tail(
                    (::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).samples_) .cast:: <
                        ACE_Unbounded_Queue_int_ > ().cast_mut())
                    )) as *mut ACE_Unbounded_Queue_int_,
                    ::core::ptr::addr_of!(value),
                ) as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    {
                        let __lv = &mut ((*__this).number_of_samples_);
                        *__lv = (*__lv).wrapping_add(1);
                        *__lv
                    };
                    if ((((((*__this).number_of_samples_ as libc::c_uint))
                        == (((0) as libc::c_uint))) as libc::c_int as libc::c_int) != 0)
                    {
                        (*__this).overflow_ = ((14) as libc::c_uint);
                        return (-((1) as libc::c_int));
                    }
                    if (((((value as libc::c_int)) < ((((*__this).min_) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        (*__this).min_ = ((value) as libc::c_int);
                    }
                    if (((((value as libc::c_int)) > ((((*__this).max_) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        (*__this).max_ = ((value) as libc::c_int);
                    }
                    return 0;
                } else {
                    (*__this).overflow_ = ((((*(__errno_location())))) as libc::c_uint);
                    return (-((1) as libc::c_int));
                }
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
    ...
    pub unsafe fn samples(__this: *const Self) -> libc::c_uint {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((*__this).number_of_samples_) as libc::c_uint);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    ///Value of the minimum sample provided so far.
    pub unsafe fn min_value(__this: *const Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((*__this).min_) as libc::c_int);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    ///Value of the maximum sample provided so far.
    pub unsafe fn max_value(__this: *const Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((*__this).max_) as libc::c_int);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    #[doc = "* Access the mean of all samples provided so far.  The fractional\n   * part is to the specified number of digits.  E.g., 3 fractional\n   * digits specifies that the fractional part is in thousandths."]
    pub unsafe fn mean(
        __this: *mut Self,
        mut m: *mut ACE_Stats_Value,
        mut scale_factor: libc::c_uint,
    ) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((((*__this).number_of_samples_ as libc::c_uint))
                    > (((0) as libc::c_uint))) as libc::c_int as libc::c_int) != 0)
                {
                    let mut ACE_STATS_INTERNAL_OFFSET: libc::c_ulong = ((4294967296u64)
                        as libc::c_ulong);
                    let mut sum: libc::c_ulong = ((ACE_STATS_INTERNAL_OFFSET)
                        as libc::c_ulong);
                    let mut i: ACE_Unbounded_Queue_Iterator_int_ = ::core::mem::MaybeUninit::<
                        ACE_Unbounded_Queue_Iterator_int_,
                    >::zeroed()
                        .assume_init();
                    <ACE_Unbounded_Queue_Iterator_int_>::new_at_s4e837c6a8f8abf3c(
                        (::core::ptr::addr_of_mut!(i))
                            as *mut ACE_Unbounded_Queue_Iterator_int_,
                        ::core::ptr::addr_of_mut!(
                            (* ::core::ptr::addr_of!((* __this).samples_) .cast:: <
                            ACE_Unbounded_Queue_int_ > ().cast_mut())
                        ),
                    ...
                    'while_0: loop {
                        if !((((!(((<ACE_Unbounded_Queue_Iterator_int_>::done(
                            (::core::ptr::addr_of!(i))
                                as *const ACE_Unbounded_Queue_Iterator_int_,
                        ...
                        'cont_0: loop {
                            {
                                {
                                    let mut sample: *mut libc::c_int = unsafe {
                                        ::core::mem::zeroed()
                                    };
                                    if ((<ACE_Unbounded_Queue_Iterator_int_>::next(
                                        (::core::ptr::addr_of_mut!(i))
                                            as *mut ACE_Unbounded_Queue_Iterator_int_,
                                        ::core::ptr::addr_of_mut!(sample),
                                    )) != 0)
                                    {
                                        {
                                            sum = (((sum) as libc::c_ulong))
                                                .wrapping_add(((*(sample))) as libc::c_ulong);
                                            sum
                                        };
                                        <ACE_Unbounded_Queue_Iterator_int_>::advance(
                                            (::core::ptr::addr_of_mut!(i))
                                                as *mut ACE_Unbounded_Queue_Iterator_int_,
                                        );
                                    }
                    ...
                    <ACE_Stats>::quotient(
                        (((((sum) as libc::c_ulong))
                            .wrapping_sub((ACE_STATS_INTERNAL_OFFSET) as libc::c_ulong))
                            as libc::c_ulong),
                        ((((((*__this).number_of_samples_) as libc::c_uint))
                            .wrapping_mul((scale_factor) as libc::c_uint))
                            as libc::c_uint),
                        ::core::ptr::addr_of_mut!((* m)),
                    );
                } else {
                    <ACE_Stats_Value>::whole(
                        (::core::ptr::addr_of_mut!((* m))) as *mut ACE_Stats_Value,
                        ((0) as libc::c_uint),
                    );
                    <ACE_Stats_Value>::fractional(
                        (::core::ptr::addr_of_mut!((* m))) as *mut ACE_Stats_Value,
                        ((0) as libc::c_uint),
                    );
                }
  ...
  /// description of {mean} method for argument descriptions.*/
    pub unsafe fn std_dev(
        __this: *mut Self,
        mut std_dev: *mut ACE_Stats_Value,
        mut scale_factor: libc::c_uint,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((((*__this).number_of_samples_ as libc::c_uint))
                    <= (((1) as libc::c_uint))) as libc::c_int as libc::c_int) != 0)
                {
                    <ACE_Stats_Value>::whole(
                        (::core::ptr::addr_of_mut!((* std_dev))) as *mut ACE_Stats_Value,
                        ((0) as libc::c_uint),
                    );
                    <ACE_Stats_Value>::fractional(
                        (::core::ptr::addr_of_mut!((* std_dev))) as *mut ACE_Stats_Value,
                    ...
                    let mut field: libc::c_uint = ((<ACE_Stats_Value>::fractional_field(
                        (::core::ptr::addr_of!((* std_dev))) as *const ACE_Stats_Value,
                    )) as libc::c_uint);
                    let mut mean_scaled: libc::c_ulong = unsafe {
                        ::core::mem::zeroed()
                    };
                    let mut avg: ACE_Stats_Value = ::core::mem::MaybeUninit::<
                        ACE_Stats_Value,
                    >::zeroed()
                        .assume_init();
                    <ACE_Stats_Value>::new_at(
                        (::core::ptr::addr_of_mut!(avg)) as *mut ACE_Stats_Value,
                        ((<ACE_Stats_Value>::precision(
                            (::core::ptr::addr_of!((* std_dev)))
                                as *const ACE_Stats_Value,
                        )) as libc::c_uint),
                    );
                    <ACE_Stats>::mean(
                        (__this) as *mut ACE_Stats,
                        ::core::ptr::addr_of_mut!(avg),
                        ((1u32) as libc::c_uint),
                    );
                    <ACE_Stats_Value>::scaled_value(
                        (::core::ptr::addr_of!(avg)) as *const ACE_Stats_Value,
                        ::core::ptr::addr_of_mut!(mean_scaled),
                    );
                    let mut sum_of_squares: libc::c_ulong = ((0) as libc::c_ulong);
                    let mut i: ACE_Unbounded_Queue_Iterator_int_ = ::core::mem::MaybeUninit::<
                        ACE_Unbounded_Queue_Iterator_int_,
                    >::zeroed()
                        .assume_init();
                            ...
                            {
                                {
                                    ...
                                    {
                                        let mut original_sum_of_squares: libc::c_ulong = ((sum_of_squares)
                                            as libc::c_ulong);
                                        let mut product: libc::c_ulong = ((((((*(sample)))
                                            as libc::c_uint))
                                            .wrapping_mul((field) as libc::c_uint)) as libc::c_ulong);
                                        let mut difference: libc::c_ulong = unsafe {
                                            ::core::mem::zeroed()
                                        };
                                        if (((((product as libc::c_ulong))
                                            >= (((mean_scaled) as libc::c_ulong))) as libc::c_int
                                            as libc::c_int) != 0)
                                        {
                                            difference = (((product) as libc::c_ulong))
                                                .wrapping_sub((mean_scaled) as libc::c_ulong);
                                        } else {
                                            difference = (((mean_scaled) as libc::c_ulong))
                                                .wrapping_sub((product) as libc::c_ulong);
                                        }
                                        {
                                            sum_of_squares = (((sum_of_squares) as libc::c_ulong))
                                                .wrapping_add(
                                                    ((((difference) as libc::c_ulong))
                                                        .wrapping_mul(
                                                            (ACE_U64_TO_U32(difference)) as libc::c_ulong,
                                                        )) as libc::c_ulong,
                                                );
                                            sum_of_squares
                                        };
                                        ...
                                        if (((((sum_of_squares as libc::c_ulong))
                                            < (((original_sum_of_squares) as libc::c_ulong)))
                                            as libc::c_int as libc::c_int) != 0)
                                        {
                                            (*__this).overflow_ = ((28) as libc::c_uint);
                                            return (-((1) as libc::c_int));
                                        }
                                    }
                                }
                    ...
                    let mut variance: ACE_Stats_Value = ::core::mem::MaybeUninit::<
                        ACE_Stats_Value,
                    >::zeroed()
                        .assume_init();
                    <ACE_Stats_Value>::new_at(
                        (::core::ptr::addr_of_mut!(variance)) as *mut ACE_Stats_Value,
                        ((<ACE_Stats_Value>::precision(
                            (::core::ptr::addr_of!((* std_dev)))
                                as *const ACE_Stats_Value,
                        )) as libc::c_uint),
                    ...
                    <ACE_Stats>::quotient(
                        ((sum_of_squares) as libc::c_ulong),
                        (((((((((((((*__this).number_of_samples_) as libc::c_uint))
                            .wrapping_sub((1) as libc::c_uint))) as libc::c_uint))
                            .wrapping_mul((field) as libc::c_uint)) as libc::c_uint))
                            .wrapping_mul((field) as libc::c_uint)) as libc::c_uint),
                        ::core::ptr::addr_of_mut!(variance),
                    );
                    let mut scaled_variance: libc::c_ulong = unsafe {
                        ::core::mem::zeroed()
                    };
                    <ACE_Stats_Value>::scaled_value(
                        (::core::ptr::addr_of!(variance)) as *const ACE_Stats_Value,
                        ::core::ptr::addr_of_mut!(scaled_variance),
                    );
                    {
                        scaled_variance = (((scaled_variance) as libc::c_ulong))
                            .wrapping_mul((field) as libc::c_ulong);
                        scaled_variance
                    };
                    let mut unscaled_standard_deviation: ACE_Stats_Value = ::core::mem::MaybeUninit::<
                        ACE_Stats_Value,
                    >::zeroed()
                        .assume_init();
                    <ACE_Stats_Value>::new_at(
                        (::core::ptr::addr_of_mut!(unscaled_standard_deviation))
                            as *mut ACE_Stats_Value,
                        ((<ACE_Stats_Value>::precision(
                            (::core::ptr::addr_of!((* std_dev)))
                                as *const ACE_Stats_Value,
                        )) as libc::c_uint),
                    );
                    <ACE_Stats>::square_root(
                        ((scaled_variance) as libc::c_ulong),
                        ::core::ptr::addr_of_mut!(unscaled_standard_deviation),
                    );
                    <ACE_Stats>::quotient_ub0fc8e782b5a532e(
                        ::core::ptr::addr_of!(unscaled_standard_deviation),
                        (((((scale_factor) as libc::c_uint))
                            .wrapping_mul((field) as libc::c_uint)) as libc::c_uint),
                        ::core::ptr::addr_of_mut!((* std_dev)),
                    );
                }
                return 0;
            }
    ...
    pub unsafe fn print_summary(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut mean_string: [libc::c_char; 128usize] = unsafe {
                    ::core::mem::zeroed()
                };
                let mut std_dev_string: [libc::c_char; 128usize] = unsafe {
                    ::core::mem::zeroed()
                };
                let mut min_string: [libc::c_char; 128usize] = unsafe {
                    ::core::mem::zeroed()
                };
                let mut max_string: [libc::c_char; 128usize] = unsafe {
                    ::core::mem::zeroed()
                };
                let mut success: libc::c_int = 0;
                {
                    let mut tmp_precision: libc::c_int = ((precision) as libc::c_int);
                    'for_0: loop {
                        if !((((((((((((!((((*__this).overflow_) != 0)) as libc::c_int)
                            as libc::c_int) != 0)
                            && (((!(((success) != 0)) as libc::c_int) as libc::c_int)
                                != 0)) as libc::c_int) as libc::c_int) != 0)
                            && (((((tmp_precision as libc::c_int))
                        ...
                        'cont_0: loop {
                            {
                                {
                                    let mut format: [libc::c_char; 32usize] = unsafe {
                                        ::core::mem::zeroed()
                                    };
                                    if (((((tmp_precision as libc::c_int))
                                        == (((0) as libc::c_int))) as libc::c_int as libc::c_int)
                                        != 0)
                                    {
                                        ACE_OS::snprintf_u9a28649a3b771eeb(
                                            ((format).as_mut_ptr() as *mut libc::c_char),
                                            ((32) as libc::c_ulong),
                                        ...
                                        ACE_OS::snprintf_u9a28649a3b771eeb(
                                            ((format).as_mut_ptr() as *mut libc::c_char),
                                            ((32) as libc::c_ulong),
                                            ((b"%%d.%%0%du\0".as_ptr() as *const libc::c_char)
                                                as *const libc::c_char),
                                            tmp_precision,
                                        );
                                    }
                                    let mut u: ACE_Stats_Value = ::core::mem::MaybeUninit::<
                                        ACE_Stats_Value,
                                    >::zeroed()
                                        .assume_init();
                                    <ACE_Stats_Value>::new_at(
                                        (::core::ptr::addr_of_mut!(u)) as *mut ACE_Stats_Value,
                                        ((tmp_precision) as libc::c_uint),
                                    );
                                    <ACE_Stats>::mean(
                                        (((__this as *mut ACE_Stats))) as *mut ACE_Stats,
                                        ::core::ptr::addr_of_mut!(u),
                                        scale_factor,
                                    );
                                    ACE_OS::snprintf_u9a28649a3b771eeb(
                                        ((mean_string).as_mut_ptr() as *mut libc::c_char),
                                        ((128) as libc::c_ulong),
                                        ((format).as_ptr() as *const libc::c_char),
                                        <ACE_Stats_Value>::whole_uafb62f09e36f57e1(
                                            (::core::ptr::addr_of!(u)) as *const ACE_Stats_Value,
                                        ),
                                        <ACE_Stats_Value>::fractional_u1bb1643807ba048d(
                                            (::core::ptr::addr_of!(u)) as *const ACE_Stats_Value,
                                        ),
                                    );
                                    let mut sd: ACE_Stats_Value = ::core::mem::MaybeUninit::<
                                        ACE_Stats_Value,
                                    >::zeroed()
                                        .assume_init();
                                    <ACE_Stats_Value>::new_at(
                                        (::core::ptr::addr_of_mut!(sd)) as *mut ACE_Stats_Value,
                                        ((tmp_precision) as libc::c_uint),
                                    );
                                    if ((<ACE_Stats>::std_dev(
                                        (((__this as *mut ACE_Stats))) as *mut ACE_Stats,
                                    ...
                                    ACE_OS::snprintf_u9a28649a3b771eeb(
                                        ((std_dev_string).as_mut_ptr() as *mut libc::c_char),
                                        ((128) as libc::c_ulong),
                                        ((format).as_ptr() as *const libc::c_char),
                                        <ACE_Stats_Value>::whole_uafb62f09e36f57e1(
                                            (::core::ptr::addr_of!(sd)) as *const ACE_Stats_Value,
                                        ),
                                        <ACE_Stats_Value>::fractional_u1bb1643807ba048d(
                                            (::core::ptr::addr_of!(sd)) as *const ACE_Stats_Value,
                                        ),
                                    );
                                    let mut minimum: ACE_Stats_Value = ::core::mem::MaybeUninit::<
                                        ACE_Stats_Value,
                                    >::zeroed()
                                        .assume_init();
                                    <ACE_Stats_Value>::new_at(
                                        (::core::ptr::addr_of_mut!(minimum))
                                            as *mut ACE_Stats_Value,
                                        ((tmp_precision) as libc::c_uint),
                                    );
                                    let mut maximum: ACE_Stats_Value = ::core::mem::MaybeUninit::<
                                        ACE_Stats_Value,
                                    >::zeroed()
                                        .assume_init();
                                    <ACE_Stats_Value>::new_at(
                                        (::core::ptr::addr_of_mut!(maximum))
                                            as *mut ACE_Stats_Value,
                                        ((tmp_precision) as libc::c_uint),
                                    );
                                    if ((((((*__this).min_ as libc::c_int))
                                        != (((0) as libc::c_int))) as libc::c_int as libc::c_int)
                                        != 0)
                                    {
                                        let mut m: libc::c_ulong = (((*__this).min_)
                                            as libc::c_ulong);
                                        <ACE_Stats>::quotient(
                                            m,
                                            scale_factor,
                                    ...
                                    if ((((((*__this).max_ as libc::c_int))
                                        != (((0) as libc::c_int))) as libc::c_int as libc::c_int)
                                        != 0)
                                    {
                                        let mut m: libc::c_ulong = (((*__this).max_)
                                            as libc::c_ulong);
                                        <ACE_Stats>::quotient(
                                            m,
                                            scale_factor,
                                    ...
                                    ACE_OS::snprintf_u9a28649a3b771eeb(
                                        ((min_string).as_mut_ptr() as *mut libc::c_char),
                                        ((128) as libc::c_ulong),
                                        ((format).as_ptr() as *const libc::c_char),
                                        <ACE_Stats_Value>::whole_uafb62f09e36f57e1(
                                            (::core::ptr::addr_of!(minimum)) as *const ACE_Stats_Value,
                                        ),
                                        <ACE_Stats_Value>::fractional_u1bb1643807ba048d(
                                            (::core::ptr::addr_of!(minimum)) as *const ACE_Stats_Value,
                                        ),
                                    ...
                                    ACE_OS::snprintf_u9a28649a3b771eeb(
                                        ((max_string).as_mut_ptr() as *mut libc::c_char),
                                        ((128) as libc::c_ulong),
                                        ((format).as_ptr() as *const libc::c_char),
                                        <ACE_Stats_Value>::whole_uafb62f09e36f57e1(
                                            (::core::ptr::addr_of!(maximum)) as *const ACE_Stats_Value,
                                        ),
                                        <ACE_Stats_Value>::fractional_u1bb1643807ba048d(
                                            (::core::ptr::addr_of!(maximum)) as *const ACE_Stats_Value,
                                        ),
                        ...
                        {
                            let __lv = &mut (tmp_precision);
                            *__lv = (*__lv).wrapping_sub(1);
                            *__lv
                        };
                    }
                }
                if (((((success as libc::c_int)) == (((1) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    ACE_OS::fprintf_u7a83295f0e5d324f(
                        file,
                        ((b"samples: %u (%s - %s); mean: %s; std dev: %s\n\0".as_ptr()
                            as *const libc::c_char) as *const libc::c_char),
                        <ACE_Stats>::samples((__this) as *const ACE_Stats),
                        ((min_string).as_mut_ptr() as *mut libc::c_char),
                        ((max_string).as_mut_ptr() as *mut libc::c_char),
                        ((mean_string).as_mut_ptr() as *mut libc::c_char),
                        ((std_dev_string).as_mut_ptr() as *mut libc::c_char),
                    ...
                    ACE_OS::fprintf_u7a83295f0e5d324f(
                        file,
                        ((b"ACE_Stats::print_summary: OVERFLOW: %s\n\0".as_ptr()
                            as *const libc::c_char) as *const libc::c_char),
                        ACE_OS::strerror_uba489202eb01d03e(
                            (((*__this).overflow_) as libc::c_int),
                        ),
                    );
                    return (-((1) as libc::c_int));
                }
    ...
    pub unsafe fn reset(__this: *mut Self) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                (*__this).overflow_ = ((0u32) as libc::c_uint);
                (*__this).number_of_samples_ = ((0u32) as libc::c_uint);
                (*__this).min_ = ((0x7fffffff) as libc::c_int);
                (*__this).max_ = ((((((-((0x8000) as libc::c_int))) as libc::c_int))
                    .wrapping_mul((0x10000) as libc::c_int)) as libc::c_int);
                <ACE_Unbounded_Queue_int_>::reset(
                    (::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).samples_) .cast:: <
                        ACE_Unbounded_Queue_int_ > ().cast_mut())
                    )) as *mut ACE_Unbounded_Queue_int_,
    ...
    pub unsafe fn quotient(
        mut dividend: libc::c_ulong,
        mut divisor: libc::c_uint,
        mut quotient: *mut ACE_Stats_Value,
    ) {
        unsafe {
            {
                <ACE_Stats_Value>::whole(
                    (::core::ptr::addr_of_mut!((* quotient))) as *mut ACE_Stats_Value,
                    (((if (((((divisor as libc::c_uint)) == (((0) as libc::c_uint)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        ((0) as libc::c_ulong)
                    } else {
                        (((dividend) as libc::c_ulong)) / ((divisor) as libc::c_ulong)
                    } as libc::c_uint)) as libc::c_uint),
                );
                if (((((((((<ACE_Stats_Value>::precision(
                    (::core::ptr::addr_of!((* quotient))) as *const ACE_Stats_Value,
                ) as libc::c_uint)) > (((0) as libc::c_uint))) as libc::c_int
                    as libc::c_int) != 0)
                    || (((((divisor as libc::c_uint)) == (((0) as libc::c_uint)))
                    ...
                    as libc::c_int) != 0)
                {
                    ...
                    <ACE_Stats_Value>::fractional(
                        (::core::ptr::addr_of_mut!((* quotient)))
                            as *mut ACE_Stats_Value,
                        (((((((((((((dividend) as libc::c_ulong))
                            % ((divisor) as libc::c_ulong)) as libc::c_ulong))
                            .wrapping_mul((field) as libc::c_ulong)) as libc::c_ulong))
                            / ((divisor) as libc::c_ulong)) as libc::c_uint))
                            as libc::c_uint),
                    );
                } else {
                    <ACE_Stats_Value>::fractional(
    ...
    pub unsafe fn quotient_ub0fc8e782b5a532e(
        mut dividend: *const ACE_Stats_Value,
        mut divisor: libc::c_uint,
        mut quotient: *mut ACE_Stats_Value,
    ) {
        unsafe {
            {
                <ACE_Stats_Value>::whole(
                        ...
                        as libc::c_int as libc::c_int) != 0)
                    {
                        ...
                        (((<ACE_Stats_Value>::whole_uafb62f09e36f57e1(
                            (::core::ptr::addr_of!((* dividend)))
                                as *const ACE_Stats_Value,
                        )) as libc::c_uint)) / ((divisor) as libc::c_uint)
                    }) as libc::c_uint),
                );
                if (((((((((<ACE_Stats_Value>::precision(
                    (::core::ptr::addr_of!((* quotient))) as *const ACE_Stats_Value,
                    ...
                    as libc::c_int) != 0)
                {
                    ...
                    <ACE_Stats_Value>::fractional(
                        ...
                        ((((((((((((((<ACE_Stats_Value>::whole_uafb62f09e36f57e1(
                            ...
                            as libc::c_uint))
                            .wrapping_mul((field) as libc::c_uint)) as libc::c_uint))
                            / ((divisor) as libc::c_uint)) as libc::c_uint))
                            .wrapping_add(
                                ((((<ACE_Stats_Value>::fractional_u1bb1643807ba048d(
                                    (::core::ptr::addr_of!((* dividend)))
                                        as *const ACE_Stats_Value,
    ...
    #[doc = "* Sqrt function, which uses an oversimplified version of Newton's\n   * method.  It's not fast, but it doesn't require floating point\n   * support."]
    pub unsafe fn square_root(
        mut n: libc::c_ulong,
        mut square_root: *mut ACE_Stats_Value,
    ) {
        unsafe {
            {
                let mut floor: libc::c_uint = ((0) as libc::c_uint);
                let mut ceiling: libc::c_uint = ((0xffffffffu32) as libc::c_uint);
                let mut mid: libc::c_uint = ((0) as libc::c_uint);
                let mut i: libc::c_uint = unsafe { ::core::mem::zeroed() };
                {
                    i = ((0) as libc::c_uint);
                    'for_0: loop {
                        if !((((((i as libc::c_uint)) < (((64) as libc::c_uint)))
                            as libc::c_int as libc::c_int) != 0))
                        {
                            break;
                        }
                        'cont_0: loop {
                            {
                                {
                                    mid = ((((((((((ceiling) as libc::c_uint))
                                        .wrapping_sub((floor) as libc::c_uint))) as libc::c_uint))
                                        / ((2) as libc::c_uint)) as libc::c_uint))
                                        .wrapping_add((floor) as libc::c_uint);
                                    if (((((floor as libc::c_uint))
                                        == (((mid) as libc::c_uint))) as libc::c_int as libc::c_int)
                                        != 0)
                                    {
                                        break 'for_0;
                                    } else {
                                        let mut mid_squared: libc::c_ulong = ((mid)
                                            as libc::c_ulong);
                                        {
                                            mid_squared = (((mid_squared) as libc::c_ulong))
                                                .wrapping_mul((mid) as libc::c_ulong);
                                            mid_squared
                                        };
                                        if (((((mid_squared as libc::c_ulong))
                ...
                <ACE_Stats_Value>::whole(
                    (::core::ptr::addr_of_mut!((* square_root))) as *mut ACE_Stats_Value,
                    ((mid) as libc::c_uint),
                );
                let mut mid_squared: libc::c_ulong = ((mid) as libc::c_ulong);
                {
                    mid_squared = (((mid_squared) as libc::c_ulong))
                        .wrapping_mul((mid) as libc::c_ulong);
                    mid_squared
                ...
                if ((((((<ACE_Stats_Value>::precision(
                    (::core::ptr::addr_of!((* square_root))) as *const ACE_Stats_Value,
                )) != 0)
                    && (((((mid_squared as libc::c_ulong)) < (((n) as libc::c_ulong)))
                        as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    let mut field: libc::c_uint = ((<ACE_Stats_Value>::fractional_field(
                        (::core::ptr::addr_of!((* square_root)))
                            as *const ACE_Stats_Value,
                    )) as libc::c_uint);
                    floor = ((0) as libc::c_uint);
                    ceiling = ((field) as libc::c_uint);
                    mid = ((0) as libc::c_uint);
                    let mut target: libc::c_ulong = ((n) as libc::c_ulong);
                    {
                    ...
                    let mut difference: libc::c_ulong = ((0) as libc::c_ulong);
                    {
                        i = ((0) as libc::c_uint);
                        'for_1: loop {
                            if !((((((i as libc::c_uint))
                                ...
                                {
                                    {
                                        mid = ((((((((((ceiling) as libc::c_uint))
                                            ...
                                            / ((2) as libc::c_uint)) as libc::c_uint))
                                            .wrapping_add((floor) as libc::c_uint);
                                        let mut current: libc::c_ulong = ((((((((<ACE_Stats_Value>::whole_uafb62f09e36f57e1(
                                            (::core::ptr::addr_of!((* square_root)))
                                                as *const ACE_Stats_Value,
                                        )) as libc::c_uint))
                                            .wrapping_mul((field) as libc::c_uint)) as libc::c_uint))
                                            .wrapping_add((mid) as libc::c_uint)) as libc::c_ulong);
                                        {
                                            current = (((current) as libc::c_ulong))
                                                .wrapping_mul(
                                                    (((((((<ACE_Stats_Value>::whole_uafb62f09e36f57e1(
                                                        (::core::ptr::addr_of!((* square_root)))
                                                            as *const ACE_Stats_Value,
                                        ...
                                        if (((((floor as libc::c_uint))
                                            ...
                                            != 0)
                                        {
                                            difference = (((target) as libc::c_ulong))
                                                .wrapping_sub((current) as libc::c_ulong);
                                            break 'for_1;
                                        } else {
                                            if (((((current as libc::c_ulong))
                                                <= (((target) as libc::c_ulong))) as libc::c_int
                                                as libc::c_int) != 0)
                                            {
                                                floor = mid;
                                            } else {
                    ...
                    let mut next: libc::c_ulong = (((((((((((<ACE_Stats_Value>::whole_uafb62f09e36f57e1(
                        (::core::ptr::addr_of!((* square_root)))
                            as *const ACE_Stats_Value,
                    )) as libc::c_uint))
                        .wrapping_mul((field) as libc::c_uint)) as libc::c_uint))
                        .wrapping_add((mid) as libc::c_uint)) as libc::c_uint))
                        .wrapping_add((1) as libc::c_uint)) as libc::c_ulong);
                    {
                        next = (((next) as libc::c_ulong))
                            .wrapping_mul(
                                ((((((((((<ACE_Stats_Value>::whole_uafb62f09e36f57e1(
                                    (::core::ptr::addr_of!((* square_root)))
                                        as *const ACE_Stats_Value,
                    ...
                    <ACE_Stats_Value>::fractional(
                        (::core::ptr::addr_of_mut!((* square_root)))
                            as *mut ACE_Stats_Value,
                        ((if ((((((((next) as libc::c_ulong))
                            .wrapping_sub((target) as libc::c_ulong) as libc::c_ulong))
                            < (((difference) as libc::c_ulong))) as libc::c_int
                            as libc::c_int) != 0)
                        {
                            (((mid) as libc::c_uint)).wrapping_add((1) as libc::c_uint)
                        } else {
                            mid
                        }) as libc::c_uint),
                    );
...
impl ACE_Unbounded_Queue_int_ {
    #[doc = "Copy constructor.\n  /**\n   * Initialize the queue to be a copy of the provided queue."]
    pub unsafe fn new_at_sc51d9482d1579a5f(
        __this: *mut Self,
        mut __a0: *const ACE_Unbounded_Queue_int_,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN19ACE_Unbounded_QueueIiEC1ERKS0_"]
            fn __ext(
                __this: *mut ACE_Unbounded_Queue_int_,
                __a0: *const ACE_Unbounded_Queue_int_,
            );
        }
        __ext(__this as *mut ACE_Unbounded_Queue_int_, __a0)
    }
    pub unsafe fn new_sc51d9482d1579a5f(
        mut __a0: *const ACE_Unbounded_Queue_int_,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_sc51d9482d1579a5f(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    #[doc = "Assignment operator.\n  /**\n   * Perform a deep copy of rhs."]
    pub unsafe fn operator_assign(
        __this: *mut Self,
        mut _anon_0: *mut ACE_Unbounded_Queue_int_,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN19ACE_Unbounded_QueueIiEaSERKS0_"]
            fn __ext(
                __this: *mut ACE_Unbounded_Queue_int_,
                _anon_0: *mut ACE_Unbounded_Queue_int_,
            );
        }
        __ext(__this as *mut ACE_Unbounded_Queue_int_, _anon_0)
    }
    #[doc = "Returns true if the container is empty, otherwise returns false.\n  /**\n   * Constant time check to see if the queue is empty."]
    pub unsafe fn is_empty(__this: *const Self) -> bool {
        extern "C-unwind" {
            #[link_name = "_ZNK19ACE_Unbounded_QueueIiE8is_emptyEv"]
            fn __ext(__this: *const ACE_Unbounded_Queue_int_) -> bool;
        }
        __ext(__this as *const ACE_Unbounded_Queue_int_)
    }
    #[doc = "Returns 0.\n  /**\n   * The queue cannot be full, so it always returns 0."]
    pub unsafe fn is_full(__this: *const Self) -> bool {
        extern "C-unwind" {
            #[link_name = "_ZNK19ACE_Unbounded_QueueIiE7is_fullEv"]
            fn __ext(__this: *const ACE_Unbounded_Queue_int_) -> bool;
        }
        __ext(__this as *const ACE_Unbounded_Queue_int_)
    }
    ...
    pub unsafe fn enqueue_head(
        __this: *mut Self,
        mut new_item: *const libc::c_int,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN19ACE_Unbounded_QueueIiE12enqueue_headERKi"]
            fn __ext(
                __this: *mut ACE_Unbounded_Queue_int_,
                new_item: *const libc::c_int,
            ) -> libc::c_int;
        }
        __ext(__this as *mut ACE_Unbounded_Queue_int_, new_item)
    }
    ...
    pub unsafe fn dequeue_head(
        __this: *mut Self,
        mut item: *mut libc::c_int,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN19ACE_Unbounded_QueueIiE12dequeue_headERi"]
            fn __ext(
                __this: *mut ACE_Unbounded_Queue_int_,
                item: *mut libc::c_int,
            ) -> libc::c_int;
        }
        __ext(__this as *mut ACE_Unbounded_Queue_int_, item)
    }
    ...
    pub unsafe fn get(
        __this: *const Self,
        mut item: *mut *mut libc::c_int,
        mut slot: libc::c_ulong,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZNK19ACE_Unbounded_QueueIiE3getERPim"]
            fn __ext(
                __this: *const ACE_Unbounded_Queue_int_,
                item: *mut *mut libc::c_int,
                slot: libc::c_ulong,
            ) -> libc::c_int;
        }
        __ext(__this as *const ACE_Unbounded_Queue_int_, item, slot)
    }
    ...
    pub unsafe fn set(
        __this: *mut Self,
        mut item: *const libc::c_int,
        mut slot: libc::c_ulong,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN19ACE_Unbounded_QueueIiE3setERKim"]
            fn __ext(
                __this: *mut ACE_Unbounded_Queue_int_,
                item: *const libc::c_int,
                slot: libc::c_ulong,
            ) -> libc::c_int;
        }
        __ext(__this as *mut ACE_Unbounded_Queue_int_, item, slot)
    }
    #[doc = "The number of items in the queue.\n  /**\n   * Return the size of the queue."]
    pub unsafe fn size(__this: *const Self) -> libc::c_ulong {
        extern "C-unwind" {
            #[link_name = "_ZNK19ACE_Unbounded_QueueIiE4sizeEv"]
            fn __ext(__this: *const ACE_Unbounded_Queue_int_) -> libc::c_ulong;
        }
        __ext(__this as *const ACE_Unbounded_Queue_int_)
    }
    ///Dump the state of an object.
    pub unsafe fn dump(__this: *const Self) {
        extern "C-unwind" {
            #[link_name = "_ZNK19ACE_Unbounded_QueueIiE4dumpEv"]
            fn __ext(__this: *const ACE_Unbounded_Queue_int_);
        }
        __ext(__this as *const ACE_Unbounded_Queue_int_)
    }
    ...
    pub unsafe fn copy_nodes(
        ...
        extern "C-unwind" {
            #[link_name = "_ZN19ACE_Unbounded_QueueIiE10copy_nodesERKS0_"]
            fn __ext(
                __this: *mut ACE_Unbounded_Queue_int_,
                _anon_0: *mut ACE_Unbounded_Queue_int_,
            );
    ...
    pub unsafe fn enqueue_tail(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                (*(*__this).head_).item_ = (((*new_item)) as libc::c_int);
                let mut temp: *mut ACE_Node_int_ = ((0) as *mut ACE_Node_int_);
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            {
                                    ...
                                    != 0)
                                {
                                    ...
                                    {
                                        let _ = {
                                            let __place: *mut ACE_Node_int_ = (temp)
                                                as *mut ACE_Node_int_;
                                            <ACE_Node_int_>::new_at_s5d241a06ce5b449f(
                                                (__place) as *mut ACE_Node_int_,
                                                (*(*__this).head_).next_,
                                                0,
                                            );
                                            __place
                ...
                (*(*__this).head_).next_ = ((temp) as *mut ACE_Node_int_);
                (*__this).head_ = temp;
                {
    ...
    pub unsafe fn delete_nodes(__this: *mut Self) {
        unsafe {
            ...
            {
                {
                    let mut curr: *mut ACE_Node_int_ = (((*(*__this).head_).next_)
                        as *mut ACE_Node_int_);
                    'for_0: loop {
                        if !(((((((curr) as *const u8))
                        ...
                        'cont_0: loop {
                            {
                                {
                                    let mut temp: *mut ACE_Node_int_ = curr;
                                    curr = (((*curr).next_) as *mut ACE_Node_int_);
                                    'dowhile_1: loop {
                                        'cont_1: loop {
                                            {
                                                {
                ...
                (*(*__this).head_).next_ = (((*__this).head_) as *mut ACE_Node_int_);
            }
            ()
        }
    }
    ...
    pub unsafe fn new_at_s160f93cc7a474edd(
        __this: *mut Self,
                        ...
                        {
                            {
                                    ...
                                    as libc::c_int) != 0)
                                {
                                    ...
                                    {
                                        let _ = {
                                            let __place: *mut ACE_Node_int_ = ((*__this).head_)
                                                as *mut ACE_Node_int_;
                                            <ACE_Node_int_>::new_at_s5d241a06ce5b449f(
                                                (__place) as *mut ACE_Node_int_,
                                                ((0) as *mut ACE_Node_int_),
    ...
    pub unsafe fn new_s160f93cc7a474edd(mut __a0: *mut ACE_Allocator) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s160f93cc7a474edd(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
}
impl ACE_Unbounded_Queue_Iterator_int_ {
  ...
  /// queue is empty, else 1.*/
    pub unsafe fn first(__this: *mut Self) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN28ACE_Unbounded_Queue_IteratorIiE5firstEv"]
            fn __ext(__this: *mut ACE_Unbounded_Queue_Iterator_int_) -> libc::c_int;
        }
        __ext(__this as *mut ACE_Unbounded_Queue_Iterator_int_)
    }
    ///Dump the state of an object.
    pub unsafe fn dump(__this: *const Self) {
        extern "C-unwind" {
            #[link_name = "_ZNK28ACE_Unbounded_Queue_IteratorIiE4dumpEv"]
            fn __ext(__this: *const ACE_Unbounded_Queue_Iterator_int_);
        }
        __ext(__this as *const ACE_Unbounded_Queue_Iterator_int_)
    }
    pub unsafe fn new_at_s4e837c6a8f8abf3c(
        __this: *mut Self,
        mut q: *mut ACE_Unbounded_Queue_int_,
        mut end: libc::c_int,
    ) {
        unsafe {
            ::core::ptr::write(
            ...
            ::core::ptr::write(
                ...
                if (((((end as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    (((*(*q).head_).next_) as *mut ACE_Node_int_)
                } else {
                    (*q).head_
                },
            );
    ...
    pub unsafe fn new_s4e837c6a8f8abf3c(
        mut __a0: *mut ACE_Unbounded_Queue_int_,
        mut __a1: libc::c_int,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s4e837c6a8f8abf3c(::core::ptr::addr_of_mut!(__obj), __a0, __a1);
        __obj
    }
