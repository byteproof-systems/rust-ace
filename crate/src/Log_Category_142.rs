...
#[export_name = "_ZN20ACE_Log_Category_TSSC1EP16ACE_Log_CategoryP11ACE_Log_Msg"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Log_Category_TSSC1EP16ACE_Log_CategoryP11ACE_Log_Msg(
    __this: *mut ACE_Log_Category_TSS,
    __a0: *mut ACE_Log_Category,
    __a1: *mut ACE_Log_Msg,
) {
    ACE_Log_Category_TSS::new_at(__this, __a0, __a1)
}
...
#[export_name = "_ZN16ACE_Log_CategoryC1EPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_Log_CategoryC1EPKc(
    __this: *mut ACE_Log_Category,
    __a0: *const libc::c_char,
) {
    ACE_Log_Category::new_at(__this, __a0)
}
                ...
                let __this: *mut Self = self as *mut Self;
                {
                        ...
                        as libc::c_int as libc::c_int) != 0)
                    {
                        ...
                        if ((((!(temp).is_null()) as libc::c_int) as libc::c_int) != 0) {
                            {
                                let __d = (temp as *mut ACE_Log_Category_TSS);
                                if !__d.is_null() {
                                    let _ = Box::from_raw(__d as *mut ACE_Log_Category_TSS);
                                }
                            };
...
#[export_name = "__acedtor_u52845f472dabf67c"]
pub unsafe extern "C-unwind" fn __acedtor_u52845f472dabf67c(
    __this: *mut ACE_Log_Category,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[export_name = "_ZN16ACE_Log_Category11per_thr_objEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_Log_Category11per_thr_objEv(
    __this: *mut ACE_Log_Category,
) -> *mut ACE_Log_Category_TSS {
    unsafe { ACE_Log_Category::per_thr_obj(__this) }
}
#[export_name = "_ZN16ACE_Log_Category7ace_libEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_Log_Category7ace_libEv() -> *mut ACE_Log_Category {
    unsafe { ACE_Log_Category::ace_lib() }
}
#[repr(C)]
#[derive(Clone)]
...
#[no_mangle]
pub unsafe extern "C-unwind" fn ACE_Log_Category_tss_destroy(mut p: *mut libc::c_void) {
    unsafe {
        {
            {
                let __d = (p as *mut ACE_Log_Category_TSS);
                if !__d.is_null() {
                    let _ = Box::from_raw(__d as *mut ACE_Log_Category_TSS);
                }
            };
...
impl ACE_Log_Category_TSS {
    pub unsafe fn new_at(
        __this: *mut Self,
        mut category: *mut ACE_Log_Category,
        mut logger: *mut ACE_Log_Msg,
    ) {
        unsafe {
            ::core::ptr::write(
                __this,
            ...
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).logger_), logger);
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).priority_mask_),
                ((0) as libc::c_ulong),
            );
            {}
            ()
...
impl ACE_Log_Category {
    ...
    pub unsafe fn new_at(__this: *mut Self, mut name: *const libc::c_char) {
        unsafe {
            ::core::ptr::write(
                __this,
                ::core::mem::MaybeUninit::<Self>::zeroed().assume_init(),
            );
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).name_), name);
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).id_),
                ((0) as libc::c_uint),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).priority_mask_),
                ((((((((((((((((((((((((((((((((LM_SHUTDOWN) as libc::c_int))
                    ...
                    | ((LM_ERROR) as libc::c_int)) as libc::c_int))
                    | ((LM_CRITICAL) as libc::c_int)) as libc::c_int))
                    | ((LM_ALERT) as libc::c_int)) as libc::c_int))
                    | ((LM_EMERGENCY) as libc::c_int)) as libc::c_ulong),
            );
            ::core::ptr::write(
            ...
            {
                {
                    ...
                    if (((((<ACE_Guard_ACE_Thread_Mutex_>::locked(
                        ...
                        as libc::c_int) != 0)
                    {} else {
                        return ((0) as *mut ACE_Log_Category_TSS);
                    };
                    if ((((((*__this).id_ as libc::c_uint)) == (((0) as libc::c_uint)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        static mut log_category_id_assigner: ACE_Atomic_Op_ACE_Thread_Mutex__unsigned_int_ = unsafe {
                            ::core::mem::MaybeUninit::<
                                ACE_Atomic_Op_ACE_Thread_Mutex__unsigned_int_,
                            >::zeroed()
                                .assume_init()
                        };
                        {
                            static __init_log_category_id_assigner_9855: ::std::sync::Once = ::std::sync::Once::new();
                            __init_log_category_id_assigner_9855
                                .call_once(|| unsafe {
                                    ::core::ptr::write(
                                        ::core::ptr::addr_of_mut!(log_category_id_assigner),
                                        <ACE_Atomic_Op_ACE_Thread_Mutex__unsigned_int_>::new_ufefa9eb56a8f4964(
                                            ((1) as libc::c_uint),
                                        ),
                                    );
                                });
                        }
                        (*__this).id_ = <ACE_Atomic_Op_GCC_unsigned_int_>::operator_inc_sbaa26e1b39b18202(
                            (::core::ptr::addr_of_mut!(
                                (* (::core::ptr::addr_of_mut!(log_category_id_assigner)))
                                .__base_0
                        ...
                        if (((((ACE_OS::thr_keycreate(
                            ::core::ptr::addr_of_mut!((* __this).key_)
                                as *mut libc::c_uint,
                            Some(ACE_Log_Category_tss_destroy as _),
                        ) as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                            as libc::c_int) != 0)
                        {
                            return ((0) as *mut ACE_Log_Category_TSS);
                ...
                if ((((!(temp).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    return (temp as *mut ACE_Log_Category_TSS);
                }
                let mut result: *mut ACE_Log_Category_TSS = unsafe {
                    ::core::mem::zeroed()
                };
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            {
                                result = {
                                    let __new: *mut ACE_Log_Category_TSS = Box::into_raw(
                                        Box::new(
                                            ::core::mem::MaybeUninit::<ACE_Log_Category_TSS>::zeroed()
                                                .assume_init(),
                                        ),
                                    );
                                    <ACE_Log_Category_TSS>::new_at(
                                        (__new) as *mut ACE_Log_Category_TSS,
                                        __this,
    ...
    pub unsafe fn ace_lib() -> *mut ACE_Log_Category {
        unsafe {
            {
                static mut ace_lib_category: ACE_Log_Category = unsafe {
                    ::core::mem::MaybeUninit::<ACE_Log_Category>::zeroed().assume_init()
                };
                {
                    static __init_ace_lib_category_9859: ::std::sync::Once = ::std::sync::Once::new();
                    __init_ace_lib_category_9859
                        .call_once(|| unsafe {
                            ::core::ptr::write(
                                ::core::ptr::addr_of_mut!(ace_lib_category),
                                <ACE_Log_Category>::new(
                                    ((b"ACE\0".as_ptr() as *const libc::c_char)
                                        as *const libc::c_char),
                                ),
                            );
                        });
                }
                return ::core::ptr::addr_of_mut!(ace_lib_category);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
            ...
            let __this: *mut Self = __this as *mut Self;
            {
                return {
                    unsafe {
                        ...
                        .fetch_add((1) as u32, ::core::sync::atomic::Ordering::SeqCst)
                };
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
