...
#[export_name = "_ZNK12ACE_Hashable4hashEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK12ACE_Hashable4hashEv(
    __this: *const ACE_Hashable,
) -> libc::c_ulong {
    unsafe { ACE_Hashable::hash(__this) }
}
