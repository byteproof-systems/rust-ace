...
pub mod ACE_OS {
    ...
    ///QoS-enabled @c ioctl
    #[export_name = "_ZN6ACE_OS5ioctlEimPvmS0_mPmP14ACE_OVERLAPPEDPFvmmS3_mE"]
    pub unsafe extern "C-unwind" fn ioctl_u8cb58ee7404e374c(
        mut socket: libc::c_int,
        mut io_control_code: libc::c_ulong,
        mut in_buffer_p: *mut libc::c_void,
        mut in_buffer: libc::c_ulong,
        mut out_buffer_p: *mut libc::c_void,
        mut out_buffer: libc::c_ulong,
        mut bytes_returned: *mut libc::c_ulong,
        mut overlapped: *mut super::ACE_OVERLAPPED,
        mut func: Option<
  ...
  /// SIO_SET_QOS or SIO_GET_QOS.*/
    #[export_name = "_ZN6ACE_OS5ioctlEimR7ACE_QoSPmPvmP14ACE_OVERLAPPEDPFvmmS5_mE"]
    pub unsafe extern "C-unwind" fn ioctl_u3ca0e31dfc98a8b9(
        mut socket: libc::c_int,
        mut io_control_code: libc::c_ulong,
        mut ace_qos: *mut super::ACE_QoS,
        mut bytes_returned: *mut libc::c_ulong,
        mut buffer_p: *mut libc::c_void,
        mut buffer: libc::c_ulong,
        mut overlapped: *mut super::ACE_OVERLAPPED,
        mut func: Option<
            unsafe extern "C-unwind" fn(
                libc::c_ulong,
