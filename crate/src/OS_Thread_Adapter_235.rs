...
#[export_name = "_ZN21ACE_OS_Thread_AdapterC1EPFPvS0_ES0_S2_l"]
pub unsafe extern "C-unwind" fn __xtu__ZN21ACE_OS_Thread_AdapterC1EPFPvS0_ES0_S2_l(
    ...
    ACE_OS_Thread_Adapter::new_at(__this, __a0, __a1, __a2, __a3)
}
#[export_name = "_ZN21ACE_OS_Thread_Adapter6invokeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN21ACE_OS_Thread_Adapter6invokeEv(
    __this: *mut ACE_OS_Thread_Adapter,
) -> *mut libc::c_void {
    unsafe { ACE_OS_Thread_Adapter::invoke(__this) }
}
impl Drop for ACE_OS_Thread_Adapter {
    fn drop(&mut self) {
        {
            unsafe {
...
impl ACE_OS_Thread_Adapter {
    ...
    pub unsafe fn new_at(
        ...
        unsafe {
            ...
            <ACE_Base_Thread_Adapter>::new_at(
                (::core::ptr::addr_of_mut!((* __this).__base_0)
                    .cast::<ACE_Base_Thread_Adapter>()) as *mut ACE_Base_Thread_Adapter,
                user_func,
                arg,
                entry_point,
                ((0) as *mut ACE_OS_Thread_Descriptor),
                cancel_flags,
            );
            *(__this as *mut *const ()) = &__VTBL_ue9d5de87bbd2b606
                as *const __Vtbl_ue9d5de87bbd2b606 as *const ();
            {}
            ()
        }
    }
            ...
            let __this: *mut Self = __this as *mut Self;
            {
                <ACE_Base_Thread_Adapter>::inherit_log_msg(
                    (::core::ptr::addr_of_mut!(
                        ...
                        ACE_Base_Thread_Adapter > ().cast_mut())
                ...
                > = unsafe {
                    ...
                    >(
                        (*::core::ptr::addr_of!((* __this).__base_0)
                            .cast::<ACE_Base_Thread_Adapter>()
                            .cast_mut())
                            .user_func_,
                    )
                };
                let mut arg: *mut libc::c_void = (*::core::ptr::addr_of!(
                    (* __this).__base_0
                )
                    .cast::<ACE_Base_Thread_Adapter>()
                    .cast_mut())
                    .arg_;
                let mut cancel_flags: libc::c_long = (*::core::ptr::addr_of!(
                    (* __this).__base_0
                )
                    .cast::<ACE_Base_Thread_Adapter>()
                    .cast_mut())
                    .flags_;
                {
                    let __p = __this;
                    if !__p.is_null() {
                        let __vt: *const __Vtbl_uf9c6177bf0b37713 = *(__p
                            as *const *const __Vtbl_uf9c6177bf0b37713);
                        ((*__vt).__vdtor)(__p as *mut ACE_Base_Thread_Adapter);
                    }
                };
                if (((((cancel_flags as libc::c_long)) != (((0) as libc::c_long)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    let mut old: libc::c_int = 0;
                    let mut val: libc::c_int = (((((cancel_flags) as libc::c_long))
                        & ((((((512) as libc::c_int)) | ((256) as libc::c_int)))
                            as libc::c_long)) as libc::c_int);
                    if (((((((((val as libc::c_int)) == (((512) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
                        || (((((val as libc::c_int)) == (((256) as libc::c_int)))
                            as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                        as libc::c_int) != 0)
                    {
                        ACE_OS::thr_setcancelstate(
                            val,
                            ::core::ptr::addr_of_mut!(old) as *mut libc::c_int,
                        );
                    }
                    val = (((((cancel_flags) as libc::c_long))
                        & ((((((1024) as libc::c_int)) | ((2048) as libc::c_int)))
                            as libc::c_long)) as libc::c_int);
                    if (((((((((val as libc::c_int)) == (((1024) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
                        || (((((val as libc::c_int)) == (((2048) as libc::c_int)))
                            as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                        as libc::c_int) != 0)
                    {
                ...
                if ((1) != 0) {
                    if ((1) != 0) {
                        let mut hook: *mut ACE_Thread_Hook = <ACE_OS_Object_Manager>::thread_hook();
                        if (!(hook).is_null()) {
                            status = {
                                let __obj: *mut ACE_Thread_Hook = (hook)
                                    as *mut ACE_Thread_Hook;
                                let __vt: *const __Vtbl_u5287a1b354e0622b = *(__obj
                                    as *const *const __Vtbl_u5287a1b354e0622b);
                                ((*__vt)
                                    .vfn_ufe523ee6e8a1e001)(
                                    __obj,
                                    unsafe {
                                        ::core::mem::transmute::<
                                            _,
                            ...
                            status = (((func)).expect("null function pointer"))(arg);
                        }
                    }
                }
                if ((1) != 0) {}
...
impl ACE_Thread_Hook {
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_Thread_HookC1Ev"]
            fn __ext(__this: *mut ACE_Thread_Hook);
        }
        __ext(__this as *mut ACE_Thread_Hook)
    }
    ...
    pub unsafe fn start(
        ...
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_Thread_Hook5startEPFPvS0_ES0_"]
            fn __ext(
        ...
        __ext(__this as *mut ACE_Thread_Hook, func, arg)
    }
  ...
  /// hook or 0 if none is set.*/
    pub unsafe fn thread_hook(mut hook: *mut ACE_Thread_Hook) -> *mut ACE_Thread_Hook {
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_Thread_Hook11thread_hookEPS_"]
            fn __ext(hook: *mut ACE_Thread_Hook) -> *mut ACE_Thread_Hook;
        }
        __ext(hook)
    }
    ...
    pub unsafe fn thread_hook_u0edcb51a0654d50c() -> *mut ACE_Thread_Hook {
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_Thread_Hook11thread_hookEv"]
