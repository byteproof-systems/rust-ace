...
impl Clone for ACE_FILE_Addr {
    #[inline]
    fn clone(&self) -> Self {
        unsafe { Self::new_ub38eedcd1eceec76(self as *const Self) }
    }
}
...
#[export_name = "_ZN13ACE_FILE_AddrC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_FILE_AddrC1Ev(
    __this: *mut ACE_FILE_Addr,
) {
    ACE_FILE_Addr::new_at(__this)
}
#[export_name = "_ZN13ACE_FILE_AddrC1ERKS_"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_FILE_AddrC1ERKS_(
    __this: *mut ACE_FILE_Addr,
    __a0: *const ACE_FILE_Addr,
) {
    ACE_FILE_Addr::new_at_ub38eedcd1eceec76(__this, __a0)
}
#[export_name = "_ZN13ACE_FILE_Addr3setERKS_"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_FILE_Addr3setERKS_(
    __this: *mut ACE_FILE_Addr,
    sa: *const ACE_FILE_Addr,
) -> libc::c_int {
    unsafe { ACE_FILE_Addr::set(__this, sa) }
}
#[export_name = "_ZN13ACE_FILE_AddrC1EPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_FILE_AddrC1EPKc(
    __this: *mut ACE_FILE_Addr,
    __a0: *const libc::c_char,
) {
    ACE_FILE_Addr::new_at_u3d5cdbb3d07ff492(__this, __a0)
}
#[export_name = "_ZN13ACE_FILE_Addr3setEPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_FILE_Addr3setEPKc(
    __this: *mut ACE_FILE_Addr,
    filename: *const libc::c_char,
) -> libc::c_int {
    unsafe { ACE_FILE_Addr::set_uf96a48a8767d95d6(__this, filename) }
}
#[export_name = "_ZN13ACE_FILE_AddraSERKS_"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_FILE_AddraSERKS_(
    __this: *mut ACE_FILE_Addr,
    sa: *const ACE_FILE_Addr,
) -> *mut ACE_FILE_Addr {
    unsafe { ACE_FILE_Addr::operator_assign(__this, sa) }
}
#[export_name = "_ZNK13ACE_FILE_Addr8get_addrEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_FILE_Addr8get_addrEv(
    __this: *const ACE_FILE_Addr,
) -> *mut libc::c_void {
    unsafe { ACE_FILE_Addr::get_addr(__this) }
}
#[export_name = "_ZNK13ACE_FILE_Addr14addr_to_stringEPcm"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_FILE_Addr14addr_to_stringEPcm(
    __this: *const ACE_FILE_Addr,
    s: *mut libc::c_char,
    len: libc::c_ulong,
) -> libc::c_int {
    unsafe { ACE_FILE_Addr::addr_to_string(__this, s, len) }
}
#[export_name = "_ZNK13ACE_FILE_Addr4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_FILE_Addr4dumpEv(
    __this: *const ACE_FILE_Addr,
) {
    unsafe { ACE_FILE_Addr::dump(__this) }
}
extern "C-unwind" {
...
impl ACE_FILE_Addr {
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ...
            *(__this as *mut *const ()) = &__VTBL_u0c5462536ace0955
                as *const __Vtbl_u0c5462536ace0955 as *const ();
            {
        ...
        unsafe {
            ...
            <ACE_Addr>::new_at(
                (::core::ptr::addr_of_mut!((* __this).__base_0).cast::<ACE_Addr>())
                    as *mut ACE_Addr,
                1,
                ((::core::mem::size_of::<[libc::c_char; 4097usize]>() as libc::c_ulong)
                    as libc::c_int),
            );
            *(__this as *mut *const ()) = &__VTBL_u0c5462536ace0955
                as *const __Vtbl_u0c5462536ace0955 as *const ();
  ...
  /// create a temporary filename using ACE_OS::mktemp.*/
            ...
            let __this: *mut Self = __this as *mut Self;
            {
                    ...
                    as libc::c_int as libc::c_int) != 0)
                {
                    if (((((ACE::get_temp_dir(
                        ...
                        (((((4096) as libc::c_int)).wrapping_sub((15) as libc::c_int))
                            as libc::c_ulong),
                    ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                                ...
                                {
                                    {
                                        ...
                                        <ACE_Log_Category_TSS>::conditional_set(
                                            ...
                                            ((b"/build/ace_full/src/ACE/ace/FILE_Addr.cpp\0".as_ptr()
                    ...
                    ACE_OS::strcat_u59e0931d4af5fb3f(
                        (((*__this).filename_).as_mut_ptr() as *mut libc::c_char),
                        ((b"ace-fileXXXXXX\0".as_ptr() as *const libc::c_char)
                            as *const libc::c_char),
                    );
                    if (((((ACE_OS::mktemp_ufd8deab57221e9e3(
                        (((*__this).filename_).as_mut_ptr() as *mut libc::c_char),
                    ))
                ...
                } else {
                    {
                        let _ = ACE_OS::strsncpy(
                            (((*__this).filename_).as_mut_ptr() as *mut libc::c_char),
                            (((*sa).filename_).as_ptr() as *const libc::c_char),
                            ((<ACE_Addr>::get_size(
                                (::core::ptr::addr_of!(
                                    (* ::core::ptr::addr_of!((* (::core::ptr::addr_of!((* sa))))
                                    .__base_0) .cast:: < ACE_Addr > ().cast_mut())
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((((__this) as *const u8))
                    != (((((::core::ptr::addr_of!((* sa)) as *const ACE_FILE_Addr)
                        as *mut ACE_FILE_Addr)) as *const u8))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    <ACE_FILE_Addr>::set(
                        (__this) as *mut ACE_FILE_Addr,
    ...
    pub unsafe fn get_addr(__this: *const Self) -> *mut libc::c_void {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (::core::ptr::addr_of!((* __this).filename_)
                    as *const [libc::c_char; 4097usize] as *mut libc::c_void);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
