...
#[export_name = "_ZN14ACE_Event_Base6removeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Event_Base6removeEv(
    __this: *mut ACE_Event_Base,
) -> libc::c_int {
    unsafe { ACE_Event_Base::remove(__this) }
}
#[export_name = "_ZN14ACE_Event_Base4waitEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Event_Base4waitEv(
    __this: *mut ACE_Event_Base,
) -> libc::c_int {
    unsafe { ACE_Event_Base::wait(__this) }
}
#[export_name = "_ZN14ACE_Event_Base4waitEPK14ACE_Time_Valuei"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Event_Base4waitEPK14ACE_Time_Valuei(
    __this: *mut ACE_Event_Base,
    abstime: *const ACE_Time_Value,
    use_absolute_time: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_Event_Base::wait_ua331c20aa8834e06(__this, abstime, use_absolute_time) }
}
#[export_name = "_ZN14ACE_Event_Base6signalEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Event_Base6signalEv(
    __this: *mut ACE_Event_Base,
) -> libc::c_int {
    unsafe { ACE_Event_Base::signal(__this) }
}
#[export_name = "_ZN14ACE_Event_Base5pulseEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Event_Base5pulseEv(
    __this: *mut ACE_Event_Base,
) -> libc::c_int {
    unsafe { ACE_Event_Base::pulse(__this) }
}
#[export_name = "_ZN14ACE_Event_Base5resetEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Event_Base5resetEv(
    __this: *mut ACE_Event_Base,
) -> libc::c_int {
    unsafe { ACE_Event_Base::reset(__this) }
}
#[export_name = "_ZNK14ACE_Event_Base4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK14ACE_Event_Base4dumpEv(
    __this: *const ACE_Event_Base,
) {
    unsafe { ACE_Event_Base::dump(__this) }
}
#[export_name = "_ZN14ACE_Event_BaseC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_Event_BaseC1Ev(
    __this: *mut ACE_Event_Base,
) {
    ACE_Event_Base::new_at(__this)
}
