...
#[doc = "* @class ACE_Profile_Timer\n *\n * @brief This class provides both a timing mechanism and a mechanism\n * for reporting the resource usage of a process."]
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Profile_Timer {
    pub begin_usage_: rusage,
    pub end_usage_: rusage,
    pub last_usage_: rusage,
    pub begin_time_: timeval,
    pub end_time_: timeval,
    pub last_time_: timeval,
}
#[export_name = "_ZN17ACE_Profile_TimerC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Profile_TimerC1Ev(
    __this: *mut ACE_Profile_Timer,
) {
    ACE_Profile_Timer::new_at(__this)
}
impl Drop for ACE_Profile_Timer {
    fn drop(&mut self) {
        unsafe {
            let __this: *mut Self = self as *mut Self;
            {}
...
#[export_name = "__acedtor_u8e03f2c09d737246"]
pub unsafe extern "C-unwind" fn __acedtor_u8e03f2c09d737246(
    __this: *mut ACE_Profile_Timer,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[export_name = "_ZN17ACE_Profile_Timer12elapsed_timeERNS_16ACE_Elapsed_TimeE"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Profile_Timer12elapsed_timeERNS_16ACE_Elapsed_TimeE(
    __this: *mut ACE_Profile_Timer,
    et: *mut ACE_Elapsed_Time,
) -> libc::c_int {
    unsafe { ACE_Profile_Timer::elapsed_time(__this, et) }
}
#[export_name = "_ZN17ACE_Profile_Timer14elapsed_rusageER6rusage"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Profile_Timer14elapsed_rusageER6rusage(
    __this: *mut ACE_Profile_Timer,
    usage: *mut rusage,
) {
    unsafe { ACE_Profile_Timer::elapsed_rusage(__this, usage) }
}
#[export_name = "_ZN17ACE_Profile_Timer10get_rusageER6rusage"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Profile_Timer10get_rusageER6rusage(
    __this: *mut ACE_Profile_Timer,
    usage: *mut rusage,
) {
    unsafe { ACE_Profile_Timer::get_rusage(__this, usage) }
}
#[export_name = "_ZNK17ACE_Profile_Timer4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK17ACE_Profile_Timer4dumpEv(
    __this: *const ACE_Profile_Timer,
) {
    unsafe { ACE_Profile_Timer::dump(__this) }
}
#[export_name = "_ZN17ACE_Profile_Timer13compute_timesERNS_16ACE_Elapsed_TimeE"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Profile_Timer13compute_timesERNS_16ACE_Elapsed_TimeE(
    __this: *mut ACE_Profile_Timer,
    et: *mut ACE_Elapsed_Time,
) {
    unsafe { ACE_Profile_Timer::compute_times(__this, et) }
}
#[export_name = "_ZN17ACE_Profile_Timer8subtractER7timevalS1_S1_"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Profile_Timer8subtractER7timevalS1_S1_(
    __this: *mut ACE_Profile_Timer,
    tdiff: *mut timeval,
    t1: *mut timeval,
    t0: *mut timeval,
) {
    unsafe { ACE_Profile_Timer::subtract(__this, tdiff, t1, t0) }
}
...
impl ACE_Profile_Timer {
        ...
        unsafe {
            ...
            );
            {
                ACE_OS::memset_u2b5dfc47d301370a(
                    ((::core::ptr::addr_of_mut!((* __this).end_usage_) as *mut rusage)
                        as *mut libc::c_void),
                    0,
                ...
                ACE_OS::memset_u2b5dfc47d301370a(
                    ((::core::ptr::addr_of_mut!((* __this).begin_usage_) as *mut rusage)
                        as *mut libc::c_void),
                    0,
                    ((::core::mem::size_of::<rusage>() as libc::c_ulong)
                        as libc::c_ulong),
                ...
                ACE_OS::memset_u2b5dfc47d301370a(
                    ((::core::ptr::addr_of_mut!((* __this).last_usage_) as *mut rusage)
                        as *mut libc::c_void),
                    0,
                    ((::core::mem::size_of::<rusage>() as libc::c_ulong)
                        as libc::c_ulong),
                ...
                ACE_OS::memset_u2b5dfc47d301370a(
                    ((::core::ptr::addr_of_mut!((* __this).begin_time_) as *mut timeval)
                        as *mut libc::c_void),
                    0,
                ...
                ACE_OS::memset_u2b5dfc47d301370a(
                    ((::core::ptr::addr_of_mut!((* __this).end_time_) as *mut timeval)
                        as *mut libc::c_void),
                    0,
                    ((::core::mem::size_of::<timeval>() as libc::c_ulong)
                        as libc::c_ulong),
                ...
                ACE_OS::memset_u2b5dfc47d301370a(
                    ((::core::ptr::addr_of_mut!((* __this).last_time_) as *mut timeval)
                        as *mut libc::c_void),
                    0,
                    ((::core::mem::size_of::<timeval>() as libc::c_ulong)
                        as libc::c_ulong),
    ...
    ///Activate the timer.
    pub unsafe fn start(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                {
                    let __v = <ACE_Time_Value>::operator_timeval(
                        (((&(ACE_OS::gettimeofday_u3220bcbbceb90f45()))
                            as *const ACE_Time_Value)) as *const ACE_Time_Value,
                    );
                    let __asg_p = ::core::ptr::addr_of_mut!((* __this).begin_time_);
                    *__asg_p = __v;
                    __asg_p
                };
                ACE_OS::getrusage_uad34c2a8c422cec1(
                    ((RUSAGE_SELF) as libc::c_int),
                    ((::core::ptr::addr_of_mut!((* __this).begin_usage_) as *mut rusage)
                        as *mut rusage),
                );
                return 0;
    ...
    ///Stop the timer.
    pub unsafe fn stop(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                {
                    let __v = (*__this).end_time_;
                    let __asg_p = ::core::ptr::addr_of_mut!((* __this).last_time_);
                    *__asg_p = __v;
                    __asg_p
                };
                {
                    ...
                    let __asg_p = ::core::ptr::addr_of_mut!((* __this).end_time_);
                    *__asg_p = __v;
                    __asg_p
                };
                {
                    let __v = (*__this).end_usage_;
                    let __asg_p = ::core::ptr::addr_of_mut!((* __this).last_usage_);
                    *__asg_p = __v;
                    __asg_p
                };
                ACE_OS::getrusage_uad34c2a8c422cec1(
    ...
    pub unsafe fn elapsed_time(
        __this: *mut Self,
        mut et: *mut ACE_Elapsed_Time,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                <ACE_Profile_Timer>::compute_times(
                    (__this) as *mut ACE_Profile_Timer,
                    ::core::ptr::addr_of_mut!((* et)),
                );
                return 0;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
  ...
  /// and @c stop().*/
    pub unsafe fn elapsed_rusage(__this: *mut Self, mut usage: *mut rusage) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                (*usage)
                    .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_47_19_
                    .ru_ixrss = ((((*__this)
                    .end_usage_
                    .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_47_19_
                    .ru_ixrss) as libc::c_long))
                    .wrapping_sub(
                        ((*__this)
                            .last_usage_
                            .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_47_19_
                ...
                (*usage)
                    .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_53_19_
                    .ru_idrss = ((((*__this)
                    .end_usage_
                    .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_53_19_
                    .ru_idrss) as libc::c_long))
                    .wrapping_sub(
                        ((*__this)
                            .last_usage_
                            .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_53_19_
                ...
                (*usage)
                    .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_59_19_
                    .ru_isrss = ((((*__this)
                    .end_usage_
                    .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_59_19_
                    .ru_isrss) as libc::c_long))
                    .wrapping_sub(
                        ((*__this)
                            .last_usage_
                            .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_59_19_
                ...
                (*usage)
                    .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_66_19_
                    .ru_minflt = ((((*__this)
                    .end_usage_
                    .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_66_19_
                    .ru_minflt) as libc::c_long))
                    .wrapping_sub(
                        ((*__this)
                            .last_usage_
                            .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_66_19_
                ...
                (*usage)
                    .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_72_19_
                    .ru_majflt = ((((*__this)
                    .end_usage_
                    .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_72_19_
                    .ru_majflt) as libc::c_long))
                    .wrapping_sub(
                        ((*__this)
                            .last_usage_
                            .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_72_19_
                ...
                (*usage)
                    .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_78_19_
                    .ru_nswap = ((((*__this)
                    .end_usage_
                    .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_78_19_
                    .ru_nswap) as libc::c_long))
                    .wrapping_sub(
                        ((*__this)
                            .last_usage_
                            .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_78_19_
                ...
                (*usage)
                    .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_85_19_
                    .ru_inblock = ((((*__this)
                    .end_usage_
                    .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_85_19_
                    .ru_inblock) as libc::c_long))
                    .wrapping_sub(
                        ((*__this)
                            .last_usage_
                            .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_85_19_
                ...
                (*usage)
                    .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_91_19_
                    .ru_oublock = ((((*__this)
                    .end_usage_
                    .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_91_19_
                    .ru_oublock) as libc::c_long))
                    .wrapping_sub(
                        ((*__this)
                            .last_usage_
                            .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_91_19_
                ...
                (*usage)
                    .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_97_19_
                    .ru_msgsnd = ((((*__this)
                    .end_usage_
                    .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_97_19_
                    .ru_msgsnd) as libc::c_long))
                    .wrapping_sub(
                        ((*__this)
                            .last_usage_
                            .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_97_19_
                ...
                (*usage)
                    .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_103_19_
                    .ru_msgrcv = ((((*__this)
                    .end_usage_
                    .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_103_19_
                    .ru_msgrcv) as libc::c_long))
                    .wrapping_sub(
                        ((*__this)
                            .last_usage_
                            .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_103_19_
                ...
                (*usage)
                    .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_109_19_
                    .ru_nsignals = ((((*__this)
                    .end_usage_
                    .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_109_19_
                    .ru_nsignals) as libc::c_long))
                    .wrapping_sub(
                        ((*__this)
                            .last_usage_
                            .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_109_19_
                ...
                (*usage)
                    .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_117_19_
                    .ru_nvcsw = ((((*__this)
                    .end_usage_
                    .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_117_19_
                    .ru_nvcsw) as libc::c_long))
                    .wrapping_sub(
                        ((*__this)
                            .last_usage_
                            .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_117_19_
                ...
                (*usage)
                    .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_124_19_
                    .ru_nivcsw = ((((*__this)
                    .end_usage_
                    .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_124_19_
                    .ru_nivcsw) as libc::c_long))
                    .wrapping_sub(
                        ((*__this)
                            .last_usage_
                            .__anon_field_rusage___anonymous_union_at__usr_include_x86_64_linux_gnu_bits_types_struct_rusage_h_124_19_
                ...
                <ACE_Profile_Timer>::subtract(
                    (__this) as *mut ACE_Profile_Timer,
                    ::core::ptr::addr_of_mut!((* usage).ru_utime),
                    ::core::ptr::addr_of_mut!((* __this).end_usage_.ru_utime),
                    ::core::ptr::addr_of_mut!((* __this).last_usage_.ru_utime),
                );
                <ACE_Profile_Timer>::subtract(
                    (__this) as *mut ACE_Profile_Timer,
                    ::core::ptr::addr_of_mut!((* usage).ru_stime),
                    ::core::ptr::addr_of_mut!((* __this).end_usage_.ru_stime),
                    ::core::ptr::addr_of_mut!((* __this).last_usage_.ru_stime),
                );
            }
            ()
        }
    ...
    pub unsafe fn get_rusage(__this: *mut Self, mut usage: *mut rusage) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                {
                    let __v = (*__this).end_usage_;
                    let __asg_p = ::core::ptr::addr_of_mut!((* usage));
                    *__asg_p = __v;
                    __asg_p
                };
            }
    ...
    pub unsafe fn compute_times(__this: *mut Self, mut et: *mut ACE_Elapsed_Time) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut td: timeval = unsafe {
                    ::core::mem::MaybeUninit::<timeval>::zeroed().assume_init()
                };
                <ACE_Profile_Timer>::subtract(
                    (__this) as *mut ACE_Profile_Timer,
                    ::core::ptr::addr_of_mut!(td),
                    ::core::ptr::addr_of_mut!((* __this).end_time_),
                    ::core::ptr::addr_of_mut!((* __this).begin_time_),
                );
                (*et).real_time = (((((td.tv_sec) as libc::c_double))
                    + (((((((td.tv_usec as libc::c_double))) as libc::c_double))
                        / ((ACE_ONE_SECOND_IN_USECS) as libc::c_double))
                        as libc::c_double)) as libc::c_double);
                <ACE_Profile_Timer>::subtract(
                    (__this) as *mut ACE_Profile_Timer,
                    ::core::ptr::addr_of_mut!(td),
                    ::core::ptr::addr_of_mut!((* __this).end_usage_.ru_utime),
                    ::core::ptr::addr_of_mut!((* __this).begin_usage_.ru_utime),
                );
                (*et).user_time = (((((td.tv_sec) as libc::c_double))
                    + (((((((td.tv_usec as libc::c_double))) as libc::c_double))
                        / ((ACE_ONE_SECOND_IN_USECS) as libc::c_double))
                        as libc::c_double)) as libc::c_double);
                <ACE_Profile_Timer>::subtract(
                    ...
                    ::core::ptr::addr_of_mut!(td),
                    ::core::ptr::addr_of_mut!((* __this).end_usage_.ru_stime),
                    ::core::ptr::addr_of_mut!((* __this).begin_usage_.ru_stime),
                );
                (*et).system_time = (((((td.tv_sec) as libc::c_double))
                    + (((((((td.tv_usec as libc::c_double))) as libc::c_double))
                        / ((ACE_ONE_SECOND_IN_USECS) as libc::c_double))
                        as libc::c_double)) as libc::c_double);
            }
    ...
    pub unsafe fn subtract(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                (*tdiff).tv_sec = ((((*t1).tv_sec) as libc::c_long))
                    .wrapping_sub(((*t0).tv_sec) as libc::c_long);
                (*tdiff).tv_usec = ((((*t1).tv_usec) as libc::c_long))
                    .wrapping_sub(((*t0).tv_usec) as libc::c_long);
                'while_0: loop {
                    if !(((((((*tdiff).tv_usec as libc::c_long))
                    ...
                    'cont_0: loop {
                        {
                            {
                                {
                                    let __lv = &mut ((*tdiff).tv_sec);
                                    let __r = *__lv;
                                    *__lv = (*__lv).wrapping_sub(1);
                                    __r
                                };
                                {
                                    let __lv = ::core::ptr::addr_of_mut!((* tdiff).tv_usec);
                                    unsafe {
                                        *__lv = ((((*__lv)) as libc::c_long))
                                            .wrapping_add((ACE_ONE_SECOND_IN_USECS) as libc::c_long);
                                        *__lv
                                    }
                                };
                            }
