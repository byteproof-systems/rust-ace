...
#[export_name = "_ZN9ACE_SPIPE5closeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_SPIPE5closeEv(
    __this: *mut ACE_SPIPE,
) -> libc::c_int {
    unsafe { ACE_SPIPE::close(__this) }
}
#[export_name = "_ZN9ACE_SPIPE6removeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_SPIPE6removeEv(
    __this: *mut ACE_SPIPE,
) -> libc::c_int {
    unsafe { ACE_SPIPE::remove(__this) }
}
#[export_name = "_ZNK9ACE_SPIPE14get_local_addrER14ACE_SPIPE_Addr"]
pub unsafe extern "C-unwind" fn __xtu__ZNK9ACE_SPIPE14get_local_addrER14ACE_SPIPE_Addr(
    __this: *const ACE_SPIPE,
    local_sap: *mut ACE_SPIPE_Addr,
) -> libc::c_int {
    unsafe { ACE_SPIPE::get_local_addr(__this, local_sap) }
}
#[export_name = "_ZNK9ACE_SPIPE4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK9ACE_SPIPE4dumpEv(__this: *const ACE_SPIPE) {
    unsafe { ACE_SPIPE::dump(__this) }
}
#[export_name = "_ZN9ACE_SPIPEC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_SPIPEC1Ev(__this: *mut ACE_SPIPE) {
    ACE_SPIPE::new_at(__this)
}
extern "C-unwind" {
...
impl ACE_SPIPE {
    ...
    pub unsafe fn get_local_addr(
        __this: *const Self,
        mut local_sap: *mut ACE_SPIPE_Addr,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                <ACE_SPIPE_Addr>::operator_assign(
                    (::core::ptr::addr_of_mut!((* local_sap))) as *mut ACE_SPIPE_Addr,
                    ::core::ptr::addr_of!(
                        (* ::core::ptr::addr_of!((* __this).local_addr_) .cast:: <
                        ACE_SPIPE_Addr > ().cast_mut())
                    ),
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ...
            <ACE_IPC_SAP>::new_at(
                ::core::ptr::addr_of_mut!((* __this).__base_0).cast::<ACE_IPC_SAP>(),
            );
            <ACE_SPIPE_Addr>::new_at(
                ::core::ptr::addr_of_mut!((* __this).local_addr_)
                    .cast::<ACE_SPIPE_Addr>(),
            );
            {}
            ()
