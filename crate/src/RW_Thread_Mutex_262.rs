...
#[export_name = "_ZN19ACE_RW_Thread_MutexC1EPKcPv"]
pub unsafe extern "C-unwind" fn __xtu__ZN19ACE_RW_Thread_MutexC1EPKcPv(
    __this: *mut ACE_RW_Thread_Mutex,
    __a0: *const libc::c_char,
    __a1: *mut libc::c_void,
) {
    ACE_RW_Thread_Mutex::new_at(__this, __a0, __a1)
}
...
#[export_name = "_ZNK19ACE_RW_Thread_Mutex4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK19ACE_RW_Thread_Mutex4dumpEv(
    __this: *const ACE_RW_Thread_Mutex,
) {
    unsafe { ACE_RW_Thread_Mutex::dump(__this) }
}
extern "C-unwind" {
...
impl ACE_RW_Thread_Mutex {
    pub unsafe fn new_at(
        ...
        unsafe {
            ...
            <ACE_RW_Mutex>::new_at(
                (::core::ptr::addr_of_mut!((* __this).__base_0).cast::<ACE_RW_Mutex>())
                    as *mut ACE_RW_Mutex,
