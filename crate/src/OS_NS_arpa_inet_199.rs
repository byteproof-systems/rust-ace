...
pub mod ACE_OS {
    ...
    #[export_name = "_ZN6ACE_OS9inet_atonEPKcP7in_addr"]
    pub unsafe extern "C-unwind" fn inet_aton_u1dc29b8522f89aaa(
        mut host_name: *const libc::c_char,
        mut addr: *mut super::in_addr,
    ) -> libc::c_int {
        unsafe {
            {
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            return ((super::inet_aton(host_name, addr)) as libc::c_int);
                        }
