...
pub mod ACE {
    #[doc = "* This method initializes the ACE library services and initializes\n   * ACE's internal resources.  Applications should not instantiate\n   * ACE classes or call methods on objects of these classes until @a\n   * ACE::init() returns successfully.\n\n   * @return Returns 0 on success, -1 on failure, and 1 if it had\n   * already been called."]
    #[export_name = "_ZN3ACE4initEv"]
    pub unsafe extern "C-unwind" fn init() -> libc::c_int {
        unsafe {
            {
                {
                    let __lv = &mut (init_fini_count_);
                    *__lv = (*__lv).wrapping_add(1);
                    *__lv
                };
                return {
                    let __obj: *mut super::ACE_Object_Manager_Base = (<super::ACE_Object_Manager>::instance())
                        as *mut super::ACE_Object_Manager_Base;
                    let __vt: *const super::__Vtbl_u06e4e36432e67f04 = *(__obj
                        as *const *const super::__Vtbl_u06e4e36432e67f04);
    ...
    #[doc = "* Counter to match init()/fini() calls.  init() must increment it;\n   * fini() must decrement it.  fini() then does nothing until it\n   * reaches 0."]
    #[no_mangle]
    pub static mut init_fini_count_: libc::c_uint = ((0) as libc::c_uint);
}
#[repr(C)]
#[derive(Clone)]
