...
#[export_name = "_ZN28ACE_Dynamic_Message_StrategyC1Emmmm"]
pub unsafe extern "C-unwind" fn __xtu__ZN28ACE_Dynamic_Message_StrategyC1Emmmm(
    ...
    ACE_Dynamic_Message_Strategy::new_at(__this, __a0, __a1, __a2, __a3)
}
impl Drop for ACE_Dynamic_Message_Strategy {
    fn drop(&mut self) {
        {
            unsafe {
        ...
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.pending_shift_);
            ::core::mem::ManuallyDrop::drop(&mut self.min_pending_);
            ::core::mem::ManuallyDrop::drop(&mut self.max_late_);
        }
    }
}
#[export_name = "_ZN28ACE_Dynamic_Message_Strategy15priority_statusER17ACE_Message_BlockRK14ACE_Time_Value"]
pub unsafe extern "C-unwind" fn __xtu__ZN28ACE_Dynamic_Message_Strategy15priority_statusER17ACE_Message_BlockRK14ACE_Time_Value(
    __this: *mut ACE_Dynamic_Message_Strategy,
    mb: *mut ACE_Message_Block,
    tv: *const ACE_Time_Value,
) -> libc::c_uint {
    unsafe { ACE_Dynamic_Message_Strategy::priority_status(__this, mb, tv) }
}
#[export_name = "_ZNK28ACE_Dynamic_Message_Strategy4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK28ACE_Dynamic_Message_Strategy4dumpEv(
    __this: *const ACE_Dynamic_Message_Strategy,
) {
    unsafe { ACE_Dynamic_Message_Strategy::dump(__this) }
}
...
#[export_name = "_ZN29ACE_Deadline_Message_StrategyC1Emmmm"]
pub unsafe extern "C-unwind" fn __xtu__ZN29ACE_Deadline_Message_StrategyC1Emmmm(
    ...
    ACE_Deadline_Message_Strategy::new_at(__this, __a0, __a1, __a2, __a3)
}
impl Drop for ACE_Deadline_Message_Strategy {
    fn drop(&mut self) {
        {
            unsafe {
                let __this: *mut Self = self as *mut Self;
...
#[export_name = "_ZN29ACE_Deadline_Message_Strategy16convert_priorityER14ACE_Time_ValueRK17ACE_Message_Block"]
pub unsafe extern "C-unwind" fn __xtu__ZN29ACE_Deadline_Message_Strategy16convert_priorityER14ACE_Time_ValueRK17ACE_Message_Block(
    __this: *mut ACE_Deadline_Message_Strategy,
    priority: *mut ACE_Time_Value,
    mb: *const ACE_Message_Block,
) {
    unsafe { ACE_Deadline_Message_Strategy::convert_priority(__this, priority, mb) }
}
#[export_name = "_ZNK29ACE_Deadline_Message_Strategy4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK29ACE_Deadline_Message_Strategy4dumpEv(
    __this: *const ACE_Deadline_Message_Strategy,
) {
    unsafe { ACE_Deadline_Message_Strategy::dump(__this) }
}
...
#[export_name = "_ZN27ACE_Laxity_Message_StrategyC1Emmmm"]
pub unsafe extern "C-unwind" fn __xtu__ZN27ACE_Laxity_Message_StrategyC1Emmmm(
    ...
    ACE_Laxity_Message_Strategy::new_at(__this, __a0, __a1, __a2, __a3)
}
impl Drop for ACE_Laxity_Message_Strategy {
    fn drop(&mut self) {
        {
            unsafe {
                let __this: *mut Self = self as *mut Self;
...
#[export_name = "_ZN27ACE_Laxity_Message_Strategy16convert_priorityER14ACE_Time_ValueRK17ACE_Message_Block"]
pub unsafe extern "C-unwind" fn __xtu__ZN27ACE_Laxity_Message_Strategy16convert_priorityER14ACE_Time_ValueRK17ACE_Message_Block(
    __this: *mut ACE_Laxity_Message_Strategy,
    priority: *mut ACE_Time_Value,
    mb: *const ACE_Message_Block,
) {
    unsafe { ACE_Laxity_Message_Strategy::convert_priority(__this, priority, mb) }
}
#[export_name = "_ZNK27ACE_Laxity_Message_Strategy4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK27ACE_Laxity_Message_Strategy4dumpEv(
    __this: *const ACE_Laxity_Message_Strategy,
) {
    unsafe { ACE_Laxity_Message_Strategy::dump(__this) }
}
extern "C-unwind" {
    pub fn clone(
...
impl ACE_Dynamic_Message_Strategy {
    ...
    pub unsafe fn new_at(
        __this: *mut Self,
        mut static_bit_field_mask: libc::c_ulong,
        mut static_bit_field_shift: libc::c_ulong,
        mut dynamic_priority_max: libc::c_ulong,
        mut dynamic_priority_offset: libc::c_ulong,
    ) {
        unsafe {
            ::core::ptr::write(
                __this,
            ...
            *(__this as *mut *const ()) = &__VTBL_uf5eab9c7846c6060
                as *const __Vtbl_uf5eab9c7846c6060 as *const ();
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).static_bit_field_mask_),
                static_bit_field_mask,
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).static_bit_field_shift_),
                static_bit_field_shift,
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).dynamic_priority_max_),
                dynamic_priority_max,
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).dynamic_priority_offset_),
                dynamic_priority_offset,
            );
            <ACE_Time_Value>::new_at_ub59bcc88eaedf2a6(
                (::core::ptr::addr_of_mut!((* __this).max_late_)
                    .cast::<ACE_Time_Value>()) as *mut ACE_Time_Value,
                ((0) as libc::c_long),
                (((((dynamic_priority_offset) as libc::c_ulong))
                    .wrapping_sub((1) as libc::c_ulong)) as libc::c_long),
            );
            <ACE_Time_Value>::new_at_ub59bcc88eaedf2a6(
                (::core::ptr::addr_of_mut!((* __this).min_pending_)
                    .cast::<ACE_Time_Value>()) as *mut ACE_Time_Value,
                ((0) as libc::c_long),
                ((dynamic_priority_offset) as libc::c_long),
            );
            <ACE_Time_Value>::new_at_ub59bcc88eaedf2a6(
                (::core::ptr::addr_of_mut!((* __this).pending_shift_)
                    .cast::<ACE_Time_Value>()) as *mut ACE_Time_Value,
                ((0) as libc::c_long),
                ((dynamic_priority_max) as libc::c_long),
            );
            {}
            ()
        }
    ...
    pub unsafe fn priority_status(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut status: libc::c_uint = ((PENDING) as libc::c_uint);
                let mut priority: ACE_Time_Value = ::core::mem::MaybeUninit::<
                    ACE_Time_Value,
                >::zeroed()
                    .assume_init();
                <ACE_Time_Value>::new_at_u3614bf99aa612c0c(
                    (::core::ptr::addr_of_mut!(priority)) as *mut ACE_Time_Value,
                    ::core::ptr::addr_of!((* tv)),
                );
                {
                    let __obj: *mut ACE_Dynamic_Message_Strategy = (__this)
                        as *mut ACE_Dynamic_Message_Strategy;
                    let __vt: *const __Vtbl_uf5eab9c7846c6060 = *(__obj
                        as *const *const __Vtbl_uf5eab9c7846c6060);
                    ((*__vt)
                        .vfn_ub8799c4f7d106ee0)(
                        __obj,
                ...
                ) as libc::c_int) != 0)
                {
                    ...
                    {
                        <ACE_Message_Block>::msg_priority_u65505cfc65301d38(
                        ...
                        status = ((LATE) as libc::c_uint);
                    }
                }
                <ACE_Message_Block>::msg_priority_u65505cfc65301d38(
                    (::core::ptr::addr_of_mut!((* mb))) as *mut ACE_Message_Block,
                    (((((((<ACE_Message_Block>::msg_priority(
                        (::core::ptr::addr_of!((* mb))) as *const ACE_Message_Block,
                    )) as libc::c_ulong))
                        & (((*__this).static_bit_field_mask_) as libc::c_ulong)))
                        as libc::c_ulong))
                        | ((((((((((<ACE_Time_Value>::usec(
                            (::core::ptr::addr_of!(priority)) as *const ACE_Time_Value,
                        )) as libc::c_long))
                            .wrapping_add(
                            ...
                            .wrapping_shl(((*__this).static_bit_field_shift_) as u32)))
                            as libc::c_ulong),
                );
...
impl ACE_Deadline_Message_Strategy {
    ...
    pub unsafe fn new_at(
        ...
        unsafe {
            ...
            <ACE_Dynamic_Message_Strategy>::new_at(
                (::core::ptr::addr_of_mut!((* __this).__base_0)
                    .cast::<ACE_Dynamic_Message_Strategy>())
                    as *mut ACE_Dynamic_Message_Strategy,
                static_bit_field_mask,
                static_bit_field_shift,
                dynamic_priority_max,
            ...
            *(__this as *mut *const ()) = &__VTBL_ubc3f30140cf29745
                as *const __Vtbl_ubc3f30140cf29745 as *const ();
            {}
            ()
        }
    }
    ...
    pub unsafe fn convert_priority(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                <ACE_Time_Value>::operator_sub_assign(
                    (::core::ptr::addr_of_mut!((* priority))) as *mut ACE_Time_Value,
                    (<ACE_Message_Block>::msg_deadline_time(
                        (::core::ptr::addr_of!((* mb))) as *const ACE_Message_Block,
...
impl ACE_Laxity_Message_Strategy {
    ...
    pub unsafe fn new_at(
        ...
        unsafe {
            ...
            *(__this as *mut *const ()) = &__VTBL_u7506d9196dd623e8
                as *const __Vtbl_u7506d9196dd623e8 as *const ();
            {}
            ()
        }
    }
    ...
    pub unsafe fn convert_priority(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                <ACE_Time_Value>::operator_add_assign(
                    (::core::ptr::addr_of_mut!((* priority))) as *mut ACE_Time_Value,
                    (<ACE_Message_Block>::msg_execution_time(
                        (::core::ptr::addr_of!((* mb))) as *const ACE_Message_Block,
                    )) as *const ACE_Time_Value,
                );
                <ACE_Time_Value>::operator_sub_assign(
