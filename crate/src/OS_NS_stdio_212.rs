...
pub mod ACE_OS {
    ...
    #[export_name = "_ZNK6ACE_OS11ace_flock_t4dumpEv"]
    pub unsafe extern "C-unwind" fn __xtu__ZNK6ACE_OS11ace_flock_t4dumpEv(
        __this: *const ace_flock_t,
    ) {
        unsafe { ace_flock_t::dump(__this) }
    }
    ...
    #[export_name = "_ZN6ACE_OS8asprintfEPPcPKcz"]
    pub unsafe extern "C-unwind" fn asprintf_u65a187f722295b8d(
        ...
        unsafe {
            {
                let mut ap: ::core::ffi::VaList<'_> = unsafe {
                    ::core::mem::MaybeUninit::<::core::ffi::VaList<'_>>::zeroed()
                        .assume_init()
                };
                ap = __args.clone();
                let mut result: libc::c_int = ((vasprintf_uf99bc2083182119a(
                    bufp,
                    format,
                    ap,
                )) as libc::c_int);
    ...
    #[export_name = "_ZN6ACE_OS8asprintfEPPwPKwz"]
    pub unsafe extern "C-unwind" fn asprintf_u12c5997d8588a495(
        mut bufp: *mut *mut libc::wchar_t,
        ...
        unsafe {
            {
                ...
                ap = __args.clone();
                let mut result: libc::c_int = ((vasprintf_u116ec636510b91c2(
                    bufp,
                    format,
                    ap,
                )) as libc::c_int);
    ...
    #[export_name = "_ZN6ACE_OS7fprintfEP8_IO_FILEPKcz"]
    pub unsafe extern "C-unwind" fn fprintf_u7a83295f0e5d324f(
        mut fp: *mut super::_IO_FILE,
        mut format: *const libc::c_char,
        mut __args: ...
    ) -> libc::c_int {
        unsafe {
            {
                ...
                ap = __args.clone();
                let mut result: libc::c_int = ((vfprintf_u987d4e89a24e4338(
                    fp,
                    format,
                    ap,
                )) as libc::c_int);
    ...
    #[export_name = "_ZN6ACE_OS7fprintfEP8_IO_FILEPKwz"]
    pub unsafe extern "C-unwind" fn fprintf_uce705d5ead3af64b(
        mut fp: *mut super::_IO_FILE,
        mut format: *const libc::wchar_t,
        mut __args: ...
    ) -> libc::c_int {
        unsafe {
            {
                ...
                ap = __args.clone();
                let mut result: libc::c_int = ((vfprintf_u56d71c75cec59c2c(
                    fp,
                    format,
                    ap,
                )) as libc::c_int);
    ...
    #[export_name = "_ZN6ACE_OS6printfEPKcz"]
    pub unsafe extern "C-unwind" fn printf_u3be153d67f031433(
        mut format: *const libc::c_char,
        mut __args: ...
    ) -> libc::c_int {
        unsafe {
            {
                ...
                ap = __args.clone();
                let mut result: libc::c_int = ((vprintf_u01e81082ba4c3478(format, ap))
                    as libc::c_int);
                ();
                return ((result) as libc::c_int);
            }
    ...
    #[export_name = "_ZN6ACE_OS6printfEPKwz"]
    pub unsafe extern "C-unwind" fn printf_ue93a1fd6e13a12d7(
        mut format: *const libc::wchar_t,
        mut __args: ...
    ) -> libc::c_int {
        unsafe {
            {
                ...
                ap = __args.clone();
                let mut result: libc::c_int = ((vprintf_uebd9f98ac54a526c(format, ap))
                    as libc::c_int);
                ();
                return ((result) as libc::c_int);
            }
    ...
    #[export_name = "_ZN6ACE_OS8snprintfEPcmPKcz"]
    pub unsafe extern "C-unwind" fn snprintf_u9a28649a3b771eeb(
        ...
        unsafe {
            {
                ...
                ap = __args.clone();
                let mut result: libc::c_int = ((vsnprintf_u82a2749143e3ac84(
                    buf,
                    maxlen,
                    format,
                    ap,
    ...
    #[export_name = "_ZN6ACE_OS8snprintfEPwmPKwz"]
    pub unsafe extern "C-unwind" fn snprintf_u649150efea9fee6b(
        mut buf: *mut libc::wchar_t,
        mut maxlen: libc::c_ulong,
        mut format: *const libc::wchar_t,
        mut __args: ...
    ) -> libc::c_int {
        unsafe {
            {
                ...
                ap = __args.clone();
                let mut result: libc::c_int = ((vsnprintf_u5faa4708bec76a1c(
                    buf,
                    maxlen,
                    format,
                    ap,
    ...
    #[export_name = "_ZN6ACE_OS7sprintfEPcPKcz"]
    pub unsafe extern "C-unwind" fn sprintf_u124e1cc3d4c1a9fc(
        mut buf: *mut libc::c_char,
        mut format: *const libc::c_char,
        mut __args: ...
    ) -> libc::c_int {
        unsafe {
            {
                ...
                ap = __args.clone();
                let mut result: libc::c_int = ((vsprintf_u244a12457fe38a73(
                    buf,
                    format,
                    ap,
                )) as libc::c_int);
    ...
    #[export_name = "_ZN6ACE_OS7sprintfEPwPKwz"]
    pub unsafe extern "C-unwind" fn sprintf_ud7576b55745c336c(
        mut buf: *mut libc::wchar_t,
        mut format: *const libc::wchar_t,
        mut __args: ...
    ) -> libc::c_int {
        unsafe {
            {
                ...
                ap = __args.clone();
                let mut result: libc::c_int = ((vsprintf_uceb65c606a90f8d3(
                    buf,
                    format,
                    ap,
                )) as libc::c_int);
    ...
    #[export_name = "_ZN6ACE_OS20vaswprintf_emulationEPPwPKwP13__va_list_tag"]
    pub unsafe extern "C-unwind" fn vaswprintf_emulation(
        mut bufp: *mut *mut libc::wchar_t,
        mut format: *const libc::wchar_t,
        mut argptr: ::core::ffi::VaList<'_>,
    ) -> libc::c_int {
        unsafe {
            {
                let mut ap: ::core::ffi::VaList<'_> = unsafe {
                ...
                ap = (argptr).clone();
                let mut size: libc::c_int = vsnprintf_u5faa4708bec76a1c(
                ...
                ();
                if (((((size as libc::c_int))
                    != ((((-((1) as libc::c_int))) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    let mut buf: *mut libc::wchar_t = (malloc_u80646b42522769ca(
                        (((((((((size) as libc::c_int))
                    ...
                    let mut aq: ::core::ffi::VaList<'_> = unsafe {
                        ::core::mem::MaybeUninit::<::core::ffi::VaList<'_>>::zeroed()
                            .assume_init()
                    };
                    aq = (argptr).clone();
                    size = vsnprintf_u5faa4708bec76a1c(
                        buf,
                        (((((size) as libc::c_int)).wrapping_add((1) as libc::c_int))
                            as libc::c_ulong),
                        format,
                        aq,
                    );
...
extern "C-unwind" {
    pub fn __builtin_va_copy(
        _anon_0: ::core::ffi::VaList<'_>,
        _anon_1: ::core::ffi::VaList<'_>,
    );
}
