...
#[export_name = "_ZN25ACE_Notification_StrategyC1EP17ACE_Event_Handlerm"]
pub unsafe extern "C-unwind" fn __xtu__ZN25ACE_Notification_StrategyC1EP17ACE_Event_Handlerm(
    __this: *mut ACE_Notification_Strategy,
    __a0: *mut ACE_Event_Handler,
    __a1: libc::c_ulong,
) {
    ACE_Notification_Strategy::new_at(__this, __a0, __a1)
}
impl Drop for ACE_Notification_Strategy {
    fn drop(&mut self) {
        unsafe {
            let __this: *mut Self = self as *mut Self;
            {}
...
impl ACE_Notification_Strategy {
    ...
    pub unsafe fn new_at(
        ...
        unsafe {
            ...
            *(__this as *mut *const ()) = &__VTBL_ud382f80a0b92d3d8
                as *const __Vtbl_ud382f80a0b92d3d8 as *const ();
