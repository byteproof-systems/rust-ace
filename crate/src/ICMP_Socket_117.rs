...
#[export_name = "_ZNK15ACE_ICMP_Socket4sendEPKvmRK8ACE_Addri"]
pub unsafe extern "C-unwind" fn __xtu__ZNK15ACE_ICMP_Socket4sendEPKvmRK8ACE_Addri(
    ...
    unsafe { ACE_ICMP_Socket::send(__this, buf, n, addr, flags) }
}
#[export_name = "_ZNK15ACE_ICMP_Socket4recvEPvmR8ACE_Addri"]
pub unsafe extern "C-unwind" fn __xtu__ZNK15ACE_ICMP_Socket4recvEPvmR8ACE_Addri(
    __this: *const ACE_ICMP_Socket,
    buf: *mut libc::c_void,
    n: libc::c_ulong,
    addr: *mut ACE_Addr,
    ...
    unsafe { ACE_ICMP_Socket::recv(__this, buf, n, addr, flags) }
}
#[export_name = "_ZNK15ACE_ICMP_Socket4recvEPvmiPK14ACE_Time_Value"]
pub unsafe extern "C-unwind" fn __xtu__ZNK15ACE_ICMP_Socket4recvEPvmiPK14ACE_Time_Value(
    __this: *const ACE_ICMP_Socket,
    buf: *mut libc::c_void,
    n: libc::c_ulong,
    flags: libc::c_int,
    ...
    unsafe { ACE_ICMP_Socket::recv_u1f245b00dbfe2fd8(__this, buf, n, flags, timeout) }
}
#[export_name = "_ZN15ACE_ICMP_Socket4openERK8ACE_Addrii"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_ICMP_Socket4openERK8ACE_Addrii(
    __this: *mut ACE_ICMP_Socket,
    local: *const ACE_Addr,
    protocol: libc::c_int,
    reuse_addr: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_ICMP_Socket::open(__this, local, protocol, reuse_addr) }
}
#[export_name = "_ZNK15ACE_ICMP_Socket4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK15ACE_ICMP_Socket4dumpEv(
    __this: *const ACE_ICMP_Socket,
) {
    unsafe { ACE_ICMP_Socket::dump(__this) }
}
#[export_name = "_ZN15ACE_ICMP_SocketC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_ICMP_SocketC1Ev(
    __this: *mut ACE_ICMP_Socket,
) {
    ACE_ICMP_Socket::new_at(__this)
}
#[export_name = "_ZN15ACE_ICMP_Socket11shared_openERK8ACE_Addr"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_ICMP_Socket11shared_openERK8ACE_Addr(
    __this: *mut ACE_ICMP_Socket,
    local: *const ACE_Addr,
) -> libc::c_int {
    unsafe { ACE_ICMP_Socket::shared_open(__this, local) }
}
#[export_name = "_ZN15ACE_ICMP_Socket18calculate_checksumEPti"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_ICMP_Socket18calculate_checksumEPti(
    __this: *mut ACE_ICMP_Socket,
    paddress: *mut libc::c_ushort,
    len: libc::c_int,
) -> libc::c_ushort {
    unsafe { ACE_ICMP_Socket::calculate_checksum(__this, paddress, len) }
}
#[repr(C)]
  ...
  /// (uses @c recvfrom(3) ).*/
    ...
    pub unsafe fn open(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut proto: *mut protoent = ((ACE_OS::getprotobyname_u839dfc24d41334f8(
                    ((b"icmp\0".as_ptr() as *const libc::c_char) as *const libc::c_char),
                )) as *mut protoent);
                if (((!((!(proto).is_null())) as libc::c_int) as libc::c_int) != 0) {
                    'dowhile_0: loop {
                        'cont_0: loop {
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/ICMP_Socket.cpp\0".as_ptr()
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        (ace___) as *mut ACE_Log_Category_TSS,
                                        LM_ERROR,
                                        ((b"(%P|%t) ACE_ICMP_Socket::open: %p; %s\n\0".as_ptr()
                                            as *const libc::c_char) as *const libc::c_char),
                                        b"getprotobyname\0".as_ptr() as *const libc::c_char,
                                        b"ICMP protocol is not properly configured or not supported.\0"
                ...
                let mut proto_number: libc::c_int = (((*proto).p_proto) as libc::c_int);
                if (((((((((proto_number as libc::c_int))
                    != ((((1 as libc::c_int)) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                    || (((((proto_number as libc::c_int))
                        != (((protocol) as libc::c_int))) as libc::c_int as libc::c_int)
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        (ace___) as *mut ACE_Log_Category_TSS,
                                        LM_ERROR,
                                        ((b"(%P|%t) ACE::ICMP_Socket::open - only IPPROTO_ICMP protocol is currently supported.\n\0"
                ...
                return <ACE_ICMP_Socket>::shared_open(
                    (__this) as *mut ACE_ICMP_Socket,
    ...
    pub unsafe fn shared_open(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                if (((((error as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    <ACE_SOCK>::close(
                        (::core::ptr::addr_of_mut!(
    ...
    pub unsafe fn calculate_checksum(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut nleft: libc::c_int = len;
                let mut sum: libc::c_int = 0;
                let mut w: *mut libc::c_ushort = paddress;
                let mut answer: libc::c_ushort = ((0) as libc::c_ushort);
                'while_0: loop {
                    if !((((((nleft as libc::c_int)) > (((1) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0))
                    {
                        break 'while_0;
                    }
                        ...
                        {
                            {
                                ...
                                {
                                    nleft = (((nleft) as libc::c_int))
                                        .wrapping_sub((2) as libc::c_int);
                                    nleft
                                };
                            }
                        }
                ...
                if (((((nleft as libc::c_int)) == (((1) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    (*(((::core::ptr::addr_of_mut!(answer) as *mut libc::c_ushort
                        as *mut libc::c_uchar)))) = (*(((w as *mut libc::c_uchar))));
                    {
                        sum = (((sum) as libc::c_int))
                            .wrapping_add((answer) as libc::c_int);
                        sum
                    };
                }
                sum = (((((((sum) as libc::c_int)).wrapping_shr((16) as u32)))
                    as libc::c_int))
                    .wrapping_add(
                        (((((sum) as libc::c_int)) & ((0xffff) as libc::c_int)))
                            as libc::c_int,
                    );
                {
                    sum = (((sum) as libc::c_int))
                        .wrapping_add(
                            (((((sum) as libc::c_int)).wrapping_shr((16) as u32)))
                                as libc::c_int,
                        );
                    sum
                };
                answer = ((!(sum)) as libc::c_ushort);
                return (answer);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
