...
pub mod ACE_Utils {
    ...
    pub type truncator_349 = Truncator_unsigned_long__int_;
...
#[derive(Clone)]
pub struct ACE_Pipe {
    pub handles_: [libc::c_int; 2usize],
}
#[export_name = "_ZN8ACE_PipeC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_PipeC1Ev(__this: *mut ACE_Pipe) {
    ACE_Pipe::new_at(__this)
}
#[export_name = "_ZN8ACE_PipeC1EPi"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_PipeC1EPi(
    __this: *mut ACE_Pipe,
    __a0: *mut libc::c_int,
) {
    ACE_Pipe::new_at_u93d230176dff3ca3(__this, __a0)
}
#[export_name = "_ZN8ACE_PipeC1Eii"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_PipeC1Eii(
    __this: *mut ACE_Pipe,
    __a0: libc::c_int,
    __a1: libc::c_int,
) {
    ACE_Pipe::new_at_ud3d3cee1570e4a37(__this, __a0, __a1)
}
impl Drop for ACE_Pipe {
    fn drop(&mut self) {
        unsafe {
...
pub unsafe extern "C-unwind" fn __acedtor_ufc5f5912bf410d5f(__this: *mut ACE_Pipe) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
    }
}
#[export_name = "_ZN8ACE_Pipe4openEPi"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_Pipe4openEPi(
    __this: *mut ACE_Pipe,
    handles: *mut libc::c_int,
) -> libc::c_int {
    unsafe { ACE_Pipe::open(__this, handles) }
}
#[export_name = "_ZN8ACE_Pipe4openEi"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_Pipe4openEi(
    __this: *mut ACE_Pipe,
    buffer_size: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_Pipe::open_ud302fd53bdc02847(__this, buffer_size) }
}
#[export_name = "_ZN8ACE_Pipe5closeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_Pipe5closeEv(
    __this: *mut ACE_Pipe,
) -> libc::c_int {
    unsafe { ACE_Pipe::close(__this) }
}
#[export_name = "_ZN8ACE_Pipe10close_readEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_Pipe10close_readEv(
    __this: *mut ACE_Pipe,
) -> libc::c_int {
    unsafe { ACE_Pipe::close_read(__this) }
}
#[export_name = "_ZN8ACE_Pipe11close_writeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_Pipe11close_writeEv(
    __this: *mut ACE_Pipe,
) -> libc::c_int {
    unsafe { ACE_Pipe::close_write(__this) }
}
#[export_name = "_ZNK8ACE_Pipe4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK8ACE_Pipe4dumpEv(__this: *const ACE_Pipe) {
    unsafe { ACE_Pipe::dump(__this) }
}
extern "C-unwind" {
    pub fn clone(
...
pub unsafe extern "C-unwind" fn __acedtor_ue7c617eb4c36c991(
    __this: *mut ACE_SOCK_Acceptor,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
    }
...
pub type tcp_seq = libc::c_uint;
#[repr(C, align(4))]
#[derive(Copy, Clone)]
pub struct _anonymous_struct_at__usr_include_netinet_tcp_h_102_7_ {
    pub th_sport: libc::c_ushort,
    pub th_dport: libc::c_ushort,
    pub th_seq: libc::c_uint,
    pub th_ack: libc::c_uint,
...
#[repr(C, align(4))]
#[derive(Copy, Clone)]
pub struct _anonymous_struct_at__usr_include_netinet_tcp_h_127_7_ {
    pub source: libc::c_ushort,
    pub dest: libc::c_ushort,
    pub seq: libc::c_uint,
    pub ack_seq: libc::c_uint,
    pub bitfield_storage_0: [u8; 2],
    pub window: libc::c_ushort,
    pub check: libc::c_ushort,
    pub urg_ptr: libc::c_ushort,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub union _anonymous_union_at__usr_include_netinet_tcp_h_100_19_ {
    pub __anon_field_tcphdr___anonymous_struct_at__usr_include_netinet_tcp_h_102_7_: _anonymous_struct_at__usr_include_netinet_tcp_h_102_7_,
    pub __anon_field_tcphdr___anonymous_struct_at__usr_include_netinet_tcp_h_127_7_: _anonymous_struct_at__usr_include_netinet_tcp_h_127_7_,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tcphdr {
    pub __anon_field_tcphdr___anonymous_union_at__usr_include_netinet_tcp_h_100_19_: _anonymous_union_at__usr_include_netinet_tcp_h_100_19_,
}
pub type _unnamed_enum_at__usr_include_netinet_tcp_h_163_1_ = libc::c_uint;
pub type tcp_ca_state = libc::c_uint;
pub const TCP_CA_Open: tcp_ca_state = 0 as tcp_ca_state;
pub const TCP_CA_Disorder: tcp_ca_state = 1 as tcp_ca_state;
pub const TCP_CA_CWR: tcp_ca_state = 2 as tcp_ca_state;
pub const TCP_CA_Recovery: tcp_ca_state = 3 as tcp_ca_state;
pub const TCP_CA_Loss: tcp_ca_state = 4 as tcp_ca_state;
#[repr(C, align(4))]
#[derive(Copy, Clone)]
pub struct tcp_info {
    pub tcpi_state: libc::c_uchar,
    pub tcpi_ca_state: libc::c_uchar,
    pub tcpi_retransmits: libc::c_uchar,
    pub tcpi_probes: libc::c_uchar,
    pub tcpi_backoff: libc::c_uchar,
    pub tcpi_options: libc::c_uchar,
    pub bitfield_storage_0: [u8; 1],
    pub tcpi_rto: libc::c_uint,
    pub tcpi_ato: libc::c_uint,
    pub tcpi_snd_mss: libc::c_uint,
    pub tcpi_rcv_mss: libc::c_uint,
    pub tcpi_unacked: libc::c_uint,
    pub tcpi_sacked: libc::c_uint,
    pub tcpi_lost: libc::c_uint,
    pub tcpi_retrans: libc::c_uint,
    pub tcpi_fackets: libc::c_uint,
    pub tcpi_last_data_sent: libc::c_uint,
    pub tcpi_last_ack_sent: libc::c_uint,
    pub tcpi_last_data_recv: libc::c_uint,
    pub tcpi_last_ack_recv: libc::c_uint,
    pub tcpi_pmtu: libc::c_uint,
    pub tcpi_rcv_ssthresh: libc::c_uint,
    pub tcpi_rtt: libc::c_uint,
    pub tcpi_rttvar: libc::c_uint,
    pub tcpi_snd_ssthresh: libc::c_uint,
    pub tcpi_snd_cwnd: libc::c_uint,
    pub tcpi_advmss: libc::c_uint,
    pub tcpi_reordering: libc::c_uint,
    pub tcpi_rcv_rtt: libc::c_uint,
    pub tcpi_rcv_space: libc::c_uint,
    pub tcpi_total_retrans: libc::c_uint,
    pub _tail_pad: [u8; 1],
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tcp_md5sig {
    ...
    pub tcpm_flags: libc::c_uchar,
    pub tcpm_prefixlen: libc::c_uchar,
    pub tcpm_keylen: libc::c_ushort,
    pub tcpm_ifindex: libc::c_int,
    pub tcpm_key: [libc::c_uchar; 80usize],
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tcp_repair_opt {
    pub opt_code: libc::c_uint,
    pub opt_val: libc::c_uint,
}
pub type _unnamed_enum_at__usr_include_netinet_tcp_h_295_1_ = libc::c_uint;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tcp_cookie_transactions {
    pub tcpct_flags: libc::c_ushort,
    pub __tcpct_pad1: libc::c_uchar,
    pub tcpct_cookie_desired: libc::c_uchar,
    pub tcpct_s_data_desired: libc::c_ushort,
    pub tcpct_used: libc::c_ushort,
    pub tcpct_value: [libc::c_uchar; 536usize],
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tcp_repair_window {
    pub snd_wl1: libc::c_uint,
    pub snd_wnd: libc::c_uint,
    pub max_window: libc::c_uint,
    pub rcv_wnd: libc::c_uint,
    pub rcv_wup: libc::c_uint,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tcp_zerocopy_receive {
    ...
    pub recv_skip_hint: libc::c_uint,
}
extern "C-unwind" {
...
impl ACE_Pipe {
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ...
            {
                (*((((*__this).handles_).as_ptr() as *mut libc::c_int)
                    .wrapping_offset((0) as isize))) = (((-((1) as libc::c_int)))
                    as libc::c_int);
                (*((((*__this).handles_).as_ptr() as *mut libc::c_int)
                    .wrapping_offset((1) as isize))) = (((-((1) as libc::c_int)))
                    as libc::c_int);
            }
            ()
        }
    ...
    pub unsafe fn new_at_u93d230176dff3ca3(
        __this: *mut Self,
        mut handles: *mut libc::c_int,
    ) {
        unsafe {
            ::core::ptr::write(
                __this,
            ...
            {
                if (((((<ACE_Pipe>::open(
                    (__this) as *mut ACE_Pipe,
                    ((handles) as *mut libc::c_int),
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/Pipe.cpp\0".as_ptr()
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        (ace___) as *mut ACE_Log_Category_TSS,
                                        LM_ERROR,
                                        ((b"ACE_Pipe::ACE_Pipe\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                    );
                                }
                            }
    ...
    pub unsafe fn new_u93d230176dff3ca3(mut __a0: *mut libc::c_int) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_u93d230176dff3ca3(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    ///Initialize the ACE_Pipe from the @a read and @a write handles.
    pub unsafe fn new_at_ud3d3cee1570e4a37(
        __this: *mut Self,
        mut read: libc::c_int,
        ...
        unsafe {
            ...
            {
                (*((((*__this).handles_).as_ptr() as *mut libc::c_int)
                    .wrapping_offset((0) as isize))) = read;
                (*((((*__this).handles_).as_ptr() as *mut libc::c_int)
                    .wrapping_offset((1) as isize))) = write;
            }
            ()
        }
    }
    pub unsafe fn new_ud3d3cee1570e4a37(
        mut __a0: libc::c_int,
        mut __a1: libc::c_int,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_ud3d3cee1570e4a37(::core::ptr::addr_of_mut!(__obj), __a0, __a1);
        __obj
    }
    ///Open the pipe and initialize the handles.
    pub unsafe fn open(__this: *mut Self, mut handles: *mut libc::c_int) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((((<ACE_Pipe>::open_ud302fd53bdc02847(
                    (__this) as *mut ACE_Pipe,
                    65535,
                ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    ...
                    (*(handles).wrapping_offset((0) as isize)) = (*((((*__this).handles_)
                        .as_ptr() as *mut libc::c_int)
                        .wrapping_offset((0) as isize)));
                    (*(handles).wrapping_offset((1) as isize)) = (*((((*__this).handles_)
                        .as_ptr() as *mut libc::c_int)
    ...
    pub unsafe fn open_ud302fd53bdc02847(
        __this: *mut Self,
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((((ACE_OS::socketpair_u1b7fa3fde1c9db8e(
                    1,
                    ((SOCK_STREAM) as libc::c_int),
                    0,
                    (((*__this).handles_).as_mut_ptr() as *mut libc::c_int),
                ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    'dowhile_0: loop {
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        b"socketpair\0".as_ptr() as *const libc::c_char,
                                    );
                                    return (-((1) as libc::c_int));
                                }
                            }
                ...
                if (((((((((ACE_OS::setsockopt_u491187844361ffa3(
                    ...
                    1,
                    8,
                    (::core::ptr::addr_of_mut!(buffer_size) as *mut libc::c_int
                        as *const libc::c_char),
                    ...
                    as libc::c_int) as libc::c_int) != 0)
                {
                    <ACE_Pipe>::close((__this) as *mut ACE_Pipe);
                    return (-((1) as libc::c_int));
                }
                if (((((((((ACE_OS::setsockopt_u491187844361ffa3(
                    (*((((*__this).handles_).as_ptr() as *mut libc::c_int)
    ...
    pub unsafe fn close(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut result: libc::c_int = <ACE_Pipe>::close_read(
                    (__this) as *mut ACE_Pipe,
                );
                {
                    result = (((result) as libc::c_int))
                        | ((<ACE_Pipe>::close_write((__this) as *mut ACE_Pipe))
                            as libc::c_int);
                    result
                };
                return result;
    ...
    pub unsafe fn close_read(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return <ACE_Pipe>::close_handle((__this) as *mut ACE_Pipe, 0);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    pub unsafe fn close_write(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return <ACE_Pipe>::close_handle((__this) as *mut ACE_Pipe, 1);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    #[doc = "* This is the \"read\" side of the pipe.  Note, however, that\n   * processes can also write to this handle as well since pipes are\n   * bi-directional."]
    pub unsafe fn read_handle(__this: *const Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((*((((*__this).handles_).as_ptr() as *mut libc::c_int)
                    .wrapping_offset((0) as isize)))) as libc::c_int);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    #[doc = "* This is the \"write\" side of the pipe.  Note, however, that\n   * processes can also read to this handle as well since pipes are\n   * bi-directional."]
    pub unsafe fn write_handle(__this: *const Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((*((((*__this).handles_).as_ptr() as *mut libc::c_int)
    ...
    pub unsafe fn send(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return ACE_OS::write_uba4fd70f52b99861(
                    <ACE_Pipe>::write_handle((__this) as *const ACE_Pipe),
    ...
    pub unsafe fn recv(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return ACE_OS::read_u821a89e28b7331a1(
                    <ACE_Pipe>::read_handle((__this) as *const ACE_Pipe),
    ...
    pub unsafe fn send_n(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return ACE::write_n_u941d14db176920fc(
                    <ACE_Pipe>::write_handle((__this) as *const ACE_Pipe),
                    buf,
                    n,
  ...
  /// operation to reduce the domain-crossing penalty.*/
    pub unsafe fn send_n_u75c1d48b3f879f1f(
        __this: *mut Self,
    ...
    pub unsafe fn send_ua4eb1aef250db93b(
        __this: *const Self,
        mut iov: *const iovec,
        mut n: libc::c_int,
    ) -> libc::c_long {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return ACE_OS::writev_u9b20468f161f7ab3(
                    <ACE_Pipe>::write_handle((__this) as *const ACE_Pipe),
                    ((iov) as *const iovec),
                    n,
                );
    ...
    pub unsafe fn recv_uaa4c3662ec4d9b0e(
        __this: *const Self,
        mut iov: *mut iovec,
        mut n: libc::c_int,
    ) -> libc::c_long {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return ACE_OS::readv_u0f79db0b81259088(
                    <ACE_Pipe>::read_handle((__this) as *const ACE_Pipe),
                    ((iov) as *const iovec),
                    n,
                );
    ...
    pub unsafe extern "C-unwind" fn send_u0eccf35953cd870b(
        ...
        unsafe {
            ...
            let mut __alloca_arena: ::std::vec::Vec<::std::boxed::Box<[u128]>> = ::std::vec::Vec::new();
            {
                ...
                let mut total_tuples: libc::c_int = ACE_Utils::truncate_cast___unsigned_long_(
                    (((((n) as libc::c_ulong)) / ((2) as libc::c_ulong))
                        as libc::c_ulong),
                );
                let mut iovp: *mut iovec = unsafe { ::core::mem::zeroed() };
                iovp = ({
                ...
                let mut result: libc::c_long = ACE_OS::writev_u9b20468f161f7ab3(
                    <ACE_Pipe>::write_handle((__this) as *const ACE_Pipe),
                    (iovp) as *const iovec,
                    total_tuples,
                );
    ...
    pub unsafe extern "C-unwind" fn recv_uee866670e26d3d61(
        ...
        unsafe {
            ...
            let mut __alloca_arena: ::std::vec::Vec<::std::boxed::Box<[u128]>> = ::std::vec::Vec::new();
            {
                ...
                let mut result: libc::c_long = ((ACE_OS::readv_u0f79db0b81259088(
                    <ACE_Pipe>::read_handle((__this) as *const ACE_Pipe),
                    (iovp) as *const iovec,
                    total_tuples,
                )) as libc::c_long);
    ...
    pub unsafe fn send_uc94cdc8acc98c7af(
        __this: *const Self,
        mut buf: *const libc::c_void,
        mut n: libc::c_ulong,
    ...
    pub unsafe fn recv_u78ff72b221884c82(
        __this: *const Self,
        mut buf: *mut libc::c_void,
        mut n: libc::c_ulong,
        mut overlapped: *mut ACE_OVERLAPPED,
    ...
    pub unsafe fn close_handle(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                if ((((((*((((*__this).handles_).as_ptr() as *mut libc::c_int)
                    .wrapping_offset((which) as isize))) as libc::c_int))
                    != ((((-((1) as libc::c_int))) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    result = ACE_OS::closesocket(
                        (*((((*__this).handles_).as_ptr() as *mut libc::c_int)
                            .wrapping_offset((which) as isize))),
                    );
                }
                (*((((*__this).handles_).as_ptr() as *mut libc::c_int)
                    .wrapping_offset((which) as isize))) = (((-((1) as libc::c_int)))
                    as libc::c_int);
                return result;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
...
impl ACE_SOCK_Acceptor {
    ///Default constructor.
    pub unsafe fn new_at(__this: *mut Self) {
        extern "C-unwind" {
            #[link_name = "_ZN17ACE_SOCK_AcceptorC1Ev"]
            fn __ext(__this: *mut ACE_SOCK_Acceptor);
        }
        __ext(__this as *mut ACE_SOCK_Acceptor)
    }
    pub unsafe fn new() -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at(::core::ptr::addr_of_mut!(__obj));
    ...
    pub unsafe fn new_at_ueca9aa94e32054d5(
        __this: *mut Self,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN17ACE_SOCK_AcceptorC1ERK8ACE_Addriiiii"]
            fn __ext(
                __this: *mut ACE_SOCK_Acceptor,
                __a0: *const ACE_Addr,
                __a1: libc::c_int,
        ...
        __ext(__this as *mut ACE_SOCK_Acceptor, __a0, __a1, __a2, __a3, __a4, __a5)
    }
    pub unsafe fn new_ueca9aa94e32054d5(
        mut __a0: *const ACE_Addr,
        mut __a1: libc::c_int,
        mut __a2: libc::c_int,
        mut __a3: libc::c_int,
    ...
    pub unsafe fn new_at_uaa8991a659393d88(
        __this: *mut Self,
        mut __a0: *const ACE_Addr,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN17ACE_SOCK_AcceptorC1ERK8ACE_AddrP17ACE_Protocol_Infommiiiii"]
            fn __ext(
                __this: *mut ACE_SOCK_Acceptor,
                __a0: *const ACE_Addr,
        ...
        __ext(
            __this as *mut ACE_SOCK_Acceptor,
            __a0,
            __a1,
            __a2,
            __a3,
    ...
    pub unsafe fn new_uaa8991a659393d88(
        mut __a0: *const ACE_Addr,
        mut __a1: *mut ACE_Protocol_Info,
        mut __a2: libc::c_ulong,
        mut __a3: libc::c_ulong,
    ...
    pub unsafe fn open(
        ...
        extern "C-unwind" {
            #[link_name = "_ZN17ACE_SOCK_Acceptor4openERK8ACE_Addriiiii"]
            fn __ext(
                __this: *mut ACE_SOCK_Acceptor,
  ...
  /// on success and -1 on failure.*/
    pub unsafe fn open_u529696811ed945f0(
        __this: *mut Self,
        mut local_sap: *const ACE_Addr,
        mut protocolinfo: *mut ACE_Protocol_Info,
        mut g: libc::c_ulong,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN17ACE_SOCK_Acceptor4openERK8ACE_AddrP17ACE_Protocol_Infommiiiii"]
            fn __ext(
                __this: *mut ACE_SOCK_Acceptor,
                local_sap: *const ACE_Addr,
                protocolinfo: *mut ACE_Protocol_Info,
    ...
    pub unsafe fn accept(
        ...
        extern "C-unwind" {
            #[link_name = "_ZNK17ACE_SOCK_Acceptor6acceptER15ACE_SOCK_StreamP8ACE_AddrP14ACE_Time_Valuebb"]
            fn __ext(
                __this: *const ACE_SOCK_Acceptor,
        ...
        __ext(
            __this as *const ACE_SOCK_Acceptor,
            new_stream,
            remote_addr,
            timeout,
            restart,
    ...
    pub unsafe fn accept_u81bd89bb409a0ca8(
        ...
        extern "C-unwind" {
            #[link_name = "_ZNK17ACE_SOCK_Acceptor6acceptER15ACE_SOCK_Stream21ACE_Accept_QoS_ParamsP8ACE_AddrP14ACE_Time_Valuebb"]
            fn __ext(
                __this: *const ACE_SOCK_Acceptor,
                new_stream: *mut ACE_SOCK_Stream,
                qos_params: ACE_Accept_QoS_Params,
                remote_addr: *mut ACE_Addr,
                timeout: *mut ACE_Time_Value,
                restart: bool,
                reset_new_handle: bool,
    ...
    pub unsafe fn dump(__this: *const Self) {
        extern "C-unwind" {
            #[link_name = "_ZNK17ACE_SOCK_Acceptor4dumpEv"]
            fn __ext(__this: *const ACE_SOCK_Acceptor);
        }
        __ext(__this as *const ACE_SOCK_Acceptor)
    }
  ...
  /// called.*/
    pub unsafe fn shared_accept_start(
        ...
        extern "C-unwind" {
            #[link_name = "_ZNK17ACE_SOCK_Acceptor19shared_accept_startEP14ACE_Time_ValuebRi"]
            fn __ext(
                __this: *const ACE_SOCK_Acceptor,
                timeout: *mut ACE_Time_Value,
                restart: bool,
        ...
        __ext(__this as *const ACE_SOCK_Acceptor, timeout, restart, in_blocking_mode)
    }
    /**Perform operations that must occur after <ACE_OS::accept> is
  /// called.*/
    pub unsafe fn shared_accept_finish(
        __this: *const Self,
        new_stream: ACE_SOCK_Stream,
        mut in_blocking_mode: libc::c_int,
        mut reset_new_handle: bool,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZNK17ACE_SOCK_Acceptor20shared_accept_finishE15ACE_SOCK_Streamib"]
            fn __ext(
                __this: *const ACE_SOCK_Acceptor,
                new_stream: *mut ACE_SOCK_Stream,
        ...
        let mut __md_new_stream = ::core::mem::ManuallyDrop::new(new_stream);
        __ext(
            __this as *const ACE_SOCK_Acceptor,
            &mut *__md_new_stream as *mut ACE_SOCK_Stream,
            in_blocking_mode,
            reset_new_handle,
        )
    }
    ...
    pub unsafe fn shared_open(
        ...
        extern "C-unwind" {
            #[link_name = "_ZN17ACE_SOCK_Acceptor11shared_openERK8ACE_Addriii"]
            fn __ext(
                __this: *mut ACE_SOCK_Acceptor,
                local_sap: *const ACE_Addr,
                protocol_family: libc::c_int,
    ...
    pub unsafe fn get_remote_addr(
        ...
        extern "C-unwind" {
            #[link_name = "_ZNK17ACE_SOCK_Acceptor15get_remote_addrER8ACE_Addr"]
            fn __ext(
                __this: *const ACE_SOCK_Acceptor,
                _anon_0: *mut ACE_Addr,
            ) -> libc::c_int;
        }
        __ext(__this as *const ACE_SOCK_Acceptor, _anon_0)
    }
}
...
impl _anonymous_struct_at__usr_include_netinet_tcp_h_102_7_ {
    #[inline]
    pub unsafe fn get_th_x2(&self) -> libc::c_uchar {
        let mut __v: u64 = 0;
        let mut __k: u32 = 0;
        while __k < (4 as u32) {
        ...
        (__v & 0xfu64) as libc::c_uchar
    }
    #[inline]
    pub unsafe fn set_th_x2(&mut self, value: libc::c_uchar) {
    ...
    #[inline]
    pub unsafe fn get_th_off(&self) -> libc::c_uchar {
        let mut __v: u64 = 0;
        let mut __k: u32 = 0;
        while __k < (4 as u32) {
    ...
    #[inline]
    pub unsafe fn set_th_off(&mut self, value: libc::c_uchar) {
        let __val = (value as u64) & 0xfu64;
        let mut __k: u32 = 0;
        while __k < (4 as u32) {
            let __bit = (4 as u32) + __k;
...
impl _anonymous_struct_at__usr_include_netinet_tcp_h_127_7_ {
    #[inline]
    pub unsafe fn get_res1(&self) -> libc::c_ushort {
        let mut __v: u64 = 0;
        let mut __k: u32 = 0;
        while __k < (4 as u32) {
            let __bit = (0 as u32) + __k;
        ...
        (__v & 0xfu64) as libc::c_ushort
    }
    #[inline]
    pub unsafe fn set_res1(&mut self, value: libc::c_ushort) {
        let __val = (value as u64) & 0xfu64;
        let mut __k: u32 = 0;
        while __k < (4 as u32) {
            let __bit = (0 as u32) + __k;
    ...
    #[inline]
    pub unsafe fn get_doff(&self) -> libc::c_ushort {
        let mut __v: u64 = 0;
        let mut __k: u32 = 0;
        while __k < (4 as u32) {
            let __bit = (4 as u32) + __k;
    ...
    #[inline]
    pub unsafe fn set_doff(&mut self, value: libc::c_ushort) {
        let __val = (value as u64) & 0xfu64;
        let mut __k: u32 = 0;
        while __k < (4 as u32) {
            let __bit = (4 as u32) + __k;
    ...
    #[inline]
    pub unsafe fn get_fin(&self) -> libc::c_ushort {
        let mut __v: u64 = 0;
        let mut __k: u32 = 0;
        while __k < (1 as u32) {
            let __bit = (8 as u32) + __k;
            __v
                |= (((self.bitfield_storage_0[(__bit / 8) as usize] >> (__bit % 8)) & 1)
                    as u64) << __k;
            __k += 1;
        }
        (__v & 0x1u64) as libc::c_ushort
    }
    #[inline]
    pub unsafe fn set_fin(&mut self, value: libc::c_ushort) {
        let __val = (value as u64) & 0x1u64;
        let mut __k: u32 = 0;
        while __k < (1 as u32) {
            let __bit = (8 as u32) + __k;
            let __idx = (__bit / 8) as usize;
    ...
    #[inline]
    pub unsafe fn get_syn(&self) -> libc::c_ushort {
        let mut __v: u64 = 0;
        let mut __k: u32 = 0;
        while __k < (1 as u32) {
            let __bit = (9 as u32) + __k;
            __v
                |= (((self.bitfield_storage_0[(__bit / 8) as usize] >> (__bit % 8)) & 1)
                    as u64) << __k;
            __k += 1;
    ...
    #[inline]
    pub unsafe fn set_syn(&mut self, value: libc::c_ushort) {
        let __val = (value as u64) & 0x1u64;
        let mut __k: u32 = 0;
        while __k < (1 as u32) {
            let __bit = (9 as u32) + __k;
    ...
    #[inline]
    pub unsafe fn get_rst(&self) -> libc::c_ushort {
        let mut __v: u64 = 0;
        let mut __k: u32 = 0;
        while __k < (1 as u32) {
            let __bit = (10 as u32) + __k;
            __v
                |= (((self.bitfield_storage_0[(__bit / 8) as usize] >> (__bit % 8)) & 1)
                    as u64) << __k;
            __k += 1;
    ...
    #[inline]
    pub unsafe fn set_rst(&mut self, value: libc::c_ushort) {
        let __val = (value as u64) & 0x1u64;
        let mut __k: u32 = 0;
        while __k < (1 as u32) {
            let __bit = (10 as u32) + __k;
    ...
    #[inline]
    pub unsafe fn get_psh(&self) -> libc::c_ushort {
        let mut __v: u64 = 0;
        let mut __k: u32 = 0;
        while __k < (1 as u32) {
            let __bit = (11 as u32) + __k;
            __v
                |= (((self.bitfield_storage_0[(__bit / 8) as usize] >> (__bit % 8)) & 1)
                    as u64) << __k;
            __k += 1;
    ...
    #[inline]
    pub unsafe fn set_psh(&mut self, value: libc::c_ushort) {
        let __val = (value as u64) & 0x1u64;
        let mut __k: u32 = 0;
        while __k < (1 as u32) {
            let __bit = (11 as u32) + __k;
    ...
    #[inline]
    pub unsafe fn get_ack(&self) -> libc::c_ushort {
        let mut __v: u64 = 0;
        let mut __k: u32 = 0;
        while __k < (1 as u32) {
            let __bit = (12 as u32) + __k;
            __v
                |= (((self.bitfield_storage_0[(__bit / 8) as usize] >> (__bit % 8)) & 1)
                    as u64) << __k;
            __k += 1;
    ...
    #[inline]
    pub unsafe fn set_ack(&mut self, value: libc::c_ushort) {
        let __val = (value as u64) & 0x1u64;
        let mut __k: u32 = 0;
        while __k < (1 as u32) {
            let __bit = (12 as u32) + __k;
    ...
    #[inline]
    pub unsafe fn get_urg(&self) -> libc::c_ushort {
        let mut __v: u64 = 0;
        let mut __k: u32 = 0;
        while __k < (1 as u32) {
            let __bit = (13 as u32) + __k;
            __v
                |= (((self.bitfield_storage_0[(__bit / 8) as usize] >> (__bit % 8)) & 1)
                    as u64) << __k;
            __k += 1;
    ...
    #[inline]
    pub unsafe fn set_urg(&mut self, value: libc::c_ushort) {
        let __val = (value as u64) & 0x1u64;
        let mut __k: u32 = 0;
        while __k < (1 as u32) {
            let __bit = (13 as u32) + __k;
    ...
    #[inline]
    pub unsafe fn get_res2(&self) -> libc::c_ushort {
        let mut __v: u64 = 0;
        let mut __k: u32 = 0;
        while __k < (2 as u32) {
            let __bit = (14 as u32) + __k;
            __v
                |= (((self.bitfield_storage_0[(__bit / 8) as usize] >> (__bit % 8)) & 1)
                    as u64) << __k;
            __k += 1;
        }
        (__v & 0x3u64) as libc::c_ushort
    }
    #[inline]
    pub unsafe fn set_res2(&mut self, value: libc::c_ushort) {
        let __val = (value as u64) & 0x3u64;
        let mut __k: u32 = 0;
        while __k < (2 as u32) {
            let __bit = (14 as u32) + __k;
            let __idx = (__bit / 8) as usize;
...
impl tcp_info {
    #[inline]
    pub unsafe fn get_tcpi_snd_wscale(&self) -> libc::c_uchar {
        let mut __v: u64 = 0;
        let mut __k: u32 = 0;
        while __k < (4 as u32) {
            let __bit = (0 as u32) + __k;
    ...
    #[inline]
    pub unsafe fn set_tcpi_snd_wscale(&mut self, value: libc::c_uchar) {
        let __val = (value as u64) & 0xfu64;
        let mut __k: u32 = 0;
        while __k < (4 as u32) {
            let __bit = (0 as u32) + __k;
    ...
    #[inline]
    pub unsafe fn get_tcpi_rcv_wscale(&self) -> libc::c_uchar {
        let mut __v: u64 = 0;
        let mut __k: u32 = 0;
        while __k < (4 as u32) {
            let __bit = (4 as u32) + __k;
    ...
    #[inline]
    pub unsafe fn set_tcpi_rcv_wscale(&mut self, value: libc::c_uchar) {
        let __val = (value as u64) & 0xfu64;
        let mut __k: u32 = 0;
        while __k < (4 as u32) {
            let __bit = (4 as u32) + __k;
