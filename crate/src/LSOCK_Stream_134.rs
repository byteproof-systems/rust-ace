...
#[export_name = "_ZN16ACE_LSOCK_Stream8send_msgEPK5iovecmi"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_LSOCK_Stream8send_msgEPK5iovecmi(
    __this: *mut ACE_LSOCK_Stream,
    iov: *const iovec,
    n: libc::c_ulong,
    handle: libc::c_int,
) -> libc::c_long {
    unsafe { ACE_LSOCK_Stream::send_msg(__this, iov, n, handle) }
}
#[export_name = "_ZN16ACE_LSOCK_Stream8recv_msgEP5iovecmRi"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_LSOCK_Stream8recv_msgEP5iovecmRi(
    __this: *mut ACE_LSOCK_Stream,
    iov: *mut iovec,
    n: libc::c_ulong,
    handle: *mut libc::c_int,
) -> libc::c_long {
    unsafe { ACE_LSOCK_Stream::recv_msg(__this, iov, n, handle) }
}
#[export_name = "_ZNK16ACE_LSOCK_Stream4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK16ACE_LSOCK_Stream4dumpEv(
    __this: *const ACE_LSOCK_Stream,
) {
    unsafe { ACE_LSOCK_Stream::dump(__this) }
}
#[export_name = "_ZNK16ACE_LSOCK_Stream14get_local_addrER8ACE_Addr"]
pub unsafe extern "C-unwind" fn __xtu__ZNK16ACE_LSOCK_Stream14get_local_addrER8ACE_Addr(
    __this: *const ACE_LSOCK_Stream,
    addr: *mut ACE_Addr,
) -> libc::c_int {
    unsafe { ACE_LSOCK_Stream::get_local_addr(__this, addr) }
}
#[export_name = "_ZNK16ACE_LSOCK_Stream15get_remote_addrER8ACE_Addr"]
pub unsafe extern "C-unwind" fn __xtu__ZNK16ACE_LSOCK_Stream15get_remote_addrER8ACE_Addr(
    __this: *const ACE_LSOCK_Stream,
    addr: *mut ACE_Addr,
) -> libc::c_int {
    unsafe { ACE_LSOCK_Stream::get_remote_addr(__this, addr) }
}
extern "C-unwind" {
...
impl ACE_LSOCK_Stream {
    ...
    pub unsafe fn send_msg(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                let mut cmsgbuf: [libc::c_char; 20usize] = unsafe {
                    ::core::mem::zeroed()
                };
                let mut cmsgptr: *mut cmsghdr = ((cmsgbuf).as_mut_ptr() as *mut cmsghdr);
                send_msg.msg_iov = (((iov as *mut iovec)) as *mut iovec);
                send_msg.msg_iovlen = n;
                send_msg.msg_name = ((0) as *mut libc::c_void);
                send_msg.msg_namelen = ((0) as libc::c_uint);
                (*cmsgptr).cmsg_level = 1;
                (*cmsgptr).cmsg_type = (((1 as libc::c_int)) as libc::c_int);
                (*cmsgptr).cmsg_len = ((::core::mem::size_of::<[libc::c_char; 20usize]>()
                    as libc::c_ulong) as libc::c_ulong);
                send_msg.msg_control = ((cmsgbuf).as_mut_ptr() as *mut libc::c_void);
                send_msg.msg_controllen = ((::core::mem::size_of::<
                    [libc::c_char; 20usize],
                >() as libc::c_ulong) as libc::c_ulong);
                (*(((((*(cmsgptr)).__cmsg_data)).as_mut_ptr() as *mut libc::c_int))) = handle;
                ...
                return ACE_OS::sendmsg_ue8fec1119c766cbe(
                    <ACE_IPC_SAP>::get_handle(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((*
                            ::core::ptr::addr_of!((* ::core::ptr::addr_of!((* __this)
                            .__base_0) .cast:: < ACE_SOCK_Stream > ().cast_mut())
                            .__base_0) .cast:: < ACE_SOCK_IO > ().cast_mut()).__base_0)
                            .cast:: < ACE_SOCK > ().cast_mut()).__base_0) .cast:: <
                            ACE_IPC_SAP > ().cast_mut())
                        )) as *const ACE_IPC_SAP,
                    ),
    ...
    pub unsafe fn recv_msg(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                recv_msg.msg_name = ((0) as *mut libc::c_void);
                recv_msg.msg_namelen = ((0) as libc::c_uint);
                recv_msg.msg_control = ((cmsgbuf).as_mut_ptr() as *mut libc::c_void);
                recv_msg.msg_controllen = ((::core::mem::size_of::<
                    [libc::c_char; 20usize],
                >() as libc::c_ulong) as libc::c_ulong);
                let mut result: libc::c_long = ACE_OS::recvmsg_u2eff40656fa046cd(
                    <ACE_IPC_SAP>::get_handle(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((*
                            ::core::ptr::addr_of!((* ::core::ptr::addr_of!((* __this)
                ...
                (*handle) = (*(((((*(cmsgptr)).__cmsg_data)).as_mut_ptr()
                    as *mut libc::c_int)));
                return result;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
    ...
    pub unsafe fn dump(__this: *const Self) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                        ...
                        {
                            {
                                ...
                                <ACE_Log_Category_TSS>::conditional_set(
                                    ...
                                    ((b"/build/ace_full/src/ACE/ace/LSOCK_Stream.cpp\0".as_ptr()
                ...
                <ACE_LSOCK>::dump(
                    (::core::ptr::addr_of!((* __this).__base_1)) as *const ACE_LSOCK,
                );
                'dowhile_1: loop {
                    'cont_1: loop {
                        {
    ...
    pub unsafe fn get_local_addr(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut rhs_unix_addr: *mut ACE_UNIX_Addr = (::core::ptr::addr_of_mut!(
                    (* addr)
                ) as *mut ACE_Addr as *mut ACE_UNIX_Addr);
                let mut lhs_unix_addr: ACE_UNIX_Addr = ::core::mem::MaybeUninit::<
                    ACE_UNIX_Addr,
                >::zeroed()
                    .assume_init();
                <ACE_UNIX_Addr>::new_at(
                    (::core::ptr::addr_of_mut!(lhs_unix_addr)) as *mut ACE_UNIX_Addr,
                );
                if (((((rhs_unix_addr).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    ...
                    if (((((<ACE_SOCK>::get_local_addr(
                        ...
                        ::core::ptr::addr_of_mut!(
                            (* ::core::ptr::addr_of!((lhs_unix_addr).__base_0) .cast:: <
                            ACE_Addr > ().cast_mut())
                        ) as *mut ACE_Addr,
                    ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        ...
                        <ACE_UNIX_Addr>::operator_assign(
                            (rhs_unix_addr) as *mut ACE_UNIX_Addr,
                            ::core::ptr::addr_of!(lhs_unix_addr),
                        );
                        return 0;
                    }
                }
  ...
  /// for UNIX domain sockets.*/
    pub unsafe fn get_remote_addr(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return <ACE_LSOCK_Stream>::get_local_addr(
                    (__this) as *const ACE_LSOCK_Stream,
