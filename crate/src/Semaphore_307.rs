...
#[export_name = "_ZN13ACE_SemaphoreC1EjiPKcPvi"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_SemaphoreC1EjiPKcPvi(
    ...
    ACE_Semaphore::new_at(__this, __a0, __a1, __a2, __a3, __a4)
}
impl Drop for ACE_Semaphore {
    fn drop(&mut self) {
        unsafe {
            let __this: *mut Self = self as *mut Self;
            {
                <ACE_Semaphore>::remove((__this) as *mut ACE_Semaphore);
            }
            ()
        }
    }
}
#[export_name = "__acedtor_uab14d097f7bc00a3"]
pub unsafe extern "C-unwind" fn __acedtor_uab14d097f7bc00a3(__this: *mut ACE_Semaphore) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
    }
}
#[export_name = "_ZNK13ACE_Semaphore4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_Semaphore4dumpEv(
    __this: *const ACE_Semaphore,
) {
    unsafe { ACE_Semaphore::dump(__this) }
}
...
impl ACE_Semaphore {
    ...
    pub unsafe fn new_at(
        ...
        unsafe {
            ...
            {
                if (((((ACE_OS::sema_init_u1271b3e1cae4c1a8(
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/Semaphore.cpp\0".as_ptr()
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        b"ACE_Semaphore::ACE_Semaphore\0".as_ptr()
                                            as *const libc::c_char,
                                    );
                                }
                            }
