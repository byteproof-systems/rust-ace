...
#[allow(non_upper_case_globals)]
#[no_mangle]
pub static mut ACE_Framework_Repository_repository_: *mut ACE_Framework_Repository = ((0)
    as *mut ACE_Framework_Repository);
#[allow(non_upper_case_globals)]
#[no_mangle]
pub static mut ACE_Framework_Repository_shutting_down_: libc::c_int = ((0)
    as libc::c_int);
            ...
            unsafe {
                let __this: *mut Self = self as *mut Self;
                {
                    <ACE_Framework_Repository>::close(
                        (__this) as *mut ACE_Framework_Repository,
                    );
                }
                ()
            }
...
#[export_name = "__acedtor_u51f16968076dafde"]
pub unsafe extern "C-unwind" fn __acedtor_u51f16968076dafde(
...
#[export_name = "_ZN24ACE_Framework_Repository4openEi"]
pub unsafe extern "C-unwind" fn __xtu__ZN24ACE_Framework_Repository4openEi(
    __this: *mut ACE_Framework_Repository,
    size: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_Framework_Repository::open(__this, size) }
}
#[export_name = "_ZN24ACE_Framework_Repository5closeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN24ACE_Framework_Repository5closeEv(
    __this: *mut ACE_Framework_Repository,
) -> libc::c_int {
    unsafe { ACE_Framework_Repository::close(__this) }
}
#[export_name = "_ZN24ACE_Framework_Repository8instanceEi"]
pub unsafe extern "C-unwind" fn __xtu__ZN24ACE_Framework_Repository8instanceEi(
    size: libc::c_int,
) -> *mut ACE_Framework_Repository {
    unsafe { ACE_Framework_Repository::instance(size) }
}
#[export_name = "_ZN24ACE_Framework_Repository15close_singletonEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN24ACE_Framework_Repository15close_singletonEv() {
    unsafe { ACE_Framework_Repository::close_singleton() }
}
#[export_name = "_ZN24ACE_Framework_Repository18register_componentEP23ACE_Framework_Component"]
pub unsafe extern "C-unwind" fn __xtu__ZN24ACE_Framework_Repository18register_componentEP23ACE_Framework_Component(
    __this: *mut ACE_Framework_Repository,
    fc: *mut ACE_Framework_Component,
) -> libc::c_int {
    unsafe { ACE_Framework_Repository::register_component(__this, fc) }
}
#[export_name = "_ZN24ACE_Framework_Repository16remove_componentEPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN24ACE_Framework_Repository16remove_componentEPKc(
    __this: *mut ACE_Framework_Repository,
    name: *const libc::c_char,
) -> libc::c_int {
    unsafe { ACE_Framework_Repository::remove_component(__this, name) }
}
#[export_name = "_ZN24ACE_Framework_Repository21remove_dll_componentsEPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN24ACE_Framework_Repository21remove_dll_componentsEPKc(
    __this: *mut ACE_Framework_Repository,
    dll_name: *const libc::c_char,
) -> libc::c_int {
    unsafe { ACE_Framework_Repository::remove_dll_components(__this, dll_name) }
}
#[export_name = "_ZNK24ACE_Framework_Repository4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK24ACE_Framework_Repository4dumpEv(
    __this: *const ACE_Framework_Repository,
) {
    unsafe { ACE_Framework_Repository::dump(__this) }
}
#[export_name = "_ZN24ACE_Framework_RepositoryC1Ei"]
pub unsafe extern "C-unwind" fn __xtu__ZN24ACE_Framework_RepositoryC1Ei(
    __this: *mut ACE_Framework_Repository,
    __a0: libc::c_int,
) {
    ACE_Framework_Repository::new_at(__this, __a0)
}
#[export_name = "_ZN24ACE_Framework_Repository23remove_dll_components_iEPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN24ACE_Framework_Repository23remove_dll_components_iEPKc(
    __this: *mut ACE_Framework_Repository,
    dll_name: *const libc::c_char,
) -> libc::c_int {
    unsafe { ACE_Framework_Repository::remove_dll_components_i(__this, dll_name) }
}
#[export_name = "_ZN24ACE_Framework_Repository7compactEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN24ACE_Framework_Repository7compactEv(
    __this: *mut ACE_Framework_Repository,
) {
    unsafe { ACE_Framework_Repository::compact(__this) }
}
#[repr(C)]
...
impl ACE_Framework_Repository {
    ...
    pub unsafe fn open(__this: *mut Self, mut size: libc::c_int) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut temp: *mut *mut ACE_Framework_Component = ((0)
                    as *mut *mut ACE_Framework_Component);
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            {
                                temp = {
                                    ...
                                    let __nbytes = __count
                                        .checked_mul(
                                            ::core::mem::size_of::<*mut ACE_Framework_Component>(),
                                        )
  ...
  /// resources, also called by dtor.*/
    pub unsafe fn close(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                ACE_Framework_Repository_shutting_down_ = ((1) as libc::c_int);
                if ((((!((*__this).component_vector_).is_null()) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    {
                        ...
                        'for_0: loop {
                            ...
                            'cont_0: loop {
                                {
                                    if (!((*((*__this).component_vector_)
                                        .wrapping_offset((i) as isize)))
                                        .is_null())
                                    {
                                        let mut s: *mut ACE_Framework_Component = ((*((*__this)
                                            .component_vector_)
                                            .wrapping_offset((i) as isize))
                                            as *mut ACE_Framework_Component);
                                        (*((*__this).component_vector_)
                                            .wrapping_offset((i) as isize)) = ((0)
                                            as *mut ACE_Framework_Component);
                                        {
                                            let __p = s;
                                            if !__p.is_null() {
                                                let __vt: *const __Vtbl_u5e4f734162c6e97d = *(__p
                                                    as *const *const __Vtbl_u5e4f734162c6e97d);
                                                ((*__vt).__vdtor)(__p as *mut ACE_Framework_Component);
                                            }
                                        };
                                    }
                                }
                    ...
                    {
                        let __data = (*__this).component_vector_
                            as *mut *mut ACE_Framework_Component;
                        if !__data.is_null() {
                            ::libc::free(__data as *mut libc::c_void);
                        }
                    };
                    (*__this).component_vector_ = ((0)
                        as *mut *mut ACE_Framework_Component);
    ...
    pub unsafe fn instance(mut size: libc::c_int) -> *mut ACE_Framework_Repository {
        unsafe {
            {
                if (((((ACE_Framework_Repository_repository_).is_null()) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    ...
                    if (((((<ACE_Guard_ACE_Recursive_Thread_Mutex_>::locked(
                        ...
                        as libc::c_int) != 0)
                    {} else {
                        return ((0) as *mut ACE_Framework_Repository);
                    };
                    if (((((ACE_Framework_Repository_repository_).is_null())
                        as libc::c_int) as libc::c_int) != 0)
                    {
                            ...
                            as libc::c_int) != 0)
                        {
                            'dowhile_0: loop {
                                'cont_0: loop {
                                    {
                                        {
                                            ACE_Framework_Repository_repository_ = {
                                                let __new: *mut ACE_Framework_Repository = Box::into_raw(
                                                    Box::new(
                                                ...
                                                <ACE_Framework_Repository>::new_at(
                                                    (__new) as *mut ACE_Framework_Repository,
                                                    size,
                                                );
                                                __new
                                            };
                ...
                return ACE_Framework_Repository_repository_;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
        ...
        unsafe {
            {
                ...
                {
                    let __d = ACE_Framework_Repository_repository_;
                    if !__d.is_null() {
                        let _ = Box::from_raw(__d as *mut ACE_Framework_Repository);
                    }
                };
                ACE_Framework_Repository_repository_ = ((0)
                    as *mut ACE_Framework_Repository);
            }
            ()
        }
    ...
    pub unsafe fn register_component(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                let mut i: libc::c_int = unsafe { ::core::mem::zeroed() };
                {
                    i = 0;
                    'for_0: loop {
                        if !((((((i as libc::c_int))
                        ...
                        'cont_0: loop {
                            {
                                if (((((!((*((*__this).component_vector_)
                                    .wrapping_offset((i) as isize)))
                                    .is_null())
                                    && (((((((*fc).this_) as *const u8))
                                        == ((((*(*((*__this).component_vector_)
                                            .wrapping_offset((i) as isize)))
                                            .this_) as *const u8))) as libc::c_int as libc::c_int)
                                            ...
                                            {
                                                {
                                                    ...
                                                    <ACE_Log_Category_TSS>::conditional_set(
                                                        ...
                                                        ((b"/build/ace_full/src/ACE/ace/Framework_Component.cpp\0"
                                                    ...
                                                    <ACE_Log_Category_TSS>::log(
                                                        (ace___) as *mut ACE_Log_Category_TSS,
                                                        LM_ERROR,
                                                        ((b"AFR::register_component: error, compenent already registered\n\0"
                                                            .as_ptr() as *const libc::c_char) as *const libc::c_char),
                                                    );
                                                    return (-((1) as libc::c_int));
                                                }
                ...
                if (((((i as libc::c_int)) < ((((*__this).total_size_) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    (*((*__this).component_vector_).wrapping_offset((i) as isize)) = fc;
                    {
  ...
  /// and 0 on success.*/
    ...
    pub unsafe fn remove_dll_components(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((ACE_Framework_Repository_shutting_down_) != 0) {
                    return <ACE_Framework_Repository>::remove_dll_components_i(
                        (__this) as *mut ACE_Framework_Repository,
                        dll_name,
                    );
                }
    ...
    pub unsafe fn new_at(__this: *mut Self, mut size: libc::c_int) {
        unsafe {
            ...
            {
                if (((((<ACE_Framework_Repository>::open(
                    (__this) as *mut ACE_Framework_Repository,
                    size,
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        b"ACE_Framework_Repository\0".as_ptr()
                                            as *const libc::c_char,
                                    );
                                }
                            }
    ...
    pub unsafe fn remove_dll_components_i(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                        ...
                        'cont_0: loop {
                            {
                                if (((((!((*((*__this).component_vector_)
                                    ...
                                    && (((((ACE_OS::strcmp_u2f671283fc8b6d4a(
                                        (((*(*((*__this).component_vector_)
                                            .wrapping_offset((i) as isize)))
                                            .dll_name_) as *const libc::c_char),
                                                ...
                                                {
                                                    {
                                                        ...
                                                        <ACE_Log_Category_TSS>::log(
                                                            (ace___) as *mut ACE_Log_Category_TSS,
                                                            LM_DEBUG,
                                                            ((b"AFR::remove_dll_components_i (%s) component \"%s\"\n\0"
                                                                .as_ptr() as *const libc::c_char) as *const libc::c_char),
                                                            dll_name,
                                                            (*(*((*__this).component_vector_)
                                                                .wrapping_offset((i) as isize)))
                ...
                return if (((((retval as libc::c_int))
                    == ((((-((1) as libc::c_int))) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    (-((1) as libc::c_int))
  ...
  /// order.*/
    pub unsafe fn compact(__this: *mut Self) {
        unsafe {
            ...
            {
                let mut i: libc::c_int = unsafe { ::core::mem::zeroed() };
                let mut start_hole: libc::c_int = unsafe { ::core::mem::zeroed() };
                let mut end_hole: libc::c_int = unsafe { ::core::mem::zeroed() };
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            {
                                start_hole = (*__this).current_size_;
                                end_hole = (*__this).current_size_;
                                {
                                    i = 0;
                                    'for_1: loop {
                                        if !((((((i as libc::c_int))
                                    ...
                                    as libc::c_int as libc::c_int) != 0)
                                {
                                    ...
                                    (*__this).current_size_ = start_hole;
                                }
                            }
                        }
                        #[allow(unreachable_code)] break 'cont_0;
                    ...
                    if !((((((start_hole as libc::c_int))
                        != ((((*__this).current_size_) as libc::c_int))) as libc::c_int
                        as libc::c_int) != 0))
                    {
                        break 'dowhile_0;
                    }
