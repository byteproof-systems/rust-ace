...
pub mod ACE_OS {
    ...
    #[doc = "* QoS-enabled @c accept, which passes @a qos_params to @c accept.  If\n   * the OS platform doesn't support QoS-enabled @c accept then the\n   * @a qos_params are ignored and the BSD-style @c accept is called."]
    #[export_name = "_ZN6ACE_OS6acceptEiP8sockaddrPiRK21ACE_Accept_QoS_Params"]
    pub unsafe extern "C-unwind" fn accept_u01a5c7d903c3928a(
        mut handle: libc::c_int,
        mut addr: *mut super::sockaddr,
        mut addrlen: *mut libc::c_int,
        mut qos_params: *const super::ACE_Accept_QoS_Params,
    ) -> libc::c_int {
        unsafe {
            {
                {
                ...
                return accept_u8430b27f80401846(handle, addr, addrlen);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    ...
    #[doc = "* QoS-enabled @c connect, which passes @a qos_params to @c connect.\n   * If the OS platform doesn't support QoS-enabled @c connect then the\n   * @a qos_params are ignored and the BSD-style @c connect is called."]
    #[export_name = "_ZN6ACE_OS7connectEiPK8sockaddriRK14ACE_QoS_Params"]
    pub unsafe extern "C-unwind" fn connect_uc00b8b6355089164(
        mut handle: libc::c_int,
        mut addr: *const super::sockaddr,
        mut addrlen: libc::c_int,
        mut qos_params: *const super::ACE_QoS_Params,
    ) -> libc::c_int {
        unsafe {
            {
                {
                ...
                return connect_u21719e7a4d49e872(
                    handle,
                    (((addr as *mut super::sockaddr)) as *mut super::sockaddr),
                    addrlen,
                );
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
    ...
    #[export_name = "_ZN6ACE_OS9join_leafEiPK8sockaddriRK14ACE_QoS_Params"]
    pub unsafe extern "C-unwind" fn join_leaf(
        mut socket: libc::c_int,
        mut name: *const super::sockaddr,
  ...
  /// requires a buffer to do a partial send*/
    #[export_name = "_ZN6ACE_OS14send_partial_iEiPKcmi"]
    pub unsafe extern "C-unwind" fn send_partial_i(
        mut handle: libc::c_int,
  ...
  /// requires a buffer to do a partial send*/
    #[export_name = "_ZN6ACE_OS15sendv_partial_iEiPK5ioveci"]
    pub unsafe extern "C-unwind" fn sendv_partial_i(
        mut handle: libc::c_int,
        mut buffers: *const super::iovec,
        mut n: libc::c_int,
    ) -> libc::c_long {
        unsafe {
            {
  ...
  /// loaded or the first use of a socket() call.*/
    #[export_name = "_ZN6ACE_OS11socket_initEii"]
    pub unsafe extern "C-unwind" fn socket_init(
        mut version_high: libc::c_int,
        mut version_low: libc::c_int,
    ) -> libc::c_int {
        unsafe {
            {
                {
    ...
    #[export_name = "_ZN6ACE_OS11socket_finiEv"]
    pub unsafe extern "C-unwind" fn socket_fini() -> libc::c_int {
        unsafe {
            {
                return 0;
            }
