...
#[doc = "* @class ACE_Thread_Semaphore\n *\n * @brief Wrapper for Dijkstra style general semaphores that work\n * only within one process."]
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Thread_Semaphore {
    pub __base_0: ::core::mem::ManuallyDrop<ACE_Semaphore>,
}
#[export_name = "_ZN20ACE_Thread_SemaphoreC1EjPKcPvi"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Thread_SemaphoreC1EjPKcPvi(
    __this: *mut ACE_Thread_Semaphore,
    __a0: libc::c_uint,
    __a1: *const libc::c_char,
    __a2: *mut libc::c_void,
    __a3: libc::c_int,
) {
    ACE_Thread_Semaphore::new_at(__this, __a0, __a1, __a2, __a3)
}
impl Drop for ACE_Thread_Semaphore {
    fn drop(&mut self) {
        {
            unsafe {
                let __this: *mut Self = self as *mut Self;
...
pub unsafe extern "C-unwind" fn __acedtor_uba5f2276898bcd7e(
    __this: *mut ACE_Thread_Semaphore,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[export_name = "_ZNK20ACE_Thread_Semaphore4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK20ACE_Thread_Semaphore4dumpEv(
    __this: *const ACE_Thread_Semaphore,
) {
    unsafe { ACE_Thread_Semaphore::dump(__this) }
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ACE_Malloc_Lock_Adapter_T_ACE_Thread_Semaphore_ {}
#[export_name = "_ZN25ACE_Malloc_Lock_Adapter_TI20ACE_Thread_SemaphoreEclEPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN25ACE_Malloc_Lock_Adapter_TI20ACE_Thread_SemaphoreEclEPKc(
    __this: *const ACE_Malloc_Lock_Adapter_T_ACE_Thread_Semaphore_,
    name: *const libc::c_char,
) -> *mut ACE_Thread_Semaphore {
    unsafe {
        ACE_Malloc_Lock_Adapter_T_ACE_Thread_Semaphore_::operator_call(__this, name)
    }
}
#[repr(C)]
    ...
    pub unsafe fn new_at(
        ...
        unsafe {
            ...
            <ACE_Semaphore>::new_at(
                (::core::ptr::addr_of_mut!((* __this).__base_0).cast::<ACE_Semaphore>())
...
impl ACE_Malloc_Lock_Adapter_T_ACE_Thread_Semaphore_ {
    ///**************************************************************************
    pub unsafe fn operator_call(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut p: *mut ACE_Thread_Semaphore = ((0)
                    as *mut ACE_Thread_Semaphore);
                        ...
                        'cont_0: loop {
                            {
                                {
                                    p = {
                                        let __new: *mut ACE_Thread_Semaphore = Box::into_raw(
                                            Box::new(
                                                ::core::mem::MaybeUninit::<ACE_Thread_Semaphore>::zeroed()
                                                    .assume_init(),
                                            ),
                                        );
                                        <ACE_Thread_Semaphore>::new_at(
                                            (__new) as *mut ACE_Thread_Semaphore,
                                            ((1) as libc::c_uint),
                                            name,
                                    ...
                                    {
                                        ((*(__errno_location()))) = 12;
                                        return ((0) as *mut ACE_Thread_Semaphore);
                                    }
                                }
                            }
