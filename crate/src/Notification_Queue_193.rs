...
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Intrusive_List_ACE_Notification_Queue_Node_ {
    pub head_: *mut ACE_Notification_Queue_Node,
    pub tail_: *mut ACE_Notification_Queue_Node,
}
#[export_name = "_ZN18ACE_Intrusive_ListI27ACE_Notification_Queue_NodeEC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_Intrusive_ListI27ACE_Notification_Queue_NodeEC1Ev(
    __this: *mut ACE_Intrusive_List_ACE_Notification_Queue_Node_,
) {
    ACE_Intrusive_List_ACE_Notification_Queue_Node_::new_at_s353292625fcee34f(__this)
}
#[export_name = "_ZN18ACE_Intrusive_ListI27ACE_Notification_Queue_NodeE10push_frontEPS0_"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_Intrusive_ListI27ACE_Notification_Queue_NodeE10push_frontEPS0_(
    __this: *mut ACE_Intrusive_List_ACE_Notification_Queue_Node_,
    node: *mut ACE_Notification_Queue_Node,
) {
    unsafe { ACE_Intrusive_List_ACE_Notification_Queue_Node_::push_front(__this, node) }
}
#[export_name = "_ZN18ACE_Intrusive_ListI27ACE_Notification_Queue_NodeE13unsafe_removeEPS0_"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_Intrusive_ListI27ACE_Notification_Queue_NodeE13unsafe_removeEPS0_(
    __this: *mut ACE_Intrusive_List_ACE_Notification_Queue_Node_,
    node: *mut ACE_Notification_Queue_Node,
) {
    unsafe {
        ACE_Intrusive_List_ACE_Notification_Queue_Node_::unsafe_remove(__this, node)
    }
}
#[export_name = "_ZN18ACE_Intrusive_ListI27ACE_Notification_Queue_NodeE9pop_frontEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_Intrusive_ListI27ACE_Notification_Queue_NodeE9pop_frontEv(
    __this: *mut ACE_Intrusive_List_ACE_Notification_Queue_Node_,
) -> *mut ACE_Notification_Queue_Node {
    unsafe { ACE_Intrusive_List_ACE_Notification_Queue_Node_::pop_front(__this) }
}
#[export_name = "_ZN18ACE_Intrusive_ListI27ACE_Notification_Queue_NodeE9push_backEPS0_"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_Intrusive_ListI27ACE_Notification_Queue_NodeE9push_backEPS0_(
    __this: *mut ACE_Intrusive_List_ACE_Notification_Queue_Node_,
    node: *mut ACE_Notification_Queue_Node,
) {
    unsafe { ACE_Intrusive_List_ACE_Notification_Queue_Node_::push_back(__this, node) }
}
impl Drop for ACE_Intrusive_List_ACE_Notification_Queue_Node_ {
    fn drop(&mut self) {
        unsafe {
...
#[export_name = "__acedtor_u353292625fcee34f"]
pub unsafe extern "C-unwind" fn __acedtor_u353292625fcee34f(
    __this: *mut ACE_Intrusive_List_ACE_Notification_Queue_Node_,
) {
    unsafe {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_ {
    pub prev_: *mut ACE_Notification_Queue_Node,
    pub next_: *mut ACE_Notification_Queue_Node,
}
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Intrusive_List_NodeI27ACE_Notification_Queue_NodeEC1Ev(
    __this: *mut ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_,
) {
    ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_::new_at_s35516dc07ccffd36(
        __this,
    )
}
extern "C-unwind" {
...
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Unbounded_Queue_ACE_Notification_Queue_Node___ {
    pub head_: *mut ACE_Node_ACE_Notification_Queue_Node___,
    pub cur_size_: libc::c_ulong,
    pub allocator_: *mut ACE_Allocator,
}
#[export_name = "_ZN19ACE_Unbounded_QueueIP27ACE_Notification_Queue_NodeEC1EP13ACE_Allocator"]
pub unsafe extern "C-unwind" fn __xtu__ZN19ACE_Unbounded_QueueIP27ACE_Notification_Queue_NodeEC1EP13ACE_Allocator(
    __this: *mut ACE_Unbounded_Queue_ACE_Notification_Queue_Node___,
    __a0: *mut ACE_Allocator,
) {
    ACE_Unbounded_Queue_ACE_Notification_Queue_Node___::new_at_s5c3f7fe777ccdfb1(
        __this,
        __a0,
    )
}
#[export_name = "_ZN19ACE_Unbounded_QueueIP27ACE_Notification_Queue_NodeE12delete_nodesEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN19ACE_Unbounded_QueueIP27ACE_Notification_Queue_NodeE12delete_nodesEv(
    __this: *mut ACE_Unbounded_Queue_ACE_Notification_Queue_Node___,
) {
    unsafe { ACE_Unbounded_Queue_ACE_Notification_Queue_Node___::delete_nodes(__this) }
}
#[export_name = "_ZN19ACE_Unbounded_QueueIP27ACE_Notification_Queue_NodeE5resetEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN19ACE_Unbounded_QueueIP27ACE_Notification_Queue_NodeE5resetEv(
    __this: *mut ACE_Unbounded_Queue_ACE_Notification_Queue_Node___,
) {
    unsafe { ACE_Unbounded_Queue_ACE_Notification_Queue_Node___::reset(__this) }
}
#[export_name = "_ZN19ACE_Unbounded_QueueIP27ACE_Notification_Queue_NodeE12enqueue_headERKS1_"]
pub unsafe extern "C-unwind" fn __xtu__ZN19ACE_Unbounded_QueueIP27ACE_Notification_Queue_NodeE12enqueue_headERKS1_(
    __this: *mut ACE_Unbounded_Queue_ACE_Notification_Queue_Node___,
    new_item: *const *mut ACE_Notification_Queue_Node,
) -> libc::c_int {
    unsafe {
        ACE_Unbounded_Queue_ACE_Notification_Queue_Node___::enqueue_head(
            __this,
            new_item,
        )
    }
}
impl Drop for ACE_Unbounded_Queue_ACE_Notification_Queue_Node___ {
    fn drop(&mut self) {
        unsafe {
            let __this: *mut Self = self as *mut Self;
            {
                <ACE_Unbounded_Queue_ACE_Notification_Queue_Node___>::delete_nodes(
                    (__this) as *mut ACE_Unbounded_Queue_ACE_Notification_Queue_Node___,
                );
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
...
#[export_name = "__acedtor_u173b6f2ad5d47e6d"]
pub unsafe extern "C-unwind" fn __acedtor_u173b6f2ad5d47e6d(
    __this: *mut ACE_Unbounded_Queue_ACE_Notification_Queue_Node___,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ACE_Unbounded_Queue_Iterator_ACE_Notification_Queue_Node___ {
    pub current_: *mut ACE_Node_ACE_Notification_Queue_Node___,
    pub queue_: *mut ACE_Unbounded_Queue_ACE_Notification_Queue_Node___,
}
#[export_name = "_ZN28ACE_Unbounded_Queue_IteratorIP27ACE_Notification_Queue_NodeEC1ER19ACE_Unbounded_QueueIS1_Ei"]
pub unsafe extern "C-unwind" fn __xtu__ZN28ACE_Unbounded_Queue_IteratorIP27ACE_Notification_Queue_NodeEC1ER19ACE_Unbounded_QueueIS1_Ei(
    __this: *mut ACE_Unbounded_Queue_Iterator_ACE_Notification_Queue_Node___,
    __a0: *mut ACE_Unbounded_Queue_ACE_Notification_Queue_Node___,
    __a1: libc::c_int,
) {
    ACE_Unbounded_Queue_Iterator_ACE_Notification_Queue_Node___::new_at_sbcdc1bf5787c85b6(
        __this,
        __a0,
        __a1,
    )
}
#[export_name = "_ZN28ACE_Unbounded_Queue_IteratorIP27ACE_Notification_Queue_NodeE4nextERPS1_"]
pub unsafe extern "C-unwind" fn __xtu__ZN28ACE_Unbounded_Queue_IteratorIP27ACE_Notification_Queue_NodeE4nextERPS1_(
    __this: *mut ACE_Unbounded_Queue_Iterator_ACE_Notification_Queue_Node___,
    item: *mut *mut *mut ACE_Notification_Queue_Node,
) -> libc::c_int {
    unsafe {
        ACE_Unbounded_Queue_Iterator_ACE_Notification_Queue_Node___::next(__this, item)
    }
}
#[export_name = "_ZN28ACE_Unbounded_Queue_IteratorIP27ACE_Notification_Queue_NodeE7advanceEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN28ACE_Unbounded_Queue_IteratorIP27ACE_Notification_Queue_NodeE7advanceEv(
    __this: *mut ACE_Unbounded_Queue_Iterator_ACE_Notification_Queue_Node___,
) -> libc::c_int {
    unsafe {
        ACE_Unbounded_Queue_Iterator_ACE_Notification_Queue_Node___::advance(__this)
    }
}
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Node_ACE_Notification_Queue_Node___ {
    pub next_: *mut ACE_Node_ACE_Notification_Queue_Node___,
    pub item_: *mut ACE_Notification_Queue_Node,
}
#[export_name = "_ZN8ACE_NodeIP27ACE_Notification_Queue_NodevEC1EPS2_i"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_NodeIP27ACE_Notification_Queue_NodevEC1EPS2_i(
    __this: *mut ACE_Node_ACE_Notification_Queue_Node___,
    __a0: *mut ACE_Node_ACE_Notification_Queue_Node___,
    __a1: libc::c_int,
) {
    ACE_Node_ACE_Notification_Queue_Node___::new_at_s0e3ec27981b68ba7(__this, __a0, __a1)
}
impl Drop for ACE_Node_ACE_Notification_Queue_Node___ {
    fn drop(&mut self) {
        unsafe {
            let __this: *mut Self = self as *mut Self;
            {}
...
#[export_name = "__acedtor_u5569ea290c394a8e"]
pub unsafe extern "C-unwind" fn __acedtor_u5569ea290c394a8e(
    __this: *mut ACE_Node_ACE_Notification_Queue_Node___,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[export_name = "_ZN8ACE_NodeIP27ACE_Notification_Queue_NodevEC1ERKS1_PS2_"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_NodeIP27ACE_Notification_Queue_NodevEC1ERKS1_PS2_(
    __this: *mut ACE_Node_ACE_Notification_Queue_Node___,
    __a0: *const *mut ACE_Notification_Queue_Node,
    __a1: *mut ACE_Node_ACE_Notification_Queue_Node___,
) {
    ACE_Node_ACE_Notification_Queue_Node___::new_at_sd541cceeb6ac4aac(__this, __a0, __a1)
}
extern "C" {
    #[allow(non_upper_case_globals)]
...
#[doc = "* @class ACE_Notification_Queue_Node\n *\n * @brief Helper class"]
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Notification_Queue_Node {
    pub __base_0: ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_,
    pub contents_: ::core::mem::ManuallyDrop<ACE_Notification_Buffer>,
}
impl Drop for ACE_Notification_Queue_Node {
    fn drop(&mut self) {
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.contents_);
        }
    }
}
pub unsafe extern "C-unwind" fn __xtu__ZN27ACE_Notification_Queue_NodeC1Ev(
    __this: *mut ACE_Notification_Queue_Node,
) {
    ACE_Notification_Queue_Node::new_at(__this)
}
pub type ACE_Notification_Queue_Buffer_List = ACE_Intrusive_List_ACE_Notification_Queue_Node_;
#[doc = "* @class ACE_Notification_Queue\n *\n * @brief Implements a user-space queue to send Reactor notifications.\n *\n * The ACE_Reactor uses a pipe to send wake up the thread running the\n * event loop from other threads.  This pipe can be limited in size\n * under some operating systems.  For some applications, this limit\n * presents a problem.  A user-space notification queue is used to\n * overcome those limitations.  The queue tries to use as few\n * resources on the pipe as possible, while keeping all the data in\n * user space.\n *\n * This code was refactored from Select_Reactor_Base."]
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Notification_Queue {
    pub __base_0: ACE_Copy_Disabled,
    pub alloc_queue_: ::core::mem::ManuallyDrop<
        ACE_Unbounded_Queue_ACE_Notification_Queue_Node___,
    >,
    pub notify_queue_: ::core::mem::ManuallyDrop<
        ACE_Intrusive_List_ACE_Notification_Queue_Node_,
    >,
    pub free_queue_: ::core::mem::ManuallyDrop<
        ACE_Intrusive_List_ACE_Notification_Queue_Node_,
    >,
    pub notify_queue_lock_: ::core::mem::ManuallyDrop<ACE_Thread_Mutex>,
}
#[export_name = "_ZN22ACE_Notification_QueueC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN22ACE_Notification_QueueC1Ev(
    __this: *mut ACE_Notification_Queue,
) {
    ACE_Notification_Queue::new_at(__this)
}
impl Drop for ACE_Notification_Queue {
    fn drop(&mut self) {
        {
            unsafe {
                let __this: *mut Self = self as *mut Self;
                {
                    <ACE_Notification_Queue>::reset(
                        (__this) as *mut ACE_Notification_Queue,
                    );
                }
                ()
            }
        ...
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.notify_queue_lock_);
            ::core::mem::ManuallyDrop::drop(&mut self.free_queue_);
            ::core::mem::ManuallyDrop::drop(&mut self.notify_queue_);
            ::core::mem::ManuallyDrop::drop(&mut self.alloc_queue_);
        }
    }
}
#[export_name = "__acedtor_u54f12b38f51bbd44"]
pub unsafe extern "C-unwind" fn __acedtor_u54f12b38f51bbd44(
    __this: *mut ACE_Notification_Queue,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[export_name = "_ZN22ACE_Notification_Queue4openEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN22ACE_Notification_Queue4openEv(
    __this: *mut ACE_Notification_Queue,
) -> libc::c_int {
    unsafe { ACE_Notification_Queue::open(__this) }
}
#[export_name = "_ZN22ACE_Notification_Queue5resetEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN22ACE_Notification_Queue5resetEv(
    __this: *mut ACE_Notification_Queue,
) {
    unsafe { ACE_Notification_Queue::reset(__this) }
}
#[export_name = "_ZN22ACE_Notification_Queue27purge_pending_notificationsEP17ACE_Event_Handlerm"]
pub unsafe extern "C-unwind" fn __xtu__ZN22ACE_Notification_Queue27purge_pending_notificationsEP17ACE_Event_Handlerm(
    __this: *mut ACE_Notification_Queue,
    eh: *mut ACE_Event_Handler,
    mask: libc::c_ulong,
) -> libc::c_int {
    unsafe { ACE_Notification_Queue::purge_pending_notifications(__this, eh, mask) }
}
#[export_name = "_ZN22ACE_Notification_Queue21push_new_notificationERK23ACE_Notification_Buffer"]
pub unsafe extern "C-unwind" fn __xtu__ZN22ACE_Notification_Queue21push_new_notificationERK23ACE_Notification_Buffer(
    __this: *mut ACE_Notification_Queue,
    buffer: *const ACE_Notification_Buffer,
) -> libc::c_int {
    unsafe { ACE_Notification_Queue::push_new_notification(__this, buffer) }
}
#[export_name = "_ZN22ACE_Notification_Queue21pop_next_notificationER23ACE_Notification_BufferRbS1_"]
pub unsafe extern "C-unwind" fn __xtu__ZN22ACE_Notification_Queue21pop_next_notificationER23ACE_Notification_BufferRbS1_(
    __this: *mut ACE_Notification_Queue,
    current: *mut ACE_Notification_Buffer,
    more_messages_queued: *mut bool,
    next: *mut ACE_Notification_Buffer,
) -> libc::c_int {
    unsafe {
...
#[export_name = "_ZN22ACE_Notification_Queue21allocate_more_buffersEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN22ACE_Notification_Queue21allocate_more_buffersEv(
    __this: *mut ACE_Notification_Queue,
) -> libc::c_int {
    unsafe { ACE_Notification_Queue::allocate_more_buffers(__this) }
}
extern "C-unwind" {
...
impl ACE_Notification_Queue_Node {
    ///* @brief Constructor
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ::core::ptr::write(
            ...
            <ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_>::new_at_s35516dc07ccffd36(
                (::core::ptr::addr_of_mut!((* __this).__base_0))
                    as *mut ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_,
            );
            <ACE_Notification_Buffer>::new_at_u2c59014350f736d9(
                (::core::ptr::addr_of_mut!((* __this).contents_)
                    .cast::<ACE_Notification_Buffer>()) as *mut ACE_Notification_Buffer,
    ...
    pub unsafe fn set(__this: *mut Self, mut rhs: *const ACE_Notification_Buffer) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                {
                    ...
                    let __asg_p = ::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).contents_) .cast:: <
                        ACE_Notification_Buffer > ().cast_mut())
                    );
                    *__asg_p = __v;
                    __asg_p
                };
    ...
    pub unsafe fn get(__this: *const Self) -> *const ACE_Notification_Buffer {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
    ...
    pub unsafe fn matches_for_purging(
        __this: *const Self,
        mut eh: *mut ACE_Event_Handler,
    ) -> bool {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((((((((!((*<ACE_Notification_Queue_Node>::get(
                    (__this) as *const ACE_Notification_Queue_Node,
                ))
                    .eh_)
                    .is_null()) as libc::c_int)) as libc::c_int) != 0)
                    && ((((((((((eh).is_null()) as libc::c_int) as libc::c_int) != 0)
                        || ((((((eh) as *const u8))
                            == ((((*<ACE_Notification_Queue_Node>::get(
                                (__this) as *const ACE_Notification_Queue_Node,
                            ))
                                .eh_) as *const u8))) as libc::c_int as libc::c_int) != 0))
    ...
    #[doc = "* @brief Return true if clearing the mask would leave no\n   * notifications to deliver."]
    pub unsafe fn mask_disables_all_notifications(
        __this: *mut Self,
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return ((((((((((((*<ACE_Notification_Queue_Node>::get(
                    ...
                    .mask_)) as libc::c_ulong)) & ((((!(mask)))) as libc::c_ulong))
                    as libc::c_ulong)) == (((0) as libc::c_ulong))) as libc::c_int)
                    as libc::c_int) != 0);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
    ...
    pub unsafe fn clear_mask(__this: *mut Self, mut mask: libc::c_ulong) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ({
                    let __lv = ::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).contents_) .cast:: <
                        ACE_Notification_Buffer > ().cast_mut()).mask_
                    );
                    unsafe {
...
impl ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_ {
    #[doc = "Constructor\n  /**\n   * The constructor is protected, because only derived classes should\n   * be instantiated."]
    pub unsafe fn new_at_s35516dc07ccffd36(__this: *mut Self) {
        unsafe {
            ::core::ptr::write(
                __this,
                ::core::mem::MaybeUninit::<Self>::zeroed().assume_init(),
            ...
            ::core::ptr::write(
                ...
                ((0) as *mut ACE_Notification_Queue_Node),
            );
            ::core::ptr::write(
    ...
    pub unsafe fn new_s35516dc07ccffd36() -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s35516dc07ccffd36(::core::ptr::addr_of_mut!(__obj));
        __obj
    }
    pub unsafe fn next_s819eaf41858ffcfd(
        __this: *const Self,
    ) -> *mut ACE_Notification_Queue_Node {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((*__this).next_) as *mut ACE_Notification_Queue_Node);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    pub unsafe fn next_s6b10bcfa33b421e5(
        __this: *mut Self,
        mut x: *mut ACE_Notification_Queue_Node,
    ) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
    ...
    pub unsafe fn prev_s6b10bcfa33b421e5(
        __this: *mut Self,
        mut x: *mut ACE_Notification_Queue_Node,
    ) {
        unsafe {
    ...
    pub unsafe fn prev_s819eaf41858ffcfd(
        __this: *const Self,
    ) -> *mut ACE_Notification_Queue_Node {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((*__this).prev_) as *mut ACE_Notification_Queue_Node);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
}
impl ACE_Notification_Queue {
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ::core::ptr::write(
                __this,
            ...
            <ACE_Copy_Disabled>::new_at(
                (::core::ptr::addr_of_mut!((* __this).__base_0))
                    as *mut ACE_Copy_Disabled,
            );
            <ACE_Unbounded_Queue_ACE_Notification_Queue_Node___>::new_at_s5c3f7fe777ccdfb1(
                (::core::ptr::addr_of_mut!((* __this).alloc_queue_)
                    .cast::<ACE_Unbounded_Queue_ACE_Notification_Queue_Node___>())
                    as *mut ACE_Unbounded_Queue_ACE_Notification_Queue_Node___,
                ((0) as *mut ACE_Allocator),
            );
            <ACE_Intrusive_List_ACE_Notification_Queue_Node_>::new_at_s353292625fcee34f(
                (::core::ptr::addr_of_mut!((* __this).notify_queue_)
                    .cast::<ACE_Intrusive_List_ACE_Notification_Queue_Node_>())
                    as *mut ACE_Intrusive_List_ACE_Notification_Queue_Node_,
            );
            <ACE_Intrusive_List_ACE_Notification_Queue_Node_>::new_at_s353292625fcee34f(
                (::core::ptr::addr_of_mut!((* __this).free_queue_)
                    .cast::<ACE_Intrusive_List_ACE_Notification_Queue_Node_>())
                    as *mut ACE_Intrusive_List_ACE_Notification_Queue_Node_,
            );
            <ACE_Thread_Mutex>::new_at(
                ::core::ptr::addr_of_mut!((* __this).notify_queue_lock_)
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                <ACE_Guard_ACE_Thread_Mutex_>::new_at_s194b481c4e491c25(
                    ...
                    ::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).notify_queue_lock_) .cast:: <
                ...
                if (((!(((<ACE_Intrusive_List_ACE_Notification_Queue_Node_>::is_empty(
                    (::core::ptr::addr_of!(
                        (* ::core::ptr::addr_of!((* __this).free_queue_) .cast:: <
                        ACE_Intrusive_List_ACE_Notification_Queue_Node_ > ().cast_mut())
                    )) as *const ACE_Intrusive_List_ACE_Notification_Queue_Node_,
                ) as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
                {
                    return 0;
                }
                return <ACE_Notification_Queue>::allocate_more_buffers(
                    (__this) as *mut ACE_Notification_Queue,
                );
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
    ...
    pub unsafe fn reset(__this: *mut Self) {
        unsafe {
            ...
            {
                {
                    let mut node: *mut ACE_Notification_Queue_Node = <ACE_Intrusive_List_ACE_Notification_Queue_Node_>::head(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* __this).notify_queue_) .cast:: <
                            ACE_Intrusive_List_ACE_Notification_Queue_Node_ > ()
                            .cast_mut())
                        )) as *const ACE_Intrusive_List_ACE_Notification_Queue_Node_,
                    );
                    'for_0: loop {
                        ...
                        'cont_0: loop {
                            {
                                {
                                    if ((((((*<ACE_Notification_Queue_Node>::get(
                                        (node) as *const ACE_Notification_Queue_Node,
                                    ))
                                        .eh_)
                                        .is_null()) as libc::c_int) as libc::c_int) != 0)
                                    {
                                    ...
                                    {
                                        let _ = {
                                            let __obj: *mut ACE_Event_Handler = ((*<ACE_Notification_Queue_Node>::get(
                                                (node) as *const ACE_Notification_Queue_Node,
                                            ))
                                                .eh_) as *mut ACE_Event_Handler;
                        ...
                        {
                            let __v = <ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_>::next_s819eaf41858ffcfd(
                                (::core::ptr::addr_of!((* node).__base_0))
                                    as *const ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_,
                            );
                            node = __v;
                            __v
                        };
                ...
                let mut b: *mut *mut ACE_Notification_Queue_Node = ((0)
                    as *mut *mut ACE_Notification_Queue_Node);
                {
                    let mut alloc_iter: ACE_Unbounded_Queue_Iterator_ACE_Notification_Queue_Node___ = ::core::mem::MaybeUninit::<
                        ACE_Unbounded_Queue_Iterator_ACE_Notification_Queue_Node___,
                    >::zeroed()
                        .assume_init();
                    <ACE_Unbounded_Queue_Iterator_ACE_Notification_Queue_Node___>::new_at_sbcdc1bf5787c85b6(
                        (::core::ptr::addr_of_mut!(alloc_iter))
                            as *mut ACE_Unbounded_Queue_Iterator_ACE_Notification_Queue_Node___,
                        ::core::ptr::addr_of_mut!(
                            (* ::core::ptr::addr_of!((* __this).alloc_queue_) .cast:: <
                            ACE_Unbounded_Queue_ACE_Notification_Queue_Node___ > ()
                            .cast_mut())
                        ),
                        0,
                    ...
                    'for_1: loop {
                        if !((((((<ACE_Unbounded_Queue_Iterator_ACE_Notification_Queue_Node___>::next(
                            (::core::ptr::addr_of_mut!(alloc_iter))
                                as *mut ACE_Unbounded_Queue_Iterator_ACE_Notification_Queue_Node___,
                        ...
                        'cont_1: loop {
                            {
                                {
                                    {
                                        let __data = (*(b)) as *mut ACE_Notification_Queue_Node;
                                        if !__data.is_null() {
                                    ...
                                    (*(b)) = ((0) as *mut ACE_Notification_Queue_Node);
                                }
                            }
                            #[allow(unreachable_code)] break 'cont_1;
                        }
                        <ACE_Unbounded_Queue_Iterator_ACE_Notification_Queue_Node___>::advance(
                            (::core::ptr::addr_of_mut!(alloc_iter))
                                as *mut ACE_Unbounded_Queue_Iterator_ACE_Notification_Queue_Node___,
                        );
                    }
                }
                <ACE_Unbounded_Queue_ACE_Notification_Queue_Node___>::reset(
                    (::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).alloc_queue_) .cast:: <
                        ACE_Unbounded_Queue_ACE_Notification_Queue_Node___ > ()
                        .cast_mut())
                ...
                <ACE_Intrusive_List_ACE_Notification_Queue_Node_>::swap(
                    (((&mut ({
                        let mut __recv: ACE_Intrusive_List_ACE_Notification_Queue_Node_ = <ACE_Intrusive_List_ACE_Notification_Queue_Node_>::new_s353292625fcee34f();
                        __recv
                    })) as *mut ACE_Intrusive_List_ACE_Notification_Queue_Node_))
                        as *mut ACE_Intrusive_List_ACE_Notification_Queue_Node_,
                    ::core::ptr::addr_of_mut!(
    ...
    pub unsafe fn purge_pending_notifications(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                let mut number_purged: libc::c_int = 0;
                let mut node: *mut ACE_Notification_Queue_Node = <ACE_Intrusive_List_ACE_Notification_Queue_Node_>::head(
                    (::core::ptr::addr_of!(
                        (* ::core::ptr::addr_of!((* __this).notify_queue_) .cast:: <
                        ACE_Intrusive_List_ACE_Notification_Queue_Node_ > ().cast_mut())
                ...
                'while_0: loop {
                    ...
                    'cont_0: loop {
                        {
                            {
                                if (((!(((<ACE_Notification_Queue_Node>::matches_for_purging(
                                    (node) as *const ACE_Notification_Queue_Node,
                                    eh,
                                ) as libc::c_int) != 0)) as libc::c_int) as libc::c_int)
                                    != 0)
                                {
                                    node = <ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_>::next_s819eaf41858ffcfd(
                                        (::core::ptr::addr_of!((* node).__base_0))
                                            as *const ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_,
                                    );
                                    break 'cont_0;
                                }
                                if (((!(((<ACE_Notification_Queue_Node>::mask_disables_all_notifications(
                                    (node) as *mut ACE_Notification_Queue_Node,
                                    mask,
                                ) as libc::c_int) != 0)) as libc::c_int) as libc::c_int)
                                    != 0)
                                {
                                    <ACE_Notification_Queue_Node>::clear_mask(
                                        (node) as *mut ACE_Notification_Queue_Node,
                                        mask,
                                    );
                                    node = <ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_>::next_s819eaf41858ffcfd(
                                ...
                                let mut next: *mut ACE_Notification_Queue_Node = <ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_>::next_s819eaf41858ffcfd(
                                    (::core::ptr::addr_of!((* node).__base_0))
                                        as *const ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_,
                                );
                                <ACE_Intrusive_List_ACE_Notification_Queue_Node_>::unsafe_remove(
                                    (::core::ptr::addr_of_mut!(
                                        (* ::core::ptr::addr_of!((* __this).notify_queue_) .cast:: <
                                        ACE_Intrusive_List_ACE_Notification_Queue_Node_ > ()
                                        .cast_mut())
                                ...
                                {
                                    let __lv = &mut (number_purged);
                                    *__lv = (*__lv).wrapping_add(1);
                                    *__lv
                                };
                                let mut event_handler: *mut ACE_Event_Handler = (((*<ACE_Notification_Queue_Node>::get(
                                    (node) as *const ACE_Notification_Queue_Node,
                                ))
                                    .eh_) as *mut ACE_Event_Handler);
                                {
                                    let __obj: *mut ACE_Event_Handler = (event_handler)
                                        as *mut ACE_Event_Handler;
                                    let __vt: *const __Vtbl_ud05ba0669c8bb3a2 = *(__obj
                                        as *const *const __Vtbl_ud05ba0669c8bb3a2);
                                    ((*__vt).vfn_u590ad03b86fd5891)(__obj)
                                };
                                <ACE_Intrusive_List_ACE_Notification_Queue_Node_>::push_front(
                                    (::core::ptr::addr_of_mut!(
                                        (* ::core::ptr::addr_of!((* __this).free_queue_) .cast:: <
                                        ACE_Intrusive_List_ACE_Notification_Queue_Node_ > ()
                                        .cast_mut())
    ...
    #[doc = "* @brief Add a new notification to the queue\n   *\n   * @return -1 on failure, 1 if a new message should be sent through\n   * the pipe and 0 otherwise."]
    pub unsafe fn push_new_notification(
        __this: *mut Self,
        mut buffer: *const ACE_Notification_Buffer,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut notification_required: bool = false;
                let mut mon: ACE_Guard_ACE_Thread_Mutex_ = ::core::mem::MaybeUninit::<
                    ACE_Guard_ACE_Thread_Mutex_,
                >::zeroed()
                    .assume_init();
                ...
                {
                    if (((((<ACE_Notification_Queue>::allocate_more_buffers(
                        (__this) as *mut ACE_Notification_Queue,
                ...
                let mut node: *mut ACE_Notification_Queue_Node = <ACE_Intrusive_List_ACE_Notification_Queue_Node_>::pop_front(
                    (::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).free_queue_) .cast:: <
                        ACE_Intrusive_List_ACE_Notification_Queue_Node_ > ().cast_mut())
                    )) as *mut ACE_Intrusive_List_ACE_Notification_Queue_Node_,
                ...
                (if (((((!(node).is_null()) as libc::c_int)) as libc::c_int) != 0) {
                    ...
                    __ace_assert(
                        ((b"/build/ace_full/src/ACE/ace/Notification_Queue.cpp\0"
                            .as_ptr() as *const libc::c_char) as *const libc::c_char),
                        181,
                        ((b"node != 0\0".as_ptr() as *const libc::c_char)
                            as *const libc::c_char),
                    )
                });
                <ACE_Notification_Queue_Node>::set(
                    (node) as *mut ACE_Notification_Queue_Node,
                    ::core::ptr::addr_of!((* buffer)),
                );
                <ACE_Intrusive_List_ACE_Notification_Queue_Node_>::push_back(
                    (::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).notify_queue_) .cast:: <
                        ACE_Intrusive_List_ACE_Notification_Queue_Node_ > ().cast_mut())
                    )) as *mut ACE_Intrusive_List_ACE_Notification_Queue_Node_,
                ...
                if (((!(((notification_required as libc::c_int) != 0)) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    return 0;
                }
    ...
    #[doc = "* @brief Extract the next notification from the queue\n   *\n   * @return -1 on failure, 1 if a message was popped, 0 otherwise"]
    pub unsafe fn pop_next_notification(
        __this: *mut Self,
        mut current: *mut ACE_Notification_Buffer,
        mut more_messages_queued: *mut bool,
        mut next: *mut ACE_Notification_Buffer,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                {
                    let __v = ((*<ACE_Notification_Queue_Node>::get(
                        (node) as *const ACE_Notification_Queue_Node,
                    )))
                        .clone();
                    let __asg_p = ::core::ptr::addr_of_mut!((* current));
                    *__asg_p = __v;
                    __asg_p
                };
                <ACE_Intrusive_List_ACE_Notification_Queue_Node_>::push_front(
                ...
                ) as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
                {
                    ...
                    {
                        let __v = ((*<ACE_Notification_Queue_Node>::get(
                            (<ACE_Intrusive_List_ACE_Notification_Queue_Node_>::head(
                                (::core::ptr::addr_of!(
                                    (* ::core::ptr::addr_of!((* __this).notify_queue_) .cast:: <
                                    ACE_Intrusive_List_ACE_Notification_Queue_Node_ > ()
                                    .cast_mut())
                                )) as *const ACE_Intrusive_List_ACE_Notification_Queue_Node_,
                            )) as *const ACE_Notification_Queue_Node,
                        )))
                            .clone();
                        let __asg_p = ::core::ptr::addr_of_mut!((* next));
                        *__asg_p = __v;
                        __asg_p
                    };
                }
    ...
    pub unsafe fn allocate_more_buffers(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut temp: *mut ACE_Notification_Queue_Node = ((0)
                    as *mut ACE_Notification_Queue_Node);
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            {
                                temp = {
                                    let __count: usize = (1024) as usize;
                                    ...
                                    *(__base as *mut usize) = __count;
                                    let __data = __base.add(__off)
                                        as *mut ACE_Notification_Queue_Node;
                                    let mut __i: usize = 0;
                                    while __i < __count {
                                        ::core::ptr::write(
                                            __data.add(__i),
                                            <ACE_Notification_Queue_Node>::new(),
                                        );
                                        __i += 1;
                                    }
                                    __data
                ...
                if (((((<ACE_Unbounded_Queue_ACE_Notification_Queue_Node___>::enqueue_head(
                    (::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).alloc_queue_) .cast:: <
                        ACE_Unbounded_Queue_ACE_Notification_Queue_Node___ > ()
                        .cast_mut())
                ...
                {
                    {
                        let __data = temp as *mut ACE_Notification_Queue_Node;
                        if !__data.is_null() {
                            let __off = ::core::alloc::Layout::new::<usize>()
                                .extend(
                                    ::core::alloc::Layout::array::<
                ...
                }
                {
                    ...
                    'for_1: loop {
                        if !((((((i as libc::c_ulong)) < (((1024) as libc::c_ulong)))
                            as libc::c_int as libc::c_int) != 0))
                        {
                            break;
                        }
...
impl ACE_Unbounded_Queue_ACE_Notification_Queue_Node___ {
    #[doc = "Copy constructor.\n  /**\n   * Initialize the queue to be a copy of the provided queue."]
    pub unsafe fn new_at_sadc0d33b52acb49b(
        __this: *mut Self,
        mut __a0: *const ACE_Unbounded_Queue_ACE_Notification_Queue_Node___,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN19ACE_Unbounded_QueueIP27ACE_Notification_Queue_NodeEC1ERKS2_"]
            fn __ext(
                __this: *mut ACE_Unbounded_Queue_ACE_Notification_Queue_Node___,
                __a0: *const ACE_Unbounded_Queue_ACE_Notification_Queue_Node___,
            );
        }
        __ext(__this as *mut ACE_Unbounded_Queue_ACE_Notification_Queue_Node___, __a0)
    }
    pub unsafe fn new_sadc0d33b52acb49b(
        mut __a0: *const ACE_Unbounded_Queue_ACE_Notification_Queue_Node___,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_sadc0d33b52acb49b(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    #[doc = "Assignment operator.\n  /**\n   * Perform a deep copy of rhs."]
    pub unsafe fn operator_assign(
        __this: *mut Self,
        mut _anon_0: *mut ACE_Unbounded_Queue_ACE_Notification_Queue_Node___,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN19ACE_Unbounded_QueueIP27ACE_Notification_Queue_NodeEaSERKS2_"]
            fn __ext(
                __this: *mut ACE_Unbounded_Queue_ACE_Notification_Queue_Node___,
                _anon_0: *mut ACE_Unbounded_Queue_ACE_Notification_Queue_Node___,
            );
        }
        __ext(__this as *mut ACE_Unbounded_Queue_ACE_Notification_Queue_Node___, _anon_0)
    }
    #[doc = "Returns true if the container is empty, otherwise returns false.\n  /**\n   * Constant time check to see if the queue is empty."]
    pub unsafe fn is_empty(__this: *const Self) -> bool {
        extern "C-unwind" {
            #[link_name = "_ZNK19ACE_Unbounded_QueueIP27ACE_Notification_Queue_NodeE8is_emptyEv"]
            fn __ext(
                __this: *const ACE_Unbounded_Queue_ACE_Notification_Queue_Node___,
            ) -> bool;
        }
        __ext(__this as *const ACE_Unbounded_Queue_ACE_Notification_Queue_Node___)
    }
    #[doc = "Returns 0.\n  /**\n   * The queue cannot be full, so it always returns 0."]
    pub unsafe fn is_full(__this: *const Self) -> bool {
        extern "C-unwind" {
            #[link_name = "_ZNK19ACE_Unbounded_QueueIP27ACE_Notification_Queue_NodeE7is_fullEv"]
            fn __ext(
                __this: *const ACE_Unbounded_Queue_ACE_Notification_Queue_Node___,
            ) -> bool;
        }
    ...
    pub unsafe fn enqueue_tail(
        __this: *mut Self,
        mut new_item: *const *mut ACE_Notification_Queue_Node,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN19ACE_Unbounded_QueueIP27ACE_Notification_Queue_NodeE12enqueue_tailERKS1_"]
            fn __ext(
                __this: *mut ACE_Unbounded_Queue_ACE_Notification_Queue_Node___,
                new_item: *const *mut ACE_Notification_Queue_Node,
            ) -> libc::c_int;
    ...
    pub unsafe fn dequeue_head(
        __this: *mut Self,
        mut item: *mut *mut ACE_Notification_Queue_Node,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN19ACE_Unbounded_QueueIP27ACE_Notification_Queue_NodeE12dequeue_headERS1_"]
            fn __ext(
                __this: *mut ACE_Unbounded_Queue_ACE_Notification_Queue_Node___,
                item: *mut *mut ACE_Notification_Queue_Node,
            ) -> libc::c_int;
        }
        __ext(__this as *mut ACE_Unbounded_Queue_ACE_Notification_Queue_Node___, item)
    }
    ...
    pub unsafe fn get(
        __this: *const Self,
        mut item: *mut *mut *mut ACE_Notification_Queue_Node,
        mut slot: libc::c_ulong,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZNK19ACE_Unbounded_QueueIP27ACE_Notification_Queue_NodeE3getERPS1_m"]
            fn __ext(
                __this: *const ACE_Unbounded_Queue_ACE_Notification_Queue_Node___,
                item: *mut *mut *mut ACE_Notification_Queue_Node,
                slot: libc::c_ulong,
        ...
        __ext(
            __this as *const ACE_Unbounded_Queue_ACE_Notification_Queue_Node___,
            item,
            slot,
        )
    }
    ...
    pub unsafe fn set(
        __this: *mut Self,
        mut item: *const *mut ACE_Notification_Queue_Node,
        mut slot: libc::c_ulong,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN19ACE_Unbounded_QueueIP27ACE_Notification_Queue_NodeE3setERKS1_m"]
            fn __ext(
                __this: *mut ACE_Unbounded_Queue_ACE_Notification_Queue_Node___,
                item: *const *mut ACE_Notification_Queue_Node,
                slot: libc::c_ulong,
            ) -> libc::c_int;
        }
        __ext(
    ...
    pub unsafe fn size(__this: *const Self) -> libc::c_ulong {
        extern "C-unwind" {
            #[link_name = "_ZNK19ACE_Unbounded_QueueIP27ACE_Notification_Queue_NodeE4sizeEv"]
            fn __ext(
                __this: *const ACE_Unbounded_Queue_ACE_Notification_Queue_Node___,
            ) -> libc::c_ulong;
        }
    ...
    pub unsafe fn dump(__this: *const Self) {
        extern "C-unwind" {
            #[link_name = "_ZNK19ACE_Unbounded_QueueIP27ACE_Notification_Queue_NodeE4dumpEv"]
            fn __ext(__this: *const ACE_Unbounded_Queue_ACE_Notification_Queue_Node___);
        }
        __ext(__this as *const ACE_Unbounded_Queue_ACE_Notification_Queue_Node___)
    }
    ...
    pub unsafe fn copy_nodes(
        ...
        extern "C-unwind" {
            #[link_name = "_ZN19ACE_Unbounded_QueueIP27ACE_Notification_Queue_NodeE10copy_nodesERKS2_"]
            fn __ext(
                __this: *mut ACE_Unbounded_Queue_ACE_Notification_Queue_Node___,
                _anon_0: *mut ACE_Unbounded_Queue_ACE_Notification_Queue_Node___,
            );
    ...
    pub unsafe fn new_at_s5c3f7fe777ccdfb1(
        __this: *mut Self,
        ...
        unsafe {
            ...
            ::core::ptr::write(
                ...
                ((0) as *mut ACE_Node_ACE_Notification_Queue_Node___),
            );
            ::core::ptr::write(
                        ...
                        {
                            {
                                ...
                                } as *mut ACE_Node_ACE_Notification_Queue_Node___);
                                    ...
                                    as libc::c_int) != 0)
                                {
                                    ...
                                    {
                                        let _ = {
                                            let __place: *mut ACE_Node_ACE_Notification_Queue_Node___ = ((*__this)
                                                .head_) as *mut ACE_Node_ACE_Notification_Queue_Node___;
                                            <ACE_Node_ACE_Notification_Queue_Node___>::new_at_s0e3ec27981b68ba7(
                                                (__place) as *mut ACE_Node_ACE_Notification_Queue_Node___,
                                                ((0) as *mut ACE_Node_ACE_Notification_Queue_Node___),
                                                0,
                                            );
                                            __place
    ...
    pub unsafe fn new_s5c3f7fe777ccdfb1(mut __a0: *mut ACE_Allocator) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s5c3f7fe777ccdfb1(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    ...
    pub unsafe fn delete_nodes(__this: *mut Self) {
        unsafe {
            ...
            {
                {
                    let mut curr: *mut ACE_Node_ACE_Notification_Queue_Node___ = (((*(*__this)
                        .head_)
                        .next_) as *mut ACE_Node_ACE_Notification_Queue_Node___);
                    'for_0: loop {
                        if !(((((((curr) as *const u8))
                        ...
                        'cont_0: loop {
                            {
                                {
                                    let mut temp: *mut ACE_Node_ACE_Notification_Queue_Node___ = curr;
                                    curr = (((*curr).next_)
                                        as *mut ACE_Node_ACE_Notification_Queue_Node___);
                                    'dowhile_1: loop {
                                        'cont_1: loop {
    ...
    pub unsafe fn enqueue_head(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut temp: *mut ACE_Node_ACE_Notification_Queue_Node___ = ((0)
                    as *mut ACE_Node_ACE_Notification_Queue_Node___);
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            {
                                    ...
                                    != 0)
                                {
                                    ...
                                    {
                                        let _ = {
                                            let __place: *mut ACE_Node_ACE_Notification_Queue_Node___ = (temp)
                                                as *mut ACE_Node_ACE_Notification_Queue_Node___;
                                            <ACE_Node_ACE_Notification_Queue_Node___>::new_at_sd541cceeb6ac4aac(
                                                (__place) as *mut ACE_Node_ACE_Notification_Queue_Node___,
...
impl ACE_Node_ACE_Notification_Queue_Node___ {
    pub unsafe fn new_at_s39dd2af3a661d7ef(
        __this: *mut Self,
        mut __a0: *const ACE_Node_ACE_Notification_Queue_Node___,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN8ACE_NodeIP27ACE_Notification_Queue_NodevEC1ERKS2_"]
            fn __ext(
                __this: *mut ACE_Node_ACE_Notification_Queue_Node___,
                __a0: *const ACE_Node_ACE_Notification_Queue_Node___,
            );
        }
        __ext(__this as *mut ACE_Node_ACE_Notification_Queue_Node___, __a0)
    }
    pub unsafe fn new_s39dd2af3a661d7ef(
        mut __a0: *const ACE_Node_ACE_Notification_Queue_Node___,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s39dd2af3a661d7ef(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    ///Not possible
    pub unsafe fn operator_assign(
        __this: *mut Self,
        mut _anon_0: *mut ACE_Node_ACE_Notification_Queue_Node___,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN8ACE_NodeIP27ACE_Notification_Queue_NodevEaSERKS2_"]
            fn __ext(
                __this: *mut ACE_Node_ACE_Notification_Queue_Node___,
                _anon_0: *mut ACE_Node_ACE_Notification_Queue_Node___,
            );
        }
        __ext(__this as *mut ACE_Node_ACE_Notification_Queue_Node___, _anon_0)
    }
    pub unsafe fn new_at_s0e3ec27981b68ba7(
        __this: *mut Self,
        mut n: *mut ACE_Node_ACE_Notification_Queue_Node___,
    ...
    pub unsafe fn new_s0e3ec27981b68ba7(
        mut __a0: *mut ACE_Node_ACE_Notification_Queue_Node___,
        mut __a1: libc::c_int,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s0e3ec27981b68ba7(::core::ptr::addr_of_mut!(__obj), __a0, __a1);
        __obj
    }
    pub unsafe fn new_at_sd541cceeb6ac4aac(
        __this: *mut Self,
        mut i: *const *mut ACE_Notification_Queue_Node,
        mut n: *mut ACE_Node_ACE_Notification_Queue_Node___,
    ) {
        unsafe {
            ::core::ptr::write(
            ...
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).next_), n);
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).item_),
                (((*i)) as *mut ACE_Notification_Queue_Node),
            );
            {}
            ()
        }
    }
    pub unsafe fn new_sd541cceeb6ac4aac(
        mut __a0: *const *mut ACE_Notification_Queue_Node,
        mut __a1: *mut ACE_Node_ACE_Notification_Queue_Node___,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_sd541cceeb6ac4aac(::core::ptr::addr_of_mut!(__obj), __a0, __a1);
        __obj
    }
}
impl ACE_Intrusive_List_ACE_Notification_Queue_Node_ {
    ///Remove the element at the end of the list
    pub unsafe fn pop_back(__this: *mut Self) -> *mut ACE_Notification_Queue_Node {
        extern "C-unwind" {
            #[link_name = "_ZN18ACE_Intrusive_ListI27ACE_Notification_Queue_NodeE8pop_backEv"]
            fn __ext(
                __this: *mut ACE_Intrusive_List_ACE_Notification_Queue_Node_,
            ) -> *mut ACE_Notification_Queue_Node;
        }
        __ext(__this as *mut ACE_Intrusive_List_ACE_Notification_Queue_Node_)
    }
    ///Get the element at the tail of the queue
    pub unsafe fn tail(__this: *const Self) -> *mut ACE_Notification_Queue_Node {
        extern "C-unwind" {
            #[link_name = "_ZNK18ACE_Intrusive_ListI27ACE_Notification_Queue_NodeE4tailEv"]
            fn __ext(
                __this: *const ACE_Intrusive_List_ACE_Notification_Queue_Node_,
            ) -> *mut ACE_Notification_Queue_Node;
        }
        __ext(__this as *const ACE_Intrusive_List_ACE_Notification_Queue_Node_)
    }
    #[doc = "Remove a element from the list\n  /**\n   * Verify that the element is still in the list before removing it."]
    pub unsafe fn remove(__this: *mut Self, mut node: *mut ACE_Notification_Queue_Node) {
        extern "C-unwind" {
            #[link_name = "_ZN18ACE_Intrusive_ListI27ACE_Notification_Queue_NodeE6removeEPS0_"]
            fn __ext(
                __this: *mut ACE_Intrusive_List_ACE_Notification_Queue_Node_,
                node: *mut ACE_Notification_Queue_Node,
            );
        }
        __ext(__this as *mut ACE_Intrusive_List_ACE_Notification_Queue_Node_, node)
    }
    pub unsafe fn new_at_sa769204e1964abeb(
        __this: *mut Self,
        mut __a0: *const ACE_Intrusive_List_ACE_Notification_Queue_Node_,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN18ACE_Intrusive_ListI27ACE_Notification_Queue_NodeEC1ERKS1_"]
            fn __ext(
                __this: *mut ACE_Intrusive_List_ACE_Notification_Queue_Node_,
                __a0: *const ACE_Intrusive_List_ACE_Notification_Queue_Node_,
            );
        }
        __ext(__this as *mut ACE_Intrusive_List_ACE_Notification_Queue_Node_, __a0)
    }
    pub unsafe fn new_sa769204e1964abeb(
        mut __a0: *const ACE_Intrusive_List_ACE_Notification_Queue_Node_,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_sa769204e1964abeb(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    pub unsafe fn operator_assign(
        __this: *mut Self,
        mut _anon_0: *mut ACE_Intrusive_List_ACE_Notification_Queue_Node_,
    ) -> *mut ACE_Intrusive_List_ACE_Notification_Queue_Node_ {
        extern "C-unwind" {
            #[link_name = "_ZN18ACE_Intrusive_ListI27ACE_Notification_Queue_NodeEaSERKS1_"]
            fn __ext(
                __this: *mut ACE_Intrusive_List_ACE_Notification_Queue_Node_,
                _anon_0: *mut ACE_Intrusive_List_ACE_Notification_Queue_Node_,
            ) -> *mut ACE_Intrusive_List_ACE_Notification_Queue_Node_;
        }
        __ext(__this as *mut ACE_Intrusive_List_ACE_Notification_Queue_Node_, _anon_0)
    }
    /**Constructor.  Use user specified allocation strategy
  /// if specified.*/
    pub unsafe fn new_at_s353292625fcee34f(__this: *mut Self) {
        unsafe {
            ::core::ptr::write(
                __this,
                ::core::mem::MaybeUninit::<Self>::zeroed().assume_init(),
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).tail_),
                ((0) as *mut ACE_Notification_Queue_Node),
            );
            {}
            ()
    ...
    pub unsafe fn new_s353292625fcee34f() -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s353292625fcee34f(::core::ptr::addr_of_mut!(__obj));
        __obj
    }
    ///Returns true if the container is empty, otherwise returns false.
    pub unsafe fn is_empty(__this: *const Self) -> bool {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return ((((((*__this).head_).is_null()) as libc::c_int) as libc::c_int)
                    != 0);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    ...
    ///Get the element at the head of the queue
    pub unsafe fn head(__this: *const Self) -> *mut ACE_Notification_Queue_Node {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((*__this).head_) as *mut ACE_Notification_Queue_Node);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    ...
    pub unsafe fn swap(
        __this: *mut Self,
        mut rhs: *mut ACE_Intrusive_List_ACE_Notification_Queue_Node_,
    ) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ::core::ptr::swap(
                    ::core::ptr::addr_of_mut!((* __this).head_),
                    ::core::ptr::addr_of_mut!((* rhs).head_),
                );
                ::core::ptr::swap(
                    ::core::ptr::addr_of_mut!((* __this).tail_),
                    ::core::ptr::addr_of_mut!((* rhs).tail_),
                );
            }
            ()
        }
    ...
    pub unsafe fn push_front(
        __this: *mut Self,
        mut node: *mut ACE_Notification_Queue_Node,
    ) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((((*__this).head_).is_null()) as libc::c_int) as libc::c_int) != 0)
                {
                    (*__this).tail_ = node;
                    (*__this).head_ = node;
                    <ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_>::next_s6b10bcfa33b421e5(
                        (::core::ptr::addr_of_mut!((* node).__base_0))
                            as *mut ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_,
                        ((0) as *mut ACE_Notification_Queue_Node),
                    );
                    <ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_>::prev_s6b10bcfa33b421e5(
                        (::core::ptr::addr_of_mut!((* node).__base_0))
                            as *mut ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_,
                        ((0) as *mut ACE_Notification_Queue_Node),
                    );
                    ...
                    <ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_>::prev_s6b10bcfa33b421e5(
                        (::core::ptr::addr_of_mut!((* (* __this).head_).__base_0))
                            as *mut ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_,
                        node,
                    );
                    <ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_>::next_s6b10bcfa33b421e5(
    ...
    pub unsafe fn unsafe_remove(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((!(<ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_>::prev_s819eaf41858ffcfd(
                    (::core::ptr::addr_of!((* node).__base_0))
                        as *const ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_,
                ))
                    .is_null()) as libc::c_int) as libc::c_int) != 0)
                {
                    <ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_>::next_s6b10bcfa33b421e5(
                        (::core::ptr::addr_of_mut!(
                            (* < ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_ >
                            ::prev_s819eaf41858ffcfd((::core::ptr::addr_of!((* node)
                            .__base_0)) as * const
                            ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_))
                            .__base_0
                        )) as *mut ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_,
                        <ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_>::next_s819eaf41858ffcfd(
                            (::core::ptr::addr_of!((* node).__base_0))
                                as *const ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_,
                        ),
                    );
                } else {
                    (*__this).head_ = <ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_>::next_s819eaf41858ffcfd(
                        (::core::ptr::addr_of!((* node).__base_0))
                            as *const ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_,
                    );
                }
                if ((((!(<ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_>::next_s819eaf41858ffcfd(
                    (::core::ptr::addr_of!((* node).__base_0))
                        as *const ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_,
                ))
                    .is_null()) as libc::c_int) as libc::c_int) != 0)
                {
                    <ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_>::prev_s6b10bcfa33b421e5(
                        (::core::ptr::addr_of_mut!(
                            (* < ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_ >
                            ::next_s819eaf41858ffcfd((::core::ptr::addr_of!((* node)
                            .__base_0)) as * const
                            ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_))
                            .__base_0
                        )) as *mut ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_,
                        <ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_>::prev_s819eaf41858ffcfd(
                            (::core::ptr::addr_of!((* node).__base_0))
                                as *const ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_,
                        ),
                    );
                } else {
                    (*__this).tail_ = <ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_>::prev_s819eaf41858ffcfd(
                        (::core::ptr::addr_of!((* node).__base_0))
                            as *const ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_,
                    );
                }
    ...
    ///Remove the element at the beginning of the list
    pub unsafe fn pop_front(__this: *mut Self) -> *mut ACE_Notification_Queue_Node {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut node: *mut ACE_Notification_Queue_Node = (*__this).head_;
                if ((((!(node).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    <ACE_Intrusive_List_ACE_Notification_Queue_Node_>::unsafe_remove(
                        (__this) as *mut ACE_Intrusive_List_ACE_Notification_Queue_Node_,
                        node,
                    );
                }
                return node;
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((((*__this).tail_).is_null()) as libc::c_int) as libc::c_int) != 0)
                {
                    ...
                    <ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_>::next_s6b10bcfa33b421e5(
                        (::core::ptr::addr_of_mut!((* (* __this).tail_).__base_0))
                            as *mut ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_,
                        node,
                    );
                    <ACE_Intrusive_List_Node_ACE_Notification_Queue_Node_>::prev_s6b10bcfa33b421e5(
...
impl ACE_Unbounded_Queue_Iterator_ACE_Notification_Queue_Node___ {
  ...
  /// queue is empty, else 1.*/
    pub unsafe fn first(__this: *mut Self) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN28ACE_Unbounded_Queue_IteratorIP27ACE_Notification_Queue_NodeE5firstEv"]
            fn __ext(
                __this: *mut ACE_Unbounded_Queue_Iterator_ACE_Notification_Queue_Node___,
            ) -> libc::c_int;
        }
        __ext(__this as *mut ACE_Unbounded_Queue_Iterator_ACE_Notification_Queue_Node___)
    }
    ///Returns 1 when all items have been seen, else 0.
    pub unsafe fn done(__this: *const Self) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZNK28ACE_Unbounded_Queue_IteratorIP27ACE_Notification_Queue_NodeE4doneEv"]
            fn __ext(
                __this: *const ACE_Unbounded_Queue_Iterator_ACE_Notification_Queue_Node___,
            ) -> libc::c_int;
        }
        __ext(
            __this as *const ACE_Unbounded_Queue_Iterator_ACE_Notification_Queue_Node___,
        )
    }
    ///Dump the state of an object.
    pub unsafe fn dump(__this: *const Self) {
        extern "C-unwind" {
            #[link_name = "_ZNK28ACE_Unbounded_Queue_IteratorIP27ACE_Notification_Queue_NodeE4dumpEv"]
            fn __ext(
                __this: *const ACE_Unbounded_Queue_Iterator_ACE_Notification_Queue_Node___,
            );
        }
    ...
    pub unsafe fn new_at_sbcdc1bf5787c85b6(
        __this: *mut Self,
        mut q: *mut ACE_Unbounded_Queue_ACE_Notification_Queue_Node___,
        mut end: libc::c_int,
    ) {
        unsafe {
            ::core::ptr::write(
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).queue_),
    ...
    pub unsafe fn new_sbcdc1bf5787c85b6(
        mut __a0: *mut ACE_Unbounded_Queue_ACE_Notification_Queue_Node___,
        mut __a1: libc::c_int,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_sbcdc1bf5787c85b6(::core::ptr::addr_of_mut!(__obj), __a0, __a1);
        __obj
    }
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((((((*__this).current_) as *const u8))
                    == ((((*(*__this).queue_).head_) as *const u8))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    return 0;
                } else {
