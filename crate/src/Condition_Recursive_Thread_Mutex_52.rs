...
pub struct ACE_Condition_ACE_Recursive_Thread_Mutex_ {
    ...
    pub mutex_: *mut ACE_Recursive_Thread_Mutex,
}
#[export_name = "_ZN13ACE_ConditionI26ACE_Recursive_Thread_MutexEC1ERS0_"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_ConditionI26ACE_Recursive_Thread_MutexEC1ERS0_(
    __this: *mut ACE_Condition_ACE_Recursive_Thread_Mutex_,
    __a0: *mut ACE_Recursive_Thread_Mutex,
) {
    ACE_Condition_ACE_Recursive_Thread_Mutex_::new_at(__this, __a0)
}
#[export_name = "_ZN13ACE_ConditionI26ACE_Recursive_Thread_MutexEC1ERS0_RK24ACE_Condition_Attributes"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_ConditionI26ACE_Recursive_Thread_MutexEC1ERS0_RK24ACE_Condition_Attributes(
    __this: *mut ACE_Condition_ACE_Recursive_Thread_Mutex_,
    __a0: *mut ACE_Recursive_Thread_Mutex,
    __a1: *const ACE_Condition_Attributes,
) {
    ACE_Condition_ACE_Recursive_Thread_Mutex_::new_at_u0a3a2d808c3849e9(
        __this,
        __a0,
        __a1,
    )
}
impl Drop for ACE_Condition_ACE_Recursive_Thread_Mutex_ {
    fn drop(&mut self) {
        unsafe {
            let __this: *mut Self = self as *mut Self;
            {
                <ACE_Condition_ACE_Recursive_Thread_Mutex_>::remove(
                    (__this) as *mut ACE_Condition_ACE_Recursive_Thread_Mutex_,
                );
            }
            ()
        }
...
#[export_name = "__acedtor_ua68d1e0a798a2aed"]
pub unsafe extern "C-unwind" fn __acedtor_ua68d1e0a798a2aed(
    __this: *mut ACE_Condition_ACE_Recursive_Thread_Mutex_,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[export_name = "_ZN13ACE_ConditionI26ACE_Recursive_Thread_MutexE6removeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_ConditionI26ACE_Recursive_Thread_MutexE6removeEv(
    __this: *mut ACE_Condition_ACE_Recursive_Thread_Mutex_,
) -> libc::c_int {
    unsafe { ACE_Condition_ACE_Recursive_Thread_Mutex_::remove(__this) }
}
#[export_name = "_ZN13ACE_ConditionI26ACE_Recursive_Thread_MutexE4waitEPK14ACE_Time_Value"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_ConditionI26ACE_Recursive_Thread_MutexE4waitEPK14ACE_Time_Value(
    __this: *mut ACE_Condition_ACE_Recursive_Thread_Mutex_,
    abstime: *const ACE_Time_Value,
) -> libc::c_int {
    unsafe { ACE_Condition_ACE_Recursive_Thread_Mutex_::wait(__this, abstime) }
}
#[export_name = "_ZN13ACE_ConditionI26ACE_Recursive_Thread_MutexE4waitERS0_PK14ACE_Time_Value"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_ConditionI26ACE_Recursive_Thread_MutexE4waitERS0_PK14ACE_Time_Value(
    __this: *mut ACE_Condition_ACE_Recursive_Thread_Mutex_,
    mutex: *mut ACE_Recursive_Thread_Mutex,
    abstime: *const ACE_Time_Value,
) -> libc::c_int {
    unsafe {
        ACE_Condition_ACE_Recursive_Thread_Mutex_::wait_ub6118b8118c6280d(
            __this,
            mutex,
            abstime,
        )
...
#[export_name = "_ZN13ACE_ConditionI26ACE_Recursive_Thread_MutexE6signalEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_ConditionI26ACE_Recursive_Thread_MutexE6signalEv(
    __this: *mut ACE_Condition_ACE_Recursive_Thread_Mutex_,
) -> libc::c_int {
    unsafe { ACE_Condition_ACE_Recursive_Thread_Mutex_::signal(__this) }
}
#[export_name = "_ZN13ACE_ConditionI26ACE_Recursive_Thread_MutexE9broadcastEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_ConditionI26ACE_Recursive_Thread_MutexE9broadcastEv(
    __this: *mut ACE_Condition_ACE_Recursive_Thread_Mutex_,
) -> libc::c_int {
    unsafe { ACE_Condition_ACE_Recursive_Thread_Mutex_::broadcast(__this) }
}
#[export_name = "_ZN13ACE_ConditionI26ACE_Recursive_Thread_MutexE5mutexEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_ConditionI26ACE_Recursive_Thread_MutexE5mutexEv(
    __this: *mut ACE_Condition_ACE_Recursive_Thread_Mutex_,
) -> *mut ACE_Recursive_Thread_Mutex {
    unsafe { ACE_Condition_ACE_Recursive_Thread_Mutex_::mutex(__this) }
}
#[export_name = "_ZNK13ACE_ConditionI26ACE_Recursive_Thread_MutexE4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_ConditionI26ACE_Recursive_Thread_MutexE4dumpEv(
    __this: *const ACE_Condition_ACE_Recursive_Thread_Mutex_,
) {
    unsafe { ACE_Condition_ACE_Recursive_Thread_Mutex_::dump(__this) }
}
extern "C-unwind" {
...
impl ACE_Condition_ACE_Recursive_Thread_Mutex_ {
    ///Initialize the condition variable with a recursive mutex.
    pub unsafe fn new_at(__this: *mut Self, mut m: *mut ACE_Recursive_Thread_Mutex) {
        unsafe {
            ::core::ptr::write(
                __this,
                ::core::mem::MaybeUninit::<Self>::zeroed().assume_init(),
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).mutex_),
                ::core::ptr::addr_of_mut!((* m)),
            );
            {
                if (((((ACE_OS::cond_init_ue107a1ce456396d5(
                    ::core::ptr::addr_of_mut!((* __this).cond_) as *mut pthread_cond_t,
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/Condition_Recursive_Thread_Mutex.cpp\0"
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        b"ACE_Condition<ACE_Recursive_Thread_Mutex>::ACE_Condition<ACE_Recursive_Thread_Mutex>\0"
    ...
    pub unsafe fn new(mut __a0: *mut ACE_Recursive_Thread_Mutex) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    ///Initialize the condition variable.
    pub unsafe fn new_at_u0a3a2d808c3849e9(
        __this: *mut Self,
        mut m: *mut ACE_Recursive_Thread_Mutex,
        mut attributes: *const ACE_Condition_Attributes,
    ) {
        unsafe {
            ::core::ptr::write(
                __this,
            ...
            );
            {
                if (((((ACE_OS::cond_init(
                    ...
                    )) as *const pthread_condattr_t) as *mut pthread_condattr_t),
                    ((0) as *const libc::c_char),
                    ((0) as *mut libc::c_void),
                ) as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
    ...
    pub unsafe fn new_u0a3a2d808c3849e9(
        mut __a0: *mut ACE_Recursive_Thread_Mutex,
        mut __a1: *const ACE_Condition_Attributes,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_u0a3a2d808c3849e9(::core::ptr::addr_of_mut!(__obj), __a0, __a1);
        __obj
    }
    ...
    pub unsafe fn wait(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return <ACE_Condition_ACE_Recursive_Thread_Mutex_>::wait_ub6118b8118c6280d(
                    (__this) as *mut ACE_Condition_ACE_Recursive_Thread_Mutex_,
                    ::core::ptr::addr_of_mut!((* (* __this).mutex_)),
                    abstime,
                );
    ...
    pub unsafe fn wait_ub6118b8118c6280d(
        __this: *mut Self,
        mut mutex: *mut ACE_Recursive_Thread_Mutex,
        mut abstime: *const ACE_Time_Value,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut mutex_state_holder: libc::c_int = unsafe {
                    ::core::mem::zeroed()
                };
                let mut recursive_mutex: *mut pthread_mutex_t = &mut ((*<ACE_Recursive_Thread_Mutex>::lock(
                    (::core::ptr::addr_of_mut!((* mutex)))
                        as *mut ACE_Recursive_Thread_Mutex,
                )));
                if (((((ACE_OS::recursive_mutex_cond_unlock(
                    ::core::ptr::addr_of_mut!((* recursive_mutex))
                        as *mut pthread_mutex_t,
                    ::core::ptr::addr_of_mut!(mutex_state_holder),
                ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    return (-((1) as libc::c_int));
                }
                let mut result: libc::c_int = ((if (((((abstime).is_null())
                    as libc::c_int) as libc::c_int) != 0)
                {
                    ACE_OS::cond_wait(
                        ...
                        (((<ACE_Recursive_Thread_Mutex>::get_nesting_mutex(
                            (::core::ptr::addr_of_mut!((* mutex)))
                                as *mut ACE_Recursive_Thread_Mutex,
                        )) as *mut pthread_mutex_t) as *mut pthread_mutex_t),
                    )
                } else {
                ...
                }) as libc::c_int);
                {
                    ...
                    ACE_OS::recursive_mutex_cond_relock(
                        ::core::ptr::addr_of_mut!((* recursive_mutex))
                            as *mut pthread_mutex_t,
                        ::core::ptr::addr_of_mut!(mutex_state_holder),
                    );
    ...
    pub unsafe fn mutex(__this: *mut Self) -> *mut ACE_Recursive_Thread_Mutex {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
    ...
    pub unsafe fn operator_assign(
        __this: *mut Self,
        mut _anon_0: *const ACE_Condition_ACE_Recursive_Thread_Mutex_,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN13ACE_ConditionI26ACE_Recursive_Thread_MutexEaSERKS1_"]
            fn __ext(
                __this: *mut ACE_Condition_ACE_Recursive_Thread_Mutex_,
                _anon_0: *const ACE_Condition_ACE_Recursive_Thread_Mutex_,
            );
        }
        __ext(__this as *mut ACE_Condition_ACE_Recursive_Thread_Mutex_, _anon_0)
    }
    pub unsafe fn new_at_u0d3ad32a576b2def(
        __this: *mut Self,
        mut __a0: *const ACE_Condition_ACE_Recursive_Thread_Mutex_,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN13ACE_ConditionI26ACE_Recursive_Thread_MutexEC1ERKS1_"]
            fn __ext(
                __this: *mut ACE_Condition_ACE_Recursive_Thread_Mutex_,
                __a0: *const ACE_Condition_ACE_Recursive_Thread_Mutex_,
            );
        }
        __ext(__this as *mut ACE_Condition_ACE_Recursive_Thread_Mutex_, __a0)
    }
    pub unsafe fn new_u0d3ad32a576b2def(
        mut __a0: *const ACE_Condition_ACE_Recursive_Thread_Mutex_,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_u0d3ad32a576b2def(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
}
