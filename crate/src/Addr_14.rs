...
#[no_mangle]
pub static mut ACE_Addr_sap_any: ACE_Addr = unsafe {
    ::core::mem::MaybeUninit::<ACE_Addr>::zeroed().assume_init()
};
#[export_name = "_ZN8ACE_AddrC1Eii"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_AddrC1Eii(
    __this: *mut ACE_Addr,
    __a0: libc::c_int,
    __a1: libc::c_int,
) {
    ACE_Addr::new_at(__this, __a0, __a1)
}
#[export_name = "_ZNK8ACE_Addr8get_addrEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK8ACE_Addr8get_addrEv(
    __this: *const ACE_Addr,
) -> *mut libc::c_void {
    unsafe { ACE_Addr::get_addr(__this) }
}
#[export_name = "_ZN8ACE_Addr8set_addrEPKvi"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_Addr8set_addrEPKvi(
    __this: *mut ACE_Addr,
    _anon_0: *const libc::c_void,
    _anon_1: libc::c_int,
) {
    unsafe { ACE_Addr::set_addr(__this, _anon_0, _anon_1) }
}
#[export_name = "_ZN8ACE_Addr8base_setEii"]
pub unsafe extern "C-unwind" fn __xtu__ZN8ACE_Addr8base_setEii(
    __this: *mut ACE_Addr,
    r#type: libc::c_int,
    size: libc::c_int,
) {
    unsafe { ACE_Addr::base_set(__this, r#type, size) }
}
#[export_name = "_ZNK8ACE_Addr4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK8ACE_Addr4dumpEv(__this: *const ACE_Addr) {
    unsafe { ACE_Addr::dump(__this) }
}
extern "C-unwind" {
...
unsafe extern "C-unwind" fn __rt_static_init() {
    ::core::ptr::write(
        ::core::ptr::addr_of_mut!(ACE_Addr_sap_any),
        <ACE_Addr>::new(((-((1) as libc::c_int))), (-((1) as libc::c_int))),
    );
}
#[used]
