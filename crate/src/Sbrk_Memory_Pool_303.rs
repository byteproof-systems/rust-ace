...
#[doc = "* @class ACE_Sbrk_Memory_Pool\n *\n * @brief Make a memory pool that is based on <sbrk(2)>."]
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Sbrk_Memory_Pool {
    pub vptr: *const (),
}
#[export_name = "_ZN20ACE_Sbrk_Memory_PoolC1EPKcPK28ACE_Sbrk_Memory_Pool_Options"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Sbrk_Memory_PoolC1EPKcPK28ACE_Sbrk_Memory_Pool_Options(
    __this: *mut ACE_Sbrk_Memory_Pool,
    __a0: *const libc::c_char,
    __a1: *const ACE_Sbrk_Memory_Pool_Options,
) {
    ACE_Sbrk_Memory_Pool::new_at(__this, __a0, __a1)
}
impl Drop for ACE_Sbrk_Memory_Pool {
    fn drop(&mut self) {
        unsafe {
            let __this: *mut Self = self as *mut Self;
            {}
...
#[export_name = "_ZN20ACE_Sbrk_Memory_Pool12init_acquireEmRmRi"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Sbrk_Memory_Pool12init_acquireEmRmRi(
    __this: *mut ACE_Sbrk_Memory_Pool,
    nbytes: libc::c_ulong,
    ...
    unsafe {
        ACE_Sbrk_Memory_Pool::init_acquire(__this, nbytes, rounded_bytes, first_time)
    }
}
#[export_name = "_ZN20ACE_Sbrk_Memory_Pool7acquireEmRm"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Sbrk_Memory_Pool7acquireEmRm(
    __this: *mut ACE_Sbrk_Memory_Pool,
    nbytes: libc::c_ulong,
    rounded_bytes: *mut libc::c_ulong,
) -> *mut libc::c_void {
    unsafe { ACE_Sbrk_Memory_Pool::acquire(__this, nbytes, rounded_bytes) }
}
#[export_name = "_ZN20ACE_Sbrk_Memory_Pool7releaseEi"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Sbrk_Memory_Pool7releaseEi(
    __this: *mut ACE_Sbrk_Memory_Pool,
    _anon_0: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_Sbrk_Memory_Pool::release(__this, _anon_0) }
}
#[export_name = "_ZN20ACE_Sbrk_Memory_Pool4syncEli"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Sbrk_Memory_Pool4syncEli(
    __this: *mut ACE_Sbrk_Memory_Pool,
    _anon_0: libc::c_long,
    _anon_1: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_Sbrk_Memory_Pool::sync(__this, _anon_0, _anon_1) }
}
#[export_name = "_ZN20ACE_Sbrk_Memory_Pool4syncEPvmi"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Sbrk_Memory_Pool4syncEPvmi(
    __this: *mut ACE_Sbrk_Memory_Pool,
    _anon_0: *mut libc::c_void,
    _anon_1: libc::c_ulong,
    _anon_2: libc::c_int,
    ...
    unsafe {
        ACE_Sbrk_Memory_Pool::sync_u6515f41f276be67e(__this, _anon_0, _anon_1, _anon_2)
    }
}
#[export_name = "_ZN20ACE_Sbrk_Memory_Pool7protectEli"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Sbrk_Memory_Pool7protectEli(
    __this: *mut ACE_Sbrk_Memory_Pool,
    _anon_0: libc::c_long,
    _anon_1: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_Sbrk_Memory_Pool::protect(__this, _anon_0, _anon_1) }
}
#[export_name = "_ZN20ACE_Sbrk_Memory_Pool7protectEPvmi"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Sbrk_Memory_Pool7protectEPvmi(
    __this: *mut ACE_Sbrk_Memory_Pool,
    _anon_0: *mut libc::c_void,
    _anon_1: libc::c_ulong,
    _anon_2: libc::c_int,
    ...
    unsafe {
        ACE_Sbrk_Memory_Pool::protect_ub625a82af7357126(
            __this,
            _anon_0,
            _anon_1,
            _anon_2,
...
#[export_name = "_ZNK20ACE_Sbrk_Memory_Pool4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK20ACE_Sbrk_Memory_Pool4dumpEv(
    __this: *const ACE_Sbrk_Memory_Pool,
) {
    unsafe { ACE_Sbrk_Memory_Pool::dump(__this) }
}
#[export_name = "_ZNK20ACE_Sbrk_Memory_Pool9base_addrEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK20ACE_Sbrk_Memory_Pool9base_addrEv(
    __this: *const ACE_Sbrk_Memory_Pool,
) -> *mut libc::c_void {
    unsafe { ACE_Sbrk_Memory_Pool::base_addr(__this) }
}
#[export_name = "_ZN20ACE_Sbrk_Memory_Pool8round_upEm"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Sbrk_Memory_Pool8round_upEm(
    __this: *mut ACE_Sbrk_Memory_Pool,
    nbytes: libc::c_ulong,
) -> libc::c_ulong {
    unsafe { ACE_Sbrk_Memory_Pool::round_up(__this, nbytes) }
}
...
impl ACE_Sbrk_Memory_Pool {
    ///Initialize the pool.
    pub unsafe fn new_at(
        __this: *mut Self,
        mut _anon_0: *const libc::c_char,
        mut _anon_1: *const ACE_Sbrk_Memory_Pool_Options,
    ) {
        unsafe {
            ::core::ptr::write(
                __this,
            ...
            *(__this as *mut *const ()) = &__VTBL_u89fcb126a921c460
                as *const __Vtbl_u89fcb126a921c460 as *const ();
            {}
            ()
        }
    }
    pub unsafe fn new(
        ...
        mut __a1: *const ACE_Sbrk_Memory_Pool_Options,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
    ...
    pub unsafe fn init_acquire(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                (*first_time) = 1;
                return {
                    let __obj: *mut ACE_Sbrk_Memory_Pool = (__this)
                        as *mut ACE_Sbrk_Memory_Pool;
                    let __vt: *const __Vtbl_u89fcb126a921c460 = *(__obj
                        as *const *const __Vtbl_u89fcb126a921c460);
                    ((*__vt)
                        .vfn_ucee62e80650564fd)(
                        __obj,
                        nbytes,
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                (*rounded_bytes) = {
                    ...
                    let __vt: *const __Vtbl_u89fcb126a921c460 = *(__obj
                        as *const *const __Vtbl_u89fcb126a921c460);
                    ((*__vt).vfn_ub75ca6286b5b84c6)(__obj, nbytes)
                };
                let mut cp: *mut libc::c_void = ACE_OS::sbrk_u1c803ce7ca4578c0(
                    (((*rounded_bytes)) as libc::c_long),
                );
                if ((((((cp) as *const u8))
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/Sbrk_Memory_Pool.cpp\0"
  ...
  /// starting at @a addr.*/
    pub unsafe fn sync_u6515f41f276be67e(
        __this: *mut Self,
  ...
  /// starting at @a addr up to @a len bytes.*/
    pub unsafe fn protect_ub625a82af7357126(
        __this: *mut Self,
        mut _anon_0: *mut libc::c_void,
        mut _anon_1: libc::c_ulong,
        mut _anon_2: libc::c_int,
...
pub unsafe fn __vdtor_u89fcb126a921c460(__this: *mut ACE_Sbrk_Memory_Pool) {
    let _ = Box::from_raw(__this as *mut ACE_Sbrk_Memory_Pool);
}
pub unsafe fn __vthunk_ou483f092422ba9756_iu483f092422ba9756(
    __this: *mut ACE_Sbrk_Memory_Pool,
    p0: libc::c_ulong,
    p1: *mut libc::c_ulong,
    p2: *mut libc::c_int,
) -> *mut libc::c_void {
    <ACE_Sbrk_Memory_Pool>::init_acquire(
        (__this as *mut ACE_Sbrk_Memory_Pool),
        p0,
        p1,
        p2,
    )
}
pub unsafe fn __vthunk_oucee62e80650564fd_iucee62e80650564fd(
    __this: *mut ACE_Sbrk_Memory_Pool,
    p0: libc::c_ulong,
    p1: *mut libc::c_ulong,
) -> *mut libc::c_void {
    <ACE_Sbrk_Memory_Pool>::acquire((__this as *mut ACE_Sbrk_Memory_Pool), p0, p1)
}
pub unsafe fn __vthunk_ou9a525b354e3066d4_iu9a525b354e3066d4(
    __this: *mut ACE_Sbrk_Memory_Pool,
    p0: libc::c_int,
) -> libc::c_int {
    <ACE_Sbrk_Memory_Pool>::release((__this as *mut ACE_Sbrk_Memory_Pool), p0)
}
pub unsafe fn __vthunk_ou386d489ad102a657_iu386d489ad102a657(
    __this: *mut ACE_Sbrk_Memory_Pool,
    p0: libc::c_long,
    p1: libc::c_int,
) -> libc::c_int {
    <ACE_Sbrk_Memory_Pool>::sync((__this as *mut ACE_Sbrk_Memory_Pool), p0, p1)
}
pub unsafe fn __vthunk_ou6515f41f276be67e_iu6515f41f276be67e(
    __this: *mut ACE_Sbrk_Memory_Pool,
    p0: *mut libc::c_void,
    p1: libc::c_ulong,
    p2: libc::c_int,
) -> libc::c_int {
    <ACE_Sbrk_Memory_Pool>::sync_u6515f41f276be67e(
        (__this as *mut ACE_Sbrk_Memory_Pool),
        p0,
        p1,
        p2,
...
pub unsafe fn __vthunk_ou70a1b8f90c3846bf_iu70a1b8f90c3846bf(
    __this: *mut ACE_Sbrk_Memory_Pool,
    p0: libc::c_long,
    p1: libc::c_int,
) -> libc::c_int {
    <ACE_Sbrk_Memory_Pool>::protect((__this as *mut ACE_Sbrk_Memory_Pool), p0, p1)
}
pub unsafe fn __vthunk_oub625a82af7357126_iub625a82af7357126(
    __this: *mut ACE_Sbrk_Memory_Pool,
    p0: *mut libc::c_void,
    p1: libc::c_ulong,
    p2: libc::c_int,
...
pub unsafe fn __vthunk_ou1a7843b422db0bb4_iu1a7843b422db0bb4(
    __this: *mut ACE_Sbrk_Memory_Pool,
) {
    <ACE_Sbrk_Memory_Pool>::dump((__this as *mut ACE_Sbrk_Memory_Pool))
}
pub unsafe fn __vthunk_ou4b3100ccc008e3a7_iu4b3100ccc008e3a7(
    __this: *mut ACE_Sbrk_Memory_Pool,
) -> *mut libc::c_void {
    <ACE_Sbrk_Memory_Pool>::base_addr((__this as *mut ACE_Sbrk_Memory_Pool))
}
pub unsafe fn __vthunk_oub75ca6286b5b84c6_iub75ca6286b5b84c6(
    __this: *mut ACE_Sbrk_Memory_Pool,
    p0: libc::c_ulong,
) -> libc::c_ulong {
    <ACE_Sbrk_Memory_Pool>::round_up((__this as *mut ACE_Sbrk_Memory_Pool), p0)
}
#[repr(C)]
pub struct __Vtbl_u89fcb126a921c460 {
    pub __type_info: &'static crate::__cxx_std::TypeInfo,
    pub __vdtor: unsafe fn(*mut ACE_Sbrk_Memory_Pool),
    pub vfn_u483f092422ba9756: unsafe fn(
        *mut ACE_Sbrk_Memory_Pool,
        libc::c_ulong,
        *mut libc::c_ulong,
        *mut libc::c_int,
    ) -> *mut libc::c_void,
    pub vfn_ucee62e80650564fd: unsafe fn(
        *mut ACE_Sbrk_Memory_Pool,
        libc::c_ulong,
        *mut libc::c_ulong,
    ) -> *mut libc::c_void,
    pub vfn_u9a525b354e3066d4: unsafe fn(
        *mut ACE_Sbrk_Memory_Pool,
        libc::c_int,
    ) -> libc::c_int,
    pub vfn_u386d489ad102a657: unsafe fn(
        *mut ACE_Sbrk_Memory_Pool,
        libc::c_long,
        libc::c_int,
    ) -> libc::c_int,
    pub vfn_u6515f41f276be67e: unsafe fn(
        *mut ACE_Sbrk_Memory_Pool,
        *mut libc::c_void,
        libc::c_ulong,
        libc::c_int,
    ) -> libc::c_int,
    pub vfn_u70a1b8f90c3846bf: unsafe fn(
        *mut ACE_Sbrk_Memory_Pool,
        libc::c_long,
        libc::c_int,
    ) -> libc::c_int,
    pub vfn_ub625a82af7357126: unsafe fn(
        *mut ACE_Sbrk_Memory_Pool,
        *mut libc::c_void,
        libc::c_ulong,
        libc::c_int,
    ) -> libc::c_int,
    pub vfn_u1a7843b422db0bb4: unsafe fn(*mut ACE_Sbrk_Memory_Pool),
    pub vfn_u4b3100ccc008e3a7: unsafe fn(*mut ACE_Sbrk_Memory_Pool) -> *mut libc::c_void,
    pub vfn_ub75ca6286b5b84c6: unsafe fn(
        *mut ACE_Sbrk_Memory_Pool,
        libc::c_ulong,
    ) -> libc::c_ulong,
}
pub static __VTBL_u89fcb126a921c460: __Vtbl_u89fcb126a921c460 = __Vtbl_u89fcb126a921c460 {
    __type_info: &__TYPEINFO_20ACE_Sbrk_Memory_Pool,
    __vdtor: __vdtor_u89fcb126a921c460,
    vfn_u483f092422ba9756: __vthunk_ou483f092422ba9756_iu483f092422ba9756,
    vfn_ucee62e80650564fd: __vthunk_oucee62e80650564fd_iucee62e80650564fd,
    vfn_u9a525b354e3066d4: __vthunk_ou9a525b354e3066d4_iu9a525b354e3066d4,
    vfn_u386d489ad102a657: __vthunk_ou386d489ad102a657_iu386d489ad102a657,
    vfn_u6515f41f276be67e: __vthunk_ou6515f41f276be67e_iu6515f41f276be67e,
    vfn_u70a1b8f90c3846bf: __vthunk_ou70a1b8f90c3846bf_iu70a1b8f90c3846bf,
    vfn_ub625a82af7357126: __vthunk_oub625a82af7357126_iub625a82af7357126,
    vfn_u1a7843b422db0bb4: __vthunk_ou1a7843b422db0bb4_iu1a7843b422db0bb4,
    vfn_u4b3100ccc008e3a7: __vthunk_ou4b3100ccc008e3a7_iu4b3100ccc008e3a7,
    vfn_ub75ca6286b5b84c6: __vthunk_oub75ca6286b5b84c6_iub75ca6286b5b84c6,
};
