...
#[doc = "* @class ACE_Read_Buffer\n *\n * @brief Efficiently reads an arbitrarily large buffer from an input\n * stream up to and including a termination character.  Also\n * performs search/replace on single occurrences a character in\n * the buffer using the principles of Integrated Layer\n * Processing.\n *\n * This implementation is optimized to do a single dynamic\n * allocation and make only one copy of the data. It uses\n * recursion and the run-time stack to accomplish this\n * efficiently."]
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Read_Buffer {
    pub size_: libc::c_ulong,
    pub occurrences_: libc::c_ulong,
    pub stream_: *mut _IO_FILE,
    pub close_on_delete_: bool,
    pub allocator_: *mut ACE_Allocator,
}
#[export_name = "_ZN15ACE_Read_BufferC1EP8_IO_FILEbP13ACE_Allocator"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Read_BufferC1EP8_IO_FILEbP13ACE_Allocator(
    __this: *mut ACE_Read_Buffer,
    __a0: *mut _IO_FILE,
    __a1: bool,
    __a2: *mut ACE_Allocator,
) {
    ACE_Read_Buffer::new_at(__this, __a0, __a1, __a2)
}
#[export_name = "_ZN15ACE_Read_BufferC1EibP13ACE_Allocator"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Read_BufferC1EibP13ACE_Allocator(
    __this: *mut ACE_Read_Buffer,
    __a0: libc::c_int,
    __a1: bool,
    __a2: *mut ACE_Allocator,
) {
    ACE_Read_Buffer::new_at_u4d44ef913f160f94(__this, __a0, __a1, __a2)
}
impl Drop for ACE_Read_Buffer {
    fn drop(&mut self) {
        unsafe {
            let __this: *mut Self = self as *mut Self;
            {
                if (((*__this).close_on_delete_ as libc::c_int) != 0) {
                    ACE_OS::fclose_u07d30b70956bcb1f((*__this).stream_);
                }
            }
            ()
        }
...
#[export_name = "__acedtor_u9ba3f6cf3bfeace2"]
pub unsafe extern "C-unwind" fn __acedtor_u9ba3f6cf3bfeace2(
    __this: *mut ACE_Read_Buffer,
) {
    unsafe {
...
#[export_name = "_ZN15ACE_Read_Buffer4readEiii"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Read_Buffer4readEiii(
    __this: *mut ACE_Read_Buffer,
    term: libc::c_int,
    search: libc::c_int,
    replace: libc::c_int,
) -> *mut libc::c_char {
    unsafe { ACE_Read_Buffer::read(__this, term, search, replace) }
}
#[export_name = "_ZNK15ACE_Read_Buffer4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK15ACE_Read_Buffer4dumpEv(
    __this: *const ACE_Read_Buffer,
) {
    unsafe { ACE_Read_Buffer::dump(__this) }
}
#[export_name = "_ZN15ACE_Read_Buffer8rec_readEiii"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Read_Buffer8rec_readEiii(
    __this: *mut ACE_Read_Buffer,
    term: libc::c_int,
    search: libc::c_int,
    replace: libc::c_int,
) -> *mut libc::c_char {
    unsafe { ACE_Read_Buffer::rec_read(__this, term, search, replace) }
}
...
impl ACE_Read_Buffer {
    ///Read from a FILE *.
    pub unsafe fn new_at(
        __this: *mut Self,
        mut fp: *mut _IO_FILE,
        mut close_on_delete: bool,
        ...
        unsafe {
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).occurrences_),
                ((0) as libc::c_ulong),
            );
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).stream_), fp);
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).close_on_delete_),
                ((close_on_delete) as bool),
            );
    ...
    pub unsafe fn new_at_u4d44ef913f160f94(
        __this: *mut Self,
        ...
        unsafe {
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).stream_),
                ACE_OS::fdopen_u3da0f96d0ebfd1da(
                    handle,
    ...
    pub unsafe fn new_u4d44ef913f160f94(
        mut __a0: libc::c_int,
        mut __a1: bool,
        mut __a2: *mut ACE_Allocator,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_u4d44ef913f160f94(
    ...
    pub unsafe fn read(
        ...
        unsafe {
            ...
            {
                (*__this).occurrences_ = ((0) as libc::c_ulong);
                (*__this).size_ = ((0) as libc::c_ulong);
                return <ACE_Read_Buffer>::rec_read(
                    (__this) as *mut ACE_Read_Buffer,
                    term,
                    search,
                    replace,
                );
    ...
    pub unsafe fn replaced(__this: *const Self) -> libc::c_ulong {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((*__this).occurrences_) as libc::c_ulong);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
  ...
  /// @c read, not including the null terminator.*/
    ...
    pub unsafe fn alloc(__this: *const Self) -> *mut ACE_Allocator {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((*__this).allocator_) as *mut ACE_Allocator);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    ...
    pub unsafe fn operator_assign(
        __this: *mut Self,
        mut _anon_0: *const ACE_Read_Buffer,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_Read_BufferaSERKS_"]
            fn __ext(__this: *mut ACE_Read_Buffer, _anon_0: *const ACE_Read_Buffer);
        }
        __ext(__this as *mut ACE_Read_Buffer, _anon_0)
    }
    pub unsafe fn new_at_u4718dc774a116700(
        __this: *mut Self,
        mut __a0: *const ACE_Read_Buffer,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN15ACE_Read_BufferC1ERKS_"]
            fn __ext(__this: *mut ACE_Read_Buffer, __a0: *const ACE_Read_Buffer);
        }
        __ext(__this as *mut ACE_Read_Buffer, __a0)
    }
    pub unsafe fn new_u4718dc774a116700(mut __a0: *const ACE_Read_Buffer) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_u4718dc774a116700(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    ///Recursive helper method that does the work...
    pub unsafe fn rec_read(
        __this: *mut Self,
        mut term: libc::c_int,
        mut search: libc::c_int,
        mut replace: libc::c_int,
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                let mut slot: libc::c_ulong = ((0) as libc::c_ulong);
                let mut done: libc::c_int = 0;
                'while_0: loop {
                    if !((((((slot as libc::c_ulong)) < (((8192) as libc::c_ulong)))
                    ...
                    'cont_0: loop {
                        {
                            {
                                c = ACE_OS::getc_u4951814d41ae1ebe((*__this).stream_);
                                if (((((c as libc::c_int))
                                    == (((((-((1) as libc::c_int)))) as libc::c_int)))
                                    as libc::c_int as libc::c_int) != 0)
                                {
                                    ACE_OS::ungetc_u60080a2bf4a1a7a7(c, (*__this).stream_);
                                    break 'while_0;
                                } else {
                                    if (((((c as libc::c_int)) == (((term) as libc::c_int)))
                                        as libc::c_int as libc::c_int) != 0)
                                    {
                                        done = 1;
                                    }
                                }
                                if (((((c as libc::c_int)) == (((search) as libc::c_int)))
                                    as libc::c_int as libc::c_int) != 0)
                                {
                                    {
                                        let __lv = &mut ((*__this).occurrences_);
                                        *__lv = (*__lv).wrapping_add(1);
                                        *__lv
                                    };
                                    if (((((replace as libc::c_int)) >= (((0) as libc::c_int)))
                                        as libc::c_int as libc::c_int) != 0)
                                    {
                                        c = replace;
                                    }
                ...
                }
                {
                    ...
                    unsafe {
                        *__lv = ((((*__lv)) as libc::c_ulong))
                            .wrapping_add((slot) as libc::c_ulong);
                        *__lv
                    }
                };
                if ((((((*__this).size_ as libc::c_ulong)) == (((0) as libc::c_ulong)))
                    as libc::c_int as libc::c_int) != 0)
                {
                        ...
                        as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
                {
                    ...
                    {
                        result = (result).wrapping_offset(((*__this).size_) as isize);
                        result
                    };
                    (*(result)) = 0 as libc::c_char;
                } else {
                    if (((((({
                        let __v = <ACE_Read_Buffer>::rec_read(
                            (__this) as *mut ACE_Read_Buffer,
                            term,
                            search,
                            replace,
                ...
                {
                    let mut j: libc::c_ulong = slot;
                    'for_1: loop {
                        if !((((((j as libc::c_ulong)) > (((0) as libc::c_ulong)))
                            as libc::c_int as libc::c_int) != 0))
                        {
                            break;
                        }
                        'cont_1: loop {
                            {
                                (*({
                                    ...
                                    *__lv
                                })) = (buf)[((((j) as libc::c_ulong))
                                    .wrapping_sub((1) as libc::c_ulong)) as usize];
                            }
