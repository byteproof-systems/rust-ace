...
#[export_name = "_ZN16ACE_Noop_CommandC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_Noop_CommandC1Ev(
    __this: *mut ACE_Noop_Command,
) {
    ACE_Noop_Command::new_at(__this)
}
#[export_name = "_ZN16ACE_Noop_Command7executeEPv"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_Noop_Command7executeEPv(
    __this: *mut ACE_Noop_Command,
    _anon_0: *mut libc::c_void,
) -> libc::c_int {
    unsafe { ACE_Noop_Command::execute(__this, _anon_0) }
}
extern "C" {
