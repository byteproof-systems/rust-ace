...
pub mod ACE_OS {
    ...
    #[export_name = "_ZN6ACE_OS13getmacaddressEPNS_14macaddr_node_tE"]
    pub unsafe extern "C-unwind" fn getmacaddress(
        mut node: *mut macaddr_node_t,
    ) -> libc::c_int {
        unsafe {
            {
                let mut ifap: *mut super::ifaddrs = ((0) as *mut super::ifaddrs);
                let mut p_if: *mut super::ifaddrs = ((0) as *mut super::ifaddrs);
                if (((((super::getifaddrs(
                    ::core::ptr::addr_of_mut!(ifap) as *mut *mut super::ifaddrs,
                            ...
                            {
                                {
                                    ...
                                    if ((((((((((((((*p_if).ifa_flags) as libc::c_uint))
                                        ...
                                        as libc::c_int) != 0)
                                        && ((((((((((*p_if).ifa_flags) as libc::c_uint))
                                            & (((((((8 as libc::c_int)) as libc::c_int))
                                                | (((16 as libc::c_int)) as libc::c_int))) as libc::c_uint))
                ...
                if (((((p_if).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    ((*(super::__errno_location()))) = 19;
                    super::freeifaddrs(ifap);
                    return (-((1) as libc::c_int));
                }
                let mut ifr: super::ifreq = unsafe {
                    ::core::mem::MaybeUninit::<super::ifreq>::zeroed().assume_init()
                };
                strcpy_u08e8184bcebbac89(
                    ((ifr.ifr_ifrn.ifrn_name).as_mut_ptr() as *mut libc::c_char),
                    (((*p_if).ifa_name) as *const libc::c_char),
                );
                super::freeifaddrs(ifap);
                let mut handle: libc::c_int = socket_u707bc17eb37e5e24(
                    2,
                ...
                if (((((ioctl_u5ac77b5f0779af02(
                    handle,
                    ((35111) as libc::c_ulong),
                    ((::core::ptr::addr_of_mut!(ifr) as *mut super::ifreq)
                        as *mut libc::c_void),
                ) as libc::c_int)) < (((0) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    close_u07c1eb6343f8c667(handle);
                    return (-((1) as libc::c_int));
                }
                let mut sa: *mut super::sockaddr = (::core::ptr::addr_of_mut!(
                    ifr.ifr_ifru.ifru_addr
                ) as *mut super::sockaddr as *mut super::sockaddr);
                close_u07c1eb6343f8c667(handle);
                memcpy_u6033eb81edaf9212(
                    (((*node).node).as_mut_ptr() as *mut libc::c_void),
                    (((*sa).sa_data).as_ptr() as *const libc::c_void),
                    ((6) as libc::c_ulong),
                );
                return 0;
            }
