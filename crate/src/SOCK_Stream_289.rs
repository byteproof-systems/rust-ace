...
#[export_name = "_ZN15ACE_SOCK_Stream5closeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_SOCK_Stream5closeEv(
    __this: *mut ACE_SOCK_Stream,
) -> libc::c_int {
    unsafe { ACE_SOCK_Stream::close(__this) }
}
#[export_name = "_ZNK15ACE_SOCK_Stream4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK15ACE_SOCK_Stream4dumpEv(
    __this: *const ACE_SOCK_Stream,
) {
    unsafe { ACE_SOCK_Stream::dump(__this) }
}
extern "C-unwind" {
