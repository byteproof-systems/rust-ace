...
#[doc = "* @class ACE_Dynamic_Service_Base\n *\n * @brief Base class for all ACE_Dynamic_Service instantiations.\n *\n * Factors out common code shared by all ACE_Dynamic_Service\n * instantiations, this avoid code bloat."]
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Dynamic_Service_Base {}
#[export_name = "_ZNK24ACE_Dynamic_Service_Base4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK24ACE_Dynamic_Service_Base4dumpEv(
    __this: *const ACE_Dynamic_Service_Base,
) {
    unsafe { ACE_Dynamic_Service_Base::dump(__this) }
}
#[export_name = "_ZN24ACE_Dynamic_Service_Base8instanceEPKcb"]
pub unsafe extern "C-unwind" fn __xtu__ZN24ACE_Dynamic_Service_Base8instanceEPKcb(
    name: *const libc::c_char,
    no_global: bool,
) -> *mut libc::c_void {
    unsafe { ACE_Dynamic_Service_Base::instance(name, no_global) }
}
#[export_name = "_ZN24ACE_Dynamic_Service_Base8instanceEPK19ACE_Service_GestaltPKcb"]
pub unsafe extern "C-unwind" fn __xtu__ZN24ACE_Dynamic_Service_Base8instanceEPK19ACE_Service_GestaltPKcb(
    repo: *const ACE_Service_Gestalt,
    name: *const libc::c_char,
    no_global: bool,
) -> *mut libc::c_void {
    unsafe {
        ACE_Dynamic_Service_Base::instance_uf329c39e96d97084(repo, name, no_global)
    }
}
#[export_name = "_ZN24ACE_Dynamic_Service_Base6find_iERPK19ACE_Service_GestaltPKcb"]
pub unsafe extern "C-unwind" fn __xtu__ZN24ACE_Dynamic_Service_Base6find_iERPK19ACE_Service_GestaltPKcb(
    repo: *mut *const ACE_Service_Gestalt,
    name: *const libc::c_char,
    no_global: bool,
) -> *const ACE_Service_Type {
    unsafe { ACE_Dynamic_Service_Base::find_i(repo, name, no_global) }
}
...
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Guard_ACE_Log_Msg_ {
    pub lock_: *mut ACE_Log_Msg,
    pub owner_: libc::c_int,
}
#[export_name = "_ZN9ACE_GuardI11ACE_Log_MsgEC1EPS0_"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_GuardI11ACE_Log_MsgEC1EPS0_(
    __this: *mut ACE_Guard_ACE_Log_Msg_,
    __a0: *mut ACE_Log_Msg,
) {
    ACE_Guard_ACE_Log_Msg_::new_at_s0ef766c97c094b2b(__this, __a0)
}
#[export_name = "_ZN9ACE_GuardI11ACE_Log_MsgEC1ERS0_"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_GuardI11ACE_Log_MsgEC1ERS0_(
    __this: *mut ACE_Guard_ACE_Log_Msg_,
    __a0: *mut ACE_Log_Msg,
) {
    ACE_Guard_ACE_Log_Msg_::new_at_s0907514047c049ff(__this, __a0)
}
impl Drop for ACE_Guard_ACE_Log_Msg_ {
    fn drop(&mut self) {
        unsafe {
            let __this: *mut Self = self as *mut Self;
            {
                <ACE_Guard_ACE_Log_Msg_>::release(
                    (__this) as *mut ACE_Guard_ACE_Log_Msg_,
                );
            }
            ()
        }
...
#[export_name = "__acedtor_u26fb8523a240b08c"]
pub unsafe extern "C-unwind" fn __acedtor_u26fb8523a240b08c(
    __this: *mut ACE_Guard_ACE_Log_Msg_,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
impl ACE_Dynamic_Service_Base {
  ...
  /// repo.*/
    pub unsafe fn instance(
        ...
        unsafe {
            {
                return <ACE_Dynamic_Service_Base>::instance_uf329c39e96d97084(
                    (<ACE_Service_Config>::current_ud6b3b837e8530981())
                        as *const ACE_Service_Gestalt,
                    name,
                    no_global,
                );
            }
    ...
    pub unsafe fn instance_uf329c39e96d97084(
        mut repo: *const ACE_Service_Gestalt,
        mut name: *const libc::c_char,
        mut no_global: bool,
    ) -> *mut libc::c_void {
        unsafe {
            {
                ...
                let mut r#type: *const ACE_Service_Type_Impl = ((0)
                    as *const ACE_Service_Type_Impl);
                let mut repo_found: *const ACE_Service_Gestalt = repo;
                let mut svc_rec: *const ACE_Service_Type = <ACE_Dynamic_Service_Base>::find_i(
                    ::core::ptr::addr_of_mut!(repo_found),
                    name,
                    no_global,
                );
                if ((((!(svc_rec).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    r#type = <ACE_Service_Type>::r#type(
                        (svc_rec) as *const ACE_Service_Type,
                    );
                    if ((((!(r#type).is_null()) as libc::c_int) as libc::c_int) != 0) {
                        obj = <ACE_Service_Type_Impl>::object(
                            (r#type) as *const ACE_Service_Type_Impl,
                        );
                    }
                }
                if ((ACE::debug() as libc::c_int) != 0) {
                    let mut log_guard: ACE_Guard_ACE_Log_Msg_ = ::core::mem::MaybeUninit::<
                        ACE_Guard_ACE_Log_Msg_,
                    >::zeroed()
                        .assume_init();
                    <ACE_Guard_ACE_Log_Msg_>::new_at_s0907514047c049ff(
                        (::core::ptr::addr_of_mut!(log_guard))
                            as *mut ACE_Guard_ACE_Log_Msg_,
                        <ACE_Log_Msg>::instance(),
                    );
                    if (((((<ACE_Guard_ACE_Log_Msg_>::locked(
                        (::core::ptr::addr_of!(log_guard))
                            as *const ACE_Guard_ACE_Log_Msg_,
                    ) as libc::c_int)) != (((0) as libc::c_int))) as libc::c_int
                        as libc::c_int) != 0)
                    {} else {
                        return ((0) as *mut libc::c_void);
                    };
                    if (((((((*repo).repo_) as *const u8))
                        != ((((*repo_found).repo_) as *const u8))) as libc::c_int
                        as libc::c_int) != 0)
                    {
                        'dowhile_0: loop {
                            'cont_0: loop {
                                {
                                    {
                                        ...
                                        <ACE_Log_Category_TSS>::conditional_set(
                                            ...
                                            ((b"/build/ace_full/src/ACE/ace/Dynamic_Service_Base.cpp\0"
                                        ...
                                        <ACE_Log_Category_TSS>::log(
                                            (ace___) as *mut ACE_Log_Category_TSS,
                                            LM_DEBUG,
                                            ((b"ACE (%P|%t) DSB::instance, repo=%@, name=%s type=%@ => %@ [in repo=%@]\n\0"
                                                .as_ptr() as *const libc::c_char) as *const libc::c_char),
                                            (*repo).repo_,
                                            name,
                                            r#type,
                                ...
                                {
                                    {
                                        ...
                                        <ACE_Log_Category_TSS>::log(
                                            (ace___) as *mut ACE_Log_Category_TSS,
                                            LM_DEBUG,
                                            ((b"ACE (%P|%t) DSB::instance, repo=%@, name=%s type=%@ => %@\n\0"
                                                .as_ptr() as *const libc::c_char) as *const libc::c_char),
                                            (*repo).repo_,
                                            name,
                                            r#type,
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        extern "C-unwind" {
            #[link_name = "_ZN24ACE_Dynamic_Service_BaseC1Ev"]
            fn __ext(__this: *mut ACE_Dynamic_Service_Base);
        }
        __ext(__this as *mut ACE_Dynamic_Service_Base)
    }
    ...
    pub unsafe fn operator_assign(
        __this: *mut Self,
        mut _anon_0: *const ACE_Dynamic_Service_Base,
    ) -> *const ACE_Dynamic_Service_Base {
        extern "C-unwind" {
            #[link_name = "_ZN24ACE_Dynamic_Service_BaseaSERKS_"]
            fn __ext(
                __this: *mut ACE_Dynamic_Service_Base,
                _anon_0: *const ACE_Dynamic_Service_Base,
            ) -> *const ACE_Dynamic_Service_Base;
        }
        __ext(__this as *mut ACE_Dynamic_Service_Base, _anon_0)
    }
    /**Implement the service search policy, i.e. "look for the service first
  /// locally and then globally"*/
    pub unsafe fn find_i(
        mut repo: *mut *const ACE_Service_Gestalt,
        mut name: *const libc::c_char,
        mut no_global: bool,
    ) -> *const ACE_Service_Type {
        unsafe {
            {
                let mut svc_rec: *const ACE_Service_Type = ((0)
                    as *const ACE_Service_Type);
                let mut global: *mut ACE_Service_Gestalt = <ACE_Service_Config>::global();
                {
                    'for_0: loop {
                        if !(((((((((((<ACE_Service_Gestalt>::find(
                            ((*repo)) as *const ACE_Service_Gestalt,
                            ((name) as *const libc::c_char),
                            ::core::ptr::addr_of_mut!(svc_rec)
                                as *mut *const ACE_Service_Type,
                            true,
                        ) as libc::c_int))
                            == ((((-((1) as libc::c_int))) as libc::c_int)))
                            as libc::c_int) as libc::c_int) != 0)
                            && (((!(((no_global as libc::c_int) != 0)) as libc::c_int)
                                as libc::c_int) != 0)) as libc::c_int) as libc::c_int)
                            != 0))
                        {
                            break;
                        ...
                        'cont_0: loop {
                            {
                                {
                                    if (((((((*repo)) as *const u8))
                                        == (((((global) as *const ACE_Service_Gestalt))
                        ...
                        {
                            let __v = (global) as *const ACE_Service_Gestalt;
                            (*repo) = __v;
                            __v
                        };
                    }
...
impl ACE_Guard_ACE_Log_Msg_ {
    /**Implicitly and automatically acquire (or try to acquire) the
  /// lock.  If @a block is non-0 then acquire() the ACE_LOCK, else
  /// tryacquire() it.*/
    pub unsafe fn new_at_s0cc8146b930de506(
        __this: *mut Self,
        mut __a0: *mut ACE_Log_Msg,
        mut __a1: bool,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN9ACE_GuardI11ACE_Log_MsgEC1ERS0_b"]
            fn __ext(
                __this: *mut ACE_Guard_ACE_Log_Msg_,
                __a0: *mut ACE_Log_Msg,
                __a1: bool,
        ...
        __ext(__this as *mut ACE_Guard_ACE_Log_Msg_, __a0, __a1)
    }
    pub unsafe fn new_s0cc8146b930de506(
        mut __a0: *mut ACE_Log_Msg,
        mut __a1: bool,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s0cc8146b930de506(::core::ptr::addr_of_mut!(__obj), __a0, __a1);
        __obj
    }
    /**Initialize the guard without implicitly acquiring the lock. The
  /// @a become_owner parameter indicates whether the guard should release
  ...
  /// ignored and is used here to disambiguate with the preceding
  /// constructor.*/
    pub unsafe fn new_at_sd87b09fc66bc0a63(
        __this: *mut Self,
        mut __a0: *mut ACE_Log_Msg,
        mut __a1: bool,
        mut __a2: libc::c_int,
        ...
        extern "C-unwind" {
            #[link_name = "_ZN9ACE_GuardI11ACE_Log_MsgEC1ERS0_bi"]
            fn __ext(
                __this: *mut ACE_Guard_ACE_Log_Msg_,
                __a0: *mut ACE_Log_Msg,
                __a1: bool,
        ...
        __ext(__this as *mut ACE_Guard_ACE_Log_Msg_, __a0, __a1, __a2)
    }
    pub unsafe fn new_sd87b09fc66bc0a63(
        mut __a0: *mut ACE_Log_Msg,
        mut __a1: bool,
        mut __a2: libc::c_int,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_sd87b09fc66bc0a63(
            ::core::ptr::addr_of_mut!(__obj),
            __a0,
            __a1,
            __a2,
    ...
    pub unsafe fn tryacquire(__this: *mut Self) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN9ACE_GuardI11ACE_Log_MsgE10tryacquireEv"]
            fn __ext(__this: *mut ACE_Guard_ACE_Log_Msg_) -> libc::c_int;
        }
        __ext(__this as *mut ACE_Guard_ACE_Log_Msg_)
    }
    /**Relinquish ownership of the lock so that it is not released
  /// implicitly in the destructor.*/
    pub unsafe fn disown(__this: *mut Self) {
        extern "C-unwind" {
            #[link_name = "_ZN9ACE_GuardI11ACE_Log_MsgE6disownEv"]
            fn __ext(__this: *mut ACE_Guard_ACE_Log_Msg_);
        }
        __ext(__this as *mut ACE_Guard_ACE_Log_Msg_)
    }
    ///Explicitly remove the lock.
    pub unsafe fn remove(__this: *mut Self) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN9ACE_GuardI11ACE_Log_MsgE6removeEv"]
            fn __ext(__this: *mut ACE_Guard_ACE_Log_Msg_) -> libc::c_int;
        }
        __ext(__this as *mut ACE_Guard_ACE_Log_Msg_)
    }
    ...
    pub unsafe fn dump(__this: *const Self) {
        extern "C-unwind" {
            #[link_name = "_ZNK9ACE_GuardI11ACE_Log_MsgE4dumpEv"]
            fn __ext(__this: *const ACE_Guard_ACE_Log_Msg_);
        }
        __ext(__this as *const ACE_Guard_ACE_Log_Msg_)
    }
    ///Helper, meant for subclass only.
    pub unsafe fn new_at_s0ef766c97c094b2b(
        __this: *mut Self,
        mut lock: *mut ACE_Log_Msg,
    ) {
        unsafe {
            ::core::ptr::write(
                __this,
    ...
    pub unsafe fn new_s0ef766c97c094b2b(mut __a0: *mut ACE_Log_Msg) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s0ef766c97c094b2b(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    pub unsafe fn operator_assign(
        __this: *mut Self,
        mut _anon_0: *mut ACE_Guard_ACE_Log_Msg_,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN9ACE_GuardI11ACE_Log_MsgEaSERKS1_"]
            fn __ext(
                __this: *mut ACE_Guard_ACE_Log_Msg_,
                _anon_0: *mut ACE_Guard_ACE_Log_Msg_,
            );
        }
        __ext(__this as *mut ACE_Guard_ACE_Log_Msg_, _anon_0)
    }
    pub unsafe fn new_at_s7ee48fbd817bd123(
        __this: *mut Self,
        mut __a0: *const ACE_Guard_ACE_Log_Msg_,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN9ACE_GuardI11ACE_Log_MsgEC1ERKS1_"]
            fn __ext(
                __this: *mut ACE_Guard_ACE_Log_Msg_,
                __a0: *const ACE_Guard_ACE_Log_Msg_,
            );
        }
        __ext(__this as *mut ACE_Guard_ACE_Log_Msg_, __a0)
    }
    pub unsafe fn new_s7ee48fbd817bd123(
        mut __a0: *const ACE_Guard_ACE_Log_Msg_,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s7ee48fbd817bd123(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    ///Explicitly acquire the lock.
    pub unsafe fn acquire(__this: *mut Self) -> libc::c_int {
        unsafe {
            ...
            {
                return {
                    let __v = <ACE_Log_Msg>::acquire(
                        ((*__this).lock_) as *mut ACE_Log_Msg,
                    );
                    (*__this).owner_ = __v;
                    __v
                };
    ...
    pub unsafe fn new_at_s0907514047c049ff(__this: *mut Self, mut l: *mut ACE_Log_Msg) {
        unsafe {
            ::core::ptr::write(
                __this,
                ::core::mem::MaybeUninit::<Self>::zeroed().assume_init(),
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).lock_),
                ::core::ptr::addr_of_mut!((* l)) as *mut ACE_Log_Msg,
            );
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).owner_), 0);
            {
                <ACE_Guard_ACE_Log_Msg_>::acquire(
                    (__this) as *mut ACE_Guard_ACE_Log_Msg_,
                );
            }
            ()
    ...
    pub unsafe fn new_s0907514047c049ff(mut __a0: *mut ACE_Log_Msg) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_s0907514047c049ff(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    /**true if locked, false if couldn't acquire the lock
  /// (errno will contain the reason for this).*/
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                    ...
                    as libc::c_int) != 0)
                {
                    ...
                    (*__this).owner_ = (-((1) as libc::c_int));
                    return <ACE_Log_Msg>::release(((*__this).lock_) as *mut ACE_Log_Msg);
                }
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
