...
#[doc = "Save multiple samples in an array\n/**\n * Save multiple samples (usually latency numbers), into an array, and\n * later print them in several formats."]
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Sample_History {
    pub max_samples_: libc::c_ulong,
    pub sample_count_: libc::c_ulong,
    pub samples_: *mut libc::c_ulong,
}
#[export_name = "_ZN18ACE_Sample_HistoryC1Em"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_Sample_HistoryC1Em(
    __this: *mut ACE_Sample_History,
    __a0: libc::c_ulong,
) {
    ACE_Sample_History::new_at(__this, __a0)
}
impl Drop for ACE_Sample_History {
    fn drop(&mut self) {
        unsafe {
            let __this: *mut Self = self as *mut Self;
            {
                {
                    let __data = (*__this).samples_ as *mut libc::c_ulong;
                    if !__data.is_null() {
...
#[export_name = "__acedtor_u7358a5f8ecbf65e2"]
pub unsafe extern "C-unwind" fn __acedtor_u7358a5f8ecbf65e2(
    __this: *mut ACE_Sample_History,
) {
    unsafe {
...
#[export_name = "_ZNK18ACE_Sample_History12dump_samplesEPKcj"]
pub unsafe extern "C-unwind" fn __xtu__ZNK18ACE_Sample_History12dump_samplesEPKcj(
    __this: *const ACE_Sample_History,
    msg: *const libc::c_char,
    scale_factor: libc::c_uint,
) {
    unsafe { ACE_Sample_History::dump_samples(__this, msg, scale_factor) }
}
#[export_name = "_ZNK18ACE_Sample_History19collect_basic_statsER15ACE_Basic_Stats"]
pub unsafe extern "C-unwind" fn __xtu__ZNK18ACE_Sample_History19collect_basic_statsER15ACE_Basic_Stats(
    __this: *const ACE_Sample_History,
    stats: *mut ACE_Basic_Stats,
) {
    unsafe { ACE_Sample_History::collect_basic_stats(__this, stats) }
}
extern "C-unwind" {
...
impl ACE_Sample_History {
    #[doc = "Constructor\n  /**\n   * The number of samples is pre-allocated, and cannot changes once\n   * the class is initialized."]
    pub unsafe fn new_at(__this: *mut Self, mut max_samples: libc::c_ulong) {
        unsafe {
            ::core::ptr::write(
                __this,
                ::core::mem::MaybeUninit::<Self>::zeroed().assume_init(),
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).max_samples_),
                max_samples,
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).sample_count_),
                ((0) as libc::c_ulong),
            );
            {
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            {
                                (*__this).samples_ = {
                                    let __count: usize = ((*__this).max_samples_) as usize;
                                    let __nbytes = __count
                                        .checked_mul(::core::mem::size_of::<libc::c_ulong>())
                                    ...
                                    if __data.is_null() {
                                        ::std::alloc::handle_alloc_error(
                                            ::core::alloc::Layout::array::<libc::c_ulong>(__count)
                                                .unwrap(),
                                        );
                                    }
                                ...
                                if ((((((*__this).samples_).is_null()) as libc::c_int)
                                    as libc::c_int) != 0)
                                {
                                    ((*(__errno_location()))) = 12;
                                    return;
    ...
    #[doc = "Record one sample.\n  /**\n   * Return 0 on success, -1 if the sample could not be stored"]
    pub unsafe fn sample(__this: *mut Self, mut value: libc::c_ulong) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((((*__this).sample_count_ as libc::c_ulong))
                    >= ((((*__this).max_samples_) as libc::c_ulong))) as libc::c_int
                    as libc::c_int) != 0)
                {
                ...
                (*((*__this).samples_)
                    .wrapping_offset(
                        ({
                            let __lv = &mut ((*__this).sample_count_);
                            let __r = *__lv;
                            *__lv = (*__lv).wrapping_add(1);
                            __r
                        }) as isize,
    ...
    pub unsafe fn max_samples(__this: *const Self) -> libc::c_ulong {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((*__this).max_samples_) as libc::c_ulong);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    ///Returns the current number of samples
    pub unsafe fn sample_count(__this: *const Self) -> libc::c_ulong {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((*__this).sample_count_) as libc::c_ulong);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    #[doc = "Dump all the samples\n  /**\n   * Prints out all the samples, using @a msg as a prefix for each\n   * message."]
    pub unsafe fn dump_samples(
        __this: *const Self,
        mut msg: *const libc::c_char,
        mut scale_factor: libc::c_uint,
    ) {
            ...
            {
                {
                    ...
                    'for_0: loop {
                        if !((((((i as libc::c_ulong))
                            != ((((*__this).sample_count_) as libc::c_ulong)))
                        ...
                        'cont_0: loop {
                            {
                                {
                                    let mut val: libc::c_ulong = ((((((*((*__this).samples_)
                                        .wrapping_offset((i) as isize))) as libc::c_ulong))
                                        / ((scale_factor) as libc::c_ulong)) as libc::c_ulong);
                                    'dowhile_1: loop {
                                        'cont_1: loop {
                                            {
                                                {
                                                    ...
                                                    <ACE_Log_Category_TSS>::conditional_set(
                                                        ...
                                                        ((b"/build/ace_full/src/ACE/ace/Sample_History.cpp\0"
    ...
    pub unsafe fn collect_basic_stats(
        __this: *const Self,
        mut stats: *mut ACE_Basic_Stats,
    ) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                            ...
                            {
                                {
                                    <ACE_Basic_Stats>::sample(
                                        ...
                                        (*((*__this).samples_).wrapping_offset((i) as isize)),
                                    );
                                }
                            }
                            #[allow(unreachable_code)] break 'cont_0;
    ...
    pub unsafe fn get_sample(
        ...
        unsafe {
            ...
            {
                if ((((((*__this).sample_count_ as libc::c_ulong))
                    <= (((i) as libc::c_ulong))) as libc::c_int as libc::c_int) != 0)
                {
                    return ((0) as libc::c_ulong);
                }
                return (*((*__this).samples_).wrapping_offset((i) as isize));
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
