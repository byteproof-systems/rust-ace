...
#[doc = "A simple class to make throughput and latency analysis.\n/**\n *\n * Keep the relevant information to perform throughput and latency\n * analysis, including:\n * -# Minimum, Average and Maximum latency\n * -# Jitter for the latency\n * -# Linear regression for throughput\n * -# Accumulate results from several samples to obtain aggregated\n *    results, across several threads or experiments.\n *\n * @todo The idea behind this class was to use linear regression to\n *       determine if the throughput was linear or exhibited jitter.\n *       Unfortunately it never worked quite right, so only average\n *       throughput is computed."]
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ACE_Throughput_Stats {
    pub __base_0: ACE_Basic_Stats,
    pub throughput_last_: libc::c_ulong,
}
#[export_name = "_ZN20ACE_Throughput_StatsC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Throughput_StatsC1Ev(
    __this: *mut ACE_Throughput_Stats,
) {
    ACE_Throughput_Stats::new_at(__this)
}
#[export_name = "_ZN20ACE_Throughput_Stats6sampleEmm"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Throughput_Stats6sampleEmm(
    __this: *mut ACE_Throughput_Stats,
    throughput: libc::c_ulong,
    latency: libc::c_ulong,
) {
    unsafe { ACE_Throughput_Stats::sample(__this, throughput, latency) }
}
#[export_name = "_ZN20ACE_Throughput_Stats10accumulateERKS_"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Throughput_Stats10accumulateERKS_(
    __this: *mut ACE_Throughput_Stats,
    rhs: *const ACE_Throughput_Stats,
) {
    unsafe { ACE_Throughput_Stats::accumulate(__this, rhs) }
}
#[export_name = "_ZN20ACE_Throughput_Stats12dump_resultsEPKcj"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Throughput_Stats12dump_resultsEPKcj(
    __this: *mut ACE_Throughput_Stats,
    msg: *const libc::c_char,
    sf: libc::c_uint,
) {
    unsafe { ACE_Throughput_Stats::dump_results(__this, msg, sf) }
}
#[export_name = "_ZN20ACE_Throughput_Stats15dump_throughputEPKcjmj"]
pub unsafe extern "C-unwind" fn __xtu__ZN20ACE_Throughput_Stats15dump_throughputEPKcjmj(
    msg: *const libc::c_char,
    sf: libc::c_uint,
    elapsed_time: libc::c_ulong,
    samples_count: libc::c_uint,
) {
    unsafe {
        ACE_Throughput_Stats::dump_throughput(msg, sf, elapsed_time, samples_count)
    }
}
extern "C-unwind" {
...
impl ACE_Throughput_Stats {
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ...
            <ACE_Basic_Stats>::new_at(
                (::core::ptr::addr_of_mut!((* __this).__base_0)) as *mut ACE_Basic_Stats,
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).throughput_last_),
                ((0) as libc::c_ulong),
            );
            {}
            ()
    ...
    pub unsafe fn sample(
        __this: *mut Self,
        mut throughput: libc::c_ulong,
        mut latency: libc::c_ulong,
    ) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                <ACE_Basic_Stats>::sample(
                    (::core::ptr::addr_of_mut!((* __this).__base_0))
                        as *mut ACE_Basic_Stats,
                    latency,
                );
                if (((((<ACE_Basic_Stats>::samples_count(
                    (::core::ptr::addr_of!((* __this).__base_0))
                        as *const ACE_Basic_Stats,
                ) as libc::c_uint)) == (((1u32) as libc::c_uint))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    (*__this).throughput_last_ = throughput;
                }
            }
            ()
        }
    ...
    pub unsafe fn accumulate(__this: *mut Self, mut rhs: *const ACE_Throughput_Stats) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((((<ACE_Basic_Stats>::samples_count(
                ...
                ) as libc::c_uint)) == (((0u32) as libc::c_uint))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    return;
                }
                <ACE_Basic_Stats>::accumulate(
                    (::core::ptr::addr_of_mut!((* __this).__base_0))
                        as *mut ACE_Basic_Stats,
                    ::core::ptr::addr_of!(((* rhs)).__base_0) as *const ACE_Basic_Stats,
                );
                if (((((<ACE_Basic_Stats>::samples_count(
                    (::core::ptr::addr_of!((* __this).__base_0))
                        as *const ACE_Basic_Stats,
                    ...
                    as libc::c_int) != 0)
                {
                    (*__this).throughput_last_ = (((*rhs).throughput_last_)
                        as libc::c_ulong);
                } else {
                    if ((((((*__this).throughput_last_ as libc::c_ulong))
                        < ((((*rhs).throughput_last_) as libc::c_ulong))) as libc::c_int
                        as libc::c_int) != 0)
                    {
                        (*__this).throughput_last_ = (((*rhs).throughput_last_)
                            as libc::c_ulong);
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/Throughput_Stats.cpp\0"
                ...
                <ACE_Throughput_Stats>::dump_throughput(
                    msg,
                    sf,
                    (*__this).throughput_last_,
                    <ACE_Basic_Stats>::samples_count(
                        (::core::ptr::addr_of!((* __this).__base_0))
                            as *const ACE_Basic_Stats,
                    ),
                );
    ...
    pub unsafe fn dump_throughput(
        mut msg: *const libc::c_char,
        mut sf: libc::c_uint,
        mut elapsed_time: libc::c_ulong,
        mut samples_count: libc::c_uint,
    ) {
        unsafe {
            {
                let mut seconds: libc::c_double = (((((elapsed_time) as libc::c_ulong))
                    / ((sf) as libc::c_ulong)) as libc::c_double);
                {
                    seconds = (((seconds) as libc::c_double))
                        / (((ACE_ONE_SECOND_IN_USECS)) as libc::c_double);
                    seconds
                };
                let mut t_avg: libc::c_double = 0.0f64;
                if (((((seconds as libc::c_double)) > (((0.0f64) as libc::c_double)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    t_avg = (((samples_count) as libc::c_double))
                        ...
                        {
                            {
                                ...
                                <ACE_Log_Category_TSS>::log(
                                    (ace___) as *mut ACE_Log_Category_TSS,
                                    LM_DEBUG,
                                    ((b"%s throughput: %.2f (events/second)\n\0".as_ptr()
                                        as *const libc::c_char) as *const libc::c_char),
                                    msg,
                                    t_avg,
                                );
