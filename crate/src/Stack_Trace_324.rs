...
#[no_mangle]
pub static mut ACE_Stack_Trace_UNSUPPORTED: [libc::c_char; 36usize] = unsafe {
    ::core::mem::transmute::<
        _,
        [libc::c_char; 36usize],
    >(*b"<stack traces unsupported platform>\0")
};
#[allow(non_upper_case_globals)]
#[no_mangle]
pub static mut ACE_Stack_Trace_UNABLE_TO_GET_TRACE: [libc::c_char; 22usize] = unsafe {
    ::core::mem::transmute::<_, [libc::c_char; 22usize]>(*b"<unable to get trace>\0")
};
#[export_name = "_ZN15ACE_Stack_TraceC1Elm"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Stack_TraceC1Elm(
    __this: *mut ACE_Stack_Trace,
    __a0: libc::c_long,
    __a1: libc::c_ulong,
) {
    ACE_Stack_Trace::new_at(__this, __a0, __a1)
}
#[export_name = "_ZNK15ACE_Stack_Trace5c_strEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK15ACE_Stack_Trace5c_strEv(
    __this: *const ACE_Stack_Trace,
) -> *const libc::c_char {
    unsafe { ACE_Stack_Trace::c_str(__this) }
}
#[export_name = "_ZN15ACE_Stack_Trace14generate_traceElm"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_Stack_Trace14generate_traceElm(
    __this: *mut ACE_Stack_Trace,
    starting_frame_offset: libc::c_long,
    num_frames: libc::c_ulong,
) {
    unsafe { ACE_Stack_Trace::generate_trace(__this, starting_frame_offset, num_frames) }
}
pub mod ACE_OS {
...
pub(crate) unsafe extern "C-unwind" fn determine_starting_frame(
    mut initial_frame: libc::c_long,
    mut offset: libc::c_long,
) -> libc::c_ulong {
    unsafe {
        {
            return (((*ace_max___const_long____const_long___(
                &(((((initial_frame) as libc::c_long))
                    .wrapping_add((offset) as libc::c_long))) as *const libc::c_long,
                &(((0 as libc::c_long))) as *const libc::c_long,
            ))) as libc::c_ulong);
        }
        #[allow(unreachable_code)] { ::core::unreachable!() }
    }
