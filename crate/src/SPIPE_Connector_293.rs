...
pub mod ACE {
    ...
    extern "C-unwind" {
        #[link_name = "_ZN3ACE17handle_timed_openEP14ACE_Time_ValuePKciii"]
        pub fn handle_timed_open(
            timeout: *mut super::ACE_Time_Value,
            name: *const libc::c_char,
            flags: libc::c_int,
            perms: libc::c_int,
...
pub type ACE_SPIPE_Connector_PEER_ADDR = ACE_SPIPE_Addr;
pub type ACE_SPIPE_Connector_PEER_STREAM = ACE_SPIPE_Stream;
#[doc = "* @class ACE_SPIPE_Connector\n *\n * @brief Defines an active connection factory for ACE_SPIPE_Stream.\n * On Windows this is mapped to Named Pipes, whereas on UNIX it is\n * mapped to STREAM pipes."]
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ACE_SPIPE_Connector {}
#[export_name = "_ZN19ACE_SPIPE_ConnectorC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN19ACE_SPIPE_ConnectorC1Ev(
    __this: *mut ACE_SPIPE_Connector,
) {
    ACE_SPIPE_Connector::new_at(__this)
}
#[export_name = "_ZN19ACE_SPIPE_ConnectorC1ER16ACE_SPIPE_StreamRK14ACE_SPIPE_AddrP14ACE_Time_ValueRK8ACE_Addriiiii"]
pub unsafe extern "C-unwind" fn __xtu__ZN19ACE_SPIPE_ConnectorC1ER16ACE_SPIPE_StreamRK14ACE_SPIPE_AddrP14ACE_Time_ValueRK8ACE_Addriiiii(
    __this: *mut ACE_SPIPE_Connector,
    __a0: *mut ACE_SPIPE_Stream,
    __a1: *const ACE_SPIPE_Addr,
    __a2: *mut ACE_Time_Value,
    __a3: *const ACE_Addr,
    __a4: libc::c_int,
    __a5: libc::c_int,
    __a6: libc::c_int,
    ...
    ACE_SPIPE_Connector::new_at_uf8b3a0798d72c6ff(
        __this,
        __a0,
        __a1,
        __a2,
...
#[export_name = "_ZN19ACE_SPIPE_Connector7connectER16ACE_SPIPE_StreamRK14ACE_SPIPE_AddrP14ACE_Time_ValueRK8ACE_Addriiiii"]
pub unsafe extern "C-unwind" fn __xtu__ZN19ACE_SPIPE_Connector7connectER16ACE_SPIPE_StreamRK14ACE_SPIPE_AddrP14ACE_Time_ValueRK8ACE_Addriiiii(
    __this: *mut ACE_SPIPE_Connector,
    new_io: *mut ACE_SPIPE_Stream,
    remote_sap: *const ACE_SPIPE_Addr,
    timeout: *mut ACE_Time_Value,
    _anon_3: *const ACE_Addr,
    _anon_4: libc::c_int,
    flags: libc::c_int,
    perms: libc::c_int,
    sa: libc::c_int,
...
#[export_name = "_ZNK19ACE_SPIPE_Connector4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK19ACE_SPIPE_Connector4dumpEv(
    __this: *const ACE_SPIPE_Connector,
) {
    unsafe { ACE_SPIPE_Connector::dump(__this) }
}
...
impl ACE_SPIPE_Connector {
    ...
    pub unsafe fn new_at_uf8b3a0798d72c6ff(
        ...
        unsafe {
            ...
            {
                if (((((((((((((<ACE_SPIPE_Connector>::connect(
                    (__this) as *mut ACE_SPIPE_Connector,
                    ::core::ptr::addr_of_mut!((* new_io)),
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/SPIPE_Connector.cpp\0"
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"address %s, %p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        <ACE_SPIPE_Addr>::get_path_name(
                                            (::core::ptr::addr_of!((* remote_sap)))
                                                as *const ACE_SPIPE_Addr,
                                        ),
                                        b"ACE_SPIPE_Connector\0".as_ptr() as *const libc::c_char,
                                    );
                                }
                            }
                            #[allow(unreachable_code)] break 'cont_0;
    ...
    pub unsafe fn new_uf8b3a0798d72c6ff(
        mut __a0: *mut ACE_SPIPE_Stream,
        mut __a1: *const ACE_SPIPE_Addr,
        mut __a2: *mut ACE_Time_Value,
    ...
    pub unsafe fn connect(
        ...
        mut remote_sap: *const ACE_SPIPE_Addr,
        mut timeout: *mut ACE_Time_Value,
        mut _anon_3: *const ACE_Addr,
        mut _anon_4: libc::c_int,
        mut flags: libc::c_int,
        mut perms: libc::c_int,
        mut sa: libc::c_int,
        mut pipe_mode: libc::c_int,
        ...
        unsafe {
            ...
            {
                ({
                    flags = (((flags) as libc::c_int)) & (((!((64)))) as libc::c_int);
                    flags
                });
                let mut handle: libc::c_int = unsafe { ::core::mem::zeroed() };
                {
                    let _ = (pipe_mode);
                };
                handle = ACE::handle_timed_open(
                    timeout,
                    <ACE_SPIPE_Addr>::get_path_name(
                        (::core::ptr::addr_of!((* remote_sap))) as *const ACE_SPIPE_Addr,
                    ),
                    flags,
                    perms,
                    sa,
                ...
                <ACE_IPC_SAP>::set_handle(
                    (::core::ptr::addr_of_mut!(
                        ...
                        (::core::ptr::addr_of_mut!((* new_io)))).__base_0) .cast:: <
                        ACE_SPIPE > ().cast_mut()).__base_0) .cast:: < ACE_IPC_SAP > ()
                        .cast_mut())
                    )) as *mut ACE_IPC_SAP,
                    handle,
                );
                <ACE_SPIPE_Addr>::operator_assign(
                    (::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* new_io).remote_addr_) .cast:: <
                        ACE_SPIPE_Addr > ().cast_mut())
                    )) as *mut ACE_SPIPE_Addr,
                    ::core::ptr::addr_of!((* remote_sap)),
                );
                return if (((((handle as libc::c_int))
                    == ((((-((1) as libc::c_int))) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    (-((1) as libc::c_int))
    ...
    pub unsafe fn reset_new_handle(__this: *mut Self, mut _anon_0: libc::c_int) -> bool {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
