...
impl Clone for ACE_UNIX_Addr {
    #[inline]
    fn clone(&self) -> Self {
        unsafe { Self::new_u93d5a1124385711e(self as *const Self) }
    }
}
...
#[export_name = "_ZN13ACE_UNIX_AddrC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_UNIX_AddrC1Ev(
    __this: *mut ACE_UNIX_Addr,
) {
    ACE_UNIX_Addr::new_at(__this)
}
#[export_name = "_ZN13ACE_UNIX_AddrC1ERKS_"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_UNIX_AddrC1ERKS_(
    __this: *mut ACE_UNIX_Addr,
    __a0: *const ACE_UNIX_Addr,
) {
    ACE_UNIX_Addr::new_at_u93d5a1124385711e(__this, __a0)
}
#[export_name = "_ZN13ACE_UNIX_AddrC1EPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_UNIX_AddrC1EPKc(
    __this: *mut ACE_UNIX_Addr,
    __a0: *const libc::c_char,
) {
    ACE_UNIX_Addr::new_at_uf68675b5b0f43d72(__this, __a0)
}
#[export_name = "_ZN13ACE_UNIX_AddrC1EPK11sockaddr_uni"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_UNIX_AddrC1EPK11sockaddr_uni(
    __this: *mut ACE_UNIX_Addr,
    __a0: *const sockaddr_un,
    __a1: libc::c_int,
) {
    ACE_UNIX_Addr::new_at_uc8eaa78b50515b93(__this, __a0, __a1)
}
#[export_name = "_ZN13ACE_UNIX_Addr3setERKS_"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_UNIX_Addr3setERKS_(
    __this: *mut ACE_UNIX_Addr,
    sa: *const ACE_UNIX_Addr,
) -> libc::c_int {
    unsafe { ACE_UNIX_Addr::set(__this, sa) }
}
#[export_name = "_ZN13ACE_UNIX_Addr3setEPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_UNIX_Addr3setEPKc(
    __this: *mut ACE_UNIX_Addr,
    rendezvous_point: *const libc::c_char,
) -> libc::c_int {
    unsafe { ACE_UNIX_Addr::set_ufe59c6d0961d927a(__this, rendezvous_point) }
}
#[export_name = "_ZN13ACE_UNIX_Addr3setEPK11sockaddr_uni"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_UNIX_Addr3setEPK11sockaddr_uni(
    __this: *mut ACE_UNIX_Addr,
    un: *const sockaddr_un,
    len: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_UNIX_Addr::set_ub3b9ef92b8415e4b(__this, un, len) }
}
#[export_name = "_ZNK13ACE_UNIX_Addr8get_addrEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_UNIX_Addr8get_addrEv(
    __this: *const ACE_UNIX_Addr,
) -> *mut libc::c_void {
    unsafe { ACE_UNIX_Addr::get_addr(__this) }
}
#[export_name = "_ZN13ACE_UNIX_Addr8set_addrEPKvi"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_UNIX_Addr8set_addrEPKvi(
    __this: *mut ACE_UNIX_Addr,
    addr: *const libc::c_void,
    len: libc::c_int,
) {
    unsafe { ACE_UNIX_Addr::set_addr(__this, addr, len) }
}
#[export_name = "_ZNK13ACE_UNIX_Addr14addr_to_stringEPcm"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_UNIX_Addr14addr_to_stringEPcm(
    __this: *const ACE_UNIX_Addr,
    s: *mut libc::c_char,
    len: libc::c_ulong,
) -> libc::c_int {
    unsafe { ACE_UNIX_Addr::addr_to_string(__this, s, len) }
}
#[export_name = "_ZN13ACE_UNIX_Addr14string_to_addrEPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_UNIX_Addr14string_to_addrEPKc(
    __this: *mut ACE_UNIX_Addr,
    addr: *const libc::c_char,
) -> libc::c_int {
    unsafe { ACE_UNIX_Addr::string_to_addr(__this, addr) }
}
...
#[export_name = "_ZNK13ACE_UNIX_Addr4hashEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_UNIX_Addr4hashEv(
    __this: *const ACE_UNIX_Addr,
) -> libc::c_ulong {
    unsafe { ACE_UNIX_Addr::hash(__this) }
}
#[export_name = "_ZNK13ACE_UNIX_Addr4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_UNIX_Addr4dumpEv(
    __this: *const ACE_UNIX_Addr,
) {
    unsafe { ACE_UNIX_Addr::dump(__this) }
}
extern "C-unwind" {
...
impl ACE_UNIX_Addr {
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ...
            *(__this as *mut *const ()) = &__VTBL_uc4e824ac38f25c55
            ...
            {
                {
                    let _ = ACE_OS::memset_u2b5dfc47d301370a(
                        (::core::ptr::addr_of_mut!((* __this).unix_addr_)
                            as *mut sockaddr_un as *mut libc::c_void),
                        0,
                        ((::core::mem::size_of::<sockaddr_un>() as libc::c_ulong)
                            as libc::c_ulong),
                    );
                };
                (*__this).unix_addr_.sun_family = ((1) as libc::c_ushort);
            }
            ()
        }
    }
            ...
            *(__this as *mut *const ()) = &__VTBL_uc4e824ac38f25c55
                as *const __Vtbl_uc4e824ac38f25c55 as *const ();
            {
                <ACE_UNIX_Addr>::set_ufe59c6d0961d927a(
                    (__this) as *mut ACE_UNIX_Addr,
                    ((rendezvous_point) as *const libc::c_char),
                );
            }
            ()
        }
    ...
    pub unsafe fn new_at_uc8eaa78b50515b93(
        ...
        unsafe {
            ...
            *(__this as *mut *const ()) = &__VTBL_uc4e824ac38f25c55
                as *const __Vtbl_uc4e824ac38f25c55 as *const ();
            {
                <ACE_UNIX_Addr>::set_ub3b9ef92b8415e4b(
                    (__this) as *mut ACE_UNIX_Addr,
                    un,
                    len,
                );
            ...
            let __this: *mut Self = __this as *mut Self;
            {
                    ...
                    as libc::c_int as libc::c_int) != 0)
                {
                    ...
                    ACE_OS::strcpy_u08e8184bcebbac89(
                        (((*__this).unix_addr_.sun_path).as_mut_ptr()
                            as *mut libc::c_char),
                        (((*sa).unix_addr_.sun_path).as_ptr() as *const libc::c_char),
                    );
                }
                (*__this).unix_addr_.sun_family = ((1) as libc::c_ushort);
                <ACE_Addr>::base_set(
                    ...
                    ((((((((::core::mem::size_of::<sockaddr_un>() as libc::c_ulong)
                        ...
                        .wrapping_add(
                            (ACE_OS::strlen_u07dd12a225364fa6(
                                (((*__this).unix_addr_.sun_path).as_ptr()
                                    as *const libc::c_char),
                            )) as libc::c_ulong,
                        )) as libc::c_int),
                );
    ...
    pub unsafe fn set_ub3b9ef92b8415e4b(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                (*__this).unix_addr_.sun_family = ((1) as libc::c_ushort);
                ACE_OS::strcpy_u08e8184bcebbac89(
                    (((*__this).unix_addr_.sun_path).as_mut_ptr() as *mut libc::c_char),
                    (((*un).sun_path).as_ptr() as *const libc::c_char),
                );
                <ACE_Addr>::base_set(
                    (::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).__base_0) .cast:: < ACE_Addr
    ...
    pub unsafe fn get_addr(__this: *const Self) -> *mut libc::c_void {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (::core::ptr::addr_of!((* __this).unix_addr_)
                    as *const sockaddr_un as *mut libc::c_void);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
