...
#[export_name = "_ZN17ACE_SOCK_AcceptorC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_SOCK_AcceptorC1Ev(
    __this: *mut ACE_SOCK_Acceptor,
) {
    ACE_SOCK_Acceptor::new_at(__this)
}
#[export_name = "_ZN17ACE_SOCK_AcceptorC1ERK8ACE_Addriiiii"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_SOCK_AcceptorC1ERK8ACE_Addriiiii(
    __this: *mut ACE_SOCK_Acceptor,
    __a0: *const ACE_Addr,
    __a1: libc::c_int,
    __a2: libc::c_int,
    ...
    ACE_SOCK_Acceptor::new_at_ueca9aa94e32054d5(
        __this,
        __a0,
        __a1,
        __a2,
...
#[export_name = "_ZN17ACE_SOCK_AcceptorC1ERK8ACE_AddrP17ACE_Protocol_Infommiiiii"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_SOCK_AcceptorC1ERK8ACE_AddrP17ACE_Protocol_Infommiiiii(
    __this: *mut ACE_SOCK_Acceptor,
    __a0: *const ACE_Addr,
    ...
    ACE_SOCK_Acceptor::new_at_uaa8991a659393d88(
        __this,
        __a0,
        __a1,
        __a2,
...
#[export_name = "_ZN17ACE_SOCK_Acceptor4openERK8ACE_Addriiiii"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_SOCK_Acceptor4openERK8ACE_Addriiiii(
    __this: *mut ACE_SOCK_Acceptor,
...
#[export_name = "_ZN17ACE_SOCK_Acceptor4openERK8ACE_AddrP17ACE_Protocol_Infommiiiii"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_SOCK_Acceptor4openERK8ACE_AddrP17ACE_Protocol_Infommiiiii(
    __this: *mut ACE_SOCK_Acceptor,
    local_sap: *const ACE_Addr,
    ...
    unsafe {
        ACE_SOCK_Acceptor::open_u529696811ed945f0(
            __this,
            local_sap,
            protocolinfo,
            g,
...
#[export_name = "_ZN17ACE_SOCK_Acceptor5closeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_SOCK_Acceptor5closeEv(
    __this: *mut ACE_SOCK_Acceptor,
) -> libc::c_int {
    unsafe { ACE_SOCK_Acceptor::close(__this) }
}
...
#[export_name = "_ZNK17ACE_SOCK_Acceptor6acceptER15ACE_SOCK_StreamP8ACE_AddrP14ACE_Time_Valuebb"]
pub unsafe extern "C-unwind" fn __xtu__ZNK17ACE_SOCK_Acceptor6acceptER15ACE_SOCK_StreamP8ACE_AddrP14ACE_Time_Valuebb(
...
#[export_name = "_ZNK17ACE_SOCK_Acceptor6acceptER15ACE_SOCK_Stream21ACE_Accept_QoS_ParamsP8ACE_AddrP14ACE_Time_Valuebb"]
pub unsafe extern "C-unwind" fn __xtu__ZNK17ACE_SOCK_Acceptor6acceptER15ACE_SOCK_Stream21ACE_Accept_QoS_ParamsP8ACE_AddrP14ACE_Time_Valuebb(
    __this: *const ACE_SOCK_Acceptor,
    new_stream: *mut ACE_SOCK_Stream,
    ...
    unsafe {
        ACE_SOCK_Acceptor::accept_u81bd89bb409a0ca8(
            __this,
            new_stream,
            qos_params,
            remote_addr,
...
#[export_name = "_ZNK17ACE_SOCK_Acceptor4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK17ACE_SOCK_Acceptor4dumpEv(
    __this: *const ACE_SOCK_Acceptor,
) {
    unsafe { ACE_SOCK_Acceptor::dump(__this) }
}
#[export_name = "_ZNK17ACE_SOCK_Acceptor19shared_accept_startEP14ACE_Time_ValuebRi"]
pub unsafe extern "C-unwind" fn __xtu__ZNK17ACE_SOCK_Acceptor19shared_accept_startEP14ACE_Time_ValuebRi(
    __this: *const ACE_SOCK_Acceptor,
    timeout: *mut ACE_Time_Value,
    restart: bool,
    ...
    unsafe {
        ACE_SOCK_Acceptor::shared_accept_start(
            __this,
            timeout,
            restart,
            in_blocking_mode,
...
#[export_name = "_ZNK17ACE_SOCK_Acceptor20shared_accept_finishE15ACE_SOCK_Streamib"]
pub unsafe extern "C-unwind" fn __xtu__ZNK17ACE_SOCK_Acceptor20shared_accept_finishE15ACE_SOCK_Streamib(
    __this: *const ACE_SOCK_Acceptor,
    new_stream: *mut ACE_SOCK_Stream,
    ...
    unsafe {
        ACE_SOCK_Acceptor::shared_accept_finish(
            __this,
            ::core::ptr::read(new_stream),
            in_blocking_mode,
            reset_new_handle,
        )
    }
}
#[export_name = "_ZN17ACE_SOCK_Acceptor11shared_openERK8ACE_Addriii"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_SOCK_Acceptor11shared_openERK8ACE_Addriii(
    __this: *mut ACE_SOCK_Acceptor,
    local_sap: *const ACE_Addr,
    protocol_family: libc::c_int,
    backlog: libc::c_int,
...
impl ACE_SOCK_Acceptor {
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/SOCK_Acceptor.cpp\0"
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        b"ACE_SOCK_Acceptor\0".as_ptr() as *const libc::c_char,
                                    );
                                }
                            }
    ...
    pub unsafe fn new_at_uaa8991a659393d88(
        ...
        unsafe {
            ...
            {
                if (((((<ACE_SOCK_Acceptor>::open_u529696811ed945f0(
                    (__this) as *mut ACE_SOCK_Acceptor,
                    ::core::ptr::addr_of!((* local_sap)),
                    protocolinfo,
                    g,
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                    ...
                    as libc::c_int as libc::c_int) != 0)
                {
                    ...
                    return <ACE_SOCK_Acceptor>::shared_open(
                        (__this) as *mut ACE_SOCK_Acceptor,
                        ::core::ptr::addr_of!((* local_sap)),
                        protocol_family,
                        backlog,
                        ...
                        'cont_0: loop {
                            {
                                <ACE_IPC_SAP>::set_handle(
                                    (::core::ptr::addr_of_mut!(
                                        ...
                                        new_stream)))).__base_0) .cast:: < ACE_SOCK_IO > ()
                                        .cast_mut()).__base_0) .cast:: < ACE_SOCK > ().cast_mut())
                                        .__base_0) .cast:: < ACE_IPC_SAP > ().cast_mut())
                                    )) as *mut ACE_IPC_SAP,
                        ...
                        'cont_0: loop {
                            {
                                <ACE_IPC_SAP>::set_handle(
                                    ...
                                    ACE_OS::accept_u01a5c7d903c3928a(
                                        <ACE_IPC_SAP>::get_handle(
                                            (::core::ptr::addr_of!(
                                                (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((* __this)
                                                .__base_0) .cast:: < ACE_SOCK > ().cast_mut()).__base_0)
  ...
  /// called.*/
    pub unsafe fn shared_accept_finish(
        __this: *const Self,
        mut new_stream: ACE_SOCK_Stream,
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut new_handle: libc::c_int = <ACE_IPC_SAP>::get_handle(
                    (::core::ptr::addr_of!(
                        (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((*
                        ::core::ptr::addr_of!((* (::core::ptr::addr_of!(new_stream)))
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                    ...
                    as libc::c_int as libc::c_int) != 0)
                {
                        ...
                        == (((0) as libc::c_int))) as libc::c_int as libc::c_int) != 0)
                    {
                        if (((((ACE::bind_port(
                            ...
                            ((__bswap_32(
                                (((local_inet_addr.sin_addr.s_addr as libc::c_uint))
                                    as libc::c_uint),
                            )) as libc::c_uint),
                            0,
                        ) as libc::c_int))
                ...
                if (((((((((error as libc::c_int)) != (((0) as libc::c_int)))
                    ...
                    as libc::c_int) != 0)
                {
                    let mut g: ACE_Errno_Guard = ::core::mem::MaybeUninit::<
                        ACE_Errno_Guard,
                    >::zeroed()
                        .assume_init();
                    <ACE_Errno_Guard>::new_at_u581aee1139351ac3(
                        (::core::ptr::addr_of_mut!(g)) as *mut ACE_Errno_Guard,
                        __errno_location(),
                    );
                    error = 1;
                    <ACE_SOCK_Acceptor>::close((__this) as *mut ACE_SOCK_Acceptor);
                }
