...
#[export_name = "_ZN15ACE_LSOCK_DgramC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_LSOCK_DgramC1Ev(
    __this: *mut ACE_LSOCK_Dgram,
) {
    ACE_LSOCK_Dgram::new_at(__this)
}
#[export_name = "_ZN15ACE_LSOCK_DgramC1ERK8ACE_Addrii"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_LSOCK_DgramC1ERK8ACE_Addrii(
    __this: *mut ACE_LSOCK_Dgram,
    __a0: *const ACE_Addr,
    __a1: libc::c_int,
    __a2: libc::c_int,
) {
    ACE_LSOCK_Dgram::new_at_ud9a4cdb81aae3bc5(__this, __a0, __a1, __a2)
}
#[export_name = "_ZN15ACE_LSOCK_Dgram4openERK8ACE_Addrii"]
pub unsafe extern "C-unwind" fn __xtu__ZN15ACE_LSOCK_Dgram4openERK8ACE_Addrii(
    __this: *mut ACE_LSOCK_Dgram,
    local: *const ACE_Addr,
    protocol_family: libc::c_int,
    protocol: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_LSOCK_Dgram::open(__this, local, protocol_family, protocol) }
}
#[export_name = "_ZNK15ACE_LSOCK_Dgram4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK15ACE_LSOCK_Dgram4dumpEv(
    __this: *const ACE_LSOCK_Dgram,
) {
    unsafe { ACE_LSOCK_Dgram::dump(__this) }
}
...
impl ACE_LSOCK_Dgram {
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ...
            <ACE_LSOCK>::new_at(::core::ptr::addr_of_mut!((* __this).__base_1));
            {}
            ()
        }
    }
    ...
    pub unsafe fn new_at_ud9a4cdb81aae3bc5(
        __this: *mut Self,
        mut local: *const ACE_Addr,
        mut protocol_family: libc::c_int,
        mut protocol: libc::c_int,
        ...
        unsafe {
            ...
            <ACE_LSOCK>::new_at(::core::ptr::addr_of_mut!((* __this).__base_1));
            {
                if (((((<ACE_LSOCK_Dgram>::open(
                    (__this) as *mut ACE_LSOCK_Dgram,
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/LSOCK_Dgram.cpp\0".as_ptr()
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        b"ACE_LSOCK_Dgram\0".as_ptr() as *const libc::c_char,
                                    );
                                }
                            }
    ...
    pub unsafe fn new_ud9a4cdb81aae3bc5(
        mut __a0: *const ACE_Addr,
        mut __a1: libc::c_int,
        mut __a2: libc::c_int,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_ud9a4cdb81aae3bc5(
            ::core::ptr::addr_of_mut!(__obj),
            __a0,
            __a1,
            __a2,
    ...
    ///Set handle.
    pub unsafe fn set_handle(__this: *mut Self, mut h: libc::c_int) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
