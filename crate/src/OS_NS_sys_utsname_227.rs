...
pub mod ACE_OS {
    #[export_name = "_ZN6ACE_OS5unameEP7utsname"]
    pub unsafe extern "C-unwind" fn uname_u87f3d152753a529e(
        mut name: *mut super::utsname,
    ) -> libc::c_int {
        unsafe {
            {
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            return ((super::uname(((name) as *mut super::utsname)))
                                as libc::c_int);
                        }
