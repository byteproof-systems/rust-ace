...
impl Clone for ACE_SPIPE_Addr {
    #[inline]
    fn clone(&self) -> Self {
        unsafe { Self::new_u3f6c42af7958b328(self as *const Self) }
    }
}
...
#[export_name = "_ZN14ACE_SPIPE_AddrC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_SPIPE_AddrC1Ev(
    __this: *mut ACE_SPIPE_Addr,
) {
    ACE_SPIPE_Addr::new_at(__this)
}
#[export_name = "_ZN14ACE_SPIPE_AddrC1ERKS_"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_SPIPE_AddrC1ERKS_(
    __this: *mut ACE_SPIPE_Addr,
    __a0: *const ACE_SPIPE_Addr,
) {
    ACE_SPIPE_Addr::new_at_u3f6c42af7958b328(__this, __a0)
}
#[export_name = "_ZN14ACE_SPIPE_AddrC1EPKcjj"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_SPIPE_AddrC1EPKcjj(
    __this: *mut ACE_SPIPE_Addr,
    __a0: *const libc::c_char,
    __a1: libc::c_uint,
    __a2: libc::c_uint,
) {
    ACE_SPIPE_Addr::new_at_ua1e75a472fd2714f(__this, __a0, __a1, __a2)
}
#[export_name = "_ZN14ACE_SPIPE_Addr3setERKS_"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_SPIPE_Addr3setERKS_(
    __this: *mut ACE_SPIPE_Addr,
    sa: *const ACE_SPIPE_Addr,
) -> libc::c_int {
    unsafe { ACE_SPIPE_Addr::set(__this, sa) }
}
#[export_name = "_ZN14ACE_SPIPE_Addr3setEPKcjj"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_SPIPE_Addr3setEPKcjj(
    __this: *mut ACE_SPIPE_Addr,
    addr: *const libc::c_char,
    gid: libc::c_uint,
    uid: libc::c_uint,
) -> libc::c_int {
    unsafe { ACE_SPIPE_Addr::set_ud2804ee121e7b608(__this, addr, gid, uid) }
}
#[export_name = "_ZNK14ACE_SPIPE_Addr8get_addrEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK14ACE_SPIPE_Addr8get_addrEv(
    __this: *const ACE_SPIPE_Addr,
) -> *mut libc::c_void {
    unsafe { ACE_SPIPE_Addr::get_addr(__this) }
}
#[export_name = "_ZN14ACE_SPIPE_Addr8set_addrEPKvi"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_SPIPE_Addr8set_addrEPKvi(
    __this: *mut ACE_SPIPE_Addr,
    addr: *const libc::c_void,
    len: libc::c_int,
) {
    unsafe { ACE_SPIPE_Addr::set_addr(__this, addr, len) }
}
#[export_name = "_ZNK14ACE_SPIPE_Addr14addr_to_stringEPcm"]
pub unsafe extern "C-unwind" fn __xtu__ZNK14ACE_SPIPE_Addr14addr_to_stringEPcm(
    __this: *const ACE_SPIPE_Addr,
    s: *mut libc::c_char,
    len: libc::c_ulong,
) -> libc::c_int {
    unsafe { ACE_SPIPE_Addr::addr_to_string(__this, s, len) }
}
#[export_name = "_ZN14ACE_SPIPE_Addr14string_to_addrEPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN14ACE_SPIPE_Addr14string_to_addrEPKc(
    __this: *mut ACE_SPIPE_Addr,
    addr: *const libc::c_char,
) -> libc::c_int {
    unsafe { ACE_SPIPE_Addr::string_to_addr(__this, addr) }
}
#[export_name = "_ZNK14ACE_SPIPE_Addr4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK14ACE_SPIPE_Addr4dumpEv(
    __this: *const ACE_SPIPE_Addr,
) {
    unsafe { ACE_SPIPE_Addr::dump(__this) }
}
extern "C-unwind" {
        ...
        unsafe {
            ...
            <ACE_Addr>::new_at(
                (::core::ptr::addr_of_mut!((* __this).__base_0).cast::<ACE_Addr>())
                    as *mut ACE_Addr,
                ((((46) as libc::c_int)).wrapping_add((1) as libc::c_int)),
                ((::core::mem::size_of::<SPIPE_Addr>() as libc::c_ulong) as libc::c_int),
            );
            *(__this as *mut *const ()) = &__VTBL_u42165294ee3c96f6
                as *const __Vtbl_u42165294ee3c96f6 as *const ();
            {
                {
                    let _ = ACE_OS::memset_u2b5dfc47d301370a(
                        (::core::ptr::addr_of_mut!((* __this).SPIPE_addr_)
                            as *mut SPIPE_Addr as *mut libc::c_void),
                        0,
                        ((::core::mem::size_of::<SPIPE_Addr>() as libc::c_ulong)
                            as libc::c_ulong),
                    );
                };
            }
    ...
    pub unsafe fn new_at_ua1e75a472fd2714f(
        ...
        unsafe {
            ...
            *(__this as *mut *const ()) = &__VTBL_u42165294ee3c96f6
                as *const __Vtbl_u42165294ee3c96f6 as *const ();
            {
                <ACE_SPIPE_Addr>::set_ud2804ee121e7b608(
                    (__this) as *mut ACE_SPIPE_Addr,
                    addr,
                    gid,
                    uid,
                    ...
                    as libc::c_int as libc::c_int) != 0)
                {
                ...
                } else {
                    {
                        let _ = ACE_OS::memcpy_u6033eb81edaf9212(
                            (::core::ptr::addr_of_mut!((* __this).SPIPE_addr_)
                                as *mut SPIPE_Addr as *mut libc::c_void),
                            (((::core::ptr::addr_of!((* sa).SPIPE_addr_)
                                as *const SPIPE_Addr as *mut libc::c_void))
  ...
  /// system.*/
    pub unsafe fn set_ud2804ee121e7b608(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut len: libc::c_int = ((::core::mem::size_of::<libc::c_uint>()
                    as libc::c_ulong) as libc::c_int);
                {
                    len = (((len) as libc::c_int))
                        .wrapping_add(
                ...
                ACE_OS::strsncpy(
                    (((*__this).SPIPE_addr_.rendezvous_).as_mut_ptr()
                        as *mut libc::c_char),
                    ((addr) as *const libc::c_char),
                    ((::core::mem::size_of::<[libc::c_char; 4097usize]>()
                        as libc::c_ulong) as libc::c_ulong),
                );
                (*__this).SPIPE_addr_.gid_ = if (((((gid as libc::c_uint))
                    == (((0) as libc::c_uint))) as libc::c_int as libc::c_int) != 0)
                {
                    ACE_OS::getgid_ubba9fd39b1327a93()
                } else {
                    gid
                };
                (*__this).SPIPE_addr_.uid_ = if (((((uid as libc::c_uint))
                    == (((0) as libc::c_uint))) as libc::c_int as libc::c_int) != 0)
                {
                    ACE_OS::getuid_udb2e58c7bca9eb99()
                } else {
                    uid
                };
                return 0;
    ...
    pub unsafe fn get_addr(__this: *const Self) -> *mut libc::c_void {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (::core::ptr::addr_of!((* __this).SPIPE_addr_)
                    as *const SPIPE_Addr as *mut libc::c_void);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    ...
    pub unsafe fn string_to_addr(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return <ACE_SPIPE_Addr>::set_ud2804ee121e7b608(
                    (__this) as *mut ACE_SPIPE_Addr,
                    addr,
                    ((0) as libc::c_uint),
                    ((0) as libc::c_uint),
