...
#[export_name = "_ZN26ACE_Delegating_Time_PolicyC1EPK28ACE_Dynamic_Time_Policy_Base"]
pub unsafe extern "C-unwind" fn __xtu__ZN26ACE_Delegating_Time_PolicyC1EPK28ACE_Dynamic_Time_Policy_Base(
    __this: *mut ACE_Delegating_Time_Policy,
    __a0: *const ACE_Dynamic_Time_Policy_Base,
) {
    ACE_Delegating_Time_Policy::new_at(__this, __a0)
}
extern "C-unwind" {
...
#[repr(C)]
#[derive(Clone)]
pub struct NULL_Time_Policy {
    pub __base_0: ::core::mem::ManuallyDrop<ACE_Dynamic_Time_Policy_Base>,
}
impl Drop for NULL_Time_Policy {
    fn drop(&mut self) {
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.__base_0);
        }
...
#[export_name = "_ZNK16NULL_Time_Policy12gettimeofdayEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK16NULL_Time_Policy12gettimeofdayEv(
    __this: *const NULL_Time_Policy,
) -> ACE_Time_Value_T_ACE_Delegating_Time_Policy_ {
    unsafe { NULL_Time_Policy::gettimeofday(__this) }
}
pub(crate) static mut null_policy_: NULL_Time_Policy = unsafe {
    ::core::mem::MaybeUninit::<NULL_Time_Policy>::zeroed().assume_init()
};
extern "C-unwind" {
...
impl NULL_Time_Policy {
    pub unsafe fn gettimeofday(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (<ACE_Time_Value_T_ACE_Delegating_Time_Policy_>::new_sae8f0a3d523fc578(
                    ::core::ptr::addr_of!(ACE_Time_Value_zero),
                    &(<ACE_Delegating_Time_Policy>::new(
                        ((0) as *const ACE_Dynamic_Time_Policy_Base),
                    )) as *const ACE_Delegating_Time_Policy,
                ));
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
...
unsafe extern "C-unwind" fn __rt_static_init() {
    ::core::ptr::write(
        ::core::ptr::addr_of_mut!(null_policy_),
        unsafe {
            {
                let mut __obj: NULL_Time_Policy = ::core::mem::MaybeUninit::<
                    NULL_Time_Policy,
                >::zeroed()
                    .assume_init();
                let __this: *mut NULL_Time_Policy = &mut __obj as *mut NULL_Time_Policy;
                ::core::ptr::write(
                    ::core::ptr::addr_of_mut!((* __this).__base_0)
                        .cast::<ACE_Dynamic_Time_Policy_Base>(),
                    {
                        let mut __obj: ACE_Dynamic_Time_Policy_Base = ::core::mem::MaybeUninit::<
                            ACE_Dynamic_Time_Policy_Base,
                        >::zeroed()
                            .assume_init();
                        let __this: *mut ACE_Dynamic_Time_Policy_Base = &mut __obj
                            as *mut ACE_Dynamic_Time_Policy_Base;
                        *(__this as *mut *const ()) = &__VTBL_uad82a161fefcba59
                            as *const __Vtbl_uad82a161fefcba59 as *const ();
                        __obj
                    },
                );
                *(__this as *mut *const ()) = &__VTBL_u5fdf94dab4c0de49
                    as *const __Vtbl_u5fdf94dab4c0de49 as *const ();
                __obj
            }
        },
    );
...
pub static __TYPEINFO_16NULL_Time_Policy: crate::__cxx_std::TypeInfo = crate::__cxx_std::TypeInfo {
    __name: b"16NULL_Time_Policy\0".as_ptr() as *const libc::c_char,
};
pub unsafe fn __vdtor_u5fdf94dab4c0de49(__this: *mut ACE_Dynamic_Time_Policy_Base) {
    let _ = Box::from_raw(__this as *mut NULL_Time_Policy);
}
pub unsafe fn __vthunk_ou4ec11c565cfa2dac_iu1b0d8372e5c62ba8(
    __this: *mut ACE_Dynamic_Time_Policy_Base,
) -> ACE_Time_Value_T_ACE_Delegating_Time_Policy_ {
    <NULL_Time_Policy>::gettimeofday((__this as *mut NULL_Time_Policy))
}
#[repr(C)]
pub struct __Vtbl_u5fdf94dab4c0de49 {
    pub __type_info: &'static crate::__cxx_std::TypeInfo,
    pub __vdtor: unsafe fn(*mut ACE_Dynamic_Time_Policy_Base),
    pub vfn_u1b0d8372e5c62ba8: unsafe fn(
        *mut ACE_Dynamic_Time_Policy_Base,
    ) -> ACE_Time_Value_T_ACE_Delegating_Time_Policy_,
}
pub static __VTBL_u5fdf94dab4c0de49: __Vtbl_u5fdf94dab4c0de49 = __Vtbl_u5fdf94dab4c0de49 {
    __type_info: &__TYPEINFO_16NULL_Time_Policy,
    __vdtor: __vdtor_u5fdf94dab4c0de49,
    vfn_u1b0d8372e5c62ba8: __vthunk_ou4ec11c565cfa2dac_iu1b0d8372e5c62ba8,
};
