...
#[export_name = "_ZN17ACE_Process_MutexC1EPKcPvj"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Process_MutexC1EPKcPvj(
    __this: *mut ACE_Process_Mutex,
    __a0: *const libc::c_char,
    __a1: *mut libc::c_void,
    __a2: libc::c_uint,
) {
    ACE_Process_Mutex::new_at(__this, __a0, __a1, __a2)
}
#[export_name = "_ZN17ACE_Process_MutexC1EPKwPvj"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Process_MutexC1EPKwPvj(
    __this: *mut ACE_Process_Mutex,
    __a0: *const libc::wchar_t,
    __a1: *mut libc::c_void,
    __a2: libc::c_uint,
) {
    ACE_Process_Mutex::new_at_u8b38e4738896fb4c(__this, __a0, __a1, __a2)
}
...
#[export_name = "__acedtor_uc4127d66b6e25f94"]
pub unsafe extern "C-unwind" fn __acedtor_uc4127d66b6e25f94(
    __this: *mut ACE_Process_Mutex,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[export_name = "_ZN17ACE_Process_Mutex6unlinkEPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Process_Mutex6unlinkEPKc(
    name: *const libc::c_char,
) -> libc::c_int {
    unsafe { ACE_Process_Mutex::unlink(name) }
}
#[export_name = "_ZNK17ACE_Process_Mutex4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK17ACE_Process_Mutex4dumpEv(
    __this: *const ACE_Process_Mutex,
) {
    unsafe { ACE_Process_Mutex::dump(__this) }
}
#[export_name = "_ZN17ACE_Process_Mutex11unique_nameEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Process_Mutex11unique_nameEv(
    __this: *mut ACE_Process_Mutex,
) -> *const libc::c_char {
    unsafe { ACE_Process_Mutex::unique_name(__this) }
}
    ...
    pub unsafe fn new_at(
        ...
        unsafe {
            ...
            <ACE_SV_Semaphore_Complex>::new_at_ubf78377b304cccc5(
                (::core::ptr::addr_of_mut!((* __this).lock_)
                    .cast::<ACE_SV_Semaphore_Complex>())
                    as *mut ACE_SV_Semaphore_Complex,
                if (!(name).is_null()) {
                    name
                } else {
                    ((<ACE_Process_Mutex>::unique_name(
                        (__this) as *mut ACE_Process_Mutex,
                    )) as *const libc::c_char)
                },
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ACE::unique_name(
                    ...
                    (((*__this).name_).as_mut_ptr() as *mut libc::c_char),
                    ((100) as libc::c_ulong),
                );
                return (((*__this).name_).as_ptr() as *const libc::c_char);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
