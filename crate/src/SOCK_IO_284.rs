...
pub mod ACE_Utils {
    ...
    pub type truncator_280 = Truncator_unsigned_long__int_;
...
#[export_name = "_ZNK11ACE_SOCK_IO5recvvEP5iovecPK14ACE_Time_Value"]
pub unsafe extern "C-unwind" fn __xtu__ZNK11ACE_SOCK_IO5recvvEP5iovecPK14ACE_Time_Value(
    __this: *const ACE_SOCK_IO,
    io_vec: *mut iovec,
    timeout: *const ACE_Time_Value,
) -> libc::c_long {
    unsafe { ACE_SOCK_IO::recvv_u24170279959bdfe8(__this, io_vec, timeout) }
}
#[export_name = "_ZNK11ACE_SOCK_IO4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK11ACE_SOCK_IO4dumpEv(
    __this: *const ACE_SOCK_IO,
) {
    unsafe { ACE_SOCK_IO::dump(__this) }
}
extern "C-unwind" {
...
impl ACE_SOCK_IO {
            ...
            let __this: *mut Self = __this as *mut Self;
            {
                    ...
                    as libc::c_int as libc::c_int) != 0)
                {
                        ...
                        as libc::c_int as libc::c_int) != 0)
                    {
                        ...
                        let mut recv_len: libc::c_long = <ACE_SOCK_IO>::recv_uc64db67f1646fc60(
                            (__this) as *const ACE_SOCK_IO,
                            (*io_vec).iov_base,
                            ((inlen) as libc::c_ulong),
                            ((0) as *const ACE_Time_Value),
                        );
                        if (((((recv_len as libc::c_long)) > (((0) as libc::c_long)))
                            as libc::c_int as libc::c_int) != 0)
                        {
                            (*io_vec).iov_len = (((recv_len as libc::c_ulong))
                                as libc::c_ulong);
                        }
                        return recv_len;
                    } else {
    ...
    #[export_name = "_ZNK11ACE_SOCK_IO4recvEmz"]
    pub unsafe extern "C-unwind" fn recv_ude56eaae5d522e1d(
        __this: *const Self,
        mut n: libc::c_ulong,
        mut __args: ...
    ) -> libc::c_long {
        unsafe {
            ...
            let mut __alloca_arena: ::std::vec::Vec<::std::boxed::Box<[u128]>> = ::std::vec::Vec::new();
            {
                ...
                let mut result: libc::c_long = ((ACE_OS::recvv_u5bf3764b3b283ae9(
                    <ACE_IPC_SAP>::get_handle(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((* __this)
                            .__base_0) .cast:: < ACE_SOCK > ().cast_mut()).__base_0)
    ...
    #[export_name = "_ZNK11ACE_SOCK_IO4sendEmz"]
    pub unsafe extern "C-unwind" fn send_u4a8ad08d58ebee9f(
        __this: *const Self,
        mut n: libc::c_ulong,
        mut __args: ...
    ) -> libc::c_long {
        unsafe {
            ...
            let mut __alloca_arena: ::std::vec::Vec<::std::boxed::Box<[u128]>> = ::std::vec::Vec::new();
            {
                ...
                let mut result: libc::c_long = ((ACE_OS::sendv_u2741ac8ad81ed9fe(
                    <ACE_IPC_SAP>::get_handle(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((* __this)
                            .__base_0) .cast:: < ACE_SOCK > ().cast_mut()).__base_0)
