...
#[export_name = "_ZN16ACE_Sched_Params12priority_minEii"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_Sched_Params12priority_minEii(
    policy: libc::c_int,
    scope: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_Sched_Params::priority_min(policy, scope) }
}
#[export_name = "_ZN16ACE_Sched_Params12priority_maxEii"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_Sched_Params12priority_maxEii(
    policy: libc::c_int,
    scope: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_Sched_Params::priority_max(policy, scope) }
}
#[export_name = "_ZN16ACE_Sched_Params13next_priorityEiii"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_Sched_Params13next_priorityEiii(
    policy: libc::c_int,
    priority: libc::c_int,
    scope: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_Sched_Params::next_priority(policy, priority, scope) }
}
#[export_name = "_ZN16ACE_Sched_Params17previous_priorityEiii"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_Sched_Params17previous_priorityEiii(
    policy: libc::c_int,
    priority: libc::c_int,
    scope: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_Sched_Params::previous_priority(policy, priority, scope) }
}
extern "C-unwind" {
