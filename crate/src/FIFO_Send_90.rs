...
#[export_name = "_ZN13ACE_FIFO_SendC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_FIFO_SendC1Ev(
    __this: *mut ACE_FIFO_Send,
) {
    ACE_FIFO_Send::new_at(__this)
}
#[export_name = "_ZN13ACE_FIFO_SendC1EPKciji"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_FIFO_SendC1EPKciji(
    __this: *mut ACE_FIFO_Send,
    ...
    ACE_FIFO_Send::new_at_u831c4a193dba6a1b(__this, __a0, __a1, __a2, __a3)
}
#[export_name = "_ZN13ACE_FIFO_Send4openEPKciji"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_FIFO_Send4openEPKciji(
    __this: *mut ACE_FIFO_Send,
    rendezvous_name: *const libc::c_char,
    flags: libc::c_int,
    perms: libc::c_uint,
    sa: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_FIFO_Send::open(__this, rendezvous_name, flags, perms, sa) }
}
#[export_name = "_ZNK13ACE_FIFO_Send4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_FIFO_Send4dumpEv(
    __this: *const ACE_FIFO_Send,
) {
    unsafe { ACE_FIFO_Send::dump(__this) }
}
#[repr(C)]
...
impl ACE_FIFO_Send {
    ...
    pub unsafe fn new_at_u831c4a193dba6a1b(
        ...
        unsafe {
            ...
            {
                if (((((<ACE_FIFO_Send>::open(
                    (__this) as *mut ACE_FIFO_Send,
                    fifo_name,
                    flags,
                    perms,
                    sa,
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/FIFO_Send.cpp\0".as_ptr()
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        b"ACE_FIFO_Send::ACE_FIFO_Send\0".as_ptr()
                                            as *const libc::c_char,
                                    );
                                }
                            }
    ...
    pub unsafe fn open(
        __this: *mut Self,
        mut rendezvous_name: *const libc::c_char,
        mut flags: libc::c_int,
        mut perms: libc::c_uint,
        mut sa: libc::c_int,
    ) -> libc::c_int {
