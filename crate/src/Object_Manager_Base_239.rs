...
#[no_mangle]
pub static mut ace_exit_hook_marker: libc::c_int = 0;
#[repr(C)]
#[derive(Clone)]
...
#[doc = "* @class ACE_OS_Object_Manager_Manager\n *\n * @brief Ensure that the ACE_OS_Object_Manager gets initialized at\n * program startup, and destroyed at program termination.\n *\n * Without ACE_HAS_NONSTATIC_OBJECT_MANAGER, a static instance of this\n * class is created.  Therefore, it gets created before main ()\n * is called.  And it gets destroyed after main () returns."]
#[repr(C)]
#[derive(Clone)]
pub struct ACE_OS_Object_Manager_Manager {
    pub saved_main_thread_id_: libc::c_ulong,
}
#[export_name = "_ZN29ACE_OS_Object_Manager_ManagerC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN29ACE_OS_Object_Manager_ManagerC1Ev(
    __this: *mut ACE_OS_Object_Manager_Manager,
) {
    ACE_OS_Object_Manager_Manager::new_at(__this)
}
impl Drop for ACE_OS_Object_Manager_Manager {
    fn drop(&mut self) {
        unsafe {
            let __this: *mut Self = self as *mut Self;
            {
                if ((ACE_OS::thr_equal(
                    ACE_OS::thr_self(),
                    (*__this).saved_main_thread_id_,
                )) != 0)
                {
                    {
                        let __p = ACE_OS_Object_Manager_instance_;
                        if !__p.is_null() {
                            let __vt: *const __Vtbl_u06e4e36432e67f04 = *(__p
                                as *const *const __Vtbl_u06e4e36432e67f04);
                            ((*__vt).__vdtor)(__p as *mut ACE_Object_Manager_Base);
                        }
                    };
                    ACE_OS_Object_Manager_instance_ = ((0)
                        as *mut ACE_OS_Object_Manager);
                }
            }
            ()
        }
...
#[export_name = "__acedtor_u1eb0f7f74784578d"]
pub unsafe extern "C-unwind" fn __acedtor_u1eb0f7f74784578d(
    __this: *mut ACE_OS_Object_Manager_Manager,
) {
    unsafe {
...
#[export_name = "_ZN23ACE_Object_Manager_BaseC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Object_Manager_BaseC1Ev(
    __this: *mut ACE_Object_Manager_Base,
) {
    ACE_Object_Manager_Base::new_at(__this)
}
#[export_name = "_ZN23ACE_Object_Manager_Base13starting_up_iEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Object_Manager_Base13starting_up_iEv(
    __this: *mut ACE_Object_Manager_Base,
) -> libc::c_int {
    unsafe { ACE_Object_Manager_Base::starting_up_i(__this) }
}
#[export_name = "_ZN23ACE_Object_Manager_Base15shutting_down_iEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN23ACE_Object_Manager_Base15shutting_down_iEv(
    __this: *mut ACE_Object_Manager_Base,
) -> libc::c_int {
    unsafe { ACE_Object_Manager_Base::shutting_down_i(__this) }
}
///**************************************************************************
#[no_mangle]
pub unsafe extern "C-unwind" fn ACE_OS_Object_Manager_Internal_Exit_Hook() {
    unsafe {
        {
            if (!(ACE_OS_Object_Manager_instance_).is_null()) {
                {
                    let __obj: *mut ACE_Object_Manager_Base = (<ACE_OS_Object_Manager>::instance())
                        as *mut ACE_Object_Manager_Base;
                    let __vt: *const __Vtbl_u06e4e36432e67f04 = *(__obj
                        as *const *const __Vtbl_u06e4e36432e67f04);
                    ((*__vt).vfn_ue800bfd5a4e8ffa3)(__obj)
                };
            }
        }
        ()
...
#[no_mangle]
pub static mut ACE_OS_Object_Manager_instance_: *mut ACE_OS_Object_Manager = ((0)
    as *mut ACE_OS_Object_Manager);
#[allow(non_upper_case_globals)]
#[no_mangle]
pub static mut ACE_OS_Object_Manager_preallocated_object: [*mut libc::c_void; 3usize] = [
    ((0) as *mut libc::c_void),
    unsafe { ::core::mem::MaybeUninit::<*mut libc::c_void>::zeroed().assume_init() },
    unsafe { ::core::mem::MaybeUninit::<*mut libc::c_void>::zeroed().assume_init() },
];
#[repr(C)]
#[derive(Clone)]
...
#[export_name = "_ZN21ACE_OS_Object_Manager4initEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN21ACE_OS_Object_Manager4initEv(
    __this: *mut ACE_OS_Object_Manager,
) -> libc::c_int {
    unsafe { ACE_OS_Object_Manager::init(__this) }
}
#[export_name = "_ZN21ACE_OS_Object_Manager4finiEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN21ACE_OS_Object_Manager4finiEv(
    __this: *mut ACE_OS_Object_Manager,
) -> libc::c_int {
    unsafe { ACE_OS_Object_Manager::fini(__this) }
}
#[export_name = "_ZN21ACE_OS_Object_Manager11starting_upEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN21ACE_OS_Object_Manager11starting_upEv() -> libc::c_int {
    unsafe { ACE_OS_Object_Manager::starting_up() }
}
#[export_name = "_ZN21ACE_OS_Object_Manager13shutting_downEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN21ACE_OS_Object_Manager13shutting_downEv() -> libc::c_int {
    unsafe { ACE_OS_Object_Manager::shutting_down() }
}
#[export_name = "_ZN21ACE_OS_Object_Manager12default_maskEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN21ACE_OS_Object_Manager12default_maskEv() -> *mut __sigset_t {
    unsafe { ACE_OS_Object_Manager::default_mask() }
}
#[export_name = "_ZN21ACE_OS_Object_Manager11thread_hookEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN21ACE_OS_Object_Manager11thread_hookEv() -> *mut ACE_Thread_Hook {
    unsafe { ACE_OS_Object_Manager::thread_hook() }
}
#[export_name = "_ZN21ACE_OS_Object_Manager11thread_hookEP15ACE_Thread_Hook"]
pub unsafe extern "C-unwind" fn __xtu__ZN21ACE_OS_Object_Manager11thread_hookEP15ACE_Thread_Hook(
    new_thread_hook: *mut ACE_Thread_Hook,
) -> *mut ACE_Thread_Hook {
    unsafe { ACE_OS_Object_Manager::thread_hook_u8ca6168bec16b970(new_thread_hook) }
}
#[export_name = "_ZN21ACE_OS_Object_ManagerC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN21ACE_OS_Object_ManagerC1Ev(
    __this: *mut ACE_OS_Object_Manager,
) {
    ACE_OS_Object_Manager::new_at(__this)
}
impl Drop for ACE_OS_Object_Manager {
    fn drop(&mut self) {
        {
            unsafe {
                let __this: *mut Self = self as *mut Self;
                {
                    (*::core::ptr::addr_of!((* __this).__base_0)
                        .cast::<ACE_Object_Manager_Base>()
                        .cast_mut())
                        .dynamically_allocated_ = false;
                    {
                        let __obj: *mut ACE_Object_Manager_Base = (__this)
                            as *mut ACE_Object_Manager_Base;
                        let __vt: *const __Vtbl_u06e4e36432e67f04 = *(__obj
                            as *const *const __Vtbl_u06e4e36432e67f04);
                        ((*__vt).vfn_ue800bfd5a4e8ffa3)(__obj)
        ...
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.exit_info_);
            ::core::mem::ManuallyDrop::drop(&mut self.__base_0);
        }
    }
}
#[export_name = "_ZN21ACE_OS_Object_Manager8instanceEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN21ACE_OS_Object_Manager8instanceEv() -> *mut ACE_OS_Object_Manager {
    unsafe { ACE_OS_Object_Manager::instance() }
}
#[export_name = "_ZN21ACE_OS_Object_Manager7at_exitEPFvvEPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN21ACE_OS_Object_Manager7at_exitEPFvvEPKc(
    __this: *mut ACE_OS_Object_Manager,
    func: Option<unsafe extern "C-unwind" fn()>,
    name: *const libc::c_char,
) -> libc::c_int {
    unsafe { ACE_OS_Object_Manager::at_exit(__this, func, name) }
}
#[export_name = "_ZN21ACE_OS_Object_Manager19print_error_messageEjPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN21ACE_OS_Object_Manager19print_error_messageEjPKc(
    line_number: libc::c_uint,
    message: *const libc::c_char,
) {
    unsafe { ACE_OS_Object_Manager::print_error_message(line_number, message) }
}
extern "C-unwind" {
...
pub(crate) static mut ACE_OS_Object_Manager_Manager_instance: ACE_OS_Object_Manager_Manager = unsafe {
    ::core::mem::MaybeUninit::<ACE_OS_Object_Manager_Manager>::zeroed().assume_init()
};
extern "C-unwind" {
...
impl ACE_OS_Object_Manager_Manager {
    ///Constructor.
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ::core::ptr::write(
            ...
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).saved_main_thread_id_),
                ACE_OS::thr_self(),
            );
            {
                {
                    let _ = <ACE_OS_Object_Manager>::instance();
                };
            }
            ()
        }
...
impl ACE_OS_Object_Manager {
    ...
    pub unsafe fn init(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((<ACE_Object_Manager_Base>::starting_up_i(
                    (::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                        ACE_Object_Manager_Base > ().cast_mut())
                    )) as *mut ACE_Object_Manager_Base,
                )) != 0)
                {
                    (*::core::ptr::addr_of!((* __this).__base_0)
                    ...
                    if ((((((__this) as *const u8))
                        == (((ACE_OS_Object_Manager_instance_) as *const u8)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        {
                            let mut obj_p: *mut pthread_mutex_t = ((0)
                                ...
                                'cont_0: loop {
                                    {
                                        {
                                            obj_p = {
                                                let mut __new: pthread_mutex_t = unsafe {
                                                    ::core::mem::MaybeUninit::<pthread_mutex_t>::zeroed()
                                                        .assume_init()
                                                };
                                                Box::into_raw(Box::new(__new))
                                            };
                                            if (((((obj_p).is_null()) as libc::c_int) as libc::c_int)
                                                != 0)
                                            {
                                                ((*(__errno_location()))) = 12;
                            ...
                            (ACE_OS_Object_Manager_preallocated_object)[(ACE_OS_MONITOR_LOCK)
                                as usize] = (obj_p as *mut libc::c_void);
                        }
                        if (((((ACE_OS::thread_mutex_init(
                            ((ACE_OS_Object_Manager_preallocated_object)[(ACE_OS_MONITOR_LOCK)
                                as usize] as *mut pthread_mutex_t),
                            0,
                            ...
                            as libc::c_int) != 0)
                        {
                            <ACE_OS_Object_Manager>::print_error_message(
                                ((228) as libc::c_uint),
                                ((b"ACE_OS_MONITOR_LOCK\0".as_ptr() as *const libc::c_char)
                        ...
                        }
                        {
                            ...
                            (ACE_OS_Object_Manager_preallocated_object)[(ACE_TSS_CLEANUP_LOCK)
                                as usize] = (obj_p as *mut libc::c_void);
                        }
                            ...
                            as libc::c_int) != 0)
                        {
                            <ACE_OS_Object_Manager>::print_error_message(
                                ((235) as libc::c_uint),
                                ((b"ACE_TSS_CLEANUP_LOCK\0".as_ptr() as *const libc::c_char)
                                    as *const libc::c_char),
                            );
                        }
                        {
                            ...
                            (ACE_OS_Object_Manager_preallocated_object)[(ACE_LOG_MSG_INSTANCE_LOCK)
                                as usize] = (obj_p as *mut libc::c_void);
                        }
                        if (((((ACE_OS::thread_mutex_init(
                            ((ACE_OS_Object_Manager_preallocated_object)[(ACE_LOG_MSG_INSTANCE_LOCK)
                            ...
                            as libc::c_int) != 0)
                        {
                            <ACE_OS_Object_Manager>::print_error_message(
                                ((242) as libc::c_uint),
                                ((b"ACE_LOG_MSG_INSTANCE_LOCK\0".as_ptr()
                                    as *const libc::c_char) as *const libc::c_char),
                            );
                        }
                        ACE_OS::socket_init(0, 0);
                        ACE_OS::set_exit_hook(
                            Some(ACE_OS_Object_Manager_Internal_Exit_Hook as _),
                        );
                    }
                    'dowhile_3: loop {
                        'cont_3: loop {
                            {
                                {
                                    (*__this).default_mask_ = {
                                        let mut __new: __sigset_t = unsafe {
                                            ::core::mem::MaybeUninit::<__sigset_t>::zeroed()
                                                .assume_init()
                                        };
                                        Box::into_raw(Box::new(__new))
                                    };
                                    if ((((((*__this).default_mask_).is_null()) as libc::c_int)
                                        as libc::c_int) != 0)
                                    {
                                        ((*(__errno_location()))) = 12;
                                        return (-((1) as libc::c_int));
                    ...
                    ACE_OS::sigfillset_ubda4b03e91b23d38((*__this).default_mask_);
                    (*::core::ptr::addr_of!((* __this).__base_0)
                        .cast::<ACE_Object_Manager_Base>()
                        .cast_mut())
                        .object_manager_state_ = ((OBJ_MAN_INITIALIZED) as libc::c_uint);
                    return 0;
                } else {
                    return 1;
                }
    ...
    pub unsafe fn fini(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((((((((ACE_OS_Object_Manager_instance_).is_null()) as libc::c_int)
                    as libc::c_int) != 0)
                ...
                {
                    return if ((((((*::core::ptr::addr_of!((* __this).__base_0)
                        .cast::<ACE_Object_Manager_Base>()
                        .cast_mut())
                        .object_manager_state_ as libc::c_uint))
                        == (((OBJ_MAN_SHUT_DOWN) as libc::c_uint))) as libc::c_int
                        as libc::c_int) != 0)
                    {
                        1
                    } else {
                ...
                (*::core::ptr::addr_of!((* __this).__base_0)
                    .cast::<ACE_Object_Manager_Base>()
                    .cast_mut())
                    .object_manager_state_ = ((OBJ_MAN_SHUTTING_DOWN) as libc::c_uint);
                ...
                {
                    {
                        let __obj: *mut ACE_Object_Manager_Base = ((*::core::ptr::addr_of!(
                            (* __this).__base_0
                        )
                            .cast::<ACE_Object_Manager_Base>()
                            .cast_mut())
                            .next_) as *mut ACE_Object_Manager_Base;
                        let __vt: *const __Vtbl_u06e4e36432e67f04 = *(__obj
                            as *const *const __Vtbl_u06e4e36432e67f04);
                        ((*__vt).vfn_ue800bfd5a4e8ffa3)(__obj)
                    };
                    (*::core::ptr::addr_of!((* __this).__base_0)
                        .cast::<ACE_Object_Manager_Base>()
                        .cast_mut())
                        .next_ = ((0) as *mut ACE_Object_Manager_Base);
                }
                <ACE_OS_Exit_Info>::call_hooks(
                    (::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).exit_info_) .cast:: <
                        ACE_OS_Exit_Info > ().cast_mut())
                    )) as *mut ACE_OS_Exit_Info,
                );
                if ((((((__this) as *const u8))
                    == (((ACE_OS_Object_Manager_instance_) as *const u8))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    ACE_OS::socket_fini();
                    ...
                    {
                        let __d = ((ACE_OS_Object_Manager_preallocated_object)[(ACE_OS_MONITOR_LOCK)
                            as usize] as *mut pthread_mutex_t);
                        if !__d.is_null() {
                            let _ = Box::from_raw(__d as *mut pthread_mutex_t);
                        }
                    };
                    (ACE_OS_Object_Manager_preallocated_object)[(ACE_OS_MONITOR_LOCK)
                        as usize] = ((0) as *mut libc::c_void);
                    ...
                    {
                        let __d = ((ACE_OS_Object_Manager_preallocated_object)[(ACE_TSS_CLEANUP_LOCK)
                            as usize] as *mut pthread_mutex_t);
                        if !__d.is_null() {
                            let _ = Box::from_raw(__d as *mut pthread_mutex_t);
                        }
                    ...
                    {
                        let __d = ((ACE_OS_Object_Manager_preallocated_object)[(ACE_LOG_MSG_INSTANCE_LOCK)
                            as usize] as *mut pthread_mutex_t);
                        if !__d.is_null() {
                            let _ = Box::from_raw(__d as *mut pthread_mutex_t);
                        }
                ...
                {
                    let __d = (*__this).default_mask_;
                    if !__d.is_null() {
                        let _ = Box::from_raw(__d as *mut __sigset_t);
                    }
                };
                (*__this).default_mask_ = ((0) as *mut __sigset_t);
                (*::core::ptr::addr_of!((* __this).__base_0)
                    .cast::<ACE_Object_Manager_Base>()
                    .cast_mut())
                    .object_manager_state_ = ((OBJ_MAN_SHUT_DOWN) as libc::c_uint);
                if (((*::core::ptr::addr_of!((* __this).__base_0)
                    .cast::<ACE_Object_Manager_Base>()
                    .cast_mut())
                    .dynamically_allocated_ as libc::c_int) != 0)
                {
                    {
                        let __p = __this;
                        if !__p.is_null() {
    ...
    pub unsafe fn starting_up() -> libc::c_int {
        unsafe {
            {
                return if (!(ACE_OS_Object_Manager_instance_).is_null()) {
                    <ACE_Object_Manager_Base>::starting_up_i(
                        (::core::ptr::addr_of_mut!(
                            (* ::core::ptr::addr_of!((* ACE_OS_Object_Manager_instance_)
                            .__base_0) .cast:: < ACE_Object_Manager_Base > ().cast_mut())
                        )) as *mut ACE_Object_Manager_Base,
                    )
                } else {
                    1
  ...
  /// ACE_Sig_Guard methods.*/
    ...
    pub unsafe fn thread_hook_u8ca6168bec16b970(
        ...
        unsafe {
            {
                let mut os_om: *mut ACE_OS_Object_Manager = <ACE_OS_Object_Manager>::instance();
                let mut old_hook: *mut ACE_Thread_Hook = (*os_om).thread_hook_;
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ...
            <ACE_Object_Manager_Base>::new_at(
                ::core::ptr::addr_of_mut!((* __this).__base_0)
                    .cast::<ACE_Object_Manager_Base>(),
            );
            *(__this as *mut *const ()) = &__VTBL_uff0c65993f46a4f5
                as *const __Vtbl_uff0c65993f46a4f5 as *const ();
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).default_mask_),
                ((0) as *mut __sigset_t),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).thread_hook_),
                ((0) as *mut ACE_Thread_Hook),
            );
            <ACE_OS_Exit_Info>::new_at(
                (::core::ptr::addr_of_mut!((* __this).exit_info_)
                    .cast::<ACE_OS_Exit_Info>()) as *mut ACE_OS_Exit_Info,
            );
            {
                if (((((ACE_OS_Object_Manager_instance_).is_null()) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    ACE_OS_Object_Manager_instance_ = __this;
                }
                {
                    let __obj: *mut ACE_Object_Manager_Base = (__this)
                        as *mut ACE_Object_Manager_Base;
                    let __vt: *const __Vtbl_u06e4e36432e67f04 = *(__obj
                        as *const *const __Vtbl_u06e4e36432e67f04);
                    ((*__vt).vfn_u2ae16bb83518d3fd)(__obj)
                };
            }
            ()
        }
        ...
        unsafe {
            {
                if (((((ACE_OS_Object_Manager_instance_).is_null()) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    let mut instance_pointer: *mut ACE_OS_Object_Manager = ((0)
                        as *mut ACE_OS_Object_Manager);
                    'dowhile_0: loop {
                        'cont_0: loop {
                            {
                                {
                                    instance_pointer = {
                                        let __new: *mut ACE_OS_Object_Manager = Box::into_raw(
                                            Box::new(
                                                ::core::mem::MaybeUninit::<ACE_OS_Object_Manager>::zeroed()
                                                    .assume_init(),
                                            ),
                                        );
                                        <ACE_OS_Object_Manager>::new_at(
                                            (__new) as *mut ACE_OS_Object_Manager,
                                        );
                                        __new
                                    };
                                    if (((((instance_pointer).is_null()) as libc::c_int)
                                        as libc::c_int) != 0)
                                    {
                                        ((*(__errno_location()))) = 12;
                                        return ((0) as *mut ACE_OS_Object_Manager);
                                    }
                                }
                            }
                            #[allow(unreachable_code)] break 'cont_0;
                    ...
                    (*::core::ptr::addr_of!((* instance_pointer).__base_0)
                        .cast::<ACE_Object_Manager_Base>()
                        .cast_mut())
                        .dynamically_allocated_ = true;
                }
                return ACE_OS_Object_Manager_instance_;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    ...
    pub unsafe fn at_exit(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return <ACE_OS_Exit_Info>::at_exit_i(
                    (::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).exit_info_) .cast:: <
                        ACE_OS_Exit_Info > ().cast_mut())
                    )) as *mut ACE_OS_Exit_Info,
                    ((::core::ptr::addr_of_mut!(ace_exit_hook_marker)
        ...
        unsafe {
            {
                fprintf(
                    ...
                    ((b"ace/Object_Manager_Base.cpp, line %u: %s \0".as_ptr()
                        as *const libc::c_char) as *const libc::c_char),
                    line_number,
                    message,
                );
...
unsafe extern "C-unwind" fn __rt_static_init() {
    ::core::ptr::write(
        ::core::ptr::addr_of_mut!(ACE_OS_Object_Manager_Manager_instance),
        <ACE_OS_Object_Manager_Manager>::new(),
    );
}
#[used]
