...
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Token_Queue_Entry {
    pub next_: *mut ACE_Token_Queue_Entry,
    pub thread_id_: libc::c_ulong,
    pub cv_: ::core::mem::ManuallyDrop<ACE_Condition_ACE_Thread_Mutex_>,
    pub runable_: libc::c_int,
}
impl Drop for ACE_Token_Queue_Entry {
    fn drop(&mut self) {
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.cv_);
        }
    }
}
#[export_name = "_ZN9ACE_Token21ACE_Token_Queue_EntryC1ER16ACE_Thread_Mutexm"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Token21ACE_Token_Queue_EntryC1ER16ACE_Thread_Mutexm(
    __this: *mut ACE_Token_Queue_Entry,
    __a0: *mut ACE_Thread_Mutex,
    __a1: libc::c_ulong,
) {
    ACE_Token_Queue_Entry::new_at(__this, __a0, __a1)
}
#[export_name = "_ZN9ACE_Token21ACE_Token_Queue_EntryC1ER16ACE_Thread_MutexmR24ACE_Condition_Attributes"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Token21ACE_Token_Queue_EntryC1ER16ACE_Thread_MutexmR24ACE_Condition_Attributes(
    __this: *mut ACE_Token_Queue_Entry,
    __a0: *mut ACE_Thread_Mutex,
    __a1: libc::c_ulong,
    __a2: *mut ACE_Condition_Attributes,
) {
    ACE_Token_Queue_Entry::new_at_u288e0ccf895ba59f(__this, __a0, __a1, __a2)
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ACE_Token_Queue {
    pub head_: *mut ACE_Token_Queue_Entry,
    pub tail_: *mut ACE_Token_Queue_Entry,
}
#[export_name = "_ZN9ACE_Token15ACE_Token_QueueC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Token15ACE_Token_QueueC1Ev(
    __this: *mut ACE_Token_Queue,
) {
    ACE_Token_Queue::new_at(__this)
}
#[export_name = "_ZN9ACE_Token15ACE_Token_Queue12remove_entryEPNS_21ACE_Token_Queue_EntryE"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Token15ACE_Token_Queue12remove_entryEPNS_21ACE_Token_Queue_EntryE(
    __this: *mut ACE_Token_Queue,
    entry: *mut ACE_Token_Queue_Entry,
) {
    unsafe { ACE_Token_Queue::remove_entry(__this, entry) }
}
#[export_name = "_ZN9ACE_Token15ACE_Token_Queue12insert_entryERNS_21ACE_Token_Queue_EntryEi"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Token15ACE_Token_Queue12insert_entryERNS_21ACE_Token_Queue_EntryEi(
    __this: *mut ACE_Token_Queue,
    entry: *mut ACE_Token_Queue_Entry,
    requeue_position: libc::c_int,
) {
    unsafe { ACE_Token_Queue::insert_entry(__this, entry, requeue_position) }
}
...
#[repr(C)]
#[derive(Clone)]
pub struct ACE_Token {
    pub vptr: *const (),
    pub writers_: ACE_Token_Queue,
    pub readers_: ACE_Token_Queue,
    pub lock_: ::core::mem::ManuallyDrop<ACE_Thread_Mutex>,
    pub owner_: libc::c_ulong,
    pub in_use_: libc::c_int,
    pub waiters_: libc::c_int,
    pub nesting_level_: libc::c_int,
    pub attributes_: ::core::mem::ManuallyDrop<ACE_Condition_Attributes>,
    pub queueing_strategy_: libc::c_int,
}
#[export_name = "_ZN9ACE_TokenC1EPKcPv"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_TokenC1EPKcPv(
    __this: *mut ACE_Token,
    __a0: *const libc::c_char,
    __a1: *mut libc::c_void,
) {
    ACE_Token::new_at(__this, __a0, __a1)
}
impl Drop for ACE_Token {
    fn drop(&mut self) {
        {
            unsafe {
                let __this: *mut Self = self as *mut Self;
        ...
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.attributes_);
            ::core::mem::ManuallyDrop::drop(&mut self.lock_);
        }
    }
}
#[export_name = "_ZN9ACE_Token7acquireEPFvPvES0_P14ACE_Time_Value"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Token7acquireEPFvPvES0_P14ACE_Time_Value(
    __this: *mut ACE_Token,
    sleep_hook_func: Option<unsafe extern "C-unwind" fn(*mut libc::c_void)>,
    arg: *mut libc::c_void,
    timeout: *mut ACE_Time_Value,
) -> libc::c_int {
    unsafe { ACE_Token::acquire(__this, sleep_hook_func, arg, timeout) }
}
#[export_name = "_ZN9ACE_Token7acquireEP14ACE_Time_Value"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Token7acquireEP14ACE_Time_Value(
    __this: *mut ACE_Token,
    timeout: *mut ACE_Time_Value,
) -> libc::c_int {
    unsafe { ACE_Token::acquire_ua8f05409cdfbc908(__this, timeout) }
}
#[export_name = "_ZN9ACE_Token10sleep_hookEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Token10sleep_hookEv(
    __this: *mut ACE_Token,
) {
    unsafe { ACE_Token::sleep_hook(__this) }
}
#[export_name = "_ZN9ACE_Token5renewEiP14ACE_Time_Value"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Token5renewEiP14ACE_Time_Value(
    __this: *mut ACE_Token,
    requeue_position: libc::c_int,
    timeout: *mut ACE_Time_Value,
) -> libc::c_int {
    unsafe { ACE_Token::renew(__this, requeue_position, timeout) }
}
#[export_name = "_ZN9ACE_Token7releaseEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Token7releaseEv(
    __this: *mut ACE_Token,
) -> libc::c_int {
    unsafe { ACE_Token::release(__this) }
}
#[export_name = "_ZNK9ACE_Token4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK9ACE_Token4dumpEv(__this: *const ACE_Token) {
    unsafe { ACE_Token::dump(__this) }
}
#[export_name = "_ZN9ACE_Token14shared_acquireEPFvPvES0_P14ACE_Time_ValueNS_17ACE_Token_Op_TypeE"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Token14shared_acquireEPFvPvES0_P14ACE_Time_ValueNS_17ACE_Token_Op_TypeE(
    __this: *mut ACE_Token,
    sleep_hook_func: Option<unsafe extern "C-unwind" fn(*mut libc::c_void)>,
    arg: *mut libc::c_void,
    timeout: *mut ACE_Time_Value,
    ...
    unsafe { ACE_Token::shared_acquire(__this, sleep_hook_func, arg, timeout, op_type) }
}
#[export_name = "_ZN9ACE_Token18wakeup_next_waiterEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN9ACE_Token18wakeup_next_waiterEv(
    __this: *mut ACE_Token,
) {
    unsafe { ACE_Token::wakeup_next_waiter(__this) }
}
...
impl ACE_Token {
    ...
    pub unsafe fn new_at(
        ...
        unsafe {
            ...
            *(__this as *mut *const ()) = &__VTBL_u1c02a40e1ed46250
                as *const __Vtbl_u1c02a40e1ed46250 as *const ();
            <ACE_Thread_Mutex>::new_at(
                (::core::ptr::addr_of_mut!((* __this).lock_).cast::<ACE_Thread_Mutex>())
                    as *mut ACE_Thread_Mutex,
                name,
                (any as *mut pthread_mutexattr_t),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).owner_),
                ACE_OS::NULL_thread,
            );
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).in_use_), 0);
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).waiters_), 0);
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).nesting_level_), 0);
            <ACE_Condition_Attributes>::new_at(
                (::core::ptr::addr_of_mut!((* __this).attributes_)
                    .cast::<ACE_Condition_Attributes>())
                    as *mut ACE_Condition_Attributes,
                (((0 as libc::c_int)) as libc::c_int),
            );
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).queueing_strategy_),
                ((FIFO) as libc::c_int),
            );
            <ACE_Token_Queue>::new_at(::core::ptr::addr_of_mut!((* __this).writers_));
            <ACE_Token_Queue>::new_at(::core::ptr::addr_of_mut!((* __this).readers_));
            {}
            ()
        }
    }
    ...
    pub unsafe fn queueing_strategy(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (*__this).queueing_strategy_;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    ///Set the queueing strategy.
    pub unsafe fn queueing_strategy_uae7d00ec304c85ee(
        __this: *mut Self,
        mut queueing_strategy: libc::c_int,
    ) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                (*__this).queueing_strategy_ = if (((((queueing_strategy as libc::c_int))
                    == ((((-((1) as libc::c_int))) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    (-((1) as libc::c_int))
    ...
    pub unsafe fn acquire(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return <ACE_Token>::shared_acquire(
                    (__this) as *mut ACE_Token,
                    sleep_hook_func,
                    arg,
                    timeout,
                    ((WRITE_TOKEN) as libc::c_uint),
                );
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    #[doc = "* This behaves just like the previous <acquire> method, except that\n   * it invokes the virtual function called <sleep_hook> that can be\n   * overridden by a subclass of ACE_Token."]
    pub unsafe fn acquire_ua8f05409cdfbc908(
        __this: *mut Self,
        mut timeout: *mut ACE_Time_Value,
    ) -> libc::c_int {
        unsafe {
    ...
    #[doc = "* This should be overridden by a subclass to define the appropriate\n   * behavior before <acquire> goes to sleep.  By default, this is a\n   * no-op..."]
    pub unsafe fn sleep_hook(__this: *mut Self) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {}
            ()
    ...
    pub unsafe fn renew(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                if ((((((((((*__this).writers_.head_).is_null()) as libc::c_int)
                    as libc::c_int) != 0)
                    && (((((((((((*__this).in_use_ as libc::c_int))
                        == (((WRITE_TOKEN) as libc::c_int))) as libc::c_int
                        as libc::c_int) != 0)
                        || ((((((*__this).readers_.head_).is_null()) as libc::c_int)
                            as libc::c_int) != 0)) as libc::c_int)) as libc::c_int)
                        != 0)) as libc::c_int) as libc::c_int) != 0)
                {
                    return 0;
                }
                let mut this_threads_queue: *mut ACE_Token_Queue = ((if ((((((*__this)
                    .in_use_ as libc::c_int)) == (((READ_TOKEN) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    ::core::ptr::addr_of_mut!((* __this).readers_)
                        as *mut ACE_Token_Queue
                } else {
                    ::core::ptr::addr_of_mut!((* __this).writers_)
                        as *mut ACE_Token_Queue
                }) as *mut ACE_Token_Queue);
                let mut my_entry: ACE_Token_Queue_Entry = ::core::mem::MaybeUninit::<
                    ACE_Token_Queue_Entry,
                >::zeroed()
                    .assume_init();
                <ACE_Token_Queue_Entry>::new_at(
                    (::core::ptr::addr_of_mut!(my_entry)) as *mut ACE_Token_Queue_Entry,
                    ::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).lock_) .cast:: <
                        ACE_Thread_Mutex > ().cast_mut())
                    ),
                ...
                <ACE_Token_Queue>::insert_entry(
                    (this_threads_queue) as *mut ACE_Token_Queue,
                    ::core::ptr::addr_of_mut!(my_entry),
                    if (((((requeue_position as libc::c_int)) == (((0) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        0
                    } else {
                        (*__this).queueing_strategy_
                    },
                );
                {
                    let __lv = &mut ((*__this).waiters_);
                    *__lv = (*__lv).wrapping_add(1);
                    *__lv
                };
                let mut save_nesting_level_: libc::c_int = (((*__this).nesting_level_)
                    as libc::c_int);
                (*__this).nesting_level_ = 0;
                <ACE_Token>::wakeup_next_waiter((__this) as *mut ACE_Token);
                ...
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            {
                                let mut result: libc::c_int = ((<ACE_Token_Queue_Entry>::wait(
                                    (::core::ptr::addr_of_mut!(my_entry))
                                        as *mut ACE_Token_Queue_Entry,
                                    timeout,
                                    ::core::ptr::addr_of_mut!(
                                        (* ::core::ptr::addr_of!((* __this).lock_) .cast:: <
                                        ACE_Thread_Mutex > ().cast_mut())
                    ...
                    if !((((!(((ACE_OS::thr_equal(my_entry.thread_id_, (*__this).owner_))
                        != 0)) as libc::c_int) as libc::c_int) != 0))
                    {
                        break 'dowhile_0;
                    }
                ...
                <ACE_Token_Queue>::remove_entry(
                    (this_threads_queue) as *mut ACE_Token_Queue,
                    ::core::ptr::addr_of_mut!(my_entry) as *mut ACE_Token_Queue_Entry,
                );
                if ((timed_out as libc::c_int) != 0) {
                    if ((my_entry.runable_) != 0) {
                        <ACE_Token>::wakeup_next_waiter((__this) as *mut ACE_Token);
                    }
                    return (-((1) as libc::c_int));
                } else {
                ...
                (if (((my_entry.runable_)) != 0) {
                    ...
                    __ace_assert(
                        ((b"/build/ace_full/src/ACE/ace/Token.cpp\0".as_ptr()
                            as *const libc::c_char) as *const libc::c_char),
                        463,
                        ((b"my_entry.runable_\0".as_ptr() as *const libc::c_char)
                            as *const libc::c_char),
                    )
                });
                (*__this).nesting_level_ = ((save_nesting_level_) as libc::c_int);
                return 0;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return <ACE_Token>::shared_acquire(
                    ...
                    None,
                    ((0) as *mut libc::c_void),
                    (::core::ptr::addr_of!(ACE_Time_Value_zero) as *const ACE_Time_Value
    ...
    pub unsafe fn release(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                if ((((((*__this).nesting_level_ as libc::c_int))
                    > (((0) as libc::c_int))) as libc::c_int as libc::c_int) != 0)
                {
                    {
                        let __lv = &mut ((*__this).nesting_level_);
                        *__lv = (*__lv).wrapping_sub(1);
                        *__lv
                    };
                } else {
  ...
  /// what's commonly expected for readers/writer locks.  See the class
  /// documentation above for more details.*/
    pub unsafe fn acquire_read_u7bdc0555342740a3(
        __this: *mut Self,
        mut sleep_hook_func: Option<unsafe extern "C-unwind" fn(*mut libc::c_void)>,
        mut arg: *mut libc::c_void,
        mut timeout: *mut ACE_Time_Value,
    ...
    ///Calls acquire().
    pub unsafe fn acquire_write_u3a72071d227489fe(
        __this: *mut Self,
        mut sleep_hook_func: Option<unsafe extern "C-unwind" fn(*mut libc::c_void)>,
        mut arg: *mut libc::c_void,
        mut timeout: *mut ACE_Time_Value,
  ...
  /// the token.*/
    pub unsafe fn waiters(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut ace_mon: ACE_Guard_ACE_Thread_Mutex_ = ::core::mem::MaybeUninit::<
                ...
                let mut ret: libc::c_int = (((*__this).waiters_) as libc::c_int);
    ...
    pub unsafe fn current_owner(__this: *mut Self) -> libc::c_ulong {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut ace_mon: ACE_Guard_ACE_Thread_Mutex_ = ::core::mem::MaybeUninit::<
    ...
    pub unsafe fn shared_acquire(
        __this: *mut Self,
        mut sleep_hook_func: Option<unsafe extern "C-unwind" fn(*mut libc::c_void)>,
        mut arg: *mut libc::c_void,
        mut timeout: *mut ACE_Time_Value,
        mut op_type: libc::c_uint,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                let mut thr_id: libc::c_ulong = ((<ACE_Thread>::self_u2ee556c73b662daa())
                    as libc::c_ulong);
                if (((!((((*__this).in_use_) != 0)) as libc::c_int) as libc::c_int) != 0)
                {
                    (*__this).in_use_ = ((op_type) as libc::c_int);
                    (*__this).owner_ = ((thr_id) as libc::c_ulong);
                    return 0;
                }
                if ((ACE_OS::thr_equal(((thr_id) as libc::c_ulong), (*__this).owner_))
                    != 0)
                {
                    {
                        let __lv = &mut ((*__this).nesting_level_);
                ...
                let mut queue: *mut ACE_Token_Queue = (if (((((op_type as libc::c_uint))
                    == (((READ_TOKEN) as libc::c_uint))) as libc::c_int as libc::c_int)
                    != 0)
                {
                    ::core::ptr::addr_of_mut!((* __this).readers_)
                        as *mut ACE_Token_Queue
                ...
                >::zeroed()
                    .assume_init();
                <ACE_Token_Queue_Entry>::new_at_u288e0ccf895ba59f(
                    (::core::ptr::addr_of_mut!(my_entry)) as *mut ACE_Token_Queue_Entry,
                    ::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).lock_) .cast:: <
                        ACE_Thread_Mutex > ().cast_mut())
                    ...
                    ::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).attributes_) .cast:: <
                        ACE_Condition_Attributes > ().cast_mut())
                    ),
                );
                <ACE_Token_Queue>::insert_entry(
                    (queue) as *mut ACE_Token_Queue,
                    ::core::ptr::addr_of_mut!(my_entry),
                    (*__this).queueing_strategy_,
                );
                {
                ...
                if ((sleep_hook_func).is_some()) {
                    (((sleep_hook_func)).expect("null function pointer"))(arg);
                    {
                        let __lv = &mut (ret);
                        *__lv = (*__lv).wrapping_add(1);
                        *__lv
                    ...
                    {
                        let __obj: *mut ACE_Token = (__this) as *mut ACE_Token;
                        let __vt: *const __Vtbl_u1c02a40e1ed46250 = *(__obj
                            as *const *const __Vtbl_u1c02a40e1ed46250);
                        ((*__vt).vfn_uf00a146eed0d3242)(__obj)
                    };
                    {
                        let __lv = &mut (ret);
                        *__lv = (*__lv).wrapping_add(1);
    ...
    pub unsafe fn wakeup_next_waiter(__this: *mut Self) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                (*__this).owner_ = ACE_OS::NULL_thread;
                (*__this).in_use_ = 0;
                if ((((((((((*__this).writers_.head_).is_null()) as libc::c_int)
                    as libc::c_int) != 0)
                    && ((((((*__this).readers_.head_).is_null()) as libc::c_int)
                ...
                let mut queue: *mut ACE_Token_Queue = ((0) as *mut ACE_Token_Queue);
                if ((((!((*__this).writers_.head_).is_null()) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    (*__this).in_use_ = ((WRITE_TOKEN) as libc::c_int);
                    queue = ::core::ptr::addr_of_mut!((* __this).writers_)
                        as *mut ACE_Token_Queue;
                } else {
                    (*__this).in_use_ = ((READ_TOKEN) as libc::c_int);
                    queue = ::core::ptr::addr_of_mut!((* __this).readers_)
                        as *mut ACE_Token_Queue;
                }
                (*(*queue).head_).runable_ = 1;
                <ACE_Token_Queue_Entry>::signal(
                    ((*queue).head_) as *mut ACE_Token_Queue_Entry,
                );
                (*__this).owner_ = (*(*queue).head_).thread_id_;
            }
            ()
        }
    }
}
impl ACE_Token_Queue_Entry {
    ///Constructor
    pub unsafe fn new_at(
        __this: *mut Self,
        mut m: *mut ACE_Thread_Mutex,
        ...
        unsafe {
            ...
            ::core::ptr::write(
                ...
                ((0) as *mut ACE_Token_Queue_Entry),
            );
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).thread_id_), t_id);
            <ACE_Condition_ACE_Thread_Mutex_>::new_at(
                (::core::ptr::addr_of_mut!((* __this).cv_)
            ...
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).runable_), 0);
            {}
            ()
        }
    }
    pub unsafe fn new(mut __a0: *mut ACE_Thread_Mutex, mut __a1: libc::c_ulong) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at(::core::ptr::addr_of_mut!(__obj), __a0, __a1);
        __obj
    }
    ///Constructor using a pre-allocated attributes
    pub unsafe fn new_at_u288e0ccf895ba59f(
        __this: *mut Self,
        mut m: *mut ACE_Thread_Mutex,
        mut t_id: libc::c_ulong,
        mut attributes: *mut ACE_Condition_Attributes,
    ) {
        unsafe {
            ::core::ptr::write(
                __this,
    ...
    pub unsafe fn new_u288e0ccf895ba59f(
        mut __a0: *mut ACE_Thread_Mutex,
        mut __a1: libc::c_ulong,
        mut __a2: *mut ACE_Condition_Attributes,
    ) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_u288e0ccf895ba59f(
            ::core::ptr::addr_of_mut!(__obj),
            __a0,
            __a1,
            __a2,
    ...
    pub unsafe fn wait(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                return <ACE_Condition_ACE_Thread_Mutex_>::wait(
                    (::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).cv_) .cast:: <
    ...
    pub unsafe fn signal(__this: *mut Self) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return <ACE_Condition_ACE_Thread_Mutex_>::signal(
                    (::core::ptr::addr_of_mut!(
                        (* ::core::ptr::addr_of!((* __this).cv_) .cast:: <
                        ACE_Condition_ACE_Thread_Mutex_ > ().cast_mut())
                    )) as *mut ACE_Condition_ACE_Thread_Mutex_,
...
impl ACE_Token_Queue {
    ...
    pub unsafe fn remove_entry(
        __this: *mut Self,
        mut entry: *mut ACE_Token_Queue_Entry,
    ) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut curr: *mut ACE_Token_Queue_Entry = ((0)
                    as *mut ACE_Token_Queue_Entry);
                let mut prev: *mut ACE_Token_Queue_Entry = ((0)
                    as *mut ACE_Token_Queue_Entry);
                ...
                }
                {
                    ...
                    'for_0: loop {
                        if !(((((((((!(curr).is_null()) as libc::c_int) as libc::c_int)
                            != 0)
                            && ((((((curr) as *const u8)) != (((entry) as *const u8)))
                ...
                if (((((curr).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    return;
                } else {
                    if (((((prev).is_null()) as libc::c_int) as libc::c_int) != 0) {
                        (*__this).head_ = (*(*__this).head_).next_;
                    } else {
                        (*prev).next_ = (*curr).next_;
                    }
                }
                if ((((((*curr).next_).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    (*__this).tail_ = prev;
                }
            }
            ()
    ...
    pub unsafe fn insert_entry(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((((*__this).head_).is_null()) as libc::c_int) as libc::c_int) != 0)
                {
                    (*__this).head_ = ((::core::ptr::addr_of_mut!((* entry))
                        as *mut ACE_Token_Queue_Entry) as *mut ACE_Token_Queue_Entry);
                    (*__this).tail_ = ((::core::ptr::addr_of_mut!((* entry))
                        as *mut ACE_Token_Queue_Entry) as *mut ACE_Token_Queue_Entry);
                } else {
                    if (((((requeue_position as libc::c_int))
                        == ((((-((1) as libc::c_int))) as libc::c_int))) as libc::c_int
                        as libc::c_int) != 0)
                    {
                        (*(*__this).tail_).next_ = ((::core::ptr::addr_of_mut!((* entry))
                            as *mut ACE_Token_Queue_Entry)
                            as *mut ACE_Token_Queue_Entry);
                        (*__this).tail_ = ((::core::ptr::addr_of_mut!((* entry))
                            as *mut ACE_Token_Queue_Entry)
                        ...
                        if (((((requeue_position as libc::c_int))
                            ...
                            != 0)
                        {
                            (*entry).next_ = (*__this).head_;
                            (*__this).head_ = ((::core::ptr::addr_of_mut!((* entry))
                                as *mut ACE_Token_Queue_Entry)
                                as *mut ACE_Token_Queue_Entry);
                        } else {
                            let mut insert_after: *mut ACE_Token_Queue_Entry = (((*__this)
                                .head_) as *mut ACE_Token_Queue_Entry);
                            'while_0: loop {
                                if !((((((({
                                    let __lv = &mut (requeue_position);
                                    let __r = *__lv;
                                    *__lv = (*__lv).wrapping_sub(1);
                                    __r
                                }) != 0)
                                    && ((((!((*insert_after).next_).is_null()) as libc::c_int)
                                        as libc::c_int) != 0)) as libc::c_int) as libc::c_int)
                                    != 0))
                                {
                                    break 'while_0;
                            ...
                            if ((((((*entry).next_).is_null()) as libc::c_int)
                                as libc::c_int) != 0)
                            {
                                (*__this).tail_ = ((::core::ptr::addr_of_mut!((* entry))
                                    as *mut ACE_Token_Queue_Entry)
                            ...
                            (*insert_after).next_ = ((::core::ptr::addr_of_mut!(
                                (* entry)
                            ) as *mut ACE_Token_Queue_Entry)
                                as *mut ACE_Token_Queue_Entry);
                        }
...
pub unsafe fn __vdtor_u1c02a40e1ed46250(__this: *mut ACE_Token) {
    let _ = Box::from_raw(__this as *mut ACE_Token);
}
pub unsafe fn __vthunk_ouf00a146eed0d3242_iuf00a146eed0d3242(__this: *mut ACE_Token) {
    <ACE_Token>::sleep_hook((__this as *mut ACE_Token))
}
#[repr(C)]
pub struct __Vtbl_u1c02a40e1ed46250 {
    pub __type_info: &'static crate::__cxx_std::TypeInfo,
    pub __vdtor: unsafe fn(*mut ACE_Token),
    pub vfn_uf00a146eed0d3242: unsafe fn(*mut ACE_Token),
}
pub static __VTBL_u1c02a40e1ed46250: __Vtbl_u1c02a40e1ed46250 = __Vtbl_u1c02a40e1ed46250 {
    __type_info: &__TYPEINFO_9ACE_Token,
    __vdtor: __vdtor_u1c02a40e1ed46250,
    vfn_uf00a146eed0d3242: __vthunk_ouf00a146eed0d3242_iuf00a146eed0d3242,
};
