...
#[export_name = "_ZN10ACE_Thread7spawn_nEmPFPvS0_ES0_llPS0_PmP18ACE_Thread_AdapterPPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN10ACE_Thread7spawn_nEmPFPvS0_ES0_llPS0_PmP18ACE_Thread_AdapterPPKc(
    n: libc::c_ulong,
...
#[export_name = "_ZN10ACE_Thread7spawn_nEPmmPFPvS1_ES1_llPS1_S0_S0_P18ACE_Thread_AdapterPPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN10ACE_Thread7spawn_nEPmmPFPvS1_ES1_llPS1_S0_S0_P18ACE_Thread_AdapterPPKc(
    ...
    unsafe {
        ACE_Thread::spawn_n_u809bafb34e21c2cf(
            thread_ids,
            n,
            func,
            arg,
                ...
                let mut i: libc::c_ulong = unsafe { ::core::mem::zeroed() };
                {
                    ...
                    'for_0: loop {
                        ...
                        'cont_0: loop {
                            {
                                {
                                    let mut t_id: libc::c_ulong = unsafe {
                                        ::core::mem::zeroed()
                                    };
                                    if (((((ACE_OS::thr_create(
                                        ...
                                        arg,
                                        flags,
                                        ::core::ptr::addr_of_mut!(t_id) as *mut libc::c_ulong,
                                        ((0) as *mut libc::c_ulong),
                                        priority,
                                        if (((((stack).is_null()) as libc::c_int) as libc::c_int)
                                            != 0)
                                        {
                                            ((0) as *mut libc::c_void)
                                        } else {
                                            (*(stack).wrapping_offset((i) as isize))
                                        },
                                        if (((((stack_size).is_null()) as libc::c_int)
                                            as libc::c_int) != 0)
                                        {
                                            ((0) as libc::c_ulong)
                                        } else {
                                            (*(stack_size).wrapping_offset((i) as isize))
                                        },
                                        ((thread_adapter) as *mut ACE_Base_Thread_Adapter),
                                        if (((((thr_name).is_null()) as libc::c_int) as libc::c_int)
                                            != 0)
                                        {
                                            ((0) as *mut *const libc::c_char)
                                        } else {
                                            ::core::ptr::addr_of_mut!(
                                                (* (thr_name).wrapping_offset((i) as isize))
                            ...
                            {
                                {
                                    ...
                                    let mut t_handle: libc::c_ulong = unsafe {
                                        ::core::mem::zeroed()
                                    };
                                    let mut result: libc::c_int = ((ACE_OS::thr_create(
                                        func,
                                        arg,
                                        flags,
                                        ::core::ptr::addr_of_mut!(t_id) as *mut libc::c_ulong,
                                        ::core::ptr::addr_of_mut!(t_handle) as *mut libc::c_ulong,
                                        priority,
                                        if (((((stack).is_null()) as libc::c_int) as libc::c_int)
                                            != 0)
                                        {
                                    ...
                                    if (((((result as libc::c_int)) == (((0) as libc::c_int)))
                                        as libc::c_int as libc::c_int) != 0)
                                    {
                                        if ((((!(thread_ids).is_null()) as libc::c_int)
                                            as libc::c_int) != 0)
                                        {
                                            (*(thread_ids).wrapping_offset((i) as isize)) = t_id;
                                        }
                                        if ((((!(thread_handles).is_null()) as libc::c_int)
                                            as libc::c_int) != 0)
                                        {
                                            (*(thread_handles).wrapping_offset((i) as isize)) = t_handle;
                                        }
                                    } else {
                                        break 'for_0;
                                    }
