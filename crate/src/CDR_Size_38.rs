...
pub mod ACE_Utils {
    ...
    #[repr(C)]
    #[derive(Copy, Clone)]
    pub struct Truncator_unsigned_long__unsigned_int_ {}
    impl Truncator_unsigned_long__unsigned_int_ {
    ...
    /// the value is larger than the maximum of value of type @c TO.*/
        pub unsafe fn operator_call(
            ...
            unsafe {
                ...
                {
                    return (if ((<Fast_Comparator_unsigned_long__unsigned_long_>::greater_than(
                        val,
                        ((<super::ACE_Numeric_Limits_unsigned_int_>::max())
                            as libc::c_ulong),
                    ) as libc::c_int) != 0)
                    {
                        <super::ACE_Numeric_Limits_unsigned_int_>::max()
        ...
        pub unsafe fn new_at_sdd844258bb11112d(__this: *mut Self) {
            unsafe {
                ::core::ptr::write(
                    __this,
    ...
    #[export_name = "_ZN9ACE_Utils13truncate_castIjmEET_T0_"]
    pub unsafe extern "C-unwind" fn truncate_cast___unsigned_long__ue27a31e3ddf7f306(
        mut val: libc::c_ulong,
    ) -> libc::c_uint {
        unsafe {
            {
                return <Truncator_unsigned_long__unsigned_int_>::operator_call(
                    (((&mut ({
                        let mut __recv: Truncator_unsigned_long__unsigned_int_ = <Truncator_unsigned_long__unsigned_int_>::new_sdd844258bb11112d();
                        __recv
                    })) as *mut Truncator_unsigned_long__unsigned_int_))
                        as *mut Truncator_unsigned_long__unsigned_int_,
                    val,
                );
            }
...
#[doc = "* @class ACE_SizeCDR\n *\n * @brief A CDR stream for calculating size of the representation."]
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ACE_SizeCDR {
    pub good_bit_: bool,
    pub size_: libc::c_ulong,
    pub major_version_: libc::c_uchar,
    pub minor_version_: libc::c_uchar,
}
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_SizeCDRC1Ehh(
    __this: *mut ACE_SizeCDR,
    __a0: libc::c_uchar,
    __a1: libc::c_uchar,
) {
    ACE_SizeCDR::new_at(__this, __a0, __a1)
}
#[export_name = "_ZN11ACE_SizeCDR11write_wcharEw"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_SizeCDR11write_wcharEw(
    __this: *mut ACE_SizeCDR,
    x: libc::wchar_t,
) -> bool {
    unsafe { ACE_SizeCDR::write_wchar(__this, x) }
}
#[export_name = "_ZN11ACE_SizeCDR12write_stringEjPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_SizeCDR12write_stringEjPKc(
    __this: *mut ACE_SizeCDR,
    len: libc::c_uint,
    x: *const libc::c_char,
) -> bool {
    unsafe { ACE_SizeCDR::write_string_u3adb8d471a77ccb5(__this, len, x) }
}
#[export_name = "_ZN11ACE_SizeCDR12write_stringERK15ACE_String_BaseIcE"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_SizeCDR12write_stringERK15ACE_String_BaseIcE(
    __this: *mut ACE_SizeCDR,
    x: *const ACE_String_Base_char_,
) -> bool {
    unsafe { ACE_SizeCDR::write_string_u1382d72d65976c36(__this, x) }
}
#[export_name = "_ZN11ACE_SizeCDR13write_wstringEjPKw"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_SizeCDR13write_wstringEjPKw(
    __this: *mut ACE_SizeCDR,
    len: libc::c_uint,
    x: *const libc::wchar_t,
) -> bool {
    unsafe { ACE_SizeCDR::write_wstring_ubb6a44741a6c320e(__this, len, x) }
}
#[export_name = "_ZN11ACE_SizeCDR19write_boolean_arrayEPKbj"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_SizeCDR19write_boolean_arrayEPKbj(
    __this: *mut ACE_SizeCDR,
    _anon_0: *const bool,
    length: libc::c_uint,
) -> bool {
    unsafe { ACE_SizeCDR::write_boolean_array(__this, _anon_0, length) }
}
#[export_name = "_ZN11ACE_SizeCDR6adjustEm"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_SizeCDR6adjustEm(
    __this: *mut ACE_SizeCDR,
    size: libc::c_ulong,
) {
    unsafe { ACE_SizeCDR::adjust(__this, size) }
}
#[export_name = "_ZN11ACE_SizeCDR6adjustEmm"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_SizeCDR6adjustEmm(
    __this: *mut ACE_SizeCDR,
    size: libc::c_ulong,
    align: libc::c_ulong,
) {
    unsafe { ACE_SizeCDR::adjust_ubcb45e88c3f59dd0(__this, size, align) }
}
#[export_name = "_ZN11ACE_SizeCDR7write_1EPKh"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_SizeCDR7write_1EPKh(
    __this: *mut ACE_SizeCDR,
    _anon_0: *const libc::c_uchar,
) -> bool {
    unsafe { ACE_SizeCDR::write_1(__this, _anon_0) }
}
#[export_name = "_ZN11ACE_SizeCDR7write_2EPKt"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_SizeCDR7write_2EPKt(
    __this: *mut ACE_SizeCDR,
    _anon_0: *const libc::c_ushort,
) -> bool {
    unsafe { ACE_SizeCDR::write_2(__this, _anon_0) }
}
#[export_name = "_ZN11ACE_SizeCDR7write_4EPKj"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_SizeCDR7write_4EPKj(
    __this: *mut ACE_SizeCDR,
    _anon_0: *const libc::c_uint,
) -> bool {
    unsafe { ACE_SizeCDR::write_4(__this, _anon_0) }
}
#[export_name = "_ZN11ACE_SizeCDR7write_8EPKm"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_SizeCDR7write_8EPKm(
    __this: *mut ACE_SizeCDR,
    _anon_0: *const libc::c_ulong,
) -> bool {
    unsafe { ACE_SizeCDR::write_8(__this, _anon_0) }
}
#[export_name = "_ZN11ACE_SizeCDR8write_16EPKe"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_SizeCDR8write_16EPKe(
    __this: *mut ACE_SizeCDR,
    _anon_0: *const crate::__f80::F80,
) -> bool {
    unsafe { ACE_SizeCDR::write_16(__this, _anon_0) }
}
#[export_name = "_ZN11ACE_SizeCDR11write_arrayEPKvmmj"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_SizeCDR11write_arrayEPKvmmj(
    __this: *mut ACE_SizeCDR,
    ...
    unsafe { ACE_SizeCDR::write_array(__this, _anon_0, size, align, length) }
}
#[export_name = "_ZN11ACE_SizeCDR19write_wchar_array_iEPKwj"]
pub unsafe extern "C-unwind" fn __xtu__ZN11ACE_SizeCDR19write_wchar_array_iEPKwj(
    __this: *mut ACE_SizeCDR,
    _anon_0: *const libc::wchar_t,
    length: libc::c_uint,
) -> bool {
    unsafe { ACE_SizeCDR::write_wchar_array_i(__this, _anon_0, length) }
}
#[export_name = "_ZlsR11ACE_SizeCDRRK15ACE_String_BaseIcE"]
pub unsafe extern "C-unwind" fn operator_shl_u99d0cf30eb2bade7(
    mut ss: *mut ACE_SizeCDR,
    mut x: *const ACE_String_Base_char_,
) -> bool {
    unsafe {
        {
            <ACE_SizeCDR>::write_string_u1382d72d65976c36(
                (::core::ptr::addr_of_mut!((* ss))) as *mut ACE_SizeCDR,
                ::core::ptr::addr_of!((* x)),
            );
            return crate::__cxx_std::__Truthy::__truthy(
                ((<ACE_SizeCDR>::good_bit(
                    (::core::ptr::addr_of!((* ss))) as *const ACE_SizeCDR,
                )) as bool),
            );
        }
        #[allow(unreachable_code)] { ::core::unreachable!() }
...
pub unsafe extern "C-unwind" fn operator_shl_u32bd28701bccb757(
    mut ss: *mut ACE_SizeCDR,
    mut x: libc::c_char,
) -> bool {
    unsafe {
        {
            <ACE_SizeCDR>::write_char(
                (::core::ptr::addr_of_mut!((* ss))) as *mut ACE_SizeCDR,
                x,
            );
            return crate::__cxx_std::__Truthy::__truthy(
...
pub unsafe extern "C-unwind" fn operator_shl_u3286c8701b9e84c7(
    mut ss: *mut ACE_SizeCDR,
    mut x: libc::c_short,
) -> bool {
    unsafe {
        {
            <ACE_SizeCDR>::write_short(
                (::core::ptr::addr_of_mut!((* ss))) as *mut ACE_SizeCDR,
                x,
            );
            return crate::__cxx_std::__Truthy::__truthy(
...
pub unsafe extern "C-unwind" fn operator_shl_u32f3c8701bfb56a7(
    mut ss: *mut ACE_SizeCDR,
    mut x: libc::c_ushort,
) -> bool {
    unsafe {
        {
            <ACE_SizeCDR>::write_ushort(
                (::core::ptr::addr_of_mut!((* ss))) as *mut ACE_SizeCDR,
                x,
            );
            return crate::__cxx_std::__Truthy::__truthy(
...
pub unsafe extern "C-unwind" fn operator_shl_u329b30701bafde89(
    mut ss: *mut ACE_SizeCDR,
    mut x: libc::c_int,
) -> bool {
    unsafe {
        {
            <ACE_SizeCDR>::write_long(
                (::core::ptr::addr_of_mut!((* ss))) as *mut ACE_SizeCDR,
                x,
            );
            return crate::__cxx_std::__Truthy::__truthy(
...
pub unsafe extern "C-unwind" fn operator_shl_u330830701c0cb069(
    mut ss: *mut ACE_SizeCDR,
    mut x: libc::c_uint,
) -> bool {
    unsafe {
        {
            <ACE_SizeCDR>::write_ulong(
                (::core::ptr::addr_of_mut!((* ss))) as *mut ACE_SizeCDR,
                x,
            );
            return crate::__cxx_std::__Truthy::__truthy(
...
pub unsafe extern "C-unwind" fn operator_shl_u32ac28701bbe4424(
    mut ss: *mut ACE_SizeCDR,
    mut x: libc::c_long,
) -> bool {
    unsafe {
        {
            <ACE_SizeCDR>::write_longlong(
                (::core::ptr::addr_of_mut!((* ss))) as *mut ACE_SizeCDR,
                ::core::ptr::addr_of!(x),
            );
            return crate::__cxx_std::__Truthy::__truthy(
...
pub unsafe extern "C-unwind" fn operator_shl_u331928701c1b1604(
    mut ss: *mut ACE_SizeCDR,
    mut x: libc::c_ulong,
) -> bool {
    unsafe {
        {
            <ACE_SizeCDR>::write_ulonglong(
                (::core::ptr::addr_of_mut!((* ss))) as *mut ACE_SizeCDR,
                ::core::ptr::addr_of!(x),
            );
            return crate::__cxx_std::__Truthy::__truthy(
...
pub unsafe extern "C-unwind" fn operator_shl_u32c798701bd5ca2c(
    mut ss: *mut ACE_SizeCDR,
    mut x: crate::__f80::F80,
) -> bool {
    unsafe {
        {
            <ACE_SizeCDR>::write_longdouble(
                (::core::ptr::addr_of_mut!((* ss))) as *mut ACE_SizeCDR,
                ::core::ptr::addr_of!(x),
            );
            return crate::__cxx_std::__Truthy::__truthy(
...
pub unsafe extern "C-unwind" fn operator_shl_u333b28701c37fc6a(
    mut ss: *mut ACE_SizeCDR,
    mut x: libc::c_float,
) -> bool {
    unsafe {
        {
            <ACE_SizeCDR>::write_float(
                (::core::ptr::addr_of_mut!((* ss))) as *mut ACE_SizeCDR,
                x,
            );
            return crate::__cxx_std::__Truthy::__truthy(
...
pub unsafe extern "C-unwind" fn operator_shl_u333418701c31c28c(
    mut ss: *mut ACE_SizeCDR,
    mut x: libc::c_double,
) -> bool {
    unsafe {
        {
            <ACE_SizeCDR>::write_double(
                (::core::ptr::addr_of_mut!((* ss))) as *mut ACE_SizeCDR,
                ::core::ptr::addr_of!(x),
            );
            return crate::__cxx_std::__Truthy::__truthy(
...
pub unsafe extern "C-unwind" fn operator_shl_uc856e70813daecd6(
    mut ss: *mut ACE_SizeCDR,
    mut x: *const Fixed,
) -> bool {
    unsafe {
        {
            <ACE_SizeCDR>::write_fixed(
                (::core::ptr::addr_of_mut!((* ss))) as *mut ACE_SizeCDR,
                ::core::ptr::addr_of!((* x)),
            );
            return crate::__cxx_std::__Truthy::__truthy(
...
pub unsafe extern "C-unwind" fn operator_shl_u0db0d1ef94a95d16(
    mut ss: *mut ACE_SizeCDR,
    mut x: *const libc::c_char,
) -> bool {
    unsafe {
        {
            <ACE_SizeCDR>::write_string(
                (::core::ptr::addr_of_mut!((* ss))) as *mut ACE_SizeCDR,
                x,
            );
            return crate::__cxx_std::__Truthy::__truthy(
...
pub unsafe extern "C-unwind" fn operator_shl_u0df4c9ef94e31c4a(
    mut ss: *mut ACE_SizeCDR,
    mut x: *const libc::wchar_t,
) -> bool {
    unsafe {
        {
            <ACE_SizeCDR>::write_wstring(
                (::core::ptr::addr_of_mut!((* ss))) as *mut ACE_SizeCDR,
                x,
            );
            return crate::__cxx_std::__Truthy::__truthy(
...
pub unsafe extern "C-unwind" fn operator_shl_u249e93d42673e0db(
    mut ss: *mut ACE_SizeCDR,
    mut x: *const crate::__cxx_std::String,
) -> bool {
    unsafe {
        {
            <ACE_SizeCDR>::write_string_u343156045708733c(
                (::core::ptr::addr_of_mut!((* ss))) as *mut ACE_SizeCDR,
                ::core::ptr::addr_of!((* x)),
            );
            return crate::__cxx_std::__Truthy::__truthy(
...
pub unsafe extern "C-unwind" fn operator_shl_u04f73b306196976f(
    mut ss: *mut ACE_SizeCDR,
    mut x: *const crate::__cxx_std::WString,
) -> bool {
    unsafe {
        {
            <ACE_SizeCDR>::write_wstring_u81a94b32c762b7db(
                (::core::ptr::addr_of_mut!((* ss))) as *mut ACE_SizeCDR,
                ::core::ptr::addr_of!((* x)),
            );
            return crate::__cxx_std::__Truthy::__truthy(
...
pub unsafe extern "C-unwind" fn operator_shl_u6d4c731f9c5462ab(
    mut ss: *mut ACE_SizeCDR,
    mut x: from_boolean,
) -> bool {
    unsafe {
        {
            <ACE_SizeCDR>::write_boolean(
                (::core::ptr::addr_of_mut!((* ss))) as *mut ACE_SizeCDR,
                x.val_,
            );
            return crate::__cxx_std::__Truthy::__truthy(
...
pub unsafe extern "C-unwind" fn operator_shl_uf9460b04ea575b5f(
    mut ss: *mut ACE_SizeCDR,
    mut x: from_char,
) -> bool {
    unsafe {
...
pub unsafe extern "C-unwind" fn operator_shl_ud387bd8214809f8c(
    mut ss: *mut ACE_SizeCDR,
    mut x: from_wchar,
) -> bool {
    unsafe {
        {
            <ACE_SizeCDR>::write_wchar(
                (::core::ptr::addr_of_mut!((* ss))) as *mut ACE_SizeCDR,
                x.val_,
            );
            return crate::__cxx_std::__Truthy::__truthy(
...
pub unsafe extern "C-unwind" fn operator_shl_uca9494777ecf24ee(
    mut ss: *mut ACE_SizeCDR,
    mut x: from_octet,
) -> bool {
    unsafe {
        {
            <ACE_SizeCDR>::write_octet(
                (::core::ptr::addr_of_mut!((* ss))) as *mut ACE_SizeCDR,
                x.val_,
            );
            return crate::__cxx_std::__Truthy::__truthy(
...
pub unsafe extern "C-unwind" fn operator_shl_u9d7f56c41aa99a18(
    mut ss: *mut ACE_SizeCDR,
    mut x: from_string,
) -> bool {
    unsafe {
        {
            ...
            <ACE_SizeCDR>::write_string_u3adb8d471a77ccb5(
                (::core::ptr::addr_of_mut!((* ss))) as *mut ACE_SizeCDR,
                len,
                ((x.val_) as *const libc::c_char),
            );
...
pub unsafe extern "C-unwind" fn operator_shl_u022d581468a70aab(
    mut ss: *mut ACE_SizeCDR,
    mut x: from_wstring,
) -> bool {
    unsafe {
        {
            ...
            <ACE_SizeCDR>::write_wstring_ubb6a44741a6c320e(
                (::core::ptr::addr_of_mut!((* ss))) as *mut ACE_SizeCDR,
                len,
                ((x.val_) as *const libc::wchar_t),
            );
...
impl ACE_SizeCDR {
    ...
    pub unsafe fn new(mut __a0: libc::c_uchar, mut __a1: libc::c_uchar) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return crate::__cxx_std::__Truthy::__truthy(
                    <ACE_SizeCDR>::write_1(
                        (__this) as *mut ACE_SizeCDR,
                        (::core::ptr::addr_of_mut!(x) as *mut libc::c_char
                            as *const libc::c_uchar),
                    ),
                );
            }
    ...
    pub unsafe fn write_wchar(__this: *mut Self, mut x: libc::wchar_t) -> bool {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((((<ACE_OutputCDR>::wchar_maxbytes_u47850143c0df4111()
                ...
                if (((((((((((*__this).major_version_ as libc::c_short) as libc::c_int))
                    ...
                    as libc::c_int) as libc::c_int) != 0)
                {
                    let mut len: libc::c_uchar = (<ACE_OutputCDR>::wchar_maxbytes_u47850143c0df4111()
                        as libc::c_uchar);
                    if ((<ACE_SizeCDR>::write_1(
                        (__this) as *mut ACE_SizeCDR,
                    ...
                    {
                        if (((((<ACE_OutputCDR>::wchar_maxbytes_u47850143c0df4111()
                            as libc::c_ulong)) == (((4) as libc::c_ulong)))
                            as libc::c_int as libc::c_int) != 0)
                        {
                            return crate::__cxx_std::__Truthy::__truthy(
                                <ACE_SizeCDR>::write_octet_array(
                                    (__this) as *mut ACE_SizeCDR,
                ...
                if (((((<ACE_OutputCDR>::wchar_maxbytes_u47850143c0df4111()
                    as libc::c_ulong)) == (((4) as libc::c_ulong))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    let mut temp: *const libc::c_void = ((::core::ptr::addr_of_mut!(x)
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return crate::__cxx_std::__Truthy::__truthy(
                    <ACE_SizeCDR>::write_2(
                        (__this) as *mut ACE_SizeCDR,
                        (::core::ptr::addr_of_mut!(x) as *mut libc::c_short
                            as *const libc::c_ushort),
                    ),
                );
            }
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return crate::__cxx_std::__Truthy::__truthy(
                    <ACE_SizeCDR>::write_4(
                        (__this) as *mut ACE_SizeCDR,
                        (::core::ptr::addr_of_mut!(x) as *mut libc::c_int
                            as *const libc::c_uint),
                    ),
                );
            }
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return crate::__cxx_std::__Truthy::__truthy(
                    <ACE_SizeCDR>::write_8(
                        (__this) as *mut ACE_SizeCDR,
                        (::core::ptr::addr_of!((* x)) as *const libc::c_long
                            as *const libc::c_ulong),
                    ),
                );
            }
    ...
    pub unsafe fn write_ulonglong(
        ...
        unsafe {
            ...
            {
                let mut temp: *const libc::c_void = ((::core::ptr::addr_of!((* x))
                    as *const libc::c_ulong) as *const libc::c_void);
                return crate::__cxx_std::__Truthy::__truthy(
                    <ACE_SizeCDR>::write_8(
                        (__this) as *mut ACE_SizeCDR,
                        (temp as *const libc::c_ulong),
    ...
    pub unsafe fn write_longdouble(
        ...
        unsafe {
            ...
            {
                let mut temp: *const libc::c_void = ((::core::ptr::addr_of!((* x))
                    as *const crate::__f80::F80) as *const libc::c_void);
                return crate::__cxx_std::__Truthy::__truthy(
                    <ACE_SizeCDR>::write_16(
                        (__this) as *mut ACE_SizeCDR,
                        (temp as *const crate::__f80::F80),
                    ),
                );
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
                ...
                return crate::__cxx_std::__Truthy::__truthy(
                    <ACE_SizeCDR>::write_array(
                        ...
                        (((((((((<Fixed>::fixed_digits(
                            ...
                            .wrapping_add((2) as libc::c_int))) as libc::c_int))
    ...
    pub unsafe fn write_string_u3adb8d471a77ccb5(
        __this: *mut Self,
        mut len: libc::c_uint,
        mut x: *const libc::c_char,
    ) -> bool {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((((len as libc::c_uint)) != (((0) as libc::c_uint))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    if ((<ACE_SizeCDR>::write_ulong(
                        (__this) as *mut ACE_SizeCDR,
                        (((len) as libc::c_uint)).wrapping_add((1) as libc::c_uint),
                    ) as libc::c_int) != 0)
                    {
                        return crate::__cxx_std::__Truthy::__truthy(
                            <ACE_SizeCDR>::write_char_array(
                                (__this) as *mut ACE_SizeCDR,
                                x,
                                (((len) as libc::c_uint)).wrapping_add((1) as libc::c_uint),
                            ),
    ...
    pub unsafe fn write_string_u1382d72d65976c36(
        __this: *mut Self,
        mut x: *const ACE_String_Base_char_,
    ) -> bool {
        unsafe {
    ...
    pub unsafe fn write_wstring_ubb6a44741a6c320e(
        __this: *mut Self,
        mut len: libc::c_uint,
        mut x: *const libc::wchar_t,
    ) -> bool {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                {
                    if ((((!(x).is_null()) as libc::c_int) as libc::c_int) != 0) {
                        let mut good_ulong: bool = <ACE_SizeCDR>::write_ulong(
                            (__this) as *mut ACE_SizeCDR,
                            ((ACE_Utils::truncate_cast___unsigned_long__ue27a31e3ddf7f306(
                                (((((<ACE_OutputCDR>::wchar_maxbytes_u47850143c0df4111())
                                    as libc::c_ulong))
    ...
    pub unsafe fn write_string_u343156045708733c(
        __this: *mut Self,
        mut x: *const crate::__cxx_std::String,
    ) -> bool {
        unsafe {
    ...
    pub unsafe fn write_wstring_u81a94b32c762b7db(
        __this: *mut Self,
        mut x: *const crate::__cxx_std::WString,
    ) -> bool {
        unsafe {
    ...
    pub unsafe fn write_boolean_array(
        __this: *mut Self,
        mut _anon_0: *const bool,
        mut length: libc::c_uint,
    ) -> bool {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                <ACE_SizeCDR>::adjust_ubcb45e88c3f59dd0(
                    (__this) as *mut ACE_SizeCDR,
                    ((length) as libc::c_ulong),
                    ((1) as libc::c_ulong),
                );
    ...
    pub unsafe fn write_wchar_array(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                return crate::__cxx_std::__Truthy::__truthy(
                    <ACE_SizeCDR>::write_wchar_array_i(
                        (__this) as *mut ACE_SizeCDR,
                        x,
                        length,
                    ),
    ...
    #[doc = "/// Adjust to @a size and count @a size octets."]
    pub unsafe fn adjust(__this: *mut Self, mut size: libc::c_ulong) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                <ACE_SizeCDR>::adjust_ubcb45e88c3f59dd0(
    ...
    /**As above, but now the size and alignment requirements may be
  /// different.*/
    pub unsafe fn adjust_ubcb45e88c3f59dd0(
        __this: *mut Self,
        mut size: libc::c_ulong,
        mut align: libc::c_ulong,
    ) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut offset: libc::c_ulong = (((((ACE_align_binary(
                    ...
                    .wrapping_sub(((*__this).size_) as libc::c_ulong)) as libc::c_ulong);
                {
                    let __lv = ::core::ptr::addr_of_mut!((* __this).size_);
                    unsafe {
                        *__lv = ((((*__lv)) as libc::c_ulong))
    ...
    ///disallow copying...
    pub unsafe fn new_at_u2100b6b6e7259bd2(
        __this: *mut Self,
        mut __a0: *const ACE_SizeCDR,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN11ACE_SizeCDRC1ERKS_"]
            fn __ext(__this: *mut ACE_SizeCDR, __a0: *const ACE_SizeCDR);
        }
        __ext(__this as *mut ACE_SizeCDR, __a0)
    }
    pub unsafe fn new_u2100b6b6e7259bd2(mut __a0: *const ACE_SizeCDR) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_u2100b6b6e7259bd2(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    pub unsafe fn operator_assign(
        __this: *mut Self,
        mut rhs: *const ACE_SizeCDR,
    ) -> *mut ACE_SizeCDR {
        extern "C-unwind" {
            #[link_name = "_ZN11ACE_SizeCDRaSERKS_"]
            fn __ext(
                __this: *mut ACE_SizeCDR,
                rhs: *const ACE_SizeCDR,
            ) -> *mut ACE_SizeCDR;
        }
        __ext(__this as *mut ACE_SizeCDR, rhs)
    }
    pub unsafe fn write_1(__this: *mut Self, mut _anon_0: *const libc::c_uchar) -> bool {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                <ACE_SizeCDR>::adjust(
    ...
    pub unsafe fn write_2(
        __this: *mut Self,
        mut _anon_0: *const libc::c_ushort,
    ) -> bool {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
    ...
    pub unsafe fn write_4(__this: *mut Self, mut _anon_0: *const libc::c_uint) -> bool {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                <ACE_SizeCDR>::adjust(
    ...
    pub unsafe fn write_8(__this: *mut Self, mut _anon_0: *const libc::c_ulong) -> bool {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                <ACE_SizeCDR>::adjust(
    ...
    pub unsafe fn write_16(
        __this: *mut Self,
        mut _anon_0: *const crate::__f80::F80,
    ) -> bool {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
    ...
    pub unsafe fn write_wchar_array_i(
        __this: *mut Self,
        mut _anon_0: *const libc::wchar_t,
        mut length: libc::c_uint,
    ) -> bool {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                let mut align: libc::c_ulong = ((if ((((((<ACE_OutputCDR>::wchar_maxbytes_u47850143c0df4111()
                    as libc::c_ulong)) == (((2) as libc::c_ulong))) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    (2 as libc::c_int)
