...
extern "C-unwind" {
    pub fn closedir(__dirp: *mut __dirstream) -> libc::c_int;
}
extern "C-unwind" {
    pub fn opendir(__name: *const libc::c_char) -> *mut __dirstream;
}
extern "C-unwind" {
    pub fn fdopendir(__fd: libc::c_int) -> *mut __dirstream;
}
extern "C-unwind" {
    pub fn readdir(__dirp: *mut __dirstream) -> *mut dirent;
}
extern "C-unwind" {
    pub fn readdir64(__dirp: *mut __dirstream) -> *mut dirent64;
}
extern "C-unwind" {
    pub fn readdir_r(
        __dirp: *mut __dirstream,
        __entry: *mut dirent,
...
extern "C-unwind" {
    pub fn rewinddir(__dirp: *mut __dirstream);
}
extern "C-unwind" {
    pub fn seekdir(__dirp: *mut __dirstream, __pos: libc::c_long);
}
extern "C-unwind" {
    pub fn telldir(__dirp: *mut __dirstream) -> libc::c_long;
}
extern "C-unwind" {
    pub fn dirfd(__dirp: *mut __dirstream) -> libc::c_int;
}
extern "C-unwind" {
    pub fn scandir(
        __dir: *const libc::c_char,
        __namelist: *mut *mut *mut dirent,
        __selector: Option<unsafe extern "C-unwind" fn(*const dirent) -> libc::c_int>,
        __cmp: Option<
            unsafe extern "C-unwind" fn(
                *mut *const dirent,
                *mut *const dirent,
...
extern "C-unwind" {
    pub fn scandir64(
        ...
        __selector: Option<unsafe extern "C-unwind" fn(*const dirent64) -> libc::c_int>,
        __cmp: Option<
            unsafe extern "C-unwind" fn(
                *mut *const dirent64,
                *mut *const dirent64,
...
#[doc = "* @class ACE_DEV_Addr\n *\n * @brief Defines device address family address format."]
#[repr(C)]
#[derive(Clone)]
pub struct ACE_DEV_Addr {
    pub __base_0: ::core::mem::ManuallyDrop<ACE_Addr>,
    pub devname_: [libc::c_char; 4097usize],
}
impl Drop for ACE_DEV_Addr {
    fn drop(&mut self) {
        unsafe {
...
pub type ACE_DEV_IO_PEER_ADDR = ACE_DEV_Addr;
#[doc = "* @class ACE_DEV_IO\n *\n * @brief Read/Write operations on Devices."]
#[repr(C)]
#[derive(Clone)]
pub struct ACE_DEV_IO {
    pub __base_0: ::core::mem::ManuallyDrop<ACE_DEV>,
    pub addr_: ::core::mem::ManuallyDrop<ACE_DEV_Addr>,
}
impl Drop for ACE_DEV_IO {
    fn drop(&mut self) {
        unsafe {
            ::core::mem::ManuallyDrop::drop(&mut self.addr_);
            ::core::mem::ManuallyDrop::drop(&mut self.__base_0);
        }
    }
}
...
#[export_name = "_ZN10ACE_TTY_IOC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN10ACE_TTY_IOC1Ev(__this: *mut ACE_TTY_IO) {
    ACE_TTY_IO::new_at(__this)
}
#[export_name = "_ZNK10ACE_TTY_IO7controlENS_12Control_ModeEPNS_13Serial_ParamsE"]
pub unsafe extern "C-unwind" fn __xtu__ZNK10ACE_TTY_IO7controlENS_12Control_ModeEPNS_13Serial_ParamsE(
    __this: *const ACE_TTY_IO,
    cmd: libc::c_uint,
    arg: *mut Serial_Params,
) -> libc::c_int {
    unsafe { ACE_TTY_IO::control(__this, cmd, arg) }
}
...
pub struct termios {
    ...
    pub c_cc: [libc::c_uchar; 32usize],
    pub c_ispeed: libc::c_uint,
    pub c_ospeed: libc::c_uint,
}
extern "C-unwind" {
    pub fn cfgetospeed(__termios_p: *const termios) -> libc::c_uint;
}
extern "C-unwind" {
    pub fn cfgetispeed(__termios_p: *const termios) -> libc::c_uint;
}
extern "C-unwind" {
    pub fn cfsetospeed(__termios_p: *mut termios, __speed: libc::c_uint) -> libc::c_int;
}
extern "C-unwind" {
    pub fn cfsetispeed(__termios_p: *mut termios, __speed: libc::c_uint) -> libc::c_int;
}
extern "C-unwind" {
    pub fn cfsetspeed(__termios_p: *mut termios, __speed: libc::c_uint) -> libc::c_int;
}
extern "C-unwind" {
...
extern "C-unwind" {
    pub fn tcgetsid(__fd: libc::c_int) -> libc::c_int;
}
pub mod __anon_ns_9889 {
    pub(crate) static ACE_TTY_IO_NONE: [libc::c_char; 5usize] = unsafe {
        ::core::mem::transmute::<_, [libc::c_char; 5usize]>(*b"none\0")
    };
    pub(crate) static ACE_TTY_IO_ODD: [libc::c_char; 4usize] = unsafe {
        ::core::mem::transmute::<_, [libc::c_char; 4usize]>(*b"odd\0")
    };
    pub(crate) static ACE_TTY_IO_EVEN: [libc::c_char; 5usize] = unsafe {
        ::core::mem::transmute::<_, [libc::c_char; 5usize]>(*b"even\0")
    };
}
extern "C-unwind" {
...
impl ACE_DEV_Addr {
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        extern "C-unwind" {
            #[link_name = "_ZN12ACE_DEV_AddrC1Ev"]
            fn __ext(__this: *mut ACE_DEV_Addr);
        }
        __ext(__this as *mut ACE_DEV_Addr)
    }
    pub unsafe fn new() -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at(::core::ptr::addr_of_mut!(__obj));
    ...
    ///Copy constructor.
    pub unsafe fn new_at_uf97a38068e21c4e0(
        __this: *mut Self,
        mut __a0: *const ACE_DEV_Addr,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN12ACE_DEV_AddrC1ERKS_"]
            fn __ext(__this: *mut ACE_DEV_Addr, __a0: *const ACE_DEV_Addr);
        }
        __ext(__this as *mut ACE_DEV_Addr, __a0)
    }
    pub unsafe fn new_uf97a38068e21c4e0(mut __a0: *const ACE_DEV_Addr) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_uf97a38068e21c4e0(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    ///Acts like a copy constructor.
    pub unsafe fn set(__this: *mut Self, mut sa: *const ACE_DEV_Addr) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZN12ACE_DEV_Addr3setERKS_"]
            fn __ext(__this: *mut ACE_DEV_Addr, sa: *const ACE_DEV_Addr) -> libc::c_int;
        }
        __ext(__this as *mut ACE_DEV_Addr, sa)
    }
    ///Create a ACE_DEV_Addr from a device name.
    pub unsafe fn new_at_u3efd57b00a84c2a1(
        __this: *mut Self,
        mut __a0: *const libc::c_char,
    ) {
        extern "C-unwind" {
            #[link_name = "_ZN12ACE_DEV_AddrC1EPKc"]
            fn __ext(__this: *mut ACE_DEV_Addr, __a0: *const libc::c_char);
        }
        __ext(__this as *mut ACE_DEV_Addr, __a0)
    }
    pub unsafe fn new_u3efd57b00a84c2a1(mut __a0: *const libc::c_char) -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at_u3efd57b00a84c2a1(::core::ptr::addr_of_mut!(__obj), __a0);
        __obj
    }
    ///Create a ACE_Addr from a ACE_DEV pathname.
    pub unsafe fn set_uea90e704e758fdd8(
        __this: *mut Self,
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                <ACE_Addr>::base_set(
                    ...
                    ((((46) as libc::c_int)).wrapping_add((3) as libc::c_int)),
                    (ACE_OS::strlen_u07dd12a225364fa6(((devname) as *const libc::c_char))
                        as libc::c_int),
                );
                ACE_OS::strsncpy(
                    (((*__this).devname_).as_mut_ptr() as *mut libc::c_char),
                    ((devname) as *const libc::c_char),
                    (((4097 as libc::c_int)) as libc::c_ulong),
                );
            }
            ()
        }
    ...
    pub unsafe fn operator_assign(
        __this: *mut Self,
        mut _anon_0: *const ACE_DEV_Addr,
    ) -> *mut ACE_DEV_Addr {
        extern "C-unwind" {
            #[link_name = "_ZN12ACE_DEV_AddraSERKS_"]
            fn __ext(
                __this: *mut ACE_DEV_Addr,
                _anon_0: *const ACE_DEV_Addr,
            ) -> *mut ACE_DEV_Addr;
        }
        __ext(__this as *mut ACE_DEV_Addr, _anon_0)
    }
    ///Return a pointer to the address.
    pub unsafe fn get_addr(__this: *const Self) -> *mut libc::c_void {
        extern "C-unwind" {
            #[link_name = "_ZNK12ACE_DEV_Addr8get_addrEv"]
            fn __ext(__this: *const ACE_DEV_Addr) -> *mut libc::c_void;
        }
        __ext(__this as *const ACE_DEV_Addr)
    }
    ...
    pub unsafe fn addr_to_string(
        ...
        extern "C-unwind" {
            #[link_name = "_ZNK12ACE_DEV_Addr14addr_to_stringEPcm"]
            fn __ext(
                __this: *const ACE_DEV_Addr,
                addr: *mut libc::c_char,
                _anon_1: libc::c_ulong,
            ) -> libc::c_int;
        }
        __ext(__this as *const ACE_DEV_Addr, addr, _anon_1)
    }
    ///Compare two addresses for equality.
    pub unsafe fn operator_eq(
        __this: *const Self,
        mut sap: *const ACE_DEV_Addr,
    ) -> bool {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((((ACE_OS::strcmp_u2f671283fc8b6d4a(
                    (((*__this).devname_).as_ptr() as *const libc::c_char),
                    (((*sap).devname_).as_ptr() as *const libc::c_char),
    ...
    pub unsafe fn operator_ne(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((!((((<ACE_DEV_Addr>::operator_eq(
                    (__this) as *const ACE_DEV_Addr,
    ...
    pub unsafe fn get_path_name(__this: *const Self) -> *const libc::c_char {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((*__this).devname_).as_ptr() as *const libc::c_char);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    ...
    pub unsafe fn dump(__this: *const Self) {
        extern "C-unwind" {
            #[link_name = "_ZNK12ACE_DEV_Addr4dumpEv"]
            fn __ext(__this: *const ACE_DEV_Addr);
        }
        __ext(__this as *const ACE_DEV_Addr)
    }
}
impl ACE_DEV_IO {
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        extern "C-unwind" {
            #[link_name = "_ZN10ACE_DEV_IOC1Ev"]
            fn __ext(__this: *mut ACE_DEV_IO);
        }
        __ext(__this as *mut ACE_DEV_IO)
    }
    pub unsafe fn new() -> Self {
        let mut __obj: Self = ::core::mem::MaybeUninit::<Self>::zeroed().assume_init();
        Self::new_at(::core::ptr::addr_of_mut!(__obj));
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return ACE_OS::write_uba4fd70f52b99861(
                    <ACE_IO_SAP>::get_handle(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((* __this)
                            .__base_0) .cast:: < ACE_DEV > ().cast_mut()).__base_0)
                            .cast:: < ACE_IO_SAP > ().cast_mut())
                        )) as *const ACE_IO_SAP,
                    ),
    ...
    pub unsafe fn send_uca971efb4956f554(
        __this: *const Self,
        mut iov: *const iovec,
        mut n: libc::c_ulong,
    ) -> libc::c_long {
    ...
    pub unsafe fn recv_u8a609ec2f94d60ad(
        __this: *const Self,
        mut iov: *mut iovec,
        mut n: libc::c_ulong,
    ) -> libc::c_long {
    ...
    pub unsafe fn send_u5b50ea021bf09fd7(
        __this: *const Self,
        mut buf: *const libc::c_void,
        mut n: libc::c_ulong,
    ...
    pub unsafe fn recv_uceea356cfa0b45aa(
        __this: *const Self,
        mut buf: *mut libc::c_void,
        mut n: libc::c_ulong,
        mut overlapped: *mut ACE_OVERLAPPED,
    ...
    pub unsafe fn dump(__this: *const Self) {
        extern "C-unwind" {
            #[link_name = "_ZNK10ACE_DEV_IO4dumpEv"]
            fn __ext(__this: *const ACE_DEV_IO);
        }
        __ext(__this as *const ACE_DEV_IO)
    }
    ///Return the local endpoint address.
    pub unsafe fn get_local_addr(
        __this: *const Self,
        mut _anon_0: *mut ACE_DEV_Addr,
    ) -> libc::c_int {
        extern "C-unwind" {
            #[link_name = "_ZNK10ACE_DEV_IO14get_local_addrER12ACE_DEV_Addr"]
            fn __ext(
                __this: *const ACE_DEV_IO,
                _anon_0: *mut ACE_DEV_Addr,
            ) -> libc::c_int;
        }
        __ext(__this as *const ACE_DEV_IO, _anon_0)
    }
  ...
  /// one).*/
    pub unsafe fn get_remote_addr(
        ...
        extern "C-unwind" {
            #[link_name = "_ZNK10ACE_DEV_IO15get_remote_addrER12ACE_DEV_Addr"]
            fn __ext(
                __this: *const ACE_DEV_IO,
                _anon_0: *mut ACE_DEV_Addr,
            ) -> libc::c_int;
...
impl ACE_TTY_IO {
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ...
            <ACE_DEV_IO>::new_at(
                ::core::ptr::addr_of_mut!((* __this).__base_0).cast::<ACE_DEV_IO>(),
            );
            {}
            ()
        }
    ...
    pub unsafe fn control(
        __this: *const Self,
        mut cmd: libc::c_uint,
        mut arg: *mut Serial_Params,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut devpar: termios = unsafe {
                    ::core::mem::MaybeUninit::<termios>::zeroed().assume_init()
                };
                let mut newbaudrate: libc::c_uint = ((0) as libc::c_uint);
                if (((((tcgetattr(
                    ((<ACE_IO_SAP>::get_handle(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((*
                            ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                            ACE_DEV_IO > ().cast_mut()).__base_0) .cast:: < ACE_DEV > ()
                            .cast_mut()).__base_0) .cast:: < ACE_IO_SAP > ().cast_mut())
                        )) as *const ACE_IO_SAP,
                    )) as libc::c_int),
                    ::core::ptr::addr_of_mut!(devpar) as *mut termios,
                ...
                'switch_0: {
                    ...
                    if __m <= 0 {
                        'switch_1: {
                            let __c: libc::c_int = (*arg).baudrate;
                            #[allow(unused_assignments)]
                            let mut __m: u32 = 31;
                            {
                            ...
                            if __m == 31 {
                                let __cv_1: libc::c_int = (50 as libc::c_int);
                                if __c == __cv_1 {
                                    __m = 1;
                                }
                            }
                            if __m == 31 {
                                let __cv_2: libc::c_int = (75 as libc::c_int);
                                if __c == __cv_2 {
                                    __m = 2;
                                }
                            }
                            if __m == 31 {
                                let __cv_3: libc::c_int = (110 as libc::c_int);
                                if __c == __cv_3 {
                                    __m = 3;
                                }
                            }
                            if __m == 31 {
                                let __cv_4: libc::c_int = (134 as libc::c_int);
                                if __c == __cv_4 {
                                    __m = 4;
                                }
                            }
                            if __m == 31 {
                                let __cv_5: libc::c_int = (150 as libc::c_int);
                                if __c == __cv_5 {
                                    __m = 5;
                                }
                            }
                            if __m == 31 {
                                let __cv_6: libc::c_int = (200 as libc::c_int);
                                if __c == __cv_6 {
                                    __m = 6;
                                }
                            }
                            if __m == 31 {
                                let __cv_7: libc::c_int = (300 as libc::c_int);
                                if __c == __cv_7 {
                                    __m = 7;
                                }
                            }
                            if __m == 31 {
                                let __cv_8: libc::c_int = (600 as libc::c_int);
                                if __c == __cv_8 {
                                    __m = 8;
                                }
                            }
                            if __m == 31 {
                                let __cv_9: libc::c_int = (1200 as libc::c_int);
                                if __c == __cv_9 {
                                    __m = 9;
                                }
                            }
                            if __m == 31 {
                                let __cv_10: libc::c_int = (1800 as libc::c_int);
                                if __c == __cv_10 {
                                    __m = 10;
                                }
                            }
                            if __m == 31 {
                                let __cv_11: libc::c_int = (2400 as libc::c_int);
                                if __c == __cv_11 {
                                    __m = 11;
                                }
                            }
                            if __m == 31 {
                                let __cv_12: libc::c_int = (4800 as libc::c_int);
                                if __c == __cv_12 {
                                    __m = 12;
                                }
                            }
                            if __m == 31 {
                                let __cv_13: libc::c_int = (9600 as libc::c_int);
                                if __c == __cv_13 {
                                    __m = 13;
                                }
                            }
                            if __m == 31 {
                                let __cv_14: libc::c_int = (19200 as libc::c_int);
                                if __c == __cv_14 {
                                    __m = 14;
                                }
                            }
                            if __m == 31 {
                                let __cv_15: libc::c_int = (38400 as libc::c_int);
                                if __c == __cv_15 {
                                    __m = 15;
                                }
                            }
                            if __m == 31 {
                                let __cv_16: libc::c_int = (57600 as libc::c_int);
                                if __c == __cv_16 {
                                    __m = 16;
                                }
                            }
                            if __m == 31 {
                                let __cv_17: libc::c_int = (115200 as libc::c_int);
                                if __c == __cv_17 {
                                    __m = 17;
                                }
                            }
                            if __m == 31 {
                                let __cv_18: libc::c_int = (230400 as libc::c_int);
                                if __c == __cv_18 {
                                    __m = 18;
                                }
                            }
                            if __m == 31 {
                                let __cv_19: libc::c_int = (460800 as libc::c_int);
                                if __c == __cv_19 {
                                    __m = 19;
                                }
                            }
                            if __m == 31 {
                                let __cv_20: libc::c_int = (500000 as libc::c_int);
                                if __c == __cv_20 {
                                    __m = 20;
                                }
                            }
                            if __m == 31 {
                                let __cv_21: libc::c_int = (576000 as libc::c_int);
                                if __c == __cv_21 {
                                    __m = 21;
                                }
                            }
                            if __m == 31 {
                                let __cv_22: libc::c_int = (921600 as libc::c_int);
                                if __c == __cv_22 {
                                    __m = 22;
                                }
                            }
                            if __m == 31 {
                                let __cv_23: libc::c_int = (1000000 as libc::c_int);
                                if __c == __cv_23 {
                                    __m = 23;
                                }
                            }
                            if __m == 31 {
                                let __cv_24: libc::c_int = (1152000 as libc::c_int);
                                if __c == __cv_24 {
                                    __m = 24;
                                }
                            }
                            if __m == 31 {
                                let __cv_25: libc::c_int = (1500000 as libc::c_int);
                                if __c == __cv_25 {
                                    __m = 25;
                                }
                            }
                            if __m == 31 {
                                let __cv_26: libc::c_int = (2000000 as libc::c_int);
                                if __c == __cv_26 {
                                    __m = 26;
                                }
                            }
                            if __m == 31 {
                                let __cv_27: libc::c_int = (2500000 as libc::c_int);
                                if __c == __cv_27 {
                                    __m = 27;
                                }
                            }
                            if __m == 31 {
                                let __cv_28: libc::c_int = (3000000 as libc::c_int);
                                if __c == __cv_28 {
                                    __m = 28;
                                }
                            }
                            if __m == 31 {
                                let __cv_29: libc::c_int = (3500000 as libc::c_int);
                                if __c == __cv_29 {
                                    __m = 29;
                                }
                            }
                            if __m == 31 {
                                let __cv_30: libc::c_int = (4000000 as libc::c_int);
                                if __c == __cv_30 {
                                    __m = 30;
                                }
                            }
                            if __m <= 0 {
                                newbaudrate = ((0) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 1 {
                                newbaudrate = ((1) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 2 {
                                newbaudrate = ((2) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 3 {
                                newbaudrate = ((3) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 4 {
                                newbaudrate = ((4) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 5 {
                                newbaudrate = ((5) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 6 {
                                newbaudrate = ((6) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 7 {
                                newbaudrate = ((7) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 8 {
                                newbaudrate = ((8) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 9 {
                                newbaudrate = ((9) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 10 {
                                newbaudrate = ((10) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 11 {
                                newbaudrate = ((11) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 12 {
                                newbaudrate = ((12) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 13 {
                                newbaudrate = ((13) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 14 {
                                newbaudrate = ((14) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 15 {
                                newbaudrate = ((15) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 16 {
                                newbaudrate = ((4097) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 17 {
                                newbaudrate = ((4098) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 18 {
                                newbaudrate = ((4099) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 19 {
                                newbaudrate = ((4100) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 20 {
                                newbaudrate = ((4101) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 21 {
                                newbaudrate = ((4102) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 22 {
                                newbaudrate = ((4103) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 23 {
                                newbaudrate = ((4104) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 24 {
                                newbaudrate = ((4105) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 25 {
                                newbaudrate = ((4106) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 26 {
                                newbaudrate = ((4107) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 27 {
                                newbaudrate = ((4108) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 28 {
                                newbaudrate = ((4109) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 29 {
                                newbaudrate = ((4110) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 30 {
                                newbaudrate = ((4111) as libc::c_uint);
                                break 'switch_1;
                            }
                            if __m <= 31 {
                                return (-((1) as libc::c_int));
                            }
                            #[allow(unreachable_code)] break 'switch_1;
                        }
                        if (((((cfsetospeed(
                            ::core::ptr::addr_of_mut!(devpar) as *mut termios,
                            newbaudrate,
                        ...
                        {
                            let __lv = ::core::ptr::addr_of_mut!(devpar.c_cflag);
                            unsafe {
                                *__lv = ((((*__lv)) as libc::c_uint))
                                    & (((!(48))) as libc::c_uint);
                                *__lv
                            }
                        };
                        'switch_2: {
                            let __c: libc::c_uchar = (*arg).databits;
                            #[allow(unused_assignments)]
                            let mut __m: u32 = 4;
                            {
                                let __cv_0: libc::c_uchar = (5 as libc::c_uchar);
                                if __c == __cv_0 {
                                    __m = 0;
                                }
                            }
                            if __m == 4 {
                                let __cv_1: libc::c_uchar = (6 as libc::c_uchar);
                                if __c == __cv_1 {
                                    __m = 1;
                                }
                            }
                            if __m == 4 {
                                let __cv_2: libc::c_uchar = (7 as libc::c_uchar);
                                if __c == __cv_2 {
                                    __m = 2;
                                }
                            }
                            if __m == 4 {
                                let __cv_3: libc::c_uchar = (8 as libc::c_uchar);
                                if __c == __cv_3 {
                                    __m = 3;
                                }
                            }
                            ...
                            #[allow(unreachable_code)] break 'switch_2;
                        }
                        'switch_3: {
                            let __c: libc::c_uchar = (*arg).stopbits;
                            #[allow(unused_assignments)]
                            let mut __m: u32 = 2;
                            {
                                let __cv_0: libc::c_uchar = (1 as libc::c_uchar);
                                if __c == __cv_0 {
                                    __m = 0;
                                }
                            }
                            if __m == 2 {
                                let __cv_1: libc::c_uchar = (2 as libc::c_uchar);
                                if __c == __cv_1 {
                                    __m = 1;
                                }
                            }
                            ...
                            #[allow(unreachable_code)] break 'switch_3;
                        }
                        if (!((*arg).paritymode).is_null()) {
                            if (((((ACE_OS::strcasecmp_u16aef50f9fc896fe(
                                (*arg).paritymode,
                                ((__anon_ns_9889::ACE_TTY_IO_ODD).as_ptr()
                                ...
                                as libc::c_int) != 0)
                            {
                                ...
                                {
                                    let __lv = ::core::ptr::addr_of_mut!(devpar.c_iflag);
                                    unsafe {
                                        *__lv = ((((*__lv)) as libc::c_uint))
                                            & (((!(4))) as libc::c_uint);
                                        *__lv
                                ...
                                if (((*arg).inpckenb as libc::c_int) != 0) {
                                    {
                                        let __lv = ::core::ptr::addr_of_mut!(devpar.c_iflag);
                                        unsafe {
                                            *__lv = ((((*__lv)) as libc::c_uint))
                                ...
                                if (((((ACE_OS::strcasecmp_u16aef50f9fc896fe(
                                    (*arg).paritymode,
                                    ((__anon_ns_9889::ACE_TTY_IO_EVEN).as_ptr()
                                        as *const libc::c_char),
                                ) as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                                    as libc::c_int) != 0)
                                {
                                    ...
                                    if (((((ACE_OS::strcasecmp_u16aef50f9fc896fe(
                                        (*arg).paritymode,
                                        ((__anon_ns_9889::ACE_TTY_IO_NONE).as_ptr()
                                            as *const libc::c_char),
                                    ) as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                                        as libc::c_int) != 0)
                                    {
                        ...
                        if ((((((((*arg).ctsenb) as libc::c_int) != 0)
                            || ((((*arg).rtsenb)) != 0)) as libc::c_int) as libc::c_int)
                            != 0)
                        {
                            {
                                let __lv = ::core::ptr::addr_of_mut!(devpar.c_cflag);
                        ...
                        if (((*arg).xoutenb as libc::c_int) != 0) {
                            {
                                let __lv = ::core::ptr::addr_of_mut!(devpar.c_iflag);
                                unsafe {
                                    *__lv = ((((*__lv)) as libc::c_uint))
                        ...
                        {
                            let __lv = ::core::ptr::addr_of_mut!(devpar.c_lflag);
                            unsafe {
                                *__lv = ((((*__lv)) as libc::c_uint))
                                    & (((!(2))) as libc::c_uint);
                                *__lv
                        ...
                        {
                            let __lv = ::core::ptr::addr_of_mut!(devpar.c_oflag);
                            unsafe {
                                *__lv = ((((*__lv)) as libc::c_uint))
                                    & (((!(1))) as libc::c_uint);
                                *__lv
                        ...
                        if ((((((*arg).readtimeoutmsec as libc::c_int))
                            < (((0) as libc::c_int))) as libc::c_int as libc::c_int)
                            != 0)
                        {
                            (*(((devpar.c_cc).as_ptr() as *mut libc::c_uchar)
                                .wrapping_offset((5) as isize))) = ((0) as libc::c_uchar);
                            if ((((((*arg).readmincharacters as libc::c_uint))
                                > ((((((((((127) as libc::c_int))
                                    .wrapping_mul((2) as libc::c_int)) as libc::c_int))
                                    .wrapping_add((1) as libc::c_int))) as libc::c_uint)))
                                as libc::c_int as libc::c_int) != 0)
                            {
                                (*(((devpar.c_cc).as_ptr() as *mut libc::c_uchar)
                                    .wrapping_offset((6) as isize))) = (((((((((127)
                                    as libc::c_int))
                                    .wrapping_mul((2) as libc::c_int)) as libc::c_int))
                                    .wrapping_add((1) as libc::c_int))) as libc::c_uchar);
                            } else {
                                if ((((((*arg).readmincharacters as libc::c_uint))
                                    < (((1) as libc::c_uint))) as libc::c_int as libc::c_int)
                                    != 0)
                                {
                                    (*(((devpar.c_cc).as_ptr() as *mut libc::c_uchar)
                                        .wrapping_offset((6) as isize))) = ((1) as libc::c_uchar);
                                } else {
                                    (*(((devpar.c_cc).as_ptr() as *mut libc::c_uchar)
                                        .wrapping_offset((6) as isize))) = ((((*arg)
                                        .readmincharacters as libc::c_uchar)) as libc::c_uchar);
                                }
                            }
                        } else {
                            (*(((devpar.c_cc).as_ptr() as *mut libc::c_uchar)
                                .wrapping_offset((5) as isize))) = ((((((((*arg)
                                .readtimeoutmsec) as libc::c_int)) / ((100) as libc::c_int))
                                ...
                                as libc::c_int as libc::c_int) != 0)
                            {
                                ...
                                {
                                    (*(((devpar.c_cc).as_ptr() as *mut libc::c_uchar)
                                        .wrapping_offset((6) as isize))) = ((0) as libc::c_uchar);
                                } else {
                                    (*(((devpar.c_cc).as_ptr() as *mut libc::c_uchar)
                                        .wrapping_offset((6) as isize))) = ((((*arg)
                                        .readmincharacters as libc::c_uchar)) as libc::c_uchar);
                        ...
                        if (((*arg).dtrdisable as libc::c_int) != 0) {
                            {
                            ...
                            {
                                status = (((status) as libc::c_int)) | ((2) as libc::c_int);
                                status
                            };
                        }
                        <ACE_IO_SAP>::control(
...
pub unsafe fn __vdtor_ub84e94a07bc97bd0(__this: *mut ACE_Addr) {
    let _ = Box::from_raw(__this as *mut ACE_DEV_Addr);
}
pub unsafe fn __vthunk_ou84afc2b2bbfcda10_iueade8b323a2ffe30(
    __this: *mut ACE_Addr,
) -> *mut libc::c_void {
    <ACE_DEV_Addr>::get_addr((__this as *mut ACE_DEV_Addr))
}
pub unsafe fn __vthunk_ou2cf9d59e169e535a_iu2cf9d59e169e535a(
    __this: *mut ACE_DEV_Addr,
    p0: *mut libc::c_char,
    p1: libc::c_ulong,
) -> libc::c_int {
    <ACE_DEV_Addr>::addr_to_string((__this as *mut ACE_DEV_Addr), p0, p1)
}
#[repr(C)]
pub struct __Vtbl_ub84e94a07bc97bd0 {
    ...
    pub vfn_u2cf9d59e169e535a: unsafe fn(
        *mut ACE_DEV_Addr,
        *mut libc::c_char,
        libc::c_ulong,
    ) -> libc::c_int,
}
pub static __VTBL_ub84e94a07bc97bd0: __Vtbl_ub84e94a07bc97bd0 = __Vtbl_ub84e94a07bc97bd0 {
    __type_info: &__TYPEINFO_12ACE_DEV_Addr,
    __vdtor: __vdtor_ub84e94a07bc97bd0,
    vfn_ueade8b323a2ffe30: __vthunk_ou84afc2b2bbfcda10_iueade8b323a2ffe30,
    vfn_ue2ea8d5bbd9dafa3: __vthunk_oue2ea8d5bbd9dafa3_iue2ea8d5bbd9dafa3,
    vfn_uc46dbcdd1f343976: __vthunk_ouc46dbcdd1f343976_iuc46dbcdd1f343976,
    vfn_u2cf9d59e169e535a: __vthunk_ou2cf9d59e169e535a_iu2cf9d59e169e535a,
};
