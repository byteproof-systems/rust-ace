...
#[export_name = "_ZN18ACE_SOCK_ConnectorC1ER15ACE_SOCK_StreamRK8ACE_AddrPK14ACE_Time_ValueS4_iiii"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_SOCK_ConnectorC1ER15ACE_SOCK_StreamRK8ACE_AddrPK14ACE_Time_ValueS4_iiii(
    __this: *mut ACE_SOCK_Connector,
...
#[export_name = "_ZN18ACE_SOCK_Connector7connectER15ACE_SOCK_StreamRK8ACE_AddrPK14ACE_Time_ValueS4_iiii"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_SOCK_Connector7connectER15ACE_SOCK_StreamRK8ACE_AddrPK14ACE_Time_ValueS4_iiii(
    __this: *mut ACE_SOCK_Connector,
...
#[export_name = "_ZN18ACE_SOCK_Connector7connectER15ACE_SOCK_StreamRK8ACE_Addr14ACE_QoS_ParamsPK14ACE_Time_ValueS4_P17ACE_Protocol_Infommii"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_SOCK_Connector7connectER15ACE_SOCK_StreamRK8ACE_Addr14ACE_QoS_ParamsPK14ACE_Time_ValueS4_P17ACE_Protocol_Infommii(
    __this: *mut ACE_SOCK_Connector,
    new_stream: *mut ACE_SOCK_Stream,
    remote_sap: *const ACE_Addr,
    ...
    unsafe {
        ACE_SOCK_Connector::connect_ub2074e6d75d82102(
            __this,
            new_stream,
            remote_sap,
            qos_params,
...
#[export_name = "_ZN18ACE_SOCK_Connector8completeER15ACE_SOCK_StreamP8ACE_AddrPK14ACE_Time_Value"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_SOCK_Connector8completeER15ACE_SOCK_StreamP8ACE_AddrPK14ACE_Time_Value(
    __this: *mut ACE_SOCK_Connector,
    new_stream: *mut ACE_SOCK_Stream,
    remote_sap: *mut ACE_Addr,
    tv: *const ACE_Time_Value,
) -> libc::c_int {
    unsafe { ACE_SOCK_Connector::complete(__this, new_stream, remote_sap, tv) }
}
#[export_name = "_ZNK18ACE_SOCK_Connector4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK18ACE_SOCK_Connector4dumpEv(
    __this: *const ACE_SOCK_Connector,
) {
    unsafe { ACE_SOCK_Connector::dump(__this) }
}
#[export_name = "_ZN18ACE_SOCK_Connector11shared_openER15ACE_SOCK_Streamiii"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_SOCK_Connector11shared_openER15ACE_SOCK_Streamiii(
    __this: *mut ACE_SOCK_Connector,
    new_stream: *mut ACE_SOCK_Stream,
...
#[export_name = "_ZN18ACE_SOCK_Connector11shared_openER15ACE_SOCK_StreamiiP17ACE_Protocol_Infommi"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_SOCK_Connector11shared_openER15ACE_SOCK_StreamiiP17ACE_Protocol_Infommi(
    __this: *mut ACE_SOCK_Connector,
    new_stream: *mut ACE_SOCK_Stream,
    protocol_family: libc::c_int,
    protocol: libc::c_int,
    ...
    unsafe {
        ACE_SOCK_Connector::shared_open_u9e80e8f49f0e633f(
            __this,
            new_stream,
            protocol_family,
            protocol,
...
#[export_name = "_ZN18ACE_SOCK_Connector20shared_connect_startER15ACE_SOCK_StreamPK14ACE_Time_ValueRK8ACE_Addr"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_SOCK_Connector20shared_connect_startER15ACE_SOCK_StreamPK14ACE_Time_ValueRK8ACE_Addr(
    __this: *mut ACE_SOCK_Connector,
    new_stream: *mut ACE_SOCK_Stream,
    timeout: *const ACE_Time_Value,
    local_sap: *const ACE_Addr,
    ...
    unsafe {
        ACE_SOCK_Connector::shared_connect_start(__this, new_stream, timeout, local_sap)
    }
}
#[export_name = "_ZN18ACE_SOCK_Connector21shared_connect_finishER15ACE_SOCK_StreamPK14ACE_Time_Valuei"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_SOCK_Connector21shared_connect_finishER15ACE_SOCK_StreamPK14ACE_Time_Valuei(
    __this: *mut ACE_SOCK_Connector,
    new_stream: *mut ACE_SOCK_Stream,
    timeout: *const ACE_Time_Value,
    result: libc::c_int,
    ...
    unsafe {
        ACE_SOCK_Connector::shared_connect_finish(__this, new_stream, timeout, result)
    }
}
...
impl ACE_SOCK_Connector {
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/SOCK_Connector.cpp\0"
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        b"ACE_SOCK_Connector::ACE_SOCK_Connector\0".as_ptr()
                                            as *const libc::c_char,
                                    );
                                }
                            }
    ...
    pub unsafe fn new_at_ue3fa445ba1b149c8(
        __this: *mut Self,
        mut new_stream: *mut ACE_SOCK_Stream,
        mut remote_sap: *const ACE_Addr,
        ...
        unsafe {
            ...
            {
                if (((((((((((((<ACE_SOCK_Connector>::connect_ub2074e6d75d82102(
                    (__this) as *mut ACE_SOCK_Connector,
                    ::core::ptr::addr_of_mut!((* new_stream)),
                    ::core::ptr::addr_of!((* remote_sap)),
                    qos_params,
    ...
    pub unsafe fn new_ue3fa445ba1b149c8(
        mut __a0: *mut ACE_SOCK_Stream,
        mut __a1: *const ACE_Addr,
        mut __a2: ACE_QoS_Params,
        mut __a3: *const ACE_Time_Value,
        mut __a4: *const ACE_Addr,
        mut __a5: *mut ACE_Protocol_Info,
    ...
    pub unsafe fn connect(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((((<ACE_SOCK_Connector>::shared_open(
                    (__this) as *mut ACE_SOCK_Connector,
                    ::core::ptr::addr_of_mut!((* new_stream)),
                    <ACE_Addr>::get_type(
                    ...
                    as libc::c_int as libc::c_int) != 0)
                {
                    ...
                    if (((((<ACE_SOCK_Connector>::shared_connect_start(
                        (__this) as *mut ACE_SOCK_Connector,
                        ::core::ptr::addr_of_mut!((* new_stream)),
                        timeout,
                        ::core::ptr::addr_of!((* local_sap)),
                ...
                return <ACE_SOCK_Connector>::shared_connect_finish(
                    (__this) as *mut ACE_SOCK_Connector,
                    ::core::ptr::addr_of_mut!((* new_stream)),
                    timeout,
                    result,
    ...
    pub unsafe fn connect_ub2074e6d75d82102(
        ...
        mut flags: libc::c_ulong,
        mut reuse_addr: libc::c_int,
        mut _anon_9: libc::c_int,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((((<ACE_SOCK_Connector>::shared_open_u9e80e8f49f0e633f(
                    (__this) as *mut ACE_SOCK_Connector,
                    ::core::ptr::addr_of_mut!((* new_stream)),
                    <ACE_Addr>::get_type(
                        (::core::ptr::addr_of!((* remote_sap))) as *const ACE_Addr,
                ...
                let mut result: libc::c_int = ACE_OS::connect_uc00b8b6355089164(
                    <ACE_IPC_SAP>::get_handle(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((*
                            ::core::ptr::addr_of!((* (::core::ptr::addr_of!((*
                    ...
                    (({
                        ...
                        let __vt: *const __Vtbl_u8861458fe5cac90c = *(__obj
                            as *const *const __Vtbl_u8861458fe5cac90c);
                        ((*__vt).vfn_ueade8b323a2ffe30)(__obj)
                    } as *mut sockaddr)) as *const sockaddr,
                    <ACE_Addr>::get_size(
                        (::core::ptr::addr_of!((* remote_sap))) as *const ACE_Addr,
                    ),
            ...
            let __this: *mut Self = __this as *mut Self;
            {
                if (((((((((<ACE_IPC_SAP>::get_handle(
                    ...
                    && (((((<ACE_SOCK>::open(
                        (::core::ptr::addr_of_mut!(
                            (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((*
                            (::core::ptr::addr_of_mut!((* new_stream)))).__base_0)
                    ...
                    as libc::c_int) as libc::c_int) != 0)
                {
                        ...
                        ) as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
                    {
                        ...
                        ) as libc::c_int) != 0)
                        {
                            ...
                            if (((((<ACE_SOCK_Connector>::complete(
                                (__this) as *mut ACE_SOCK_Connector,
                                ::core::ptr::addr_of_mut!((* new_stream)),
                                ((0) as *mut ACE_Addr),
                                timeout,
