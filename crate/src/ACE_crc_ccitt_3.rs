...
pub mod ACE {
    ...
    #[export_name = "_ZN3ACE9crc_ccittEPKc"]
    pub unsafe extern "C-unwind" fn crc_ccitt_u4c460c26d9ccad87(
        mut string: *const libc::c_char,
    ) -> libc::c_ushort {
        unsafe {
            {
                let mut crc: libc::c_ushort = ((0xffff) as libc::c_ushort);
                {
                            ...
                            {
                                {
                                    (crc) = ((((((super::__anon_ns_9666::crc_table)[((((((((crc)
                                        ...
                                        as libc::c_int))
                                        ^ ((((((crc) as libc::c_int)).wrapping_shr((8) as u32)))
                ...
                return ((!(crc)) as libc::c_ushort);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    ///Computes CRC-CCITT for the buffer.
    #[export_name = "_ZN3ACE9crc_ccittEPKvmt"]
    pub unsafe extern "C-unwind" fn crc_ccitt_u2a057a3f51526d89(
        mut buffer: *const libc::c_void,
        mut len: libc::c_ulong,
        mut crc: libc::c_ushort,
    ) -> libc::c_ushort {
        unsafe {
            {
                crc = ((!(crc)) as libc::c_ushort);
                {
    ...
    #[export_name = "_ZN3ACE9crc_ccittEPK5iovecit"]
    pub unsafe extern "C-unwind" fn crc_ccitt(
...
pub mod __anon_ns_9666 {
    ///**************************************************************
    pub(crate) static crc_table: [libc::c_ushort; 256usize] = [
        ((0x0000) as libc::c_ushort),
        ((0x1189) as libc::c_ushort),
        ((0x2312) as libc::c_ushort),
        ((0x329b) as libc::c_ushort),
        ((0x4624) as libc::c_ushort),
        ((0x57ad) as libc::c_ushort),
        ((0x6536) as libc::c_ushort),
        ((0x74bf) as libc::c_ushort),
        ((0x8c48) as libc::c_ushort),
        ((0x9dc1) as libc::c_ushort),
        ((0xaf5a) as libc::c_ushort),
        ((0xbed3) as libc::c_ushort),
        ((0xca6c) as libc::c_ushort),
        ((0xdbe5) as libc::c_ushort),
        ((0xe97e) as libc::c_ushort),
        ((0xf8f7) as libc::c_ushort),
        ((0x1081) as libc::c_ushort),
        ((0x0108) as libc::c_ushort),
        ((0x3393) as libc::c_ushort),
        ((0x221a) as libc::c_ushort),
        ((0x56a5) as libc::c_ushort),
        ((0x472c) as libc::c_ushort),
        ((0x75b7) as libc::c_ushort),
        ((0x643e) as libc::c_ushort),
        ((0x9cc9) as libc::c_ushort),
        ((0x8d40) as libc::c_ushort),
        ((0xbfdb) as libc::c_ushort),
        ((0xae52) as libc::c_ushort),
        ((0xdaed) as libc::c_ushort),
        ((0xcb64) as libc::c_ushort),
        ((0xf9ff) as libc::c_ushort),
        ((0xe876) as libc::c_ushort),
        ((0x2102) as libc::c_ushort),
        ((0x308b) as libc::c_ushort),
        ((0x0210) as libc::c_ushort),
        ((0x1399) as libc::c_ushort),
        ((0x6726) as libc::c_ushort),
        ((0x76af) as libc::c_ushort),
        ((0x4434) as libc::c_ushort),
        ((0x55bd) as libc::c_ushort),
        ((0xad4a) as libc::c_ushort),
        ((0xbcc3) as libc::c_ushort),
        ((0x8e58) as libc::c_ushort),
        ((0x9fd1) as libc::c_ushort),
        ((0xeb6e) as libc::c_ushort),
        ((0xfae7) as libc::c_ushort),
        ((0xc87c) as libc::c_ushort),
        ((0xd9f5) as libc::c_ushort),
        ((0x3183) as libc::c_ushort),
        ((0x200a) as libc::c_ushort),
        ((0x1291) as libc::c_ushort),
        ((0x0318) as libc::c_ushort),
        ((0x77a7) as libc::c_ushort),
        ((0x662e) as libc::c_ushort),
        ((0x54b5) as libc::c_ushort),
        ((0x453c) as libc::c_ushort),
        ((0xbdcb) as libc::c_ushort),
        ((0xac42) as libc::c_ushort),
        ((0x9ed9) as libc::c_ushort),
        ((0x8f50) as libc::c_ushort),
        ((0xfbef) as libc::c_ushort),
        ((0xea66) as libc::c_ushort),
        ((0xd8fd) as libc::c_ushort),
        ((0xc974) as libc::c_ushort),
        ((0x4204) as libc::c_ushort),
        ((0x538d) as libc::c_ushort),
        ((0x6116) as libc::c_ushort),
        ((0x709f) as libc::c_ushort),
        ((0x0420) as libc::c_ushort),
        ((0x15a9) as libc::c_ushort),
        ((0x2732) as libc::c_ushort),
        ((0x36bb) as libc::c_ushort),
        ((0xce4c) as libc::c_ushort),
        ((0xdfc5) as libc::c_ushort),
        ((0xed5e) as libc::c_ushort),
        ((0xfcd7) as libc::c_ushort),
        ((0x8868) as libc::c_ushort),
        ((0x99e1) as libc::c_ushort),
        ((0xab7a) as libc::c_ushort),
        ((0xbaf3) as libc::c_ushort),
        ((0x5285) as libc::c_ushort),
        ((0x430c) as libc::c_ushort),
        ((0x7197) as libc::c_ushort),
        ((0x601e) as libc::c_ushort),
        ((0x14a1) as libc::c_ushort),
        ((0x0528) as libc::c_ushort),
        ((0x37b3) as libc::c_ushort),
        ((0x263a) as libc::c_ushort),
        ((0xdecd) as libc::c_ushort),
        ((0xcf44) as libc::c_ushort),
        ((0xfddf) as libc::c_ushort),
        ((0xec56) as libc::c_ushort),
        ((0x98e9) as libc::c_ushort),
        ((0x8960) as libc::c_ushort),
        ((0xbbfb) as libc::c_ushort),
        ((0xaa72) as libc::c_ushort),
        ((0x6306) as libc::c_ushort),
        ((0x728f) as libc::c_ushort),
        ((0x4014) as libc::c_ushort),
        ((0x519d) as libc::c_ushort),
        ((0x2522) as libc::c_ushort),
        ((0x34ab) as libc::c_ushort),
        ((0x0630) as libc::c_ushort),
        ((0x17b9) as libc::c_ushort),
        ((0xef4e) as libc::c_ushort),
        ((0xfec7) as libc::c_ushort),
        ((0xcc5c) as libc::c_ushort),
        ((0xddd5) as libc::c_ushort),
        ((0xa96a) as libc::c_ushort),
        ((0xb8e3) as libc::c_ushort),
        ((0x8a78) as libc::c_ushort),
        ((0x9bf1) as libc::c_ushort),
        ((0x7387) as libc::c_ushort),
        ((0x620e) as libc::c_ushort),
        ((0x5095) as libc::c_ushort),
        ((0x411c) as libc::c_ushort),
        ((0x35a3) as libc::c_ushort),
        ((0x242a) as libc::c_ushort),
        ((0x16b1) as libc::c_ushort),
        ((0x0738) as libc::c_ushort),
        ((0xffcf) as libc::c_ushort),
        ((0xee46) as libc::c_ushort),
        ((0xdcdd) as libc::c_ushort),
        ((0xcd54) as libc::c_ushort),
        ((0xb9eb) as libc::c_ushort),
        ((0xa862) as libc::c_ushort),
        ((0x9af9) as libc::c_ushort),
        ((0x8b70) as libc::c_ushort),
        ((0x8408) as libc::c_ushort),
        ((0x9581) as libc::c_ushort),
        ((0xa71a) as libc::c_ushort),
        ((0xb693) as libc::c_ushort),
        ((0xc22c) as libc::c_ushort),
        ((0xd3a5) as libc::c_ushort),
        ((0xe13e) as libc::c_ushort),
        ((0xf0b7) as libc::c_ushort),
        ((0x0840) as libc::c_ushort),
        ((0x19c9) as libc::c_ushort),
        ((0x2b52) as libc::c_ushort),
        ((0x3adb) as libc::c_ushort),
        ((0x4e64) as libc::c_ushort),
        ((0x5fed) as libc::c_ushort),
        ((0x6d76) as libc::c_ushort),
        ((0x7cff) as libc::c_ushort),
        ((0x9489) as libc::c_ushort),
        ((0x8500) as libc::c_ushort),
        ((0xb79b) as libc::c_ushort),
        ((0xa612) as libc::c_ushort),
        ((0xd2ad) as libc::c_ushort),
        ((0xc324) as libc::c_ushort),
        ((0xf1bf) as libc::c_ushort),
        ((0xe036) as libc::c_ushort),
        ((0x18c1) as libc::c_ushort),
        ((0x0948) as libc::c_ushort),
        ((0x3bd3) as libc::c_ushort),
        ((0x2a5a) as libc::c_ushort),
        ((0x5ee5) as libc::c_ushort),
        ((0x4f6c) as libc::c_ushort),
        ((0x7df7) as libc::c_ushort),
        ((0x6c7e) as libc::c_ushort),
        ((0xa50a) as libc::c_ushort),
        ((0xb483) as libc::c_ushort),
        ((0x8618) as libc::c_ushort),
        ((0x9791) as libc::c_ushort),
        ((0xe32e) as libc::c_ushort),
        ((0xf2a7) as libc::c_ushort),
        ((0xc03c) as libc::c_ushort),
        ((0xd1b5) as libc::c_ushort),
        ((0x2942) as libc::c_ushort),
        ((0x38cb) as libc::c_ushort),
        ((0x0a50) as libc::c_ushort),
        ((0x1bd9) as libc::c_ushort),
        ((0x6f66) as libc::c_ushort),
        ((0x7eef) as libc::c_ushort),
        ((0x4c74) as libc::c_ushort),
        ((0x5dfd) as libc::c_ushort),
        ((0xb58b) as libc::c_ushort),
        ((0xa402) as libc::c_ushort),
        ((0x9699) as libc::c_ushort),
        ((0x8710) as libc::c_ushort),
        ((0xf3af) as libc::c_ushort),
        ((0xe226) as libc::c_ushort),
        ((0xd0bd) as libc::c_ushort),
        ((0xc134) as libc::c_ushort),
        ((0x39c3) as libc::c_ushort),
        ((0x284a) as libc::c_ushort),
        ((0x1ad1) as libc::c_ushort),
        ((0x0b58) as libc::c_ushort),
        ((0x7fe7) as libc::c_ushort),
        ((0x6e6e) as libc::c_ushort),
        ((0x5cf5) as libc::c_ushort),
        ((0x4d7c) as libc::c_ushort),
        ((0xc60c) as libc::c_ushort),
        ((0xd785) as libc::c_ushort),
        ((0xe51e) as libc::c_ushort),
        ((0xf497) as libc::c_ushort),
        ((0x8028) as libc::c_ushort),
        ((0x91a1) as libc::c_ushort),
        ((0xa33a) as libc::c_ushort),
        ((0xb2b3) as libc::c_ushort),
        ((0x4a44) as libc::c_ushort),
        ((0x5bcd) as libc::c_ushort),
        ((0x6956) as libc::c_ushort),
        ((0x78df) as libc::c_ushort),
        ((0x0c60) as libc::c_ushort),
        ((0x1de9) as libc::c_ushort),
        ((0x2f72) as libc::c_ushort),
        ((0x3efb) as libc::c_ushort),
        ((0xd68d) as libc::c_ushort),
        ((0xc704) as libc::c_ushort),
        ((0xf59f) as libc::c_ushort),
        ((0xe416) as libc::c_ushort),
        ((0x90a9) as libc::c_ushort),
        ((0x8120) as libc::c_ushort),
        ((0xb3bb) as libc::c_ushort),
        ((0xa232) as libc::c_ushort),
        ((0x5ac5) as libc::c_ushort),
        ((0x4b4c) as libc::c_ushort),
        ((0x79d7) as libc::c_ushort),
        ((0x685e) as libc::c_ushort),
        ((0x1ce1) as libc::c_ushort),
        ((0x0d68) as libc::c_ushort),
        ((0x3ff3) as libc::c_ushort),
        ((0x2e7a) as libc::c_ushort),
        ((0xe70e) as libc::c_ushort),
        ((0xf687) as libc::c_ushort),
        ((0xc41c) as libc::c_ushort),
        ((0xd595) as libc::c_ushort),
        ((0xa12a) as libc::c_ushort),
        ((0xb0a3) as libc::c_ushort),
        ((0x8238) as libc::c_ushort),
        ((0x93b1) as libc::c_ushort),
        ((0x6b46) as libc::c_ushort),
        ((0x7acf) as libc::c_ushort),
        ((0x4854) as libc::c_ushort),
        ((0x59dd) as libc::c_ushort),
        ((0x2d62) as libc::c_ushort),
        ((0x3ceb) as libc::c_ushort),
        ((0x0e70) as libc::c_ushort),
        ((0x1ff9) as libc::c_ushort),
        ((0xf78f) as libc::c_ushort),
        ((0xe606) as libc::c_ushort),
        ((0xd49d) as libc::c_ushort),
        ((0xc514) as libc::c_ushort),
        ((0xb1ab) as libc::c_ushort),
        ((0xa022) as libc::c_ushort),
        ((0x92b9) as libc::c_ushort),
        ((0x8330) as libc::c_ushort),
        ((0x7bc7) as libc::c_ushort),
        ((0x6a4e) as libc::c_ushort),
        ((0x58d5) as libc::c_ushort),
        ((0x495c) as libc::c_ushort),
        ((0x3de3) as libc::c_ushort),
        ((0x2c6a) as libc::c_ushort),
        ((0x1ef1) as libc::c_ushort),
        ((0x0f78) as libc::c_ushort),
    ];
}
extern "C-unwind" {
