...
#[export_name = "_ZN16ACE_Thread_MutexC1EPKcP19pthread_mutexattr_t"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_Thread_MutexC1EPKcP19pthread_mutexattr_t(
    __this: *mut ACE_Thread_Mutex,
    __a0: *const libc::c_char,
    __a1: *mut pthread_mutexattr_t,
) {
    ACE_Thread_Mutex::new_at(__this, __a0, __a1)
}
impl Drop for ACE_Thread_Mutex {
    fn drop(&mut self) {
        unsafe {
            let __this: *mut Self = self as *mut Self;
            {
                <ACE_Thread_Mutex>::remove((__this) as *mut ACE_Thread_Mutex);
            }
            ()
        }
    }
}
#[export_name = "__acedtor_u2944902dcb34c4d7"]
pub unsafe extern "C-unwind" fn __acedtor_u2944902dcb34c4d7(
    __this: *mut ACE_Thread_Mutex,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[export_name = "_ZNK16ACE_Thread_Mutex4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK16ACE_Thread_Mutex4dumpEv(
    __this: *const ACE_Thread_Mutex,
) {
    unsafe { ACE_Thread_Mutex::dump(__this) }
}
#[repr(C)]
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/Thread_Mutex.cpp\0".as_ptr()
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        b"ACE_Thread_Mutex::ACE_Thread_Mutex\0".as_ptr()
                                            as *const libc::c_char,
                                    );
                                }
                            }
