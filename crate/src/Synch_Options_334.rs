...
#[allow(non_upper_case_globals)]
#[no_mangle]
pub static mut ACE_Synch_Options_defaults: ACE_Synch_Options = unsafe {
    ::core::mem::MaybeUninit::<ACE_Synch_Options>::zeroed().assume_init()
};
#[allow(non_upper_case_globals)]
#[no_mangle]
pub static mut ACE_Synch_Options_synch: ACE_Synch_Options = unsafe {
    ::core::mem::MaybeUninit::<ACE_Synch_Options>::zeroed().assume_init()
};
#[allow(non_upper_case_globals)]
#[no_mangle]
pub static mut ACE_Synch_Options_asynch: ACE_Synch_Options = unsafe {
    ::core::mem::MaybeUninit::<ACE_Synch_Options>::zeroed().assume_init()
};
#[export_name = "_ZN17ACE_Synch_OptionsC1EmRK14ACE_Time_ValuePKv"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Synch_OptionsC1EmRK14ACE_Time_ValuePKv(
    __this: *mut ACE_Synch_Options,
    __a0: libc::c_ulong,
    __a1: *const ACE_Time_Value,
    __a2: *const libc::c_void,
) {
    ACE_Synch_Options::new_at(__this, __a0, __a1, __a2)
}
#[export_name = "_ZN17ACE_Synch_Options3setEmRK14ACE_Time_ValuePKv"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Synch_Options3setEmRK14ACE_Time_ValuePKv(
    __this: *mut ACE_Synch_Options,
    options: libc::c_ulong,
    timeout: *const ACE_Time_Value,
    arg: *const libc::c_void,
) {
    unsafe { ACE_Synch_Options::set(__this, options, timeout, arg) }
}
#[export_name = "_ZNK17ACE_Synch_OptionsixEm"]
pub unsafe extern "C-unwind" fn __xtu__ZNK17ACE_Synch_OptionsixEm(
    __this: *const ACE_Synch_Options,
    option: libc::c_ulong,
) -> bool {
    unsafe { ACE_Synch_Options::operator_index(__this, option) }
}
#[export_name = "_ZN17ACE_Synch_OptionsaSEm"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Synch_OptionsaSEm(
    __this: *mut ACE_Synch_Options,
    option: libc::c_ulong,
) {
    unsafe { ACE_Synch_Options::operator_assign(__this, option) }
}
#[export_name = "_ZNK17ACE_Synch_Options3argEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK17ACE_Synch_Options3argEv(
    __this: *const ACE_Synch_Options,
) -> *const libc::c_void {
    unsafe { ACE_Synch_Options::arg(__this) }
}
#[export_name = "_ZN17ACE_Synch_Options3argEPKv"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Synch_Options3argEPKv(
    __this: *mut ACE_Synch_Options,
    a: *const libc::c_void,
) {
    unsafe { ACE_Synch_Options::arg_u55a7ee34b98bb1a7(__this, a) }
}
#[export_name = "_ZNK17ACE_Synch_Options7timeoutEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK17ACE_Synch_Options7timeoutEv(
    __this: *const ACE_Synch_Options,
) -> *const ACE_Time_Value {
    unsafe { ACE_Synch_Options::timeout(__this) }
}
#[export_name = "_ZN17ACE_Synch_Options7timeoutERK14ACE_Time_Value"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Synch_Options7timeoutERK14ACE_Time_Value(
    __this: *mut ACE_Synch_Options,
    tv: *const ACE_Time_Value,
) {
    unsafe { ACE_Synch_Options::timeout_u266e97bbec1ddb0e(__this, tv) }
}
#[export_name = "_ZNK17ACE_Synch_Options10time_valueEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK17ACE_Synch_Options10time_valueEv(
    __this: *const ACE_Synch_Options,
) -> *const ACE_Time_Value {
    unsafe { ACE_Synch_Options::time_value(__this) }
}
#[export_name = "_ZNK17ACE_Synch_Options4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK17ACE_Synch_Options4dumpEv(
    __this: *const ACE_Synch_Options,
) {
    unsafe { ACE_Synch_Options::dump(__this) }
}
extern "C-unwind" {
...
unsafe extern "C-unwind" fn __rt_static_init() {
    ::core::ptr::write(
        ::core::ptr::addr_of_mut!(ACE_Synch_Options_defaults),
        <ACE_Synch_Options>::new(
            ((0) as libc::c_ulong),
            &(<ACE_Time_Value>::new()) as *const ACE_Time_Value,
            ((0) as *const libc::c_void),
        ),
    );
    ::core::ptr::write(
        ::core::ptr::addr_of_mut!(ACE_Synch_Options_synch),
        <ACE_Synch_Options>::new(
            ((0) as libc::c_ulong),
            &(<ACE_Time_Value>::new()) as *const ACE_Time_Value,
            ((0) as *const libc::c_void),
    ...
    ::core::ptr::write(
        ::core::ptr::addr_of_mut!(ACE_Synch_Options_asynch),
        <ACE_Synch_Options>::new(
