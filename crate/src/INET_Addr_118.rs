...
impl Clone for ACE_INET_Addr {
    #[inline]
    fn clone(&self) -> Self {
        unsafe { Self::new_ufdc256446431ae0e(self as *const Self) }
    }
}
#[export_name = "_ZN13ACE_INET_AddrC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_INET_AddrC1Ev(
    __this: *mut ACE_INET_Addr,
) {
    ACE_INET_Addr::new_at(__this)
}
#[export_name = "_ZN13ACE_INET_AddrC1ERKS_"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_INET_AddrC1ERKS_(
    __this: *mut ACE_INET_Addr,
    __a0: *const ACE_INET_Addr,
) {
    ACE_INET_Addr::new_at_ufdc256446431ae0e(__this, __a0)
}
#[export_name = "_ZN13ACE_INET_AddrC1EPK11sockaddr_ini"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_INET_AddrC1EPK11sockaddr_ini(
    __this: *mut ACE_INET_Addr,
    __a0: *const sockaddr_in,
    __a1: libc::c_int,
) {
    ACE_INET_Addr::new_at_u7d57fae8a46ef0f3(__this, __a0, __a1)
}
#[export_name = "_ZN13ACE_INET_AddrC1EtPKci"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_INET_AddrC1EtPKci(
    __this: *mut ACE_INET_Addr,
    __a0: libc::c_ushort,
    __a1: *const libc::c_char,
    __a2: libc::c_int,
) {
    ACE_INET_Addr::new_at_u85c760a46d886990(__this, __a0, __a1, __a2)
}
#[export_name = "_ZN13ACE_INET_AddrC1EPKci"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_INET_AddrC1EPKci(
    __this: *mut ACE_INET_Addr,
    __a0: *const libc::c_char,
    __a1: libc::c_int,
) {
    ACE_INET_Addr::new_at_u1f600faeb3053862(__this, __a0, __a1)
}
#[export_name = "_ZN13ACE_INET_AddrC1Etj"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_INET_AddrC1Etj(
    __this: *mut ACE_INET_Addr,
    __a0: libc::c_ushort,
    __a1: libc::c_uint,
) {
    ACE_INET_Addr::new_at_uccf807117aa945b3(__this, __a0, __a1)
}
#[export_name = "_ZN13ACE_INET_AddrC1EPKcS1_S1_"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_INET_AddrC1EPKcS1_S1_(
    __this: *mut ACE_INET_Addr,
    __a0: *const libc::c_char,
    __a1: *const libc::c_char,
    __a2: *const libc::c_char,
) {
    ACE_INET_Addr::new_at_ucdb04bf5cb5195d6(__this, __a0, __a1, __a2)
}
#[export_name = "_ZN13ACE_INET_AddrC1EPKcjS1_"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_INET_AddrC1EPKcjS1_(
    __this: *mut ACE_INET_Addr,
    __a0: *const libc::c_char,
    __a1: libc::c_uint,
    __a2: *const libc::c_char,
) {
    ACE_INET_Addr::new_at_ub3fdd154b4ca85f3(__this, __a0, __a1, __a2)
}
#[export_name = "_ZN13ACE_INET_AddrC1EtPKwi"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_INET_AddrC1EtPKwi(
    __this: *mut ACE_INET_Addr,
    __a0: libc::c_ushort,
    __a1: *const libc::wchar_t,
    __a2: libc::c_int,
) {
    ACE_INET_Addr::new_at_udd5b903f2a757c84(__this, __a0, __a1, __a2)
}
#[export_name = "_ZN13ACE_INET_AddrC1EPKwi"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_INET_AddrC1EPKwi(
    __this: *mut ACE_INET_Addr,
    __a0: *const libc::wchar_t,
    __a1: libc::c_int,
) {
    ACE_INET_Addr::new_at_uca351f4be2ae3ee6(__this, __a0, __a1)
}
#[export_name = "_ZN13ACE_INET_AddrC1EPKwS1_S1_"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_INET_AddrC1EPKwS1_S1_(
    __this: *mut ACE_INET_Addr,
    __a0: *const libc::wchar_t,
    __a1: *const libc::wchar_t,
    __a2: *const libc::wchar_t,
) {
    ACE_INET_Addr::new_at_uf0a9b5a7ab65abaa(__this, __a0, __a1, __a2)
}
#[export_name = "_ZN13ACE_INET_AddrC1EPKwjS1_"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_INET_AddrC1EPKwjS1_(
    __this: *mut ACE_INET_Addr,
    __a0: *const libc::wchar_t,
    __a1: libc::c_uint,
    __a2: *const libc::wchar_t,
) {
    ACE_INET_Addr::new_at_u881c7b3be891e7af(__this, __a0, __a1, __a2)
}
impl Drop for ACE_INET_Addr {
    fn drop(&mut self) {
        {
            unsafe {
...
#[export_name = "_ZN13ACE_INET_AddraSERKS_"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_INET_AddraSERKS_(
    __this: *mut ACE_INET_Addr,
    rhs: *const ACE_INET_Addr,
) -> *mut ACE_INET_Addr {
    unsafe { ACE_INET_Addr::operator_assign(__this, rhs) }
}
#[export_name = "_ZN13ACE_INET_Addr3setERKS_"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_INET_Addr3setERKS_(
    __this: *mut ACE_INET_Addr,
    sa: *const ACE_INET_Addr,
) -> libc::c_int {
    unsafe { ACE_INET_Addr::set(__this, sa) }
}
#[export_name = "_ZN13ACE_INET_Addr3setEtPKcii"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_INET_Addr3setEtPKcii(
    __this: *mut ACE_INET_Addr,
    ...
    unsafe {
        ACE_INET_Addr::set_u7beffee0f8836764(
            __this,
            port_number,
            host_name,
            encode,
...
#[export_name = "_ZN13ACE_INET_Addr3setEtjii"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_INET_Addr3setEtjii(
    __this: *mut ACE_INET_Addr,
    port_number: libc::c_ushort,
    inet_address: libc::c_uint,
    encode: libc::c_int,
    map: libc::c_int,
) -> libc::c_int {
    unsafe {
        ACE_INET_Addr::set_u25969953d4ee6f07(
            __this,
            port_number,
            inet_address,
            encode,
...
#[export_name = "_ZN13ACE_INET_Addr3setEPKcS1_S1_"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_INET_Addr3setEPKcS1_S1_(
    __this: *mut ACE_INET_Addr,
    ...
    unsafe {
        ACE_INET_Addr::set_u95cc26a19650f362(__this, port_name, host_name, protocol)
    }
}
#[export_name = "_ZN13ACE_INET_Addr3setEPKcjS1_"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_INET_Addr3setEPKcjS1_(
    __this: *mut ACE_INET_Addr,
    port_name: *const libc::c_char,
    inet_address: libc::c_uint,
    protocol: *const libc::c_char,
    ...
    unsafe {
        ACE_INET_Addr::set_u96435504a79ea087(__this, port_name, inet_address, protocol)
    }
}
#[export_name = "_ZN13ACE_INET_Addr3setEPKci"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_INET_Addr3setEPKci(
    __this: *mut ACE_INET_Addr,
    address: *const libc::c_char,
    address_family: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_INET_Addr::set_u1c01826cbf0f2d4e(__this, address, address_family) }
}
#[export_name = "_ZN13ACE_INET_Addr3setEPK11sockaddr_ini"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_INET_Addr3setEPK11sockaddr_ini(
    __this: *mut ACE_INET_Addr,
    addr: *const sockaddr_in,
    len: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_INET_Addr::set_u463e6dadeed4b31f(__this, addr, len) }
}
#[export_name = "_ZNK13ACE_INET_Addr8get_addrEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_INET_Addr8get_addrEv(
    __this: *const ACE_INET_Addr,
) -> *mut libc::c_void {
    unsafe { ACE_INET_Addr::get_addr(__this) }
}
#[export_name = "_ZN13ACE_INET_Addr8set_addrEPKvi"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_INET_Addr8set_addrEPKvi(
    __this: *mut ACE_INET_Addr,
    addr: *const libc::c_void,
    len: libc::c_int,
) {
    unsafe { ACE_INET_Addr::set_addr(__this, addr, len) }
}
#[export_name = "_ZN13ACE_INET_Addr8set_addrEPKvii"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_INET_Addr8set_addrEPKvii(
    __this: *mut ACE_INET_Addr,
    addr: *const libc::c_void,
    _anon_1: libc::c_int,
    map: libc::c_int,
) {
    unsafe { ACE_INET_Addr::set_addr_ud6313bc69c6faed5(__this, addr, _anon_1, map) }
}
#[export_name = "_ZNK13ACE_INET_Addr14addr_to_stringEPcmi"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_INET_Addr14addr_to_stringEPcmi(
    __this: *const ACE_INET_Addr,
    s: *mut libc::c_char,
    size: libc::c_ulong,
    ipaddr_format: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_INET_Addr::addr_to_string(__this, s, size, ipaddr_format) }
}
#[export_name = "_ZN13ACE_INET_Addr14string_to_addrEPKci"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_INET_Addr14string_to_addrEPKci(
    __this: *mut ACE_INET_Addr,
    s: *const libc::c_char,
    address_family: libc::c_int,
) -> libc::c_int {
    unsafe { ACE_INET_Addr::string_to_addr(__this, s, address_family) }
}
#[export_name = "_ZN13ACE_INET_Addr15set_port_numberEti"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_INET_Addr15set_port_numberEti(
    __this: *mut ACE_INET_Addr,
    port_number: libc::c_ushort,
    encode: libc::c_int,
) {
    unsafe { ACE_INET_Addr::set_port_number(__this, port_number, encode) }
}
#[export_name = "_ZN13ACE_INET_Addr11set_addressEPKciii"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_INET_Addr11set_addressEPKciii(
    __this: *mut ACE_INET_Addr,
    ...
    unsafe { ACE_INET_Addr::set_address(__this, ip_addr, len, encode, map) }
}
#[export_name = "_ZNK13ACE_INET_Addr13get_host_nameEPcm"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_INET_Addr13get_host_nameEPcm(
    __this: *const ACE_INET_Addr,
    hostname: *mut libc::c_char,
    len: libc::c_ulong,
) -> libc::c_int {
    unsafe { ACE_INET_Addr::get_host_name(__this, hostname, len) }
}
#[export_name = "_ZNK13ACE_INET_Addr13get_host_nameEPwm"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_INET_Addr13get_host_nameEPwm(
    __this: *const ACE_INET_Addr,
    hostname: *mut libc::wchar_t,
    len: libc::c_ulong,
) -> libc::c_int {
    unsafe { ACE_INET_Addr::get_host_name_u44c430077e6123ac(__this, hostname, len) }
}
#[export_name = "_ZNK13ACE_INET_Addr13get_host_nameEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_INET_Addr13get_host_nameEv(
    __this: *const ACE_INET_Addr,
) -> *const libc::c_char {
    unsafe { ACE_INET_Addr::get_host_name_u9e4db10baaeaecab(__this) }
}
#[export_name = "_ZNK13ACE_INET_Addr13get_host_addrEPci"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_INET_Addr13get_host_addrEPci(
    __this: *const ACE_INET_Addr,
    dst: *mut libc::c_char,
    size: libc::c_int,
) -> *const libc::c_char {
    unsafe { ACE_INET_Addr::get_host_addr(__this, dst, size) }
}
#[export_name = "_ZNK13ACE_INET_Addr13get_host_addrEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_INET_Addr13get_host_addrEv(
    __this: *const ACE_INET_Addr,
) -> *const libc::c_char {
    unsafe { ACE_INET_Addr::get_host_addr_u74ff37b8fb08070b(__this) }
}
#[export_name = "_ZNK13ACE_INET_Addr14get_ip_addressEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_INET_Addr14get_ip_addressEv(
    __this: *const ACE_INET_Addr,
) -> libc::c_uint {
    unsafe { ACE_INET_Addr::get_ip_address(__this) }
}
#[export_name = "_ZNK13ACE_INET_AddreqERKS_"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_INET_AddreqERKS_(
    __this: *const ACE_INET_Addr,
    sap: *const ACE_INET_Addr,
) -> bool {
    unsafe { ACE_INET_Addr::operator_eq(__this, sap) }
}
#[export_name = "_ZNK13ACE_INET_AddrneERKS_"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_INET_AddrneERKS_(
    __this: *const ACE_INET_Addr,
    sap: *const ACE_INET_Addr,
) -> bool {
    unsafe { ACE_INET_Addr::operator_ne(__this, sap) }
}
#[export_name = "_ZNK13ACE_INET_Addr11is_ip_equalERKS_"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_INET_Addr11is_ip_equalERKS_(
    __this: *const ACE_INET_Addr,
    sap: *const ACE_INET_Addr,
) -> bool {
    unsafe { ACE_INET_Addr::is_ip_equal(__this, sap) }
}
#[export_name = "_ZNK13ACE_INET_Addr4hashEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_INET_Addr4hashEv(
    __this: *const ACE_INET_Addr,
) -> libc::c_ulong {
    unsafe { ACE_INET_Addr::hash(__this) }
}
#[export_name = "_ZN13ACE_INET_Addr4nextEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_INET_Addr4nextEv(
    __this: *mut ACE_INET_Addr,
) -> bool {
    unsafe { ACE_INET_Addr::next(__this) }
}
#[export_name = "_ZN13ACE_INET_Addr5resetEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN13ACE_INET_Addr5resetEv(
    __this: *mut ACE_INET_Addr,
) {
    unsafe { ACE_INET_Addr::reset(__this) }
}
#[export_name = "_ZNK13ACE_INET_Addr4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_INET_Addr4dumpEv(
    __this: *const ACE_INET_Addr,
) {
    unsafe { ACE_INET_Addr::dump(__this) }
}
#[export_name = "_ZNK13ACE_INET_Addr15get_host_name_iEPcm"]
pub unsafe extern "C-unwind" fn __xtu__ZNK13ACE_INET_Addr15get_host_name_iEPcm(
    __this: *const ACE_INET_Addr,
    hostname: *mut libc::c_char,
    len: libc::c_ulong,
) -> libc::c_int {
    unsafe { ACE_INET_Addr::get_host_name_i(__this, hostname, len) }
}
pub mod ACE {
    extern "C-unwind" {
...
pub(crate) unsafe extern "C-unwind" fn get_port_number_from_name(
    ...
    unsafe {
        {
            ...
            let mut port_number: libc::c_long = ACE_OS::strtol_u0d03b0a19d8ced84(
                ((port_name) as *const libc::c_char),
                ::core::ptr::addr_of_mut!(endp) as *mut *mut libc::c_char,
                10,
            );
            if ((((((*(endp)) as libc::c_int as libc::c_char))
                == (((0 as libc::c_char) as libc::c_int as libc::c_char))) as libc::c_int
                as libc::c_int) != 0)
            {
                if (((((((((port_number as libc::c_long)) < (((0) as libc::c_long)))
                    as libc::c_int as libc::c_int) != 0)
                    || (((((port_number as libc::c_long)) > (((65535) as libc::c_long)))
                        as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    return (-((1) as libc::c_int));
                }
                let mut n: libc::c_ushort = (port_number as libc::c_ushort);
                n = ((__bswap_16(((n) as libc::c_ushort))) as libc::c_ushort);
                return ((n) as libc::c_int);
            }
            port_number = (((-((1) as libc::c_int))) as libc::c_long);
            let mut sentry: servent = unsafe {
                ::core::mem::MaybeUninit::<servent>::zeroed().assume_init()
            };
            let mut buf: [libc::c_char; 4096usize] = unsafe { ::core::mem::zeroed() };
            let mut sp: *mut servent = ((ACE_OS::getservbyname_r_u7054edf2cbe5b4bd(
                ((port_name) as *const libc::c_char),
                ((protocol) as *const libc::c_char),
                ((::core::ptr::addr_of_mut!(sentry) as *mut servent) as *mut servent),
                ((buf).as_mut_ptr() as *mut libc::c_char),
            )) as *mut servent);
            if ((((!(sp).is_null()) as libc::c_int) as libc::c_int) != 0) {
                port_number = (((*sp).s_port) as libc::c_long);
            }
            return ((port_number) as libc::c_int);
        }
        #[allow(unreachable_code)] { ::core::unreachable!() }
    }
}
...
impl ACE_INET_Addr {
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ...
            <ACE_Addr>::new_at(
                (::core::ptr::addr_of_mut!((* __this).__base_0).cast::<ACE_Addr>())
                    as *mut ACE_Addr,
                <ACE_INET_Addr>::determine_type((__this) as *const ACE_INET_Addr),
                ((::core::mem::size_of::<ip46>() as libc::c_ulong) as libc::c_int),
            );
            *(__this as *mut *const ()) = &__VTBL_ued8c6ee26a6e6919
                as *const __Vtbl_ued8c6ee26a6e6919 as *const ();
            {
                <ACE_INET_Addr>::reset_i((__this) as *mut ACE_INET_Addr);
            }
            ()
        }
    }
    ...
    pub unsafe fn new_at_ufdc256446431ae0e(
        ...
        unsafe {
            ...
            <ACE_Addr>::new_at(
                ...
                <ACE_Addr>::get_type(
                    (::core::ptr::addr_of!(
                        (* ::core::ptr::addr_of!((* (::core::ptr::addr_of!((* sa))))
                        .__base_0) .cast:: < ACE_Addr > ().cast_mut())
                    )) as *const ACE_Addr,
                ),
                <ACE_Addr>::get_size(
                    (::core::ptr::addr_of!(
    ...
    pub unsafe fn new_at_u7d57fae8a46ef0f3(
        ...
        unsafe {
            ...
            *(__this as *mut *const ()) = &__VTBL_ued8c6ee26a6e6919
                as *const __Vtbl_ued8c6ee26a6e6919 as *const ();
            {
                <ACE_INET_Addr>::set_u463e6dadeed4b31f(
                    (__this) as *mut ACE_INET_Addr,
                    addr,
                    len,
                );
        ...
        unsafe {
            ...
            *(__this as *mut *const ()) = &__VTBL_ued8c6ee26a6e6919
                as *const __Vtbl_ued8c6ee26a6e6919 as *const ();
            {
                ...
                if (((((<ACE_INET_Addr>::set_u7beffee0f8836764(
                    (__this) as *mut ACE_INET_Addr,
                    port_number,
                    ((host_name) as *const libc::c_char),
                    1,
                    address_family,
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/INET_Addr.cpp\0".as_ptr()
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        (ace___) as *mut ACE_Log_Category_TSS,
                                        LM_ERROR,
                                        ((b"ACE_INET_Addr::ACE_INET_Addr: %p\n\0".as_ptr()
                                            as *const libc::c_char) as *const libc::c_char),
                                        if ((((((host_name).is_null()) as libc::c_int))
                                            as libc::c_int) != 0)
                                        {
                                            b"<unknown>\0".as_ptr() as *const libc::c_char
                                        } else {
                                            ((host_name) as *const libc::c_char)
                                        },
                                    );
    ...
    pub unsafe fn new_at_u1f600faeb3053862(
        ...
        unsafe {
            ...
            *(__this as *mut *const ()) = &__VTBL_ued8c6ee26a6e6919
                as *const __Vtbl_ued8c6ee26a6e6919 as *const ();
            {
                <ACE_INET_Addr>::set_u1c01826cbf0f2d4e(
                    (__this) as *mut ACE_INET_Addr,
    ...
    pub unsafe fn new_at_uccf807117aa945b3(
        ...
        unsafe {
            ...
            *(__this as *mut *const ()) = &__VTBL_ued8c6ee26a6e6919
                as *const __Vtbl_ued8c6ee26a6e6919 as *const ();
            {
                if (((((<ACE_INET_Addr>::set_u25969953d4ee6f07(
                    (__this) as *mut ACE_INET_Addr,
                    port_number,
                    inet_address,
                    1,
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        b"ACE_INET_Addr::ACE_INET_Addr\0".as_ptr()
                                            as *const libc::c_char,
                                    );
                                }
                            }
  ...
  /// @a port_name, the remote @a host_name, and the @a protocol.*/
    pub unsafe fn new_at_ucdb04bf5cb5195d6(
        ...
        unsafe {
            ...
            *(__this as *mut *const ()) = &__VTBL_ued8c6ee26a6e6919
                as *const __Vtbl_ued8c6ee26a6e6919 as *const ();
            {
                if (((((<ACE_INET_Addr>::set_u95cc26a19650f362(
                    (__this) as *mut ACE_INET_Addr,
                    ((port_name) as *const libc::c_char),
                    ((host_name) as *const libc::c_char),
                    ((protocol) as *const libc::c_char),
    ...
    pub unsafe fn new_at_ub3fdd154b4ca85f3(
        ...
        unsafe {
            ...
            *(__this as *mut *const ()) = &__VTBL_ued8c6ee26a6e6919
                as *const __Vtbl_ued8c6ee26a6e6919 as *const ();
            {
                if (((((<ACE_INET_Addr>::set_u96435504a79ea087(
                    (__this) as *mut ACE_INET_Addr,
                    ((port_name) as *const libc::c_char),
                    ((__bswap_32(((inet_address) as libc::c_uint))) as libc::c_uint),
                    ((protocol) as *const libc::c_char),
                ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
        ...
        unsafe {
            ...
            *(__this as *mut *const ()) = &__VTBL_ued8c6ee26a6e6919
                as *const __Vtbl_ued8c6ee26a6e6919 as *const ();
            {
                ...
                if (((((<ACE_INET_Addr>::set_u13276f10427e88b0(
                    (__this) as *mut ACE_INET_Addr,
                    port_number,
                                        ...
                                        <ACE_Wide_To_Ascii>::char_rep(
                                            (((&mut ({
                                                let mut __recv: ACE_Wide_To_Ascii = (<ACE_Wide_To_Ascii>::new(
                                                    ...
                                                    {
                                                        (({
                                                            const _S: [libc::wchar_t; 10] = [
                                                                0x3cu32 as libc::wchar_t,
                                                                0x75u32 as libc::wchar_t,
                                                                0x6eu32 as libc::wchar_t,
                                                                0x6bu32 as libc::wchar_t,
                                                                0x6eu32 as libc::wchar_t,
                                                                0x6fu32 as libc::wchar_t,
                                                                0x77u32 as libc::wchar_t,
                                                                0x6eu32 as libc::wchar_t,
                                                                0x3eu32 as libc::wchar_t,
                                                                0x0u32 as libc::wchar_t,
                                                            ];
                                                            _S.as_ptr()
    ...
    pub unsafe fn new_at_uca351f4be2ae3ee6(
        __this: *mut Self,
        mut address: *const libc::wchar_t,
        mut address_family: libc::c_int,
    ) {
        unsafe {
            ::core::ptr::write(
            ...
            *(__this as *mut *const ()) = &__VTBL_ued8c6ee26a6e6919
                as *const __Vtbl_ued8c6ee26a6e6919 as *const ();
            {
                <ACE_INET_Addr>::set_u9aef31c60198a34a(
                    (__this) as *mut ACE_INET_Addr,
                    ((address) as *const libc::wchar_t),
                    address_family,
                );
            }
            ()
    ...
    pub unsafe fn new_at_uf0a9b5a7ab65abaa(
        ...
        unsafe {
            ...
            *(__this as *mut *const ()) = &__VTBL_ued8c6ee26a6e6919
                as *const __Vtbl_ued8c6ee26a6e6919 as *const ();
            {
                if (((((<ACE_INET_Addr>::set_ua2365d5667a6f0ae(
                    (__this) as *mut ACE_INET_Addr,
    ...
    pub unsafe fn new_at_u881c7b3be891e7af(
        ...
        unsafe {
            ...
            *(__this as *mut *const ()) = &__VTBL_ued8c6ee26a6e6919
                as *const __Vtbl_ued8c6ee26a6e6919 as *const ();
            {
                if (((((<ACE_INET_Addr>::set_ueb968ca7a589a5ab(
                    (__this) as *mut ACE_INET_Addr,
                    ((port_name) as *const libc::wchar_t),
                    ((__bswap_32(((inet_address) as libc::c_uint))) as libc::c_uint),
                    ((protocol) as *const libc::wchar_t),
  ...
  /// life ordered in this common scenario.*/
            ...
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((((__this) as *const u8))
                    != (((((::core::ptr::addr_of!((* rhs)) as *const ACE_INET_Addr)
                        as *mut ACE_INET_Addr)) as *const u8))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    <ACE_INET_Addr>::set(
                        (__this) as *mut ACE_INET_Addr,
    ...
    pub unsafe fn set(__this: *mut Self, mut sa: *const ACE_INET_Addr) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                    ...
                    as libc::c_int as libc::c_int) != 0)
                {
                    ACE_OS::memset_u2b5dfc47d301370a(
                        ((::core::ptr::addr_of_mut!((* __this).inet_addr_) as *mut ip46)
                            as *mut libc::c_void),
                        0,
                        ((::core::mem::size_of::<ip46>() as libc::c_ulong)
                            as libc::c_ulong),
                    );
                } else {
                    ACE_OS::memcpy_u6033eb81edaf9212(
                        ((::core::ptr::addr_of_mut!((* __this).inet_addr_) as *mut ip46)
                            as *mut libc::c_void),
                        ((::core::ptr::addr_of!((* sa).inet_addr_) as *const ip46)
                    ...
                    ((*__this).inet_addrs_) = (((*sa).inet_addrs_).clone());
                    <ACE_INET_Addr>::reset((__this) as *mut ACE_INET_Addr);
                }
                return 0;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
    ...
    pub unsafe fn set_u7beffee0f8836764(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((((host_name).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    ((*(__errno_location()))) = 22;
                    return (-((1) as libc::c_int));
                }
                <ACE_INET_Addr>::reset_i((__this) as *mut ACE_INET_Addr);
                address_family = 2;
                if (((((ACE_OS::inet_pton_u954637153700152b(
                    2,
                    ((host_name) as *const libc::c_char),
                    ((::core::ptr::addr_of_mut!((* __this).inet_addr_.in4_.sin_addr)
                ...
                let mut hints: addrinfo = unsafe {
                    ::core::mem::MaybeUninit::<addrinfo>::zeroed().assume_init()
                };
                ACE_OS::memset_u2b5dfc47d301370a(
                    ((::core::ptr::addr_of_mut!(hints) as *mut addrinfo)
                        as *mut libc::c_void),
                    0,
                ...
                let mut error: libc::c_int = ((ACE_OS::getaddrinfo_u337ffbb26d9a3335(
                    ((host_name) as *const libc::c_char),
                    ((0) as *const libc::c_char),
                    (::core::ptr::addr_of_mut!(hints) as *mut addrinfo)
                        as *const addrinfo,
                    ::core::ptr::addr_of_mut!(res) as *mut *mut addrinfo,
                )) as libc::c_int);
                if ((error) != 0) {
                    ((*(__errno_location()))) = ((error) as libc::c_int);
                    return (-((1) as libc::c_int));
                }
                <ACE_Addr>::set_type(
                    (::core::ptr::addr_of_mut!(
                ...
                );
                {
                    ...
                    'for_0: loop {
                        ...
                        'cont_0: loop {
                            {
                                {
                                    let mut addr: ip46 = unsafe {
                                        ::core::mem::MaybeUninit::<ip46>::zeroed().assume_init()
                                    };
                                    ACE_OS::memcpy_u6033eb81edaf9212(
                                        ((::core::ptr::addr_of_mut!(addr) as *mut ip46)
                                            as *mut libc::c_void),
                                        (((*curr).ai_addr) as *const libc::c_void),
                                        (((*curr).ai_addrlen) as libc::c_ulong),
                                    );
                                    addr.in4_.sin_port = ((if ((encode) != 0) {
                                        ((__bswap_16(((port_number) as libc::c_ushort)))
                                            as libc::c_ushort)
                                    } else {
                                        ((port_number) as libc::c_ushort)
                                    }) as libc::c_ushort);
                                    (*__this).inet_addrs_.push_back(addr);
                                }
                            }
                            #[allow(unreachable_code)] break 'cont_0;
                        }
                        {
                            let __v = (((*curr).ai_next) as *mut addrinfo);
                            curr = __v;
                            __v
                        };
                    }
                }
                ACE_OS::freeaddrinfo_u6f46ec03d1f136e7(res);
                <ACE_INET_Addr>::reset((__this) as *mut ACE_INET_Addr);
                return 0;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
    ...
    pub unsafe fn set_u25969953d4ee6f07(
        ...
        unsafe {
            ...
            {
                <ACE_INET_Addr>::reset_i((__this) as *mut ACE_INET_Addr);
                <ACE_INET_Addr>::set_address(
                    (__this) as *mut ACE_INET_Addr,
                    (::core::ptr::addr_of_mut!(inet_address) as *mut libc::c_uint
                        as *const libc::c_char),
  ...
  /// @a port_name, the remote @a host_name, and the @a protocol.*/
    pub unsafe fn set_u95cc26a19650f362(
        ...
        unsafe {
            ...
            {
                <ACE_INET_Addr>::reset_i((__this) as *mut ACE_INET_Addr);
                let mut port_number: libc::c_int = ((get_port_number_from_name(
                    ((port_name) as *const libc::c_char),
                    ((protocol) as *const libc::c_char),
                )) as libc::c_int);
                if (((((port_number as libc::c_int))
                ...
                let mut address_family: libc::c_int = 0;
                if (((((ACE_OS::strcmp_u2f671283fc8b6d4a(
                    ((protocol) as *const libc::c_char),
                    ((b"tcp\0".as_ptr() as *const libc::c_char) as *const libc::c_char),
    ...
    pub unsafe fn set_u96435504a79ea087(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                return <ACE_INET_Addr>::set_u25969953d4ee6f07(
                    (__this) as *mut ACE_INET_Addr,
                    (port_number as libc::c_ushort),
                    inet_address,
                    0,
    ...
    pub unsafe fn set_u1c01826cbf0f2d4e(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                <ACE_INET_Addr>::reset_i((__this) as *mut ACE_INET_Addr);
                return {
                    let __obj: *mut ACE_INET_Addr = (__this) as *mut ACE_INET_Addr;
                    let __vt: *const __Vtbl_ued8c6ee26a6e6919 = *(__obj
                        as *const *const __Vtbl_ued8c6ee26a6e6919);
                    ((*__vt)
                        .vfn_u87cf85c4f5cb9bbb)(
                        __obj,
                        ((address) as *const libc::c_char),
                        address_family,
                    )
    ...
    pub unsafe fn set_u463e6dadeed4b31f(
        ...
        unsafe {
            ...
            {
                <ACE_INET_Addr>::reset_i((__this) as *mut ACE_INET_Addr);
                if ((((((*addr).sin_family as libc::c_int)) == (((2) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    let mut maxlen: libc::c_int = (((::core::mem::size_of::<
                        sockaddr_in,
                    >() as libc::c_ulong as libc::c_int)) as libc::c_int);
                    if (((((len as libc::c_int)) > (((maxlen) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        len = ((maxlen) as libc::c_int);
                    }
                    ACE_OS::memcpy_u6033eb81edaf9212(
                        ((::core::ptr::addr_of_mut!((* __this).inet_addr_.in4_)
                            as *mut sockaddr_in) as *mut libc::c_void),
    ...
    pub unsafe fn get_addr(__this: *const Self) -> *mut libc::c_void {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (::core::ptr::addr_of!((* __this).inet_addr_) as *const ip46
                    as *mut libc::c_void);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
            ...
            {
                {
                    ...
                    let __vt: *const __Vtbl_ued8c6ee26a6e6919 = *(__obj
                        as *const *const __Vtbl_ued8c6ee26a6e6919);
                    ((*__vt).vfn_ud6313bc69c6faed5)(__obj, addr, len, 0)
                };
            }
            ()
        }
    ...
    pub unsafe fn set_addr_ud6313bc69c6faed5(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut getfamily: *const sockaddr_in = (addr as *const sockaddr_in);
                if ((((((*getfamily).sin_family as libc::c_int))
                    == (((2) as libc::c_int))) as libc::c_int as libc::c_int) != 0)
                {
                    ...
                    <ACE_INET_Addr>::set_port_number(
                        (__this) as *mut ACE_INET_Addr,
                        (((*getfamily).sin_port) as libc::c_ushort),
                        0,
                    );
                    <ACE_INET_Addr>::set_address(
                        (__this) as *mut ACE_INET_Addr,
                        (::core::ptr::addr_of!((* getfamily).sin_addr) as *const in_addr
                            as *const libc::c_char),
    ...
    pub unsafe fn addr_to_string(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut hoststr: [libc::c_char; 65usize] = unsafe {
                    ::core::mem::zeroed()
                };
                let mut result: bool = false;
                if (((((ipaddr_format as libc::c_int)) == (((0) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    result = ((((((<ACE_INET_Addr>::get_host_name(
                        (__this) as *const ACE_INET_Addr,
                        ((hoststr).as_mut_ptr() as *mut libc::c_char),
                        (((((64) as libc::c_int)).wrapping_add((1) as libc::c_int))
                            as libc::c_ulong),
                    ) as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int)
                        as libc::c_int) != 0);
                } else {
                    result = (((((!(<ACE_INET_Addr>::get_host_addr(
                        (__this) as *const ACE_INET_Addr,
                        ((hoststr).as_mut_ptr() as *mut libc::c_char),
                        (((64) as libc::c_int)).wrapping_add((1) as libc::c_int),
                    ))
                ...
                let mut total_len: libc::c_ulong = (((((((((ACE_OS::strlen_u07dd12a225364fa6(
                    ((hoststr).as_ptr() as *const libc::c_char),
                )) as libc::c_ulong))
                    .wrapping_add((5) as libc::c_ulong)) as libc::c_ulong))
                    .wrapping_add((1) as libc::c_ulong)) as libc::c_ulong))
                    .wrapping_add((1) as libc::c_ulong);
                let mut format: *const libc::c_char = b"%s:%d\0".as_ptr()
                    as *const libc::c_char;
                if (((((size as libc::c_ulong)) < (((total_len) as libc::c_ulong)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    return (-((1) as libc::c_int));
                } else {
    ...
    pub unsafe fn string_to_addr(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                let mut ip_buf: *mut libc::c_char = ((0) as *mut libc::c_char);
                let mut ip_addr: *mut libc::c_char = ((0) as *mut libc::c_char);
                'dowhile_0: loop {
                    'cont_0: loop {
                        {
                            {
                                ip_buf = ACE_OS::strdup_u8b6a84c4b070659c(
                                    ((s) as *const libc::c_char),
                                );
                                if (((((ip_buf).is_null()) as libc::c_int) as libc::c_int)
                                    != 0)
                                {
                                    ((*(__errno_location()))) = 12;
                                    return (-((1) as libc::c_int));
                ...
                ip_addr = ip_buf;
                let mut port_p: *mut libc::c_char = ACE_OS::strrchr_ud9ed4b42142d6283(
                    ip_addr,
                    ((58 as libc::c_char) as libc::c_int),
                );
                if (((((port_p).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    let mut endp: *mut libc::c_char = ((0) as *mut libc::c_char);
                    let mut port: libc::c_long = ((ACE_OS::strtol_u0d03b0a19d8ced84(
                        ((ip_addr) as *const libc::c_char),
                        ::core::ptr::addr_of_mut!(endp) as *mut *mut libc::c_char,
                        10,
                    )) as libc::c_long);
                    if ((((((*(endp)) as libc::c_int as libc::c_char))
                        ...
                        as libc::c_int as libc::c_int) != 0)
                    {
                        if (((((((((port as libc::c_long)) < (((0) as libc::c_long)))
                            as libc::c_int as libc::c_int) != 0)
                            || (((((port as libc::c_long)) > (((65535) as libc::c_long)))
                                as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                            as libc::c_int) != 0)
                        {
                            result = (-((1) as libc::c_int));
                        } else {
                            result = <ACE_INET_Addr>::set_u25969953d4ee6f07(
                                (__this) as *mut ACE_INET_Addr,
                        ...
                        result = <ACE_INET_Addr>::set_u96435504a79ea087(
                            (__this) as *mut ACE_INET_Addr,
                            ((ip_addr) as *const libc::c_char),
                            (((0 as libc::c_uint)) as libc::c_uint),
                            ((b"tcp\0".as_ptr() as *const libc::c_char)
                                as *const libc::c_char),
                        );
                    }
                } else {
                    (*(port_p)) = 0 as libc::c_char;
                    {
                        let __lv = &mut (port_p);
                        ...
                        as libc::c_int as libc::c_int) != 0)
                    {
                            ...
                            as libc::c_int) != 0)
                        {
                            ...
                            result = <ACE_INET_Addr>::set_u7beffee0f8836764(
                                (__this) as *mut ACE_INET_Addr,
                                (port as libc::c_ushort),
                                ((ip_addr) as *const libc::c_char),
                                1,
                        ...
                        result = <ACE_INET_Addr>::set_u95cc26a19650f362(
                            (__this) as *mut ACE_INET_Addr,
                            ((port_p) as *const libc::c_char),
                            ((ip_addr) as *const libc::c_char),
                            ((b"tcp\0".as_ptr() as *const libc::c_char)
                ...
                ACE_OS::free_ucbe6910a56eae126(
                    (((ip_buf as *mut libc::c_void)) as *mut libc::c_void),
                );
                return result;
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
    ...
    pub unsafe fn set_port_number(
        ...
        unsafe {
            ...
            {
                if ((encode) != 0) {
                    port_number = ((__bswap_16(((port_number) as libc::c_ushort)))
                        as libc::c_ushort);
                }
                (*__this).inet_addr_.in4_.sin_port = ((port_number) as libc::c_ushort);
                if ((((((*__this).inet_addrs_.empty()) as libc::c_int)) as libc::c_int)
                    != 0)
                {
                    return;
                }
                {
                    let mut i: *mut ip46 = (*__this).inet_addrs_.begin_ptr();
                    'for_0: loop {
                        if !((((((i) != ((*__this).inet_addrs_.end_ptr()))
                            as libc::c_int) as libc::c_int) != 0))
                        {
                            break;
                        }
                        'cont_0: loop {
                            {
                                {
                                    (*i).in4_.sin_port = ((port_number) as libc::c_ushort);
                                }
                            }
                            #[allow(unreachable_code)] break 'cont_0;
                        }
    ...
    pub unsafe fn set_address(
        ...
        unsafe {
            ...
            {
                if ((((((encode) != 0)
                    && (((((len as libc::c_int)) != (((4) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                    as libc::c_int) != 0)
                {
                    ((*(__errno_location()))) = 97;
                ...
                if (((((len as libc::c_int)) == (((4) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    let mut ip4: libc::c_uint = (((*((ip_addr as *const libc::c_uint))))
                        as libc::c_uint);
                    if ((encode) != 0) {
                        ip4 = ((__bswap_32(((ip4) as libc::c_uint))) as libc::c_uint);
                    }
                    if (((((((((<ACE_Addr>::get_type(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
                        ...
                        as libc::c_int) != 0)
                        && (((((map as libc::c_int)) == (((0) as libc::c_int)))
                            as libc::c_int as libc::c_int) != 0)) as libc::c_int)
                        as libc::c_int) != 0)
                    {
                        <ACE_Addr>::base_set(
                        ...
                        ACE_OS::memcpy_u6033eb81edaf9212(
                            ((::core::ptr::addr_of_mut!(
                                (* __this).inet_addr_.in4_.sin_addr
                            ) as *mut in_addr) as *mut libc::c_void),
                            ((::core::ptr::addr_of_mut!(ip4) as *mut libc::c_uint)
                                as *const libc::c_void),
                            ((len) as libc::c_ulong),
                        );
                    }
    ...
    pub unsafe fn get_host_name(
        ...
        unsafe {
            ...
            {
                let mut result: libc::c_int = unsafe { ::core::mem::zeroed() };
                if (((((len as libc::c_ulong)) > (((1) as libc::c_ulong))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    result = <ACE_INET_Addr>::get_host_name_i(
                        (__this) as *const ACE_INET_Addr,
                        ((hostname) as *mut libc::c_char),
                        len,
                    );
                        ...
                        as libc::c_int as libc::c_int) != 0)
                    {
                            ...
                            as libc::c_int as libc::c_int) != 0)
                        {
                            ...
                            (*(hostname).wrapping_offset((0) as isize)) = 0
                                as libc::c_char;
                        }
                    }
                } else {
                    if (((((len as libc::c_ulong)) == (((1) as libc::c_ulong)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        (*(hostname).wrapping_offset((0) as isize)) = 0 as libc::c_char;
                    }
                    result = (-((1) as libc::c_int));
                }
                return result;
    ...
    pub unsafe fn get_host_name_u44c430077e6123ac(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut char_hostname: [libc::c_char; 65usize] = unsafe {
                    ::core::mem::zeroed()
                };
                ...
                {
                    len = (((((64) as libc::c_int)).wrapping_add((1) as libc::c_int))
                        as libc::c_ulong);
                }
                let mut result: libc::c_int = ((<ACE_INET_Addr>::get_host_name(
                    (__this) as *const ACE_INET_Addr,
                    ((char_hostname).as_mut_ptr() as *mut libc::c_char),
                    len,
                )) as libc::c_int);
                if (((((result as libc::c_int)) == (((0) as libc::c_int))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    ACE_OS::strcpy_u7344f334f51e13d1(
                        ((hostname) as *mut libc::wchar_t),
                        ((<ACE_Ascii_To_Wide>::wchar_rep(
                            (((&mut ({
                                let mut __recv: ACE_Ascii_To_Wide = (<ACE_Ascii_To_Wide>::new(
                                    ((char_hostname).as_ptr() as *const libc::c_char),
                                ));
                                __recv
                            })) as *mut ACE_Ascii_To_Wide)) as *mut ACE_Ascii_To_Wide,
                        )) as *const libc::wchar_t),
                    );
                }
    ...
    pub unsafe fn get_host_name_u9e4db10baaeaecab(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                static mut name: [libc::c_char; 65usize] = unsafe {
                    ::core::mem::MaybeUninit::<[libc::c_char; 65usize]>::zeroed()
                        .assume_init()
                };
                if (((((<ACE_INET_Addr>::get_host_name(
                    (__this) as *const ACE_INET_Addr,
                    ...
                    as libc::c_int as libc::c_int) != 0)
                {
                    ACE_OS::strcpy_u08e8184bcebbac89(
                        (::core::ptr::addr_of_mut!(name) as *mut libc::c_char),
                        ((b"<unknown>\0".as_ptr() as *const libc::c_char)
                            as *const libc::c_char),
                    );
                }
                return (::core::ptr::addr_of!(name) as *const libc::c_char);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
    }
    ...
    pub unsafe fn get_host_addr(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return ACE_OS::inet_ntop_ufa1224988bfba6dc(
                    2,
                    ((::core::ptr::addr_of!((* __this).inet_addr_.in4_.sin_addr)
                        as *const in_addr) as *const libc::c_void),
                    dst,
    ...
    pub unsafe fn get_host_addr_u74ff37b8fb08070b(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                static mut buf: [libc::c_char; 16usize] = unsafe {
                    ::core::mem::MaybeUninit::<[libc::c_char; 16usize]>::zeroed()
                        .assume_init()
                };
                return <ACE_INET_Addr>::get_host_addr(
                    (__this) as *const ACE_INET_Addr,
                    (::core::ptr::addr_of_mut!(buf) as *mut libc::c_char),
                    16,
                );
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
  ...
  /// order.*/
    pub unsafe fn get_ip_address(__this: *const Self) -> libc::c_uint {
        unsafe {
            ...
            {
                return ((__bswap_32(
                    ((((*__this).inet_addr_.in4_.sin_addr.s_addr as libc::c_uint))
                        as libc::c_uint),
                )) as libc::c_uint);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
  ...
  /// equal if they contain the same IP address and port number.*/
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((((((((<ACE_Addr>::get_type(
                    ...
                    != (((<ACE_Addr>::get_type(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* (::core::ptr::addr_of!((* sap))))
                            .__base_0) .cast:: < ACE_Addr > ().cast_mut())
                        )) as *const ACE_Addr,
                    ...
                    || (((((<ACE_Addr>::get_size(
                        ...
                        != (((<ACE_Addr>::get_size(
                            (::core::ptr::addr_of!(
                                ...
                                sap)))).__base_0) .cast:: < ACE_Addr > ().cast_mut())
                            )) as *const ACE_Addr,
                        )) as libc::c_int))) as libc::c_int as libc::c_int) != 0))
                    as libc::c_int) as libc::c_int) != 0)
                {
                ...
                return ((((((ACE_OS::memcmp_u2459c16080f3a32c(
                    ((::core::ptr::addr_of!((* __this).inet_addr_) as *const ip46)
                        as *const libc::c_void),
                    ((::core::ptr::addr_of!((* sap).inet_addr_) as *const ip46)
                        as *const libc::c_void),
                    ((<ACE_Addr>::get_size(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* __this).__base_0) .cast:: <
    ...
    pub unsafe fn operator_ne(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (((!((((<ACE_INET_Addr>::operator_eq(
                    (__this) as *const ACE_INET_Addr,
                    ::core::ptr::addr_of!((* sap)),
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                return (((((<ACE_INET_Addr>::get_ip_address(
                    ...
                    == (((<ACE_INET_Addr>::get_ip_address(
                        (::core::ptr::addr_of!((* sap))) as *const ACE_INET_Addr,
                    )) as libc::c_uint))) as libc::c_int as libc::c_int) != 0);
            }
            #[allow(unreachable_code)] { ::core::unreachable!() }
        }
  ...
  /// else return false.*/
    pub unsafe fn next(__this: *mut Self) -> bool {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((((((((*__this).inet_addrs_.empty()) as libc::c_int))
                    as libc::c_int) != 0)
                    || ((((((*__this).inet_addrs_iter_)
                        == ((*__this).inet_addrs_.end_ptr())) as libc::c_int)
                        as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
                {
                    return crate::__cxx_std::__Truthy::__truthy(false);
                }
                let mut next_a: ip46 = (*{
                    let __old = (*__this).inet_addrs_iter_;
                    (*__this).inet_addrs_iter_ = __old.add(1);
                    __old
                });
                {
                    let __obj: *mut ACE_Addr = (__this) as *mut ACE_Addr;
                    let __vt: *const __Vtbl_u8861458fe5cac90c = *(__obj
                        as *const *const __Vtbl_u8861458fe5cac90c);
                    ((*__vt)
                        .vfn_ue2ea8d5bbd9dafa3)(
                        __obj,
                        ((::core::ptr::addr_of_mut!(next_a) as *mut ip46)
                            as *const libc::c_void),
                        ((::core::mem::size_of::<ip46>() as libc::c_ulong)
                            as libc::c_int),
                    )
    ...
    pub unsafe fn reset(__this: *mut Self) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ((*__this).inet_addrs_iter_) = (*__this).inet_addrs_.begin_ptr();
                <ACE_INET_Addr>::next((__this) as *mut ACE_INET_Addr);
            }
            ()
        }
    }
    ...
    pub unsafe fn get_host_name_i(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((((*__this).inet_addr_.in4_.sin_addr.s_addr as libc::c_uint))
                    == (((((0 as libc::c_uint))) as libc::c_uint))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    return if ((((((ACE_OS::hostname(
                        ((hostname) as *mut libc::c_char),
                        len,
                    ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                        as libc::c_int) as libc::c_int) != 0)
                ...
                let mut addr_size: libc::c_uint = ((16) as libc::c_uint);
                let mut res: libc::c_int = ((ACE_OS::getnameinfo_uba86e201ee9aef5f(
                    ({
                        let __obj: *mut ACE_Addr = (__this) as *mut ACE_Addr;
                        let __vt: *const __Vtbl_u8861458fe5cac90c = *(__obj
                            as *const *const __Vtbl_u8861458fe5cac90c);
                ...
                return if ((((((res as libc::c_int)) == (((0) as libc::c_int)))
                    as libc::c_int) as libc::c_int) != 0)
                {
                    0
                } else {
