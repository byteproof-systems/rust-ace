...
#[export_name = "_ZN12ACE_DumpableC1EPKv"]
pub unsafe extern "C-unwind" fn __xtu__ZN12ACE_DumpableC1EPKv(
    __this: *mut ACE_Dumpable,
    __a0: *const libc::c_void,
) {
    ACE_Dumpable::new_at(__this, __a0)
}
#[export_name = "_ZN16ACE_Dumpable_PtrC1EPK12ACE_Dumpable"]
pub unsafe extern "C-unwind" fn __xtu__ZN16ACE_Dumpable_PtrC1EPK12ACE_Dumpable(
    __this: *mut ACE_Dumpable_Ptr,
    __a0: *const ACE_Dumpable,
) {
    ACE_Dumpable_Ptr::new_at(__this, __a0)
}
#[export_name = "_ZNK16ACE_Dumpable_PtrptEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK16ACE_Dumpable_PtrptEv(
    __this: *const ACE_Dumpable_Ptr,
) -> *const ACE_Dumpable {
    unsafe { ACE_Dumpable_Ptr::operator_arrow(__this) }
}
#[export_name = "_ZNK16ACE_Dumpable_PtraSEPK12ACE_Dumpable"]
pub unsafe extern "C-unwind" fn __xtu__ZNK16ACE_Dumpable_PtraSEPK12ACE_Dumpable(
    __this: *const ACE_Dumpable_Ptr,
    dumper: *const ACE_Dumpable,
) {
    unsafe { ACE_Dumpable_Ptr::operator_assign(__this, dumper) }
}
#[allow(non_upper_case_globals)]
#[no_mangle]
pub static mut ACE_ODB_instance_: *mut ACE_ODB = ((0) as *mut ACE_ODB);
#[doc = "* @class ACE_ODB\n *\n * @brief This is the object database (ODB) that keeps track of all\n * live ACE objects."]
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ACE_ODB {
    pub object_table_: [Tuple; 100000usize],
    pub current_size_: libc::c_int,
}
#[export_name = "_ZN7ACE_ODB12dump_objectsEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN7ACE_ODB12dump_objectsEv(__this: *mut ACE_ODB) {
    unsafe { ACE_ODB::dump_objects(__this) }
}
#[export_name = "_ZN7ACE_ODB15register_objectEPK12ACE_Dumpable"]
pub unsafe extern "C-unwind" fn __xtu__ZN7ACE_ODB15register_objectEPK12ACE_Dumpable(
    __this: *mut ACE_ODB,
    dumper: *const ACE_Dumpable,
) {
    unsafe { ACE_ODB::register_object(__this, dumper) }
}
#[export_name = "_ZN7ACE_ODB13remove_objectEPKv"]
pub unsafe extern "C-unwind" fn __xtu__ZN7ACE_ODB13remove_objectEPKv(
    __this: *mut ACE_ODB,
    this_ptr: *const libc::c_void,
) {
    unsafe { ACE_ODB::remove_object(__this, this_ptr) }
}
#[export_name = "_ZN7ACE_ODB8instanceEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN7ACE_ODB8instanceEv() -> *mut ACE_ODB {
    unsafe { ACE_ODB::instance() }
}
#[export_name = "_ZN7ACE_ODBC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN7ACE_ODBC1Ev(__this: *mut ACE_ODB) {
    ACE_ODB::new_at(__this)
}
extern "C-unwind" {
...
impl ACE_ODB {
  ...
  /// dumps their state.*/
    pub unsafe fn dump_objects(__this: *mut Self) {
        unsafe {
            ...
            {
                {
                    ...
                    'for_0: loop {
                        ...
                        'cont_0: loop {
                            {
                                {
                                    if ((((!((*((((*__this).object_table_).as_ptr()
                                        as *mut Tuple)
                                    ...
                                    {
                                        {
                                            let __obj: *mut ACE_Dumpable = (<ACE_Dumpable_Ptr>::operator_arrow(
                                                (::core::ptr::addr_of!(
                                                    (* ((((* __this).object_table_).as_ptr() as * mut Tuple)
                                                    .wrapping_offset((i) as isize))).dumper_
                                                )) as *const ACE_Dumpable_Ptr,
                                            )) as *mut ACE_Dumpable;
                                            let __vt: *const __Vtbl_u91fb72e09a75f655 = *(__obj
                                                as *const *const __Vtbl_u91fb72e09a75f655);
                                            ((*__vt).vfn_u90c36e856cc7f3b8)(__obj)
                                        };
                                    }
                                }
                            }
    ...
    pub unsafe fn register_object(__this: *mut Self, mut dumper: *const ACE_Dumpable) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                            ...
                            {
                                {
                                        ...
                                        .is_null()) as libc::c_int) as libc::c_int) != 0)
                                    {
                                        ...
                                        if (((((((*((((*__this).object_table_).as_ptr()
                                            ...
                                            .wrapping_offset((i) as isize)))
                                            .this_) as *const u8))
                                            == ((((*dumper).this_) as *const u8))) as libc::c_int
                                            as libc::c_int) != 0)
                                        {
                                            slot = i;
                                            break 'for_0;
                    ...
                    as libc::c_int) != 0)
                {
                    ...
                    (if (((((((*__this).current_size_ as libc::c_int))
                        < ((((100000 as libc::c_int)) as libc::c_int))) as libc::c_int)
                        as libc::c_int) != 0)
                    {
                        ()
                    } else {
                        __ace_assert(
                            ((b"/build/ace_full/src/ACE/ace/Dump.cpp\0".as_ptr()
                                as *const libc::c_char) as *const libc::c_char),
                            116,
                            ((b"this->current_size_ < ACE_ODB::MAX_TABLE_SIZE\0".as_ptr()
                                as *const libc::c_char) as *const libc::c_char),
                        )
                    });
                }
                (*((((*__this).object_table_).as_ptr() as *mut Tuple)
                    .wrapping_offset((slot) as isize)))
                    .this_ = (((*dumper).this_) as *const libc::c_void);
                <ACE_Dumpable_Ptr>::operator_assign(
                    (::core::ptr::addr_of!(
                        (* ((((* __this).object_table_).as_ptr() as * mut Tuple)
                        .wrapping_offset((slot) as isize))).dumper_
                    )) as *const ACE_Dumpable_Ptr,
                    dumper,
                );
            }
  ...
  /// list of registered ACE objects.*/
    pub unsafe fn remove_object(__this: *mut Self, mut this_ptr: *const libc::c_void) {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut i: libc::c_int = unsafe { ::core::mem::zeroed() };
                            ...
                            {
                                {
                                    if (((((((*((((*__this).object_table_).as_ptr()
                                        as *mut Tuple)
                                        .wrapping_offset((i) as isize)))
                                        .this_) as *const u8)) == (((this_ptr) as *const u8)))
                                        as libc::c_int as libc::c_int) != 0)
                                    {
                                        break 'for_0;
                                    }
                    ...
                    as libc::c_int) != 0)
                {
                    (*((((*__this).object_table_).as_ptr() as *mut Tuple)
                        .wrapping_offset((i) as isize)))
                        .this_ = ((0) as *const libc::c_void);
                    <ACE_Dumpable_Ptr>::operator_assign(
                        (::core::ptr::addr_of!(
                            (* ((((* __this).object_table_).as_ptr() as * mut Tuple)
                            .wrapping_offset((i) as isize))).dumper_
                        )) as *const ACE_Dumpable_Ptr,
                        ((0) as *const ACE_Dumpable),
                    );
                }
            }
            ()
    ...
    pub unsafe fn instance() -> *mut ACE_ODB {
        unsafe {
            {
                if (((((ACE_ODB_instance_).is_null()) as libc::c_int) as libc::c_int)
                    != 0)
                {
                            ...
                            'cont_0: loop {
                                {
                                    {
                                        ACE_ODB_instance_ = {
                                            let __new: *mut ACE_ODB = Box::into_raw(
                                                Box::new(
                                                    ::core::mem::MaybeUninit::<ACE_ODB>::zeroed().assume_init(),
                                                ),
                                            );
                                            <ACE_ODB>::new_at((__new) as *mut ACE_ODB);
                                            __new
                                        };
                                        if (((((ACE_ODB_instance_).is_null()) as libc::c_int)
                                            as libc::c_int) != 0)
                                        {
                                            ((*(__errno_location()))) = 12;
                                            return ((0) as *mut ACE_ODB);
