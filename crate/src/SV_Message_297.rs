...
#[export_name = "_ZNK14ACE_SV_Message4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK14ACE_SV_Message4dumpEv(
    __this: *const ACE_SV_Message,
) {
    unsafe { ACE_SV_Message::dump(__this) }
}
extern "C-unwind" {
