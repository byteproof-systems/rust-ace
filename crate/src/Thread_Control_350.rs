...
#[export_name = "_ZN18ACE_Thread_ControlC1EP18ACE_Thread_Manageri"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_Thread_ControlC1EP18ACE_Thread_Manageri(
    __this: *mut ACE_Thread_Control,
    __a0: *mut ACE_Thread_Manager,
    __a1: libc::c_int,
) {
    ACE_Thread_Control::new_at(__this, __a0, __a1)
}
impl Drop for ACE_Thread_Control {
    fn drop(&mut self) {
        unsafe {
            ...
            {
                <ACE_Thread_Control>::exit(
                    (__this) as *mut ACE_Thread_Control,
                    (*__this).status_,
                    0,
                );
            }
...
#[export_name = "__acedtor_u75ad39712414a451"]
pub unsafe extern "C-unwind" fn __acedtor_u75ad39712414a451(
    __this: *mut ACE_Thread_Control,
) {
    unsafe {
...
#[export_name = "_ZN18ACE_Thread_Control4exitEPvi"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_Thread_Control4exitEPvi(
    __this: *mut ACE_Thread_Control,
    exit_status: *mut libc::c_void,
    do_thr_exit: libc::c_int,
) -> *mut libc::c_void {
    unsafe { ACE_Thread_Control::exit(__this, exit_status, do_thr_exit) }
}
#[export_name = "_ZN18ACE_Thread_Control6insertEP18ACE_Thread_Managerb"]
pub unsafe extern "C-unwind" fn __xtu__ZN18ACE_Thread_Control6insertEP18ACE_Thread_Managerb(
    __this: *mut ACE_Thread_Control,
    tm: *mut ACE_Thread_Manager,
    insert: bool,
) -> libc::c_int {
    unsafe { ACE_Thread_Control::insert(__this, tm, insert) }
}
#[export_name = "_ZNK18ACE_Thread_Control4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK18ACE_Thread_Control4dumpEv(
    __this: *const ACE_Thread_Control,
) {
    unsafe { ACE_Thread_Control::dump(__this) }
}
extern "C-unwind" {
...
impl ACE_Thread_Control {
  ...
  /// register the thread with the Thread_Manager.*/
    pub unsafe fn new_at(
        __this: *mut Self,
        mut t: *mut ACE_Thread_Manager,
        mut insert: libc::c_int,
    ) {
        unsafe {
            ::core::ptr::write(
                __this,
            ...
            ::core::ptr::write(::core::ptr::addr_of_mut!((* __this).tm_), t);
            ::core::ptr::write(
                ::core::ptr::addr_of_mut!((* __this).status_),
                ((0) as *mut libc::c_void),
            );
            {
                if ((((((((!((*__this).tm_).is_null()) as libc::c_int) as libc::c_int)
                    != 0) && ((insert) != 0)) as libc::c_int) as libc::c_int) != 0)
                {
                    let mut t_id: libc::c_ulong = unsafe { ::core::mem::zeroed() };
                    ACE_OS::thr_self_u35bfcd9d5906cbcf(::core::ptr::addr_of_mut!(t_id));
                    <ACE_Thread_Manager>::insert_thr(
                        ((*__this).tm_) as *mut ACE_Thread_Manager,
                        ACE_OS::thr_self(),
                        t_id,
                        (-((1) as libc::c_int)),
                        ((0) as libc::c_long),
  ...
  /// the thread if @a do_thr_exit is enabled.*/
    pub unsafe fn exit(
        __this: *mut Self,
        mut exit_status: *mut libc::c_void,
        mut do_thr_exit: libc::c_int,
    ) -> *mut libc::c_void {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((!((*__this).tm_).is_null()) as libc::c_int) as libc::c_int) != 0)
                {
                    return <ACE_Thread_Manager>::exit(
                        ((*__this).tm_) as *mut ACE_Thread_Manager,
                        exit_status,
                        ((do_thr_exit) != 0),
                    );
    ...
    pub unsafe fn insert(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                ACE_OS::thr_self_u35bfcd9d5906cbcf(::core::ptr::addr_of_mut!(t_id));
                (*__this).tm_ = tm;
                if ((insert as libc::c_int) != 0) {
                    return <ACE_Thread_Manager>::insert_thr(
                        ((*__this).tm_) as *mut ACE_Thread_Manager,
                        ACE_OS::thr_self(),
                        t_id,
                        (-((1) as libc::c_int)),
