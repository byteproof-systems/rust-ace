...
#[export_name = "_ZN19ACE_Dirent_SelectorC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN19ACE_Dirent_SelectorC1Ev(
    __this: *mut ACE_Dirent_Selector,
) {
    ACE_Dirent_Selector::new_at(__this)
}
#[export_name = "_ZN19ACE_Dirent_Selector5closeEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN19ACE_Dirent_Selector5closeEv(
    __this: *mut ACE_Dirent_Selector,
) -> libc::c_int {
    unsafe { ACE_Dirent_Selector::close(__this) }
}
#[export_name = "_ZN19ACE_Dirent_Selector4openEPKcPFiPK6direntEPFiPS4_S7_E"]
pub unsafe extern "C-unwind" fn __xtu__ZN19ACE_Dirent_Selector4openEPKcPFiPK6direntEPFiPS4_S7_E(
    __this: *mut ACE_Dirent_Selector,
    dir: *const libc::c_char,
    sel: Option<unsafe extern "C-unwind" fn(*const dirent) -> libc::c_int>,
    cmp: Option<
        unsafe extern "C-unwind" fn(
            *mut *const dirent,
            *mut *const dirent,
    ...
    unsafe { ACE_Dirent_Selector::open(__this, dir, sel, cmp) }
}
