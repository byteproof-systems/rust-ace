...
#[export_name = "_ZN10ACE_DEV_IOC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN10ACE_DEV_IOC1Ev(__this: *mut ACE_DEV_IO) {
    ACE_DEV_IO::new_at(__this)
}
#[export_name = "_ZNK10ACE_DEV_IO4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK10ACE_DEV_IO4dumpEv(
    __this: *const ACE_DEV_IO,
) {
    unsafe { ACE_DEV_IO::dump(__this) }
}
#[export_name = "_ZNK10ACE_DEV_IO14get_local_addrER12ACE_DEV_Addr"]
pub unsafe extern "C-unwind" fn __xtu__ZNK10ACE_DEV_IO14get_local_addrER12ACE_DEV_Addr(
    __this: *const ACE_DEV_IO,
    addr: *mut ACE_DEV_Addr,
) -> libc::c_int {
    unsafe { ACE_DEV_IO::get_local_addr(__this, addr) }
}
#[export_name = "_ZNK10ACE_DEV_IO15get_remote_addrER12ACE_DEV_Addr"]
pub unsafe extern "C-unwind" fn __xtu__ZNK10ACE_DEV_IO15get_remote_addrER12ACE_DEV_Addr(
    __this: *const ACE_DEV_IO,
    addr: *mut ACE_DEV_Addr,
) -> libc::c_int {
    unsafe { ACE_DEV_IO::get_remote_addr(__this, addr) }
}
#[repr(C)]
...
impl ACE_DEV_IO {
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ...
            <ACE_DEV>::new_at(
                ::core::ptr::addr_of_mut!((* __this).__base_0).cast::<ACE_DEV>(),
            );
            <ACE_DEV_Addr>::new_at(
                ::core::ptr::addr_of_mut!((* __this).addr_).cast::<ACE_DEV_Addr>(),
            );
            {}
            ()
        }
    ...
    #[export_name = "_ZNK10ACE_DEV_IO4sendEmz"]
    pub unsafe extern "C-unwind" fn send_u1e2c5331ebfd7ec3(
        __this: *const Self,
        mut n: libc::c_ulong,
        mut __args: ...
    ) -> libc::c_long {
    ...
    #[export_name = "_ZNK10ACE_DEV_IO4recvEmz"]
    pub unsafe extern "C-unwind" fn recv_u814e7686187a03a9(
        __this: *const Self,
        mut n: libc::c_ulong,
        mut __args: ...
    ) -> libc::c_long {
    ...
    pub unsafe fn get_local_addr(
        __this: *const Self,
        mut addr: *mut ACE_DEV_Addr,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                <ACE_DEV_Addr>::operator_assign(
                    (::core::ptr::addr_of_mut!((* addr))) as *mut ACE_DEV_Addr,
                    ::core::ptr::addr_of!(
                        (* ::core::ptr::addr_of!((* __this).addr_) .cast:: < ACE_DEV_Addr
                        > ().cast_mut())
                    ),
                );
                return 0;
