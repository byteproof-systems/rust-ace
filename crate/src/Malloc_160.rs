...
#[export_name = "_ZN17ACE_Control_Block17ACE_Malloc_HeaderC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Control_Block17ACE_Malloc_HeaderC1Ev(
    __this: *mut ACE_Control_Block_ACE_Malloc_Header,
) {
    ACE_Control_Block_ACE_Malloc_Header::new_at(__this)
}
#[export_name = "_ZNK17ACE_Control_Block17ACE_Malloc_Header4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK17ACE_Control_Block17ACE_Malloc_Header4dumpEv(
    __this: *const ACE_Control_Block_ACE_Malloc_Header,
) {
    unsafe { ACE_Control_Block_ACE_Malloc_Header::dump(__this) }
}
#[export_name = "_ZN17ACE_Control_Block13ACE_Name_NodeC1EPKcPcS3_PS0_"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Control_Block13ACE_Name_NodeC1EPKcPcS3_PS0_(
    __this: *mut ACE_Control_Block_ACE_Name_Node,
    __a0: *const libc::c_char,
    __a1: *mut libc::c_char,
    __a2: *mut libc::c_char,
    __a3: *mut ACE_Control_Block_ACE_Name_Node,
) {
    ACE_Control_Block_ACE_Name_Node::new_at(__this, __a0, __a1, __a2, __a3)
}
#[export_name = "_ZN17ACE_Control_Block13ACE_Name_NodeC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Control_Block13ACE_Name_NodeC1Ev(
    __this: *mut ACE_Control_Block_ACE_Name_Node,
) {
    ACE_Control_Block_ACE_Name_Node::new_at_u0c16d8424585c88d(__this)
}
#[export_name = "_ZNK17ACE_Control_Block13ACE_Name_Node4nameEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK17ACE_Control_Block13ACE_Name_Node4nameEv(
    __this: *const ACE_Control_Block_ACE_Name_Node,
) -> *const libc::c_char {
    unsafe { ACE_Control_Block_ACE_Name_Node::name(__this) }
}
#[export_name = "_ZNK17ACE_Control_Block13ACE_Name_Node4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK17ACE_Control_Block13ACE_Name_Node4dumpEv(
    __this: *const ACE_Control_Block_ACE_Name_Node,
) {
    unsafe { ACE_Control_Block_ACE_Name_Node::dump(__this) }
}
#[export_name = "_ZN17ACE_Control_Block20print_alignment_infoEv"]
pub unsafe extern "C-unwind" fn __xtu__ZN17ACE_Control_Block20print_alignment_infoEv() {
    unsafe { ACE_Control_Block::print_alignment_info() }
}
#[export_name = "_ZNK17ACE_Control_Block4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK17ACE_Control_Block4dumpEv(
    __this: *const ACE_Control_Block,
) {
    unsafe { ACE_Control_Block::dump(__this) }
}
#[repr(C)]
...
#[allow(non_upper_case_globals)]
#[no_mangle]
pub static mut ACE_Allocator_allocator_: *mut ACE_Allocator = ((0)
