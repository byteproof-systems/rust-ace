...
impl Clone for ACE_DEV_Addr {
    #[inline]
    fn clone(&self) -> Self {
        unsafe { Self::new_uf97a38068e21c4e0(self as *const Self) }
    }
}
...
#[export_name = "_ZN12ACE_DEV_AddrC1Ev"]
pub unsafe extern "C-unwind" fn __xtu__ZN12ACE_DEV_AddrC1Ev(__this: *mut ACE_DEV_Addr) {
    ACE_DEV_Addr::new_at(__this)
}
#[export_name = "_ZN12ACE_DEV_AddrC1ERKS_"]
pub unsafe extern "C-unwind" fn __xtu__ZN12ACE_DEV_AddrC1ERKS_(
    __this: *mut ACE_DEV_Addr,
    __a0: *const ACE_DEV_Addr,
) {
    ACE_DEV_Addr::new_at_uf97a38068e21c4e0(__this, __a0)
}
#[export_name = "_ZN12ACE_DEV_Addr3setERKS_"]
pub unsafe extern "C-unwind" fn __xtu__ZN12ACE_DEV_Addr3setERKS_(
    __this: *mut ACE_DEV_Addr,
    sa: *const ACE_DEV_Addr,
) -> libc::c_int {
    unsafe { ACE_DEV_Addr::set(__this, sa) }
}
#[export_name = "_ZN12ACE_DEV_AddrC1EPKc"]
pub unsafe extern "C-unwind" fn __xtu__ZN12ACE_DEV_AddrC1EPKc(
    __this: *mut ACE_DEV_Addr,
    __a0: *const libc::c_char,
) {
    ACE_DEV_Addr::new_at_u3efd57b00a84c2a1(__this, __a0)
}
#[export_name = "_ZN12ACE_DEV_AddraSERKS_"]
pub unsafe extern "C-unwind" fn __xtu__ZN12ACE_DEV_AddraSERKS_(
    __this: *mut ACE_DEV_Addr,
    sa: *const ACE_DEV_Addr,
) -> *mut ACE_DEV_Addr {
    unsafe { ACE_DEV_Addr::operator_assign(__this, sa) }
}
#[export_name = "_ZNK12ACE_DEV_Addr8get_addrEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK12ACE_DEV_Addr8get_addrEv(
    __this: *const ACE_DEV_Addr,
) -> *mut libc::c_void {
    unsafe { ACE_DEV_Addr::get_addr(__this) }
}
#[export_name = "_ZNK12ACE_DEV_Addr14addr_to_stringEPcm"]
pub unsafe extern "C-unwind" fn __xtu__ZNK12ACE_DEV_Addr14addr_to_stringEPcm(
    __this: *const ACE_DEV_Addr,
    s: *mut libc::c_char,
    len: libc::c_ulong,
) -> libc::c_int {
    unsafe { ACE_DEV_Addr::addr_to_string(__this, s, len) }
}
#[export_name = "_ZNK12ACE_DEV_Addr4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK12ACE_DEV_Addr4dumpEv(
    __this: *const ACE_DEV_Addr,
) {
    unsafe { ACE_DEV_Addr::dump(__this) }
}
extern "C-unwind" {
...
impl ACE_DEV_Addr {
    ...
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ...
            *(__this as *mut *const ()) = &__VTBL_ub84e94a07bc97bd0
                as *const __Vtbl_ub84e94a07bc97bd0 as *const ();
            {
                {
                    let _ = ACE_OS::memset_u2b5dfc47d301370a(
                        (::core::ptr::addr_of_mut!((* __this).devname_)
                            as *mut [libc::c_char; 4097usize] as *mut libc::c_void),
                        0,
                    ...
                    as libc::c_int as libc::c_int) != 0)
                {
                ...
                } else {
                    {
                        let _ = ACE_OS::strsncpy(
                            ...
                            (((*sa).devname_).as_ptr() as *const libc::c_char),
    ...
    pub unsafe fn new_at_u3efd57b00a84c2a1(
        ...
        unsafe {
            ...
            *(__this as *mut *const ()) = &__VTBL_ub84e94a07bc97bd0
                as *const __Vtbl_ub84e94a07bc97bd0 as *const ();
            {
                <ACE_DEV_Addr>::set_uea90e704e758fdd8(
                    (__this) as *mut ACE_DEV_Addr,
                    devname,
                );
            }
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if ((((((__this) as *const u8))
                    != (((((::core::ptr::addr_of!((* sa)) as *const ACE_DEV_Addr)
                        as *mut ACE_DEV_Addr)) as *const u8))) as libc::c_int
                    as libc::c_int) != 0)
                {
                    <ACE_DEV_Addr>::set(
                        (__this) as *mut ACE_DEV_Addr,
    ...
    pub unsafe fn get_addr(__this: *const Self) -> *mut libc::c_void {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                return (::core::ptr::addr_of!((* __this).devname_)
