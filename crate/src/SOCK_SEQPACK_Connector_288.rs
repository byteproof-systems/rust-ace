...
pub type ACE_SOCK_SEQPACK_Connector_PEER_ADDR = ACE_Multihomed_INET_Addr;
pub type ACE_SOCK_SEQPACK_Connector_PEER_STREAM = ACE_SOCK_SEQPACK_Association;
#[doc = "* @class ACE_SOCK_SEQPACK_Connector\n *\n * @brief Defines a factory that actively connects to a remote IP\n * address and TCP port, creating a new @c ACE_SOCK_SEQPACK_Association object.\n *\n * The @c ACE_SOCK_SEQPACK_Connector doesn't have a socket of its own,\n * i.e., it simply \"borrows\" the one from the @c ACE_SOCK_SEQPACK_Association\n * that's being connected.  The reason for this is that the\n * underlying socket API doesn't use a factory socket to connect\n * data mode sockets.  Therefore, there's no need to inherit\n * @c ACE_SOCK_SEQPACK_Connector from @c ACE_SOCK.  A nice side-effect of\n * this is that @c ACE_SOCK_SEQPACK_Connector objects do not store state so\n * they can be used reentrantly in multithreaded programs."]
#[repr(C)]
#[derive(Clone)]
pub struct ACE_SOCK_SEQPACK_Connector {}
pub unsafe extern "C-unwind" fn __xtu__ZN26ACE_SOCK_SEQPACK_ConnectorC1Ev(
    __this: *mut ACE_SOCK_SEQPACK_Connector,
) {
    ACE_SOCK_SEQPACK_Connector::new_at(__this)
}
#[export_name = "_ZN26ACE_SOCK_SEQPACK_ConnectorC1ER28ACE_SOCK_SEQPACK_AssociationRK8ACE_AddrPK14ACE_Time_ValueS4_iiii"]
pub unsafe extern "C-unwind" fn __xtu__ZN26ACE_SOCK_SEQPACK_ConnectorC1ER28ACE_SOCK_SEQPACK_AssociationRK8ACE_AddrPK14ACE_Time_ValueS4_iiii(
    __this: *mut ACE_SOCK_SEQPACK_Connector,
    __a0: *mut ACE_SOCK_SEQPACK_Association,
    __a1: *const ACE_Addr,
    ...
    ACE_SOCK_SEQPACK_Connector::new_at_udc74f05b09596c3e(
        __this,
        __a0,
        __a1,
        __a2,
...
#[export_name = "_ZN26ACE_SOCK_SEQPACK_ConnectorC1ER28ACE_SOCK_SEQPACK_AssociationRK8ACE_AddrPK14ACE_Time_ValueRK24ACE_Multihomed_INET_Addriiii"]
pub unsafe extern "C-unwind" fn __xtu__ZN26ACE_SOCK_SEQPACK_ConnectorC1ER28ACE_SOCK_SEQPACK_AssociationRK8ACE_AddrPK14ACE_Time_ValueRK24ACE_Multihomed_INET_Addriiii(
    __this: *mut ACE_SOCK_SEQPACK_Connector,
    __a0: *mut ACE_SOCK_SEQPACK_Association,
    __a1: *const ACE_Addr,
    __a2: *const ACE_Time_Value,
    __a3: *const ACE_Multihomed_INET_Addr,
    __a4: libc::c_int,
    __a5: libc::c_int,
    __a6: libc::c_int,
    __a7: libc::c_int,
) {
    ACE_SOCK_SEQPACK_Connector::new_at_u308cb7cdb3e18183(
        __this,
        __a0,
        __a1,
        __a2,
...
#[export_name = "_ZN26ACE_SOCK_SEQPACK_Connector7connectER28ACE_SOCK_SEQPACK_AssociationRK8ACE_AddrPK14ACE_Time_ValueS4_iiii"]
pub unsafe extern "C-unwind" fn __xtu__ZN26ACE_SOCK_SEQPACK_Connector7connectER28ACE_SOCK_SEQPACK_AssociationRK8ACE_AddrPK14ACE_Time_ValueS4_iiii(
    __this: *mut ACE_SOCK_SEQPACK_Connector,
    ...
    unsafe {
        ACE_SOCK_SEQPACK_Connector::connect(
            __this,
            new_association,
            remote_sap,
            timeout,
...
#[export_name = "_ZN26ACE_SOCK_SEQPACK_Connector7connectER28ACE_SOCK_SEQPACK_AssociationRK8ACE_AddrPK14ACE_Time_ValueRK24ACE_Multihomed_INET_Addriiii"]
pub unsafe extern "C-unwind" fn __xtu__ZN26ACE_SOCK_SEQPACK_Connector7connectER28ACE_SOCK_SEQPACK_AssociationRK8ACE_AddrPK14ACE_Time_ValueRK24ACE_Multihomed_INET_Addriiii(
    __this: *mut ACE_SOCK_SEQPACK_Connector,
    new_association: *mut ACE_SOCK_SEQPACK_Association,
    remote_sap: *const ACE_Addr,
    timeout: *const ACE_Time_Value,
    ...
    unsafe {
        ACE_SOCK_SEQPACK_Connector::connect_u0076b2f013cc5528(
            __this,
            new_association,
            remote_sap,
            timeout,
...
impl Drop for ACE_SOCK_SEQPACK_Connector {
    fn drop(&mut self) {
        unsafe {
            let __this: *mut Self = self as *mut Self;
            {}
...
pub unsafe extern "C-unwind" fn __acedtor_u89bbe955cc39fe7e(
    __this: *mut ACE_SOCK_SEQPACK_Connector,
) {
    unsafe {
        ::core::ptr::drop_in_place(__this);
...
#[export_name = "_ZN26ACE_SOCK_SEQPACK_Connector8completeER28ACE_SOCK_SEQPACK_AssociationP8ACE_AddrPK14ACE_Time_Value"]
pub unsafe extern "C-unwind" fn __xtu__ZN26ACE_SOCK_SEQPACK_Connector8completeER28ACE_SOCK_SEQPACK_AssociationP8ACE_AddrPK14ACE_Time_Value(
    __this: *mut ACE_SOCK_SEQPACK_Connector,
    new_association: *mut ACE_SOCK_SEQPACK_Association,
    ...
    unsafe {
        ACE_SOCK_SEQPACK_Connector::complete(__this, new_association, remote_sap, tv)
    }
}
#[export_name = "_ZNK26ACE_SOCK_SEQPACK_Connector4dumpEv"]
pub unsafe extern "C-unwind" fn __xtu__ZNK26ACE_SOCK_SEQPACK_Connector4dumpEv(
    __this: *const ACE_SOCK_SEQPACK_Connector,
) {
    unsafe { ACE_SOCK_SEQPACK_Connector::dump(__this) }
}
#[export_name = "_ZN26ACE_SOCK_SEQPACK_Connector11shared_openER28ACE_SOCK_SEQPACK_Associationiii"]
pub unsafe extern "C-unwind" fn __xtu__ZN26ACE_SOCK_SEQPACK_Connector11shared_openER28ACE_SOCK_SEQPACK_Associationiii(
    __this: *mut ACE_SOCK_SEQPACK_Connector,
    new_association: *mut ACE_SOCK_SEQPACK_Association,
    ...
    unsafe {
        ACE_SOCK_SEQPACK_Connector::shared_open(
            __this,
            new_association,
            protocol_family,
            protocol,
...
#[export_name = "_ZN26ACE_SOCK_SEQPACK_Connector11shared_openER28ACE_SOCK_SEQPACK_AssociationiiP17ACE_Protocol_Infommi"]
pub unsafe extern "C-unwind" fn __xtu__ZN26ACE_SOCK_SEQPACK_Connector11shared_openER28ACE_SOCK_SEQPACK_AssociationiiP17ACE_Protocol_Infommi(
    __this: *mut ACE_SOCK_SEQPACK_Connector,
    new_association: *mut ACE_SOCK_SEQPACK_Association,
    protocol_family: libc::c_int,
    protocol: libc::c_int,
    ...
    unsafe {
        ACE_SOCK_SEQPACK_Connector::shared_open_ufa5fb1dec0216f8b(
            __this,
            new_association,
            protocol_family,
            protocol,
...
#[export_name = "_ZN26ACE_SOCK_SEQPACK_Connector20shared_connect_startER28ACE_SOCK_SEQPACK_AssociationPK14ACE_Time_ValueRK8ACE_Addr"]
pub unsafe extern "C-unwind" fn __xtu__ZN26ACE_SOCK_SEQPACK_Connector20shared_connect_startER28ACE_SOCK_SEQPACK_AssociationPK14ACE_Time_ValueRK8ACE_Addr(
    __this: *mut ACE_SOCK_SEQPACK_Connector,
    new_association: *mut ACE_SOCK_SEQPACK_Association,
    timeout: *const ACE_Time_Value,
    local_sap: *const ACE_Addr,
    ...
    unsafe {
        ACE_SOCK_SEQPACK_Connector::shared_connect_start(
            __this,
            new_association,
            timeout,
            local_sap,
...
#[export_name = "_ZN26ACE_SOCK_SEQPACK_Connector20shared_connect_startER28ACE_SOCK_SEQPACK_AssociationPK14ACE_Time_ValueRK24ACE_Multihomed_INET_Addr"]
pub unsafe extern "C-unwind" fn __xtu__ZN26ACE_SOCK_SEQPACK_Connector20shared_connect_startER28ACE_SOCK_SEQPACK_AssociationPK14ACE_Time_ValueRK24ACE_Multihomed_INET_Addr(
    __this: *mut ACE_SOCK_SEQPACK_Connector,
    new_association: *mut ACE_SOCK_SEQPACK_Association,
    timeout: *const ACE_Time_Value,
    local_sap: *const ACE_Multihomed_INET_Addr,
    ...
    unsafe {
        ACE_SOCK_SEQPACK_Connector::shared_connect_start_ufff276a5100d6509(
            __this,
            new_association,
            timeout,
            local_sap,
...
#[export_name = "_ZN26ACE_SOCK_SEQPACK_Connector21shared_connect_finishER28ACE_SOCK_SEQPACK_AssociationPK14ACE_Time_Valuei"]
pub unsafe extern "C-unwind" fn __xtu__ZN26ACE_SOCK_SEQPACK_Connector21shared_connect_finishER28ACE_SOCK_SEQPACK_AssociationPK14ACE_Time_Valuei(
    __this: *mut ACE_SOCK_SEQPACK_Connector,
    new_association: *mut ACE_SOCK_SEQPACK_Association,
    timeout: *const ACE_Time_Value,
    result: libc::c_int,
    ...
    unsafe {
        ACE_SOCK_SEQPACK_Connector::shared_connect_finish(
            __this,
            new_association,
            timeout,
            result,
...
impl ACE_SOCK_SEQPACK_Connector {
    ///Default constructor.
    pub unsafe fn new_at(__this: *mut Self) {
        unsafe {
            ::core::ptr::write(
    ...
    pub unsafe fn new_at_udc74f05b09596c3e(
        ...
        unsafe {
            ...
            {
                if (((((((((((((<ACE_SOCK_SEQPACK_Connector>::connect(
                    (__this) as *mut ACE_SOCK_SEQPACK_Connector,
                    ::core::ptr::addr_of_mut!((* new_association)),
                    ::core::ptr::addr_of!((* remote_sap)),
                    timeout,
                    ...
                    as libc::c_int as libc::c_int) != 0)
                    && ((((!(timeout).is_null()) as libc::c_int) as libc::c_int) != 0))
                    as libc::c_int) as libc::c_int) != 0)
                    && (((!(((((((((((((((((*(__errno_location()))) as libc::c_int))
                        == (((11) as libc::c_int))) as libc::c_int as libc::c_int) != 0)
                        || (((((((*(__errno_location()))) as libc::c_int))
                            == (((62) as libc::c_int))) as libc::c_int as libc::c_int)
                            != 0)) as libc::c_int) as libc::c_int) != 0)
                        || (((((((*(__errno_location()))) as libc::c_int))
                            == (((110) as libc::c_int))) as libc::c_int as libc::c_int)
                            != 0)) as libc::c_int)) as libc::c_int) != 0))
                            ...
                            {
                                {
                                    ...
                                    <ACE_Log_Category_TSS>::conditional_set(
                                        ...
                                        ((b"/build/ace_full/src/ACE/ace/SOCK_SEQPACK_Connector.cpp\0"
                                    ...
                                    <ACE_Log_Category_TSS>::log(
                                        ...
                                        ((b"%p\n\0".as_ptr() as *const libc::c_char)
                                            as *const libc::c_char),
                                        b"ACE_SOCK_SEQPACK_Connector::ACE_SOCK_SEQPACK_Connector\0"
    ...
    pub unsafe fn new_udc74f05b09596c3e(
        mut __a0: *mut ACE_SOCK_SEQPACK_Association,
    ...
    pub unsafe fn new_at_u308cb7cdb3e18183(
        __this: *mut Self,
        mut new_association: *mut ACE_SOCK_SEQPACK_Association,
        mut remote_sap: *const ACE_Addr,
        mut timeout: *const ACE_Time_Value,
        ...
        unsafe {
            ...
            {
                if (((((((((((((<ACE_SOCK_SEQPACK_Connector>::connect_u0076b2f013cc5528(
                    (__this) as *mut ACE_SOCK_SEQPACK_Connector,
                    ::core::ptr::addr_of_mut!((* new_association)),
                    ::core::ptr::addr_of!((* remote_sap)),
                    timeout,
    ...
    pub unsafe fn new_u308cb7cdb3e18183(
        mut __a0: *mut ACE_SOCK_SEQPACK_Association,
        mut __a1: *const ACE_Addr,
        mut __a2: *const ACE_Time_Value,
        mut __a3: *const ACE_Multihomed_INET_Addr,
        mut __a4: libc::c_int,
        mut __a5: libc::c_int,
        mut __a6: libc::c_int,
        mut __a7: libc::c_int,
    ...
    pub unsafe fn connect(
        ...
        mut local_sap: *const ACE_Addr,
        mut reuse_addr: libc::c_int,
        mut _anon_5: libc::c_int,
        mut _anon_6: libc::c_int,
        mut protocol: libc::c_int,
    ) -> libc::c_int {
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((((<ACE_SOCK_SEQPACK_Connector>::shared_open(
                    (__this) as *mut ACE_SOCK_SEQPACK_Connector,
                    ::core::ptr::addr_of_mut!((* new_association)),
                    <ACE_Addr>::get_type(
                        (::core::ptr::addr_of!((* remote_sap))) as *const ACE_Addr,
                    ),
                    protocol,
                    reuse_addr,
                ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                    as libc::c_int as libc::c_int) != 0)
                {
                    ...
                    if (((((<ACE_SOCK_SEQPACK_Connector>::shared_connect_start(
                        (__this) as *mut ACE_SOCK_SEQPACK_Connector,
                        ::core::ptr::addr_of_mut!((* new_association)),
                        timeout,
                        ::core::ptr::addr_of!((* local_sap)),
                ...
                let mut result: libc::c_int = ACE_OS::connect_u21719e7a4d49e872(
                    <ACE_IPC_SAP>::get_handle(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((*
                            ::core::ptr::addr_of!((* (::core::ptr::addr_of!((*
                ...
                return <ACE_SOCK_SEQPACK_Connector>::shared_connect_finish(
                    (__this) as *mut ACE_SOCK_SEQPACK_Connector,
                    ::core::ptr::addr_of_mut!((* new_association)),
                    timeout,
                    result,
    ...
    #[doc = "* Actively connect to a peer, producing a connected @c ACE_SOCK_SEQPACK_Association\n   * object if the connection succeeds.\n   *\n   * @param new_association  The @c ACE_SOCK_SEQPACK_Association object that will be connected\n   *                    to the peer.\n   * @param remote_sap  The address that we are trying to connect to.\n   *                    The protocol family of @c remote_sap is used for\n   *                    the connected socket. That is, if @c remote_sap\n   *                    contains an IPv6 address, a socket with family\n   *                    PF_INET6 will be used, else it will be PF_INET.\n   * @param timeout     Pointer to an @c ACE_Time_Value object with amount\n   *                    of time to wait to connect. If the pointer is 0\n   *                    then the call blocks until the connection attempt\n   *                    is complete, whether it succeeds or fails.  If\n   *                    *timeout == {0, 0} then the connection is done\n   *                    using nonblocking mode.  In this case, if the\n   *                    connection can't be made immediately, this method\n   *                    returns -1 and errno == EWOULDBLOCK.\n   *                    If *timeout > {0, 0} then this is the maximum amount\n   *                    of time to wait before timing out; if the specified\n   *                    amount of time passes before the connection is made,\n   *                    this method returns -1 and errno == ETIME. Note\n   *                    the difference between this case and when a blocking\n   *                    connect is attempted that TCP times out - in the latter\n   *                    case, errno will be ETIMEDOUT.\n   * @param local_sap   (optional) The set of local addresses for SCTP to\n   *                    bind to.\n   * @param reuse_addr  (optional) If the value is 1, the local address\n   *                    (@c local_sap) is reused, even if it hasn't been\n   *                    cleaned up yet.\n   * @param flags       Ignored.\n   * @param perms       Ignored.\n   * @param protocol    (optional) If value is 0, default SOCK_STREAM\n   *                    protocol is selected by kernel (typically TCP).\n   *\n   * @return            Returns 0 if the connection succeeds. If it fails,\n   *                    -1 is returned and errno contains a specific error\n   *                    code."]
    pub unsafe fn connect_u0076b2f013cc5528(
        __this: *mut Self,
        mut new_association: *mut ACE_SOCK_SEQPACK_Association,
        mut remote_sap: *const ACE_Addr,
        mut timeout: *const ACE_Time_Value,
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                    ...
                    as libc::c_int as libc::c_int) != 0)
                {
                    ...
                    if (((((<ACE_SOCK_SEQPACK_Connector>::shared_connect_start_ufff276a5100d6509(
                        (__this) as *mut ACE_SOCK_SEQPACK_Connector,
                        ::core::ptr::addr_of_mut!((* new_association)),
                        timeout,
                        ::core::ptr::addr_of!((* local_sap)),
    ...
    pub unsafe fn complete(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                let mut h: libc::c_int = ACE::handle_timed_complete(
                    <ACE_IPC_SAP>::get_handle(
                        (::core::ptr::addr_of!(
                            (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((*
                            ::core::ptr::addr_of!((* (::core::ptr::addr_of!((*
                    ...
                    as libc::c_int) != 0)
                {
                    ...
                    <ACE_SOCK_SEQPACK_Association>::close(
                        (::core::ptr::addr_of_mut!((* new_association)))
                            as *mut ACE_SOCK_SEQPACK_Association,
                    );
                    return (-((1) as libc::c_int));
                }
                if ((((!(remote_sap).is_null()) as libc::c_int) as libc::c_int) != 0) {
                    let mut len: libc::c_int = <ACE_Addr>::get_size(
                        (remote_sap) as *const ACE_Addr,
                    );
                    let mut addr: *mut sockaddr = ({
                        let __obj: *mut ACE_Addr = (remote_sap) as *mut ACE_Addr;
                        let __vt: *const __Vtbl_u8861458fe5cac90c = *(__obj
                            as *const *const __Vtbl_u8861458fe5cac90c);
                        ((*__vt).vfn_ueade8b323a2ffe30)(__obj)
                    } as *mut sockaddr);
                    if (((((ACE_OS::getpeername_uad82bd4458b2c991(
                        h,
                        ((addr) as *mut sockaddr),
                        ::core::ptr::addr_of_mut!(len) as *mut libc::c_int,
                    ) as libc::c_int)) == ((((-((1) as libc::c_int))) as libc::c_int)))
                        as libc::c_int as libc::c_int) != 0)
                    {
                        let mut error: ACE_Errno_Guard = ::core::mem::MaybeUninit::<
            ...
            let __this: *mut Self = __this as *mut Self;
            {
                if (((((((((<ACE_IPC_SAP>::get_handle(
                    ...
                    && (((((<ACE_SOCK>::open(
                        (::core::ptr::addr_of_mut!(
                            (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((*
                            (::core::ptr::addr_of_mut!((* new_association)))).__base_0)
                            .cast:: < ACE_SOCK_IO > ().cast_mut()).__base_0) .cast:: <
                            ACE_SOCK > ().cast_mut())
                        )) as *mut ACE_SOCK,
  ...
  /// QoS-enabled semantics.*/
    pub unsafe fn shared_open_ufa5fb1dec0216f8b(
        __this: *mut Self,
        mut new_association: *mut ACE_SOCK_SEQPACK_Association,
        mut protocol_family: libc::c_int,
        mut protocol: libc::c_int,
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                if (((((((((<ACE_IPC_SAP>::get_handle(
                    ...
                    as libc::c_int as libc::c_int) != 0)
                    && (((((<ACE_SOCK>::open_ua8dc1292ba9f7772(
                        (::core::ptr::addr_of_mut!(
                            (* ::core::ptr::addr_of!((* ::core::ptr::addr_of!((*
                            (::core::ptr::addr_of_mut!((* new_association)))).__base_0)
                            .cast:: < ACE_SOCK_IO > ().cast_mut()).__base_0) .cast:: <
    ...
    pub unsafe fn shared_connect_start(
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                {
                    let mut laddr: *mut sockaddr = ({
                        let __obj: *mut ACE_Addr = (::core::ptr::addr_of!((* local_sap)))
                            as *mut ACE_Addr;
                        let __vt: *const __Vtbl_u8861458fe5cac90c = *(__obj
                            as *const *const __Vtbl_u8861458fe5cac90c);
                        ((*__vt).vfn_ueade8b323a2ffe30)(__obj)
                    } as *mut sockaddr);
                    let mut size: libc::c_int = <ACE_Addr>::get_size(
                        (::core::ptr::addr_of!((* local_sap))) as *const ACE_Addr,
                    );
    ...
    pub unsafe fn shared_connect_start_ufff276a5100d6509(
        __this: *mut Self,
        mut new_association: *mut ACE_SOCK_SEQPACK_Association,
        mut timeout: *const ACE_Time_Value,
        mut local_sap: *const ACE_Multihomed_INET_Addr,
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                ) as libc::c_int) != 0)
                {
                    ...
                    let mut name_len: libc::c_ulong = ((((((16)) as libc::c_ulong))
        ...
        unsafe {
            let __this: *mut Self = __this as *mut Self;
            {
                ...
                if (((((((((result as libc::c_int))
                    ...
                    as libc::c_int) as libc::c_int) != 0)
                {
                    if ((((((<ACE_Errno_Guard>::operator_eq(
                        (::core::ptr::addr_of_mut!(error)) as *mut ACE_Errno_Guard,
                        115,
                    ) as libc::c_int) != 0)
                        || ((<ACE_Errno_Guard>::operator_eq(
                            (::core::ptr::addr_of_mut!(error)) as *mut ACE_Errno_Guard,
                            11,
                        ) as libc::c_int) != 0)) as libc::c_int) as libc::c_int) != 0)
                    {
                        ...
                        {
                            <ACE_Errno_Guard>::operator_assign(
                                (::core::ptr::addr_of_mut!(error)) as *mut ACE_Errno_Guard,
                                11,
                            );
                        } else {
                            if (((((<ACE_SOCK_SEQPACK_Connector>::complete(
                                (__this) as *mut ACE_SOCK_SEQPACK_Connector,
                                ::core::ptr::addr_of_mut!((* new_association)),
                                ((0) as *mut ACE_Addr),
                                timeout,
